...
void func_45(var uParam0)
{
	if (uParam0->f_4 == 69)
	{
		if (BUILTIN::VDIST2(aggregate.camera_item.func_108(PLAYER::PLAYER_ID()), uParam0->f_2371.f_11) <= 100f)
		{
			if (!aggregate.annesburg.func_121(uParam0->f_2371.f_11) && Local_21.f_5 == -1)
			{
				Local_21.f_5 = aggregate.long_update.func_68(uParam0->f_19, 51, uParam0->f_2371.f_11, -1);
			}
		}
		else if (Local_21.f_5 != -1)
		{
			aggregate.net_camp_manager.func_17(&(Local_21.f_5), 0);
			Local_21.f_5 = -1;
		}
	}
}
...
bool func_316(var uParam0, int iParam1, int iParam2, vector3 vParam3, vector3 vParam6, int iParam9, int iParam10, int iParam11)
{
	...
	aggregate.camera_item.func_77(&(uParam0->f_4), 137558);
	aggregate.camera_item.func_77(&(uParam0->f_4), 137595);
	aggregate.shop_bait.func_733(&(uParam0->f_4), 137623);
	aggregate.shop_bait.func_733(&(uParam0->f_4), 138158);
...
void func_332(var uParam0)
{
	...
	{
		aggregate.shop_bait.func_749(uParam0, 0, 138963, 138972, 138981, 139523);
		aggregate.shop_bait.func_42(uParam0, 0, 32);
	}
	aggregate.shop_bait.func_749(uParam0, 1, 138963, 138972, 138981, 139523);
...
{
	if (aggregate.bandana.func_11(bParam1, -1192049572))
	{
		if (bParam2)
		{
	...
	if (aggregate.bandana.func_11(bParam1, -2085281117) || aggregate.bandana.func_11(bParam1, -887064662))
	{
		if (bParam2)
		{
	...
	if (aggregate.bandana.func_11(bParam1, 887366763))
	{
		if (bParam2)
		{
	...
	if (aggregate.bandana.func_11(bParam1, -1359903382))
	{
		if (bParam2)
		{
	...
	if (aggregate.bandana.func_11(bParam1, -1202768860))
	{
		if (bParam2)
		{
	...
	if (aggregate.bandana.func_11(bParam1, 1490540191))
	{
		if (bParam2)
		{
	...
	if (aggregate.bandana.func_11(bParam1, 554195525))
	{
		if (bParam2)
		{
...
void func_695(var uParam0)
{
	...
	if (!MISC::IS_BIT_SET(uParam0->f_2371.f_9, 1))
	{
		...
		{
			aggregate.mp_intro.func_1329(uParam0, 195357);
			aggregate.mp_intro.func_1329(uParam0, 196277);
			aggregate.mp_intro.func_1329(uParam0, 196880);
			aggregate.mp_intro.func_1329(uParam0, 197174);
			aggregate.mp_intro.func_1329(uParam0, 197377);
...
int func_749(var uParam0, int iParam1)
{
	...
	{
		return aggregate.shop_bait.func_749(uParam0, iParam1, 221795, 221826, 221913, 223511);
	}
	else
	{
		iVar0 = 0;
		...
		return aggregate.shop_bait.func_749(uParam0, iParam1, 223721, 197487, 128737, 30792);
	}
	return 0;
}
...
void func_804(var uParam0)
{
	...
	if (aggregate.fishing_core.func_34(uParam0, 16))
	{
		...
		if (!aggregate.fishing_core.func_34(uParam0, 256) && ((uParam0->f_2520.f_1 == 0 && !aggregate.flow_controller.func_195(uParam0->f_167.f_1757, func_1247(uParam0, uParam0->f_2520))) || !aggregate.flow_controller.func_195(func_1247(uParam0, uParam0->f_2520.f_1), func_1247(uParam0, uParam0->f_2520))))
		{
	...
	if (aggregate.fishing_core.func_34(uParam0, 256) && MISC::ABSI(NETWORK::GET_TIME_DIFFERENCE(uParam0->f_2520.f_2, NETWORK::GET_NETWORK_TIME_ACCURATE())) > 150)
	{
		...
		aggregate.fm_deathmatch_controller.func_2189(iVar0, func_1247(uParam0, uParam0->f_2520), uParam0->f_167.f_1760, 2, 1073741824 /* Float: 2f */);
		aggregate.fme_animal_tagging.func_1147(uParam0, 256);
	}
	bVar2 = false;
	...
	if (uParam0->f_2520 != 0)
	{
		...
		if (!aggregate.fishing_core.func_34(uParam0, 64))
		{
			if (!aggregate.fishing_core.func_34(uParam0, 128) && bVar2)
			{
				...
				{
					aggregate.fme_animal_tagging.func_1147(uParam0, 128);
					aggregate.fme_animal_tagging.func_300(iVar0, uParam0->f_2520, 2, 0, 1, func_1249(uParam0->f_2520));
					aggregate.binoculars.func_37(uParam0->f_2520.f_3, 0, 1, 1);
				}
			}
			else if (!bVar1)
		...
		if (!aggregate.fishing_core.func_34(uParam0, 128) && aggregate.doc_book.func_50(uParam0->f_2520.f_3, 1))
		{
			...
			aggregate.fme_animal_tagging.func_300(iVar0, uParam0->f_2520, 1, 1, 1, func_1249(uParam0->f_2520));
...
int func_1043(var uParam0, var uParam1)
{
	...
	iVar0 = aggregate.bandana.func_10(uParam1->f_7);
	bVar1 = false;
	switch (uParam1->f_10)
	{
		case 1:
			...
			{
				aggregate.aberdeenpigfarm.func_181(uParam1->f_7);
			}
			break;
		case 2:
			bVar1 = aggregate.mp_intro.func_1734();
			if (aggregate.mp_intro.func_1354(uParam0) == 1256151078)
			{
				aggregate.net_camp.func_1328(uParam0, -1934515925, 1, -1, 1, 1, 1, 0);
				return 1;
			}
			switch (*uParam1)
			{
			...
			if (bVar3)
			{
				if (aggregate.dynamic_craft_scenario.func_162(uParam1->f_7))
				{
					if (aggregate.mp_intro.func_1735(aggregate.net_camp.func_1061(uParam0)))
					{
						aggregate.mp_intro.func_1418(uParam0, -1, 1);
					}
					aggregate.interactive_campfire.func_730(uParam1->f_7, 0, 0);
					if (aggregate.bandana.func_30(bVar1, 0))
					{
						aggregate.mp_intro.func_1737(bVar1, 3);
					}
					else
					{
						aggregate.mp_intro.func_1737(uParam1->f_7, 3);
					}
				}
				else
				{
					aggregate.dynamic_craft_scenario.func_163(uParam1->f_7, 0, 0, 0);
					if (aggregate.bandana.func_30(bVar1, 0))
					{
						aggregate.mp_intro.func_1737(bVar1, 2);
					}
					else
					{
						aggregate.mp_intro.func_1737(uParam1->f_7, 2);
					}
				}
			}
			aggregate.bandana.func_52(1048576);
			break;
		case 3:
			if (!aggregate.mp_intro.func_1725(uParam1->f_7) || uParam1->f_7 == 491602716)
			{
			}
			else
			{
				...
				Jump @574; //curOff = 377
				if ((aggregate.mp_intro.func_1725(uParam1->f_7) && aggregate.mp_intro.func_1726() != uParam1->f_7) && uParam1->f_7 != 491602716)
				{
					if (aggregate.dynamic_craft_scenario.func_162(uParam1->f_7))
					{
						aggregate.interactive_campfire.func_730(uParam1->f_7, 0, 0);
					...
					aggregate.mp_intro.func_1737(uParam1->f_7, 1);
					if (aggregate.mp_intro.func_1739(uParam1->f_7, &iVar4, 1))
					{
						aggregate.mp_intro.func_1740(iVar4);
						aggregate.mp_intro.func_1741(2, iVar4, 6);
						aggregate.mp_intro.func_1742(iVar4);
						aggregate.bandana.func_52(1048576);
					}
					aggregate.mp_intro.func_1418(uParam0, -1, 1);
				}
				else if (aggregate.mp_intro.func_1743(&(uParam0->f_2371.f_6)))
				{
					iVar2 = aggregate.mp_intro.func_1744(uParam0->f_2371.f_6);
					if (iVar2 != 0)
					{
...
bool func_1132(var uParam0, var uParam1, bool bParam2)
{
	...
	*uParam1 = 1;
	iVar0 = 0;
	iVar8 = aggregate.mp_intro.func_1878(uParam0);
	Var14 = -1;
	Var14.f_1 = -1;
	Var14.f_2 = -1;
	Var14.f_3 = -1;
	...
	while (bVar1 < iVar50)
	{
		...
		{
			bVar2 = DATABINDING::_DATABINDING_READ_DATA_HASH_STRING_FROM_PARENT(iVar49, aggregate.mp_intro.func_1962());
			bVar6 = bVar2;
			iVar4 = DATABINDING::_DATABINDING_READ_DATA_INT_FROM_PARENT(iVar49, aggregate.mp_intro.func_1963());
			iVar5 = iVar4;
			iVar3 = DATABINDING::_DATABINDING_READ_DATA_INT_FROM_PARENT(iVar49, aggregate.mp_intro.func_1964());
			if (aggregate.bandana.func_30(bVar6, 0))
			{
				if (iVar5 == 1702073444)
				{
					if (aggregate.mp_intro.func_2048(bVar6))
					{
						Var14.f_8 = iVar3;
						iVar8 = aggregate.mp_intro.func_1878(uParam0);
						...
						while (iVar11 < iVar9)
						{
							bVar12 = aggregate.fm_mission_controller.func_6851(iVar11, iVar10);
							if ((((aggregate.bandana.func_30(bVar12, 0) && bVar12 != bVar6) && !aggregate.mp_intro.func_2050(bVar12, &bVar24, iVar35)) && aggregate.mp_intro.func_2051(&(uParam0->f_2094), bVar12, &uVar7)) || ITEMDATABASE::_ITEM_DATABASE_GET_ITEM_TAG_TYPE(bVar12, Var14.f_8) == -2089472884)
							{
								uParam0->f_2094.f_73 = uVar7;
								iVar13 = aggregate.mp_intro.func_2052(uParam0, bVar12);
								if (!func_1562(uParam0, bVar12, iVar13))
								{
									if (iVar47 < (iVar36 - 1))
									{
				...
				else if (!aggregate.mp_intro.func_2050(bVar6, &bVar24, iVar35))
				{
					if (!func_1562(uParam0, bVar6, iVar5))
					{
						if (!(aggregate.fme_animal_tagging.func_1525(bVar6, 59806960) && aggregate.fm_mission_controller.func_6305()))
						{
							iVar0 = (iVar0 + aggregate.shop_bait.func_562(bVar6, bVar48, 1, 0, 1));
						}
						*uParam1 = 0;
					}
					if (aggregate.bandana.func_11(bVar6, 1954943838))
					{
						if (iVar47 < (iVar36 - 1))
						{
							iVar36[iVar47] = bVar6;
	...
	while (bVar1 < iVar47)
	{
		if (&iVar36[bVar1] != 0 && !aggregate.bandana.func_11(&(iVar36[bVar1]), 1954943838))
		{
			iVar51 = 0;
			while (iVar51 < iVar47)
			{
				if ((&iVar36[iVar51] != 0 && aggregate.bandana.func_11(&(iVar36[iVar51]), 1954943838)) && aggregate.mp_intro.func_2053(&(iVar36[bVar1]), &(iVar36[iVar51])))
				{
					if (!(aggregate.fme_animal_tagging.func_1525(&(iVar36[bVar1]), 59806960) && aggregate.fm_mission_controller.func_6305()))
					{
						iVar0 = (iVar0 + aggregate.shop_bait.func_562(&(iVar36[bVar1]), bVar48, 1, 0, 1));
					}
					*uParam1 = 0;
					iVar36[bVar1] = 0;
				}
...
bool func_1193(var uParam0)
{
	...
	if (!aggregate.mp_intro.func_1426(uParam0))
	{
		...
		if (func_1040(uParam0, Var0.f_2, Var0.f_3, 0))
		{
			...
			aggregate.mp_intro.func_1329(uParam0, 324698);
			aggregate.mp_intro.func_1329(uParam0, 324902);
			aggregate.mp_intro.func_1329(uParam0, 325012);
...
bool func_1194(var uParam0)
{
	...
	if (!aggregate.mp_intro.func_1426(uParam0))
	{
		...
		if (func_1040(uParam0, bVar5, bVar6, 1))
		{
			...
			aggregate.mp_intro.func_1329(uParam0, 325717);
			aggregate.mp_intro.func_1329(uParam0, 325871);
			aggregate.mp_intro.func_1329(uParam0, 326084);
...
bool func_1195(var uParam0)
{
	...
	if (!aggregate.mp_intro.func_1426(uParam0))
	{
		...
		{
			aggregate.shop_doctor.func_1735(uParam0, 173);
			aggregate.mp_intro.func_1329(uParam0, 326624);
			aggregate.mp_intro.func_1329(uParam0, 326691);
			aggregate.mp_intro.func_1329(uParam0, 326864);
			if (bVar0)
			{
				if (!aggregate.net_camp.func_1094(uParam0, Var1.f_2, Var1.f_3, -1, 1, 1))
				{
...
bool func_1562(var uParam0, bool bParam1, bool bParam2)
{
	...
	if (bParam2 == -1502467280 || bParam2 == 777890122)
	{
				...
				if (bVar23 != 0 && bVar24 != 0)
				{
					...
					if (iVar1 != 0)
					{
						...
						while (iVar26 < iVar25)
						{
							...
							{
								Var5 = { aggregate.binoculars.func_85(0, iVar2, -1591664384, -1591664384, 0, 0, 0) };
		...
		{
			bVar29 = aggregate.net_camp.func_1061(uParam0);
			Var30.f_2 = -1;
			Var30.f_3 = -1;
			Var38 = -1;
			Var38.f_1 = -1;
					...
					if (Var30 == bParam1 && aggregate.bandana.func_30(Var30, 0))
					{
						...
						else
						{
							...
							while (iVar50 < iVar48)
							{
								...
								{
									bVar52 = aggregate.mp_intro.func_2052(uParam0, bVar51);
									...
									{
										bVar56 = aggregate.net_camp.func_1061(uParam0);
										Var57.f_2 = -1;
										Var57.f_3 = -1;
										Var65 = -1;
										Var65.f_1 = -1;
												...
												if (Var57 == bParam1 && aggregate.bandana.func_30(Var57, 0))
												{
													...
													else
													{
														...
														while (iVar77 < iVar75)
														{
															...
															{
																bVar79 = aggregate.mp_intro.func_2052(uParam0, bVar78);
...
void func_2731(int iParam0, bool bParam1, int iParam2)
{
	int iVar0;
	int iVar1;
	int iVar2;
...
bool func_2879(bool bParam0, bool bParam1, bool bParam2)
{
	if (bParam0 == 0)
	{
		return false;
