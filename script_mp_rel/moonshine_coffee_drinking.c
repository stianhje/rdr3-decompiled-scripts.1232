...
void func_48(int iParam0, bool bParam1, int iParam2, int iParam3)
{
	...
	switch (iParam0)
	{
		...
		case -635441454:
		case 1448771675:
			func_82(func_85(1368284188, -2049431929), 1);
			break;
	}
	switch (iParam0)
	{
		...
		case -1907044919:
		case 688258043:
			func_82(func_85(1368284188, 894597474), 1);
			break;
		case -541584777:
		case 206762213:
...
int func_79(int iParam0, float fParam1, bool bParam2, var uParam3)
{
	char* sVar0;
	int iVar1;
