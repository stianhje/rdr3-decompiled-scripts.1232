...
void __EntryFunction__()
{
	...
	while (!SCRIPTS::_0x9E4EF615E307FBBE())
	{
		...
		switch (Var0)
		{
			...
			case 1:
				func_8(&Var0);
				if (!aggregate_func_4240(Var0.f_184, 4) && TASK::_0x6AA3DCA2C6F5EB6D(Global_35) != -1200848232)
				{
					aggregate_func_4247(&(Var0.f_184), 4);
					func_11(&Var0, 0);
				}
				else if (aggregate_func_4240(Var0.f_184, 4) && TASK::_0x6AA3DCA2C6F5EB6D(Global_35) == -1200848232)
				{
					aggregate_func_4247(&(Var0.f_184), 4);
					func_11(&Var0, 1);
				}
				if (aggregate_func_2973(&(Var0.f_180[0]), 1))
				{
				...
				if (aggregate_func_2973(&(Var0.f_180[1]), 1))
				{
				...
				if (ENTITY::HAS_ANIM_EVENT_FIRED(Global_35, 442509369))
				{
					...
					{
						aggregate_func_7706((-0.1f / Var0.f_1.f_2), 1);
					}
...
int func_4(int iParam0)
{
	...
	{
		iVar1 = iVar0;
		if (aggregate_func_2875(&(iParam0->f_180[iVar0])))
		{
			aggregate_func_2052(&(iParam0->f_180[iVar0]), func_23(iVar1), 0);
		}
		else
		{
			iParam0->f_180[iVar0] = aggregate_func_2385(func_23(iVar1), func_25(iVar1), 2, 0, 0, func_26(iVar1), 570, 4000, 10, 1073741824 /* Float: 2f */, joaat("SHORT_TIMED_EVENT"), 0);
			aggregate_func_2079(&(iParam0->f_180[iVar0]), HUD::_UIPROMPT_GET_GROUP_ID_FOR_TARGET_ENTITY(Global_35), 0, 1);
		}
		iVar0++;
	}
	return 1;
...
{
	if (!aggregate_func_4934() && iParam0->f_183 != 0)
	{
		iParam0->f_183 = 0;
		aggregate_func_4247(&(iParam0->f_184), 1);
	}
	if (aggregate_func_5101() && iParam0->f_183 != 1)
	{
		iParam0->f_183 = 1;
		aggregate_func_4247(&(iParam0->f_184), 1);
	}
	if (aggregate_func_5077() && iParam0->f_183 != 2)
	{
		iParam0->f_183 = 2;
		aggregate_func_4247(&(iParam0->f_184), 1);
	}
	if (aggregate_func_4240(iParam0->f_184, 1))
	{
		aggregate_func_4247(&(iParam0->f_184), 1);
		func_4(iParam0);
	}
...
void func_11(var uParam0, bool bParam1)
{
	...
	while (iVar0 < 2)
	{
		if (aggregate_func_2875(&(uParam0->f_180[iVar0])))
		{
			aggregate_func_4583(&(uParam0->f_180[iVar0]), bParam1, 0, 1);
		}
		iVar0++;
	}
}
