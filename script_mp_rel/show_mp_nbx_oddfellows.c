...
void func_4(var uParam0, var uParam1, var uParam2)
{
	...
	switch (uParam0->f_1352)
	{
		...
		case 2:
			...
			{
				NETWORK::RESERVE_NETWORK_MISSION_OBJECTS((1 - NETWORK::GET_NUM_RESERVED_MISSION_OBJECTS(0)));
				return;
			}
...
int func_21(var uParam0)
{
	if (NETWORK::NETWORK_IS_HOST_OF_THIS_SCRIPT())
	{
		...
		uParam0->f_23 = 4;
		uParam0->f_2 = 0;
		uParam0->f_1401[0] = -2053326164;
		uParam0->f_1401[1] = -1458432563;
		uParam0->f_1401[2] = 1599685341;
		uParam0->f_1401[3] = 1110781448;
		uParam0->f_1385[0] = 335081545;
...
int func_96(var uParam0)
{
	...
	if (!ENTITY::DOES_ENTITY_EXIST(&(uParam0->f_1393[0])))
	{
		...
		{
			ANIMSCENE::SET_ANIM_SCENE_ENTITY(iVar0, "p_cs_bullwhip01x", &(uParam0->f_1393[0]), 0);
		}
		else
		{
			return 0;
	...
	if (!func_155(uParam0, iVar0, 0, "CS_GENSTORYFEMALE"))
	{
		return 0;
	}
	if (!func_155(uParam0, iVar0, 1, "CS_ODDFELLOWSPINHEAD"))
	{
		return 0;
	}
	if (!func_155(uParam0, iVar0, 2, "CS_MAGNIFICO"))
	{
		return 0;
	}
	if (!func_155(uParam0, iVar0, 3, "CS_GENSTORYMALE"))
	{
		return 0;
	}
...
void func_127(int iParam0, bool bParam1, float fParam2, bool bParam3, bool bParam4, float fParam5, int iParam6, bool bParam7)
{
	...
	if (func_159(iParam0))
	{
		...
		if (bParam3)
		{
			func_166(iParam0, fParam2, 1, iParam6);
		}
		else if (bParam1)
		{
			if (bParam4)
...
int func_133(var uParam0, var uParam1, int iParam2)
{
	...
	if (!func_13(*uParam1, 1))
	{
		...
		{
			iVar3 = iVar0;
			if (func_175((*uParam0)[iVar0 /*5*/], func_173(iParam2), func_174(iParam2, iVar3), 1065353216))
			{
				iVar2++;
			}
			iVar0++;
	...
	if (!func_13(*uParam1, 8))
	{
		...
		{
			iVar4 = iVar0;
			if (func_175(uParam0->f_31[iVar0 /*5*/], func_177(iParam2), func_178(iParam2, iVar4), 1065353216))
			{
				iVar2++;
			}
			iVar0++;
	...
	if (!func_13(*uParam1, 2048))
	{
		...
		{
			iVar5 = iVar0;
			if (func_175(uParam0->f_107[iVar0 /*5*/], func_180(iParam2), func_181(iParam2, iVar5), 1065353216))
			{
				iVar2++;
			}
			iVar0++;
	...
	{
		case 0:
			if (!func_13(*uParam1, 64) && func_175(uParam0->f_118[0 /*5*/], func_182(iParam2, 0), func_183(iParam2, 0), 1065353216))
			{
				func_18(uParam1, 64);
			}
			if ((!func_13(*uParam1, 16384) && func_175(uParam0->f_118[1 /*5*/], func_182(iParam2, 1), func_183(iParam2, 1), 1065353216)) && func_175(uParam0->f_118[2 /*5*/], func_182(iParam2, 2), func_183(iParam2, 2), 1065353216))
			{
		...
		case 1:
			...
			if (!func_13(*uParam1, 2097152))
			{
				...
				{
					iVar6 = iVar0;
					if (func_175(uParam0->f_118[iVar0 /*5*/], func_182(iParam2, 0), func_183(iParam2, iVar6), 1065353216))
					{
						iVar2++;
					}
					iVar0++;
...
void func_134(var uParam0, var uParam1, int iParam2)
{
	...
	if (iParam2 == 0)
	{
		...
		{
			if (func_13(*uParam0, 128) && func_199(uParam1->f_118[0 /*5*/], func_197(uParam1), &(uParam1->f_238), func_198(uParam1), func_187(uParam1)))
			{
				func_14(uParam0, 128);
			}
			if (func_13(*uParam0, 256) && func_201(uParam1->f_118[0 /*5*/], func_200(uParam1), &(uParam1->f_238), func_198(uParam1), func_187(uParam1)))
			{
				func_14(uParam0, 256);
			}
			if (func_13(*uParam0, 512) && func_199(uParam1->f_118[0 /*5*/], func_197(uParam1), &(uParam1->f_238), 0.5f, func_187(uParam1)))
			{
				func_14(uParam0, 512);
			}
			if (func_13(*uParam0, 1024) && func_201(uParam1->f_118[0 /*5*/], func_200(uParam1), &(uParam1->f_238), 0.5f, func_187(uParam1)))
			{
...
Vector3 func_153(int iParam0)
{
	...
	{
		case 0:
			return 2553.193f, -1310.103f, 49.21665f;
...
void func_166(int iParam0, float fParam1, int iParam2, int iParam3)
{
	if (func_159(iParam0))
	{
...
int func_175(var uParam0, int iParam1, vector3 vParam2, int iParam5)
{
	if (uParam0->f_1 == 0)
	{
...
int func_190(var uParam0, float fParam1, var uParam2, float fParam3, int iParam4)
{
	int iVar0;
	float fVar1;
...
int func_201(var uParam0, float fParam1, var uParam2, float fParam3, int iParam4)
{
	float fVar0;
...
int func_206(int iParam0, int iParam1, var uParam2, float fParam3, var uParam4, float fParam5, int iParam6)
{
	int iVar0;
	int iVar1;
	float fVar2;
...
var func_212(vector3 vParam0, vector3 vParam3, vector3 vParam6, int iParam9, var uParam10, var uParam11)
{
	var uVar0;
	int iVar1;
	int iVar2;
	...
	else
	{
		...
		{
			case 665633627:
				iVar8 = VOLUME::_CREATE_VOLUME_CYLINDER_WITH_CUSTOM_NAME(vParam0, vParam3, vParam6, func_226());
				break;
			
			case -432403087:
				iVar8 = VOLUME::_0x10157BC3247FF3BA(vParam0, vParam3, vParam6, func_226());
				break;
			
			case -1612834106:
				iVar8 = VOLUME::_CREATE_VOLUME_BOX_WITH_CUSTOM_NAME(vParam0, vParam3, vParam6, func_226());
				break;
		}
	}
	if (iVar9 & 8 != 0)
	{
		iVar9 = (iVar9 || func_227(PLAYER::GET_PLAYER_TEAM(iVar5)));
	}
...
int func_233(int iParam0, int iParam1)
{
	...
	if (iParam1 == 255)
	{
		return func_236(&(Global_1099293->f_4), iVar0, 5);
	}
	if (iParam1 == func_237())
	{
		return func_236(&(Global_1099293->f_4), iVar0, 5);
	...
	{
		return func_236(&(((*Global_1097609)[iParam1 /*51*/])->f_4), iVar0, 5);
	}
	return 0;
}
