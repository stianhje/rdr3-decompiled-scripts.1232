...
bool func_54(int iParam0)
{
	...
	if (func_87(iVar1))
	{
		if (Global_1070355->f_17915.f_24 && !func_88(iParam0))
		{
			return false;
		}
...
void func_71(int iParam0, int iParam1, int iParam2, bool bParam3, int iParam4, bool bParam5)
{
	...
	Global_1938075->f_145 = func_114(sVar1, sVar2, 4000, 0, 0, 0, 0, 1);
}
...
{
	func_145((Global_1938932->f_5[iParam0 /*11*/])->f_6, 1);
	func_146((Global_1938932->f_5[iParam0 /*11*/])->f_6, 0);
...
void func_121(int iParam0)
{
	...
	if (func_94((Global_1915170->f_3[iParam0 /*447*/])->f_21) && func_148((Global_1915170->f_3[iParam0 /*447*/])->f_21))
	{
		func_149((Global_1915170->f_3[iParam0 /*447*/])->f_21, 0, 1, 0, 0);
	}
	...
	func_150((Global_1915170->f_3[iParam0 /*447*/])->f_9, 0);
	...
	else
	{
		...
		while (iVar0 < iVar1)
		{
			func_153(&((Global_1915170->f_3[iParam0 /*447*/])->f_318[iVar0 /*6*/]));
...
void func_128(int iParam0)
{
	...
	else
	{
		...
		while (iVar2 < iVar3)
		{
			func_153(&((Global_1051387->f_69[iParam0 /*76*/])->f_32[iVar2]));
	...
	if (VOLUME::_0x92A78D0BEDB332A3((Global_1051387->f_69[iParam0 /*76*/])->f_25) && func_167(iParam0, 2))
	{
...
{
	func_176(&((Global_1938932->f_5[iParam0 /*11*/])->f_7), iParam1);
}
