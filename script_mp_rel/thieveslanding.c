...
void func_29(int iParam0)
{
	...
	{
		func_59(4, iLocal_21, iParam0, iLocal_22, 0, 44, 0, 0, -1082130432 /* Float: -1f */, 0);
		func_60(4, 0);
	}
}
...
int func_60(int iParam0, bool bParam1)
{
	...
	if ((!bParam1 && func_105(iVar0, &iVar1, &uVar2, &vVar3)) || (bParam1 && func_106(iVar0, &iVar1, &uVar2, &vVar3)))
	{
		func_107(iParam0, iVar1, vVar3, uVar2, 0);
...
void func_71(int iParam0, int iParam1, int iParam2, bool bParam3, int iParam4, bool bParam5)
{
	...
	sVar1 = func_112(iParam0, iParam1, iParam2, iParam4, bParam5, bParam3, &bVar0);
	...
	else
	{
		...
		if (!MISC::_SHOULD_USE_24_HOUR_CLOCK())
		{
			...
			sVar2 = MISC::_CREATE_VAR_STRING(674, sVar8, iVar4, func_124(&cVar6, joaat("COLOR_PURE_WHITE")), sVar9, func_124(&cVar10, joaat("COLOR_PURE_WHITE")));
		}
		else
		{
			...
			IntToString(&cVar10, BUILTIN::ROUND(fVar7), 8);
			sVar2 = MISC::_CREATE_VAR_STRING(162, sVar8, iVar4, func_124(&cVar6, joaat("COLOR_PURE_WHITE")), func_124(&cVar10, joaat("COLOR_PURE_WHITE")));
		}
...
bool func_105(int iParam0, int iParam1, bool bParam2, var uParam3)
{
	return func_165(iParam0, "sHash", iParam1, "fHeading", bParam2, "vPos", uParam3);
}

bool func_106(int iParam0, int iParam1, bool bParam2, var uParam3)
{
	return func_165(iParam0, "sClosedHash", iParam1, "fClosedHeading", bParam2, "vClosedPos", uParam3);
}

void func_107(int iParam0, int iParam1, vector3 vParam2, var uParam5, bool bParam6)
{
	if (bParam6)
	{
...
bool func_109(int iParam0, int iParam1, int iParam2, bool bParam3)
{
...
char* func_112(int iParam0, int iParam1, int iParam2, int iParam3, bool bParam4, bool bParam5, var uParam6)
{
	char* sVar0;
...
int func_165(int iParam0, char* sParam1, int iParam2, char* sParam3, bool bParam4, char* sParam5, var uParam6)
{
	struct<4> Var0;
...
int func_166(int iParam0, vector3 vParam1, int iParam4, int iParam5, int iParam6, int iParam7)
{
...
void func_181(int iParam0, bool bParam1, bool bParam2, bool bParam3, bool bParam4)
{
	int iVar0;
	int iVar1;
...
int func_209(vector3 vParam0, int iParam3)
{
	...
	func_230(iParam3, &vVar0, &Var3, &uVar6);
	if (func_231(vParam0, vVar0, Var3, Var3.f_1, uVar6))
	{
		return 1;
	}
	return 0;
