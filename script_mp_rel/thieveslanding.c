...
int func_13()
{
	...
	func_53(&Local_23, -1355.28f, -2296.67f, 40.62f, 0f, 0f, 0f, 6f, 5f, 3f, "HTL_VOLUME_BOAT_INTERIOR");
	Local_23.f_1 = 0;
	Local_23.f_2 = 0;
	return 1;
}
...
void func_29(int iParam0)
{
	...
	{
		func_59(4, iLocal_21, iParam0, iLocal_22, 0, 44, 0, 0, -1082130432, 0);
		func_60(4, 0);
	}
}
...
void func_41(var uParam0, int iParam1)
{
	...
	if ((BUILTIN::VDIST(Global_36, 0f, 0f, 0f) <= 5f || func_64(&Global_1939168, 32768)) || func_64(&Global_1939168, 16777216))
	{
		return;
	}
...
int func_44(int iParam0)
{
	if (iParam0 == 0)
	{
		...
		if (STATS::CHAL_IS_GOAL_ACTIVE(-663946200, 1055032020))
		{
			switch (iLocal_30)
			{
				...
				case 127:
				case 135:
					STATS::CHAL_ADD_GOAL_PROGRESS_INT_BY_SCORE_ID(func_77(iLocal_30, 0), 1);
					break;
			}
		}
		if (func_10(func_70()))
	...
	else if (func_45() == -1)
	{
		func_81(iLocal_30);
		func_82(iLocal_30);
		if (!func_83(iLocal_30, 0))
		{
			return 0;
		}
	}
	else if (!func_84(iLocal_30))
	{
		return 0;
	}
	SCRIPTS::TERMINATE_THIS_THREAD();
...
void func_53(int iParam0, vector3 vParam1, vector3 vParam4, vector3 vParam7, char* sParam10)
{
...
int func_54(int iParam0, int iParam1, int iParam2, bool bParam3)
{
	...
	if (func_86(iParam0) && !func_87(iParam0))
	{
	}
	if (func_88(iParam0, &iVar0, &iVar1, 0, 0))
	{
		if (func_89(iParam1))
		{
			iVar0 = iParam1;
		...
		while (true)
		{
			if ((!func_86(iParam0) || func_87(iParam0)) || func_90(&Global_1896608))
			{
				func_91(&Global_1896608, 0);
			}
...
int func_60(int iParam0, bool bParam1)
{
	...
	if ((func_102(iParam0, 16384) || func_102(iParam0, 32768)) || func_103((Global_1051387->f_69[iParam0 /*76*/])->f_3))
	{
	...
	iVar0 = func_97(func_104(), iParam0);
	if ((!bParam1 && func_105(iVar0, &iVar1, &fVar2, &vVar3)) || (bParam1 && func_106(iVar0, &iVar1, &fVar2, &vVar3)))
	{
		func_107(iParam0, iVar1, vVar3, fVar2, 0);
...
void func_63()
{
	...
	if (Local_23.f_2)
	{
		if (!func_109(PLAYER::PLAYER_PED_ID(), Local_23, 0, 1))
		{
	...
	else if (func_109(PLAYER::PLAYER_PED_ID(), Local_23, 0, 1))
	{
		WATER::_DISABLE_WATER_COLLISION();
		Local_23.f_2 = 1;
	}
...
bool func_66()
{
	return func_64(&Global_1939168, 8192);
}
...
bool func_68(int iParam0)
{
	...
	return ((((*Global_1887327)[iParam0 /*36*/])->f_21 == 1 || ((*Global_1887327)[iParam0 /*36*/])->f_21 == 2) && !func_110(iParam0));
}
...
void func_71(int iParam0, int iParam1, int iParam2, bool bParam3, int iParam4, int iParam5)
{
	...
	sVar1 = func_112(iParam0, iParam1, iParam2, iParam4, iParam5, bParam3, &uVar0);
	...
	if (func_113(iParam4))
	{
		iVar3 = func_115(iParam4);
	}
	if (uVar0 && bParam3)
	{
		sVar2 = func_117(func_116(iParam2));
	}
	else if ((func_118(iParam1, 2) || func_119(iParam4, 2)) && !Global_1893575->f_9)
	{
	...
	else if ((func_61(iParam0) && func_85(iParam0, 16777216)) && !Global_1893575->f_9)
	{
	...
	{
		iVar4 = func_121(func_120());
		iVar5 = func_122(func_120());
		if (iVar5 < 10)
		{
		...
		if (!MISC::_SHOULD_USE_24_HOUR_CLOCK())
		{
			...
			{
				fVar7 = func_123(fVar7);
				sVar8 = "TIME_AND_TEMP_F";
			}
			IntToString(&sVar10, BUILTIN::ROUND(fVar7), 8);
			sVar2 = MISC::_CREATE_VAR_STRING(674, sVar8, iVar4, func_124(&sVar6, 109029619), sVar9, func_124(&sVar10, 109029619));
		}
		else
		{
			...
			IntToString(&sVar10, BUILTIN::ROUND(fVar7), 8);
			sVar2 = MISC::_CREATE_VAR_STRING(162, sVar8, iVar4, func_124(&sVar6, 109029619), func_124(&sVar10, 109029619));
		}
		Global_1893575->f_9 = 0;
	}
	Global_1938075->f_145 = func_125(sVar1, sVar2, 4000, 0, 0, 0, 0, 1);
}
...
void func_73(int iParam0, bool bParam1)
{
	...
	switch (func_9(iParam0))
	{
		...
		case 2:
		case 11:
			func_129(func_128(-1532769513, 213519508), 1);
			break;
		case 1:
		case 5:
		case 6:
		case 7:
		case 12:
			func_129(func_128(-1532769513, 242571679), 1);
			break;
		case 3:
		case 10:
			func_129(func_128(-1532769513, 1349449307), 1);
			break;
		case 4:
		case 9:
			func_129(func_128(-1532769513, 1140362070), 1);
			break;
		case 8:
			func_129(func_128(-1532769513, -172330899), 1);
			break;
		case 13:
		case 14:
		case 15:
		case 16:
			func_129(func_128(-1532769513, -910218296), 1);
			break;
	}
	switch (iParam0)
	{
...
int func_83(int iParam0, bool bParam1)
{
	...
	if (func_88(iParam0, &iVar0, &iVar1, 0, 0))
	{
		...
		while (true)
		{
			if (!func_132(Global_1896608->f_1, 16))
			{
				func_133(Global_1896608->f_1, 0);
			}
			Global_1896608->f_1++;
			iVar2++;
...
int func_84(int iParam0)
{
	...
	while (iVar0 < 39)
	{
		if (func_134(iVar0) || func_135(iVar0))
		{
		}
		else
		{
...
int func_88(int iParam0, var uParam1, var uParam2, bool bParam3, bool bParam4)
{
	bool bVar0;
...
int func_91(int iParam0, bool bParam1)
{
	...
	{
		func_139(iParam0, _NAMESPACE48::_0x4F76E3676583D951(func_138(iParam0)));
		if (func_45() == -1)
		{
			if (func_132(iParam0, 2048))
			{
				_NAMESPACE48::_0x49A8C2CD97815215(func_140(iParam0));
	...
	if (_NAMESPACE48::_0x800DF3FC913355F3(func_140(iParam0)))
	{
...
void func_95(bool bParam0, bool bParam1)
{
	...
	func_151(Global_1099293->f_516, 36);
	func_152(Global_1099293->f_555, 36);
}
...
void func_96(int iParam0)
{
	...
	if (func_154(iParam0, 16384) && !bVar0)
	{
	...
	else
	{
		...
		while (iVar2 < iVar3)
		{
			func_157(&((Global_1051387->f_69[iParam0 /*76*/])->f_32[iVar2]));
	...
	if (VOLUME::_0x92A78D0BEDB332A3((Global_1051387->f_69[iParam0 /*76*/])->f_25) && func_160(iParam0, 2))
	{
...
int func_98(int iParam0)
{
	...
	{
		Global_1051387->f_4360[iParam0] = func_164(iParam0);
	}
...
int func_105(int iParam0, var uParam1, float fParam2, var uParam3)
{
	return func_165(iParam0, "sHash", uParam1, "fHeading", fParam2, "vPos", uParam3);
}

int func_106(int iParam0, var uParam1, float fParam2, var uParam3)
{
	return func_165(iParam0, "sClosedHash", uParam1, "fClosedHeading", fParam2, "vClosedPos", uParam3);
}

void func_107(int iParam0, int iParam1, vector3 vParam2, float fParam5, bool bParam6)
{
	if (bParam6)
	{
		MISC::GET_GROUND_Z_FOR_3D_COORD(vParam2, &(vParam2.f_2), 0);
	}
	(Global_1051387->f_69[iParam0 /*76*/])->f_6 = func_166(iParam1, vParam2, fParam5, 0, 0, 0);
...
{
	if ((iParam0 == 22 || iParam0 == 39) && !func_167())
	{
		return 1;
	}
	if (iParam0 == 66)
...
char* func_112(int iParam0, int iParam1, int iParam2, int iParam3, var uParam4, var uParam5, var uParam6)
{
	char* sVar0;

	if (!MISC::IS_STRING_NULL_OR_EMPTY(&(Global_1893575->f_162)))
	{
		sVar0 = func_170(Global_1893575->f_162);
	}
	if (MISC::IS_STRING_NULL_OR_EMPTY(sVar0) && uParam4)
	{
		sVar0 = func_172(func_171(Global_36));
	}
	if (MISC::IS_STRING_NULL_OR_EMPTY(sVar0))
	{
		if (!func_173(iParam0) || func_174(44))
		{
			switch (iParam0)
			{
				case 2:
...
int func_115(int iParam0)
{
	...
	iVar0 = 0;
	Var1 = { func_175(PLAYER::PLAYER_ID()) };
...
char* func_124(char* sParam0, int iParam1)
{
	...
	return func_176(MISC::_CREATE_VAR_STRING(10, "LITERAL_STRING", sParam0), iParam1);
}

var func_125(char* sParam0, char* sParam1, int iParam2, int iParam3, int iParam4, int iParam5, int iParam6, int iParam7)
{
	struct<4> Var0;
	vector3 vVar13;
	var uVar16;
...
{
	func_177((Global_1938932->f_5[iParam0 /*11*/])->f_6, 1);
	func_178((Global_1938932->f_5[iParam0 /*11*/])->f_6, 0);
...
void func_131(int iParam0)
{
	...
	if (func_89((Global_1915170->f_3[iParam0 /*447*/])->f_21) && func_180((Global_1915170->f_3[iParam0 /*447*/])->f_21))
	{
		func_181((Global_1915170->f_3[iParam0 /*447*/])->f_21, 0, 1, 0, 0);
	}
	...
	func_182((Global_1915170->f_3[iParam0 /*447*/])->f_9, 0);
	...
	else
	{
		...
		while (iVar0 < iVar1)
		{
			func_157(&((Global_1915170->f_3[iParam0 /*447*/])->f_318[iVar0 /*6*/]));
...
int func_133(int iParam0, bool bParam1)
{
	...
	func_187(iParam0);
	_NAMESPACE48::_0xFC77C5B44D5FF7C0(func_140(iParam0));
	func_139(iParam0, 0);
	return 1;
}
...
bool func_143(struct<2> Param0)
{
	return func_189(Param0, 5, 8);
}
...
{
	if (func_191(&(Global_1099293->f_4), iParam0, 5))
	{
		return 1;
	}
	return 0;
...
void func_147(int iParam0, bool bParam1, int iParam2, int iParam3)
{
	...
	else if (!func_194(128) && !func_195(18))
	{
		CAM::DO_SCREEN_FADE_OUT(iParam2);
	}
	if (iParam3 && func_196() == 4)
	{
		func_146(17);
	}
	func_197(1024);
...
{
	if (func_198(&(Global_1099293->f_4), iParam0, 5))
	{
		return 1;
	}
	return 0;
...
void func_151(struct<29> Param0, var uParam29, int iParam30)
{
	switch (Param0.f_5)
	{
		case 1:
...
void func_152(struct<6> Param0, var uParam6, var uParam7, var uParam8, int iParam9)
{
	switch (Param0.f_5)
	{
		case 1:
...
{
	return func_201((Global_1051387->f_69[iParam0 /*76*/])->f_51, iParam1);
}
...
int func_165(int iParam0, char* sParam1, var uParam2, char* sParam3, float fParam4, char* sParam5, var uParam6)
{
	struct<4> Var0;

	Var0 = func_204();
	Var0.f_2 = -738708473;
	Var0.f_3 = func_202(iParam0);
...
var func_166(int iParam0, vector3 vParam1, float fParam4, int iParam5, int iParam6, int iParam7)
{
...
char* func_170(var uParam0, var uParam1, var uParam2, var uParam3, var uParam4, var uParam5, var uParam6, var uParam7)
{
...
{
	func_212(&((Global_1938932->f_5[iParam0 /*11*/])->f_7), iParam1);
}
...
void func_181(int iParam0, bool bParam1, int iParam2, bool bParam3, bool bParam4)
{
	...
	if ((!bParam4 && !func_180(iParam0)) && func_213(iParam0))
	{
		return;
	}
	func_141(iParam0, 1);
...
bool func_189(struct<2> Param0, int iParam2, int iParam3)
{
	int iVar0;
...
int func_190(int iParam0, int iParam1)
{
	...
	if (iParam1 == 255)
	{
		return func_222(&(Global_1099293->f_4), iVar0, 5);
	}
	if (iParam1 == func_223())
	{
		return func_222(&(Global_1099293->f_4), iVar0, 5);
	...
	{
		return func_222(&(((*Global_1097609)[iParam1 /*51*/])->f_4), iVar0, 5);
	}
	return 0;
}
...
int func_203(int iParam0, var uParam1, var uParam2)
{
	...
	if (func_226(iParam0, uParam1, &iVar0))
	{
		func_227(&iVar0, iParam0, uParam2);
	}
	else
	{
		return 0;
...
int func_205()
{
	...
	if (!func_207(*Global_1051163) && Global_1572887->f_7 & 1 != 0)
	{
		return 1;
	}
	return 0;
...
int func_209(vector3 vParam0, int iParam3)
{
	vector3 vVar0;
	struct<2> Var3;
	float fVar6;

	func_230(iParam3, &vVar0, &Var3, &fVar6);
	if (func_231(vParam0, vVar0, Var3, Var3.f_1, fVar6))
	{
		return 1;
	}
	return 0;
...
bool func_226(int iParam0, var uParam1, int iParam2)
{
	*iParam2 = Global_1131373->f_7;
	iParam2->f_2 = 1351168281;
	iParam2->f_3 = func_235(iParam0);
	iParam2->f_4 = uParam1;
...
bool func_231(vector3 vParam0, vector3 vParam3, float fParam6, float fParam7, float fParam8)
{
	vector3 vVar0;
	struct<2> Var3;
	float fVar6;
...
int func_236(struct<2> Param0, int iParam2)
{
	if (!func_207(Param0))
	{
		return 0;
