...
void func_18(var uParam0)
{
	...
	if (ENTITY::DOES_ENTITY_EXIST(iVar0) && !PED::IS_PED_INJURED(iVar0))
	{
		if (PED::IS_PED_FLEEING(iVar0) && !PED::_0xB086C8C0F5701D14(iVar0))
		{
			...
			aggregate.aberdeenpigfarm.func_168(uParam0->f_4, 1048576);
			aggregate.benedictpoint.func_129(uParam0->f_3, 16777216);
		}
		else if (TASK::GET_IS_TASK_ACTIVE(iVar0, 7))
		{
			if (aggregate.aberdeenpigfarm.func_167(uParam0->f_4, 1048576))
			{
				aggregate.aberdeenpigfarm.func_169(uParam0->f_4, 1048576);
			}
			if (aggregate.fme_animal_tagging.func_913(uParam0->f_3, 16777216))
			{
				aggregate.aberdeenpigfarm.func_139(uParam0->f_3, 16777216);
			}
		}
...
{
	aggregate.shop_camp_lockbox.func_332(uParam0, 10);
	aggregate.shop_bait.func_334(uParam0, 10, 61685);
	aggregate.shop_camp_butchertable.func_338(uParam0, 10, 61804);
	aggregate.shop_camp_lockbox.func_332(uParam0, 15);
	func_342(uParam0, 15, 61968);
	aggregate.shop_bait.func_334(uParam0, 15, 62121);
	aggregate.shop_camp_butchertable.func_338(uParam0, 15, 62203);
	func_345(uParam0, 12);
	aggregate.shop_bait.func_334(uParam0, 12, 62399);
	aggregate.shop_bait.func_749(uParam0, 11, 62411, 62473, 62514, 62528);
	aggregate.shop_bait.func_334(uParam0, 11, 62655);
}
...
int func_237(int iParam0)
{
	...
	vVar0 = { vVar0 + aggregate.ambient_fishing_scenario.func_26(Global_36 - vVar0) * Vector(2f, 2f, 2f) };
...
bool func_320(var uParam0, int iParam1, int iParam2, vector3 vParam3, vector3 vParam6, int iParam9, int iParam10, int iParam11)
{
	...
	{
		if (!func_742(&(uParam0->f_4), iParam1, iParam2, aggregate.shop_bait.func_725(iParam2), uParam0->f_1767, 0))
		{
		}
	}
	...
	aggregate.camera_item.func_77(&(uParam0->f_4), 137976);
	aggregate.camera_item.func_77(&(uParam0->f_4), 138013);
	aggregate.shop_bait.func_733(&(uParam0->f_4), 138041);
	aggregate.shop_bait.func_733(&(uParam0->f_4), 138576);
...
int func_337(var uParam0)
{
	...
	if (Local_25.f_8 > 0 && aggregate.fme_animal_tagging.func_1400(Local_25.f_8))
	{
		return 1;
	}
	return 0;
...
int func_339(var uParam0, int iParam1)
{
	...
	Var2 = { aggregate.fme_animal_tagging.func_783() };
	...
	iVar9 = aggregate.binoculars.func_24("SHOP_POSTOFFICE_PAY_BOUNTY", iParam1, 4, 570, 4000, 10, 1073741824 /* Float: 2f */, 0, 1065353216 /* Float: 1f */, 0, 3, joaat("SHORT_TIMED_EVENT"), 0);
	if (Local_25.f_8 > 0)
	{
		aggregate.fm_mission_controller.func_7013(iVar9, "SHOP_POSTOFFICE_PAY_BOUNTY_MP", Local_25.f_8, 1);
	}
	return iVar9;
}
...
int func_341(var uParam0)
{
	...
	else if (!aggregate.fme_animal_tagging.func_1569(-1458756770, &(Local_25.f_15)) && !aggregate.fme_animal_tagging.func_1570(-1458756770, &(Local_25.f_15)))
	{
		return 0;
	}
	Local_25.f_9 = aggregate.mp_intro.func_2428(-1458756770, Local_25.f_15, 1, 0, 1, 0);
	return 1;
}
...
int func_342(var uParam0, int iParam1, int iParam2)
{
	...
	aggregate.shop_bait.func_42(uParam0, iParam1, 256);
	return 1;
}
...
int func_343(var uParam0)
{
	...
	if (aggregate.fm_mission_controller.func_6230(Local_25.f_15) || (aggregate.mp_intro.func_2033(Local_25.f_15) && aggregate.fme_animal_tagging.func_1400(Local_25.f_9)))
	{
		return 1;
	}
	return 0;
...
int func_344(var uParam0, int iParam1)
{
	...
	iVar0 = aggregate.binoculars.func_24("SHOP_POSTOFFICE_PAY_BOUNTY_MP_REWARD", iParam1, 4, 570, 4000, 10, 1073741824 /* Float: 2f */, 0, 1065353216 /* Float: 1f */, 0, 3, joaat("SHORT_TIMED_EVENT"), 0);
	if (aggregate.mp_intro.func_2033(Local_25.f_15))
	{
		aggregate.fm_mission_controller.func_7013(iVar0, "SHOP_POSTOFFICE_PAY_BOUNTY_MP_OFFER", Local_25.f_9, 1);
	}
	else
	{
		aggregate.fm_mission_controller.func_7013(iVar0, "SHOP_POSTOFFICE_PAY_BOUNTY_MP_REWARD", Local_25.f_9, 1);
	}
	return iVar0;
}
...
int func_345(var uParam0, int iParam1)
{
	...
	{
		return aggregate.shop_bait.func_749(uParam0, iParam1, 139845, 139876, 139963, 141561);
	}
	else
	{
		iVar0 = 0;
		...
		return aggregate.shop_bait.func_749(uParam0, iParam1, 141771, 141823, 129155, 31127);
	}
	return 0;
}
...
bool func_347(var uParam0)
{
	...
	{
		if (!aggregate.doc_book.func_337(5, &(Global_1904602->f_3)))
		{
		}
	...
	return aggregate.shop_bait.func_751(uParam0);
}

bool func_348(var uParam0)
{
	if (aggregate.aberdeenpigfarm.func_45() == -1 && !TXD::HAS_STREAMED_TEXTURE_DICT_LOADED("toast_log_blips"))
	{
		return false;
	}
...
int func_352(var uParam0)
{
	...
	Var0 = { aggregate.bandana.func_59(-1268909760, aggregate.bandana.func_57(1), 359221401, 1) };
	if (func_779(&Var0, 1) > 0)
	{
		return 1;
	}
	Var4 = { aggregate.binoculars.func_85(0, 1045621973, -1591664384, -1591664384, 0, 0, 0) };
	if (aggregate.long_update.func_592(&Var4, 1) > 0)
	{
		return 1;
	}
	if (aggregate.mp_intro.func_2549())
	{
		if (aggregate.binoculars.func_32(-858931429, 1))
		{
			aggregate.interactive_campfire.func_76(-858931429, 1, 1, -142743235);
		}
		return 1;
	}
	return 0;
...
{
	if (!aggregate.fme_animal_tagging.func_916(*uParam0))
	{
		return 1;
	}
...
{
	if (aggregate.aberdeenpigfarm.func_45() == 0 || !aggregate.barcustomer_interaction.func_12(uParam0->f_4, 0))
	{
		return 0;
	}
	if (!func_793(uParam0))
...
bool func_402(var uParam0, int iParam1)
{
	...
	Local_25.f_10 = 1;
	aggregate.net_fetch.func_3067(8);
	return true;
}
...
void func_712(var uParam0)
{
	...
	if (!MISC::IS_BIT_SET(uParam0->f_2371.f_9, 1))
	{
		...
		{
			aggregate.mp_intro.func_1329(uParam0, 197528);
			aggregate.mp_intro.func_1329(uParam0, 198448);
			aggregate.mp_intro.func_1329(uParam0, 199048);
			aggregate.mp_intro.func_1329(uParam0, 199342);
			aggregate.mp_intro.func_1329(uParam0, 199545);
...
{
	return INVENTORY::_0xE843D21A8E2498AA(aggregate.bandana.func_72(bParam1), uParam0);
}
...
bool func_792(var uParam0)
{
	...
	{
		case 0:
			if (!aggregate.saloon_dining.func_297(uParam0->f_4) && func_793(uParam0))
			{
			...
			break;
		case 5:
			aggregate.saloon_dining.func_463(uParam0, 0);
...
bool func_793(var uParam0)
{
	...
	iVar4 = aggregate.annesburg.func_114(aggregate.annesburg.func_122(), 2);
	vVar5 = { aggregate.benedictpoint.func_118(iVar4) };
	iVar8 = aggregate.annesburg.func_114(aggregate.annesburg.func_122(), 1);
	vVar9 = { aggregate.benedictpoint.func_118(iVar8) };
	fVar0 = aggregate.fishing_core.func_39(Global_35, vVar5, 1);
	fVar1 = aggregate.fishing_core.func_39(Global_35, vVar9, 1);
	fVar2 = aggregate.fishing_core.func_39(uParam0->f_4, vVar5, 1);
	fVar3 = aggregate.fishing_core.func_39(uParam0->f_4, vVar9, 1);
	if (fVar0 < fVar1)
	{
		if (fVar2 < fVar3)
		{
...
bool func_795()
{
	...
	while (bVar0 < 6)
	{
		...
		{
			iVar1 = (iVar1 + aggregate.aberdeenpigfarm.func_94(bVar0));
			if (iVar1 > 10000)
			{
				return true;
			}
...
void func_1648(var uParam0, bool bParam1, bool bParam2)
{
	...
	if (!aggregate.doc_book.func_158(bParam1))
	{
		return;
	}
	Var0.f_1 = 20;
	...
	{
		fVar34 = 100f;
		Var35 = { aggregate.aberdeenpigfarm.func_107(-664570214, WEAPON::_0x8EC44AE8DECFF841(bParam1)) };
		...
		iVar42 = 0;
		iVar43 = 0;
		Var44 = { aggregate.bandana.func_41(bParam1, 0, 0) };
		Var44.f_4 = aggregate.mp_intro.func_1426(uParam0);
		Var49 = { aggregate.bandana.func_59(bParam1, Var44, Var44.f_4, 0) };
		iVar53 = aggregate.net_camp.func_2216(bParam1);
		bVar58 = true;
		bVar54 = false;
		while (bVar54 < iVar53)
		{
			bVar55 = aggregate.mp_freemode_tutorial.func_585(bParam1, bVar54);
			if (bVar55 != 0)
			{
				bVar56 = aggregate.bandana.func_81(Var49, bVar55, 0, -1);
				bVar58 = true;
				if (aggregate.bandana.func_30(bParam2, 0))
				{
					if (aggregate.interactive_campfire.func_668(bParam2, bVar55) || aggregate.bandana.func_11(bParam2, 1844906744))
					{
						if (aggregate.bandana.func_11(bParam2, 1844906744))
						{
							if (aggregate.mp_intro.func_2486(uParam0, aggregate.mp_intro.func_1395(uParam0), aggregate.net_camp.func_1061(uParam0), &bVar57))
							{
								if (aggregate.interactive_campfire.func_668(bVar57, bVar55))
								{
									bVar58 = false;
								}
							}
						}
						else if (!aggregate.bandana.func_30(bVar56, 0))
						{
							bVar58 = false;
						}
				...
				if (aggregate.bandana.func_30(bVar56, 0))
				{
		...
		if (aggregate.bandana.func_58(bParam2) == joaat("ammo"))
		{
			if (ITEMDATABASE::_ITEM_DATABASE_FILLOUT_ITEM_EFFECTS_IDS(bParam2, &Var0))
			{
				iVar37 = 0;
