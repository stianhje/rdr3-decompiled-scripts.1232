...
int func_15(bool bParam0, int iParam1, bool bParam2, bool bParam3, bool bParam4, int iParam5, float fParam6, int iParam7, int iParam8, bool bParam9)
{
	...
	if (!bVar3)
	{
		...
		else if (func_20(bParam0) == -427144552)
		{
		...
		else if (func_20(bParam0) == 307971639 && func_35(bParam0))
		{
...
{
	return func_20(bParam0) == -427144552;
}
...
int func_112(bool bParam0)
{
	...
	if (!func_176(bParam0, &uVar0, 805880880, 0, 0, -401018458))
	{
		return -1102349958;
	}
	return uVar0;
