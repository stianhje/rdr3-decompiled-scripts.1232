...
int func_12(bool bParam0, int iParam1)
{
	if (!func_4(bParam0, 0))
	{
		return func_27(func_26(bParam0), iParam1);
	}
	if (iParam1 == 0)
	{
		return 0;
...
void func_24(bool bParam0, bool bParam1, bool bParam2, int iParam3)
{
	...
	switch (bParam0)
	{
		...
		case 1448771675: /* GXTEntry: "Hay" */
			func_48(func_51(1368284188, -2049431929 /* GXTEntry: "Feed Bag" */), 1);
			break;
	}
	switch (bParam0)
	{
		...
		case 688258043: /* GXTEntry: "Kentucky Bourbon" */
			func_48(func_51(1368284188, 894597474 /* GXTEntry: "Whiskey" */), 1);
			break;
...
int func_45(int iParam0, float fParam1, bool bParam2, int iParam3)
{
	char* sVar0;
	int iVar1;
...
void func_52(bool bParam0, int iParam1)
{
	...
	if (func_8() == 0)
	{
		...
		if ((func_12(bParam0, 1765172170) || 1443104131 == iVar0) || -1919515848 == iVar0)
		{
		...
		if (((func_12(bParam0, -887064662) || func_12(bParam0, -839724752)) || func_12(bParam0, 1264218912)) || bParam0 == -1994237933)
		{
