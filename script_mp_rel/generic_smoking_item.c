...
void func_24(bool bParam0, bool bParam1, bool bParam2, int iParam3)
{
	...
	{
		func_48(func_51(joaat("used"), -939665347), 1);
	}
	...
	switch (bParam0)
	{
		...
		case 1448771675: /* GXTEntry: "Hay" */
			func_48(func_51(joaat("used"), -2049431929 /* GXTEntry: "Feed Bag" */), 1);
			break;
	}
	switch (bParam0)
	{
		case 299161628: /* GXTEntry: "Moonshine" */
			func_48(func_51(joaat("used"), 304473406), 1);
			break;
	...
	if (func_8() == -1)
	{
		...
		{
			func_48(func_51(joaat("used"), 595572217), 1);
		}
	}
	if (bParam1)
	{
