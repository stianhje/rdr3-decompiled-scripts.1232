...
{
	func_61(3, iLocal_22, iParam0, iLocal_23, iLocal_24, 4, 0, 0, -1082130432, 0);
	func_62(3, 1595373759, 0, 0);
	func_62(3, 1854467923, 0, 0);
	func_63(3, 8192);
	func_64(3, 0);
	func_61(25, iLocal_26, iParam0, 0, 0, 2, 0, 0, -1082130432, 0);
	func_63(25, 1);
	func_63(25, 16384);
	func_63(25, 8192);
	func_63(25, 536870912);
	func_61(10, iLocal_32, iParam0, iLocal_33, 0, 460, 0, 0, -1082130432, 0);
	func_63(10, 536870912);
	func_64(10, 0);
	func_61(9, iLocal_35, iParam0, 0, 0, 2, 1, 0, -1082130432, 0);
	func_63(9, 536870912);
	func_63(9, 16384);
	func_63(9, 32768);
	func_63(9, 1);
	...
	func_61(2, iLocal_31, iParam0, iLocal_29, iLocal_30, 1277952, 0, 0, -1082130432, 0);
	func_64(2, 0);
	func_67(iParam0);
...
void func_41(var uParam0, int iParam1)
{
	...
	if ((BUILTIN::VDIST(Global_36, 0f, 0f, 0f) <= 5f || func_78(&Global_1939168, 32768)) || func_78(&Global_1939168, 16777216))
	{
		return;
	}
...
bool func_80()
{
	return func_78(&Global_1939168, 8192);
}
...
void func_85(int iParam0, int iParam1, int iParam2, bool bParam3, int iParam4, int iParam5)
{
	...
	sVar1 = func_143(iParam0, iParam1, iParam2, iParam4, iParam5, bParam3, &uVar0);
	...
	else
	{
		...
		if (!MISC::_SHOULD_USE_24_HOUR_CLOCK())
		{
			...
			sVar2 = MISC::_CREATE_VAR_STRING(674, sVar8, iVar4, func_155(&sVar6, 109029619), sVar9, func_155(&sVar10, 109029619));
		}
		else
		{
			...
			IntToString(&sVar10, BUILTIN::ROUND(fVar7), 8);
			sVar2 = MISC::_CREATE_VAR_STRING(162, sVar8, iVar4, func_155(&sVar6, 109029619), func_155(&sVar10, 109029619));
		}
		Global_1893575->f_9 = 0;
	}
	Global_1938075->f_145 = func_156(sVar1, sVar2, 4000, 0, 0, 0, 0, 1);
}
...
int func_102(int iParam0, var uParam1, var uParam2, bool bParam3, bool bParam4)
{
	bool bVar0;
...
void func_109(int iParam0)
{
	...
	else
	{
		...
		while (iVar2 < iVar3)
		{
			func_186(&((Global_1051387->f_69[iParam0 /*76*/])->f_32[iVar2]));
	...
	if (VOLUME::_0x92A78D0BEDB332A3((Global_1051387->f_69[iParam0 /*76*/])->f_25) && func_189(iParam0, 2))
	{
...
int func_111(int iParam0)
{
	...
	{
		Global_1051387->f_4360[iParam0] = func_193(iParam0);
	}
...
bool func_123(int iParam0, var uParam1, float fParam2, var uParam3)
{
	return func_195(iParam0, "sHash", uParam1, "fHeading", fParam2, "vPos", uParam3);
}
...
void func_125(int iParam0, int iParam1, vector3 vParam2, float fParam5, bool bParam6)
{
	...
	(Global_1051387->f_69[iParam0 /*76*/])->f_6 = func_196(iParam1, vParam2, fParam5, 0, 0, 0);
...
int func_127(int iParam0)
{
	...
	vVar2 = { 0f, 0f, 0f };
	if (!func_123(iParam0, &iVar0, &fVar1, &vVar2) || func_121(vVar2))
	{
		return 0;
	}
	iVar6 = 4;
	...
	(Global_1051387->f_4319[iVar6 /*7*/])->f_6 = func_196(iVar0, vVar2, fVar1, 0, 0, 0);
...
bool func_128(int iParam0, int iParam1)
{
	...
	if (iParam1 && !ENTITY::DOES_ENTITY_EXIST(func_199(iParam0)))
	{
		return false;
	}
...
void func_134(int iParam0)
{
	...
	{
		if (func_203(Global_35, (Global_1915170->f_3[3 /*447*/])->f_10, 1) > 80f)
		{
			return;
		}
	}
	...
	{
		if (func_203(Global_35, (Global_1915170->f_3[0 /*447*/])->f_10, 1) > 100f)
		{
			return;
		}
	}
...
void func_136(int iParam0, float fParam1, int iParam2, int iParam3)
{
	if (func_117(iParam0))
	{
...
char* func_143(int iParam0, int iParam1, int iParam2, int iParam3, var uParam4, var uParam5, var uParam6)
{
	char* sVar0;
	...
	{
		sVar0 = func_209(func_208(Global_36));
	}
...
{
	func_214((Global_1938932->f_5[iParam0 /*11*/])->f_6, 1);
	func_215((Global_1938932->f_5[iParam0 /*11*/])->f_6, 0);
...
void func_162(int iParam0)
{
	...
	if (func_103((Global_1915170->f_3[iParam0 /*447*/])->f_21) && func_217((Global_1915170->f_3[iParam0 /*447*/])->f_21))
	{
		func_218((Global_1915170->f_3[iParam0 /*447*/])->f_21, 0, 1, 0, 0);
	}
	...
	func_219((Global_1915170->f_3[iParam0 /*447*/])->f_9, 0);
	...
	else
	{
		...
		while (iVar0 < iVar1)
		{
			func_186(&((Global_1915170->f_3[iParam0 /*447*/])->f_318[iVar0 /*6*/]));
...
{
	if (func_234(&(Global_1099293->f_4), iParam0, 5))
	{
		return 1;
	}
	return 0;
...
{
	return func_236((Global_1051387->f_69[iParam0 /*76*/])->f_51, iParam1);
}
...
int func_193(int iParam0)
{
	...
	if (DATAFILE::_0x603AC35FD4602C76(Global_1131373->f_7) && !func_238(12, func_237(iParam0), &vVar0))
	{
		return 0;
	}
	return vVar0.z;
...
var func_196(int iParam0, vector3 vParam1, float fParam4, int iParam5, int iParam6, int iParam7)
{
...
{
	func_248(&((Global_1938932->f_5[iParam0 /*11*/])->f_7), iParam1);
}
...
void func_218(int iParam0, bool bParam1, int iParam2, bool bParam3, bool bParam4)
{
	int iVar0;
	int iVar1;
...
int func_226(int iParam0, int iParam1)
{
	...
	if (iParam1 == 255)
	{
		return func_256(&(Global_1099293->f_4), iVar0, 5);
	}
	if (iParam1 == func_257())
	{
		return func_256(&(Global_1099293->f_4), iVar0, 5);
	...
	{
		return func_256(&(((*Global_1097609)[iParam1 /*51*/])->f_4), iVar0, 5);
	}
	return 0;
}
...
int func_238(int iParam0, var uParam1, var uParam2)
{
	...
	if (func_259(iParam0, uParam1, &iVar0))
	{
		func_260(&iVar0, iParam0, uParam2);
	}
	else
	{
		return 0;
...
int func_245(vector3 vParam0, int iParam3)
{
	...
	func_264(iParam3, &vVar0, &Var3, &fVar6);
	if (func_265(vParam0, vVar0, Var3, Var3.f_1, fVar6))
	{
		return 1;
	}
	return 0;
