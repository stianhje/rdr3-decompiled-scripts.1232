...
{
	func_59(3, iLocal_22, iParam0, iLocal_23, iLocal_24, 4, 0, 0, -1082130432 /* Float: -1f */, 0);
	func_60(3, 8192);
	func_61(3, 0);
	func_59(2, iLocal_26, iParam0, iLocal_27, 0, 1277952, 0, 0, -1082130432 /* Float: -1f */, 0);
	func_61(2, 0);
	func_59(35, iLocal_28, iParam0, iLocal_29, 0, 4, 0, 0, -1082130432 /* Float: -1f */, 0);
	func_61(35, 0);
	func_62();
	func_63(110);
}
...
void func_78(int iParam0, int iParam1, int iParam2, bool bParam3, int iParam4, bool bParam5)
{
	bool bVar0;
	char* sVar1;
	char* sVar2;
...
void func_80(int iParam0, bool bParam1)
{
	...
	func_132(func_151(-1532769513, joaat("areas")), 1);
...
bool func_116(int iParam0, var uParam1, var uParam2, var uParam3)
{
...
var func_124(var uParam0, vector3 vParam1, int iParam4, int iParam5, int iParam6, int iParam7)
{
...
void func_129(int iParam0, bool bParam1, float fParam2, bool bParam3, bool bParam4, float fParam5, int iParam6, bool bParam7)
{
	...
	if (func_185(iParam0))
	{
		...
		if (bParam3)
		{
			func_186(iParam0, fParam2, 1, iParam6);
		}
		else if (bParam1)
		{
			if (bParam4)
...
void func_203(int iParam0, bool bParam1, bool bParam2, bool bParam3, bool bParam4)
{
	int iVar0;
	int iVar1;
...
int func_231(vector3 vParam0, int iParam3)
{
	...
	func_250(iParam3, &vVar0, &Var3, &uVar6);
	if (func_251(vParam0, vVar0, Var3, Var3.f_1, uVar6))
	{
		return 1;
	}
	return 0;
