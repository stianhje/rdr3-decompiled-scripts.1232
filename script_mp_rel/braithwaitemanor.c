		...
		if (MISC::GET_GAME_TIMER() > iLocal_61)
		{
			...
			switch (iLocal_60)
			{
				...
				case 2:
					...
					LAW::_0x9BBDCB8DF789EBC1(PLAYER::PLAYER_ID(), func_12(iLocal_62));
					Global_1896608 = -1;
	...
	if (iLocal_19 != -1)
	{
		if (func_65(473295046) && !func_66(44))
		{
			if (func_67(Global_35, iLocal_18, 0, 0))
			{
				...
				{
					AUDIO::_0xDCF5BA95BBF0FABA(iLocal_19, "MAIN_LOOP", 1011.224f, -1766.506f, 46.5833f, "FIRE_SMOLDER_LARGE_SOUNDSET", 0, 0, 0);
				}
			}
...
void func_75(int iParam0, int iParam1, int iParam2, bool bParam3, int iParam4, int iParam5)
{
	...
	sVar1 = func_114(iParam0, iParam1, iParam2, iParam4, iParam5, bParam3, &uVar0);
	...
	else
	{
		...
		if (!MISC::_SHOULD_USE_24_HOUR_CLOCK())
		{
			...
			sVar2 = MISC::_CREATE_VAR_STRING(674, sVar8, iVar4, func_126(&sVar6, 109029619), sVar9, func_126(&sVar10, 109029619));
		}
		else
		{
			...
			IntToString(&sVar10, BUILTIN::ROUND(fVar7), 8);
			sVar2 = MISC::_CREATE_VAR_STRING(162, sVar8, iVar4, func_126(&sVar6, 109029619), func_126(&sVar10, 109029619));
		}
...
void func_77(int iParam0, bool bParam1)
{
	...
	func_131(func_130(-1532769513, -36357794), 1);
...
int func_93(int iParam0, var uParam1, var uParam2, bool bParam3, bool bParam4)
{
	bool bVar0;
...
void func_102(int iParam0, float fParam1, int iParam2, int iParam3)
{
	if (func_101(iParam0))
	{
...
char* func_114(int iParam0, int iParam1, int iParam2, int iParam3, var uParam4, var uParam5, var uParam6)
{
	char* sVar0;
...
void func_140(int iParam0)
{
	...
	if (VOLUME::_0x92A78D0BEDB332A3((Global_1051387->f_69[iParam0 /*76*/])->f_25) && func_179(iParam0, 2))
	{
