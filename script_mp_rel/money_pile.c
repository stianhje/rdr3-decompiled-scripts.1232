...
void func_6()
{
	...
	if (ENTITY::HAS_ANIM_EVENT_FIRED(Global_35, -1898385492) && !iLocal_18)
	{
		fVar0 = 1f;
		fVar1 = 1f;
		bVar2 = false;
...
int func_20(int iParam0, var uParam1, bool bParam2)
{
	if (func_22())
	{
		bParam2 = true;
...
void func_23(int iParam0, char* sParam1, var uParam2, bool bParam3)
{
	if (iParam0 == 0)
	{
		return;
	...
	func_29(MISC::_CREATE_VAR_STRING(2, sParam1, iParam0), "ITEMTYPE_TEXTURES", 1831944558, 0, 109029619, 0, 0, 0, 1);
}
...
void func_24(int iParam0, bool bParam1, float fParam2, int iParam3)
{
	...
	if (bParam1)
	{
		...
		iVar1 = (iVar1 + iVar2);
		func_29(MISC::_CREATE_VAR_STRING(2, "FEED_GANG_TOTAL_EARN", iParam0), "ITEMTYPE_TEXTURES", -1957849484, 0, 109029619, 0, 0, 0, 1);
		iParam0 = (iParam0 - iVar0);
		if (iVar0 > 0)
		{
		}
		func_29(MISC::_CREATE_VAR_STRING(2, "FEED_GANG_PLAYER_EARN", iVar1), "ITEMTYPE_TEXTURES", 1831944558, 0, 109029619, 0, 0, 0, 1);
	}
	else
	{
		iVar1 = iParam0;
...
struct<5> func_37(int iParam0, bool bParam1, int iParam2)
{
	struct<5> Var0;
	int iVar5;
	struct<10> Var6;
...
struct<4> func_38(int iParam0, var uParam1, var uParam2, var uParam3, var uParam4, int iParam5, bool bParam6)
{
	struct<4> Var0;
...
int func_42(int iParam0, var uParam1, int iParam2, bool bParam3, bool bParam4, int iParam5, int iParam6)
{
	struct<4> Var0;
	struct<10> Var4;
	int iVar26;
...
struct<4> func_43(bool bParam0)
{
	...
	if (Global_1572887->f_13 == 0)
	{
		...
		if (iVar0 == 2)
		{
			...
			{
				*Global_1270479 = { func_38(1328661203, func_59(), -1591664384, bParam0) };
			}
		...
		else if (iVar0 == 3)
		{
			...
			{
				Global_1270479->f_12 = { func_38(1328661203, func_59(), -1591664384, 0) };
			}
...
bool func_52(var uParam0, var uParam1, var uParam2, var uParam3, var uParam4, bool bParam5, bool bParam6, int iParam7)
{
	return func_63(&uParam0, uParam4, bParam5, bParam6, iParam7);
}
...
int func_63(var uParam0, var uParam1, bool bParam2, bool bParam3, int iParam4)
{
...
int func_66(var uParam0, var uParam1, var uParam2, var uParam3, int iParam4, bool bParam5, int iParam6)
{
...
int func_69(var uParam0, var uParam1, bool bParam2, int iParam3)
{
	struct<10> Var0;

	Var0.f_9 = -1591664384;
	if (func_71(uParam0, uParam1, &Var0, bParam2, iParam3))
	{
		return Var0.f_4;
	}
	return 0;
...
int func_71(var uParam0, var uParam1, var uParam2, bool bParam3, int iParam4)
{
	var uVar0;
	...
	if (!func_63(&uVar0, uParam2, bParam3, 0, iParam4))
	{
		return 0;
	}
	return 1;
