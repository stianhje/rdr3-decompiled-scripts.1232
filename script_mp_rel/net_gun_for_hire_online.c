#region Local Var
	...
	var uLocal_782 = 0;
	var uLocal_783 = 0;
	var uLocal_784 = 493038497;
	var uLocal_785 = 493038497;
	var uLocal_786 = -1;
	var uLocal_787 = -1;
	var uLocal_788 = -1;
	var uLocal_789 = -1;
...
void __EntryFunction__()
{
	...
	func_2(&uLocal_21, &Local_224, &uLocal_673, &uScriptParam_0);
	while (func_3(&uLocal_21, &uLocal_673, &uScriptParam_0))
	{
		func_4(&uLocal_21, &Local_224, &uLocal_673, &uScriptParam_0);
		BUILTIN::WAIT(0);
	}
	func_5(&Local_224, &uLocal_673, &uScriptParam_0);
	func_6();
}
...
void func_1(var uParam0)
{
	...
	func_8();
	NETWORK::NETWORK_REGISTER_HOST_BROADCAST_VARIABLES(&uLocal_21, 203, 45);
	func_9(NETWORK::_0xBA24095EA96DFE17(&uLocal_21), 203, "m_hostData");
	NETWORK::NETWORK_REGISTER_PLAYER_BROADCAST_VARIABLES(&Local_224, 449, 46);
	func_10(NETWORK::_0x690806BC83BC8CA2(Local_224[0 /*14*/]), 449, "m_clientData");
	func_11(0);
...
void func_2(var uParam0, var uParam1, var uParam2, var uParam3)
{
	...
	if (NETWORK::NETWORK_IS_HOST_OF_THIS_SCRIPT() && !func_13(&(uParam0->f_3), 2))
	{
		if (Global_1103536->f_16)
		{
...
int func_3(var uParam0, var uParam1, var uParam2)
{
	struct<2> Var0;
...
{
	((*uParam0)[iParam2 /*14*/])->f_5 = { func_52(uParam1->f_2) };
}

void func_16(var uParam0)
{
	uParam0->f_7 = PLAYER::PLAYER_ID();
...
int func_20(bool bParam0, bool bParam1)
{
	int iVar0;
...
int func_29(struct<2> Param0, int iParam2, int iParam3)
{
	...
	if (func_25(*Global_1051163) && !func_62(*Global_1051163, Param0))
	{
...
int func_30()
{
	if (!func_66(Global_1572887->f_248.f_63, 8))
	{
		return 2;
	}
...
{
	return (((*Global_1113330)[iParam0 /*1991*/])->f_21 && iParam1) != 0;
}
...
void func_35(var uParam0, var uParam1, var uParam2, var uParam3)
{
	...
	Var0.f_27 = -1;
	Var0.f_27.f_1 = -1;
	Var0 = NETWORK::PARTICIPANT_ID_TO_INT();
	Var0.f_1 = func_67(uParam2->f_7, uParam2->f_7.f_31.f_1);
	Var0.f_7 = (uParam2->f_7.f_31.f_7 + 1 % 32);
	Var0.f_6 = PLAYER::INT_TO_PLAYERINDEX(Var0.f_7);
	Var0.f_9 = PLAYER::GET_PLAYER_PED(uParam2->f_7);
	Var0.f_10 = { ENTITY::GET_ENTITY_COORDS(Var0.f_9, false, false) };
	Var0.f_13 = _NAMESPACE26::_0x901E0DC25080C8B9(uParam2->f_7);
	Var0.f_5 = func_68(*uParam3);
	Var0.f_15 = { func_69(uParam1, Var0.f_13) };
	Var0.f_21 = MISC::GET_GAME_TIMER();
	Var0.f_22 = NETWORK::GET_NETWORK_TIME_ACCURATE();
	Var0.f_23 = func_70();
	...
	else if (&uParam0->f_4[Var0.f_1 /*6*/] == -1)
	{
		func_72(&(Var0.f_2), 2048);
	}
	else
	{
		Var0.f_27 = { func_73(*uParam3, &(uParam0->f_4[Var0.f_1 /*6*/])) };
	}
	Var0.f_25 = { func_74() };
	if (Var0.f_1 == -1)
	{
	...
	{
		func_47(*uParam3, &(uParam0->f_4[Var0.f_1 /*6*/]));
	}
	iVar29 = _NAMESPACE26::_0x4BE6C13A45CCA8EC(Var0.f_13);
	if (NETWORK::_0x255A5EF65EDA9167(iVar29))
	{
		if (NETWORK::NETWORK_IS_PLAYER_ACTIVE(iVar29))
		{
			if (iVar29 == PLAYER::PLAYER_ID())
			{
				if (func_75(*uParam3) != ((*uParam1)[Var0 /*14*/])->f_3)
				{
					((*uParam1)[NETWORK::PARTICIPANT_ID_TO_INT() /*14*/])->f_3 = func_75(*uParam3);
				}
			}
			else if (NETWORK::NETWORK_IS_PLAYER_A_PARTICIPANT(iVar29))
			{
				iVar30 = NETWORK::NETWORK_GET_PARTICIPANT_INDEX(iVar29);
				if (iVar30 < 0 || iVar30 >= 32)
				{
				}
				else
				{
					func_76(*uParam3, ((*uParam1)[iVar30 /*14*/])->f_3);
				}
			}
		}
	}
	iVar31 = func_75(*uParam3);
	if (((*uParam1)[Var0 /*14*/])->f_3 != iVar31)
	{
		((*uParam1)[Var0 /*14*/])->f_3 = iVar31;
	}
	iVar32 = func_78(func_77(uParam3->f_2));
	if (((*uParam1)[Var0 /*14*/])->f_7 != iVar32)
	{
		((*uParam1)[Var0 /*14*/])->f_7 = iVar32;
	}
	Var33 = -1;
	Var33.f_1 = -1;
	Var33.f_2 = -1;
	...
	Var33.f_26 = 2;
	Var33.f_26.f_1 = -1;
	Var33.f_26.f_1.f_1 = -1;
	Var33.f_29 = 493038497;
	Var33.f_29.f_1 = 493038497;
	func_79(&Var33);
	if (((*uParam1)[Var0 /*14*/])->f_8 != Var33.f_2.f_1)
	{
		((*uParam1)[Var0 /*14*/])->f_8 = Var33.f_2.f_1;
	}
	((*uParam1)[Var0 /*14*/])->f_9 = 1;
	if (func_80(PLAYER::PLAYER_ID(), 1, 0))
	{
		Var0.f_14 = 1;
	}
	else
...
void func_37(var uParam0, var uParam1)
{
	...
	{
		WEAPON::_0x94A3C1B804D291EC(uParam0->f_7.f_2.f_9, 0, 0, 1, 0);
	}
}
...
void func_41(var uParam0, var uParam1)
{
	...
	{
		MISC::_0xE98D55C5983F2509(func_93(*uParam1, uParam0->f_99.f_12));
...
{
	((*Global_1113330)[iParam0 /*1991*/])->f_7 = iParam1;
}

void func_48(int iParam0, bool bParam1)
{
	((*Global_1113330)[iParam0 /*1991*/])->f_8 = bParam1;
}

void func_49(var uParam0, var uParam1, int iParam2)
{
	func_105(uParam1->f_2, ((*uParam0)[iParam2 /*14*/])->f_5);
}
...
int func_57(struct<2> Param0, int iParam2)
{
	if (!func_25(Param0))
	{
		return 0;
...
int func_58(var uParam0)
{
	...
	if (!DATAFILE::_0x603AC35FD4602C76(func_110()))
	{
		return 0;
	}
	*uParam0 = func_110();
...
int func_65()
{
	...
	if (!func_25(*Global_1051163) && Global_1572887->f_7 & 1 != 0)
	{
		return 1;
	}
	return 0;
...
{
	return ((*Global_1113330)[iParam0 /*1991*/])->f_19;
}
...
struct<6> func_69(var uParam0, int iParam1)
{
	...
	iVar56 = _NAMESPACE26::_0xD1BF325C8252A982(iParam1, &Var6);
	iVar57 = 0;
	while (iVar57 <= (iVar56 - 1))
	{
		iVar59 = NETWORK::NETWORK_GET_PLAYER_FROM_GAMER_HANDLE(Var6[iVar57 /*7*/]);
		if (!NETWORK::_0x255A5EF65EDA9167(iVar59))
		{
		}
		else if (!NETWORK::NETWORK_IS_PLAYER_ACTIVE(iVar59))
		{
		}
		else if (!NETWORK::NETWORK_IS_PLAYER_A_PARTICIPANT(iVar59))
		{
		}
		else
		{
			iVar58 = NETWORK::NETWORK_GET_PARTICIPANT_INDEX(iVar59);
			if (iVar58 < 0 || iVar58 >= 32)
			{
			}
			else
			{
				Var0 = (Var0 || uParam0[iVar58 /*14*/]);
				Var0.f_1 = (Var0.f_1 || ((*uParam0)[iVar58 /*14*/])->f_1);
				Var0.f_2 = (Var0.f_2 || ((*uParam0)[iVar58 /*14*/])->f_2);
				if (iVar57 == 0)
				{
					Var0.f_3 = uParam0[iVar58 /*14*/];
					Var0.f_3.f_1 = ((*uParam0)[iVar58 /*14*/])->f_1;
					Var0.f_3.f_2 = ((*uParam0)[iVar58 /*14*/])->f_2;
				}
				else
				{
					Var0.f_3 = (Var0.f_3 && uParam0[iVar58 /*14*/]);
					Var0.f_3.f_1 = (Var0.f_3.f_1 && ((*uParam0)[iVar58 /*14*/])->f_1);
					Var0.f_3.f_2 = (Var0.f_3.f_2 && ((*uParam0)[iVar58 /*14*/])->f_2);
				}
			}
		}
		iVar57++;
...
{
	return *(((*Global_1113330)[iParam0 /*1991*/])->f_24.f_2[iParam1 /*31*/]);
}
...
{
	return ((*Global_1113330)[iParam0 /*1991*/])->f_9;
}

void func_76(int iParam0, var uParam1)
{
	((*Global_1113330)[iParam0 /*1991*/])->f_9 = uParam1;
}
...
{
	if (PLAYER::IS_PLAYER_DEAD(uParam0->f_7))
	{
...
{
	if (NETWORK::_0x255A5EF65EDA9167(uParam0->f_7.f_2.f_6))
	{
		func_72(&(uParam0->f_7.f_2.f_2), 8);
		if (NETWORK::NETWORK_IS_PLAYER_ACTIVE(uParam0->f_7.f_2.f_6))
		{
			...
			{
				if (NETWORK::NETWORK_IS_PLAYER_A_PARTICIPANT(uParam0->f_7.f_2.f_6))
				{
					func_72(&(uParam0->f_7.f_2.f_2), 32);
					uParam0->f_7.f_2.f_8 = NETWORK::NETWORK_GET_PARTICIPANT_INDEX(uParam0->f_7.f_2.f_6);
				}
				if (_NAMESPACE26::_0x81FB74C83C2ED69F(uParam0->f_7.f_2.f_6))
				{
					func_72(&(uParam0->f_7.f_2.f_2), 64);
				}
				if (PLAYER::IS_PLAYER_DEAD(uParam0->f_7.f_2.f_6))
				{
					func_72(&(uParam0->f_7.f_2.f_2), 128);
					func_118(&(uParam0->f_7.f_2.f_4), 1);
				}
	...
	if (_NAMESPACE26::_0x424B17A7DC5C90BC(uParam0->f_7))
	{
...
void func_84(var uParam0, var uParam1, var uParam2, var uParam3)
{
	...
	{
		func_119(&(((*uParam1)[uParam2->f_7.f_2 /*14*/])->f_1), 11, *uParam3);
	...
	if (func_120(&(uParam2->f_7.f_2.f_15.f_1), 1))
	{
		...
		func_121(&(((*uParam1)[uParam2->f_7.f_2 /*14*/])->f_1), 1, *uParam3);
	}
	...
	if ((uParam0->f_4[iVar0 /*6*/])->f_3 < 5 || (uParam0->f_4[iVar0 /*6*/])->f_3 > 9)
	{
		func_119(&(((*uParam1)[uParam2->f_7.f_2 /*14*/])->f_1), 11, *uParam3);
	}
	func_48(*uParam3, (uParam0->f_4[iVar0 /*6*/])->f_3 == 6);
}
...
void func_86(var uParam0, var uParam1, var uParam2, var uParam3)
{
	...
	switch ((uParam0->f_4[iVar1 /*6*/])->f_3)
	{
		case 0:
		case 1:
		case 2:
		...
		case 8:
			...
			break;
		case 9:
			if (func_120(&(((*uParam1)[iVar0 /*14*/])->f_1), 1) || func_120(&(((*uParam1)[iVar0 /*14*/])->f_1), 2))
			{
	...
	if (func_32(&(uParam2->f_3), 8))
	{
		if (bVar2)
		{
			func_119(&(((*uParam1)[iVar0 /*14*/])->f_1), 11, *uParam3);
...
void func_87(var uParam0, var uParam1, var uParam2)
{
	...
	switch ((uParam0->f_4[iVar0 /*6*/])->f_3)
	{
		case 5:
		case 7:
		case 8:
...
void func_88(var uParam0, var uParam1, var uParam2, var uParam3)
{
	...
	if (!func_25(((*uParam1)[uParam2->f_7.f_2 /*14*/])->f_5))
	{
		((*uParam1)[uParam2->f_7.f_2 /*14*/])->f_5 = { func_73(*uParam3, &(uParam0->f_4[uParam2->f_7.f_2.f_1 /*6*/])) };
		return;
	}
	if (!func_62(((*uParam1)[uParam2->f_7.f_2 /*14*/])->f_5, func_73(*uParam3, &(uParam0->f_4[uParam2->f_7.f_2.f_1 /*6*/]))))
	{
		((*uParam1)[uParam2->f_7.f_2 /*14*/])->f_5 = { func_73(*uParam3, &(uParam0->f_4[uParam2->f_7.f_2.f_1 /*6*/])) };
		return;
	}
...
{
	if ((*uParam0)[uParam1->f_7.f_2 /*14*/])->f_4 != func_128(*uParam2)
	{
		((*uParam0)[uParam1->f_7.f_2 /*14*/])->f_4 = func_128(*uParam2);
	}
}
...
{
	return Global_1113330->f_7965[iParam0 /*4*/][func_140(iParam1, 1)];
}
...
{
	((*Global_1113330)[iParam0 /*1991*/])->f_14 = iParam1;
}

void func_98(int iParam0, int iParam1)
{
	((*Global_1113330)[iParam0 /*1991*/])->f_12 = iParam1;
}

void func_99(int iParam0, int iParam1)
{
	((*Global_1113330)[iParam0 /*1991*/])->f_11 = iParam1;
}
...
void func_100(int iParam0)
{
	...
	Global_1123331->f_293 = 0;
	Global_1123331->f_293.f_1 = -1;
}
...
void func_101(var uParam0)
{
	...
	if (CAM::DOES_CAM_EXIST(uParam0->f_131.f_5))
	{
		CAM::SET_CAM_ACTIVE(uParam0->f_131.f_5, false);
		bVar0 = true;
	}
	if (CAM::DOES_CAM_EXIST(uParam0->f_131))
	{
		CAM::SET_CAM_ACTIVE(uParam0->f_131, false);
		bVar0 = true;
	}
	iVar1 = 0;
	while (iVar1 <= (3 - 1))
	{
		if (CAM::DOES_CAM_EXIST(&(uParam0->f_131.f_1[iVar1])))
		{
			CAM::SET_CAM_ACTIVE(&(uParam0->f_131.f_1[iVar1]), false);
			bVar0 = true;
		}
		iVar1++;
	}
...
void func_102(var uParam0)
{
	...
	if (CAM::DOES_CAM_EXIST(uParam0->f_131))
	{
		if (CAM::IS_CAM_RENDERING(uParam0->f_131))
		{
			bVar0 = true;
		}
		CAM::DESTROY_CAM(uParam0->f_131, false);
	}
	if (CAM::DOES_CAM_EXIST(uParam0->f_131.f_5))
	{
		if (CAM::IS_CAM_RENDERING(uParam0->f_131.f_5))
		{
			bVar0 = true;
		}
		CAM::DESTROY_CAM(uParam0->f_131.f_5, false);
	}
	iVar1 = 0;
	while (iVar1 <= (3 - 1))
	{
		if (CAM::DOES_CAM_EXIST(&(uParam0->f_131.f_1[iVar1])))
		{
			if (CAM::IS_CAM_RENDERING(&(uParam0->f_131.f_1[iVar1])))
			{
				bVar0 = true;
			}
			CAM::DESTROY_CAM(&(uParam0->f_131.f_1[iVar1]), false);
		}
		iVar1++;
	}
	if (bVar0)
...
{
	return ((*Global_1112103)[iParam0 /*35*/])->f_16;
}
...
int func_110()
{
	return (Global_1070355->f_26934[28 /*4*/])->f_3;
}
...
int func_122(var uParam0, var uParam1)
{
	...
	if (PED::IS_PED_IN_COMBAT(uParam0->f_7.f_2.f_9, 0))
	{
		return 0;
	}
	if (func_147(uParam0))
	...
	if (ENTITY::IS_ENTITY_VISIBLE(func_93(*uParam1, func_128(*uParam1))))
	{
...
{
	((*Global_1113330)[iParam0 /*1991*/])->f_21 = (((*Global_1113330)[iParam0 /*1991*/])->f_21 || iParam1);
}

void func_127(int iParam0, int iParam1)
{
	((*Global_1113330)[iParam0 /*1991*/])->f_21 = (((*Global_1113330)[iParam0 /*1991*/])->f_21 - (((*Global_1113330)[iParam0 /*1991*/])->f_21 && iParam1));
}

int func_128(int iParam0)
{
	return ((*Global_1113330)[iParam0 /*1991*/])->f_10;
}
...
int func_143()
{
	return Global_1123331->f_293.f_1;
}

void func_144(int iParam0, struct<2> Param1)
{
	((*Global_1112103)[iParam0 /*35*/])->f_16 = { Param1 };
}
...
{
	return func_202(Global_1103536->f_6063.f_3[iParam1 /*8*/], iParam0, 2);
}
...
void func_191(var uParam0, var uParam1, var uParam2, var uParam3)
{
	...
	while (iVar0 <= 31)
	{
		...
		else if (_NAMESPACE26::_0x93A91A351A07360E(iVar3))
		{
...
void func_196(var uParam0, var uParam1, var uParam2)
{
	...
	if (uParam1->f_4 == 0)
	{
		func_236((*uParam0)[uParam1->f_7.f_2 /*14*/], 4096, *uParam2);
	}
	else
	{
		func_237((*uParam0)[uParam1->f_7.f_2 /*14*/], 4096, *uParam2);
	}
}
...
{
	uParam1->f_240.f_5[4] = (&uParam1->f_240.f_5[4] + 1 % 70);
}
...
{
	return &uParam0->f_4[iParam1 /*6*/] != -1;
}
...
void func_211(var uParam0, int iParam1, var uParam2)
{
	...
	Var1.f_1 = -15;
	Var1.f_5 = 255;
	*(uParam0->f_4[iParam1 /*6*/]) = { Var1 };
}

void func_212(var uParam0, var uParam1, int iParam2)
{
	if ((uParam0->f_4[iParam2 /*6*/])->f_3 == 0)
	{
		func_273(&((uParam0->f_4[iParam2 /*6*/])->f_3), 1, *uParam1, iParam2, uParam1->f_3, uParam1->f_4);
	}
}
...
void func_213(var uParam0, var uParam1, var uParam2, var uParam3, int iParam4, int iParam5)
{
	...
	switch ((uParam0->f_4[iParam4 /*6*/])->f_3)
	{
		case 1:
	...
	if (bVar7)
	{
		func_273(&((uParam0->f_4[iParam4 /*6*/])->f_3), iVar6, *uParam3, iParam4, uParam3->f_3, uParam3->f_4);
	}
}
...
int func_216(vector3 vParam0, var uParam3, var uParam4, var uParam5, var uParam6)
{
	float fVar0;
	...
	if (!DATAFILE::_DATAFILE_GET_FLOAT(&fVar0, &vParam0))
	{
		return 0;
	}
	if (fVar0 <= 0f)
...
int func_217(struct<5> Param0, var uParam5, var uParam6)
{
...
int func_218(vector3 vParam0, var uParam3, var uParam4, var uParam5, var uParam6)
{
	int iVar0;
	...
	if (DATAFILE::_DATAFILE_GET_HASH(&iVar0, &vParam0))
	{
		if (iVar0 == 0)
		{
...
int func_226(var uParam0, var uParam1)
{
	...
	else if (iVar7 >= Global_1901929->f_160.f_2)
	{
		return 1;
	}
	return 0;
...
void func_229(var uParam0, var uParam1, int iParam2)
{
	...
	_NAMESPACE71::_0x2F901291EF177B02(iVar0, 0);
...
void func_230(var uParam0, var uParam1)
{
	...
	iVar2 = func_308(MISC::_CREATE_VAR_STRING(0, iVar1), 10000, 0, 0, 0, 1);
	func_309(uParam0, uParam1, iVar0, iVar2);
}

int func_231()
{
	if (UNLOCK::_UNLOCK_IS_UNLOCKED(2144034109))
	{
		if (UNLOCK::_UNLOCK_IS_VISIBLE(2144034109))
		{
			return 1;
		}
	}
...
int func_233(var uParam0, var uParam1)
{
	...
	iVar0 = _NAMESPACE26::_0x4BE6C13A45CCA8EC(_NAMESPACE26::_0x901E0DC25080C8B9(uParam0->f_7));
	if (uParam0->f_7 == iVar0)
	{
		iVar1 = func_77(uParam1->f_2);
		return (UNLOCK::_UNLOCK_IS_UNLOCKED(iVar1) && UNLOCK::_UNLOCK_IS_VISIBLE(iVar1));
	}
...
void func_234(var uParam0, var uParam1)
{
	...
	if (_NAMESPACE26::_0x4BE6C13A45CCA8EC(_NAMESPACE26::_0x901E0DC25080C8B9(iVar1)) != iVar1)
	{
		return;
	}
	...
	iVar3 = func_308(MISC::_CREATE_VAR_STRING(0, iVar2), 10000, 0, 0, 0, 1);
...
int func_238(var uParam0, var uParam1)
{
	...
	if (!PED::IS_PED_ON_FOOT(uParam0->f_7.f_2.f_9))
	{
		return 0;
	}
	if (func_185())
	{
		if (!UNLOCK::_UNLOCK_IS_UNLOCKED(func_77(uParam1->f_2)))
		{
			return 0;
		}
		if (!UNLOCK::_UNLOCK_IS_VISIBLE(func_77(uParam1->f_2)))
		{
			return 0;
		}
	}
...
int func_240(var uParam0, var uParam1, var uParam2, var uParam3)
{
	...
	iVar3 = HUD::_UIPROMPT_GET_GROUP_ID_FOR_TARGET_ENTITY(iVar1);
	switch (uParam3->f_4)
	{
		case -323664079:
			iVar2 = 3;
			...
			uParam2->f_99[iVar2] = func_315("GFH_EXIT", joaat("INPUT_GAME_MENU_CANCEL"), iVar1, 3, 0, 0, 0, 0, 10f, 570, 4000, 10, 1073741824, 0, joaat("SHORT_TIMED_EVENT"), 0, 0);
			HUD::_UIPROMPT_SET_GROUP(func_316(&(uParam2->f_99[iVar2])), iVar3, 0);
			...
			uParam2->f_99[iVar2] = func_315("GFH_TAKE_POSTER", joaat("INPUT_GAME_MENU_ACCEPT"), iVar1, 3, 0, 0, 0, 0, 10f, 570, 4000, 10, 1073741824, 0, joaat("SHORT_TIMED_EVENT"), 0, 0);
			HUD::_UIPROMPT_SET_GROUP(func_316(&(uParam2->f_99[iVar2])), iVar3, 0);
			func_317(&(uParam2->f_99[iVar2]), 10f, 0);
			func_318(&(uParam2->f_99[iVar2]), 0, 0, 1);
			func_319(&(uParam2->f_99[iVar2]), 0, 0);
			...
			uParam2->f_99[iVar2] = func_315("GFH_READ", joaat("INPUT_GAME_MENU_OPTION"), iVar1, 3, 0, 0, 0, 0, 10f, 570, 4000, 10, 1073741824, 0, joaat("SHORT_TIMED_EVENT"), 0, 0);
			HUD::_UIPROMPT_SET_GROUP(func_316(&(uParam2->f_99[iVar2])), iVar3, 0);
			func_317(&(uParam2->f_99[iVar2]), 10f, 0);
			func_318(&(uParam2->f_99[iVar2]), 0, 0, 1);
			func_319(&(uParam2->f_99[iVar2]), 0, 0);
			...
			uParam2->f_99[iVar2] = func_315("GFH_MOVE_RIGHT", joaat("INPUT_GAME_MENU_RIGHT"), iVar1, 3, 0, 0, 0, 0, 10f, 570, 4000, 10, 1073741824, 0, joaat("SHORT_TIMED_EVENT"), 0, 0);
			HUD::_UIPROMPT_SET_GROUP(func_316(&(uParam2->f_99[iVar2])), iVar3, 0);
			func_317(&(uParam2->f_99[iVar2]), 10f, 0);
			func_318(&(uParam2->f_99[iVar2]), 0, 0, 1);
			func_319(&(uParam2->f_99[iVar2]), 0, 0);
			...
			uParam2->f_99[iVar2] = func_315("GFH_MOVE_LEFT", joaat("INPUT_GAME_MENU_LEFT"), iVar1, 3, 0, 0, 0, 0, 10f, 570, 4000, 10, 1073741824, 0, joaat("SHORT_TIMED_EVENT"), 0, 0);
			HUD::_UIPROMPT_SET_GROUP(func_316(&(uParam2->f_99[iVar2])), iVar3, 0);
			func_317(&(uParam2->f_99[iVar2]), 10f, 0);
			func_318(&(uParam2->f_99[iVar2]), 0, 0, 1);
			func_319(&(uParam2->f_99[iVar2]), 0, 0);
			...
			uParam2->f_99[iVar2] = func_315("GFH_LEGENDARY", joaat("INPUT_GAME_MENU_EXTRA_OPTION"), iVar1, 3, 0, 0, 0, 0, 10f, 570, 4000, 10, 1073741824, 0, joaat("SHORT_TIMED_EVENT"), 0, 0);
			HUD::_UIPROMPT_SET_GROUP(func_316(&(uParam2->f_99[iVar2])), iVar3, 0);
			func_317(&(uParam2->f_99[iVar2]), 10f, 0);
			func_318(&(uParam2->f_99[iVar2]), 0, 0, 1);
			func_319(&(uParam2->f_99[iVar2]), 0, 0);
			...
			uParam2->f_99[iVar2] = func_320("GFH_INTERACT_BOUNTY_BOARD", joaat("INPUT_CONTEXT_X"), ENTITY::GET_ENTITY_COORDS(iVar1, true, false), 10f, 3, 1, 0, 5, 570, 4000, 10, 1073741824, 0, joaat("SHORT_TIMED_EVENT"), 0);
			func_317(&(uParam2->f_99[iVar2]), 10f, 0);
			func_318(&(uParam2->f_99[iVar2]), 0, 0, 1);
			func_319(&(uParam2->f_99[iVar2]), 0, 0);
			if (func_94(&(uParam2->f_99[iVar2])))
			...
			uParam2->f_99[iVar2] = func_315("GFH_ZOOM", joaat("INPUT_INSPECT_ZOOM"), iVar1, 3, 0, 0, 0, 3, 10f, 570, 4000, 10, 1073741824, 0, joaat("SHORT_TIMED_EVENT"), 0, 0);
			HUD::_UIPROMPT_SET_GROUP(func_316(&(uParam2->f_99[iVar2])), iVar3, 0);
			func_317(&(uParam2->f_99[iVar2]), 10f, 0);
			func_318(&(uParam2->f_99[iVar2]), 0, 0, 1);
			func_319(&(uParam2->f_99[iVar2]), 0, 0);
			...
			uParam2->f_99[iVar2] = func_320("GFH_PURCHASE_BOUNTY_HUNTING_LICENSE", joaat("INPUT_GAME_MENU_ACCEPT"), ENTITY::GET_ENTITY_COORDS(iVar1, true, false), 10f, 3, 1, 0, 5, 570, 4000, 10, 1073741824, 0, -2018976333, 0);
			HUD::_UIPROMPT_SET_GROUP(func_316(&(uParam2->f_99[iVar2])), iVar3, 0);
			func_317(&(uParam2->f_99[iVar2]), 10f, 0);
			func_318(&(uParam2->f_99[iVar2]), 0, 0, 1);
			func_319(&(uParam2->f_99[iVar2]), 0, 0);
		...
		default:
			...
			uParam2->f_99[iVar2] = func_315("GFH_ACCEPT_NO_MISSION", joaat("INPUT_CONTEXT_X"), iVar1, 1, 0, 0, 0, 0, 10f, 570, 4000, 10, 1073741824, 0, joaat("SHORT_TIMED_EVENT"), 0, 0);
			...
			if (func_323(uParam3))
			{
				...
				uParam2->f_99[iVar2] = func_315("GFH_GREET_NO_MISSION", joaat("INPUT_CONTEXT_X"), iVar1, 1, 0, 0, 0, 0, 10f, 570, 4000, 10, 1073741824, 0, joaat("SHORT_TIMED_EVENT"), 0, 0);
				func_321(&(uParam2->f_99[iVar2]), iVar1, 0, 0, -1);
				func_317(&(uParam2->f_99[iVar2]), 10f, 0);
				func_318(&(uParam2->f_99[iVar2]), 0, 0, 1);
				func_319(&(uParam2->f_99[iVar2]), 0, 0);
...
int func_242(var uParam0, var uParam1)
{
	...
	MISC::_0x870708A6E147A9AD(iVar1, sVar2, 10f, 10f, iVar3, 0, 0, 0, 0, -1);
	switch (uParam1->f_4)
	{
		case -323664079:
...
int func_248(var uParam0, var uParam1, var uParam2, var uParam3, int iParam4)
{
	...
	if (func_120(&(((*uParam1)[NETWORK::PARTICIPANT_ID_TO_INT() /*14*/])->f_1), 1))
	{
		func_344(uParam2, 1);
		func_342(uParam2, 1);
		func_322(uParam0, uParam1, uParam2, uParam3, 1);
	...
	if ((iVar0 == -1 && iVar1 != -1) && (uParam0->f_4[iVar1 /*6*/])->f_3 == 6)
	{
		func_354(uParam2, uParam3, (uParam0->f_4[iVar1 /*6*/])->f_3);
		func_350(uParam2, 1);
		func_344(uParam2, 1);
		func_322(uParam0, uParam1, uParam2, uParam3, 1);
		return 0;
...
int func_249(var uParam0, var uParam1, var uParam2, int iParam3)
{
	...
	if (func_120(&(((*uParam0)[NETWORK::PARTICIPANT_ID_TO_INT() /*14*/])->f_1), 1))
	{
		func_343(uParam1);
		func_341(uParam1);
		return 0;
	...
	Var32 = { func_368(*uParam2, uParam1->f_7.f_2.f_24) };
	iVar37 = 536877072;
	if (func_369(&Var1, iVar0, &Var32, uParam1->f_7.f_2.f_13, uParam1->f_7.f_2.f_1, uParam2->f_1, &iVar36, iVar37, -1))
	{
		switch (iVar36)
		{
			case 3:
...
int func_250(var uParam0, var uParam1, var uParam2, int iParam3)
{
	...
	switch (func_313(*uParam2))
	{
		case 0:
			...
			iVar0 = func_377(uParam2);
			if (iVar0 == -1)
			{
				if (!func_378() || func_379())
				{
					func_351(uParam1, uParam2);
					func_325(uParam1);
					func_333(uParam1);
...
int func_251(var uParam0, var uParam1, int iParam2)
{
	...
	if ((MISC::GET_GAME_TIMER() - uParam0->f_99.f_28) >= 3000)
	{
		func_391(uParam0, uParam1, 0, 0);
		func_392(uParam0, 0);
		func_100(uParam1->f_1);
...
int func_252(var uParam0, var uParam1, var uParam2, var uParam3, int iParam4)
{
	...
	if (func_361(*uParam3, iVar31, 1859868723))
	{
		func_395(&uVar35, 2);
	}
	if (func_361(*uParam3, iVar31, 518798111))
	{
		bVar33 = true;
		func_396(uParam3->f_1, uParam3->f_2, uVar35, Var0.f_2, Var0, Var36, 0);
	}
	else
	{
		bVar33 = func_397(&Var0, uParam3->f_2, uParam3->f_1);
	}
	if (!bVar33)
	{
		func_394(&(uParam2->f_99[0]), 1);
	...
	func_398(*uParam3, uParam3->f_1, uParam3->f_2, &(uParam0->f_4[iVar32 /*6*/]), iVar34, Var0, uVar35);
	if (iVar34 != 2)
	{
	...
	func_121(&(((*uParam1)[NETWORK::PARTICIPANT_ID_TO_INT() /*14*/])->f_1), 9, *uParam3);
	func_394(&(uParam2->f_99[0]), 1);
	*iParam4 = 4;
	return 1;
}
...
int func_253(var uParam0, var uParam1, var uParam2, int iParam3)
{
	...
	func_394(&(uParam1->f_99[1]), 1);
	func_121(&(((*uParam0)[NETWORK::PARTICIPANT_ID_TO_INT() /*14*/])->f_1), 9, *uParam2);
	HUD::_UIPROMPT_ENABLE_PROMPT_TYPE_THIS_FRAME(6);
	HUD::_0xC9CAEAEEC1256E54(-1249243147);
	*iParam3 = 5;
	return 1;
...
int func_254(var uParam0, var uParam1, int iParam2)
{
	...
	WEAPON::_0x94A3C1B804D291EC(PLAYER::GET_PLAYER_PED(PLAYER::PLAYER_ID()), 0, 0, 0, 0);
	func_400(uParam0, uParam1);
	func_401(uParam0, uParam1);
	func_402(uParam1->f_1);
	func_403(uParam0);
	func_97(*uParam1, 1);
...
int func_255(var uParam0, var uParam1, int iParam2, bool bParam3)
{
	...
	if (bParam3)
	{
		AUDIO::_0xE8EAFF7B41EDD291(1921928004, 483933850, 2);
	}
	func_45(uParam0, uParam1);
	func_46(uParam0, uParam1);
	func_392(uParam0, 0);
...
{
	_NAMESPACE79::_0x1C38C3577901AF1F();
	if (func_404(*uParam2) == 2 && func_406(func_405(), 0))
	{
		if (func_407(uParam2, 0))
		{
			AUDIO::_0xE8EAFF7B41EDD291(-711531040, 483933850, 2);
			uParam1->f_99.f_28 = MISC::GET_GAME_TIMER();
			*iParam3 = 2;
			return 1;
		}
	}
	...
	{
		func_408(uParam0, uParam1, uParam2);
	}
...
{
	_NAMESPACE79::_0x1C38C3577901AF1F();
	if (func_406(func_409(), 1))
	{
		if (func_407(uParam1, 1))
		{
			uParam0->f_99.f_28 = MISC::GET_GAME_TIMER();
			*iParam2 = 2;
			return 1;
		}
	}
...
int func_258(var uParam0, var uParam1, int iParam2)
{
	...
	func_387(*uParam1, func_410(uParam1, 1));
	if (func_411(uParam1))
	{
		AUDIO::_0xE8EAFF7B41EDD291(1639311733, 483933850, 2);
	}
	else
	{
		AUDIO::_0xE8EAFF7B41EDD291(joaat("NAV_RIGHT"), 483933850, 2);
	}
...
int func_259(var uParam0, var uParam1, int iParam2)
{
	...
	{
		AUDIO::_0xE8EAFF7B41EDD291(joaat("NAV_LEFT"), 483933850, 2);
	}
	func_412(uParam0, uParam1);
	*iParam2 = 3;
	return 1;
...
{
	_NAMESPACE79::_0x1C38C3577901AF1F();
	AUDIO::_0xE8EAFF7B41EDD291(1155235276, 483933850, 2);
...
int func_264(var uParam0, var uParam1, int iParam2)
{
	...
	if (func_414(uParam0))
	{
		TELEMETRY::_0x775B2ED944E44973(func_415(25), func_417(func_416(uParam1)), func_419(func_418(), 0), Global_36);
		if (!func_421(&(uParam0->f_198), 2103384153 /* GXTEntry: "Bounty Hunter License" */, 1, 1, func_420(uParam0), -1))
		{
		}
		TELEMETRY::_0xF78E669FDC202E73();
	}
	func_422(uParam0, uParam1);
	func_412(uParam0, uParam1);
	*iParam2 = 3;
	return 1;
}
...
int func_266(var uParam0, var uParam1, bool bParam2, bool bParam3)
{
	int iVar0;
	int iVar1;
	int iVar2;
...
void func_271(vector3 vParam0, int iParam3, var uParam4, int iParam5, int iParam6, int iParam7)
{
	...
	iVar6 = iVar0;
	if (!func_426(&vParam0, iParam6))
	{
		return;
	}
	vParam0.f_2 = -809702995;
	DATAFILE::_DATAFILE_GET_BOOL(&bVar3, &vParam0);
	vParam0.f_2 = -267638862;
	DATAFILE::_DATAFILE_GET_BOOL(&bVar4, &vParam0);
	vParam0.f_2 = 1323614307;
	DATAFILE::_DATAFILE_GET_BOOL(&bVar5, &vParam0);
	vParam0.f_2 = -1537888061;
	DATAFILE::_DATAFILE_GET_FLOAT(&fVar1, &vParam0);
	vParam0.f_2 = 1417063580;
	DATAFILE::_DATAFILE_GET_FLOAT(&fVar2, &vParam0);
	OBJECT::DOOR_SYSTEM_SET_OPEN_RATIO(iVar6, fVar1, bVar5);
	OBJECT::DOOR_SYSTEM_SET_AUTOMATIC_RATE(iVar6, fVar2);
	if (bVar3)
	{
		if (bVar4)
		{
			OBJECT::DOOR_SYSTEM_SET_DOOR_STATE(iVar6, 2);
		}
		else
		{
			OBJECT::DOOR_SYSTEM_SET_DOOR_STATE(iVar6, 1);
		}
	}
	else
	{
		OBJECT::DOOR_SYSTEM_SET_DOOR_STATE(iVar6, 0);
	}
}
...
void func_272(var uParam0, int iParam1, var uParam2)
{
	...
	func_427(&(uParam0->f_197), iParam1, 3);
}
...
int func_274(var uParam0, var uParam1, var uParam2, int iParam3, int iParam4, var uParam5, int iParam6)
{
	if (func_428(_NAMESPACE26::_0x4BE6C13A45CCA8EC(iParam4), uParam2->f_2))
	{
		uParam0->f_4[iParam3 /*6*/] = func_430(*uParam2, func_429(iParam3));
		*iParam6 = 9;
		return 1;
	}
	if (func_431(uParam5, 4096))
	{
		*iParam6 = 3;
		return 1;
	}
	if (func_432(&((uParam0->f_4[iParam3 /*6*/])->f_4), 2))
	{
		*iParam6 = 10;
		return 1;
	}
	if (&uParam0->f_4[iParam3 /*6*/] != -1)
	{
		if (func_433(uParam0, &(uParam0->f_4[iParam3 /*6*/]), *uParam2))
		{
			func_272(uParam0, &(uParam0->f_4[iParam3 /*6*/]), *uParam2);
		}
		uParam0->f_4[iParam3 /*6*/] = -1;
	}
	return 0;
}

int func_275(var uParam0, var uParam1, var uParam2, var uParam3, int iParam4, int iParam5, var uParam6, int iParam7)
{
	int iVar0;

	if (func_434(iParam4) == -1)
	{
		return 0;
	}
	if (func_432(&((uParam0->f_4[iParam4 /*6*/])->f_4), 1))
	{
		iVar0 = func_435(uParam0, uParam1, uParam2, uParam3, iParam5, iParam4, &(uParam0->f_4[iParam4 /*6*/]));
		func_436(&((uParam0->f_4[iParam4 /*6*/])->f_4), 1, *uParam3);
	}
	else
	{
		iVar0 = func_437(uParam0, uParam1, uParam2, uParam3, iParam5, iParam4);
		if (iVar0 == -1)
		{
			iVar0 = func_435(uParam0, uParam1, uParam2, uParam3, iParam5, iParam4, -1);
		}
	}
	if (iVar0 == -1)
	{
		(uParam0->f_4[iParam4 /*6*/])->f_1 = uParam2->f_7.f_2.f_23;
		func_438(&((uParam0->f_4[iParam4 /*6*/])->f_1), 0, 0, 1, 0, 0, 0, 0);
		*iParam7 = 6;
		return 1;
	}
	func_439(uParam0, iVar0, *uParam3);
	uParam0->f_4[iParam4 /*6*/] = iVar0;
	(uParam0->f_4[iParam4 /*6*/])->f_1 = uParam2->f_7.f_2.f_23;
	func_438(&((uParam0->f_4[iParam4 /*6*/])->f_1), 0, 0, 0, 1, 0, 0, 0);
	*iParam7 = 2;
	return 1;
}

int func_276(var uParam0, var uParam1, int iParam2, int iParam3, var uParam4, int iParam5)
{
	int iVar0;
	struct<24> Var1;

	if (!func_431(uParam4, 4096))
	{
		*iParam5 = 1;
		return 1;
	}
	if (&uParam0->f_4[iParam2 /*6*/] == -1)
	{
		*iParam5 = 1;
		return 1;
	}
	...
	Var1.f_8.f_5.f_6 = { func_73(*uParam1, &(uParam0->f_4[iParam2 /*6*/])) };
	Var1.f_8.f_5.f_4 = uParam1->f_1;
	Var1.f_8.f_5.f_9 = 1;
	func_440(&Var1);
	func_441((*Global_1187677)[&Global_1273882 /*204*/], &Var1, 0, 0, 0, 0, 0);
	func_442(&((uParam0->f_4[iParam2 /*6*/])->f_4), 2, *uParam1);
	(uParam0->f_4[iParam2 /*6*/])->f_2 = iVar0;
	*iParam5 = 4;
	return 1;
}

int func_277(var uParam0, var uParam1, int iParam2, int iParam3, var uParam4, int iParam5)
{
	struct<10> Var0;
	struct<15> Var10;
	int iVar25;
	...
	iVar25 = func_443(&Var0);
	iVar26 = NETWORK::GET_NETWORK_TIME_ACCURATE();
	if (func_444(iVar25))
	{
		Var10 = { func_445(iVar25) };
		if (Var10 == 1)
		{
			if (!func_431(uParam4, 4096))
			{
			...
			(uParam0->f_4[iParam2 /*6*/])->f_2 = iVar26;
			*iParam5 = 5;
			return 1;
		}
		else
		{
			func_436(&((uParam0->f_4[iParam2 /*6*/])->f_4), 2, *uParam1);
			*iParam5 = 2;
			return 1;
		}
	}
	else if (NETWORK::GET_TIME_DIFFERENCE((uParam0->f_4[iParam2 /*6*/])->f_2, iVar26) >= 30000)
	{
		(uParam0->f_4[iParam2 /*6*/])->f_2 = iVar26;
		func_272(uParam0, &(uParam0->f_4[iParam2 /*6*/]), *uParam1);
		*iParam5 = 11;
		return 1;
	}
	return 0;
...
int func_278(var uParam0, var uParam1, var uParam2, var uParam3, int iParam4, int iParam5, var uParam6, int iParam7)
{
	struct<31> Var0;
	struct<4> Var31;
	var uVar35;
	...
	Var0.f_29.f_1 = 493038497;
	Var31 = 3;
	if (!func_431(uParam6, 4096))
	{
		*iParam7 = 10;
		return 1;
	}
	if (func_446((uParam0->f_4[iParam4 /*6*/])->f_1, 1))
	{
		func_272(uParam0, &(uParam0->f_4[iParam4 /*6*/]), *uParam3);
		func_436(&((uParam0->f_4[iParam4 /*6*/])->f_4), 4, *uParam3);
		*iParam7 = 10;
		return 1;
	}
	Var0 = { func_367(*uParam3, &(uParam0->f_4[iParam4 /*6*/])) };
	Var31 = { func_368(*uParam3, uParam2->f_7.f_2.f_24) };
	iVar36 = 1073742987;
	if (!func_13(&(uParam0->f_3), 4))
	{
		iVar36 |= 4096;
	}
	if (func_369(&Var0, &(uParam0->f_4[iParam4 /*6*/]), &Var31, iParam5, iParam4, uParam3->f_1, &uVar35, iVar36, -1))
	{
		func_272(uParam0, &(uParam0->f_4[iParam4 /*6*/]), *uParam3);
		func_436(&((uParam0->f_4[iParam4 /*6*/])->f_4), 4, *uParam3);
		*iParam7 = 10;
	...
	{
		func_436(&((uParam0->f_4[iParam4 /*6*/])->f_4), 4, *uParam3);
		(uParam0->f_4[iParam4 /*6*/])->f_2 = NETWORK::GET_NETWORK_TIME_ACCURATE();
		if (&uParam0->f_4[iParam4 /*6*/] == -1)
		{
			*iParam7 = 10;
			return 1;
		}
		if (func_361(*uParam3, &(uParam0->f_4[iParam4 /*6*/]), 518798111))
		{
			(uParam0->f_4[iParam4 /*6*/])->f_5 = func_447(uParam1, iParam5, 1);
			*iParam7 = 8;
			return 1;
		}
		else
	...
	if (func_448(uParam3->f_2, iParam4))
	{
		*iParam7 = 9;
		return 1;
	}
	...
	{
		func_442(&((uParam0->f_4[iParam4 /*6*/])->f_4), 1, *uParam3);
		func_436(&((uParam0->f_4[iParam4 /*6*/])->f_4), 4, *uParam3);
		func_272(uParam0, &(uParam0->f_4[iParam4 /*6*/]), *uParam3);
		*iParam7 = 10;
		return 1;
...
{
	if (func_448(uParam1->f_2, iParam2))
	{
		*iParam3 = 9;
		return 1;
	}
	if (func_446((uParam0->f_4[iParam2 /*6*/])->f_1, 1))
	{
		*iParam3 = 1;
		return 1;
	}
...
int func_281(var uParam0, var uParam1, int iParam2, int iParam3)
{
	int iVar0;
	int iVar1;

	iVar0 = NETWORK::GET_NETWORK_TIME_ACCURATE();
	iVar1 = NETWORK::GET_TIME_DIFFERENCE((uParam0->f_4[iParam2 /*6*/])->f_2, iVar0);
	if (func_449((uParam0->f_4[iParam2 /*6*/])->f_5, 64))
	{
		*iParam3 = 9;
		return 1;
	}
...
int func_282(var uParam0, var uParam1, int iParam2, int iParam3)
{
	int iVar0;
...
int func_283(var uParam0, var uParam1, int iParam2, int iParam3, int iParam4)
{
	struct<10> Var0;
	int iVar10;
	int iVar11;
	...
	Var0.f_6.f_1 = -1;
	Var0.f_9 = 2;
	if (func_432(&((uParam0->f_4[iParam2 /*6*/])->f_4), 2))
	{
		func_450(uParam1->f_1, iParam3);
		(uParam0->f_4[iParam2 /*6*/])->f_2 = NETWORK::GET_NETWORK_TIME_ACCURATE();
		func_436(&((uParam0->f_4[iParam2 /*6*/])->f_4), 2, *uParam1);
	}
	else
	{
		Var0.f_2 = iParam3;
		Var0.f_4 = uParam1->f_1;
		iVar10 = func_443(&Var0);
		if (func_444(iVar10))
		{
			if (NETWORK::GET_TIME_DIFFERENCE((uParam0->f_4[iParam2 /*6*/])->f_2, NETWORK::GET_NETWORK_TIME_ACCURATE()) > 30000)
			{
				func_442(&((uParam0->f_4[iParam2 /*6*/])->f_4), 2, *uParam1);
			}
		}
...
int func_285(var uParam0, var uParam1, var uParam2, int iParam3, int iParam4, var uParam5, int iParam6)
{
	if (func_428(_NAMESPACE26::_0x4BE6C13A45CCA8EC(iParam4), uParam2->f_2))
	{
		uParam0->f_4[iParam3 /*6*/] = func_430(*uParam2, func_429(iParam3));
...
int func_286(var uParam0, var uParam1, int iParam2, int iParam3, var uParam4, int iParam5)
{
	int iVar0;
	struct<24> Var1;
...
int func_287(var uParam0, var uParam1, var uParam2, var uParam3, int iParam4, int iParam5, var uParam6, int iParam7)
{
	int iVar0;
...
int func_288(var uParam0, var uParam1, int iParam2, int iParam3, var uParam4, int iParam5)
{
	struct<10> Var0;
	struct<15> Var10;
	int iVar25;
...
int func_289(var uParam0, var uParam1, var uParam2, var uParam3, int iParam4, int iParam5, var uParam6, int iParam7)
{
	struct<31> Var0;
	struct<4> Var31;
	var uVar35;
	...
	if (func_120(&(uParam6->f_1), 1))
	{
		func_436(&((uParam0->f_4[iParam4 /*6*/])->f_4), 4, *uParam3);
		(uParam0->f_4[iParam4 /*6*/])->f_2 = NETWORK::GET_NETWORK_TIME_ACCURATE();
		if (&uParam0->f_4[iParam4 /*6*/] != -1 && func_361(*uParam3, &(uParam0->f_4[iParam4 /*6*/]), 518798111))
		{
			(uParam0->f_4[iParam4 /*6*/])->f_5 = func_447(uParam1, iParam5, 1);
			*iParam7 = 8;
			return 1;
...
int func_293(struct<5> Param0, var uParam5, var uParam6)
{
	int iVar0;
	int iVar1;

	if (!func_452(&Param0, 940344631))
	{
		return 0;
	}
	...
	while (iVar1 <= (iVar0 - 1))
	{
		if (!func_453(Param0, uParam5, iVar1))
		{
			return 0;
		}
		iVar1++;
...
{
	return (uParam0->f_137[iParam1 /*2*/])->f_1;
}

int func_304(var uParam0, var uParam1, bool bParam2)
{
	int iVar0;
	int iVar1;
	...
	{
		if ((MISC::GET_GAME_TIMER() - func_455(uParam0)) < 2000)
		{
			return 0;
		}
	}
	if (bParam2)
	{
		...
		if (ENTITY::DOES_ENTITY_EXIST(iVar1))
		{
			if (!ENTITY::IS_ENTITY_VISIBLE(iVar1))
			{
				return 0;
			}
		}
...
int func_305(var uParam0, var uParam1, int iParam2, int iParam3)
{
	if (func_303(uParam0, iParam2) <= 0)
	{
		return 1;
	}
	if ((MISC::GET_GAME_TIMER() - func_456(uParam0, iParam2)) < iParam3)
	{
		return 0;
	}
	return 1;
...
int func_307(var uParam0, var uParam1, int iParam2)
{
	...
	if (!func_106(func_457(*uParam1)))
	{
		return 0;
	}
	iVar4 = func_458(*uParam1);
	if (uParam1->f_4 == -323664079)
	{
		bVar0 = true;
	}
	...
	bVar1 = func_459() == PLAYER::PLAYER_ID();
	if (uParam1->f_4 == -323664079)
	{
		iVar2 = 1;
	}
...
int func_308(char* sParam0, int iParam1, int iParam2, int iParam3, int iParam4, bool bParam5)
{
	struct<4> Var0;
	struct<2> Var13;
	var uVar15;
...
void func_309(var uParam0, var uParam1, int iParam2, int iParam3)
{
	...
	iVar0 = MISC::GET_GAME_TIMER();
	func_462(uParam0, uParam1, iParam2);
	func_463(uParam0, uParam1, iParam2, iVar0);
	func_301(uParam0, uParam1, iParam3);
	func_302(uParam0, uParam1, iParam2);
	func_464(uParam0, uParam1);
	func_465(uParam0, uParam1, iVar0);
}

bool func_310(int iParam0)
{
	return func_202(&(Global_1103536->f_242.f_6), iParam0, 2);
}

bool func_311(int iParam0, int iParam1)
{
	return func_202(&(((*Global_1121338)[iParam0 /*54*/])->f_35), iParam1, 2);
}
...
bool func_312(int iParam0)
{
	...
	return func_466(Var0);
}

int func_313(int iParam0)
{
	return ((*Global_1113330)[iParam0 /*1991*/])->f_14;
}
...
int func_315(char* sParam0, int iParam1, int iParam2, int iParam3, int iParam4, bool bParam5, int iParam6, int iParam7, float fParam8, int iParam9, int iParam10, int iParam11, int iParam12, int iParam13, int iParam14, bool bParam15, bool bParam16)
{
	int iVar0;
	int iVar1;
	...
	while (iVar0 < 60)
	{
		if (func_200(iVar0, 2))
		{
			...
			if (iVar1 != 0)
			{
				func_467(iVar1, iParam1, sParam0, 5, iParam3, iParam4, 0f, 0f, 0f, fParam8, 0, iParam2, 3, iParam6, iParam7, iParam9, iParam10, iParam11, iParam12, iParam13, 1065353216, 0, bParam5, 0, iParam14, bParam16);
				return iVar1;
			}
			return 0;
		}
...
void func_317(int iParam0, float fParam1, bool bParam2)
{
	...
	((*Global_1949749)[iVar0 /*23*/])->f_9 = fParam1;
	HUD::_UIPROMPT_CONTEXT_SET_SIZE(((*Global_1949749)[iVar0 /*23*/])->f_3, fParam1);
}
...
int func_320(char* sParam0, int iParam1, vector3 vParam2, float fParam5, int iParam6, int iParam7, int iParam8, int iParam9, int iParam10, int iParam11, int iParam12, int iParam13, int iParam14, bool bParam15, int iParam16)
{
	...
	while (iVar0 < 60)
	{
		if (func_200(iVar0, 2))
		{
			if (func_472(vParam2, ((*Global_1949749)[iVar0 /*23*/])->f_6, 0.01f, 1) && iParam1 == ((*Global_1949749)[iVar0 /*23*/])->f_4)
			{
				iVar2 = iVar0;
				return iVar2;
			}
	...
	if (iVar1 != 0)
	{
		func_467(iVar1, iParam1, sParam0, 4, iParam6, iParam7, vParam2, fParam5, 0, 0, 2, iParam8, iParam9, iParam10, iParam11, iParam12, iParam13, iParam14, 1065353216, 0, 0, 0, bParam15, iParam16);
		return iVar1;
	}
	return 0;
}
...
void func_321(int iParam0, int iParam1, int iParam2, bool bParam3, int iParam4)
{
	...
	iVar0 = func_141(iParam0);
	func_473(iParam0, 18, 0, 1);
	func_473(iParam0, 17, 0, 1);
	if (iParam4 == -1)
	{
...
void func_322(var uParam0, var uParam1, var uParam2, var uParam3, bool bParam4)
{
	...
	else if (func_185())
	{
		...
		else if ((uParam0->f_4[iVar1 /*6*/])->f_3 != 5)
		{
			func_474(uParam2);
		}
		else if (func_120(&(((*uParam1)[NETWORK::PARTICIPANT_ID_TO_INT() /*14*/])->f_1), 1))
		{
			func_474(uParam2);
		}
		else
		{
			...
			{
				func_476(uParam2, uParam3, iVar0);
			}
		}
	}
	else
...
void func_324(var uParam0, var uParam1)
{
	...
	{
		func_478(uParam0, uParam1, iVar0);
	}
}
...
bool func_346(var uParam0, var uParam1)
{
	...
	return PLAYER::IS_PLAYER_TARGETTING_ENTITY(uParam0->f_7, iVar0, 0);
}

void func_347(var uParam0, var uParam1)
{
	func_484(uParam0, uParam1, 4);
	func_484(uParam0, uParam1, 3);
	func_484(uParam0, uParam1, 5);
	func_484(uParam0, uParam1, 7);
	func_484(uParam0, uParam1, 15);
	func_484(uParam0, uParam1, 14);
	func_484(uParam0, uParam1, 6);
	func_484(uParam0, uParam1, 13);
	func_484(uParam0, uParam1, 1);
	func_484(uParam0, uParam1, 0);
	func_484(uParam0, uParam1, 12);
	func_484(uParam0, uParam1, 19);
	func_484(uParam0, uParam1, 20);
	func_484(uParam0, uParam1, 21);
	func_484(uParam0, uParam1, 2);
	func_484(uParam0, uParam1, 22);
	func_484(uParam0, uParam1, 27);
}
...
{
	return ((*Global_1113330)[iParam0 /*1991*/])->f_16;
}
...
int func_353(var uParam0, var uParam1)
{
	...
	if (func_434(uParam0->f_7.f_2.f_1) > 0 && !func_25(func_74()))
	{
		if (func_485(uParam0->f_7.f_2.f_1, 4))
		{
...
void func_354(var uParam0, var uParam1, int iParam2)
{
	...
	if (func_486(_NAMESPACE26::_0x4BE6C13A45CCA8EC(_NAMESPACE26::_0x901E0DC25080C8B9(PLAYER::PLAYER_ID()))))
	{
...
bool func_355(var uParam0, var uParam1)
{
	...
	vVar1 = { func_488(ENTITY::GET_ENTITY_HEADING(iVar0)) };
	vVar4 = { func_490(ENTITY::GET_ENTITY_COORDS(iVar0, true, false) - func_489(uParam0->f_7)) };
	return func_491(vVar1, vVar4) <= -0.2f;
}

int func_356(var uParam0, var uParam1, var uParam2, var uParam3)
{
	struct<2> Var0;
	struct<4> Var31;
	int iVar35;
	...
	if (func_120(&(((*uParam1)[NETWORK::PARTICIPANT_ID_TO_INT() /*14*/])->f_1), 2))
	{
		return 0;
	}
	if (func_185())
	...
	Var0.f_29.f_1 = 493038497;
	Var31 = 3;
	Var0 = { func_367(*uParam3, &(uParam0->f_4[uParam2->f_7.f_2.f_1 /*6*/])) };
	Var31 = { func_368(*uParam3, uParam2->f_7.f_2.f_24) };
	iVar36 = 0;
	if (func_369(&Var0, &(uParam0->f_4[uParam2->f_7.f_2.f_1 /*6*/]), &Var31, uParam2->f_7.f_2.f_13, uParam2->f_7.f_2.f_1, uParam3->f_1, &iVar35, iVar36, -1))
	{
		switch (iVar35)
		{
			case 3:
...
void func_358(var uParam0, var uParam1)
{
	...
	Var0.f_22 = 3;
	Var0.f_4 = 21030;
	Var0.f_3 = PLAYER::GET_PLAYER_PED(PLAYER::PLAYER_ID());
	Var0.f_19 = 4;
	Var0.f_20 = 3;
	Var0.f_21 = 4;
	Var0.f_22 = 3;
	...
	Var0.f_7 = 500;
	func_495(&(Var0.f_5), 1);
	_NAMESPACE29::_0x66F9EB44342BB4C5(ENTITY::GET_PED_INDEX_FROM_ENTITY_INDEX(func_93(*uParam1, uParam0->f_99.f_12)), &Var0);
}
...
void func_359(var uParam0, var uParam1)
{
	...
	while (iVar1 <= 6)
	{
		...
		else if (!func_25(((*Global_1055965)[iVar3 /*436*/])->f_2))
		{
		}
		else
		{
			Var4 = { ((*Global_1055965)[iVar3 /*436*/])->f_2 };
			if (func_25(Var4))
			{
				...
				iVar7 = func_308(MISC::_CREATE_VAR_STRING(0, iVar6), 10000, 0, 0, 0, 1);
...
void func_360(var uParam0, var uParam1, var uParam2)
{
	...
	iVar3 = &uParam0->f_4[iVar4 /*6*/];
	if (iVar3 == -1)
	{
		return;
	}
	iVar5 = func_497(*uParam2, iVar3);
	switch (iVar5)
	{
		case 493038497:
			return;
		case joaat("POSITIVE"):
			iVar0 = 9;
			if (func_499(func_498(-909181932)) > 2)
			{
				func_462(uParam1, uParam2, iVar0);
				return;
			}
			break;
		case joaat("NEGATIVE"):
			iVar0 = 10;
			if (func_499(func_498(1767412264)) > 2)
			{
				func_462(uParam1, uParam2, iVar0);
				return;
			}
	...
	func_502(0, -1906191545);
	func_503(0, 1699087565);
	...
	{
		case joaat("NEGATIVE"):
			func_506(func_498(1767412264), 1);
			break;
		case joaat("POSITIVE"):
			func_506(func_498(-909181932), 1);
			break;
	}
}
...
{
	return func_507(((*Global_1113330)[iParam0 /*1991*/])->f_24.f_2[iParam1 /*31*/], iParam2);
}
...
void func_362(var uParam0, var uParam1)
{
	...
	iVar1 = func_308(MISC::_CREATE_VAR_STRING(0, iVar0), 10000, 0, 0, 0, 1);
...
void func_363(var uParam0, var uParam1, int iParam2)
{
	...
	iVar4 = (_NAMESPACE26::_0x149A2751AB66AC02(iVar3) - 1);
...
{
	return ((*Global_1113330)[iParam0 /*1991*/])->f_24.f_1;
}
...
struct<31> func_367(int iParam0, int iParam1)
{
	return *(((*Global_1113330)[iParam0 /*1991*/])->f_24.f_2[iParam1 /*31*/]);
}
...
{
	return *(((*Global_1113330)[iParam0 /*1991*/])->f_24.f_1950[iParam1 /*4*/]);
}
...
bool func_369(var uParam0, int iParam1, var uParam2, int iParam3, int iParam4, int iParam5, int iParam6, int iParam7, int iParam8)
{
	...
	iVar0 = func_510(uParam0->f_2);
	iVar1 = func_511(iVar0);
	if (iParam8 == -1)
	{
		iVar2 = func_512(iParam5);
	}
	else
	{
		iVar2 = iParam8;
	...
	*iParam6 = 0;
	*iParam6 = func_513(uParam0);
	if (*iParam6 != 0)
	{
		return true;
	}
	*iParam6 = func_514(iVar2, iParam7);
	if (*iParam6 != 0)
	{
		return true;
	}
	...
	*iParam6 = func_516(uParam0, iParam1, uParam2, iParam7);
	if (*iParam6 != 0)
	{
		return true;
	}
	*iParam6 = func_517(uParam0, iParam7);
	if (*iParam6 != 0)
	{
		return true;
	}
	*iParam6 = func_518(iVar2, iParam7);
	if (*iParam6 != 0)
	{
		return true;
	}
	*iParam6 = func_519(uParam0, iVar2, iParam3, iParam7);
	if (*iParam6 != 0)
	{
		return true;
	}
	*iParam6 = func_520(uParam0, iParam3, iParam7);
	if (*iParam6 != 0)
	{
		return true;
	}
	*iParam6 = func_521(iParam3, iParam4, iParam7);
	if (*iParam6 != 0)
	{
		return true;
	}
	*iParam6 = func_522(iParam3);
	if (*iParam6 != 0)
	{
		return true;
	}
	*iParam6 = func_523(iParam3, uParam0, iParam7);
	if (*iParam6 != 0)
	{
		return true;
	}
	*iParam6 = func_524(uParam0, iParam3, iParam7);
	if (*iParam6 != 0)
	{
		return true;
	}
	*iParam6 = func_525(uParam0, iParam7);
	if (*iParam6 != 0)
	{
		return true;
	}
	*iParam6 = func_526(uParam0, iParam7);
	if (*iParam6 != 0)
	{
		return true;
	}
	*iParam6 = func_527(iParam3, iParam7);
	if (*iParam6 != 0)
	{
		return true;
	}
	...
	{
		case 2:
			*iParam6 = func_528(uParam0, iParam7, iParam3, iVar2, iParam5);
			break;
		case 1:
			*iParam6 = func_529(uParam0, iParam7);
			break;
		case 0:
			*iParam6 = func_530(uParam0, iParam7, iParam3);
			break;
		default:
			*iParam6 = 45;
			break;
...
void func_370(var uParam0, var uParam1, var uParam2)
{
	...
	sVar2 = MISC::_CREATE_VAR_STRING(0, &(uParam2->f_4[5]));
	iVar3 = func_308(MISC::_CREATE_VAR_STRING(8, iVar1, sVar2), 10000, 0, 0, 0, 1);
	func_309(uParam0, uParam1, iVar0, iVar3);
}
...
void func_372(var uParam0, var uParam1, int iParam2, var uParam3, struct<2> Param4, bool bParam6)
{
	struct<28> Var0;
	var uVar31;
	...
	Var0.f_27.f_1 = -1;
	uVar31 = func_531(32768, 8);
	if (!bParam6)
	{
		SCRIPTS::_0xD426E2E3288469D6(&uVar31, PLAYER::PLAYER_ID());
	}
...
int func_377(var uParam0)
{
	...
	while (iVar0 <= (3 - 1))
	{
		if (ENTITY::IS_ENTITY_VISIBLE(func_533(*uParam0, iVar0)))
		{
			return iVar0;
		}
		iVar0++;
...
{
	((*Global_1113330)[iParam0 /*1991*/])->f_15 = iParam1;
}
...
int func_389(var uParam0, var uParam1, int iParam2)
{
	...
	func_545(uParam0);
	func_546(uParam0);
	if (func_547(2103384153 /* GXTEntry: "Bounty Hunter License" */, 1, func_420(uParam0)))
	{
		func_541(uParam0);
	...
	else
	{
		...
		if (func_386(&(uParam0->f_99[9]), 0))
		{
			func_549(2103384153 /* GXTEntry: "Bounty Hunter License" */, 0, -1);
			func_550(1);
			return 0;
		}
	}
...
int func_390(var uParam0, var uParam1, var uParam2, int iParam3)
{
	...
	vVar0.f_1 = -1;
	func_539(uParam1, uParam2);
	func_412(uParam1, uParam2);
	func_332(uParam1);
	func_340(uParam1);
	func_551(uParam1);
	...
	{
		case 0:
			if ((((func_404(*uParam2) != -1 && ENTITY::DOES_ENTITY_EXIST(func_533(*uParam2, func_404(*uParam2)))) && ENTITY::IS_ENTITY_VISIBLE(func_533(*uParam2, func_404(*uParam2)))) && func_553(*uParam2) == 0) && func_554(*uParam2) == 0)
			{
				func_555(uParam1);
				func_556(uParam1);
				if (func_557(&(uParam1->f_99[8]), 0))
				{
					func_327(uParam1);
					func_335(uParam1);
					func_330(uParam1);
					...
					func_326(uParam1);
					func_334(uParam1);
					func_558(uParam1, func_404(*uParam2));
					func_559(*uParam2, 1);
					return 0;
				}
			}
		...
		case 1:
			...
			{
				func_560(uParam1, func_404(*uParam2));
				func_559(*uParam2, 0);
			}
			break;
		default:
	...
	func_542(uParam1);
	if (func_553(*uParam2) != 0 || func_554(*uParam2) != 0)
	{
		func_326(uParam1);
	}
	else
	...
	iVar4 = func_404(*uParam2);
	if (iVar4 != -1)
	{
		func_561(*uParam2, iVar4, &vVar0);
	}
	if ((func_553(*uParam2) == 0 && func_554(*uParam2) == 0) && func_364(&(uParam1->f_99[3]), 0))
	{
		*iParam3 = 9;
		return 1;
	}
	...
	switch (func_553(*uParam2))
	{
		case 0:
			...
			else if (ENTITY::DOES_ENTITY_EXIST(func_533(*uParam2, func_404(*uParam2))) && ENTITY::IS_ENTITY_VISIBLE(func_533(*uParam2, func_404(*uParam2))))
			{
				if (func_554(*uParam2) == 0)
				{
					func_565(uParam1);
					func_566(uParam1);
				}
	...
	switch (func_554(*uParam2))
	{
		case 0:
			if (func_534())
			{
				if (func_553(*uParam2) == 1)
				{
					func_329(uParam1);
					func_337(uParam1);
				}
	...
	if (vVar0.x != 0 && func_572(func_571(uParam2->f_1), func_404(*uParam2)) == 0)
	{
	...
	func_577(uParam1, uParam2, vVar0.x);
	if (func_405() != -1)
	{
		if (func_404(*uParam2) == 2)
		{
			if (!func_103(uParam1, 4))
			{
				func_578(4);
				func_579(uParam1, uParam2, 4);
			}
		}
	}
	if (func_486(_NAMESPACE26::_0x4BE6C13A45CCA8EC(_NAMESPACE26::_0x901E0DC25080C8B9(PLAYER::PLAYER_ID()))))
	...
	if (func_554(*uParam2) != 0 || func_553(*uParam2) != 0)
	{
		func_328(uParam1);
		func_336(uParam1);
	}
	...
	{
		if (!_NAMESPACE26::_0x424B17A7DC5C90BC(uParam1->f_7))
		{
			func_230(uParam1, uParam2);
			func_570(uParam1);
			func_336(uParam1);
...
void func_391(var uParam0, var uParam1, bool bParam2, bool bParam3)
{
	...
	if (func_554(*uParam1) != 0)
	{
		func_263(uParam0, uParam1, &uVar0, bParam3);
	}
	if (func_553(*uParam1) != 0)
	{
...
{
	Global_1123331->f_291.f_1 = iParam0;
}
...
void func_396(int iParam0, var uParam1, var uParam2, var uParam3, struct<2> Param4, int iParam6, var uParam7, var uParam8, var uParam9, int iParam10)
{
	...
	uVar35 = func_588(iParam0);
	func_589(&(Var0.f_19), Var0.f_11, vVar32, uVar35);
	func_532(&Var0, uVar31);
}
...
int func_397(var uParam0, var uParam1, var uParam2)
{
	...
	Var0.f_1 = -1;
	return func_590(uParam0, uParam1, uParam2, &Var0);
}
...
void func_398(int iParam0, int iParam1, int iParam2, int iParam3, int iParam4, struct<2> Param5, var uParam7)
{
	...
	switch (iParam4)
	{
		case 2:
			...
			else if (PED::IS_PED_MALE(PLAYER::GET_PLAYER_PED(PLAYER::PLAYER_ID())))
			{
				switch (Global_1070355->f_26827.f_2)
				{
					case 0:
						Var0.f_18 = 7;
						break;
		...
		default:
			...
			Var0.f_18 = func_594(func_77(iParam2), func_591(iParam1), iVar31, func_592(iParam0, iParam3), func_593(iParam0));
			if (func_134(iParam2) == -800238780 || func_134(iParam2) == joaat("TRAIN"))
			{
				if (Var0.f_18 == -1)
				{
					Var0.f_17 = 4;
	...
	func_589(&(Var0.f_19), iVar33, vVar34, uVar37);
	func_532(&Var0, uVar32);
}

var func_399(int iParam0, int iParam1)
{
	return (((*Global_1113330)[iParam0 /*1991*/])->f_24.f_2[iParam1 /*31*/])->f_2;
}
...
void func_402(int iParam0)
{
	...
	Global_1123331->f_293 = 1;
	Global_1123331->f_293.f_1 = iParam0;
}
...
void func_403(var uParam0)
{
	...
	bVar0 = !CAM::DOES_CAM_EXIST(CAM::GET_RENDERING_CAM());
	CAM::SET_CAM_ACTIVE(uParam0->f_131, true);
	if (bVar0)
	{
...
{
	return ((*Global_1113330)[iParam0 /*1991*/])->f_15;
}

int func_405()
{
	return Global_1123331->f_291;
}
...
int func_406(int iParam0, int iParam1)
{
	...
	iVar0 = func_597(func_596(iParam0, iParam1));
	if (!UNLOCK::_UNLOCK_IS_UNLOCKED(iVar0))
	{
		return 0;
	}
...
int func_407(var uParam0, int iParam1)
{
	...
	if (!func_599(&Var1, func_598(iVar0), -1, -1, 3))
	{
		return 0;
	}
	uVar68 = func_600(iVar0);
	Var1.f_53 = { func_601(iVar0) };
	func_602();
	func_604(iVar0, uVar68, func_603(func_591(uParam0->f_1)), iParam1);
	func_605(Var1, Var1.f_53, iVar65, iVar66, 0);
	func_606(iVar67);
	func_607(1, 1, 0, 0, 0, 0, 0, 0, 0);
	return 1;
}
...
void func_408(var uParam0, var uParam1, var uParam2)
{
	...
	Var0.f_29.f_1 = 493038497;
	Var31.f_1 = -1;
	if (!func_608(uParam2, &Var0, func_404(*uParam2)))
	{
		return;
	}
	func_561(*uParam2, func_404(*uParam2), &Var31);
	if (func_609(&(Var0.f_23), 518798111))
	{
		if (func_609(&(Var0.f_23), 1859868723))
		{
			func_395(&uVar36, 2);
		}
		func_396(uParam2->f_1, uParam2->f_2, uVar36, Var0.f_2, Var0, Var31, 0);
		bVar35 = true;
	}
	else
	{
		bVar35 = func_590(&Var0, uParam2->f_2, uParam2->f_1, &Var31);
	}
	if (!bVar35)
	{
		return;
...
int func_409()
{
	return Global_1123331->f_291.f_1;
}
...
int func_410(var uParam0, int iParam1)
{
	...
	while (iVar0 <= (3 - 1))
	{
		iVar1 = func_610(uParam0, (iVar0 * iParam1));
		if (ENTITY::IS_ENTITY_VISIBLE(func_533(*uParam0, iVar1)))
		{
			return iVar1;
		}
		iVar0++;
...
void func_412(var uParam0, var uParam1)
{
	...
	iVar0 = HUD::_UIPROMPT_GET_GROUP_ID_FOR_TARGET_ENTITY(func_93(*uParam1, 303108068));
	HUD::_UIPROMPT_SET_ACTIVE_GROUP_THIS_FRAME(iVar0, &(uParam0->f_99.f_20), 1, 0, 0, 0);
}
...
void func_413(var uParam0)
{
	...
	CAM::SET_CAM_ACTIVE(uParam0->f_131, true);
	CAM::SET_CAM_ACTIVE(uParam0->f_131.f_5, true);
	CAM::SET_CAM_ACTIVE_WITH_INTERP(uParam0->f_131, uParam0->f_131.f_5, 750, 1, 1);
}
...
int func_420(var uParam0)
{
	...
	{
		case 1:
			return func_612(2103384153 /* GXTEntry: "Bounty Hunter License" */, 0, 1, -1, 1);
		default:
			break;
	}
	return 0;
...
int func_421(int* iParam0, bool bParam1, int iParam2, int iParam3, bool bParam4, int iParam5)
{
	struct<5> Var0;
	struct<16> Var5;
	struct<5> Var21;
	...
	if (func_614(bParam1))
	{
		return func_617(iParam0, func_615(bParam1, 1), Var0, 1, 1, iParam3, 0, bParam4, iParam5, func_616(bParam1));
	}
	Var5.f_9 = 1;
	Var5.f_11 = -1591664384;
	Var21 = { func_618(bParam1, 1, 1) };
	if (func_619(bParam1, &iVar26))
	{
		return func_617(iParam0, iVar26, Var21, iParam2, 1, iParam3, 0, 0, iParam5, 0);
	}
	if (func_620(bParam1))
	{
		if (!func_621(iParam0, bParam1, Var21, iParam2, &Var5, bParam4, iParam5))
		{
			return 0;
		}
	}
	else if (!func_622(iParam0, bParam1, Var21, Var21.f_4, iParam2, &Var5, iParam3, bParam4, iParam5, 1))
	{
		return 0;
	}
	func_623(Var5);
...
void func_422(var uParam0, var uParam1)
{
	...
	func_502(1, -1636832113 /* GXTEntry: "Bounty Poster" */);
	func_503(1, 1699087565);
...
{
	if (!ENTITY::DOES_ENTITY_EXIST(func_93(*uParam1, uParam0->f_99.f_12)))
	{
		return false;
	}
...
int func_430(int iParam0, struct<2> Param1)
{
	int iVar0;
...
int func_435(var uParam0, var uParam1, var uParam2, var uParam3, int iParam4, int iParam5, int iParam6)
{
	int iVar0;
	int iVar1;
	int iVar2;
	...
	Var71.f_26 = 2;
	Var71.f_26.f_1 = -1;
	Var71.f_26.f_1.f_1 = -1;
	Var71.f_29 = 493038497;
	Var71.f_29.f_1 = 493038497;
	Var102 = 3;
	iVar108 = 255;
	iVar109 = 255;
	iVar108 = _NAMESPACE26::_0x4BE6C13A45CCA8EC(iParam4);
	iVar6 = 0;
	iVar7 = 0;
	if (NETWORK::_0x255A5EF65EDA9167(iVar108))
	{
		if (NETWORK::NETWORK_IS_PLAYER_ACTIVE(iVar108))
		{
			if (NETWORK::NETWORK_IS_PLAYER_A_PARTICIPANT(iVar108))
			{
				iVar109 = NETWORK::NETWORK_GET_PARTICIPANT_INDEX(iVar108);
				if (func_627(iVar109))
				{
					if (NETWORK::NETWORK_IS_PARTICIPANT_ACTIVE(iVar109))
					{
						iVar2 = iVar109;
						if (func_12(iVar2))
						{
							if (((*uParam1)[iVar2 /*14*/])->f_9)
							{
								iVar6 = ((*uParam1)[iVar2 /*14*/])->f_7;
								iVar7 = ((*uParam1)[iVar2 /*14*/])->f_8;
							}
						}
					}
				}
	...
	Var102 = { func_368(*uParam3, uParam2->f_7.f_2.f_24) };
	func_628(&uVar8, 62, 1);
	iVar4 = (100 - MISC::GET_RANDOM_INT_IN_RANGE(0, 100));
	iVar3 = -1;
	iVar0 = 0;
	while (iVar0 <= 61)
	{
		iVar1 = &uVar8[iVar0];
		if (iVar1 < 0 || iVar1 >= func_629(*uParam3))
		{
		}
		else
		{
			...
			if (func_630(Var71.f_2, 1))
			{
			}
			else if (func_433(uParam0, iVar1, *uParam3))
			{
			}
			...
			else
			{
				...
				if (func_369(&Var71, iVar1, &Var102, iParam4, iParam5, uParam3->f_1, &iVar106, iVar107, -1))
				{
					switch (iVar106)
					{
						case 25:
...
void func_436(var uParam0, int iParam1, var uParam2)
{
	*uParam0 = (*uParam0 - (*uParam0 && iParam1));
}

int func_437(var uParam0, var uParam1, var uParam2, var uParam3, int iParam4, int iParam5)
{
	int iVar0;
	int iVar1;
	int iVar2;
	...
	Var5.f_26.f_1.f_1 = -1;
	Var5.f_29 = 493038497;
	Var5.f_29.f_1 = 493038497;
	Var36 = 3;
	iVar0 = _NAMESPACE26::_0x4BE6C13A45CCA8EC(iParam4);
	Var36 = { func_368(*uParam3, uParam2->f_7.f_2.f_24) };
	if (!NETWORK::_0x255A5EF65EDA9167(iVar0))
	{
		return -1;
	}
	...
	Var3 = { ((*uParam1)[iVar1 /*14*/])->f_5 };
	if (!func_25(Var3))
	{
		return -1;
	}
	iVar2 = func_430(*uParam3, Var3);
	if (iVar2 == -1)
	{
		return -1;
	}
	Var5 = { func_367(*uParam3, iVar2) };
	if (func_630(Var5.f_2, 1))
	{
		return -1;
	}
	if (func_433(uParam0, iVar2, *uParam3))
	{
		return -1;
	}
	if (((*uParam1)[iVar1 /*14*/])->f_9)
	{
		if (Var5.f_2.f_1 == ((*uParam1)[iVar1 /*14*/])->f_7 || Var5.f_2.f_1 == ((*uParam1)[iVar1 /*14*/])->f_8)
		{
			return -1;
		}
	}
	...
	if (func_369(&Var5, iVar2, &Var36, iParam4, iParam5, uParam3->f_1, &uVar40, iVar41, -1))
	{
		return -1;
	}
	return iVar2;
...
void func_438(var uParam0, int iParam1, int iParam2, int iParam3, int iParam4, int iParam5, int iParam6, bool bParam7)
{
	...
	iVar2 = func_634(*uParam0);
	iVar3 = func_71(*uParam0);
	iVar4 = func_635(*uParam0);
	iVar5 = func_636(*uParam0);
	...
	func_638(uParam0, iVar5, iVar4, iVar3, iVar2, iVar1, iVar0);
}

void func_439(var uParam0, int iParam1, var uParam2)
{
	if (iParam1 == -1)
	{
		return;
	}
	func_639(&(uParam0->f_197), iParam1, 3);
}
...
void func_440(var uParam0)
{
	...
	Var0.f_5 = { *uParam0 };
	Var0.f_4 = 0;
	func_640(&Var0, func_531(0, 8));
}

int func_441(var uParam0, var uParam1, bool bParam2, int iParam3, int iParam4, int iParam5, int iParam6)
{
	int iVar0;
	int iVar1;
	...
	iVar0 = func_643(uParam0, uParam1);
	if (iVar0 >= 0)
	{
		return 0;
	}
	switch (uParam1->f_5)
	{
		...
		default:
			break;
			if (!func_644(uParam1, bParam2, iParam3, iParam4, iParam5, iParam6))
			{
				return 0;
			}
			break;
	...
	*(uParam0->f_3[iVar1 /*40*/]) = { *uParam1 };
	func_645(uParam0->f_3[iVar1 /*40*/], 0);
	*uParam0++;
	return 1;
}

void func_442(var uParam0, int iParam1, var uParam2)
{
	*uParam0 = (*uParam0 || iParam1);
}
...
int func_443(var uParam0)
{
	...
	iVar0 = func_647(uParam0, uParam0->f_9);
	if (iVar0 != -1)
	{
		return iVar0;
	}
...
struct<15> func_445(int iParam0)
{
	struct<15> Var0;
...
{
	return func_648(func_70(), iParam0, bParam1);
}
...
int func_447(var uParam0, int iParam1, int iParam2)
{
	...
	{
		iVar53 = NETWORK::NETWORK_GET_PLAYER_FROM_GAMER_HANDLE(Var0[iVar51 /*7*/]);
		if (!NETWORK::_0x255A5EF65EDA9167(iVar53))
		{
		}
		else if (!NETWORK::NETWORK_IS_PLAYER_ACTIVE(iVar53))
		{
		}
		else if (!NETWORK::NETWORK_IS_PLAYER_A_PARTICIPANT(iVar53))
		{
		}
		else
		{
			iVar52 = NETWORK::NETWORK_GET_PARTICIPANT_INDEX(iVar53);
			if (iVar52 < 0 || iVar52 >= 32)
			{
			}
			else if (func_120(&(((*uParam0)[iVar52 /*14*/])->f_1), iParam2))
			{
				return iVar53;
			}
		}
...
bool func_448(int iParam0, int iParam1)
{
	...
	return func_625(iParam1) == iParam0;
}

bool func_449(int iParam0, int iParam1)
{
	return (((*Global_1121338)[iParam0 /*54*/])->f_52 && iParam1) != 0;
}
...
int func_453(vector3 vParam0, var uParam3, var uParam4, var uParam5, int iParam6)
{
	int iVar0;
	int iVar1;
	var uVar2;
	...
	iVar10 = iVar0;
	iVar1 = func_652(iVar10, 1);
	if (iVar1 == -1)
	{
		return 0;
	}
	vParam0.f_2 = -904522836;
	if (!DATAFILE::_DATAFILE_GET_STRING(&uVar2, &vParam0))
	{
		return 0;
	}
	DATAFILE::_DATAFILE_GET_HASH(&iVar0, &vParam0);
...
{
	return &(uParam0->f_137[iParam1 /*2*/]);
}

int func_457(int iParam0)
{
	return ((*Global_1113330)[iParam0 /*1991*/])->f_5;
}

int func_458(int iParam0)
{
	return func_77(func_457(iParam0));
}
...
int func_472(vector3 vParam0, vector3 vParam3, float fParam6, bool bParam7)
{
	if (fParam6 < 0f)
	{
		fParam6 = 0f;
...
void func_474(var uParam0)
{
	...
	func_654(&(uParam0->f_99[0]), MISC::_CREATE_VAR_STRING(2, "GFH_ACCEPT_NO_MISSION"), 1);
	uParam0->f_99.f_14 = -1;
	uParam0->f_99.f_16 = -1;
}
...
void func_475(var uParam0)
{
	...
	func_654(&(uParam0->f_99[0]), MISC::_CREATE_VAR_STRING(2, "GFH_GREET_NO_MISSION"), 1);
	uParam0->f_99.f_14 = -2;
	uParam0->f_99.f_16 = -1;
}
...
void func_476(var uParam0, var uParam1, int iParam2)
{
	...
	iVar0 = func_497(*uParam1, iParam2);
	switch (iVar0)
	{
		case 493038497:
			iVar1 = 0;
			break;
		case joaat("POSITIVE"):
			iVar1 = MISC::_CREATE_VAR_STRING(2, "GFH_BLIP_GUNSLINGER");
			break;
		case joaat("NEGATIVE"):
			iVar1 = MISC::_CREATE_VAR_STRING(2, "GFH_BLIP_OUTLAW");
			break;
		default:
			break;
	}
	sVar2 = MISC::_CREATE_VAR_STRING(0, func_655(*uParam1, iParam2));
	...
	switch (uParam0->f_7.f_2.f_14)
	{
		case 1:
			if (func_361(*uParam1, iParam2, -890716772))
			{
				if (iVar0 == 493038497)
				{
					HUD::_UIPROMPT_SET_TEXT(iVar3, MISC::_CREATE_VAR_STRING(10, "GFH_ACCEPT", sVar2));
				}
				else
				{
					HUD::_UIPROMPT_SET_TEXT(iVar3, MISC::_CREATE_VAR_STRING(42, "GFH_ACCEPT_BLIP", iVar1, sVar2));
				}
			}
			else if (iVar0 == 493038497)
			{
				HUD::_UIPROMPT_SET_TEXT(iVar3, MISC::_CREATE_VAR_STRING(42, "GFH_ACCEPT_BLIP", "GFH_BLIP_OFFENSIVE", sVar2));
			}
			else
			{
				HUD::_UIPROMPT_SET_TEXT(iVar3, MISC::_CREATE_VAR_STRING(170, "GFH_ACCEPT_BLIP_TO_OFFENSIVE", "GFH_BLIP_OFFENSIVE", iVar1, sVar2));
			}
			break;
		default:
			if (iVar0 == 493038497)
...
void func_477(var uParam0)
{
	...
	func_654(&(uParam0->f_99[1]), MISC::_CREATE_VAR_STRING(2, "GFH_GREET_NO_MISSION"), 1);
	uParam0->f_99.f_15 = -1;
	uParam0->f_99.f_17 = -1;
}
	...
	switch (uParam0->f_7.f_2.f_14)
	{
		case 1:
			if (func_361(*uParam1, iParam2, -890716772))
			{
				if (iVar0 == 493038497)
				{
					HUD::_UIPROMPT_SET_TEXT(iVar2, MISC::_CREATE_VAR_STRING(2, "GFH_TALK"));
				}
				else
				{
					HUD::_UIPROMPT_SET_TEXT(iVar2, MISC::_CREATE_VAR_STRING(10, "GFH_GREET_BLIP", iVar1));
				}
			}
			else if (iVar0 == 493038497)
			{
				HUD::_UIPROMPT_SET_TEXT(iVar2, MISC::_CREATE_VAR_STRING(10, "GFH_GREET_BLIP", "GFH_BLIP_OFFENSIVE"));
			}
			else
			{
				HUD::_UIPROMPT_SET_TEXT(iVar2, MISC::_CREATE_VAR_STRING(42, "GFH_GREET_BLIP_TO_OFFENSIVE", "GFH_BLIP_OFFENSIVE", iVar1));
			}
			break;
		default:
			if (iVar0 == 493038497)
...
void func_481(var uParam0, var uParam1)
{
	...
	fVar6 = 70f;
	if (!func_656(uParam0, uParam1, &vVar0, &vVar3))
	{
		return;
	}
	uParam0->f_131 = CAM::CREATE_CAMERA(26379945, false);
	CAM::SET_CAM_COORD(uParam0->f_131, vVar0);
	CAM::SET_CAM_ROT(uParam0->f_131, vVar3, 2);
	CAM::SET_CAM_FOV(uParam0->f_131, fVar6);
	CAM::SET_CAM_ACTIVE(uParam0->f_131, false);
}
...
void func_483(var uParam0, var uParam1)
{
	...
	fVar6 = 70f;
	if (!func_658(uParam1, &vVar0, &vVar3))
	{
		return;
	}
	uParam0->f_131.f_5 = CAM::CREATE_CAMERA(26379945, false);
	CAM::SET_CAM_COORD(uParam0->f_131.f_5, vVar0);
	CAM::SET_CAM_ROT(uParam0->f_131.f_5, vVar3, 2);
	CAM::SET_CAM_FOV(uParam0->f_131.f_5, fVar6);
	CAM::SET_CAM_ACTIVE(uParam0->f_131.f_5, false);
}

void func_484(var uParam0, var uParam1, int iParam2)
{
	(uParam0->f_137[iParam2 /*2*/])->f_1 = 0;
}
...
int func_486(int iParam0)
{
	...
	while (iVar50 <= (iVar51 - 1))
	{
		...
		else if (func_659(1048576, iVar52))
		{
			return 1;
		}
		iVar50++;
...
Vector3 func_488(float fParam0)
{
...
Vector3 func_490(vector3 vParam0)
{
	float fVar0;
	float fVar1;
...
{
	return (((*Global_1113330)[iParam0 /*1991*/])->f_24.f_2[iParam1 /*31*/])->f_29;
}
...
void func_501(int iParam0, int iParam1)
{
	...
	if (MAP::DOES_BLIP_EXIST(&(Global_1103536->f_255.f_5295[iParam0])))
	{
		MAP::REMOVE_BLIP(Global_1103536->f_255.f_5295[iParam0]);
	}
	Global_1103536->f_255.f_5295[iParam0] = MAP::_0x3E593DF9C2962EC6(iParam1);
}
...
void func_502(int iParam0, int iParam1)
{
	...
	MAP::SET_BLIP_SPRITE(iVar0, iParam1, true);
}
...
void func_503(int iParam0, int iParam1)
{
	...
	if (MAP::_0xEDD964B7984AC291(iVar0, iParam1))
	{
	}
}
...
void func_504(int iParam0, int iParam1)
{
	...
	if (MAP::_0x662D364ABF16DE2F(iVar0, iParam1))
	{
	}
}
...
{
	return func_202(&(uParam0->f_23), func_662(iParam1, 1), 18);
}

int func_508(int iParam0)
{
	if (Global_1103536->f_21.f_120 != 1)
	{
		return 0;
	}
	return func_202(&(Global_1103536->f_21.f_120), iParam0, 1);
}
...
void func_509(int iParam0)
{
	...
	if (func_639(&(Global_1103536->f_21.f_120), iParam0, 1))
	{
	}
}
...
int func_516(var uParam0, int iParam1, var uParam2, int iParam3)
{
	if (func_664(iParam3, 16))
	{
		return 0;
	}
	if (!func_185())
	...
	if (func_630(uParam0->f_2, 1))
	{
		return 0;
	}
	if (func_665(uParam2, iParam1))
	{
		return 0;
	}
	return 5;
...
int func_519(var uParam0, int iParam1, int iParam2, int iParam3)
{
	int iVar0;
...
int func_522(int iParam0)
{
	...
	if (func_25(((*Global_1055965)[iVar0 /*436*/])->f_2))
	{
		return 6;
	}
	return 0;
...
int func_524(var uParam0, int iParam1, int iParam2)
{
	if (func_664(iParam2, 512))
	{
		return 0;
	}
...
int func_528(var uParam0, bool bParam1, int iParam2, int iParam3, int iParam4)
{
	vector3 vVar0;
	var uVar3;
	bool bVar4;
	...
	bVar4 = func_66(bParam1, 536870912);
	if (func_609(&(uParam0->f_23), 2015728894) || func_609(&(uParam0->f_23), -1211373264))
	{
		if (!func_670(iParam2, vVar0, uVar3))
		{
			return 33;
		}
	}
	uVar5 = func_671(*uParam0);
	iVar6 = func_672(uParam0->f_2, uVar5);
	if (!bVar4)
	{
		iVar7 = 0;
		while (iVar7 < iVar6)
		{
			vVar8 = { func_673(uParam0->f_2, uVar5, iVar7) };
			if (func_219(vVar8))
			{
			}
...
int func_529(var uParam0, bool bParam1)
{
	var uVar0;
	int iVar1;
	bool bVar2;
	...
	uVar0 = func_671(*uParam0);
	iVar1 = func_672(uParam0->f_2, uVar0);
	bVar2 = func_66(bParam1, 536870912);
	if (!bVar2)
	{
		iVar3 = 0;
		while (iVar3 < iVar1)
		{
			vVar4 = { func_673(uParam0->f_2, uVar0, iVar3) };
			if (func_219(vVar4))
			{
			}
...
int func_530(var uParam0, int iParam1, int iParam2)
{
	int iVar0;
	int iVar1;
	var uVar2;
	...
	bVar3 = func_664(iParam1, 1073741824);
	bVar4 = func_664(iParam1, 536870912);
	if (func_664(iParam1, 8192))
	{
		vVar5 = { 0f, 0f, 0f };
	}
	else
	{
		vVar5 = { func_489(_NAMESPACE26::_0x4BE6C13A45CCA8EC(iParam2)) };
	}
	func_674(*uParam0, &iVar1, &uVar2);
	iVar8 = func_676(iVar1, uVar2, func_675(iVar1), vVar5, !bVar3, bVar4, 1, -1082130432);
	if (iVar8 != 0)
	{
		switch (iVar8)
		{
...
{
	return func_677(0f, 0f, 0f, 0f, 0f, 0f, 0f, 0f, 0f, 665633627, iParam0, iParam1);
}
...
{
	return Global_1113330->f_7982[iParam0 /*4*/][iParam1];
}

bool func_534()
{
	return (UNLOCK::_UNLOCK_IS_UNLOCKED(-2062544048) && UNLOCK::_UNLOCK_IS_VISIBLE(-2062544048));
}
...
int func_535(int iParam0)
{
	...
	while (iVar0 <= (func_679(iParam0) - 1))
	{
		if (!func_680(iVar0))
		{
		}
		else if (!func_681(iVar0))
		{
		}
		else
		{
...
bool func_536()
{
	...
	if (!BOUNTY::_0x8FAF4D262FABA99C(&iVar0))
	{
		return true;
	}
	return Global_1273882->f_21 < iVar0;
}
...
int func_538()
{
	if (func_684(2103384153 /* GXTEntry: "Bounty Hunter License" */, 1, 1, 0) == 0)
	{
		return 0;
	}
	return 1;
...
void func_539(var uParam0, var uParam1)
{
	...
	{
		bVar9 = (ENTITY::DOES_ENTITY_EXIST(func_533(*uParam1, iVar10)) && ENTITY::IS_ENTITY_VISIBLE(func_533(*uParam1, iVar10)));
		if (bVar9)
		{
...
void func_546(var uParam0)
{
	...
	sVar0 = func_687(2103384153 /* GXTEntry: "Bounty Hunter License" */, func_420(uParam0), 1, 0, 1);
	iVar1 = func_316(&(uParam0->f_99[9]));
	switch (uParam0->f_99.f_30)
	{
		case 1:
			HUD::_UIPROMPT_SET_TEXT(iVar1, MISC::_CREATE_VAR_STRING(2, "GFH_PURCHASE_BOUNTY_HUNTING_LICENSE_GOLD", sVar0));
			break;
		default:
			break;
	}
...
bool func_547(bool bParam0, int iParam1, bool bParam2)
{
	var uVar0;
	var uVar2;

	return func_688(bParam0, iParam1, bParam2, &uVar0, &uVar2, 0, 0);
}
...
{
	Global_1051387->f_4354.f_3 = iParam0;
	Global_1051387->f_4354.f_4 = iParam1;
	Global_1051387->f_4354.f_5 = iParam2;
}

void func_550(int iParam0)
{
	Global_1051387->f_4354 = iParam0;
}
...
void func_551(var uParam0)
{
	...
	{
		case 1:
			HUD::_UIPROMPT_SET_TEXT(iVar0, MISC::_CREATE_VAR_STRING(2, "GFH_ZOOM"));
			break;
		case 0:
			HUD::_UIPROMPT_SET_TEXT(iVar0, MISC::_CREATE_VAR_STRING(2, "SHOP_USE_GOLD"));
			break;
		default:
			break;
	}
...
{
	return ((*Global_1113330)[iParam0 /*1991*/])->f_13;
}

int func_553(int iParam0)
{
	return ((*Global_1113330)[iParam0 /*1991*/])->f_11;
}

int func_554(int iParam0)
{
	return ((*Global_1113330)[iParam0 /*1991*/])->f_12;
}
...
{
	if (!CAM::DOES_CAM_EXIST(&(uParam0->f_131.f_1[iParam1])))
	{
		return;
	}
	if (!CAM::DOES_CAM_EXIST(uParam0->f_131))
	...
	CAM::SET_CAM_ACTIVE(&(uParam0->f_131.f_1[iParam1]), true);
	CAM::SET_CAM_ACTIVE(uParam0->f_131, true);
	CAM::SET_CAM_ACTIVE_WITH_INTERP(&(uParam0->f_131.f_1[iParam1]), uParam0->f_131, 750, 1, 1);
}

void func_559(int iParam0, int iParam1)
{
	((*Global_1113330)[iParam0 /*1991*/])->f_13 = iParam1;
}
...
void func_560(var uParam0, int iParam1)
{
	...
	CAM::SET_CAM_ACTIVE(uParam0->f_131, true);
	CAM::SET_CAM_ACTIVE(&(uParam0->f_131.f_1[iParam1]), true);
	CAM::SET_CAM_ACTIVE_WITH_INTERP(uParam0->f_131, &(uParam0->f_131.f_1[iParam1]), 750, 1, 1);
}

void func_561(int iParam0, int iParam1, int iParam2)
{
	MISC::_COPY_MEMORY(iParam2, ((*Global_1113330)[iParam0 /*1991*/])->f_24.f_1925[iParam1 /*4*/], 4);
}
...
void func_569(var uParam0)
{
	...
	CAM::SET_CAM_ACTIVE(uParam0->f_131.f_5, true);
	CAM::SET_CAM_ACTIVE(uParam0->f_131, true);
	CAM::SET_CAM_ACTIVE_WITH_INTERP(uParam0->f_131.f_5, uParam0->f_131, 750, 1, 1);
}
...
{
	return ((*Global_1109623)[iParam0 /*42*/])->f_2;
}

int func_572(int iParam0, int iParam1)
{
	return &(((*Global_1123331)[iParam0 /*18*/])->f_2[iParam1 /*5*/]);
}
...
int func_574(var uParam0)
{
	...
	iVar1 = func_571(uParam0->f_1);
	iVar0 = 0;
	while (iVar0 <= (3 - 1))
	{
		iVar2 = func_572(iVar1, iVar0);
		if (iVar2 != 0)
		{
			return 1;
		}
...
void func_576(var uParam0, var uParam1)
{
	...
	if (func_499(func_498(-619416644)) >= 1)
	{
		return;
	}
	iVar1 = 0;
	...
	iVar4 = func_308(MISC::_CREATE_VAR_STRING(0, iVar3), 10000, 0, 0, 0, 1);
	func_309(uParam0, uParam1, iVar0, iVar4);
	func_506(func_498(-619416644), 1);
}
...
void func_577(var uParam0, var uParam1, int iParam2)
{
	...
	if (func_499(func_498(63391007)) >= 3)
	{
		return;
	}
	...
	if (_NAMESPACE26::_0x149A2751AB66AC02(_NAMESPACE26::_0x901E0DC25080C8B9(PLAYER::PLAYER_ID())) >= iVar1)
	{
		return;
	}
	iVar2 = func_307(uParam0, uParam1, iVar0);
	...
	iVar3 = func_308(MISC::_CREATE_VAR_STRING(0, iVar2), 10000, 0, 0, 0, 1);
	func_309(uParam0, uParam1, iVar0, iVar3);
	func_506(func_498(63391007), 1);
}

void func_578(int iParam0)
{
	Global_1123331->f_295 = (Global_1123331->f_295 || iParam0);
}
...
bool func_585()
{
	return (UNLOCK::_UNLOCK_IS_UNLOCKED(1320158438) && UNLOCK::_UNLOCK_IS_VISIBLE(1320158438));
}

bool func_586()
{
	return (UNLOCK::_UNLOCK_IS_UNLOCKED(1355693032) && UNLOCK::_UNLOCK_IS_VISIBLE(1355693032));
}
...
void func_589(var uParam0, int iParam1, vector3 vParam2, var uParam5)
{
	int iVar0;
	int iVar1;
	int iVar2;
	...
	while (iVar2 <= 31)
	{
		...
		else if (func_691(iVar12, vParam2, uParam5))
		{
			if (iVar0 + 1 < 7)
			{
...
int func_590(var uParam0, var uParam1, var uParam2, var uParam3)
{
	var uVar0;

	if (!func_692(uParam0, &uVar0, uParam2, 0, 0, *uParam3))
	{
		return 0;
	}
	func_693(uParam1, uParam2, *uParam0, uParam0->f_2, *uParam3, PLAYER::PLAYER_ID(), 0, 0);
	return 1;
}
...
{
	return &((((*Global_1113330)[iParam0 /*1991*/])->f_24.f_2[iParam1 /*31*/])->f_4[7]);
}
...
int func_599(var uParam0, int iParam1, int iParam2, int iParam3, int iParam4)
{
	int iVar0;
	int iVar1;
	vector3 vVar2;
	...
	if (iParam2 != -1)
	{
		if ((uParam0->f_21.f_2 == -933924539 && func_699(iParam2)) || (uParam0->f_21.f_2 == 395262693 && func_700(iParam2)))
		{
	...
	iVar1 = func_701(&(Global_265331->f_63755[iVar0 /*8*/]));
	vVar2 = { func_702(uParam0->f_17) };
	if (iVar1 != -1)
	{
		uParam0->f_53 = { func_703(iVar1) };
	}
	else if (func_704(uParam0->f_17))
	{
		uParam0->f_53 = { func_601(func_705(uParam0->f_17)) };
	}
	else if (vVar2.y != -1 && vVar2.x != -1)
	{
		uParam0->f_53 = { func_706(&vVar2) };
	}
	else
	{
		uParam0->f_53 = { func_707(uParam0->f_16) };
		if (!func_25(uParam0->f_53))
		{
			uParam0->f_53 = { func_709(func_708(uParam0->f_21.f_2)) };
		}
	}
	func_710(uParam0);
	func_697(uParam0, 4194304);
...
void func_604(int iParam0, var uParam1, var uParam2, int iParam3)
{
...
void func_605(struct<34> Param0, var uParam34, var uParam35, var uParam36, var uParam37, var uParam38, var uParam39, var uParam40, var uParam41, var uParam42, var uParam43, var uParam44, var uParam45, var uParam46, var uParam47, var uParam48, var uParam49, var uParam50, var uParam51, var uParam52, var uParam53, var uParam54, var uParam55, var uParam56, var uParam57, var uParam58, var uParam59, var uParam60, var uParam61, var uParam62, var uParam63, struct<2> Param64, int iParam66, int iParam67, int iParam68)
{
	func_718(iParam67, Param0.f_33, 2, Param0.f_17, Param64, iParam66, -1, 0, 0, iParam68);
}
...
void func_607(bool bParam0, bool bParam1, int iParam2, int iParam3, int iParam4, int iParam5, int iParam6, bool bParam7, int iParam8)
{
	if (bParam0)
	{
...
int func_608(var uParam0, int iParam1, int iParam2)
{
	int iVar0;
	int iVar1;
	int iVar2;
	...
	Var106.f_26 = 2;
	Var106.f_26.f_1 = -1;
	Var106.f_26.f_1.f_1 = -1;
	Var106.f_29 = 493038497;
	Var106.f_29.f_1 = 493038497;
	Var137 = -1;
	Var137.f_1 = -1;
	Var137.f_2 = -1;
	Var137.f_4 = 8;
	...
	Var137.f_26 = 2;
	Var137.f_26.f_1 = -1;
	Var137.f_26.f_1.f_1 = -1;
	Var137.f_29 = 493038497;
	Var137.f_29.f_1 = 493038497;
	Var168 = -1;
	Var168.f_1 = -1;
	Var168.f_2 = -1;
	Var168.f_4 = 8;
	...
	Var168.f_26 = 2;
	Var168.f_26.f_1 = -1;
	Var168.f_26.f_1.f_1 = -1;
	Var168.f_29 = 493038497;
	Var168.f_29.f_1 = 493038497;
	Var199 = -1;
	Var199.f_1 = -1;
	Var199.f_2 = -1;
	Var199.f_4 = 8;
	...
	Var199.f_26 = 2;
	Var199.f_26.f_1 = -1;
	Var199.f_26.f_1.f_1 = -1;
	Var199.f_29 = 493038497;
	Var199.f_29.f_1 = 493038497;
	Var230 = -1;
	Var230.f_1 = -1;
	Var230.f_2 = -1;
	Var230.f_4 = 8;
	...
	Var230.f_26 = 2;
	Var230.f_26.f_1 = -1;
	Var230.f_26.f_1.f_1 = -1;
	Var230.f_29 = 493038497;
	Var230.f_29.f_1 = 493038497;
	Var261 = -1;
	Var261.f_1 = -1;
	Var261.f_2 = -1;
	Var261.f_4 = 8;
	...
	Var261.f_26 = 2;
	Var261.f_26.f_1 = -1;
	Var261.f_26.f_1.f_1 = -1;
	Var261.f_29 = 493038497;
	Var261.f_29.f_1 = 493038497;
	Var292 = -1;
	Var292.f_1 = -1;
	Var292.f_2 = -1;
	Var292.f_4 = 8;
	...
	Var292.f_26 = 2;
	Var292.f_26.f_1 = -1;
	Var292.f_26.f_1.f_1 = -1;
	Var292.f_29 = 493038497;
	Var292.f_29.f_1 = 493038497;
	Var323 = -1;
	Var323.f_1 = -1;
	Var323.f_2 = -1;
	Var323.f_4 = 8;
	...
	Var323.f_26 = 2;
	Var323.f_26.f_1 = -1;
	Var323.f_26.f_1.f_1 = -1;
	Var323.f_29 = 493038497;
	Var323.f_29.f_1 = 493038497;
	uVar354 = 3;
	func_628(&uVar8, 62, 1);
	iVar360 = _NAMESPACE26::_0x901E0DC25080C8B9(PLAYER::PLAYER_ID());
	iVar2 = func_719(PLAYER::PLAYER_ID());
	iVar6 = -1;
	func_561(*uParam0, iParam2, &vVar71);
	iVar75 = func_584(vVar71.z);
	iVar76 = vVar71.x;
	iVar3 = func_689(iVar76);
	if (iVar3 <= 0 || iVar3 > 6)
	{
		return 0;
	}
	...
	while (iVar0 <= 61)
	{
		...
		iVar4 = 0;
		iVar105 = -1;
		if (iVar1 >= func_629(*uParam0))
		{
		}
		else
		{
			Var106 = { func_367(*uParam0, iVar1) };
			iVar105 = func_510(Var106.f_2);
			if (func_722(iVar105) != 7)
			{
			}
			else if (!func_724(iVar105, func_723(iVar75, 1)))
			{
			}
			else
			{
				iVar5 = func_725(iVar105, -1883278863, -1456364914);
				iVar4 = func_725(iVar105, -1883278863, 1237176269);
				if (iVar4 < iVar5)
				{
				}
				...
				else if (Var199.f_2 != -1)
				{
					if (func_726(&uVar77, Var106.f_2.f_1))
					{
					}
					else
					{
						iVar358 = 48;
						if (func_369(&Var106, iVar1, &uVar354, iVar360, iVar2, uParam0->f_1, &uVar359, iVar358, -1))
						{
							if (Var137.f_2 == -1)
							{
								iVar358 = 48;
								...
								else if (func_726(&uVar77, Var106.f_2.f_1))
								{
									if (Var292.f_2 == -1)
									{
										MISC::_COPY_MEMORY(&Var292, &Var106, 31);
									}
								}
								else
								{
									MISC::_COPY_MEMORY(&Var137, &Var106, 31);
								}
							}
							if (Var230.f_2 == -1)
							{
								...
								else if (func_726(&uVar77, Var106.f_2.f_1))
								{
									if (func_726(&uVar77, Var106.f_2.f_1))
									{
										if (Var323.f_2 == -1)
										{
											MISC::_COPY_MEMORY(&Var323, &Var106, 31);
											func_727(&(Var230.f_23), 518798111);
										}
									}
								}
								else
								{
									MISC::_COPY_MEMORY(&Var230, &Var106, 31);
									func_727(&(Var230.f_23), 518798111);
								}
							}
							if (Var261.f_2 == -1)
							{
								...
								{
									MISC::_COPY_MEMORY(&Var261, &Var106, 31);
									func_727(&(Var261.f_23), 518798111);
								}
							}
						}
						else
						{
							if (Var199.f_2 == -1)
							{
								...
								{
									MISC::_COPY_MEMORY(&Var199, &Var106, 31);
								}
							}
							iVar7 = func_728(&uVar91, Var106.f_2);
							if (iVar6 == -1)
							{
								if (func_726(&uVar77, Var106.f_2.f_1))
								{
								...
								{
									MISC::_COPY_MEMORY(&Var168, &Var106, 31);
									iVar6 = iVar7;
								}
							}
							else if (iVar7 < iVar6)
					...
					iVar0++;
					MISC::_COPY_MEMORY(iParam1, &Var168, 31);
					if (iParam1->f_2 != -1)
					{
						return 1;
					}
					MISC::_COPY_MEMORY(iParam1, &Var199, 31);
					if (iParam1->f_2 != -1)
					{
						return 1;
					}
					MISC::_COPY_MEMORY(iParam1, &Var137, 31);
					if (iParam1->f_2 != -1)
					{
						return 1;
					}
					MISC::_COPY_MEMORY(iParam1, &Var230, 31);
					if (iParam1->f_2 != -1)
					{
						return 1;
					}
					MISC::_COPY_MEMORY(iParam1, &Var261, 31);
					if (iParam1->f_2 != -1)
					{
						return 1;
					}
					MISC::_COPY_MEMORY(iParam1, &Var292, 31);
					if (iParam1->f_2 != -1)
					{
						return 1;
					}
					MISC::_COPY_MEMORY(iParam1, &Var323, 31);
					if (iParam1->f_2 != -1)
					{
						return 1;
					}
...
{
	return func_202(uParam0, func_662(iParam1, 1), 1);
}

int func_610(var uParam0, int iParam1)
{
	return ((func_404(*uParam0) + iParam1) + 3 % 3);
}

int func_611(int* iParam0)
{
	return func_729(iParam0->f_1);
}

bool func_612(bool bParam0, bool bParam1, bool bParam2, bool bParam3, bool bParam4)
{
	int iVar0;
	bool bVar1;
	bool bVar2;

	if (!func_730(bParam0, 0))
	{
		return false;
	}
	if (func_614(bParam0))
	{
		return func_731(func_615(bParam0, 0), bParam1, bParam2, bParam3, func_616(bParam0));
	}
	if (func_732(bParam0, bParam4) || func_733(bParam0))
	{
		bParam1 = 997808187;
	}
	else if (func_616(bParam0) && (func_734(bParam0, &iVar0) || func_735(bParam0, &iVar0)))
	{
		bParam1 = iVar0;
	}
	else
	{
		bVar1 = func_736(bParam0, -570078785);
		bVar2 = func_736(bParam0, -915411861);
		if (bVar1 && !bVar2)
		{
			bParam1 = -570078785;
		}
...
int func_615(bool bParam0, bool bParam1)
{
	struct<6> Var0;

	if (!func_730(bParam0, 0))
	{
		return func_741(func_740(bParam0), bParam1);
	}
...
{
	if (!func_185() && func_742())
	{
		return 1;
	}
	return func_739(bParam0, 1435272033);
}

int func_617(int* iParam0, int iParam1, struct<4> Param2, int iParam6, bool bParam7, int iParam8, int iParam9, int iParam10, bool bParam11, int iParam12, int iParam13)
{
	struct<17> Var0;
	...
	Var0.f_10 = iParam8;
	Var0.f_14 = iParam10;
	if (!func_743(iParam0, iParam1, &Var0, iParam9, bParam11, iParam12, iParam13))
	{
		return 0;
	}
	func_744(Var0);
...
struct<5> func_618(bool bParam0, bool bParam1, int iParam2)
{
	struct<5> Var0;
	int iVar5;
	struct<10> Var6;
	...
	{
		case joaat("clothing"):
			Var0 = { func_747(889965687 /* GXTEntry: "Wardrobe" */, Var0, 1034665895, bParam1) };
			Var0.f_4 = INVENTORY::_0x6452B1D357D81742(bParam0, 889965687);
			break;
		case -427144552:
			Var0 = { func_748(bParam1) };
			if (iParam2 && func_749(bParam0, 1))
			{
				Var6.f_9 = -1591664384;
				if (!func_750(bParam0, &Var0, 1728382685 /* GXTEntry: "Right" */, 0, 0))
				{
					Var0.f_4 = 1728382685; /* GXTEntry: "Right" */
				}
				else if (!func_750(bParam0, &Var0, -649335959 /* GXTEntry: "Left" */, 0, 0))
				{
					Var0.f_4 = -649335959; /* GXTEntry: "Left" */
				}
				else if (func_751(bParam0, &Var6, 1728382685 /* GXTEntry: "Right" */))
				{
					Var0.f_4 = 1728382685; /* GXTEntry: "Right" */
				}
				else
		...
		case -1650247667:
			Var0.f_4 = -1591664384;
			Var0 = { func_752(bParam1) };
			switch (func_753(bParam0))
			{
				case -1070622585:
					Var0.f_4 = -6796437;
					break;
		...
		case joaat("DOG"):
			...
			{
				Var0 = { func_747(-1838434463 /* GXTEntry: "Camp" */, Var0, 1084182731, bParam1) };
			...
			{
				Var0 = { func_747(1384535894, Var0, 1784584921, bParam1) };
...
int func_619(bool bParam0, int iParam1)
{
	int iVar0;
	struct<5> Var1;
	...
	*iParam1 = 0;
	...
	if (func_739(bParam0, 81450561) || func_739(bParam0, 1342455455))
	{
		return 0;
	}
	if (func_614(bParam0))
	...
	iVar0 = func_615(bParam0, 1);
	if (iVar0 == 0)
	{
		return 0;
	}
	if (!func_757(iVar0, -570078785, 0))
	{
		return 0;
	}
	if (Global_1915170->f_21989.f_2 == 1)
	{
		Var1 = { func_618(bParam0, 0, 0) };
...
{
	return func_739(bParam0, 709475682);
}

int func_621(int* iParam0, bool bParam1, struct<4> Param2, int iParam6, var uParam7, bool bParam8, bool bParam9)
{
	struct<16> Var0;
	bool bVar16;
	bool bVar17;
	...
	if (bParam8 == 0)
	{
		bParam8 = func_612(bParam1, bParam8, 1, -1, 1);
	}
	func_759(&bParam9, 32);
	func_759(&bParam9, 64);
	func_759(&bParam9, 4);
	func_759(&bParam9, 128);
	func_759(&bParam9, 2);
	if (iParam6 < 1)
	{
		iParam6 = 1;
	}
	if (!func_760(iParam0, bParam1, Param2, -1591664384, bParam8, iParam6, bParam9, 1))
	{
		return 0;
	}
	Var0 = { func_761(bParam1, Param2, 1084182731, iParam6, 0) };
	Var0.f_13 = bParam8;
	Var0.f_12 = 1248274121;
	*uParam7 = { Var0 };
	if (!func_762(iParam0, 1702063850))
	{
		return 0;
	}
	bVar16 = false;
	...
	while (iVar41 < 5)
	{
		if (!func_730(&(Global_1051387->f_46[iVar41]), 0))
		{
		}
		else if (!func_763(&(Global_1051387->f_46[iVar41]), bVar18, &iVar20, &Var30, &uVar21, 1, iVar19))
		{
		}
		else
		{
			iVar38 = func_746(&(Global_1051387->f_46[iVar41]));
			Var26 = { func_747(&(Global_1051387->f_46[iVar41]), Var30, iVar20, 0) };
			switch (iVar38)
			{
				case -1013984273:
				case 658570475:
					if (!func_750(&(Global_1051387->f_46[iVar41]), &Var30, iVar20, 0, 0))
					{
						if (!&Global_1051387->f_46.f_6[iVar41])
						{
						}
						else if (func_764(&(Global_1051387->f_46[iVar41])))
						{
						}
						else
						{
							bVar40 = bParam8;
							if (func_736(&(Global_1051387->f_46[iVar41]), 997808187))
							{
								bVar40 = 997808187;
							}
							if (!func_765(iParam0, &(Global_1051387->f_46[iVar41]), Var30, iVar20, 1, &Var0, 0, bVar40, 0, bParam9, 0))
							{
								bVar16 = false;
								Jump @628; //curOff = 487
							}
							...
							if (!&Global_1051387->f_46.f_6[iVar41])
							{
								bVar39 = func_766(Var30, iVar20, 0, -1);
								if (!func_730(bVar39, 0))
								{
								}
								else
								{
									Var34 = { func_747(bVar39, Var34, iVar20, 0) };
									if (!func_767(Var34, 0))
									{
										bVar16 = false;
										Jump @628; //curOff = 579
								...
								if (bVar17)
								{
									...
									else
									{
										...
										if (!MISC::IS_BIT_SET(&(Global_1051387->f_4349[(func_770(iVar42, 1) / 32)]), (func_770(iVar42, 1) % 32)))
										{
											func_506(func_115(1137323725, 1914305383), 1);
											MISC::SET_BIT(Global_1051387->f_4349[(func_770(iVar42, 1) / 32)], (func_770(iVar42, 1) % 32));
										}
									}
								}
								return 1;
...
int func_622(int* iParam0, bool bParam1, struct<4> Param2, int iParam6, bool bParam7, int iParam8, int iParam9, bool bParam10, bool bParam11, bool bParam12)
{
	struct<16> Var0;
	struct<17> Var16;
	...
	if (bParam10 == 0)
	{
		bParam10 = func_612(bParam1, bParam10, 1, bParam11, 1);
	}
	if (!func_760(iParam0, bParam1, Param2, iParam6, bParam10, bParam7, bParam11, bParam12))
	{
		return 0;
	}
	Var0 = { func_761(bParam1, Param2, iParam6, bParam7, bParam12) };
	Var0.f_13 = bParam10;
	Var0.f_12 = 1248274121;
	*iParam8 = { Var0 };
	if (func_746(bParam1) == joaat("clothing"))
	{
		Var16.f_9 = 1;
		Var16.f_11 = -1591664384;
		Var16 = { Var0 };
		if (!func_771(iParam0, Var16, 2113164098, iParam9, -1))
		{
			return 0;
		}
	}
	else if (!func_772(iParam0, Var0, 2113164098, iParam9, bParam11))
	{
		return 0;
	}
	return 1;
...
void func_623(struct<9> Param0, var uParam9, var uParam10, var uParam11, var uParam12, var uParam13, var uParam14, var uParam15)
{
	bool bVar0;
	int iVar1;
...
{
	return ((*Global_1113330)[iParam0 /*1991*/])->f_24;
}

bool func_630(int iParam0, int iParam1)
{
	return func_774(&((Global_1103536->f_5569[iParam0 /*5*/])->f_2), iParam1);
}
...
{
	return (BUILTIN::SHIFT_RIGHT(iParam0, 26) & 31 * func_461(MISC::IS_BIT_SET(iParam0, 31), -1, 1)) + 1898;
}
...
void func_638(var uParam0, int iParam1, int iParam2, int iParam3, int iParam4, int iParam5, int iParam6)
{
...
bool func_639(var uParam0, int iParam1, int iParam2)
{
	int iVar0;
	int iVar1;
	bool bVar2;
...
void func_640(var uParam0, var uParam1)
{
	...
	*uParam0 = 4;
	uParam0->f_1 = PLAYER::PLAYER_ID();
	SCRIPTS::TRIGGER_SCRIPT_EVENT(1, uParam0, 45, 43, &uParam1);
}
...
int func_643(var uParam0, var uParam1)
{
	...
	while (iVar0 < *uParam0)
	{
		...
		if (func_781(uParam1, uParam0->f_3[iVar1 /*40*/]))
		{
			return iVar0;
		}
		iVar0++;
...
int func_644(var uParam0, bool bParam1, int iParam2, int iParam3, int iParam4, int iParam5)
{
	struct<29> Var0;
	struct<2> Var32;
	bool bVar34;
	...
	else if (!func_782(func_27(Var32), &Var0))
	{
		return 0;
	}
...
int func_647(var uParam0, int iParam1)
{
	...
	while (iVar6 <= iVar1)
	{
		if (bVar2)
		{
			if (func_62((Global_1184672->f_231[iVar6 /*15*/])->f_5, *uParam0))
			{
				return iVar6;
			}
		}
...
bool func_648(int iParam0, int iParam1, bool bParam2)
{
	if (bParam2)
	{
...
{
	return &((((*Global_1113330)[iParam0 /*1991*/])->f_24.f_2[iParam1 /*31*/])->f_4[5]);
}

int func_656(var uParam0, var uParam1, var uParam2, var uParam3)
{
	vector3 vVar0;
	vector3 vVar3;
	vector3 vVar6;
	...
	if (!ENTITY::DOES_ENTITY_EXIST(iVar35))
	{
		return 0;
	}
	vVar9 = { ENTITY::GET_ENTITY_COORDS(iVar35, true, false) };
	vVar18 = { ENTITY::GET_ENTITY_ROTATION(iVar35, 2) };
	vVar18.x = 0f;
	vVar18.f_1 = 0f;
	vVar0 = { func_786(vVar18) };
	vVar3 = { func_787(vVar0, 0f, 0f, 1f) };
	vVar6 = { func_787(vVar3, vVar0) };
	fVar30 = 0f;
	fVar31 = 0f;
	fVar32 = 0f;
	fVar33 = 0.612f;
	fVar34 = 0.226f;
	uParam3->f_2 = (MISC::GET_HEADING_FROM_VECTOR_2D(vVar0.x, vVar0.y) + 180f);
	vVar12 = { func_788(vVar0, fVar30) };
	vVar15 = { func_788(vVar3, fVar31) };
...
void func_657(var uParam0, var uParam1, int iParam2)
{
	...
	if (CAM::DOES_CAM_EXIST(&(uParam0->f_131.f_1[iParam2])))
	{
		return;
	}
	fVar6 = 70f;
	if (!func_789(uParam1, iParam2, &vVar0, &vVar3))
	{
		return;
	}
	uParam0->f_131.f_1[iParam2] = CAM::CREATE_CAMERA(26379945, false);
	CAM::SET_CAM_COORD(&(uParam0->f_131.f_1[iParam2]), vVar0);
	CAM::SET_CAM_ROT(&(uParam0->f_131.f_1[iParam2]), vVar3, 2);
	CAM::SET_CAM_FOV(&(uParam0->f_131.f_1[iParam2]), fVar6);
	CAM::SET_CAM_ACTIVE(&(uParam0->f_131.f_1[iParam2]), false);
}

int func_658(var uParam0, var uParam1, var uParam2)
{
	vector3 vVar0;
	vector3 vVar3;
	vector3 vVar6;
	...
	iVar35 = 2;
	iVar36 = func_533(*uParam0, iVar35);
	if (!ENTITY::DOES_ENTITY_EXIST(iVar36))
	{
		return 0;
	}
	vVar9 = { ENTITY::GET_ENTITY_COORDS(iVar36, true, false) };
	vVar18 = { ENTITY::GET_ENTITY_ROTATION(iVar36, 2) };
	vVar18.x = 0f;
	vVar18.f_1 = 0f;
	vVar0 = { func_786(vVar18) };
	vVar3 = { func_787(vVar0, 0f, 0f, 1f) };
	...
	fVar33 = 0.349f;
	fVar34 = 0.235f;
	uParam2->f_2 = (MISC::GET_HEADING_FROM_VECTOR_2D(vVar0.x, vVar0.y) + 180f);
	vVar12 = { func_788(vVar0, fVar30) };
	vVar15 = { func_788(vVar3, fVar31) };
	vVar21 = { vVar12 * Vector(fVar33, fVar33, fVar33) };
	vVar24 = { vVar15 * Vector(fVar32, fVar32, fVar32) };
...
int func_667(int iParam0, int iParam1)
{
	...
	return func_791(iParam0, iParam1);
}
...
int func_670(int iParam0, vector3 vParam1, bool bParam4)
{
	int iVar0;
	int iVar1;
	...
	while (iVar0 < 32)
	{
		...
		else if (func_792(iVar1))
		{
		}
		else if (!bParam4 && !func_793(iVar1, vParam1))
		{
		}
		else
		{
...
int func_672(int iParam0, var uParam1)
{
	...
	if (func_219(func_794(iParam0, uParam1)))
	{
		return 0;
	}
	if (!func_795(iParam0, &vVar0, uParam1))
	{
		return 1;
	}
	vVar0.f_2 = -146546566;
...
Vector3 func_673(int iParam0, var uParam1, int iParam2)
{
	vector3 vVar0;
	struct<4> Var3;
	...
	if (iParam2 == 0)
	{
		return func_794(iParam0, uParam1);
	}
	iParam2 = (iParam2 - 1);
	if (!func_795(iParam0, &Var3, uParam1))
	{
		return vVar0;
	}
	Var3.f_2 = -146546566;
...
void func_674(struct<2> Param0, int iParam2, var uParam3)
{
	*iParam2 = func_797(func_796(Param0));
	*uParam3 = func_671(Param0);
}
...
int func_676(int iParam0, var uParam1, int iParam2, vector3 vParam3, bool bParam6, bool bParam7, int iParam8, float fParam9)
{
	int iVar0;
	var uVar1;
	int iVar2;
	...
	uVar1 = func_799(iParam0);
	iVar2 = func_800(uVar1, uParam1);
	if (iVar2 < 0 || iVar2 >= 55)
	{
		return 11;
	}
	if (!bParam7 && func_801(iParam0, iVar2, iParam8, &bVar3))
	{
		if (bVar3)
		{
			return 1;
	...
	if (func_802(uVar1, uParam1))
	{
		vVar4 = { func_803(uVar1, uParam1) };
		iVar7 = func_804(uVar1, iVar2);
		if (!func_805(iVar7, vVar4))
		{
			return 5;
		}
	}
	if (func_806(iParam2) == -1)
	{
		return 6;
	}
	if (fParam9 >= 0f && !func_219(vParam3))
	{
		vVar8 = { func_807(iParam0, iVar2) };
	...
	if (func_808(iParam2))
	{
		iVar11 = func_809(_NAMESPACE26::_0x4BE6C13A45CCA8EC(_NAMESPACE26::_0x901E0DC25080C8B9(PLAYER::PLAYER_ID())));
		if (!func_810(iVar11))
		{
			return 13;
		}
	...
	if (bParam6)
	{
		if (iParam2 != 1717788883 && func_812(func_107(), func_107(), 0, bParam7))
		{
			return 3;
		}
		iVar12 = func_813(iParam0, iVar2);
...
var func_677(vector3 vParam0, vector3 vParam3, vector3 vParam6, int iParam9, int iParam10, int iParam11)
{
	var uVar0;
	int iVar1;
	int iVar2;
	...
	else
	{
		switch (iParam9)
		{
			case 665633627:
				...
				break;
			case -432403087:
				iVar8 = VOLUME::_0x10157BC3247FF3BA(vParam0, vParam3, vParam6, func_816());
				break;
			case -1612834106:
...
{
	return UNLOCK::_UNLOCK_IS_UNLOCKED(func_597(iParam0));
}

bool func_681(int iParam0)
{
	return UNLOCK::_UNLOCK_IS_VISIBLE(func_597(iParam0));
}
...
int func_684(bool bParam0, bool bParam1, bool bParam2, bool bParam3)
{
	if (func_821(bParam0) && !bParam2)
	{
...
int func_685(var uParam0, int iParam1)
{
	...
	if (func_405() != -1 && iParam1 == 2)
	{
		return func_823(func_405());
	}
	Var0.f_1 = -1;
	func_561(*uParam0, iParam1, &Var0);
	return func_824(Var0, Var0.f_1, 1, 4);
}

struct<8> func_686(var uParam0, int iParam1)
{
	struct<8> Var0;
	struct<2> Var8;
	...
	if (func_405() != -1 && iParam1 == 2)
	{
		return func_825(func_405());
	}
	Var8.f_1 = -1;
	func_561(*uParam0, iParam1, &Var8);
	func_826(Var8, Var8.f_1, &Var0, 1, 4);
	return Var0;
}

int func_687(bool bParam0, bool bParam1, bool bParam2, bool bParam3, bool bParam4)
{
	int iVar0;
	bool bVar1;
	int iVar2;
	...
	bVar1 = func_619(bParam0, &iVar0);
	if ((bParam2 && bVar1) || ((func_737() && bVar1) && bParam1 == 0))
	{
		if (func_757(iVar0, 997808187, 0) && !func_827(iVar0, 997808187))
		{
			Global_1051387->f_45 = 0;
			Global_1051387->f_58 = bParam0;
			return Global_1051387->f_45;
		}
		else if (func_757(iVar0, -570078785, 0))
		{
			if (bParam3)
			{
				iVar2 = func_828(iVar0, -570078785, 0, 1);
			}
			else
			{
				iVar2 = func_829(func_828(iVar0, -570078785, 0, 1));
			}
	...
	if (bVar3 == 0)
	{
		bVar3 = func_612(bParam0, bVar3, 1, -1, 1);
	}
	iVar4 = 0;
	if (func_830(bParam0))
	{
		iVar4 = func_831(bParam0);
	}
	else if (func_832(bParam0))
	{
		iVar4 = func_833(bParam0);
	}
	if (iVar4 != 0)
	{
		iVar2 = func_828(iVar4, bVar3, 0, 1);
		bVar5 = false;
		if (func_834(bVar3))
		{
			if (func_835(iVar4, 773203532 /* GXTEntry: "Gold Bar" */, bVar3, 1, 1) > 0)
			{
				bVar5 = true;
			}
		}
	...
	{
		iVar2 = func_836(bParam0, bVar3, bParam4, 0, 1, 0);
		bVar6 = false;
		if (func_834(bVar3))
		{
			if (func_837(bParam0, 773203532 /* GXTEntry: "Gold Bar" */, bVar3, 1, 1) > 0)
			{
				bVar6 = true;
			}
		}
...
int func_688(bool bParam0, bool bParam1, bool bParam2, var uParam3, var uParam4, bool bParam5, int iParam6)
{
	struct<2> Var0[15];
	int iVar31;
	int iVar32;
	...
	if (func_614(bParam0))
	{
		return func_838(func_615(bParam0, 1), bParam2, uParam3);
	}
	if (!func_839(bParam0, bParam2, &Var0, &iVar31, 1, 0))
	{
		return 0;
	}
	bVar35 = (func_840(0) && !func_841());
	if (iParam6 != 0)
	{
		if (func_50() == 0)
		{
	...
	while (iVar34 < iVar31)
	{
		...
		else
		{
			...
			if (&Var0[iVar34 /*2*/] == 2084597891 && func_842(iVar32))
			{
				Jump @438; //curOff = 179
			}
			else if (&Var0[iVar34 /*2*/] == 773203532 && func_843(iVar32))
			{
			}
			else
			{
				if (iParam6 != 0)
				{
					iVar33 = func_844(&(Var0[iVar34 /*2*/]), iParam6);
				}
				else
				{
					iVar33 = func_845(&(Var0[iVar34 /*2*/]), 0, !bVar35, 1);
				}
				if (iVar33 >= iVar32)
				{
				}
				...
				{
					if (func_846(&(Var0[iVar34 /*2*/])) || func_847(&(Var0[iVar34 /*2*/])))
					{
						iVar36 = 0;
						if (bParam5)
						{
							iVar37 = func_848(7, &(Var0[iVar34 /*2*/]), &iVar36);
						}
						iVar38 = func_849(&(Var0[iVar34 /*2*/]), iParam6);
						...
						{
							Jump @422; //curOff = 378
							if (bParam5 && ((iVar33 + func_850(7, &(Var0[iVar34 /*2*/]))) + func_851(&(Var0[iVar34 /*2*/]))) >= iVar32)
							{
							}
							else
							{
...
int func_689(int iParam0)
{
	...
	if (!func_854(&uVar0, 3, 0, 0, 1))
	{
		return 0;
	}
	if (!func_854(&uVar0, 4, 0, 0, 1))
	{
		return 0;
	}
	if (!func_854(&uVar0, 6, func_855(iVar5), 0, 1))
	{
		return 0;
	}
	if (!func_854(&uVar0, 7, 0, 0, 1))
	{
		return 0;
	}
	if (!func_854(&uVar0, 8, iParam0, 0, 1))
	{
		return 0;
	}
	if (!func_854(&uVar0, 14, 0, 0, 1))
	{
		return 1;
	}
	return func_856(&uVar0, 0) + 1;
}

bool func_690()
{
	return func_857(_NAMESPACE26::_0x901E0DC25080C8B9(PLAYER::PLAYER_ID()));
}

bool func_691(int iParam0, vector3 vParam1, float fParam4)
{
	return BUILTIN::VDIST(func_489(iParam0), vParam1) <= fParam4;
}

bool func_692(var uParam0, var uParam1, var uParam2, bool bParam3, bool bParam4, var uParam5, var uParam6, var uParam7, var uParam8)
{
	int iVar0;
	int iVar1;
	...
	switch (iVar1)
	{
		...
		case 1:
			*uParam1 = func_859();
			break;
		case 0:
			*uParam1 = func_860(uParam0, bParam3, bParam4, &uParam5, uParam2);
			break;
		default:
			*uParam1 = 1;
			break;
...
void func_693(var uParam0, var uParam1, struct<2> Param2, var uParam4, int iParam5, int iParam6, int iParam7, var uParam8, int iParam9, int iParam10, int iParam11)
{
	struct<28> Var0;
...
int func_694(int iParam0, int iParam1, int iParam2, var uParam3, var uParam4)
{
	struct<5> Var0;

	if (!func_861(&Var0, iParam0, iParam1, iParam2, uParam4))
	{
		return 0;
	}
	if (!func_862(&Var0))
	...
	if (!func_863(&Var0, uParam3, 0))
	{
		return 0;
	}
	return func_864(Var0);
}
...
Vector3 func_702(int iParam0)
{
	...
	if (!func_869(&Var0, 13, 0, 0, 1))
	{
		return vVar5;
	}
	if (!func_869(&Var0, 17, 0, 0, 1))
	{
		return vVar5;
	}
	uVar12 = Var0.f_1;
	iVar9 = func_870(&Var0, 0);
	iVar8 = 0;
	while (iVar8 <= (iVar9 - 1))
	{
		Var0.f_1 = uVar12;
		if (!func_869(&Var0, 19, iVar8, 0, 1))
		{
		}
		else if (!func_869(&Var0, 20, 0, 0, 1))
		{
		}
		else
		{
			iVar10 = func_870(&Var0, 1);
			if (!func_869(&Var0, 22, iParam0, 0, 0))
			{
			}
			else
			{
...
struct<2> func_706(int iParam0)
{
	...
	if (!func_869(&uVar0, 13, 0, 0, 1))
	{
		return func_107();
	}
	if (!func_869(&uVar0, 17, 0, 0, 1))
	{
		return func_107();
	}
	if (!func_869(&uVar0, 19, *iParam0, 0, 1))
	{
		return func_107();
	}
	if (!func_869(&uVar0, 20, 0, 0, 1))
	{
		return func_107();
	}
	if (!func_869(&uVar0, 23, iParam0->f_1, 0, 1))
	{
		return func_107();
	}
	iVar5 = func_871(&uVar0);
	return func_709(iVar5);
}
...
struct<2> func_707(int iParam0)
{
	...
	return func_874(Var5.f_3, Var5.f_4);
}
...
struct<2> func_709(int iParam0)
{
	...
	Var0 = -1;
	Var0.f_1 = -1;
	Var0 = { func_874(iParam0, 2) };
	if (Var0.f_1 >= 0)
	{
		return Var0;
	}
	Var0 = { func_874(iParam0, 7) };
	if (Var0.f_1 >= 0)
	{
		return Var0;
	}
	Var0 = { func_874(iParam0, 5) };
	if (Var0.f_1 >= 0)
	{
		return Var0;
	}
	Var0 = { func_874(iParam0, 6) };
	if (Var0.f_1 >= 0)
	{
		return Var0;
	}
	Var0 = { func_874(iParam0, 8) };
	if (Var0.f_1 >= 0)
	{
		return Var0;
	}
	Var0 = { func_874(iParam0, 3) };
	if (Var0.f_1 >= 0)
	{
		return Var0;
	}
	Var0 = { func_874(iParam0, 4) };
	if (Var0.f_1 >= 0)
	{
		return Var0;
	}
...
int func_711(int iParam0)
{
	...
	if (!BOUNTY::_0x85E4D7B225A30ED1(func_875(iParam0), &Var0))
	{
		return 0;
	}
	switch (Var0.f_1)
...
{
	Global_1274070->f_374.f_2 = iParam0;
}
...
{
	Global_1274070->f_374.f_5 = iParam0;
}

int func_718(int iParam0, var uParam1, int iParam2, int iParam3, struct<2> Param4, int iParam6, int iParam7, bool bParam8, int iParam9, int iParam10)
{
	struct<7> Var0;
	char cVar57[64];
	struct<56> Var65;

	if (!func_876(iParam2, iParam3))
	{
		return 0;
	}
	if (func_877() && Global_1572887->f_106.f_75 != 8)
	{
		return 0;
	}
	if (!func_878(Global_1273882->f_10))
	{
		return 0;
	}
	Var0.f_3 = -1;
	...
	Var0.f_3 = { Param4 };
	func_879(&Var0);
	func_880(iParam2, iParam3, iParam7, 1);
	func_881(Param4, 1);
	func_882(iParam6);
	func_883(iParam9);
	func_884(iParam10, 1);
	if ((func_25(Param4) && !func_885()) && &Global_1197951 == -1)
	{
		func_886(Param4);
	}
	...
	else
	{
		if (iParam2 == 2)
		{
			...
			Var65.f_53.f_1 = -1;
			Var65.f_55.f_3 = -1;
			func_599(&Var65, iParam3, -1, -1, 3);
			StringCopy(&cVar57, func_891(&(Var65.f_37), joaat("COLOR_PURE_WHITE")), 64);
		}
		else if (iParam2 == 1)
		{
			StringCopy(&cVar57, MISC::_CREATE_VAR_STRING(2, func_892(iParam3)), 64);
		}
		else
		{
			StringCopy(&cVar57, MISC::_CREATE_VAR_STRING(2, func_894(func_893(), iParam3)), 64);
		}
	...
	if ((!_NAMESPACE26::_0x424B17A7DC5C90BC(PLAYER::PLAYER_ID()) && func_895(255, 0)) && !bParam8)
	{
		func_896("NM_MATCHMAKING_WARNING");
	}
	func_897(9);
	return 1;
}
...
void func_720(var uParam0)
{
	...
	iVar0 = 0;
	while (iVar0 <= (func_899() - 1))
	{
		iVar1 = func_900(iVar0);
		if (func_34(iVar1))
		{
			iVar2 = func_512(iVar1);
			if (func_106(iVar2))
			{
				iVar4 = func_77(iVar2);
				iVar3 = func_78(iVar4);
...
int func_724(int iParam0, int iParam1)
{
	...
	if (!func_904(Var0, &(Var0.f_1), 7, 0, 0, 1))
	{
		return 0;
	}
	if (!func_904(Var0, &(Var0.f_1), 8, iParam0, 0, 1))
	{
		return 0;
	}
	if (!func_904(Var0, &(Var0.f_1), 24, 0, 0, 0))
	{
		return 1;
	}
	if (!func_904(Var0, &(Var0.f_1), 25, 1628150097, 0, 0))
	{
		return 1;
	}
	return func_904(Var0, &(Var0.f_1), 27, iParam1, 0, 0);
}
...
int func_725(int iParam0, int iParam1, int iParam2)
{
	...
	if (!func_904(Var0, &(Var0.f_1), 25, iParam1, 0, 0))
	{
		return 0;
	}
	if (!func_904(Var0, &(Var0.f_1), 27, iParam2, 0, 0))
	{
		return 0;
	}
	return func_905(Var0, 39, 1);
}
...
{
	if (func_639(uParam0, func_662(iParam1, 1), 1))
	{
	}
}
...
int func_729(int iParam0)
{
	...
	if ((iVar0 == 0 || iVar0 == 1) || iVar0 == 5)
	{
		if (NETSHOPPING::_CASHINVENTORY_TRANSACTION_CHECKOUT_STATUS(iParam0, &iVar1))
		{
			...
			{
				func_907(iParam0, iVar1, 0, 0);
				iVar0 = iVar1;
			}
		}
		else if (iVar0 == 1 || iVar0 == 5)
		{
			func_907(iParam0, 4, 0, 0);
		}
	}
	return iVar0;
}

int func_730(bool bParam0, int iParam1)
{
	if (bParam0 == 0)
	{
		return 0;
...
bool func_731(int iParam0, bool bParam1, bool bParam2, bool bParam3, int iParam4)
{
	...
	bVar1 = func_66(bParam3, 2);
	bVar2 = func_757(iParam0, -570078785, bVar1);
	bVar3 = func_757(iParam0, -915411861, bVar1);
	if (func_757(iParam0, 997808187, bVar1))
	{
		bParam1 = 997808187;
	}
...
bool func_732(bool bParam0, bool bParam1)
{
	...
	return (func_736(bParam0, 997808187) && !func_911(bParam0, 997808187, bParam1));
}
...
int func_733(bool bParam0)
{
	...
	iVar0 = func_615(bParam0, 1);
	if (iVar0 != 0 && func_757(iVar0, 997808187, 0))
	{
...
{
	*iParam1 = func_912(bParam0, 1);
	return *iParam1 != 0;
}

bool func_735(bool bParam0, int iParam1)
{
	*iParam1 = func_913(bParam0, 1, 0);
	return *iParam1 != 0;
}
...
bool func_736(bool bParam0, bool bParam1)
{
	...
	if (func_614(bParam0))
	{
		return func_757(func_615(bParam0, 0), bParam1, 0);
	}
...
{
	return func_739(bParam0, 1279601681);
}
...
int func_739(bool bParam0, int iParam1)
{
	if (!func_730(bParam0, 0))
	{
		return func_914(func_740(bParam0), iParam1);
	}
	if (iParam1 == 0)
	{
		return 0;
...
int func_741(bool bParam0, bool bParam1)
{
	int iVar0;

	if (!func_915(bParam0, 2))
	{
		return 0;
	}
	iVar0 = 0;
...
bool func_742()
{
	return func_916(func_113(0));
}

int func_743(int* iParam0, int iParam1, var uParam2, int iParam3, bool bParam4, bool bParam5, int iParam6)
{
	if (!func_758(iParam0, 0))
	{
		return 0;
	...
	if (bParam4 == 0)
	{
		bParam4 = func_731(iParam1, 0, 1, bParam5, iParam6);
	}
	if (!func_917(iParam1, bParam4, bParam5))
	{
		return 0;
	}
	...
	if (!func_918(iParam0, *uParam2, 541670136, iParam3))
	{
		return 0;
	}
...
void func_744(var uParam0, var uParam1, var uParam2, var uParam3, var uParam4, var uParam5, var uParam6, var uParam7, var uParam8, var uParam9, var uParam10, var uParam11, var uParam12, var uParam13, var uParam14, var uParam15, var uParam16)
{
	AUDIO::PLAY_SOUND_FRONTEND("PURCHASE", "HUD_SHOP_SOUNDSET", true, 0);
}
...
struct<4> func_745(bool bParam0)
{
	...
	{
		iVar0 = func_822(bParam0);
		if (iVar0 == 2)
		{
			if (!INVENTORY::_0xB881CA836CC4B6D4(Global_1270479))
			{
				*Global_1270479 = { func_747(joaat("CHARACTER"), func_919(), -1591664384, bParam0) };
			}
		...
		else if (iVar0 == 3)
		{
			...
			{
				Global_1270479->f_12 = { func_747(joaat("CHARACTER"), func_919(), -1591664384, 0) };
			}
			return Global_1270479->f_12;
		}
	}
	return func_747(joaat("CHARACTER"), func_919(), -1591664384, bParam0);
}
...
struct<4> func_747(bool bParam0, var uParam1, bool bParam2, bool bParam3, var uParam4, bool bParam5, bool bParam6)
{
	struct<4> Var0;
	...
	INVENTORY::_0x886DFD3E185C8A89(func_822(bParam6), &uParam1, bParam0, bParam5, &Var0);
	return Var0;
}
...
struct<4> func_748(bool bParam0)
{
	...
	if (iVar0 == 2)
	{
		...
		{
			Global_1270479->f_4 = { func_747(923904168, func_745(bParam0), -740156546, bParam0) };
		}
	...
	else if (iVar0 == 3)
	{
		...
		{
			Global_1270479->f_16 = { func_747(923904168, func_745(bParam0), -740156546, 0) };
		}
		return Global_1270479->f_16;
	}
	return func_747(923904168, func_745(bParam0), -740156546, 0);
}

int func_749(bool bParam0, bool bParam1)
{
	if (func_753(bParam0) == 1779021115)
	{
		return 0;
	}
...
bool func_750(bool bParam0, var uParam1, bool bParam2, int iParam3, bool bParam4)
{
	return func_921(bParam0, *uParam1, bParam2, iParam3, 1, bParam4) > 0;
}

int func_751(bool bParam0, var uParam1, int iParam2)
{
	var uVar0;

	if (func_922(bParam0, &uVar0, uParam1, iParam2))
	{
...
struct<4> func_752(bool bParam0)
{
	int iVar0;
	...
	if (iVar0 == 2 || iVar0 == 3)
	{
		...
		{
			Global_1270479->f_8 = { func_747(271701509, func_745(bParam0), 12999093, 0) };
		}
		return Global_1270479->f_8;
	}
	return func_747(271701509, func_745(bParam0), 12999093, 0);
}
...
int func_754(bool bParam0, int iParam1)
{
	...
	while (iVar2 < iVar3)
	{
		...
		{
			if (func_923(bParam0, iParam1, bVar0))
			{
				return 1;
			}
		}
...
{
	return func_924(&uParam0, iParam4, bParam5, bParam6, iParam7);
}
...
int func_757(int iParam0, bool bParam1, bool bParam2)
{
	...
	if (bParam2)
	{
		return !func_827(iParam0, bParam1);
	}
	return 1;
}
...
void func_759(bool bParam0, int iParam1)
{
	*bParam0 = (*bParam0 - (*bParam0 && iParam1));
}

int func_760(int* iParam0, bool bParam1, struct<4> Param2, bool bParam6, bool bParam7, bool bParam8, bool bParam9, bool bParam10)
{
	struct<10> Var0;
	struct<4> Var14;
	int iVar19;
	...
	if (func_66(bParam9, 32))
	{
		...
		Var0.f_9 = -1591664384;
		if (!func_755(Param2, &Var0, 1, 0, -1))
		{
			return 0;
		}
		if (!func_923(bParam1, func_753(Var0.f_4), bParam6))
		{
			return 0;
		}
	}
	if (func_66(bParam9, 1))
	{
		if (!func_756(bParam1))
		{
			return 0;
	...
	if (func_66(bParam9, 2))
	{
		if (func_911(bParam1, bParam7, 1))
		{
			return 0;
		}
	}
	if (func_66(bParam9, 4))
	{
		...
		Var14.f_4 = bParam6;
		Var14 = { Param2 };
		iVar19 = func_921(bParam1, Param2, bParam6, 1, !bParam10, 0);
		iVar20 = func_928(bParam1, &Var14, !bParam10, 1);
		iVar21 = 1;
		if (func_929(bParam1, bParam7, &iVar21, 0))
		{
		}
		iVar22 = (func_930(iParam0, bParam1) * iVar21);
		if (iVar22 > 0)
		{
		}
		if (iVar20 >= 0)
	...
	if (func_66(bParam9, 8))
	{
		return func_931(iParam0, bParam1, bParam7, bParam8);
	}
	return 1;
}

struct<16> func_761(bool bParam0, struct<4> Param1, int iParam5, bool bParam6, bool bParam7)
{
	struct<16> Var0;
	...
	Var0.f_11 = -1591664384;
	Var0.f_4 = { Param1 };
	Var0 = { func_747(bParam0, Var0.f_4, iParam5, 1) };
	Var0.f_8 = bParam0;
	Var0.f_9 = bParam6;
	Var0.f_11 = iParam5;
	if (bParam7)
	{
		Var0.f_15 = func_932(bParam0, joaat("DEFAULT"));
		if (Var0.f_15 != 0)
		{
			Var0.f_4 = { func_919() };
			Var0.f_11 = 0;
...
int func_763(bool bParam0, bool bParam1, int iParam2, var uParam3, var uParam4, bool bParam5, int iParam6)
{
	bool bVar0;
	int iVar1;
	bool bVar2;
	...
	{
		iVar1 = func_753(bParam1);
		iVar5 = func_933(bParam1);
		bVar0 = false;
		while (bVar0 < iVar5)
		{
			if (ITEMDATABASE::_ITEM_DATABASE_GET_HAS_SLOT_INFO(iVar1, bVar0, &bVar2))
			{
				if (func_923(bParam0, iVar1, bVar2))
				{
					*uParam4 = { func_618(bParam1, 0, 0) };
					if (iParam6 != 0)
					{
						uParam4->f_4 = iParam6;
					}
					*uParam3 = { func_747(bParam1, *uParam4, uParam4->f_4, 0) };
					*iParam2 = bVar2;
					return 1;
				}
			}
		...
		if (bParam5)
		{
			...
			iVar34 = func_822(0);
			Var37 = { func_618(bParam1, 0, 0) };
			if (iParam6 != 0)
			{
				Var37.f_4 = iParam6;
			}
			Var42 = { func_747(bParam1, Var37, Var37.f_4, 0) };
				...
				if (INVENTORY::_0xCD9A485F2B383B44(iVar34, &Var42, iVar36, &Var6))
				{
					...
					while (bVar0 < iVar5)
					{
						if (ITEMDATABASE::_ITEM_DATABASE_GET_HAS_SLOT_INFO(iVar1, bVar0, &bVar2))
						{
							if (func_923(bParam0, iVar1, bVar2))
							{
								if (func_934(Var42, Var6.f_9, &Var20, 0, -1))
								{
...
{
	return func_739(bParam0, 1282106666);
}

int func_765(int* iParam0, bool bParam1, struct<4> Param2, int iParam6, bool bParam7, int iParam8, bool bParam9, bool bParam10, int iParam11, bool bParam12, bool bParam13)
{
	struct<16> Var0;
	...
	if (bParam10 == 0)
	{
		bParam10 = func_612(bParam1, bParam10, 1, bParam12, 1);
	}
	if (!func_935(iParam0, bParam1, Param2, iParam6, bParam10, bParam12))
	{
		return 0;
	}
	Var0.f_9 = 1;
	...
	if (bParam13)
	{
		Var0.f_15 = func_932(bParam1, joaat("DEFAULT"));
		if (Var0.f_15 != 0)
		{
			Var0.f_4 = { func_919() };
			Var0.f_11 = 0;
	...
	*iParam8 = { Var0 };
	if (!func_772(iParam0, Var0, 2113164098, bParam9, bParam12))
	{
		return 0;
	}
	return 1;
...
int func_766(var uParam0, int iParam1, int iParam2, int iParam3, bool bParam4, bool bParam5, int iParam6)
{
	return func_936(&uParam0, bParam4, bParam5, iParam6);
}

int func_767(struct<4> Param0, int iParam4)
{
	struct<11> Var0;

	if (!func_840(0))
	{
		return func_937(Param0, iParam4, 1) != -1;
	}
	...
	if (!INVENTORY::_0x734311E2852760D0(func_822(0), &Param0, iParam4))
	{
		return 0;
	}
	return 1;
...
int func_769(int* iParam0)
{
	...
	{
		func_907(*iParam0, 2, 0, 0);
		return 0;
	}
	func_907(*iParam0, 1, 0, 0);
...
int func_771(int* iParam0, struct<16> Param1, var uParam17, int iParam18, bool bParam19, int iParam20)
{
	if ((iParam18 != 2113164098 && iParam18 != -1318406457) && iParam18 != -1230526146)
	{
		return 0;
	}
	if (!func_938(iParam18, Param1, iParam20))
	{
		return 0;
	}
	if (!func_939(iParam0, iParam18))
	{
		return 0;
	}
	...
	return func_940(iParam0, bParam19);
}

int func_772(int* iParam0, struct<16> Param1, int iParam17, bool bParam18, bool bParam19)
{
	if ((((iParam17 != 2113164098 && iParam17 != -1318406457) && iParam17 != -1230526146) && iParam17 != 1702063850) && iParam17 != -1406934746)
	{
		return 0;
	}
	if (!func_938(iParam17, Param1, bParam19))
	{
		return 0;
	}
	if (!func_939(iParam0, iParam17))
	{
		return 0;
	}
	...
	return func_940(iParam0, bParam18);
}
...
int func_782(int iParam0, var uParam1)
{
	...
	Var0 = { func_709(iParam0) };
	if (!func_25(Var0))
	{
		return 0;
	}
	func_941(Var0, iParam0, uParam1);
	return 1;
}
...
Vector3 func_786(vector3 vParam0)
{
	...
	return func_490((-fVar3 * fVar0), (fVar3 * fVar1), fVar2);
}

Vector3 func_787(vector3 vParam0, vector3 vParam3)
{
	return ((vParam0.y * vParam3.z) - (vParam0.z * vParam3.y)), ((vParam0.z * vParam3.x) - (vParam0.x * vParam3.z)), ((vParam0.x * vParam3.y) - (vParam0.y * vParam3.x));
}

Vector3 func_788(vector3 vParam0, float fParam3)
{
	vector3 vVar0;
	float fVar3;
	float fVar4;
...
int func_789(var uParam0, int iParam1, var uParam2, var uParam3)
{
	vector3 vVar0;
	vector3 vVar3;
	vector3 vVar6;
	...
	iVar35 = func_533(*uParam0, iParam1);
	if (!ENTITY::DOES_ENTITY_EXIST(iVar35))
	{
		return 0;
	}
...
{
	return func_202((*Global_1123067)[iParam0 /*7*/], iParam1, 2);
}

bool func_791(int iParam0, int iParam1)
{
	return func_202(&(((*Global_1123067)[iParam0 /*7*/])->f_3), iParam1, 3);
}
...
int func_793(int iParam0, vector3 vParam1)
{
	vector3 vVar0;
	float fVar3;
	float fVar4;
...
Vector3 func_794(int iParam0, var uParam1)
{
	vector3 vVar0;
	vector3 vVar3;

	if (!func_795(iParam0, &vVar3, uParam1))
	{
		return vVar0;
	}
	vVar3.f_2 = -134912699;
...
int func_797(var uParam0)
{
	...
	iVar0 = -1;
	if (func_945(&Var1, uParam0))
	{
		iVar0 = ((func_946() - DATAFILE::_0xE13634BB6BAF0734(Var1, Var1.f_1)) - 1);
	}
	return iVar0;
}
...
int func_800(var uParam0, var uParam1)
{
	int iVar0;
	struct<2> Var1;

	iVar0 = -1;
	if (func_945(&Var1, uParam0) && func_947(&Var1, uParam1))
	{
		iVar0 = ((func_948(uParam0) - DATAFILE::_0xE13634BB6BAF0734(Var1, Var1.f_1)) - 1);
	}
	return iVar0;
}
...
int func_801(int iParam0, int iParam1, int iParam2, bool bParam3)
{
	...
	uVar0 = func_949(iParam0, iParam1, 2);
	if (func_950(iParam0, iParam1, uVar0))
	{
		return 1;
	}
	vVar1 = { func_807(iParam0, iParam1) };
	if (func_219(vVar1))
	{
		return 0;
	}
	uVar4 = func_951(func_799(iParam0), iParam1);
	if ((iParam2 && func_949(iParam0, iParam1, 1)) && func_952(vVar1, uVar4))
	{
		*bParam3 = 1;
		return 1;
	}
	return func_953(vVar1, uVar4, uVar0);
}
...
int func_802(var uParam0, var uParam1)
{
	...
	if (func_945(&Var1, uParam0) && func_947(&Var1, uParam1))
	{
		func_954(Var1, -528314399, &iVar0, 0);
	}
	return iVar0;
}

Vector3 func_803(var uParam0, var uParam1)
{
	vector3 vVar0;
	struct<5> Var3;

	if (func_945(&Var3, uParam0) && func_947(&Var3, uParam1))
	{
		func_955(Var3, -370006557, &vVar0, 1);
	}
	return vVar0;
}
...
int func_804(var uParam0, int iParam1)
{
	...
	if (func_945(&Var1, uParam0))
	{
		if (func_956(&Var1, iParam1))
		{
			func_957(Var1, 1342438652, &iVar0, 0);
		}
	}
	iVar6 = 0;
	if (iVar0 != 0)
	{
		iVar6 = func_958(iVar0);
	}
	return iVar6;
}

int func_805(int iParam0, vector3 vParam1)
{
	float fVar0;
	float fVar1;
	int iVar2;
	...
	while (iVar5 <= 31)
	{
		...
		if (NETWORK::NETWORK_IS_PLAYER_ACTIVE(iVar2))
		{
			...
			if (ENTITY::DOES_ENTITY_EXIST(iVar3))
			{
				...
				if (fVar4 < fVar1 && !func_961(iParam0))
				{
					return 0;
				}
			}
...
Vector3 func_807(int iParam0, int iParam1)
{
	int iVar0;
	...
	iVar0 = func_964(iParam0, iParam1);
...
bool func_811(int iParam0)
{
	...
	return (func_965(iParam0) && ((*Global_1123778)[iParam0 /*27*/])->f_18.f_1 != 0);
}

int func_812(struct<2> Param0, struct<2> Param2, bool bParam4, bool bParam5)
{
	struct<2> Var0;
	struct<2> Var2;
...
var func_823(int iParam0)
{
	return func_969(iParam0);
}

int func_824(int iParam0, int iParam1, int iParam2, int iParam3)
{
	var uVar0;
	int iVar5;
	...
	if (!func_854(&uVar0, 17, 0, 0, 1))
	{
		return 0;
	}
	if (!func_854(&uVar0, 18, func_970(iParam2), 0, 1))
	{
		return 0;
	}
	if (!func_854(&uVar0, 19, func_971(iParam3), 0, 1))
	{
		return 0;
	}
	if (!func_854(&uVar0, 20, iParam1, 0, 1))
	{
		return 0;
	}
	return func_972(&uVar0);
}

struct<8> func_825(int iParam0)
{
	return func_973(iParam0);
}

bool func_826(int iParam0, int iParam1, char* sParam2, int iParam3, int iParam4)
{
	var uVar0;
	int iVar5;
	...
	if (!func_854(&uVar0, 18, func_970(iParam3), 0, 1))
	{
		return false;
	}
	if (!func_854(&uVar0, 19, func_971(iParam4), 0, 1))
	{
		return false;
	}
	if (!func_854(&uVar0, 20, iParam1, 0, 1))
	...
	*sParam2 = { func_974(&uVar0) };
	return !MISC::_0x375F5870A7B8BEC1(sParam2);
}
...
int func_828(int iParam0, bool bParam1, bool bParam2, bool bParam3)
{
	struct<2> Var0[15];
	int iVar31;
	int iVar32;

	if (!func_975(iParam0, bParam1, &Var0, &iVar31, bParam2, bParam3))
	{
		if (!bParam2)
		{
		}
...
bool func_830(bool bParam0)
{
	...
	return func_753(bParam0) == -999503751;
}
...
bool func_832(bool bParam0)
{
	...
	return func_753(bParam0) == 153430294;
}
...
int func_835(int iParam0, int iParam1, bool bParam2, bool bParam3, bool bParam4)
{
	struct<2> Var0[15];
	int iVar31;
	int iVar32;

	if (!func_975(iParam0, bParam2, &Var0, &iVar31, bParam3, bParam4))
	{
		if (!bParam3)
		{
		}
...
int func_836(bool bParam0, bool bParam1, bool bParam2, bool bParam3, bool bParam4, int iParam5)
{
	struct<2> Var0[15];
	int iVar31;
	int iVar32;

	if ((bParam4 && bParam1 == -915411861) && func_736(bParam0, 59806960))
	{
		bParam1 = 59806960;
	}
	if (func_614(bParam0))
	{
		return func_828(func_615(bParam0, 0), bParam1, bParam3, 1);
	}
	if (!func_839(bParam0, bParam1, &Var0, &iVar31, bParam2, bParam3))
	{
		if (!bParam3)
		{
		}
...
int func_837(bool bParam0, int iParam1, bool bParam2, bool bParam3, bool bParam4)
{
	struct<2> Var0[15];
	int iVar31;
	int iVar32;
	...
	if (func_614(bParam0))
	{
		return func_835(func_615(bParam0, 0), iParam1, bParam2, bParam4, 1);
	}
	if (!func_839(bParam0, bParam2, &Var0, &iVar31, bParam3, bParam4))
	{
		if (!bParam4)
		{
		}
...
int func_838(int iParam0, bool bParam1, var uParam2)
{
	struct<2> Var0[15];
	int iVar31;
	int iVar32;

	if (!func_975(iParam0, bParam1, &Var0, &iVar31, 0, 1))
	{
		return 0;
	}
	iVar32 = 0;
	while (iVar32 < iVar31)
	{
		...
		else
		{
			...
			{
				if (!func_843((Var0[iVar32 /*2*/])->f_1))
				{
					return 0;
				}
			}
			else if (func_845(&(Var0[iVar32 /*2*/]), 0, 0, 1) < (Var0[iVar32 /*2*/])->f_1)
			{
...
int func_839(bool bParam0, bool bParam1, var uParam2, int iParam3, bool bParam4, bool bParam5)
{
	int iVar0;
	...
	*iParam3 = ITEMDATABASE::_0xDEE7B3C76ED664BE(bParam0, bParam1);
	...
	if (bParam4)
	{
		func_976(bParam0, bParam1, uParam2, *iParam3);
	}
	return 1;
}
...
int func_840(bool bParam0)
{
	...
	return INVENTORY::_0x0FBBFFC891A97C81(func_822(bParam0));
}
...
int func_844(bool bParam0, int iParam1)
{
	struct<5> Var0;
	struct<4> Var5;
	int iVar9;
	...
	Var5 = { func_747(bParam0, Var0, Var0.f_4, 0) };
	if (!INVENTORY::_0xB881CA836CC4B6D4(&Var5))
	{
		return 0;
	}
	iVar9 = INVENTORY::_0xC97E0D2302382211(func_822(0), &Var5, false);
	return iVar9;
}

int func_845(bool bParam0, bool bParam1, bool bParam2, bool bParam3)
{
	int iVar0;
	int iVar1;
	bool bVar2;
	...
	iVar1 = func_746(bParam0);
	if (iVar1 == 307971639 || (bParam1 && iVar1 == -427144552))
	{
		bVar2 = func_980(bParam0, 1);
		if (bVar2 != 0)
		{
	...
	{
		Var3 = { func_982(bParam0, bParam2) };
		if (!INVENTORY::_0xB881CA836CC4B6D4(&Var3))
		{
			return 0;
		}
		iVar0 = INVENTORY::_0xC97E0D2302382211(func_822(bParam2), &Var3, bParam3);
	}
	return iVar0;
}
...
int func_846(bool bParam0)
{
	...
	if (func_739(bParam0, -887064662))
	{
		return 1;
	}
	return func_847(bParam0);
}
...
int func_849(bool bParam0, int iParam1)
{
	...
	if (!func_846(bParam0) && !func_847(bParam0))
	{
		return 0;
	}
	Var3 = -1;
	...
	Var3.f_7 = -1;
	Var3.f_8 = -1;
	iVar13 = func_987(bParam0, 1697966752);
	if (iVar13 == 0)
	{
		return 0;
	}
	Var3 = { func_988(-1591664384, -1591664384, 0, 235313564, 0, 0, -1, iVar13, 0) };
	if (func_989(Var3, &iVar1, &iVar2, 0))
	{
		iVar15 = 0;
		while (iVar15 < iVar2)
		{
			bVar14 = func_990(iVar15, iVar1);
			if (func_730(bVar14, 0) && bParam0 != bVar14)
			{
				iVar16 = func_991(bVar14);
				if (iVar16 != 0)
				{
					iVar17 = func_844(bVar14, iParam1);
					if (iVar17 > 0)
					{
						iVar0 = (iVar0 + (iVar17 * func_993(iVar16, func_992(bVar14), bParam0)));
					}
				}
			}
			iVar15++;
...
int func_854(int iParam0, int iParam1, int iParam2, int iParam3, int iParam4)
{
	var uVar0;
...
{
	return _NAMESPACE26::_0x149A2751AB66AC02(iParam0) > 4;
}
...
int func_860(var uParam0, bool bParam1, bool bParam2, int iParam3, var uParam4)
{
	int iVar0;
	var uVar1;
	int iVar2;
	...
	func_674(*uParam0, &iVar0, &uVar1);
	func_996(iVar0, &uVar3, iParam3);
	func_997(iParam3, iVar0, &uVar3, uVar1, iVar2, uParam4);
	return 0;
}

int func_861(int iParam0, int iParam1, int iParam2, int iParam3, var uParam4)
{
	int iVar0;
	int iVar1;
	int iVar2;
	...
	if (!func_998(iParam0, uParam4, iParam1))
	{
		return 0;
	}
	...
	while (iVar0 <= (iVar1 - 1))
	{
		...
		else
		{
			...
			else if (func_1003(*iParam0, iParam2))
			{
			}
			else
			{
...
int func_864(vector3 vParam0, var uParam3, var uParam4)
{
	var uVar0;
...
int func_869(int iParam0, int iParam1, int iParam2, int iParam3, int iParam4)
{
	var uVar0;
...
struct<2> func_874(int iParam0, int iParam1)
{
	struct<2> Var0;
	...
	{
		case 2:
			Var0.f_1 = func_1013(iParam0, &(Global_1070355->f_634), func_56(iParam1));
			break;
		case 3:
			Var0.f_1 = func_1013(iParam0, &(Global_1070355->f_634.f_602), func_56(iParam1));
			break;
		case 4:
			Var0.f_1 = func_1013(iParam0, &(Global_1070355->f_634.f_2104), func_56(iParam1));
			break;
		case 5:
			Var0.f_1 = func_1013(iParam0, &(Global_1070355->f_634.f_12606), func_56(iParam1));
			break;
		case 6:
			Var0.f_1 = func_1013(iParam0, &(Global_1070355->f_634.f_12908), func_56(iParam1));
			break;
		case 7:
			Var0.f_1 = func_1013(iParam0, &(Global_1070355->f_634.f_15910), func_56(iParam1));
			break;
		case 8:
			Var0.f_1 = func_1013(iParam0, &(Global_1070355->f_634.f_15981), func_56(iParam1));
			break;
	}
	if (Var0.f_1 < 0)
	{
...
void func_880(int iParam0, int iParam1, int iParam2, bool bParam3)
{
...
void func_881(struct<2> Param0, bool bParam2)
{
...
void func_888(struct<2> Param0)
{
	...
	uVar2 = func_1018(iVar0);
	Var3 = { func_1019(iVar1, uVar2) };
...
int func_890(int iParam0, bool bParam1)
{
	...
	if (!func_1021(bParam1, bParam1, !bParam1))
	{
		return 0;
	}
	func_1022(iParam0);
...
char* func_891(char* sParam0, int iParam1)
{
	if (iParam1 == joaat("COLOR_PURE_WHITE"))
	{
		return MISC::_CREATE_VAR_STRING(10, "LITERAL_STRING", sParam0);
	}
	return func_1023(MISC::_CREATE_VAR_STRING(10, "LITERAL_STRING", sParam0), iParam1);
}
...
var func_896(char* sParam0)
{
	char* sVar0;
	var uVar1;

	sVar0 = MISC::_CREATE_VAR_STRING(2, sParam0);
	uVar1 = func_1026(sVar0, -2, 0, 0, 0, 1);
	return uVar1;
}
...
int func_899()
{
	return Global_1123331->f_235;
}

int func_900(int iParam0)
{
	return Global_1123331[iParam0 /*18*/];
}
...
int func_904(struct<5> Param0, int iParam5, int iParam6, int iParam7, int iParam8, int iParam9)
{
	Param0.f_2 = iParam6;
	Param0.f_3 = iParam7;
	Param0.f_4 = iParam8;
...
var func_905(vector3 vParam0, var uParam3, var uParam4, int iParam5, int iParam6)
{
	var uVar0;
...
void func_907(int iParam0, int iParam1, int iParam2, int iParam3)
{
	int iVar0;
	...
	func_1029(iParam0, iParam1, iParam2, iParam3);
}
...
{
	*iParam1 = func_1030(iParam0, 1);
	return *iParam1 != 0;
}

bool func_910(int iParam0, int iParam1)
{
	*iParam1 = func_1031(iParam0, 1, 0);
	return *iParam1 != 0;
}

int func_911(bool bParam0, bool bParam1, bool bParam2)
{
	var uVar0[10];
	int iVar11;
	int iVar12;
	...
	if (!func_730(bParam0, 0))
	{
		return func_1032(func_740(bParam0), bParam1, bParam2);
	}
	if (func_614(bParam0))
	{
		return func_827(func_615(bParam0, 1), bParam1);
	}
	if ((bParam2 && func_50() == 0) && !UNLOCK::_UNLOCK_IS_VISIBLE(bParam0))
	{
		return 1;
	}
	if (!func_1033(bParam0, bParam1, &uVar0, &iVar11) || iVar11 < 1)
	{
		return 0;
	}
	iVar12 = 0;
...
int func_912(bool bParam0, bool bParam1)
{
	int iVar0;
	int iVar1;
	struct<2> Var2[15];
	...
	while (iVar0 < 3)
	{
		bVar33 = func_1034(iVar0, 1, 0);
		if (!func_839(bParam0, bVar33, &Var2, &iVar1, 1, 0))
		{
		}
		else
		{
			...
			while (iVar34 < iVar1)
			{
				if (func_1035(&(Var2[iVar34 /*2*/])))
				{
					if (!bParam1 || func_845(&(Var2[iVar34 /*2*/]), 0, 1, 1) > 0)
					{
						return bVar33;
					}
					Jump @134; //curOff = 106
...
bool func_913(bool bParam0, bool bParam1, bool bParam2)
{
	int iVar0;
	int iVar1;
	int iVar2;
	...
	while (iVar0 < 5)
	{
		bVar40 = func_1034(iVar0, 0, 1);
		if (!func_839(bParam0, bVar40, &Var9, &iVar1, 1, 0))
		{
		}
		else
		{
			...
			while (iVar41 < iVar1)
			{
				if (func_1036(&(Var9[iVar41 /*2*/])))
				{
					if (!bParam1 || func_845(&(Var9[iVar41 /*2*/]), 0, 1, 1) > 0)
					{
						bVar8 = true;
					}
				}
...
int func_914(bool bParam0, int iParam1)
{
	if (!func_915(bParam0, 2))
	{
		return 0;
...
bool func_916(struct<2> Param0)
{
	return func_1037(Param0, 5, 8);
}
...
int func_917(int iParam0, bool bParam1, bool bParam2)
{
	...
	if (!func_757(iParam0, bParam1, 0))
	{
		return 0;
	}
	if (func_66(bParam2, 2))
	{
		if (func_827(iParam0, bParam1))
		{
			return 0;
		}
	}
	...
	if (func_66(bParam2, 8))
	{
		return func_1038(iParam0, bParam1);
	}
	return 1;
}

int func_918(int* iParam0, struct<17> Param1, int iParam18, bool bParam19)
{
...
bool func_920()
{
	return (func_684(-1185145312 /* GXTEntry: "Upgraded Off-Hand Holster" */, 0, 0, 0) > 0 && func_766(func_747(889965687 /* GXTEntry: "Wardrobe" */, func_745(1), 1034665895, 1), -234132662, 1, -1) != 0);
}

int func_921(bool bParam0, struct<4> Param1, bool bParam5, bool bParam6, bool bParam7, bool bParam8)
{
	int iVar0;
	struct<4> Var1;
	...
	if (!bParam7 && func_932(bParam0, joaat("DEFAULT")) == 0)
	{
		bParam7 = true;
	}
	iVar0 = 0;
	if (bParam7)
	{
		Var1 = { func_747(bParam0, Param1, bParam5, bParam6) };
		if (!INVENTORY::_0xB881CA836CC4B6D4(&Var1))
		{
			return 0;
		}
		iVar0 = INVENTORY::_0xC97E0D2302382211(func_822(bParam6), &Var1, bParam8);
	}
	else
	{
...
int func_922(bool bParam0, var uParam1, var uParam2, bool bParam3)
{
	int iVar0;

	iVar0 = func_822(0);
	*uParam1 = { func_747(bParam0, func_748(0), bParam3, 0) };
...
int func_923(bool bParam0, int iParam1, bool bParam2)
{
...
int func_924(var uParam0, int iParam1, bool bParam2, bool bParam3, int iParam4)
{
...
{
	return func_746(bParam0) == -427144552;
}
...
int func_928(bool bParam0, var uParam1, bool bParam2, bool bParam3)
{
	if (!func_730(bParam0, 0) && !func_915(func_740(bParam0), 2))
	{
		return 0;
	}
	if (func_746(bParam0) == 26423971)
	{
		return -1;
	}
	if (!bParam2 && func_932(bParam0, joaat("DEFAULT")) == 0)
	{
		bParam2 = true;
	}
	if (bParam2)
	...
	return INVENTORY::_0xADDD1E7C0ECF7D95(func_822(bParam3), bParam0);
}

int func_929(bool bParam0, bool bParam1, int iParam2, bool bParam3)
{
	struct<37> Var0;
...
int func_931(int* iParam0, bool bParam1, bool bParam2, bool bParam3)
{
	int iVar0;
	int iVar1;
	int iVar2;
	...
	if (func_1040(bParam1, 1) && !func_1041(bParam1, 1))
	{
		if (Global_1915170->f_20142)
		{
			func_1042(MISC::_CREATE_VAR_STRING(2, "SHOP_H_TOO_POOR_TOKEN"));
		}
		return 0;
	}
	if (bParam2 == -570078785)
	{
		iVar0 = func_836(bParam1, -570078785, 1, 0, 1, 0);
		if (iVar0 == 0)
		{
		}
		iVar1 = (iVar0 * bParam3);
		if (!func_843((iVar1 + func_1043(iParam0, bParam2))))
		{
			if (Global_1915170->f_20142)
			{
				func_1042(MISC::_CREATE_VAR_STRING(2, "SHOP_H_TOO_POOR_GOLD", (iVar1 / 100)));
			}
			return 0;
		}
	}
	...
	{
		iVar2 = func_836(bParam1, -915411861, 1, 0, 1, 0);
		if (iVar2 == 0)
		{
		}
		iVar3 = (iVar2 * bParam3);
		if (!func_842((iVar3 + func_1043(iParam0, bParam2))))
		{
			if (Global_1915170->f_20142)
			{
				func_1042("SHOP_H_TOO_POOR");
			}
			return 0;
		}
	}
	...
	if (func_915(func_740(bParam1), 2))
	{
		if (!func_1044(func_740(bParam1), bParam3, bParam2, &uVar4))
		{
			return 0;
		}
	}
	else if (func_730(bParam1, 0))
	{
		if (!func_688(bParam1, bParam3, bParam2, &uVar4, &uVar6, 0, 0))
		{
			return 0;
		}
	}
...
int func_932(bool bParam0, int iParam1)
{
	if (iParam1 == 0)
	{
		return 0;
...
bool func_934(var uParam0, var uParam1, var uParam2, int iParam3, bool bParam4, int iParam5, bool bParam6, int iParam7)
{
	return func_1045(&uParam0, bParam4, iParam5, bParam6, iParam7);
}

int func_935(int* iParam0, bool bParam1, struct<4> Param2, bool bParam6, bool bParam7, bool bParam8)
{
	if (!func_760(iParam0, bParam1, Param2, bParam6, bParam7, 1, bParam8, 1))
	{
		return 0;
	}
	if (func_66(bParam8, 4) && func_750(bParam1, &Param2, bParam6, 1, 0))
	{
		return 0;
	}
	return 1;
...
int func_936(var uParam0, bool bParam1, bool bParam2, int iParam3)
{
	struct<10> Var0;

	Var0.f_9 = -1591664384;
	if (func_1045(uParam0, bParam1, &Var0, bParam2, iParam3))
	{
		return Var0.f_4;
	}
	return 0;
...
int func_937(struct<4> Param0, int iParam4, bool bParam5)
{
	int iVar0;
	struct<11> Var1;
	int iVar15;
	...
	{
		Var16 = { func_1046(Param0, 1, 0) };
		Var16.f_10 = iParam4;
		iVar0 = func_1047(-1230526146, &Var16, bParam5);
		if (iVar0 == -1)
		{
			return iVar0;
		}
	...
	{
		Var44 = { func_1048(Param0, 1, 0) };
		Var44.f_10 = iParam4;
		iVar0 = func_1049(-1230526146, &Var44, bParam5);
		if (iVar0 == -1)
		{
			return iVar0;
		}
	...
	{
		Var69 = { func_1050(Param0, 1, 0) };
		Var69.f_10 = iParam4;
		iVar0 = func_1051(-1230526146, &Var69, bParam5);
		if (iVar0 == -1)
		{
			return iVar0;
		}
	...
	{
		Var86 = { func_1052(&Var1, 0) };
		Var86.f_10 = iParam4;
		iVar0 = func_1053(-1230526146, &Var86, bParam5);
		if (iVar0 == -1)
		{
			return iVar0;
		}
...
int func_938(int iParam0, struct<10> Param1, var uParam11, var uParam12, var uParam13, var uParam14, var uParam15, var uParam16, bool bParam17)
{
	if (Param1.f_9 < 1)
	{
		return 0;
	}
	if (!func_730(Param1.f_8, 0) && !func_915(func_740(Param1.f_8), 2))
	{
		return 0;
	}
	if (func_66(bParam17, 128))
	{
		if (func_753(Param1.f_8) == 0)
		{
			return 0;
		}
	}
	if (func_66(bParam17, 16))
	{
		if (!func_1054(iParam0, &Param1))
		{
			return 0;
		}
	}
...
int func_943(int iParam0, int iParam1)
{
	...
	if (iVar0 >= 0 && iVar0 < 32)
	{
		return func_1057(((*Global_1275475)[iVar0 /*86*/])->f_85, iParam1);
	}
	return 0;
}
...
int func_949(int iParam0, int iParam1, int iParam2)
{
	...
	iVar0 = func_964(iParam0, iParam1);
	return func_1057((Global_1232796->f_401[iVar0 /*7*/])->f_2, iParam2);
}

int func_950(int iParam0, int iParam1, var uParam2)
{
	int iVar0;
	vector3 vVar1;
	var uVar4;
	...
	iVar0 = 0;
	while (iVar0 <= (func_1060(iParam0, iParam1) - 1))
	{
		vVar1 = { func_1061(func_799(iParam0), iParam1, iVar0) };
		uVar4 = func_1062(func_799(iParam0), iParam1, iVar0);
		if (func_219(vVar1))
		{
		}
		else
		{
			if (func_953(vVar1, uVar4, uParam2))
			{
				return 1;
			}
			iVar0++;
...
var func_951(var uParam0, int iParam1)
{
	var uVar0;
	struct<5> Var1;

	uVar0 = Global_1901929->f_160.f_34;
	if (func_945(&Var1, uParam0) && func_956(&Var1, iParam1))
	{
		func_1063(Var1, -364402952, &uVar0, 0);
	}
	return uVar0;
}

int func_952(vector3 vParam0, float fParam3)
{
	int iVar0;
	int iVar1;
...
bool func_953(vector3 vParam0, float fParam3, bool bParam4)
{
	int iVar0;
...
int func_954(vector3 vParam0, int iParam3, var uParam4, int iParam5, bool bParam6, bool bParam7)
{
	vParam0.f_2 = iParam5;
...
int func_955(vector3 vParam0, int iParam3, var uParam4, int iParam5, var uParam6, bool bParam7)
{
	vParam0.f_2 = iParam5;
...
int func_957(vector3 vParam0, int iParam3, var uParam4, int iParam5, int iParam6, bool bParam7)
{
	var uVar0;
...
{
	return func_1064(iParam0, 4);
}

float func_960(int iParam0)
{
	switch (iParam0)
	{
		case 0:
...
int func_966(int iParam0, int iParam1)
{
	...
	if (iParam1 == 255)
	{
		return func_202(&(Global_1099293->f_4), iVar0, 5);
	}
	...
	{
		return func_202(&(((*Global_1097609)[iParam1 /*51*/])->f_4), iVar0, 5);
	}
	return 0;
}
...
{
	return ((*Global_1274070)[iParam0 /*37*/])->f_10;
}
...
{
	return func_1070(uParam0, 27, 1);
}

struct<8> func_973(int iParam0)
{
	return ((*Global_1274070)[iParam0 /*37*/])->f_11;
}

struct<8> func_974(var uParam0)
{
	return func_1071(uParam0, 27, 1);
}

int func_975(int iParam0, bool bParam1, var uParam2, int iParam3, bool bParam4, bool bParam5)
{
	int iVar0;
	...
	*iParam3 = ITEMDATABASE::_0xF540239F9937033B(iParam0, bParam1);
	...
	if (bParam5)
	{
		func_1072(iParam0, bParam1, uParam2, *iParam3);
	}
	return 1;
}

void func_976(bool bParam0, bool bParam1, var uParam2, int iParam3)
{
	int iVar0;
	int iVar1;
	int iVar2;
...
int func_980(bool bParam0, int iParam1)
{
	...
	if (func_739(bParam0, 1399091007))
	{
		func_1073(bParam0, &uVar1, &uVar2);
		return uVar2;
	}
	return 0;
}

int func_981(bool bParam0, bool bParam1)
{
	struct<14> Var0;
	int iVar14;
	var uVar15;
	...
	Var0 = { func_1074(bParam0, -1591664384, -1591664384, -1591664384, 0, 0, 0) };
	if (bParam1)
	{
		func_1075(&Var0, func_748(0));
	}
	if (!func_1076(&Var0, &iVar14, &uVar15, 0))
	{
		return 0;
	}
	func_1077(iVar14);
...
struct<4> func_982(bool bParam0, bool bParam1)
{
	struct<5> Var0;

	Var0 = { func_618(bParam0, bParam1, 0) };
	return func_747(bParam0, Var0, Var0.f_4, bParam1);
}
...
struct<10> func_988(int iParam0, int iParam1, int iParam2, int iParam3, int iParam4, int iParam5, int iParam6, int iParam7, int iParam8)
{
	struct<10> Var0;
...
int func_989(var uParam0, var uParam1, var uParam2, int iParam3, var uParam4, var uParam5, var uParam6, var uParam7, var uParam8, var uParam9, int iParam10, int iParam11, int iParam12)
{
...
{
	if (func_739(bParam0, 1064293907))
	{
		return 2;
	}
	else if (func_739(bParam0, -1218707194))
	{
		return 1;
	}
	else if (func_739(bParam0, 1888974372))
	{
		return 0;
	}
	return 1;
...
int func_993(int iParam0, int iParam1, bool bParam2)
{
	...
	while (iVar17 < 15)
	{
		if (func_730(&(uVar0[iVar17]), 0) && bParam2 == &uVar0[iVar17])
		{
			iVar16++;
		}
		iVar17++;
...
{
	return func_1078(func_1070(uParam0, 30, 1));
}
...
void func_996(int iParam0, var uParam1, int iParam2)
{
	...
	switch (iVar0)
	{
		case 1918154385:
			...
			break;
		case 974227447:
			func_1080(uParam1, iParam2);
			break;
	}
}

void func_997(int iParam0, int iParam1, int iParam2, var uParam3, int iParam4, var uParam5)
{
	struct<22> Var0;
	...
	Var0.f_14.f_1 = -1;
	Var0.f_21 = 6;
	func_1081(&Var0, iParam1, func_800(func_799(iParam1), uParam3), iParam4, uParam5);
...
int func_999(vector3 vParam0, var uParam3, var uParam4, int iParam5)
{
	vParam0.f_2 = iParam5;
	return DATAFILE::_DATAFILE_GET_NUM_NODES(&vParam0);
}
...
int func_1001(vector3 vParam0, var uParam3, var uParam4)
{
	var uVar0;
...
int func_1003(var uParam0, int iParam1, var uParam2, var uParam3, var uParam4, int iParam5)
{
	if (!func_1084(&uParam0))
	{
		return 0;
	}
	if (!func_1085(&uParam0, iParam5))
	{
		return 0;
	}
	return 1;
...
int func_1007(int iParam0, var uParam1)
{
	...
	if (func_1086(iParam0, uParam1, &vVar0))
	{
		return vVar0.z;
	}
	return 0;
...
int func_1013(int iParam0, var uParam1, int iParam2)
{
	int iVar0;
	int iVar1;
	int iVar2;
...
void func_1014()
{
	...
	{
		func_1087(&(((*Global_1055965)[iVar0 /*436*/])->f_153.f_10), 4);
	}
	else
	{
		func_759(&(((*Global_1055965)[iVar0 /*436*/])->f_153.f_10), 4);
	}
	...
	if (func_889(1024))
	{
		func_1087(&(((*Global_1055965)[iVar0 /*436*/])->f_153.f_10), 2);
	}
	else
	{
		func_759(&(((*Global_1055965)[iVar0 /*436*/])->f_153.f_10), 2);
	}
}

bool func_1015()
{
	return func_25(*Global_1051163);
}

int func_1016(struct<2> Param0)
{
	int iVar0;
	...
	while (iVar0 <= 7)
	{
		if (func_62((Global_1183537->f_66[iVar0 /*20*/])->f_7, Param0))
		{
			return iVar0;
		}
		iVar0++;
...
struct<8> func_1019(int iParam0, var uParam1)
{
	struct<8> Var0;
	struct<5> Var8;

	if (((func_1088(&Var8, iParam0) && func_1089(&Var8)) && func_1090(&Var8, uParam1)) && func_1091(&Var8))
	{
		func_1092(Var8, 37194763, &Var0, 1);
	}
	return Var0;
}
...
int func_1021(bool bParam0, bool bParam1, bool bParam2)
{
	...
	bVar0 = func_1094(bParam2, func_1093(), 1, 0, 1, 1, 1, bParam0, bParam1);
	if (!bVar0)
	{
		return 0;
	}
...
char* func_1023(char* sParam0, int iParam1)
{
...
var func_1026(char* sParam0, int iParam1, int iParam2, int iParam3, int iParam4, bool bParam5)
{
	struct<4> Var0;
	struct<2> Var13;
	var uVar17;
...
int func_1027(struct<2> Param0)
{
	...
	uVar0 = func_145(Param0, -1);
	return func_1095(uVar0);
}
...
void func_1029(int iParam0, int iParam1, int iParam2, int iParam3)
{
	int iVar0;
	struct<20> Var1;
...
int func_1030(int iParam0, bool bParam1)
{
	...
	{
		bVar33 = func_1034(iVar0, 1, 0);
		if (!func_975(iParam0, bVar33, &Var2, &iVar1, 0, 1))
		{
		}
		else
		{
...
bool func_1031(int iParam0, bool bParam1, bool bParam2)
{
	int iVar0;
	int iVar1;
	int iVar2;
	...
	{
		bVar40 = func_1034(iVar0, 0, 1);
		if (!func_975(iParam0, bVar40, &Var9, &iVar1, 0, 1))
		{
		}
		else
		{
...
int func_1032(bool bParam0, bool bParam1, bool bParam2)
{
	var uVar0[10];
	int iVar11;
	int iVar12;
	...
	if (!func_1096(bParam0, bParam1, &uVar0, &iVar11) || iVar11 < 1)
	{
		return 0;
	}
	iVar12 = 0;
...
int func_1033(bool bParam0, bool bParam1, var uParam2, int iParam3)
{
	struct<37> Var0;
	int iVar47;
...
int func_1034(int iParam0, bool bParam1, bool bParam2)
{
	int iVar0;
...
{
	return func_753(bParam0) == 1946043663;
}

bool func_1036(bool bParam0)
{
	return func_753(bParam0) == -126813555;
}

bool func_1037(struct<2> Param0, int iParam2, int iParam3)
{
	int iVar0;
...
int func_1038(int iParam0, bool bParam1)
{
	...
	{
		iVar0 = func_828(iParam0, -570078785, 0, 1);
		if (iVar0 == 0)
		{
		}
		if (!func_843(iVar0))
		{
			if (Global_1915170->f_20142)
			{
				func_1042(MISC::_CREATE_VAR_STRING(2, "SHOP_H_TOO_POOR_GOLD", func_829(iVar0)));
			}
			return 0;
		}
	}
	...
	{
		iVar1 = func_828(iParam0, -915411861, 0, 1);
		if (iVar1 == 0)
		{
		}
		if (!func_842(iVar1))
	...
	if (!func_838(iParam0, bParam1, &uVar2))
	{
		return 0;
	}
	return 1;
...
int func_1039(struct<17> Param0)
{
	if (!func_908(Param0.f_16))
	{
		return 0;
	}
	return 1;
...
int func_1040(bool bParam0, bool bParam1)
{
	if (!func_739(bParam0, 947377998))
	{
		return 0;
	}
	if (bParam1)
	{
		if (func_739(bParam0, -1090933859))
		{
			return func_615(bParam0, 1) != 0;
		}
		if ((func_911(bParam0, -915411861, 0) || func_911(bParam0, 600942249, 0)) || func_911(bParam0, -570078785, 0))
		{
			return 1;
		}
		else
...
int func_1041(bool bParam0, bool bParam1)
{
	int iVar0;
	var uVar1;

	iVar0 = func_1098(bParam0, 1);
	if (iVar0 == 0)
	{
		return 0;
	}
	if (func_827(iVar0, -2141192156))
	{
		return 0;
	}
	if (bParam1)
	{
		if (!func_838(iVar0, -2141192156, &uVar1))
		{
			return 0;
		}
	}
...
{
	Global_1915170->f_21955 = func_308(sParam0, 10000, 0, 0, 0, 1);
}
...
int func_1043(int* iParam0, bool bParam1)
{
	...
	if (NETSHOPPING::_CASHINVENTORY_TRANSACTION_GET_BASKET_IS_VALID(*iParam0))
	{
		...
		while (iVar1 < iVar2)
		{
			...
			{
				iVar0 = (iVar0 + (func_836(Var3.f_8, bParam1, 1, 0, 1, 0) * Var3.f_9));
			}
			iVar1++;
		}
	}
...
int func_1044(bool bParam0, bool bParam1, bool bParam2, var uParam3)
{
	struct<2> Var0[15];
	int iVar31;
	int iVar32;
	...
	if (!func_1099(bParam0, bParam2, &Var0, &iVar31, 1, 0))
	{
		return 0;
	}
	bVar35 = (func_840(0) && !func_841());
	...
	while (iVar34 < iVar31)
	{
		...
		else
		{
			...
			{
				iVar33 = func_845(&(Var0[iVar34 /*2*/]), 0, !bVar35, 0);
				if (iVar33 >= iVar32)
				{
				}
				else
...
int func_1045(var uParam0, bool bParam1, int iParam2, bool bParam3, int iParam4)
{
	var uVar0;
	...
	if (!func_924(&uVar0, iParam2, bParam3, 0, iParam4))
	{
		return 0;
	}
	return 1;
...
struct<28> func_1046(var uParam0, int iParam1, int iParam2, var uParam3, bool bParam4, bool bParam5)
{
	struct<28> Var0;
	struct<29> Var28;
	...
	Var28.f_9 = -1591664384;
	if (!INVENTORY::_0x025A1B1FB03FBF61(func_822(bParam4), &uParam0, &Var28, 29, 1))
	{
		return Var0;
	}
	Var0 = { func_1052(&Var28, bParam5) };
...
int func_1047(int iParam0, var uParam1, bool bParam2)
{
	int iVar0;
	...
	if (bParam2)
	{
		...
		{
			return func_1100(NETSHOPPING::_CASHINVENTORY_TRANSACTION_ADD_ITEM(iVar0, uParam1, 28), iVar0, uParam1);
		}
	}
	else
	{
		return func_1101(NETSHOPPING::_CASHINVENTORY_TRANSACTION_FIRE_AND_FORGET_ITEM(iParam0, &iVar0, uParam1, 28), iVar0, uParam1);
	}
	return -1;
}

struct<25> func_1048(var uParam0, int iParam1, int iParam2, var uParam3, bool bParam4, bool bParam5)
{
	struct<25> Var0;
	struct<24> Var25;
	...
	if (!INVENTORY::_0x025A1B1FB03FBF61(func_822(bParam4), &uParam0, &Var25, 24, 1))
	{
		return Var0;
	}
	Var0 = { func_1052(&Var25, bParam5) };
...
int func_1049(int iParam0, var uParam1, bool bParam2)
{
	...
	if (bParam2)
	{
		if (NETSHOPPING::_CASHINVENTORY_TRANSACTION_START(&iVar0, 712853601, iParam0))
		{
			return func_1100(NETSHOPPING::_CASHINVENTORY_TRANSACTION_ADD_ITEM(iVar0, uParam1, 25), iVar0, uParam1);
		}
	}
	else
	{
		return func_1101(NETSHOPPING::_CASHINVENTORY_TRANSACTION_FIRE_AND_FORGET_ITEM(iParam0, &iVar0, uParam1, 25), iVar0, uParam1);
	}
	return -1;
}

struct<17> func_1050(var uParam0, int iParam1, int iParam2, var uParam3, bool bParam4, bool bParam5)
{
	struct<17> Var0;
	struct<15> Var17;
	...
	if (!INVENTORY::_0x025A1B1FB03FBF61(func_822(bParam4), &uParam0, &Var17, 15, 1))
	{
		return Var0;
	}
	Var0 = { func_1052(&Var17, bParam5) };
...
int func_1051(int iParam0, var uParam1, bool bParam2)
{
	...
	if (bParam2)
	{
		if (NETSHOPPING::_CASHINVENTORY_TRANSACTION_START(&iVar0, 712853601, iParam0))
		{
			return func_1100(NETSHOPPING::_CASHINVENTORY_TRANSACTION_ADD_ITEM(iVar0, uParam1, 17), iVar0, uParam1);
		}
	}
	else
	{
		return func_1101(NETSHOPPING::_CASHINVENTORY_TRANSACTION_FIRE_AND_FORGET_ITEM(iParam0, &iVar0, uParam1, 17), iVar0, uParam1);
	}
	return -1;
}

struct<16> func_1052(var uParam0, bool bParam1)
{
	struct<16> Var0;
	...
	if (bParam1)
	{
		Var0.f_15 = func_932(uParam0->f_4, joaat("DEFAULT"));
		if (Var0.f_15 != 0)
		{
			Var0.f_4 = { func_919() };
			Var0.f_11 = 0;
...
int func_1053(int iParam0, var uParam1, bool bParam2)
{
	...
	if (bParam2)
	{
		if (NETSHOPPING::_CASHINVENTORY_TRANSACTION_START(&iVar0, 712853601, iParam0))
		{
			return func_1100(NETSHOPPING::_CASHINVENTORY_TRANSACTION_ADD_ITEM(iVar0, uParam1, 16), iVar0, uParam1);
		}
	}
	else
	{
		return func_1101(NETSHOPPING::_CASHINVENTORY_TRANSACTION_FIRE_AND_FORGET_ITEM(iParam0, &iVar0, uParam1, 16), iVar0, uParam1);
	}
	return -1;
}

int func_1054(int iParam0, var uParam1)
{
	int iVar0;
	...
	{
		if (func_1057(iVar0, 2048))
		{
			return 0;
		}
	}
	else if (func_1057(iVar0, 8))
	{
		return 0;
	}
	else if (func_1057(iVar0, 16))
	{
		return 0;
	}
	else if (func_1057(iVar0, 65536))
	{
		return 0;
	}
	return 1;
...
Vector3 func_1061(var uParam0, int iParam1, int iParam2)
{
	vector3 vVar0;
	struct<5> Var3;

	if ((func_945(&Var3, uParam0) && func_956(&Var3, iParam1)) && func_1103(&Var3, iParam2))
	{
		func_955(Var3, 1702777600, &vVar0, 0);
	}
	return vVar0;
}

var func_1062(var uParam0, int iParam1, int iParam2)
{
	var uVar0;
	struct<5> Var1;

	uVar0 = Global_1901929->f_160.f_35;
	if ((func_945(&Var1, uParam0) && func_956(&Var1, iParam1)) && func_1103(&Var1, iParam2))
	{
		func_1063(Var1, -364402952, &uVar0, 0);
	}
	return uVar0;
...
int func_1063(vector3 vParam0, int iParam3, var uParam4, int iParam5, float fParam6, bool bParam7)
{
	vParam0.f_2 = iParam5;
...
int func_1064(int iParam0, int iParam1)
{
	...
	while (iVar0 <= 31)
	{
		if (NETWORK::NETWORK_IS_PLAYER_ACTIVE(PLAYER::INT_TO_PLAYERINDEX(iVar0)) && func_1057((*Global_1130406)[iVar0 /*13*/][iParam0 /*4*/], iParam1))
		{
			return 1;
		}
		iVar0++;
...
void func_1072(int iParam0, bool bParam1, var uParam2, int iParam3)
{
	int iVar0;
	int iVar1;
	int iVar2;
...
void func_1073(bool bParam0, var uParam1, var uParam2)
{
	*uParam1 = 0;
	*uParam2 = 0;
	switch (bParam0)
...
struct<14> func_1074(bool bParam0, int iParam1, int iParam2, int iParam3, int iParam4, int iParam5, int iParam6)
{
	struct<14> Var0;
...
void func_1075(var uParam0, struct<4> Param1)
{
...
int func_1076(var uParam0, int iParam1, bool bParam2, bool bParam3)
{
	*iParam1 = INVENTORY::_0x640F890C3E5A3FFD(func_822(bParam3), uParam0, bParam2);
	if (*iParam1 >= 0)
	{
		return 1;
	}
...
void func_1080(var uParam0, int iParam1)
{
	...
	if (func_1110(&Global_1273882, 4096))
	{
		func_1108(uParam0, 64);
	}
	else if (func_1110(&Global_1273882, 2048))
	{
	...
	{
		case -1240530384:
			func_1108(uParam0, 512);
			break;
		case 1606989084:
			func_1108(uParam0, 1024);
			break;
		case -640645303:
	...
	{
		func_1108(uParam0, 4096);
	}
}

void func_1081(var uParam0, int iParam1, int iParam2, int iParam3, var uParam4)
{
	uParam0->f_4 = 1;
	uParam0->f_6 = iParam1;
...
int func_1092(vector3 vParam0, int iParam3, var uParam4, int iParam5, char[4] cParam6, bool bParam7)
{
	vParam0.f_2 = iParam5;
...
int func_1094(bool bParam0, bool bParam1, bool bParam2, bool bParam3, bool bParam4, bool bParam5, bool bParam6, bool bParam7, bool bParam8)
{
	int iVar0;
	int iVar1;
	bool bVar2;
...
int func_1095(var uParam0)
{
	...
	iVar0 = func_1119(0, (func_1118() - 1), &uParam0);
	if (iVar0 == -1)
	{
		return -1;
	}
	return func_1120(iVar0);
}

int func_1096(bool bParam0, bool bParam1, var uParam2, int iParam3)
{
	struct<37> Var0;
	int iVar47;
	...
	*iParam3 = 0;
	...
	Var0.f_4 = 15;
	Var0.f_36 = 10;
	if (!func_1121(bParam0, bParam1, &Var0))
	{
		return 0;
	}
	if (Var0.f_35 > 10)
...
int func_1097(struct<2> Param0)
{
	if (Param0 == 2)
	{
		return func_796(Param0);
	}
	return -1;
}

int func_1098(bool bParam0, bool bParam1)
{
	if (!func_1040(bParam0, bParam1))
	{
		return 0;
	}
	if (bParam0 == 1949608568)
	{
		return func_615(1657716792 /* GXTEntry: "Arrow - Tracking" */, 1);
	}
	else if (bParam0 == 20024186)
	{
		return func_615(963726415, 1);
	}
	return func_615(bParam0, 1);
}

int func_1099(bool bParam0, bool bParam1, var uParam2, int iParam3, bool bParam4, bool bParam5)
{
	int iVar0;
	...
	*iParam3 = ITEMDATABASE::_0x388088BFF3681189(bParam0, bParam1);
	...
	if (bParam4)
	{
		func_1122(bParam0, bParam1, uParam2, *iParam3);
	}
	return 1;
}

int func_1100(bool bParam0, int iParam1, var uParam2)
{
	if (bParam0)
	{
		if (NETSHOPPING::_CASHINVENTORY_TRANSACTION_CHECKOUT(iParam1))
		{
			func_907(iParam1, 1, 0, 0);
			return iParam1;
		}
...
{
	return func_1037(Param0, 1, 4);
}

bool func_1105()
{
	return func_1123(-1490861779 /* GXTEntry: "Large Delivery Wagon" */, 1);
}

bool func_1106()
{
	return func_1123(1476279059 /* GXTEntry: "Medium Delivery Wagon" */, 1);
}

int func_1107()
{
	return func_921(-735397297, func_745(1), 1784584921, 1, 0, 0);
}

void func_1108(var uParam0, int iParam1)
{
	func_1087(uParam0, iParam1);
}
...
int func_1110(int iParam0, int iParam1)
{
	...
	return func_1057(((*Global_1275475)[iParam0 /*86*/])->f_19, iParam1);
}
...
int func_1111()
{
	...
	if (!func_1124(&(Global_1275329->f_50)))
	{
		return 0;
	}
	uVar0 = func_1125(Global_1275329->f_50, -268973591, 0, 1);
	return uVar0;
}
...
void func_1112(var uParam0, var uParam1)
{
	...
	while (iVar0 <= 31)
	{
		bVar1 = func_1126(iVar0);
		if (func_66(uParam0->f_7, bVar1))
		{
		}
		iVar0++;
	}
...
int func_1119(int iParam0, int iParam1, var uParam2)
{
	int iVar0;
	...
	if (*uParam2 < &Global_1103536->f_5569.f_351[iVar0 /*2*/])
	{
		return func_1119(iParam0, (iVar0 - 1), uParam2);
	}
	if (*uParam2 > &Global_1103536->f_5569.f_351[iVar0 /*2*/])
	{
		return func_1119(iVar0 + 1, iParam1, uParam2);
	}
	return iVar0;
}

var func_1120(int iParam0)
{
	return (Global_1103536->f_5569.f_351[iParam0 /*2*/])->f_1;
}

int func_1121(bool bParam0, bool bParam1, var uParam2)
{
	int iVar0;
	int iVar1;
...
void func_1122(bool bParam0, bool bParam1, var uParam2, int iParam3)
{
	int iVar0;
	int iVar1;
	int iVar2;
...
bool func_1123(bool bParam0, int iParam1)
{
	int iVar0;
	...
	switch (iVar0)
	{
		case -427144552:
			...
			break;
		case 307971639:
			if (!func_1127(bParam0, 1))
			{
				return false;
			}
			break;
		case joaat("clothing"):
			if (func_1128(bParam0))
			{
				return true;
			}
			break;
	}
	return func_845(bParam0, 0, 0, 0) >= iParam1;
}
...
int func_1125(struct<4> Param0, int iParam4, int iParam5, bool bParam6)
{
	struct<10> Var0;

	Var0.f_9 = -1591664384;
	if (func_1129(Param0, iParam4, &Var0, iParam5, bParam6))
	{
		return Var0.f_4;
	}
	return 0;
...
int func_1127(bool bParam0, int iParam1)
{
	bool bVar0;
	int iVar1;
	int iVar2;
	...
	bVar0 = func_980(bParam0, iParam1);
	Var4.f_9 = -1591664384;
	if (func_1130("ALL WEAPONS", &iVar1, &iVar2, -1591664384, 0))
	{
		bVar3 = false;
		while (bVar3 < iVar2)
		{
			if (!func_1131(&Var4, bVar3, iVar1, iVar2))
			{
			}
			else if (!func_1132(Var4.f_4))
			{
			}
...
bool func_1128(bool bParam0)
{
	...
	iVar1 = func_1133(bParam0);
	if (!iVar1 == 0)
	{
		iVar2 = func_1134(&(Global_17173.f_54.f_644.f_1353.f_5), iVar1);
		if (iVar2 == -1)
		{
			return true;
		}
	}
	iVar1 = func_1135(bParam0);
	iVar2 = func_1134(&(Global_17173.f_54.f_644.f_1353.f_5), iVar1);
	if (iVar2 == -1)
	{
		return false;
...
int func_1129(var uParam0, int iParam1, var uParam2, int iParam3, bool bParam4, var uParam5, int iParam6, bool bParam7)
{
	int iVar0;

	iVar0 = func_822(bParam7);
...
int func_1130(char* sParam0, int iParam1, bool bParam2, int iParam3, bool bParam4)
{
	*iParam1 = INVENTORY::_0x80D78BDC9D88EF07(func_822(bParam4), sParam0, iParam3, bParam2);
	if (*iParam1 >= 0)
	{
		return 1;
	}
...
int func_1131(var uParam0, bool bParam1, int iParam2, bool bParam3)
{
	if (iParam2 < 0)
	{
		return 0;
