...
void func_13(var uParam0, var uParam1, var uParam2, var uParam3, var uParam4)
{
	...
	iVar19 = func_30(&bVar18, Local_809.f_1, Local_809.f_2);
	if (bVar18 || iVar19 == -1)
	{
		return;
	}
...
int func_157(vector3 vParam0, int iParam3, var uParam4, int iParam5, int iParam6, bool bParam7)
{
	var uVar0;
...
int func_199(int iParam0)
{
	...
	{
		case 0:
			return func_277(997958153 /* GXTEntry: "Riding" */, 1);
		case 1:
			return 2030804811;
		case 2:
			return -727455979;
	...
	while (iVar7 < 3)
	{
		if (NETWORK::NETWORK_DOES_NETWORK_ID_EXIST(&(Local_0.f_7.f_16[iVar4 /*2*/])))
		{
			...
			if (NETWORK::NETWORK_HAS_CONTROL_OF_ENTITY(iVar6))
			{
				...
				PED::_0xCC8CA3E88256E58F(iVar6, 0, 1, 1, 1, true);
			}
		}
		iVar7++;
	}
...
int func_216()
{
	...
	bVar0 = true;
	if (bVar0 && !UNLOCK::_UNLOCK_IS_UNLOCKED(Local_809.f_14))
	{
		return 0;
	}
	return 1;
...
int func_233(int iParam0, int iParam1, bool bParam2, bool bParam3)
{
...
int func_249(var uParam0, int iParam1, vector3 vParam2, int iParam5, bool bParam6, bool bParam7, int iParam8, bool bParam9, bool bParam10)
{
	int iVar0;
	...
	iVar0 = func_335(iParam1, vParam2, iParam5, iParam8, 1, bParam6, bParam7, bParam9);
...
void func_307()
{
	...
	if (iVar1 == 0)
	{
		...
		if (!TASK::IS_PED_ACTIVE_IN_SCENARIO(iVar0, 1))
		{
			...
			TASK::_TASK_USE_SCENARIO_POINT(iVar0, iVar2, 0, 0, false, true, 0, false, -1082130432, 0);
		}
		else
		{
			...
			else
			{
				...
				if (iVar2 == 0)
				{
					...
					if (!TASK::IS_PED_ACTIVE_IN_SCENARIO(iVar1, 1))
					{
						...
						TASK::_TASK_USE_SCENARIO_POINT(iVar1, iVar4, 0, 0, false, true, 0, false, -1082130432, 0);
					}
					else
					{
			...
			if (func_251(0) && !func_251(8))
			{
				...
				else
				{
					if (iVar0 == 0)
					{
						...
						{
							TASK::_TASK_USE_SCENARIO_POINT(iVar2, iVar5, 0, 0, false, true, 0, false, -1082130432, 0);
						}
					}
					func_315(NETWORK::PARTICIPANT_ID_TO_INT(), iVar1, 16);
				}
...
void func_323()
{
	...
	{
		ENTITY::_0x18FF3110CF47115D(func_190(0), 1, true);
	}
	func_417();
	if (!func_254(13))
	{
...
int func_335(int iParam0, vector3 vParam1, float fParam4, bool bParam5, bool bParam6, bool bParam7, bool bParam8, bool bParam9)
{
	int iVar0;
...
int func_359(int iParam0, bool bParam1, bool bParam2, bool bParam3)
{
	struct<11> Var0;
	int iVar17;
	struct<11> Var18;
	...
	{
		return func_453(bParam1, bParam2, bParam3);
	}
	if (Global_1572887->f_13 != -1)
	{
...
int func_378(int iParam0, int iParam1, int iParam2)
{
	...
	return func_471(iParam0, vVar0, iParam2);
}
...
bool func_411(int iParam0, var uParam1, var uParam2, var uParam3, int iParam4, int iParam5, int iParam6, int iParam7)
{
	struct<7> Var0;
...
int func_415(vector3 vParam0, int iParam3, int iParam4, int iParam5, int iParam6, bool bParam7)
{
	int iVar0;
	float fVar1;
	int iVar2;
	...
	*iParam3 = iParam4;
	...
	while (iVar0 <= 31)
	{
		...
		else if (bParam7 && !func_496(NETWORK::NETWORK_GET_PARTICIPANT_INDEX(iVar2), 1, 1))
		{
		}
		else
		{
...
int func_453(bool bParam0, bool bParam1, bool bParam2)
{
...
int func_480(int iParam0, var uParam1, int iParam2, var uParam3, int iParam4, int iParam5, int iParam6, bool bParam7)
{
	bool bVar0;
	int iVar1;
	var uVar2;
...
var func_495(int iParam0, var uParam1)
{
...
var func_503(vector3 vParam0, vector3 vParam3, vector3 vParam6, int iParam9, int iParam10, int iParam11)
{
	var uVar0;
	int iVar1;
	int iVar2;
