#region Local Var
	...
	struct<18> Local_1601[32];
	struct<2> Local_2178 = { 0, 0 } ;
	var uLocal_2180 = 6;
	var uLocal_2181 = 0;
	var uLocal_2182 = 0;
	var uLocal_2183 = 0;
...
void __EntryFunction__()
{
	...
	{
		func_2(&uLocal_17, ScriptParam_0);
	}
	Local_2178.f_1 = NETWORK::PARTICIPANT_ID_TO_INT();
	while (!func_3(Local_1601[Local_2178.f_1 /*18*/]))
	{
		if (NETWORK::NETWORK_IS_HOST_OF_THIS_SCRIPT())
		{
			func_4(&uLocal_17, &Local_1601, &Local_2178);
		}
		func_5(&uLocal_17, &Local_1601, &Local_2178);
		BUILTIN::WAIT(0);
	}
	if (NETWORK::NETWORK_IS_HOST_OF_THIS_SCRIPT())
	{
...
void func_1(int iParam0)
{
	...
	func_10(NETWORK::_0xBA24095EA96DFE17(&uLocal_17), 1584, "sHostData");
	NETWORK::NETWORK_REGISTER_PLAYER_BROADCAST_VARIABLES(&Local_1601, 577, 9);
	func_11(NETWORK::_0x690806BC83BC8CA2(Local_1601[0 /*18*/]), 577, "m_showClientStruct");
	func_12(0);
...
void func_4(var uParam0, var uParam1, var uParam2)
{
	...
	switch (uParam0->f_1352)
	{
		...
		case 2:
			...
			{
				NETWORK::RESERVE_NETWORK_MISSION_OBJECTS((5 - NETWORK::GET_NUM_RESERVED_MISSION_OBJECTS(0)));
				return;
			}
			if (NETWORK::GET_NUM_RESERVED_MISSION_PEDS(0) < uParam0->f_23)
			{
				NETWORK::RESERVE_NETWORK_MISSION_PEDS((2 - NETWORK::GET_NUM_RESERVED_MISSION_PEDS(0)));
				return;
			}
			uParam0->f_25 = 0;
			func_20(uParam0, 3);
...
int func_21(var uParam0)
{
	if (NETWORK::NETWORK_IS_HOST_OF_THIS_SCRIPT())
	{
		...
		uParam0->f_1401[1] = -141596905;
		uParam0->f_1385[0] = -890087611;
		uParam0->f_1385[1] = 1019569266;
		uParam0->f_1385[2] = 1019569266;
		uParam0->f_1385[3] = -1303647802;
		uParam0->f_1385[4] = 459594226;
...
int func_25(var uParam0)
{
	...
	if (!uParam0->f_1357 && !uParam0->f_1559)
	{
		...
		if (!func_79(NETWORK::_0xD7F6781A0ABAF6FB(uParam0->f_1376), func_93(1), func_82()))
		{
			return 0;
		}
	}
...
void func_32(var uParam0, int iParam1)
{
	...
	switch (*uParam0)
	{
		...
		case 1:
			...
			{
				iVar1 = iVar0;
				uParam0->f_3[iVar0] = OBJECT::CREATE_OBJECT(func_105(iVar1), func_109(iVar1), true, true, false, false, true);
				iVar0++;
			}
			func_103(uParam0, 2);
			break;
		...
		case 4:
			if (!ANIMSCENE::_0x1F0E401031E20146(uParam0->f_9, func_111(iParam1, 1)) || !ANIMSCENE::_0x23E33CB9F4A3F547(uParam0->f_9, func_111(iParam1, 1)))
			{
				return;
			}
			func_103(uParam0, 5);
...
{
	if (func_129(Global_35, uParam0->f_9, 1, 0))
	{
	...
	if (func_129(Global_35, uParam0->f_10, 1, 0))
	{
...
void func_49(var uParam0, var uParam1)
{
	...
	while (iVar0 <= 2)
	{
		...
		{
			if (!func_131(uParam0->f_12[iVar0 /*3*/], uParam1->f_3[iVar0 /*3*/]))
			{
				func_132(uParam0->f_12[iVar0 /*3*/], uParam1->f_3[iVar0 /*3*/]);
			}
	...
	switch (*uParam1)
	{
		...
		case 3:
			if ((ANIMSCENE::_0x25557E324489393C(uParam0->f_9) && ANIMSCENE::_0x477122B8D05E7968(uParam0->f_9, 1, 0)) && NETWORK::_NETWORK_HAS_CONTROL_OF_ANIM_SCENE(uParam0->f_9))
			{
				...
				while (iVar0 <= (5 - 1))
				{
					ANIMSCENE::SET_ANIM_SCENE_ENTITY(uParam0->f_9, func_138(iParam2, iVar0), &(uParam0->f_3[iVar0]), 0);
					iVar0++;
				}
		...
		case 4:
			...
			{
				if (!ANIMSCENE::_0x1F0E401031E20146(uParam0->f_9, func_111(iParam2, 1)))
				{
					if (!ANIMSCENE::_0x23E33CB9F4A3F547(uParam0->f_9, func_111(iParam2, 1)))
					{
						ANIMSCENE::_0xDF7B5144E25CD3FE(uParam0->f_9, func_111(iParam2, 1));
					}
					else
					{
						ANIMSCENE::_SET_ANIM_SCENE_PLAYBACK_LIST_BOOL(uParam0->f_9, func_111(iParam2, 1), true);
					}
				}
			}
			if (!ANIMSCENE::_0x1F0E401031E20146(uParam0->f_9, func_111(iParam2, 1)) || !ANIMSCENE::_0x23E33CB9F4A3F547(uParam0->f_9, func_111(iParam2, 1)))
			{
				return;
			}
			func_136(uParam1, 5);
...
int func_92(var uParam0, int iParam1, vector3 vParam2)
{
...
int func_94(var uParam0, var uParam1, var uParam2, char* sParam3, char* sParam4, bool bParam5)
{
...
int func_95(var uParam0, int iParam1, vector3 vParam2, float fParam5)
{
	bool bVar0;
	bool bVar1;
	int iVar2;
...
int func_96(var uParam0)
{
	...
	if (!ENTITY::DOES_ENTITY_EXIST(&(uParam0->f_1393[0])))
	{
		...
		{
			ANIMSCENE::SET_ANIM_SCENE_ENTITY(iVar0, "BOTTLE", &(uParam0->f_1393[0]), 0);
		}
		else
		{
			return 0;
	...
	if (!ENTITY::DOES_ENTITY_EXIST(&(uParam0->f_1393[1])))
	{
		...
		{
			ANIMSCENE::SET_ANIM_SCENE_ENTITY(iVar0, "STICK_0_", &(uParam0->f_1393[1]), 0);
		}
		else
		{
			return 0;
	...
	if (!ENTITY::DOES_ENTITY_EXIST(&(uParam0->f_1393[2])))
	{
		...
		{
			ANIMSCENE::SET_ANIM_SCENE_ENTITY(iVar0, "STICK_1_", &(uParam0->f_1393[2]), 0);
		}
		else
		{
			return 0;
	...
	if (!ENTITY::DOES_ENTITY_EXIST(&(uParam0->f_1393[3])))
	{
		...
		{
			ANIMSCENE::SET_ANIM_SCENE_ENTITY(iVar0, "TABLE", &(uParam0->f_1393[3]), 0);
		}
		else
		{
			return 0;
	...
	if (!ENTITY::DOES_ENTITY_EXIST(&(uParam0->f_1393[4])))
	{
		...
		{
			ANIMSCENE::SET_ANIM_SCENE_ENTITY(iVar0, "lantern", &(uParam0->f_1393[4]), 0);
		}
		else
		{
			return 0;
	...
	if (!func_155(uParam0, iVar0, 1, "male"))
	{
		return 0;
	}
...
void func_119(var uParam0, var uParam1, var uParam2, float fParam3)
{
	switch (uParam0->f_1)
	{
		...
		case 34:
			if (ANIMSCENE::_0xCBFC7725DE6CE2E0(NETWORK::_0xD7F6781A0ABAF6FB(uParam0->f_1374), 0) && ANIMSCENE::_0x3FBC3F51BF12DFBF(NETWORK::_0xD7F6781A0ABAF6FB(uParam0->f_1374)) > func_162(iLocal_16))
			{
...
{
	return func_166(iParam0, 23);
}

void func_127(int iParam0, bool bParam1, float fParam2, bool bParam3, bool bParam4, float fParam5, int iParam6, bool bParam7)
{
	func_158(iParam0, 0, 0);
	if (func_159(iParam0))
	{
...
int func_133(var uParam0, var uParam1, int iParam2)
{
	...
	if (!func_13(*uParam1, 1))
	{
		...
		{
			iVar3 = iVar0;
			if (func_176((*uParam0)[iVar0 /*5*/], func_174(iParam2), func_175(iParam2, iVar3), 1065353216))
			{
				iVar2++;
			}
			iVar0++;
	...
	if (!func_13(*uParam1, 8))
	{
		...
		{
			iVar4 = iVar0;
			if (func_176(uParam0->f_31[iVar0 /*5*/], func_178(iParam2), func_179(iParam2, iVar4), 1065353216))
			{
				iVar2++;
			}
			iVar0++;
	...
	if (!func_13(*uParam1, 2048))
	{
		...
		{
			iVar5 = iVar0;
			if (func_176(uParam0->f_107[iVar0 /*5*/], func_181(iParam2), func_182(iParam2, iVar5), 1065353216))
			{
				iVar2++;
			}
			iVar0++;
	...
	{
		case 0:
			if (!func_13(*uParam1, 64) && func_176(uParam0->f_118[0 /*5*/], func_183(iParam2, 0), func_184(iParam2, 0), 1065353216))
			{
				func_18(uParam1, 64);
			}
			if ((!func_13(*uParam1, 16384) && func_176(uParam0->f_118[1 /*5*/], func_183(iParam2, 1), func_184(iParam2, 1), 1065353216)) && func_176(uParam0->f_118[2 /*5*/], func_183(iParam2, 2), func_184(iParam2, 2), 1065353216))
			{
		...
		case 1:
			...
			{
				iVar1 = func_185(iParam2);
				iVar0 = 0;
				while (iVar0 <= (iVar1 - 1))
				{
					iVar6 = iVar0;
					if (func_176(uParam0->f_118[iVar0 /*5*/], func_183(iParam2, 0), func_184(iParam2, iVar6), 1065353216))
					{
						iVar2++;
					}
					iVar0++;
...
void func_134(var uParam0, var uParam1, int iParam2)
{
	...
	{
		if (func_13(*uParam0, 2) && func_189(uParam1, func_186(uParam1), &(uParam1->f_229), func_187(uParam1), func_188(uParam1)))
		{
			func_14(uParam0, 2);
		}
		if (func_13(*uParam0, 4) && func_191(uParam1, func_190(uParam1), &(uParam1->f_229), func_187(uParam1), func_188(uParam1)))
		{
			func_14(uParam0, 4);
		}
	}
	...
	{
		if (func_13(*uParam0, 16) && func_189(&(uParam1->f_31), func_192(uParam1), &(uParam1->f_232), func_193(uParam1), func_188(uParam1)))
		{
			func_14(uParam0, 16);
		}
		if (func_13(*uParam0, 32) && func_191(&(uParam1->f_31), func_194(uParam1), &(uParam1->f_232), func_193(uParam1), func_188(uParam1)))
		{
			func_14(uParam0, 32);
		}
	}
	...
	{
		if (func_13(*uParam0, 4096) && func_189(&(uParam1->f_107), func_195(uParam1), &(uParam1->f_235), func_196(uParam1), func_188(uParam1)))
		{
			func_14(uParam0, 4096);
		}
		if (func_13(*uParam0, 8192) && func_191(&(uParam1->f_107), func_197(uParam1), &(uParam1->f_235), func_196(uParam1), func_188(uParam1)))
		{
	...
	if (iParam2 == 0)
	{
		...
		{
			if (func_13(*uParam0, 128) && func_200(uParam1->f_118[0 /*5*/], func_198(uParam1), &(uParam1->f_238), func_199(uParam1), func_188(uParam1)))
			{
				func_14(uParam0, 128);
			}
			if (func_13(*uParam0, 256) && func_202(uParam1->f_118[0 /*5*/], func_201(uParam1), &(uParam1->f_238), func_199(uParam1), func_188(uParam1)))
			{
				func_14(uParam0, 256);
			}
			if (func_13(*uParam0, 512) && func_200(uParam1->f_118[0 /*5*/], func_198(uParam1), &(uParam1->f_238), 0.5f, func_188(uParam1)))
			{
				func_14(uParam0, 512);
			}
			if (func_13(*uParam0, 1024) && func_202(uParam1->f_118[0 /*5*/], func_201(uParam1), &(uParam1->f_238), 0.5f, func_188(uParam1)))
			{
		...
		{
			if (func_13(*uParam0, 32768) && func_205(1, 2, &(uParam1->f_118), func_203(uParam1), &(uParam1->f_241), func_204(uParam1), func_188(uParam1)))
			{
				func_14(uParam0, 32768);
			}
			if (func_13(*uParam0, 65536) && func_207(1, 2, &(uParam1->f_118), func_206(uParam1), &(uParam1->f_241), func_204(uParam1), func_188(uParam1)))
			{
				func_14(uParam0, 65536);
			}
			if (func_13(*uParam0, 131072) && func_205(1, 2, &(uParam1->f_118), func_203(uParam1), &(uParam1->f_241), 0.5f, func_188(uParam1)))
			{
				func_14(uParam0, 131072);
			}
			if (func_13(*uParam0, 262144) && func_207(1, 2, &(uParam1->f_118), func_206(uParam1), &(uParam1->f_241), 0.5f, func_188(uParam1)))
			{
	...
	if (iParam2 == 1)
	{
		...
		{
			if (func_13(*uParam0, 4194304) && func_189(&(uParam1->f_118), func_208(uParam1), &(uParam1->f_238), func_209(uParam1), func_188(uParam1)))
			{
				func_14(uParam0, 4194304);
			}
			if (func_13(*uParam0, 8388608) && func_191(&(uParam1->f_118), func_210(uParam1), &(uParam1->f_238), func_209(uParam1), func_188(uParam1)))
			{
...
{
	return func_213(0f, 0f, 0f, 0f, 0f, 0f, 0f, 0f, 0f, 665633627, iParam0, iParam1);
}
...
Vector3 func_153(int iParam0)
{
	...
	{
		case 0:
			return 2543.209f, -1310.053f, 49.20665f;
		
		case 1:
			return 2543.209f, -1310.153f, 49.21665f;
		
		case 2:
			return 2543.209f, -1310.253f, 49.21665f;
		
		case 3:
			return 2543.673f, -1308.602f, 48.6201f;
		
		case 4:
			return 2548.551f, -1308.547f, 48.6211f;
...
int func_154(var uParam0, int iParam1, vector3 vParam2)
{
	if (!STREAMING::HAS_MODEL_LOADED(iParam1))
	{
		return 0;
...
int func_155(var uParam0, int iParam1, int iParam2, char* sParam3)
{
...
void func_167(int iParam0, float fParam1, int iParam2, int iParam3)
{
	if (func_159(iParam0))
	{
...
int func_176(var uParam0, int iParam1, vector3 vParam2, int iParam5)
{
	if (uParam0->f_1 == 0)
	{
...
int func_189(var uParam0, float fParam1, var uParam2, float fParam3, int iParam4)
{
	...
	{
		func_223((*uParam0)[iVar0 /*5*/], fParam1, fVar1, fParam3, iParam4);
		iVar0++;
	}
	if (fVar1 >= fParam3)
	{
...
int func_191(var uParam0, float fParam1, var uParam2, float fParam3, int iParam4)
{
	int iVar0;
	float fVar1;
	...
	while (iVar0 <= (*uParam0 - 1))
	{
		func_224((*uParam0)[iVar0 /*5*/], fParam1, fVar1, fParam3, iParam4);
		iVar0++;
	}
	if (fVar1 >= fParam3)
	{
...
int func_202(var uParam0, float fParam1, var uParam2, float fParam3, int iParam4)
{
	float fVar0;
	...
	fVar0 = func_149(uParam2);
	func_224(uParam0, fParam1, fVar0, fParam3, iParam4);
	if (fVar0 >= fParam3)
	{
		func_150(uParam2);
		return 1;
...
int func_205(int iParam0, int iParam1, var uParam2, float fParam3, var uParam4, float fParam5, int iParam6)
{
	...
	while (iVar3 <= iVar1)
	{
		func_223((*uParam2)[iVar3 /*5*/], fParam3, fVar2, fParam5, iParam6);
		iVar3++;
	}
	if (fVar2 >= fParam5)
	{
...
int func_207(int iParam0, int iParam1, var uParam2, float fParam3, var uParam4, float fParam5, int iParam6)
{
	int iVar0;
	int iVar1;
	float fVar2;
	...
	while (iVar3 <= iVar1)
	{
		func_224((*uParam2)[iVar3 /*5*/], fParam3, fVar2, fParam5, iParam6);
		iVar3++;
	}
	if (fVar2 >= fParam5)
	{
...
var func_213(vector3 vParam0, vector3 vParam3, vector3 vParam6, int iParam9, var uParam10, var uParam11)
{
	var uVar0;
	int iVar1;
	int iVar2;
	...
	else
	{
		...
		{
			case 665633627:
				iVar8 = VOLUME::_CREATE_VOLUME_CYLINDER_WITH_CUSTOM_NAME(vParam0, vParam3, vParam6, func_227());
				break;
			
			case -432403087:
				iVar8 = VOLUME::_0x10157BC3247FF3BA(vParam0, vParam3, vParam6, func_227());
				break;
			
			case -1612834106:
				iVar8 = VOLUME::_CREATE_VOLUME_BOX_WITH_CUSTOM_NAME(vParam0, vParam3, vParam6, func_227());
				break;
		}
	}
	if (iVar9 & 8 != 0)
	{
		iVar9 = (iVar9 || func_228(PLAYER::GET_PLAYER_TEAM(iVar5)));
	}
	...
	while (iVar2 < 32)
	{
		if (NETWORK::NETWORK_IS_PLAYER_ACTIVE(&(Global_1273882->f_154[iVar2])))
		{
			...
			if (!bVar3)
			{
				if (iVar9 & 8192 != 0 && func_230(iVar2) != 1)
				{
					bVar3 = true;
				}
			}
...
void func_223(var uParam0, float fParam1, float fParam2, float fParam3, int iParam4)
{
	...
	if (ENTITY::DOES_ENTITY_EXIST(*uParam0))
	{
		if (uParam0->f_2 > fParam1 && uParam0->f_2 > uParam0->f_3)
		{
			...
			fVar0 = (fVar1 / fParam3);
			uParam0->f_2 = func_233(fParam1, uParam0->f_4, fVar0);
...
void func_224(var uParam0, float fParam1, float fParam2, float fParam3, int iParam4)
{
	float fVar0;
	float fVar1;
	...
	if (ENTITY::DOES_ENTITY_EXIST(*uParam0))
	{
		if (uParam0->f_2 < fParam1 && uParam0->f_2 < uParam0->f_4)
		{
			...
			uParam0->f_2 = func_233(uParam0->f_3, fParam1, fVar0);
			if (uParam0->f_2 > fParam1)
			{
				uParam0->f_2 = fParam1;
			}
...
int func_234(int iParam0, int iParam1)
{
	...
	if (iParam1 == 255)
	{
		return func_237(&(Global_1099293->f_4), iVar0, 5);
	}
	if (iParam1 == func_238())
	{
		return func_237(&(Global_1099293->f_4), iVar0, 5);
	...
	{
		return func_237(&(((*Global_1097609)[iParam1 /*51*/])->f_4), iVar0, 5);
	}
	return 0;
}
