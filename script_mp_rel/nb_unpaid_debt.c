...
void func_13(var uParam0, var uParam1, var uParam2, var uParam3, var uParam4)
{
	...
	iVar19 = func_30(&uVar18, Local_501.f_1, Local_501.f_2);
	if (uVar18 || iVar19 == -1)
	{
		return;
	}
...
void func_41()
{
	...
	iVar0 = (Global_1184672->f_231.f_1066[Local_501.f_12 /*17*/])->f_5;
...
int func_171()
{
	...
	iVar0 = 1;
	if (iVar0 && !UNLOCK::_UNLOCK_IS_UNLOCKED(Local_501.f_14))
	{
		return 0;
	}
	return 1;
