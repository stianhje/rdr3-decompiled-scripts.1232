...
bool func_5(var uParam0)
{
	...
	while (iVar0 < 5)
	{
		aggregate.hub_offers.func_18(uParam0->f_2[iVar0 /*3*/]);
		iVar0++;
	}
	aggregate.hub_offers.func_18(&(uParam0->f_18));
	return true;
}
...
{
	aggregate.fme_round_up.func_1144(iParam0, 0);
...
void func_10(int* iParam0)
{
	...
	if (aggregate.fme_animal_tagging.func_1458(iParam0, 1))
	{
		Var4 = { aggregate.hub_offers.func_24(iParam0) };
		if (func_25(iParam0, &Var4))
		{
			func_22(iParam0, &Var4, 1);
		}
		aggregate.hub_offers.func_26(iParam0, 1, 0);
	}
}
...
void func_11(int* iParam0)
{
	...
	iVar1 = aggregate.hub.func_16(iParam0);
	iVar0 = joaat("main");
	if (iVar0 != iVar1)
	{
		if (iVar1 != 0)
		{
			aggregate.hub_offers.func_28(iParam0, iVar1);
		}
		aggregate.camera_item.func_77(iParam0, iVar0);
		aggregate.hub_offers.func_28(iParam0, iVar0);
	}
	aggregate.hub_offers.func_28(iParam0, iVar0);
}
...
void func_12(var uParam0, var uParam1)
{
	...
	if (*uParam0)
	{
		if (!aggregate.camera_item.func_20(uParam1))
		{
			*uParam0 = 0;
		}
	}
...
{
	if (!aggregate.fme_animal_tagging.func_397(*iParam0, 1))
	{
		return;
	}
	...
	aggregate.fme_round_up.func_1140(iParam0, 1);
}
...
void func_17(int* iParam0)
{
	...
	aggregate.fme_round_up.func_1140(iParam0, 0);
	StringCopy(&(iParam0->f_1), "", 128);
	StringCopy(&(iParam0->f_17), "", 128);
}
...
bool func_25(var uParam0, var uParam1)
{
	...
	if (func_47(uParam0) > 0)
	{
		...
		{
			uParam1->f_2 = DATABINDING::_DATABINDING_READ_DATA_INT_FROM_PARENT(uParam1->f_3, aggregate.fme_animal_tagging.func_979(57));
		}
		else
		{
			iVar0 = 0;
...
bool func_33(var uParam0, float fParam1, int iParam2)
{
	...
	*uParam0 = 1;
	uParam0->f_1 = aggregate.barcustomer_interaction.func_55();
	uParam0->f_2 = fParam1;
	uParam0->f_3 = iParam2;
	return true;
}
...
{
	return aggregate.generic_document_inspection.func_433(*uParam0);
}
...
float func_35(var uParam0)
{
	...
	return MISC::ABSF((aggregate.barcustomer_interaction.func_55() - uParam0->f_1));
}
...
void func_41(var uParam0, int iParam1)
{
	...
	aggregate.fm_mission_controller.func_5525(uParam0);
}
...
int func_51(int* iParam0)
{
	...
	func_60(iParam0);
	aggregate.camera_item.func_77(&(iParam0->f_84), 4000);
	func_71(-712383481);
	return 1;
}
...
void func_52(int* iParam0)
{
	...
	{
		if (aggregate.binoculars.func_15(&(iParam0->f_18)))
		{
		}
		else
		{
...
{
	if (!aggregate.bandana.func_30(*uParam0, 0))
	{
		return 0;
	}
	if (!aggregate.hub.func_87(*uParam0))
	{
		return 1;
	}
	aggregate.hub_offers.func_81(*uParam0);
	*uParam0 = 0;
	uParam0->f_1 = 1;
	return 1;
}
...
bool func_59(var uParam0, var uParam1)
{
	...
	bVar19 = false;
	if (aggregate.aberdeenpigfarm.func_130(&Var0))
	{
		sVar18 = func_88(1);
	}
	else if (aggregate.hub.func_82(Var0))
	{
		sVar18 = func_90(Var0);
		bVar19 = true;
	}
...
bool func_61(int* iParam0, var uParam1)
{
	...
	else if (aggregate.aberdeenpigfarm.func_130(&Var0))
	{
		sVar18 = func_88(0);
	}
	else if (aggregate.hub.func_82(Var0))
...
bool func_67(var uParam0, var uParam1)
{
	...
	Var4.f_9 = -1591664384;
	if (!aggregate.bandana.func_66(Var0, &Var4, 1, 0, -1))
	{
		return false;
	}
	...
	if (!aggregate.fme_animal_tagging.func_1718(Var4.f_4))
	{
		return false;
	}
	if (!func_97(Var4.f_4))
...
void func_74(int* iParam0)
{
	...
	if (aggregate.hub_offers.func_106(&(iParam0->f_18)) == -1948187754)
	{
		func_107(iParam0, &vVar0);
		if (!aggregate.hub_offers.func_108(vVar0.x, &uVar3))
		{
		}
	...
	aggregate.hub_offers.func_26(iParam0, 0, 1);
	aggregate.hub_offers.func_26(iParam0, 1, 1);
}
...
int func_86(var uParam0, bool bParam1)
{
	...
	if (!aggregate.hub.func_87(bParam1))
	{
		return 1;
	}
	*uParam0 = bParam1;
...
char* func_90(struct<4> Param0)
{
	...
	if (!aggregate.doc_book.func_308(&Param0))
	{
		return "";
	}
	if (aggregate.hub.func_88(Param0) <= 0)
	{
		return "";
	}
	vVar0 = { aggregate.hub_offers.func_129(aggregate.hub.func_88(Param0), 1) };
	vVar3 = { aggregate.hub_offers.func_130(aggregate.hub.func_88(Param0), 1) };
	vVar6 = { aggregate.hub_offers.func_131(aggregate.hub.func_88(Param0)) };
...
bool func_97(bool bParam0)
{
	...
	{
		iVar0 = aggregate.fme_animal_tagging.func_1527(bParam0, 1);
		if (!aggregate.fme_animal_tagging.func_1698(iVar0))
		{
			return false;
		}
	}
...
bool func_98(var uParam0, bool bParam1)
{
	int iVar0;
	vector3 vVar1;
	struct<2> Var4;
	...
	if (!aggregate.fme_animal_tagging.func_1718(bParam1))
	{
		return false;
	}
	iVar0 = aggregate.fme_animal_tagging.func_1527(bParam1, 1);
	...
	if (aggregate.hub_offers.func_136(iVar0))
	{
		return false;
	}
	Var4 = -1;
	Var4.f_1 = -1;
	if (!aggregate.hub_offers.func_138(&Var4, iVar0, Var14, 1, 1, 0, 0, aggregate.fm_mission_controller.func_6299(iVar0, 0, 1, -1, 1), -1, 0))
	{
		return false;
	}
	...
	vVar1.x = Var4;
	vVar1.f_2 = bParam1;
	vVar1.f_1 = aggregate.hub_offers.func_140(bParam1);
	TELEMETRY::_0xCA9E42F437625A85(Var4, 1821104826, 1821104826);
	if (!aggregate.generic_document_inspection.func_393(&Var4))
	{
		return false;
	}
...
{
	if (*uParam0 && aggregate.camera_item.func_20(uParam1))
	{
		return false;
	}
	return *uParam0;
...
bool func_148(int* iParam0, char* sParam1, char* sParam2)
{
	if (!aggregate.fme_animal_tagging.func_397(*iParam0, 0))
	{
		return false;
	}
	if (aggregate.fme_animal_tagging.func_397(*iParam0, 1))
	...
	aggregate.fme_round_up.func_1144(iParam0, 1);
...
bool func_175(var uParam0, var uParam1)
{
	...
	uParam1->f_36 = aggregate.hub_offers.func_202(bVar0);
	Var1.f_8 = 10;
	Var1.f_8.f_1.f_4 = 15;
...
char* func_176(var uParam0)
{
	...
	if (!aggregate.fme_animal_tagging.func_1719(*uParam0))
	{
		return "";
	}
	if (aggregate.bandana.func_11(*uParam0, -462364930))
	{
		sVar0 = "COUPON_OFFER_LOCATION_BOUNTY_BOARD";
	}
	else if (aggregate.bandana.func_11(*uParam0, 791503389))
	{
		sVar0 = "COUPON_OFFER_LOCATION_COOK";
	}
	else if (aggregate.bandana.func_11(*uParam0, 1631625825) || aggregate.bandana.func_11(*uParam0, 769052425))
	{
		sVar0 = "COUPON_OFFER_LOCATION_OUTFITTERS";
	}
	else if (aggregate.bandana.func_11(*uParam0, 805642000))
	{
		sVar0 = "COUPON_OFFER_LOCATION_MADAM_NAZAR";
	}
	else if (aggregate.bandana.func_11(*uParam0, -290607961))
	{
		sVar0 = "COUPON_OFFER_LOCATION_OFFER";
	}
	else if (aggregate.bandana.func_11(*uParam0, -657940588))
	{
		sVar0 = "COUPON_OFFER_LOCATION_CATALOGUE";
	}
	else if (aggregate.bandana.func_11(*uParam0, -2141994197))
	{
		sVar0 = "COUPON_OFFER_LOCATION_STABLE";
	}
	else if (aggregate.bandana.func_11(*uParam0, -1336773246))
	{
		sVar0 = "COUPON_OFFER_LOCATION_GUNSMITH_STORE_CATALOGUE";
	}
	else if (aggregate.bandana.func_11(*uParam0, 565025927))
	{
		sVar0 = "COUPON_OFFER_LOCATION_GUNSMITH";
	}
	else if (aggregate.bandana.func_11(*uParam0, -698888345))
	{
		sVar0 = "COUPON_OFFER_LOCATION_GUNSMITH_CATALOGUE";
	}
	else if (aggregate.bandana.func_11(*uParam0, -700325949))
	{
		sVar0 = "COUPON_OFFER_LOCATION_ABILITIES_MENU";
	}
	else if (aggregate.bandana.func_11(*uParam0, 563589121))
	{
		sVar0 = "COUPON_OFFER_LOCATION_FAST_TRAVEL";
	}
	else if (aggregate.bandana.func_11(*uParam0, -1572489300))
	{
...
bool func_177(bool bParam0)
{
	...
	if (aggregate.bandana.func_11(*bParam0, -2141147161))
	{
		return true;
	}
	if (aggregate.bandana.func_11(*bParam0, -657940588))
	{
		return true;
	}
	else if (aggregate.bandana.func_11(*bParam0, -1197174069))
	{
		return true;
	}
	else if (aggregate.bandana.func_11(*bParam0, -1336773246))
	{
		return true;
	}
	else if (aggregate.bandana.func_11(*bParam0, -698888345))
	{
		return true;
	}
	return false;
...
bool func_178(bool bParam0)
{
	...
	if (!aggregate.fme_animal_tagging.func_1699(iVar0, 205718222))
	{
		return false;
	}
	return true;
...
char* func_180(bool bParam0)
{
	...
	if (aggregate.bandana.func_11(*bParam0, 791503389))
	{
		sVar0 = "COUPON_REWARD_LOCATION_COOK";
	}
	else if (aggregate.bandana.func_11(*bParam0, 1678998893))
	{
		sVar0 = "COUPON_REWARD_LOCATION_BUTCHERS_TABLE";
	}
	else if (aggregate.bandana.func_11(*bParam0, 1060967958))
	{
		sVar0 = "COUPON_REWARD_LOCATION_POSSE";
	}
	else if (aggregate.bandana.func_11(*bParam0, -354977419))
	{
		sVar0 = "COUPON_REWARD_LOCATION_OPTIONS";
	}
	else if (aggregate.bandana.func_11(*bParam0, -700325949))
	{
		sVar0 = "COUPON_REWARD_LOCATION_ABILITIES";
	}
	else if (aggregate.bandana.func_11(*bParam0, -462364930))
	{
		sVar0 = "COUPON_REWARD_LOCATION_BOUNTY_BOARD";
	}
	else if (aggregate.bandana.func_11(*bParam0, 769052425))
	{
		sVar0 = "COUPON_REWARD_LOCATION_OUTFITTERS_OR_CRIPPS";
	}
	else if (aggregate.bandana.func_11(*bParam0, 1631625825))
	{
		sVar0 = "COUPON_REWARD_LOCATION_OUTFITTERS";
	}
	else if (aggregate.bandana.func_11(*bParam0, 805642000))
	{
		sVar0 = "COUPON_REWARD_LOCATION_MADAM_NAZAR";
	}
	else if (aggregate.bandana.func_11(*bParam0, -290607961))
	{
		sVar0 = "COUPON_REWARD_LOCATION_REWARD";
	}
	else if (aggregate.bandana.func_11(*bParam0, -13230814))
	{
		sVar0 = "COUPON_REWARD_LOCATION_POST_OFFICE";
	}
	else if (aggregate.bandana.func_11(*bParam0, 1501879121))
	{
		sVar0 = "COUPON_REWARD_LOCATION_OLD_MAN_JONES";
	}
	else if (aggregate.bandana.func_11(*bParam0, -657940588))
	{
	...
	else if (aggregate.bandana.func_11(*bParam0, 565025927))
	{
	...
	else if (aggregate.bandana.func_11(*bParam0, 720980519))
	{
...
bool func_182(var uParam0, var uParam1, char[32] cParam2, char[4] cParam10)
{
	...
	aggregate.fme_animal_tagging.func_1236(uParam0, *uParam1, cParam2, *cParam10);
...
bool func_183(var uParam0, char[4] cParam1)
{
	...
	DATABINDING::_DATABINDING_WRITE_DATA_BOOL_FROM_PARENT(*uParam0, aggregate.fme_animal_tagging.func_979(0), *cParam1);
	DATABINDING::_DATABINDING_WRITE_DATA_BOOL_FROM_PARENT(*uParam0, aggregate.fme_animal_tagging.func_979(1), cParam1->f_1);
	DATABINDING::_DATABINDING_WRITE_DATA_HASH_STRING_FROM_PARENT(*uParam0, aggregate.fme_animal_tagging.func_979(2), cParam1->f_2);
	DATABINDING::_DATABINDING_WRITE_DATA_HASH_STRING_FROM_PARENT(*uParam0, aggregate.fme_animal_tagging.func_979(54), cParam1->f_3);
	DATABINDING::_DATABINDING_WRITE_DATA_HASH_STRING_FROM_PARENT(*uParam0, aggregate.fme_animal_tagging.func_979(57), cParam1->f_5);
	DATABINDING::_DATABINDING_WRITE_DATA_HASH_STRING_FROM_PARENT(*uParam0, aggregate.fme_animal_tagging.func_979(56), cParam1->f_6);
	DATABINDING::_DATABINDING_WRITE_DATA_HASH_STRING_FROM_PARENT(*uParam0, aggregate.fme_animal_tagging.func_979(55), cParam1->f_4);
	DATABINDING::_0xA3BD6FF95E713EE5(*uParam0, -2035241910, &(cParam1->f_42));
	DATABINDING::_DATABINDING_WRITE_DATA_BOOL_FROM_PARENT(*uParam0, aggregate.fme_animal_tagging.func_979(59), cParam1->f_8);
	DATABINDING::_DATABINDING_WRITE_DATA_BOOL_FROM_PARENT(*uParam0, aggregate.fme_animal_tagging.func_979(60), cParam1->f_9);
...
bool func_201(bool bParam0, var uParam1)
{
	...
	if (!aggregate.doc_book.func_272(*bParam0))
	{
		return false;
	}
	Var16.f_2 = 5;
