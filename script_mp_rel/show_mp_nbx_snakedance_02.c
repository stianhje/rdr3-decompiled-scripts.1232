...
int func_96(var uParam0)
{
	...
	if (!func_153(uParam0, iVar0, 0, "DANCER"))
	{
		return 0;
	}
	if (!func_153(uParam0, iVar0, 1, "SNAKE"))
	{
		return 0;
	}
...
void func_119(var uParam0, var uParam1, var uParam2, float fParam3)
{
	switch (uParam0->f_1)
	{
		...
		case 34:
			if (ANIMSCENE::_0xCBFC7725DE6CE2E0(NETWORK::_0xD7F6781A0ABAF6FB(uParam0->f_1374), 0) && ANIMSCENE::_0x3FBC3F51BF12DFBF(NETWORK::_0xD7F6781A0ABAF6FB(uParam0->f_1374)) > func_160(iLocal_16))
			{
