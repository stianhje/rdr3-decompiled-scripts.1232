...
void __EntryFunction__()
{
	...
	fLocal_21 = 1f;
	iLocal_25 = 20000;
	iLocal_28 = vScriptParam_0.x;
	iLocal_26 = vScriptParam_0.z;
	iLocal_30 = 0;
		...
		if (MISC::GET_GAME_TIMER() > iLocal_27)
		{
			...
			switch (iLocal_26)
			{
				case 0:
					if (Global_1901929->f_1.f_24 > 0)
					{
						iLocal_29 = (MISC::GET_GAME_TIMER() + Global_1901929->f_1.f_24);
						iLocal_26 = 1;
					}
					else
					{
				...
				case 2:
					...
					LAW::_0x9BBDCB8DF789EBC1(PLAYER::PLAYER_ID(), func_12(iLocal_28));
					Global_1896608 = -1;
				...
				case 7:
					if (func_10(func_9(iLocal_28)))
					{
						...
						else
						{
							...
							func_36(iLocal_28, Global_1896662);
							iLocal_26 = 11;
							Jump @816; //curOff = 642
							func_37(iLocal_28);
							func_21(iLocal_28, 8);
							...
							func_41(Global_1896662, iLocal_28);
							func_42(iLocal_28);
							func_21(iLocal_28, 8);
							if (func_43())
							{
							...
							PATHFIND::SET_AMBIENT_PED_RANGE_MULTIPLIER_THIS_FRAME(((*Global_1887327)[iLocal_28 /*36*/])->f_11);
							if (((*Global_1887327)[iLocal_28 /*36*/])->f_12 > 0f)
							{
								PED::_0xA77FA7BE9312F8C0(((*Global_1887327)[iLocal_28 /*36*/])->f_12);
							}
							Jump @816; //curOff = 793
							func_8();
							func_44(iVar0);
						...
						if (((*Global_1887327)[iLocal_28 /*36*/])->f_13 != 0)
						{
							PED::_0x95423627A9CA598E(((*Global_1887327)[iLocal_28 /*36*/])->f_13);
						}
						BUILTIN::WAIT(0);
						iVar0 = 0;
						while (!func_44(iVar0))
...
{
	if (((func_60(Global_35, iLocal_13, 1, 0) && iLocal_15 < MISC::GET_GAME_TIMER()) && func_62(func_61())) && func_63(6, 18))
	{
	...
	if (iParam0 == 0)
	{
		...
		if (STATS::CHAL_IS_GOAL_ACTIVE(-663946200, 1055032020))
		{
			switch (iLocal_28)
			{
				...
				case 127:
				case 135:
					STATS::CHAL_ADD_GOAL_PROGRESS_INT_BY_SCORE_ID(func_77(iLocal_28, 0), 1);
					break;
			}
		}
		if (func_10(func_70()))
...
int func_83(int iParam0, bool bParam1)
{
	...
	if (func_88(iParam0, &iVar0, &iVar1, 0, 0))
	{
		...
		while (true)
		{
			if (!func_116(Global_1896608->f_1, 16))
			{
				func_117(Global_1896608->f_1, 0);
			}
			Global_1896608->f_1++;
			iVar2++;
...
int func_84(int iParam0)
{
	...
	while (iVar0 < 39)
	{
		if (func_118(iVar0) || func_119(iVar0))
		{
		}
		else
		{
...
int func_91(int iParam0, bool bParam1)
{
	...
	{
		func_124(iParam0, _NAMESPACE48::_0x4F76E3676583D951(func_123(iParam0)));
		if (func_45() == -1)
		{
			if (func_116(iParam0, 2048))
			{
				_NAMESPACE48::_0x49A8C2CD97815215(func_125(iParam0));
				func_126(iParam0, 2048);
			}
			_NAMESPACE48::_0xFCC6DB8DBE709BC8(func_125(iParam0));
		}
		return 0;
	}
	...
	if (_NAMESPACE48::_0x800DF3FC913355F3(func_125(iParam0)))
	{
		func_126(iParam0, 128);
		return 1;
	}
	func_124(iParam0, _NAMESPACE48::_0x4F76E3676583D951(func_123(iParam0)));
	_NAMESPACE48::_0x4F81EAD1DE8FA19B(func_125(iParam0));
	if (func_116(iParam0, 2048))
	{
		_NAMESPACE48::_0x49A8C2CD97815215(func_125(iParam0));
		func_126(iParam0, 2048);
...
char* func_96(int iParam0, int iParam1, int iParam2, int iParam3, var uParam4, var uParam5, var uParam6)
{
	...
	{
		sVar0 = func_131(Global_1893575->f_162);
	}
	if (MISC::IS_STRING_NULL_OR_EMPTY(sVar0) && uParam4)
	{
		sVar0 = func_133(func_132(Global_36));
	}
...
int func_99(int iParam0)
{
	...
	iVar0 = 0;
	Var1 = { func_136(PLAYER::PLAYER_ID()) };
...
char* func_108(char* sParam0, int iParam1)
{
	...
	return func_137(MISC::_CREATE_VAR_STRING(10, "LITERAL_STRING", sParam0), iParam1);
}
...
{
	func_138((Global_1938932->f_5[iParam0 /*11*/])->f_6, 1);
	func_139((Global_1938932->f_5[iParam0 /*11*/])->f_6, 0);
...
void func_115(int iParam0)
{
	...
	if (func_89((Global_1915170->f_3[iParam0 /*447*/])->f_21) && func_141((Global_1915170->f_3[iParam0 /*447*/])->f_21))
	{
		func_142((Global_1915170->f_3[iParam0 /*447*/])->f_21, 0, 1, 0, 0);
	}
	...
	func_143((Global_1915170->f_3[iParam0 /*447*/])->f_9, 0);
	...
	else
	{
		...
		while (iVar0 < iVar1)
		{
			func_146(&((Global_1915170->f_3[iParam0 /*447*/])->f_318[iVar0 /*6*/]));
...
int func_117(int iParam0, bool bParam1)
{
	...
	func_149(iParam0);
	_NAMESPACE48::_0xFC77C5B44D5FF7C0(func_125(iParam0));
	func_124(iParam0, 0);
	return 1;
}
...
void func_122(int iParam0)
{
	...
	else
	{
		...
		while (iVar2 < iVar3)
		{
			func_146(&((Global_1051387->f_69[iParam0 /*76*/])->f_32[iVar2]));
...
var func_131(var uParam0, var uParam1, var uParam2, var uParam3, var uParam4, var uParam5, var uParam6, var uParam7)
{
...
char* func_137(char* sParam0, int iParam1)
{
...
{
	func_168(&((Global_1938932->f_5[iParam0 /*11*/])->f_7), iParam1);
}
...
{
	return func_180((Global_1051387->f_69[iParam0 /*76*/])->f_51, iParam1);
}
...
int func_161()
{
	...
	if (!func_163(*Global_1051163) && Global_1572887->f_7 & 1 != 0)
	{
		return 1;
	}
	return 0;
...
int func_165(vector3 vParam0, int iParam3)
{
	vector3 vVar0;
	struct<2> Var3;
	float fVar6;

	func_183(iParam3, &vVar0, &Var3, &fVar6);
	if (func_184(vParam0, vVar0, Var3, Var3.f_1, fVar6))
	{
		return 1;
	}
	return 0;
...
bool func_184(vector3 vParam0, vector3 vParam3, float fParam6, float fParam7, float fParam8)
{
	vector3 vVar0;
	struct<2> Var3;
	float fVar6;
