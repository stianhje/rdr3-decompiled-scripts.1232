...
void func_2()
{
	...
	aggregate.bayounwa_population.func_7(iLocal_21);
	...
	aggregate.bayounwa_population.func_7(iLocal_26);
	...
	aggregate.bayounwa_population.func_9(iLocal_27, 0, 0);
	...
	aggregate.bigvalley_population.func_12(iLocal_29, 0, 0);
	...
	aggregate.bayounwa_population.func_10(iLocal_31, 0, 0);
	...
	aggregate.bayounwa_population.func_8(iLocal_32, 0, 0);
}
