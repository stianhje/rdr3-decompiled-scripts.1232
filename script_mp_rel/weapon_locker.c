...
int func_7(var uParam0)
{
	...
	uParam0->f_94.f_3 = DATABINDING::_DATABINDING_ADD_DATA_HASH(uParam0->f_94, "footer_color", 1105014447);
	return 1;
}
...
int func_46(var uParam0, var uParam1)
{
	...
	Var2 = { func_63(iVar0, func_62(0), iVar1, 0) };
	if (!func_64(&Var2))
	{
		return 0;
	}
...
int func_49(var uParam0, int iParam1)
{
	...
	if (!func_68(iVar0, iVar1, iParam1))
	{
		return 0;
	}
	return 1;
...
int func_56(int* iParam0, int iParam1)
{
	...
	while (iVar19 < 7)
	{
		...
		while (iVar18 < iVar1)
		{
			if (!func_77(&Var2, iVar18, iVar0, iVar1))
			{
			}
						...
						case -1:
							...
							else
							{
								...
								else
								{
									...
									else if (!func_81(iParam0, iVar17, Var2.f_4, Var2.f_9, iVar16, iParam1))
									{
									}
									else
									{
...
void func_58(int* iParam0, int iParam1)
{
	...
	switch (iParam1)
	{
		case 1:
			...
			func_88(iParam0, -2012945523);
			break;
		
		case 2:
			func_87(iParam0, iVar0 == 0);
			func_88(iParam0, -1705332461);
			break;
...
struct<4> func_63(int iParam0, var uParam1, var uParam2, var uParam3, var uParam4, int iParam5, bool bParam6)
{
	struct<4> Var0;
	...
	INVENTORY::_0x886DFD3E185C8A89(func_93(bParam6), &uParam1, iParam0, iParam5, &Var0);
	return Var0;
}
...
int func_68(int iParam0, int iParam1, int iParam2)
{
	...
	Var1 = { func_63(iParam0, func_62(0), iParam1, 0) };
	Var5.f_9 = -1591664384;
	if (!INVENTORY::_0x025A1B1FB03FBF61(2, &Var1, &Var5, 22, 1))
	{
		return 0;
	...
	if (func_78(Var28.f_4))
	{
		...
		while (iVar84 < iVar83)
		{
			...
			else if (!func_99(iParam0, iVar84, &iVar82))
			{
			}
			else if (iParam2 != iVar82)
			{
			}
			else if (!func_99(iParam0, iVar84 + 1, &iVar81))
			{
			}
					...
					if (INVENTORY::_0x025A1B1FB03FBF61(2, &uVar55, &Var59, 22, 1))
					{
						...
						else
						{
							...
							if (!bVar54)
							{
								if (func_64(&uVar50))
								{
									if (func_103(iParam0, iVar27, iVar0))
									{
...
{
	*uParam1 = INVENTORY::_0x80D78BDC9D88EF07(func_93(bParam4), sParam0, iParam3, uParam2);
	if (*uParam1 >= 0)
	{
		return 1;
	}
...
int func_81(var uParam0, int iParam1, int iParam2, int iParam3, int iParam4, int iParam5)
{
	struct<13> Var0;
	bool bVar53;
	var uVar54;
	...
	Var0.f_11 = -1;
	Var0.f_12 = -1;
	if (!func_105(iParam2, iParam3, &Var0, iParam4, iParam5))
	{
		return 0;
	}
	bVar53 = true;
	if (iParam1 < func_84(uParam0))
	{
		if (func_91(uParam0, iParam1, &uVar54))
		{
...
int func_82(var uParam0, int iParam1)
{
	...
	while (iVar1 >= iParam1)
	{
		DATABINDING::_0x6318FB3BE37E11B3(uParam0->f_2.f_1, iVar1);
		iVar1 = (iVar1 + -1);
	}
	return 1;
}
...
{
	if (!DATABINDING::_DATABINDING_IS_DATA_ID_VALID(uParam0->f_2.f_90))
	{
		return 0;
	}
	DATABINDING::_DATABINDING_WRITE_DATA_BOOL(uParam0->f_2.f_90, bParam1);
	return 1;
}

int func_88(var uParam0, int iParam1)
{
	if (!DATABINDING::_DATABINDING_IS_DATA_ID_VALID(uParam0->f_2.f_91))
	{
		return 0;
	}
	DATABINDING::_DATABINDING_WRITE_DATA_HASH_STRING(uParam0->f_2.f_91, iParam1);
	return 1;
}

var func_89(var uParam0)
{
	return uParam0->f_102.f_1;
}
...
int func_91(var uParam0, int iParam1, var uParam2)
{
	if (!DATABINDING::_DATABINDING_IS_DATA_ID_VALID(uParam0->f_2.f_1))
	{
		return 0;
	}
	if (iParam1 < 0 || iParam1 >= DATABINDING::_DATABDING_GET_ARRAY_COUNT(uParam0->f_2.f_1))
	{
		return 0;
	}
...
int func_92(var uParam0, int iParam1)
{
	...
	MISC::_COPY_MEMORY(&(uParam0->f_98), iParam1, 4);
	return 1;
}
...
struct<4> func_94(bool bParam0)
{
	...
	if (Global_1572887->f_13 == 0)
	{
		...
		if (iVar0 == 2)
		{
			...
			{
				*Global_1270479 = { func_63(1328661203, func_109(), -1591664384, bParam0) };
			}
		...
		else if (iVar0 == 3)
		{
			...
			{
				Global_1270479->f_12 = { func_63(1328661203, func_109(), -1591664384, 0) };
			}
			return Global_1270479->f_12;
		}
	}
	return func_63(1328661203, func_109(), -1591664384, bParam0);
}
...
int func_96(var uParam0)
{
	...
	Var0.f_9 = -1591664384;
	if (!INVENTORY::_0x025A1B1FB03FBF61(func_93(0), uParam0, &Var0, 22, 1))
	{
		return 2;
	}
	iVar22 = Var0.f_14;
...
int func_101(var uParam0, int iParam1, bool bParam2)
{
	struct<4> Var0;
	struct<13> Var22;
	var uVar38;
...
int func_105(int iParam0, int iParam1, var uParam2, int iParam3, int iParam4)
{
	struct<5> Var0;
	...
	if (INVENTORY::_0xE787F05DFC977BDE(func_93(1), iParam0, 0) > 1)
	{
	...
	StringCopy(&(uParam2->f_16), func_112(iParam0), 64);
	if (!func_115(iParam0, &Var0))
	{
	}
	uParam2->f_30 = Var0;
	...
	uParam2->f_8 = 0;
	uParam2->f_9 = 0;
	if (!func_116(iParam0, iParam1, uParam2))
	{
		return 0;
	}
...
int func_107(var uParam0, var uParam1)
{
	...
	StringIntConCat(&cVar0, DATABINDING::_DATABDING_GET_ARRAY_COUNT(uParam0->f_2.f_1), 64);
	func_119(&iVar8, uParam0->f_2.f_1, cVar0, uParam1);
	DATABINDING::_DATABINDING_INSERT_UI_ITEM_TO_LIST_FROM_CONTEXT_STRING_ALIAS(uParam0->f_2.f_1, -1, "pm_dynamic_text_and_end_image", iVar8);
	return 1;
}
...
int func_115(int iParam0, var uParam1)
{
	...
	fVar34 = 100f;
	Var35 = { func_124(-664570214, WEAPON::_0x8EC44AE8DECFF841(iParam0)) };
	...
	iVar39 = 0;
	iVar40 = 0;
	Var41 = { func_125(iParam0, 0, 0) };
	Var46 = { func_63(iParam0, Var41, Var41.f_4, 0) };
	iVar50 = func_126(iParam0);
	iVar51 = 0;
	while (iVar51 < iVar50)
	{
		iVar52 = func_127(iParam0, iVar51);
		if (iVar52 != 0)
		{
			iVar53 = func_128(Var46, iVar52, 0, -1);
			if (func_67(iVar53, 0))
			{
...
int func_116(int iParam0, int iParam1, var uParam2)
{
	...
	Var0 = { func_63(iParam0, func_62(0), iParam1, 0) };
	if (!func_64(&Var0))
	{
		return 0;
	}
	if (!func_129(iParam0, 1728382685, 0) && !func_129(iParam0, -649335959, 0))
	{
		return 0;
	}
	...
	while (iVar6 < iVar5)
	{
		if (!func_99(iParam0, iVar6, &iVar4))
		{
		}
		else if (iVar6 == 0)
		{
...
int func_119(var uParam0, int iParam1, char[32] cParam2, var uParam10)
{
	if (!DATABINDING::_DATABINDING_IS_DATA_ID_VALID(iParam1))
	{
		return 0;
	}
	func_136(uParam0, iParam1, cParam2, *uParam10);
	if (!DATABINDING::_DATABINDING_IS_DATA_ID_VALID(*uParam0))
	{
		return 0;
	}
	uParam0->f_22 = DATABINDING::_DATABINDING_ADD_DATA_HASH(*uParam0, func_118(9), uParam10->f_27);
	uParam0->f_23 = DATABINDING::_DATABINDING_ADD_DATA_HASH(*uParam0, func_118(10), uParam10->f_28);
	uParam0->f_24 = DATABINDING::_DATABINDING_ADD_DATA_BOOL(*uParam0, func_118(11), uParam10->f_29);
...
bool func_120()
{
	return (func_137(-1185145312, 0, 0, 0) > 0 && func_128(func_63(889965687, func_94(1), 1034665895, 1), -234132662, 1, -1) != 0);
}
...
int func_121()
{
	...
	Var4.f_9 = -1591664384;
	if (func_76("ALL WEAPONS", &iVar0, &iVar1, -1591664384, 0))
	{
		iVar2 = 0;
		while (iVar2 < iVar1)
		{
...
{
	return func_139(iParam0) == -427144552;
}
...
struct<5> func_125(int iParam0, bool bParam1, int iParam2)
{
	struct<5> Var0;
	int iVar5;
	struct<10> Var6;
	...
	{
		case -1037537535:
			Var0 = { func_63(889965687, Var0, 1034665895, bParam1) };
		...
		case -1962314949:
			...
			{
				Var0 = { func_63(-1838434463, Var0, 1084182731, bParam1) };
...
int func_127(int iParam0, int iParam1)
{
	...
	if (iParam0 != 0)
	{
		...
		if (iVar0 != 0)
		{
			if (iParam1 >= 0 && iParam1 < func_126(iParam0))
			{
...
int func_128(var uParam0, var uParam1, var uParam2, var uParam3, int iParam4, bool bParam5, int iParam6)
{
	return func_147(&uParam0, iParam4, bParam5, iParam6);
}
...
int func_129(int iParam0, int iParam1, bool bParam2)
{
	...
	if (!func_148(iParam0, &uVar22, &Var0, iParam1))
	{
		return 0;
	}
	if (!bParam2)
	{
		if (func_142(iParam0, &Var0, iParam1))
		{
			return 0;
		}
	}
...
int func_130(var uParam0, int iParam1)
{
	...
	if (func_80(uParam0) == 0)
	{
		if (func_64(&uVar22))
		{
			if (func_149(uParam0, &uVar22))
			{
				return 3;
			}
		}
...
int func_133(var uParam0)
{
	...
	if (func_80(uParam0) == 2)
	{
		return 3;
	}
	if (func_80(uParam0) == 0)
	{
		switch (func_150(uParam0))
		{
			case 1:
				return 1;
...
void func_136(var uParam0, int iParam1, struct<8> Param2, struct<27> Param10)
{
	func_151(uParam0, iParam1, Param2, Param10);
	uParam0->f_18 = DATABINDING::_DATABINDING_ADD_DATA_STRING(*uParam0, func_118(15), &(Param10.f_16));
	uParam0->f_19 = DATABINDING::_DATABINDING_ADD_DATA_HASH(*uParam0, func_118(21), Param10.f_24);
	uParam0->f_20 = DATABINDING::_DATABINDING_ADD_DATA_HASH(*uParam0, func_118(22), Param10.f_25);
	uParam0->f_21 = DATABINDING::_DATABINDING_ADD_DATA_BOOL(*uParam0, func_118(23), Param10.f_26);
}

int func_137(int iParam0, bool bParam1, bool bParam2, int iParam3)
{
	if (func_152(iParam0) && !bParam2)
	{
		return WEAPON::GET_PED_AMMO_BY_TYPE(Global_35, iParam0);
	}
	return INVENTORY::_0xE787F05DFC977BDE(func_93(bParam1), iParam0, iParam3);
}
...
bool func_141(int iParam0, var uParam1, int iParam2, bool bParam3, int iParam4)
{
	return func_153(iParam0, *uParam1, iParam2, bParam3, 1, iParam4) > 0;
}
...
int func_142(int iParam0, var uParam1, int iParam2)
{
	...
	if (func_148(iParam0, &uVar0, uParam1, iParam2))
	{
...
bool func_146(var uParam0, var uParam1, var uParam2, var uParam3, var uParam4, bool bParam5, bool bParam6, int iParam7)
{
	return func_155(&uParam0, uParam4, bParam5, bParam6, iParam7);
}

int func_147(var uParam0, var uParam1, bool bParam2, int iParam3)
{
	struct<10> Var0;
	
	Var0.f_9 = -1591664384;
	if (func_156(uParam0, uParam1, &Var0, bParam2, iParam3))
	{
		return Var0.f_4;
	}
	return 0;
...
int func_148(int iParam0, var uParam1, var uParam2, int iParam3)
{
	...
	iVar0 = func_93(0);
	*uParam1 = { func_63(iParam0, func_62(0), iParam3, 0) };
...
void func_151(var uParam0, int iParam1, var uParam2, var uParam3, var uParam4, var uParam5, var uParam6, var uParam7, var uParam8, var uParam9, struct<16> Param10)
{
	*uParam0 = DATABINDING::_DATABINDING_ADD_DATA_CONTAINER(iParam1, &uParam2);
	uParam0->f_1 = DATABINDING::_DATABINDING_ADD_DATA_BOOL(*uParam0, func_118(0), Param10);
	uParam0->f_2 = DATABINDING::_DATABINDING_ADD_DATA_BOOL(*uParam0, func_118(1), Param10.f_1);
	uParam0->f_3 = DATABINDING::_DATABINDING_ADD_DATA_HASH(*uParam0, func_118(2), Param10.f_2);
	uParam0->f_4 = DATABINDING::_DATABINDING_ADD_DATA_HASH(*uParam0, func_118(54), Param10.f_3);
	uParam0->f_5 = DATABINDING::_DATABINDING_ADD_DATA_HASH(*uParam0, func_118(55), Param10.f_4);
	uParam0->f_7 = DATABINDING::_DATABINDING_ADD_DATA_HASH(*uParam0, func_118(57), Param10.f_5);
	...
	uParam0->f_10 = DATABINDING::_DATABINDING_ADD_DATA_BOOL(*uParam0, func_118(60), Param10.f_9);
	uParam0->f_11 = DATABINDING::_DATABINDING_ADD_DATA_HASH(*uParam0, func_118(61), Param10.f_10);
	uParam0->f_13 = DATABINDING::_DATABINDING_ADD_DATA_HASH(*uParam0, func_118(67), Param10.f_11);
	...
	uParam0->f_16 = DATABINDING::_DATABINDING_ADD_DATA_BOOL(*uParam0, func_118(66), Param10.f_15);
}
...
int func_153(int iParam0, struct<4> Param1, int iParam5, bool bParam6, bool bParam7, int iParam8)
{
	...
	if (!bParam7 && func_157(iParam0, -455129387) == 0)
	{
		bParam7 = true;
	}
	iVar0 = 0;
	if (bParam7)
	{
		Var1 = { func_63(iParam0, Param1, iParam5, bParam6) };
		if (!INVENTORY::_0xB881CA836CC4B6D4(&Var1))
		{
			return 0;
		}
		iVar0 = INVENTORY::_0xC97E0D2302382211(func_93(bParam6), &Var1, iParam8);
	}
	else
	{
		iVar0 = INVENTORY::_0xE787F05DFC977BDE(func_93(bParam6), iParam0, iParam8);
	}
	return iVar0;
}
...
int func_155(var uParam0, var uParam1, bool bParam2, bool bParam3, int iParam4)
{
...
int func_156(var uParam0, var uParam1, var uParam2, bool bParam3, int iParam4)
{
	var uVar0;
	...
	if (!func_155(&uVar0, uParam2, bParam3, 0, iParam4))
	{
		return 0;
	}
	return 1;
