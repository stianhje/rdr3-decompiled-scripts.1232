...
void __EntryFunction__()
{
	...
	while (bVar0)
	{
		...
		{
			if (aggregate.adlerranch.func_93(-1414537028))
			{
				POPULATION::_0xF45E46DEECF7DF6E(2016, 0, 0, -1, -1);
			}
			else if (aggregate.adlerranch.func_93(38162571))
			{
				POPULATION::_0xF45E46DEECF7DF6E(224, 0, 0, -1, -1);
				POPULATION::_0xDBBF12EA7C1029B2(0, 1);
			}
			else if (aggregate.adlerranch.func_93(1350391819))
			{
...
void func_2()
{
	...
	aggregate.bayounwa_population.func_8(iLocal_19, 0, 0);
	...
	aggregate.bayounwa_population.func_8(iLocal_20, 0, 0);
