...
bool func_103(int iParam0, int iParam1, var uParam2, var uParam3)
{
	return func_162(iParam0, "sHash", iParam1, "fHeading", uParam2, "vPos", uParam3);
}

bool func_104(int iParam0, int iParam1, var uParam2, var uParam3)
{
	return func_162(iParam0, "sClosedHash", iParam1, "fClosedHeading", uParam2, "vClosedPos", uParam3);
}
...
int func_162(int iParam0, char* sParam1, int iParam2, char* sParam3, var uParam4, char* sParam5, var uParam6)
{
	struct<4> Var0;
