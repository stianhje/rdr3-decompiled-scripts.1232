	...
	switch (func_29(uParam0))
	{
		...
		case 5:
			if (func_43(uParam0, 1097859072))
			{
				if (!func_32(uParam0->f_14))
				{
					uParam0->f_14 = func_44("UC_CLT_DIG", joaat("INPUT_CONTEXT_X"), uParam0->f_6, 1070386381, 3, 1, 0, 4, 570, 4000, 10, 1073741824, 0, joaat("SHORT_TIMED_EVENT"), 0);
				}
				func_31(uParam0, 6);
			}
			break;
...
{
	if (func_80(85134332 /* GXTEntry: "Pennington Field Shovel" */, 1))
	{
		if (bParam0)
		{
			if (func_80(-862059856 /* GXTEntry: "Metal Detector" */, 1))
			{
				return 1;
			}
		}
...
void func_36(var uParam0, vector3 vParam1, bool bParam4, bool bParam5, int iParam6)
{
	...
	if (!func_80(-1733092640 /* GXTEntry: "Collector\'s Bag" */, 1))
	{
		return;
	}
	if (func_82(0))
...
bool func_80(bool bParam0, int iParam1)
{
	...
	return func_121(bParam0, 0, 0, 0) >= iParam1;
}
...
bool func_94(bool bParam0)
{
	...
	Var0.f_4 = 1084182731;
	Var0 = { func_128(0) };
	return func_129(bParam0, &Var0, 1, 1, 0, -1, 0);
}
...
int func_119(bool bParam0, int iParam1)
{
	...
	iVar0 = func_137(bParam0, iParam1);
	Var4.f_9 = -1591664384;
	if (func_138("ALL WEAPONS", &iVar1, &iVar2, -1591664384, 0))
	{
		...
		while (bVar3 < iVar2)
		{
			if (!func_139(&Var4, bVar3, iVar1, iVar2))
			{
			}
...
int func_121(bool bParam0, bool bParam1, bool bParam2, bool bParam3)
{
	...
	if (func_147(bParam0, joaat("DEFAULT")) != 0)
	{
		iVar0 = INVENTORY::_0xE787F05DFC977BDE(func_148(bParam2), bParam0, bParam3);
	}
	else
	{
		Var3 = { func_149(bParam0, bParam2) };
...
struct<4> func_128(bool bParam0)
{
	...
	if (Global_1572887->f_13 == 0)
	{
		...
		if (iVar0 == 2)
		{
			...
			{
				*Global_1270479 = { func_154(joaat("CHARACTER"), func_153(), -1591664384, bParam0) };
			}
		...
		else if (iVar0 == 3)
		{
			...
			{
				Global_1270479->f_12 = { func_154(joaat("CHARACTER"), func_153(), -1591664384, 0) };
			}
...
int func_129(bool bParam0, var uParam1, int iParam2, bool bParam3, bool bParam4, int iParam5, int iParam6)
{
	struct<4> Var0;
	struct<10> Var4;
	int iVar26;
	...
	func_155(&bParam0);
	if (!func_62(bParam0, 0) && !func_157(func_156(bParam0), 2))
	{
		return 0;
	}
	if (!bParam3 && func_147(bParam0, joaat("DEFAULT")) == 0)
	{
		bParam3 = true;
	}
	if (func_158(bParam0) && WEAPON::_0x705BE297EEBDB95D(bParam0))
	{
		Var0 = { func_159(0) };
		Var4.f_9 = -1591664384;
		if (!func_160(bParam0, &Var0, 1728382685 /* GXTEntry: "Right" */, 0, 0))
		{
			return 0;
		}
		else if (func_161(bParam0, &Var4, 1728382685 /* GXTEntry: "Right" */))
		{
			return 0;
		}
		if (func_162(bParam0, 1))
		{
			if (!func_160(bParam0, &Var0, -649335959 /* GXTEntry: "Left" */, 0, 0))
			{
				return 0;
			}
			else if (func_161(bParam0, &Var4, -649335959 /* GXTEntry: "Left" */))
			{
				return 0;
			}
		}
	...
	if (iParam5 < 0)
	{
		iVar26 = func_163(bParam0, uParam1, bParam3, bParam4);
	}
	if (iVar26 < 0)
	{
		return 0;
	...
	iVar27 = func_164(bParam0, *uParam1, uParam1->f_4, bParam4, bParam3, iParam6);
...
int func_137(bool bParam0, int iParam1)
{
	...
	if (func_173(bParam0, 1399091007))
	{
		func_174(bParam0, &uVar1, &uVar2);
		return uVar2;
	}
	return 0;
}

int func_138(char* sParam0, int iParam1, bool bParam2, int iParam3, bool bParam4)
{
	*iParam1 = INVENTORY::_0x80D78BDC9D88EF07(func_148(bParam4), sParam0, iParam3, bParam2);
	if (*iParam1 >= 0)
	{
		return 1;
	}
...
int func_139(var uParam0, bool bParam1, int iParam2, bool bParam3)
{
	if (iParam2 < 0)
	{
		return 0;
...
struct<4> func_149(bool bParam0, bool bParam1)
{
	struct<5> Var0;
...
struct<4> func_154(bool bParam0, var uParam1, int iParam2, bool bParam3, var uParam4, bool bParam5, bool bParam6)
{
	...
	INVENTORY::_0x886DFD3E185C8A89(func_148(bParam6), &uParam1, bParam0, bParam5, &Var0);
	return Var0;
}
...
{
	return func_118(bParam0) == -427144552;
}
...
bool func_160(bool bParam0, var uParam1, int iParam2, bool bParam3, int iParam4)
{
	return func_164(bParam0, *uParam1, iParam2, bParam3, 1, iParam4) > 0;
}

int func_161(bool bParam0, var uParam1, int iParam2)
{
	var uVar0;

	if (func_180(bParam0, &uVar0, uParam1, iParam2))
	{
...
{
	if (func_142(bParam0) == 1779021115)
	{
		return 0;
	}
...
int func_163(bool bParam0, var uParam1, bool bParam2, bool bParam3)
{
	if (!func_62(bParam0, 0) && !func_157(func_156(bParam0), 2))
	{
		return 0;
	}
	if (func_118(bParam0) == 26423971)
	{
		return -1;
	}
	if (!bParam2 && func_147(bParam0, joaat("DEFAULT")) == 0)
	{
		bParam2 = true;
	}
	if (bParam2)
	...
	return INVENTORY::_0xADDD1E7C0ECF7D95(func_148(bParam3), bParam0);
}

int func_164(bool bParam0, struct<4> Param1, int iParam5, bool bParam6, bool bParam7, bool bParam8)
{
	int iVar0;
	struct<4> Var1;
	...
	{
		iVar0 = INVENTORY::_0xE787F05DFC977BDE(func_148(bParam6), bParam0, bParam8);
	}
	return iVar0;
}
...
int func_173(bool bParam0, int iParam1)
{
	if (!func_62(bParam0, 0))
	{
		return func_184(func_156(bParam0), iParam1);
	}
	if (iParam1 == 0)
	{
		return 0;
...
void func_174(bool bParam0, var uParam1, var uParam2)
{
	*uParam1 = 0;
	*uParam2 = 0;
	switch (bParam0)
...
struct<14> func_175(bool bParam0, int iParam1, int iParam2, int iParam3, int iParam4, int iParam5, int iParam6)
{
	struct<14> Var0;
...
int func_177(var uParam0, int iParam1, bool bParam2, bool bParam3)
{
	*iParam1 = INVENTORY::_0x640F890C3E5A3FFD(func_148(bParam3), uParam0, bParam2);
	if (*iParam1 >= 0)
	{
		return 1;
	}
	...
	switch (iVar5)
	{
		...
		case -427144552:
			...
			if (bParam2 && func_162(bParam0, 1))
			{
				...
				else if (!func_160(bParam0, &Var0, -649335959 /* GXTEntry: "Left" */, 0, 0))
				{
					Var0.f_4 = -649335959; /* GXTEntry: "Left" */
				}
				else if (func_161(bParam0, &Var6, 1728382685 /* GXTEntry: "Right" */))
				{
					Var0.f_4 = 1728382685; /* GXTEntry: "Right" */
				}
				else
...
{
	return func_173(bParam0, 1279601681);
}

int func_180(bool bParam0, var uParam1, var uParam2, int iParam3)
{
	int iVar0;

	iVar0 = func_148(0);
	*uParam1 = { func_154(bParam0, func_159(0), iParam3, 0) };
...
bool func_181()
{
	return (func_188(-1185145312 /* GXTEntry: "Upgraded Off-Hand Holster" */, 0, 0, 0) > 0 && func_189(func_154(889965687 /* GXTEntry: "Wardrobe" */, func_128(1), 1034665895, 1), -234132662, 1, -1) != 0);
}
...
int func_186(bool bParam0, int iParam1)
{
	...
	while (iVar2 < iVar3)
	{
		...
		{
			if (func_190(bParam0, iParam1, bVar0))
			{
				return 1;
			}
		}
...
{
	if (func_192(bParam0) && !bParam2)
	{
		return WEAPON::GET_PED_AMMO_BY_TYPE(Global_35, bParam0);
	}
	return INVENTORY::_0xE787F05DFC977BDE(func_148(bParam1), bParam0, bParam3);
}
