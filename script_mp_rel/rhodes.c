...
{
	func_68(3, iLocal_31, iParam0, iLocal_40, iLocal_34, 4, 0, 0, -1082130432, 0);
	func_69(3, 972368328, 0, 0);
	func_69(3, 1060413677, 0, 0);
	func_70(3, 8192);
	func_71(3, 0);
	func_68(6, iLocal_38, iParam0, iLocal_35, iLocal_37, 20, 0, 0, -1082130432, 0);
	func_69(6, 393076024, 0, 0);
	func_69(6, 934926308, 0, 0);
	func_69(6, 743565308, 0, 0);
	func_71(6, 0);
	func_68(25, iLocal_75, iParam0, 0, 0, 2, 0, 0, -1082130432, 0);
	func_70(25, 1);
	func_70(25, 16384);
	func_70(25, 8192);
	...
	func_72();
	func_73(36);
	func_68(10, iLocal_43, iParam0, iLocal_44, 0, 460, 0, 0, -1082130432, 0);
	func_70(10, 536870912);
	func_71(10, 0);
	func_68(4, iLocal_41, iParam0, iLocal_42, 0, 44, 0, 0, -1082130432, 0);
	func_71(4, 0);
	func_68(2, iLocal_22, iParam0, iLocal_26, iLocal_27, 1277952, 0, 0, -1082130432, 0);
...
void func_73(int iParam0)
{
	...
	if (func_138(&(Global_1051387->f_3582[iVar0 /*19*/]), &iVar1, &fVar2, &vVar3))
	{
		(Global_1051387->f_3582[iVar0 /*19*/])->f_6 = func_147(iVar1, vVar3, fVar2, 0, 0, 0);
	...
	if (bVar7)
	{
		...
		{
			(Global_1051387->f_3582[iVar0 /*19*/])->f_13 = func_147(iVar1, vVar3, fVar2, 0, 0, 0);
...
void func_91(int iParam0, int iParam1, int iParam2, bool bParam3, int iParam4, int iParam5)
{
	var uVar0;
	char* sVar1;
	char* sVar2;
	...
	sVar1 = func_159(iParam0, iParam1, iParam2, iParam4, iParam5, bParam3, &uVar0);
	...
	else
	{
		...
		if (!MISC::_SHOULD_USE_24_HOUR_CLOCK())
		{
			...
			sVar2 = MISC::_CREATE_VAR_STRING(674, sVar8, iVar4, func_171(&sVar6, 109029619), sVar9, func_171(&sVar10, 109029619));
		}
		else
		{
			...
			IntToString(&sVar10, BUILTIN::ROUND(fVar7), 8);
			sVar2 = MISC::_CREATE_VAR_STRING(162, sVar8, iVar4, func_171(&sVar6, 109029619), func_171(&sVar10, 109029619));
		}
...
void func_93(int iParam0, bool bParam1)
{
	...
	func_156(func_175(-1532769513, -36357794), 1);
...
int func_113(int iParam0, var uParam1, var uParam2, bool bParam3, bool bParam4)
{
	bool bVar0;
...
void func_134(int iParam0, bool bParam1, float fParam2, bool bParam3, bool bParam4, float fParam5, int iParam6, bool bParam7)
{
	...
	if (func_132(iParam0))
	{
		...
		if (bParam3)
		{
			func_214(iParam0, fParam2, 1, iParam6);
		}
		else if (bParam1)
		{
			if (bParam4)
...
bool func_138(int iParam0, int iParam1, float fParam2, var uParam3)
{
	return func_219(iParam0, "sHash", iParam1, "fHeading", fParam2, "vPos", uParam3);
}

int func_139(int iParam0, var uParam1, float fParam2, var uParam3)
{
	return func_219(iParam0, "sClosedHash", uParam1, "fClosedHeading", fParam2, "vClosedPos", uParam3);
}
...
void func_140(int iParam0, int iParam1, vector3 vParam2, float fParam5, bool bParam6)
{
	...
	(Global_1051387->f_69[iParam0 /*76*/])->f_6 = func_147(iParam1, vParam2, fParam5, 0, 0, 0);
...
var func_147(int iParam0, vector3 vParam1, float fParam4, int iParam5, int iParam6, int iParam7)
{
...
int func_149(int iParam0)
{
	...
	(Global_1051387->f_4319[iVar6 /*7*/])->f_6 = func_147(iVar0, vVar2, fVar1, 0, 0, 0);
...
struct<2> func_155(int iParam0)
{
	...
	return func_175(-277276100, uVar0);
}
...
char* func_159(int iParam0, int iParam1, int iParam2, int iParam3, var uParam4, var uParam5, var uParam6)
{
	char* sVar0;
...
void func_214(int iParam0, float fParam1, int iParam2, int iParam3)
{
	if (func_132(iParam0))
	{
...
int func_219(int iParam0, char* sParam1, var uParam2, char* sParam3, float fParam4, char* sParam5, var uParam6)
{
	struct<4> Var0;
...
void func_235(int iParam0, bool bParam1, int iParam2, bool bParam3, bool bParam4)
{
	int iVar0;
	int iVar1;
...
int func_257(int iParam0, var uParam1, var uParam2)
{
	...
	if (func_278(iParam0, uParam1, &iVar0))
	{
		func_279(&iVar0, iParam0, uParam2);
	}
	else
	{
		return 0;
...
int func_263(vector3 vParam0, int iParam3)
{
	...
	func_282(iParam3, &vVar0, &Var3, &fVar6);
	if (func_283(vParam0, vVar0, Var3, Var3.f_1, fVar6))
	{
		return 1;
	}
	return 0;
