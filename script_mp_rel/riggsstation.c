...
{
	func_58(2, iLocal_21, iParam0, iLocal_22, iLocal_23, 1277952, 0, 0, -1082130432, 0);
...
void func_41(var uParam0, int iParam1)
{
	...
	if ((BUILTIN::VDIST(Global_36, 0f, 0f, 0f) <= 5f || func_66(&Global_1939168, 32768)) || func_66(&Global_1939168, 16777216))
	{
		return;
	}
...
void func_58(int iParam0, int iParam1, int iParam2, int iParam3, int iParam4, int iParam5, bool bParam6, bool bParam7, float fParam8, int iParam9)
{
	...
	(Global_1051387->f_69[iParam0 /*76*/])->f_18 = func_99(iParam2, iParam0);
	...
	(Global_1051387->f_69[iParam0 /*76*/])->f_64 = func_100((Global_1051387->f_69[iParam0 /*76*/])->f_18);
...
void func_59(int iParam0, int iParam1, float fParam2, bool bParam3)
{
	...
	(Global_1051387->f_69[iParam0 /*76*/])->f_32[iVar0] = func_105(iParam1, 0, 0);
	if (func_106(&((Global_1051387->f_69[iParam0 /*76*/])->f_32[iVar0])))
	{
		if (!func_107(&((Global_1051387->f_69[iParam0 /*76*/])->f_32[iVar0])))
		{
			func_108(&((Global_1051387->f_69[iParam0 /*76*/])->f_32[iVar0]), 0, fParam2, bParam3, 1, 0, 0, 0);
		}
	}
...
int func_60(int iParam0, bool bParam1)
{
	...
	if ((func_109(iParam0, 16384) || func_109(iParam0, 32768)) || func_110((Global_1051387->f_69[iParam0 /*76*/])->f_3))
	{
	...
	if ((!bParam1 && func_112(iVar0, &iVar1, &fVar2, &vVar3)) || (bParam1 && func_113(iVar0, &iVar1, &fVar2, &vVar3)))
	{
		func_114(iParam0, iVar1, vVar3, fVar2, 0);
...
void func_65(int iParam0, int iParam1, var uParam2)
{
	if (!*uParam2)
	{
		if (func_119(Global_35, iParam1, 1, 0))
		{
			func_121(func_120(iParam0), 1);
			*uParam2 = 1;
		}
	}
	else if (!func_119(Global_35, iParam1, 1, 0))
	{
		*uParam2 = 0;
	}
}
...
bool func_68()
{
	return func_66(&Global_1939168, 8192);
}
...
void func_73(int iParam0, int iParam1, int iParam2, bool bParam3, int iParam4, int iParam5)
{
	...
	sVar1 = func_124(iParam0, iParam1, iParam2, iParam4, iParam5, bParam3, &uVar0);
	...
	else
	{
		...
		if (!MISC::_SHOULD_USE_24_HOUR_CLOCK())
		{
			...
			sVar2 = MISC::_CREATE_VAR_STRING(674, sVar8, iVar4, func_136(&sVar6, 109029619), sVar9, func_136(&sVar10, 109029619));
		}
		else
		{
			...
			IntToString(&sVar10, BUILTIN::ROUND(fVar7), 8);
			sVar2 = MISC::_CREATE_VAR_STRING(162, sVar8, iVar4, func_136(&sVar6, 109029619), func_136(&sVar10, 109029619));
		}
		Global_1893575->f_9 = 0;
	}
	Global_1938075->f_145 = func_137(sVar1, sVar2, 4000, 0, 0, 0, 0, 1);
}
...
int func_90(int iParam0, var uParam1, var uParam2, bool bParam3, bool bParam4)
{
	bool bVar0;
...
int func_93(int iParam0, bool bParam1)
{
	...
	{
		func_150(iParam0, _NAMESPACE48::_0x4F76E3676583D951(func_149(iParam0)));
		if (func_45() == -1)
		{
...
void func_97(bool bParam0, bool bParam1)
{
	...
	func_161(Global_1099293->f_516, 36);
	func_162(Global_1099293->f_555, 36);
}
...
void func_98(int iParam0)
{
	...
	else
	{
		...
		while (iVar2 < iVar3)
		{
			func_166(&((Global_1051387->f_69[iParam0 /*76*/])->f_32[iVar2]));
...
int func_100(int iParam0)
{
	...
	{
		Global_1051387->f_4360[iParam0] = func_173(iParam0);
	}
...
int func_112(int iParam0, var uParam1, float fParam2, var uParam3)
{
	return func_180(iParam0, "sHash", uParam1, "fHeading", fParam2, "vPos", uParam3);
}

int func_113(int iParam0, var uParam1, float fParam2, var uParam3)
{
	return func_180(iParam0, "sClosedHash", uParam1, "fClosedHeading", fParam2, "vClosedPos", uParam3);
}

void func_114(int iParam0, int iParam1, vector3 vParam2, float fParam5, bool bParam6)
{
	if (bParam6)
	{
		MISC::GET_GROUND_Z_FOR_3D_COORD(vParam2, &(vParam2.f_2), 0);
	}
	(Global_1051387->f_69[iParam0 /*76*/])->f_6 = func_181(iParam1, vParam2, fParam5, 0, 0, 0);
...
bool func_115(int iParam0, int iParam1)
{
	...
	if (iParam1 && !ENTITY::DOES_ENTITY_EXIST(func_182(iParam0)))
	{
		return false;
	}
...
struct<2> func_120(int iParam0)
{
	...
	return func_140(-277276100, uVar0);
}
...
char* func_124(int iParam0, int iParam1, int iParam2, int iParam3, var uParam4, var uParam5, var uParam6)
{
	char* sVar0;
	...
	{
		sVar0 = func_189(func_188(Global_36));
	}
...
void func_142(int iParam0)
{
	...
	if (func_91((Global_1915170->f_3[iParam0 /*447*/])->f_21) && func_197((Global_1915170->f_3[iParam0 /*447*/])->f_21))
	{
		func_198((Global_1915170->f_3[iParam0 /*447*/])->f_21, 0, 1, 0, 0);
	}
	...
	func_199((Global_1915170->f_3[iParam0 /*447*/])->f_9, 0);
	...
	else
	{
		...
		while (iVar0 < iVar1)
		{
			func_166(&((Global_1915170->f_3[iParam0 /*447*/])->f_318[iVar0 /*6*/]));
...
{
	if (func_208(&(Global_1099293->f_4), iParam0, 5))
	{
		return 1;
	}
	return 0;
...
void func_157(int iParam0, bool bParam1, int iParam2, int iParam3)
{
	func_209(iParam0);
	if (!func_210(1))
	{
...
{
	if (func_215(&(Global_1099293->f_4), iParam0, 5))
	{
		return 1;
	}
	return 0;
...
{
	return func_217((Global_1051387->f_69[iParam0 /*76*/])->f_51, iParam1);
}
...
int func_173(int iParam0)
{
	...
	if (DATAFILE::_0x603AC35FD4602C76(Global_1131373->f_7) && !func_219(12, func_218(iParam0), &vVar0))
	{
		return 0;
	}
	return vVar0.z;
...
void func_175(int iParam0, float fParam1, int iParam2, int iParam3)
{
	if (func_106(iParam0))
	{
...
int func_180(int iParam0, char* sParam1, var uParam2, char* sParam3, float fParam4, char* sParam5, var uParam6)
{
	struct<4> Var0;
...
var func_181(int iParam0, vector3 vParam1, float fParam4, int iParam5, int iParam6, int iParam7)
{
...
{
	func_228(&((Global_1938932->f_5[iParam0 /*11*/])->f_7), iParam1);
}
...
void func_198(int iParam0, bool bParam1, int iParam2, bool bParam3, bool bParam4)
{
	int iVar0;
	int iVar1;
...
int func_219(int iParam0, var uParam1, var uParam2)
{
	...
	if (func_240(iParam0, uParam1, &iVar0))
	{
		func_241(&iVar0, iParam0, uParam2);
	}
	else
	{
		return 0;
...
int func_225(vector3 vParam0, int iParam3)
{
	...
	func_244(iParam3, &vVar0, &Var3, &fVar6);
	if (func_245(vParam0, vVar0, Var3, Var3.f_1, fVar6))
	{
		return 1;
	}
	return 0;
