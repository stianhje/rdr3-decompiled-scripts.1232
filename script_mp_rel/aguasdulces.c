...
void func_41(var uParam0, int iParam1)
{
	...
	if ((BUILTIN::VDIST(Global_36, 0f, 0f, 0f) <= 5f || func_63(&Global_1939168, 32768)) || func_63(&Global_1939168, 16777216))
	{
		return;
	}
...
bool func_65()
{
	return func_63(&Global_1939168, 8192);
}
...
void func_70(int iParam0, int iParam1, int iParam2, bool bParam3, int iParam4, int iParam5)
{
	var uVar0;
	char* sVar1;
	char* sVar2;
	...
	sVar1 = func_94(iParam0, iParam1, iParam2, iParam4, iParam5, bParam3, &uVar0);
	...
	else
	{
		...
		if (!MISC::_SHOULD_USE_24_HOUR_CLOCK())
		{
			...
			sVar2 = MISC::_CREATE_VAR_STRING(674, sVar8, iVar4, func_106(&sVar6, 109029619), sVar9, func_106(&sVar10, 109029619));
		}
		else
		{
			...
			IntToString(&sVar10, BUILTIN::ROUND(fVar7), 8);
			sVar2 = MISC::_CREATE_VAR_STRING(162, sVar8, iVar4, func_106(&sVar6, 109029619), func_106(&sVar10, 109029619));
		}
		Global_1893575->f_9 = 0;
	}
	Global_1938075->f_145 = func_107(sVar1, sVar2, 4000, 0, 0, 0, 0, 1);
}
...
char* func_94(int iParam0, int iParam1, int iParam2, int iParam3, var uParam4, var uParam5, var uParam6)
{
	char* sVar0;
	...
	{
		sVar0 = func_131(func_130(Global_36));
	}
...
{
	func_136((Global_1938932->f_5[iParam0 /*11*/])->f_6, 1);
	func_137((Global_1938932->f_5[iParam0 /*11*/])->f_6, 0);
...
void func_113(int iParam0)
{
	...
	if (func_87((Global_1915170->f_3[iParam0 /*447*/])->f_21) && func_139((Global_1915170->f_3[iParam0 /*447*/])->f_21))
	{
		func_140((Global_1915170->f_3[iParam0 /*447*/])->f_21, 0, 1, 0, 0);
	}
	...
	func_141((Global_1915170->f_3[iParam0 /*447*/])->f_9, 0);
	...
	else
	{
		...
		while (iVar0 < iVar1)
		{
			func_144(&((Global_1915170->f_3[iParam0 /*447*/])->f_318[iVar0 /*6*/]));
...
void func_120(int iParam0)
{
	...
	else
	{
		...
		while (iVar2 < iVar3)
		{
			func_144(&((Global_1051387->f_69[iParam0 /*76*/])->f_32[iVar2]));
	...
	if (VOLUME::_0x92A78D0BEDB332A3((Global_1051387->f_69[iParam0 /*76*/])->f_25) && func_158(iParam0, 2))
	{
...
{
	func_166(&((Global_1938932->f_5[iParam0 /*11*/])->f_7), iParam1);
}
