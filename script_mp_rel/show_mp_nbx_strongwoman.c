...
int func_96(var uParam0)
{
	...
	if (!ENTITY::DOES_ENTITY_EXIST(&(uParam0->f_1393[0])))
	{
		...
		{
			ANIMSCENE::SET_ANIM_SCENE_ENTITY(iVar0, "BAR", &(uParam0->f_1393[0]), 0);
		}
		else
		{
			return 0;
	...
	if (!ENTITY::DOES_ENTITY_EXIST(&(uParam0->f_1393[1])))
	{
		...
		{
			ANIMSCENE::SET_ANIM_SCENE_ENTITY(iVar0, "CHEST", &(uParam0->f_1393[1]), 0);
		}
		else
		{
			return 0;
	...
	if (!ENTITY::DOES_ENTITY_EXIST(&(uParam0->f_1393[2])))
	{
		...
		{
			ANIMSCENE::SET_ANIM_SCENE_ENTITY(iVar0, "HAMMER", &(uParam0->f_1393[2]), 0);
		}
		else
		{
			return 0;
	...
	if (!ENTITY::DOES_ENTITY_EXIST(&(uParam0->f_1393[3])))
	{
		...
		{
			ANIMSCENE::SET_ANIM_SCENE_ENTITY(iVar0, "Block", &(uParam0->f_1393[3]), 0);
		}
		else
		{
			return 0;
	...
	if (!ENTITY::DOES_ENTITY_EXIST(&(uParam0->f_1393[4])))
	{
		...
		{
			ANIMSCENE::SET_ANIM_SCENE_ENTITY(iVar0, "BOOK", &(uParam0->f_1393[4]), 0);
		}
		else
		{
			return 0;
	...
	if (!func_155(uParam0, iVar0, 0, "Female"))
	{
		return 0;
	}
