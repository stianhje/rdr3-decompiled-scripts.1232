...
bool func_91(int iParam0, int iParam1)
{
	...
	if (iParam1 && !ENTITY::DOES_ENTITY_EXIST(func_129(iParam0)))
	{
		return false;
	}
...
{
	func_140((Global_1938932->f_5[iParam0 /*11*/])->f_6, 1);
	func_141((Global_1938932->f_5[iParam0 /*11*/])->f_6, 0);
...
void func_117(int iParam0)
{
	...
	if (func_88((Global_1915170->f_3[iParam0 /*447*/])->f_21) && func_143((Global_1915170->f_3[iParam0 /*447*/])->f_21))
	{
		func_144((Global_1915170->f_3[iParam0 /*447*/])->f_21, 0, 1, 0, 0);
	}
	...
	func_145((Global_1915170->f_3[iParam0 /*447*/])->f_9, 0);
	...
	else
	{
		...
		while (iVar0 < iVar1)
		{
			func_148(&((Global_1915170->f_3[iParam0 /*447*/])->f_318[iVar0 /*6*/]));
...
void func_124(int iParam0)
{
	...
	else
	{
		...
		while (iVar2 < iVar3)
		{
			func_148(&((Global_1051387->f_69[iParam0 /*76*/])->f_32[iVar2]));
	...
	if (VOLUME::_0x92A78D0BEDB332A3((Global_1051387->f_69[iParam0 /*76*/])->f_25) && func_162(iParam0, 2))
	{
...
{
	func_170(&((Global_1938932->f_5[iParam0 /*11*/])->f_7), iParam1);
}
...
{
	return func_181((Global_1051387->f_69[iParam0 /*76*/])->f_51, iParam1);
}
...
int func_167(vector3 vParam0, int iParam3)
{
	...
	func_184(iParam3, &vVar0, &Var3, &fVar6);
	if (func_185(vParam0, vVar0, Var3, Var3.f_1, fVar6))
	{
		return 1;
	}
	return 0;
