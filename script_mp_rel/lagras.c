...
void func_29(int iParam0)
{
	...
	{
		aggregate.annesburg.func_63(14, iLocal_22, iParam0, iLocal_22, 0, 4, 0, 0, -1082130432 /* Float: -1f */, 0);
		aggregate.beechershope.func_59(14, 0);
	}
}

void func_30(int iParam0)
{
	aggregate.annesburg.func_67(638, iLocal_22, 1);
}

void func_33(int iParam0)
{
	iParam0 = iParam0;
	aggregate.aguasdulces.func_58(0.8f, 0.2f, 0f, 0f);
}
