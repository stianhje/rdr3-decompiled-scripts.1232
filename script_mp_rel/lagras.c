...
void func_29(int iParam0)
{
	...
	{
		func_60(14, iLocal_22, iParam0, iLocal_22, 0, 4, 0, 0, -1082130432 /* Float: -1f */, 0);
		func_61(14, 0);
	}
}
...
void func_74(int iParam0, int iParam1, int iParam2, bool bParam3, int iParam4, bool bParam5)
{
	...
	else
	{
		...
		if (!MISC::_SHOULD_USE_24_HOUR_CLOCK())
		{
			...
			sVar2 = MISC::_CREATE_VAR_STRING(674, sVar8, iVar4, func_141(&cVar6, joaat("COLOR_PURE_WHITE")), sVar9, func_141(&cVar10, joaat("COLOR_PURE_WHITE")));
		}
		else
		{
			...
			IntToString(&cVar10, BUILTIN::ROUND(fVar7), 8);
			sVar2 = MISC::_CREATE_VAR_STRING(162, sVar8, iVar4, func_141(&cVar6, joaat("COLOR_PURE_WHITE")), func_141(&cVar10, joaat("COLOR_PURE_WHITE")));
		}
...
bool func_120(int iParam0, int iParam1, float fParam2, var uParam3)
{
	return func_190(iParam0, "sHash", iParam1, "fHeading", fParam2, "vPos", uParam3);
}

bool func_121(int iParam0, int iParam1, float fParam2, var uParam3)
{
	return func_190(iParam0, "sClosedHash", iParam1, "fClosedHeading", fParam2, "vClosedPos", uParam3);
}
...
void func_122(int iParam0, int iParam1, vector3 vParam2, var uParam5, bool bParam6)
{
	...
	(Global_1051387->f_69[iParam0 /*76*/])->f_6 = func_191(iParam1, vParam2, uParam5, 0, 0, 0);
...
bool func_123(int iParam0, bool bParam1)
{
	...
	if (bParam1 && !ENTITY::DOES_ENTITY_EXIST(func_166(iParam0)))
	{
		return false;
	}
...
int func_190(int iParam0, char* sParam1, int iParam2, char* sParam3, float fParam4, char* sParam5, var uParam6)
{
	struct<4> Var0;
...
var func_191(int iParam0, vector3 vParam1, int iParam4, int iParam5, int iParam6, int iParam7)
{
