...
int func_5(var uParam0)
{
	...
	while (iVar0 < 10)
	{
		if (func_9(Local_13.f_1, ((*Global_1914742)[iVar0 /*4*/])->f_1, 1056964608, 1))
		{
			return 1;
		}
		iVar0++;
...
int func_18(int iParam0, int iParam1, bool bParam2, int iParam3)
{
	int iVar0;
	int iVar1;
	int iVar2;
...
int func_28(char* sParam0, var uParam1, var uParam2, int iParam3, bool bParam4)
{
	*uParam1 = INVENTORY::_0x80D78BDC9D88EF07(func_26(bParam4), sParam0, iParam3, uParam2);
	if (*uParam1 >= 0)
	{
		return 1;
	}
...
{
	*uParam1 = INVENTORY::_0x640F890C3E5A3FFD(func_26(bParam3), uParam0, uParam2);
	if (*uParam1 >= 0)
	{
		return 1;
	}
...
struct<5> func_42(int iParam0, bool bParam1, int iParam2)
{
	struct<5> Var0;
	int iVar5;
	struct<10> Var6;
...
struct<4> func_43(int iParam0, var uParam1, var uParam2, var uParam3, var uParam4, int iParam5, bool bParam6)
{
	struct<4> Var0;
...
struct<4> func_46(bool bParam0)
{
	...
	if (Global_1572887->f_13 == 0)
	{
		...
		if (iVar0 == 2)
		{
			...
			{
				*Global_1270479 = { func_43(1328661203, func_54(), -1591664384, bParam0) };
			}
		...
		else if (iVar0 == 3)
		{
			...
			{
				Global_1270479->f_12 = { func_43(1328661203, func_54(), -1591664384, 0) };
			}
...
bool func_48(int iParam0, var uParam1, int iParam2, bool bParam3, int iParam4)
{
	return func_56(iParam0, *uParam1, iParam2, bParam3, 1, iParam4) > 0;
}
...
{
	return func_59(&uParam0, uParam4, bParam5, bParam6, iParam7);
}
...
int func_59(var uParam0, var uParam1, bool bParam2, bool bParam3, int iParam4)
{
...
int func_61(var uParam0, var uParam1, var uParam2, var uParam3, int iParam4, bool bParam5, int iParam6)
{
...
int func_63(var uParam0, var uParam1, bool bParam2, int iParam3)
{
	struct<10> Var0;

	Var0.f_9 = -1591664384;
	if (func_64(uParam0, uParam1, &Var0, bParam2, iParam3))
	{
		return Var0.f_4;
	}
	return 0;
...
int func_64(var uParam0, var uParam1, var uParam2, bool bParam3, int iParam4)
{
	var uVar0;
	...
	if (!func_59(&uVar0, uParam2, bParam3, 0, iParam4))
	{
		return 0;
	}
	return 1;
