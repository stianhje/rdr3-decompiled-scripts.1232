...
{
	func_58(3, iLocal_23, iParam0, iLocal_24, iLocal_25, 4, 0, 0, -1082130432 /* Float: -1f */, 0);
	func_59(3, 96424206, 0, 0);
	func_59(3, 381066979, 0, 0);
	func_60(3, 8192);
	func_61(3, 0);
	func_58(2, iLocal_21, iParam0, iLocal_22, 0, 1277952, 0, 0, -1082130432 /* Float: -1f */, 0);
...
int func_61(int iParam0, bool bParam1)
{
	...
	if ((!bParam1 && func_114(iVar0, &iVar1, &uVar2, &vVar3)) || (bParam1 && func_115(iVar0, &iVar1, &uVar2, &vVar3)))
	{
		func_116(iParam0, iVar1, vVar3, uVar2, 0);
...
void func_74(int iParam0, int iParam1, int iParam2, bool bParam3, int iParam4, bool bParam5)
{
	...
	sVar1 = func_126(iParam0, iParam1, iParam2, iParam4, bParam5, bParam3, &bVar0);
	...
	else
	{
		...
		if (!MISC::_SHOULD_USE_24_HOUR_CLOCK())
		{
			...
			sVar2 = MISC::_CREATE_VAR_STRING(674, sVar8, iVar4, func_138(&cVar6, joaat("COLOR_PURE_WHITE")), sVar9, func_138(&cVar10, joaat("COLOR_PURE_WHITE")));
		}
		else
		{
			...
			IntToString(&cVar10, BUILTIN::ROUND(fVar7), 8);
			sVar2 = MISC::_CREATE_VAR_STRING(162, sVar8, iVar4, func_138(&cVar6, joaat("COLOR_PURE_WHITE")), func_138(&cVar10, joaat("COLOR_PURE_WHITE")));
		}
...
void func_76(int iParam0, bool bParam1)
{
	...
	func_123(func_142(-1532769513, joaat("areas")), 1);
...
void func_109(int iParam0, bool bParam1, float fParam2, bool bParam3, bool bParam4, float fParam5, bool bParam6, bool bParam7)
{
	...
	if (func_107(iParam0))
	{
		...
		if (bParam3)
		{
			func_177(iParam0, fParam2, 1, bParam6);
		}
		else if (bParam1)
		{
			if (bParam4)
...
bool func_114(int iParam0, int iParam1, bool bParam2, var uParam3)
{
	return func_182(iParam0, "sHash", iParam1, "fHeading", bParam2, "vPos", uParam3);
}

bool func_115(int iParam0, int iParam1, bool bParam2, var uParam3)
{
	return func_182(iParam0, "sClosedHash", iParam1, "fClosedHeading", bParam2, "vClosedPos", uParam3);
}

void func_116(int iParam0, int iParam1, vector3 vParam2, var uParam5, bool bParam6)
{
	if (bParam6)
	{
		MISC::GET_GROUND_Z_FOR_3D_COORD(vParam2, &(vParam2.f_2), 0);
	}
	(Global_1051387->f_69[iParam0 /*76*/])->f_6 = func_183(iParam1, vParam2, uParam5, 0, 0, 0);
...
bool func_117(int iParam0, bool bParam1)
{
	...
	if (bParam1 && !ENTITY::DOES_ENTITY_EXIST(func_184(iParam0)))
	{
		return false;
	}
...
struct<2> func_122(int iParam0)
{
	...
	return func_142(-277276100, iVar0);
}
...
char* func_126(int iParam0, int iParam1, int iParam2, int iParam3, bool bParam4, bool bParam5, var uParam6)
{
	char* sVar0;
...
void func_177(int iParam0, float fParam1, bool bParam2, bool bParam3)
{
	if (func_107(iParam0))
	{
...
int func_182(int iParam0, char* sParam1, int iParam2, char* sParam3, bool bParam4, char* sParam5, var uParam6)
{
	struct<4> Var0;
...
int func_183(int iParam0, vector3 vParam1, int iParam4, int iParam5, int iParam6, int iParam7)
{
...
void func_200(int iParam0, bool bParam1, bool bParam2, bool bParam3, bool bParam4)
{
	int iVar0;
	int iVar1;
...
int func_227(vector3 vParam0, int iParam3)
{
	...
	func_246(iParam3, &vVar0, &Var3, &uVar6);
	if (func_247(vParam0, vVar0, Var3, Var3.f_1, uVar6))
	{
		return 1;
	}
	return 0;
