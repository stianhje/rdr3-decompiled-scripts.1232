...
void func_127(int iParam0, bool bParam1, float fParam2, bool bParam3, bool bParam4, float fParam5, bool bParam6, bool bParam7)
{
	...
	if (func_162(iParam0))
	{
		...
		if (bParam3)
		{
			func_170(iParam0, fParam2, 1, bParam6);
		}
		else if (bParam1)
		{
			if (bParam4)
...
int func_133(var uParam0, var uParam1, int iParam2)
{
	...
	if (!func_13(*uParam1, 1))
	{
		...
		{
			iVar3 = iVar0;
			if (func_179((*uParam0)[iVar0 /*5*/], func_177(iParam2), func_178(iParam2, iVar3), 1065353216 /* Float: 1f */))
			{
				iVar2++;
			}
			iVar0++;
	...
	if (!func_13(*uParam1, 8))
	{
		...
		{
			iVar4 = iVar0;
			if (func_179(uParam0->f_31[iVar0 /*5*/], func_181(iParam2), func_182(iParam2, iVar4), 1065353216 /* Float: 1f */))
			{
				iVar2++;
			}
			iVar0++;
	...
	if (!func_13(*uParam1, 2048))
	{
		...
		{
			iVar5 = iVar0;
			if (func_179(uParam0->f_107[iVar0 /*5*/], func_184(iParam2), func_185(iParam2, iVar5), 1065353216 /* Float: 1f */))
			{
				iVar2++;
			}
			iVar0++;
	...
	{
		case 0:
			if (!func_13(*uParam1, 64) && func_179(uParam0->f_118[0 /*5*/], func_186(iParam2, 0), func_187(iParam2, 0), 1065353216 /* Float: 1f */))
			{
				func_18(uParam1, 64);
			}
			if ((!func_13(*uParam1, 16384) && func_179(uParam0->f_118[1 /*5*/], func_186(iParam2, 1), func_187(iParam2, 1), 1065353216 /* Float: 1f */)) && func_179(uParam0->f_118[2 /*5*/], func_186(iParam2, 2), func_187(iParam2, 2), 1065353216 /* Float: 1f */))
			{
		...
		case 1:
			...
			if (!func_13(*uParam1, 2097152))
			{
				...
				{
					iVar6 = iVar0;
					if (func_179(uParam0->f_118[iVar0 /*5*/], func_186(iParam2, 0), func_187(iParam2, iVar6), 1065353216 /* Float: 1f */))
					{
						iVar2++;
					}
					iVar0++;
...
int func_156(var uParam0, bool bParam1, vector3 vParam2)
{
	if (!ENTITY::DOES_ENTITY_EXIST(*uParam0))
	{
		*uParam0 = WEAPON::_0x9888652B8BA77F73(bParam1, 0, vParam2, 1, 1065353216);
	}
	if (!ENTITY::DOES_ENTITY_EXIST(*uParam0))
	{
		return 0;
...
void func_170(int iParam0, float fParam1, bool bParam2, bool bParam3)
{
	if (func_162(iParam0))
	{
