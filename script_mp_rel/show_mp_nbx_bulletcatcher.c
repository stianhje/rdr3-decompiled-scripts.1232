...
void func_4(var uParam0, var uParam1, var uParam2)
{
	...
	switch (uParam0->f_1352)
	{
		...
		case 2:
			...
			{
				NETWORK::RESERVE_NETWORK_MISSION_PEDS((3 - NETWORK::GET_NUM_RESERVED_MISSION_PEDS(0)));
				return;
			}
			uParam0->f_25 = 0;
			func_20(uParam0, 3);
...
int func_21(var uParam0)
{
	if (NETWORK::NETWORK_IS_HOST_OF_THIS_SCRIPT())
	{
		...
		uParam0->f_1401[2] = 339709868;
		uParam0->f_1385[0] = 1755911592;
		uParam0->f_1385[1] = -2021274799;
		uParam0->f_1385[2] = 1843407141;
		uParam0->f_1415[0] = 379542007;
		uParam0->f_1415[1] = 379542007;
...
int func_96(var uParam0)
{
	...
	if (!ENTITY::DOES_ENTITY_EXIST(&(uParam0->f_1393[0])))
	{
		...
		{
			ANIMSCENE::SET_ANIM_SCENE_ENTITY(iVar0, "BUCKET", &(uParam0->f_1393[0]), 0);
		}
		else
		{
			return 0;
	...
	if (!ENTITY::DOES_ENTITY_EXIST(&(uParam0->f_1393[1])))
	{
		...
		{
			ANIMSCENE::SET_ANIM_SCENE_ENTITY(iVar0, "Stool", &(uParam0->f_1393[1]), 0);
		}
		else
		{
			return 0;
	...
	if (!ENTITY::DOES_ENTITY_EXIST(&(uParam0->f_1393[2])))
	{
		...
		{
			ANIMSCENE::SET_ANIM_SCENE_ENTITY(iVar0, "BOTTLE", &(uParam0->f_1393[2]), 0);
		}
		else
		{
			return 0;
	...
	if (!func_157(uParam0, iVar0, 0, "Benjamin"))
	{
		return 0;
	}
	if (!func_157(uParam0, iVar0, 1, "Assistant"))
	{
		return 0;
	}
	if (!func_157(uParam0, iVar0, 2, "Crowd_Member"))
	{
		return 0;
	}
	ANIMSCENE::SET_ANIM_SCENE_ENTITY(iVar0, "Gun", &(uParam0->f_1423[0]), 0);
...
int func_108(int iParam0, vector3 vParam1, float fParam4, bool bParam5, bool bParam6, int iParam7, bool bParam8, bool bParam9, bool bParam10, bool bParam11, bool bParam12)
{
	...
	func_163(iVar0, iParam0, iParam7, bParam8, bParam9, bParam10, bParam11, bParam12);
	return iVar0;
}
...
void func_119(var uParam0, var uParam1, var uParam2, float fParam3)
{
	switch (uParam0->f_1)
	{
		...
		case 34:
			if (ANIMSCENE::_0xCBFC7725DE6CE2E0(NETWORK::_0xD7F6781A0ABAF6FB(uParam0->f_1374), 0) && ANIMSCENE::_0x3FBC3F51BF12DFBF(NETWORK::_0xD7F6781A0ABAF6FB(uParam0->f_1374)) > func_165())
			{
...
void func_127(int iParam0, bool bParam1, float fParam2, bool bParam3, bool bParam4, float fParam5, int iParam6, bool bParam7)
{
	...
	if (func_162(iParam0))
	{
		...
		if (bParam3)
		{
			func_170(iParam0, fParam2, 1, iParam6);
		}
		else if (bParam1)
		{
			if (bParam4)
...
int func_133(var uParam0, var uParam1, int iParam2)
{
	...
	if (!func_13(*uParam1, 1))
	{
		...
		{
			iVar3 = iVar0;
			if (func_179((*uParam0)[iVar0 /*5*/], func_177(iParam2), func_178(iParam2, iVar3), 1065353216))
			{
				iVar2++;
			}
			iVar0++;
	...
	if (!func_13(*uParam1, 8))
	{
		...
		{
			iVar4 = iVar0;
			if (func_179(uParam0->f_31[iVar0 /*5*/], func_181(iParam2), func_182(iParam2, iVar4), 1065353216))
			{
				iVar2++;
			}
			iVar0++;
	...
	if (!func_13(*uParam1, 2048))
	{
		...
		{
			iVar5 = iVar0;
			if (func_179(uParam0->f_107[iVar0 /*5*/], func_184(iParam2), func_185(iParam2, iVar5), 1065353216))
			{
				iVar2++;
			}
			iVar0++;
	...
	{
		case 0:
			if (!func_13(*uParam1, 64) && func_179(uParam0->f_118[0 /*5*/], func_186(iParam2, 0), func_187(iParam2, 0), 1065353216))
			{
				func_18(uParam1, 64);
			}
			if ((!func_13(*uParam1, 16384) && func_179(uParam0->f_118[1 /*5*/], func_186(iParam2, 1), func_187(iParam2, 1), 1065353216)) && func_179(uParam0->f_118[2 /*5*/], func_186(iParam2, 2), func_187(iParam2, 2), 1065353216))
			{
		...
		case 1:
			...
			{
				iVar1 = func_188(iParam2);
				iVar0 = 0;
				while (iVar0 <= (iVar1 - 1))
				{
					iVar6 = iVar0;
					if (func_179(uParam0->f_118[iVar0 /*5*/], func_186(iParam2, 0), func_187(iParam2, iVar6), 1065353216))
					{
						iVar2++;
					}
					iVar0++;
...
void func_134(var uParam0, var uParam1, int iParam2)
{
	...
	{
		if (func_13(*uParam0, 2) && func_192(uParam1, func_189(uParam1), &(uParam1->f_229), func_190(uParam1), func_191(uParam1)))
		{
			func_14(uParam0, 2);
		}
		if (func_13(*uParam0, 4) && func_194(uParam1, func_193(uParam1), &(uParam1->f_229), func_190(uParam1), func_191(uParam1)))
		{
			func_14(uParam0, 4);
		}
	}
	...
	{
		if (func_13(*uParam0, 16) && func_192(&(uParam1->f_31), func_195(uParam1), &(uParam1->f_232), func_196(uParam1), func_191(uParam1)))
		{
			func_14(uParam0, 16);
		}
		if (func_13(*uParam0, 32) && func_194(&(uParam1->f_31), func_197(uParam1), &(uParam1->f_232), func_196(uParam1), func_191(uParam1)))
		{
			func_14(uParam0, 32);
		}
	}
	...
	{
		if (func_13(*uParam0, 4096) && func_192(&(uParam1->f_107), func_198(uParam1), &(uParam1->f_235), func_199(uParam1), func_191(uParam1)))
		{
			func_14(uParam0, 4096);
		}
		if (func_13(*uParam0, 8192) && func_194(&(uParam1->f_107), func_200(uParam1), &(uParam1->f_235), func_199(uParam1), func_191(uParam1)))
		{
	...
	if (iParam2 == 0)
	{
		...
		{
			if (func_13(*uParam0, 128) && func_203(uParam1->f_118[0 /*5*/], func_201(uParam1), &(uParam1->f_238), func_202(uParam1), func_191(uParam1)))
			{
				func_14(uParam0, 128);
			}
			if (func_13(*uParam0, 256) && func_205(uParam1->f_118[0 /*5*/], func_204(uParam1), &(uParam1->f_238), func_202(uParam1), func_191(uParam1)))
			{
				func_14(uParam0, 256);
			}
			if (func_13(*uParam0, 512) && func_203(uParam1->f_118[0 /*5*/], func_201(uParam1), &(uParam1->f_238), 0.5f, func_191(uParam1)))
			{
				func_14(uParam0, 512);
			}
			if (func_13(*uParam0, 1024) && func_205(uParam1->f_118[0 /*5*/], func_204(uParam1), &(uParam1->f_238), 0.5f, func_191(uParam1)))
			{
		...
		{
			if (func_13(*uParam0, 32768) && func_208(1, 2, &(uParam1->f_118), func_206(uParam1), &(uParam1->f_241), func_207(uParam1), func_191(uParam1)))
			{
				func_14(uParam0, 32768);
			}
			if (func_13(*uParam0, 65536) && func_210(1, 2, &(uParam1->f_118), func_209(uParam1), &(uParam1->f_241), func_207(uParam1), func_191(uParam1)))
			{
				func_14(uParam0, 65536);
			}
			if (func_13(*uParam0, 131072) && func_208(1, 2, &(uParam1->f_118), func_206(uParam1), &(uParam1->f_241), 0.5f, func_191(uParam1)))
			{
				func_14(uParam0, 131072);
			}
			if (func_13(*uParam0, 262144) && func_210(1, 2, &(uParam1->f_118), func_209(uParam1), &(uParam1->f_241), 0.5f, func_191(uParam1)))
			{
	...
	if (iParam2 == 1)
	{
		...
		{
			if (func_13(*uParam0, 4194304) && func_192(&(uParam1->f_118), func_211(uParam1), &(uParam1->f_238), func_212(uParam1), func_191(uParam1)))
			{
				func_14(uParam0, 4194304);
			}
			if (func_13(*uParam0, 8388608) && func_194(&(uParam1->f_118), func_213(uParam1), &(uParam1->f_238), func_212(uParam1), func_191(uParam1)))
			{
...
int func_156(var uParam0, int iParam1, vector3 vParam2)
{
	if (!ENTITY::DOES_ENTITY_EXIST(*uParam0))
	{
		*uParam0 = WEAPON::_0x9888652B8BA77F73(iParam1, 0, vParam2, 1, 1065353216);
	}
	if (!ENTITY::DOES_ENTITY_EXIST(*uParam0))
	{
		return 0;
...
int func_157(var uParam0, int iParam1, int iParam2, char* sParam3)
{
...
void func_163(int iParam0, int iParam1, int iParam2, bool bParam3, bool bParam4, bool bParam5, bool bParam6, bool bParam7)
{
	bool bVar0;
...
void func_170(int iParam0, float fParam1, int iParam2, int iParam3)
{
	if (func_162(iParam0))
	{
...
int func_179(var uParam0, int iParam1, vector3 vParam2, int iParam5)
{
	if (uParam0->f_1 == 0)
	{
...
int func_192(var uParam0, float fParam1, var uParam2, float fParam3, int iParam4)
{
	int iVar0;
	float fVar1;
	...
	{
		func_226((*uParam0)[iVar0 /*5*/], fParam1, fVar1, fParam3, iParam4);
		iVar0++;
	}
	if (fVar1 >= fParam3)
	{
...
int func_194(var uParam0, float fParam1, var uParam2, float fParam3, int iParam4)
{
	int iVar0;
	float fVar1;
	...
	while (iVar0 <= (*uParam0 - 1))
	{
		func_227((*uParam0)[iVar0 /*5*/], fParam1, fVar1, fParam3, iParam4);
		iVar0++;
	}
	if (fVar1 >= fParam3)
	{
...
int func_203(var uParam0, float fParam1, var uParam2, float fParam3, int iParam4)
{
	float fVar0;
	...
	func_226(uParam0, fParam1, fVar0, fParam3, iParam4);
	if (fVar0 >= fParam3)
	{
		func_150(uParam2);
		return 1;
...
int func_205(var uParam0, float fParam1, var uParam2, float fParam3, int iParam4)
{
	float fVar0;
	...
	fVar0 = func_149(uParam2);
	func_227(uParam0, fParam1, fVar0, fParam3, iParam4);
	if (fVar0 >= fParam3)
	{
		func_150(uParam2);
		return 1;
...
int func_208(int iParam0, int iParam1, var uParam2, float fParam3, var uParam4, float fParam5, int iParam6)
{
	int iVar0;
	int iVar1;
	float fVar2;
	...
	while (iVar3 <= iVar1)
	{
		func_226((*uParam2)[iVar3 /*5*/], fParam3, fVar2, fParam5, iParam6);
		iVar3++;
	}
	if (fVar2 >= fParam5)
	{
...
int func_210(int iParam0, int iParam1, var uParam2, float fParam3, var uParam4, float fParam5, int iParam6)
{
	int iVar0;
	int iVar1;
	float fVar2;
	...
	while (iVar3 <= iVar1)
	{
		func_227((*uParam2)[iVar3 /*5*/], fParam3, fVar2, fParam5, iParam6);
		iVar3++;
	}
	if (fVar2 >= fParam5)
	{
...
var func_216(vector3 vParam0, vector3 vParam3, vector3 vParam6, int iParam9, var uParam10, var uParam11)
{
	var uVar0;
	int iVar1;
	int iVar2;
	...
	if (iVar9 & 8 != 0)
	{
		iVar9 = (iVar9 || func_231(PLAYER::GET_PLAYER_TEAM(iVar5)));
	}
	...
	while (iVar2 < 32)
	{
		if (NETWORK::NETWORK_IS_PLAYER_ACTIVE(&(Global_1273882->f_154[iVar2])))
		{
			...
			if (!bVar3)
			{
				if (iVar9 & 8192 != 0 && func_233(iVar2) != 1)
				{
					bVar3 = true;
				}
			}
...
void func_226(var uParam0, float fParam1, float fParam2, float fParam3, int iParam4)
{
	float fVar0;
	float fVar1;
	float fVar2;
	...
	if (ENTITY::DOES_ENTITY_EXIST(*uParam0))
	{
		if (uParam0->f_2 > fParam1 && uParam0->f_2 > uParam0->f_3)
		{
			...
			fVar0 = (fVar1 / fParam3);
			uParam0->f_2 = func_236(fParam1, uParam0->f_4, fVar0);
...
void func_227(var uParam0, float fParam1, float fParam2, float fParam3, int iParam4)
{
	float fVar0;
	float fVar1;
	...
	if (ENTITY::DOES_ENTITY_EXIST(*uParam0))
	{
		if (uParam0->f_2 < fParam1 && uParam0->f_2 < uParam0->f_4)
		{
			...
			uParam0->f_2 = func_236(uParam0->f_3, fParam1, fVar0);
			if (uParam0->f_2 > fParam1)
			{
				uParam0->f_2 = fParam1;
			}
