				...
				case 7:
					if (func_10(func_9(iLocal_36)))
					{
						...
						else
						{
							...
							func_36(iLocal_36, Global_1896662);
							iLocal_34 = 11;
							Jump @850; //curOff = 676
							func_37(iLocal_36);
							func_21(iLocal_36, 8);
							...
							func_41(Global_1896662, iLocal_36);
							func_42(iLocal_36);
							func_21(iLocal_36, 8);
							if (func_43())
							{
...
int func_44(int iParam0)
{
	if (iParam0 == 0)
	{
		...
		if (STATS::CHAL_IS_GOAL_ACTIVE(-663946200, 1055032020))
		{
			switch (iLocal_36)
			{
				...
				case 127:
				case 135:
					STATS::CHAL_ADD_GOAL_PROGRESS_INT_BY_SCORE_ID(func_75(iLocal_36, 0), 1);
					break;
			}
		}
		if (func_10(func_68()))
	...
	else if (func_45() == -1)
	{
		func_79(iLocal_36);
		func_80(iLocal_36);
		if (!func_81(iLocal_36, 0))
		{
			return 0;
		}
	}
	else if (!func_82(iLocal_36))
	{
		return 0;
	}
	SCRIPTS::TERMINATE_THIS_THREAD();
	...
	switch (iLocal_28)
	{
		case 0:
			...
			if (STREAMING::HAS_MODEL_LOADED(iLocal_19) && STREAMING::HAS_ANIM_DICT_LOADED("MECH_RANSACK@LOCKBOX@MED@0CM@OPENUNLOCKED@A"))
			{
				...
				{
					iLocal_20 = OBJECT::CREATE_OBJECT(822933632, vLocal_21, false, false, false, true, true);
				}
				...
				{
					iLocal_20 = OBJECT::CREATE_OBJECT(822933632, vLocal_21, false, false, false, false, true);
				}
		...
		case 1:
			...
			{
				if (!func_93(-448258490, 0, 255, 1, 0))
				{
				}
				iLocal_28 = 2;
			}
...
void func_69(int iParam0, int iParam1, int iParam2, bool bParam3, int iParam4, int iParam5)
{
	...
	else if ((func_58(iParam0) && func_83(iParam0, 16777216)) && !Global_1893575->f_9)
	{
...
int func_86(int iParam0, var uParam1, var uParam2, bool bParam3, bool bParam4)
{
	bool bVar0;
...
bool func_93(int iParam0, int iParam1, int iParam2, int iParam3, bool bParam4)
{
	struct<2> Var0;
	struct<2> Var12;
	var uVar25;
	...
	Var0.f_1 = 10;
	Var12.f_1 = 11;
	return func_128(iParam0, &uVar25, &Var12, &Var0, iParam1, iParam2, iParam3, bParam4);
}
...
char* func_96(int iParam0, int iParam1, int iParam2, int iParam3, var uParam4, var uParam5, var uParam6)
{
	...
	{
		sVar0 = func_132(Global_1893575->f_162);
	}
	if (MISC::IS_STRING_NULL_OR_EMPTY(sVar0) && uParam4)
	{
		sVar0 = func_134(func_133(Global_36));
	}
...
int func_99(int iParam0)
{
	...
	iVar0 = 0;
	Var1 = { func_137(PLAYER::PLAYER_ID()) };
...
char* func_108(char* sParam0, int iParam1)
{
	...
	return func_138(MISC::_CREATE_VAR_STRING(10, "LITERAL_STRING", sParam0), iParam1);
}
...
{
	func_139((Global_1938932->f_5[iParam0 /*11*/])->f_6, 1);
	func_140((Global_1938932->f_5[iParam0 /*11*/])->f_6, 0);
...
void func_115(int iParam0)
{
	...
	if (func_87((Global_1915170->f_3[iParam0 /*447*/])->f_21) && func_142((Global_1915170->f_3[iParam0 /*447*/])->f_21))
	{
		func_143((Global_1915170->f_3[iParam0 /*447*/])->f_21, 0, 1, 0, 0);
	}
	...
	func_144((Global_1915170->f_3[iParam0 /*447*/])->f_9, 0);
	...
	else
	{
		...
		while (iVar0 < iVar1)
		{
			func_147(&((Global_1915170->f_3[iParam0 /*447*/])->f_318[iVar0 /*6*/]));
...
void func_122(int iParam0)
{
	...
	if (func_155(iParam0, 262144) && !bVar0)
	{
	...
	else
	{
		...
		while (iVar2 < iVar3)
		{
			func_147(&((Global_1051387->f_69[iParam0 /*76*/])->f_32[iVar2]));
	...
	if (VOLUME::_0x92A78D0BEDB332A3((Global_1051387->f_69[iParam0 /*76*/])->f_25) && func_161(iParam0, 2))
	{
...
int func_128(int iParam0, var uParam1, int iParam2, var uParam3, var uParam4, var uParam5, var uParam6, bool bParam7)
{
	bool bVar0;
	int iVar1;
	var uVar2;
...
char* func_132(var uParam0, var uParam1, var uParam2, var uParam3, var uParam4, var uParam5, var uParam6, var uParam7)
{
...
void func_143(int iParam0, bool bParam1, int iParam2, bool bParam3, bool bParam4)
{
	int iVar0;
	int iVar1;
...
void func_163(var uParam0, int iParam1, struct<17> Param2)
{
	int iVar0;
	struct<24> Var1;
...
int func_168(vector3 vParam0, int iParam3)
{
	...
	func_187(iParam3, &vVar0, &Var3, &fVar6);
	if (func_188(vParam0, vVar0, Var3, Var3.f_1, fVar6))
	{
		return 1;
	}
	return 0;
...
void func_187(int iParam0, var uParam1, var uParam2, var uParam3)
{
	switch (iParam0)
	{
		case 0:
...
bool func_188(vector3 vParam0, vector3 vParam3, float fParam6, float fParam7, float fParam8)
{
	vector3 vVar0;
	struct<2> Var3;
	float fVar6;
