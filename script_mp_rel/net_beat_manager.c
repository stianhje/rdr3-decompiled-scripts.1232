...
void func_53(var uParam0, int iParam1, int iParam2, int iParam3, int iParam4)
{
	...
	switch (iParam1)
	{
			...
			*uParam0 = 1;
			...
			switch (iParam2)
			{
				case 0:
					...
					uParam0->f_11 = { func_89(func_88(iParam4)) };
					break;
			}
			break;
		case 14:
		...
		case 23:
			...
			*uParam0 = func_91(iVar17);
			uParam0->f_1 = 0;
			uParam0->f_6 = 2;
			func_85(uParam0, 32);
			if (iParam2 != -1)
			{
				uParam0->f_9 = func_93(func_92(iVar17), iParam2);
				uParam0->f_15 = func_94(func_92(iVar17), iParam2);
				uParam0->f_5 = func_95(iVar17, iParam2);
				uParam0->f_11 = { func_96(iVar17, iParam2) };
			}
			break;
	}
}
...
void func_98(var uParam0, var uParam1, var uParam2, var uParam3, int iParam4)
{
	uParam0->f_4 = 1;
	uParam0->f_6 = uParam1;
...
{
	return func_135(uParam0->f_16, iParam1);
}
...
bool func_111(var uParam0, int iParam1)
{
	...
	return func_75(((*Global_1242415)[iParam1 /*56*/])->f_55, uParam0);
}
...
int func_132(vector3 vParam0, var uParam3, var uParam4, int iParam5, int iParam6, bool bParam7)
{
	var uVar0;
...
void func_134(var uParam0, var uParam1)
{
	...
	while (iVar0 <= 31)
	{
		uVar1 = func_159(iVar0);
		if (func_75(uParam0->f_7, uVar1))
		{
		}
		iVar0++;
	}
...
int func_147(var uParam0, bool bParam1, var uParam2, var uParam3, var uParam4, var uParam5)
{
	struct<29> Var0;
	struct<2> Var32;
	bool bVar34;
...
float func_152(var uParam0, int iParam1, int iParam2, int iParam3, var uParam4)
{
	int iVar0;
	float fVar1;
	...
	while (iVar0 <= 14)
	{
		fVar1 = (fVar1 + func_168(uParam0, iParam1, iParam2, iParam3, uParam4, iVar0));
		if (!func_169(uParam0))
		{
		}
		else
	...
	func_170(uParam0, iParam3, iParam1, uParam4);
	return fVar1;
}
...
var func_167(vector3 vParam0, vector3 vParam3, vector3 vParam6, int iParam9, var uParam10, var uParam11)
{
	var uVar0;
	int iVar1;
	int iVar2;
...
float func_168(var uParam0, int iParam1, int iParam2, int iParam3, var uParam4, int iParam5)
{
	switch (iParam5)
	{
		case 0:
			return func_184(uParam0, iParam1, iParam2, iParam3, uParam4);
		case 1:
			return func_185(uParam0, iParam3);
		case 2:
			return func_186(uParam0, iParam3, uParam4);
		case 3:
			return func_187(uParam0, iParam1, iParam2, iParam3, uParam4);
		case 4:
			return func_188(uParam0, iParam3, uParam4);
		case 5:
			return func_189(uParam0, iParam3, uParam4);
		case 6:
			return func_190(uParam0, iParam1, iParam3, uParam4);
		case 8:
			return func_191(uParam0, iParam3);
		case 14:
			return func_192(uParam0, iParam1, iParam3, uParam4);
		case 9:
			return func_193(uParam0, iParam3, uParam4);
		case 10:
			return func_194(uParam0, iParam3, uParam4);
		case 11:
			return func_195(uParam0, iParam1, iParam3, uParam4);
		case 12:
			return func_196(uParam0, iParam3);
		case 13:
			return func_197(uParam0, iParam1, iParam3, uParam4);
		default:
			break;
	}
	return 0f;
...
void func_170(var uParam0, int iParam1, int iParam2, var uParam3)
{
	int iVar0;
	...
	if (*uParam0 == ((*Global_1244208)[iParam1 /*4*/])->f_3)
	{
		return;
	}
	TELEMETRY::_0x6571E4327390EC0B(uParam3->f_5, iParam2, Global_36, *uParam0);
}
...
float func_184(var uParam0, int iParam1, int iParam2, int iParam3, var uParam4)
{
	vector3 vVar0;
	bool bVar3;
	bool bVar4;
	...
	vVar0 = { uParam4->f_11 };
	if (func_100(uParam4, 1) && func_164(vVar0))
	{
		func_155(uParam0, iParam3, 256, 0);
		return -1f;
	}
...
float func_185(var uParam0, int iParam1)
{
	...
	{
		func_155(uParam0, iParam1, 131072, 0);
		return 0f;
	}
	return 0f;
}

float func_186(var uParam0, int iParam1, var uParam2)
{
	int iVar0;

	if (!func_100(uParam2, 1))
	{
		return 0f;
	}
	...
	if (!func_126(iVar0))
	{
		func_155(uParam0, iParam1, 256, 0);
		return 0f;
	}
	if (func_213(iVar0))
	{
		func_155(uParam0, iParam1, 524288, 0);
		return 0f;
	}
	return 0f;
}

float func_187(var uParam0, int iParam1, int iParam2, int iParam3, var uParam4)
{
	float fVar0;
	vector3 vVar1;
	int iVar4;
...
float func_188(var uParam0, int iParam1, var uParam2)
{
	if (func_216(uParam2->f_7))
	{
		func_155(uParam0, iParam1, 2097152, 0);
		return 0f;
	}
	return 0f;
}

float func_189(var uParam0, int iParam1, var uParam2)
{
	int iVar0;
	int iVar1;
	int iVar2;
	...
	{
		func_155(uParam0, iParam1, 8, 0);
		return 0f;
	}
	iVar1 = func_219(func_218(153786159));
	if (iVar1 == uParam2->f_5)
	{
...
float func_190(var uParam0, int iParam1, int iParam2, var uParam3)
{
	int iVar0;

	if (func_100(uParam3, 32))
	{
		return 0f;
	}
	...
	{
		func_155(uParam0, iParam2, 16, 0);
		return 0f;
	}
	return 0f;
}

float func_191(var uParam0, int iParam1)
{
	if (func_60(Global_1240910[iParam1 /*3*/]) && func_62(Global_1240910[iParam1 /*3*/]) < Global_1901929->f_230.f_54)
	{
		func_155(uParam0, iParam1, 32, 0);
		return 0f;
	}
	return 0f;
}

float func_192(var uParam0, int iParam1, int iParam2, var uParam3)
{
	int iVar0;
	int iVar1;
	...
	if (uParam3->f_6 == 2)
	{
		...
		{
			func_155(uParam0, iParam2, 65536, 0);
			return 0f;
		}
	}
	return 0f;
...
float func_193(var uParam0, int iParam1, var uParam2)
{
	int iVar0;
	int iVar1;

	func_223(uParam2->f_15, &iVar0, &iVar1);
	if (iVar0 == -1 || iVar1 == -1)
	{
		return 0f;
	}
	...
	func_155(uParam0, iParam1, 128, 0);
	return 0f;
}

float func_194(var uParam0, int iParam1, var uParam2)
{
	if (uParam2->f_14 == 0)
	{
		return 0f;
	}
	if (func_225(0) == uParam2->f_14)
	{
		return 0.25f;
	}
	func_155(uParam0, iParam1, 512, 0);
	return 0f;
}

float func_195(var uParam0, int iParam1, int iParam2, var uParam3)
{
	var uVar0;

	if (uParam3->f_6 == 2)
	{
		uVar0 = func_55(iParam1);
		if (func_226(uVar0))
		{
			func_155(uParam0, iParam2, 16384, 0);
		}
	}
	return 0f;
}
...
float func_196(var uParam0, int iParam1)
{
	...
	{
		func_155(uParam0, iParam1, 32768, 0);
	}
	return 0f;
}

float func_197(var uParam0, int iParam1, int iParam2, var uParam3)
{
	int iVar0;
	int iVar1;
	int iVar2;
	...
	{
		func_155(uParam0, iParam2, 1024, 0);
		return 0f;
	}
	if (!func_230(uParam3->f_7))
	{
		func_155(uParam0, iParam2, 268435456, 0);
		return 0f;
	}
	if (uParam3->f_6 == 2)
	{
		...
		iVar0 = func_231(iVar2, uParam3->f_5, iVar3, Global_36, 1, 0, 0, -1082130432);
		iVar1 = func_232(iVar0);
		if (iVar1 != 0)
		{
			func_155(uParam0, iParam2, iVar1, 0);
			return 0f;
		}
	}
	else if (uParam3->f_6 == 1)
	{
		if (!UNLOCK::_UNLOCK_IS_UNLOCKED(uParam3->f_5))
		{
			func_155(uParam0, iParam2, 268435456, 0);
			return 0f;
		}
		if (func_100(uParam3, 8) && !_NAMESPACE26::_0x424B17A7DC5C90BC(PLAYER::PLAYER_ID()))
		{
			func_155(uParam0, iParam2, 1048576, 0);
			return 0f;
		}
	}
	return 0f;
...
bool func_202(int iParam0, var uParam1, var uParam2)
{
...
var func_219(var uParam0, var uParam1)
{
	var uVar0;
...
int func_227(int iParam0, bool bParam1, int iParam2, int iParam3)
{
	struct<11> Var0;
	int iVar17;
	struct<11> Var18;
	...
	{
		return func_252(bParam1, iParam2, iParam3);
	}
	if (Global_1572887->f_13 != -1)
	{
...
int func_245(vector3 vParam0, var uParam3, var uParam4, int iParam5, var uParam6, bool bParam7)
{
	vParam0.f_2 = iParam5;
...
int func_256(int iParam0, int iParam1, var uParam2, var uParam3)
{
	bool bVar0;
	vector3 vVar1;
	float fVar4;

	bVar0 = func_278(iParam0, iParam1, 2);
	if (func_279(iParam0, iParam1, bVar0))
	{
		return 1;
	}
	...
	fVar4 = func_280(func_92(iParam0), iParam1);
	if ((uParam2 && func_278(iParam0, iParam1, 1)) && func_281(vVar1, fVar4))
	{
		*uParam3 = 1;
		return 1;
	}
	return func_282(vVar1, fVar4, bVar0);
}
...
int func_279(int iParam0, int iParam1, bool bParam2)
{
	...
	while (iVar0 <= (func_209(iParam0, iParam1) - 1))
	{
		...
		fVar4 = func_296(func_92(iParam0), iParam1, iVar0);
		if (func_164(vVar1))
		{
		}
		else
		{
			if (func_282(vVar1, fVar4, bParam2))
			{
				return 1;
			}
			iVar0++;
...
float func_280(var uParam0, int iParam1)
{
	...
	if (func_130(&Var1, uParam0) && func_131(&Var1, iParam1))
	{
		func_297(Var1, -364402952, &fVar0, 0);
	}
	return fVar0;
}
...
int func_283(vector3 vParam0, var uParam3, var uParam4, int iParam5, int iParam6, bool bParam7)
{
	vParam0.f_2 = iParam5;
...
float func_296(var uParam0, int iParam1, int iParam2)
{
	float fVar0;
	struct<5> Var1;
...
int func_297(vector3 vParam0, var uParam3, var uParam4, int iParam5, float fParam6, bool bParam7)
{
	vParam0.f_2 = iParam5;
