...
int func_31(int iParam0, vector3 vParam1, var uParam4, int iParam5, int iParam6, int iParam7, int iParam8)
{
	...
	while (iVar0 <= 3)
	{
		if (func_81(*uParam4, iVar0))
		{
			...
			{
				vVar8 = { func_55(*uParam4) };
				func_84(*uParam4, iVar0, &iVar1, &iVar2, &uVar3);
...
void func_57(var uParam0, int iParam1, vector3 vParam2, int iParam5)
{
	...
	*uParam0 = iParam1;
	uParam0->f_1 = func_123(vParam2);
	uParam0->f_2 = iParam5;
}

void func_58(var uParam0, int iParam1, vector3 vParam2, int iParam5)
{
	struct<5> Var0;
...
void func_71(var uParam0, float fParam1, int iParam2)
{
	if (iParam2 || !func_70(uParam0))
	{
...
void func_84(int iParam0, int iParam1, var uParam2, var uParam3, var uParam4)
{
	if (iParam0 <= -1)
	{
		return;
	...
	if (func_2() != -1)
	{
		func_141(Global_20250[iParam0 /*9*/], iParam1, uParam2, uParam3, uParam4);
		return;
	}
	func_142(Global_12343[iParam0 /*9*/], iParam1, uParam2, uParam3, uParam4);
}
...
{
	func_163(func_161(-1256705067, func_102(iParam0)), iParam1);
...
void func_109(int iParam0)
{
	...
	if (func_145(iParam0) == 2085633299)
	{
		...
		if (iVar39 || func_166(iParam0, -537818634))
		{
...
void func_110(int iParam0, int iParam1, bool bParam2, int iParam3, int iParam4, bool bParam5, int iParam6)
{
	bool bVar0;
	int iVar1;
	char cVar2[32];
	...
	else if (!func_182(iParam0, &Var7, iVar11, iVar10, 0, -401018458))
	{
		Var7 = "_PLACEHOLDER";
	...
	if (((((iParam1 == 1 || func_166(iParam0, 1443104131)) || iParam0 == -885810591) || iParam0 == -1424823393) || iParam0 == 1463786584) || iParam0 == 1358243310)
	{
	...
	if (iVar12 == -126813555 || iVar12 == 1946043663)
	{
		if (!func_166(iParam0, 920823793))
		{
			...
			if (func_189(iParam0, &Var20))
			{
				sVar19 = func_191(func_190(Var20), 109029619);
			}
		}
	}
...
void func_139(var uParam0, int iParam1, int iParam2, int iParam3, int iParam4, int iParam5, int iParam6)
{
...
void func_141(var uParam0, int iParam1, var uParam2, var uParam3, var uParam4)
{
...
void func_142(var uParam0, int iParam1, var uParam2, var uParam3, var uParam4)
{
	*uParam3 = uParam0->f_4[iParam1] & 511;
	*uParam2 = BUILTIN::SHIFT_RIGHT(uParam0->f_4[iParam1] & 3584, 9);
	*uParam4 = BUILTIN::SHIFT_RIGHT(uParam0->f_4[iParam1] & 57344, 13);
...
int func_148(int iParam0, int iParam1, bool bParam2, int iParam3)
{
	...
	if (func_215(iParam0, -455129387) != 0)
	{
...
void func_178(int iParam0, int iParam1, int iParam2, int iParam3, int iParam4, int iParam5)
{
	int iVar0;
...
int func_207(char* sParam0, var uParam1, var uParam2, int iParam3, bool bParam4)
{
	*uParam1 = INVENTORY::_0x80D78BDC9D88EF07(func_216(bParam4), sParam0, iParam3, uParam2);
	if (*uParam1 >= 0)
	{
		return 1;
	}
...
int func_238(int iParam0, float fParam1, bool bParam2, var uParam3)
{
	char* sVar0;
	int iVar1;
...
int func_254(var uParam0, var uParam1, var uParam2, bool bParam3)
{
	*uParam1 = INVENTORY::_0x640F890C3E5A3FFD(func_216(bParam3), uParam0, uParam2);
	if (*uParam1 >= 0)
	{
		return 1;
	}
...
struct<5> func_255(int iParam0, bool bParam1, int iParam2)
{
	...
	{
		case -1037537535:
			Var0 = { func_256(889965687, Var0, 1034665895, bParam1) };
		...
		case -427144552:
			...
			{
				Var6.f_9 = -1591664384;
				if (!func_280(iParam0, &Var0, 1728382685, 0, 0))
				{
					Var0.f_4 = 1728382685;
				}
				else if (!func_280(iParam0, &Var0, -649335959, 0, 0))
				{
					Var0.f_4 = -649335959;
				}
				else if (func_281(iParam0, &Var6, 1728382685))
				{
					Var0.f_4 = 1728382685;
				}
				else
		...
		case -1962314949:
			...
			{
				Var0 = { func_256(-1838434463, Var0, 1084182731, bParam1) };
...
struct<4> func_256(int iParam0, var uParam1, var uParam2, var uParam3, var uParam4, int iParam5, bool bParam6)
{
	struct<4> Var0;
...
struct<4> func_278(bool bParam0)
{
	...
	if (Global_1572887->f_13 == 0)
	{
		...
		if (iVar0 == 2)
		{
			...
			{
				*Global_1270479 = { func_256(1328661203, func_296(), -1591664384, bParam0) };
			}
		...
		else if (iVar0 == 3)
		{
			...
			{
				Global_1270479->f_12 = { func_256(1328661203, func_296(), -1591664384, 0) };
			}
			return Global_1270479->f_12;
		}
	}
	return func_256(1328661203, func_296(), -1591664384, bParam0);
}
...
bool func_280(int iParam0, var uParam1, int iParam2, bool bParam3, int iParam4)
{
	return func_298(iParam0, *uParam1, iParam2, bParam3, 1, iParam4) > 0;
}
...
bool func_284(var uParam0, var uParam1, var uParam2, var uParam3, var uParam4, bool bParam5, bool bParam6, int iParam7)
{
	return func_301(&uParam0, uParam4, bParam5, bParam6, iParam7);
}
...
bool func_297()
{
	return (func_313(-1185145312, 0, 0, 0) > 0 && func_314(func_256(889965687, func_278(1), 1034665895, 1), -234132662, 1, -1) != 0);
}
...
int func_298(int iParam0, struct<4> Param1, int iParam5, bool bParam6, bool bParam7, int iParam8)
{
	...
	if (!bParam7 && func_215(iParam0, -455129387) == 0)
	{
		bParam7 = true;
	}
	iVar0 = 0;
...
int func_301(var uParam0, var uParam1, bool bParam2, bool bParam3, int iParam4)
{
...
int func_314(var uParam0, var uParam1, var uParam2, var uParam3, int iParam4, bool bParam5, int iParam6)
{
...
int func_326(var uParam0, var uParam1, bool bParam2, int iParam3)
{
	struct<10> Var0;

	Var0.f_9 = -1591664384;
	if (func_344(uParam0, uParam1, &Var0, bParam2, iParam3))
	{
		return Var0.f_4;
	}
	return 0;
...
int func_344(var uParam0, var uParam1, var uParam2, bool bParam3, int iParam4)
{
	var uVar0;
	...
	if (!func_301(&uVar0, uParam2, bParam3, 0, iParam4))
	{
		return 0;
	}
	return 1;
...
int func_369(int iParam0, var uParam1, var uParam2)
{
	struct<5> Var0;
	int iVar7;
