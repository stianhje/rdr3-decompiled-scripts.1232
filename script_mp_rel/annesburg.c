...
{
	func_63(25, iLocal_33, iParam0, 0, 0, 2, 0, 0, -1082130432, 0);
	func_64(25, 1);
	func_64(25, 16384);
	func_64(25, 8192);
	func_64(25, 536870912);
	func_63(6, iLocal_34, iParam0, iLocal_35, iLocal_36, 20, 0, 0, -1082130432, 0);
	func_65(6, 0);
	func_63(2, iLocal_40, iParam0, iLocal_41, iLocal_42, 1277952, 0, 0, -1082130432, 0);
...
void func_66(int iParam0, int iParam1, int iParam2, bool bParam3)
{
	...
	if (func_128(&((Global_1051387->f_69[iParam0 /*76*/])->f_32[iVar0])))
	{
		...
		{
			func_77(&((Global_1051387->f_69[iParam0 /*76*/])->f_32[iVar0]), 0, iParam2, bParam3, 1, 0, 0, 0);
		}
	}
...
void func_87(int iParam0, int iParam1, int iParam2, bool bParam3, int iParam4, int iParam5)
{
	...
	sVar1 = func_147(iParam0, iParam1, iParam2, iParam4, iParam5, bParam3, &uVar0);
	...
	else
	{
		...
		if (!MISC::_SHOULD_USE_24_HOUR_CLOCK())
		{
			...
			sVar2 = MISC::_CREATE_VAR_STRING(674, sVar8, iVar4, func_159(&sVar6, 109029619), sVar9, func_159(&sVar10, 109029619));
		}
		else
		{
			...
			IntToString(&sVar10, BUILTIN::ROUND(fVar7), 8);
			sVar2 = MISC::_CREATE_VAR_STRING(162, sVar8, iVar4, func_159(&sVar6, 109029619), func_159(&sVar10, 109029619));
		}
...
int func_105(int iParam0, var uParam1, var uParam2, bool bParam3, bool bParam4)
{
	bool bVar0;
...
int func_124(int iParam0, var uParam1, var uParam2, var uParam3)
{
...
bool func_130(int iParam0, int iParam1)
{
	...
	if (iParam1 && !ENTITY::DOES_ENTITY_EXIST(func_203(iParam0)))
	{
		return false;
	}
...
struct<2> func_143(int iParam0)
{
	...
	return func_163(-277276100, uVar0);
}
...
char* func_147(int iParam0, int iParam1, int iParam2, int iParam3, var uParam4, var uParam5, var uParam6)
{
	char* sVar0;
...
var func_201(var uParam0, vector3 vParam1, var uParam4, int iParam5, int iParam6, int iParam7)
{
