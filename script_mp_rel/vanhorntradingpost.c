...
{
	func_63(4, iLocal_22, iParam0, iLocal_23, 0, 44, 0, 0, -1082130432, 0);
	func_64(4, -919742804, 0, 0);
	func_64(4, -1653762302, 0, 0);
	func_64(4, 877945562, 0, 0);
	func_65(4, 8192);
	func_66(4, 0);
	func_63(9, iLocal_32, iParam0, 0, 0, 2, 1, 0, -1082130432, 0);
	if (!func_67() && func_68())
	{
	...
	func_65(9, 16777216);
	func_65(9, 67108864);
	func_63(2, iLocal_24, iParam0, iLocal_25, iLocal_26, 1277952, 0, 0, -1082130432, 0);
	func_66(2, 0);
	func_69();
	func_70(94);
}
...
void func_70(int iParam0)
{
	...
	if (func_134(&(Global_1051387->f_3582[iVar0 /*19*/]), &iVar1, &fVar2, &vVar3))
	{
		(Global_1051387->f_3582[iVar0 /*19*/])->f_6 = func_144(iVar1, vVar3, fVar2, 0, 0, 0);
	...
	if (bVar7)
	{
		...
		{
			(Global_1051387->f_3582[iVar0 /*19*/])->f_13 = func_144(iVar1, vVar3, fVar2, 0, 0, 0);
...
void func_80(int iParam0, bool bParam1, float fParam2, bool bParam3, bool bParam4, float fParam5, int iParam6, bool bParam7)
{
...
void func_88(int iParam0, int iParam1, int iParam2, bool bParam3, int iParam4, int iParam5)
{
	var uVar0;
	char* sVar1;
	char* sVar2;
	...
	sVar1 = func_160(iParam0, iParam1, iParam2, iParam4, iParam5, bParam3, &uVar0);
	...
	else
	{
		...
		if (!MISC::_SHOULD_USE_24_HOUR_CLOCK())
		{
			...
			sVar2 = MISC::_CREATE_VAR_STRING(674, sVar8, iVar4, func_172(&sVar6, 109029619), sVar9, func_172(&sVar10, 109029619));
		}
		else
		{
			...
			IntToString(&sVar10, BUILTIN::ROUND(fVar7), 8);
			sVar2 = MISC::_CREATE_VAR_STRING(162, sVar8, iVar4, func_172(&sVar6, 109029619), func_172(&sVar10, 109029619));
		}
...
void func_90(int iParam0, bool bParam1)
{
	...
	func_177(func_176(-1532769513, -36357794), 1);
...
int func_114(int iParam0, bool bParam1)
{
	...
	{
		func_189(iParam0, _NAMESPACE48::_0x4F76E3676583D951(func_188(iParam0)));
		if (func_45() == -1)
		{
			if (func_179(iParam0, 2048))
			{
				_NAMESPACE48::_0x49A8C2CD97815215(func_147(iParam0));
	...
	if (_NAMESPACE48::_0x800DF3FC913355F3(func_147(iParam0)))
	{
...
void func_121(int iParam0)
{
	...
	if (VOLUME::_0x92A78D0BEDB332A3((Global_1051387->f_69[iParam0 /*76*/])->f_25) && func_207(iParam0, 2))
	{
...
bool func_134(int iParam0, int iParam1, float fParam2, var uParam3)
{
	return func_211(iParam0, "sHash", iParam1, "fHeading", fParam2, "vPos", uParam3);
}

int func_135(int iParam0, int iParam1, float fParam2, var uParam3)
{
	return func_211(iParam0, "sClosedHash", iParam1, "fClosedHeading", fParam2, "vClosedPos", uParam3);
}
...
void func_136(int iParam0, int iParam1, vector3 vParam2, float fParam5, bool bParam6)
{
	...
	(Global_1051387->f_69[iParam0 /*76*/])->f_6 = func_144(iParam1, vParam2, fParam5, 0, 0, 0);
...
var func_144(int iParam0, vector3 vParam1, float fParam4, int iParam5, int iParam6, int iParam7)
{
...
bool func_146(int iParam0, int iParam1)
{
	...
	if (iParam1 && !ENTITY::DOES_ENTITY_EXIST(func_213(iParam0)))
	{
		return false;
	}
	return !_NAMESPACE48::_0xEB98B38CA60742D7(func_147(iParam0));
}
...
void func_153(int iParam0, float fParam1, int iParam2, int iParam3)
{
	if (func_129(iParam0))
	{
...
char* func_160(int iParam0, int iParam1, int iParam2, int iParam3, var uParam4, var uParam5, var uParam6)
{
	char* sVar0;
...
int func_180(int iParam0, bool bParam1)
{
	...
	func_231(iParam0);
	_NAMESPACE48::_0xFC77C5B44D5FF7C0(func_147(iParam0));
	func_189(iParam0, 0);
	return 1;
}
...
int func_211(int iParam0, char* sParam1, var uParam2, char* sParam3, float fParam4, char* sParam5, var uParam6)
{
	struct<4> Var0;
...
int func_245(int iParam0, var uParam1, var uParam2)
{
	...
	if (func_266(iParam0, uParam1, &iVar0))
	{
		func_267(&iVar0, iParam0, uParam2);
	}
	else
	{
		return 0;
...
int func_252(vector3 vParam0, int iParam3)
{
	...
	func_271(iParam3, &vVar0, &Var3, &fVar6);
	if (func_272(vParam0, vVar0, Var3, Var3.f_1, fVar6))
	{
		return 1;
	}
	return 0;
