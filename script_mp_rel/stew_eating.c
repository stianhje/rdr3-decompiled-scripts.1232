...
void func_29(bool bParam0, bool bParam1, bool bParam2, int iParam3)
{
	...
	{
		func_56(func_59(joaat("used"), -939665347), 1);
	}
	...
	if (func_60() == -1)
	{
		...
		{
			func_56(func_59(joaat("used"), 595572217), 1);
		}
	}
	if (bParam1)
	{
