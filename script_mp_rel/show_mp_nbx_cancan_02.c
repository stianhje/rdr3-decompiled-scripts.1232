...
void func_126(int iParam0, bool bParam1, float fParam2, bool bParam3, bool bParam4, float fParam5, bool bParam6, bool bParam7)
{
	...
	if (func_156(iParam0))
	{
		...
		if (bParam3)
		{
			func_163(iParam0, fParam2, 1, bParam6);
		}
		else if (bParam1)
		{
			if (bParam4)
...
void func_163(int iParam0, float fParam1, bool bParam2, bool bParam3)
{
	if (func_156(iParam0))
	{
...
var func_209(vector3 vParam0, vector3 vParam3, vector3 vParam6, int iParam9, int iParam10, int iParam11)
{
	var uVar0;
	int iVar1;
	int iVar2;
