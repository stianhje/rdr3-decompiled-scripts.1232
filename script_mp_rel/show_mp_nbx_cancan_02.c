...
void func_4(var uParam0, var uParam1, var uParam2)
{
	...
	switch (uParam0->f_1352)
	{
		...
		case 2:
			...
			{
				NETWORK::RESERVE_NETWORK_MISSION_OBJECTS((0 - NETWORK::GET_NUM_RESERVED_MISSION_OBJECTS(0)));
				return;
			}
			if (NETWORK::GET_NUM_RESERVED_MISSION_PEDS(0) < uParam0->f_23)
			{
				NETWORK::RESERVE_NETWORK_MISSION_PEDS((5 - NETWORK::GET_NUM_RESERVED_MISSION_PEDS(0)));
				return;
			}
			uParam0->f_25 = 0;
			func_20(uParam0, 3);
...
int func_21(var uParam0)
{
	if (NETWORK::NETWORK_IS_HOST_OF_THIS_SCRIPT())
	{
		...
		uParam0->f_23 = 5;
		uParam0->f_2 = 0;
		uParam0->f_1401[0] = -792643455;
		uParam0->f_1401[1] = 794654164;
		uParam0->f_1401[2] = -1116138991;
		uParam0->f_1401[3] = 316325071;
		uParam0->f_1401[4] = 755774783;
...
int func_95(var uParam0)
{
	...
	if (!func_152(uParam0, iVar0, 0, "CS_CANCAN_01"))
	{
		return 0;
	}
	if (!func_152(uParam0, iVar0, 1, "CS_CANCAN_02"))
	{
		return 0;
	}
	if (!func_152(uParam0, iVar0, 2, "CS_CANCAN_03"))
	{
		return 0;
	}
	if (!func_152(uParam0, iVar0, 3, "CS_CANCAN_04"))
	{
		return 0;
	}
	if (!func_152(uParam0, iVar0, 4, "CS_CANCANMAN_01"))
	{
		return 0;
	}
...
int func_107(int iParam0, vector3 vParam1, float fParam4, bool bParam5, bool bParam6, int iParam7, bool bParam8, bool bParam9, bool bParam10, bool bParam11, bool bParam12)
{
	...
	func_157(iVar0, iParam0, iParam7, bParam8, bParam9, bParam10, bParam11, bParam12);
	return iVar0;
}
...
void func_126(int iParam0, bool bParam1, float fParam2, bool bParam3, bool bParam4, float fParam5, int iParam6, bool bParam7)
{
	...
	if (func_156(iParam0))
	{
		...
		if (bParam3)
		{
			func_163(iParam0, fParam2, 1, iParam6);
		}
		else if (bParam1)
		{
			if (bParam4)
...
void func_133(var uParam0, var uParam1, int iParam2)
{
	...
	{
		if (func_13(*uParam0, 2) && func_185(uParam1, func_182(uParam1), &(uParam1->f_229), func_183(uParam1), func_184(uParam1)))
		{
			func_14(uParam0, 2);
		}
		if (func_13(*uParam0, 4) && func_187(uParam1, func_186(uParam1), &(uParam1->f_229), func_183(uParam1), func_184(uParam1)))
		{
			func_14(uParam0, 4);
		}
	}
	...
	{
		if (func_13(*uParam0, 16) && func_185(&(uParam1->f_31), func_188(uParam1), &(uParam1->f_232), func_189(uParam1), func_184(uParam1)))
		{
			func_14(uParam0, 16);
		}
		if (func_13(*uParam0, 32) && func_187(&(uParam1->f_31), func_190(uParam1), &(uParam1->f_232), func_189(uParam1), func_184(uParam1)))
		{
			func_14(uParam0, 32);
		}
	}
	...
	{
		if (func_13(*uParam0, 4096) && func_185(&(uParam1->f_107), func_191(uParam1), &(uParam1->f_235), func_192(uParam1), func_184(uParam1)))
		{
			func_14(uParam0, 4096);
		}
		if (func_13(*uParam0, 8192) && func_187(&(uParam1->f_107), func_193(uParam1), &(uParam1->f_235), func_192(uParam1), func_184(uParam1)))
		{
	...
	if (iParam2 == 0)
	{
		...
		{
			if (func_13(*uParam0, 128) && func_196(uParam1->f_118[0 /*5*/], func_194(uParam1), &(uParam1->f_238), func_195(uParam1), func_184(uParam1)))
			{
				func_14(uParam0, 128);
			}
			if (func_13(*uParam0, 256) && func_198(uParam1->f_118[0 /*5*/], func_197(uParam1), &(uParam1->f_238), func_195(uParam1), func_184(uParam1)))
			{
				func_14(uParam0, 256);
			}
			if (func_13(*uParam0, 512) && func_196(uParam1->f_118[0 /*5*/], func_194(uParam1), &(uParam1->f_238), 0.5f, func_184(uParam1)))
			{
				func_14(uParam0, 512);
			}
			if (func_13(*uParam0, 1024) && func_198(uParam1->f_118[0 /*5*/], func_197(uParam1), &(uParam1->f_238), 0.5f, func_184(uParam1)))
			{
		...
		{
			if (func_13(*uParam0, 32768) && func_201(1, 2, &(uParam1->f_118), func_199(uParam1), &(uParam1->f_241), func_200(uParam1), func_184(uParam1)))
			{
				func_14(uParam0, 32768);
			}
			if (func_13(*uParam0, 65536) && func_203(1, 2, &(uParam1->f_118), func_202(uParam1), &(uParam1->f_241), func_200(uParam1), func_184(uParam1)))
			{
				func_14(uParam0, 65536);
			}
			if (func_13(*uParam0, 131072) && func_201(1, 2, &(uParam1->f_118), func_199(uParam1), &(uParam1->f_241), 0.5f, func_184(uParam1)))
			{
				func_14(uParam0, 131072);
			}
			if (func_13(*uParam0, 262144) && func_203(1, 2, &(uParam1->f_118), func_202(uParam1), &(uParam1->f_241), 0.5f, func_184(uParam1)))
			{
	...
	if (iParam2 == 1)
	{
		...
		{
			if (func_13(*uParam0, 4194304) && func_185(&(uParam1->f_118), func_204(uParam1), &(uParam1->f_238), func_205(uParam1), func_184(uParam1)))
			{
				func_14(uParam0, 4194304);
			}
			if (func_13(*uParam0, 8388608) && func_187(&(uParam1->f_118), func_206(uParam1), &(uParam1->f_238), func_205(uParam1), func_184(uParam1)))
			{
...
{
	return func_209(0f, 0f, 0f, 0f, 0f, 0f, 0f, 0f, 0f, 665633627, iParam0, iParam1);
}
...
void func_157(int iParam0, int iParam1, int iParam2, bool bParam3, bool bParam4, bool bParam5, bool bParam6, bool bParam7)
{
	bool bVar0;
...
void func_163(int iParam0, float fParam1, int iParam2, int iParam3)
{
	if (func_156(iParam0))
	{
...
int func_172(var uParam0, int iParam1, vector3 vParam2, int iParam5)
{
	if (uParam0->f_1 == 0)
	{
...
int func_185(var uParam0, float fParam1, var uParam2, float fParam3, int iParam4)
{
	int iVar0;
	float fVar1;
...
int func_187(var uParam0, float fParam1, var uParam2, float fParam3, int iParam4)
{
	...
	while (iVar0 <= (*uParam0 - 1))
	{
		func_220((*uParam0)[iVar0 /*5*/], fParam1, fVar1, fParam3, iParam4);
		iVar0++;
	}
	if (fVar1 >= fParam3)
	{
...
int func_196(var uParam0, float fParam1, var uParam2, float fParam3, int iParam4)
{
	float fVar0;
...
int func_198(var uParam0, float fParam1, var uParam2, float fParam3, int iParam4)
{
	...
	fVar0 = func_148(uParam2);
	func_220(uParam0, fParam1, fVar0, fParam3, iParam4);
	if (fVar0 >= fParam3)
	{
		func_149(uParam2);
		return 1;
...
int func_201(int iParam0, int iParam1, var uParam2, float fParam3, var uParam4, float fParam5, int iParam6)
{
	int iVar0;
	int iVar1;
	float fVar2;
...
int func_203(int iParam0, int iParam1, var uParam2, float fParam3, var uParam4, float fParam5, int iParam6)
{
	...
	while (iVar3 <= iVar1)
	{
		func_220((*uParam2)[iVar3 /*5*/], fParam3, fVar2, fParam5, iParam6);
		iVar3++;
	}
	if (fVar2 >= fParam5)
	{
...
var func_209(vector3 vParam0, vector3 vParam3, vector3 vParam6, int iParam9, var uParam10, var uParam11)
{
	var uVar0;
	int iVar1;
	int iVar2;
	...
	else
	{
		...
		{
			case 665633627:
				iVar8 = VOLUME::_CREATE_VOLUME_CYLINDER_WITH_CUSTOM_NAME(vParam0, vParam3, vParam6, func_223());
				break;
			
			case -432403087:
				iVar8 = VOLUME::_0x10157BC3247FF3BA(vParam0, vParam3, vParam6, func_223());
				break;
			
			case -1612834106:
				iVar8 = VOLUME::_CREATE_VOLUME_BOX_WITH_CUSTOM_NAME(vParam0, vParam3, vParam6, func_223());
				break;
		}
	}
	if (iVar9 & 8 != 0)
	{
		iVar9 = (iVar9 || func_224(PLAYER::GET_PLAYER_TEAM(iVar5)));
	}
	...
	while (iVar2 < 32)
	{
		if (NETWORK::NETWORK_IS_PLAYER_ACTIVE(&(Global_1273882->f_154[iVar2])))
		{
			...
			if (!bVar3)
			{
				if (iVar9 & 8192 != 0 && func_226(iVar2) != 1)
				{
					bVar3 = true;
				}
			}
...
void func_219(var uParam0, float fParam1, float fParam2, float fParam3, int iParam4)
{
	...
	if (ENTITY::DOES_ENTITY_EXIST(*uParam0))
	{
		if (uParam0->f_2 > fParam1 && uParam0->f_2 > uParam0->f_3)
		{
			...
			fVar0 = (fVar1 / fParam3);
			uParam0->f_2 = func_229(fParam1, uParam0->f_4, fVar0);
...
void func_220(var uParam0, float fParam1, float fParam2, float fParam3, int iParam4)
{
	float fVar0;
	float fVar1;
	...
	if (ENTITY::DOES_ENTITY_EXIST(*uParam0))
	{
		if (uParam0->f_2 < fParam1 && uParam0->f_2 < uParam0->f_4)
		{
			...
			uParam0->f_2 = func_229(uParam0->f_3, fParam1, fVar0);
			if (uParam0->f_2 > fParam1)
			{
				uParam0->f_2 = fParam1;
			}
...
int func_230(int iParam0, int iParam1)
{
	...
	if (iParam1 == 255)
	{
		return func_233(&(Global_1099293->f_4), iVar0, 5);
	}
	if (iParam1 == func_234())
	{
		return func_233(&(Global_1099293->f_4), iVar0, 5);
	...
	{
		return func_233(&(((*Global_1097609)[iParam1 /*51*/])->f_4), iVar0, 5);
	}
	return 0;
}
