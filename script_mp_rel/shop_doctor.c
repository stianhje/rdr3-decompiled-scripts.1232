...
bool func_316(var uParam0, int iParam1, int iParam2, vector3 vParam3, vector3 vParam6, int iParam9, int iParam10, int iParam11)
{
	...
	{
		if (!func_721(&(uParam0->f_4), iParam1, iParam2, aggregate.shop_bait.func_725(iParam2), uParam0->f_1767, 0))
		{
		}
	}
	...
	aggregate.camera_item.func_77(&(uParam0->f_4), 135810);
	aggregate.camera_item.func_77(&(uParam0->f_4), 135847);
	aggregate.shop_bait.func_733(&(uParam0->f_4), 135875);
	aggregate.shop_bait.func_733(&(uParam0->f_4), 136410);
...
void func_332(var uParam0)
{
	...
	{
		aggregate.shop_bait.func_749(uParam0, 0, 137215, 137224, 137233, 137775);
		aggregate.shop_bait.func_42(uParam0, 0, 32);
	}
	aggregate.shop_bait.func_749(uParam0, 1, 137215, 137224, 137233, 137775);
...
int func_339(var uParam0, bool bParam1, bool bParam2)
{
	switch (MISC::GET_RANDOM_INT_IN_RANGE(0, 5))
	{
		case 0:
			...
			break;
		case 1:
			if (aggregate.bandana.func_11(bParam1, 836323602))
			{
			...
			if (aggregate.bandana.func_11(bParam1, -906398725))
			{
			...
			if (aggregate.bandana.func_11(bParam1, 18203328))
			{
...
int func_340(var uParam0, bool bParam1)
{
	...
	else if (aggregate.long_update.func_361(uParam0))
	{
		uParam0->f_45 = 1;
...
void func_691(var uParam0)
{
	...
	if (!MISC::IS_BIT_SET(uParam0->f_2371.f_9, 1))
	{
		...
		{
			aggregate.mp_intro.func_1329(uParam0, 191052);
			aggregate.mp_intro.func_1329(uParam0, 191972);
			aggregate.mp_intro.func_1329(uParam0, 192572);
			aggregate.mp_intro.func_1329(uParam0, 192866);
			aggregate.mp_intro.func_1329(uParam0, 193069);
...
int func_745(var uParam0, int iParam1)
{
	...
	{
		return aggregate.shop_bait.func_749(uParam0, iParam1, 217495, 217526, 217613, 219211);
	}
	else
	{
		iVar0 = 0;
		...
		return aggregate.shop_bait.func_749(uParam0, iParam1, 219421, 193179, 126989, 30652);
	}
	return 0;
}
...
bool func_1175(var uParam0)
{
	...
	if (!aggregate.mp_intro.func_1426(uParam0))
	{
		...
		if (func_1022(uParam0, Var0.f_2, Var0.f_3, 0))
		{
			...
			aggregate.mp_intro.func_1329(uParam0, 315870);
			aggregate.mp_intro.func_1329(uParam0, 316074);
			aggregate.mp_intro.func_1329(uParam0, 316184);
...
bool func_1176(var uParam0)
{
	...
	if (!aggregate.mp_intro.func_1426(uParam0))
	{
		...
		if (func_1022(uParam0, bVar5, bVar6, 1))
		{
			...
			aggregate.mp_intro.func_1329(uParam0, 316889);
			aggregate.mp_intro.func_1329(uParam0, 317043);
			aggregate.mp_intro.func_1329(uParam0, 317256);
...
bool func_1177(var uParam0)
{
	...
	if (!aggregate.mp_intro.func_1426(uParam0))
	{
		...
		{
			aggregate.shop_doctor.func_1735(uParam0, 173);
			aggregate.mp_intro.func_1329(uParam0, 317796);
			aggregate.mp_intro.func_1329(uParam0, 317863);
			aggregate.mp_intro.func_1329(uParam0, 318036);
			if (bVar0)
			{
				if (!aggregate.net_camp.func_1094(uParam0, Var1.f_2, Var1.f_3, -1, 1, 1))
				{
...
int func_1695(var uParam0, bool bParam1)
{
	bool bVar0;
...
void func_2696(int iParam0, bool bParam1, int iParam2)
{
	...
	bVar35 = aggregate.net_camp.func_2216(bParam1);
	bVar30 = false;
	while (bVar30 < bVar35)
	{
...
bool func_2844(bool bParam0, bool bParam1, bool bParam2)
{
	if (bParam0 == 0)
	{
		return false;
