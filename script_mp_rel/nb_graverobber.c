...
void func_13(var uParam0, var uParam1, var uParam2, var uParam3, var uParam4)
{
	...
	iVar19 = func_30(&uVar18, Local_204.f_1, Local_204.f_2);
	if (uVar18 || iVar19 == -1)
	{
		return;
	}
...
void func_41()
{
	...
	iVar0 = (Global_1184672->f_231.f_1066[Local_204.f_12 /*17*/])->f_5;
...
int func_111(int iParam0, int iParam1, bool bParam2)
{
	...
	{
		func_193(&(((*Global_1126840)[iVar1 /*83*/])->f_70.f_1), 1);
	}
	return 1;
}
...
int func_132()
{
	...
	iVar1 = func_189(3);
	iVar2 = func_189(4);
	if ((ENTITY::IS_ENTITY_DEAD(iVar0) && !PED::GET_PED_CONFIG_FLAG(iVar0, 11, true)) && func_228(iVar0, Global_35))
	{
	...
	if (func_231(iVar0, 518218985, 1, 0))
	{
		...
		{
			PED::_0xEEED8FAFEC331A70(iVar0, ENTITY::GET_ENTITY_COORDS(PLAYER::GET_PLAYER_PED(func_232(ENTITY::GET_ENTITY_COORDS(iVar0, false, false), &uVar3, 1203982208, 0, 0, 0)), true, false), 3);
		}
...
void func_197(struct<2> Param0)
{
	...
	{
		STATS::_0x99230691875FC218(func_234(Param0), func_236(Param0), Global_36);
	}
}
...
int func_207()
{
	...
	iVar0 = 1;
	if (iVar0 && !UNLOCK::_UNLOCK_IS_UNLOCKED(Local_204.f_14))
	{
		return 0;
	}
	return 1;
	...
	switch (Local_16.f_7.f_6)
	{
		...
		case 5:
			if (bVar0)
			{
				...
				func_287(1, -1595050198, 0, 0);
				func_287(2, -1595050198, 0, 0);
				if (NETWORK::NETWORK_HAS_CONTROL_OF_ENTITY(func_189(1)))
				{
		...
		case 7:
			if (bVar0)
			{
				...
				if (func_289())
				{
					func_287(1, -1595050198, 942020339, 0);
					func_287(2, -1595050198, 942020339, 0);
				}
				iVar4 = func_189(3);
				iVar5 = func_189(4);
			...
			else
			{
				...
				if (func_231(func_189(2), 1469008894, 1, 0))
				{
					TASK::TASK_GRAPPLE(func_189(2), func_189(0), 0, 1, 2f, 1, 0);
				}
			}
...
void func_220()
{
	...
	if (ENTITY::DOES_ENTITY_EXIST(iVar0))
	{
		...
		func_303(iVar0, Global_36, 2, 1, 3);
	}
}
...
void func_221()
{
	...
	else if (func_291(0, 10f))
	{
		if (!func_267(1))
		{
			...
			{
				func_304(807, 0);
				if (!func_309(ENTITY::GET_ENTITY_COORDS(iVar0, false, false), 1101004800, 1, 0, 1, 1))
				{
					if (func_306() == 0)
					{
						func_301(8, 1);
	...
	{
		func_311(6, &(Local_204.f_18.f_155), 1092616192);
	}
	else if (func_311(5, &(Local_204.f_18.f_155), 1092616192))
	{
...
void func_222()
{
	...
	iVar0 = func_189(0);
	iVar1 = func_312();
	func_311(26, &(Local_204.f_18.f_155), 1092616192);
	switch (iVar1)
	{
		case 0:
			func_285(Global_35, "SILENT_GENERIC_AGREE", 291934926, iVar0, 1, 0, 0, 1);
			func_313(4, Local_204.f_4);
			func_314(4, Local_204.f_4);
			if (func_309(ENTITY::GET_ENTITY_COORDS(iVar0, false, false), 1101004800, 0, 1, 1, 1))
			{
				func_301(13, 1);
			}
			else
			...
			break;
		case 1:
			func_285(Global_35, "SILENT_GENERIC_DISAGREE", 291934926, iVar0, 1, 0, 0, 1);
			func_217(128);
			if (func_309(ENTITY::GET_ENTITY_COORDS(iVar0, false, false), 1101004800, 1, 1, 1, 1))
			{
				func_301(9, 1);
			}
			else
...
void func_223()
{
	...
	if ((func_36(Var0) && !func_21(Local_204.f_9, Var0)) || !func_289())
	{
		...
		if (!func_294(2048))
		{
			if ((!func_216() || !_NAMESPACE26::_0x3F59FE6F37869576(Local_16.f_7.f_17, PLAYER::GET_PLAYER_INDEX())) && func_316(Global_35, func_189(0), 35f, 0))
			{
				func_295(2048);
				func_304(810, 1);
			}
	...
	while (iVar4 < 8)
	{
		if (!&Local_204.f_18.f_130[iVar4 /*3*/])
		{
			...
			{
				if (bVar2 && func_325(iVar4, 1070386381, 0))
				{
				...
				if (bVar3)
				{
					if (func_325(iVar4, 1070386381, 0))
					{
						Local_204.f_18.f_130[iVar4 /*3*/] = 1;
						func_140(iVar4);
						if (iVar4 == Local_16.f_7.f_18)
	...
	{
		func_311(14, &(Local_204.f_18.f_155), 1092616192);
	}
	if (func_294(32))
	{
...
void func_225()
{
	...
	if (func_231(iVar0, 518218985, 1, 0))
	{
		...
		TASK::_TASK_SMART_FLEE_STYLE_PED_VIA(iVar0, Global_35, 3, func_233(), 0, -1082130432, -1, 0);
		PED::SET_PED_KEEP_TASK(iVar0, true);
	}
	func_142();
	func_321(0);
...
void func_226()
{
	...
	if (func_259(512))
	{
		...
		{
			func_311(24, &(Local_204.f_18.f_155), 1092616192);
		}
...
void func_227()
{
	...
	if (ENTITY::DOES_ENTITY_EXIST(iVar0))
	{
		...
		func_303(iVar0, Global_36, 2, 1, 1);
	}
	Local_204.f_18.f_158 = (Local_16.f_7.f_5 - func_257(&(Local_16.f_7.f_2)));
	if (Local_204.f_18.f_2 > 5 && func_309(ENTITY::GET_ENTITY_COORDS(iVar0, false, false), 1101004800, 0, 0, 0, 0))
	{
		func_301(22, 1);
	}
	func_311(16, &(Local_204.f_18.f_155), 1092616192);
}
...
int func_232(vector3 vParam0, var uParam3, int iParam4, int iParam5, int iParam6, int iParam7)
{
	int iVar0;
	float fVar1;
	int iVar2;
	...
	*uParam3 = iParam4;
	...
	while (iVar0 <= 31)
	{
		...
		else if (iParam7 && !func_334(NETWORK::NETWORK_GET_PARTICIPANT_INDEX(iVar2), 1, 1))
		{
		}
		else
		{
...
int func_250(var uParam0, int iParam1, vector3 vParam2, float fParam5, bool bParam6, int iParam7, bool bParam8, bool bParam9, bool bParam10)
{
	int iVar0;
	...
	iVar0 = func_344(iParam1, vParam2, fParam5, bParam8, 1, bParam6, iParam7, bParam9);
...
int func_265(int iParam0, int iParam1)
{
	...
	while (iVar1 <= 31)
	{
		...
		else
		{
			...
			else if (iParam1 && func_218(128, iVar2))
			{
			}
			else
			{
...
int func_273(int iParam0)
{
	...
	while (iVar0 < 32)
	{
		...
		if (iParam0 && iVar1 == PLAYER::GET_PLAYER_INDEX())
		{
		}
...
int func_280(int iParam0, int iParam1, var uParam2, var uParam3, int iParam4, float fParam5)
{
	...
	if (!Global_1939168->f_6 && !ENTITY::IS_ENTITY_DEAD(iParam0))
	{
		...
		if (Global_1939168->f_20 && func_357(PLAYER::PLAYER_ID(), 0, 1, uParam2->f_1 & 524288 == 0))
		{
		...
		{
			if (func_358(uParam2, 1065353216))
			{
				if (!uParam2->f_1 & 4 != 0)
				{
					if (func_359(Global_35, iParam0, uParam2))
					{
						*uParam3 = 4;
						func_353(iParam0, uParam2, *uParam3);
						return 1;
		...
		if (!uParam2->f_1 & 16 != 0)
		{
			...
			{
				if (func_361(Global_35, iParam0, uParam2, 0))
				{
					*uParam3 = 16;
					func_353(iParam0, uParam2, *uParam3);
					return 1;
			...
			else if (func_361(Global_35, iParam0, uParam2, 1))
			{
				*uParam3 = 16;
				func_353(iParam0, uParam2, *uParam3);
				return 1;
		...
		if (Global_1939168->f_24 || Global_1939168->f_25)
		{
			if (!uParam2->f_1 & 2 != 0)
			{
				...
				{
					if ((func_365(iParam0, Global_1939168->f_35, *uParam2 & 128 != 0, 0, *uParam2 & 256 != 0) && func_366(uParam2, iParam0)) && func_367(uParam2, iParam0))
					{
						*uParam3 = 2;
						func_353(iParam0, uParam2, *uParam3);
						return 1;
		...
		if (!uParam2->f_1 & 2 != 0)
		{
			if (uParam2->f_12 < 4f)
			{
				if ((func_365(iParam0, Global_1939168->f_35, *uParam2 & 128 != 0, 1, *uParam2 & 256 != 0) && func_366(uParam2, iParam0)) && func_367(uParam2, iParam0))
				{
					*uParam3 = 2;
					func_353(iParam0, uParam2, *uParam3);
					return 1;
			...
			else if (Global_1939168->f_34 == 0)
			{
				...
				{
					if (func_368(iParam0, Global_1939168->f_35))
					{
						func_369();
						*uParam3 = 2;
						func_353(iParam0, uParam2, *uParam3);
			...
			if (Global_1939168->f_36 != 0)
			{
				if (func_372())
				{
					if (func_368(iParam0, Global_1939168->f_36))
					{
						func_369();
						*uParam3 = 2;
						func_353(iParam0, uParam2, *uParam3);
		...
		if (Global_1939168->f_50)
		{
			if (*uParam2 & -2147483648 != 0)
			{
				...
				{
					if (func_376(PLAYER::PLAYER_PED_ID(), iParam0, 1060437492) == 0)
					{
						*uParam3 = 1048576;
						func_353(iParam0, uParam2, *uParam3);
						return 1;
...
int func_289()
{
	...
	if (!func_316(Global_35, func_189(0), 35f, 0))
	{
		return 0;
	}
	if (!func_216())
...
void func_290(int iParam0)
{
	switch (iParam0)
	{
		case 0:
			...
			break;
		case 1:
			func_391(0, "NB_GRAVEROBBER_ILO_HELP_DIG", -163964935, 3, 0);
			func_391(1, "GREET_NEG", 648122183, 3, 0);
			func_392(0);
			break;
		case 2:
			func_391(0, "NB_GRAVEROBBER_ILO_HELP_DIG", -163964935, 3, 0);
...
{
	if (iParam1 && func_297(func_296(iParam0)))
	{
		return;
	}
	else
...
int func_309(vector3 vParam0, float fParam3, int iParam4, int iParam5, int iParam6, int iParam7)
{
	int iVar0;
	int iVar1;
	...
	while (iVar0 <= 31)
	{
		...
		else if (iParam7 && iVar1 == PLAYER::GET_PLAYER_INDEX())
		{
		}
		else if (iParam4 && func_218(128, iVar0))
		{
		}
		else if (iParam6 && func_218(256, iVar0))
		{
		}
		else if (BUILTIN::VDIST(func_374(iVar1), vParam0) < fParam3)
		{
			if (iParam5 && !_NAMESPACE26::_0x3F59FE6F37869576(iVar1, PLAYER::GET_PLAYER_INDEX()))
			{
				Jump @167; //curOff = 157
			}
			else
...
int func_317(int iParam0)
{
	...
	if (func_190(iParam0, 1369124074))
	{
		...
		while (iVar0 < 8)
		{
			if (func_325(iVar0, 1070386381, 0))
			{
				return 1;
			}
			iVar0++;
...
int func_323(int iParam0, int iParam1)
{
	...
	while (iVar0 < 32)
	{
		if (iParam1 && PLAYER::INT_TO_PLAYERINDEX(iVar0) == PLAYER::GET_PLAYER_INDEX())
		{
		}
		else if (NETWORK::NETWORK_IS_PARTICIPANT_ACTIVE(PLAYER::INT_TO_PARTICIPANTINDEX(iVar0)))
		{
...
int func_343(vector3 vParam0, float fParam3, float fParam4)
{
	...
	if (func_261(Global_35, vParam0, fParam4, 1, 1) && CAM::IS_SPHERE_VISIBLE(vParam0, fParam3))
	{
		return 1;
	}
	iVar0 = 0;
...
int func_344(int iParam0, vector3 vParam1, float fParam4, bool bParam5, bool bParam6, bool bParam7, var uParam8, bool bParam9)
{
	int iVar0;
	...
	switch (uParam0->f_6)
	{
		case 0:
			if (*uParam0 & 16 != 0)
			{
				...
				else if (!PED::IS_PED_PLANTING_BOMB(Global_35) && (!func_433(1, 1) || *uParam0 & 8192 != 0))
				{
...
int func_357(int iParam0, bool bParam1, int iParam2, bool bParam3)
{
	struct<11> Var0;
	int iVar17;
	struct<11> Var18;
...
int func_362(int iParam0, var uParam1)
{
	...
	{
		if (!func_436(iParam0, uParam1, &(Global_1939168->f_28[iVar0])) || iParam0 == &Global_1939168->f_28[iVar0])
		{
		}
		else
		{
			bVar13 = func_453(&(Global_1939168->f_28[iVar0]));
			fVar1 = BUILTIN::VDIST(ENTITY::GET_ENTITY_COORDS(&(Global_1939168->f_28[iVar0]), false, false), vVar9);
			if (func_454(&(Global_1939168->f_28[iVar0])))
			{
				if (fVar1 < 35f)
				{
...
int func_372()
{
	...
	if ((func_371() - Global_1939168->f_37) >= 10000)
	{
		return 0;
	}
	return 1;
...
int func_376(int iParam0, int iParam1, float fParam2)
{
	...
	return func_466(iParam0, vVar0, fParam2);
}
...
int func_382(int iParam0, var uParam1)
{
	...
	{
		return func_473(iParam0, uParam1, 0, -1082130432);
	}
	return 0;
}
...
var func_389(var uParam0, var uParam1)
{
...
void func_391(int iParam0, char* sParam1, int iParam2, int iParam3, int iParam4)
{
	...
	iVar0 = func_189(0);
	iVar1 = func_478(sParam1, iParam2, iVar0, iParam3, iParam4, 0, 0, 0, 1070386381, 570, 4000, 10, 1073741824, 0, 1704213876, 0, 0);
...
bool func_396(var uParam0, char[12] cParam1, bool bParam4, int iParam5, bool bParam6, bool bParam7)
{
	bool bVar0;
...
bool func_400(int iParam0)
{
	...
	if (!iVar1 == 0)
	{
		iVar2 = func_493(&(Global_17173.f_54.f_644.f_1353.f_5), iVar1);
		if (iVar2 == -1)
		{
			return true;
		}
...
int func_401(int iParam0, int iParam1, bool bParam2, int iParam3)
{
	int iVar0;
	int iVar1;
	int iVar2;
	...
	if (func_496(iParam0, -455129387) != 0)
	{
...
int func_408(int iParam0, int iParam1, int iParam2, bool bParam3)
{
	...
	{
		if (!func_504(iParam0, 262144) || !Global_1904612->f_8189)
		{
			return 0;
		}
	}
...
void func_431(int iParam0)
{
	...
	{
		case 0:
			func_512(&(Global_1939168->f_28), &(Global_1939168->f_33));
...
float func_461(int iParam0, int iParam1, bool bParam2, int iParam3)
{
...
int func_467(int iParam0, int iParam1, bool bParam2, bool bParam3, float fParam4, bool bParam5)
{
	...
	if (bVar0)
	{
		if (func_461(iParam0, Global_1939168->f_34, 0, 1) < 2.5f)
		{
...
void func_485(var uParam0, var uParam1, var uParam2, var uParam3)
{
	int iVar0;
...
int func_487(char* sParam0, var uParam1, var uParam2, int iParam3, bool bParam4)
{
...
int func_513(bool bParam0, var uParam1, var uParam2)
{
	int iVar0;
	int iVar1;
...
int func_520(int iParam0, int iParam1, bool bParam2, int iParam3)
{
...
void func_529(int iParam0, int iParam1)
{
	if (HUD::_UIPROMPT_IS_VALID(((*Global_1949749)[iParam0 /*23*/])->f_3))
	{
		if (((*Global_1949749)[iParam0 /*23*/])->f_5 == 5 && !func_526(iParam0, 8))
		{
...
struct<4> func_536(bool bParam0)
{
	...
	if (iVar0 == 2)
	{
		...
		{
			Global_1270479->f_4 = { func_540(923904168, func_545(bParam0), -740156546, bParam0) };
		}
	...
	else if (iVar0 == 3)
	{
		...
		{
			Global_1270479->f_16 = { func_540(923904168, func_545(bParam0), -740156546, 0) };
		}
...
int func_538(var uParam0, var uParam1, var uParam2, bool bParam3)
{
	*uParam1 = INVENTORY::_0x640F890C3E5A3FFD(func_497(bParam3), uParam0, uParam2);
	if (*uParam1 >= 0)
	{
		return 1;
	}
...
struct<5> func_539(int iParam0, bool bParam1, int iParam2)
{
	...
	{
		case -1037537535:
			Var0 = { func_540(889965687, Var0, 1034665895, bParam1) };
		...
		case -427144552:
			...
			{
				Var6.f_9 = -1591664384;
				if (!func_547(iParam0, &Var0, 1728382685, 0, 0))
				{
					Var0.f_4 = 1728382685; /* GXTEntry: "Right" */
				}
				else if (!func_547(iParam0, &Var0, -649335959, 0, 0))
				{
					Var0.f_4 = -649335959; /* GXTEntry: "Left" */
				}
				else if (func_548(iParam0, &Var6, 1728382685))
				{
					Var0.f_4 = 1728382685; /* GXTEntry: "Right" */
				}
				else
		...
		case -1962314949:
			...
			{
				Var0 = { func_540(-1838434463, Var0, 1084182731, bParam1) };
...
struct<4> func_540(int iParam0, var uParam1, var uParam2, var uParam3, var uParam4, int iParam5, bool bParam6)
{
	struct<4> Var0;
...
struct<4> func_545(bool bParam0)
{
	...
	if (Global_1572887->f_13 == 0)
	{
		...
		if (iVar0 == 2)
		{
			...
			{
				*Global_1270479 = { func_540(1328661203, func_556(), -1591664384, bParam0) };
			}
		...
		else if (iVar0 == 3)
		{
			...
			{
				Global_1270479->f_12 = { func_540(1328661203, func_556(), -1591664384, 0) };
			}
			return Global_1270479->f_12;
		}
	}
	return func_540(1328661203, func_556(), -1591664384, bParam0);
}
...
bool func_547(int iParam0, var uParam1, int iParam2, bool bParam3, int iParam4)
{
	return func_558(iParam0, *uParam1, iParam2, bParam3, 1, iParam4) > 0;
}
...
struct<4> func_549(bool bParam0)
{
	...
	if (iVar0 == 2 || iVar0 == 3)
	{
		...
		{
			Global_1270479->f_8 = { func_540(271701509, func_545(bParam0), 12999093, 0) };
		}
...
bool func_551(var uParam0, var uParam1, var uParam2, var uParam3, var uParam4, bool bParam5, bool bParam6, int iParam7)
{
	return func_561(&uParam0, uParam4, bParam5, bParam6, iParam7);
}
...
bool func_557()
{
	return (func_569(-1185145312, 0, 0, 0) > 0 && func_570(func_540(889965687, func_545(1), 1034665895, 1), -234132662, 1, -1) != 0);
}
...
int func_558(int iParam0, struct<4> Param1, int iParam5, bool bParam6, bool bParam7, int iParam8)
{
	...
	if (!bParam7 && func_496(iParam0, -455129387) == 0)
	{
		bParam7 = true;
	}
	iVar0 = 0;
...
int func_561(var uParam0, var uParam1, bool bParam2, bool bParam3, int iParam4)
{
...
int func_570(var uParam0, var uParam1, var uParam2, var uParam3, int iParam4, bool bParam5, int iParam6)
{
...
int func_573(var uParam0, var uParam1, bool bParam2, int iParam3)
{
	struct<10> Var0;

	Var0.f_9 = -1591664384;
	if (func_576(uParam0, uParam1, &Var0, bParam2, iParam3))
	{
		return Var0.f_4;
	}
	return 0;
...
int func_576(var uParam0, var uParam1, var uParam2, bool bParam3, int iParam4)
{
	var uVar0;
	...
	if (!func_561(&uVar0, uParam2, bParam3, 0, iParam4))
	{
		return 0;
	}
	return 1;
