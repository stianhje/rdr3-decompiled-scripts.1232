...
void func_1(bool bParam0)
{
	...
	{
		if (func_7(&(iLocal_47[iVar0]), 0))
		{
			if (bParam0)
			{
				func_8(iLocal_47[iVar0], 1, 1, 1);
				func_8(iLocal_55[iVar0], 1, 1, 1);
			}
			else
			{
				if ((func_9(Global_35, &(iLocal_47[iVar0]), 1, 1) > 20f && (!ENTITY::IS_ENTITY_ON_SCREEN(&(iLocal_47[iVar0])) || ENTITY::IS_ENTITY_OCCLUDED(&(iLocal_47[iVar0])))) || CAM::IS_SCREEN_FADED_OUT())
				{
					func_10(iLocal_47[iVar0]);
				}
				else
				{
					func_8(iLocal_47[iVar0], 1, 1, 1);
				}
				if ((func_9(Global_35, &(iLocal_55[iVar0]), 1, 1) > 20f && (!ENTITY::IS_ENTITY_ON_SCREEN(&(iLocal_55[iVar0])) || ENTITY::IS_ENTITY_OCCLUDED(&(iLocal_55[iVar0])))) || CAM::IS_SCREEN_FADED_OUT())
				{
					func_10(iLocal_55[iVar0]);
				}
				else
				{
					func_8(iLocal_55[iVar0], 1, 1, 1);
...
int func_2(int iParam0, bool bParam1, int iParam2, int iParam3)
{
	...
	{
		return func_11(bParam1, iParam2, iParam3);
	}
...
void func_6()
{
	...
	bVar0 = func_20(Global_35, iLocal_43, 1, 0);
	if (bVar0)
	{
		fLocal_31 = 250f;
		fLocal_32 = 150f;
	...
	switch (iLocal_18)
	{
		...
		case 2:
			...
			if (((((STREAMING::HAS_MODEL_LOADED(iLocal_38) && STREAMING::HAS_MODEL_LOADED(&(iLocal_39[0]))) && STREAMING::HAS_MODEL_LOADED(&(iLocal_39[1]))) && STREAMING::HAS_MODEL_LOADED(&(iLocal_39[2]))) && PED::_0x5E420FF293EE5472()) && func_24(&uLocal_44) > IntToFloat(iLocal_35))
			{
				iLocal_18 = 3;
			}
			break;
		case 3:
			...
			break;
		case 4:
			if (!iLocal_36 && !iLocal_37)
			{
				func_31();
			}
			else if (iLocal_36 && !iLocal_37)
			{
			...
			else
			{
				...
				{
					func_33(iVar9);
					func_34(&(iLocal_47[iVar9]), &(iLocal_55[iVar9]), 0, -1, 1);
					bVar10 = false;
					if (iVar9 == 0)
					{
					...
					if (func_7(&(iLocal_47[iVar9]), 0))
					{
						if (func_24(&uLocal_44) < fLocal_32 || bVar0)
						{
							if (bVar0)
							{
		...
		case 5:
			...
			{
				if (func_7(&(iLocal_47[iVar19]), 0))
				{
					if (func_9(Global_35, &(iLocal_47[iVar19]), 1, 1) > (fLocal_31 + 20f))
					{
						iVar18++;
					}
				}
...
float func_9(int iParam0, int iParam1, bool bParam2, int iParam3)
{
...
int func_11(bool bParam0, var uParam1, var uParam2)
{
...
int func_13(int iParam0, int iParam1)
{
	...
	if (func_40(iParam0, 1) || (iParam1 && func_40(iParam0, 2)))
	{
		return 1;
	}
	return 0;
...
int func_18()
{
	...
	if (func_45((Global_40.f_186[iVar0 /*12*/])->f_1) || (Global_40.f_186[iVar0 /*12*/])->f_4 < 1f)
	{
		return 0;
	}
	if (func_46(Global_35, (Global_40.f_186[iVar0 /*12*/])->f_1, ((Global_40.f_186[iVar0 /*12*/])->f_4 + 10f), 1, 1))
	{
		return 1;
	}
	return 0;
...
int func_19(int iParam0, int iParam1)
{
	...
	if (iParam1 == 255)
	{
		return func_47(&(Global_1099293->f_4), iVar0, 5);
	}
	if (iParam1 == func_48())
	{
		return func_47(&(Global_1099293->f_4), iVar0, 5);
	...
	{
		return func_47(&(((*Global_1097609)[iParam1 /*51*/])->f_4), iVar0, 5);
	}
	return 0;
}
...
int func_26(vector3 vParam0, var uParam3, var uParam4, int iParam5, bool bParam6, float fParam7, int iParam8, float fParam9, float fParam10, float fParam11)
{
	int iVar0;
	...
	switch (*uParam3)
	{
		case 0:
			...
			func_56(&(uParam3->f_1), uParam3->f_2, vParam0, iParam5, fParam7, iParam8, fParam9, fParam10, fParam11);
			if (!TASK::_0x1AC5A8AB50CFAA33(uParam3->f_1))
			{
			}
			else
			{
				func_57(&(uParam3->f_1), iParam5, vParam0);
				if (!func_45(uParam3->f_6))
				{
...
int func_27(vector3 vParam0, int iParam3, int iParam4, int iParam5)
{
	var uVar0[4];
	int iVar5[4];
...
void func_31()
{
	...
	{
		iLocal_47[iLocal_34] = func_60(iLocal_38, vLocal_28, 0, 1, 1, 0, 1, 1, 1, 0, 0);
		iLocal_34++;
...
void func_32(int iParam0)
{
	if (!CAM::IS_SPHERE_VISIBLE(vLocal_28, 5f))
	{
		iLocal_55[iLocal_34] = func_60(&(iLocal_39[iParam0]), vLocal_28, 0, 1, 1, 0, 1, 1, 1, 0, 0);
		TASK::_0x9DE63896B176EA94(&(iLocal_55[iLocal_34]), 0);
		iLocal_34++;
		if (iLocal_34 >= iLocal_33)
		{
			iLocal_37 = 1;
...
{
	if (!func_7(&(iLocal_47[iParam0]), 0))
	{
		return;
	}
	PED::SET_PED_CONFIG_FLAG(&(iLocal_47[iParam0]), 188, true);
	TASK::_0x9DE63896B176EA94(&(iLocal_47[iParam0]), 0);
	LAW::_0x819ADD5EF1742F47(&(iLocal_47[iParam0]), 1);
	PED::SET_PED_COMBAT_ATTRIBUTES(&(iLocal_47[iParam0]), 27, true);
	PED::_0x712B2C2B2471B493(&(iLocal_47[iParam0]), -1722884127);
	WEAPON::SET_PED_DROPS_WEAPONS_WHEN_DEAD(&(iLocal_47[iParam0]), false);
	WEAPON::_GIVE_WEAPON_TO_PED_2(&(iLocal_47[iParam0]), -1212426201, 100, true, false, 0, false, 0.5f, 1f, 752097756, false, 0f, false);
}
...
int func_36(var uParam0, int iParam1, int iParam2, int iParam3, bool bParam4)
{
	var uVar0;
	int iVar1;
	bool bVar2;
...
int func_46(int iParam0, vector3 vParam1, float fParam4, bool bParam5, bool bParam6)
{
	if (!ENTITY::DOES_ENTITY_EXIST(iParam0))
	{
		return 0;
...
int func_51(int iParam0, int iParam1, int iParam2, bool bParam3)
{
	...
	if ((Global_1900718->f_67 && !func_69(iParam0, 1)) || func_70(32768))
	{
		if (!func_69(iParam0, 262144) || !Global_1904612->f_8189)
		{
			return 0;
		}
	}
...
void func_56(var uParam0, int iParam1, vector3 vParam2, int iParam5, float fParam6, var uParam7, float fParam8, float fParam9, float fParam10)
{
	int iVar0;
	int iVar1;
...
int func_81(vector3 vParam0)
{
	...
	return func_82(vParam0, ((*Global_1892728)[iVar0 /*3*/])->f_1, ((*Global_1892728)[iVar0 /*3*/])->f_2, Global_1892728[iVar0 /*3*/], 4);
}

int func_82(struct<2> Param0, var uParam2, float fParam3, float fParam4, int iParam5, int iParam6)
{
	if (Param0 < fParam3)
	{
