...
void func_41(var uParam0, int iParam1)
{
	...
	if ((BUILTIN::VDIST(Global_36, 0f, 0f, 0f) <= 5f || func_61(&Global_1939168, 32768)) || func_61(&Global_1939168, 16777216))
	{
		return;
	}
...
int func_44(int iParam0)
{
	if (iParam0 == 0)
	{
		...
		if (STATS::CHAL_IS_GOAL_ACTIVE(-663946200, 1055032020))
		{
			switch (iLocal_25)
			{
				...
				case 127:
				case 135:
					STATS::CHAL_ADD_GOAL_PROGRESS_INT_BY_SCORE_ID(func_74(iLocal_25, 0), 1);
					break;
			}
		}
		if (func_10(func_67()))
	...
	else if (func_45() == -1)
	{
		func_78(iLocal_25);
		func_79(iLocal_25);
		if (!func_80(iLocal_25, 0))
		{
			return 0;
		}
	}
	else if (!func_81(iLocal_25))
	{
		return 0;
	}
	SCRIPTS::TERMINATE_THIS_THREAD();
...
int func_53(int iParam0, int iParam1, int iParam2, bool bParam3)
{
	...
	if (func_85(iParam0, &iVar0, &iVar1, 0, 0))
	{
		if (func_86(iParam1))
		{
			iVar0 = iParam1;
		...
		while (true)
		{
			if ((!func_83(iParam0) || func_84(iParam0)) || func_87(&Global_1896608))
			{
				func_88(&Global_1896608, 0);
			}
...
bool func_63()
{
	return func_61(&Global_1939168, 8192);
}
...
void func_68(int iParam0, int iParam1, int iParam2, bool bParam3, int iParam4, int iParam5)
{
	...
	else if ((func_58(iParam0) && func_82(iParam0, 16777216)) && !Global_1893575->f_9)
	{
...
int func_85(int iParam0, var uParam1, var uParam2, bool bParam3, bool bParam4)
{
	bool bVar0;
...
char* func_95(int iParam0, int iParam1, int iParam2, int iParam3, var uParam4, var uParam5, var uParam6)
{
	...
	{
		sVar0 = func_130(Global_1893575->f_162);
	}
...
int func_98(int iParam0)
{
	...
	iVar0 = 0;
	Var1 = { func_135(PLAYER::PLAYER_ID()) };
...
char* func_107(char* sParam0, int iParam1)
{
	...
	return func_136(MISC::_CREATE_VAR_STRING(10, "LITERAL_STRING", sParam0), iParam1);
}
...
{
	func_137((Global_1938932->f_5[iParam0 /*11*/])->f_6, 1);
	func_138((Global_1938932->f_5[iParam0 /*11*/])->f_6, 0);
...
void func_114(int iParam0)
{
	...
	if (func_86((Global_1915170->f_3[iParam0 /*447*/])->f_21) && func_140((Global_1915170->f_3[iParam0 /*447*/])->f_21))
	{
		func_141((Global_1915170->f_3[iParam0 /*447*/])->f_21, 0, 1, 0, 0);
	}
	...
	func_142((Global_1915170->f_3[iParam0 /*447*/])->f_9, 0);
	...
	else
	{
		...
		while (iVar0 < iVar1)
		{
			func_145(&((Global_1915170->f_3[iParam0 /*447*/])->f_318[iVar0 /*6*/]));
...
void func_121(int iParam0)
{
	...
	else
	{
		...
		while (iVar2 < iVar3)
		{
			func_145(&((Global_1051387->f_69[iParam0 /*76*/])->f_32[iVar2]));
	...
	if (VOLUME::_0x92A78D0BEDB332A3((Global_1051387->f_69[iParam0 /*76*/])->f_25) && func_159(iParam0, 2))
	{
...
var func_130(var uParam0, var uParam1, var uParam2, var uParam3, var uParam4, var uParam5, var uParam6, var uParam7)
{
...
char* func_136(char* sParam0, int iParam1)
{
...
{
	func_167(&((Global_1938932->f_5[iParam0 /*11*/])->f_7), iParam1);
}
...
int func_160()
{
	...
	if (!func_162(*Global_1051163) && Global_1572887->f_7 & 1 != 0)
	{
		return 1;
	}
	return 0;
