...
void func_3(var uParam0)
{
	...
	if (ENTITY::DOES_ENTITY_EXIST(&(uParam0->f_68[0])))
	{
...
int func_6(var uParam0)
{
	...
	{
		func_14(&(uParam0->f_138), uParam0->f_4, bVar0, bVar1, func_13(uParam0, 4));
	}
	switch (func_12(uParam0))
	{
		...
		case 1:
			if (func_16(&(uParam0->f_68), &(uParam0->f_80), 1, uParam0->f_4, 1f) > 0)
			{
				...
				while (iVar2 < 10)
				{
					if (ENTITY::DOES_ENTITY_EXIST(&(uParam0->f_68[iVar2])))
					{
						if (func_13(uParam0, 4))
						{
							func_17(&(uParam0->f_68[iVar2]), &(uParam0->f_68[iVar2]), 0);
							MISC::_0x553D67295DDD2309(&(uParam0->f_68[iVar2]));
						}
						MAP::_0x7563CBCA99253D1A(&(uParam0->f_68[iVar2]), 187984275);
						func_18(&(uParam0->f_138), ENTITY::GET_ENTITY_COORDS(&(uParam0->f_68[iVar2]), true, false));
						uParam0->f_137 = ENTITY::GET_ENTITY_MODEL(&(uParam0->f_68[iVar2]));
						func_15(uParam0, 2);
						return 0;
					}
					iVar2++;
		...
		case 3:
			if (_NAMESPACE49::_0x188313616D184213(uParam0->f_4, uParam0->f_137))
			{
				...
				if (func_13(uParam0, 4))
				{
					...
					while (iVar3 < 10)
					{
						if (ENTITY::DOES_ENTITY_EXIST(&(uParam0->f_68[iVar3])))
						{
...
void func_14(var uParam0, vector3 vParam1, bool bParam4, bool bParam5, bool bParam6)
{
	bool bVar0;
	float fVar1;
	float fVar2;
	...
	if (!func_25(-1733092640 /* GXTEntry: "Collector\'s Bag" */, 1))
	{
		return;
	}
	if (func_26(0))
	...
	if (!func_28(*Global_1199509) && MISC::GET_DISTANCE_BETWEEN_COORDS(*Global_1199509, vParam1, true) <= 5f)
	{
		bVar0 = true;
	}
	...
	fVar1 = func_29(PLAYER::GET_PLAYER_PED(PLAYER::PLAYER_ID()), vParam1, 1);
	fVar2 = 10f;
	...
	switch (uParam0->f_1)
	{
			...
			if (fVar1 < fVar2)
			{
				if (bParam5)
				{
					if (AUDIO::_0xD9130842D7226045("RDRO_Collectible_Sounds_Travelling_Saleswoman", 0))
					{
						...
						if (func_31(PLAYER::GET_PLAYER_PED(PLAYER::PLAYER_ID()), 0, 1, 0) != -862059856)
						{
							AUDIO::_0xDCF5BA95BBF0FABA(uParam0->f_5, "collectible_lure", vParam1, "RDRO_Collectible_Sounds_Travelling_Saleswoman", 0, 0, bParam6);
						}
						func_32(uParam0, 1);
					}
				}
		...
		case 2:
			...
			else if (func_34(&(uParam0->f_2)) >= 2f)
			{
				func_32(uParam0, 1);
			}
			break;
...
int func_16(var uParam0, var uParam1, int iParam2, vector3 vParam3, float fParam6)
{
	...
	uVar1 = func_35(uParam0, uParam1, iVar0, iParam2);
	func_36(iVar0);
	return uVar1;
}
...
{
	if (func_40(iParam0, iParam1) && (!bParam2 || &(Global_1070355->f_20795.f_353[iParam0 /*11*/])->f_1[iParam1] == SCRIPTS::GET_ID_OF_THIS_THREAD()))
	{
...
bool func_25(bool bParam0, int iParam1)
{
	...
	return func_46(bParam0, 0, 0, 0) >= iParam1;
}
...
float func_34(var uParam0)
{
	...
	return (func_51() - uParam0->f_1);
}

int func_35(var uParam0, var uParam1, int iParam2, int iParam3)
{
	int iVar0;
	int iVar1;
	int iVar2;
...
int func_37(int iParam0)
{
	...
	if (!DATAFILE::_0x603AC35FD4602C76(func_52()))
	{
		return 0;
	}
	Var0 = func_52();
...
int func_44(bool bParam0, int iParam1)
{
	...
	Var4.f_9 = -1591664384;
	if (func_54("ALL WEAPONS", &iVar1, &iVar2, -1591664384, 0))
	{
		bVar3 = false;
		while (bVar3 < iVar2)
		{
			if (!func_55(&Var4, bVar3, iVar1, iVar2))
			{
			}
			else if (!func_56(Var4.f_4))
			{
			}
...
bool func_45(bool bParam0)
{
	...
	iVar1 = func_59(bParam0);
	if (!iVar1 == 0)
	{
		iVar2 = func_60(&(Global_17173.f_54.f_644.f_1353.f_5), iVar1);
		if (iVar2 == -1)
		{
			return true;
		}
...
int func_46(bool bParam0, bool bParam1, bool bParam2, bool bParam3)
{
	...
	if (func_63(bParam0, joaat("default")) != 0)
	{
		iVar0 = INVENTORY::_0xE787F05DFC977BDE(func_64(bParam2), bParam0, bParam3);
	}
	else
	{
		Var3 = { func_65(bParam0, bParam2) };
		if (!INVENTORY::_0xB881CA836CC4B6D4(&Var3))
		{
			return 0;
		}
		iVar0 = INVENTORY::_0xC97E0D2302382211(func_64(bParam2), &Var3, bParam3);
	}
	return iVar0;
}
...
int func_53(bool bParam0, int iParam1)
{
	...
	{
		func_70(bParam0, &uVar1, &uVar2);
		return uVar2;
	}
	return 0;
}

int func_54(char* sParam0, int iParam1, bool bParam2, int iParam3, bool bParam4)
{
	*iParam1 = INVENTORY::_0x80D78BDC9D88EF07(func_64(bParam4), sParam0, iParam3, bParam2);
	if (*iParam1 >= 0)
	{
		return 1;
	}
...
int func_55(int iParam0, bool bParam1, int iParam2, bool bParam3)
{
	if (iParam2 < 0)
	{
		return 0;
...
int func_62(bool bParam0, bool bParam1)
{
	...
	Var0 = { func_71(bParam0, -1591664384, -1591664384, -1591664384, 0, 0, 0) };
	if (bParam1)
	{
		func_73(&Var0, func_72(0));
	}
	if (!func_74(&Var0, &iVar14, &uVar15, 0))
	{
		return 0;
	}
	func_57(iVar14);
...
struct<4> func_65(bool bParam0, bool bParam1)
{
	struct<5> Var0;

	Var0 = { func_75(bParam0, bParam1, 0) };
	return func_76(bParam0, Var0, Var0.f_4, bParam1);
}
...
int func_69(bool bParam0, int iParam1)
{
	if (!func_42(bParam0, 0))
	{
		return func_78(func_77(bParam0), iParam1);
	}
	if (iParam1 == 0)
	{
		return 0;
...
void func_70(bool bParam0, var uParam1, var uParam2)
{
	*uParam1 = 0;
	*uParam2 = 0;
	switch (bParam0)
...
struct<14> func_71(bool bParam0, int iParam1, int iParam2, int iParam3, int iParam4, int iParam5, int iParam6)
{
	struct<14> Var0;
...
struct<4> func_72(bool bParam0)
{
	...
	if (iVar0 == 2)
	{
		...
		{
			Global_1270479->f_4 = { func_76(923904168, func_79(bParam0), -740156546, bParam0) };
		}
	...
	else if (iVar0 == 3)
	{
		...
		{
			Global_1270479->f_16 = { func_76(923904168, func_79(bParam0), -740156546, 0) };
		}
		return Global_1270479->f_16;
	}
	return func_76(923904168, func_79(bParam0), -740156546, 0);
}

void func_73(var uParam0, struct<4> Param1)
{
...
int func_74(var uParam0, int iParam1, bool bParam2, bool bParam3)
{
	*iParam1 = INVENTORY::_0x640F890C3E5A3FFD(func_64(bParam3), uParam0, bParam2);
	if (*iParam1 >= 0)
	{
		return 1;
	}
...
struct<5> func_75(bool bParam0, bool bParam1, int iParam2)
{
	struct<5> Var0;
	int iVar5;
	struct<10> Var6;
	...
	Var0 = { func_79(bParam1) };
	Var0.f_4 = 1084182731;
	iVar5 = func_43(bParam0);
	switch (iVar5)
	{
		case joaat("clothing"):
			...
			break;
		case joaat("weapon"):
			Var0 = { func_72(bParam1) };
			if (iParam2 && func_80(bParam0, 1))
			{
				Var6.f_9 = -1591664384;
				if (!func_81(bParam0, &Var0, 1728382685 /* GXTEntry: "Right" */, 0, 0))
				{
					Var0.f_4 = 1728382685; /* GXTEntry: "Right" */
				}
				else if (!func_81(bParam0, &Var0, -649335959 /* GXTEntry: "Left" */, 0, 0))
				{
					Var0.f_4 = -649335959; /* GXTEntry: "Left" */
				}
				else if (func_82(bParam0, &Var6, 1728382685 /* GXTEntry: "Right" */))
				{
					Var0.f_4 = 1728382685; /* GXTEntry: "Right" */
				}
				else
		...
		case -1650247667:
			Var0.f_4 = -1591664384;
			Var0 = { func_83(bParam1) };
			switch (func_58(bParam0))
			{
				case -1070622585:
					Var0.f_4 = -6796437;
					break;
		...
		case joaat("dog"):
			...
			else if (func_84(bParam0, -1653629781))
			{
				Var0 = { func_76(1384535894, Var0, 1784584921, bParam1) };
...
struct<4> func_76(bool bParam0, var uParam1, int iParam2, bool bParam3, var uParam4, bool bParam5, bool bParam6)
{
	struct<4> Var0;
	...
	INVENTORY::_0x886DFD3E185C8A89(func_64(bParam6), &uParam1, bParam0, bParam5, &Var0);
	return Var0;
}
...
struct<4> func_79(bool bParam0)
{
	...
	if (Global_1572887->f_13 == 0)
	{
		...
		if (iVar0 == 2)
		{
			...
			{
				*Global_1270479 = { func_76(joaat("character"), func_87(), -1591664384, bParam0) };
			}
		...
		else if (iVar0 == 3)
		{
			...
			{
				Global_1270479->f_12 = { func_76(joaat("character"), func_87(), -1591664384, 0) };
			}
			return Global_1270479->f_12;
		}
	}
	return func_76(joaat("character"), func_87(), -1591664384, bParam0);
}

int func_80(bool bParam0, bool bParam1)
{
	if (func_58(bParam0) == 1779021115)
	{
		return 0;
	}
...
bool func_81(bool bParam0, var uParam1, int iParam2, int iParam3, int iParam4)
{
	return func_89(bParam0, *uParam1, iParam2, iParam3, 1, iParam4) > 0;
}

int func_82(bool bParam0, int iParam1, int iParam2)
{
	var uVar0;

	if (func_90(bParam0, &uVar0, iParam1, iParam2))
	{
...
struct<4> func_83(bool bParam0)
{
	...
	if (iVar0 == 2 || iVar0 == 3)
	{
		...
		{
			Global_1270479->f_8 = { func_76(271701509, func_79(bParam0), 12999093, 0) };
		}
		return Global_1270479->f_8;
	}
	return func_76(271701509, func_79(bParam0), 12999093, 0);
}
...
int func_84(bool bParam0, int iParam1)
{
	...
	while (iVar2 < iVar3)
	{
		...
		{
			if (func_91(bParam0, iParam1, bVar0))
			{
				return 1;
			}
		}
...
bool func_85(var uParam0, var uParam1, bool bParam2, int iParam3, int iParam4, bool bParam5, bool bParam6, int iParam7)
{
	return func_92(&uParam0, iParam4, bParam5, bParam6, iParam7);
}
...
bool func_88()
{
	return (func_93(-1185145312 /* GXTEntry: "Upgraded Off-Hand Holster" */, 0, 0, 0) > 0 && func_94(func_76(889965687 /* GXTEntry: "Wardrobe" */, func_79(1), 1034665895, 1), -234132662, 1, -1) != 0);
}

int func_89(bool bParam0, struct<4> Param1, int iParam5, bool bParam6, bool bParam7, bool bParam8)
{
	int iVar0;
	struct<4> Var1;
	...
	if (!bParam7 && func_63(bParam0, joaat("default")) == 0)
	{
		bParam7 = true;
	}
	iVar0 = 0;
	if (bParam7)
	{
		Var1 = { func_76(bParam0, Param1, iParam5, bParam6) };
		if (!INVENTORY::_0xB881CA836CC4B6D4(&Var1))
		{
			return 0;
		}
		iVar0 = INVENTORY::_0xC97E0D2302382211(func_64(bParam6), &Var1, bParam8);
	}
	else
	{
		iVar0 = INVENTORY::_0xE787F05DFC977BDE(func_64(bParam6), bParam0, bParam8);
	}
	return iVar0;
}

int func_90(bool bParam0, int iParam1, int iParam2, int iParam3)
{
	int iVar0;

	iVar0 = func_64(0);
	*iParam1 = { func_76(bParam0, func_72(0), iParam3, 0) };
...
int func_93(bool bParam0, bool bParam1, bool bParam2, bool bParam3)
{
	if (func_95(bParam0) && !bParam2)
	{
		return WEAPON::GET_PED_AMMO_BY_TYPE(Global_35, bParam0);
	}
	return INVENTORY::_0xE787F05DFC977BDE(func_64(bParam1), bParam0, bParam3);
}

int func_94(var uParam0, int iParam1, int iParam2, int iParam3, bool bParam4, bool bParam5, int iParam6)
{
...
int func_97(int iParam0, bool bParam1, int iParam2, bool bParam3, int iParam4)
{
	...
	if (iParam4 == -1)
	{
		iParam4 = func_64(bParam3);
	}
	if (!INVENTORY::_0x22E590F108289A9D(iParam4, iParam0, bParam1, &uVar0))
	{
		return 0;
	}
	if (!func_92(&uVar0, iParam2, bParam3, 0, iParam4))
	{
		return 0;
	}
	return 1;
