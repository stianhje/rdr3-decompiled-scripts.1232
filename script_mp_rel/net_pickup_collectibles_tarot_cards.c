...
int func_44(int iParam0, int iParam1)
{
	...
	if (func_54("ALL WEAPONS", &iVar1, &iVar2, -1591664384, 0))
	{
		...
		while (iVar3 < iVar2)
		{
			if (!func_55(&Var4, iVar3, iVar1, iVar2))
			{
			}
...
int func_46(int iParam0, int iParam1, bool bParam2, int iParam3)
{
	...
	if (func_63(iParam0, -455129387) != 0)
	{
		iVar0 = INVENTORY::_0xE787F05DFC977BDE(func_64(bParam2), iParam0, iParam3);
	}
	else
	{
		Var3 = { func_65(iParam0, bParam2) };
		if (!INVENTORY::_0xB881CA836CC4B6D4(&Var3))
		{
			return 0;
		}
		iVar0 = INVENTORY::_0xC97E0D2302382211(func_64(bParam2), &Var3, iParam3);
	}
	return iVar0;
}
...
int func_53(int iParam0, int iParam1)
{
	...
	{
		func_70(iParam0, &uVar1, &uVar2);
		return uVar2;
	}
	return 0;
}

int func_54(char* sParam0, var uParam1, var uParam2, int iParam3, bool bParam4)
{
	*uParam1 = INVENTORY::_0x80D78BDC9D88EF07(func_64(bParam4), sParam0, iParam3, uParam2);
	if (*uParam1 >= 0)
	{
		return 1;
	}
...
int func_62(int iParam0, bool bParam1)
{
	...
	Var0 = { func_71(iParam0, -1591664384, -1591664384, -1591664384, 0, 0, 0) };
	if (bParam1)
	{
		func_73(&Var0, func_72(0));
	}
	if (!func_74(&Var0, &iVar14, &iVar15, 0))
	{
		return 0;
	}
	func_57(iVar14);
...
struct<4> func_65(int iParam0, bool bParam1)
{
	struct<5> Var0;

	Var0 = { func_75(iParam0, bParam1, 0) };
	return func_76(iParam0, Var0, Var0.f_4, bParam1);
}
...
int func_69(int iParam0, int iParam1)
{
	if (!func_42(iParam0, 0))
	{
		return func_78(func_77(iParam0), iParam1);
	}
	if (iParam1 == 0)
	{
		return 0;
...
void func_70(int iParam0, var uParam1, var uParam2)
{
	*uParam1 = 0;
	*uParam2 = 0;
	switch (iParam0)
...
struct<14> func_71(int iParam0, int iParam1, int iParam2, int iParam3, int iParam4, int iParam5, int iParam6)
{
	struct<14> Var0;
...
int func_74(var uParam0, var uParam1, int iParam2, bool bParam3)
{
	*uParam1 = INVENTORY::_0x640F890C3E5A3FFD(func_64(bParam3), uParam0, iParam2);
	if (*uParam1 >= 0)
	{
		return 1;
	}
...
struct<5> func_75(int iParam0, bool bParam1, int iParam2)
{
	struct<5> Var0;
	int iVar5;
	struct<10> Var6;
	...
	switch (iVar5)
	{
		...
		case -427144552:
			...
			if (iParam2 && func_80(iParam0, 1))
			{
				Var6.f_9 = -1591664384;
				if (!func_81(iParam0, &Var0, 1728382685, 0, 0))
				{
					Var0.f_4 = 1728382685;
				}
				else if (!func_81(iParam0, &Var0, -649335959, 0, 0))
				{
					Var0.f_4 = -649335959;
				}
				else if (func_82(iParam0, &Var6, 1728382685))
				{
					Var0.f_4 = 1728382685;
				}
				else
		...
		case -2130996531:
		case -1962314949:
			if (func_84(iParam0, -1823706425))
			{
				Var0 = { func_76(-1838434463, Var0, 1084182731, bParam1) };
				Var0.f_4 = INVENTORY::_0x6452B1D357D81742(iParam0, -1838434463);
			}
			else if (func_84(iParam0, -1483207246))
			{
				Var0 = { func_76(889965687, Var0, 1034665895, bParam1) };
				Var0.f_4 = INVENTORY::_0x6452B1D357D81742(iParam0, 889965687);
			}
			...
			else if (func_84(iParam0, -1653629781))
			{
...
struct<4> func_76(int iParam0, var uParam1, var uParam2, var uParam3, var uParam4, int iParam5, bool bParam6)
{
	...
	INVENTORY::_0x886DFD3E185C8A89(func_64(bParam6), &uParam1, iParam0, iParam5, &Var0);
	return Var0;
}
...
struct<4> func_79(bool bParam0)
{
	...
	if (Global_1572887->f_13 == 0)
	{
		...
		if (iVar0 == 2)
		{
			...
			{
				*Global_1270479 = { func_76(1328661203, func_87(), -1591664384, bParam0) };
			}
		...
		else if (iVar0 == 3)
		{
			...
			{
				Global_1270479->f_12 = { func_76(1328661203, func_87(), -1591664384, 0) };
			}
			return Global_1270479->f_12;
		}
	}
	return func_76(1328661203, func_87(), -1591664384, bParam0);
}

int func_80(int iParam0, bool bParam1)
{
	if (func_58(iParam0) == 1779021115)
	{
		return 0;
	}
...
bool func_81(int iParam0, var uParam1, int iParam2, bool bParam3, int iParam4)
{
	return func_89(iParam0, *uParam1, iParam2, bParam3, 1, iParam4) > 0;
}
...
int func_82(int iParam0, var uParam1, int iParam2)
{
	...
	if (func_90(iParam0, &uVar0, uParam1, iParam2))
	{
...
int func_84(int iParam0, int iParam1)
{
	...
	while (iVar2 < iVar3)
	{
		...
		{
			if (func_91(iParam0, iParam1, iVar0))
			{
				return 1;
			}
		}
...
bool func_85(var uParam0, var uParam1, var uParam2, var uParam3, var uParam4, bool bParam5, bool bParam6, int iParam7)
{
	return func_92(&uParam0, uParam4, bParam5, bParam6, iParam7);
}
...
bool func_88()
{
	return (func_93(-1185145312, 0, 0, 0) > 0 && func_94(func_76(889965687, func_79(1), 1034665895, 1), -234132662, 1, -1) != 0);
}

int func_89(int iParam0, struct<4> Param1, int iParam5, bool bParam6, bool bParam7, int iParam8)
{
	int iVar0;
	struct<4> Var1;
	...
	if (!bParam7 && func_63(iParam0, -455129387) == 0)
	{
		bParam7 = true;
	}
	iVar0 = 0;
	if (bParam7)
	{
		Var1 = { func_76(iParam0, Param1, iParam5, bParam6) };
		if (!INVENTORY::_0xB881CA836CC4B6D4(&Var1))
		{
			return 0;
		}
		iVar0 = INVENTORY::_0xC97E0D2302382211(func_64(bParam6), &Var1, iParam8);
	}
	else
	{
		iVar0 = INVENTORY::_0xE787F05DFC977BDE(func_64(bParam6), iParam0, iParam8);
	}
	return iVar0;
}

int func_90(int iParam0, var uParam1, var uParam2, int iParam3)
{
	int iVar0;

	iVar0 = func_64(0);
	*uParam1 = { func_76(iParam0, func_72(0), iParam3, 0) };
...
int func_92(var uParam0, var uParam1, bool bParam2, bool bParam3, int iParam4)
{
...
int func_93(int iParam0, bool bParam1, bool bParam2, int iParam3)
{
	if (func_95(iParam0) && !bParam2)
	{
		return WEAPON::GET_PED_AMMO_BY_TYPE(Global_35, iParam0);
	}
	return INVENTORY::_0xE787F05DFC977BDE(func_64(bParam1), iParam0, iParam3);
}

int func_94(var uParam0, var uParam1, var uParam2, var uParam3, int iParam4, bool bParam5, int iParam6)
{
	return func_96(&uParam0, iParam4, bParam5, iParam6);
}
...
int func_96(var uParam0, var uParam1, bool bParam2, int iParam3)
{
	struct<10> Var0;

	Var0.f_9 = -1591664384;
	if (func_97(uParam0, uParam1, &Var0, bParam2, iParam3))
	{
		return Var0.f_4;
	}
	return 0;
...
int func_97(var uParam0, var uParam1, var uParam2, bool bParam3, int iParam4)
{
	var uVar0;
	...
	if (!func_92(&uVar0, uParam2, bParam3, 0, iParam4))
	{
		return 0;
	}
	return 1;
