...
void func_13(var uParam0, var uParam1, var uParam2, var uParam3, var uParam4)
{
	...
	iVar19 = func_30(&uVar18, Local_107.f_1, Local_107.f_2);
	if (uVar18 || iVar19 == -1)
	{
		return;
	}
...
int func_184()
{
	...
	iVar0 = 1;
	if (iVar0 && !UNLOCK::_UNLOCK_IS_UNLOCKED(Local_107.f_14))
	{
		return 0;
	}
	return 1;
...
void func_188()
{
	...
	if (PED::_0x34D6AC1157C8226C(PLAYER::GET_PLAYER_PED(PLAYER::PLAYER_ID()), 1545192181) && ENTITY::HAS_ANIM_EVENT_FIRED(PLAYER::GET_PLAYER_PED(PLAYER::PLAYER_ID()), -693272019))
	{
		func_212(1);
		func_213(1);
	}
...
void func_208(int iParam0)
{
	...
	switch (iParam0->f_9)
	{
		case -773758976:
			...
			if (iParam0->f_10 == PLAYER::PLAYER_ID() || iVar0)
			{
				func_211();
				func_221();
				func_231();
...
var func_254(vector3 vParam0, vector3 vParam3, vector3 vParam6, int iParam9, var uParam10, var uParam11)
{
	var uVar0;
	int iVar1;
	int iVar2;
