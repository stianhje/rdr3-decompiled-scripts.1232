...
void func_13(var uParam0, var uParam1, var uParam2, var uParam3, var uParam4)
{
	...
	iVar19 = func_30(&uVar18, Local_478.f_1, Local_478.f_2);
	if (uVar18 || iVar19 == -1)
	{
		return;
	}
...
void func_41()
{
	...
	iVar0 = (Global_1184672->f_231.f_1066[Local_478.f_12 /*17*/])->f_5;
...
bool func_90(int iParam0)
{
	...
	return (func_156(iParam0) && ((*Global_1123778)[iParam0 /*27*/])->f_18.f_1 != 0);
}
...
int func_110(int iParam0, int iParam1, bool bParam2)
{
	...
	if (bParam2)
	{
		func_142(&(((*Global_1126840)[iVar1 /*83*/])->f_70.f_1), 1);
	}
	else
	{
		func_164(&(((*Global_1126840)[iVar1 /*83*/])->f_70.f_1), 1);
	}
	return 1;
}
...
int func_152(vector3 vParam0, var uParam3, var uParam4, int iParam5, int iParam6, bool bParam7)
{
	var uVar0;
...
void func_165(struct<2> Param0)
{
	...
	{
		STATS::_0x99230691875FC218(func_172(Param0), func_174(Param0), Global_36);
	}
}
...
int func_171()
{
	...
	iVar0 = 1;
	if (iVar0 && !UNLOCK::_UNLOCK_IS_UNLOCKED(Local_478.f_14))
	{
		return 0;
	}
	return 1;
