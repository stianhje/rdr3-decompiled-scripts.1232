...
void func_41(var uParam0)
{
	...
	func_332(uParam0, 1);
	func_332(uParam0, 2);
	aggregate_func_7000(uParam0, 1, 61213);
}
...
void func_122(var uParam0)
{
	...
	{
		TASK::_TASK_START_SCENARIO_IN_PLACE(uParam0->f_2421.f_4, TASK::_0xA92450B5AE687AAF(aggregate_func_983(uParam0->f_3)), 0, 0, 0, 0.2f, 0);
	}
...
bool func_316(var uParam0, int iParam1, int iParam2, vector3 vParam3, vector3 vParam6, int iParam9, int iParam10, int iParam11)
{
	...
	{
		if (!func_726(&(uParam0->f_4), iParam1, iParam2, aggregate_func_6464(iParam2), uParam0->f_1767, 0))
		{
		}
	}
	...
	aggregate_func_4242(&(uParam0->f_4), 137194);
	aggregate_func_4242(&(uParam0->f_4), 137231);
	aggregate_func_4932(&(uParam0->f_4), 137259);
	aggregate_func_4932(&(uParam0->f_4), 137794);
...
int func_332(var uParam0, int iParam1)
{
	...
	{
		return aggregate_func_6708(uParam0, iParam1, 138599, 138630, 138717, 140315);
	}
	else
	{
		iVar0 = 0;
		...
		return aggregate_func_6708(uParam0, iParam1, 140613, 140665, 128371, 30857);
	}
	return 0;
}
...
bool func_333(var uParam0)
{
	if (aggregate_func_4251() == -1)
	{
		if (aggregate_func_4455((Global_1915170->f_3[uParam0->f_3 /*447*/])->f_21) && aggregate_func_1545((Global_1915170->f_3[uParam0->f_3 /*447*/])->f_21, 0))
		{
			if (!aggregate_func_2737(aggregate_func_3379((Global_1915170->f_3[uParam0->f_3 /*447*/])->f_21), uParam0->f_3))
			{
				return false;
			}
		}
...
{
	if (aggregate_func_2852(bParam1, 210646929))
	{
		if (bParam2)
		{
	...
	if (aggregate_func_2852(bParam1, 678620317))
	{
		if (bParam2)
		{
...
int func_343(var uParam0)
{
	...
	else if ((aggregate_func_5073(&uVar1) && (uParam0->f_43 == 0 || uParam0->f_43 >= 3)) && MISC::GET_RANDOM_INT_IN_RANGE(0, 4) != 0)
	{
...
int func_403(var uParam0)
{
	...
	func_798(&Local_23);
	aggregate_func_30(Global_35, Local_23.f_6, Local_23.f_9, 2, 1073741824 /* Float: 2f */);
	return 1;
}
...
void func_696(var uParam0)
{
	...
	if (!MISC::IS_BIT_SET(uParam0->f_2371.f_9, 1))
	{
		...
		{
			aggregate_func_4358(uParam0, 194785);
			aggregate_func_4358(uParam0, 195705);
			aggregate_func_4358(uParam0, 196305);
			aggregate_func_4358(uParam0, 196599);
			aggregate_func_4358(uParam0, 196802);
				...
				else if ((&uParam0->f_1[iVar0 /*3*/] != 1733464892 && &uParam0->f_1[iVar0 /*3*/] != -230310728) && &uParam0->f_1[iVar0 /*3*/] != 1326838792)
				{
					...
					else
					{
						...
						if (aggregate_func_5367(iVar0, bVar4))
						{
							...
							iVar0++;
							aggregate_func_6034(&(Global_1951131->f_1776), uParam1, Var5);
							if (*uParam1 != 1)
							{
							...
							bVar4 = aggregate_func_4299(Var5, (Global_1951131->f_81[iVar3 /*12*/])->f_9, 1, -1);
							iVar0 = 0;
							while (iVar0 < 39)
							{
								bVar15 = aggregate_func_4299(Var5, (Global_1951131->f_81[iVar0 /*12*/])->f_9, 1, -1);
								bVar2 = (&uParam0->f_1[iVar0 /*3*/] == 0 || aggregate_func_5024(&(uParam0->f_1[iVar0 /*3*/]), 1));
...
int func_1639(var uParam0, bool bParam1, int iParam2)
{
	...
	if (aggregate_func_2836(&Var71, &iVar55, &iVar56, 1))
	{
		...
		while (bVar46 < iVar56)
		{
			if (aggregate_func_2840(&Var57, bVar46, iVar55, iVar56))
			{
				bVar49 = false;
				iVar47 = 0;
				while (iVar47 < iVar42)
