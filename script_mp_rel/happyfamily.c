...
bool func_66(int iParam0)
{
	...
	return ((((*Global_1887327)[iParam0 /*36*/])->f_21 == 1 || ((*Global_1887327)[iParam0 /*36*/])->f_21 == 2) && !func_93(iParam0));
}
...
void func_69(int iParam0, int iParam1, int iParam2, bool bParam3, int iParam4, int iParam5)
{
	...
	sVar1 = func_95(iParam0, iParam1, iParam2, iParam4, iParam5, bParam3, &uVar0);
	...
	if (func_96(iParam4))
	{
		iVar3 = func_98(iParam4);
	}
	if (uVar0 && bParam3)
	{
		sVar2 = func_100(func_99(iParam2));
	}
	else if ((func_101(iParam1, 2) || func_102(iParam4, 2)) && !Global_1893575->f_9)
	{
	...
	{
		iVar4 = func_104(func_103());
		iVar5 = func_105(func_103());
		if (iVar5 < 10)
		{
		...
		if (!MISC::_SHOULD_USE_24_HOUR_CLOCK())
		{
			...
			{
				fVar7 = func_106(fVar7);
				sVar8 = "TIME_AND_TEMP_F";
			}
			IntToString(&sVar10, BUILTIN::ROUND(fVar7), 8);
			sVar2 = MISC::_CREATE_VAR_STRING(674, sVar8, iVar4, func_107(&sVar6, 109029619), sVar9, func_107(&sVar10, 109029619));
		}
		else
		{
			...
			IntToString(&sVar10, BUILTIN::ROUND(fVar7), 8);
			sVar2 = MISC::_CREATE_VAR_STRING(162, sVar8, iVar4, func_107(&sVar6, 109029619), func_107(&sVar10, 109029619));
		}
		Global_1893575->f_9 = 0;
	}
	Global_1938075->f_145 = func_108(sVar1, sVar2, 4000, 0, 0, 0, 0, 1);
}
...
void func_71(int iParam0, bool bParam1)
{
	...
	func_21(iParam0, 32);
	func_110(Global_1939168, 16384);
	func_112(func_111(-1532769513, -36357794), 1);
	switch (func_9(iParam0))
	{
		case 0:
		case 2:
		case 11:
			func_112(func_111(-1532769513, 213519508), 1);
			break;
		case 1:
		case 5:
		case 6:
		case 7:
		case 12:
			func_112(func_111(-1532769513, 242571679), 1);
			break;
		case 3:
		case 10:
			func_112(func_111(-1532769513, 1349449307), 1);
			break;
		case 4:
		case 9:
			func_112(func_111(-1532769513, 1140362070), 1);
			break;
		case 8:
			func_112(func_111(-1532769513, -172330899), 1);
			break;
		case 13:
		case 14:
		case 15:
		case 16:
			func_112(func_111(-1532769513, -910218296), 1);
			break;
	}
	switch (iParam0)
	{
...
int func_81(int iParam0, bool bParam1)
{
	...
	if (func_86(iParam0, &iVar0, &iVar1, 0, 0))
	{
		...
		while (true)
		{
			if (!func_115(Global_1896608->f_1, 16))
			{
				func_116(Global_1896608->f_1, 0);
			}
			Global_1896608->f_1++;
			iVar2++;
...
int func_82(int iParam0)
{
	...
	while (iVar0 < 39)
	{
		if (func_117(iVar0) || func_118(iVar0))
		{
		}
		else
		{
...
void func_92(int iParam0, bool bParam1, float fParam2, bool bParam3, bool bParam4, float fParam5, int iParam6, bool bParam7)
{
	...
	if (func_128(iParam0))
	{
		...
		if (bParam3)
		{
			func_129(iParam0, fParam2, 1, iParam6);
		}
		else if (bParam1)
		{
			if (bParam4)
...
char* func_95(int iParam0, int iParam1, int iParam2, int iParam3, var uParam4, var uParam5, var uParam6)
{
	char* sVar0;

	if (!MISC::IS_STRING_NULL_OR_EMPTY(&(Global_1893575->f_162)))
	{
		sVar0 = func_137(Global_1893575->f_162);
	}
	if (MISC::IS_STRING_NULL_OR_EMPTY(sVar0) && uParam4)
	{
		sVar0 = func_139(func_138(Global_36));
	}
...
int func_98(int iParam0)
{
	...
	iVar0 = 0;
	Var1 = { func_142(PLAYER::PLAYER_ID()) };
...
char* func_107(char* sParam0, int iParam1)
{
	if (iParam1 == 109029619)
	{
		return MISC::_CREATE_VAR_STRING(10, "LITERAL_STRING", sParam0);
	}
	return func_143(MISC::_CREATE_VAR_STRING(10, "LITERAL_STRING", sParam0), iParam1);
}

var func_108(char* sParam0, char* sParam1, int iParam2, int iParam3, int iParam4, int iParam5, int iParam6, int iParam7)
{
	struct<4> Var0;
	vector3 vVar13;
	var uVar16;
...
struct<2> func_111(int iParam0, int iParam1)
{
	struct<2> Var0;
...
{
	func_144((Global_1938932->f_5[iParam0 /*11*/])->f_6, 1);
	func_145((Global_1938932->f_5[iParam0 /*11*/])->f_6, 0);
...
void func_114(int iParam0)
{
	...
	if (func_87((Global_1915170->f_3[iParam0 /*447*/])->f_21) && func_147((Global_1915170->f_3[iParam0 /*447*/])->f_21))
	{
		func_148((Global_1915170->f_3[iParam0 /*447*/])->f_21, 0, 1, 0, 0);
	}
	...
	func_149((Global_1915170->f_3[iParam0 /*447*/])->f_9, 0);
	...
	else
	{
		...
		while (iVar0 < iVar1)
		{
			func_152(&((Global_1915170->f_3[iParam0 /*447*/])->f_318[iVar0 /*6*/]));
...
void func_121(int iParam0)
{
	...
	if (func_160(iParam0, 16384) && !bVar0)
	{
	...
	else
	{
		...
		while (iVar2 < iVar3)
		{
			func_152(&((Global_1051387->f_69[iParam0 /*76*/])->f_32[iVar2]));
	...
	if (VOLUME::_0x92A78D0BEDB332A3((Global_1051387->f_69[iParam0 /*76*/])->f_25) && func_166(iParam0, 2))
	{
...
void func_129(int iParam0, float fParam1, int iParam2, int iParam3)
{
	if (func_128(iParam0))
	{
...
char* func_137(var uParam0, var uParam1, var uParam2, var uParam3, var uParam4, var uParam5, var uParam6, var uParam7)
{
...
{
	func_175(&((Global_1938932->f_5[iParam0 /*11*/])->f_7), iParam1);
}
...
{
	return func_186((Global_1051387->f_69[iParam0 /*76*/])->f_51, iParam1);
}
...
int func_168()
{
	...
	if (!func_170(*Global_1051163) && Global_1572887->f_7 & 1 != 0)
	{
		return 1;
	}
	return 0;
...
int func_172(vector3 vParam0, int iParam3)
{
	...
	func_189(iParam3, &vVar0, &Var3, &fVar6);
	if (func_190(vParam0, vVar0, Var3, Var3.f_1, fVar6))
	{
		return 1;
	}
	return 0;
...
bool func_190(vector3 vParam0, vector3 vParam3, float fParam6, float fParam7, float fParam8)
{
	vector3 vVar0;
	struct<2> Var3;
	float fVar6;
