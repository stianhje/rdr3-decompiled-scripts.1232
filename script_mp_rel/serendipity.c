...
void __EntryFunction__()
{
	...
	fLocal_16 = 1f;
	iLocal_51 = 20000;
	iLocal_54 = vScriptParam_0.x;
	iLocal_52 = vScriptParam_0.z;
	iLocal_56 = 0;
	...
	while (func_4())
	{
		...
		{
			iLocal_53 = 0;
			func_5(iLocal_54, &iLocal_52);
			switch (iLocal_52)
			{
				case 0:
					if (Global_1901929->f_1.f_24 > 0)
					{
						iLocal_55 = (MISC::GET_GAME_TIMER() + Global_1901929->f_1.f_24);
						iLocal_52 = 1;
					}
					else
					{
				...
				case 1:
					if (!func_1() || iLocal_55 < MISC::GET_GAME_TIMER())
					{
						iLocal_56 = 0;
						iLocal_52 = 2;
					}
				...
				case 2:
					...
					func_7();
					func_8();
					if (func_10(func_9(iLocal_54)))
					{
						func_11(func_9(iLocal_54), 4);
					}
					LAW::_0x9BBDCB8DF789EBC1(PLAYER::PLAYER_ID(), func_12(iLocal_54));
					Global_1896608 = -1;
					iLocal_55 = (iLocal_51 + MISC::GET_GAME_TIMER());
					iLocal_52 = 3;
					break;
				
				case 3:
					if (func_13() || iLocal_55 < MISC::GET_GAME_TIMER())
					{
						func_14(iLocal_54);
						iLocal_55 = (iLocal_51 + MISC::GET_GAME_TIMER());
						iLocal_52 = 4;
				...
				case 4:
					if (func_15(iLocal_54) || iLocal_55 < MISC::GET_GAME_TIMER())
					{
						func_16(iLocal_54);
						iLocal_55 = (MISC::GET_GAME_TIMER() + iLocal_51);
						iLocal_52 = 5;
					}
					break;
				
				case 5:
					if (func_17(iLocal_54) || iLocal_55 < MISC::GET_GAME_TIMER())
					{
						func_18(iLocal_54);
						iLocal_55 = (iLocal_51 + MISC::GET_GAME_TIMER());
						iLocal_52 = 7;
				...
				case 7:
					if (func_10(func_9(iLocal_54)))
					{
						if (func_19(func_9(iLocal_54), 4) && !iLocal_55 < MISC::GET_GAME_TIMER())
						{
						}
						else
						{
							if (func_20(iLocal_54) || iLocal_55 < MISC::GET_GAME_TIMER())
							{
								func_21(iLocal_54, 4);
								iLocal_55 = (iLocal_51 + MISC::GET_GAME_TIMER());
								iLocal_52 = 8;
							...
							func_36(iLocal_54, Global_1896662);
							iLocal_52 = 11;
							Jump @813; //curOff = 639
							func_37(iLocal_54);
							func_21(iLocal_54, 8);
							...
							iLocal_52 = 12;
							Jump @813; //curOff = 689
							if (func_40(iLocal_54))
							{
								iLocal_53 = MISC::GET_GAME_TIMER() + 1000;
							}
							func_41(Global_1896662, iLocal_54);
							func_42(iLocal_54);
							func_21(iLocal_54, 8);
							if (func_43())
							{
							...
							PATHFIND::SET_AMBIENT_PED_RANGE_MULTIPLIER_THIS_FRAME(((*Global_1887327)[iLocal_54 /*36*/])->f_11);
							if (((*Global_1887327)[iLocal_54 /*36*/])->f_12 > 0f)
							{
								PED::_0xA77FA7BE9312F8C0(((*Global_1887327)[iLocal_54 /*36*/])->f_12);
							}
							Jump @813; //curOff = 790
							func_8();
							func_44(iVar0);
						...
						if (((*Global_1887327)[iLocal_54 /*36*/])->f_13 != 0)
						{
							PED::_0x95423627A9CA598E(((*Global_1887327)[iLocal_54 /*36*/])->f_13);
						}
						BUILTIN::WAIT(0);
						iVar0 = 0;
						while (!func_44(iVar0))
...
{
	iParam0 = iParam0;
	if ((func_60(255) && func_61()) && !func_62())
	{
		func_63(5, 0);
	}
	return 0;
...
int func_44(int iParam0)
{
	if (iParam0 == 0)
	{
		...
		if (STATS::CHAL_IS_GOAL_ACTIVE(-663946200, 1055032020))
		{
			switch (iLocal_54)
			{
				...
				case 127:
				case 135:
					STATS::CHAL_ADD_GOAL_PROGRESS_INT_BY_SCORE_ID(func_77(iLocal_54, 0), 1);
					break;
			}
		}
		if (func_10(func_70()))
	...
	else if (func_45() == -1)
	{
		func_81(iLocal_54);
		func_82(iLocal_54);
		if (!func_83(iLocal_54, 0))
		{
			return 0;
		}
	}
	else if (!func_84(iLocal_54))
	{
		return 0;
	}
	SCRIPTS::TERMINATE_THIS_THREAD();
...
bool func_62()
{
	return func_94(Global_1572887->f_7, 1);
}
...
bool func_68(int iParam0)
{
	...
	return ((((*Global_1887327)[iParam0 /*36*/])->f_21 == 1 || ((*Global_1887327)[iParam0 /*36*/])->f_21 == 2) && !func_101(iParam0));
}
...
void func_71(int iParam0, int iParam1, int iParam2, bool bParam3, int iParam4, int iParam5)
{
	...
	if (!func_104(iParam4))
	{
		if (func_58(iParam0))
		{
			iParam4 = func_105(func_9(iParam0));
		}
		else
		{
	...
	else if ((func_109(iParam1, 2) || func_110(iParam4, 2)) && !Global_1893575->f_9)
	{
	...
	else if ((func_58(iParam0) && func_85(iParam0, 16777216)) && !Global_1893575->f_9)
	{
	...
	Global_1938075->f_145 = func_116(sVar1, sVar2, 4000, 0, 0, 0, 0, 1);
}
...
void func_73(int iParam0, bool bParam1)
{
	...
	switch (func_9(iParam0))
	{
		...
		case 2:
		case 11:
			func_120(func_119(-1532769513, 213519508), 1);
			break;
		...
		case 7:
		case 12:
			func_120(func_119(-1532769513, 242571679), 1);
			break;
		
		case 3:
		case 10:
			func_120(func_119(-1532769513, 1349449307), 1);
			break;
		
		case 4:
		case 9:
			func_120(func_119(-1532769513, 1140362070), 1);
			break;
		
		case 8:
			func_120(func_119(-1532769513, -172330899), 1);
			break;
		...
		case 15:
		case 16:
			func_120(func_119(-1532769513, -910218296), 1);
			break;
	}
	switch (iParam0)
	{
...
int func_83(int iParam0, bool bParam1)
{
	...
	if (func_88(iParam0, &iVar0, &iVar1, 0, 0))
	{
		...
		while (true)
		{
			if (!func_124(Global_1896608->f_1, 16))
			{
				func_125(Global_1896608->f_1, 0);
			}
			Global_1896608->f_1++;
			iVar2++;
...
int func_84(int iParam0)
{
	...
	while (iVar0 < 39)
	{
		if (func_126(iVar0) || func_127(iVar0))
		{
		}
		else
		{
...
int func_91(int iParam0, bool bParam1)
{
	...
	{
		func_132(iParam0, _NAMESPACE48::_0x4F76E3676583D951(func_131(iParam0)));
		if (func_45() == -1)
		{
			if (func_124(iParam0, 2048))
			{
				_NAMESPACE48::_0x49A8C2CD97815215(func_133(iParam0));
				func_134(iParam0, 2048);
			}
			_NAMESPACE48::_0xFCC6DB8DBE709BC8(func_133(iParam0));
		}
		return 0;
	}
	if (!func_135(iParam0) && func_45() == -1)
	{
		return 0;
	}
	if (_NAMESPACE48::_0x800DF3FC913355F3(func_133(iParam0)))
	{
		func_134(iParam0, 128);
		return 1;
	}
	func_132(iParam0, _NAMESPACE48::_0x4F76E3676583D951(func_131(iParam0)));
	_NAMESPACE48::_0x4F81EAD1DE8FA19B(func_133(iParam0));
	if (func_124(iParam0, 2048))
	{
		_NAMESPACE48::_0x49A8C2CD97815215(func_133(iParam0));
		func_134(iParam0, 2048);
...
int func_95(var uParam0, float fParam1, bool bParam2)
{
	int iVar0;
	int iVar1;
	int iVar2;
	...
	else
	{
		...
		if (func_138(iVar0, iVar6, uParam0, fParam1))
		{
			return 1;
		}
	}
...
{
	if (func_139(&(Global_1099293->f_4), iParam0, 5))
	{
		return 1;
	}
	return 0;
...
void func_98(var uParam0, var uParam1, int iParam2, bool bParam3, int iParam4)
{
	if (func_140(255) == 4)
	{
		return;
	...
	func_142(&(Global_1099293->f_516));
	Global_1099293->f_516 = { *uParam0 };
	func_143(&(Global_1099293->f_555));
	Global_1099293->f_555 = { *uParam1 };
	Global_1099293->f_26.f_18 = 0;
	Global_1099293->f_26.f_19 = 0;
	func_144(Global_1099293->f_516, 36);
	func_145(Global_1099293->f_555, 36);
}

int func_99(int iParam0)
{
	if (func_146(&(Global_1099293->f_4), iParam0, 5))
	{
		return 1;
	}
	return 0;
...
void func_100(vector3 vParam0, float fParam3, float fParam4, float fParam5, bool bParam6, int iParam7, int iParam8)
{
	vector3 vVar0;
	float fVar3;
	...
	fVar3 = fParam3;
	if (!func_95(&vVar0, &fVar3, 1))
	{
		vVar0 = { ENTITY::GET_ENTITY_COORDS(PLAYER::PLAYER_PED_ID(), false, false) };
		fVar3 = fParam3;
	}
	func_147(vParam0, fParam3, vVar0, fVar3, fParam4, fParam5, bParam6, iParam7, iParam8, 1);
}
...
char* func_103(int iParam0, int iParam1, int iParam2, int iParam3, var uParam4, var uParam5, var uParam6)
{
	...
	{
		if (!func_154(iParam0) || func_155(44))
		{
			switch (iParam0)
			{
				case 2:
...
char* func_115(char* sParam0, int iParam1)
{
	...
	return func_157(MISC::_CREATE_VAR_STRING(10, "LITERAL_STRING", sParam0), iParam1);
}
...
void func_121(var uParam0, int iParam1)
{
	...
	{
		func_161(&(uParam0->f_8), 1, 1);
	}
}

void func_122(int iParam0)
{
	func_162((Global_1938932->f_5[iParam0 /*11*/])->f_6, 1);
	func_163((Global_1938932->f_5[iParam0 /*11*/])->f_6, 0);
...
void func_123(int iParam0)
{
	...
	if (func_89((Global_1915170->f_3[iParam0 /*447*/])->f_21) && func_165((Global_1915170->f_3[iParam0 /*447*/])->f_21))
	{
		func_166((Global_1915170->f_3[iParam0 /*447*/])->f_21, 0, 1, 0, 0);
	}
	...
	func_167((Global_1915170->f_3[iParam0 /*447*/])->f_9, 0);
	...
	else
	{
		...
		while (iVar0 < iVar1)
		{
			func_170(&((Global_1915170->f_3[iParam0 /*447*/])->f_318[iVar0 /*6*/]));
...
int func_125(int iParam0, bool bParam1)
{
	...
	func_173(iParam0);
	_NAMESPACE48::_0xFC77C5B44D5FF7C0(func_133(iParam0));
	func_132(iParam0, 0);
	return 1;
}
...
void func_130(int iParam0)
{
	...
	if (func_178(iParam0, 16384) && !bVar0)
	{
	...
	else
	{
		...
		while (iVar2 < iVar3)
		{
			func_170(&((Global_1051387->f_69[iParam0 /*76*/])->f_32[iVar2]));
	...
	if (VOLUME::_0x92A78D0BEDB332A3((Global_1051387->f_69[iParam0 /*76*/])->f_25) && func_184(iParam0, 2))
	{
...
int func_136(int iParam0, int iParam1)
{
	...
	if (iParam1 == 255)
	{
		return func_185(&(Global_1099293->f_4), iVar0, 5);
	}
	if (iParam1 == func_186())
	{
		return func_185(&(Global_1099293->f_4), iVar0, 5);
	...
	{
		return func_185(&(((*Global_1097609)[iParam1 /*51*/])->f_4), iVar0, 5);
	}
	return 0;
}
...
int func_138(int iParam0, int iParam1, var uParam2, float fParam3)
{
	struct<5> Var0;
...
void func_144(struct<29> Param0, var uParam29, int iParam30)
{
	switch (Param0.f_5)
	{
		case 1:
...
void func_145(struct<6> Param0, var uParam6, var uParam7, var uParam8, int iParam9)
{
	switch (Param0.f_5)
	{
		case 1:
...
void func_147(vector3 vParam0, float fParam3, vector3 vParam4, float fParam7, float fParam8, float fParam9, bool bParam10, var uParam11, var uParam12, int iParam13)
{
	if (func_140(255) == 4)
	{
		return;
...
{
	func_197(&((Global_1938932->f_5[iParam0 /*11*/])->f_7), iParam1);
}
...
void func_166(int iParam0, bool bParam1, int iParam2, bool bParam3, bool bParam4)
{
	...
	if ((!bParam4 && !func_165(iParam0)) && func_198(iParam0))
	{
		return;
	}
	func_134(iParam0, 1);
	func_173(iParam0);
	if (func_199(func_131(iParam0)))
	{
...
{
	return func_94((Global_1051387->f_69[iParam0 /*76*/])->f_51, iParam1);
}
...
void func_187(int iParam0, bool bParam1, int iParam2, int iParam3)
{
	func_209(iParam0);
	if (!func_210(1))
	{
	...
	else if (!func_211(128) && !func_212(18))
	{
		CAM::DO_SCREEN_FADE_OUT(iParam2);
	}
	if (iParam3 && func_213() == 4)
	{
		func_99(17);
	}
	func_214(1024);
...
int func_188()
{
	...
	if (!func_190(*Global_1051163) && Global_1572887->f_7 & 1 != 0)
	{
		return 1;
	}
	return 0;
...
int func_192(vector3 vParam0, int iParam3)
{
	...
	func_217(iParam3, &vVar0, &Var3, &fVar6);
	if (func_218(vParam0, vVar0, Var3, Var3.f_1, fVar6))
	{
		return 1;
	}
	return 0;
...
void func_217(int iParam0, var uParam1, var uParam2, var uParam3)
{
	switch (iParam0)
	{
		case 0:
...
bool func_218(vector3 vParam0, vector3 vParam3, float fParam6, float fParam7, float fParam8)
{
	vector3 vVar0;
	struct<2> Var3;
	float fVar6;
