...
void func_71(int iParam0, int iParam1, int iParam2, bool bParam3, int iParam4, bool bParam5)
{
	...
	else
	{
		...
		if (!MISC::_SHOULD_USE_24_HOUR_CLOCK())
		{
			...
			sVar2 = MISC::_CREATE_VAR_STRING(674, sVar8, iVar4, func_115(&cVar6, joaat("COLOR_PURE_WHITE")), sVar9, func_115(&cVar10, joaat("COLOR_PURE_WHITE")));
		}
		else
		{
			...
			IntToString(&cVar10, BUILTIN::ROUND(fVar7), 8);
			sVar2 = MISC::_CREATE_VAR_STRING(162, sVar8, iVar4, func_115(&cVar6, joaat("COLOR_PURE_WHITE")), func_115(&cVar10, joaat("COLOR_PURE_WHITE")));
		}
...
int func_95(var uParam0, bool bParam1, bool bParam2)
{
	...
	else
	{
		...
		if (func_138(iVar0, iVar6, uParam0, bParam1))
		{
			return 1;
		}
	}
...
void func_100(vector3 vParam0, int iParam3, int iParam4, int iParam5, int iParam6, int iParam7, float fParam8)
{
	vector3 vVar0;
	int iVar3;
	...
	iVar3 = iParam3;
	if (!func_95(&vVar0, &iVar3, 1))
	{
		vVar0 = { ENTITY::GET_ENTITY_COORDS(PLAYER::PLAYER_PED_ID(), false, false) };
		iVar3 = iParam3;
	}
	func_147(vParam0, iParam3, vVar0, iVar3, iParam4, iParam5, iParam6, iParam7, fParam8, 1);
}
...
int func_138(int iParam0, int iParam1, var uParam2, bool bParam3)
{
	struct<5> Var0;
...
void func_147(vector3 vParam0, int iParam3, vector3 vParam4, int iParam7, float fParam8, float fParam9, bool bParam10, int iParam11, float fParam12, int iParam13)
{
	if (func_140(255) == 4)
	{
		return;
...
int func_192(vector3 vParam0, int iParam3)
{
	...
	func_217(iParam3, &vVar0, &Var3, &uVar6);
	if (func_218(vParam0, vVar0, Var3, Var3.f_1, uVar6))
	{
		return 1;
	}
	return 0;
