...
void func_36(bool bParam0, bool bParam1, bool bParam2, int iParam3)
{
	...
	{
		func_67(func_70(joaat("used"), -939665347), 1);
	}
	...
	if (func_18() == -1)
	{
		...
		{
			func_67(func_70(joaat("used"), 595572217), 1);
		}
	}
	if (bParam1)
	{
