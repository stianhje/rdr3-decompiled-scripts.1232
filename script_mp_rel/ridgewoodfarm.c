...
void func_30(int iParam0)
{
	...
	func_58(883, iLocal_14, 1);
	func_58(884, iLocal_14, 0);
	func_58(885, iLocal_14, 0);
	func_58(886, iLocal_14, 0);
}
...
int func_89(int iParam0, bool bParam1)
{
	...
	if (func_116(iParam0, 32) && !bParam1)
	{
		...
		if (func_45() == -1)
		{
			...
			{
				_NAMESPACE48::_0x49A8C2CD97815215(func_91(iParam0));
				func_125(iParam0, 2048);
			}
			_NAMESPACE48::_0xFCC6DB8DBE709BC8(func_91(iParam0));
		}
		return 0;
	}
	...
	if (_NAMESPACE48::_0x800DF3FC913355F3(func_91(iParam0)))
	{
		func_125(iParam0, 128);
		return 1;
	}
	func_124(iParam0, _NAMESPACE48::_0x4F76E3676583D951(func_123(iParam0)));
	_NAMESPACE48::_0x4F81EAD1DE8FA19B(func_91(iParam0));
	if (func_116(iParam0, 2048))
	{
		_NAMESPACE48::_0x49A8C2CD97815215(func_91(iParam0));
		func_125(iParam0, 2048);
...
bool func_90(int iParam0, int iParam1)
{
	...
	if (iParam1 && !ENTITY::DOES_ENTITY_EXIST(func_127(iParam0)))
	{
		return false;
	}
	return !_NAMESPACE48::_0xEB98B38CA60742D7(func_91(iParam0));
}
...
void func_115(int iParam0)
{
	...
	if (func_87((Global_1915170->f_3[iParam0 /*447*/])->f_21) && func_141((Global_1915170->f_3[iParam0 /*447*/])->f_21))
	{
...
int func_117(int iParam0, bool bParam1)
{
	...
	func_149(iParam0);
	_NAMESPACE48::_0xFC77C5B44D5FF7C0(func_91(iParam0));
	func_124(iParam0, 0);
	return 1;
}
...
char* func_131(var uParam0, var uParam1, var uParam2, var uParam3, var uParam4, var uParam5, var uParam6, var uParam7)
{
...
{
	return func_179((Global_1051387->f_69[iParam0 /*76*/])->f_51, iParam1);
}
...
int func_165(vector3 vParam0, int iParam3)
{
	...
	func_182(iParam3, &vVar0, &Var3, &fVar6);
	if (func_183(vParam0, vVar0, Var3, Var3.f_1, fVar6))
	{
		return 1;
	}
	return 0;
...
bool func_183(vector3 vParam0, vector3 vParam3, float fParam6, float fParam7, float fParam8)
{
	vector3 vVar0;
	struct<2> Var3;
	float fVar6;
