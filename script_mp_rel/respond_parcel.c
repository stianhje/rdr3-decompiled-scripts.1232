...
void func_6(var uParam0)
{
	...
	if (iVar0 > 0)
	{
		uParam0->f_3[0] = func_17("IB_POS_RESP", joaat("INPUT_INTERACT_LOCKON_POS"), Global_35, 1, 0, 0, 1, 0, 1070386381, 570, 4000, 10, 1073741824, 0, joaat("SHORT_TIMED_EVENT"), 0, 0);
	}
	if (iVar1 > 0)
	{
		uParam0->f_3[1] = func_17("IB_NEG_RESP", joaat("INPUT_INTERACT_LOCKON_NEG"), Global_35, 1, 0, 0, 1, 0, 1070386381, 570, 4000, 10, 1073741824, 0, joaat("SHORT_TIMED_EVENT"), 0, 0);
	}
}
...
void func_8(var uParam0, bool bParam1)
{
	...
	func_20(Global_40.f_4514[iVar1 /*6*/], iVar0);
...
int func_14(int iParam0)
{
	...
	return (func_23(Global_40.f_4514[iVar0 /*6*/], 1) || func_23(Global_40.f_4514[iVar0 /*6*/], 2));
}
...
int func_28(bool bParam0, int iParam1, bool bParam2, bool bParam3, bool bParam4, int iParam5, float fParam6, int iParam7, int iParam8, bool bParam9)
{
	...
	iVar2 = 0;
	if (func_39(bParam0) == joaat("clothing"))
	{
		if (!func_40(bParam0, 866047851) && !func_40(bParam0, -1979000645))
		{
			bVar3 = true;
		}
	}
	...
	if (!bVar3)
	{
		if (func_40(bParam0, -1588156645))
		{
			...
			if (WEAPON::IS_WEAPON_VALID(bVar1))
			{
				...
				{
					func_52(bParam0, bVar0, iParam5);
				}
			}
		}
		else if (func_39(bParam0) == -427144552)
		{
		...
		else if (func_39(bParam0) == 307971639 && func_54(bParam0))
		{
			if (!func_55(bParam0, &bVar0, iParam5))
			{
				bParam2 = true;
			}
			bVar4 = true;
		}
		else if (func_40(bParam0, 866047851))
		{
		}
		else if (func_40(bParam0, 2000026003))
		{
		}
		else if (func_40(bParam0, -103750053))
		{
			func_57(func_56(-1019857971), bVar0);
		}
		else if (bParam0 == 2093098109)
		{
			func_57(func_58(-717883113, 2091222383), bVar0);
		}
		else if (func_40(bParam0, -121341956) && !func_40(bParam0, 606799272))
		{
			if (bParam0 != 191707516)
			{
				func_59(534, 0);
			}
			if (func_40(bParam0, -2017733358) || func_40(bParam0, -1369131378))
			{
			}
		}
		else if (func_40(bParam0, -136654233))
		{
			if (func_40(bParam0, -1021472396))
			{
			}
		}
		else if (func_40(bParam0, -1466706512) && func_40(bParam0, 1147021565))
		{
			func_59(517, 0);
		}
		else if (func_40(bParam0, 1147021565) && func_40(bParam0, -524514947))
		{
		}
		else if (func_40(bParam0, 554195525))
		{
		}
		else if (func_40(bParam0, 589988438))
		{
			if (func_60())
			{
		...
		else if (func_40(bParam0, 787083290) && func_40(bParam0, 949916894))
		{
			func_62(bParam0);
		}
		else if (func_40(bParam0, -1718133314))
		{
			func_63(bParam0);
		}
		else if (func_40(bParam0, -1738650224))
		{
			func_64(bParam0);
		}
		else if (func_40(bParam0, -1112814642) && func_40(bParam0, 949916894))
		{
			func_65(bParam0);
		}
		...
		else if (func_40(bParam0, 1841149704))
		{
			func_66();
		}
		else if (func_40(bParam0, -1979000645))
		{
		}
		else if (func_40(bParam0, 606799272))
		{
		}
		else if (func_40(bParam0, -1112814642) && func_40(bParam0, -1697809989))
		{
		}
		else if (func_40(bParam0, -2017733358) || func_40(bParam0, -1369131378))
		{
		}
		else if (func_40(bParam0, -1921346699))
		{
			return 0;
		}
		else if (func_40(bParam0, 1192444843))
		{
			switch (bParam0)
			{
		...
		else if (func_40(bParam0, -839724752) && func_41(bParam0, 4))
		{
		}
		else if (func_40(bParam0, 1399091007))
		{
		...
		switch (bParam0)
		{
			...
			case -21093309: /* GXTEntry: "Aged Pirate Rum" */
				func_70(271, func_69(-21093309 /* GXTEntry: "Aged Pirate Rum" */), 0);
				break;
			case 204375141: /* GXTEntry: "Ginseng Elixir" */
				func_70(269, func_69(204375141 /* GXTEntry: "Ginseng Elixir" */), 0);
				break;
			case -417963070: /* GXTEntry: "Valerian Root" */
				func_70(270, func_69(-417963070 /* GXTEntry: "Valerian Root" */), 0);
				break;
	...
	if (!bVar4)
	{
		...
		bVar5 = bParam0;
		func_72(&bVar5);
		if (!func_52(bVar5, bVar0, iParam5))
		{
			return 0;
		}
		else if (!func_49(0))
	...
	else if (!bParam2)
	{
		...
		func_79(bParam0, bVar0, 0, bVar32, 0, 0, 0);
	}
	return 1;
}
...
void func_32(int iParam0, bool bParam1)
{
	if (HUD::_UIPROMPT_IS_VALID(((*Global_1949749)[iParam0 /*23*/])->f_3))
	{
		if (((*Global_1949749)[iParam0 /*23*/])->f_5 == 5 && !func_24(iParam0, 8))
		{
...
int func_37(bool bParam0, bool bParam1, int iParam2)
{
	...
	*bParam1 = iParam2;
	...
	if (func_90(bParam0, &Var0, *bParam1, 0, 0, -1, 0))
	{
		if (iVar6 < iVar5)
		{
			*bParam1 = (iVar5 - iVar6);
...
void func_38(bool bParam0, bool bParam1)
{
	...
	switch (func_92(bParam0, -949239683))
	{
		case -1565009253:
		case -1420737577:
		case -1273369295:
...
{
	if (func_40(bParam0, -1522723129))
	{
		func_99(-848633709, 0, 255, 0, 0);
	}
	else if (func_40(bParam0, -283942357))
	{
		func_99(-981153234, 0, 255, 0, 0);
	}
	else if (func_40(bParam0, 683680997))
	{
		func_99(-756350192, 0, 255, 0, 0);
	}
	else if (func_40(bParam0, 1307628809))
	{
...
int func_50(bool bParam0, bool bParam1, bool bParam2, bool bParam3, int iParam4, bool bParam5, int iParam6, bool bParam7)
{
	struct<5> Var0;
	struct<10> Var5;
	struct<4> Var27;
	...
	if (WEAPON::HAS_PED_GOT_WEAPON(Global_35, bParam0, 0, 0))
	{
		...
		if (func_104(bParam0, &Var0, Var0.f_4, 0, 0))
		{
			...
			if (func_105(bParam0, &Var5, Var0.f_4))
			{
				...
				func_107(bParam0, &Var27, &Var0, 1, -142743235, 1, 0);
			}
		}
	}
	if (func_49(0))
	{
		...
		func_51(WEAPON::_0x5C2EA6C44F515F34(bParam0), bParam1, iParam6);
		func_108(bParam0, bParam1);
		return 1;
	}
	if (!WEAPON::HAS_PED_GOT_WEAPON(Global_35, bParam0, 0, 0))
	{
...
int func_51(bool bParam0, bool bParam1, int iParam2)
{
	if (bParam1 < 1)
	{
		return 1;
...
int func_52(bool bParam0, bool bParam1, int iParam2)
{
	...
	iVar0 = func_109(bParam0, joaat("DEFAULT"));
	if (iVar0 != 0)
	{
		return func_110(bParam0, bParam1, iParam2);
	}
	Var1 = { func_87(bParam0, 0, 1) };
	Var6 = { func_106(bParam0, Var1, Var1.f_4, 0) };
	return func_111(bParam0, &Var6, &Var1, bParam1, iParam2, 0);
}

int func_53(bool bParam0, int iParam1, bool bParam2, bool bParam3, bool bParam4)
{
	bool bVar0;
	var uVar1;
	bool bVar6;
	...
	if (WEAPON::IS_WEAPON_VALID(bVar0))
	{
		...
		if (!func_90(bParam0, &uVar1, 1, 0, 0, -1, 0))
		{
			...
			bVar6 = func_113(bVar0);
			if (WEAPON::_0x6AD66548840472E5(bVar0))
			{
				func_50(bVar0, bVar6, bParam3, bParam4, 0, 0, iParam1, 0);
			}
			...
			{
				if (bVar0 == joaat("weapon_melee_knife_john") && !func_114())
				{
					return 0;
				}
				...
				{
					func_50(bVar0, WEAPON::_0xD3750CCC00635FC2(bVar0) * 4, bParam3, bParam4, 0, 0, iParam1, 0);
				}
			}
			else if (WEAPON::_0xD955FEE4B87AFA07(bVar0))
			{
				bVar7 = func_116(Global_35, 2, 0, 1);
				if ((((func_102(bVar7) && !Global_26387) && bVar7 != bVar0) && !func_67(-1185145312 /* GXTEntry: "Upgraded Off-Hand Holster" */, 1)) && bParam4)
				{
					WEAPON::_0xE9BD19F8121ADE3E(Global_35, bVar7);
				}
				if (func_102(bVar7) && func_67(-1185145312 /* GXTEntry: "Upgraded Off-Hand Holster" */, 1))
				{
					if (!func_50(bVar0, bVar6, bParam3, bParam4, 3, 1, iParam1, 0))
					{
						return 0;
					}
				}
				else if (!func_50(bVar0, bVar6, bParam3, bParam4, 0, 1, iParam1, 0))
				{
					return 0;
				}
			}
			else if (!func_50(bVar0, bVar6, bParam3, bParam4, 0, 0, iParam1, 0))
			{
				return 0;
			}
		}
...
int func_55(bool bParam0, bool bParam1, int iParam2)
{
	...
	{
		func_70(func_117(bParam0), func_69(bParam0), 1);
		return 0;
	}
	...
	if (func_49(0))
	{
		if (func_51(bParam0, bVar0, iParam2))
		{
			*bParam1 = bVar0;
			return 1;
		}
	...
	{
		return func_52(bParam0, *bParam1, iParam2);
	}
	return 0;
}
...
struct<2> func_76(bool bParam0)
{
	...
	if (func_40(bParam0, -305066475))
	{
		if (func_47() == -1)
		{
			if (func_40(bParam0, -537818634))
			{
	...
	else if (func_40(bParam0, -537818634))
	{
		return func_132(-963660207);
	}
	if (func_40(bParam0, 2084895747))
	{
...
void func_78(bool bParam0, char* sParam1)
{
	...
	sVar0 = func_133(Global_1902941->f_37);
	func_135(MISC::_CREATE_VAR_STRING(38, "ITEM_CAUGHT_PUMP", sParam1, sVar0), "inventory_items", func_134(bParam0), 0, joaat("COLOR_PURE_WHITE"), "Transaction_Feed_Sounds", "Transaction_Positive", 0, 1);
}
...
void func_79(bool bParam0, bool bParam1, bool bParam2, bool bParam3, bool bParam4, bool bParam5, bool bParam6)
{
	...
	if (!func_136() || bParam6)
	{
		func_137(bParam0, bParam1, bParam2, bParam4, bParam3, bParam5);
		return;
	}
	bVar0 = false;
	...
	else if (!func_140(bParam0, &Var7, iVar11, iVar10, 0, -401018458))
	{
		Var7 = "_PLACEHOLDER";
	...
	if (func_40(bParam0, 1816585950))
	{
		iVar13 = 76603059;
	}
	iVar18 = func_69(bParam0);
	if ((func_142(iVar12) && func_40(bParam0, -306684263)) && iVar18 != 0)
	{
		iVar18 = func_143(bParam0);
	}
	sVar19 = func_144(MISC::_CREATE_VAR_STRING(10, &cVar2, MISC::_CREATE_VAR_STRING(0, iVar18), iVar1), iVar13);
	if (((((bParam1 == 1 || func_40(bParam0, 1443104131)) || bParam0 == -885810591) || bParam0 == -1424823393) || bParam0 == 1463786584) || bParam0 == 1358243310)
	{
	...
	{
		sVar19 = MISC::_CREATE_VAR_STRING(0, func_145(bParam0, -442898163));
	}
	if (iVar12 == -126813555 || iVar12 == 1946043663)
	{
		if (!func_40(bParam0, 920823793))
		{
			StringCopy(&cVar20, "", 128);
			if (func_146(bParam0, &cVar20))
			{
...
int func_80()
{
	if ((Global_1939221->f_10485 != (Global_1939221->f_38.f_203 - 1) || func_150(func_149(0), Global_1939221->f_10478, 0, 1, 1) > 0) || Global_1939221->f_10485 == 15)
	{
		return 1;
	}
	func_151();
...
{
	return func_39(bParam0) == -427144552;
}
...
void func_85(bool bParam0, bool bParam1, bool bParam2, bool bParam3, int iParam4)
{
	bool bVar0;

	if (func_39(bParam0) != -427144552)
	{
		return;
	}
	bVar0 = func_46(bParam0, 0);
	...
	{
		if (bParam2 || (!WEAPON::HAS_PED_GOT_WEAPON(Global_35, bVar0, 0, 0) && func_126(bParam0, 0, 0, 0) == 0))
		{
			if (func_47() == -1)
			{
				func_48(bVar0);
			...
			{
				func_79(bParam0, bParam1, 0, 0, 0, 0, 0);
...
{
	if (func_40(bParam0, 58855631))
	{
		func_152(bParam0, -915411861, bParam1, 1);
	}
}
...
struct<5> func_87(bool bParam0, bool bParam1, bool bParam2)
{
	...
	{
		case joaat("clothing"):
			Var0 = { func_106(889965687 /* GXTEntry: "Wardrobe" */, Var0, 1034665895, bParam1) };
			Var0.f_4 = INVENTORY::_0x6452B1D357D81742(bParam0, 889965687);
			break;
		case -427144552:
			Var0 = { func_154(bParam1) };
			if (bParam2 && func_155(bParam0, 1))
			{
				Var6.f_9 = -1591664384;
				if (!func_104(bParam0, &Var0, 1728382685 /* GXTEntry: "Right" */, 0, 0))
				{
					Var0.f_4 = 1728382685; /* GXTEntry: "Right" */
				}
				else if (!func_104(bParam0, &Var0, -649335959 /* GXTEntry: "Left" */, 0, 0))
				{
					Var0.f_4 = -649335959; /* GXTEntry: "Left" */
				}
				else if (func_105(bParam0, &Var6, 1728382685 /* GXTEntry: "Right" */))
				{
					Var0.f_4 = 1728382685; /* GXTEntry: "Right" */
				}
				else
		...
		case -2130996531:
		case joaat("DOG"):
			if (func_157(bParam0, -1823706425))
			{
				Var0 = { func_106(-1838434463 /* GXTEntry: "Camp" */, Var0, 1084182731, bParam1) };
				Var0.f_4 = INVENTORY::_0x6452B1D357D81742(bParam0, -1838434463);
			}
			else if (func_157(bParam0, -1483207246))
			{
				Var0 = { func_106(889965687 /* GXTEntry: "Wardrobe" */, Var0, 1034665895, bParam1) };
				Var0.f_4 = INVENTORY::_0x6452B1D357D81742(bParam0, 889965687);
			}
			...
			else if (func_157(bParam0, -1653629781))
			{
...
{
	if (!func_35(bParam0, 0) && !func_159(func_93(bParam0), 2))
	{
		return 0;
	}
	if (func_39(bParam0) == 26423971)
	{
		return -1;
	}
	if (!bParam2 && func_109(bParam0, joaat("DEFAULT")) == 0)
	{
		bParam2 = true;
	}
	if (bParam2)
	...
	return INVENTORY::_0xADDD1E7C0ECF7D95(func_103(bParam3), bParam0);
}
...
int func_89(bool bParam0, bool bParam1, bool bParam2, bool bParam3)
{
	...
	return INVENTORY::_0xE787F05DFC977BDE(func_103(bParam1), bParam0, bParam3);
}

int func_90(bool bParam0, int iParam1, bool bParam2, bool bParam3, bool bParam4, int iParam5, int iParam6)
{
	struct<4> Var0;
	struct<10> Var4;
	int iVar26;
	...
	if (!bParam3 && func_109(bParam0, joaat("DEFAULT")) == 0)
	{
		bParam3 = true;
	}
	if (func_83(bParam0) && WEAPON::_0x705BE297EEBDB95D(bParam0))
	{
		Var0 = { func_154(0) };
		Var4.f_9 = -1591664384;
		if (!func_104(bParam0, &Var0, 1728382685 /* GXTEntry: "Right" */, 0, 0))
		...
		else if (func_105(bParam0, &Var4, 1728382685 /* GXTEntry: "Right" */))
		{
			return 0;
		}
		if (func_155(bParam0, 1))
		{
			if (!func_104(bParam0, &Var0, -649335959 /* GXTEntry: "Left" */, 0, 0))
			{
				return 0;
			}
			else if (func_105(bParam0, &Var4, -649335959 /* GXTEntry: "Left" */))
			{
				return 0;
			}
		}
	...
	iVar27 = func_161(bParam0, *iParam1, iParam1->f_4, bParam4, bParam3, iParam6);
...
int func_91()
{
	if (((((!ANIMSCENE::_0x3AB6C7B0BB0DF4B1(Global_35, -1) && !PED::IS_PED_USING_ANY_SCENARIO(Global_35)) && !func_162(Global_35, 1369124074)) && !func_162(Global_35, 713668775)) && !TASK::_0xEC7E480FF8BD0BED(Global_35)) && !PED::IS_PED_IN_ANY_VEHICLE(Global_35, false))
	{
		return 1;
	}
	return 0;
...
void func_98(int iParam0)
{
	switch (iParam0)
	{
		...
		case 1:
			...
			break;
		case 2:
			if (func_171() && PLAYER::_0x8A0643B0B4CA276B(PLAYER::GET_PLAYER_INDEX(), 2))
			{
				func_172("DEADEYE_ABILITY_UNLOCK", "DEADEYE_ABILITY_MANUAL_PAINT", 908516622, 1963346246, 8000, 0, 0, 0, 0, 1, 1);
			}
			PLAYER::_0x2797B8D66DD0EBB8(PLAYER::GET_PLAYER_INDEX(), 1, 0);
			...
			break;
		case 3:
			if (func_171() && PLAYER::_0x8A0643B0B4CA276B(PLAYER::GET_PLAYER_INDEX(), 3))
			{
				func_172("DEADEYE_ABILITY_UNLOCK", "DEADEYE_ABILITY_STAY_ACTIVE", 908516622, 1963346246, 8000, 0, 0, 0, 0, 1, 1);
			}
			PLAYER::_0x2797B8D66DD0EBB8(PLAYER::GET_PLAYER_INDEX(), 1, 0);
			PLAYER::_0x2797B8D66DD0EBB8(PLAYER::GET_PLAYER_INDEX(), 2, 0);
			...
			break;
		case 4:
			if (func_171() && PLAYER::_0x8A0643B0B4CA276B(PLAYER::GET_PLAYER_INDEX(), 4))
			{
				func_172("DEADEYE_ABILITY_UNLOCK", "DEADEYE_ABILITY_FATAL", 908516622, 1963346246, 8000, 0, 0, 0, 0, 1, 1);
			}
			PLAYER::_0x2797B8D66DD0EBB8(PLAYER::GET_PLAYER_INDEX(), 1, 0);
			PLAYER::_0x2797B8D66DD0EBB8(PLAYER::GET_PLAYER_INDEX(), 2, 0);
			PLAYER::_0x2797B8D66DD0EBB8(PLAYER::GET_PLAYER_INDEX(), 3, 0);
			...
			break;
		case 5:
			if (func_171() && PLAYER::_0x8A0643B0B4CA276B(PLAYER::GET_PLAYER_INDEX(), 5))
			{
				func_172("DEADEYE_ABILITY_UNLOCK", "DEADEYE_ABILITY_CRITICAL", 908516622, 1963346246, 8000, 0, 0, 0, 0, 1, 1);
			}
			PLAYER::_0x2797B8D66DD0EBB8(PLAYER::GET_PLAYER_INDEX(), 1, 0);
			PLAYER::_0x2797B8D66DD0EBB8(PLAYER::GET_PLAYER_INDEX(), 2, 0);
			PLAYER::_0x2797B8D66DD0EBB8(PLAYER::GET_PLAYER_INDEX(), 3, 0);
...
bool func_104(bool bParam0, var uParam1, int iParam2, bool bParam3, int iParam4)
{
	return func_161(bParam0, *uParam1, iParam2, bParam3, 1, iParam4) > 0;
}
...
int func_105(bool bParam0, int iParam1, int iParam2)
{
	...
	if (func_174(bParam0, &uVar0, iParam1, iParam2))
	{
...
struct<4> func_106(bool bParam0, var uParam1, int iParam2, bool bParam3, var uParam4, bool bParam5, bool bParam6)
{
	struct<4> Var0;
	...
	INVENTORY::_0x886DFD3E185C8A89(func_103(bParam6), &uParam1, bParam0, bParam5, &Var0);
	return Var0;
}

int func_107(bool bParam0, int iParam1, var uParam2, bool bParam3, int iParam4, int iParam5, bool bParam6)
{
	struct<12> Var0;
	int iVar14;
	struct<13> Var15;
	...
	if (!INVENTORY::_0x3E4E811480B3AE79(func_103(bParam6), iParam1, bParam3, iParam4))
	{
		return 0;
	}
	return 1;
...
void func_108(bool bParam0, bool bParam1)
{
	...
	{
		iVar2 = func_178(WEAPON::_0xD3750CCC00635FC2(bParam0), bParam1);
...
int func_110(bool bParam0, bool bParam1, int iParam2)
{
	int iVar0;
	struct<5> Var1;
	var uVar6;
	...
	if (func_90(bParam0, &Var1, bParam1, 0, 0, -1, 0))
	{
		return 0;
	}
	if (!func_49(0))
	...
	if (!INVENTORY::_0xCB5D11F9508A928D(func_103(0), &uVar6, &Var1, bParam0, Var1.f_4, bParam1, iParam2))
	{
		return 0;
	}
	return 1;
...
int func_111(bool bParam0, var uParam1, int iParam2, bool bParam3, int iParam4, bool bParam5)
{
	if (!func_35(bParam0, 0))
	{
		return 0;
	...
	if (func_90(bParam0, iParam2, bParam3, bParam5, 0, -1, 0))
	{
		return 0;
	}
	if (!func_49(0))
	...
	if (!INVENTORY::_0xCB5D11F9508A928D(func_103(0), uParam1, iParam2, bParam0, iParam2->f_4, bParam3, iParam4))
	{
		return 0;
	}
	return 1;
...
int func_119(int iParam0, int iParam1, int iParam2, bool bParam3)
{
	...
	{
		if (!func_129(iParam0, 262144) || !Global_1904612->f_8189)
		{
			return 0;
		}
	}
...
int func_121(int iParam0, bool bParam1, int iParam2)
{
	...
	fVar0 = 1f;
	if (bParam1 && func_67(1811977508 /* GXTEntry: "Elk Antler Trinket" */, 1))
	{
		fVar0 = (fVar0 + 0.1f);
	}
	Var1.f_1 = 10;
	...
	while (iVar24 < Var1)
	{
		...
		else
		{
			...
			if (func_35(bVar25, 0) && func_40(bVar25, -1921346699))
			{
				return BUILTIN::CEIL((IntToFloat(&Var1.f_12[iVar24]) * fVar0));
			}
		}
...
void func_122(int iParam0, char* sParam1, int iParam2, bool bParam3)
{
	...
	func_135(MISC::_CREATE_VAR_STRING(2, sParam1, iParam0), "ITEMTYPE_TEXTURES", 1831944558, 0, joaat("COLOR_PURE_WHITE"), 0, 0, 0, 1);
}
...
void func_123(int iParam0, bool bParam1, float fParam2, int iParam3)
{
	...
	if (bParam1)
	{
		...
		bVar1 = (bVar1 + iVar2);
		func_135(MISC::_CREATE_VAR_STRING(2, "FEED_GANG_TOTAL_EARN", iParam0), "ITEMTYPE_TEXTURES", -1957849484, 0, joaat("COLOR_PURE_WHITE"), 0, 0, 0, 1);
		iParam0 = (iParam0 - iVar0);
		if (iVar0 > 0)
		{
		}
		func_135(MISC::_CREATE_VAR_STRING(2, "FEED_GANG_PLAYER_EARN", bVar1), "ITEMTYPE_TEXTURES", 1831944558, 0, joaat("COLOR_PURE_WHITE"), 0, 0, 0, 1);
	}
	else
	{
		bVar1 = iParam0;
	...
	if (bVar1 > 0)
	{
		...
		func_57(func_132(1644987397), bVar1);
	}
}
...
int func_124(bool bParam0, int iParam1)
{
	...
	iVar0 = func_190(bParam0, iParam1);
	Var4.f_9 = -1591664384;
	if (func_191("ALL WEAPONS", &iVar1, &iVar2, -1591664384, 0))
	{
		...
		while (bVar3 < iVar2)
		{
			if (!func_192(&Var4, bVar3, iVar1, iVar2))
			{
			}
...
bool func_125(bool bParam0)
{
	...
	if (!iVar1 == 0)
	{
		iVar2 = func_195(&(Global_17173.f_54.f_644.f_1353.f_5), iVar1);
		if (iVar2 == -1)
		{
			return true;
		}
...
int func_126(bool bParam0, bool bParam1, bool bParam2, bool bParam3)
{
	...
	if (func_109(bParam0, joaat("DEFAULT")) != 0)
	{
		iVar0 = INVENTORY::_0xE787F05DFC977BDE(func_103(bParam2), bParam0, bParam3);
	}
	else
	{
...
int func_134(bool bParam0)
{
	...
	if (!func_201(bParam0, &uVar0, 805880880, 0, 0, -401018458))
	{
		return -1102349958;
	}
	return uVar0;
...
int func_140(bool bParam0, var uParam1, int iParam2, int iParam3, int iParam4, int iParam5)
{
	int iVar0;
	int iVar1;
	int iVar2;
...
{
	if (func_40(bParam0, -1995062316))
	{
		return "collectible_arrowheads";
	}
	if (func_40(bParam0, 1239889275))
	{
		return "collectible_liquor_bottles";
	}
	if (func_40(bParam0, 143267379))
	{
		return "collectible_coins";
	}
	if (func_40(bParam0, -944041124))
	{
		return "colectible_heirlooms";
	}
	if (func_40(bParam0, 1562621600))
	{
		return "collectible_jewelry";
	}
	if (func_40(bParam0, -149719013))
	{
		return "collectible_bird_eggs";
	}
	if (func_40(bParam0, 1940829793))
	{
		return "collectible_tarot_cards";
	}
	if (func_40(bParam0, 781094263))
	{
...
int func_145(bool bParam0, int iParam1)
{
	...
	iVar0 = func_203(bParam0, iParam1);
	if (iVar0 == 0)
	{
		return 0;
	}
...
int func_146(bool bParam0, char* sParam1)
{
	int iVar0;
	char cVar1[128];
	...
	StringCopy(sParam1, func_204(bParam0), 128);
	iVar0 = HUD::GET_LENGTH_OF_LITERAL_STRING(sParam1);
	if (!func_205(bParam0))
	{
		return 0;
	}
	StringCopy(&cVar1, func_206(bParam0), 128);
...
int func_150(int iParam0, bool bParam1, bool bParam2, bool bParam3, bool bParam4)
{
	int iVar0;
	...
	{
		iVar0 = (iVar0 + func_207(INVENTORY::_0x13D234A2A3F66E63(iParam0), bParam1));
	}
	if (bParam3)
	{
		iVar0 = (iVar0 + func_208(bParam1, bParam4));
	}
	return iVar0;
}
...
void func_151()
{
	if (!func_35(Global_1939221->f_10478, 0))
	{
		Global_1939221->f_6 = 0;
	}
	else if ((((func_92(Global_1939221->f_10478, 1224357681) != 0 && Global_1939221->f_10477 != 0) && Global_1939221->f_10477 != -2074770370) && !Global_1915170->f_20136) && !Global_1915170->f_21989.f_1)
	{
...
int func_152(bool bParam0, bool bParam1, bool bParam2, bool bParam3)
{
	struct<37> Var0;
...
struct<4> func_153(bool bParam0)
{
	...
	if (Global_1572887->f_13 == 0)
	{
		...
		if (iVar0 == 2)
		{
			...
			{
				*Global_1270479 = { func_106(joaat("CHARACTER"), func_209(), -1591664384, bParam0) };
			}
		...
		else if (iVar0 == 3)
		{
			...
			{
				Global_1270479->f_12 = { func_106(joaat("CHARACTER"), func_209(), -1591664384, 0) };
			}
...
struct<4> func_154(bool bParam0)
{
	...
	if (iVar0 == 2)
	{
		...
		{
			Global_1270479->f_4 = { func_106(923904168, func_153(bParam0), -740156546, bParam0) };
		}
	...
	else if (iVar0 == 3)
	{
		...
		{
			Global_1270479->f_16 = { func_106(923904168, func_153(bParam0), -740156546, 0) };
		}
...
{
	if (func_139(bParam0) == 1779021115)
	{
		return 0;
	}
...
struct<4> func_156(bool bParam0)
{
	...
	if (iVar0 == 2 || iVar0 == 3)
	{
		...
		{
			Global_1270479->f_8 = { func_106(271701509, func_153(bParam0), 12999093, 0) };
		}
...
int func_157(bool bParam0, int iParam1)
{
	...
	while (iVar2 < iVar3)
	{
		...
		{
			if (func_211(bParam0, iParam1, bVar0))
			{
				return 1;
			}
		}
...
int func_161(bool bParam0, struct<4> Param1, int iParam5, bool bParam6, bool bParam7, bool bParam8)
{
	int iVar0;
	struct<4> Var1;
	...
	if (!bParam7 && func_109(bParam0, joaat("DEFAULT")) == 0)
	{
		bParam7 = true;
	}
	iVar0 = 0;
	if (bParam7)
	{
		Var1 = { func_106(bParam0, Param1, iParam5, bParam6) };
	...
	{
		iVar0 = INVENTORY::_0xE787F05DFC977BDE(func_103(bParam6), bParam0, bParam8);
	}
	return iVar0;
}
...
int func_174(bool bParam0, int iParam1, int iParam2, int iParam3)
{
	int iVar0;

	iVar0 = func_103(0);
	*iParam1 = { func_106(bParam0, func_154(0), iParam3, 0) };
	if (!INVENTORY::_0xB881CA836CC4B6D4(iParam1))
	{
		return 0;
	}
...
int func_191(char* sParam0, int iParam1, bool bParam2, int iParam3, bool bParam4)
{
	*iParam1 = INVENTORY::_0x80D78BDC9D88EF07(func_103(bParam4), sParam0, iParam3, bParam2);
	if (*iParam1 >= 0)
	{
		return 1;
	}
...
int func_197(bool bParam0, bool bParam1)
{
	...
	Var0 = { func_229(bParam0, -1591664384, -1591664384, -1591664384, 0, 0, 0) };
	if (bParam1)
	{
...
int func_201(bool bParam0, var uParam1, int iParam2, int iParam3, int iParam4, int iParam5)
{
	int iVar0;
	int iVar1;
	int iVar2;
...
{
	if (func_139(bParam0) == -126813555 || func_139(bParam0) == 1946043663)
	{
		return 1;
	}
	return 0;
...
int func_208(bool bParam0, bool bParam1)
{
	if (!bParam1 || func_235())
	{
		return func_161(bParam0, func_153(1), -2015960939, 1, 1, 0);
	}
	return 0;
}
...
bool func_210()
{
	return (func_89(-1185145312 /* GXTEntry: "Upgraded Off-Hand Holster" */, 0, 0, 0) > 0 && func_236(func_106(889965687 /* GXTEntry: "Wardrobe" */, func_153(1), 1034665895, 1), -234132662, 1, -1) != 0);
}
...
{
	return func_40(bParam0, 1279601681);
}
...
struct<14> func_229(bool bParam0, int iParam1, int iParam2, int iParam3, int iParam4, int iParam5, int iParam6)
{
	struct<14> Var0;
...
int func_231(var uParam0, int iParam1, bool bParam2, bool bParam3)
{
	*iParam1 = INVENTORY::_0x640F890C3E5A3FFD(func_103(bParam3), uParam0, bParam2);
	if (*iParam1 >= 0)
	{
		return 1;
	}
...
struct<4> func_234(int iParam0, bool bParam1)
{
	struct<5> Var0;

	Var0 = { func_246(iParam0) };
	return func_247(iParam0, bParam1, Var0, Var0.f_4);
}
...
struct<4> func_247(int iParam0, bool bParam1, var uParam2, int iParam3, var uParam4, var uParam5, bool bParam6)
{
	struct<4> Var0;
