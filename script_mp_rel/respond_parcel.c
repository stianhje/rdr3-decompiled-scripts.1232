...
void __EntryFunction__()
{
	...
	{
		aggregate.coffee_drinking.func_5(&Var1, 3);
	}
	...
	while (true)
	{
		...
		switch (aggregate.bandana.func_20(&Var1))
		{
			case 0:
				if (aggregate.fm_mission_controller.func_5479(Global_35, 0) != joaat("weapon_unarmed"))
				{
				...
				{
					aggregate.coffee_drinking.func_5(&Var1, 1);
				}
				break;
			case 1:
				func_4(&Var1);
				func_5(5, &(Var1.f_2));
				func_6(&Var1);
				aggregate.coffee_drinking.func_5(&Var1, 2);
				break;
			case 2:
				if (aggregate.binoculars.func_13(&(Var1.f_3[0]), 1))
				{
					func_8(&Var1, 1);
				}
				else if (aggregate.binoculars.func_13(&(Var1.f_3[1]), 1))
				{
					func_8(&Var1, 0);
				}
...
void func_4(var uParam0)
{
	...
	{
		if (aggregate.annesburg.func_217(&(uParam0->f_3[iVar0])))
		{
			aggregate.annesburg.func_218(uParam0->f_3[iVar0], 1, 1);
		}
		iVar0++;
	}
}
...
{
	if (!aggregate.doc_book.func_343(iParam0))
	{
		return 0;
	}
...
void func_6(var uParam0)
{
	...
	if (!aggregate.aberdeenpigfarm.func_165(uParam0->f_1))
	{
		return;
	}
	...
	if (iVar0 > 0)
	{
		uParam0->f_3[0] = aggregate.camera_item.func_46("IB_POS_RESP", joaat("INPUT_INTERACT_LOCKON_POS"), Global_35, 1, 0, 0, 1, 0, 1070386381 /* Float: 1.6f */, 570, 4000, 10, 1073741824 /* Float: 2f */, 0, joaat("SHORT_TIMED_EVENT"), 0, 0);
	}
	if (iVar1 > 0)
	{
		uParam0->f_3[1] = aggregate.camera_item.func_46("IB_NEG_RESP", joaat("INPUT_INTERACT_LOCKON_NEG"), Global_35, 1, 0, 0, 1, 0, 1070386381 /* Float: 1.6f */, 570, 4000, 10, 1073741824 /* Float: 2f */, 0, joaat("SHORT_TIMED_EVENT"), 0, 0);
	}
}
...
void func_8(var uParam0, bool bParam1)
{
	...
	aggregate.aberdeenpigfarm.func_68(Global_40.f_4514[iVar1 /*6*/], iVar0);
...
bool func_14(int iParam0)
{
	...
	return (aggregate.aberdeenpigfarm.func_61(Global_40.f_4514[iVar0 /*6*/], 1) || aggregate.aberdeenpigfarm.func_61(Global_40.f_4514[iVar0 /*6*/], 2));
}
...
void func_21(int iParam0, var uParam1, bool bParam2)
{
	...
	while (iVar1 < iVar0)
	{
		...
		aggregate.pv_hunt_the_posse.func_1137(bVar2, iVar3, 0, 0, 0, 752097756, 0, 0, 0, 0);
		iVar1++;
	}
