...
int func_26(int iParam0, int iParam1, var uParam2, var uParam3, int iParam4)
{
	struct<5> Var0;
...
int func_27(int iParam0, int iParam1, var uParam2, var uParam3, int iParam4)
{
	struct<5> Var0;
...
int func_28(int iParam0, int iParam1, bool bParam2, bool bParam3, bool bParam4, int iParam5, char* sParam6, int iParam7, int iParam8, bool bParam9)
{
	...
	if (!bVar3)
	{
		...
		switch (iParam0)
		{
			...
			case -21093309:
				func_70(271, func_69(-21093309), 0);
				break;
			
			case 204375141:
				func_70(269, func_69(204375141), 0);
				break;
			
			case -417963070:
				func_70(270, func_69(-417963070), 0);
				break;
...
int func_36(int iParam0, int iParam1, int iParam2, int iParam3)
{
	if (func_47() == -1)
	{
		...
		{
			func_85(iParam0, iParam1, 1, &iParam2, iParam3);
			return 0;
		}
	}
...
int func_37(int iParam0, var uParam1, int iParam2)
{
	struct<5> Var0;
	int iVar5;
	int iVar6;
	...
	*uParam1 = iParam2;
	...
	if (func_90(iParam0, &Var0, *uParam1, 0, 0, -1, 0))
	{
		if (iVar6 < iVar5)
		{
			*uParam1 = (iVar5 - iVar6);
...
int func_53(int iParam0, int iParam1, bool bParam2, bool bParam3, bool bParam4)
{
	...
	if (WEAPON::IS_WEAPON_VALID(iVar0))
	{
		...
		if (!func_90(iParam0, &uVar1, 1, 0, 0, -1, 0))
		{
			...
			{
				iVar7 = func_116(Global_35, 2, 0, 1);
				if ((((func_102(iVar7) && !Global_26387) && iVar7 != iVar0) && !func_67(-1185145312, 1)) && bParam4)
				{
...
int func_61(int iParam0, bool bParam1, float fParam2, int iParam3, char* sParam4, int iParam5, int iParam6, int iParam7)
{
	int iVar0;
	...
	iVar0 = func_121(iParam0, iParam6, iParam7);
	if (!bParam1)
	{
...
void func_78(int iParam0, char* sParam1)
{
	...
	func_135(MISC::_CREATE_VAR_STRING(38, "ITEM_CAUGHT_PUMP", sParam1, sVar0), "inventory_items", func_134(iParam0), 0, 109029619, "Transaction_Feed_Sounds", "Transaction_Positive", 0, 1);
}

void func_79(int iParam0, int iParam1, bool bParam2, bool bParam3, int iParam4, bool bParam5, int iParam6)
{
	bool bVar0;
	int iVar1;
	char cVar2[32];
	...
	if (!func_136() || iParam6)
	{
		func_137(iParam0, iParam1, bParam2, iParam4, bParam3, bParam5);
		return;
	}
	bVar0 = false;
	...
	if (((((iParam1 == 1 || func_40(iParam0, 1443104131)) || iParam0 == -885810591) || iParam0 == -1424823393) || iParam0 == 1463786584) || iParam0 == 1358243310)
	{
	...
	if (iVar12 == -126813555 || iVar12 == 1946043663)
	{
		if (!func_40(iParam0, 920823793))
		{
			...
			if (func_146(iParam0, &Var20))
			{
				sVar19 = func_148(func_147(Var20), 109029619);
			}
		}
	}
...
void func_85(int iParam0, int iParam1, int iParam2, var uParam3, int iParam4)
{
	int iVar0;
	...
	{
		if (iParam2 || (!WEAPON::HAS_PED_GOT_WEAPON(Global_35, iVar0, 0, 0) && func_126(iParam0, 0, 0, 0) == 0))
		{
			if (func_47() == -1)
			{
				func_48(iVar0);
...
void func_86(int iParam0, var uParam1)
{
	...
	{
		func_152(iParam0, -915411861, uParam1, 1);
	}
}

struct<5> func_87(int iParam0, bool bParam1, int iParam2)
{
	struct<5> Var0;
	int iVar5;
	struct<10> Var6;
...
int func_89(int iParam0, bool bParam1, bool bParam2, int iParam3)
{
	...
	return INVENTORY::_0xE787F05DFC977BDE(func_103(bParam1), iParam0, iParam3);
}

int func_90(int iParam0, var uParam1, int iParam2, bool bParam3, bool bParam4, int iParam5, int iParam6)
{
	struct<4> Var0;
	struct<10> Var4;
	int iVar26;
	...
	iVar27 = func_161(iParam0, *uParam1, uParam1->f_4, bParam4, bParam3, iParam6);
...
int func_105(int iParam0, var uParam1, int iParam2)
{
	...
	if (func_174(iParam0, &uVar0, uParam1, iParam2))
	{
...
struct<4> func_106(int iParam0, var uParam1, var uParam2, var uParam3, var uParam4, int iParam5, bool bParam6)
{
	struct<4> Var0;
	...
	INVENTORY::_0x886DFD3E185C8A89(func_103(bParam6), &uParam1, iParam0, iParam5, &Var0);
	return Var0;
}

int func_107(int iParam0, var uParam1, var uParam2, int iParam3, int iParam4, int iParam5, bool bParam6)
{
	struct<12> Var0;
	int iVar14;
	struct<13> Var15;
	...
	Var0.f_9 = -1591664384;
	if (!func_158(*uParam1, &Var0, bParam6, 0, -1))
	{
		return 0;
	}
	if (iParam3 < 0)
	...
	if (!INVENTORY::_0x3E4E811480B3AE79(func_103(bParam6), uParam1, iParam3, iParam4))
	{
		return 0;
	}
	return 1;
...
int func_111(int iParam0, var uParam1, var uParam2, int iParam3, int iParam4, bool bParam5)
{
	...
	if (!INVENTORY::_0xCB5D11F9508A928D(func_103(0), uParam1, uParam2, iParam0, uParam2->f_4, iParam3, iParam4))
	{
		return 0;
	}
	return 1;
...
int func_121(int iParam0, var uParam1, int iParam2)
{
	...
	fVar0 = 1f;
	if (uParam1 && func_67(1811977508, 1))
	{
		fVar0 = (fVar0 + 0.1f);
	}
	Var1.f_1 = 10;
...
void func_122(int iParam0, char* sParam1, var uParam2, bool bParam3)
{
	if (iParam0 == 0)
	{
		return;
	...
	func_135(MISC::_CREATE_VAR_STRING(2, sParam1, iParam0), "ITEMTYPE_TEXTURES", 1831944558, 0, 109029619, 0, 0, 0, 1);
}
...
void func_123(int iParam0, bool bParam1, float fParam2, int iParam3)
{
	...
	if (bParam1)
	{
		...
		iVar1 = (iVar1 + iVar2);
		func_135(MISC::_CREATE_VAR_STRING(2, "FEED_GANG_TOTAL_EARN", iParam0), "ITEMTYPE_TEXTURES", -1957849484, 0, 109029619, 0, 0, 0, 1);
		iParam0 = (iParam0 - iVar0);
		if (iVar0 > 0)
		{
		}
		func_135(MISC::_CREATE_VAR_STRING(2, "FEED_GANG_PLAYER_EARN", iVar1), "ITEMTYPE_TEXTURES", 1831944558, 0, 109029619, 0, 0, 0, 1);
	}
	else
	{
		iVar1 = iParam0;
...
int func_126(int iParam0, int iParam1, bool bParam2, int iParam3)
{
	...
	{
		iVar0 = INVENTORY::_0xE787F05DFC977BDE(func_103(bParam2), iParam0, iParam3);
	}
	else
	{
		...
		iVar0 = INVENTORY::_0xC97E0D2302382211(func_103(bParam2), &Var3, iParam3);
	}
	return iVar0;
}
...
int func_131(int iParam0, var uParam1, var uParam2, var uParam3)
{
	var uVar0;
	struct<14> Var1;
...
int func_134(int iParam0)
{
	...
	if (!func_201(iParam0, &uVar0, 805880880, 0, 0, -401018458))
	{
		return -1102349958;
	}
	return uVar0;
...
int func_150(int iParam0, int iParam1, int iParam2, bool bParam3, bool bParam4)
{
	int iVar0;
	
	iVar0 = func_126(iParam1, iParam2, 0, 0);
...
struct<4> func_153(bool bParam0)
{
	...
	if (Global_1572887->f_13 == 0)
	{
		...
		if (iVar0 == 2)
		{
			...
			{
				*Global_1270479 = { func_106(1328661203, func_209(), -1591664384, bParam0) };
			}
		...
		else if (iVar0 == 3)
		{
			...
			{
				Global_1270479->f_12 = { func_106(1328661203, func_209(), -1591664384, 0) };
			}
			return Global_1270479->f_12;
		}
	}
	return func_106(1328661203, func_209(), -1591664384, bParam0);
}
...
bool func_158(var uParam0, var uParam1, var uParam2, var uParam3, var uParam4, bool bParam5, bool bParam6, int iParam7)
{
	return func_212(&uParam0, uParam4, bParam5, bParam6, iParam7);
}
...
int func_161(int iParam0, struct<4> Param1, int iParam5, bool bParam6, bool bParam7, int iParam8)
{
	int iVar0;
	struct<4> Var1;
	...
	if (bParam7)
	{
		...
		iVar0 = INVENTORY::_0xC97E0D2302382211(func_103(bParam6), &Var1, iParam8);
	}
	else
	{
		iVar0 = INVENTORY::_0xE787F05DFC977BDE(func_103(bParam6), iParam0, iParam8);
	}
	return iVar0;
}
...
int func_174(int iParam0, var uParam1, var uParam2, int iParam3)
{
	...
	iVar0 = func_103(0);
	*uParam1 = { func_106(iParam0, func_154(0), iParam3, 0) };
	if (!INVENTORY::_0xB881CA836CC4B6D4(uParam1))
	{
		return 0;
	}
...
void func_180(var uParam0, int iParam1, int iParam2, int iParam3, int iParam4, int iParam5, int iParam6, bool bParam7)
{
	int iVar0;
	int iVar1;
	int iVar2;
	...
	func_226(uParam0, iVar5, iVar4, iVar3, iVar2, iVar1, iVar0);
}
...
int func_191(char* sParam0, var uParam1, var uParam2, int iParam3, bool bParam4)
{
	*uParam1 = INVENTORY::_0x80D78BDC9D88EF07(func_103(bParam4), sParam0, iParam3, uParam2);
	if (*uParam1 >= 0)
	{
		return 1;
	}
...
int func_197(int iParam0, bool bParam1)
{
	...
	if (!func_231(&Var0, &iVar14, &iVar15, 0))
	{
		return 0;
	}
	func_193(iVar14);
...
bool func_210()
{
	return (func_89(-1185145312, 0, 0, 0) > 0 && func_236(func_106(889965687, func_153(1), 1034665895, 1), -234132662, 1, -1) != 0);
}
...
int func_212(var uParam0, var uParam1, bool bParam2, bool bParam3, int iParam4)
{
...
void func_215(int iParam0, int iParam1, struct<17> Param2)
{
	int iVar0;
	struct<24> Var1;
...
int func_216(int iParam0, var uParam1)
{
	...
	{
		if (func_237(uVar0, 2048))
		{
			return 0;
		}
	}
	else if (func_237(uVar0, 8))
	{
		return 0;
	}
	else if (func_237(uVar0, 16))
	{
		return 0;
	}
	else if (func_237(uVar0, 65536))
	{
		return 0;
	}
	return 1;
...
int func_231(var uParam0, var uParam1, int iParam2, bool bParam3)
{
	*uParam1 = INVENTORY::_0x640F890C3E5A3FFD(func_103(bParam3), uParam0, iParam2);
	if (*uParam1 >= 0)
	{
		return 1;
	}
...
int func_236(var uParam0, var uParam1, var uParam2, var uParam3, int iParam4, bool bParam5, int iParam6)
{
	return func_249(&uParam0, iParam4, bParam5, iParam6);
}
...
struct<5> func_246(int iParam0)
{
	...
	Var0 = { func_247(iParam0, 1328661203, func_209(), -1591664384) };
	Var0.f_4 = 1084182731;
	return Var0;
}

struct<4> func_247(int iParam0, int iParam1, var uParam2, var uParam3, var uParam4, var uParam5, int iParam6)
{
	struct<4> Var0;
...
int func_249(var uParam0, var uParam1, bool bParam2, int iParam3)
{
	struct<10> Var0;
	
	Var0.f_9 = -1591664384;
	if (func_251(uParam0, uParam1, &Var0, bParam2, iParam3))
	{
		return Var0.f_4;
	}
	return 0;
...
int func_251(var uParam0, var uParam1, var uParam2, bool bParam3, int iParam4)
{
	var uVar0;
	...
	if (!func_212(&uVar0, uParam2, bParam3, 0, iParam4))
	{
		return 0;
	}
	return 1;
