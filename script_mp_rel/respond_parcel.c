...
int func_28(bool bParam0, int iParam1, bool bParam2, bool bParam3, bool bParam4, int iParam5, float fParam6, int iParam7, int iParam8, bool bParam9)
{
	...
	if (!bVar3)
	{
		...
		else if (func_39(bParam0) == joaat("weapon"))
		{
		...
		else if (func_39(bParam0) == joaat("ammo") && func_54(bParam0))
		{
		...
		else if (func_40(bParam0, 589988438))
		{
			if (func_60())
			{
				func_61(1339418451, 0, 1065353216 /* Float: 1f */, 1, 0, 0, 0, -1);
				bParam2 = true;
				bVar4 = true;
			}
		}
...
{
	return func_39(bParam0) == joaat("weapon");
}
...
void func_85(bool bParam0, bool bParam1, bool bParam2, bool bParam3, int iParam4)
{
	...
	if (func_39(bParam0) != joaat("weapon"))
	{
		return;
	}
	bVar0 = func_46(bParam0, 0);
...
int func_134(bool bParam0)
{
	...
	if (!func_201(bParam0, &uVar0, joaat("inventory"), 0, 0, -401018458))
	{
		return -1102349958;
	}
	return uVar0;
