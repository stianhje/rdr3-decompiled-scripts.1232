...
int func_21(var uParam0)
{
	if (NETWORK::NETWORK_IS_HOST_OF_THIS_SCRIPT())
	{
		...
		uParam0->f_1401[1] = 1110781448;
		uParam0->f_1385[0] = -2021274799;
		uParam0->f_1385[1] = 330367347;
		uParam0->f_1385[2] = 330367347;
...
int func_96(var uParam0)
{
	...
	if (!ENTITY::DOES_ENTITY_EXIST(&(uParam0->f_1393[0])))
	{
		...
		{
			ANIMSCENE::SET_ANIM_SCENE_ENTITY(iVar0, "Stool", &(uParam0->f_1393[0]), 0);
		}
		else
		{
			return 0;
	...
	if (!ENTITY::DOES_ENTITY_EXIST(&(uParam0->f_1393[1])))
	{
		...
		{
			ANIMSCENE::SET_ANIM_SCENE_ENTITY(iVar0, "Chair", &(uParam0->f_1393[1]), 0);
		}
		else
		{
			return 0;
	...
	if (!ENTITY::DOES_ENTITY_EXIST(&(uParam0->f_1393[2])))
	{
		...
		{
			ANIMSCENE::SET_ANIM_SCENE_ENTITY(iVar0, "Chair^1", &(uParam0->f_1393[2]), 0);
		}
		else
		{
			return 0;
	...
	if (!func_155(uParam0, iVar0, 0, "PERFORMER"))
	{
		return 0;
	}
	if (!func_155(uParam0, iVar0, 1, "CrowdMember"))
	{
		return 0;
	}
...
void func_119(var uParam0, var uParam1, var uParam2, float fParam3)
{
	switch (uParam0->f_1)
	{
		...
		case 33:
			...
			break;
		case 34:
			if (ANIMSCENE::_0xCBFC7725DE6CE2E0(NETWORK::_0xD7F6781A0ABAF6FB(uParam0->f_1374), 0) && ANIMSCENE::_0x3FBC3F51BF12DFBF(NETWORK::_0xD7F6781A0ABAF6FB(uParam0->f_1374)) > func_162())
			{
...
Vector3 func_153(int iParam0)
{
	...
	{
		case 0:
			return 2546.098f, -1310.338f, 48.2087f;
		case 1:
			return 2541.685f, -1311.861f, 49.21665f;
		case 2:
			return 2541.685f, -1311.961f, 49.21665f;
		default:
			break;
	}
	return 2541.685f, -1311.961f, 49.21665f;
