...
void func_41(var uParam0)
{
	...
	aggregate.shop_bait.func_334(uParam0, 10, 60940);
	aggregate.shop_camp_butchertable.func_338(uParam0, 10, 61055);
	aggregate.shop_camp_lockbox.func_332(uParam0, 15);
	func_338(uParam0, 15, 61211);
	aggregate.shop_bait.func_334(uParam0, 15, 61362);
	aggregate.shop_camp_butchertable.func_338(uParam0, 15, 61444);
	aggregate.shop_bait.func_749(uParam0, 11, 61538, 61568, 61582, 61596);
	aggregate.shop_bait.func_334(uParam0, 11, 61707);
}
...
bool func_316(var uParam0, int iParam1, int iParam2, vector3 vParam3, vector3 vParam6, int iParam9, int iParam10, int iParam11)
{
	...
	aggregate.camera_item.func_77(&(uParam0->f_4), 137049);
	aggregate.camera_item.func_77(&(uParam0->f_4), 137086);
	aggregate.shop_bait.func_733(&(uParam0->f_4), 137114);
	aggregate.shop_bait.func_733(&(uParam0->f_4), 137649);
...
int func_333(var uParam0)
{
	...
	if (Local_21 > 0 && aggregate.fme_animal_tagging.func_1400(Local_21))
	{
		return 1;
	}
	return 0;
...
int func_335(var uParam0, int iParam1)
{
	...
	if (Local_21 > 0)
	{
		aggregate.fm_mission_controller.func_7013(iVar9, "SHOP_POSTOFFICE_PAY_BOUNTY_MP", Local_21, 1);
	}
	return iVar9;
}
...
int func_337(var uParam0)
{
	...
	else if (!aggregate.fme_animal_tagging.func_1569(-1458756770, &(Local_21.f_7)) && !aggregate.fme_animal_tagging.func_1570(-1458756770, &(Local_21.f_7)))
	{
		return 0;
	}
	Local_21.f_1 = aggregate.mp_intro.func_2428(-1458756770, Local_21.f_7, 1, 0, 1, 0);
	return 1;
}
...
int func_339(var uParam0)
{
	...
	if (aggregate.fm_mission_controller.func_6230(Local_21.f_7) || (aggregate.mp_intro.func_2033(Local_21.f_7) && aggregate.fme_animal_tagging.func_1400(Local_21.f_1)))
	{
		return 1;
	}
	return 0;
...
int func_340(var uParam0, int iParam1)
{
	...
	if (aggregate.mp_intro.func_2033(Local_21.f_7))
	{
		aggregate.fm_mission_controller.func_7013(iVar0, "SHOP_POSTOFFICE_PAY_BOUNTY_MP_OFFER", Local_21.f_1, 1);
	}
	else
	{
		aggregate.fm_mission_controller.func_7013(iVar0, "SHOP_POSTOFFICE_PAY_BOUNTY_MP_REWARD", Local_21.f_1, 1);
	}
	return iVar0;
}
...
void func_702(var uParam0)
{
	...
	if (!MISC::IS_BIT_SET(uParam0->f_2371.f_9, 1))
	{
		...
		{
			aggregate.mp_intro.func_1329(uParam0, 192631);
			aggregate.mp_intro.func_1329(uParam0, 193551);
			aggregate.mp_intro.func_1329(uParam0, 194151);
			aggregate.mp_intro.func_1329(uParam0, 194445);
			aggregate.mp_intro.func_1329(uParam0, 194648);
