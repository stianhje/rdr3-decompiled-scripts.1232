...
void func_72(int iParam0, int iParam1, int iParam2, bool bParam3, int iParam4, int iParam5)
{
	...
	sVar1 = func_96(iParam0, iParam1, iParam2, iParam4, iParam5, bParam3, &uVar0);
	...
	else
	{
		...
		if (!MISC::_SHOULD_USE_24_HOUR_CLOCK())
		{
			...
			sVar2 = MISC::_CREATE_VAR_STRING(674, sVar8, iVar4, func_108(&sVar6, 109029619), sVar9, func_108(&sVar10, 109029619));
		}
		else
		{
			...
			IntToString(&sVar10, BUILTIN::ROUND(fVar7), 8);
			sVar2 = MISC::_CREATE_VAR_STRING(162, sVar8, iVar4, func_108(&sVar6, 109029619), func_108(&sVar10, 109029619));
		}
...
char* func_96(int iParam0, int iParam1, int iParam2, int iParam3, var uParam4, var uParam5, var uParam6)
{
	char* sVar0;
...
void func_114(var uParam0, var uParam1)
{
	...
	{
		VOLUME::_0xFD010A2154B40676(uParam0, 623901053);
	}
	if (uParam1->f_4)
	{
		PLAYER::_0x0751D461F06E41CE(PLAYER::PLAYER_ID(), 7, 0, 0);
...
int func_168(vector3 vParam0, int iParam3)
{
	...
	func_186(iParam3, &vVar0, &Var3, &fVar6);
	if (func_187(vParam0, vVar0, Var3, Var3.f_1, fVar6))
	{
		return 1;
	}
	return 0;
