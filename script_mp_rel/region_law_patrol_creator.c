...
int func_2(int iParam0, bool bParam1, int iParam2, int iParam3)
{
	...
	{
		return func_14(bParam1, iParam2, iParam3);
	}
...
void func_9()
{
	...
	switch (iLocal_18)
	{
		...
		case 4:
			...
			else if (iLocal_30 && (!iLocal_31 && func_6() != 8))
			{
				func_32();
			}
			else
				...
				while (iVar4 < iLocal_37)
				{
					...
					if (func_11(&(iLocal_37[iVar4]), 0))
					{
						...
						if (func_19())
						{
							...
							if (func_34(iVar0))
							{
								vVar6 = { func_35((Global_40.f_186[iVar0 /*12*/])->f_1, ((Global_40.f_186[iVar0 /*12*/])->f_4 - 3f), 10f) };
		...
		case 5:
			...
			{
				if (func_11(&(iLocal_37[iVar9]), 0) && func_11(Global_35, 0))
				{
					if (func_37(Global_35, &(iLocal_37[iVar9]), 1, 1) > 220f)
					{
						iLocal_18 = 6;
						return;
					}
...
int func_14(bool bParam0, var uParam1, var uParam2)
{
...
int func_16(int iParam0, int iParam1)
{
	...
	if (func_41(iParam0, 1) || (iParam1 && func_41(iParam0, 2)))
	{
		return 1;
	}
	return 0;
...
int func_19()
{
	...
	if (func_46((Global_40.f_186[iVar0 /*12*/])->f_1) || (Global_40.f_186[iVar0 /*12*/])->f_4 < 1f)
	{
		return 0;
	}
	if (func_47(Global_35, (Global_40.f_186[iVar0 /*12*/])->f_1, ((Global_40.f_186[iVar0 /*12*/])->f_4 + 10f), 1, 1))
	{
		return 1;
	}
	return 0;
...
int func_20(int iParam0, int iParam1)
{
	...
	if (iParam1 == 255)
	{
		return func_48(&(Global_1099293->f_4), iVar0, 5);
	}
	if (iParam1 == func_49())
	{
		return func_48(&(Global_1099293->f_4), iVar0, 5);
	...
	{
		return func_48(&(((*Global_1097609)[iParam1 /*51*/])->f_4), iVar0, 5);
	}
	return 0;
}
...
void func_26()
{
	...
	if (func_6() == 8)
	{
		...
		else if (func_11(Global_35, 0))
		{
			if (!func_55(Global_35, iLocal_50, 1, 0))
			{
...
int func_28(vector3 vParam0, var uParam3, var uParam4, int iParam5, bool bParam6, float fParam7, int iParam8, float fParam9, float fParam10, float fParam11)
{
	int iVar0;
	...
	switch (*uParam3)
	{
		case 0:
			...
			func_57(&(uParam3->f_1), uParam3->f_2, vParam0, iParam5, fParam7, iParam8, fParam9, fParam10, fParam11);
			if (!TASK::_0x1AC5A8AB50CFAA33(uParam3->f_1))
			{
			}
			else
			{
				func_58(&(uParam3->f_1), iParam5, vParam0);
				if (!func_46(uParam3->f_6))
				{
...
void func_57(var uParam0, int iParam1, vector3 vParam2, int iParam5, float fParam6, var uParam7, float fParam8, float fParam9, float fParam10)
{
	int iVar0;
	int iVar1;
...
int func_80(struct<2> Param0, var uParam2, float fParam3, float fParam4, int iParam5, int iParam6)
{
	if (Param0 < fParam3)
	{
