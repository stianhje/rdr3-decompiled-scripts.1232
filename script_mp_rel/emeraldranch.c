...
{
	func_60(2, iLocal_22, iParam0, iLocal_23, iLocal_24, 1277952, 0, 0, -1082130432, 0);
	func_61(2, 2057841001, 0, 0);
	func_62(2, 0);
	func_60(4, iLocal_27, iParam0, iLocal_27, 0, 12, 0, 0, -1082130432, 0);
	func_62(4, 0);
	func_60(38, iLocal_28, iParam0, iLocal_29, 0, 12, 1, 0, -1082130432, 0);
	func_62(38, 0);
}
...
void func_81(int iParam0, int iParam1, int iParam2, bool bParam3, int iParam4, int iParam5)
{
	var uVar0;
	char* sVar1;
	char* sVar2;
...
void func_83(int iParam0, bool bParam1)
{
	...
	func_130(func_151(-1532769513, -36357794), 1);
...
int func_98(int iParam0, var uParam1, var uParam2, bool bParam3, bool bParam4)
{
	bool bVar0;
...
int func_120(int iParam0, var uParam1, var uParam2, var uParam3)
{
	return func_192(iParam0, "sHash", uParam1, "fHeading", uParam2, "vPos", uParam3);
}

int func_121(int iParam0, var uParam1, var uParam2, var uParam3)
{
	return func_192(iParam0, "sClosedHash", uParam1, "fClosedHeading", uParam2, "vClosedPos", uParam3);
}
...
void func_122(int iParam0, int iParam1, vector3 vParam2, float fParam5, bool bParam6)
{
	...
	(Global_1051387->f_69[iParam0 /*76*/])->f_6 = func_193(iParam1, vParam2, fParam5, 0, 0, 0);
...
bool func_123(int iParam0, int iParam1)
{
	...
	if (iParam1 && !ENTITY::DOES_ENTITY_EXIST(func_194(iParam0)))
	{
		return false;
	}
...
void func_187(int iParam0, float fParam1, int iParam2, int iParam3)
{
	if (func_114(iParam0))
	{
...
int func_192(int iParam0, char* sParam1, var uParam2, char* sParam3, var uParam4, char* sParam5, var uParam6)
{
	struct<4> Var0;
...
var func_193(int iParam0, vector3 vParam1, float fParam4, int iParam5, int iParam6, int iParam7)
{
...
int func_237(vector3 vParam0, int iParam3)
{
	...
	func_256(iParam3, &vVar0, &Var3, &fVar6);
	if (func_257(vParam0, vVar0, Var3, Var3.f_1, fVar6))
	{
		return 1;
	}
	return 0;
