#region Local Var
	...
	var uLocal_19 = 0;
	var uLocal_20 = 0;
	struct<8> Local_21 = { 0, 0, 0, 0, 0, 0, 0, -1 } ;
	var uLocal_28 = -1;
	var uLocal_29 = 0;
	var uLocal_30 = 0;
	var uLocal_31 = 0;
...
void func_90(var uParam0, bool bParam1)
{
	...
	if (!aggregate_func_4268(uParam0->f_2371.f_11) && Local_21.f_7 == -1)
	{
		Local_21.f_7 = aggregate_func_3637(uParam0->f_19, 51, uParam0->f_2371.f_11, -1);
	}
}
...
bool func_316(var uParam0, int iParam1, int iParam2, vector3 vParam3, vector3 vParam6, int iParam9, int iParam10, int iParam11)
{
	...
	aggregate_func_4242(&(uParam0->f_4), 137858);
	aggregate_func_4242(&(uParam0->f_4), 137895);
	aggregate_func_4932(&(uParam0->f_4), 137923);
	aggregate_func_4932(&(uParam0->f_4), 138458);
...
void func_332(var uParam0)
{
	...
	{
		aggregate_func_6708(uParam0, 0, 139263, 139272, 139281, 139823);
		aggregate_func_4958(uParam0, 0, 32);
	}
	aggregate_func_6708(uParam0, 1, 139263, 139272, 139281, 139823);
...
int func_338(var uParam0)
{
	if (uParam0->f_5 == 2)
	{
		if (!Local_21.f_5)
		{
			...
			{
				if (!aggregate_func_2926(Global_1051387->f_45))
				{
			...
			if (Global_1051387->f_59 != 0 && aggregate_func_4890(Global_1051387->f_59))
			{
...
int func_340(var uParam0)
{
	...
	switch (MISC::GET_RANDOM_INT_IN_RANGE(0, 4))
	{
		...
		case 1:
			...
			return 1;
		case 2:
			if (((((((aggregate_func_2827(uParam0->f_13) == 1769055947 || aggregate_func_2827(uParam0->f_13) == -839140560) || aggregate_func_2827(uParam0->f_13) == -1719060085) || aggregate_func_2827(uParam0->f_13) == -163032984) || aggregate_func_2827(uParam0->f_13) == 502936876) || aggregate_func_2827(uParam0->f_13) == -923693316) || aggregate_func_2827(uParam0->f_13) == 2016058810) || aggregate_func_2827(uParam0->f_13) == 1282123855)
			{
...
int func_341(var uParam0, bool bParam1, var uParam2)
{
	...
	switch (MISC::GET_RANDOM_INT_IN_RANGE(0, 3))
	{
		case 0:
			...
			{
				if (iVar0 == 688587926 && aggregate_func_2083())
				{
...
{
	if (!aggregate_func_6011(*uParam0) && MISC::GET_RANDOM_INT_IN_RANGE(0, 8) == 0)
	{
...
void func_407(var uParam0)
{
	...
	iVar0 = aggregate_func_2827(Global_1051387->f_59);
	switch (iVar0)
	{
		case -2101244071:
		case -1070622585:
		case -1057349201:
		case 874188557:
			if (!aggregate_func_6111(uParam0->f_4))
			{
...
void func_433(var uParam0)
{
	...
	aggregate_func_1801(&(Local_21.f_7), 0);
}
...
void func_698(var uParam0)
{
	...
	if (!MISC::IS_BIT_SET(uParam0->f_2371.f_9, 1))
	{
		...
		{
			aggregate_func_4358(uParam0, 196100);
			aggregate_func_4358(uParam0, 197021);
			aggregate_func_4358(uParam0, 197621);
			aggregate_func_4358(uParam0, 197915);
			aggregate_func_4358(uParam0, 198118);
...
int func_752(var uParam0, int iParam1)
{
	...
	{
		return aggregate_func_6708(uParam0, iParam1, 222537, 222568, 222655, 224253);
	}
	else
	{
		iVar0 = 0;
		...
		return aggregate_func_6708(uParam0, iParam1, 224463, 198228, 129034, 30756);
	}
	return 0;
}
...
void func_810(var uParam0)
{
	...
	if (aggregate_func_4278(uParam0, 16))
	{
		...
		if (!aggregate_func_4278(uParam0, 256) && ((uParam0->f_2520.f_1 == 0 && !aggregate_func_4745(uParam0->f_167.f_1757, func_1253(uParam0, uParam0->f_2520))) || !aggregate_func_4745(func_1253(uParam0, uParam0->f_2520.f_1), func_1253(uParam0, uParam0->f_2520))))
		{
	...
	if (aggregate_func_4278(uParam0, 256) && MISC::ABSI(NETWORK::GET_TIME_DIFFERENCE(uParam0->f_2520.f_2, NETWORK::GET_NETWORK_TIME_ACCURATE())) > 150)
	{
		...
		aggregate_func_30(iVar0, func_1253(uParam0, uParam0->f_2520), uParam0->f_167.f_1760, 2, 1073741824 /* Float: 2f */);
		aggregate_func_4266(uParam0, 256);
	}
	bVar2 = false;
	...
	if (uParam0->f_2520 != 0)
	{
		...
		if (!aggregate_func_4278(uParam0, 64))
		{
			if (!aggregate_func_4278(uParam0, 128) && bVar2)
			{
				...
				{
					aggregate_func_4266(uParam0, 128);
					aggregate_func_1696(iVar0, uParam0->f_2520, 2, 0, 1, func_1255(uParam0->f_2520));
					aggregate_func_4583(uParam0->f_2520.f_3, 0, 1, 1);
				}
			}
			else if (!bVar1)
		...
		if (!aggregate_func_4278(uParam0, 128) && aggregate_func_455(uParam0->f_2520.f_3, 1))
		{
			...
			aggregate_func_1696(iVar0, uParam0->f_2520, 1, 1, 1, func_1255(uParam0->f_2520));
...
int func_1047(var uParam0, var uParam1)
{
	...
	if (!aggregate_func_6021(uParam0))
	{
		aggregate_func_3190(uParam0, 4, 1945003767, 0, 0, 0);
	}
	else
	{
		aggregate_func_3190(uParam0, 4, 1945003767, aggregate_func_6022(), 1, 0);
	}
	switch (*uParam1)
	{
		case 2077448405:
			if (aggregate_func_2827(uParam1->f_9) != -999503751)
			{
			}
			else
			{
				if (aggregate_func_5372(uParam1->f_9) && uParam1->f_9 != 491602716)
				{
					iVar0 = aggregate_func_5067(uParam1->f_9);
					if ((iVar0 <= -1 || aggregate_func_5667() == uParam1->f_9) || !aggregate_func_5043(2, iVar0))
					{
						aggregate_func_3190(uParam0, 4, 904671343, 0, 0, 0);
					}
					else
					{
						aggregate_func_3190(uParam0, 4, 904671343, 1, 1, 0);
					}
				}
				if (aggregate_func_5372(uParam1->f_9) && uParam1->f_9 != 491602716)
				{
					iVar0 = aggregate_func_5067(uParam1->f_9);
					if (iVar0 <= -1 || !aggregate_func_5043(2, iVar0))
					{
						aggregate_func_3190(uParam0, 3, -1503720446 /* GXTEntry: "Rename Outfit" */, 0, 0, 1);
					}
					else
					{
						aggregate_func_3190(uParam0, 3, -1503720446 /* GXTEntry: "Rename Outfit" */, 1, 1, 1);
					}
				}
				if (aggregate_func_5667() == uParam1->f_9 || aggregate_func_5024(uParam1->f_9, 0))
				{
					aggregate_func_3190(uParam0, 2, -1208531349, 0, 0, 0);
				}
				else if (aggregate_func_5193(uParam1->f_9))
				{
					aggregate_func_3190(uParam0, 2, -1208531349, 1, 1, 0);
				}
				else
				{
					iVar0 = aggregate_func_5067(uParam1->f_9);
					if (iVar0 <= -1)
					{
						aggregate_func_3190(uParam0, 2, 920855044, aggregate_func_6023() > 0, 1, 0);
					}
					else if (uParam1->f_9 == 491602716)
					{
						if (aggregate_func_5667() == 491602716)
						{
							aggregate_func_3190(uParam0, 2, 920855044, (aggregate_func_6023() > 0 && aggregate_func_5043(2, iVar0)), 1, 0);
						}
					}
					else
					{
				...
				Jump @769; //curOff = 496
				if (aggregate_func_5636(uParam1->f_9) || aggregate_func_5024(uParam1->f_9, 0))
				{
					aggregate_func_3190(uParam0, 2, -1208531349, 0, 0, 0);
				}
				else if (aggregate_func_5193(uParam1->f_9))
				...
				{
					aggregate_func_3190(uParam0, 2, 920855044, aggregate_func_5192(-525676072, 0), 1, 0);
				}
				Jump @769; //curOff = 597
				if (aggregate_func_1500(-55206167, aggregate_func_1967(1), joaat("SLOTID_PROGRESSION"), 1, 0, 0) >= 5)
				{
					if (aggregate_func_2827(uParam1->f_9) == -2061583405)
					{
						if (aggregate_func_5024(uParam1->f_9, 0))
						{
							aggregate_func_3190(uParam0, 2, -1208531349, 0, 0, 0);
						}
						else if (aggregate_func_5193(uParam1->f_9))
						{
							aggregate_func_3190(uParam0, 2, -1208531349, uParam1->f_9 != aggregate_func_5189(1108822547), 1, 0);
						}
						else
						{
							aggregate_func_3190(uParam0, 2, 920855044, aggregate_func_5192(-2061583405, 0), 1, 0);
						}
					}
				}
				else
				{
					aggregate_func_3190(uParam0, 2, 0, 0, 0, 0);
				}
				Jump @769; //curOff = 752
				aggregate_func_3190(uParam0, 2, 0, 0, 0, 0);
			}
			if (aggregate_func_2830(uParam1->f_9) == joaat("clothing") && aggregate_func_5662(aggregate_func_2827(uParam1->f_9)))
			{
				aggregate_func_663(&(uParam0->f_2371.f_2), aggregate_func_2827(uParam1->f_9), uParam0->f_2094.f_108);
			}
			else
			{
				aggregate_func_1622(&(uParam0->f_2371.f_2), uParam0->f_2094.f_108);
			}
			if (aggregate_func_4911(uParam0) == 1256151078 && !aggregate_func_4734(64))
			{
				aggregate_func_3190(uParam0, 2, -810523886, 1, 1, 0);
			}
			return 1;
			default:
				break;
...
bool func_1199(var uParam0)
{
	...
	if (!aggregate_func_4275(uParam0))
	{
		...
		if (func_1046(uParam0, Var0.f_2, Var0.f_3, 0))
		{
			...
			aggregate_func_4358(uParam0, 325584);
			aggregate_func_4358(uParam0, 325788);
			aggregate_func_4358(uParam0, 325898);
...
bool func_1200(var uParam0)
{
	...
	if (!aggregate_func_4275(uParam0))
	{
		...
		if (func_1046(uParam0, bVar5, bVar6, 1))
		{
			...
			aggregate_func_4358(uParam0, 326603);
			aggregate_func_4358(uParam0, 326757);
			aggregate_func_4358(uParam0, 326970);
...
bool func_1201(var uParam0)
{
	...
	if (!aggregate_func_4275(uParam0))
	{
		...
		{
			aggregate_func_8078(uParam0, 173);
			aggregate_func_4358(uParam0, 327510);
			aggregate_func_4358(uParam0, 327577);
			aggregate_func_4358(uParam0, 327752);
			if (bVar0)
			{
				if (!aggregate_func_6051(uParam0, Var1.f_2, Var1.f_3, -1, 1, 1))
				{
