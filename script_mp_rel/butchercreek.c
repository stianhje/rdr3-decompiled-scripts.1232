...
void func_76(int iParam0, int iParam1, int iParam2, bool bParam3, int iParam4, int iParam5)
{
	...
	sVar1 = func_111(iParam0, iParam1, iParam2, iParam4, iParam5, bParam3, &uVar0);
	...
	else
	{
		...
		if (!MISC::_SHOULD_USE_24_HOUR_CLOCK())
		{
			...
			sVar2 = MISC::_CREATE_VAR_STRING(674, sVar8, iVar4, func_123(&sVar6, 109029619), sVar9, func_123(&sVar10, 109029619));
		}
		else
		{
			...
			IntToString(&sVar10, BUILTIN::ROUND(fVar7), 8);
			sVar2 = MISC::_CREATE_VAR_STRING(162, sVar8, iVar4, func_123(&sVar6, 109029619), func_123(&sVar10, 109029619));
		}
		Global_1893575->f_9 = 0;
	}
	Global_1938075->f_145 = func_124(sVar1, sVar2, 4000, 0, 0, 0, 0, 1);
}
...
int func_100(int iParam0)
{
	...
	(Global_1051387->f_4319[iVar6 /*7*/])->f_6 = func_146(iVar0, vVar2, fVar1, 0, 0, 0);
...
char* func_111(int iParam0, int iParam1, int iParam2, int iParam3, var uParam4, var uParam5, var uParam6)
{
	char* sVar0;
	...
	{
		sVar0 = func_162(func_161(Global_36));
	}
...
{
	func_167((Global_1938932->f_5[iParam0 /*11*/])->f_6, 1);
	func_168((Global_1938932->f_5[iParam0 /*11*/])->f_6, 0);
...
void func_130(int iParam0)
{
	...
	if (func_97((Global_1915170->f_3[iParam0 /*447*/])->f_21) && func_170((Global_1915170->f_3[iParam0 /*447*/])->f_21))
	{
		func_171((Global_1915170->f_3[iParam0 /*447*/])->f_21, 0, 1, 0, 0);
	}
	...
	func_172((Global_1915170->f_3[iParam0 /*447*/])->f_9, 0);
	...
	else
	{
		...
		while (iVar0 < iVar1)
		{
			func_175(&((Global_1915170->f_3[iParam0 /*447*/])->f_318[iVar0 /*6*/]));
...
void func_137(int iParam0)
{
	...
	else
	{
		...
		while (iVar2 < iVar3)
		{
			func_175(&((Global_1051387->f_69[iParam0 /*76*/])->f_32[iVar2]));
...
var func_146(int iParam0, vector3 vParam1, float fParam4, int iParam5, int iParam6, int iParam7)
{
...
void func_152(int iParam0, float fParam1, int iParam2, int iParam3)
{
	if (func_151(iParam0))
	{
...
{
	func_203(&((Global_1938932->f_5[iParam0 /*11*/])->f_7), iParam1);
}
...
void func_171(int iParam0, bool bParam1, int iParam2, bool bParam3, bool bParam4)
{
	int iVar0;
	int iVar1;
...
{
	return func_213((Global_1051387->f_69[iParam0 /*76*/])->f_51, iParam1);
}
