			...
			case -727924611:
				...
				else
				{
					...
					else
					{
						...
						if (func_36(Global_35, 1, 0, 0) != -1016714371)
						{
...
int func_985(int iParam0, int iParam1, int iParam2, int iParam3, bool bParam4)
{
	struct<5> Var0;
	struct<4> Var5;
	...
	return func_1011(iParam0, iParam1, &Var5, iParam2, iParam3, bParam4);
}
