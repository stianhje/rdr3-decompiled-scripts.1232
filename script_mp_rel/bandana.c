					...
					else
					{
						...
						else
						{
							...
							else
							{
								if (ENTITY::HAS_ANIM_EVENT_FIRED(uParam0->f_3, 822176400) || uParam0->f_4)
								{
									if (aggregate.bandana.func_10(uParam0->f_1) == 81053684 || aggregate.bandana.func_11(uParam0->f_1, -1348134986))
									{
								...
								else
								{
									...
									else
									{
										if (ENTITY::HAS_ANIM_EVENT_FIRED(uParam0->f_3, 822176400) || uParam0->f_4)
										{
											...
											uParam0->f_5 = aggregate.bandana.func_15();
											func_1(uParam0, 8);
										}
										Jump @886; //curOff = 715
										if (func_5(uParam0->f_5, 4000))
...
{
	if (aggregate.bandana.func_20(uParam0) == 10)
	{
		return;
	}
...
void func_6(var uParam0)
{
	...
	if (!aggregate.bandana.func_21(uParam0->f_1))
	{
		func_1(uParam0, 10);
		return;
	}
	bVar2 = false;
	bVar3 = true;
	if (aggregate.bandana.func_22(&iVar0))
	{
	...
	iVar4 = aggregate.bandana.func_10(uParam0->f_1);
	bVar5 = aggregate.bandana.func_23(&uVar1);
	if (bVar3)
	{
		iVar6 = aggregate.bandana.func_24(uParam0->f_1);
		if (iVar6 != -358215195 && aggregate.aberdeenpigfarm.func_175(uParam0->f_6, 1))
		{
			func_1(uParam0, 6);
		}
		else if (bVar2)
		{
			if (bVar5)
			{
				if (iVar4 == 81053684 || aggregate.bandana.func_11(uParam0->f_1, -1348134986))
				{
					func_1(uParam0, 4);
				}
				else
		...
		else if ((iVar4 == 81053684 || aggregate.bandana.func_11(uParam0->f_1, -1348134986)) && aggregate.aberdeenpigfarm.func_175(uParam0->f_6, 2))
		{
			func_1(uParam0, 2);
			aggregate.bandana.func_26(&(uParam0->f_6), 2);
		}
		else
		{
			func_1(uParam0, 3);
...
void func_8(int iParam0)
{
	...
	if (aggregate.bandana.func_23(&uVar1))
	{
		return;
	}
	PED::_0x2208438012482A1A(iParam0, false, false);
	...
	aggregate.bandana.func_27(iVar0, 1);
	aggregate.bandana.func_28(22, 0, 0, 0, 0);
}

int func_9(int iParam0, int iParam1, var uParam2)
{
	if (!aggregate.bandana.func_21(iParam1))
	{
		return 0;
	}
	if (!aggregate.bandana.func_29(iParam1))
	{
		return 0;
	}
	PED::_0x2208438012482A1A(iParam0, false, false);
	PED::_0xC494C76A34266E82(iParam0, 13);
	aggregate.bandana.func_26(uParam2, 1);
	aggregate.bandana.func_27(iParam1, 8);
	aggregate.bandana.func_28(22, 0, 0, 0, 0);
	return 1;
}
...
{
	if (aggregate.bandana.func_10(iParam1) != 81053684 && !aggregate.bandana.func_11(iParam1, -1348134986))
	{
		return;
	}
	PED::_0x2208438012482A1A(iParam0, false, false);
	aggregate.bandana.func_27(iParam1, 2);
	aggregate.bandana.func_28(22, 0, 0, 0, 0);
}

void func_13(int iParam0, int iParam1)
{
	if (aggregate.bandana.func_10(iParam1) != -525676072)
	{
		return;
	}
	PED::_0x2208438012482A1A(iParam0, false, false);
	...
	aggregate.bandana.func_27(iParam1, 1);
	aggregate.bandana.func_28(22, 0, 0, 0, 0);
}
...
int func_19(int iParam0, int iParam1)
{
	...
	bVar3 = aggregate.bandana.func_29(iParam0);
...
bool func_39(int iParam0)
{
	...
	iVar0 = aggregate.bandana.func_10(iParam0);
	if ((iVar0 == 81053684 || iVar0 == -525676072) || aggregate.bandana.func_11(iParam0, -1348134986))
	{
		return true;
	}
	return false;
...
void func_55(int iParam0)
{
	...
	iVar0 = aggregate.bandana.func_44(aggregate.bandana.func_48(iParam0), 1);
	if (iVar0 == 39)
	{
		return;
	}
	aggregate.bandana.func_27(&(Global_1951131->f_81[iVar0 /*12*/]), 8);
	aggregate.bandana.func_28(22, 0, 0, 0, 0);
}
