...
void func_1(var uParam0, vector3 vParam1)
{
	if (vParam1.z == 1260056893)
	{
		if (!aggregate_func_4278(uParam0, 32))
		{
			...
			vParam1.x = 0;
			aggregate_func_7269(uParam0, 32);
			if (MISC::ABSI(uParam0->f_16) <= 50)
			{
				uParam0->f_26 = aggregate_func_7952(MISC::ABSI(uParam0->f_16));
	...
	*uParam0 = 2;
	...
	uParam0->f_27 = aggregate_func_4032();
	if (uParam0->f_1 == 211)
	{
	...
	aggregate_func_1694(&(uParam0->f_30), uParam0->f_6);
	aggregate_func_3743(*uParam0, uParam0->f_1);
	uParam0->f_28 = func_18(uParam0);
	uParam0->f_5 = aggregate_func_8282(uParam0->f_28);
	uParam0->f_23 = aggregate_func_4033(0);
	uParam0->f_24 = aggregate_func_4034();
...
bool func_8(var uParam0)
{
	...
	if (aggregate_func_4278(uParam0, 16) && aggregate_func_4278(uParam0, 8))
	{
	...
	if (aggregate_func_4249(uParam0) < 10)
	{
		if (aggregate_func_4278(uParam0, 4))
		{
			...
			{
				if (aggregate_func_731(uParam0->f_6, &(uParam0->f_20), &(uParam0->f_18), &(uParam0->f_19), aggregate_func_4278(uParam0, 1), 1073741824 /* Float: 2f */))
				{
					aggregate_func_7534(*uParam0, uParam0->f_1, 16);
				}
			}
		}
		if (aggregate_func_1355(*uParam0) && func_35(uParam0))
		{
	...
	bVar2 = !aggregate_func_4278(uParam0, 16);
	if (aggregate_func_7954(aggregate_func_4278(uParam0, 2)))
	{
		...
		{
			aggregate_func_204(&(uParam0->f_30), uParam0->f_6, bVar1, bVar2, 1);
		}
	}
	...
	switch (aggregate_func_4249(uParam0))
	{
		case 0:
			...
			aggregate_func_2904(&(uParam0->f_30.f_7), uParam0->f_6, 1.5f, 1, 319, 0);
			if (aggregate_func_4278(uParam0, 16))
			{
				...
				else if (aggregate_func_53(&(uParam0->f_11), uParam0->f_12, "PBL_LOOTED", uParam0->f_6, uParam0->f_20, uParam0->f_26, uParam0->f_18, uParam0->f_23, uParam0->f_19, uParam0->f_27, aggregate_func_4278(uParam0, 1)))
				{
					aggregate_func_4242(uParam0, 12);
				}
			}
			...
			{
				if (aggregate_func_53(&(uParam0->f_11), uParam0->f_12, "PBL_LOOTED", uParam0->f_6, uParam0->f_20, uParam0->f_26, uParam0->f_18, uParam0->f_23, uParam0->f_19, uParam0->f_27, aggregate_func_4278(uParam0, 1)))
				{
		...
		case 1:
			if (((STREAMING::HAS_MODEL_LOADED(uParam0->f_23) && STREAMING::HAS_MODEL_LOADED(uParam0->f_27)) && STREAMING::HAS_MODEL_LOADED(-1456904552)) && STREAMING::HAS_MODEL_LOADED(uParam0->f_24))
			{
				...
				if (aggregate_func_4278(uParam0, 1))
				{
					...
					if (ENTITY::DOES_ENTITY_EXIST(uParam0->f_20))
					{
						ENTITY::SET_ENTITY_ROTATION(uParam0->f_20, aggregate_func_840(uParam0->f_40, 0), 2, true);
					}
				}
				if (!ENTITY::DOES_ENTITY_EXIST(uParam0->f_19))
				{
		...
		case 6:
			if (aggregate_func_2875(uParam0->f_14))
			{
				...
				if (!aggregate_func_4278(uParam0, 16))
				{
					aggregate_func_2551(uParam0->f_14, &(uParam0->f_30.f_6));
				}
		...
		case 12:
			...
			if (aggregate_func_4278(uParam0, 4))
			{
				...
				uParam0->f_25 = aggregate_func_3032(uParam0->f_5);
...
int func_12(struct<2> Param0, var uParam2, var uParam3)
{
	...
	if (TASK::_0x841475AC96E794D1(iVar2))
	{
		...
		bVar3 = iVar0 == 99;
		if (aggregate_func_4278(uParam3, 32))
		{
			iVar1 = ((*Global_1199220)[PLAYER::PLAYER_ID() /*9*/])->f_2;
		}
		else if ((iVar1 >= 200 || iVar1 == 0) || bVar3)
		{
			aggregate_func_7269(uParam3, 16);
			if (bVar3)
			{
				aggregate_func_7269(uParam3, 8);
			}
		}
...
bool func_67(var uParam0)
{
	...
	while (!aggregate_func_7957(uParam0->f_28, &uVar0))
	{
		return false;
	}
	iVar5 = aggregate_func_8282(uParam0->f_28);
	iVar4 = 0;
