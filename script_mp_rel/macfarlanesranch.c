...
void func_30(int iParam0)
{
	...
	func_58(894, iLocal_22, 1);
	func_58(889, iLocal_22, 0);
	func_58(890, iLocal_22, 0);
	func_58(891, iLocal_22, 0);
	func_58(892, iLocal_22, 0);
	func_58(893, iLocal_22, 0);
	VOLUME::_0x4A8FEFC43FD8AC9B(iLocal_22, 3, 1);
	VOLUME::_0x53D05D60E5F5B40C(iLocal_22, 3, 1, func_59(893));
	VOLUME::_0x53D05D60E5F5B40C(iLocal_22, 3, 1, func_59(889));
	VOLUME::_0x53D05D60E5F5B40C(iLocal_22, 3, 1, func_59(890));
	VOLUME::_0x53D05D60E5F5B40C(iLocal_22, 3, 1, func_59(891));
	VOLUME::_0x53D05D60E5F5B40C(iLocal_22, 3, 1, func_59(892));
}
...
void func_41(var uParam0, int iParam1)
{
	...
	if ((BUILTIN::VDIST(Global_36, 0f, 0f, 0f) <= 5f || func_65(&Global_1939168, 32768)) || func_65(&Global_1939168, 16777216))
	{
		return;
	}
			...
			case 1:
				if (VOLUME::_0x92A78D0BEDB332A3(uParam0[iVar3 /*3*/]))
				{
					if (VOLUME::_0xF256A75210C5C0EB(uParam0[iVar3 /*3*/], Global_36))
					{
						if (!bVar1 && !bVar2)
						{
							if ((!func_68((*uParam0)[iVar3 /*3*/], 1) && func_69(iParam1)) && !func_70(iParam1, 16))
							{
								func_72(iParam1, func_71(), -1, 0, -1, 0);
								func_73((*uParam0)[iVar3 /*3*/], 1);
							}
							func_74(iParam1, 0);
						}
						bVar0 = true;
...
int func_44(int iParam0)
{
	if (iParam0 == 0)
	{
		...
		if (STATS::CHAL_IS_GOAL_ACTIVE(-663946200, 1055032020))
		{
			switch (iLocal_30)
			{
				...
				case 127:
				case 135:
					STATS::CHAL_ADD_GOAL_PROGRESS_INT_BY_SCORE_ID(func_78(iLocal_30, 0), 1);
					break;
			}
		}
		if (func_10(func_71()))
	...
	else if (func_45() == -1)
	{
		func_82(iLocal_30);
		func_83(iLocal_30);
		if (!func_84(iLocal_30, 0))
		{
			return 0;
		}
	}
	else if (!func_85(iLocal_30))
	{
		return 0;
	}
	SCRIPTS::TERMINATE_THIS_THREAD();
...
int func_53(int iParam0, int iParam1, int iParam2, bool bParam3)
{
	...
	if (func_89(iParam0, &iVar0, &iVar1, 0, 0))
	{
		...
		while (true)
		{
			if ((!func_87(iParam0) || func_88(iParam0)) || func_91(&Global_1896608))
			{
				func_92(&Global_1896608, 0);
			}
...
void func_60(float fParam0, float fParam1, float fParam2, float fParam3)
{
...
bool func_67()
{
	return func_65(&Global_1939168, 8192);
}
...
bool func_69(int iParam0)
{
	...
	return ((((*Global_1887327)[iParam0 /*36*/])->f_21 == 1 || ((*Global_1887327)[iParam0 /*36*/])->f_21 == 2) && !func_96(iParam0));
}
...
void func_72(int iParam0, int iParam1, int iParam2, bool bParam3, int iParam4, bool bParam5)
{
	bool bVar0;
	char* sVar1;
	char* sVar2;
	...
	sVar1 = func_98(iParam0, iParam1, iParam2, iParam4, bParam5, bParam3, &bVar0);
	...
	if (func_99(iParam4))
	{
		iVar3 = func_101(iParam4);
	}
	if (bVar0 && bParam3)
	{
		sVar2 = func_103(func_102(iParam2));
	}
	else if ((func_104(iParam1, 2) || func_105(iParam4, 2)) && !Global_1893575->f_9)
	{
	...
	else if ((func_62(iParam0) && func_86(iParam0, 16777216)) && !Global_1893575->f_9)
	{
	...
	{
		iVar4 = func_107(func_106());
		iVar5 = func_108(func_106());
		if (iVar5 < 10)
		{
		...
		if (!MISC::_SHOULD_USE_24_HOUR_CLOCK())
		{
			...
			{
				fVar7 = func_109(fVar7);
				sVar8 = "TIME_AND_TEMP_F";
			}
			IntToString(&cVar10, BUILTIN::ROUND(fVar7), 8);
			sVar2 = MISC::_CREATE_VAR_STRING(674, sVar8, iVar4, func_110(&cVar6, joaat("COLOR_PURE_WHITE")), sVar9, func_110(&cVar10, joaat("COLOR_PURE_WHITE")));
		}
		else
		{
			...
			IntToString(&cVar10, BUILTIN::ROUND(fVar7), 8);
			sVar2 = MISC::_CREATE_VAR_STRING(162, sVar8, iVar4, func_110(&cVar6, joaat("COLOR_PURE_WHITE")), func_110(&cVar10, joaat("COLOR_PURE_WHITE")));
		}
		Global_1893575->f_9 = 0;
	}
	Global_1938075->f_145 = func_111(sVar1, sVar2, 4000, 0, 0, 0, 0, 1);
}
...
void func_74(int iParam0, bool bParam1)
{
	...
	func_21(iParam0, 32);
	func_113(Global_1939168, 16384);
	func_115(func_114(-1532769513, joaat("areas")), 1);
	switch (func_9(iParam0))
	{
		case 0:
		case 2:
		case 11:
			func_115(func_114(-1532769513, 213519508), 1);
			break;
		case 1:
		case 5:
		case 6:
		case 7:
		case 12:
			func_115(func_114(-1532769513, 242571679), 1);
			break;
		case 3:
		case 10:
			func_115(func_114(-1532769513, 1349449307), 1);
			break;
		case 4:
		case 9:
			func_115(func_114(-1532769513, 1140362070), 1);
			break;
		case 8:
			func_115(func_114(-1532769513, -172330899), 1);
			break;
		case 13:
		case 14:
		case 15:
		case 16:
			func_115(func_114(-1532769513, -910218296), 1);
			break;
	}
	switch (iParam0)
	{
...
int func_84(int iParam0, bool bParam1)
{
	...
	if (func_89(iParam0, &iVar0, &iVar1, 0, 0))
	{
		...
		while (true)
		{
			if (!func_119(Global_1896608->f_1, 16))
			{
				func_120(Global_1896608->f_1, 0);
			}
			Global_1896608->f_1++;
			iVar2++;
...
int func_85(int iParam0)
{
	...
	while (iVar0 < 39)
	{
		if (func_121(iVar0) || func_122(iVar0))
		{
		}
		else
		{
...
int func_92(int iParam0, bool bParam1)
{
	...
	if (func_119(iParam0, 32) && !bParam1)
	{
		...
		if (func_45() == -1)
		{
			...
			{
				_NAMESPACE48::_0x49A8C2CD97815215(func_59(iParam0));
				func_128(iParam0, 2048);
			}
			_NAMESPACE48::_0xFCC6DB8DBE709BC8(func_59(iParam0));
		}
		return 0;
	}
	...
	if (_NAMESPACE48::_0x800DF3FC913355F3(func_59(iParam0)))
	{
		func_128(iParam0, 128);
		return 1;
	}
	func_127(iParam0, _NAMESPACE48::_0x4F76E3676583D951(func_126(iParam0)));
	_NAMESPACE48::_0x4F81EAD1DE8FA19B(func_59(iParam0));
	if (func_119(iParam0, 2048))
	{
		_NAMESPACE48::_0x49A8C2CD97815215(func_59(iParam0));
		func_128(iParam0, 2048);
...
bool func_93(int iParam0, bool bParam1)
{
	...
	return !_NAMESPACE48::_0xEB98B38CA60742D7(func_59(iParam0));
}
...
char* func_98(int iParam0, int iParam1, int iParam2, int iParam3, bool bParam4, bool bParam5, var uParam6)
{
	char* sVar0;

	if (!MISC::IS_STRING_NULL_OR_EMPTY(&(Global_1893575->f_162)))
	{
		sVar0 = func_134(Global_1893575->f_162);
	}
...
int func_101(int iParam0)
{
	...
	iVar0 = 0;
	Var1 = { func_139(PLAYER::PLAYER_ID()) };
...
char* func_110(char* sParam0, int iParam1)
{
	...
	return func_140(MISC::_CREATE_VAR_STRING(10, "LITERAL_STRING", sParam0), iParam1);
}

var func_111(char* sParam0, char* sParam1, int iParam2, int iParam3, int iParam4, int iParam5, int iParam6, int iParam7)
{
	struct<4> Var0;
	vector3 vVar13;
	var uVar16;
...
{
	func_141((Global_1938932->f_5[iParam0 /*11*/])->f_6, 1);
	func_142((Global_1938932->f_5[iParam0 /*11*/])->f_6, 0);
...
void func_118(int iParam0)
{
	...
	if (func_90((Global_1915170->f_3[iParam0 /*447*/])->f_21) && func_144((Global_1915170->f_3[iParam0 /*447*/])->f_21))
	{
		func_145((Global_1915170->f_3[iParam0 /*447*/])->f_21, 0, 1, 0, 0);
	}
	...
	func_146((Global_1915170->f_3[iParam0 /*447*/])->f_9, 0);
	...
	else
	{
		...
		while (iVar0 < iVar1)
		{
			func_149(&((Global_1915170->f_3[iParam0 /*447*/])->f_318[iVar0 /*6*/]));
...
int func_120(int iParam0, bool bParam1)
{
	...
	func_152(iParam0);
	_NAMESPACE48::_0xFC77C5B44D5FF7C0(func_59(iParam0));
	func_127(iParam0, 0);
	return 1;
}
...
void func_125(int iParam0)
{
	...
	if (func_157(iParam0, 16384) && !bVar0)
	{
	...
	if (func_157(iParam0, 262144) && !bVar0)
	{
	...
	else
	{
		...
		while (iVar2 < iVar3)
		{
			func_149(&((Global_1051387->f_69[iParam0 /*76*/])->f_32[iVar2]));
	...
	if (VOLUME::_0x92A78D0BEDB332A3((Global_1051387->f_69[iParam0 /*76*/])->f_25) && func_163(iParam0, 2))
	{
...
char* func_134(var uParam0, var uParam1, var uParam2, var uParam3, var uParam4, var uParam5, var uParam6, var uParam7)
{
...
{
	func_171(&((Global_1938932->f_5[iParam0 /*11*/])->f_7), iParam1);
}
...
void func_145(int iParam0, bool bParam1, bool bParam2, bool bParam3, bool bParam4)
{
	int iVar0;
	int iVar1;
...
{
	return func_182((Global_1051387->f_69[iParam0 /*76*/])->f_51, iParam1);
}
...
int func_164()
{
	...
	if (!func_166(*Global_1051163) && Global_1572887->f_7 & 1 != 0)
	{
		return 1;
	}
	return 0;
...
int func_168(vector3 vParam0, int iParam3)
{
	vector3 vVar0;
	struct<2> Var3;
	var uVar6;

	func_185(iParam3, &vVar0, &Var3, &uVar6);
	if (func_186(vParam0, vVar0, Var3, Var3.f_1, uVar6))
	{
		return 1;
	}
	return 0;
...
bool func_186(vector3 vParam0, vector3 vParam3, float fParam6, float fParam7, float fParam8)
{
	vector3 vVar0;
	struct<2> Var3;
	float fVar6;
