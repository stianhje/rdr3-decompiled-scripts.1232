...
void func_41(var uParam0, int iParam1)
{
	...
	if ((BUILTIN::VDIST(Global_36, 0f, 0f, 0f) <= 5f || func_75(&Global_1939168, 32768)) || func_75(&Global_1939168, 16777216))
	{
		return;
	}
...
void func_59(int iParam0, vector3 vParam1, int iParam4, int iParam5)
{
	...
	(Global_1938932->f_5[iParam0 /*11*/])->f_6 = func_105(iParam5, iParam0);
}
...
void func_60(int iParam0, int iParam1, int iParam2, int iParam3, int iParam4, int iParam5, bool bParam6, bool bParam7, float fParam8, int iParam9)
{
	...
	(Global_1051387->f_69[iParam0 /*76*/])->f_18 = func_110(iParam2, iParam0);
	...
	(Global_1051387->f_69[iParam0 /*76*/])->f_64 = func_111((Global_1051387->f_69[iParam0 /*76*/])->f_18);
...
void func_61(int iParam0, int iParam1, float fParam2, bool bParam3)
{
	...
	(Global_1051387->f_69[iParam0 /*76*/])->f_32[iVar0] = func_116(iParam1, 0, 0);
	if (func_117(&((Global_1051387->f_69[iParam0 /*76*/])->f_32[iVar0])))
	{
		if (!func_118(&((Global_1051387->f_69[iParam0 /*76*/])->f_32[iVar0])))
		{
			func_119(&((Global_1051387->f_69[iParam0 /*76*/])->f_32[iVar0]), 0, fParam2, bParam3, 1, 0, 0, 0);
		}
	}
...
{
	func_120(&((Global_1051387->f_69[iParam0 /*76*/])->f_50), iParam1);
}
...
int func_63(int iParam0, bool bParam1)
{
	...
	if ((func_121(iParam0, 16384) || func_121(iParam0, 32768)) || func_103((Global_1051387->f_69[iParam0 /*76*/])->f_3))
	{
...
void func_65(int iParam0)
{
	...
	if (func_123(&(Global_1051387->f_3582[iVar0 /*19*/]), &iVar1, &fVar2, &vVar3))
	{
		(Global_1051387->f_3582[iVar0 /*19*/])->f_6 = func_132(iVar1, vVar3, fVar2, 0, 0, 0);
	...
	iVar6 = func_133(&(Global_1051387->f_3582[iVar0 /*19*/]));
	bVar7 = iVar6 != -1;
	if (bVar7)
	{
		(Global_1051387->f_3582[iVar0 /*19*/])->f_9 = iVar6;
		if (func_123(iVar6, &iVar1, &fVar2, &vVar3))
		{
			(Global_1051387->f_3582[iVar0 /*19*/])->f_13 = func_132(iVar1, vVar3, fVar2, 0, 0, 0);
	...
	(Global_1051387->f_3582[iVar0 /*19*/])->f_5 = func_111(&(Global_1051387->f_3582[iVar0 /*19*/]));
	if (!func_130(30, 4))
	{
		func_113(30, 4);
		func_114(30);
...
bool func_77()
{
	return func_75(&Global_1939168, 8192);
}
...
void func_82(int iParam0, int iParam1, int iParam2, bool bParam3, int iParam4, int iParam5)
{
	...
	sVar1 = func_142(iParam0, iParam1, iParam2, iParam4, iParam5, bParam3, &uVar0);
	...
	else
	{
		...
		if (!MISC::_SHOULD_USE_24_HOUR_CLOCK())
		{
			...
			sVar2 = MISC::_CREATE_VAR_STRING(674, sVar8, iVar4, func_154(&sVar6, 109029619), sVar9, func_154(&sVar10, 109029619));
		}
		else
		{
			...
			IntToString(&sVar10, BUILTIN::ROUND(fVar7), 8);
			sVar2 = MISC::_CREATE_VAR_STRING(162, sVar8, iVar4, func_154(&sVar6, 109029619), func_154(&sVar10, 109029619));
		}
		Global_1893575->f_9 = 0;
	}
	Global_1938075->f_145 = func_155(sVar1, sVar2, 4000, 0, 0, 0, 0, 1);
}
...
int func_99(int iParam0, var uParam1, var uParam2, bool bParam3, bool bParam4)
{
	bool bVar0;
...
{
	func_170((Global_1938932->f_5[iParam0 /*11*/])->f_6, 1);
	func_171((Global_1938932->f_5[iParam0 /*11*/])->f_6, 0);
...
void func_108(bool bParam0, bool bParam1)
{
	...
	func_181(Global_1099293->f_516, 36);
	func_182(Global_1099293->f_555, 36);
}
...
void func_109(int iParam0)
{
	...
	else
	{
		...
		while (iVar2 < iVar3)
		{
			func_184(&((Global_1051387->f_69[iParam0 /*76*/])->f_32[iVar2]));
...
int func_111(int iParam0)
{
	...
	{
		Global_1051387->f_4360[iParam0] = func_188(iParam0);
	}
...
void func_119(int iParam0, bool bParam1, float fParam2, bool bParam3, bool bParam4, float fParam5, int iParam6, bool bParam7)
{
	func_116(iParam0, 0, 0);
	if (func_117(iParam0))
	{
...
bool func_123(int iParam0, int iParam1, float fParam2, var uParam3)
{
	return func_195(iParam0, "sHash", iParam1, "fHeading", fParam2, "vPos", uParam3);
}

int func_124(int iParam0, int iParam1, float fParam2, var uParam3)
{
	return func_195(iParam0, "sClosedHash", iParam1, "fClosedHeading", fParam2, "vClosedPos", uParam3);
}
...
void func_125(int iParam0, int iParam1, vector3 vParam2, float fParam5, bool bParam6)
{
	...
	(Global_1051387->f_69[iParam0 /*76*/])->f_6 = func_132(iParam1, vParam2, fParam5, 0, 0, 0);
...
var func_132(int iParam0, vector3 vParam1, float fParam4, int iParam5, int iParam6, int iParam7)
{
...
bool func_135(int iParam0, int iParam1)
{
	...
	if (iParam1 && !ENTITY::DOES_ENTITY_EXIST(func_197(iParam0)))
	{
		return false;
	}
...
char* func_142(int iParam0, int iParam1, int iParam2, int iParam3, var uParam4, var uParam5, var uParam6)
{
	char* sVar0;
	...
	{
		sVar0 = func_203(func_202(Global_36));
	}
...
void func_160(int iParam0)
{
	...
	if (func_100((Global_1915170->f_3[iParam0 /*447*/])->f_21) && func_208((Global_1915170->f_3[iParam0 /*447*/])->f_21))
	{
		func_209((Global_1915170->f_3[iParam0 /*447*/])->f_21, 0, 1, 0, 0);
	}
	...
	func_210((Global_1915170->f_3[iParam0 /*447*/])->f_9, 0);
	...
	else
	{
		...
		while (iVar0 < iVar1)
		{
			func_184(&((Global_1915170->f_3[iParam0 /*447*/])->f_318[iVar0 /*6*/]));
...
{
	func_216(&((Global_1938932->f_5[iParam0 /*11*/])->f_7), iParam1);
}
...
{
	if (func_218(&(Global_1099293->f_4), iParam0, 5))
	{
		return 1;
	}
	return 0;
...
void func_177(int iParam0, bool bParam1, int iParam2, int iParam3)
{
	func_219(iParam0);
	if (!func_220(1))
	{
...
{
	if (func_225(&(Global_1099293->f_4), iParam0, 5))
	{
		return 1;
	}
	return 0;
...
{
	return func_227((Global_1051387->f_69[iParam0 /*76*/])->f_51, iParam1);
}
...
int func_188(int iParam0)
{
	...
	if (DATAFILE::_0x603AC35FD4602C76(Global_1131373->f_7) && !func_229(12, func_228(iParam0), &vVar0))
	{
		return 0;
	}
	return vVar0.z;
...
void func_190(int iParam0, float fParam1, int iParam2, int iParam3)
{
	if (func_117(iParam0))
	{
...
int func_195(int iParam0, char* sParam1, var uParam2, char* sParam3, float fParam4, char* sParam5, var uParam6)
{
	struct<4> Var0;
...
int func_217(int iParam0, int iParam1)
{
	...
	if (iParam1 == 255)
	{
		return func_246(&(Global_1099293->f_4), iVar0, 5);
	}
	if (iParam1 == func_247())
	{
		return func_246(&(Global_1099293->f_4), iVar0, 5);
	...
	{
		return func_246(&(((*Global_1097609)[iParam1 /*51*/])->f_4), iVar0, 5);
	}
	return 0;
}
...
int func_229(int iParam0, var uParam1, var uParam2)
{
	...
	if (func_249(iParam0, uParam1, &iVar0))
	{
		func_250(&iVar0, iParam0, uParam2);
	}
	else
	{
		return 0;
...
int func_236(vector3 vParam0, int iParam3)
{
	...
	func_254(iParam3, &vVar0, &Var3, &fVar6);
	if (func_255(vParam0, vVar0, Var3, Var3.f_1, fVar6))
	{
		return 1;
	}
	return 0;
