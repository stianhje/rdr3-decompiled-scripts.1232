...
void func_30()
{
	...
	else if (!func_126())
	{
		func_102(1);
		func_124(1);
		func_115(func_127(33, 1), 0f, -1082130432, -1082130432, 1, 1, 1);
	}
	else if (!func_128())
	{
		func_102(1);
	...
	else
	{
		func_102(1);
		func_124(1);
		func_115(func_127(func_129(Global_1070355->f_26827.f_2), 1), 0f, -1082130432, -1082130432, 1, 1, 1);
	}
...
void func_65()
{
	...
	if (!bVar223)
	{
		if (NETWORK::_0xAADED99A6B268A27() || iVar0)
		{
...
void func_80(var uParam0)
{
	...
	if (func_230())
	{
		if (((!func_82(8) && !STREAMING::_0xCF45DF50C7775F2A()) && !func_231(-1562607865)) || uParam0)
		{
			func_232(-1562607865);
			func_83(8);
		}
...
int func_88(char* sParam0, int iParam1, int iParam2)
{
	...
	{
		Global_1051202->f_16[iParam1] = BUILTIN::START_NEW_SCRIPT(sParam0, iParam2);
...
int func_101(vector3 vParam0, bool bParam3)
{
	...
	return func_245(vParam0, bParam3);
}
...
void func_104(int iParam0, bool bParam1)
{
	...
	func_115(Var30.f_6, Var30, -1082130432, -1082130432, 1, 1, 1);
	if (bParam1)
	{
		func_246(0);
	}
...
void func_115(vector3 vParam0, float fParam3, float fParam4, float fParam5, bool bParam6, int iParam7, int iParam8)
{
	vector3 vVar0;
	float fVar3;
	...
	fVar3 = fParam3;
	if (!func_100(&vVar0, &fVar3, 1))
	{
		vVar0 = { ENTITY::GET_ENTITY_COORDS(PLAYER::PLAYER_PED_ID(), false, false) };
		fVar3 = fParam3;
	}
	func_253(vParam0, fParam3, vVar0, fVar3, fParam4, fParam5, bParam6, iParam7, iParam8, 1);
}
...
void func_156()
{
	if (!func_59(Global_1572887->f_7, 1073741824))
	{
		return;
	}
	func_57(&(Global_1572887->f_7), 1073741824);
	if (func_289())
	{
		if (func_17())
		{
						...
						else
						{
							...
							else
							{
								...
								else
								{
									...
									{
										func_374(func_373());
										func_377(func_376(773203532, func_375(1), 1084182731, 1, 0, 0));
										func_379(func_378(0));
										func_380(func_378(7));
										func_381();
										if (func_355(32))
									...
									else
									{
										...
										if (iVar1 > 0)
										{
											func_387(MISC::_CREATE_VAR_STRING(2, "FEED_MONEY_EARN", iVar1), "ITEMTYPE_TEXTURES", 1831944558, 0, 109029619, 0, 0, 0, 1);
										}
										iVar1 = (func_376(773203532, func_375(1), 1084182731, 1, 0, 0) - func_388());
										if (iVar1 > 0)
										{
										...
										if (iVar1 > 0)
										{
											func_387(MISC::_CREATE_VAR_STRING(2, "PLAYER_RPG_XP_GAIN", iVar1), "itemtype_textures", 1088654639, 0, 109029619, "Transaction_Feed_Sounds", "Transaction_Positive", 0, 1);
										}
										iVar1 = (func_378(7) - func_392());
										if (iVar1 > 0)
										{
											func_387(MISC::_CREATE_VAR_STRING(2, "NET_TRADE_BOUNTY_HUNTER_XP", iVar1), "itemtype_textures", 1088654639, 0, 109029619, "Transaction_Feed_Sounds", "Transaction_Positive", 0, 1);
										}
										if (func_367() != 0)
										{
											func_356(11);
...
struct<19> func_234(bool bParam0)
{
	...
	Var19 = { func_471(-1838434463, func_375(1), 1084182731, 1) };
...
void func_253(vector3 vParam0, float fParam3, vector3 vParam4, float fParam7, float fParam8, float fParam9, bool bParam10, var uParam11, var uParam12, int iParam13)
{
	if (func_146(255) == 4)
	{
		return;
...
int func_262(vector3 vParam0, var uParam3)
{
	if (func_97(vParam0))
	{
		return 0;
...
var func_272(char* sParam0, int iParam1, int iParam2, int iParam3, int iParam4, int iParam5)
{
	struct<4> Var0;
	struct<2> Var13;
	var uVar15;
...
void func_297()
{
	...
	if (func_523(8, 255))
	{
		...
		{
			Global_1273516->f_61 = func_525("STORY_COOP_TRANSITION_CANCEL", 992265328, 2, 0, 1, 4, 570, 4000, 10, 1073741824, 1704213876, 0);
		}
	...
	{
		Global_1273516->f_60 = func_525("STORY_COOP_TRANSITION_CONFIRM", -473983589, 2, 0, 1, 4, 570, 4000, 10, 1073741824, 1704213876, 0);
	}
...
void func_315(int iParam0)
{
	...
	while (iVar0 <= (iParam0 - 1))
	{
		...
		if (func_579(iVar6))
		{
			...
			if (iVar13 == 15)
			{
				if (UNK_0xE145864DECC34219(iVar16))
				{
					UNK_0x957A830C9B4B99EA(iVar16, 0);
				}
			}
			else if (!UNK_0xE145864DECC34219(iVar16))
			{
				UNK_0x957A830C9B4B99EA(iVar16, 1);
			}
		}
		else
		{
...
struct<8> func_330(int iParam0)
{
	...
	if (!func_590(&iVar0, 13, 0, 0, 1))
	{
		return Var5;
	}
	if (!func_590(&iVar0, 17, 0, 0, 1))
	{
		return Var5;
	}
	if (!func_590(&iVar0, 19, iParam0, 0, 1))
	{
		return Var5;
	}
	if (!func_590(&iVar0, 53, 0, 0, 1))
	{
		return Var5;
	}
	if (!func_590(&iVar0, 54, 0, 0, 1))
	{
		return Var5;
	}
	return func_591(&iVar0, 59, 1);
}
...
void func_351(int iParam0, int iParam1, int iParam2, int iParam3, bool bParam4, int iParam5, int iParam6)
{
	struct<4> Var0;
...
{
	Global_1274070->f_374.f_14 = uParam0;
}
...
struct<4> func_375(bool bParam0)
{
	...
	if (Global_1572887->f_13 == 0)
	{
		...
		if (iVar0 == 2)
		{
			...
			{
				*Global_1270479 = { func_471(1328661203, func_658(), -1591664384, bParam0) };
			}
		...
		else if (iVar0 == 3)
		{
			...
			{
				Global_1270479->f_12 = { func_471(1328661203, func_658(), -1591664384, 0) };
			}
			return Global_1270479->f_12;
		}
	}
	return func_471(1328661203, func_658(), -1591664384, bParam0);
}

int func_376(int iParam0, struct<4> Param1, int iParam5, bool bParam6, bool bParam7, int iParam8)
{
	int iVar0;
	struct<4> Var1;
	...
	if (!bParam7 && func_660(iParam0, -455129387) == 0)
	{
		bParam7 = true;
	}
	iVar0 = 0;
	if (bParam7)
	{
		...
		iVar0 = INVENTORY::_0xC97E0D2302382211(func_472(bParam6), &Var1, iParam8);
	}
	else
	{
		iVar0 = INVENTORY::_0xE787F05DFC977BDE(func_472(bParam6), iParam0, iParam8);
	}
	return iVar0;
}
...
{
	Global_1274070->f_374.f_15 = uParam0;
}
...
int func_378(int iParam0)
{
	...
	switch (iParam0)
	{
		...
		case 17:
			...
			if (func_659(iVar0, 0))
			{
				return func_376(iVar0, func_375(1), -1990194462, 1, 0, 0);
			}
			break;
	}
	return 0;
...
{
	Global_1274070->f_374.f_12 = uParam0;
}

void func_380(var uParam0)
{
	Global_1274070->f_374.f_13 = uParam0;
}
...
int func_441(int iParam0)
{
	...
	switch (iVar0)
	{
		...
		case -510945576:
			...
			break;
		case 1238086793:
			if (!func_697(-414301703, 1120403456, 1133084672))
			{
				return 0;
			}
			break;
		case -1344601768:
			if (!func_697(728379187, 1120403456, 1133084672))
			{
				return 0;
			}
			break;
		case 1302228510:
			if (!func_697(-1809365172, 1120403456, 1133084672))
			{
				return 0;
			}
			else if (func_698())
			...
			break;
		case -460024530:
			if (!func_697(1092530042, 1120403456, 1133084672))
			{
				return 0;
			}
			break;
		case -108780030:
			if (!func_697(-2051059045, 1120403456, 1133084672))
			{
				return 0;
			}
			break;
		case 1698972798:
			if (!func_697(-1408478050, 1120403456, 1133084672))
			{
				return 0;
			}
			break;
		case -1340339190:
			if (!func_697(-612173099, 1120403456, 1133084672))
			{
				return 0;
			}
			break;
		case -1296807958:
			if (!func_697(-1974746920, 1120403456, 1133084672))
			{
				return 0;
			}
			break;
		case -1283202000:
			if (!func_697(1171226610, 1120403456, 1133084672))
			{
				return 0;
			}
			break;
		case -1610966108:
			if (!func_697(406701199, 1120403456, 1133084672))
			{
				return 0;
			}
			break;
		case -693828600:
			if (!func_697(1502951187, 1120403456, 1133084672))
			{
				return 0;
			}
			break;
		case 1321892118:
			if (!func_697(-1151968796, 1120403456, 1133084672))
			{
				return 0;
			}
			break;
		case -61411516:
			if (!func_697(1975720265, 1120403456, 1133084672))
			{
				return 0;
			}
			break;
		case 582380806:
			if (!func_697(508578717, 1120403456, 1133084672))
			{
				return 0;
			}
			break;
		case 1932172605:
			if (!func_697(-848533860, 1120403456, 1133084672))
			{
				return 0;
			}
			break;
		case 1159471771:
			if (!func_697(830856441, 1120403456, 1133084672))
			{
				return 0;
			}
			break;
		case 784360470:
			if (!func_697(-522767301, 1120403456, 1133084672))
			{
				return 0;
			}
			break;
		case 1881028477:
			if (!func_697(-2103414139, 1120403456, 1133084672))
			{
				return 0;
			}
			break;
		case 1703398561:
			if (!func_697(771896020, 1120403456, 1133084672))
			{
				return 0;
			}
			break;
		case -1209597203:
			if (!func_697(895825612, 1120403456, 1133084672))
			{
				return 0;
			}
			break;
		case -897750037:
			if (!func_697(1256749990, 1120403456, 1133084672))
			{
				return 0;
			}
			break;
		case 929582877:
			if (!func_697(-1934886317, 1120403456, 1133084672))
			{
				return 0;
			}
			break;
		case -911126844:
			if (!func_697(993438435, 1120403456, 1133084672))
			{
				return 0;
			}
			break;
		case -355531636:
			if (!func_697(1495728629, 1120403456, 1133084672))
			{
				return 0;
			}
			break;
		case -1455998786:
			if (!func_697(967935536, 1120403456, 1133084672))
			{
				return 0;
			}
			break;
		case -851626677:
			if (!func_697(-773956478, 1120403456, 1133084672))
			{
				return 0;
			}
			break;
		case -734416508:
			if (!func_697(-1615749463, 1120403456, 1133084672))
			{
				return 0;
			}
			break;
		case -396624371:
			if (!func_697(-361709910, 1120403456, 1133084672))
			{
				return 0;
			}
			break;
		case 885777893:
			if (!func_697(-1323334072, 1120403456, 1133084672))
			{
				return 0;
			}
			break;
		case 619839857:
			if (!func_697(-1521897637, 1120403456, 1133084672))
			{
				return 0;
			}
			break;
		case 2113625508:
			if (!func_697(-716370751, 1120403456, 1133084672))
			{
				return 0;
			}
			break;
		case 1549124796:
			if (!func_697(-2053832767, 1120403456, 1133084672))
			{
				return 0;
			}
			break;
		case -502473159:
			if (!func_697(372806894, 1120403456, 1133084672))
			{
				return 0;
			}
			break;
		case 229371495:
			if (!func_697(-1534577778, 1120403456, 1133084672))
			{
				return 0;
			}
			break;
		case -781631220:
			if (!func_697(-2024941402, 1120403456, 1133084672))
			{
				return 0;
			}
			break;
		case 1708045337:
			if (!func_697(-50297425, 1120403456, 1133084672))
			{
				return 0;
			}
			break;
		case 1166612791:
			if (!func_697(536714458, 1120403456, 1133084672))
			{
				return 0;
			}
			break;
		case 74872959:
			if (!func_697(2068117822, 1120403456, 1133084672))
			{
				return 0;
			}
			break;
		case 1744443559:
			if (!func_697(-576687258, 1120403456, 1133084672))
			{
				return 0;
			}
			break;
		case 509781469:
			if (!func_697(226557169, 1120403456, 1133084672))
			{
				return 0;
			}
			break;
		case 885378256:
			if (!func_697(476687617, 1120403456, 1133084672))
			{
				return 0;
			}
			break;
		case -524787708:
			if (!func_697(1856368424, 1120403456, 1133084672))
			{
				return 0;
			}
			break;
		case -1861414976:
			if (!func_697(568096966, 1120403456, 1133084672))
			{
				return 0;
			}
			break;
		case 747514327:
			if (!func_697(1104817207, 1120403456, 1133084672))
			{
				return 0;
			}
			break;
		case -1042021329:
			if (!func_697(478888800, 1120403456, 1133084672))
			{
				return 0;
			}
			break;
		case -591815673:
			if (!func_697(1955414013, 1120403456, 1133084672))
			{
				return 0;
			}
			break;
		case 883901517:
			if (!func_697(-1207218596, 1120403456, 1133084672))
			{
				return 0;
			}
			break;
		case 1561093093:
			if (!func_697(-116967529, 1120403456, 1133084672))
			{
				return 0;
			}
			break;
		case 1287917122:
			if (!func_697(-605808708, 1120403456, 1133084672))
			{
				return 0;
			}
			break;
		case -1943367752:
			if (!func_697(-100150000, 1120403456, 1133084672))
			{
				return 0;
			}
			break;
		case -371827125:
			if (!func_697(-320403109, 1120403456, 1133084672))
			{
				return 0;
			}
			break;
		case -889906510:
			if (!func_697(18369533, 1120403456, 1133084672))
			{
				return 0;
			}
			break;
		case 64896505:
			if (!func_697(-331965904, 1120403456, 1133084672))
			{
				return 0;
			}
			break;
		case -1161687045:
			if (!func_697(127191252, 1120403456, 1133084672))
			{
				return 0;
			}
			break;
		case 526003171:
			if (!func_697(-2074957003, 1120403456, 1133084672))
			{
				return 0;
			}
			break;
		case -895073533:
			if (!func_697(-1226747327, 1120403456, 1133084672) || !func_697(-141795616, 1120403456, 1133084672))
			{
				return 0;
			}
			break;
		case -2066272360:
			if (!func_697(-1973910443, 1120403456, 1133084672))
			{
				return 0;
			}
			break;
		case 93964309:
			if (!func_697(1707200698, 1120403456, 1133084672))
			{
				return 0;
			}
			break;
		case 2103908624:
			if (!func_697(1883767827, 1120403456, 1133084672))
			{
				return 0;
			}
			break;
		...
		case 2127412005:
			...
			if (iVar1 != -1554566073)
			{
				if (!func_697(iVar1, 1120403456, 1133084672))
				{
					return 0;
				}
			}
			...
			break;
		case -812641169:
			if (!func_697(104287396, 1120403456, 1133084672))
			{
				return 0;
			}
			break;
		case -554519756:
			if (!func_697(715920781, 1120403456, 1133084672))
			{
				return 0;
			}
			break;
		case 865557632:
			if (!func_697(-900541220, 1120403456, 1133084672))
			{
				return 0;
			}
			break;
		case 1112996351:
			if (!func_697(-1199296193, 1120403456, 1133084672))
			{
				return 0;
			}
			break;
		case -1608141409:
			if (!func_697(546408124, 1120403456, 1133084672))
			{
				return 0;
			}
			break;
		case -311373772:
			if (!func_697(-1232784731, 1120403456, 1133084672))
			{
				return 0;
			}
			break;
		case 61537448:
			if (!func_697(301558156, 1120403456, 1133084672))
			{
				return 0;
			}
			break;
		case -925071604:
			if (!func_697(1683033662, 1120403456, 1133084672))
			{
				return 0;
			}
			break;
		case 1195508693:
			if (!func_697(-643041038, 1120403456, 1133084672))
			{
				return 0;
			}
			break;
...
struct<4> func_471(int iParam0, var uParam1, var uParam2, var uParam3, var uParam4, int iParam5, bool bParam6)
{
	...
	INVENTORY::_0x886DFD3E185C8A89(func_472(bParam6), &uParam1, iParam0, iParam5, &Var0);
	return Var0;
}
...
struct<16> func_473(var uParam0, bool bParam1)
{
	...
	if (bParam1)
	{
		Var0.f_15 = func_660(uParam0->f_4, -455129387);
		if (Var0.f_15 != 0)
		{
			Var0.f_4 = { func_658() };
			Var0.f_11 = 0;
...
void func_484(int iParam0, bool bParam1, int iParam2, int iParam3)
{
	func_708(iParam0);
	if (!func_531(1))
	{
...
int func_525(char* sParam0, int iParam1, int iParam2, int iParam3, int iParam4, int iParam5, int iParam6, int iParam7, int iParam8, int iParam9, int iParam10, bool bParam11)
{
	...
	if (iVar1 != 0)
	{
		func_724(iVar1, iParam1, sParam0, 1, iParam2, iParam3, 0f, 0f, 0f, 0f, 0, 0, 0, iParam4, iParam5, iParam6, iParam7, iParam8, iParam9, 0, 1065353216, 0, 0, 0, iParam10, bParam11);
		return iVar1;
	}
	return 0;
}
...
int func_536(int iParam0)
{
	...
	if (!func_590(&iVar0, 16, 0, 0, 1))
	{
		return 0;
	}
	if (!func_590(&iVar0, 41, iParam0, 0, 1))
	{
		return 0;
	}
	return func_729(&iVar0, 7);
}
...
int func_550(int iParam0)
{
	...
	if (!func_590(&iVar0, 36, 0, 0, 0))
	{
		return 0;
	}
	return func_729(&iVar0, 8);
}
...
struct<4> func_551(int iParam0, int iParam1)
{
	...
	if (!func_590(&iVar0, 37, iParam1, 0, 1))
	{
		return Var5;
	}
	iVar9 = func_733(&iVar0);
...
void func_552(var uParam0, var uParam1)
{
	...
	if (!func_737(*uParam0, &iVar1, 1, 255, 0, 0))
	{
		return;
	}
	func_738(iVar0, &iVar1, uParam1, uParam0->f_3);
}
...
int func_555(int iParam0)
{
	...
	if (!func_590(&iVar0, 20, 0, 0, 1))
	{
		return 0;
	}
	return func_729(&iVar0, 1);
}
...
int func_556(int iParam0, int iParam1)
{
	...
	if (!func_590(&iVar0, 23, iParam1, 0, 1))
	{
		return 0;
	}
	if (!func_590(&iVar0, 24, 0, 0, 0))
	{
		return 0;
	}
	return func_729(&iVar0, 2);
}
...
int func_562(int iParam0)
{
	...
	if (!func_741(&iVar0, iParam0, -337291755))
	{
		return 0;
	}
...
struct<2> func_564(int iParam0, int iParam1)
{
	...
	if (!func_590(&iVar0, 34, 0, 0, 0))
	{
		return Var5;
	}
	if (!func_590(&iVar0, 35, iParam1, 0, 0))
	{
		return Var5;
	}
	uVar7 = func_743(&iVar0);
	uVar8 = func_744(&iVar0);
...
{
	((*Global_1055965)[PLAYER::PLAYER_ID() /*436*/])->f_384.f_2 = uParam0;
}
...
{
	((*Global_1055965)[PLAYER::PLAYER_ID() /*436*/])->f_384.f_5 = uParam0;
}
...
int func_707(struct<2> Param0, var uParam2, float fParam3, float fParam4, int iParam5, int iParam6)
{
	if (Param0 < fParam3)
	{
...
struct<2> func_712(var uParam0, var uParam1)
{
	struct<2> Var0;
...
float func_719(int iParam0, var uParam1)
{
	int iVar0;
...
int func_730(int iParam0, int iParam1)
{
	...
	if (!func_590(&iVar0, 42, iParam1, 0, 1))
	{
		return 0;
	}
...
var func_732(int iParam0, var uParam1)
{
	int iVar0;
	int iVar1;
	int iVar2;
	...
	iVar1 = func_908(iParam0, uParam1);
...
bool func_737(int iParam0, int iParam1, int iParam2, int iParam3, int iParam4, bool bParam5)
{
	struct<2> Var0;
	struct<2> Var12;
	...
	Var0.f_1 = 10;
	Var12.f_1 = 11;
	return func_912(iParam0, iParam1, &Var12, &Var0, iParam2, iParam3, iParam4, bParam5);
}
...
void func_747(int iParam0, var uParam1, int iParam2)
{
	...
	uVar1 = func_907(iParam0);
	if (MISC::IS_BIT_SET(iParam2, iVar0))
	{
		iParam2 = (iParam2 && uVar1);
	}
	else
	{
		iParam2 = -1;
...
int func_758(int iParam0, int iParam1, int iParam2)
{
	...
	if (!func_590(&iVar0, 24, 0, 0, 1))
	{
		return 0;
	}
	if (!func_590(&iVar0, 25, iParam2, 0, 1))
	{
		return 0;
	}
	if (!func_590(&iVar0, 46, 0, 0, 0))
	{
		return 0;
	}
	return func_729(&iVar0, 10);
}
...
struct<6> func_759(struct<4> Param0, var uParam4, var uParam5, var uParam6, var uParam7, int iParam8)
{
	...
	if (!func_590(&iVar0, 19, Param0.f_3, 0, 1))
	{
		return Var5;
	}
	if (!func_590(&iVar0, 20, 0, 0, 1))
	...
	if (!func_590(&iVar0, 23, Param0.f_3.f_1, 0, 1))
	{
		return Var5;
	}
	if (!func_590(&iVar0, 24, 0, 0, 1))
	...
	if (!func_590(&iVar0, 25, Param0.f_3.f_2, 0, 1))
	{
		return Var5;
	}
	if (!func_590(&iVar0, 46, 0, 0, 0))
	...
	if (!func_590(&iVar0, 47, iParam8, 0, 1))
	{
		return Var5;
	}
	iVar11 = func_925(&iVar0);
...
int func_761(int iParam0, int iParam1, int iParam2)
{
	...
	if (!func_590(&iVar0, 56, 0, 0, 0))
	{
		return 0;
	}
	return func_729(&iVar0, 12);
}
...
void func_763(var uParam0, var uParam1)
{
	...
	switch (uParam0->f_1)
	{
		case 2049349725:
			...
			break;
		case 759256821:
			UNK_0x957A830C9B4B99EA(uParam0->f_3, 0);
			break;
		default:
			break;
	}
...
struct<4> func_765(struct<4> Param0, var uParam4, var uParam5, var uParam6, var uParam7, int iParam8)
{
	...
	if (!func_590(&iVar0, 37, iParam8, 0, 1))
	{
		return Var5;
	}
	iVar9 = func_733(&iVar0);
...
void func_844(int iParam0, int iParam1, var uParam2, int iParam3, struct<2> Param4, var uParam6, var uParam7, var uParam8, var uParam9, int iParam10)
{
	struct<28> Var0;
	var uVar31;
	vector3 vVar32;
	...
	fVar35 = func_1027(iParam0);
	func_1028(&(Var0.f_19), Var0.f_11, vVar32, fVar35);
	func_1006(&Var0, uVar31);
}
...
void func_874(struct<2> Param0, bool bParam2, int iParam3, int iParam4)
{
	int iVar0;
	...
	if (func_350(Param0) == 3 || (func_350(Param0) == 1 && STATS::_0x01F4D242765C6B24(func_1034(Param0))))
	{
		if (iParam3 != -1)
		{
			func_1036(Param0, iParam3, iParam4);
		}
		else
		{
			func_1036(Param0, 2, iParam4);
		}
	}
	func_876(Param0, 0);
...
int func_912(int iParam0, int iParam1, int iParam2, var uParam3, var uParam4, var uParam5, var uParam6, bool bParam7)
{
	bool bVar0;
	int iVar1;
	var uVar2;
	...
	Var3.f_14 = uParam6;
	Var3 = { *iParam2 };
	func_1055(iParam1, iParam0, Var3);
	return 1;
}
...
int func_931(var uParam0, var uParam1)
{
	struct<4> Var0;
...
void func_1028(var uParam0, int iParam1, vector3 vParam2, float fParam5)
{
	int iVar0;
	int iVar1;
	int iVar2;
	...
	while (iVar2 <= 31)
	{
		...
		else if (func_1122(iVar12, vParam2, fParam5))
		{
			if (iVar0 + 1 < 7)
			{
...
void func_1036(struct<2> Param0, int iParam2, var uParam3)
{
	var uVar0;
	int iVar1;
	vector3 vVar2;
...
int func_1053(struct<2> Param0, var uParam2, var uParam3, var uParam4, var uParam5)
{
	int iVar0;
	int iVar1;
	var uVar2;
...
void func_1055(int iParam0, int iParam1, struct<17> Param2)
{
	int iVar0;
	struct<24> Var1;
...
var func_1056(int iParam0)
{
	return func_909(iParam0, 78, 1);
}

var func_1057(int iParam0)
{
...
int func_1082(int iParam0, int iParam1)
{
	...
	if (SCRIPTS::HAS_SCRIPT_WITH_NAME_HASH_LOADED(iVar1))
	{
		...
		if (func_768(iParam0, 64))
		{
			...
			iVar2 = BUILTIN::START_NEW_SCRIPT_WITH_NAME_HASH_AND_ARGS(iVar1, &Var3, 10, func_1151(iParam0));
		}
		else if (func_768(iParam0, 128))
		{
			...
			iVar2 = BUILTIN::START_NEW_SCRIPT_WITH_NAME_HASH_AND_ARGS(iVar1, &Var13, 5, func_1151(iParam0));
		}
		else
		{
			iVar2 = BUILTIN::START_NEW_SCRIPT_WITH_NAME_HASH_AND_ARGS(iVar1, &uVar18, 1, func_1151(iParam0));
		}
...
int func_1146(struct<2> Param0, bool bParam2)
{
	int iVar0;
	...
	if (!func_1173(Param0, func_205(0), bParam2))
	{
...
int func_1167(var uParam0, bool bParam1, var uParam2, var uParam3, var uParam4, var uParam5)
{
	struct<29> Var0;
	struct<2> Var32;
	bool bVar34;
...
int func_1174(int iParam0, int iParam1, var uParam2)
{
	...
	if (func_1183(iParam0, iParam1, &iVar0))
	{
		func_1184(iParam0, &iVar0, uParam2);
	}
	else
	{
		return 0;
...
bool func_1183(int iParam0, var uParam1, int iParam2)
{
...
int func_1198(int iParam0, var uParam1, var uParam2)
{
	...
	if (func_1200(iParam0, uParam1, &iVar0))
	{
		func_1201(&iVar0, iParam0, uParam2);
	}
	else
	{
		return 0;
