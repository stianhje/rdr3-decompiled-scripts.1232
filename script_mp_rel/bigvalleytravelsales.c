...
int func_13()
{
	iLocal_21 = VOLUME::_CREATE_VOLUME_BOX_WITH_CUSTOM_NAME(-2112.93f, 477.087f, 117.116f, 0f, 0f, 170f, 14.456f, 10.148f, 8.8f, "BGV TravellingSalesman - m_volTravellingSalesman");
	iLocal_22 = VOLUME::_CREATE_VOLUME_CYLINDER_WITH_CUSTOM_NAME(-2110.533f, 476.639f, 117.116f, 0f, 0f, 170f, 3.7f, 3.7f, 4.2f, "BGV TravellingSalesman - m_volTravellingSalesmanPrompt");
	return 1;
}
