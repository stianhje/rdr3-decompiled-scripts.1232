...
void func_58(float fParam0, float fParam1, float fParam2, float fParam3)
{
...
void func_71(int iParam0, int iParam1, int iParam2, bool bParam3, int iParam4, int iParam5)
{
	...
	else if ((func_60(iParam0) && func_85(iParam0, 16777216)) && !Global_1893575->f_9)
	{
...
int func_91(int iParam0, bool bParam1)
{
	...
	if (func_118(iParam0, 32) && !bParam1)
	{
		...
		if (func_45() == -1)
		{
			...
			{
				_NAMESPACE48::_0x49A8C2CD97815215(func_127(iParam0));
				func_128(iParam0, 2048);
			}
			_NAMESPACE48::_0xFCC6DB8DBE709BC8(func_127(iParam0));
		}
		return 0;
	}
	...
	if (_NAMESPACE48::_0x800DF3FC913355F3(func_127(iParam0)))
	{
		func_128(iParam0, 128);
		return 1;
	}
	func_126(iParam0, _NAMESPACE48::_0x4F76E3676583D951(func_125(iParam0)));
	_NAMESPACE48::_0x4F81EAD1DE8FA19B(func_127(iParam0));
	if (func_118(iParam0, 2048))
	{
		_NAMESPACE48::_0x49A8C2CD97815215(func_127(iParam0));
		func_128(iParam0, 2048);
...
void func_95(int iParam0, bool bParam1, float fParam2, bool bParam3, bool bParam4, float fParam5, int iParam6, bool bParam7)
{
	...
	if (func_131(iParam0))
	{
		...
		if (bParam3)
		{
			func_132(iParam0, fParam2, 1, iParam6);
		}
		else if (bParam1)
		{
			if (bParam4)
...
void func_117(int iParam0)
{
	...
	if (func_89((Global_1915170->f_3[iParam0 /*447*/])->f_21) && func_150((Global_1915170->f_3[iParam0 /*447*/])->f_21))
	{
	...
	else
	{
		...
		while (iVar0 < iVar1)
		{
			func_155(&((Global_1915170->f_3[iParam0 /*447*/])->f_318[iVar0 /*6*/]));
...
int func_119(int iParam0, bool bParam1)
{
	...
	func_158(iParam0);
	_NAMESPACE48::_0xFC77C5B44D5FF7C0(func_127(iParam0));
	func_126(iParam0, 0);
	return 1;
}
...
void func_124(int iParam0)
{
	...
	else
	{
		...
		while (iVar2 < iVar3)
		{
			func_155(&((Global_1051387->f_69[iParam0 /*76*/])->f_32[iVar2]));
	...
	if (VOLUME::_0x92A78D0BEDB332A3((Global_1051387->f_69[iParam0 /*76*/])->f_25) && func_169(iParam0, 2))
	{
...
void func_132(int iParam0, float fParam1, int iParam2, int iParam3)
{
	if (func_131(iParam0))
	{
...
{
	return func_189((Global_1051387->f_69[iParam0 /*76*/])->f_51, iParam1);
}
