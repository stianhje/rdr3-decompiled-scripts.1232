...
void func_95(int iParam0, bool bParam1, float fParam2, bool bParam3, bool bParam4, float fParam5, bool bParam6, bool bParam7)
{
	...
	if (func_131(iParam0))
	{
		...
		if (bParam3)
		{
			func_132(iParam0, fParam2, 1, bParam6);
		}
		else if (bParam1)
		{
			if (bParam4)
...
void func_132(int iParam0, float fParam1, bool bParam2, bool bParam3)
{
	if (func_131(iParam0))
	{
