...
void __EntryFunction__()
{
	...
	Global_1915170->f_21989.f_3 = 0;
	Global_1915170->f_21989.f_1 = 0;
	Global_1915170->f_21989 = 1;
	Var0 = 4;
	Var0.f_1 = 8;
	Var0.f_21 = 16;
	Var0.f_150 = 16;
	...
	Var0.f_4 = 148;
	Var0 = 0;
	aggregate_func_4252(&(Var0.f_167), 1);
	while (!aggregate_func_523(1, 1))
	{
		...
		switch (Var0)
		{
			...
			case 4:
				...
				else if (aggregate_func_5137())
				{
					aggregate_func_3605();
					aggregate_func_1640(Var0.f_3, Var0.f_4);
					aggregate_func_4300(0);
					if (!aggregate_func_8488(262144))
					{
						aggregate_func_7714(262144);
						bLocal_22 = true;
					}
					aggregate_func_5180(65536);
					Var0.f_12 = 1;
					TELEMETRY::_0xF78E669FDC202E73();
					TELEMETRY::_0x775B2ED944E44973(aggregate_func_5190(34), aggregate_func_4659(148), aggregate_func_4328(aggregate_func_4314(), 0), Global_36);
					aggregate_func_6225(&Var0, 7);
				}
				break;
			case 7:
				if (Global_1051387->f_3211 && aggregate_func_4429(Var0.f_3, 1024))
				{
					...
					if (aggregate_func_2830(aggregate_func_4505(&(Var0.f_167.f_4))) == joaat("ammo") && aggregate_func_4287(&(Var0.f_167.f_4)))
					{
						aggregate_func_6261(&(Var0.f_167.f_4), aggregate_func_4505(&(Var0.f_167.f_4)));
					}
				...
				if (func_27(&(Var0.f_167), &Var0))
				{
					aggregate_func_4242(&Var0, 0);
					aggregate_func_5128(65536);
					Var0.f_12 = 0;
					func_7();
					func_30(0);
				...
				break;
			case 8:
				aggregate_func_4252(&(Var0.f_167.f_4), 0);
				aggregate_func_6246(Var0.f_3);
				aggregate_func_6225(&Var0, 3);
				if (bLocal_22)
				{
				...
				func_34(&(Var0.f_167));
				TELEMETRY::_0xF78E669FDC202E73();
				if (Global_1915170->f_19742 != -1 && aggregate_func_4636())
				{
					TELEMETRY::_0x775B2ED944E44973(aggregate_func_5190(Global_1915170->f_19742), aggregate_func_4659(Global_1915170->f_19742.f_1), aggregate_func_4328(aggregate_func_5278(Global_1915170->f_19742.f_1), 0), (Global_1051387->f_69[Global_1915170->f_19742 /*76*/])->f_3);
				}
				break;
			case 9:
				Jump @2470; //curOff = 2456
				BUILTIN::WAIT(0);
			}
			func_37(&Var0);
...
void func_5(var uParam0, var uParam1)
{
	...
	if (uParam0->f_4.f_1225 || Global_1051387->f_3576)
	{
		if (!ENTITY::DOES_ENTITY_EXIST(uParam0->f_4.f_1295))
		{
			uParam0->f_4.f_1295 = TASK::_0x05A0100EA714DB68(Global_35, 0);
		}
		OBJECT::_0xF40AB58D83C35027(uParam0->f_4.f_1295);
		uParam0->f_4.f_1225 = 0;
		Global_1051387->f_3576 = 0;
	}
	if (aggregate_func_4641(uParam0) >= 1)
	{
		aggregate_func_787(&(uParam0->f_4), uParam1);
		if (uParam0->f_4 >= 4 && uParam0->f_4 < 18)
		{
			Global_1915170->f_21989.f_3 = 1;
		}
		else
		{
			Global_1915170->f_21989.f_3 = 0;
	...
	if (uParam0->f_4 < 8 || uParam0->f_4 >= 15)
	{
		Global_1915170->f_21989.f_2 = 0;
	}
	else
	{
		Global_1915170->f_21989.f_2 = 1;
	}
	if (aggregate_func_6231(&(uParam0->f_4)))
	{
		if (aggregate_func_4641(uParam0) != 8 || aggregate_func_4641(uParam0) != 9)
		{
			aggregate_func_4252(uParam0, 8);
		}
	}
	iVar1 = aggregate_func_4641(uParam0);
	if ((iVar1 == 3 || iVar1 == 4) || iVar1 == 5)
	{
		aggregate_func_789(&(uParam0->f_4), 0, 0);
		aggregate_func_789(&(uParam0->f_4), 1, 0);
	}
	bVar2 = true;
	switch (iVar1)
	{
		case 1:
			if (!ANIMSCENE::_0x25557E324489393C(uParam0->f_1749))
			{
				uParam0->f_1749 = ANIMSCENE::_CREATE_ANIM_SCENE("lightrig@player_journal", 0, "plMain", false, true);
			}
			else if (!ANIMSCENE::_0x477122B8D05E7968(uParam0->f_1749, 1, 0))
			{
				ANIMSCENE::LOAD_ANIM_SCENE(uParam0->f_1749);
			}
			else
			{
			...
			break;
		case 2:
			uParam0->f_1303 = aggregate_func_4304(&(uParam0->f_4));
			bVar0 = aggregate_func_4505(&(uParam0->f_4));
			if (Global_1915170->f_21989.f_1 && Global_1915170->f_19742.f_3.f_4)
			{
				aggregate_func_6234(&(uParam0->f_4));
				Global_1915170->f_19742.f_3.f_4 = 0;
			}
			if (uParam0->f_1303 != 0)
			{
				switch (aggregate_func_6243(&(uParam0->f_4)))
				{
					case 0:
						if (uParam0->f_1303 == 2)
						{
							if (aggregate_func_6285(&(uParam0->f_4), aggregate_func_4275(&(uParam0->f_4)), &iVar3))
							{
								aggregate_func_3369(&(uParam0->f_4), iVar3, 1);
							}
							else
							{
								aggregate_func_3366(&(uParam0->f_4));
							}
						}
						break;
					case 3:
					...
					case 12:
						if (uParam0->f_1303 == 4)
						{
							aggregate_func_6266(uParam0);
							aggregate_func_2305(&(uParam0->f_4), 0);
							aggregate_func_4252(uParam0, 7);
							bVar2 = false;
							aggregate_func_6235(uParam0, uParam1, bVar0);
						}
						else if (uParam0->f_1303 == 2)
						{
							if (aggregate_func_6305(bVar0))
							{
								aggregate_func_6238(&(uParam0->f_4), 0, 0);
								aggregate_func_6266(uParam0);
								aggregate_func_2305(&(uParam0->f_4), 0);
								aggregate_func_4252(uParam0, 3);
								bVar2 = false;
							}
							else if (aggregate_func_5921(bVar0) && !(aggregate_func_5659(bVar0) && !aggregate_func_6300(bVar0)))
							{
								aggregate_func_6238(&(uParam0->f_4), 0, 0);
								aggregate_func_6266(uParam0);
								aggregate_func_2305(&(uParam0->f_4), 0);
							...
							else if (aggregate_func_5951(bVar0) && !aggregate_func_6237(&(uParam0->f_4), bVar0))
							{
								aggregate_func_6238(&(uParam0->f_4), 0, 0);
								aggregate_func_6266(uParam0);
								aggregate_func_2305(&(uParam0->f_4), 0);
							...
							else if (aggregate_func_5814(bVar0))
							{
								aggregate_func_6238(&(uParam0->f_4), 0, 0);
								aggregate_func_6266(uParam0);
								aggregate_func_2305(&(uParam0->f_4), 0);
							...
							{
								uParam1->f_167.f_1774 = 1;
								aggregate_func_5896(uParam1, bVar0, 0);
							}
						}
						else if (uParam0->f_1303 == 3)
						{
							uParam1->f_167.f_1774 = uParam0->f_4.f_1291;
							aggregate_func_5896(uParam1, bVar0, 0);
							uParam1->f_167.f_1774 = 1;
							uParam0->f_4.f_1291 = 1;
						}
						break;
				}
				if (bVar2)
				{
					aggregate_func_4285(&(uParam0->f_4));
				}
			}
			break;
		case 3:
			if (!func_63(uParam1))
			{
				aggregate_func_6239(uParam0);
				aggregate_func_6240(&(uParam0->f_4));
				aggregate_func_6234(&(uParam0->f_4));
				aggregate_func_4285(&(uParam0->f_4));
				aggregate_func_4252(uParam0, 2);
			}
		...
		case 6:
			...
			break;
		case 7:
			aggregate_func_2302(uParam0);
			if (!func_70(uParam1))
			{
				aggregate_func_5019(uParam0, 6, 0);
				aggregate_func_6239(uParam0);
				aggregate_func_6240(&(uParam0->f_4));
				aggregate_func_6234(&(uParam0->f_4));
				aggregate_func_4285(&(uParam0->f_4));
...
bool func_27(var uParam0, var uParam1)
{
	...
	switch (uParam1->f_2)
	{
		case 0:
			...
			if (UISTATEMACHINE::_UIFLOWBLOCK_IS_LOADED(uParam0->f_4.f_1226))
			{
				UISTATEMACHINE::_UIFLOWBLOCK_RELEASE(&(uParam0->f_4.f_1226));
			}
		...
		case 2:
			...
			PAD::DISABLE_CONTROL_ACTION(0, joaat("INPUT_OPEN_SATCHEL_MENU"), false);
			Global_1915170->f_20142 = 1;
			if (!aggregate_func_3361(&(uParam0->f_4)))
			{
				aggregate_func_6245(&(uParam0->f_4));
			}
			if (!aggregate_func_1058("SHOP", 30, -1, 0, 0))
			{
				return false;
			}
			if (!aggregate_func_670(&(uParam0->f_4)))
			{
			}
		...
		case 3:
			aggregate_func_4580();
			if (aggregate_func_7910(uParam0))
			{
				if (ANIMSCENE::_0x477122B8D05E7968(uParam0->f_1749, 1, 0))
				{
					ANIMSCENE::SET_ANIM_SCENE_ORIGIN(uParam0->f_1749, Global_36, ENTITY::GET_ENTITY_ROTATION(Global_35, 2), 2);
					ANIMSCENE::ATTACH_ANIM_SCENE_TO_ENTITY_PRESERVING_LOCATION(uParam0->f_1749, Global_35, -1);
					if (!ANIMSCENE::_0xCBFC7725DE6CE2E0(uParam0->f_1749, 0))
					{
						ANIMSCENE::START_ANIM_SCENE(uParam0->f_1749);
					}
					aggregate_func_4242(uParam1, 7);
				}
			}
			break;
		case 7:
			...
			if (uParam0->f_4 == 15)
			{
				if (ANIMSCENE::_0x25557E324489393C(uParam0->f_1749))
				{
					ANIMSCENE::_DELETE_ANIM_SCENE(uParam0->f_1749);
				}
			}
			aggregate_func_2173(&(uParam1->f_2047));
			aggregate_func_1587(&(uParam1->f_167));
			if ((func_92(uParam1) || !func_38()) || aggregate_func_4911(uParam0))
			{
				if (!aggregate_func_4911(uParam0))
				{
					func_94(uParam0);
				}
				aggregate_func_4242(uParam1, 8);
			}
			break;
		case 8:
			func_95(uParam1);
			aggregate_func_4242(uParam1, 10);
			break;
		case 10:
			aggregate_func_2985(1);
			MAP::DISPLAY_RADAR(true);
			aggregate_func_5638(uParam1);
			aggregate_func_5639(uParam1);
			...
			break;
		case 12:
			aggregate_func_4344(uParam1->f_3, 8388608);
			return true;
	}
	return false;
}
...
{
	if (aggregate_func_4240(uParam0->f_1825, 32))
	{
		aggregate_func_2903("SHOP_CATALOGUE_PURCHASE", "SHOP_CATALOGUE_PURCHASE_ITEM", -558676520, 2010301228, 8000, 0, 0, 0, 0, 1, 1);
	}
	if (aggregate_func_4240(uParam0->f_1825, 1))
	{
		aggregate_func_2903("SHOP_CATALOGUE_PURCHASE", "SHOP_CATALOGUE_PURCHASE_ITEM_CAMP", -558676520, 2010301228, 8000, 0, 0, 0, 0, 1, 1);
	}
	if (aggregate_func_4240(uParam0->f_1825, 2))
	{
		aggregate_func_2903("SHOP_CATALOGUE_PURCHASE", "SHOP_CATALOGUE_PURCHASE_CLOTHING", -558676520, 2010301228, 8000, 0, 0, 0, 0, 1, 1);
	}
	if (aggregate_func_4240(uParam0->f_1825, 4))
	{
		aggregate_func_2903("SHOP_CATALOGUE_PURCHASE", "SHOP_CATALOGUE_PURCHASE_HORSE_EQUIPMENT", -558676520, 2010301228, 8000, 0, 0, 0, 0, 1, 1);
	}
	if (aggregate_func_4240(uParam0->f_1825, 8))
	{
		aggregate_func_2903("SHOP_CATALOGUE_PURCHASE", "SHOP_CATALOGUE_PURCHASE_HORSE", -558676520, 2010301228, 8000, 0, 0, 0, 0, 1, 1);
	}
	if (aggregate_func_4240(uParam0->f_1825, 256))
	{
		aggregate_func_2903("SHOP_CATALOGUE_PURCHASE", "SHOP_CATALOGUE_PURCHASE_VEHICLE", -558676520, 2010301228, 8000, 0, 0, 0, 0, 1, 1);
	}
	if (aggregate_func_4240(uParam0->f_1825, 16))
	{
		aggregate_func_2903("SHOP_CATALOGUE_PURCHASE", "SHOP_CATALOGUE_PURCHASE_WEAPON", -558676520, 2010301228, 8000, 0, 0, 0, 0, 1, 1);
	}
	if (aggregate_func_4240(uParam0->f_1825, 64))
	{
		aggregate_func_2903("SHOP_CATALOGUE_PURCHASE", "SHOP_CATALOGUE_PURCHASE_WEAPON_FISHINGROD", -558676520, 2010301228, 8000, 0, 0, 0, 0, 1, 1);
	}
	if (aggregate_func_4240(uParam0->f_1825, 128))
	{
		aggregate_func_2903("SHOP_CATALOGUE_PURCHASE", "SHOP_CATALOGUE_PURCHASE_WEAPON_BINOCULAR", -558676520, 2010301228, 8000, 0, 0, 0, 0, 1, 1);
	}
	if (aggregate_func_4240(uParam0->f_1825, 512))
	{
		aggregate_func_2903("SHOP_CATALOGUE_PURCHASE", "SHOP_CATALOGUE_PURCHASE_KIT_HORSE_BRUSH", -558676520, 2010301228, 8000, 0, 0, 0, 0, 1, 1);
	}
	uParam0->f_1825 = (uParam0->f_1825 - uParam0->f_1825);
}
...
void func_37(var uParam0)
{
	...
	aggregate_func_1235(uParam0);
	if (Global_1915170->f_19742 == uParam0->f_3 || Global_1915170->f_19742 == -1)
	{
		Global_1915170->f_19742 = -1;
		Global_1915170->f_19742.f_1 = -1;
		Global_1915170->f_19742.f_2 = 0;
		aggregate_func_4300(0);
	}
	aggregate_func_2300(uParam0->f_3, 0);
	uParam0->f_14 = 1;
	if (SCRIPTS::_DOES_THREAD_EXIST(Global_1915170->f_21988))
	{
		SCRIPTS::_0x7DE4643157AD646C(Global_1915170->f_21988);
	}
	Global_1915170->f_21989.f_2 = 0;
	if (uParam0->f_12 == 1)
	{
...
bool func_38()
{
	...
	if (aggregate_func_4255(Var0) && Var0 == 6)
	{
		...
		if (iVar2 != -1)
		{
			Global_1915170->f_21989.f_5 = func_112(iVar2);
			return false;
		}
	}
	if (func_113())
...
bool func_63(var uParam0)
{
	...
	{
		if (func_184(uParam0, bVar4, bVar5, 1))
		{
			aggregate_func_8078(uParam0, 148);
			HUD::_0x4CC5F2FC1332577F(439038017);
			aggregate_func_4358(uParam0, 37078);
			aggregate_func_4358(uParam0, 37112);
			aggregate_func_4358(uParam0, 37146);
		}
		else
		{
			return false;
	...
	if (aggregate_func_4275(uParam0) && !aggregate_func_4275(uParam0))
	{
		...
		{
			if (aggregate_func_2226(uParam0, bVar4, bVar5, &bVar6))
			{
				func_194(uParam0, bVar6);
			}
			else
			{
				return false;
		...
		else if (aggregate_func_951(uParam0))
		{
		}
	}
	if (aggregate_func_4275(uParam0) && aggregate_func_4275(uParam0))
...
bool func_66(var uParam0)
{
	...
	if (!aggregate_func_4275(uParam0))
	{
		...
		bVar4 = Var0.f_2;
		bVar5 = Var0.f_3;
		if (func_184(uParam0, bVar4, 681948426, 1))
		{
			aggregate_func_8078(uParam0, 148);
			aggregate_func_6052(uParam0, bVar5, 1, -1, 0, 0, 0, 0);
			aggregate_func_4358(uParam0, 41296);
			aggregate_func_4358(uParam0, 41305);
			aggregate_func_4358(uParam0, 41314);
			aggregate_func_4242(uParam0, aggregate_func_4462(Var0));
		}
		else
		{
			return false;
...
bool func_67(var uParam0)
{
	...
	if (!aggregate_func_4275(uParam0))
	{
		...
		if (func_184(uParam0, bVar4, bVar5, 1))
		{
			...
			aggregate_func_4867(uParam0, 64);
			aggregate_func_4300(Var0);
			bVar6 = aggregate_func_4462(Var0);
			if (aggregate_func_2852(Var0, -306684263) && bVar6 != 0)
			{
				bVar6 = aggregate_func_2863(Var0);
			}
			aggregate_func_4242(uParam0, bVar6);
			aggregate_func_1592(uParam0, bVar6);
		}
		else
		{
			return false;
...
bool func_70(var uParam0)
{
	...
	if (uParam0->f_8 || uParam0->f_3 == 34)
	{
		if (!uParam0->f_2532.f_54)
		{
			if (!aggregate_func_4275(uParam0))
			{
				StringCopy(&cVar0, aggregate_func_5484(uParam0->f_3), 32);
				StringConCat(&cVar0, "_COUPONS", 32);
				bVar4 = MISC::GET_HASH_KEY(&cVar0);
				bVar5 = -1979958621;
				if (func_184(uParam0, bVar4, -329685068, 1))
				{
					aggregate_func_6052(uParam0, bVar5, 1, -1, 0, 0, 0, 0);
			...
			if (aggregate_func_4275(uParam0) && aggregate_func_4275(uParam0))
			{
				...
				{
					aggregate_func_1201(uParam0);
					if (uParam0->f_2532.f_53)
					{
						uParam0->f_2532.f_54 = 1;
					}
					else
					{
						return false;
		...
		else if (aggregate_func_524(&(uParam0->f_2047), 0))
		{
			aggregate_func_3186(uParam0->f_2047.f_1, Global_1915170->f_19742.f_3.f_35, Global_1051387->f_3214);
			return false;
		}
		return true;
	}
...
bool func_80(var uParam0)
{
	...
	if (!func_242(&(uParam0->f_4), 148, 34, bVar0, 1015895641, 1))
	{
		return false;
	}
	func_243(&(uParam0->f_4), 0, -2005122350, -917343754, -917343754, 1);
	func_243(&(uParam0->f_4), 1, -1225089074, -917343754, -917343754, 1);
	func_243(&(uParam0->f_4), 9, -21542437, -917343754, -917343754, 0);
	func_243(&(uParam0->f_4), 8, -1261193715, -917343754, -917343754, 0);
	func_243(&(uParam0->f_4), 3, 632981348, -917343754, -917343754, 1);
	func_243(&(uParam0->f_4), 5, -692562623, -917343754, -917343754, 1);
	func_243(&(uParam0->f_4), 7, 632981348, -917343754, -917343754, 1);
	func_243(&(uParam0->f_4), 2, 632167180, -917343754, -917343754, 0);
	func_243(&(uParam0->f_4), 4, 1557078798, -917343754, -917343754, 0);
	func_243(&(uParam0->f_4), 6, 632167180, -917343754, -917343754, 0);
	aggregate_func_4242(&(uParam0->f_4), 45358);
	aggregate_func_4242(&(uParam0->f_4), 45395);
	aggregate_func_4932(&(uParam0->f_4), 45408);
	aggregate_func_4932(&(uParam0->f_4), 45943);
...
bool func_88(var uParam0)
{
	...
	{
		if (aggregate_func_6306(&(uParam0->f_4), bVar0, &bVar1, &uVar2))
		{
			return aggregate_func_2308(&(uParam0->f_4), bVar1);
		}
	}
	return aggregate_func_2308(&(uParam0->f_4), 0);
}
...
bool func_92(var uParam0)
{
	...
	if (*uParam0 == 7)
	{
		if (ENTITY::HAS_ENTITY_COLLIDED_WITH_ANYTHING(Global_35))
		{
			return true;
		}
	}
...
{
	return aggregate_func_4271(&(uParam0->f_4));
}

int func_95(var uParam0)
{
	aggregate_func_786(&(uParam0->f_167), 1);
	if (aggregate_func_4275(uParam0) && aggregate_func_4275(uParam0))
	{
		aggregate_func_1201(uParam0);
	}
	aggregate_func_6244(&(uParam0->f_167));
	aggregate_func_4285(&(uParam0->f_167.f_4));
	...
	aggregate_func_4252(&(uParam0->f_167), 9);
...
bool func_144(var uParam0, var uParam1, bool bParam2)
{
	char cVar0[64];
	char* sVar8;
	char* sVar9;
	...
	switch (*uParam1)
	{
		...
		case 0:
			...
			while (iVar11 < 16)
			{
				...
				if (iVar11 >= uParam1->f_154)
				{
					sVar15 = "";
				}
				else
				{
					sVar15 = HUD::_GET_LABEL_TEXT_BY_HASH(&(uParam1->f_155[iVar11]));
				}
				if (bParam2)
				{
				...
				bVar16 = (iVar11 < (uParam1->f_154 - 1) && (iVar11 % iVar17) < (iVar17 - 1));
		...
		case 13:
			...
			if (iVar12 <= 0)
			{
				...
				if (aggregate_func_6289(&(uParam1->f_136[iVar11 /*4*/])))
				{
				...
				DATABINDING::_DATABINDING_WRITE_DATA_STRING_FROM_PARENT(&(uParam1->f_4.f_96[iVar11 /*8*/]), "ItemPrice", &cVar28);
				DATABINDING::_DATABINDING_WRITE_DATA_STRING_FROM_PARENT(&(uParam1->f_4.f_96[iVar11 /*8*/]), "ItemPriceDollar", &cVar32);
				DATABINDING::_DATABINDING_WRITE_DATA_STRING_FROM_PARENT(&(uParam1->f_4.f_96[iVar11 /*8*/]), "ItemPriceCents", &cVar24);
				DATABINDING::_DATABINDING_WRITE_DATA_BOOL_FROM_PARENT(&(uParam1->f_4.f_96[iVar11 /*8*/]), "ItemTokenVisible", false);
				DATABINDING::_DATABINDING_WRITE_DATA_STRING_FROM_PARENT(&(uParam1->f_4.f_96[iVar11 /*8*/]), "ItemTokenPrice", "");
				iVar50 = 0;
				while (iVar50 < 6)
				{
					DATABINDING::_DATABINDING_WRITE_DATA_HASH_STRING_FROM_PARENT(&((uParam1->f_4.f_96[iVar11 /*8*/])->f_1[iVar50]), "statLabel", false);
					DATABINDING::_DATABINDING_WRITE_DATA_INT_FROM_PARENT(&((uParam1->f_4.f_96[iVar11 /*8*/])->f_1[iVar50]), "invertedPotentialStat", false);
					DATABINDING::_DATABINDING_WRITE_DATA_INT_FROM_PARENT(&((uParam1->f_4.f_96[iVar11 /*8*/])->f_1[iVar50]), "invertedCurrentStat", 100);
					iVar50++;
				}
				uParam1->f_2 = 0;
			}
			else
			{
				...
				while (iVar11 < iVar12)
				{
					...
					if (!aggregate_func_6271(bVar10))
					{
						...
						{
							DATABINDING::_DATABINDING_WRITE_DATA_STRING_FROM_PARENT(&(uParam1->f_4.f_96[iVar11 /*8*/]), "ItemName", &cVar51);
						}
						else
						{
							DATABINDING::_DATABINDING_WRITE_DATA_STRING_FROM_PARENT(&(uParam1->f_4.f_96[iVar11 /*8*/]), "ItemName", "");
					...
					else
					{
						...
						{
							bVar70 = false;
							if (aggregate_func_1213((uParam1->f_136[iVar11 /*4*/])->f_2, (uParam1->f_136[iVar11 /*4*/])->f_3, &bVar70))
							{
						...
						{
							iVar23 = func_238(bVar68, 1);
						}
						StringIntConCat(&cVar44, iVar23, 32);
						DATABINDING::_DATABINDING_WRITE_DATA_BOOL_FROM_PARENT(&(uParam1->f_4.f_96[iVar11 /*8*/]), "ItemTokenVisible", iVar23 > 0);
						DATABINDING::_DATABINDING_WRITE_DATA_STRING_FROM_PARENT(&(uParam1->f_4.f_96[iVar11 /*8*/]), "ItemTokenPrice", &cVar44);
						if ((iVar23 > 0 && bVar21 != bVar18) && aggregate_func_6288(*uParam1))
						{
						...
						{
							bVar13 = false;
							if (aggregate_func_4747(uParam0) == uParam1->f_3 && aggregate_func_4275(uParam0) == iVar11)
							{
								bVar13 = true;
							}
							DATABINDING::_DATABINDING_WRITE_DATA_BOOL_FROM_PARENT(&(uParam1->f_4.f_96[iVar11 /*8*/]), "IsSelected", bVar13);
						}
						DATABINDING::_DATABINDING_WRITE_DATA_STRING_FROM_PARENT(&(uParam1->f_4.f_96[iVar11 /*8*/]), "Header", &cVar59);
						if (aggregate_func_6288(*uParam1))
						{
							DATABINDING::_DATABINDING_WRITE_DATA_STRING_FROM_PARENT(&(uParam1->f_4.f_96[iVar11 /*8*/]), "SubHeader", &cVar51);
						}
						else
						{
							DATABINDING::_DATABINDING_WRITE_DATA_STRING_FROM_PARENT(&(uParam1->f_4.f_96[iVar11 /*8*/]), "ItemName", &cVar51);
						}
						DATABINDING::_DATABINDING_WRITE_DATA_STRING_FROM_PARENT(&(uParam1->f_4.f_96[iVar11 /*8*/]), "Description", aggregate_func_550(bVar10));
						DATABINDING::_DATABINDING_WRITE_DATA_BOOL_FROM_PARENT(&(uParam1->f_4.f_96[iVar11 /*8*/]), "ItemDollarSymbolVisible", !bVar67);
						DATABINDING::_DATABINDING_WRITE_DATA_STRING_FROM_PARENT(&(uParam1->f_4.f_96[iVar11 /*8*/]), "ItemOldPrice", &cVar36);
						DATABINDING::_DATABINDING_WRITE_DATA_STRING_FROM_PARENT(&(uParam1->f_4.f_96[iVar11 /*8*/]), "ItemRank", &cVar40);
						DATABINDING::_DATABINDING_WRITE_DATA_STRING_FROM_PARENT(&(uParam1->f_4.f_96[iVar11 /*8*/]), "PriceLabel", sVar49);
						if (aggregate_func_6289(&(uParam1->f_136[iVar11 /*4*/])))
						{
							DATABINDING::_DATABINDING_WRITE_DATA_HASH_STRING_FROM_PARENT(&(uParam1->f_4.f_96[iVar11 /*8*/]), "AdvertTextureName", MISC::GET_HASH_KEY(sVar8));
							DATABINDING::_DATABINDING_WRITE_DATA_STRING_FROM_PARENT(&(uParam1->f_4.f_96[iVar11 /*8*/]), "AdvertTextureDictionary", sVar9);
...
bool func_184(var uParam0, bool bParam1, bool bParam2, bool bParam3)
{
	int iVar0;
	...
	uParam0->f_2094.f_149 = 81257;
	uParam0->f_2094.f_150 = 82141;
	uParam0->f_2094.f_151 = 82937;
	uParam0->f_2094.f_152 = 83056;
...
void func_190(var uParam0, var uParam1, var uParam2)
{
	...
	bVar0 = aggregate_func_5650();
	if (aggregate_func_2823(bVar0, 0))
	{
		func_194(uParam0, bVar0);
	}
}
...
int func_194(var uParam0, bool bParam1)
{
	...
	{
		iVar0 = aggregate_func_3032(bParam1);
		if (ENTITY::DOES_ENTITY_EXIST(iLocal_21))
		{
			iVar1 = ENTITY::GET_ENTITY_MODEL(iLocal_21);
			if (iVar0 != iVar1)
			{
				PED::DELETE_PED(&iLocal_21);
		...
		if (!ENTITY::DOES_ENTITY_EXIST(iLocal_21))
		{
			...
			iLocal_21 = PED::CREATE_PED(iVar0, 0f, 0f, 0f, 0f, true, true, false, false);
			ENTITY::FREEZE_ENTITY_POSITION(iLocal_21, true);
			ENTITY::SET_ENTITY_VISIBLE(iLocal_21, false);
			ENTITY::SET_ENTITY_COLLISION(iLocal_21, false, false);
			aggregate_func_1302(iLocal_21, 0, 100);
			aggregate_func_1302(iLocal_21, 1, 100);
			func_480(uParam0, iLocal_21, 0);
			return 1;
		}
	}
	return 0;
...
char* func_238(bool bParam0, bool bParam1)
{
	bool bVar0;

	bVar0 = aggregate_func_6301(bParam0, bParam1);
	if (!aggregate_func_2891(bVar0))
	{
		return 0;
	}
	return aggregate_func_5796(bVar0, -2141192156, 0, 1);
}
...
bool func_242(var uParam0, int iParam1, int iParam2, bool bParam3, int iParam4, int iParam5)
{
	struct<173> Var0;
	int iVar189;
	...
	uParam0->f_1279 = 106987;
	uParam0->f_1280 = 106996;
	uParam0->f_1281 = 107005;
	uParam0->f_1282 = 107005;
	uParam0->f_222 = iParam5;
	aggregate_func_4252(uParam0, 0);
	return true;
}

int func_243(var uParam0, int iParam1, int iParam2, int iParam3, int iParam4, int iParam5)
{
	if (!uParam0->f_222)
	{
		return 0;
	}
	uParam0->f_1.f_186[iParam1] = iParam2;
	uParam0->f_1.f_197[iParam1] = iParam3;
	uParam0->f_1.f_208[iParam1] = iParam4;
	uParam0->f_1.f_174[iParam1] = iParam5;
	return 1;
}

bool func_260()
{
	return Global_1051387->f_3578;
}

int func_271(var uParam0)
{
	if (aggregate_func_4641(uParam0) == 17 || aggregate_func_4641(uParam0) == 18)
	{
		return 1;
	}
	return 0;
...
bool func_413(var uParam0, bool bParam1, bool bParam2, bool bParam3, bool bParam4)
{
	bool bVar0;
	struct<4> Var1;
	bool bVar5;
		...
		if (aggregate_func_2852(bParam1, 1844906744))
		{
			...
			if (aggregate_func_3236(aggregate_func_5306(&(uParam0->f_2094)), bParam4, &Var6))
			{
				...
				while (bVar5 < Var6.f_3)
				{
					...
					{
						if (func_413(uParam0, Var1, aggregate_func_6134(uParam0, Var1), -1, -1))
						{
							bVar0 = false;
						}
						else
										...
										else
										{
											...
											while (iVar33 < iVar31)
											{
												...
												if (((aggregate_func_2823(bVar34, 0) && bVar34 != bParam1) && aggregate_func_5724(&(uParam0->f_2094), bVar34, &uVar11)) || ITEMDATABASE::_ITEM_DATABASE_GET_ITEM_TAG_TYPE(bVar34, Var21.f_8) == -2089472884)
												{
													...
													if (func_413(uParam0, bVar34, bVar35, -1, -1))
													{
														bVar0 = true;
													}
													else
													...
													else if (bParam2 == 1394581936)
													{
														if (aggregate_func_4923(bParam1))
														{
															...
															{
																return aggregate_func_7074(Var40, -2119169513, 0, -1) == bParam1;
															}
															if (aggregate_func_5902(bParam1))
															{
																return aggregate_func_7074(Var40, 1415981582, 0, -1) == bParam1;
															}
															if (aggregate_func_5904(bParam1))
															{
																return aggregate_func_7074(Var40, -653439684, 0, -1) == bParam1;
															}
														}
														else
														{
															...
															while (iVar49 < iVar48)
															{
																...
																if (bVar50 != 0)
																{
																	if (aggregate_func_7074(Var44, bVar50, 0, -1) == bParam1)
																	{
																		return true;
																	}
																}
													...
													else if (bParam2 == -584027224 || bParam2 == -87783305)
													{
														...
														if (iVar51 == 2065516088)
														{
															...
															if (bParam1 == aggregate_func_7074(Var52, aggregate_func_5910(2065516088), 1, -1))
															{
																return true;
															}
														}
														else if (iVar51 == -186198417)
														{
															...
															if (bParam1 == aggregate_func_7074(Var56, aggregate_func_5910(-186198417), 1, -1))
															{
																return true;
															}
														}
														else
														{
															...
															switch (iVar64)
															{
																...
																case 1415299667:
																case 1795979421:
																	if (bParam1 == aggregate_func_7074(Var60, aggregate_func_5910(iVar64), 1, -1))
																	{
																		return true;
																	}
																	break;
													...
													else if (bParam2 == 1702073444)
													{
														if (aggregate_func_5722(bParam1))
														{
															...
															if (aggregate_func_2836(&Var76, &iVar90, &iVar91, 0))
															{
																Var92.f_9 = -1591664384;
																bVar106 = false;
																while (bVar106 < iVar91)
																{
																	if (aggregate_func_2840(&Var92, bVar106, iVar90, iVar91))
																	{
																	...
																	else
																	{
																		...
																		while (iVar130 < iVar128)
																		{
																			...
																			if (((aggregate_func_2823(bVar131, 0) && bVar131 != bParam1) && aggregate_func_5724(&(uParam0->f_2094), bVar131, &uVar108)) || ITEMDATABASE::_ITEM_DATABASE_GET_ITEM_TAG_TYPE(bVar131, Var118.f_8) == -2089472884)
																			{
																				...
																				if (func_413(uParam0, bVar131, bVar132, -1, -1))
																				{
																					bVar0 = true;
																				}
																				else
																				...
																				Jump @2102; //curOff = 2090
																				bVar107++;
																				Jump @2279; //curOff = 2102
																				...
																				else
																				{
																					...
																					if (aggregate_func_2836(&Var152, &iVar135, &iVar136, 0))
																					{
																						bVar137 = false;
																						while (bVar137 < iVar136)
																						{
																							if (aggregate_func_2840(&Var138, bVar137, iVar135, iVar136))
																							{
																								bVar0 = Var138.f_10;
																							}
																							else
...
bool func_435(int* iParam0, bool bParam1, int iParam2, bool bParam3, int iParam4)
{
	struct<4> Var0;
	bool bVar4;
	bool bVar5;
	...
	if (!aggregate_func_7064(&bVar4, 0))
	{
		return false;
	}
	if (aggregate_func_6263(bParam1, &bVar5))
	{
		Var6 = { Var0 };
		Var6.f_4 = bVar4;
		return aggregate_func_5387(iParam0, bVar5, Var6, 1, 0, iParam2, 0, 0, iParam4, 0);
	}
	return aggregate_func_6344(iParam0, bParam1, Var0, bVar4, 0, iParam2, bParam3, iParam4);
}
...
bool func_458(int* iParam0, bool bParam1, struct<4> Param2, bool bParam6, var uParam7, bool bParam8, bool bParam9)
{
	struct<16> Var0;
	bool bVar16;
	bool bVar17;
	...
	if (bParam8 == 0)
	{
		bParam8 = aggregate_func_5209(bParam1, bParam8, 1, -1, 1);
	}
	...
	if (!aggregate_func_2154(iParam0, bParam1, Param2, -1591664384, bParam8, bParam6, bParam9, 1))
	{
		return false;
	}
	Var0 = { aggregate_func_4493(bParam1, Param2, 1084182731, bParam6, 0) };
	Var0.f_13 = bParam8;
	...
	*uParam7 = { Var0 };
	...
	bVar19 = Global_1915170->f_19742.f_50;
	iVar41 = 0;
	while (iVar41 < 5)
	{
		...
		else if (!aggregate_func_1019(&(Global_1051387->f_46[iVar41]), bVar18, &bVar20, &Var30, &uVar21, 1, bVar19))
		{
		}
		else
		{
				...
				case 658570475:
					if (!aggregate_func_4290(&(Global_1051387->f_46[iVar41]), &Var30, bVar20, 0, 0))
					{
						...
						else
						{
							...
							if (!aggregate_func_5258(iParam0, &(Global_1051387->f_46[iVar41]), Var30, bVar20, 1, &Var0, 0, bVar40, 0, bParam9, 0))
							{
								bVar16 = false;
								Jump @628; //curOff = 487
							}
							...
							if (!&Global_1051387->f_46.f_6[iVar41])
							{
								bVar39 = aggregate_func_7074(Var30, bVar20, 0, -1);
...
bool func_774(char[4] cParam0, char[4] cParam1, char[4] cParam2, char[4] cParam3, char[4] cParam4, char[4] cParam5, char[4] cParam6, char[4] cParam7)
{
	int iVar0;
	int iVar1;
	struct<4> Var2;
...
int func_896(var uParam0, var uParam1)
{
	int iVar0;
	int iVar1;
	bool bVar2;
	...
	iVar4 = aggregate_func_3180(uParam0);
	if (!aggregate_func_2267(iVar4, iVar1, &iVar5))
	{
		bVar3 = iVar5;
	}
	if (bVar3 == 0)
	...
	{
		aggregate_func_4891(uParam0, bVar3);
	}
	aggregate_func_3247(uParam0, bVar2);
	return 1;
}

int func_1104(var uParam0, bool bParam1, int iParam2)
{
	int iVar0;
	bool bVar1;
	struct<2> Var2[15];
	...
	while (iVar44 < 8)
	{
		...
		else
		{
			...
			else
			{
				...
				while (bVar46 < iVar43)
				{
					if (aggregate_func_4379(&(Var2[bVar46 /*2*/])))
					{
						bVar49 = false;
						iVar47 = 0;
						while (iVar47 < iVar42)
						...
						if (!bVar49)
						{
							...
							iVar42++;
							bVar45 = aggregate_func_1136(&(Var2[bVar46 /*2*/]), 0, 0, 1);
							if (bVar45 > 0)
							{
								if (!bParam1)
								{
									Var50 = { aggregate_func_4307(&(Var2[bVar46 /*2*/]), 0) };
									aggregate_func_2219(uParam0, &Var50, &(Var2[bVar46 /*2*/]), bVar45, (iParam2 + iVar0));
								}
								iVar0++;
							}
						}
	...
	bVar54 = aggregate_func_3250(&(uVar33[0]));
	if (bVar54 == 0)
	{
		return iVar0;
	}
	Var57.f_9 = -1591664384;
	Var71 = { aggregate_func_4303(0, -1591664384, -1591664384, -1591664384, 0, bVar54, 0) };
	if (aggregate_func_2836(&Var71, &iVar55, &bVar56, 1))
	{
		bVar46 = false;
		while (bVar46 < bVar56)
		{
			if (aggregate_func_2840(&Var57, bVar46, iVar55, bVar56))
			{
				bVar49 = false;
				iVar47 = 0;
				while (iVar47 < iVar42)
...
bool func_1392(bool bParam0, bool bParam1, bool bParam2, bool bParam3, int iParam4)
{
	var uVar0;
	var uVar1;
	var uVar2;

	return aggregate_func_5629(bParam0, bParam1, &uVar0, &uVar1, &uVar2, bParam2, bParam3, iParam4);
}

bool func_1483()
{
	return Global_1915170->f_21357;
}
