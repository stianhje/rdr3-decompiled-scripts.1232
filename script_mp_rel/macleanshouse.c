...
void __EntryFunction__()
{
	...
	while (func_4())
	{
		...
		{
			iLocal_28 = 0;
			func_5(iLocal_29, &iLocal_27);
			switch (iLocal_27)
			{
				case 0:
					if (Global_1901929->f_1.f_24 > 0)
					{
						iLocal_30 = (MISC::GET_GAME_TIMER() + Global_1901929->f_1.f_24);
						iLocal_27 = 1;
					}
					else
					{
					...
					break;
				case 1:
					if (!func_1() || iLocal_30 < MISC::GET_GAME_TIMER())
					{
						iLocal_31 = 0;
						iLocal_27 = 2;
					}
				...
				case 2:
					...
					func_7();
					func_8();
					if (func_10(func_9(iLocal_29)))
					{
						func_11(func_9(iLocal_29), 4);
					}
					LAW::_0x9BBDCB8DF789EBC1(PLAYER::PLAYER_ID(), func_12(iLocal_29));
					Global_1896608 = -1;
					iLocal_30 = (iLocal_26 + MISC::GET_GAME_TIMER());
					iLocal_27 = 3;
					break;
				case 3:
					if (func_13() || iLocal_30 < MISC::GET_GAME_TIMER())
					{
						func_14(iLocal_29);
						iLocal_30 = (iLocal_26 + MISC::GET_GAME_TIMER());
						iLocal_27 = 4;
					...
					break;
				case 4:
					if (func_15(iLocal_29) || iLocal_30 < MISC::GET_GAME_TIMER())
					{
						func_16(iLocal_29);
					...
					break;
				case 5:
					if (func_17(iLocal_29) || iLocal_30 < MISC::GET_GAME_TIMER())
					{
						func_18(iLocal_29);
						iLocal_30 = (iLocal_26 + MISC::GET_GAME_TIMER());
						iLocal_27 = 7;
				...
				case 7:
					if (func_10(func_9(iLocal_29)))
					{
						if (func_19(func_9(iLocal_29), 4) && !iLocal_30 < MISC::GET_GAME_TIMER())
						{
						}
						else
						{
							if (func_20(iLocal_29) || iLocal_30 < MISC::GET_GAME_TIMER())
							{
								func_21(iLocal_29, 4);
								iLocal_30 = (iLocal_26 + MISC::GET_GAME_TIMER());
								iLocal_27 = 8;
							...
							func_36(iLocal_29, Global_1896662);
							iLocal_27 = 11;
							Jump @813; //curOff = 639
							func_37(iLocal_29);
							func_21(iLocal_29, 8);
							...
							iLocal_27 = 12;
							Jump @813; //curOff = 689
							if (func_40(iLocal_29))
							{
								iLocal_28 = MISC::GET_GAME_TIMER() + 1000;
							}
							func_41(Global_1896662, iLocal_29);
							func_42(iLocal_29);
							func_21(iLocal_29, 8);
							if (func_43())
							{
							...
							PATHFIND::SET_AMBIENT_PED_RANGE_MULTIPLIER_THIS_FRAME(((*Global_1887327)[iLocal_29 /*36*/])->f_11);
							if (((*Global_1887327)[iLocal_29 /*36*/])->f_12 > 0f)
							{
								PED::_0xA77FA7BE9312F8C0(((*Global_1887327)[iLocal_29 /*36*/])->f_12);
							}
							Jump @813; //curOff = 790
							func_8();
							func_44(iVar0);
						...
						if (((*Global_1887327)[iLocal_29 /*36*/])->f_13 != 0)
						{
							PED::_0x95423627A9CA598E(((*Global_1887327)[iLocal_29 /*36*/])->f_13);
						}
						BUILTIN::WAIT(0);
						iVar0 = 0;
						while (!func_44(iVar0))
...
void func_30(int iParam0)
{
	...
	func_58(899, iLocal_15, 1);
	func_58(766, iLocal_15, 0);
	func_58(900, iLocal_15, 0);
...
int func_44(int iParam0)
{
	if (iParam0 == 0)
	{
		...
		if (STATS::CHAL_IS_GOAL_ACTIVE(-663946200, 1055032020))
		{
			switch (iLocal_29)
			{
				...
				case 127:
				case 135:
					STATS::CHAL_ADD_GOAL_PROGRESS_INT_BY_SCORE_ID(func_77(iLocal_29, 0), 1);
					break;
			}
		}
		if (func_10(func_70()))
	...
	else if (func_45() == -1)
	{
		func_81(iLocal_29);
		func_82(iLocal_29);
		if (!func_83(iLocal_29, 0))
		{
			return 0;
		}
	}
	else if (!func_84(iLocal_29))
	{
		return 0;
	}
	SCRIPTS::TERMINATE_THIS_THREAD();
...
bool func_68(int iParam0)
{
	...
	return ((((*Global_1887327)[iParam0 /*36*/])->f_21 == 1 || ((*Global_1887327)[iParam0 /*36*/])->f_21 == 2) && !func_95(iParam0));
}
...
void func_71(int iParam0, int iParam1, int iParam2, bool bParam3, int iParam4, int iParam5)
{
	...
	sVar1 = func_97(iParam0, iParam1, iParam2, iParam4, iParam5, bParam3, &uVar0);
	...
	else if ((func_103(iParam1, 2) || func_104(iParam4, 2)) && !Global_1893575->f_9)
	{
	...
	else if ((func_62(iParam0) && func_85(iParam0, 16777216)) && !Global_1893575->f_9)
	{
	...
	else
	{
		...
		if (!MISC::_SHOULD_USE_24_HOUR_CLOCK())
		{
			...
			sVar2 = MISC::_CREATE_VAR_STRING(674, sVar8, iVar4, func_109(&sVar6, 109029619), sVar9, func_109(&sVar10, 109029619));
		}
		else
		{
			...
			IntToString(&sVar10, BUILTIN::ROUND(fVar7), 8);
			sVar2 = MISC::_CREATE_VAR_STRING(162, sVar8, iVar4, func_109(&sVar6, 109029619), func_109(&sVar10, 109029619));
		}
		Global_1893575->f_9 = 0;
	}
	Global_1938075->f_145 = func_110(sVar1, sVar2, 4000, 0, 0, 0, 0, 1);
}
...
int func_83(int iParam0, bool bParam1)
{
	...
	if (func_88(iParam0, &iVar0, &iVar1, 0, 0))
	{
		...
		while (true)
		{
			if (!func_118(Global_1896608->f_1, 16))
			{
				func_119(Global_1896608->f_1, 0);
			}
			Global_1896608->f_1++;
			iVar2++;
...
int func_91(int iParam0, bool bParam1)
{
	...
	{
		func_126(iParam0, _NAMESPACE48::_0x4F76E3676583D951(func_125(iParam0)));
		if (func_45() == -1)
		{
...
bool func_92(int iParam0, int iParam1)
{
	...
	if (iParam1 && !ENTITY::DOES_ENTITY_EXIST(func_60(iParam0)))
	{
		return false;
	}
...
char* func_97(int iParam0, int iParam1, int iParam2, int iParam3, var uParam4, var uParam5, var uParam6)
{
	char* sVar0;
...
void func_117(int iParam0)
{
	...
	if (func_89((Global_1915170->f_3[iParam0 /*447*/])->f_21) && func_142((Global_1915170->f_3[iParam0 /*447*/])->f_21))
	{
...
{
	func_169(&((Global_1938932->f_5[iParam0 /*11*/])->f_7), iParam1);
}
...
int func_162()
{
	...
	if (!func_164(*Global_1051163) && Global_1572887->f_7 & 1 != 0)
	{
		return 1;
	}
	return 0;
...
int func_166(vector3 vParam0, int iParam3)
{
	vector3 vVar0;
	struct<2> Var3;
	float fVar6;
