...
int func_13()
{
	...
	iLocal_172 = func_57(2834.069f, -1229.412f, 46.6618f, 0f, 0f, 0f, 18f, 18f, 18f, 1065353216);
	return 1;
}
...
int func_17(int iParam0)
{
	...
	iVar0 = 1;
	vVar1 = { 0f, 0f, 0f };
	if (func_61(61, &uVar5, &fVar4, &vVar1) && !func_62(vVar1))
	{
...
{
	func_70(0, iLocal_55, iParam0, iLocal_56, iLocal_57, 12, 0, 0, -1082130432, 0);
	...
	func_72(0, 0);
	func_70(3, iLocal_58, iParam0, iLocal_59, iLocal_61, 4, 0, 0, -1082130432, 0);
	func_73(3, 8192);
	...
	func_72(3, 0);
	func_70(4, iLocal_62, iParam0, iLocal_81, iLocal_82, 44, 0, 0, -1082130432, 0);
	func_71(4, 1687619371, 0, 0);
	func_72(4, 0);
	func_70(6, iLocal_51, iParam0, iLocal_52, iLocal_54, 20, 0, 0, -1082130432, 0);
	func_71(6, 1057071735, 0, 0);
	func_71(6, -1011766303, 0, 0);
	func_71(6, 841127028, 0, 0);
	func_72(6, 0);
	func_70(7, iLocal_69, iParam0, iLocal_67, iLocal_68, 4, 0, 0, -1082130432, 0);
	func_71(7, -1683351620, 0, 0);
	func_71(7, -548537711, 0, 0);
	func_71(7, -843327635, 0, 0);
	func_72(7, 0);
	func_70(25, iLocal_124, iParam0, 0, 0, 2, 0, 0, -1082130432, 0);
	func_73(25, 1);
	func_73(25, 16384);
	func_73(25, 8192);
	func_73(25, 536870912);
	func_70(18, iLocal_118, iParam0, iLocal_119, 0, 524290, 0, 0, -1082130432, 0);
	func_71(18, 123675751, 0, 0);
	func_71(18, 1079875175, 0, 0);
	func_72(18, 0);
	func_70(36, &(Global_1268116->f_47[Global_1268116->f_45]), 5, &(Global_1268116->f_50[Global_1268116->f_45]), 0, 2, 0, 0, -1082130432, 0);
	func_70(9, iLocal_71, iParam0, 0, 0, 2, 1, 0, -1082130432, 0);
	func_73(9, 536870912);
	func_73(9, 8388608);
	func_73(9, 1);
	func_73(9, 16384);
	...
	func_70(10, iLocal_90, iParam0, iLocal_91, 0, 460, 0, 0, -1082130432, 0);
	func_73(10, 536870912);
	func_72(10, 0);
	func_76();
	func_77(54);
	func_77(56);
	func_70(8, iLocal_63, iParam0, iLocal_64, 0, 4098, 0, 0, -1082130432, 0);
	...
	func_72(8, 0);
	func_70(2, iLocal_86, iParam0, iLocal_87, 0, 1277952, 0, 0, -1082130432, 0);
	func_72(2, 0);
	func_78(iParam0);
}
...
bool func_61(int iParam0, int iParam1, float fParam2, var uParam3)
{
	return func_130(iParam0, "sHash", iParam1, "fHeading", fParam2, "vPos", uParam3);
}
...
void func_77(int iParam0)
{
	...
	if (func_61(&(Global_1051387->f_3582[iVar0 /*19*/]), &iVar1, &fVar2, &vVar3))
	{
		(Global_1051387->f_3582[iVar0 /*19*/])->f_6 = func_165(iVar1, vVar3, fVar2, 0, 0, 0);
	...
	if (bVar7)
	{
		...
		{
			(Global_1051387->f_3582[iVar0 /*19*/])->f_13 = func_165(iVar1, vVar3, fVar2, 0, 0, 0);
...
void func_90()
{
	func_190(&uLocal_160, &uLocal_162, &uLocal_161, 2753.91f, -1396.01f, 45.21f, 1788943942, 715447956, -523602066);
}
...
void func_102(int iParam0, int iParam1, int iParam2, bool bParam3, int iParam4, int iParam5)
{
	var uVar0;
	char* sVar1;
	char* sVar2;
...
void func_104(int iParam0, bool bParam1)
{
	...
	func_186(func_213(-1532769513, -36357794), 1);
...
void func_122(var uParam0)
{
	...
	iVar0 = func_181();
	func_225(uParam0, func_224(iVar0));
	func_227(uParam0, func_226(iVar0));
	func_229(uParam0, func_228(iVar0));
}
...
int func_130(int iParam0, char* sParam1, var uParam2, char* sParam3, float fParam4, char* sParam5, var uParam6)
{
	struct<4> Var0;
...
int func_133(int iParam0, var uParam1, var uParam2, bool bParam3, bool bParam4)
{
	bool bVar0;
...
int func_155(int iParam0, var uParam1, float fParam2, var uParam3)
{
	return func_130(iParam0, "sClosedHash", uParam1, "fClosedHeading", fParam2, "vClosedPos", uParam3);
}
...
void func_156(int iParam0, int iParam1, vector3 vParam2, float fParam5, bool bParam6)
{
	...
	(Global_1051387->f_69[iParam0 /*76*/])->f_6 = func_165(iParam1, vParam2, fParam5, 0, 0, 0);
...
var func_165(int iParam0, vector3 vParam1, float fParam4, int iParam5, int iParam6, int iParam7)
{
...
int func_167(int iParam0)
{
	...
	(Global_1051387->f_4319[iVar6 /*7*/])->f_6 = func_165(iVar0, vVar2, fVar1, 0, 0, 0);
...
bool func_168(int iParam0, int iParam1)
{
	...
	if (iParam1 && !ENTITY::DOES_ENTITY_EXIST(func_175(iParam0)))
	{
		return false;
	}
...
struct<2> func_185(int iParam0)
{
	...
	return func_213(-277276100, uVar0);
}
...
float func_187(vector3 vParam0, bool bParam3)
{
	return func_265(Global_35, vParam0, bParam3);
}
...
void func_192(int iParam0, float fParam1, int iParam2, int iParam3)
{
	if (func_151(iParam0))
	{
...
void func_247(int iParam0, bool bParam1, int iParam2, int iParam3)
{
	func_292(iParam0);
	if (!func_293(1))
	{
...
int func_300(int iParam0, var uParam1, var uParam2)
{
	...
	if (func_322(iParam0, uParam1, &iVar0))
	{
		func_323(&iVar0, iParam0, uParam2);
	}
	else
	{
		return 0;
...
int func_308(vector3 vParam0, int iParam3)
{
	...
	func_327(iParam3, &vVar0, &Var3, &fVar6);
	if (func_328(vParam0, vVar0, Var3, Var3.f_1, fVar6))
	{
		return 1;
	}
	return 0;
