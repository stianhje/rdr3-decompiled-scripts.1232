...
int func_40(int iParam0)
{
	...
	{
		case 0:
			if ((((STREAMING::HAS_MODEL_LOADED(1282171014) && PED::_0x5E420FF293EE5472()) && ANIMSCENE::_0x25557E324489393C(iLocal_20)) && ANIMSCENE::_0x477122B8D05E7968(iLocal_20, 1, 0)) && !func_62())
			{
				iLocal_21 = 1;
			}
			break;
...
void func_41(var uParam0, int iParam1)
{
	...
	if ((BUILTIN::VDIST(Global_36, 0f, 0f, 0f) <= 5f || func_72(&Global_1939168, 32768)) || func_72(&Global_1939168, 16777216))
	{
		return;
	}
...
bool func_62()
{
	return func_72(&Global_1939168, 8192);
}
...
void func_87(int iParam0)
{
	...
	STREAMING::SET_MODEL_AS_NO_LONGER_NEEDED(1282171014);
...
void func_107(var uParam0, var uParam1)
{
	if (ENTITY::DOES_ENTITY_EXIST(*uParam0) && !ENTITY::IS_ENTITY_DEAD(*uParam0))
	{
		_NAMESPACE29::_0x0EABF182FBB63D72(*uParam0, uParam1, 1);
	}
}
...
{
	func_161((Global_1938932->f_5[iParam0 /*11*/])->f_6, 1);
	func_162((Global_1938932->f_5[iParam0 /*11*/])->f_6, 0);
...
void func_131(int iParam0)
{
	...
	if (func_96((Global_1915170->f_3[iParam0 /*447*/])->f_21) && func_164((Global_1915170->f_3[iParam0 /*447*/])->f_21))
	{
		func_165((Global_1915170->f_3[iParam0 /*447*/])->f_21, 0, 1, 0, 0);
	}
	...
	func_166((Global_1915170->f_3[iParam0 /*447*/])->f_9, 0);
	...
	else
	{
		...
		while (iVar0 < iVar1)
		{
			func_169(&((Global_1915170->f_3[iParam0 /*447*/])->f_318[iVar0 /*6*/]));
...
void func_138(int iParam0)
{
	...
	else
	{
		...
		while (iVar2 < iVar3)
		{
			func_169(&((Global_1051387->f_69[iParam0 /*76*/])->f_32[iVar2]));
	...
	if (VOLUME::_0x92A78D0BEDB332A3((Global_1051387->f_69[iParam0 /*76*/])->f_25) && func_183(iParam0, 2))
	{
...
{
	func_192(&((Global_1938932->f_5[iParam0 /*11*/])->f_7), iParam1);
}
...
{
	return func_204((Global_1051387->f_69[iParam0 /*76*/])->f_51, iParam1);
}
...
int func_189(vector3 vParam0, int iParam3)
{
	...
	func_210(iParam3, &vVar0, &Var3, &fVar6);
	if (func_211(vParam0, vVar0, Var3, Var3.f_1, fVar6))
	{
		return 1;
	}
	return 0;
