...
void func_13(var uParam0, var uParam1, var uParam2, var uParam3, var uParam4)
{
	...
	iVar19 = func_30(&uVar18, Local_90.f_1, Local_90.f_2);
	if (uVar18 || iVar19 == -1)
	{
		return;
	}
...
int func_154(vector3 vParam0, var uParam3, var uParam4, int iParam5, int iParam6, bool bParam7)
{
	var uVar0;
...
int func_190()
{
	...
	iVar0 = 1;
	if (iVar0 && !UNLOCK::_UNLOCK_IS_UNLOCKED(Local_90.f_14))
	{
		return 0;
	}
	return 1;
...
int func_212(var uParam0, int iParam1, vector3 vParam2, float fParam5, bool bParam6, int iParam7, bool bParam8, bool bParam9, bool bParam10)
{
	int iVar0;
	...
	iVar0 = func_238(iParam1, vParam2, fParam5, bParam8, 1, bParam6, iParam7, bParam9);
...
int func_216(int iParam0, int iParam1, var uParam2, var uParam3, int iParam4, float fParam5)
{
	...
	if (!Global_1939168->f_6 && !ENTITY::IS_ENTITY_DEAD(iParam0))
	{
		...
		{
			if (func_248(uParam2, 1065353216))
			{
				if (!uParam2->f_1 & 4 != 0)
				{
		...
		if (Global_1939168->f_50)
		{
			if (*uParam2 & -2147483648 != 0)
			{
				...
				{
					if (func_266(PLAYER::PLAYER_PED_ID(), iParam0, 1060437492) == 0)
					{
						*uParam3 = 1048576;
						func_243(iParam0, uParam2, *uParam3);
						return 1;
...
int func_238(int iParam0, vector3 vParam1, float fParam4, bool bParam5, bool bParam6, bool bParam7, var uParam8, bool bParam9)
{
	int iVar0;
...
int func_266(int iParam0, int iParam1, float fParam2)
{
	vector3 vVar0;

	vVar0 = { ENTITY::GET_ENTITY_COORDS(iParam1, false, false) };
	return func_324(iParam0, vVar0, fParam2);
}
