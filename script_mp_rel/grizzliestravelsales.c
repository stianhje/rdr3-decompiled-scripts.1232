...
int func_13()
{
	iLocal_21 = VOLUME::_CREATE_VOLUME_BOX_WITH_CUSTOM_NAME(1387.506f, 1317.969f, 163.969f, 0f, 0f, 170f, 14.456f, 10.148f, 8.8f, "GRZ TravellingSalesman - m_volTravellingSalesman");
	iLocal_22 = VOLUME::_CREATE_VOLUME_CYLINDER_WITH_CUSTOM_NAME(1390.109f, 1317.562f, 163.969f, 0f, 0f, 170f, 3.7f, 3.7f, 4.2f, "GRZ TravellingSalesman - m_volTravellingSalesmanPrompt");
	return 1;
}
...
{
	func_58(38, iLocal_21, iParam0, iLocal_22, 0, 12, 1, 0, -1082130432, 0);
	func_59(38, 0);
}
...
int func_59(int iParam0, bool bParam1)
{
	...
	if ((!bParam1 && func_103(iVar0, &iVar1, &fVar2, &vVar3)) || (bParam1 && func_104(iVar0, &iVar1, &fVar2, &vVar3)))
	{
		func_105(iParam0, iVar1, vVar3, fVar2, 0);
...
int func_103(int iParam0, var uParam1, float fParam2, var uParam3)
{
	return func_162(iParam0, "sHash", uParam1, "fHeading", fParam2, "vPos", uParam3);
}

int func_104(int iParam0, var uParam1, float fParam2, var uParam3)
{
	return func_162(iParam0, "sClosedHash", uParam1, "fClosedHeading", fParam2, "vClosedPos", uParam3);
}

void func_105(int iParam0, int iParam1, vector3 vParam2, float fParam5, bool bParam6)
{
	if (bParam6)
	{
		MISC::GET_GROUND_Z_FOR_3D_COORD(vParam2, &(vParam2.f_2), 0);
	}
	(Global_1051387->f_69[iParam0 /*76*/])->f_6 = func_163(iParam1, vParam2, fParam5, 0, 0, 0);
...
int func_162(int iParam0, char* sParam1, var uParam2, char* sParam3, float fParam4, char* sParam5, var uParam6)
{
	struct<4> Var0;
...
var func_163(int iParam0, vector3 vParam1, float fParam4, int iParam5, int iParam6, int iParam7)
{
...
bool func_198(var uParam0, var uParam1)
{
...
int func_206(vector3 vParam0, int iParam3)
{
	...
	func_227(iParam3, &vVar0, &Var3, &fVar6);
	if (func_228(vParam0, vVar0, Var3, Var3.f_1, fVar6))
	{
		return 1;
	}
	return 0;
...
int func_233(struct<2> Param0, var uParam2)
{
	if (!func_204(Param0))
	{
		return 0;
