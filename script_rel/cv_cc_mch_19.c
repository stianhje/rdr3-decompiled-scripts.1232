...
int func_72(var uParam0)
{
	...
	func_151(uParam0, 1.62f, -1.09f, 1f, 0f, 3f, 4f, 3f, -1612834106, 1632043240, 1, 1, 1);
	iLocal_15 = func_152(uParam0, 1058703817, 0f, 0f, 0f, "HAMMER", 0, 1, 1);
	func_152(uParam0, -1402507254, 0f, 0f, 0f, "CIGAR", 0, 1, 1);
	if (iVar0 == 1)
	{
		iLocal_16 = func_152(uParam0, 1855988254, 0.335795f, 0.233134f, 0.478706f, 0, 1, 0, 1);
	}
	func_153(uParam0, "script@vignette@micah_19@base", 1, 1, 0, 0);
	func_153(uParam0, "script@vignette@micah_19@action", 0, 0, 1, 0);
	func_154(uParam0, "CCM19AU");
	func_155(uParam0, iLocal_14, 2, 368826910, "PROP_HUMAN_REPAIR_WAGON_WHEEL_ON_SMALL_MALE_A", -1, 0, -1073741824, 1065353216, 1);
...
int func_86(var uParam0)
{
	...
	if (iLocal_16 != -1)
	{
		iVar0 = func_188(uParam0, iLocal_16);
		if (ENTITY::DOES_ENTITY_EXIST(iVar0))
		{
			ENTITY::SET_ENTITY_COORDS(iVar0, func_189(uParam0, 0.762663f, 0.177343f, 0.465f), true, false, true, true);
		}
	}
	return 1;
}
