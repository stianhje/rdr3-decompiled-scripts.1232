...
int func_20()
{
	...
	if (func_61(&(uLocal_15[iVar0]), 0, 0))
	{
		...
		func_127(&(uLocal_15[iVar0]), func_126(&Local_274, iVar0), 1);
		if (func_128(&(uLocal_15.f_40[iVar0]), 0))
		{
		...
		{
			case 0:
				Local_274.f_57 = PED::GET_PED_ACCURACY(&(uLocal_15[iVar0]));
				func_129(&(uLocal_15[iVar0]), -1101297303, -1, 1, 0, 1056964608, 1065353216, 1);
				TASK::TASK_FOLLOW_NAV_MESH_TO_COORD(&(uLocal_15[0]), func_130(&Local_274, 0), 1.5f, 20000, 0.25f, false, func_131(&Local_274, 0));
				break;
			
			case 1:
				func_129(&(uLocal_15[iVar0]), -594562071, -1, 1, 0, 1056964608, 1065353216, 1);
				TASK::TASK_FOLLOW_NAV_MESH_TO_COORD(&(uLocal_15[1]), func_130(&Local_274, 1), 1.5f, 20000, 0.25f, false, func_131(&Local_274, 1));
				break;
...
int func_31()
{
	...
	Local_274.f_56 = func_166(&uLocal_15);
	func_167();
	func_168();
	iVar0 = 0;
	while (iVar0 < uLocal_15.f_215)
	{
		func_169(&uLocal_15, iVar0, &(uLocal_15.f_40[iVar0]));
		iVar0++;
	}
	switch (Local_274.f_5)
	{
		...
		case 2:
			if (func_172(&uLocal_15, &(Local_274.f_54), Local_274.f_10[3 /*3*/], "COMBAT_FLEE", 1092616192))
			{
				func_173();
...
void func_49()
{
	...
	if (!func_18(Global_1393447, 65536))
	{
		if (func_61(&(uLocal_15[0]), 0, 0))
		{
			...
			TASK::_TASK_SMART_FLEE_STYLE_COORD(&(uLocal_15[0]), uLocal_15.f_209, 4, 16768, -1f, -1, 0);
			PED::SET_PED_KEEP_TASK(&(uLocal_15[0]), true);
		}
		if (func_61(&(uLocal_15[1]), 0, 0))
		{
			func_195(&uLocal_15, 1, 2);
			TASK::_TASK_SMART_FLEE_STYLE_COORD(&(uLocal_15[1]), uLocal_15.f_209, 4, 16768, -1f, -1, 0);
...
void func_51()
{
			...
			else
			{
				if (func_61(&(uLocal_15[iVar0]), 0, 0))
				{
					...
					else if ((uLocal_15.f_215 == uLocal_15.f_216 && func_61(&(uLocal_15.f_40[iVar0]), 0, 1)) && !PED::IS_PED_IN_ANY_VEHICLE(&(uLocal_15[iVar0]), true))
					{
						...
						func_200(&(uLocal_15[iVar0]), &iVar12, 0, 0, 1, 1);
						PED::SET_PED_KEEP_TASK(&(uLocal_15[iVar0]), true);
					}
					else
					{
	...
	while (iVar0 < uLocal_15.f_218)
	{
		if (ENTITY::DOES_ENTITY_EXIST(&(uLocal_15.f_52[iVar0])))
		{
			if (func_205(&uLocal_15, &(uLocal_15.f_52[iVar0])))
			{
...
void func_75()
{
	...
	if (uLocal_15.f_19 < uLocal_15.f_215)
	{
		...
		if (ENTITY::DOES_ENTITY_EXIST(&(uLocal_15[iVar0])))
		{
			...
			{
				if (func_221(&(uLocal_15[iVar0]), 200f, -1082130432, &(uLocal_15.f_9[iVar0]), -1082130432))
				{
					func_195(&uLocal_15, iVar0, 8);
				}
			}
		}
	}
	else if (uLocal_15.f_19 < (uLocal_15.f_215 + uLocal_15.f_216))
	{
		...
		if (ENTITY::DOES_ENTITY_EXIST(&(uLocal_15.f_40[iVar0])))
		{
			...
			{
				if (func_221(&(uLocal_15.f_40[iVar0]), 200f, -1082130432, -1082130432, -1082130432))
				{
...
int func_83()
{
	...
	Local_274.f_58 = uLocal_15.f_222;
	func_22(&uLocal_15, 131072);
	func_246(&uLocal_15, 2, 1);
	func_247();
	func_248();
...
int func_92(int iParam0)
{
	...
	{
		case 0:
			if (&uLocal_15.f_57[iVar0] == 0)
			{
				uLocal_15.f_57[iVar0] = -526169133;
			}
			break;
		...
		case 1:
			if (&uLocal_15.f_57[iVar0] == 0)
			{
				uLocal_15.f_57[iVar0] = -450053710;
			}
			break;
	}
	if (&uLocal_15.f_57[iVar0] == 0)
	{
		uLocal_15.f_57[iVar0] = func_257(uLocal_15.f_181, 0, 1);
	}
	return &(uLocal_15.f_57[iVar0]);
}
...
int func_95()
{
	...
	switch (Local_274.f_3)
	{
		...
		case 1:
			...
			if (!func_262(&uLocal_15, &Local_274))
			{
				iVar0 = 0;
			}
			return iVar0;
...
void func_134(int iParam0, int iParam1)
{
	...
	PED::SET_PED_SHOOT_RATE(&(uLocal_15[iParam0]), iVar0);
}
...
int func_138()
{
	...
	if (ENTITY::DOES_ENTITY_EXIST(&(uLocal_15.f_40[Local_274.f_55])))
	{
		if (ENTITY::HAS_ENTITY_BEEN_DAMAGED_BY_ENTITY(&(uLocal_15.f_40[Local_274.f_55]), Global_35, 1, 1))
		{
			return 1;
		}
	}
	if (func_278(&uLocal_15, &(uLocal_15.f_152), &(uLocal_15.f_180), &(Local_274.f_55), 0, 4, 1))
	{
		return 1;
	}
	return 0;
...
int func_146()
{
	...
	{
		func_288(&uLocal_15, func_287(36, 1), 0, 0, 1, 0);
	}
	if (func_61(&(uLocal_15[1]), 0, 1))
	{
		func_288(&uLocal_15, func_287(36, 1), 1, 1, 1, 1.2f);
	}
	return 1;
}
...
int func_147()
{
	...
	{
		func_291(&(uLocal_15[0]), Global_35, 3, 1, 100, 0);
...
void func_151()
{
	...
	func_79(&(uLocal_15.f_152), 1);
	func_292(&(uLocal_15.f_152), 1);
	func_293(&(uLocal_15.f_152), 1);
	func_234(&(uLocal_15.f_152), 1);
	func_294(&(uLocal_15.f_152), 1);
...
int func_152()
{
	...
	switch (Local_274.f_6)
	{
		case 0:
			...
			if (!func_125(&Local_274))
			{
				TASK::TASK_AIM_GUN_AT_ENTITY(&(uLocal_15[Local_274.f_8]), Global_35, BUILTIN::FLOOR((1f * 1000f)) + 4000, 0, 1);
			}
		...
		case 1:
			...
			if (func_297(&(uLocal_15[Local_274.f_9]), Local_274.f_42[Local_274.f_9], 41, 0, 0, 1084227584, 100, 0, 0) || func_47(Local_274.f_10[5 /*3*/], 2f))
			{
				if (!func_125(&Local_274))
				{
					func_298();
					Local_274.f_59 = EVENT::ADD_SHOCKING_EVENT_AT_POSITION(-2108467590, uLocal_15.f_209, -1f, 100f, 100f, -1082130432, -1082130432, 4, 4);
					if (Local_274.f_59 != 0)
					{
					}
				}
				...
				*(vVar0[1 /*3*/]) = { func_300(&Local_274, Local_274.f_8) };
				...
				func_200(&(uLocal_15[Local_274.f_8]), &iVar7, 0, 0, 1, 1);
		...
		case 2:
			...
			*(vVar0[1 /*3*/]) = { func_300(&Local_274, Local_274.f_9) };
			...
			TASK::TASK_FOLLOW_NAV_MESH_TO_COORD(0, *(vVar0[1 /*3*/]), 2f, -1, 0.25f, 1056773, 40000f);
			TASK::TASK_COMBAT_PED(0, Global_35, 0, 0);
			func_200(&(uLocal_15[Local_274.f_9]), &iVar7, 0, 0, 1, 1);
		...
		case 3:
			...
			if (func_47(Local_274.f_10[1 /*3*/], 0.2f))
			{
				...
				{
					sVar8 = func_301(&uLocal_15, &Local_274);
					iVar10 = func_302(&Local_274);
					cVar9 = func_126(&Local_274, 0);
					func_303(&(uLocal_15[0]), Global_35, sVar8, -1073741824, 0, -500314840, 0, cVar9, iVar10);
					func_304(&(uLocal_15[0]), uLocal_15.f_22[0], 831283580, 0, 0, 0);
...
void func_153()
{
	...
	while (iVar0 <= 4)
	{
		if (func_61(&(uLocal_15[iVar0]), 0, 1))
		{
			...
			{
				func_304(&(uLocal_15[iVar0]), uLocal_15.f_22[iVar0], 831283580, 0, 0, 0);
			...
			if (func_47(Local_274.f_10[0 /*3*/], 2.5f))
			{
				...
				if (func_326(iVar0))
				{
					...
					if (!func_148(&Local_274, 2))
					{
						...
						func_303(&(uLocal_15[iVar0]), Global_35, sVar2, -1073741824, 1, -500314840, 0, cVar1, iVar3);
		...
		case 1:
			if (func_47(Local_274.f_10[2 /*3*/], 5f))
			{
				...
				if (func_326(iVar0))
				{
					...
					func_303(&(uLocal_15[iVar0]), Global_35, sVar2, -1073741824, 1, 1744022339, 0, cVar1, iVar3);
...
void func_174()
{
	...
	while (iVar0 < 5)
	{
		if (!func_136(&uLocal_15, iVar0, 16777216))
		{
			if (func_342(&(uLocal_15[iVar0]), Global_35, 10f, 1))
			{
				if (func_61(&(uLocal_15.f_40[iVar0]), 0, 1) && PED::_0xB676EFDA03DADA52(&(uLocal_15.f_40[iVar0]), 0) != 0)
				{
					TASK::CLEAR_PED_TASKS(&(uLocal_15.f_40[iVar0]), 1, 0);
				}
				TASK::TASK_COMBAT_PED(&(uLocal_15[iVar0]), Global_35, 100663296, 0);
				func_162(&uLocal_15, iVar0, 16777216);
			}
		}
		iVar0++;
	}
...
int func_188(int iParam0)
{
	...
	{
		fVar0 = func_194(&(uLocal_15.f_247));
...
int func_202(int iParam0, int iParam1)
{
	...
	if (func_373(&(uLocal_15.f_40[iParam0]), iParam1))
	{
		return 1;
	}
...
int func_203(int iParam0)
{
	...
	if (func_375(&(uLocal_15.f_84[iParam0]), fVar0))
	{
		return 0;
	}
	if (func_190(&(uLocal_15.f_84[iParam0]), Global_36, 1) < 10f)
	{
		return 0;
	}
	return 1;
...
void func_281()
{
	...
	while (iVar3 <= 4)
	{
		if (func_61(&(uLocal_15[iVar3]), 0, 0))
		{
			...
			TASK::TASK_COMBAT_PED(0, Global_35, 0, 0);
			func_200(&(uLocal_15[iVar3]), &iVar4, fVar5, 0, 1, 1);
		}
		iVar3++;
	}
...
void func_283()
{
	...
	if (!bVar2)
	{
		if (func_61(&(uLocal_15[0]), 0, 1))
		{
			func_341(&(uLocal_15[0]), Global_35, func_301(&uLocal_15, &Local_274), 0, 70f, 0, 0, 0, 1, 1, 1, 291934926, 1, 0, 0);
			bVar2 = true;
		}
	}
	iVar0 = 0;
	while (iVar0 < uLocal_15.f_215)
	{
		if (func_61(&(uLocal_15[iVar0]), 0, 1))
		{
			...
			func_200(&(uLocal_15[iVar0]), &iVar1, 0.3f, 1f, 1, 1);
			func_304(&(uLocal_15[iVar0]), uLocal_15.f_22[iVar0], 831283580, 0, 0, 0);
			if (!bVar2)
			{
				func_341(&(uLocal_15[iVar0]), Global_35, func_301(&uLocal_15, &Local_274), 0, 70f, 0, 0, 0, 1, 1, 1, 291934926, 1, 0, 0);
				bVar2 = true;
			}
		}
		iVar0++;
...
void func_298()
{
	...
	Var3.f_8 = -1082130432;
	Var3 = { ENTITY::GET_OFFSET_FROM_ENTITY_IN_WORLD_COORDS(&(uLocal_15[1]), 0f, 2f, 1f) };
	Var3.f_3 = { vVar0 };
	Var3.f_6 = 1402226560;
	Var3.f_7 = 1f;
	Var3.f_12 = 1;
...
int func_336(int iParam0, int iParam1)
{
	...
	while (iVar0 <= iParam1)
	{
		if (func_61(&(uLocal_15[iVar0]), 0, 0))
		{
			fVar3 = func_220(&(uLocal_15[iVar0]), Global_36, 0);
			if (fVar3 < fVar2)
			{
				fVar2 = fVar3;
				iVar1 = iVar0;
...
int func_442(int iParam0, int iParam1, bool bParam2, int iParam3)
{
	...
	while (iVar2 <= iParam1)
	{
		if (func_61(&(uLocal_15[iVar2]), 0, 0))
		{
			fVar1 = &uLocal_15.f_9[iVar2];
			if ((fVar1 < fVar0 && !bParam2) || !AUDIO::IS_SCRIPTED_SPEECH_PLAYING(&(uLocal_15[iVar2])))
			{
...
int func_591(int iParam0, int iParam1)
{
	...
	if (func_672(iParam0, 1, 0, 0) != 2055893578)
	{
		return 0;
	}
