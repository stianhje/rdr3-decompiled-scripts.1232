...
void func_53()
{
	...
	{
		INTERIOR::DEACTIVATE_INTERIOR_ENTITY_SET(iVar0, "Lights", 1);
		bVar1 = true;
	}
	if (bVar1)
	{
...
void func_97(int iParam0, bool bParam1, int iParam2, bool bParam3, bool bParam4, float fParam5, int iParam6, bool bParam7)
{
	...
	if (func_152(iParam0))
	{
		...
		if (bParam3)
		{
			func_153(iParam0, iParam2, 1, iParam6);
		}
		else if (bParam1)
		{
			if (bParam4)
