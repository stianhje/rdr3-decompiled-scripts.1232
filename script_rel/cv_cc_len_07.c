...
int func_72(var uParam0)
{
	...
	uLocal_25 = func_152(uParam0, joaat("p_chairfolding02x"), 0f, 0f, 0f, "CHAIR", 1, 0, 1);
	uLocal_26 = func_152(uParam0, joaat("p_stoolfolding01x"), 1.38431f, -0.0333712f, 0.0286636f, 0, 1, 0, 1);
	uLocal_27 = func_152(uParam0, joaat("p_stoolfolding01x"), -1.50732f, -0.0390171f, 0.0290756f, 0, 1, 0, 1);
...
void func_402(int iParam0, int iParam1)
{
	...
	switch (iParam0)
	{
		case 11:
			...
			{
				func_447(iParam1, joaat("weapon_revolver_cattleman_sadie"), 0, 0, 2, 1, 0, 1056964608, 1065353216, -1, 0, 0, 0, 0);
				func_447(iParam1, joaat("weapon_revolver_cattleman_sadie_dualwield"), 0, 0, 3, 1, 1, 1056964608, 1065353216, -1, 0, 1, 0, 0);
			}
			break;
	}
}
