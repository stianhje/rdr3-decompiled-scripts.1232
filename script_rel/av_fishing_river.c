...
{
	func_33(uParam0, 11074/*func_30*/, 11139/*func_31*/, 12672/*func_32*/);
}
...
void func_14(var uParam0, vector3 vParam1, vector3 vParam4)
{
	...
	func_50(uParam0, 2, "FRP_FISH", -2116748615, OBJECT::_GET_OBJECT_OFFSET_FROM_COORDS(vParam1, vParam4.z, 0f, 33f, -0.5f), vParam4.z, 1, 1, 1, 1, 41788943, 1);
}
...
int func_31(var uParam0)
{
	...
	if (!iLocal_82)
	{
		...
		{
			func_71(&(uParam0->f_20[0 /*14*/]), Global_35, "GREET_MALE", 0, -1082130432, 1, 0, 0, 1, 1, 1, -417894478, 1, 0, 0);
			iLocal_82 = 1;
		}
	}
	if (!iLocal_83)
	...
	switch (iLocal_10)
	{
		case 0:
			if (!ENTITY::IS_ENTITY_DEAD(&(uParam0->f_20[0 /*14*/])))
			{
				...
				WEAPON::_GIVE_WEAPON_TO_PED_2(&(uParam0->f_20[0 /*14*/]), -1415022764, 1, true, true, 0, false, 0.5f, 1f, 752097756, true, 0f, false);
				WEAPON::_GIVE_WEAPON_TO_PED_2(&(uParam0->f_20[0 /*14*/]), 379542007, 999, false, true, 0, false, 0.5f, 1f, 752097756, false, 0f, false);
				WEAPON::SET_CURRENT_PED_WEAPON(&(uParam0->f_20[0 /*14*/]), -1415022764, true, 0, false, false);
			...
			if (!ENTITY::IS_ENTITY_DEAD(&(uParam0->f_20[1 /*14*/])))
			{
				...
				if (*uParam0 == 44)
				{
					PED::_0xB8B6430EAD2D2437(&(uParam0->f_20[1 /*14*/]), 1378588234);
...
void func_67(var uParam0)
{
	if (!ENTITY::IS_ENTITY_DEAD(&(uParam0->f_20[0 /*14*/])))
	{
		WEAPON::SET_CURRENT_PED_WEAPON(&(uParam0->f_20[0 /*14*/]), 379542007, true, 0, true, false);
	}
}
...
bool func_71(int iParam0, int iParam1, char* sParam2, int iParam3, float fParam4, int iParam5, bool bParam6, int iParam7, int iParam8, bool bParam9, int iParam10, int iParam11, bool bParam12, bool bParam13, int iParam14)
{
	return func_114(iParam0, iParam1, sParam2, iParam3, fParam4, iParam5, bParam6, iParam7, iParam8, bParam9, iParam10, iParam11, 0, bParam12, bParam13, iParam14) >= 0;
}
...
void func_75(var uParam0, bool bParam1, int iParam2)
{
...
float func_76(int iParam0, int iParam1, bool bParam2, int iParam3)
{
...
int func_79(var uParam0)
{
	switch (Local_42)
	{
		case 1:
			...
			Local_42.f_1 = 30f;
			func_77(&uLocal_72);
			if (!func_123(&(uParam0->f_20[0 /*14*/]), 425310094))
			{
		...
		case 6:
			if (((func_78(&uLocal_75, 80f) && !iLocal_87) && Local_42.f_2 > 15f) && *uParam0 != 44)
			{
				if (!ENTITY::IS_ENTITY_DEAD(&(uParam0->f_20[2 /*14*/])))
				{
		...
		case 12:
			...
			if (!iLocal_89 && func_119(Local_42.f_5, 32))
			{
...
void func_112(int iParam0, vector3 vParam1)
{
	...
	while (iVar0 < 10)
	{
		...
		{
			if (func_137((Global_32073.f_2697.f_1495[iVar0 /*4*/])->f_1, vParam1, 1056964608, 1))
			{
				return;
			}
		}
...
int func_114(int iParam0, int iParam1, char* sParam2, var uParam3, float fParam4, var uParam5, bool bParam6, var uParam7, var uParam8, bool bParam9, var uParam10, int iParam11, bool bParam12, bool bParam13, bool bParam14, var uParam15)
{
	bool bVar0;
	float fVar1;
	int iVar2;
	...
	if ((!ENTITY::IS_ENTITY_DEAD(iParam0) || iParam11 == 1718175949) || bParam9 == 0)
	{
		...
		if (((bVar0 || uParam7) || fVar1 < fParam4) || bParam9 == 0)
		{
			...
			{
				iVar2 = func_138(func_185(iParam0, sParam2, iParam11, iParam1, NETWORK::NETWORK_IS_GAME_IN_PROGRESS(), 0, uParam5, uParam15), 1, -1);
			}
			if (iVar2 >= 0)
			{
			}
...
void func_182(int iParam0, int iParam1, int iParam2, int iParam3, int iParam4, int iParam5, bool bParam6, int iParam7)
{
	int iVar0;
	
	iVar0 = (((iParam2 + (60 * iParam3)) + (3600 * iParam4)) + (86400 * iParam5));
	if (func_235(iParam0) == 1 && iParam7)
	{
		return;
	}
	if (bParam6)
...
float func_183(int iParam0, bool bParam1, int iParam2)
{
	if (iParam2 && ENTITY::IS_ENTITY_DEAD(iParam0))
	{
		return -1f;
	}
	return func_76(Global_35, iParam0, bParam1, iParam2);
}
...
bool func_185(int iParam0, char* sParam1, int iParam2, int iParam3, bool bParam4, int iParam5, var uParam6, var uParam7)
{
	struct<7> Var0;
...
int func_240(bool bParam0, var uParam1, var uParam2)
{
	int iVar0;
	int iVar1;
