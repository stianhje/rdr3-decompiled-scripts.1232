...
int func_42(var uParam0)
{
	*uParam0 = 15;
	...
	uParam0->f_9 = 80f;
	uParam0->f_10 = 180f;
	uParam0->f_572[0] = 704666041;
	uParam0->f_572[1] = -653781891;
	uParam0->f_572[2] = -115697482;
	uParam0->f_580[0] = 0;
	uParam0->f_580[1] = 1;
	uParam0->f_580[2] = 2;
	uParam0->f_588[0] = 0;
...
Vector3 func_160()
{
	return func_203("ATZ_INS_EXC_WO");
}

Vector3 func_161()
{
	return func_203("ATZ_INS_FUR_WO");
}
...
Vector3 func_202(int iParam0, int iParam1)
{
	switch (iParam0)
	{
		case 0:
			...
			{
				case 0:
					return 125.438f, 1822.5f, 199.2836f;
				case 1:
					return 237.6015f, 1907.287f, 205.3007f;
				case 2:
					return 193.563f, 1922.584f, 205.2459f;
			}
			break;
		case 1:
			switch (iParam1)
			{
				case 0:
					return 225.3844f, 1919.657f, 204.4669f;
				case 1:
					return 137.1918f, 1897.371f, 201.4729f;
				case 2:
					return 242.483f, 1830.81f, 199.6367f;
			}
			break;
		case 2:
			switch (iParam1)
			{
				case 0:
					return 235.378f, 1869.217f, 203.8495f;
				case 1:
					return 157.9313f, 1864.147f, 200.5739f;
				case 2:
					return 193.8669f, 1832.833f, 201.079f;
			}
			break;
		case 3:
			switch (iParam1)
			{
				case 0:
					return 206.5241f, 1831.74f, 201.0796f;
				case 1:
					return 182.0847f, 1916.186f, 204.7546f;
				case 2:
					return 153.3792f, 1873.394f, 200.4012f;
			}
			break;
	}
	return 0f, 0f, 0f;
