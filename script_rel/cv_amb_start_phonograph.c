...
int func_72(var uParam0)
{
	...
	{
		func_150(uParam0, "script@ambient@campfiregeneral@start_music_cylinder@table@base", 1, 1, 0, 0);
		iLocal_16 = func_150(uParam0, "script@ambient@campfiregeneral@start_music_cylinder@table@action", 0, 0, 1, 0);
	}
	else
	{
		func_150(uParam0, "script@ambient@campfiregeneral@start_music_cylinder@tent@base", 1, 1, 0, 0);
		iLocal_16 = func_150(uParam0, "script@ambient@campfiregeneral@start_music_cylinder@tent@action", 0, 0, 1, 0);
	}
	iLocal_14 = func_151(uParam0, 0, 0);
	func_152(uParam0, -0.45f, 1.21f, 0f, 0f, 2.5f, 2f, 3f, -1612834106, 2017216891, 1, 1, 1);
	iLocal_15 = func_153(uParam0, -548150401, 0f, 0f, 0f, "p_cigar01x_PH_R_HAND", 0, 0, 1);
	func_153(uParam0, -1816726898, 0f, 0f, 0f, "p_phonograph01x", 1, 0, 1);
	if (bVar0)
	{
		func_154(uParam0, iLocal_14, 2, 920578187, "WORLD_CAMP_DUTCH_SMOKE_CIGAR_MALE_A", -1, 0, -1073741824, 1065353216, 0);
	}
	else
	{
		func_154(uParam0, iLocal_14, 2, 920578187, "WORLD_CAMP_DUTCH_SMOKE_CIGAR_MALE_A", -1, 1, -1073741824, 1065353216, 1);
	}
...
int func_85(var uParam0)
{
	...
	if (!uParam0->f_4)
	{
		...
		while (iVar0 < uParam0->f_106)
		{
			...
			else if (func_169(uParam0, iVar0))
			{
			}
	...
	{
		func_184(uParam0);
		func_185(uParam0, uParam0->f_2047, 1);
	}
...
int func_91(var uParam0)
{
	...
	if (!uParam0->f_2265)
	{
		func_187(uParam0->f_2, 1);
	}
	iVar0 = func_188(func_19(uParam0));
	func_189(iVar0);
	...
	if (uParam0->f_2048 >= 0)
	{
		func_185(uParam0, uParam0->f_2048, 1);
	}
	func_192(uParam0);
...
int func_150(var uParam0, char* sParam1, int iParam2, bool bParam3, bool bParam4, bool bParam5)
{
	int iVar0;
...
void func_164(var uParam0, vector3 vParam1, vector3 vParam4)
{
	int iVar0;
...
int func_168(var uParam0)
{
	...
	while (iVar3 < uParam0->f_106)
	{
		...
		else if (func_169(uParam0, iVar3))
		{
		}
...
void func_200(var uParam0)
{
	...
	while (iVar0 < uParam0->f_106)
	{
		if (((uParam0->f_107[iVar0 /*113*/])->f_32.f_60 > 0f && !(uParam0->f_107[iVar0 /*113*/])->f_32.f_62) && func_193(uParam0, (uParam0->f_107[iVar0 /*113*/])->f_32.f_61, (uParam0->f_107[iVar0 /*113*/])->f_32.f_60))
		{
...
int func_307()
{
	if (PED::_0xA911EE21EDF69DAF(Global_35) || func_345(Global_35))
	{
		return 1;
	}
	return 0;
...
int func_321(int iParam0, bool bParam1, bool bParam2, int iParam3, int iParam4, int iParam5, bool bParam6, bool bParam7, bool bParam8, int iParam9, int iParam10, int iParam11, float fParam12, bool bParam13, bool bParam14, bool bParam15, bool bParam16)
{
	...
	iVar1 = func_351(&uVar0, iParam0, bParam1, bParam2, iParam3, iParam4, iParam5, bParam7, bParam8, iParam9, iParam10, iParam11, fParam12, bParam13, bParam14, bParam15, bParam6, bParam16);
	if (!ENTITY::DOES_ENTITY_EXIST(iVar1))
	{
		return 0;
	}
		...
		else if (func_19(uParam0) == 355)
		{
			if (iVar3 == 5)
			{
				if (uParam0->f_3)
				{
					...
					else if ((bParam1 && !func_355(iVar3)) || (!bParam1 && func_355(iVar3)))
					{
					}
					else if (!func_356(iVar3, 0, 0))
					{
					}
					else if (((*Global_1360165)[iVar3 /*1157*/])->f_62 == -289447566)
					{
					}
					else if (func_357(iVar3, func_99(uParam0->f_7), 1))
					{
					}
					else if (func_359(&uVar2, func_358(iVar3)))
					{
						...
						else
						{
							...
							if (bParam2)
							{
								...
								if (!func_360(iVar0, func_99(uParam0->f_7), 0, -1))
								{
									return -1;
								}
								return iVar0;
...
int func_351(var uParam0, int iParam1, bool bParam2, bool bParam3, var uParam4, var uParam5, var uParam6, bool bParam7, bool bParam8, var uParam9, var uParam10, var uParam11, float fParam12, bool bParam13, bool bParam14, bool bParam15, bool bParam16, bool bParam17)
{
	int iVar0;
...
int func_361(int iParam0, bool bParam1, int iParam2, int iParam3, int iParam4, int iParam5, float fParam6, int iParam7, int iParam8, bool bParam9, bool bParam10, bool bParam11, int iParam12, int iParam13, bool bParam14, bool bParam15, bool bParam16, bool bParam17, bool bParam18, bool bParam19, bool bParam20, bool bParam21, bool bParam22, bool bParam23, bool bParam24)
{
	vector3 vVar0;
	bool bVar3;
	int iVar4;
...
struct<8> func_370(char* sParam0)
{
	char cVar0[64];
...
int func_384(int iParam0, bool bParam1, bool bParam2, var uParam3, var uParam4, var uParam5, float fParam6, bool bParam7, bool bParam8, bool bParam9, bool bParam10)
{
	...
	switch (((*Global_1360165)[iParam0 /*1157*/])->f_70.f_12)
	{
		...
		case 3:
			...
			sVar12 = func_419(iParam0, func_276());
...
void func_418(int iParam0, int iParam1)
{
	...
	func_369(iParam0, func_450(iParam1));
		...
		case 7:
			switch (iParam0)
			{
				...
				case 14:
					...
					break;
				case 4:
					if (func_318(747937920, 1) && !func_387(((*Global_1347702)[1 /*49*/])->f_15, 1))
					{
						iVar1[0] = -1155031950;
					}
					else
