...
void func_14(var uParam0, vector3 vParam1, vector3 vParam4)
{
	...
	iVar0 = joaat("a_m_m_wapwarriors_01");
	...
	if (!bParam1)
	{
		if (!ENTITY::IS_ENTITY_DEAD(&(uParam0->f_20[iParam2 /*14*/])))
		{
			if (!func_104(&(uParam0->f_20[iParam2 /*14*/]), -76381094))
			{
				...
				WEAPON::_GIVE_WEAPON_TO_PED_2(&(uParam0->f_20[iParam2 /*14*/]), joaat("weapon_bow"), 500, false, true, 0, false, 0.5f, 1f, 752097756, true, 0f, false);
