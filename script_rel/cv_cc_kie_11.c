...
int func_72(var uParam0)
{
	switch (func_149(uParam0))
	{
		case 1:
			...
			break;
		case 2:
			func_151(uParam0, 663.0867f, -1231.747f, 43.2655f, 0f, 0f, 168.12f);
			break;
		default:
			return 0;
	}
	...
	func_154(uParam0, -0.105f, 1.0775f, 0.85f, -78.25f, 4.325f, 4.3875f, 3.2075f, -1612834106, 211687389, 1, 1, 1);
	func_154(uParam0, -4.5875f, 6.7625f, 0.85f, -65.75f, 1.5f, 1.5f, 3.2075f, -1612834106, 271759394, 1, 1, 1);
	func_155(uParam0, 1);
	func_156(uParam0, 858540986, 0f, 0f, 0f, "BRUSH", 0, 1, 1);
	func_156(uParam0, -967333571, 0f, 0f, 0f, "CIGARETTE", 0, 1, 1);
	func_157(uParam0, "script@vignette@kieran_11@base", 1, 1, 0, 0);
	iLocal_17 = func_157(uParam0, "script@vignette@kieran_11@Action", 0, 0, 1, 0);
	func_158(uParam0, iLocal_16, 3, -830507952, 0, -1, 1);
	func_159(uParam0, iLocal_16, 2, -830507952, 0, -1, 1, -1073741824, 1065353216, 1);
	func_159(uParam0, iLocal_14, 3, 1626779076, "WORLD_HUMAN_HORSE_TEND_BRUSH_LINK_MALE_A", -1, 1, 2f, 1065353216, 1);
	func_160(uParam0, iLocal_14, 1, 1, 0, 0, 0);
	func_161(uParam0, iLocal_14, 1, -1);
	func_158(uParam0, iLocal_15, 3, -22664287, "WORLD_HUMAN_SMOKE_MALE_C", -1, 1);
	func_162(uParam0, 644410088, -1660484236);
...
int func_93(var uParam0)
{
	...
	{
		iVar0 = &uParam0->f_1984[iLocal_17];
		if (ANIMSCENE::_0x3FBC3F51BF12DFBF(iVar0) > 0.85f)
		{
			if (iLocal_18)
			{
				func_204(uParam0, iLocal_20, 0);
				iLocal_18 = 0;
			}
		}
		else if (ANIMSCENE::_0x3FBC3F51BF12DFBF(iVar0) > 0.23f)
		{
			if (!iLocal_18)
			{
				iLocal_20 = func_205(uParam0, 1.075f, 1.014f, 0.6f, 0f, 2f, 2f, 2.5f, 665633627, 1);
				func_204(uParam0, iLocal_20, 1);
				iLocal_18 = 1;
			}
		}
	}
	...
	{
		TASK::_TASK_START_SCENARIO_IN_PLACE(func_48(uParam0, iLocal_16), -830507952, 45000, 0, 0, 1f, 0);
	}
	return 1;
}
...
int func_143(var uParam0)
{
	if (UIAPPS::_IS_APP_ACTIVE(1833066477))
	{
		...
		_NAMESPACE48::_0xD4B614179BCD0654(func_219(10, 0));
		func_35(uParam0);
		return 1;
	}
	return 0;
...
void func_159(var uParam0, int iParam1, int iParam2, int iParam3, int iParam4, int iParam5, int iParam6, float fParam7, int iParam8, int iParam9)
{
...
void func_163(var uParam0, int iParam1, int iParam2, float fParam3)
{
	if (iParam2 == -1)
	{
		iParam2 = 0;
...
int func_195(var uParam0, int iParam1, bool bParam2)
{
	...
	if (bParam2)
	{
		...
		while (iVar1 < uParam0->f_1984)
		{
			...
			else if (func_203(uParam0, iVar1) || func_297(uParam0, iVar1))
			{
...
int func_205(var uParam0, vector3 vParam1, float fParam4, vector3 vParam5, int iParam8, bool bParam9)
{
	int iVar0;
...
float func_328(float fParam0, float fParam1)
{
...
int func_387(int iParam0, bool bParam1, bool bParam2, var uParam3, var uParam4, var uParam5, float fParam6, bool bParam7, bool bParam8, bool bParam9, bool bParam10)
{
	...
	switch (((*Global_1360165)[iParam0 /*1157*/])->f_70.f_12)
	{
		...
		case 3:
			...
			sVar12 = func_422(iParam0, func_288());
		...
		case 7:
			switch (iParam0)
			{
				...
				case 14:
					...
					break;
				case 4:
					if (func_327(747937920, 1) && !func_390(((*Global_1347702)[1 /*49*/])->f_15, 1))
					{
						iVar1[0] = -1155031950;
					}
					else
