...
int func_72(var uParam0)
{
	...
	iLocal_17 = func_151(uParam0, -862949069, 0f, 0f, 0f, "BOOK", 0, 1, 1);
	func_151(uParam0, -1914893189, 0f, 0f, 0f, "CUP", 0, 1, 1);
	func_152(uParam0, "script@vignette@molly_6@base", 1, 1, 0, 0);
	uLocal_16 = func_152(uParam0, "script@vignette@molly_6@action", 0, 0, 1, 0);
	func_153(uParam0, "CMLL6AU");
	func_154(uParam0, 1923514314, -929760679);
	func_155(uParam0, uLocal_16, -1, 0.88f);
	func_156(uParam0, iLocal_14, 2, 4, 0, 0, 0);
	func_157(uParam0, iLocal_14, 1, 180);
	func_158(uParam0, iLocal_15, 2, -25074136, "WORLD_HUMAN_SIT_GROUND_READING_JOURNAL_FEMALE_A", -1, 1, -1073741824, 1065353216, 1);
	...
	while (iVar0 < uParam0->f_1711)
	{
		...
		else
		{
			...
			if (!(uParam0->f_1711[iVar0 /*15*/])->f_5 && !ENTITY::DOES_ENTITY_EXIST((uParam0->f_1711[iVar0 /*15*/])->f_10))
			{
				...
				{
					vVar3 = { func_280(uParam0, (uParam0->f_1711[iVar0 /*15*/])->f_1) };
				}
				else
				{
...
void func_184(var uParam0)
{
	...
	{
		uParam0->f_1976.f_6 = PROPSET::_CREATE_PROPSET_2(uParam0->f_1976, func_280(uParam0, uParam0->f_1976.f_1), 1, func_282(uParam0, uParam0->f_1976.f_4), 3f, false, true);
	}
}
...
int func_261(var uParam0)
{
	...
	while (iVar1 < uParam0->f_1711)
	{
		...
		else if ((uParam0->f_1711[iVar1 /*15*/])->f_5)
		{
			...
			{
				vVar2 = { func_280(uParam0, (uParam0->f_1711[iVar1 /*15*/])->f_1) };
			}
			else
			{
...
Vector3 func_280(var uParam0, vector3 vParam1)
{
...
int func_380(int iParam0, bool bParam1, bool bParam2, var uParam3, var uParam4, var uParam5, float fParam6, bool bParam7, bool bParam8, bool bParam9, bool bParam10)
{
	...
	switch (((*Global_1360165)[iParam0 /*1157*/])->f_70.f_12)
	{
		...
		case 3:
			...
			sVar12 = func_415(iParam0, func_276());
