...
int func_78(var uParam0)
{
	...
	iLocal_39 = func_160(uParam0, 1230724566, 0.8f, 0.491f, -0.004f, "crate02", 0, 0, 1);
	iLocal_38 = func_160(uParam0, 1504738597, 1.314f, 1.778f, -0.062f, "crate15", 0, 0, 1);
	iLocal_40 = func_160(uParam0, 1210783447, 0f, 0f, 0f, "BOOK", 0, 0, 1);
	...
	func_167(uParam0, iLocal_18, 2, 1253642035, "PROP_HUMAN_SEAT_CHAIR_READING_FEMALE_A", iLocal_38, 0, 110f, 1065353216, 1);
...
void func_167(var uParam0, int iParam1, int iParam2, int iParam3, char* sParam4, int iParam5, int iParam6, float fParam7, int iParam8, int iParam9)
{
...
void func_484(int iParam0, int iParam1)
{
	...
	switch (iParam0)
	{
		case 11:
			...
			{
				func_525(iParam1, 1240907314, 0, 0, 2, 1, 0, 1056964608, 1065353216, -1, 0, 0, 0, 0);
				func_525(iParam1, -2088446466, 0, 0, 3, 1, 1, 1056964608, 1065353216, -1, 0, 1, 0, 0);
			}
			break;
	}
}
