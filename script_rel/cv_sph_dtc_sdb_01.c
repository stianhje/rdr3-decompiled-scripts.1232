...
int func_72(var uParam0)
{
	...
	func_149(uParam0, -0.381f, -1.1475f, 0f, -5.25f, 5.3775f, 2.475f, 5f, -1612834106, 2017216891, 1, 1, 1);
	func_149(uParam0, 6.6439f, -6.21f, 0f, 0f, 1.2f, 1.2f, 5f, -1612834106, 1267380940, 1, 1, 1);
	iLocal_14 = func_150(uParam0, 0, 0);
	iLocal_15 = func_150(uParam0, 5, 0);
	iLocal_16 = func_151(uParam0, -946807796, 0f, 0f, 0f, "BOOK", 0, 0, 1);
	iLocal_17 = func_151(uParam0, -82199229, 0f, 0f, 0f, "MUG", 0, 1, 1);
	iLocal_18 = func_151(uParam0, -1006095118, 0f, 0f, 0f, 0, 1, 0, 1);
	func_152(uParam0, "script@vignette@dutch_speech_shadybelle_1@base", 1, 1, 0, 0);
	uLocal_19 = func_152(uParam0, "script@vignette@dutch_speech_shadybelle_1@action", 0, 0, 1, 0);
	func_153(uParam0, "CSBD1AU");
	func_154(uParam0, -1163106739, 2073994807);
	func_155(uParam0, uLocal_19, -1, 0.93f);
	func_156(uParam0, iLocal_14, 3, -787460071, "SC_PROP_CAMP_DUTCH_SEAT_CHAIR_READING_MALE_A", -1, 0);
	func_157(uParam0, iLocal_14, 1, -1);
	func_158(uParam0, iLocal_14, 3, -787460071, "SC_PROP_CAMP_DUTCH_SEAT_CHAIR_READING_MALE_A", iLocal_18, 0, -1073741824, 1065353216, 1);
	...
	func_158(uParam0, iLocal_15, 3, -1489483851, "WORLD_HUMAN_COFFEE_DRINK_MALE_A", -1, 1, -1073741824, 1065353216, 1);
...
int func_149(var uParam0, vector3 vParam1, float fParam4, vector3 vParam5, int iParam8, int iParam9, bool bParam10, int iParam11, int iParam12)
{
	int iVar0;
...
void func_155(var uParam0, var uParam1, int iParam2, float fParam3)
{
	if (iParam2 == -1)
	{
		iParam2 = 0;
...
void func_160(var uParam0, int iParam1, int iParam2, int iParam3)
{
	...
	{
		case 4:
			(uParam0->f_107[iParam1 /*113*/])->f_32.f_5 = { func_255(func_253(uParam0), func_254(uParam0, iParam1), func_19(uParam0), 1) };
			break;
		default:
			Var0 = { func_256(func_253(uParam0), func_254(uParam0, iParam1), func_19(uParam0), 1) };
...
int func_278(var uParam0, int iParam1, vector3 vParam2)
{
	...
	if (func_253(uParam0) == 3 || func_253(uParam0) == 8)
	{
		...
		case 7:
			switch (iParam0)
			{
				...
				case 14:
					...
					break;
				case 4:
					if (func_324(747937920, 1) && !func_389(((*Global_1347702)[1 /*49*/])->f_15, 1))
					{
						iVar1[0] = -1155031950;
					}
					else
