...
{
	func_33(uParam0, 10822/*func_30*/, 10954/*func_31*/, 11513/*func_32*/);
}
...
void func_14(var uParam0, vector3 vParam1, vector3 vParam4)
{
	...
	func_50(uParam0, 0, "MALE", uVar0, 0f, 0f, 0f, 0f, 1, 1, 1, 1, 41788943, 1);
...
int func_106(int iParam0, bool bParam1, int iParam2, bool bParam3)
{
	...
	{
		return func_181(bParam1, iParam2, bParam3);
	}
	if (Global_1572887->f_12 != -1)
	{
...
void func_132(int iParam0, vector3 vParam1)
{
	...
	while (iVar0 < 10)
	{
		...
		{
			if (func_150((Global_32073.f_2697.f_1495[iVar0 /*4*/])->f_1, vParam1, 1056964608, 1))
			{
				return;
			}
		}
...
int func_181(bool bParam0, var uParam1, var uParam2)
{
...
float func_193(int iParam0, int iParam1, bool bParam2, int iParam3)
{
...
void func_205(int iParam0, int iParam1, int iParam2, int iParam3, int iParam4, int iParam5, bool bParam6, int iParam7)
{
	int iVar0;

	iVar0 = (((iParam2 + (60 * iParam3)) + (3600 * iParam4)) + (86400 * iParam5));
	if (func_233(iParam0) == 1 && iParam7)
	{
		return;
	}
	if (bParam6)
