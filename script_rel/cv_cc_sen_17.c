...
int func_72(var uParam0)
{
	...
	func_151(uParam0, -6.4125f, 0.55f, 0.782f, 80f, 1f, 1f, 2.2325f, -1612834106, 1418411488, 1, 1, 1);
	func_151(uParam0, 1.99f, 1.61f, 1.1875f, -23.75f, 1.0175f, 0.9225f, 3.2075f, -1612834106, -1377448058, 1, 1, 1);
	func_151(uParam0, 1.59f, 0.8225f, 1.1875f, -28f, 1.12f, 0.9225f, 3.2075f, -1612834106, -950285770, 1, 1, 1);
	iLocal_17 = func_152(uParam0, -862949069, 0f, 0f, 0f, "BOOK", 0, 0, 1);
	func_152(uParam0, -967333571, 0f, 0f, 0f, "CIGARETTE", 0, 1, 1);
	func_153(uParam0, iLocal_16, 3, -22664287, "WORLD_HUMAN_SMOKE_MALE_C", -1, 1);
	func_154(uParam0, iLocal_16, 4, 2, 0, 0, 0);
	func_153(uParam0, iLocal_14, 3, -2118813809, "WORLD_HUMAN_SIT_GROUND_FEMALE_A", -1, 1);
	func_155(uParam0, iLocal_14, 2, -2118813809, "WORLD_HUMAN_SIT_GROUND_FEMALE_A", -1, 1, -1073741824, 1065353216, 1);
	func_153(uParam0, iLocal_15, 3, 1204099266, "WORLD_HUMAN_SIT_GROUND_READING_JOURNAL_FEMALE_A", -1, 1);
	func_155(uParam0, iLocal_15, 2, 1204099266, "WORLD_HUMAN_SIT_GROUND_READING_JOURNAL_FEMALE_A", -1, 1, -1073741824, 1065353216, 1);
	func_156(uParam0, iLocal_15, iLocal_17, "p_cs_ledgerSmall01x_PH_L_HAND", 0, 0);
	func_154(uParam0, iLocal_15, 4, 2, 0, 0, 0);
	func_157(uParam0, "script@vignette@sean_17@base", 1, 1, 0, 0);
	func_157(uParam0, "script@vignette@sean_17@action", 0, 0, 1, 0);
...
void func_154(var uParam0, int iParam1, int iParam2, int iParam3, int iParam4, char* sParam5, char* sParam6)
{
