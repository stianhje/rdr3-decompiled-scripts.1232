...
int func_72(var uParam0)
{
	...
	uLocal_21 = func_153(uParam0, joaat("p_chair_crate02x"), 1.67993f, -0.624575f, 0.00882721f, 0, 1, 0, 1);
	...
	func_156(uParam0, iLocal_14, 3, -1666245605, "PROP_CAMP_SEAT_CHAIR_STEW_EATING_FEMALE_B", uLocal_21, 0, -1073741824, 1065353216, 1);
...
void func_203(var uParam0, var uParam1, int iParam2, float fParam3)
{
	if (iParam2 == -1)
	{
		iParam2 = 0;
...
void func_416(int iParam0, int iParam1)
{
	...
	switch (iParam0)
	{
		case 11:
			...
			{
				func_457(iParam1, joaat("weapon_revolver_cattleman_sadie"), 0, 0, 2, 1, 0, 1056964608, 1065353216, -1, 0, 0, 0, 0);
				func_457(iParam1, joaat("weapon_revolver_cattleman_sadie_dualwield"), 0, 0, 3, 1, 1, 1056964608, 1065353216, -1, 0, 1, 0, 0);
			}
			break;
	}
}
