...
void func_19()
{
	...
	if ((((((HUD::_0xD0976CC34002DB57("SPGJAU") && HUD::_0xD0976CC34002DB57("SPGJ")) && STREAMING::HAS_MODEL_LOADED(iLocal_17)) && STREAMING::HAS_MODEL_LOADED(iLocal_18)) && STREAMING::HAS_MODEL_LOADED(iLocal_19)) && (iLocal_176 != 1 || STREAMING::HAS_MODEL_LOADED(iLocal_20))) && PED::_0x5C16855277819BBF() == 1)
	{
		if (iLocal_176 == 1)
		{
			if (iLocal_279 == 0)
			{
				iLocal_279 = ENTITY::_0x6F3068258A499E52(325252933, vLocal_14, 5);
			}
			if (!ENTITY::DOES_ENTITY_EXIST(iLocal_259))
			{
		...
		if (!TASK::_0x841475AC96E794D1(iLocal_277))
		{
			switch (iLocal_176)
			{
				...
				case 0:
					if (!TASK::_0x841475AC96E794D1(iLocal_277))
					{
						iLocal_277 = TASK::CREATE_SCENARIO_POINT(447176986, -313.1921f, 809.0455f, 117.978f, -170f, 0f, 0, 1);
						TASK::_0x5AF19B6CC2115D34(iLocal_277, 16, 1);
						TASK::_0x5AF19B6CC2115D34(iLocal_277, 18, 1);
						bVar0 = true;
					}
	...
	if ((func_104(&iLocal_255, iLocal_17, func_103(), 119.5846f, 1, 0, 1) && func_106(&iLocal_257, iLocal_18, func_105(iLocal_18))) && func_106(&iLocal_258, iLocal_19, func_105(iLocal_19)))
	{
		if (func_36(iLocal_255, 0))
		{
			if (!func_8(iLocal_182, 16777216))
			{
				...
				ENTITY::_0x203BEFFDBE12E96A(iLocal_255, func_103(), 197.2573f, 1, false, 1);
...
void func_25()
{
	...
	if (!func_8(iLocal_182, 131072))
	{
		...
		iLocal_278 = TASK::CREATE_SCENARIO_POINT(1386012138, -316.4402f, 805.7891f, 116.855f, -170f, 0f, 0, 0);
...
void func_34(int iParam0)
{
	...
	if (func_43(&(iParam0->f_13)))
	{
		func_48(&(iParam0->f_13));
	}
}
...
int func_59(int iParam0, int iParam1, var uParam2, int iParam3, int iParam4, float fParam5)
{
	int iVar0;
...
bool func_162(int iParam0, int* iParam1, float fParam2, float fParam3, var uParam4, bool bParam5, float fParam6, int iParam7, int iParam8, char* sParam9, int iParam10, int iParam11, int iParam12, int iParam13, bool bParam14, bool bParam15, bool bParam16, bool bParam17, bool bParam18)
{
	...
	while (iVar0 < *uParam4)
	{
		...
		func_269(*iParam0, (*uParam4)[iVar0 /*17*/], fParam3, iParam7, iParam8, iParam12, bParam5);
		if (MISC::IS_BIT_SET(uParam4[iVar0 /*17*/], 20))
		{
			bVar3 = true;
		}
		if (func_270(*iParam0, iParam1, (*uParam4)[iVar0 /*17*/], bVar4, fParam3, fParam2, iParam7, iParam8, bParam14, bParam16, bParam17, bVar9, bVar10, bParam15, fVar12, bVar11, iVar1))
		{
			if (!bParam18 && !bVar5)
			{
