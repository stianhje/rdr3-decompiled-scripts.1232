...
{
	func_33(uParam0, 10786/*func_30*/, 10844/*func_31*/, 11622/*func_32*/);
}
...
void func_14(var uParam0, vector3 vParam1, vector3 vParam4)
{
	...
	func_46(uParam0, "AV_BODY_TOSS", "script@ambient@generic@Body_Toss@Action", vParam1, vParam4);
	func_47(uParam0, 1, "pl_Action", "", 0);
	uVar0 = func_49(func_48());
	func_50(uParam0, 0, "MALE_A", uVar0, 0f, 0f, 0f, 0f, 1, 1, 1, 1, 41788943, 1);
	func_50(uParam0, 1, "MALE_B", uVar0, 0f, 0f, 0f, 0f, 1, 1, 1, 1, 41788943, 1);
	func_50(uParam0, 2, "MALE_DEAD", uVar0, 0f, 0f, 0f, 0f, 1, 1, 1, 1, 41788943, 1);
}
...
int func_31(var uParam0)
{
	...
	if (!&uParam0->f_469[0])
	{
		...
		while (iVar1 < 3)
		{
			if (ENTITY::DOES_ENTITY_EXIST(&(uParam0->f_20[iVar1 /*14*/])) && !ENTITY::IS_ENTITY_DEAD(&(uParam0->f_20[iVar1 /*14*/])))
			{
				if (func_65(&(uParam0->f_20[iVar1 /*14*/]), 0, &uLocal_9, &uVar0, 0, 0))
				{
					TASK::TASK_SMART_FLEE_PED(&(uParam0->f_20[iVar1 /*14*/]), Global_35, -1f, -1, 0, 3f, 0);
					func_66(uParam0);
					if (!&uParam0->f_469[7])
					{
	...
	if (!&uParam0->f_469[4])
	{
		if (PED::IS_PED_DEAD_OR_DYING(&(uParam0->f_20[2 /*14*/]), true))
		{
			...
			{
				_NAMESPACE49::_0x3CA5E58C9731A16B(&(uParam0->f_20[2 /*14*/]), 60);
				uParam0->f_469[4] = 1;
			}
		}
	}
	...
	if (&uParam0->f_469[2])
	{
		if (!&uParam0->f_469[7])
		{
			if (func_69(uParam0, fLocal_37, 50f, 4, -91962372, 1))
			{
				func_67(*uParam0, uParam0->f_483, 1);
				uParam0->f_469[7] = 1;
			}
	...
	if ((uParam0->f_469[5] && uParam0->f_469[6]) // PointerArith)
	{
		return 1;
	}
	return 0;
...
int func_65(int iParam0, int iParam1, var uParam2, var uParam3, int iParam4, float fParam5)
{
	...
	if (!Global_1935630->f_12 && !ENTITY::IS_ENTITY_DEAD(iParam0))
	{
		...
		if (!uParam2->f_1 & 128 != 0)
		{
			...
			{
				*uParam3 = 128;
				func_100(iParam0, uParam2, *uParam3);
				return 1;
			}
		}
		if (Global_1935630->f_27)
		{
			if (!uParam2->f_1 & 8 != 0)
			{
				...
				else if (func_102(iParam0, iParam1, uParam2))
				{
					*uParam3 = 8;
					func_100(iParam0, uParam2, *uParam3);
					return 1;
		...
		if (Global_1935630->f_26 && func_104(PLAYER::PLAYER_ID(), 0, 1, uParam2->f_1 & 524288 == 0))
		{
		...
		{
			if (func_105(uParam2, 1065353216))
			{
				if (!uParam2->f_1 & 4 != 0)
				{
				...
				{
					if (func_107(Global_35, iParam0, uParam2))
					{
						*uParam3 = 256;
						func_100(iParam0, uParam2, *uParam3);
						return 1;
		...
		if (!uParam2->f_1 & 16 != 0)
		{
			...
			{
				if (func_108(Global_35, iParam0, uParam2, 0))
				{
					*uParam3 = 16;
					func_100(iParam0, uParam2, *uParam3);
					return 1;
			...
			else if (func_108(Global_35, iParam0, uParam2, 1))
			{
				*uParam3 = 16;
				func_100(iParam0, uParam2, *uParam3);
				return 1;
		...
		if (Global_1935630->f_30 || Global_1935630->f_31)
		{
			if (!uParam2->f_1 & 2 != 0)
			{
				if (func_111(uParam2, 4000))
				{
					if ((func_112(iParam0, Global_1935630->f_41, *uParam2 & 128 != 0, 0, *uParam2 & 256 != 0) && func_113(uParam2, iParam0)) && func_114(uParam2, iParam0))
					{
						*uParam3 = 2;
						func_100(iParam0, uParam2, *uParam3);
						return 1;
		...
		if (!uParam2->f_1 & 2 != 0)
		{
			if (uParam2->f_12 < 4f)
			{
				if ((func_112(iParam0, Global_1935630->f_41, *uParam2 & 128 != 0, 1, *uParam2 & 256 != 0) && func_113(uParam2, iParam0)) && func_114(uParam2, iParam0))
				{
					*uParam3 = 2;
					func_100(iParam0, uParam2, *uParam3);
					return 1;
				...
				if (Global_1935630->f_40 == 0)
				{
					if (Global_1935630->f_41 != 0)
					{
						if (*uParam2 & 131072 == 0)
						{
							if (func_115(iParam0, Global_1935630->f_41))
							{
								func_116();
								*uParam3 = 2;
								func_100(iParam0, uParam2, *uParam3);
			...
			if (uParam2->f_12 < 10f)
			{
				if (func_117(uParam2, iParam0) || (uParam2->f_9 > 0 && (func_118() - uParam2->f_9) < 2000))
				{
			...
			if (Global_1935630->f_42 != 0)
			{
				if (*uParam2 & 131072 == 0)
				{
					if (func_119())
					{
						if (func_115(iParam0, Global_1935630->f_42))
						{
							func_116();
							*uParam3 = 2;
							func_100(iParam0, uParam2, *uParam3);
...
int func_68(var uParam0, float fParam1, float fParam2, int iParam3, float fParam4, float fParam5)
{
	...
	if ((MISC::GET_FRAME_COUNT() % 8) == 0)
	{
		...
		fVar7 = func_134(Global_36, uParam0->f_483);
		...
		while (iVar0 < uParam0->f_19)
		{
			...
			if (!ENTITY::IS_ENTITY_DEAD(&(uParam0->f_20[iVar0 /*14*/])))
			{
				...
				fVar8 = func_135(Global_35, &(uParam0->f_20[iVar0 /*14*/]), 1);
				if (fVar8 < fVar1)
				{
					return 1;
				}
				if (fVar8 < (fParam2 * fParam2))
				{
					if (PED::_0x5102307CE88798EB(&(uParam0->f_20[iVar0 /*14*/])) && PED::IS_TRACKED_PED_VISIBLE(&(uParam0->f_20[iVar0 /*14*/])))
					{
						...
						if (func_138(&(uParam0->f_490), fParam1))
						{
		...
		while (iVar0 < uParam0->f_19)
		{
			...
			else
			{
				if (!ENTITY::IS_ENTITY_DEAD(&(uParam0->f_20[iVar0 /*14*/])))
				{
					...
					{
						if ((func_135(Global_35, &(uParam0->f_20[iVar0 /*14*/]), 1) < fParam2 && PED::_0x5102307CE88798EB(&(uParam0->f_20[iVar0 /*14*/]))) && PED::IS_TRACKED_PED_VISIBLE(&(uParam0->f_20[iVar0 /*14*/])))
						{
							if (!func_136(&(uParam0->f_490)))
							{
								func_140(&(uParam0->f_490), 0);
							}
...
void func_98(var uParam0, bool bParam1, int iParam2)
{
	...
	switch (uParam0->f_6)
	{
		case 0:
			if (*uParam0 & 16 != 0)
			{
				...
				else if (!PED::IS_PED_PLANTING_BOMB(Global_35) && (!func_162(1) || *uParam0 & 8192 != 0))
				{
	...
	if (!uParam0->f_1 & 1024 != 0)
	{
		if (!ENTITY::DOES_ENTITY_EXIST(uParam0->f_14))
		{
			if (func_163(uParam0))
			{
				uParam0->f_15 = func_118();
			}
		}
		else if (uParam0->f_15 > 0)
		{
			if ((func_118() - uParam0->f_15) > 500)
			{
...
int func_99(int iParam0, var uParam1)
{
	...
	switch (iVar0)
	{
		...
		case 1589923363:
			...
			if (!func_165(iParam0, uParam1, iVar2))
			{
				return 0;
			}
			if (func_166(iParam0, iVar2) <= func_167(uParam1))
			{
				return 1;
			}
			break;
...
void func_100(int iParam0, var uParam1, int iParam2)
{
	if (iParam2 != 16384)
	{
...
int func_101(int iParam0, var uParam1)
{
	...
	{
		if (func_171(iParam0, !*uParam1 & 268435456 != 0, !*uParam1 & 536870912 != 0, !*uParam1 & 1073741824 != 0, 0, 0))
		{
			if (uParam1->f_12 < 5f)
			{
				fVar0 = 95f;
			...
			fVar1 = func_172(uParam1);
			if (func_173(uParam1, iParam0, fVar0, fVar1))
			{
				if (uParam1->f_2 == 0)
				{
...
int func_102(int iParam0, int iParam1, var uParam2)
{
	...
	fVar0 = 85f;
	if (func_175(iParam1, !*uParam2 & 268435456 != 0, !*uParam2 & 536870912 != 0, !*uParam2 & 1073741824 != 0, 0))
	{
		if (uParam2->f_12 < 5f)
		{
			fVar0 = 95f;
		...
		fVar1 = func_172(uParam2);
		if (func_173(uParam2, iParam0, fVar0, fVar1))
		{
			if (uParam2->f_2 == 0)
			{
			...
			if (uParam2->f_2 != 0)
			{
				if (MISC::GET_GAME_TIMER() - uParam2->f_2) > func_174(uParam2)
				{
					func_169(uParam2, 1);
					return 1;
				}
...
int func_103(int iParam0, var uParam1)
{
	...
	if (func_165(iParam0, uParam1, iVar1))
	{
		if (uParam1->f_3 == 0)
		{
			uParam1->f_3 = MISC::GET_GAME_TIMER();
		}
		else if (MISC::GET_GAME_TIMER() - uParam1->f_3) > func_174(uParam1)
		{
			fVar3 = func_172(uParam1);
...
int func_104(int iParam0, bool bParam1, int iParam2, bool bParam3)
{
	struct<11> Var0;
	int iVar17;
	struct<11> Var18;
...
int func_105(var uParam0, float fParam1)
{
	int iVar0;
	int iVar1;
...
int func_107(var uParam0, int iParam1, var uParam2)
{
	...
	if (uParam2->f_12 < IntToFloat(func_178(uParam2)))
	{
...
int func_108(var uParam0, int iParam1, var uParam2, bool bParam3)
{
	vector3 vVar0;
	int iVar3;
	vector3 vVar4;
		...
		switch (iVar3)
		{
			...
			case 2:
				if (EVENT::IS_SHOCKING_EVENT_IN_SPHERE(-966930978, vVar0, uParam2->f_22))
				{
					...
					if (func_180(iParam1, vVar0, vVar4))
					{
						func_169(uParam2, 1);
						return 1;
					}
		...
		switch (iVar3)
		{
			...
			case 2:
				if (EVENT::IS_SHOCKING_EVENT_IN_SPHERE(-966930978, vVar0, uParam2->f_22))
				{
					...
					if (func_180(iParam1, vVar0, vVar7))
					{
						func_169(uParam2, 1);
						return 1;
					}
...
int func_109(int iParam0, var uParam1)
{
	...
	{
		if (!func_165(iParam0, uParam1, &(Global_1935630->f_34[iVar0])) || iParam0 == &Global_1935630->f_34[iVar0])
		{
		}
		else
		{
			bVar13 = func_181(&(Global_1935630->f_34[iVar0]));
			...
			if (func_182(uParam1, iParam0, fVar1, bVar12, bVar13))
			{
				*(vVar2[0 /*3*/]) = { ENTITY::GET_ENTITY_COORDS(&(Global_1935630->f_34[iVar0]), false, false) };
				*(vVar2[1 /*3*/]) = { vVar9 };
				uParam1->f_10 = iParam0;
			...
			else if (func_183(uParam1, iParam0, fVar1, bVar12, bVar13))
			{
				*(vVar2[0 /*3*/]) = { ENTITY::GET_ENTITY_COORDS(&(Global_1935630->f_34[iVar0]), false, false) };
				*(vVar2[1 /*3*/]) = { vVar9 };
				uParam1->f_10 = iParam0;
			...
			else if (func_184(uParam1, iParam0, fVar1, iVar0))
			{
				*(vVar2[0 /*3*/]) = { ENTITY::GET_ENTITY_COORDS(&(Global_1935630->f_34[iVar0]), false, false) };
				*(vVar2[1 /*3*/]) = { vVar9 };
				uParam1->f_10 = iParam0;
...
int func_112(int iParam0, int iParam1, bool bParam2, bool bParam3, bool bParam4)
{
	int iVar0;
	int iVar1;
	int iVar2;
...
int func_117(var uParam0, int iParam1)
{
	...
	if (iVar0 != 0 && !VEHICLE::IS_THIS_MODEL_A_TRAIN(ENTITY::GET_ENTITY_MODEL(iVar0)))
	{
		...
		if (func_189(iVar0, iParam1, vVar1))
		{
			uParam0->f_9 = func_118();
			return 1;
		}
...
int func_120(var uParam0, int iParam1)
{
	...
	fVar0 = func_167(uParam0);
	if (uParam0->f_12 > func_191(uParam0) && uParam0->f_12 > fVar0)
	{
		return 0;
	}
	iVar2 = func_192(iParam1);
	iVar1 = func_193(uParam0->f_14);
...
int func_121(int iParam0, int iParam1, var uParam2)
{
	...
	return func_194(iParam0, iParam1, bVar0, bVar2, uParam2->f_12, bVar1);
}
...
int func_126(int iParam0, var uParam1)
{
	...
	if (uParam1->f_4 == 0)
	{
		uParam1->f_4 = func_118();
	}
	else if (func_118() - uParam1->f_4) > func_198(uParam1)
	{
		return func_199(iParam0, uParam1, 0, -1082130432);
	}
	return 0;
}
...
void func_129(int iParam0)
{
	if (func_43(iParam0))
	{
		...
		{
			case 1:
				func_200(0, 1, 0, 0, ((Global_1415419->f_19[iParam0 /*12*/])->f_7 / 4), 0, 0, 1);
				func_200(1, 1, 0, 0, ((Global_1415419->f_19[iParam0 /*12*/])->f_7 / 4), 0, 0, 1);
				break;
			case 37:
				func_200(60, 1, 0, 0, ((Global_1415419->f_19[iParam0 /*12*/])->f_7 / 4), 0, 0, 1);
				break;
		}
	}
}

void func_130(int iParam0, vector3 vParam1)
{
	int iVar0;
	int iVar1;
	...
	while (iVar0 < 10)
	{
		...
		{
			if (func_145((Global_32073.f_2697.f_1495[iVar0 /*4*/])->f_1, vParam1, 1056964608, 1))
			{
				return;
			}
		}
...
float func_134(vector3 vParam0, vector3 vParam3)
{
	vParam0.f_2 = 0f;
	vParam3.f_2 = 0f;
...
float func_135(int iParam0, int iParam1, bool bParam2)
{
	...
	return func_201(ENTITY::GET_ENTITY_COORDS(iParam0, false, false), ENTITY::GET_ENTITY_COORDS(iParam1, false, false));
}
...
int func_162(bool bParam0)
{
	...
	if (func_214(bParam0, &uVar0, &uVar1))
	{
		return 1;
	}
	return 0;
...
int func_165(int iParam0, var uParam1, int iParam2)
{
	...
	{
		iVar1 = func_193(iParam2);
	}
	else
	{
		iVar1 = func_192(iParam2);
	}
	if (!PED::IS_PED_HUMAN(iParam0))
	{
...
int func_168(int iParam0, int iParam1, int iParam2, int iParam3, int iParam4)
{
	switch (iParam0)
	{
		case 8:
...
int func_171(int iParam0, bool bParam1, bool bParam2, bool bParam3, int iParam4, int iParam5)
{
	int iVar0;
	int iVar1;
	int iVar2;
...
int func_173(var uParam0, int iParam1, float fParam2, float fParam3)
{
	float fVar0;
...
int func_175(int iParam0, bool bParam1, bool bParam2, bool bParam3, int iParam4)
{
	int iVar0;
	int iVar1;
...
int func_180(int iParam0, vector3 vParam1, vector3 vParam4)
{
...
int func_184(var uParam0, int iParam1, float fParam2, int iParam3)
{
	float fVar0;
...
int func_189(int iParam0, int iParam1, vector3 vParam2)
{
	float fVar0;
...
int func_194(int iParam0, int iParam1, bool bParam2, bool bParam3, float fParam4, bool bParam5)
{
	bool bVar0;
	int iVar1;
	float fVar2;
...
int func_195(int iParam0, var uParam1, bool bParam2)
{
	int iVar0;
	int iVar1;

	func_214(1, &iVar0, &iVar1);
	...
	if (ENTITY::DOES_ENTITY_EXIST(iVar0))
	{
		if (iVar0 != iParam0)
		{
			if (PED::_0x06087579E7AA85A9(iParam0, Global_35, -1f, -1f, -1f, -1f))
			{
				if (ENTITY::HAS_ENTITY_CLEAR_LOS_TO_ENTITY(iParam0, Global_35, 17))
				{
					if (!bParam2 || !func_196(uParam1, iVar0))
					{
						return 1;
					}
				}
	...
	if (ENTITY::DOES_ENTITY_EXIST(iVar1))
	{
		if (iVar1 != iParam0)
		{
			...
			{
				if (!bParam2 || !func_196(uParam1, iVar1))
				{
...
int func_199(int iParam0, var uParam1, bool bParam2, float fParam3)
{
	if (!bParam2)
	{
		if (uParam1->f_4 == 0)
...
void func_200(int iParam0, int iParam1, int iParam2, int iParam3, int iParam4, int iParam5, bool bParam6, int iParam7)
{
	int iVar0;

	iVar0 = (((iParam2 + (60 * iParam3)) + (3600 * iParam4)) + (86400 * iParam5));
	if (func_227(iParam0) == 1 && iParam7)
	{
		return;
	}
	if (bParam6)
...
int func_214(bool bParam0, var uParam1, var uParam2)
{
	int iVar0;
	int iVar1;
