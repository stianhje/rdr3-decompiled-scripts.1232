...
int func_72(var uParam0)
{
	...
	func_151(uParam0, 0.1689f, -0.7804f, 0f, 14f, 1.155f, 1.0825f, 5f, -1612834106, 2017216891, 1, 1, 1);
	func_152(uParam0, joaat("p_cs_bookevelynmiller"), 0f, 0f, 0f, "BOOK", 0, 1, 1);
	func_153(uParam0, "script@vignette@dutch_3@base", 1, 1, 0, 0);
	iLocal_15 = func_153(uParam0, "script@vignette@dutch_3@beckon_a", 2, 0, 1, 1);
	iLocal_16 = func_153(uParam0, "script@vignette@dutch_3@beckon_b", 2, 0, 0, 1);
	iLocal_17 = func_153(uParam0, "script@vignette@dutch_3@action_a", 2, 0, 0, 1);
	iLocal_18 = func_153(uParam0, "script@vignette@dutch_3@action_b", 2, 0, 0, 0);
	iLocal_23 = func_153(uParam0, "script@vignette@dutch_3@base", 2, 0, 0, 0);
	iLocal_24 = func_153(uParam0, "script@vignette@dutch_3@base", 2, 0, 0, 0);
	iLocal_19 = func_153(uParam0, "script@vignette@dutch_3@dismiss_sit", 2, 0, 0, 0);
	iLocal_20 = func_153(uParam0, "script@vignette@dutch_3@dismiss_stand", 2, 0, 0, 0);
	iLocal_21 = func_153(uParam0, "script@vignette@dutch_3@exit_idle", 2, 0, 0, 0);
	iLocal_22 = func_153(uParam0, "script@vignette@dutch_3@exit", 0, 0, 0, 0);
	func_154(uParam0, "CDT3AUD");
	func_155(uParam0, 1809571623, -1141642849);
	...
	Local_25 = { func_161(uParam0, 0.255f, -0.5375f, 0.564f, 173.5f, 10f, 0.9775f, 0.8625f) };
	Local_35 = { func_161(uParam0, 0.255f, -0.538f, 0.564f, 171.32f, 7f, 1f, 0.84f) };
	return 1;
}
...
{
	return func_192(uParam0, Local_25, 1, 0);
}
...
int func_93(var uParam0)
{
	...
	{
		if (func_192(uParam0, Local_35, 1, 0))
		{
	...
	if (func_202(uParam0, iLocal_23))
	{
		...
		else if (func_192(uParam0, Local_25, 1, 0))
		{
...
int func_151(var uParam0, vector3 vParam1, float fParam4, vector3 vParam5, int iParam8, int iParam9, bool bParam10, int iParam11, int iParam12)
{
	...
	if (bParam10)
	{
		vParam1 = { func_253(uParam0, vParam1) };
...
struct<10> func_161(var uParam0, vector3 vParam1, float fParam4, float fParam5, float fParam6, float fParam7)
{
	...
	fVar0 = func_254(uParam0, (fParam4 + (fParam6 * 90f)));
	fVar1 = func_254(uParam0, (fParam4 - (fParam7 * 90f)));
	Var2 = { func_253(uParam0, vParam1) };
	...
	while (iVar0 < uParam0->f_1711)
	{
		...
		else
		{
			...
			if (!(uParam0->f_1711[iVar0 /*15*/])->f_5 && !ENTITY::DOES_ENTITY_EXIST((uParam0->f_1711[iVar0 /*15*/])->f_10))
			{
				...
				{
					vVar3 = { func_253(uParam0, (uParam0->f_1711[iVar0 /*15*/])->f_1) };
				}
				else
				{
...
void func_186(var uParam0)
{
	...
	{
		uParam0->f_1976.f_6 = PROPSET::_CREATE_PROPSET_2(uParam0->f_1976, func_253(uParam0, uParam0->f_1976.f_1), 1, func_254(uParam0, uParam0->f_1976.f_4), 3f, false, true);
	}
}
...
int func_191(var uParam0, int iParam1, bool bParam2)
{
	...
	if (bParam2)
	{
		...
		while (iVar1 < uParam0->f_1984)
		{
			...
			else if (func_200(uParam0, iVar1) || func_202(uParam0, iVar1))
			{
...
int func_192(var uParam0, struct<4> Param1, var uParam5, var uParam6, var uParam7, var uParam8, var uParam9, var uParam10, bool bParam11, bool bParam12)
{
	...
	if (!func_293(Param1, Param1.f_6, Global_36))
	{
		return 0;
	}
	if (func_293(Param1, Param1.f_3, Global_36))
	{
		return 0;
	}
	if (bParam12)
...
int func_193(var uParam0)
{
	...
	if (func_22() == 3)
	{
		if (func_294(Global_35, 1))
		{
			fVar0 = 5f;
			fVar1 = 8f;
		}
	}
	if (func_295(uParam0, fVar0, fVar1))
	{
		return 1;
	}
	return 0;
...
void func_196(int iParam0)
{
	...
	if (func_297(iVar2, iVar0, 0))
	{
		if (func_297(iVar2, iVar1, 0))
		{
...
Vector3 func_253(var uParam0, vector3 vParam1)
{
	return OBJECT::_GET_OBJECT_OFFSET_FROM_COORDS(uParam0->f_23, uParam0->f_26.f_2, vParam1);
}

float func_254(var uParam0, float fParam1)
{
	float fVar0;
...
int func_255(int iParam0, int iParam1, bool bParam2, int iParam3, int iParam4, bool bParam5, float fParam6)
{
	...
	uVar6 = func_323(vVar0, vVar3.x, iParam1, bParam2, iParam3, iParam4, bParam5, fParam6);
	return uVar6;
}
	...
	while (iVar1 < uParam0->f_106)
	{
		...
		else
		{
			if (func_50((uParam0->f_107[iVar1 /*113*/])->f_7))
			{
				...
				{
					(uParam0->f_107[iVar1 /*113*/])->f_5 = func_324((uParam0->f_107[iVar1 /*113*/])->f_7, 1, 1, 0, 0, 1, 1, (uParam0->f_107[iVar1 /*113*/])->f_6, 0, 0, 0, 0, 0, 0, 0, 0, 0);
					return 0;
					if ((uParam0->f_107[iVar1 /*113*/])->f_102 || (uParam0->f_107[iVar1 /*113*/])->f_103)
					{
						if (!func_50((uParam0->f_107[iVar1 /*113*/])->f_1))
						{
							...
							{
								(uParam0->f_107[iVar1 /*113*/])->f_1 = func_325(uParam0, 1, 1);
							}
							else
							{
								(uParam0->f_107[iVar1 /*113*/])->f_1 = func_325(uParam0, 1, 0);
							}
						}
						if (!func_50((uParam0->f_107[iVar1 /*113*/])->f_1))
						{
					...
					if (!func_326(uParam0, iVar1, (uParam0->f_107[iVar1 /*113*/])->f_1))
					{
						if (!uParam0->f_21)
						{
							return 0;
...
int func_259(var uParam0)
{
	...
	while (iVar0 < uParam0->f_106)
	{
		...
		{
			if (ENTITY::IS_ENTITY_DEAD(func_327(iVar1)))
			{
				func_328(iVar1, 1);
				return 0;
			}
			(uParam0->f_107[iVar0 /*113*/])->f_5 = func_329(iVar1, 0, 0, 1, 1, 1);
			if (!ENTITY::DOES_ENTITY_EXIST((uParam0->f_107[iVar0 /*113*/])->f_5))
			{
				return 0;
			}
...
int func_266(var uParam0)
{
	...
	while (iVar1 < uParam0->f_1711)
	{
		...
		else if ((uParam0->f_1711[iVar1 /*15*/])->f_5)
		{
			...
			{
				vVar2 = { func_253(uParam0, (uParam0->f_1711[iVar1 /*15*/])->f_1) };
			}
			else
			{
...
int func_275(var uParam0, int iParam1, vector3 vParam2)
{
	...
	{
		fVar4 = func_332(fVar3, fVar1, fVar2, uParam0->f_2254, uParam0->f_2255);
	}
...
int func_276(var uParam0, int iParam1, vector3 vParam2)
{
	...
	{
		fVar4 = func_332(fVar3, fVar1, fVar2, uParam0->f_2259, uParam0->f_2260);
	}
...
int func_280(int iParam0, vector3 vParam1, float fParam4, bool bParam5, bool bParam6, int iParam7, bool bParam8, bool bParam9, bool bParam10, bool bParam11, bool bParam12, bool bParam13, bool bParam14)
{
	...
	func_333(iVar0, iParam0, iParam7, bParam8, bParam9, bParam10, bParam11, bParam12);
	return iVar0;
}
...
bool func_293(struct<2> Param0, var uParam2, struct<2> Param3, var uParam5, struct<2> Param6, var uParam8)
{
...
int func_295(var uParam0, float fParam1, float fParam2)
{
	float fVar0;
	int iVar1;
...
int func_302(var uParam0, int iParam1)
{
	...
	{
		if (!func_331((uParam0->f_107[iParam1 /*113*/])->f_5, 1435919172))
		{
			return 1;
		}
	}
...
void func_303(var uParam0, int iParam1, bool bParam2, bool bParam3)
{
	...
	if (bParam3)
	{
		uVar0 = func_342(uParam0, iParam1);
	}
	if (bParam2)
	{
...
int func_323(vector3 vParam0, float fParam3, var uParam4, bool bParam5, int iParam6, int iParam7, bool bParam8, float fParam9)
{
	int iVar0;
	int iVar1;
	vector3 vVar2;
...
int func_324(int iParam0, bool bParam1, bool bParam2, int iParam3, int iParam4, int iParam5, bool bParam6, bool bParam7, bool bParam8, int iParam9, int iParam10, int iParam11, float fParam12, bool bParam13, bool bParam14, bool bParam15, bool bParam16)
{
	var uVar0;
	int iVar1;
...
int func_329(int iParam0, bool bParam1, bool bParam2, bool bParam3, int iParam4, bool bParam5)
{
	int iVar0;
	int iVar1;
...
float func_332(float fParam0, float fParam1, float fParam2, float fParam3, float fParam4)
{
	return ((((fParam0 - fParam1) / (fParam2 - fParam1)) * (fParam4 - fParam3)) + fParam3);
}

void func_333(int iParam0, int iParam1, int iParam2, bool bParam3, bool bParam4, bool bParam5, bool bParam6, bool bParam7)
{
	bool bVar0;
...
float func_343(float fParam0, float fParam1)
{
...
int func_385(int iParam0, bool bParam1, bool bParam2, var uParam3, var uParam4, var uParam5, float fParam6, bool bParam7, bool bParam8, bool bParam9, bool bParam10)
{
	...
	switch (((*Global_1360165)[iParam0 /*1157*/])->f_70.f_12)
	{
		...
		case 3:
			...
			sVar12 = func_420(iParam0, func_281());
