...
{
	func_33(uParam0, 11160/*func_30*/, 11316/*func_31*/, 11712/*func_32*/);
}
...
void func_14(var uParam0, vector3 vParam1, vector3 vParam4)
{
	...
	{
		case 23:
			func_46(uParam0, "VOMIT_SIT_FEMALE", "script@ambient@town@wall_vomit_sit@female01", vParam1, vParam4);
			iVar0 = func_48(func_47());
			func_49(uParam0, 0, "BUCKET", 1502991738, 0f, 0f, 0f, 0f, 1);
			break;
		
		case 24:
			func_46(uParam0, "VOMIT_SIT_MALE", "script@ambient@town@wall_vomit_sit@male01", vParam1, vParam4);
			iVar0 = func_50(func_47());
			func_49(uParam0, 0, "BUCKET", 1502991738, 0f, 0f, 0f, 0f, 1);
			bLocal_37 = true;
			break;
		
		case 25:
			func_46(uParam0, "VOMIT_WALL_FEMALE", "script@ambient@town@wall_vomit@female01", vParam1, vParam4);
			if (func_51(&(uParam0->f_20[0 /*14*/]), 0))
			{
				iVar0 = ENTITY::GET_ENTITY_MODEL(&(uParam0->f_20[0 /*14*/]));
			}
			else
			{
				iVar0 = func_48(func_47());
		...
		case 26:
			func_46(uParam0, "VOMIT_WALL_MALE", "script@ambient@town@wall_vomit@male01", vParam1, vParam4);
			if (func_51(&(uParam0->f_20[0 /*14*/]), 0))
			{
				iVar0 = ENTITY::GET_ENTITY_MODEL(&(uParam0->f_20[0 /*14*/]));
			}
	...
	func_53(uParam0, 0, "ped", iVar0, 0f, 0f, 0f, 0f, 1, 1, 1, 1, 41788943, 1);
}
	...
	while (iVar12 < uParam0->f_19)
	{
		if ((uParam0->f_20[iVar12 /*14*/])->f_2 != 0)
		{
			...
			if (ENTITY::IS_ENTITY_DEAD(&(uParam0->f_20[iVar12 /*14*/])))
			{
				...
				{
					uParam0->f_20[iVar12 /*14*/] = func_60((uParam0->f_20[iVar12 /*14*/])->f_2, (uParam0->f_20[iVar12 /*14*/])->f_5, (uParam0->f_20[iVar12 /*14*/])->f_8, 1, 1, 0, 1, (uParam0->f_20[iVar12 /*14*/])->f_11, (uParam0->f_20[iVar12 /*14*/])->f_9, 0, 0, 0, 0);
				}
				...
				if (!PED::IS_PED_HUMAN(&(uParam0->f_20[iVar12 /*14*/])))
				{
					if (!func_61(&(uParam0->f_20[iVar12 /*14*/])))
					{
...
int func_28(var uParam0)
{
	...
	{
		if (!TASK::IS_PED_ACTIVE_IN_SCENARIO(&(uParam0->f_20[0 /*14*/]), 1) && !func_62(&(uParam0->f_20[0 /*14*/]), 993674639))
		{
			func_63(&(uParam0->f_20[0 /*14*/]), iLocal_39, 0, 0, 0, -1082130432);
		}
		if (func_64(uParam0, &uLocal_9, 0))
		{
			uParam0->f_499 = 1;
			return 0;
		}
		if (TASK::_0x02EBBB3989B7E695(&(uParam0->f_20[0 /*14*/])))
		{
			if (func_65(uParam0, 1065353216, 1116471296, 4, 10f, 1112014848))
			{
				PED::_0x406CCF555B04FAD3(&(uParam0->f_20[0 /*14*/]), 1, 0.7f);
				func_66(uParam0);
				return 1;
			}
		}
...
int func_30(var uParam0)
{
	if (bLocal_38)
	{
		...
		if (bLocal_37)
		{
			func_67(iLocal_39, 15, 0, 368585157);
		}
		else
		{
			func_67(iLocal_39, 15, 0, -1203809772);
		}
	}
	else
	{
		...
		if (bLocal_37)
		{
			func_67(iLocal_39, 15, 0, -268410244);
		}
		else
		{
			func_67(iLocal_39, 15, 0, -531870220);
		}
	}
	func_68(&uLocal_9, 0);
	func_69(&uLocal_9, 1);
...
int func_31(var uParam0)
{
	if (!&uParam0->f_469[0])
	{
		if (!ENTITY::IS_ENTITY_DEAD(&(uParam0->f_20[0 /*14*/])))
		{
			if (func_64(uParam0, &uLocal_9, 0))
			{
				...
				if (!&uParam0->f_469[4])
				{
					func_75(*uParam0, uParam0->f_483, 1);
					uParam0->f_469[4] = 1;
				}
				uParam0->f_469[0] = 1;
			}
	...
	if (!&uParam0->f_469[3])
	{
		if (!&uParam0->f_469[4])
		{
			...
			if (func_76(uParam0, fLocal_40, 1116471296, 4, -91962372, 1))
			{
				func_75(*uParam0, uParam0->f_483, 1);
				uParam0->f_469[4] = 1;
			}
		...
		if (ENTITY::DOES_ENTITY_EXIST(&(uParam0->f_20[0 /*14*/])))
		{
			if (ANIMSCENE::_0x005E6F28DD7ED58D(uParam0->f_3.f_1, (uParam0->f_20[0 /*14*/])->f_1))
			{
				...
				if (!uParam0->f_500)
				{
					if (bLocal_38)
					{
						TASK::TASK_WANDER_STANDARD(&(uParam0->f_20[0 /*14*/]), 40000f, 0);
					}
					else
					{
						func_63(&(uParam0->f_20[0 /*14*/]), iLocal_39, 45000, 0, 0, -1082130432);
					}
...
int func_38(int iParam0, vector3 vParam1, float fParam4)
{
	...
	if (func_81(vVar0, vVar0 + vVar3, vParam1))
	{
		return 3;
	}
	return 2;
...
void func_41(var uParam0, int iParam1, int iParam2, int iParam3, int iParam4, int iParam5, int iParam6, bool bParam7)
{
	...
	iVar2 = func_86(*uParam0);
	iVar3 = func_87(*uParam0);
	iVar4 = func_88(*uParam0);
	iVar5 = func_89(*uParam0);
	...
	func_91(uParam0, iVar5, iVar4, iVar3, iVar2, iVar1, iVar0);
}
...
void func_49(var uParam0, int iParam1, char* sParam2, int iParam3, vector3 vParam4, float fParam7, int iParam8)
{
...
void func_52(var uParam0, int iParam1, char* sParam2, char* sParam3, int iParam4)
{
...
void func_53(var uParam0, int iParam1, char* sParam2, int iParam3, vector3 vParam4, float fParam7, int iParam8, int iParam9, int iParam10, int iParam11, int iParam12, int iParam13)
{
...
int func_60(int iParam0, vector3 vParam1, float fParam4, bool bParam5, bool bParam6, int iParam7, bool bParam8, bool bParam9, bool bParam10, bool bParam11, bool bParam12, bool bParam13, bool bParam14)
{
	...
	func_98(iVar0, iParam0, iParam7, bParam8, bParam9, bParam10, bParam11, bParam12);
	return iVar0;
}
...
void func_63(int iParam0, int iParam1, int iParam2, int iParam3, int iParam4, int iParam5)
{
...
int func_65(var uParam0, float fParam1, float fParam2, int iParam3, float fParam4, float fParam5)
{
	...
	if ((MISC::GET_FRAME_COUNT() % 8) == 0)
	{
		...
		fVar7 = func_103(Global_36, uParam0->f_483);
		...
		while (iVar0 < uParam0->f_19)
		{
			...
			if (!ENTITY::IS_ENTITY_DEAD(&(uParam0->f_20[iVar0 /*14*/])))
			{
				...
				fVar8 = func_104(Global_35, &(uParam0->f_20[iVar0 /*14*/]), 1);
				if (fVar8 < fVar1)
				{
					return 1;
				}
...
void func_75(int iParam0, vector3 vParam1, bool bParam4)
{
	if (func_40() > (Global_32073.f_2697.f_6[iParam0 /*6*/])->f_5)
	{
		(Global_32073.f_2697.f_6[iParam0 /*6*/])->f_5 = func_40();
	...
	func_118(iParam0);
	func_119(iParam0, vParam1);
	Global_32073.f_2697.f_6[iParam0 /*6*/] = &Global_32073.f_2697.f_6[iParam0 /*6*/] + 1;
	Global_32073.f_2697.f_2++;
}

int func_76(var uParam0, float fParam1, float fParam2, int iParam3, int iParam4, bool bParam5)
{
	int iVar0;
		...
		while (iVar0 < uParam0->f_19)
		{
			...
			else
			{
				if (!ENTITY::IS_ENTITY_DEAD(&(uParam0->f_20[iVar0 /*14*/])))
				{
					...
					{
						if ((func_104(Global_35, &(uParam0->f_20[iVar0 /*14*/]), 1) < fParam2 && PED::_0x5102307CE88798EB(&(uParam0->f_20[iVar0 /*14*/]))) && PED::IS_TRACKED_PED_VISIBLE(&(uParam0->f_20[iVar0 /*14*/])))
						{
							if (!func_105(&(uParam0->f_490)))
							{
								func_120(&(uParam0->f_490), 0);
							}
...
bool func_81(struct<2> Param0, var uParam2, struct<2> Param3, Vector3 vParam5, struct<2> Param6, var uParam8)
{
	return (((Param3 - Param0) * (Param6.f_1 - Param0.f_1)) - ((Param3.f_1 - Param0.f_1) * (Param6 - Param0))) > 0f;
}

int func_82(vector3 vParam0, float fParam3)
{
	int iVar0;
	...
	while (iVar0 < 4)
	{
		...
		{
			if (func_125(vParam0, (Global_1415419->f_9721[iVar0 /*8*/])->f_4, fParam3, 0))
			{
				return 1;
			}
		}
...
int func_83(vector3 vParam0)
{
	...
	while (iVar0 < 10)
	{
		...
		{
			if (func_125(vParam0, (Global_32073.f_2697.f_1495[iVar0 /*4*/])->f_1, 1f, 0))
			{
				return 1;
			}
		}
...
{
	return (BUILTIN::SHIFT_RIGHT(iParam0, 26) & 31 * func_126(MISC::IS_BIT_SET(iParam0, 31), -1, 1)) + 1898;
}
...
void func_91(var uParam0, int iParam1, int iParam2, int iParam3, int iParam4, int iParam5, int iParam6)
{
	func_127(uParam0, iParam6);
	func_128(uParam0, iParam5);
...
void func_98(int iParam0, int iParam1, int iParam2, bool bParam3, bool bParam4, bool bParam5, bool bParam6, bool bParam7)
{
	bool bVar0;
...
float func_104(int iParam0, int iParam1, bool bParam2)
{
	if (!ENTITY::DOES_ENTITY_EXIST(iParam0))
	{
		return 0f;
...
void func_118(int iParam0)
{
	if (func_43(iParam0))
	{
		...
		{
			case 1:
				func_173(0, 1, 0, 0, ((Global_1415419->f_19[iParam0 /*12*/])->f_7 / 4), 0, 0, 1);
				func_173(1, 1, 0, 0, ((Global_1415419->f_19[iParam0 /*12*/])->f_7 / 4), 0, 0, 1);
				break;
			
			case 37:
				func_173(60, 1, 0, 0, ((Global_1415419->f_19[iParam0 /*12*/])->f_7 / 4), 0, 0, 1);
				break;
		}
	}
}

void func_119(int iParam0, vector3 vParam1)
{
	int iVar0;
	int iVar1;
	...
	while (iVar0 < 10)
	{
		...
		{
			if (func_125((Global_32073.f_2697.f_1495[iVar0 /*4*/])->f_1, vParam1, 1056964608, 1))
			{
				return;
			}
		}
...
int func_123(var uParam0, float fParam1)
{
	if (!func_105(uParam0))
	{
		return 0;
...
int func_125(vector3 vParam0, vector3 vParam3, float fParam6, bool bParam7)
{
	if (fParam6 < 0f)
	{
		fParam6 = 0f;
...
int func_126(bool bParam0, int iParam1, int iParam2)
{
	if (bParam0)
	{
		return iParam1;
	...
	switch (uParam0->f_6)
	{
		case 0:
			if (*uParam0 & 16 != 0)
			{
				...
				else if (!PED::IS_PED_PLANTING_BOMB(Global_35) && (!func_184(1) || *uParam0 & 8192 != 0))
				{
...
int func_141(int iParam0, var uParam1)
{
	...
	switch (iVar0)
	{
		...
		case 1589923363:
			...
			if (!func_187(iParam0, uParam1, iVar2))
			{
				return 0;
			}
			if (func_188(iParam0, iVar2) <= func_189(uParam1))
			{
				return 1;
			}
			break;
...
int func_143(int iParam0, var uParam1)
{
	...
	if (!ENTITY::IS_ENTITY_DEAD(iParam0))
	{
		if (func_193(iParam0, !*uParam1 & 268435456 != 0, !*uParam1 & 536870912 != 0, !*uParam1 & 1073741824 != 0, 0, 0))
		{
			if (uParam1->f_12 < 5f)
			{
				fVar0 = 95f;
			...
			fVar1 = func_194(uParam1);
			if (func_195(uParam1, iParam0, fVar0, fVar1))
			{
				if (uParam1->f_2 == 0)
				{
...
int func_144(int iParam0, int iParam1, var uParam2)
{
	...
	fVar0 = 85f;
	if (func_197(iParam1, !*uParam2 & 268435456 != 0, !*uParam2 & 536870912 != 0, !*uParam2 & 1073741824 != 0, 0))
	{
		if (uParam2->f_12 < 5f)
		{
			fVar0 = 95f;
		...
		fVar1 = func_194(uParam2);
		if (func_195(uParam2, iParam0, fVar0, fVar1))
		{
			if (uParam2->f_2 == 0)
			{
			...
			if (uParam2->f_2 != 0)
			{
				if (MISC::GET_GAME_TIMER() - uParam2->f_2) > func_196(uParam2)
				{
					func_191(uParam2, 1);
					return 1;
				}
...
int func_145(int iParam0, var uParam1)
{
	...
	if (func_187(iParam0, uParam1, iVar1))
	{
		if (uParam1->f_3 == 0)
		{
			uParam1->f_3 = MISC::GET_GAME_TIMER();
		}
		else if (MISC::GET_GAME_TIMER() - uParam1->f_3) > func_196(uParam1)
		{
			fVar3 = func_194(uParam1);
...
int func_146(int iParam0, bool bParam1, int iParam2, bool bParam3)
{
	...
	{
		return func_198(bParam1, iParam2, bParam3);
	}
	if (Global_1572887->f_12 != -1)
	{
...
int func_149(var uParam0, int iParam1, var uParam2)
{
	...
	if (uParam2->f_12 < IntToFloat(func_200(uParam2)))
	{
		...
		switch (iVar3)
		{
			...
			case 2:
				if (EVENT::IS_SHOCKING_EVENT_IN_SPHERE(-966930978, vVar0, uParam2->f_22))
				{
					...
					if (func_202(iParam1, vVar0, vVar4))
					{
						func_191(uParam2, 1);
						return 1;
					}
		...
		switch (iVar3)
		{
			...
			case 2:
				if (EVENT::IS_SHOCKING_EVENT_IN_SPHERE(-966930978, vVar0, uParam2->f_22))
				{
					...
					if (func_202(iParam1, vVar0, vVar7))
					{
						func_191(uParam2, 1);
						return 1;
					}
...
int func_151(int iParam0, var uParam1)
{
	...
	{
		if (!func_187(iParam0, uParam1, &(Global_1935630->f_34[iVar0])) || iParam0 == &Global_1935630->f_34[iVar0])
		{
		}
		else
		{
			bVar13 = func_203(&(Global_1935630->f_34[iVar0]));
			fVar1 = BUILTIN::VDIST(ENTITY::GET_ENTITY_COORDS(&(Global_1935630->f_34[iVar0]), false, false), vVar9);
			if (func_61(&(Global_1935630->f_34[iVar0])))
			{
				if (fVar1 < 35f)
				{
			...
			if (func_204(uParam1, iParam0, fVar1, bVar12, bVar13))
			{
				*(vVar2[0 /*3*/]) = { ENTITY::GET_ENTITY_COORDS(&(Global_1935630->f_34[iVar0]), false, false) };
				*(vVar2[1 /*3*/]) = { vVar9 };
				uParam1->f_10 = iParam0;
			...
			else if (func_205(uParam1, iParam0, fVar1, bVar12, bVar13))
			{
				*(vVar2[0 /*3*/]) = { ENTITY::GET_ENTITY_COORDS(&(Global_1935630->f_34[iVar0]), false, false) };
				*(vVar2[1 /*3*/]) = { vVar9 };
				uParam1->f_10 = iParam0;
			...
			else if (func_206(uParam1, iParam0, fVar1, iVar0))
			{
				*(vVar2[0 /*3*/]) = { ENTITY::GET_ENTITY_COORDS(&(Global_1935630->f_34[iVar0]), false, false) };
				*(vVar2[1 /*3*/]) = { vVar9 };
				uParam1->f_10 = iParam0;
...
int func_157(int iParam0, int iParam1)
{
	if (!ENTITY::IS_ENTITY_DEAD(iParam1))
	{
		...
		if (func_210(iParam0, iParam1, 1, 1) < 4f)
		{
...
int func_159(var uParam0, int iParam1)
{
	...
	if (iVar0 != 0 && !VEHICLE::IS_THIS_MODEL_A_TRAIN(ENTITY::GET_ENTITY_MODEL(iVar0)))
	{
		...
		if (func_211(iVar0, iParam1, vVar1))
		{
...
int func_162(var uParam0, int iParam1)
{
	...
	fVar0 = func_189(uParam0);
	if (uParam0->f_12 > func_213(uParam0) && uParam0->f_12 > fVar0)
	{
		return 0;
	}
	iVar2 = func_214(iParam1);
	iVar1 = func_215(uParam0->f_14);
...
int func_163(int iParam0, int iParam1, var uParam2)
{
	...
	return func_216(iParam0, iParam1, bVar0, bVar2, uParam2->f_12, bVar1);
}
	...
	switch (iVar1)
	{
		...
		case -1601932249:
			...
			if (PED::_0x06087579E7AA85A9(iParam0, iVar4, -1f, -1f, -1f, -1f) && PED::_0x06087579E7AA85A9(iParam0, Global_35, -1f, -1f, -1f, -1f))
			{
				...
				{
					if (!func_218(uParam1, iParam0))
					{
						if (func_212(iVar4, Global_36, 1) < 7f)
						{
							return 1;
						}
					}
...
int func_168(int iParam0, var uParam1)
{
	...
	else if (func_160() - uParam1->f_4) > func_220(uParam1)
	{
		return func_221(iParam0, uParam1, 0, -1082130432);
	}
	return 0;
}
...
void func_173(int iParam0, int iParam1, int iParam2, int iParam3, int iParam4, int iParam5, bool bParam6, int iParam7)
{
	int iVar0;
...
int func_184(bool bParam0)
{
	...
	if (func_226(bParam0, &uVar0, &uVar1))
	{
		return 1;
	}
	return 0;
...
{
	return func_210(iParam0, iParam1, 1, 1);
}
...
int func_190(int iParam0, int iParam1, int iParam2, int iParam3, int iParam4)
{
	switch (iParam0)
	{
		case 8:
...
int func_193(int iParam0, bool bParam1, bool bParam2, bool bParam3, int iParam4, int iParam5)
{
	int iVar0;
	int iVar1;
	int iVar2;
	...
	if (bParam3)
	{
		if (((WEAPON::_0xCB690F680A3EA971(iVar0, 1) && PLAYER::IS_PLAYER_TARGETTING_ENTITY(iVar1, iParam0, iParam5)) && PLAYER::IS_PLAYER_FREE_AIMING_AT_ENTITY(iVar1, iParam0)) && func_210(iVar0, iParam0, 1, 1) <= 4f)
		{
			return 1;
		}
	}
	...
	{
		if (WEAPON::_0x6AD66548840472E5(func_229(iVar0, 0)))
		{
			if (func_230(iParam0, 0.4f, 0.6f, 0.3f, 0.7f))
			{
				return 1;
			}
		}
...
int func_195(var uParam0, int iParam1, float fParam2, float fParam3)
{
	float fVar0;
...
int func_197(int iParam0, bool bParam1, bool bParam2, bool bParam3, int iParam4)
{
	int iVar0;
	int iVar1;
	...
	if (PLAYER::IS_PLAYER_FREE_AIMING(iVar1))
	{
		if (WEAPON::_0x6AD66548840472E5(func_229(iVar0, 0)))
		{
			if (func_231(ENTITY::GET_ENTITY_COORDS(iParam0, true, false), 0.4f, 0.6f, 0.3f, 0.7f))
			{
				return 1;
			}
		}
...
int func_198(bool bParam0, var uParam1, var uParam2)
{
...
int func_202(int iParam0, vector3 vParam1, vector3 vParam4)
{
	if (func_232(iParam0, vParam4, 0.5f))
	{
...
int func_204(var uParam0, int iParam1, float fParam2, bool bParam3, bool bParam4)
{
	float fVar0;
...
int func_206(var uParam0, int iParam1, float fParam2, int iParam3)
{
	float fVar0;
...
int func_208(int iParam0, int iParam1)
{
	...
	if (func_235(iParam0, 1, 0, 0) != 2055893578)
	{
		return 0;
	}
...
float func_210(int iParam0, int iParam1, bool bParam2, int iParam3)
{
...
int func_211(int iParam0, int iParam1, vector3 vParam2)
{
	float fVar0;
	
	fVar0 = func_212(iParam0, vParam2, 1);
	if (fVar0 < 4f)
	{
...
int func_216(int iParam0, int iParam1, bool bParam2, bool bParam3, float fParam4, bool bParam5)
{
	bool bVar0;
	int iVar1;
	float fVar2;
	...
	if (fParam4 <= 0f)
	{
		fVar2 = func_210(iParam0, PLAYER::PLAYER_PED_ID(), 0, 1);
	}
	else
	{
		fVar2 = fParam4;
	...
	if (bVar0)
	{
		if (func_210(iParam0, Global_1935630->f_40, 0, 1) < 2.5f)
		{
...
int func_217(int iParam0, var uParam1, bool bParam2)
{
	int iVar0;
	int iVar1;
	
	func_226(1, &iVar0, &iVar1);
	...
	if (ENTITY::DOES_ENTITY_EXIST(iVar0))
	{
		if (iVar0 != iParam0)
		{
			if (PED::_0x06087579E7AA85A9(iParam0, Global_35, -1f, -1f, -1f, -1f))
			{
				if (ENTITY::HAS_ENTITY_CLEAR_LOS_TO_ENTITY(iParam0, Global_35, 17))
				{
					if (!bParam2 || !func_218(uParam1, iVar0))
					{
						return 1;
					}
				}
	...
	if (ENTITY::DOES_ENTITY_EXIST(iVar1))
	{
		if (iVar1 != iParam0)
		{
			...
			{
				if (!bParam2 || !func_218(uParam1, iVar1))
				{
					if (func_212(iVar1, Global_36, 1) < 5f)
					{
						return 1;
					}
				}
...
int func_219(int iParam0)
{
	...
	return func_237(((*Global_1347702)[58 /*49*/])->f_15, 1);
}
...
int func_221(int iParam0, var uParam1, bool bParam2, float fParam3)
{
	if (!bParam2)
	{
		if (uParam1->f_4 == 0)
...
int func_230(int iParam0, float fParam1, float fParam2, float fParam3, float fParam4)
{
	if (!ENTITY::IS_ENTITY_DEAD(iParam0))
	{
		if (func_231(ENTITY::GET_ENTITY_COORDS(iParam0, true, false), fParam1, fParam2, fParam3, fParam4))
		{
			return 1;
		}
	}
...
int func_231(vector3 vParam0, float fParam3, float fParam4, float fParam5, float fParam6)
{
	float fVar0;
	float fVar1;
	bool bVar2;
...
bool func_232(int iParam0, vector3 vParam1, float fParam4)
{
	vector3 vVar0;
	vector3 vVar3;
