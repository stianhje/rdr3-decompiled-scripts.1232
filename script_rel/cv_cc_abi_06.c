...
int func_72(var uParam0)
{
	...
	func_152(uParam0, 1.15f, -0.7f, 0.22f, 0f, 4f, 4f, 5f, 665633627, -1, 1, 1, 1);
	func_153(uParam0, "script@vignette@abigail_6@base", 1, 1, 0, 0);
	iLocal_16 = func_153(uParam0, "script@vignette@abigail_6@action_a", 2, 0, 1, 0);
	iLocal_17 = func_153(uParam0, "script@vignette@abigail_6@action_b", 2, 0, 0, 0);
	iLocal_18 = func_153(uParam0, "script@vignette@abigail_6@action_b_front", 2, 0, 0, 1);
	iLocal_19 = func_153(uParam0, "script@vignette@abigail_6@action_b_back", 2, 0, 0, 1);
	iLocal_20 = func_153(uParam0, "script@vignette@abigail_6@action_c_normal_no_arthur", 0, 0, 0, 0);
	iLocal_21 = func_153(uParam0, "script@vignette@abigail_6@action_c_normal_arthur_front", 0, 0, 0, 1);
	iLocal_22 = func_153(uParam0, "script@vignette@abigail_6@action_c_normal_arthur_back", 0, 0, 0, 1);
	iLocal_23 = func_153(uParam0, "script@vignette@abigail_6@action_c_front_no_arthur", 0, 0, 0, 0);
	iLocal_24 = func_153(uParam0, "script@vignette@abigail_6@action_c_front_arthur_front", 0, 0, 0, 1);
	iLocal_25 = func_153(uParam0, "script@vignette@abigail_6@action_c_front_arthur_back", 0, 0, 0, 1);
	iLocal_26 = func_153(uParam0, "script@vignette@abigail_6@action_c_back_no_arthur", 0, 0, 0, 0);
	iLocal_27 = func_153(uParam0, "script@vignette@abigail_6@action_c_back_arthur_front", 0, 0, 0, 1);
	iLocal_28 = func_153(uParam0, "script@vignette@abigail_6@action_c_back_arthur_back", 0, 0, 0, 1);
	...
	uLocal_30 = func_158(uParam0, 1.6236f, 2.5306f, 1.0664f, 0f, 0f, 0f, 6f, 5f, 2f, "BackTrigger", -1612834106);
	uLocal_29 = func_158(uParam0, 1.6236f, -2.4694f, 1.0664f, 0f, 0f, 0f, 6f, 5f, 2f, "FrontTrigger", -1612834106);
	return 1;
}
...
int func_93(var uParam0)
{
	...
	{
		if (func_197(uParam0, &uLocal_29, 1))
		{
			func_188(uParam0, iLocal_18, 1);
		}
		else if (func_197(uParam0, &uLocal_30, 1))
		{
	...
	if (func_196(uParam0, iLocal_19))
	{
		if (func_197(uParam0, &uLocal_29, 1))
		{
			func_188(uParam0, iLocal_27, 1);
		}
		else if (func_197(uParam0, &uLocal_30, 1))
		{
			func_188(uParam0, iLocal_28, 1);
		}
		else
		{
			func_188(uParam0, iLocal_26, 1);
		}
	}
	return 1;
}
...
void func_155(var uParam0, int iParam1, float fParam2, int iParam3, int iParam4)
{
...
int func_158(var uParam0, vector3 vParam1, vector3 vParam4, vector3 vParam7, char* sParam10, int iParam11)
{
	int iVar0;
	vector3 vVar1;
	...
	vVar1 = { func_250(uParam0, vParam1) };
...
int func_188(var uParam0, int iParam1, bool bParam2)
{
	...
	if (bParam2)
	{
		...
		while (iVar1 < uParam0->f_1984)
		{
			...
			else if (func_288(uParam0, iVar1) || func_196(uParam0, iVar1))
			{
...
int func_197(var uParam0, var uParam1, bool bParam2)
{
	...
	return func_298(Global_35, *uParam1, 1, 0);
}
