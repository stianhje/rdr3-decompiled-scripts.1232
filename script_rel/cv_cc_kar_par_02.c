...
int func_72(var uParam0)
{
	...
	iLocal_18 = func_151(uParam0, 17.59f, 0.12f, 0.9632f, 20.88f, 6.5f, 3.5f, 5f, -1612834106, -695792551, 1, 1, 1);
	func_151(uParam0, 1.015f, 0.616f, 0.9977f, 23.04f, 2f, 1.5f, 3f, -1612834106, -1, 1, 1, 1);
	func_152(uParam0, -1971689092, 0f, 0f, 0f, "BOTTLEJD", 0, 0, 1);
	func_152(uParam0, 1843407141, 0f, 0f, 0f, "BOTTLEBEER", 0, 1, 1);
	if (!func_153(15))
	{
		func_154(uParam0, "script@vignette@party@karen_2@base", 1, 1, 0, 0);
	}
	iLocal_16 = func_154(uParam0, "script@vignette@party@karen_2@action", 2, 0, 1, 0);
	iLocal_17 = func_154(uParam0, "script@vignette@party@karen_2@sleep_loops", 0, 0, 0, 0);
	func_155(uParam0, "CKRP2AU");
	func_156(uParam0, 1002263180, 750381136);
	func_157(uParam0, iLocal_16, -1, 0.55f);
	func_158(uParam0, iLocal_14, 3, -359184052, "WORLD_HUMAN_LEAN_WALL_DRINKING_FEMALE_B", -1, 1);
	func_159(uParam0, iLocal_14, 1, -1);
	func_160(uParam0, iLocal_14, 1061142135);
	func_161(uParam0, iLocal_14);
	func_158(uParam0, iLocal_15, 3, 2087366558, "WORLD_HUMAN_STAND_WAITING_FEMALE_A", -1, 1);
...
int func_93(var uParam0)
{
	if (!iLocal_19)
	{
		...
		{
			if (PED::_0x91A5F9CBEBB9D936((uParam0->f_36[iLocal_18 /*5*/])->f_4))
			{
...
int func_195(var uParam0, int iParam1, bool bParam2)
{
	...
	if (bParam2)
	{
		...
		while (iVar1 < uParam0->f_1984)
		{
			...
			else if (func_296(uParam0, iVar1) || func_204(uParam0, iVar1))
			{
...
void func_259(var uParam0, int iParam1, int iParam2, int iParam3, int iParam4, int iParam5, int iParam6, float fParam7, int iParam8, int iParam9)
{
...
void func_326(var uParam0, int iParam1, float fParam2)
{
	if (fParam2 == -2f)
	{
...
int func_387(int iParam0, bool bParam1, bool bParam2, var uParam3, var uParam4, var uParam5, float fParam6, bool bParam7, bool bParam8, bool bParam9, bool bParam10)
{
	...
	switch (((*Global_1360165)[iParam0 /*1157*/])->f_70.f_12)
	{
		...
		case 3:
			...
			sVar12 = func_422(iParam0, func_286());
		...
		case 7:
			switch (iParam0)
			{
				...
				case 14:
					...
					break;
				case 4:
					if (func_325(747937920, 1) && !func_390(((*Global_1347702)[1 /*49*/])->f_15, 1))
					{
						iVar1[0] = -1155031950;
					}
					else
