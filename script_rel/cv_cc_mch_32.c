...
int func_72(var uParam0)
{
	...
	func_151(uParam0, 0.125f, -0.9125f, 0.85f, 0f, 3.633f, 2.635f, 3.2075f, -1612834106, 1243438920, 1, 1, 1);
	func_151(uParam0, -0.1f, 5.65f, 0.85f, 0f, 1f, 1f, 3.2075f, -1612834106, -1689743484, 1, 1, 1);
	iLocal_17 = func_152(uParam0, -1971689092, 0f, 0f, 0f, "BOTTLE", 0, 1, 1);
	func_152(uParam0, -967333571, 0f, 0f, 0f, "CIGARETTE", 0, 1, 1);
	func_153(uParam0, "script@vignette@micah_32@base", 1, 1, 0, 0);
	func_153(uParam0, "script@vignette@micah_32@Action", 64, 0, 1, 0);
	func_154(uParam0, "CCM32AU");
	func_155(uParam0, iLocal_14, 3, -22664287, "WORLD_HUMAN_SMOKE_MALE_C", -1, 1);
	func_155(uParam0, iLocal_15, 3, -202451008, "WORLD_HUMAN_SIT_GROUND_DRINKING_DRUNK_PASSED_OUT_MALE_B", -1, 1);
	func_156(uParam0, iLocal_15, 2, -202451008, "WORLD_HUMAN_SIT_GROUND_DRINKING_DRUNK_PASSED_OUT_MALE_B", -1, 1, -1073741824, 1065353216, 1);
	func_157(uParam0, iLocal_15, iLocal_17, "p_bottleJD01x_PH_R_HAND", 0, 0);
	func_155(uParam0, iLocal_16, 3, 2087366558, "WORLD_HUMAN_STAND_WAITING_FEMALE_A", -1, 1);
	return 1;
}
