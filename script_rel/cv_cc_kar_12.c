...
{
	iLocal_15 = OBJECT::CREATE_OBJECT_NO_OFFSET(joaat("p_chair_crate15x"), 1881.71f, -1833.58f, 42.25f, true, true, false, true);
	ENTITY::SET_ENTITY_HEADING(iLocal_15, 65f);
	iLocal_16 = OBJECT::CREATE_OBJECT_NO_OFFSET(joaat("p_chair_crate15x"), 1881.5f, -1834.79f, 42.25f, true, true, false, true);
