...
int func_72(var uParam0)
{
	...
	func_151(uParam0, 0f, 0f, 0.5445f, 80f, 2f, 2f, 2.7825f, -1612834106, -1, 1, 1, 1);
	func_152(uParam0, 0f, 0.8f, 0f, 0f, 2f, 5f, 3f, -1612834106, 1);
	func_153(uParam0, 1789147356, 0f, 0f, 0f, "SOCK0", 0, 1, 1);
	func_153(uParam0, 1789147356, 0f, 0f, 0f, "SOCK1", 0, 1, 1);
	func_154(uParam0, "script@vignette@karen_12@base", 1, 1, 0, 0);
	func_154(uParam0, "script@vignette@karen_12@Action", 0, 0, 1, 0);
	func_155(uParam0, "CKR12AU");
	func_156(uParam0, iLocal_14, 3, -360309995, "PROP_HUMAN_SEAT_CHAIR_SEWING_FEMALE_B", -1, 0, -1073741824, 1065353216, 1);
	STREAMING::REQUEST_MODEL(1504738597, false);
...
int func_75(var uParam0)
{
	...
	if (!STREAMING::HAS_MODEL_LOADED(1504738597))
	{
		return 0;
	}
	return 1;
...
{
	iLocal_15 = OBJECT::CREATE_OBJECT_NO_OFFSET(1504738597, 1881.71f, -1833.58f, 42.25f, true, true, false, true);
	ENTITY::SET_ENTITY_HEADING(iLocal_15, 65f);
	iLocal_16 = OBJECT::CREATE_OBJECT_NO_OFFSET(1504738597, 1881.5f, -1834.79f, 42.25f, true, true, false, true);
	ENTITY::SET_ENTITY_HEADING(iLocal_16, 105f);
	return 1;
}
...
int func_377(int iParam0, bool bParam1, bool bParam2, var uParam3, var uParam4, var uParam5, float fParam6, bool bParam7, bool bParam8, bool bParam9, bool bParam10)
{
	...
	switch (((*Global_1360165)[iParam0 /*1157*/])->f_70.f_12)
	{
		...
		case 3:
			...
			sVar12 = func_412(iParam0, func_276());
