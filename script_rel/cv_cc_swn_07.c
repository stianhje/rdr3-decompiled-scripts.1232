...
int func_72(var uParam0)
{
	...
	iLocal_19 = func_152(uParam0, 1210783447, 0f, 0f, 0f, "BIBLE", 0, 1, 1);
	func_153(uParam0, "script@vignette@swanson_7@base", 1, 1, 0, 0);
	iLocal_15 = func_153(uParam0, "script@vignette@swanson_7@action_front", 0, 0, 0, 1);
	iLocal_16 = func_153(uParam0, "script@vignette@swanson_7@action_left", 0, 0, 0, 1);
	iLocal_17 = func_153(uParam0, "script@vignette@swanson_7@action_right", 0, 0, 0, 1);
