...
{
	func_33(uParam0, 10780/*func_30*/, 10789/*func_31*/, 10966/*func_32*/);
}
...
void func_14(var uParam0, vector3 vParam1, vector3 vParam4)
{
	...
	func_46(uParam0, "VEH_BOAT", iLocal_9, vParam1, vParam4.z, 0, 0, 1, 0);
}
...
int func_38(int iParam0, vector3 vParam1, float fParam4)
{
	...
	if (func_59(vVar0, vVar0 + vVar3, vParam1))
	{
		return 3;
	}
	return 2;
...
void func_46(var uParam0, char* sParam1, int iParam2, vector3 vParam3, var uParam6, int iParam7, int iParam8, int iParam9, int iParam10)
{
...
int func_47(int iParam0, bool bParam1, int iParam2)
{
	...
	{
		iVar0 = func_71(&(Global_1898164->f_1[0 /*5*/]));
		if (func_72(iVar0) && func_73(((*Global_1347702)[iVar0 /*49*/])->f_12, 131072))
		{
			return 0;
		}
	}
...
bool func_50()
{
	return (Global_1894899 & 1 != 0 && func_57() != -1);
}
...
float func_55(int iParam0, int iParam1, bool bParam2)
{
	if (!ENTITY::DOES_ENTITY_EXIST(iParam0))
	{
		return 0f;
...
bool func_59(struct<2> Param0, var uParam2, struct<2> Param3, Vector3 vParam5, struct<2> Param6, var uParam8)
{
...
int func_60(vector3 vParam0, float fParam3)
{
	...
	while (iVar0 < 4)
	{
		...
		{
			if (func_77(vParam0, (Global_1415419->f_9721[iVar0 /*8*/])->f_4, fParam3, 0))
			{
				return 1;
			}
		}
...
int func_61(vector3 vParam0)
{
	...
	while (iVar0 < 10)
	{
		...
		{
			if (func_77(vParam0, (Global_32073.f_2697.f_1495[iVar0 /*4*/])->f_1, 1f, 0))
			{
				return 1;
			}
		}
...
int func_77(vector3 vParam0, vector3 vParam3, float fParam6, bool bParam7)
{
	if (fParam6 < 0f)
	{
		fParam6 = 0f;
