...
{
	func_33(uParam0, 11068/*func_30*/, 11126/*func_31*/, 11477/*func_32*/);
}
...
int func_28(var uParam0)
{
	if (!&uParam0->f_469[2])
	{
		...
		TASK::TASK_START_SCENARIO_AT_POSITION(&(uParam0->f_20[0 /*14*/]), -22664287, uParam0->f_483, uParam0->f_486.f_2, 0, 0, 1, 0, -1082130432, 0);
		uParam0->f_469[2] = 1;
	}
	if (!&uParam0->f_469[0])
	{
...
int func_50(int iParam0, bool bParam1, bool bParam2, bool bParam3, int iParam4, bool bParam5)
{
	int iVar0;
	int iVar1;
	...
	if ((iParam4 && !func_77(iParam0)) && !ENTITY::IS_ENTITY_DEAD(iVar0))
	{
...
int func_51(int iParam0, bool bParam1, int iParam2, int iParam3, int iParam4, bool bParam5)
{
	...
	if (!func_7(vVar0))
	{
		_NAMESPACE48::_0x59C7AD6FEA2AC449(func_100(iParam0), vVar0);
	}
	if (bParam5)
	{
		iVar3 = _NAMESPACE48::_0x08FC896D2CB31FCC(func_100(iParam0), 0);
	}
	else
	{
		iVar3 = _NAMESPACE48::_0x0CADC3A977997472(func_100(iParam0), 0);
	}
	if (!func_7(vVar0))
	{
		_NAMESPACE48::_0xBB68908CD11AEBDC(func_100(iParam0));
	}
...
{
	func_122(Global_35, &(uParam0->f_20[0 /*14*/]), &uLocal_39, 0f, 0f, 0f, 0, 0, 1, 1069547520, -1082130432, 1073069561, 1056964608, 1092616192, -1, 1, 0, 0, 0, 1);
	func_123(&(uParam0->f_20[0 /*14*/]), Global_35, &uLocal_39, -1082130432, 0, 0, -1082130432, -1082130432, 1, 8, 0, 0, 1069547520, 1073741824, 1050253722, 1067030938, 0, 0, -1, 1, -1082130432, -1082130432, 1);
	func_124(&sLocal_77);
}
...
void func_74(var uParam0)
{
	...
	func_143(&sLocal_77, &(uParam0->f_20[0 /*14*/]));
}
...
int func_103(int iParam0, bool bParam1)
{
	...
	{
		func_159(iParam0, _NAMESPACE48::_0x4F76E3676583D951(func_95(iParam0)));
		if (func_92() == -1)
		{
			if (func_94(iParam0, 2048))
			{
				_NAMESPACE48::_0x49A8C2CD97815215(func_100(iParam0));
				func_148(iParam0, 2048);
			}
			_NAMESPACE48::_0xFCC6DB8DBE709BC8(func_100(iParam0));
		}
		return 0;
	}
	...
	func_159(iParam0, _NAMESPACE48::_0x4F76E3676583D951(func_95(iParam0)));
	_NAMESPACE48::_0x4F81EAD1DE8FA19B(func_100(iParam0));
	if (func_94(iParam0, 2048))
	{
		_NAMESPACE48::_0x49A8C2CD97815215(func_100(iParam0));
		func_148(iParam0, 2048);
...
int func_105(int iParam0)
{
	...
	{
		_NAMESPACE48::_0x49A8C2CD97815215(func_100(iParam0));
		if (!ENTITY::DOES_ENTITY_EXIST(_NAMESPACE48::_0x0CADC3A977997472(func_100(iParam0), 0)))
		{
			return 0;
		}
	}
...
void func_140(int iParam0, vector3 vParam1)
{
	...
	while (iVar0 < 10)
	{
		...
		{
			if (func_151((Global_32073.f_2697.f_1495[iVar0 /*4*/])->f_1, vParam1, 1056964608, 1))
			{
				return;
			}
		}
...
int func_174(int iParam0, bool bParam1, int iParam2, bool bParam3)
{
	...
	{
		return func_229(bParam1, iParam2, bParam3);
	}
	if (Global_1572887->f_12 != -1)
	{
...
int func_224(int iParam0, bool bParam1, bool bParam2, bool bParam3, int iParam4, int iParam5)
{
	int iVar0;
	int iVar1;
	int iVar2;
...
int func_229(bool bParam0, var uParam1, var uParam2)
{
