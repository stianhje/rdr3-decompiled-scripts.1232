...
{
	func_33(uParam0, 10777/*func_30*/, 10829/*func_31*/, 12023/*func_32*/);
}
...
{
	func_46(uParam0, "CAT_CARRY_RAT", "script@ambient@animal@cat_carry_rat@action", vParam1, vParam4);
	uParam0->f_16 = 1;
	func_47(uParam0, 1, "pbl_action", "", 0);
	func_48(uParam0, 0, "CAT", iLocal_37, 0f, 0f, 0f, 0f, 1, 1, 1, 1, 41788943, 0);
	func_48(uParam0, 1, "RAT", iLocal_38, 0f, 0f, 0f, 0f, 1, 1, 1, 1, 41788943, 0);
}
...
int func_31(var uParam0)
{
	...
	sVar0 = "script_amb@animal@cat_carry_rat";
	sVar1 = "cat_exit";
	sVar2 = "rat_exit";
	vVar3 = { 0f, 0f, 0f };
	vVar6 = { 0f, 0f, 0f };
	...
	if (!&uParam0->f_469[0])
	{
		if (!bLocal_42 == 1)
		{
			if (func_62(uParam0, &uLocal_9, 1) || func_63(Global_35, uParam0->f_483, 1) <= 9f)
			{
				bLocal_42 = true;
			}
		}
		if (bLocal_42)
		{
			if ((!ENTITY::HAS_ANIM_EVENT_FIRED(&(uParam0->f_20[0 /*14*/]), 725039534) || ENTITY::IS_ENTITY_DEAD(&(uParam0->f_20[0 /*14*/]))) || ENTITY::IS_ENTITY_DEAD(&(uParam0->f_20[1 /*14*/])))
			{
				...
				if (!&uParam0->f_469[6])
				{
					func_67(*uParam0, uParam0->f_483, 0);
					uParam0->f_469[6] = 1;
				}
				func_68(uParam0);
				func_69(uParam0);
	...
	if (!&uParam0->f_469[0])
	{
		...
		if (&uParam0->f_469[2])
		{
			if (!&uParam0->f_469[6])
			{
				if (func_72(uParam0, 1.5f, 40f, 4, -91962372, 1))
				{
					func_67(*uParam0, uParam0->f_483, 0);
					uParam0->f_469[6] = 1;
				}
							...
							if (!ENTITY::IS_ENTITY_DEAD(&(uParam0->f_20[0 /*14*/])))
							{
								if (ANIMSCENE::_0x005E6F28DD7ED58D(uParam0->f_3.f_1, (uParam0->f_20[0 /*14*/])->f_1))
								{
									if (ENTITY::DOES_ENTITY_EXIST(&(uParam0->f_20[1 /*14*/])))
									{
										...
										func_73(uParam0->f_20[1 /*14*/], 1, 1);
										PED::SET_PED_CAN_BE_TARGETTED(&(uParam0->f_20[1 /*14*/]), false);
										TASK::TASK_PLAY_ANIM(&(uParam0->f_20[1 /*14*/]), sVar0, sVar2, 8f, -1056964608, -1, 1, 0, 0, 0, 0, 0, 0);
										TASK::TASK_PLAY_ANIM(&(uParam0->f_20[0 /*14*/]), sVar0, sVar1, 8f, -1056964608, -1, 65553, 0, 0, 0, 0, "FacialWithPHJaw_filter", 0);
										ENTITY::ATTACH_ENTITY_TO_ENTITY(&(uParam0->f_20[1 /*14*/]), &(uParam0->f_20[0 /*14*/]), PED::GET_PED_BONE_INDEX(&(uParam0->f_20[0 /*14*/]), 61276), vVar3, vVar6, 1, 0, 0, 0, 2, 1, 1, 0);
										uParam0->f_469[4] = 1;
										return 1;
									}
								}
					...
					if (ANIMSCENE::_0x477122B8D05E7968(uParam0->f_3.f_1, 1, 0))
					{
						if (ANIMSCENE::_0x1F0E401031E20146(uParam0->f_3.f_1, "pbl_action"))
						{
							if (ENTITY::HAS_ANIM_EVENT_FIRED(&(uParam0->f_20[0 /*14*/]), -1795669989))
							{
								if (!ENTITY::IS_ENTITY_DEAD(&(uParam0->f_20[0 /*14*/])))
								{
									vLocal_39 = { func_74(uParam0) };
									ANIMSCENE::REMOVE_ANIM_SCENE_ENTITY(uParam0->f_3.f_1, (uParam0->f_20[0 /*14*/])->f_1, &(uParam0->f_20[0 /*14*/]));
									PED::FORCE_PED_MOTION_STATE(&(uParam0->f_20[0 /*14*/]), -668482597, false, 0, false);
									TASK::SET_PED_DESIRED_MOVE_BLEND_RATIO(&(uParam0->f_20[0 /*14*/]), 1f);
									func_73(uParam0->f_20[0 /*14*/], 1, 1);
									func_75(&(uParam0->f_20[0 /*14*/]), -75130390, vLocal_39, 0f, -1, 1, 0, 0, -1082130432);
									PED::SET_PED_KEEP_TASK(&(uParam0->f_20[0 /*14*/]), true);
									if (TASK::IS_PED_ACTIVE_IN_SCENARIO(&(uParam0->f_20[0 /*14*/]), 1) && !TASK::_0x02EBBB3989B7E695(&(uParam0->f_20[0 /*14*/])))
									{
...
int func_32(var uParam0, bool bParam1)
{
	...
	if (uParam0->f_469[4] && !&uParam0->f_469[5])
	{
		...
		else if (TASK::IS_PED_ACTIVE_IN_SCENARIO(&(uParam0->f_20[0 /*14*/]), 0) && TASK::_0x2D0571BB55879DA2(&(uParam0->f_20[0 /*14*/])) == -75130390)
		{
			...
			ENTITY::DETACH_ENTITY(&(uParam0->f_20[1 /*14*/]), true, true);
			PED::SET_PED_TO_RAGDOLL(&(uParam0->f_20[1 /*14*/]), 10000, 10000, 0, false, false, false);
	...
	if ((!bParam1 && uParam0->f_469[4]) // PointerArith && !&uParam0->f_469[5])
	{
		iVar2 = 0;
		while (iVar2 < uParam0->f_19)
		{
			...
			{
				if (func_77(&(uParam0->f_20[iVar2 /*14*/]), Global_35, 1) < 22500f)
				{
					return 0;
				}
			}
...
int func_62(var uParam0, var uParam1, int iParam2)
{
	...
	{
		if (func_106(&(uParam0->f_20[uParam0->f_501 /*14*/]), 0, uParam1, &(uParam0->f_468), 0, 0))
		{
			return 1;
		}
		uParam0->f_501++;
	...
	if ((MISC::GET_FRAME_COUNT() % 8) == 0)
	{
		...
		while (iVar0 < uParam0->f_19)
		{
			...
			if (!ENTITY::IS_ENTITY_DEAD(&(uParam0->f_20[iVar0 /*14*/])))
			{
				...
				fVar8 = func_77(Global_35, &(uParam0->f_20[iVar0 /*14*/]), 1);
				if (fVar8 < fVar1)
				{
					return 1;
				}
...
int func_72(var uParam0, float fParam1, float fParam2, int iParam3, int iParam4, bool bParam5)
{
	int iVar0;
		...
		while (iVar0 < uParam0->f_19)
		{
			...
			else
			{
				if (!ENTITY::IS_ENTITY_DEAD(&(uParam0->f_20[iVar0 /*14*/])))
				{
					...
					{
						if ((func_77(Global_35, &(uParam0->f_20[iVar0 /*14*/]), 1) < fParam2 && PED::_0x5102307CE88798EB(&(uParam0->f_20[iVar0 /*14*/]))) && PED::IS_TRACKED_PED_VISIBLE(&(uParam0->f_20[iVar0 /*14*/])))
						{
							if (!func_64(&(uParam0->f_490)))
							{
								func_121(&(uParam0->f_490), 0);
							}
...
Vector3 func_74(var uParam0)
{
	...
	vVar0 = { 0f, 0f, 0f };
	fVar3 = 1E+11f;
	*(vVar4[0 /*3*/]) = { 1459.462f, 301.6016f, 89.5523f };
	iVar14 = 0;
	while (iVar14 < vVar4.x)
	{
		if (!func_7(*(vVar4[iVar14 /*3*/])))
		{
			fVar15 = BUILTIN::VDIST2(uParam0->f_483, *(vVar4[iVar14 /*3*/]));
			if (fVar15 < fVar3)
			{
				fVar3 = fVar15;
				vVar0 = { *(vVar4[iVar14 /*3*/]) };
			}
		}
		iVar14++;
	}
...
void func_78(var uParam0, bool bParam1, bool bParam2, bool bParam3)
{
	int iVar0;
...
int func_106(int iParam0, int iParam1, var uParam2, var uParam3, int iParam4, float fParam5)
{
	int iVar0;
...
void func_112(int iParam0, vector3 vParam1)
{
	int iVar0;
	int iVar1;
...
int func_168(int iParam0, var uParam1)
{
	...
	else if (func_160() - uParam1->f_4) > func_216(uParam1)
	{
...
int func_180(bool bParam0)
{
	...
	if (func_222(bParam0, &uVar0, &uVar1))
	{
		return 1;
	}
	return 0;
...
int func_189(int iParam0, bool bParam1, bool bParam2, bool bParam3, int iParam4, int iParam5)
{
	...
	{
		if (WEAPON::_0x6AD66548840472E5(func_225(iVar0, 0)))
		{
...
int func_204(int iParam0, int iParam1)
{
	...
	if (func_231(iParam0, 1, 0, 0) != 2055893578)
	{
		return 0;
	}
...
int func_222(bool bParam0, var uParam1, var uParam2)
{
	int iVar0;
	int iVar1;
...
int func_226(int iParam0, float fParam1, float fParam2, float fParam3, float fParam4)
{
	if (!ENTITY::IS_ENTITY_DEAD(iParam0))
	{
...
int func_227(vector3 vParam0, float fParam3, float fParam4, float fParam5, float fParam6)
{
	float fVar0;
	float fVar1;
	bool bVar2;
