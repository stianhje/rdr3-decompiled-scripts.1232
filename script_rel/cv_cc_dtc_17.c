...
int func_72(var uParam0)
{
	...
	func_151(uParam0, 0f, -1.75f, 0.9f, 0f, 4f, 3f, 2f, -1612834106, 2017216891, 1, 1, 1);
	func_152(uParam0, iLocal_14, 1.1f);
	iLocal_18 = func_153(uParam0, joaat("p_cs_bookevelynmiller"), 0f, 0f, 0f, "BOOK", 0, 0, 1);
	uLocal_19 = func_153(uParam0, joaat("p_chairfolding02x"), 0f, 0f, 0f, 0, 1, 0, 1);
	func_154(uParam0, "script@vignette@dutch_17@base", 1, 1, 0, 0);
	iLocal_15 = func_154(uParam0, "script@vignette@dutch_17@action_a", 2, 0, 1, 1);
	iLocal_16 = func_154(uParam0, "script@vignette@dutch_17@action_b", 0, 0, 0, 1);
	iLocal_17 = func_154(uParam0, "script@vignette@dutch_17@action_to_base", 0, 0, 0, 0);
	func_155(uParam0, "CDT17AU");
	func_156(uParam0, iLocal_14, 3, -787460071, "SC_PROP_CAMP_DUTCH_SEAT_CHAIR_READING_MALE_A", uLocal_19, 0);
	func_157(uParam0, iLocal_14, 2, -787460071, "SC_PROP_CAMP_DUTCH_SEAT_CHAIR_READING_MALE_A", uLocal_19, 0, -1073741824, 1065353216, 1);
	func_158(uParam0, iLocal_14, iLocal_18, "p_cs_bookEvelynMiller_PH_R_HAND", 0, 0);
	func_159(uParam0, iLocal_14, 2, -1);
	Local_20 = { func_160(uParam0, 0.02f, 0.16f, 0.782f, 180f, 7f, 0.7f, 0.7f) };
	func_161(uParam0, 1);
...
int func_192(var uParam0, int iParam1, bool bParam2)
{
	...
	if (bParam2)
	{
		...
		while (iVar1 < uParam0->f_1984)
		{
			...
			else if (func_292(uParam0, iVar1) || func_201(uParam0, iVar1))
			{
