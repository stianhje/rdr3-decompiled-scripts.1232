...
{
	func_33(uParam0, 10772/*func_30*/, 10823/*func_31*/, 11561/*func_32*/);
}
...
{
	func_46(uParam0, "FOX_HUNT_IN_SNOW", "script@ambient@animal@fox_hunt_in_snow@action", vParam1, vParam4);
	uParam0->f_16 = 1;
	func_47(uParam0, 1, "pbl_action", "", 0);
	func_48(uParam0, 0, "FOX", iLocal_9, 0f, 0f, 0f, 0f, 1, 1, 1, 1, 41788943, 1);
}
...
int func_31(var uParam0)
{
	if (!ENTITY::IS_ENTITY_DEAD(&(uParam0->f_20[0 /*14*/])))
	{
		...
		bLocal_40 = ANIMSCENE::_0x3AB6C7B0BB0DF4B1(&(uParam0->f_20[0 /*14*/]), -1);
	}
	if (!&uParam0->f_469[0])
	{
		if (!bLocal_38)
		{
			if ((!bLocal_40 || func_62(uParam0, &uLocal_10, 1)) || func_63(&(uParam0->f_20[0 /*14*/]), Global_35, 1) <= 400f)
			{
				func_64(uParam0);
				if (!&uParam0->f_469[3])
				{
					func_65(*uParam0, uParam0->f_483, 1);
					uParam0->f_469[3] = 1;
				}
				bLocal_38 = true;
			}
	...
	if (!&uParam0->f_469[0] && !bLocal_38)
	{
		...
		if (&uParam0->f_469[1])
		{
			if (!&uParam0->f_469[3])
			{
				if (func_70(uParam0, 1065353216, 1116471296, 4, -91962372, 1))
				{
					func_65(*uParam0, uParam0->f_483, 1);
					uParam0->f_469[3] = 1;
				}
						...
						if (ANIMSCENE::_0x1F0E401031E20146(uParam0->f_3.f_1, "pbl_action"))
						{
							if (ANIMSCENE::_0xD8254CB2C586412B(uParam0->f_3.f_1, 0) || ANIMSCENE::_0xCDC5512A407CF08D(uParam0->f_3.f_1))
							{
								if (!ENTITY::IS_ENTITY_DEAD(&(uParam0->f_20[0 /*14*/])))
								{
									...
									if (STREAMING::IS_MODEL_VALID((uParam0->f_20[0 /*14*/])->f_2))
									{
										STREAMING::SET_MODEL_AS_NO_LONGER_NEEDED((uParam0->f_20[0 /*14*/])->f_2);
									}
								}
								uParam0->f_469[2] = 1;
								return 1;
...
int func_68(var uParam0, float fParam1)
{
	if (!func_66(uParam0))
	{
		return 0;
...
int func_70(var uParam0, float fParam1, float fParam2, int iParam3, int iParam4, bool bParam5)
{
	...
	if ((MISC::GET_FRAME_COUNT() % 8) == 0)
	{
		...
		if (func_66(&(uParam0->f_490)) && !func_114(&(uParam0->f_490)))
		{
...
void func_102(int iParam0)
{
	if (func_43(iParam0))
	{
		...
		{
			case 1:
				func_162(0, 1, 0, 0, ((Global_1415419->f_19[iParam0 /*12*/])->f_7 / 4), 0, 0, 1);
				func_162(1, 1, 0, 0, ((Global_1415419->f_19[iParam0 /*12*/])->f_7 / 4), 0, 0, 1);
				break;
			case 37:
				func_162(60, 1, 0, 0, ((Global_1415419->f_19[iParam0 /*12*/])->f_7 / 4), 0, 0, 1);
				break;
		}
	}
}

void func_103(int iParam0, vector3 vParam1)
{
	int iVar0;
	int iVar1;
...
int func_160(int iParam0, var uParam1)
{
	...
	else if (func_152() - uParam1->f_4) > func_208(uParam1)
	{
...
void func_162(int iParam0, int iParam1, int iParam2, int iParam3, int iParam4, int iParam5, bool bParam6, int iParam7)
{
	int iVar0;

	iVar0 = (((iParam2 + (60 * iParam3)) + (3600 * iParam4)) + (86400 * iParam5));
	if (func_210(iParam0) == 1 && iParam7)
	{
		return;
	}
	if (bParam6)
