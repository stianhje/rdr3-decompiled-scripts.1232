...
int func_72(var uParam0)
{
	...
	func_151(uParam0, 0f, 0f, 0f, 0f, 5f, 5f, 10f, -1612834106, -1495061186, 1, 1, 1);
	iLocal_16 = func_152(uParam0, joaat("p_cs_book04x"), 0f, 0f, 0f, "BOOK", 0, 1, 1);
	if (func_153(10))
	{
		func_154(uParam0, iLocal_14, 2, 1253642035, "PROP_HUMAN_SEAT_CHAIR_READING_MALE_A", -1, 0, -1f, 1065353216, 1);
		func_155(uParam0, iLocal_14, iLocal_16, "p_cs_book04x_PH_R_HAND", 0, 0);
	}
	else
	{
		func_154(uParam0, iLocal_14, 3, 1253642035, "PROP_HUMAN_SEAT_CHAIR_READING_MALE_A", -1, 0, -1073741824, 1065353216, 1);
		func_155(uParam0, iLocal_14, iLocal_16, "p_cs_book04x_PH_R_HAND", 0, 0);
	}
	func_156(uParam0, iLocal_15, 4, 2087366558, "WORLD_HUMAN_STAND_WAITING_FEMALE_A", -1, 1);
	...
	func_160(uParam0, -667268386, 1269497949);
	if (!func_153(10))
	{
		func_161(uParam0, "script@vignette@john_4@base", 1, 1, 0, 0);
	}
	func_161(uParam0, "script@vignette@john_4@action", 0, 0, 1, 0);
...
int func_85(var uParam0)
{
	...
	if (!uParam0->f_4)
	{
		...
		while (iVar0 < uParam0->f_106)
		{
			...
			else if (func_182(uParam0, iVar0))
			{
			}
	...
	{
		func_197(uParam0);
		func_198(uParam0, uParam0->f_2047, 1);
	}
...
int func_91(var uParam0)
{
	...
	iVar0 = func_201(func_19(uParam0));
	func_202(iVar0);
	...
	if (uParam0->f_2048 >= 0)
	{
		func_198(uParam0, uParam0->f_2048, 1);
	}
	func_205(uParam0);
...
void func_166(var uParam0, int iParam1, int iParam2, int iParam3, int iParam4)
{
...
void func_177(var uParam0, vector3 vParam1, vector3 vParam4)
{
	int iVar0;
...
int func_181(var uParam0)
{
	...
	while (iVar3 < uParam0->f_106)
	{
		...
		else if (func_182(uParam0, iVar3))
		{
		}
		...
		case 7:
			switch (iParam0)
			{
				...
				case 14:
					...
					break;
				case 4:
					if (func_328(747937920, 1) && !func_392(((*Global_1347702)[1 /*49*/])->f_15, 1))
					{
						iVar1[0] = -1155031950;
					}
					else
