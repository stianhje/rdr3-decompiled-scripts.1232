...
int func_72(var uParam0)
{
	...
	iLocal_16 = func_151(uParam0, 2095602337, 0f, 0f, 0f, "NEWSPAPER", 0, 0, 1);
	iLocal_17 = func_151(uParam0, -1006095118, -0.258237f, -1.19728f, 0f, "Chair", 1, 0, 1);
	...
	func_157(uParam0, iLocal_15, 3, 1348830223, "PROP_HUMAN_SEAT_CHAIR_READ_NEWSPAPER_MALE_B", iLocal_17, 0, -1073741824, 1065353216, 1);
...
void func_425(int iParam0, int iParam1)
{
	...
	switch (iParam0)
	{
		case 11:
			...
			{
				func_466(iParam1, 1240907314, 0, 0, 2, 1, 0, 1056964608, 1065353216, -1, 0, 0, 0, 0);
				func_466(iParam1, -2088446466, 0, 0, 3, 1, 1, 1056964608, 1065353216, -1, 0, 1, 0, 0);
			}
			break;
	}
}
