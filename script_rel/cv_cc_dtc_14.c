...
int func_72(var uParam0)
{
	...
	func_151(uParam0, -0.048f, -0.6479f, 1.1058f, 164.7765f, 1.5f, 1.5f, 3f, -1612834106, 2017216891, 1, 1, 1);
	func_152(uParam0, iLocal_14, 1.1f);
	iLocal_17 = func_153(uParam0, joaat("p_cs_book04x"), 0f, 0f, 0f, "BOOK", 0, 0, 1);
	func_154(uParam0, "script@vignette@dutch_14@base", 1, 1, 0, 0);
	iLocal_15 = func_154(uParam0, "script@vignette@dutch_14@action_a", 2, 0, 1, 1);
	iLocal_16 = func_154(uParam0, "script@vignette@dutch_14@action_b", 0, 0, 0, 1);
	func_155(uParam0, "CDT14AU");
	func_156(uParam0, iLocal_14, 2, -716577201, "WORLD_HUMAN_SIT_GROUND_READING_BOOK_MALE_A", -1, 1, -1073741824, 1065353216, 1);
	...
	Local_18 = { func_160(uParam0, -0.048f, -0.6479f, 1.1058f, 164.7765f, 8f, 0.8f, 0.8f) };
	func_161(uParam0, 1);
...
{
	return func_193(uParam0, Local_18, 1, 0);
}
...
int func_93(var uParam0)
{
	...
	{
		if (func_193(uParam0, Local_18, 1, 0))
		{
			func_192(uParam0, iLocal_16, 1);
		}
		else
		{
...
void func_152(var uParam0, int iParam1, float fParam2)
{
...
int func_192(var uParam0, int iParam1, bool bParam2)
{
	...
	if (bParam2)
	{
		...
		while (iVar1 < uParam0->f_1984)
		{
			...
			else if (func_291(uParam0, iVar1) || func_201(uParam0, iVar1))
			{
...
int func_193(var uParam0, struct<4> Param1, var uParam5, var uParam6, var uParam7, var uParam8, var uParam9, var uParam10, bool bParam11, bool bParam12)
{
	...
	if (!func_294(Param1, Param1.f_6, Global_36))
	{
		return 0;
	}
	if (func_294(Param1, Param1.f_3, Global_36))
	{
		return 0;
	}
	if (bParam12)
...
void func_202(var uParam0, int iParam1, bool bParam2, bool bParam3)
{
	...
	if (bParam3)
	{
		uVar0 = func_302(uParam0, iParam1);
	}
	if (bParam2)
	{
...
bool func_294(struct<2> Param0, var uParam2, struct<2> Param3, var uParam5, struct<2> Param6, var uParam8)
{
...
float func_303(float fParam0, float fParam1)
{
...
void func_344(var uParam0, int iParam1)
{
	...
	func_383(sVar1, uVar2, uVar3, iVar4);
}
...
int func_348(var uParam0, int iParam1)
{
	...
	while (iVar2 <= iVar1)
	{
		...
		else
		{
			...
			vVar10 = { func_386(fVar9) };
			vVar13 = { func_387(ENTITY::GET_ENTITY_COORDS((uParam0->f_107[iParam1 /*113*/])->f_5, true, false), vVar3, 1065353216) };
...
void func_383(char* sParam0, var uParam1, var uParam2, int iParam3)
{
...
Vector3 func_386(float fParam0)
{
	return -BUILTIN::SIN(fParam0), BUILTIN::COS(fParam0), 0f;
}

Vector3 func_387(vector3 vParam0, vector3 vParam3, float fParam6)
{
	return func_414(vParam3 - vParam0) * Vector(fParam6, fParam6, fParam6);
}
...
Vector3 func_414(vector3 vParam0)
{
	float fVar0;
	float fVar1;
...
void func_421(int iParam0, int iParam1)
{
	...
	func_382(iParam0, func_451(iParam1));
	...
	func_393(iParam1, func_449(iParam1, 8192), func_449(iParam1, 16384), 1);
}
		...
		case 1:
			switch (iParam0)
			{
				...
				case 9:
					...
					break;
				case 10:
					if (func_394(((*Global_1347702)[63 /*49*/])->f_15, 1) || func_431(((*Global_1347702)[63 /*49*/])->f_15))
					{
						iVar1[0] = -268604689;
					}
					else
		...
		case 3:
			switch (iParam0)
			{
				...
				case 10:
					...
					break;
				case 11:
					if (func_394(((*Global_1347702)[134 /*49*/])->f_15, 1) || func_431(((*Global_1347702)[134 /*49*/])->f_15))
					{
						iVar1[0] = -2040275819;
						iVar1[1] = 1205492208;
						iVar7 = 2;
		...
		case 7:
			switch (iParam0)
			{
				...
				case 14:
					...
					break;
				case 4:
					if (func_324(747937920, 1) && !func_394(((*Global_1347702)[1 /*49*/])->f_15, 1))
					{
						iVar1[0] = -1155031950;
					}
					else
