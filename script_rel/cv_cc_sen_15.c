...
int func_72(var uParam0)
{
	...
	func_151(uParam0, -1.0725f, 0.6225f, 1.1875f, -36f, 1.1f, 1.0875f, 3.2075f, -1612834106, -2087487524, 1, 1, 1);
	func_151(uParam0, -0.485f, -1.1775f, 1.1875f, -36f, 1.1f, 1.0875f, 3.2075f, -1612834106, 271759394, 1, 1, 1);
	func_151(uParam0, 1.19f, -0.4525f, 1.1875f, -19.25f, 1.305f, 1.0875f, 3.2075f, -1612834106, 1418411488, 1, 1, 1);
	iLocal_20 = func_152(uParam0, -1971689092, 0f, 0f, 0f, "BOTTLE0", 0, 0, 1);
	iLocal_22 = func_152(uParam0, -1971689092, 0f, 0f, 0f, "BOTTLE1", 0, 0, 1);
	iLocal_21 = func_152(uParam0, -1971689092, 0f, 0f, 0f, "BOTTLE2", 0, 0, 1);
	iLocal_17 = func_152(uParam0, -1618805595, -1.2888f, 0.763619f, -0.00258636f, 0, 1, 0, 1);
	iLocal_18 = func_152(uParam0, 1230724566, 1.42062f, -0.462748f, 0.00315094f, 0, 1, 0, 1);
	iLocal_19 = func_152(uParam0, 264425748, -0.584697f, -1.37147f, -0.0016098f, 0, 1, 0, 1);
	func_153(uParam0, "script@vignette@sean_15@base", 1, 1, 0, 0);
	func_153(uParam0, "script@vignette@sean_15@action", 0, 0, 1, 0);
	func_154(uParam0, "CSE15AU");
	func_155(uParam0, iLocal_15, 3, -120888770, "PROP_HUMAN_SEAT_CHAIR_TABLE_DRINKING_BADASS_MALE_D", iLocal_18, 0, -1073741824, 1065353216, 1);
	...
	func_155(uParam0, iLocal_16, 3, 460481756, "WORLD_HUMAN_DRINK_PUT_DOWN_TABLE_WHISKEY_MALE_A", -1, 0, -1073741824, 1065353216, 1);
...
int func_151(var uParam0, vector3 vParam1, float fParam4, vector3 vParam5, int iParam8, int iParam9, bool bParam10, int iParam11, int iParam12)
{
	...
	if (bParam10)
	{
		vParam1 = { func_189(uParam0, vParam1) };
...
void func_157(var uParam0, int iParam1, int iParam2, int iParam3)
{
	...
	{
		case 4:
			(uParam0->f_107[iParam1 /*113*/])->f_32.f_5 = { func_252(func_148(uParam0), func_251(uParam0, iParam1), func_19(uParam0), 1) };
			break;
		default:
			Var0 = { func_253(func_148(uParam0), func_251(uParam0, iParam1), func_19(uParam0), 1) };
	...
	while (iVar0 < uParam0->f_1711)
	{
		...
		else
		{
			...
			if (!(uParam0->f_1711[iVar0 /*15*/])->f_5 && !ENTITY::DOES_ENTITY_EXIST((uParam0->f_1711[iVar0 /*15*/])->f_10))
			{
				...
				{
					vVar3 = { func_189(uParam0, (uParam0->f_1711[iVar0 /*15*/])->f_1) };
				}
				else
				{
...
void func_182(var uParam0)
{
	...
	{
		uParam0->f_1976.f_6 = PROPSET::_CREATE_PROPSET_2(uParam0->f_1976, func_189(uParam0, uParam0->f_1976.f_1), 1, func_249(uParam0, uParam0->f_1976.f_4), 3f, false, true);
	}
}
...
int func_187(var uParam0, int iParam1, bool bParam2)
{
	...
	if (bParam2)
	{
		...
		while (iVar1 < uParam0->f_1984)
		{
			...
			else if (func_290(uParam0, iVar1) || func_291(uParam0, iVar1))
			{
...
Vector3 func_189(var uParam0, vector3 vParam1)
{
...
Vector3 func_252(int iParam0, int iParam1, int iParam2, bool bParam3)
{
	switch (iParam0)
	{
		case 0:
...
struct<4> func_253(int iParam0, int iParam1, int iParam2, bool bParam3)
{
	switch (iParam0)
	{
		case 1:
						...
						case 485:
							...
							switch (iParam1)
							{
								...
								case 14:
									...
									{
										case 156:
											return func_323(2329.663f, 1347.464f, 104.5794f, 155.2611f);
										default:
											break;
									}
									break;
								case 1:
									switch (iParam2)
									{
										...
										case 156:
											return func_323(2330.225f, 1345.275f, 104.7174f, 21.2991f);
										default:
											break;
									}
									break;
							...
							switch (iParam1)
							{
								...
								case 4:
									...
									{
										case 669:
											return func_323(-1603.036f, -1408.744f, 80.9423f, 69.6409f);
										default:
											break;
									}
									break;
...
int func_265(var uParam0)
{
	...
	while (iVar1 < uParam0->f_1711)
	{
		...
		else if ((uParam0->f_1711[iVar1 /*15*/])->f_5)
		{
			...
			{
				vVar2 = { func_189(uParam0, (uParam0->f_1711[iVar1 /*15*/])->f_1) };
			}
			else
			{
...
struct<4> func_323(vector3 vParam0, float fParam3)
{
	struct<4> Var0;
		...
		case 7:
			switch (iParam0)
			{
				...
				case 14:
					...
					break;
				case 4:
					if (func_321(747937920, 1) && !func_386(((*Global_1347702)[1 /*49*/])->f_15, 1))
					{
						iVar1[0] = -1155031950;
					}
					else
