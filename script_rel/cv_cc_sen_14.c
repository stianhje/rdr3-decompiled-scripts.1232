...
int func_72(var uParam0)
{
	...
	func_151(uParam0, 12.3f, 4.5f, 1.612f, 123.25f, 2f, 3.1425f, 3.2075f, -1612834106, 1418411488, 1, 1, 1);
	func_151(uParam0, -1.1475f, -1.4025f, 1.4875f, -44f, 1.0975f, 1.145f, 3.2075f, -1612834106, 1632043240, 1, 1, 1);
	iLocal_16 = func_152(uParam0, -1618805595, -1.16311f, -1.68532f, -0.0235901f, 0, 1, 0, 1);
	func_152(uParam0, -967333571, 0f, 0f, 0f, "p_cigarette_cs01x", 0, 1, 1);
	func_152(uParam0, -1074884633, 0f, 0f, 0f, "p_cs_rag02x", 0, 1, 1);
	func_153(uParam0, iLocal_14, -183018591, "w_repeater_carbine01");
	func_153(uParam0, iLocal_15, 127400949, "w_revolver_cattleman01");
	func_154(uParam0, "script@vignette@sean_14@base", 1, 1, 0, 0);
	func_154(uParam0, "script@vignette@sean_14@Action", 0, 0, 1, 0);
	func_155(uParam0, "CSE14AU");
	func_156(uParam0, iLocal_14, 3, -22664287, "WORLD_HUMAN_SMOKE_MALE_C", -1, 1);
	func_157(uParam0, iLocal_14, 3, -258459266, "WORLD_HUMAN_GUARD_SCOUT_MALE_C", -1, 0, -1073741824, 1065353216, 1);
	func_158(uParam0, iLocal_14, 3, 0);
	func_156(uParam0, iLocal_15, 3, 1381842067, "PROP_CAMP_MICAH_SEAT_CHAIR_CLEAN_GUN_MALE_A", iLocal_16, 0);
	func_157(uParam0, iLocal_15, 3, 1381842067, "PROP_CAMP_MICAH_SEAT_CHAIR_CLEAN_GUN_MALE_A", iLocal_16, 0, -1073741824, 1065353216, 1);
	return 1;
}
