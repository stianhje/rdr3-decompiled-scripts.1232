...
int func_72(var uParam0)
{
	...
	func_151(uParam0, -0.5643f, -1.2972f, 0.5073f, -19.8f, 1.5f, 1.5f, 3f, -1612834106, 1632043240, 1, 1, 1);
	func_151(uParam0, 0.5259f, 1.1492f, 0.5633f, -23.04f, 1.5f, 1.5f, 3f, -1612834106, -2087487524, 1, 1, 1);
	iLocal_17 = func_152(uParam0, 264425748, -0.585f, -1.372f, -0.001f, 0, 1, 0, 1);
	iLocal_16 = func_152(uParam0, 1504738597, 0.636f, 1.325f, -0.004f, 0, 1, 0, 1);
	func_152(uParam0, -967333571, 0f, 0f, 0f, "CIGARETTE", 0, 1, 1);
	func_152(uParam0, 617552302, 0f, 0f, 0f, "MATCH", 0, 1, 1);
	iLocal_18 = func_152(uParam0, 587066646, 0f, 0f, 0f, "BOWL", 0, 0, 1);
	iLocal_19 = func_152(uParam0, -755866836, 0f, 0f, 0f, "SPOON", 0, 0, 1);
	func_153(uParam0, "script@vignette@micah_25@base", 1, 1, 0, 0);
	func_153(uParam0, "script@vignette@micah_25@action", 0, 0, 1, 0);
	func_154(uParam0, "CCM25AU");
	func_155(uParam0, iLocal_14, 1, -1);
	func_156(uParam0, iLocal_15, 3, 1627566189, "PROP_CAMP_SEAT_CHAIR_TABLE_STEW_EATING_MALE_A", iLocal_16, 0, -1073741824, 1065353216, 1);
	...
	func_159(uParam0, 400922671, -1233540955);
	return 1;
}
...
int func_86(var uParam0)
{
	...
	if (iLocal_16 != -1)
	{
		iVar0 = func_190(uParam0, iLocal_16);
		if (ENTITY::DOES_ENTITY_EXIST(iVar0))
		{
			ENTITY::SET_ENTITY_COORDS(iVar0, func_191(uParam0, 0.638596f, 1.2423f, -0.00779724f), true, false, true, true);
		}
	}
	if (iLocal_17 != -1)
	{
		iVar1 = func_190(uParam0, iLocal_17);
		if (ENTITY::DOES_ENTITY_EXIST(iVar1))
		{
			ENTITY::SET_ENTITY_COORDS(iVar1, func_191(uParam0, -0.581406f, -1.2677f, 0.00219727f), true, false, true, true);
		}
	}
...
int func_151(var uParam0, vector3 vParam1, float fParam4, vector3 vParam5, int iParam8, int iParam9, bool bParam10, int iParam11, int iParam12)
{
	...
	if (bParam10)
	{
		vParam1 = { func_191(uParam0, vParam1) };
	...
	while (iVar0 < uParam0->f_1711)
	{
		...
		else
		{
			...
			if (!(uParam0->f_1711[iVar0 /*15*/])->f_5 && !ENTITY::DOES_ENTITY_EXIST((uParam0->f_1711[iVar0 /*15*/])->f_10))
			{
				...
				{
					vVar3 = { func_191(uParam0, (uParam0->f_1711[iVar0 /*15*/])->f_1) };
				}
				else
				{
...
void func_184(var uParam0)
{
	...
	{
		uParam0->f_1976.f_6 = PROPSET::_CREATE_PROPSET_2(uParam0->f_1976, func_191(uParam0, uParam0->f_1976.f_1), 1, func_251(uParam0, uParam0->f_1976.f_4), 3f, false, true);
	}
}
...
Vector3 func_191(var uParam0, vector3 vParam1)
{
...
int func_264(var uParam0)
{
	...
	while (iVar1 < uParam0->f_1711)
	{
		...
		else if ((uParam0->f_1711[iVar1 /*15*/])->f_5)
		{
			...
			{
				vVar2 = { func_191(uParam0, (uParam0->f_1711[iVar1 /*15*/])->f_1) };
			}
			else
			{
...
int func_381(int iParam0, bool bParam1, bool bParam2, var uParam3, var uParam4, var uParam5, float fParam6, bool bParam7, bool bParam8, bool bParam9, bool bParam10)
{
	...
	switch (((*Global_1360165)[iParam0 /*1157*/])->f_70.f_12)
	{
		...
		case 3:
			...
			sVar12 = func_416(iParam0, func_279());
