...
void __EntryFunction__()
{
	...
	fLocal_8 = 1f;
	fLocal_9 = 2.5f;
	iLocal_10 = 1465438313;
	iLocal_11 = -1874044762;
	Var0.f_1 = -1;
	Var0.f_3.f_9 = 3;
	Var0.f_20 = 25;
...
{
	func_33(uParam0, 10828/*func_30*/, 10837/*func_31*/, 11471/*func_32*/);
}
...
{
	func_46(uParam0, "SQUIRREL_CHASE_SQUIRREL", "", vParam1, vParam4);
	switch (*uParam0)
	{
		case 213:
			iLocal_10 = 1465438313;
		...
		case 192:
			iLocal_10 = -541762431;
			fLocal_9 = 2f;
			iLocal_11 = -1374871530;
			break;
	}
	func_47(uParam0, 0, "SQS_SQUIRREL_1", iLocal_10, OBJECT::_GET_OBJECT_OFFSET_FROM_COORDS(vParam1, vParam4.z, 0f, 0f, 1f), (0f + vParam4.z), 1, 1, 1, 1, 41788943, 1);
	func_47(uParam0, 1, "SQS_SQUIRREL_2", iLocal_10, OBJECT::_GET_OBJECT_OFFSET_FROM_COORDS(vParam1, vParam4.z, 0.25f, -1f, 1f), (0f + vParam4.z), 1, 1, 1, 1, 41788943, 1);
}
...
int func_31(var uParam0)
{
	...
	switch (iLocal_12)
	{
		case 0:
			...
			{
				func_55(&((uParam0->f_20[0 /*14*/])->f_5), 50, 10, 0);
				uLocal_13[0] = func_56(iLocal_11, (uParam0->f_20[0 /*14*/])->f_5, (uParam0->f_20[0 /*14*/])->f_8, 0, 0, 0);
				TASK::_TASK_USE_SCENARIO_POINT(&(uParam0->f_20[0 /*14*/]), &(uLocal_13[0]), 0, 0, 0, 1, 0, 0, -1082130432, 0);
				func_57(uParam0->f_20[0 /*14*/], 1, 1);
			}
			if (!ENTITY::IS_ENTITY_DEAD(&(uParam0->f_20[1 /*14*/])))
			{
				func_55(&((uParam0->f_20[1 /*14*/])->f_5), 50, 10, 0);
				uLocal_13[1] = func_56(iLocal_11, (uParam0->f_20[1 /*14*/])->f_5, (uParam0->f_20[1 /*14*/])->f_8, 0, 0, 0);
				TASK::_TASK_USE_SCENARIO_POINT(&(uParam0->f_20[1 /*14*/]), &(uLocal_13[1]), 0, 0, 0, 1, 0, 0, -1082130432, 0);
		...
		case 1:
			if (func_58(uParam0, uParam0->f_493, uParam0->f_494, 4, uParam0->f_495, 1112014848))
			{
				if (!ENTITY::IS_ENTITY_DEAD(&(uParam0->f_20[0 /*14*/])) && !ENTITY::IS_ENTITY_DEAD(&(uParam0->f_20[1 /*14*/])))
				{
					...
					TASK::OPEN_SEQUENCE_TASK(&iVar0);
					TASK::TASK_FOLLOW_TO_OFFSET_OF_ENTITY(0, &(uParam0->f_20[0 /*14*/]), 0f, -1f, 0f, fLocal_9, -1, 1036831949, 1, 1, 0, 0, 1);
					TASK::TASK_SET_BLOCKING_OF_NON_TEMPORARY_EVENTS(0, false);
					TASK::CLOSE_SEQUENCE_TASK(iVar0);
					func_57(uParam0->f_20[1 /*14*/], 1, 1);
				...
				func_59(*uParam0, 1);
				func_60(*uParam0, uParam0->f_483, 1);
				func_61(&uLocal_16);
				iLocal_12 = 2;
			}
			break;
...
int func_32(var uParam0, var uParam1)
{
	...
	func_63(uParam0, 0, 0, 0);
	iVar0 = 0;
	while (iVar0 < uParam0->f_19)
	{
		if (TASK::_0x841475AC96E794D1(&(uLocal_13[iVar0])))
		{
...
int func_38(int iParam0, vector3 vParam1, float fParam4)
{
	...
	if (func_66(vVar0, vVar0 + vVar3, vParam1))
	{
		return 3;
	}
	return 2;
...
int func_48(int iParam0, bool bParam1, int iParam2)
{
	...
	{
		iVar0 = func_78(&(Global_1898164->f_1[0 /*5*/]));
		if (func_79(iVar0) && func_80(((*Global_1347702)[iVar0 /*49*/])->f_12, 131072))
		{
			return 0;
		}
	}
...
bool func_51()
{
	return (Global_1894899 & 1 != 0 && func_64() != -1);
}
...
var func_56(int iParam0, vector3 vParam1, float fParam4, float fParam5, int iParam6, int iParam7)
{
...
int func_58(var uParam0, float fParam1, float fParam2, int iParam3, float fParam4, float fParam5)
{
	int iVar0;
	float fVar1;
	int iVar2;
	...
	if ((MISC::GET_FRAME_COUNT() % 8) == 0)
	{
		...
		fVar7 = func_87(Global_36, uParam0->f_483);
		...
		while (iVar0 < uParam0->f_19)
		{
			...
			if (!ENTITY::IS_ENTITY_DEAD(&(uParam0->f_20[iVar0 /*14*/])))
			{
				...
				fVar8 = func_88(Global_35, &(uParam0->f_20[iVar0 /*14*/]), 1);
				if (fVar8 < fVar1)
				{
					return 1;
				}
...
void func_60(int iParam0, vector3 vParam1, bool bParam4)
{
	if (func_40() > (Global_32073.f_2697.f_6[iParam0 /*6*/])->f_5)
	{
		(Global_32073.f_2697.f_6[iParam0 /*6*/])->f_5 = func_40();
...
int func_62(var uParam0, float fParam1)
{
	if (!func_89(uParam0))
	{
		return 0;
...
bool func_66(struct<2> Param0, var uParam2, struct<2> Param3, Vector3 vParam5, struct<2> Param6, var uParam8)
{
	return (((Param3 - Param0) * (Param6.f_1 - Param0.f_1)) - ((Param3.f_1 - Param0.f_1) * (Param6 - Param0))) > 0f;
}

int func_67(vector3 vParam0, float fParam3)
{
	int iVar0;
	...
	while (iVar0 < 4)
	{
		...
		{
			if (func_96(vParam0, (Global_1415419->f_9721[iVar0 /*8*/])->f_4, fParam3, 0))
			{
				return 1;
			}
		}
...
int func_68(vector3 vParam0)
{
	...
	while (iVar0 < 10)
	{
		...
		{
			if (func_96(vParam0, (Global_32073.f_2697.f_1495[iVar0 /*4*/])->f_1, 1f, 0))
			{
				return 1;
			}
		}
...
{
	return (BUILTIN::SHIFT_RIGHT(iParam0, 26) & 31 * func_97(MISC::IS_BIT_SET(iParam0, 31), -1, 1)) + 1898;
}
...
bool func_83(vector3 vParam0, vector3 vParam3)
{
...
float func_88(int iParam0, int iParam1, bool bParam2)
{
	if (!ENTITY::DOES_ENTITY_EXIST(iParam0))
	{
		return 0f;
	...
	return func_111(ENTITY::GET_ENTITY_COORDS(iParam0, false, false), ENTITY::GET_ENTITY_COORDS(iParam1, false, false));
}
...
void func_92(int iParam0)
{
	if (func_43(iParam0))
	{
		...
		{
			case 1:
				func_113(0, 1, 0, 0, ((Global_1415419->f_19[iParam0 /*12*/])->f_7 / 4), 0, 0, 1);
				func_113(1, 1, 0, 0, ((Global_1415419->f_19[iParam0 /*12*/])->f_7 / 4), 0, 0, 1);
				break;
			
			case 37:
				func_113(60, 1, 0, 0, ((Global_1415419->f_19[iParam0 /*12*/])->f_7 / 4), 0, 0, 1);
				break;
		}
	}
}

void func_93(int iParam0, vector3 vParam1)
{
	int iVar0;
	int iVar1;
	...
	while (iVar0 < 10)
	{
		...
		{
			if (func_96((Global_32073.f_2697.f_1495[iVar0 /*4*/])->f_1, vParam1, 1056964608, 1))
			{
				return;
			}
		}
...
void func_113(int iParam0, int iParam1, int iParam2, int iParam3, int iParam4, int iParam5, bool bParam6, int iParam7)
{
	int iVar0;
	
	iVar0 = (((iParam2 + (60 * iParam3)) + (3600 * iParam4)) + (86400 * iParam5));
	if (func_122(iParam0) == 1 && iParam7)
	{
		return;
	}
	if (bParam6)
