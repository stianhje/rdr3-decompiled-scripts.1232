...
int func_72(var uParam0)
{
	...
	func_152(uParam0, "script@vignette@lenny_2@base", 1, 1, 0, 0);
	func_152(uParam0, "script@vignette@lenny_2@action", 0, 0, 1, 1);
	...
	Local_15 = { func_157(uParam0, 0f, 0f, 0f, 0f, 8f, 0.6f, 0.6f) };
	func_158(uParam0, 1);
...
{
	return func_190(uParam0, Local_15, 1, 0);
}
