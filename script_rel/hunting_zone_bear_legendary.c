...
int func_5(var uParam0)
{
	...
	if (uParam0->f_11 > 0)
	{
		...
		if ((SCRIPTS::_0x9E4EF615E307FBBE() && SCRIPTS::_GET_NUMBER_OF_REFERENCES_OF_SCRIPT_WITH_NAME_HASH(joaat("hunting1")) == 0) && !func_34(15))
		{
			bVar0 = true;
		}
...
bool func_35()
{
	return (func_36(&Global_1935630, 4096) || SCRIPTS::_GET_NUMBER_OF_REFERENCES_OF_SCRIPT_WITH_NAME_HASH(1637780761) > 0);
}
...
int func_42(var uParam0)
{
	*uParam0 = 0;
	uParam0->f_1 = 2;
	uParam0->f_10 = 300f;
	uParam0->f_572[0] = -1954560321;
	uParam0->f_572[1] = 1913959575;
	uParam0->f_580[0] = 4;
	uParam0->f_580[1] = 0;
	uParam0->f_588[0] = 0;
	uParam0->f_588[1] = 0;
	uParam0->f_596[0] = 1;
	uParam0->f_596[1] = 1;
	uParam0->f_12.f_1 = -1124266369;
	uParam0->f_12.f_5 = 1;
	uParam0->f_12.f_8 = 597297690;
	return 1;
}
...
Vector3 func_160()
{
	return func_203("ATZ_INS_EXC_BE");
}
