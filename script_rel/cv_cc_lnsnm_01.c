...
int func_72(var uParam0)
{
	...
	uLocal_17 = func_152(uParam0, joaat("p_chair_crate15x"), 0.636307f, 1.3249f, -0.00391388f, 0, 1, 0, 1);
	uLocal_18 = func_152(uParam0, joaat("p_chair_barrel04b"), -0.584518f, -1.37169f, -0.000602722f, 0, 1, 0, 1);
	uLocal_19 = func_152(uParam0, joaat("p_chair_crate02x"), 1.42059f, -0.462698f, 0.000679016f, 0, 1, 0, 1);
...
void func_395(int iParam0, int iParam1)
{
	...
	switch (iParam0)
	{
		case 11:
			...
			{
				func_440(iParam1, joaat("weapon_revolver_cattleman_sadie"), 0, 0, 2, 1, 0, 1056964608, 1065353216, -1, 0, 0, 0, 0);
				func_440(iParam1, joaat("weapon_revolver_cattleman_sadie_dualwield"), 0, 0, 3, 1, 1, 1056964608, 1065353216, -1, 0, 1, 0, 0);
			}
			break;
	}
}
