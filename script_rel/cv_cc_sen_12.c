...
int func_73(var uParam0)
{
	...
	func_152(uParam0, 0.4f, -1.0625f, 1.15f, 6.81f, 3.48f, 2.08f, 2.685f, -1612834106, -1, 1, 1, 1);
	func_153(uParam0, 546935383, 0f, 0f, 0f, "KNIFE", 0, 1, 1);
	iLocal_17 = func_153(uParam0, -82199229, 0f, 0f, 0f, "MUG", 0, 0, 1);
	func_153(uParam0, -989609930, 0f, 0f, 0f, "STONE", 0, 1, 1);
	iLocal_16 = func_153(uParam0, 264425748, -0.585f, -1.372f, 0f, 0, 1, 0, 1);
	func_154(uParam0, "script@vignette@sean_12@base", 1, 1, 0, 0);
	func_154(uParam0, "script@vignette@sean_12@action", 0, 0, 1, 0);
	func_155(uParam0, "CSE12AU");
	func_156(uParam0, iLocal_14, 3, 188888616, "PROP_HUMAN_SEAT_CHAIR_KNIFE_BADASS_SHARPEN_MALE_B", iLocal_16, 0);
	func_157(uParam0, iLocal_14, 3, 188888616, "PROP_HUMAN_SEAT_CHAIR_KNIFE_BADASS_SHARPEN_MALE_B", iLocal_16, 0, 30f, 1065353216, 1);
	func_156(uParam0, iLocal_15, 3, -1489483851, "WORLD_HUMAN_COFFEE_DRINK_MALE_A", -1, 1);
	if (func_149(uParam0) == 1)
	{
		func_157(uParam0, iLocal_15, 4, -1858511014, 0, -1, 0, -1073741824, 1065353216, 1);
		func_158(uParam0, iLocal_15, 4, 0);
		func_159(uParam0, iLocal_15, iLocal_17, "p_mugCoffee01x_ph_r_hand", 0, 0);
	}
	iLocal_18 = func_160(uParam0, -0.0625f, -1.25f, 0f, 0f, 0f, 0f, 1.67f, 1.2775f, 6f, "GRIEF", -1612834106);
	return 1;
}
...
int func_144(var uParam0)
{
	...
	while (iVar0 < uParam0->f_106)
	{
		...
		else
		{
			...
			{
				if (func_123((uParam0->f_107[iVar0 /*113*/])->f_1, 29, 1) || func_241((uParam0->f_107[iVar0 /*113*/])->f_1))
				{
					return 1;
				}
				if (!uParam0->f_3)
...
void func_158(var uParam0, int iParam1, int iParam2, int iParam3)
{
	...
	{
		case 4:
			(uParam0->f_107[iParam1 /*113*/])->f_32.f_5 = { func_254(func_149(uParam0), func_253(uParam0, iParam1), func_20(uParam0), 1) };
			break;
		default:
			Var0 = { func_255(func_149(uParam0), func_253(uParam0, iParam1), func_20(uParam0), 1) };
...
int func_160(var uParam0, vector3 vParam1, vector3 vParam4, vector3 vParam7, char* sParam10, int iParam11)
{
	int iVar0;
	vector3 vVar1;
...
int func_190(var uParam0, int iParam1, bool bParam2)
{
	...
	if (uParam0->f_2270)
	{
		uParam0->f_2274 = 0;
		uParam0->f_2275 = 0;
		if ((func_113() && ANIMSCENE::_0x6F1F0B17109309DA(uParam0->f_2046, "ARTHUR")) || (func_282() && ANIMSCENE::_0x6F1F0B17109309DA(uParam0->f_2046, "JOHN")))
		{
			uParam0->f_2274 = 1;
		}
	}
		...
		else if (func_20(uParam0) == 355)
		{
			if (iVar3 == 5)
			{
				if (uParam0->f_3)
				{
					...
					else if (func_360(iVar3, func_100(uParam0->f_7), 1))
					{
					}
					else if (func_362(&uVar2, func_361(iVar3)))
					{
						...
						else
						{
							...
							if (bParam2)
							{
								...
								if (!func_363(iVar0, func_100(uParam0->f_7), 0, -1))
								{
									return -1;
								}
								return iVar0;
...
int func_331(int iParam0, bool bParam1)
{
	...
	{
		func_231(iParam0, _NAMESPACE48::_0x4F76E3676583D951(func_133(iParam0)));
		if (func_219() == -1)
		{
...
void func_387(int iParam0, bool bParam1, bool bParam2, bool bParam3)
{
	...
	if (bParam3)
	{
		func_421(func_105(iParam0), 1f, 0);
	}
	if (bParam1)
	{
		func_422(iParam0);
