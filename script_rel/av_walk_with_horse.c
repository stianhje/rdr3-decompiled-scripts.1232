...
{
	func_33(uParam0, 11430/*func_30*/, 11488/*func_31*/, 12098/*func_32*/);
}
	...
	switch (*uParam0)
	{
		case 30:
			...
			*(vLocal_41[0 /*3*/]) = { OBJECT::_GET_OBJECT_OFFSET_FROM_COORDS(vParam1, vParam4.z, -1.5f, 0f, 0f) };
			...
			uLocal_38[1] = func_49(997958153, 1);
...
void func_51(var uParam0, int iParam1, char* sParam2, var uParam3, vector3 vParam4, var uParam7, int iParam8, int iParam9, int iParam10, int iParam11, int iParam12, int iParam13)
{
