...
void func_23(int iParam0, int iParam1)
{
	...
	if (iVar4 > 0 && iVar4 < 15)
	{
		...
		while (iVar3 < iVar4)
		{
			...
			if (iParam1 && func_76(&(uVar5[iVar3]), -768110908, &iVar0))
			{
...
int func_40(int iParam0, bool bParam1, int iParam2, int iParam3)
{
	...
	{
		return func_90(bParam1, iParam2, iParam3);
	}
	if (Global_1572887->f_12 != -1)
	{
...
var func_42(var uParam0, char* sParam1, int iParam2, int iParam3, int iParam4, int iParam5, int iParam6, int iParam7)
{
	struct<7> Var0;
...
void func_52(var uParam0)
{
	...
	while (iVar0 < uParam0->f_618)
	{
			...
			if (ENTITY::DOES_ENTITY_EXIST((uParam0->f_31[iVar0 /*36*/])->f_1))
			{
				...
				if (((uParam0->f_31[iVar0 /*36*/])->f_13 && fVar8 < 2500f) && ENTITY::IS_ENTITY_ON_SCREEN((uParam0->f_31[iVar0 /*36*/])->f_1))
				{
					...
					if ((fVar8 < 6.25f && !func_112()) && !bVar6)
					{
						...
						{
							(uParam0->f_31[iVar0 /*36*/])->f_16 = func_113("INSPECT_GENERIC", -719620017, (uParam0->f_31[iVar0 /*36*/])->f_1, 2, 0, 0, 0, 5, 1070386381, 570, 4000, 10, 1073741824, 0, -820096546, 0, 0);
					...
					if (iVar7 && func_84((uParam0->f_31[iVar0 /*36*/])->f_16))
					{
						func_32(&((uParam0->f_31[iVar0 /*36*/])->f_16), 1, 1);
					}
				}
		...
		else if ((uParam0->f_31[iVar0 /*36*/])->f_15)
		{
			...
			{
				func_121(uParam0->f_12, func_109(&((uParam0->f_31[iVar0 /*36*/])->f_29)), 1, 0.762f, 1053609165, 0, 2f, 1);
...
var func_94(var uParam0, var uParam1)
{
...
int func_99(int iParam0, char* sParam1, bool bParam2, int iParam3, int iParam4, bool bParam5, float fParam6)
{
	...
	uVar6 = func_158(vVar0, vVar3.x, sParam1, bParam2, iParam3, iParam4, bParam5, fParam6);
	return uVar6;
}
...
void func_114(int iParam0, float fParam1, int iParam2)
{
	int iVar0;

	if (iParam2 && !func_84(iParam0))
	{
		return;
	}
	if (fParam1 <= 0f)
...
int func_132(int iParam0, int iParam1, var uParam2, var uParam3, bool bParam4, bool bParam5)
{
	struct<37> Var0;
	int iVar47;
	...
	*uParam3 = Var0.f_3;
	...
	if (bParam4)
	{
		func_190(iParam0, iParam1, uParam2, *uParam3);
	}
	return 1;
}
...
struct<4> func_135(int iParam0, var uParam1, var uParam2, var uParam3, var uParam4, int iParam5, bool bParam6)
{
	struct<4> Var0;
...
int func_158(vector3 vParam0, float fParam3, var uParam4, bool bParam5, int iParam6, int iParam7, bool bParam8, float fParam9)
{
	int iVar0;
	int iVar1;
	vector3 vVar2;
...
int func_231(int iParam0, bool bParam1)
{
	...
	if (WEAPON::_0xD955FEE4B87AFA07(iParam0))
	{
		if (bParam1)
		{
			return func_139(-1185145312, 0) > 0;
		}
		else
		{
			return 1;
...
int func_232(int iParam0, var uParam1, int iParam2)
{
	struct<5> Var0;
	int iVar5;
	struct<10> Var6;
...
int func_250(var uParam0, var uParam1, var uParam2, var uParam3, var uParam4, bool bParam5, bool bParam6)
{
