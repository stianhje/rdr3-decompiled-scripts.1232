...
int func_78(var uParam0)
{
	...
	uLocal_16 = func_158(uParam0, 1159859573, 3.388f, -3.688f, 0f, "CHAIR", 1, 0, 1);
	...
	func_163(uParam0, iLocal_14, 3, -787460071, "SC_PROP_CAMP_DUTCH_SEAT_CHAIR_READING_MALE_A", uLocal_16, 0);
	func_164(uParam0, iLocal_14, 3, -787460071, "SC_PROP_CAMP_DUTCH_SEAT_CHAIR_READING_MALE_A", uLocal_16, 0, -1073741824, 1065353216, 1);
...
void func_156(var uParam0, int iParam1, int iParam2, int iParam3, int iParam4)
{
	uParam0->f_23 = { func_261(iParam1) + Vector(iParam4, iParam3, iParam2) };
...
void func_163(var uParam0, int iParam1, int iParam2, int iParam3, char* sParam4, var uParam5, int iParam6)
{
...
void func_164(var uParam0, int iParam1, int iParam2, int iParam3, char* sParam4, var uParam5, int iParam6, float fParam7, int iParam8, int iParam9)
{
...
void func_315(var uParam0, int iParam1, bool bParam2, bool bParam3)
{
	...
	if (bParam3)
	{
		uVar0 = func_355(uParam0, iParam1);
	}
	if (bParam2)
	{
...
int func_341(int iParam0, bool bParam1)
{
	...
	{
		func_245(iParam0, _NAMESPACE48::_0x4F76E3676583D951(func_139(iParam0)));
		if (func_233() == -1)
		{
...
int func_390(var uParam0, int iParam1)
{
	...
	while (iVar2 <= iVar1)
	{
		...
		else
		{
			...
			vVar13 = { func_423(ENTITY::GET_ENTITY_COORDS((uParam0->f_107[iParam1 /*113*/])->f_5, true, false), vVar3, 1065353216) };
...
int func_397(int iParam0, bool bParam1, bool bParam2, var uParam3, var uParam4, var uParam5, float fParam6, bool bParam7, bool bParam8, bool bParam9, bool bParam10)
{
	...
	switch (((*Global_1360165)[iParam0 /*1157*/])->f_70.f_12)
	{
		case 0:
			...
			{
				if (!func_426(iParam0) && func_427(iParam0, &sVar4))
				{
		...
		case 1:
			if (!Global_1359489->f_12)
			{
				...
				if (!func_429(iParam0, vVar0, fParam6, bParam10))
				{
					return func_428();
				}
				if (func_127(((*Global_1360165)[iParam0 /*1157*/])->f_124, 0))
...
void func_408(int iParam0, vector3 vParam1, float fParam4, int iParam5, int iParam6)
{
	...
	if (func_237(iParam5, 2))
	{
		...
		{
			ENTITY::_0x203BEFFDBE12E96A(iParam0, vParam1, fParam4, 1, func_237(iParam5, 32), 1);
		}
		else
		{
			ENTITY::_0x203BEFFDBE12E96A(iParam0, vParam1, fParam4, 1, func_237(iParam5, 32), 1);
...
int func_429(int iParam0, vector3 vParam1, float fParam4, bool bParam5)
{
	int iVar0;
...
void func_431(int iParam0, int iParam1)
{
	...
	{
		PED::_0x931B241409216C1F(func_239(iParam1), iParam0, 0);
