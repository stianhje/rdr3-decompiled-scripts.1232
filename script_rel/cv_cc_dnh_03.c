...
int func_72(var uParam0)
{
	...
	func_151(uParam0, -1.45f, -0.5f, 0.45f, 0f, 4f, 4f, 3f, -1612834106, 2017216891, 1, 1, 1);
	func_151(uParam0, -4.9099f, 2.8865f, 0.9954f, -26.7944f, 1.5f, 1.5f, 3f, -1612834106, 1267380940, 1, 1, 1);
	func_152(uParam0, -2.575f, -1.3752f, 1.15f, 38.56f, 1f, 1f, 2.685f, 665633627, 1);
	iLocal_17 = func_153(uParam0, -437493635, 0f, 0f, 0f, "BOOK", 0, 0, 1);
	iLocal_16 = func_153(uParam0, joaat("p_pencil01x"), 0f, 0f, 0f, "PEN", 0, 0, 1);
	func_154(uParam0, "script@vignette@dutch_and_hosea_3@base", 1, 1, 0, 0);
	iLocal_18 = func_154(uParam0, "script@vignette@dutch_and_hosea_3@action_a", 2, 0, 1, 0);
	iLocal_19 = func_154(uParam0, "script@vignette@dutch_and_hosea_3@action_b", 0, 0, 0, 0);
	iLocal_20 = func_154(uParam0, "script@vignette@dutch_and_hosea_3@action_b_alt", 0, 0, 0, 1);
	func_155(uParam0, "CDH3AUD");
	func_156(uParam0, -318486908, 1809340185);
	func_157(uParam0, iLocal_14, 3, -192175547, "PROP_HUMAN_SEAT_CHAIR_SKETCHING_MALE_A", -1, 0, -1073741824, 1065353216, 1);
	...
	Local_21 = { func_161(uParam0, -3.8632f, -3.4077f, 0.8889f, -128.88f, 8f, 0.5f, 0.5f) };
	return 1;
}
...
int func_93(var uParam0)
{
	...
	{
		if (func_200(uParam0, Local_21, 1, 0))
		{
...
int func_191(var uParam0, int iParam1, bool bParam2)
{
	...
	if (bParam2)
	{
		...
		while (iVar1 < uParam0->f_1984)
		{
			...
			else if (func_292(uParam0, iVar1) || func_199(uParam0, iVar1))
			{
