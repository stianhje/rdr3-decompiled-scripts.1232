...
int func_72(var uParam0)
{
	...
	{
		case 8:
			func_149(uParam0, -1651.532f, -1364.943f, 82.957f, -0.412f, 0.03f, 152.954f);
			break;
		default:
			return 0;
	}
	...
	iLocal_20 = func_151(uParam0, 1096564642, 9.191689f, 38.85237f, 1.644012f, "Poop", 0, 0, 1);
	func_152(uParam0, 8.9325f, 38.97f, 0.2375f, 0f, 2f, 2f, 5f, -1612834106, -1, 1, 1, 1);
	func_153(uParam0, "script@vignette@beecher@charles_and_jack_1@base", 1, 1, 0, 0);
	iLocal_14 = func_153(uParam0, "script@vignette@beecher@charles_and_jack_1@action_a", 2, 0, 1, 0);
	iLocal_15 = func_153(uParam0, "script@vignette@beecher@charles_and_jack_1@action_b", 0, 0, 0, 0);
	iLocal_16 = func_153(uParam0, "script@vignette@beecher@charles_and_jack_1@ACTION_B_ALT_FRONT", 0, 0, 0, 1);
	iLocal_17 = func_153(uParam0, "script@vignette@beecher@charles_and_jack_1@ACTION_B_ALT_BACK", 0, 0, 0, 1);
	func_154(uParam0, -982551795, -1227104803);
	func_155(uParam0, iLocal_18, 1, -1);
	func_155(uParam0, iLocal_19, 1, -1);
	func_156(uParam0, "BCJA1AU");
	Local_21 = { func_157(uParam0, 8.405f, 38.97f, 1.7755f, 0f, 6f, 1f, 1f) };
	Local_31 = { func_157(uParam0, 8.405f, 38.97f, 1.7755f, -180f, 6f, 1f, 1f) };
	return 1;
}
...
int func_187(var uParam0, int iParam1, bool bParam2)
{
	...
	if (bParam2)
	{
		...
		while (iVar1 < uParam0->f_1984)
		{
			...
			else if (func_289(uParam0, iVar1) || func_195(uParam0, iVar1))
			{
...
void func_197(var uParam0, var uParam1, int iParam2, float fParam3)
{
	if (iParam2 == -1)
	{
		iParam2 = 0;
...
int func_383(int iParam0, bool bParam1, bool bParam2, var uParam3, var uParam4, var uParam5, float fParam6, bool bParam7, bool bParam8, bool bParam9, bool bParam10)
{
	...
	switch (((*Global_1360165)[iParam0 /*1157*/])->f_70.f_12)
	{
		...
		case 3:
			...
			sVar12 = func_418(iParam0, func_279());
