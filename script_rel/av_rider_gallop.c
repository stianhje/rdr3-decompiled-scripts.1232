...
{
	func_33(uParam0, 10740/*func_30*/, 10749/*func_31*/, 11147/*func_32*/);
}
...
void func_50(var uParam0, int iParam1, char* sParam2, var uParam3, vector3 vParam4, var uParam7, int iParam8, int iParam9, int iParam10, int iParam11, int iParam12, int iParam13)
{
...
void func_101(int iParam0, vector3 vParam1)
{
	...
	while (iVar0 < 10)
	{
		...
		{
			if (func_104((Global_32073.f_2697.f_1495[iVar0 /*4*/])->f_1, vParam1, 1056964608, 1))
			{
				return;
			}
		}
...
void func_121(int iParam0, int iParam1, int iParam2, int iParam3, int iParam4, int iParam5, bool bParam6, int iParam7)
{
	int iVar0;

	iVar0 = (((iParam2 + (60 * iParam3)) + (3600 * iParam4)) + (86400 * iParam5));
	if (func_130(iParam0) == 1 && iParam7)
	{
		return;
	}
	if (bParam6)
