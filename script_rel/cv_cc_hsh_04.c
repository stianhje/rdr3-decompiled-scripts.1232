...
int func_72(var uParam0)
{
	...
	func_151(uParam0, 1.4627f, -0.0848f, 0.5257f, 0f, 1.5f, 1.5f, 3f, -1612834106, -1, 1, 1, 1);
	func_152(uParam0, "script@vignette@hosea_4@base", 1, 1, 0, 0);
	uLocal_25 = func_152(uParam0, "script@vignette@hosea_4@action", 0, 0, 1, 1);
	func_153(uParam0, "CHS4AUD");
	func_154(uParam0, iLocal_14, 2, -38747227, "PROP_CAMP_FIRE_SEATED_MALE_F", -1, 0);
	func_155(uParam0, iLocal_14, 3, -38747227, "PROP_CAMP_FIRE_SEATED_MALE_F", -1, 0, 45f, 1065353216, 1);
	...
	func_159(uParam0, 716487658, -599575341);
	Local_15 = { func_160(uParam0, 1.4627f, -1.28f, 0.5257f, 5.5384f, 7f, 0.8f, 0.8f) };
	func_161(uParam0, 1);
	func_162(uParam0, uLocal_25, -1, 0.68f);
...
{
	return func_194(uParam0, Local_15, 1, 0);
}
...
void func_156(var uParam0, int iParam1, char* sParam2)
{
	if (!MISC::IS_STRING_NULL_OR_EMPTY(sParam2))
	{
