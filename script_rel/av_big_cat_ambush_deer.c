...
{
	func_33(uParam0, 10881/*func_30*/, 10960/*func_31*/, 11991/*func_32*/);
}
...
{
	func_46(uParam0, "BIG_CAT_AMBUSH_DEER", "script@ambient@animal@BIG_CAT_AMBUSH_DEER@action", vParam1, vParam4);
	uParam0->f_16 = 1;
	func_47(uParam0, 1, "pbl_action", "", 0);
	func_48(uParam0, 0, "COUGAR", iLocal_9, 0f, 0f, 0f, 0f, 1, 1, 1, 1, 41788943, 0);
...
{
	if (!STREAMING::_0x9427C94D2E4094A4(-963073294, 0))
	{
		return 0;
	}
	return 1;
...
{
	STREAMING::_0x19A6BE7D9C6884D3(-963073294, 1, 0, 0);
	func_57(&uLocal_23, 0);
	func_58(&uLocal_23, 1);
	func_59(&uLocal_23, 1);
	func_60(&uLocal_23, 1);
...
int func_31(var uParam0)
{
	...
	if (!&uParam0->f_469[0])
	{
		if (!bLocal_51 == 1)
		{
			if ((func_65(uParam0, &uLocal_23, 1) || func_66(Global_35, &(uParam0->f_20[0 /*14*/]), 1) <= 400f) || func_66(Global_35, &(uParam0->f_20[1 /*14*/]), 1) <= 400f)
			{
				bLocal_51 = true;
			}
		}
	...
	if (!&uParam0->f_469[0] && !bLocal_51)
	{
					...
					if (ANIMSCENE::_0x25557E324489393C(uParam0->f_3.f_1))
					{
						if (ANIMSCENE::_0x477122B8D05E7968(uParam0->f_3.f_1, 1, 0))
						{
							if (ANIMSCENE::_0x1F0E401031E20146(uParam0->f_3.f_1, "pbl_action"))
							{
								...
								if (ANIMSCENE::_GET_ANIM_SCENE_ENTITY_MATRIX(uParam0->f_3.f_1, (uParam0->f_20[0 /*14*/])->f_1, &Local_11, true, "pbl_action", 2))
								{
									func_75(&(Local_11.f_6), 50, 10, 0);
								}
								uParam0->f_469[1] = 1;
								uParam0->f_469[2] = 1;
								return 0;
		...
		if (&uParam0->f_469[2])
		{
			if (!&uParam0->f_469[5])
			{
				if (func_76(uParam0, 1.5f, 80f, 4, -91962372, 1))
				{
					func_70(*uParam0, uParam0->f_483, 1);
					uParam0->f_469[5] = 1;
				}
					...
					if (ANIMSCENE::_0x477122B8D05E7968(uParam0->f_3.f_1, 1, 0))
					{
						if (ANIMSCENE::_0x1F0E401031E20146(uParam0->f_3.f_1, "pbl_action"))
						{
							if (ANIMSCENE::_0x005E6F28DD7ED58D(uParam0->f_3.f_1, (uParam0->f_20[0 /*14*/])->f_1))
							{
								...
								func_56(uParam0->f_20[0 /*14*/], 1, 1);
								uVar0[0] = Global_35;
								PED::_0x34EDDD59364AD74A(&(uParam0->f_20[0 /*14*/]), &uVar0);
								PED::_0xA3A9299C4F2ADB98(&(uParam0->f_20[0 /*14*/]));
								TASK::TASK_START_SCENARIO_AT_POSITION(&(uParam0->f_20[0 /*14*/]), -963073294, Local_11.f_6, Local_11.f_9.f_2, 0, 0, 1, 0, -1082130432, 0);
			...
			else if (!&uParam0->f_469[4])
			{
				...
				{
					if (PED::_0x34D6AC1157C8226C(&(uParam0->f_20[0 /*14*/]), -963073294))
					{
						if (!TASK::_0x0C3CB2E600C8977D(&(uParam0->f_20[0 /*14*/]), 0) && !func_79(&uLocal_58))
						{
...
float func_66(int iParam0, int iParam1, bool bParam2)
{
	...
	return func_109(ENTITY::GET_ENTITY_COORDS(iParam0, false, false), ENTITY::GET_ENTITY_COORDS(iParam1, false, false));
}
...
void func_71(var uParam0)
{
	...
	if (!ENTITY::IS_ENTITY_DEAD(&(uParam0->f_20[0 /*14*/])))
	{
		if (!func_116(&(uParam0->f_20[0 /*14*/]), 1287254818))
		{
			...
			if (func_66(&(uParam0->f_20[0 /*14*/]), Global_35, 1) < 900f)
			{
				TASK::TASK_COMBAT_PED(&(uParam0->f_20[0 /*14*/]), Global_35, 0, 0);
			}
			else
			{
				TASK::_TASK_SMART_FLEE_STYLE_PED(&(uParam0->f_20[0 /*14*/]), Global_35, 2, 256, -1082130432, -1, 0);
			}
			PED::SET_PED_KEEP_TASK(&(uParam0->f_20[0 /*14*/]), true);
		}
	}
...
int func_74(var uParam0, float fParam1, float fParam2, int iParam3, float fParam4, float fParam5)
{
	...
	if ((MISC::GET_FRAME_COUNT() % 8) == 0)
	{
		...
		fVar7 = func_120(Global_36, uParam0->f_483);
...
int func_85(vector3 vParam0, float fParam3)
{
	...
	while (iVar0 < 4)
	{
		...
		{
			if (func_127(vParam0, (Global_1415419->f_9721[iVar0 /*8*/])->f_4, fParam3, 0))
			{
				return 1;
			}
		}
...
int func_86(vector3 vParam0)
{
	...
	while (iVar0 < 10)
	{
		...
		{
			if (func_127(vParam0, (Global_32073.f_2697.f_1495[iVar0 /*4*/])->f_1, 1f, 0))
			{
				return 1;
			}
		}
...
{
	return (BUILTIN::SHIFT_RIGHT(iParam0, 26) & 31 * func_128(MISC::IS_BIT_SET(iParam0, 31), -1, 1)) + 1898;
}
...
{
	func_129(uParam0, iParam6);
	func_130(uParam0, iParam5);
	func_131(uParam0, iParam4);
	func_132(uParam0, iParam3);
...
int func_108(int iParam0, int iParam1, var uParam2, var uParam3, int iParam4, float fParam5)
{
	...
	if (!Global_1935630->f_12 && !ENTITY::IS_ENTITY_DEAD(iParam0))
	{
		...
		if (!uParam2->f_1 & 128 != 0)
		{
			...
			{
				*uParam3 = 128;
				func_144(iParam0, uParam2, *uParam3);
				return 1;
			}
		}
		if (Global_1935630->f_27)
		{
			if (!uParam2->f_1 & 8 != 0)
			{
				...
				else if (func_146(iParam0, iParam1, uParam2))
				{
					*uParam3 = 8;
					func_144(iParam0, uParam2, *uParam3);
					return 1;
		...
		if (Global_1935630->f_26 && func_148(PLAYER::PLAYER_ID(), 0, 1, uParam2->f_1 & 524288 == 0))
		{
		...
		{
			if (func_149(uParam2, 1065353216))
			{
				if (!uParam2->f_1 & 4 != 0)
				{
				...
				{
					if (func_151(Global_35, iParam0, uParam2))
					{
						*uParam3 = 256;
						func_144(iParam0, uParam2, *uParam3);
						return 1;
		...
		if (!uParam2->f_1 & 16 != 0)
		{
			...
			{
				if (func_152(Global_35, iParam0, uParam2, 0))
				{
					*uParam3 = 16;
					func_144(iParam0, uParam2, *uParam3);
					return 1;
			...
			else if (func_152(Global_35, iParam0, uParam2, 1))
			{
				*uParam3 = 16;
				func_144(iParam0, uParam2, *uParam3);
				return 1;
		...
		if (Global_1935630->f_30 || Global_1935630->f_31)
		{
			if (!uParam2->f_1 & 2 != 0)
			{
				...
				{
					if ((func_156(iParam0, Global_1935630->f_41, *uParam2 & 128 != 0, 0, *uParam2 & 256 != 0) && func_157(uParam2, iParam0)) && func_158(uParam2, iParam0))
					{
						*uParam3 = 2;
						func_144(iParam0, uParam2, *uParam3);
						return 1;
		...
		if (!uParam2->f_1 & 2 != 0)
		{
			if (uParam2->f_12 < 4f)
			{
				if ((func_156(iParam0, Global_1935630->f_41, *uParam2 & 128 != 0, 1, *uParam2 & 256 != 0) && func_157(uParam2, iParam0)) && func_158(uParam2, iParam0))
				{
					*uParam3 = 2;
					func_144(iParam0, uParam2, *uParam3);
					return 1;
				...
				if (Global_1935630->f_40 == 0)
				{
					if (Global_1935630->f_41 != 0)
					{
						if (*uParam2 & 131072 == 0)
						{
							if (func_159(iParam0, Global_1935630->f_41))
							{
								func_160();
								*uParam3 = 2;
								func_144(iParam0, uParam2, *uParam3);
			...
			if (uParam2->f_12 < 10f)
			{
				if (func_161(uParam2, iParam0) || (uParam2->f_9 > 0 && (func_162() - uParam2->f_9) < 2000))
				{
			...
			if (Global_1935630->f_42 != 0)
			{
				if (*uParam2 & 131072 == 0)
				{
					if (func_163())
					{
						if (func_159(iParam0, Global_1935630->f_42))
						{
							func_160();
							*uParam3 = 2;
							func_144(iParam0, uParam2, *uParam3);
		...
		if (uParam2->f_12 < uParam2->f_26)
		{
			...
			{
				if (func_165(iParam0, iParam1, uParam2))
				{
					*uParam3 = 2048;
					func_144(iParam0, uParam2, *uParam3);
					return 1;
...
void func_114(int iParam0, vector3 vParam1)
{
	int iVar0;
	int iVar1;
	...
	while (iVar0 < 10)
	{
		...
		{
			if (func_127((Global_32073.f_2697.f_1495[iVar0 /*4*/])->f_1, vParam1, 1056964608, 1))
			{
				return;
			}
		}
...
float func_120(vector3 vParam0, vector3 vParam3)
{
	vParam0.f_2 = 0f;
	vParam3.f_2 = 0f;
...
bool func_123(vector3 vParam0, vector3 vParam3)
{
...
int func_127(vector3 vParam0, vector3 vParam3, float fParam6, bool bParam7)
{
	if (fParam6 < 0f)
	{
		fParam6 = 0f;
...
int func_128(bool bParam0, int iParam1, int iParam2)
{
	if (bParam0)
	{
		return iParam1;
...
void func_142(var uParam0, bool bParam1, int iParam2)
{
	func_178(iParam2);
	if (Global_1572887->f_12 == -1)
	{
	...
	if (!uParam0->f_1 & 1024 != 0)
	{
		if (!ENTITY::DOES_ENTITY_EXIST(uParam0->f_14))
		{
			if (func_181(uParam0))
			{
				uParam0->f_15 = func_162();
			}
		}
		else if (uParam0->f_15 > 0)
		{
			if ((func_162() - uParam0->f_15) > 500)
			{
...
int func_151(var uParam0, int iParam1, var uParam2)
{
	var uVar0;
...
int func_152(var uParam0, int iParam1, var uParam2, bool bParam3)
{
	vector3 vVar0;
	int iVar3;
	vector3 vVar4;
...
int func_156(int iParam0, int iParam1, bool bParam2, bool bParam3, bool bParam4)
{
	int iVar0;
	int iVar1;
	int iVar2;
...
int func_170(int iParam0, var uParam1)
{
	...
	if (uParam1->f_4 == 0)
	{
		uParam1->f_4 = func_162();
	}
	else if (func_162() - uParam1->f_4) > func_216(uParam1)
	{
