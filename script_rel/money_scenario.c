...
{
	if (TASK::_0x6718F40313A2B5A6(iLocal_3) == 0f)
	{
		return;
	}
...
int func_15(int iParam0, bool bParam1, float fParam2, int iParam3, char* sParam4, int iParam5, bool bParam6, int iParam7)
{
	...
	func_18(iVar0, bParam1, fParam2, iParam3, iVar1);
	return iVar0;
}
...
int func_16(int iParam0, var uParam1, int iParam2)
{
	...
	while (iVar24 < Var1)
	{
		...
		else
		{
			...
			if (func_20(iVar25, 0) && func_21(iVar25, -1921346699))
			{
				return BUILTIN::CEIL((IntToFloat(&Var1.f_12[iVar24]) * fVar0));
			}
		}
...
void func_17(int iParam0, char* sParam1, var uParam2)
{
	if (iParam0 == 0)
	{
		return;
...
void func_18(int iParam0, bool bParam1, float fParam2, int iParam3, int iParam4)
{
	int iVar0;
	int iVar1;
	int iVar2;
...
bool func_19(int iParam0, int iParam1, bool bParam2)
{
	...
	return func_30(iParam0, 0, bParam2) >= iParam1;
}
...
var func_22(char* sParam0, char* sParam1, int iParam2, int iParam3, int iParam4, int iParam5, int iParam6, int iParam7, int iParam8)
{
	...
	func_31(sParam0, sParam1, iParam2);
	return uVar20;
}
...
int func_29(int iParam0, int iParam1)
{
	...
	Var4.f_9 = -1591664384;
	if (func_35("ALL WEAPONS", &iVar1, &iVar2, -1591664384, 0))
	{
		iVar3 = 0;
		while (iVar3 < iVar2)
		{
			if (!func_36(&Var4, iVar3, iVar1, iVar2))
			{
			}
			else if (!func_37(Var4.f_4))
			{
			}
...
int func_30(int iParam0, int iParam1, bool bParam2)
{
	...
	iVar2 = INVENTORY::_0xE787F05DFC977BDE(func_40(bParam2), iParam0, 0);
	return iVar2;
}

void func_31(char* sParam0, char* sParam1, int iParam2)
{
...
int func_34(int iParam0, int iParam1)
{
	...
	{
		func_41(iParam0, &uVar1, &uVar2);
		return uVar2;
	}
	return 0;
}

int func_35(char* sParam0, var uParam1, var uParam2, int iParam3, bool bParam4)
{
	*uParam1 = INVENTORY::_0x80D78BDC9D88EF07(func_40(bParam4), sParam0, iParam3, uParam2);
	if (*uParam1 >= 0)
	{
		return 1;
	}
...
int func_39(int iParam0, bool bParam1)
{
	...
	Var0 = { func_42(iParam0, -1591664384, -1591664384, -1591664384, 0, 0) };
	if (bParam1)
	{
		func_44(&Var0, func_43(0));
	}
	if (!func_45(&Var0, &iVar14, &uVar15, 0))
	{
		return 0;
	}
	func_38(iVar14);
...
struct<4> func_43(bool bParam0)
{
	...
	if (iVar0 == 2)
	{
		...
		{
			*Global_1224214 = { func_48(923904168, func_47(bParam0), -740156546, bParam0) };
		}
	...
	else if (iVar0 == 3)
	{
		...
		{
			*Global_1224222 = { func_48(923904168, func_47(bParam0), -740156546, 0) };
		}
		return *Global_1224222;
	}
	return func_48(923904168, func_47(bParam0), -740156546, 0);
}

void func_44(var uParam0, struct<4> Param1)
{
...
int func_45(var uParam0, var uParam1, var uParam2, bool bParam3)
{
	*uParam1 = INVENTORY::_0x640F890C3E5A3FFD(func_40(bParam3), uParam0, uParam2);
	if (*uParam1 >= 0)
	{
		return 1;
	}
...
{
	return func_48(1328661203, func_49(), -1591664384, bParam0);
}
...
struct<4> func_48(int iParam0, var uParam1, var uParam2, var uParam3, var uParam4, int iParam5, bool bParam6)
{
	...
	INVENTORY::_0x886DFD3E185C8A89(func_40(bParam6), &uParam1, iParam0, iParam5, &Var0);
	return Var0;
}
