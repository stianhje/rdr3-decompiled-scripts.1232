...
int func_72(var uParam0)
{
	...
	func_154(uParam0, 531516298, 0f, 0f, 0f, "BILLS", 0, 1, 1);
	iLocal_19 = func_154(uParam0, -160658674, 0f, 0f, 0f, "CASE", 1, 0, 1);
	func_154(uParam0, -82199229, 0f, 0f, 0f, "MUG", 0, 1, 1);
	func_154(uParam0, -1971689092, 0f, 0f, 0f, "BOTTLE1", 0, 1, 1);
	...
	iLocal_17 = func_154(uParam0, 264425748, vVar9, 0, 1, 0, 1);
	iLocal_18 = func_154(uParam0, 1230724566, vVar6, 0, 1, 0, 1);
...
void func_415(int iParam0, int iParam1)
{
	...
	switch (iParam0)
	{
		case 11:
			...
			{
				func_456(iParam1, 1240907314, 0, 0, 2, 1, 0, 1056964608, 1065353216, -1, 0, 0, 0, 0);
				func_456(iParam1, -2088446466, 0, 0, 3, 1, 1, 1056964608, 1065353216, -1, 0, 1, 0, 0);
			}
			break;
	}
}
