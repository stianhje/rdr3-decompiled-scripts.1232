...
int func_73(var uParam0)
{
	...
	uLocal_16 = func_155(uParam0, "script@vignette@marybeth_2@action_a_left", 2, 0, 0, 1);
	uLocal_17 = func_155(uParam0, "script@vignette@marybeth_2@action_a_right", 2, 0, 0, 1);
	...
	while (iVar12 < uParam0->f_106)
	{
		...
		else
		{
			if (!STREAMING::IS_MODEL_VALID((uParam0->f_107[iVar12 /*113*/])->f_3))
			{
				...
				{
					(uParam0->f_107[iVar12 /*113*/])->f_3 = _NAMESPACE48::_0xA00DF706C60173D1(func_286((uParam0->f_107[iVar12 /*113*/])->f_1));
				}
...
void func_212(var uParam0, var uParam1, int iParam2, float fParam3)
{
	if (iParam2 == -1)
	{
		iParam2 = 0;
...
int func_272(int iParam0, int iParam1, bool bParam2, int iParam3, int iParam4, bool bParam5, float fParam6)
{
	vector3 vVar0;
	vector3 vVar3;
	var uVar6;
...
void func_319(var uParam0, int iParam1, bool bParam2, bool bParam3)
{
	...
	if (bParam3)
	{
		uVar0 = func_360(uParam0, iParam1);
	}
	if (bParam2)
	{
...
int func_347(int iParam0, bool bParam1)
{
	...
	{
		func_247(iParam0, _NAMESPACE48::_0x4F76E3676583D951(func_133(iParam0)));
		if (func_235() == -1)
		{
