...
{
	func_33(uParam0, 11287/*func_30*/, 11345/*func_31*/, 11808/*func_32*/);
}
	...
	switch (iLocal_10)
	{
		case 0:
			if (!ENTITY::IS_ENTITY_DEAD(&(uParam0->f_20[iLocal_42 /*14*/])))
			{
				...
				TASK::TASK_START_SCENARIO_AT_POSITION(&(uParam0->f_20[iLocal_42 /*14*/]), -830507952, (uParam0->f_20[iLocal_42 /*14*/])->f_5, (uParam0->f_20[iLocal_42 /*14*/])->f_8, 0, 0, 1, 0, -1082130432, 0);
			}
			iLocal_42++;
			if (iLocal_42 >= 12)
			{
		...
		case 2:
			if (func_65(uParam0, uParam0->f_493, uParam0->f_494, 4, uParam0->f_495, 1112014848))
			{
				...
				while (iVar1 <= 11)
				{
					...
					{
						func_66(&(uParam0->f_20[iVar1 /*14*/]), ENTITY::GET_OFFSET_FROM_ENTITY_IN_WORLD_COORDS(&(uParam0->f_20[iVar1 /*14*/]), 0f, 0f, 4.5f), uParam0->f_486.f_2, 32, 1073741824);
...
void func_159(int iParam0, vector3 vParam1)
{
	...
	while (iVar0 < 10)
	{
		...
		{
			if (func_113((Global_32073.f_2697.f_1495[iVar0 /*4*/])->f_1, vParam1, 1056964608, 1))
			{
				return;
			}
		}
