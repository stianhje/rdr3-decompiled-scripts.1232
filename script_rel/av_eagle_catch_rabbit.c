...
{
	func_33(uParam0, 10737/*func_30*/, 10782/*func_31*/, 12072/*func_32*/);
}
...
{
	func_46(uParam0, "EAGLE_CATCH_RABBIT", "script@ambient@animal@EAGLE_CATCH_RABBIT@action", vParam1, vParam4);
	uParam0->f_16 = 1;
	func_47(uParam0, 1, "pbl_action", "", 0);
	func_48(uParam0, 0, "EAGLE", iLocal_9, 0f, 0f, 0f, 0f, 1, 1, 1, 1, 41788943, 1);
	func_48(uParam0, 1, "RABBIT", iLocal_10, 0f, 0f, 0f, 0f, 1, 1, 1, 1, 41788943, 1);
}
...
int func_31(var uParam0)
{
	...
	sVar0 = "script_amb@animal@EAGLE_CATCH_RABBIT";
	sVar1 = "eagle_exit_a";
	sVar2 = "rabbit_exit_a";
	vVar3 = { 0f, 0f, 0f };
	vVar6 = { 0f, 0f, 0f };
	...
	if (!iLocal_40)
	{
		...
		{
			func_61(uParam0->f_20[0 /*14*/], 1, 1);
			func_61(uParam0->f_20[1 /*14*/], 1, 1);
			iLocal_40 = 1;
		}
	}
	else if (!ENTITY::HAS_ANIM_EVENT_FIRED(&(uParam0->f_20[0 /*14*/]), 725039534))
	{
		func_61(uParam0->f_20[0 /*14*/], 0, 1);
	...
	if (!&uParam0->f_469[0])
	{
		...
		if (!bLocal_39 == 1)
		{
			if (((func_62(uParam0, &uLocal_11, 0) || func_63(&(uParam0->f_20[0 /*14*/]), Global_35, 1) < 225f) || func_63(&(uParam0->f_20[1 /*14*/]), Global_35, 1) < 225f) || MISC::HAS_BULLET_IMPACTED_IN_AREA(ENTITY::GET_ENTITY_COORDS(&(uParam0->f_20[1 /*14*/]), true, false), 2f, true, true))
			{
				bLocal_39 = true;
			}
		}
	...
	if (!&uParam0->f_469[0] && !bLocal_39)
	{
		...
		if (&uParam0->f_469[2])
		{
			if (!&uParam0->f_469[6])
			{
				if (func_72(uParam0, 1065353216, 100f, 4, -91962372, 1))
				{
					func_67(*uParam0, uParam0->f_483, 1);
					uParam0->f_469[6] = 1;
				}
							...
							if (!ENTITY::IS_ENTITY_DEAD(&(uParam0->f_20[0 /*14*/])))
							{
								if (ANIMSCENE::_0x005E6F28DD7ED58D(uParam0->f_3.f_1, (uParam0->f_20[0 /*14*/])->f_1))
								{
									if (ENTITY::DOES_ENTITY_EXIST(&(uParam0->f_20[1 /*14*/])))
									{
										...
										TASK::TASK_PLAY_ANIM(&(uParam0->f_20[0 /*14*/]), sVar0, sVar1, 8f, -1056964608, -1, 65553, 0, 0, 0, 0, "LegsOnlyBird_filter", 0);
										PED::SET_PED_CAN_BE_TARGETTED(&(uParam0->f_20[1 /*14*/]), false);
										ENTITY::ATTACH_ENTITY_TO_ENTITY(&(uParam0->f_20[1 /*14*/]), &(uParam0->f_20[0 /*14*/]), PED::GET_PED_BONE_INDEX(&(uParam0->f_20[0 /*14*/]), 38142), vVar3, vVar6, 0, 0, 0, 0, 2, 1, 1, 0);
										uParam0->f_469[4] = 1;
										return 1;
									}
								}
...
int func_32(var uParam0, bool bParam1)
{
	...
	if (!bParam1)
	{
		...
		while (iVar2 < uParam0->f_19)
		{
			...
			{
				if ((uParam0->f_469[4] && !&uParam0->f_469[5]) && func_63(&(uParam0->f_20[iVar2 /*14*/]), Global_35, 1) < 22500f)
				{
					return 0;
				}
			}
...
void func_61(var uParam0, bool bParam1, int iParam2)
{
...
void func_69(var uParam0)
{
	...
	{
		iVar1 = -1115154469;
		if (ENTITY::HAS_ANIM_EVENT_FIRED(&(uParam0->f_20[1 /*14*/]), -1401953231))
		{
	...
	if ((MISC::GET_FRAME_COUNT() % 8) == 0)
	{
		...
		while (iVar0 < uParam0->f_19)
		{
			...
			if (!ENTITY::IS_ENTITY_DEAD(&(uParam0->f_20[iVar0 /*14*/])))
			{
				...
				fVar8 = func_63(Global_35, &(uParam0->f_20[iVar0 /*14*/]), 1);
				if (fVar8 < fVar1)
				{
					return 1;
				}
		...
		while (iVar0 < uParam0->f_19)
		{
			...
			else
			{
				if (!ENTITY::IS_ENTITY_DEAD(&(uParam0->f_20[iVar0 /*14*/])))
				{
					...
					{
						if ((func_63(Global_35, &(uParam0->f_20[iVar0 /*14*/]), 1) < fParam2 && PED::_0x5102307CE88798EB(&(uParam0->f_20[iVar0 /*14*/]))) && PED::IS_TRACKED_PED_VISIBLE(&(uParam0->f_20[iVar0 /*14*/])))
						{
							if (!func_64(&(uParam0->f_490)))
							{
