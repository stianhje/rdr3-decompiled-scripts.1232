...
{
	func_33(uParam0, 10947/*func_30*/, 11013/*func_31*/, 11772/*func_32*/);
}
...
void func_14(var uParam0, vector3 vParam1, vector3 vParam4)
{
	...
	func_46(uParam0, "RAMS_HEADBUTT", "script@ambient@animal@RAMS_HEADBUTT@action", vParam1, vParam4);
	iVar0 = func_47();
	if (iVar0 == 12 || iVar0 == 1)
	{
		iLocal_10 = -163914005;
	}
	else if ((iVar0 == 13 || iVar0 == 14) || iVar0 == 15)
	{
		iLocal_10 = -2116663991;
	}
	else
	{
		iLocal_10 = -1151440774;
	}
	uParam0->f_16 = 1;
...
int func_31(var uParam0)
{
	...
	if (!&uParam0->f_469[0])
	{
		if (!bLocal_39)
		{
			if ((func_66(uParam0, &uLocal_11, 1) || func_67(Global_35, &(uParam0->f_20[0 /*14*/]), 1) <= 400f) || func_67(Global_35, &(uParam0->f_20[1 /*14*/]), 1) <= 400f)
			{
				bLocal_39 = true;
			}
		}
	...
	if (!&uParam0->f_469[0] && !bLocal_39)
	{
		...
		if (&uParam0->f_469[2])
		{
			if (!&uParam0->f_469[4])
			{
				if (func_75(uParam0, 1065353216, 1116471296, 4, -91962372, 1))
				{
					func_71(*uParam0, uParam0->f_483, 1);
					uParam0->f_469[4] = 1;
				}
...
void func_48(var uParam0, int iParam1, char* sParam2, char* sParam3, int iParam4)
{
	...
	if ((MISC::GET_FRAME_COUNT() % 8) == 0)
	{
		...
		while (iVar0 < uParam0->f_19)
		{
			...
			if (!ENTITY::IS_ENTITY_DEAD(&(uParam0->f_20[iVar0 /*14*/])))
			{
				...
				fVar8 = func_67(Global_35, &(uParam0->f_20[iVar0 /*14*/]), 1);
				if (fVar8 < fVar1)
				{
					return 1;
				}
		...
		while (iVar0 < uParam0->f_19)
		{
			...
			else
			{
				if (!ENTITY::IS_ENTITY_DEAD(&(uParam0->f_20[iVar0 /*14*/])))
				{
					...
					{
						if ((func_67(Global_35, &(uParam0->f_20[iVar0 /*14*/]), 1) < fParam2 && PED::_0x5102307CE88798EB(&(uParam0->f_20[iVar0 /*14*/]))) && PED::IS_TRACKED_PED_VISIBLE(&(uParam0->f_20[iVar0 /*14*/])))
						{
							if (!func_68(&(uParam0->f_490)))
							{
