...
int func_72(var uParam0)
{
	...
	func_150(uParam0, -1.5312f, -2.9055f, 0f, 0f, 2f, 2f, 5f, -1612834106, -1, 1, 1, 1);
	iLocal_15 = func_151(uParam0, -946807796, 0f, 0f, 0f, "BOOK", 0, 0, 1);
	iLocal_16 = func_151(uParam0, 531527393, 0.821093f, -0.152114f, 0.244499f, 0, 1, 0, 1);
	func_152(uParam0, iLocal_14, 3, 2087366558, "WORLD_HUMAN_STAND_WAITING_MALE_B", -1, 1);
	func_153(uParam0, 350798315, -502379432);
	func_154(uParam0, iLocal_14, 2, 2087366558, "WORLD_HUMAN_STAND_WAITING_MALE_B", -1, 1, -1073741824, 1065353216, 1);
	func_154(uParam0, iLocal_14, 3, -787460071, "SC_PROP_CAMP_DUTCH_SEAT_CHAIR_READING_MALE_A", iLocal_16, 0, -1073741824, 1065353216, 1);
	func_155(uParam0, iLocal_14, iLocal_15, "p_cs_bookEvelynMiller_PH_R_HAND", 0, 0);
	func_156(uParam0, iLocal_14, 1, -1);
	func_157(uParam0, "script@vignette@dutch_speech_beaver_1@base_intro", 1, 1, 0, 0);
	uLocal_17 = func_157(uParam0, "script@vignette@dutch_speech_beaver_1@action", 0, 0, 1, 0);
	func_158(uParam0, "CDSB1AU");
	func_159(uParam0, uLocal_17, -1, 0.91f);
	return 1;
}
