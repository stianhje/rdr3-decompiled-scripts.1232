...
int func_72(var uParam0)
{
	...
	{
		func_155(uParam0, 1.9376f, -0.875f, 1.4875f, 0f, 2.1625f, 2.2275f, 3.2075f, -1612834106, -1, 1, 1, 1);
	}
	iLocal_17 = func_156(uParam0, 1843407141, 0f, 0f, 0f, "p_bottlebeer01x", 0, 0, 1);
	iLocal_18 = func_156(uParam0, -1971689092, 0f, 0f, 0f, "p_bottleJD01x", 0, 0, 1);
	if (!func_152(14))
	{
		func_157(uParam0, "script@vignette@sean_karen_par_1@base", 1, 1, 0, 0);
	}
	uLocal_16 = func_157(uParam0, "script@vignette@sean_karen_par_1@Action", 0, 0, 1, 0);
	func_158(uParam0, "CSKP1AU");
	func_159(uParam0, 1931616895, 1176816020);
	func_160(uParam0, uLocal_16, -1, 0.87f);
	if (!func_152(14))
	{
		func_161(uParam0, iLocal_14, 3, -719188272, "WORLD_HUMAN_LEAN_WALL_LEFT_DRINKING_MALE_A", -1, 1);
	}
	func_162(uParam0, iLocal_14, 2, -1043454001, "WORLD_HUMAN_SIT_GROUND_TIRED_MALE_A", -1, 1, -1073741824, 1065353216, 1);
	func_163(uParam0, iLocal_14, 1, -1);
	func_164(uParam0, iLocal_14, 4, 1, 0, 0, 0);
	if (!func_152(14))
	{
		func_161(uParam0, iLocal_15, 3, 920968891, "WORLD_HUMAN_LEAN_WALL_DRINKING_FEMALE_B", -1, 1);
	}
	...
	if (func_152(14))
	{
		...
		func_161(uParam0, iLocal_14, 4, -719188272, "WORLD_HUMAN_LEAN_WALL_LEFT_DRINKING_MALE_A", -1, 0);
		func_166(uParam0, iLocal_14, -106.644f, -38.557f, 94.864f, 47.39f, 0, 0);
		func_167(uParam0, iLocal_14, 1);
		func_168(uParam0, iLocal_14, -1f);
		func_165(uParam0, iLocal_15, iLocal_18, "p_bottleJD01x_ph_r_hand");
		func_161(uParam0, iLocal_15, 4, 920968891, "WORLD_HUMAN_LEAN_WALL_DRINKING_FEMALE_B", -1, 0);
		func_166(uParam0, iLocal_15, -107.4155f, -38.3862f, 94.877f, -13.43f, 0, 0);
...
int func_85(var uParam0)
{
	...
	if (!uParam0->f_4)
	{
		...
		while (iVar0 < uParam0->f_106)
		{
			...
			else if (func_185(uParam0, iVar0))
			{
			}
	...
	{
		func_200(uParam0);
		func_201(uParam0, uParam0->f_2047, 1);
	}
...
int func_91(var uParam0)
{
	...
	if (!uParam0->f_2265)
	{
		func_203(uParam0->f_2, 1);
	}
	iVar0 = func_204(func_19(uParam0));
	func_205(iVar0);
	...
	if (uParam0->f_2048 >= 0)
	{
		func_201(uParam0, uParam0->f_2048, 1);
	}
	func_208(uParam0);
...
int func_155(var uParam0, vector3 vParam1, float fParam4, vector3 vParam5, int iParam8, int iParam9, bool bParam10, int iParam11, int iParam12)
{
	int iVar0;

	if (bParam10)
	{
		vParam1 = { func_261(uParam0, vParam1) };
...
void func_160(var uParam0, var uParam1, int iParam2, float fParam3)
{
	if (iParam2 == -1)
	{
		iParam2 = 0;
...
void func_161(var uParam0, int iParam1, int iParam2, int iParam3, char* sParam4, int iParam5, int iParam6)
{
...
void func_162(var uParam0, int iParam1, int iParam2, int iParam3, char* sParam4, int iParam5, int iParam6, float fParam7, int iParam8, int iParam9)
{
...
void func_164(var uParam0, int iParam1, int iParam2, int iParam3, int iParam4, char* sParam5, char* sParam6)
{
...
void func_165(var uParam0, int iParam1, int iParam2, char* sParam3)
{
	(uParam0->f_1711[iParam2 /*15*/])->f_13 = sParam3;
	(uParam0->f_1711[iParam2 /*15*/])->f_14 = iParam1;
}

void func_166(var uParam0, int iParam1, vector3 vParam2, float fParam5, int iParam6, bool bParam7)
{
	if (bParam7)
	{
...
void func_168(var uParam0, int iParam1, float fParam2)
{
	if (fParam2 == -2f)
	{
		fParam2 = func_263(1101004800, 1123024896);
	}
	else if (fParam2 < 0f)
	{
		fParam2 = -1f;
...
int func_184(var uParam0)
{
	...
	while (iVar3 < uParam0->f_106)
	{
		...
		else if (func_185(uParam0, iVar3))
		{
		}
...
int func_201(var uParam0, int iParam1, bool bParam2)
{
	int iVar0;
	int iVar1;
	...
	if (bParam2)
	{
		...
		while (iVar1 < uParam0->f_1984)
		{
			...
			else if (func_300(uParam0, iVar1) || func_301(uParam0, iVar1))
			{
			...
			if (!(uParam0->f_107[iVar0 /*113*/])->f_32)
			{
				if (func_310(uParam0, iVar0))
				{
					if ((uParam0->f_107[iVar0 /*113*/])->f_32.f_48)
					{
						...
						func_311(uParam0, iVar0, 0, 1);
					}
					else
					{
						func_311(uParam0, iVar0, 1, 1);
					}
...
void func_214(var uParam0)
{
	...
	while (iVar0 < uParam0->f_106)
	{
		if (((uParam0->f_107[iVar0 /*113*/])->f_32.f_60 > 0f && !(uParam0->f_107[iVar0 /*113*/])->f_32.f_62) && func_313(uParam0, (uParam0->f_107[iVar0 /*113*/])->f_32.f_61, (uParam0->f_107[iVar0 /*113*/])->f_32.f_60))
		{
...
float func_218(int iParam0, int iParam1, bool bParam2)
{
	...
	return func_314(ENTITY::GET_ENTITY_COORDS(iParam0, false, false), ENTITY::GET_ENTITY_COORDS(iParam1, false, false));
}
...
int func_253(int iParam0)
{
	...
	fVar0 = func_326(iParam0);
	fVar1 = func_327(iParam0);
...
float func_263(float fParam0, float fParam1)
{
...
void func_311(var uParam0, int iParam1, bool bParam2, bool bParam3)
{
	var uVar0;
...
int func_313(var uParam0, int iParam1, float fParam2)
{
	int iVar0;
...
int func_391(int iParam0, bool bParam1, bool bParam2, var uParam3, var uParam4, var uParam5, float fParam6, bool bParam7, bool bParam8, bool bParam9, bool bParam10)
{
	...
	switch (((*Global_1360165)[iParam0 /*1157*/])->f_70.f_12)
	{
		...
		case 3:
			...
			sVar12 = func_426(iParam0, func_290());
		...
		case 7:
			switch (iParam0)
			{
				...
				case 14:
					...
					break;
				case 4:
					if (func_331(747937920, 1) && !func_394(((*Global_1347702)[1 /*49*/])->f_15, 1))
					{
						iVar1[0] = -1155031950;
					}
					else
