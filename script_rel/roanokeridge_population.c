...
void func_6()
{
	...
	switch (iLocal_24)
	{
		...
		case 1:
			...
			{
				iLocal_45 = VEHICLE::CREATE_VEHICLE(-283162583, vLocal_42, 22.22f, true, true, false, false);
		...
		case 2:
			...
			if (iVar1 >= VEHICLE::_0x5B1A26BB18E7D451(-283162583))
			{
				MISC::GET_MODEL_DIMENSIONS(-283162583, &vVar2, &vVar5);
				vVar8 = { vVar5 - vVar2 };
				vVar8 = { vVar8 * Vector(0.9f, 0.9f, 0.9f) };
				iVar14 = 0;
				while (iVar14 < 6)
				{
					iVar15 = VEHICLE::_0xA8BA0BAE0173457B(iLocal_45, iVar14);
