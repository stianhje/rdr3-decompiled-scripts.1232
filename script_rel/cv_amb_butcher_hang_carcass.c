...
int func_73(var uParam0)
{
	...
	iLocal_14 = func_154(uParam0, 1110710183, "DEER");
	iLocal_15 = func_155(uParam0, -1145133781, 0f, 0f, 0f, "HANGER", 0, 0, 1);
...
int func_157(var uParam0, int iParam1, char* sParam2, int iParam3)
{
	int iVar0;
	char cVar1[64];
