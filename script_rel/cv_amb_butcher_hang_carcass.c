...
int func_73(var uParam0)
{
	...
	func_151(uParam0, 0f, 0f, 0f, 0f, 1f, 1f, 2f, 665633627, 1);
	func_152(uParam0, 0f, 0f, 0f, 0f, 1f, 1f, 2f, -1612834106, -1386303207, 1, 1, 1);
	func_153(uParam0, 17, "MALE");
	iLocal_14 = func_154(uParam0, joaat("a_c_deer_01"), "DEER");
	iLocal_15 = func_155(uParam0, joaat("p_cs_meathanger01x"), 0f, 0f, 0f, "HANGER", 0, 0, 1);
	iLocal_16 = func_156(uParam0, "script@ambient@campfiregeneral@butcher_hang_carcass@action", 0, 1, 0, 0);
...
{
	func_191(uParam0, iLocal_16, "BOOL_BASE", 1);
	return 1;
}
...
int func_144(var uParam0)
{
	...
	while (iVar0 < uParam0->f_106)
	{
		...
		else
		{
			...
			{
				if (func_123((uParam0->f_107[iVar0 /*113*/])->f_1, 29, 1) || func_243((uParam0->f_107[iVar0 /*113*/])->f_1))
				{
					return 1;
				}
				if (!uParam0->f_3)
...
int func_157(var uParam0, var uParam1, char* sParam2, int iParam3)
{
	int iVar0;
	char cVar1[64];
...
int func_187(var uParam0, int iParam1, bool bParam2)
{
	...
	if (uParam0->f_2270)
	{
		uParam0->f_2274 = 0;
		uParam0->f_2275 = 0;
		if ((func_113() && ANIMSCENE::_0x6F1F0B17109309DA(uParam0->f_2046, "ARTHUR")) || (func_280() && ANIMSCENE::_0x6F1F0B17109309DA(uParam0->f_2046, "JOHN")))
		{
			uParam0->f_2274 = 1;
		}
	}
...
void func_188(var uParam0, int iParam1)
{
	...
	{
		func_293(func_49(uParam0, iParam1), 0);
		ENTITY::_0x18FF3110CF47115D(func_49(uParam0, iParam1), 7, 0);
...
int func_191(var uParam0, int iParam1, char* sParam2, bool bParam3)
{
	int iVar0;
...
void func_199(var uParam0)
{
	...
	iVar0 = PED::GET_PED_BONE_INDEX(func_49(uParam0, iLocal_14), 53081);
	iVar1 = PED::GET_PED_BONE_INDEX(func_49(uParam0, iLocal_14), 41273);
	iVar2 = ENTITY::GET_ENTITY_BONE_INDEX_BY_NAME(func_22(uParam0, iLocal_15), "bottomHookInd02");
	iVar3 = ENTITY::GET_ENTITY_BONE_INDEX_BY_NAME(func_22(uParam0, iLocal_15), "bottomHookInd01");
	vVar4 = { ENTITY::GET_WORLD_POSITION_OF_ENTITY_BONE(func_22(uParam0, iLocal_15), iVar2) };
	vVar7 = { ENTITY::GET_WORLD_POSITION_OF_ENTITY_BONE(func_22(uParam0, iLocal_15), iVar3) };
	PED::SET_PED_TO_RAGDOLL(func_49(uParam0, iLocal_14), 10000, 15000, 0, false, true, false);
	PED::_0xE1AADD0055D76603(func_49(uParam0, iLocal_14), func_22(uParam0, iLocal_15), iVar0, iVar2, vVar4, -1f, 0, 0, 0);
	PED::_0xE1AADD0055D76603(func_49(uParam0, iLocal_14), func_22(uParam0, iLocal_15), iVar1, iVar3, vVar7, -1f, 0, 0, 0);
}
		...
		else if (func_19(uParam0) == 355)
		{
			if (iVar3 == 5)
			{
				if (uParam0->f_3)
				{
					...
					else if (func_358(iVar3, func_100(uParam0->f_7), 1))
					{
					}
					else if (func_360(&uVar2, func_359(iVar3)))
					{
						...
						else
						{
							...
							if (bParam2)
							{
								...
								if (!func_361(iVar0, func_100(uParam0->f_7), 0, -1))
								{
									return -1;
								}
								return iVar0;
...
int func_328(int iParam0, bool bParam1)
{
	...
	{
		func_233(iParam0, _NAMESPACE48::_0x4F76E3676583D951(func_133(iParam0)));
		if (func_221() == -1)
		{
...
void func_385(int iParam0, bool bParam1, bool bParam2, bool bParam3)
{
	...
	if (bParam3)
	{
		func_419(func_105(iParam0), 1f, 0);
	}
	if (bParam1)
	{
		func_420(iParam0);
