...
int func_72(var uParam0)
{
	...
	func_154(uParam0, "script@vignette@beecher@charles_3@base", 1, 1, 0, 0);
	iLocal_16 = func_154(uParam0, "script@vignette@beecher@charles_3@action_a", 2, 0, 1, 1);
	iLocal_17 = func_154(uParam0, "script@vignette@beecher@charles_3@action_b", 0, 0, 0, 1);
	func_155(uParam0, -2142224971, -1219059668);
	func_156(uParam0, "BCHR3AU");
	func_157(uParam0, iLocal_14, 2, 1626779076, "WORLD_HUMAN_HORSE_TEND_BRUSH_LINK_MALE_A", -1, 1, 38f, 1065353216, 1);
	func_158(uParam0, iLocal_14, 1, -1);
	uLocal_18 = func_159(uParam0, -0.31f, 9.12f, 0f, 0f, 0f, 0f, 10f, 10f, 5f, "volTrigger", -1612834106);
	func_160(uParam0, 1);
...
{
	return func_194(uParam0, &uLocal_18, 1);
}
...
int func_93(var uParam0)
{
	...
	{
		if (func_194(uParam0, &uLocal_18, 1))
		{
	...
	if (func_204(uParam0, iLocal_17))
	{
		...
		{
			TASK::_TASK_START_SCENARIO_IN_PLACE(func_48(uParam0, iLocal_15), -830507952, 45000, 0, 0, 1f, 0);
		}
	}
	return 1;
}
...
int func_159(var uParam0, vector3 vParam1, vector3 vParam4, vector3 vParam7, char* sParam10, int iParam11)
{
	...
	vVar1 = { func_259(uParam0, vParam1) };
...
int func_176(int iParam0, int iParam1)
{
	...
	if (!func_120(iParam1, 256))
	{
		return 0;
	}
	PED::_0xA2F8B3B5FEDFC100(iParam1, func_284(iParam0));
...
void func_188(var uParam0)
{
	...
	{
		uParam0->f_1976.f_6 = PROPSET::_CREATE_PROPSET_2(uParam0->f_1976, func_259(uParam0, uParam0->f_1976.f_1), 1, func_293(uParam0, uParam0->f_1976.f_4), 3f, false, true);
	}
}
...
int func_193(var uParam0, int iParam1, bool bParam2)
{
	...
	if (bParam2)
	{
		...
		while (iVar1 < uParam0->f_1984)
		{
			...
			else if (func_204(uParam0, iVar1) || func_202(uParam0, iVar1))
			{
...
int func_194(var uParam0, var uParam1, bool bParam2)
{
	if (bParam2)
	{
	...
	return func_301(Global_35, *uParam1, 1, 0);
}
...
float func_293(var uParam0, float fParam1)
{
	float fVar0;
...
int func_392(int iParam0, bool bParam1, bool bParam2, var uParam3, var uParam4, var uParam5, float fParam6, bool bParam7, bool bParam8, bool bParam9, bool bParam10)
{
	...
	switch (((*Global_1360165)[iParam0 /*1157*/])->f_70.f_12)
	{
		...
		case 3:
			...
			sVar12 = func_427(iParam0, func_288());
...
int func_425(int iParam0, int iParam1, bool bParam2)
{
	...
	PED::_0x1902C4CFCC5BE57C(iParam1, func_284(iParam0));
	PED::_0xCC8CA3E88256E58F(iParam1, 0, 1, 1, 1, 0);
...
void func_426(int iParam0, int iParam1)
{
	...
	func_379(iParam0, func_456(iParam1));
	...
	func_394(iParam1, func_283(iParam1, 8192), func_283(iParam1, 16384), 1);
}
		...
		case 7:
			switch (iParam0)
			{
				...
				case 14:
					...
					break;
				case 4:
					if (func_330(747937920, 1) && !func_395(((*Global_1347702)[1 /*49*/])->f_15, 1))
					{
						iVar1[0] = -1155031950;
					}
					else
