...
{
	func_33(uParam0, 10973/*func_30*/, 11038/*func_31*/, 11782/*func_32*/);
}
...
void func_14(var uParam0, vector3 vParam1, vector3 vParam4)
{
	...
	uVar0 = func_48(func_47(), 1, 0, 1, 1, 0, 0);
	func_49(uParam0, 0, "WBPP_MAN_1", uVar0, OBJECT::_GET_OBJECT_OFFSET_FROM_COORDS(vParam1, vParam4.z, 3f, 0f, 0f), vParam4.z, 1, 1, 1, 1, 41788943, 1);
	func_49(uParam0, 1, "WBPP_MAN_2", uVar0, OBJECT::_GET_OBJECT_OFFSET_FROM_COORDS(vParam1, vParam4.z, -3f, 0f, 0f), vParam4.z, 1, 1, 1, 1, 41788943, 1);
