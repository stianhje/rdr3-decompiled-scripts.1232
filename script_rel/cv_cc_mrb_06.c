...
int func_72(var uParam0)
{
	...
	func_151(uParam0, 0.85f, -1.3375f, 0.85f, 0f, 4.4575f, 3.4825f, 3.2075f, -1612834106, -2055224817, 1, 1, 1);
	func_151(uParam0, 0.2f, 4.525f, 0.85f, -65.75f, 1f, 1f, 3.2075f, -1612834106, -1377448058, 1, 1, 1);
	func_152(uParam0, 0.614285f, -1.53936f, 1.00907f, 0f, 1.2f, 1.2f, 3.2f, 665633627, 1);
	func_153(uParam0, 663716280, 0f, 0f, 0f, "BROOM", 0, 1, 1);
	func_154(uParam0, "script@vignette@marybeth_6@base", 1, 1, 0, 0);
	func_154(uParam0, "script@vignette@marybeth_6@Action", 0, 0, 1, 0);
	func_155(uParam0, "CCMB6AU");
	func_156(uParam0, iLocal_14, 3, 837932401, "WORLD_HUMAN_BROOM_WORKING_FEMALE_B", -1, 1);
	func_157(uParam0, iLocal_14, 2, 837932401, "WORLD_HUMAN_BROOM_WORKING_FEMALE_B", -1, 1, 45f, 1065353216, 1);
	func_156(uParam0, iLocal_15, 3, -1124614608, "WORLD_HUMAN_WAITING_IMPATIENT_FEMALE_A", -1, 1);
	func_157(uParam0, iLocal_15, 3, -1124614608, "WORLD_HUMAN_WAITING_IMPATIENT_FEMALE_A", -1, 0, 55f, 1065353216, 1);
