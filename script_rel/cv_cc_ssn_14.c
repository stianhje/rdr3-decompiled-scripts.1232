...
int func_72(var uParam0)
{
	...
	func_151(uParam0, -6.2251f, 1.2273f, 0f, -29f, 1.1f, 1.1f, 4f, -1612834106, -695792551, 1, 1, 1);
	func_151(uParam0, -0.742f, -0.362f, 1.03f, 0f, 6f, 6f, 4f, -1612834106, -1689743484, 1, 1, 1);
	iLocal_21 = func_152(uParam0, joaat("p_bottlejd01x"), 0f, 0f, 0f, "BOTTLE", 0, 0, 1);
	func_153(uParam0, "script@vignette@susan_14@base", 1, 1, 0, 0);
	iLocal_16 = func_153(uParam0, "script@vignette@susan_14@action_a", 2, 0, 1, 0);
	iLocal_20 = func_153(uParam0, "script@vignette@susan_14@action_b", 0, 0, 0, 0);
	iLocal_17 = func_153(uParam0, "script@vignette@susan_14@action_b_front", 0, 0, 0, 1);
	iLocal_18 = func_153(uParam0, "script@vignette@susan_14@action_b_left", 0, 0, 0, 1);
	iLocal_19 = func_153(uParam0, "script@vignette@susan_14@action_b_right", 0, 0, 0, 1);
	func_154(uParam0, "CSN14AU");
	func_155(uParam0, 1502462601, 563725021);
	func_156(uParam0, iLocal_14, 3, -1426662425, "PROP_HUMAN_SEAT_CHAIR_GENERIC_FEMALE_C", -1, 0);
	func_157(uParam0, iLocal_14, 2, -1426662425, "PROP_HUMAN_SEAT_CHAIR_GENERIC_FEMALE_C", -1, 0, -1073741824, 1065353216, 1);
	func_158(uParam0, iLocal_14, 1, 4, 0, 0, 0);
	func_159(uParam0, iLocal_14, 1, -1);
	func_156(uParam0, iLocal_15, 3, 421625586, "WORLD_HUMAN_LEAN_WALL_DRINKING_FEMALE_B", -1, 1);
	func_158(uParam0, iLocal_15, 2, 6, 0, 0, 0);
	func_160(uParam0, iLocal_15, 1061142135);
	func_159(uParam0, iLocal_15, 1, -1);
	func_157(uParam0, iLocal_15, 3, 421625586, "WORLD_HUMAN_LEAN_WALL_DRINKING_FEMALE_B", -1, 0, -1073741824, 1065353216, 1);
	func_161(uParam0, iLocal_15, iLocal_21, "p_bottleJD01x_ph_r_hand", 0, 0);
	func_162(uParam0, iLocal_15, 3, 0);
	func_163(uParam0, 1);
	func_164(uParam0, 1);
	Local_22 = { func_165(uParam0, 0.5025f, -1.455f, 1f, 155f, 7f, 0.888f, 0.47f) };
	Local_42 = { func_165(uParam0, 0.503f, -1.455f, 1f, 85.5f, 7f, 0.3f, 0.3f) };
	Local_32 = { func_165(uParam0, 0.503f, -1.455f, 1f, -95f, 7f, 0.333f, 0.333f) };
	return 1;
}
...
int func_93(var uParam0)
{
	...
	{
		if (func_205(uParam0, Local_42, 1, 0))
		{
		...
		else if (func_205(uParam0, Local_22, 1, 0))
		{
...
struct<10> func_165(var uParam0, vector3 vParam1, float fParam4, float fParam5, float fParam6, float fParam7)
{
	float fVar0;
	float fVar1;
	struct<10> Var2;
	...
	if (!uParam0->f_72)
	{
		...
		while (iVar0 < uParam0->f_33)
		{
			...
			else
			{
				...
				{
					func_265(&(uParam0->f_33[iVar0]), 0, 1, 0, 2048, 0, -1082130432);
					iVar0++;
				}
				if (!uParam0->f_71)
				{
	...
	while (iVar12 < uParam0->f_106)
	{
		...
		else
		{
			if (!STREAMING::IS_MODEL_VALID((uParam0->f_107[iVar12 /*113*/])->f_3))
			{
				...
				{
					(uParam0->f_107[iVar12 /*113*/])->f_3 = _NAMESPACE48::_0xA00DF706C60173D1(func_279((uParam0->f_107[iVar12 /*113*/])->f_1));
				}
				else if (func_57((uParam0->f_107[iVar12 /*113*/])->f_2))
				{
					(uParam0->f_107[iVar12 /*113*/])->f_3 = func_280((uParam0->f_107[iVar12 /*113*/])->f_2);
				}
		...
		else
		{
			...
			else if (!(uParam0->f_107[iVar0 /*113*/])->f_8.f_22)
			{
				if (iVar1 < 0)
				{
					...
					func_281(&((uParam0->f_107[iVar0 /*113*/])->f_8.f_23), 1, 0);
				}
				else
				{
	...
	while (iVar1 < 27)
	{
		...
		else
		{
			...
			while (iVar0 < uParam0->f_36)
			{
				...
				else if (iVar1 == func_282((uParam0->f_36[iVar0 /*5*/])->f_1))
				{
				}
...
int func_205(var uParam0, struct<4> Param1, var uParam5, var uParam6, var uParam7, var uParam8, var uParam9, var uParam10, bool bParam11, bool bParam12)
{
	...
	if (!func_313(Param1, Param1.f_6, Global_36))
	{
		return 0;
	}
	if (func_313(Param1, Param1.f_3, Global_36))
	{
		return 0;
	}
	if (bParam12)
			...
			if (!(uParam0->f_107[iVar0 /*113*/])->f_32)
			{
				if (func_315(uParam0, iVar0))
				{
					if ((uParam0->f_107[iVar0 /*113*/])->f_32.f_48)
					{
						...
						func_316(uParam0, iVar0, 0, 1);
					}
					else
					{
						func_316(uParam0, iVar0, 1, 1);
					}
...
void func_212(var uParam0)
{
	...
	while (iVar0 < uParam0->f_106)
	{
		if (((uParam0->f_107[iVar0 /*113*/])->f_32.f_60 > 0f && !(uParam0->f_107[iVar0 /*113*/])->f_32.f_62) && func_311(uParam0, (uParam0->f_107[iVar0 /*113*/])->f_32.f_61, (uParam0->f_107[iVar0 /*113*/])->f_32.f_60))
		{
...
int func_248(int iParam0, bool bParam1, int iParam2)
{
	...
	if ((Global_1898164->f_1[0 /*5*/])->f_2 == 8)
	{
		...
		if (func_303(iVar0) && func_327(((*Global_1347702)[iVar0 /*49*/])->f_12, 131072))
		{
			return 0;
		}
	}
				...
				case 9:
					...
					switch (iParam1)
					{
						...
						case 14:
							...
							{
								case 156:
									return func_336(2329.663f, 1347.464f, 104.5794f, 155.2611f);
								default:
									break;
							}
							break;
						case 1:
							switch (iParam2)
							{
								...
								case 156:
									return func_336(2330.225f, 1345.275f, 104.7174f, 21.2991f);
								default:
									break;
							}
							break;
					...
					switch (iParam1)
					{
						...
						case 4:
							...
							{
								case 669:
									return func_336(-1603.036f, -1408.744f, 80.9423f, 69.6409f);
								default:
									break;
							}
							break;
...
int func_265(int iParam0, int iParam1, bool bParam2, int iParam3, int iParam4, bool bParam5, float fParam6)
{
	vector3 vVar0;
	vector3 vVar3;
	var uVar6;
...
void func_266(var uParam0, int iParam1, float fParam2)
{
...
bool func_313(struct<2> Param0, var uParam2, struct<2> Param3, var uParam5, struct<2> Param6, var uParam8)
{
...
float func_335(float fParam0, float fParam1)
{
	return MISC::GET_RANDOM_FLOAT_IN_RANGE(fParam0, fParam1);
}

struct<4> func_336(vector3 vParam0, float fParam3)
{
	struct<4> Var0;
...
void func_389(var uParam0, int iParam1)
{
	...
	func_423(sVar1, uVar2, uVar3, iVar4);
}
...
int func_393(var uParam0, int iParam1)
{
	...
	while (iVar2 <= iVar1)
	{
		...
		else
		{
			...
			vVar10 = { func_426(fVar9) };
			vVar13 = { func_427(ENTITY::GET_ENTITY_COORDS((uParam0->f_107[iParam1 /*113*/])->f_5, true, false), vVar3, 1065353216) };
...
int func_395(var uParam0, int iParam1)
{
	...
	{
		func_281(&((uParam0->f_107[iParam1 /*113*/])->f_32.f_21), 1, (uParam0->f_107[iParam1 /*113*/])->f_32.f_13);
		bVar71 = Var1.f_10;
...
int func_400(int iParam0, bool bParam1, bool bParam2, var uParam3, var uParam4, var uParam5, float fParam6, bool bParam7, bool bParam8, bool bParam9, bool bParam10)
{
	...
	switch (((*Global_1360165)[iParam0 /*1157*/])->f_70.f_12)
	{
		case 0:
			...
			{
				if (!func_430(iParam0) && func_431(iParam0, &sVar4))
				{
		...
		case 1:
			if (!Global_1359489->f_12)
			{
				...
				if (!func_433(iParam0, vVar0, fParam6, bParam10))
				{
					return func_432();
				}
				if (func_120(((*Global_1360165)[iParam0 /*1157*/])->f_124, 0))
		...
		case 3:
			...
			if (bParam7)
			{
				if (!func_434(iParam0, ((*Global_1360165)[iParam0 /*1157*/])->f_124, 1))
				{
					return func_432();
				}
			}
			...
			sVar12 = func_436(iParam0, func_291());
...
void func_402(int iParam0, bool bParam1, bool bParam2, bool bParam3)
{
	...
	if (bParam3)
	{
		func_437(func_104(iParam0), 1f, 0);
	}
	if (bParam1)
	{
		func_438(iParam0);
	...
	switch (((*Global_1360165)[iParam0 /*1157*/])->f_3)
	{
		...
		case 1:
			...
			if (iParam4 == 0)
			{
				if (iParam9 != -1)
				{
					iParam4 = func_442(iParam0, iParam9, bParam7, 1);
				}
				...
				{
					iParam4 = func_442(iParam0, Global_40.f_4283, bParam7, 1);
				}
...
void func_423(char* sParam0, var uParam1, var uParam2, int iParam3)
{
...
Vector3 func_426(float fParam0)
{
	return -BUILTIN::SIN(fParam0), BUILTIN::COS(fParam0), 0f;
}

Vector3 func_427(vector3 vParam0, vector3 vParam3, float fParam6)
{
	return func_462(vParam3 - vParam0) * Vector(fParam6, fParam6, fParam6);
}
...
int func_431(int iParam0, char* sParam1)
{
...
int func_433(int iParam0, vector3 vParam1, float fParam4, bool bParam5)
{
	int iVar0;
...
int func_434(int iParam0, int iParam1, bool bParam2)
{
	...
	PED::_0x1902C4CFCC5BE57C(iParam1, func_464(iParam0));
	PED::_0xCC8CA3E88256E58F(iParam1, 0, 1, 1, 1, 0);
...
void func_435(int iParam0, int iParam1)
{
	...
	func_386(iParam0, func_465(iParam1));
	...
	func_402(iParam1, func_463(iParam1, 8192), func_463(iParam1, 16384), 1);
}

char* func_436(int iParam0, bool bParam1)
{
	switch (iParam0)
	{
		case 3:
		...
		case 1:
			switch (iParam0)
			{
				...
				case 9:
					...
					break;
				case 10:
					if (func_403(((*Global_1347702)[63 /*49*/])->f_15, 1) || func_304(((*Global_1347702)[63 /*49*/])->f_15))
					{
						iVar1[0] = -268604689;
					}
					else
		...
		case 3:
			switch (iParam0)
			{
				...
				case 10:
					...
					break;
				case 11:
					if (func_403(((*Global_1347702)[134 /*49*/])->f_15, 1) || func_304(((*Global_1347702)[134 /*49*/])->f_15))
					{
						iVar1[0] = -2040275819;
						iVar1[1] = 1205492208;
						iVar7 = 2;
		...
		case 7:
			switch (iParam0)
			{
				...
				case 14:
					...
					break;
				case 4:
					if (func_334(747937920, 1) && !func_403(((*Global_1347702)[1 /*49*/])->f_15, 1))
					{
						iVar1[0] = -1155031950;
					}
					else
...
int func_456(int iParam0, int iParam1)
{
	...
	switch (iParam0)
	{
		...
		case -1862464078:
			return 1895628185;
		case 296923297:
			iVar0 = func_474(296923297, iParam1);
		...
		case -1414977761:
			return 1059434053;
		case 1237718549:
			iVar0 = func_474(1237718549, iParam1);
			return func_475(iVar0);
		case -23947011:
			return -456769142;
		case 1295334688:
...
bool func_460(int iParam0, int iParam1, bool bParam2, bool bParam3, int iParam4, bool bParam5, int iParam6, int iParam7, int iParam8, int iParam9, bool bParam10, bool bParam11, bool bParam12, bool bParam13)
{
		...
		default:
			...
			if ((WEAPON::_0x705BE297EEBDB95D(bVar0) || WEAPON::_0x959383DCD42040DA(bVar0)) && PED::GET_PED_RELATIONSHIP_GROUP_HASH(iParam0) == 1030835986)
			{
				...
				if (!Global_43890 && MISC::_DOES_STRING_EXIST_IN_STRING(&cVar5, "_DUALWIELD"))
				{
					...
					if (func_477(iVar3) && WEAPON::_0xF252A85B8F3F8C58(iVar2, iVar3))
					{
						bVar21 = true;
					}
				}
	...
	if (iParam9 < 0)
	{
		if (iParam0 != Global_35 && func_477(bVar0))
		{
	...
	{
		func_479(bVar0, iParam9, bParam2, bParam5, iParam4, bParam11, 752097756, 0);
	}
	else if (!bParam13)
	{
		fVar25 = 0f;
		func_480(iParam0, &bVar0, &fVar25);
...
Vector3 func_462(vector3 vParam0)
{
	float fVar0;
	float fVar1;
...
float func_466(float fParam0, float fParam1, float fParam2)
{
	if (fParam0 > fParam2)
	{
		return fParam2;
...
int func_479(int iParam0, int iParam1, bool bParam2, bool bParam3, int iParam4, bool bParam5, int iParam6, bool bParam7)
{
	struct<4> Var0;
	int iVar5;
	struct<10> Var6;
...
void func_480(int iParam0, int iParam1, float fParam2)
{
	bool bVar0;
	int iVar1;
