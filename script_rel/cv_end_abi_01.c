...
int func_72(var uParam0)
{
	...
	func_152(uParam0, 1.3527f, 1.6955f, 1.0578f, -94.52f, 2.8f, 2.8f, 3f, -1612834106, -1, 1, 1, 1);
	func_153(uParam0, 1.35f, 1.65f, 0f, 0f, 1.5f, 1.5f, 3f, 665633627, 1);
	func_154(uParam0, 1502991738, 0f, 0f, 0f, "BUCKET", 0, 0, 1);
	func_154(uParam0, joaat("p_stool02x"), 0f, 0f, 0f, "STOOL", 0, 0, 1);
	func_155(uParam0, "script@vignette@beecher@abigail_1@base", 1, 1, 0, 0);
	iLocal_15 = func_155(uParam0, "script@vignette@beecher@abigail_1@action", 2, 0, 1, 1);
	iLocal_16 = func_155(uParam0, "script@vignette@beecher@abigail_1@exit_action", 0, 0, 0, 0);
	func_156(uParam0, "BABI1AU");
	func_157(uParam0, 1281988756, 2117887699);
	func_158(uParam0, iLocal_14, 1, -1);
	uLocal_18 = func_159(uParam0, -2.25f, 2.1f, 1.95f, 0f, 0f, -4f, 10.75f, 7.48f, 4f, "volTrigger", -1612834106);
	func_160(uParam0, 1);
...
{
	if (ANIMSCENE::_0x005E6F28DD7ED58D(&(uParam0->f_1984[iLocal_16]), "COW") && !func_108(&uLocal_19))
	{
		TASK::_TASK_START_SCENARIO_IN_PLACE(func_48(uParam0, iLocal_17), -830507952, 0, 0, 0, -1082130432, 0);
		PED::SET_BLOCKING_OF_NON_TEMPORARY_EVENTS(func_48(uParam0, iLocal_17), true);
		func_115(&uLocal_19, 0);
	}
...
int func_159(var uParam0, vector3 vParam1, vector3 vParam4, vector3 vParam7, char* sParam10, int iParam11)
{
	...
	vVar1 = { func_254(uParam0, vParam1) };
...
int func_191(var uParam0, int iParam1, bool bParam2)
{
	...
	if (bParam2)
	{
		...
		while (iVar1 < uParam0->f_1984)
		{
			...
			else if (func_292(uParam0, iVar1) || func_200(uParam0, iVar1))
			{
...
int func_192(var uParam0, var uParam1, bool bParam2)
{
	...
	return func_295(Global_35, *uParam1, 1, 0);
}
