...
int func_79(var uParam0)
{
	...
	iLocal_39 = func_161(uParam0, 1230724566, 0.8f, 0.491f, -0.004f, "crate02", 0, 0, 1);
	iLocal_38 = func_161(uParam0, 1504738597, 1.314f, 1.778f, -0.062f, "crate15", 0, 0, 1);
	...
	func_169(uParam0, iLocal_18, 2, -1426662425, "PROP_HUMAN_SEAT_CHAIR_GENERIC_FEMALE_C", iLocal_38, 0, 110f, 1065353216, 1);
	...
	if (iLocal_50 >= 3 && iLocal_50 < 6)
	{
		...
		if (func_226(&uLocal_99))
		{
			...
			else
			{
				...
				func_169(uParam0, iLocal_18, 2, -1074764191, "PROP_CAMP_FIRE_SEAT_BENCH_FEMALE_A", iLocal_38, 0, 110f, 1065353216, 1);
			}
			func_228(uParam0, iLocal_23, "b_WaitLoop", 1);
			func_217(9);
			return 0;
...
int func_164(var uParam0, int iParam1, char* sParam2, int iParam3)
{
	int iVar0;
	char cVar1[64];
...
void func_480(int iParam0, int iParam1)
{
	...
	switch (iParam0)
	{
		case 11:
			...
			{
				func_521(iParam1, 1240907314, 0, 0, 2, 1, 0, 1056964608, 1065353216, -1, 0, 0, 0, 0);
				func_521(iParam1, -2088446466, 0, 0, 3, 1, 1, 1056964608, 1065353216, -1, 0, 1, 0, 0);
			}
			break;
	}
}
