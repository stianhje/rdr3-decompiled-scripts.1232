...
{
	func_33(uParam0, 11466/*func_30*/, 11592/*func_31*/, 12822/*func_32*/);
}
...
void func_14(var uParam0, vector3 vParam1, vector3 vParam4)
{
	...
	uVar0 = func_49(func_48(), 1, 0, 0, 1, 0, 1);
	iVar2 = 40345436;
	func_50(uParam0, 0, "RHP_RANCHER", uVar0, OBJECT::_GET_OBJECT_OFFSET_FROM_COORDS(vParam1, vParam4.z, 0f, 2.25f, 0f), vParam4.z, 1, 1, 1, 1, 41788943, 1);
	func_50(uParam0, 2, "RHP_HORSE", uVar1, OBJECT::_GET_OBJECT_OFFSET_FROM_COORDS(vParam1, vParam4.z, 0f, 0.5f, 0f), vParam4.z, 1, 1, 1, 1, 41788943, 1);
	func_50(uParam0, 1, "RHP_DOG", 1087552700, OBJECT::_GET_OBJECT_OFFSET_FROM_COORDS(vParam1, vParam4.z, -1f, 0.5f, 0f), vParam4.z, 1, 1, 1, 1, 41788943, 1);
...
int func_31(var uParam0)
{
	...
	switch (iLocal_25)
	{
		case 0:
			...
			PED::_0x24C82EF607105FAA(&(uParam0->f_20[0 /*14*/]), -920810745);
			...
			while (iVar0 <= 14)
			{
				if (!ENTITY::IS_ENTITY_DEAD(&(uParam0->f_20[iVar0 /*14*/])))
				{
					...
					TASK::TASK_START_SCENARIO_AT_POSITION(&(uParam0->f_20[iVar0 /*14*/]), -830507952, (uParam0->f_20[iVar0 /*14*/])->f_5, (uParam0->f_20[iVar0 /*14*/])->f_8, 0, 0, 1, 0, -1082130432, 0);
...
void func_50(var uParam0, int iParam1, char* sParam2, int iParam3, vector3 vParam4, var uParam7, int iParam8, int iParam9, int iParam10, int iParam11, int iParam12, int iParam13)
{
...
void func_121(int iParam0, vector3 vParam1)
{
	...
	while (iVar0 < 10)
	{
		...
		{
			if (func_138((Global_32073.f_2697.f_1495[iVar0 /*4*/])->f_1, vParam1, 1056964608, 1))
			{
				return;
			}
		}
...
void func_157(int iParam0, int iParam1, int iParam2, int iParam3, int iParam4, int iParam5, bool bParam6, int iParam7)
{
	int iVar0;
	
	iVar0 = (((iParam2 + (60 * iParam3)) + (3600 * iParam4)) + (86400 * iParam5));
	if (func_192(iParam0) == 1 && iParam7)
	{
		return;
	}
	if (bParam6)
