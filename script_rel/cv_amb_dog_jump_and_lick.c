...
int func_72(var uParam0)
{
	...
	iLocal_15 = func_151(uParam0, "script@ambient@campfiregeneral@DOG_JUMP_AND_LICK@action", 64, 0, 0, 0);
	func_152(uParam0, -0.1235f, 0.2914f, 1.0827f, -76.75f, 1.9375f, 1.5675f, 3f, -1612834106, -2087487524, 1, 1, 1);
	func_152(uParam0, -1.086f, 8.8789f, 1.0827f, -76.75f, 1.2975f, 1.0125f, 3f, -1612834106, -1, 1, 1, 1);
	iVar0 = MISC::GET_RANDOM_INT_IN_RANGE(0, 2);
	func_153(uParam0, iLocal_14, 3, 1951165908, "WORLD_ANIMAL_DOG_SITTING", -1, 0);
...
int func_85(var uParam0)
{
	...
	{
		func_186(uParam0);
		func_170(uParam0, uParam0->f_2047, 1);
	}
...
{
	func_188(uParam0, iLocal_15, "b_breakout", 1);
	return 1;
}
...
int func_91(var uParam0)
{
	...
	if (uParam0->f_2048 >= 0)
	{
		func_170(uParam0, uParam0->f_2048, 1);
	}
	func_194(uParam0);
...
int func_169(var uParam0, int iParam1, bool bParam2)
{
	int iVar0;
	struct<4> Var1;
	int iVar5;
...
int func_170(var uParam0, int iParam1, bool bParam2)
{
	...
	if (bParam2)
	{
		...
		while (iVar1 < uParam0->f_1984)
		{
			...
			else if (func_275(uParam0, iVar1) || func_276(uParam0, iVar1))
			{
...
int func_188(var uParam0, int iParam1, char* sParam2, bool bParam3)
{
	int iVar0;
...
void func_247(var uParam0, int iParam1, int iParam2, int iParam3, int iParam4, int iParam5, int iParam6, float fParam7, int iParam8, int iParam9)
{
...
int func_248(int iParam0, int iParam1, bool bParam2, int iParam3, int iParam4, bool bParam5, float fParam6)
{
	...
	uVar6 = func_317(vVar0, vVar3.x, iParam1, bParam2, iParam3, iParam4, bParam5, fParam6);
	return uVar6;
}
	...
	while (iVar1 < uParam0->f_106)
	{
		...
		else
		{
			if (func_50((uParam0->f_107[iVar1 /*113*/])->f_7))
			{
				...
				{
					(uParam0->f_107[iVar1 /*113*/])->f_5 = func_318((uParam0->f_107[iVar1 /*113*/])->f_7, 1, 1, 0, 0, 1, 1, (uParam0->f_107[iVar1 /*113*/])->f_6, 0, 0, 0, 0, 0, 0, 0, 0, 0);
					return 0;
					if ((uParam0->f_107[iVar1 /*113*/])->f_102 || (uParam0->f_107[iVar1 /*113*/])->f_103)
					{
						if (!func_50((uParam0->f_107[iVar1 /*113*/])->f_1))
						{
							...
							{
								(uParam0->f_107[iVar1 /*113*/])->f_1 = func_319(uParam0, 1, 1);
							}
							else
							{
								(uParam0->f_107[iVar1 /*113*/])->f_1 = func_319(uParam0, 1, 0);
							}
						}
						if (!func_50((uParam0->f_107[iVar1 /*113*/])->f_1))
						{
					...
					if (!func_320(uParam0, iVar1, (uParam0->f_107[iVar1 /*113*/])->f_1))
					{
						if (!uParam0->f_21)
						{
							return 0;
...
int func_252(var uParam0)
{
	...
	while (iVar0 < uParam0->f_106)
	{
		...
		{
			if (ENTITY::IS_ENTITY_DEAD(func_321(iVar1)))
			{
				func_322(iVar1, 1);
				return 0;
			}
			(uParam0->f_107[iVar0 /*113*/])->f_5 = func_323(iVar1, 0, 0, 1, 1, 1);
			if (!ENTITY::DOES_ENTITY_EXIST((uParam0->f_107[iVar0 /*113*/])->f_5))
			{
				return 0;
			}
...
int func_268(var uParam0, int iParam1, vector3 vParam2)
{
	...
	{
		fVar4 = func_326(fVar3, fVar1, fVar2, uParam0->f_2254, uParam0->f_2255);
	}
...
int func_269(var uParam0, int iParam1, vector3 vParam2)
{
	...
	{
		fVar4 = func_326(fVar3, fVar1, fVar2, uParam0->f_2259, uParam0->f_2260);
	}
...
int func_280(int iParam0, vector3 vParam1, float fParam4, bool bParam5, bool bParam6, int iParam7, bool bParam8, bool bParam9, bool bParam10, bool bParam11, bool bParam12, bool bParam13, bool bParam14)
{
	...
	func_327(iVar0, iParam0, iParam7, bParam8, bParam9, bParam10, bParam11, bParam12);
	return iVar0;
}
...
int func_288(var uParam0, float fParam1, float fParam2)
{
	...
	while (iVar1 < uParam0->f_106)
	{
		...
		{
			fVar0 = func_331(Global_35, (uParam0->f_107[iVar1 /*113*/])->f_5, 1, 1);
			if (fVar0 > fParam2)
			{
			}
			else
...
int func_294(var uParam0, int iParam1)
{
	...
	{
		if (!func_325((uParam0->f_107[iParam1 /*113*/])->f_5, 1435919172))
		{
			return 1;
		}
	}
...
void func_295(var uParam0, int iParam1, bool bParam2, bool bParam3)
{
	...
	if (bParam3)
	{
		uVar0 = func_334(uParam0, iParam1);
	}
	if (bParam2)
	{
...
void func_316(var uParam0, int iParam1, float fParam2)
{
	if (fParam2 == -2f)
	{
...
int func_317(vector3 vParam0, float fParam3, var uParam4, bool bParam5, int iParam6, int iParam7, bool bParam8, float fParam9)
{
	int iVar0;
	int iVar1;
	vector3 vVar2;
...
int func_318(int iParam0, bool bParam1, bool bParam2, int iParam3, int iParam4, int iParam5, bool bParam6, bool bParam7, bool bParam8, int iParam9, int iParam10, int iParam11, float fParam12, bool bParam13, bool bParam14, bool bParam15, bool bParam16)
{
	var uVar0;
	int iVar1;
...
int func_323(int iParam0, bool bParam1, bool bParam2, bool bParam3, int iParam4, bool bParam5)
{
	int iVar0;
	int iVar1;
...
float func_326(float fParam0, float fParam1, float fParam2, float fParam3, float fParam4)
{
	return ((((fParam0 - fParam1) / (fParam2 - fParam1)) * (fParam4 - fParam3)) + fParam3);
}

void func_327(int iParam0, int iParam1, int iParam2, bool bParam3, bool bParam4, bool bParam5, bool bParam6, bool bParam7)
{
	bool bVar0;
...
float func_331(int iParam0, int iParam1, bool bParam2, int iParam3)
{
...
int func_377(int iParam0, bool bParam1, bool bParam2, var uParam3, var uParam4, var uParam5, float fParam6, bool bParam7, bool bParam8, bool bParam9, bool bParam10)
{
	...
	switch (((*Global_1360165)[iParam0 /*1157*/])->f_70.f_12)
	{
		...
		case 3:
			...
			sVar12 = func_412(iParam0, func_274());
...
void func_393(int iParam0, int iParam1)
{
	...
	switch (iParam0)
	{
		case 11:
			...
			{
				func_438(iParam1, joaat("weapon_revolver_cattleman_sadie"), 0, 0, 2, 1, 0, 1056964608, 1065353216, -1, 0, 0, 0, 0);
				func_438(iParam1, joaat("weapon_revolver_cattleman_sadie_dualwield"), 0, 0, 3, 1, 1, 1056964608, 1065353216, -1, 0, 1, 0, 0);
			}
			break;
	}
}
		...
		case 7:
			switch (iParam0)
			{
				...
				case 14:
					...
					break;
				case 4:
					if (func_315(747937920, 1) && !func_380(((*Global_1347702)[1 /*49*/])->f_15, 1))
					{
						iVar1[0] = -1155031950;
					}
					else
