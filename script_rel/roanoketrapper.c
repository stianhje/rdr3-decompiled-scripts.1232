...
int func_11()
{
	if (func_20() == -1)
	{
		iLocal_9 = VOLUME::_CREATE_VOLUME_BOX_WITH_CUSTOM_NAME(2076.216f, 1001.187f, 112.332f, 0f, 0f, 13.199f, 14.446f, 11.798f, 3.385f, "Roanoke Trapper - m_volTrapper");
		iLocal_10 = VOLUME::_CREATE_VOLUME_BOX_WITH_CUSTOM_NAME(2076.577f, 1000.768f, 113.832f, 0f, 0f, 14.334f, 1.507f, 2.813f, 4.877f, "Roanoke Trapper - m_volTrapperPrompt");
		iLocal_11 = VOLUME::_CREATE_VOLUME_BOX_WITH_CUSTOM_NAME(2073.717f, 1000.015f, 113.832f, 0f, 0f, 14.334f, 3.821f, 4.158f, 4.877f, "Roanoke Trapper - m_volTrapperOfflimits");
	}
	return 1;
}
...
char* func_168(var uParam0, var uParam1, var uParam2, var uParam3, var uParam4, var uParam5, var uParam6, var uParam7)
{
...
bool func_197(int iParam0, int iParam1)
{
	...
	return !_NAMESPACE48::_0xEB98B38CA60742D7(func_140(iParam0));
}
