...
int func_72(var uParam0)
{
	...
	func_151(uParam0, 2.35f, 4.3625f, 0.8945f, 80f, 1f, 1f, 2.2325f, -1612834106, 1877049591, 1, 1, 1);
	func_151(uParam0, -0.2875f, -0.625f, 0.832f, 92.5f, 2f, 5.8325f, 2.135f, -1612834106, -1689743484, 1, 1, 1);
	...
	func_153(uParam0, "script@vignette@susan_uncle_1@base", 1, 1, 0, 0);
	iLocal_16 = func_153(uParam0, "script@vignette@susan_uncle_1@action_a", 2, 0, 1, 0);
	iLocal_18 = func_153(uParam0, "script@vignette@susan_uncle_1@ACTION_B_ALT_LEFT", 0, 0, 0, 1);
	iLocal_19 = func_153(uParam0, "script@vignette@susan_uncle_1@ACTION_B_ALT_RIGHT", 0, 0, 0, 1);
	iLocal_17 = func_153(uParam0, "script@vignette@susan_uncle_1@action_b", 0, 0, 0, 0);
	func_154(uParam0, "CSNU1AU");
	func_155(uParam0, 574994872, -256652297);
	func_156(uParam0, iLocal_14, 3, -1489483851, "WORLD_HUMAN_COFFEE_DRINK_FEMALE_C", -1, 1);
	func_157(uParam0, iLocal_14, 2, 0, 30, 0, 0);
	func_158(uParam0, iLocal_15, 3, -1);
	func_159(uParam0, iLocal_14, 1.4f, 1065353216, 1092616192);
	func_160(uParam0, iLocal_14, 1, -1489483851, 0, -1, 0, -1073741824, 1065353216, 1);
	func_161(uParam0, iLocal_14, iLocal_20, "p_mugCoffee01x_PH_R_HAND", 0, 0);
	func_156(uParam0, iLocal_15, 3, -1122379099, "WORLD_HUMAN_STAND_DRINK_MALE_B", -1, 1);
	func_158(uParam0, iLocal_15, 1, -1);
	Local_21 = { func_162(uParam0, 0.5875f, -1.4975f, 1.07f, 98f, 6.0475f, 0.285f, 0.6575f) };
	Local_31 = { func_162(uParam0, 0.588f, -1.498f, 1.07f, 34f, 6.0575f, 0.0525f, 0.66f) };
	return 1;
}
...
int func_93(var uParam0)
{
	...
	{
		if (func_201(uParam0, Local_21, 1, 0))
		{
			func_202(uParam0, iLocal_18, -1, 0.53f);
			func_192(uParam0, iLocal_18, 1);
		}
		else if (func_201(uParam0, Local_31, 1, 0))
		{
...
void func_159(var uParam0, int iParam1, float fParam2, int iParam3, int iParam4)
{
...
int func_192(var uParam0, int iParam1, bool bParam2)
{
	...
	if (bParam2)
	{
		...
		while (iVar1 < uParam0->f_1984)
		{
			...
			else if (func_294(uParam0, iVar1) || func_200(uParam0, iVar1))
			{
