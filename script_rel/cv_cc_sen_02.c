...
int func_72(var uParam0)
{
	...
	iLocal_15 = func_152(uParam0, 1085457901, 0f, 0f, 0f, "RAG", 0, 0, 1);
	func_153(uParam0, "script@vignette@sean_2@base", 1, 1, 0, 0);
	iLocal_17 = func_153(uParam0, "script@vignette@sean_2@action_a_front", 2, 0, 1, 1);
	iLocal_16 = func_153(uParam0, "script@vignette@sean_2@action_a_left", 2, 0, 0, 1);
...
void func_410(int iParam0, int iParam1)
{
	...
	switch (iParam0)
	{
		case 11:
			...
			{
				func_451(iParam1, 1240907314, 0, 0, 2, 1, 0, 1056964608, 1065353216, -1, 0, 0, 0, 0);
				func_451(iParam1, -2088446466, 0, 0, 3, 1, 1, 1056964608, 1065353216, -1, 0, 1, 0, 0);
			}
			break;
	}
}
