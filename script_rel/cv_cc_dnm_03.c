...
int func_72(var uParam0)
{
	...
	func_151(uParam0, 0.0326f, -1.1852f, 0.5177f, 0f, 2.5f, 2.5f, 3f, -1612834106, 2017216891, 1, 1, 1);
	func_151(uParam0, -9.0601f, -8.936f, 1.029f, 0f, 1.5f, 1.5f, 3f, -1612834106, -727195357, 1, 1, 1);
	iLocal_16 = func_152(uParam0, -234159968, 0f, 0f, 0f, "CIGAR", 0, 1, 1);
	if (!func_153(15))
	{
		func_154(uParam0, "script@vignette@dutch_and_molly_3@base", 1, 1, 0, 0);
	}
	uLocal_17 = func_154(uParam0, "script@vignette@dutch_and_molly_3@action", 0, 0, 1, 0);
	func_155(uParam0, "CDNM3AU");
	func_156(uParam0, 18665219, 106996832);
	func_157(uParam0, uLocal_17, -1, 0.89f);
	func_158(uParam0, iLocal_14, 2, 1677569809, "PROP_HUMAN_SEAT_CHAIR_CIGAR_MALE_D", -1, 0);
	func_159(uParam0, iLocal_14, 2, 1677569809, "PROP_HUMAN_SEAT_CHAIR_CIGAR_MALE_D", -1, 0, -1073741824, 1065353216, 1);
...
void func_164(var uParam0, int iParam1, float fParam2)
{
	if (fParam2 == -2f)
	{
...
int func_388(int iParam0, bool bParam1, bool bParam2, var uParam3, var uParam4, var uParam5, float fParam6, bool bParam7, bool bParam8, bool bParam9, bool bParam10)
{
	...
	switch (((*Global_1360165)[iParam0 /*1157*/])->f_70.f_12)
	{
		...
		case 3:
			...
			sVar12 = func_423(iParam0, func_287());
	...
	switch (iParam1)
	{
		...
		case 7:
			switch (iParam0)
			{
				...
				case 4:
					if (func_328(747937920, 1) && !func_391(((*Global_1347702)[1 /*49*/])->f_15, 1))
					{
						iVar1[0] = -1155031950;
					}
					else
