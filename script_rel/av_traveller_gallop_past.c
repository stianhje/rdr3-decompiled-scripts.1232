...
{
	func_33(uParam0, 11056/*func_30*/, 11114/*func_31*/, 11619/*func_32*/);
}
	...
	switch (iLocal_9)
	{
		case 0:
			if (!ENTITY::IS_ENTITY_DEAD(&(uParam0->f_20[0 /*14*/])))
			{
				...
				{
					func_75(&(uParam0->f_20[1 /*14*/]), (uParam0->f_20[0 /*14*/])->f_5, fVar0, 2, 1073741824);
					func_76(&(uParam0->f_20[0 /*14*/]), &(uParam0->f_20[1 /*14*/]), 1, -1, 1);
				}
				else if (!ENTITY::IS_ENTITY_DEAD(uParam0->f_453))
				{
					func_75(uParam0->f_453, (uParam0->f_20[0 /*14*/])->f_5, fVar0, 2, 1073741824);
...
void func_52(var uParam0, char* sParam1, var uParam2, vector3 vParam3, var uParam6, int iParam7, int iParam8, int iParam9, int iParam10)
{
...
void func_55(var uParam0, int iParam1, char* sParam2, int iParam3, vector3 vParam4, var uParam7, int iParam8, int iParam9, int iParam10, int iParam11, int iParam12, int iParam13)
{
...
int func_146(int iParam0, bool bParam1, int iParam2, bool bParam3)
{
	...
	{
		return func_196(bParam1, iParam2, bParam3);
	}
	if (Global_1572887->f_12 != -1)
	{
...
float func_208(int iParam0, int iParam1, bool bParam2, int iParam3)
{
...
int func_227(bool bParam0, var uParam1, var uParam2)
{
	int iVar0;
	int iVar1;
