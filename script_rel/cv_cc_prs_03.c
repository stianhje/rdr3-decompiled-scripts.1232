...
{
	if (ENTITY::HAS_ANIM_EVENT_FIRED(func_8(uParam0, iLocal_14), 1044034326) || !func_9(func_8(uParam0, iLocal_14), 1435919172))
	{
		TASK::_0x6EF4E31B4D5D2DA0((uParam0->f_107[iLocal_14 /*113*/])->f_32.f_21, "KNIFE");
		STREAMING::_0x66BC28E50E85270E(uLocal_42);
		return 1;
	}
	return 0;
}
...
void func_48(var uParam0, char* sParam1, int iParam2, int iParam3)
{
...
int func_73(var uParam0)
{
	...
	func_153(uParam0, 1f, 0.8f, 0f, 0f, 3f, 6f, 5f, -1612834106, -1386303207, 1, 1, 1);
	func_154(uParam0, 489231067, 0f, 0f, 0f, "CARCASS", 0, 0, 1);
	iLocal_20 = func_154(uParam0, 1433326914, 0f, 0f, 0f, "LEG", 0, 1, 1);
	iLocal_21 = func_154(uParam0, joaat("p_knife03x"), 0f, 0f, 0f, "KNIFE", 0, 1, 1);
	func_154(uParam0, 37759582, 0f, 0f, 0f, "SAW", 0, 0, 1);
	func_154(uParam0, joaat("p_bottlejd01x"), 0f, 0f, 0f, "BOTTLE", 0, 0, 1);
	func_155(uParam0, "script@vignette@pearson_3@base_intro", 1, 1, 0, 0);
	iLocal_15 = func_155(uParam0, "script@vignette@pearson_3@action_a_front", 2, 0, 0, 1);
	iLocal_16 = func_155(uParam0, "script@vignette@pearson_3@action_a_back", 2, 0, 0, 1);
	...
	func_157(uParam0, iLocal_14, 4, 1939042559, "PROP_HUMAN_BUTCHER_DEER_MALE_A_LEG_SLICE", -1, 0, -1073741824, 1065353216, 1);
	...
	Local_22 = { func_162(uParam0, 1.6307f, 2.9087f, 1.0166f, -66.9355f, 6f, 1f, 0.143f) };
	Local_32 = { func_162(uParam0, 1.631f, 2.909f, 1.017f, 71.64f, 4.3f, 0.5f, 0.5f) };
	func_163(uParam0, 1);
...
{
	uLocal_42 = STREAMING::_0xB223249B7798EEED(func_8(uParam0, iLocal_14), 1939042559, 262145, 1298822494);
	return 1;
}

int func_88(var uParam0)
{
	if (func_195(uParam0, Local_22, 1, 0))
	{
		iLocal_19 = iLocal_15;
		return 1;
	}
	else if (func_195(uParam0, Local_32, 1, 0))
	{
		iLocal_19 = iLocal_16;
		return 1;
	}
...
int func_92(var uParam0)
{
	...
	iVar0 = func_198(func_21(uParam0));
	func_199(iVar0);
...
int func_144(var uParam0)
{
	...
	while (iVar0 < uParam0->f_106)
	{
		...
		else
		{
			...
			{
				if (func_123((uParam0->f_107[iVar0 /*113*/])->f_1, 29, 1) || func_247((uParam0->f_107[iVar0 /*113*/])->f_1))
				{
					return 1;
				}
				if (!uParam0->f_3)
...
void func_151(var uParam0, vector3 vParam1, vector3 vParam4)
{
...
void func_158(var uParam0, int iParam1, int iParam2, int iParam3)
{
	...
	{
		case 4:
			(uParam0->f_107[iParam1 /*113*/])->f_32.f_5 = { func_260(func_149(uParam0), func_259(uParam0, iParam1), func_21(uParam0), 1) };
			break;
		default:
			Var0 = { func_261(func_149(uParam0), func_259(uParam0, iParam1), func_21(uParam0), 1) };
...
void func_159(var uParam0, int iParam1, int iParam2, char* sParam3, int iParam4, char* sParam5)
{
	int iVar0;
	...
	while (iVar3 < uParam0->f_106)
	{
		...
		else if ((uParam0->f_107[iVar3 /*113*/])->f_8.f_14)
		{
			...
			else if (ANIMSCENE::_0x3AB6C7B0BB0DF4B1((uParam0->f_107[iVar3 /*113*/])->f_5, -1))
			{
				...
				{
					func_48(uParam0, "Create ped check - Ped is in an animscene", 30, iVar3);
					iVar1 = 0;
				}
				else
				{
					...
					if (func_211(vVar4))
					{
						func_48(uParam0, "Start location is zero?", 10, iVar3);
					}
					else
					{
...
int func_194(var uParam0, int iParam1, bool bParam2)
{
	...
	if (uParam0->f_2270)
	{
		uParam0->f_2274 = 0;
		uParam0->f_2275 = 0;
		if ((func_113() && ANIMSCENE::_0x6F1F0B17109309DA(uParam0->f_2046, "ARTHUR")) || (func_288() && ANIMSCENE::_0x6F1F0B17109309DA(uParam0->f_2046, "JOHN")))
		{
			uParam0->f_2274 = 1;
		}
	}
	if (bParam2)
	{
		...
		while (iVar1 < uParam0->f_1984)
		{
			...
			else if (func_298(uParam0, iVar1) || func_203(uParam0, iVar1))
			{
...
int func_195(var uParam0, struct<4> Param1, var uParam5, var uParam6, var uParam7, var uParam8, var uParam9, var uParam10, bool bParam11, bool bParam12)
{
	if (bParam11)
	{
		if (!func_300(func_21(uParam0), 1))
		{
			return 0;
		}
	}
...
int func_310(var uParam0, int iParam1)
{
	...
	{
		if (!func_9((uParam0->f_107[iParam1 /*113*/])->f_5, 1435919172))
		{
			return 1;
		}
	}
		...
		else if (func_21(uParam0) == 355)
		{
			if (iVar3 == 5)
			{
				if (uParam0->f_3)
				{
					...
					else if (func_368(iVar3, func_100(uParam0->f_7), 1))
					{
					}
					else if (func_370(&uVar2, func_369(iVar3)))
					{
						...
						else
						{
							...
							if (bParam2)
							{
								...
								if (!func_371(iVar0, func_100(uParam0->f_7), 0, -1))
								{
									return -1;
								}
								return iVar0;
...
int func_338(int iParam0, bool bParam1)
{
	...
	{
		func_237(iParam0, _NAMESPACE48::_0x4F76E3676583D951(func_133(iParam0)));
		if (func_225() == -1)
		{
...
int func_393(int iParam0, bool bParam1, bool bParam2, var uParam3, var uParam4, var uParam5, float fParam6, bool bParam7, bool bParam8, bool bParam9, bool bParam10)
{
	...
	switch (((*Global_1360165)[iParam0 /*1157*/])->f_70.f_12)
	{
		...
		case 3:
			...
			sVar12 = func_428(iParam0, func_288());
...
void func_395(int iParam0, bool bParam1, bool bParam2, bool bParam3)
{
	...
	if (bParam3)
	{
		func_429(func_105(iParam0), 1f, 0);
	}
	if (bParam1)
	{
		func_430(iParam0);
		...
		case 7:
			switch (iParam0)
			{
				...
				case 14:
					...
					break;
				case 4:
					if (func_330(747937920, 1) && !func_396(((*Global_1347702)[1 /*49*/])->f_15, 1))
					{
						iVar1[0] = -1155031950;
					}
					else
