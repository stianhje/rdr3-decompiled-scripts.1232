...
int func_72(var uParam0)
{
	...
	iLocal_15 = func_151(uParam0, "script@ambient@campfiregeneral@dog_jump_up_down_bed@action", 0, 0, 0, 0);
	func_152(uParam0, 0.3015f, 0.0164f, 1.0827f, -76.75f, 1.9375f, 1.5675f, 3f, -1612834106, -1, 1, 1, 1);
	switch (func_19(uParam0))
	{
		case 3:
			func_153(uParam0, iLocal_14, 3, 825624686, "WORLD_ANIMAL_DOG_RESTING", -1, 0);
...
int func_85(var uParam0)
{
	...
	{
		func_185(uParam0);
		func_169(uParam0, uParam0->f_2047, 1);
	}
...
{
	func_187(uParam0, iLocal_15, "b_breakout", 1);
	return 1;
}
...
int func_91(var uParam0)
{
	...
	if (uParam0->f_2048 >= 0)
	{
		func_169(uParam0, uParam0->f_2048, 1);
	}
	func_193(uParam0);
...
void func_163(var uParam0, vector3 vParam1, vector3 vParam4)
{
	int iVar0;
...
int func_168(var uParam0, int iParam1, bool bParam2)
{
	int iVar0;
	struct<4> Var1;
	int iVar5;
...
int func_169(var uParam0, int iParam1, bool bParam2)
{
	...
	if (bParam2)
	{
		...
		while (iVar1 < uParam0->f_1984)
		{
			...
			else if (func_273(uParam0, iVar1) || func_274(uParam0, iVar1))
			{
				func_275(uParam0, iVar1);
			}
			iVar1++;
		}
	}
...
int func_187(var uParam0, int iParam1, char* sParam2, bool bParam3)
{
	int iVar0;
