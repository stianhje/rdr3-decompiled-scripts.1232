...
int func_72(var uParam0)
{
	...
	iLocal_18 = func_152(uParam0, -1971689092, 0f, 0f, 0f, "BOTTLE", 0, 0, 1);
	func_152(uParam0, -1074884633, 0f, 0f, 0f, "RAG", 0, 0, 1);
	func_153(uParam0, iLocal_14, -916314281, "REVOLVER");
...
int func_153(var uParam0, int iParam1, int iParam2, char* sParam3)
{
	int iVar0;
