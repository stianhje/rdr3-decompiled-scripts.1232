...
int func_72(var uParam0)
{
	...
	func_151(uParam0, 1.1084f, -1.7496f, 0.5579f, 34.7662f, 1.5f, 1.5f, 3f, -1612834106, 1267380940, 1, 1, 1);
	func_151(uParam0, -1.3f, 1.5f, 0.558f, 35.28f, 3f, 1.5f, 3f, -1612834106, -1495061186, 1, 1, 1);
	func_151(uParam0, -1.37f, -1.14f, 0.558f, 34.2f, 1.5f, 2.3f, 3f, -1612834106, -1, 1, 1, 1);
	...
	func_154(uParam0, "script@vignette@hosea_8@intro_base", 1, 1, 0, 0);
	iLocal_19 = func_154(uParam0, "script@vignette@hosea_8@action_a", 2, 0, 1, 0);
	iLocal_20 = func_154(uParam0, "script@vignette@hosea_8@action_b", 0, 0, 0, 0);
	iLocal_21 = func_154(uParam0, "script@vignette@hosea_8@action_b_alt", 0, 0, 0, 1);
	func_155(uParam0, "HSH8AUD");
	func_156(uParam0, iLocal_16, 3, -1426662425, "PROP_HUMAN_SEAT_CHAIR_GENERIC_MALE_D", -1, 0);
	func_157(uParam0, iLocal_14, 2, -1074764191, "PROP_CAMP_FIRE_SEAT_BENCH_MALE_B", -1, 0, -1073741824, 1065353216, 1);
	func_157(uParam0, iLocal_17, 2, -2036140949, "PROP_HUMAN_SEAT_BENCH_PORCH_DRINKING_MALE_A", -1, 0, -1073741824, 1065353216, 1);
	func_158(uParam0, iLocal_17, iLocal_18, "p_bottleJD01x_ph_r_hand", 0, 0);
	func_156(uParam0, iLocal_15, 3, -1133174268, "PROP_HUMAN_SEAT_CHAIR_PORCH_FEMALE_B", -1, 0);
	func_157(uParam0, iLocal_15, 2, -1133174268, "PROP_HUMAN_SEAT_CHAIR_PORCH_FEMALE_B", -1, 0, -1073741824, 1065353216, 1);
	Local_22 = { func_159(uParam0, 1.2084f, -1.8996f, 0.5579f, 34.7662f, 8f, 0.7f, 0.7f) };
	return 1;
}
...
int func_153(var uParam0, var uParam1, int iParam2, char* sParam3)
{
	int iVar0;
