	...
	while (func_3())
	{
		if (MISC::GET_GAME_TIMER() > iLocal_32)
		{
			...
			switch (iLocal_31)
			{
				...
				case 1:
					func_5(iLocal_33);
					if (func_7(func_6(iLocal_33)))
					{
						func_8(func_6(iLocal_33), 4);
					}
					LAW::_0x9BBDCB8DF789EBC1(PLAYER::PLAYER_ID(), func_9(iLocal_33));
					iVar1 = func_10(iLocal_33);
					if (iVar1 != -1)
					{
				...
				case 2:
					...
					break;
				case 3:
					if (func_13(iLocal_33) || iLocal_34 < MISC::GET_GAME_TIMER())
					{
						func_14(iLocal_33);
						iLocal_34 = (MISC::GET_GAME_TIMER() + iLocal_30);
						iLocal_31 = 4;
				...
				case 6:
					if (func_7(func_6(iLocal_33)))
					{
						if (func_17(func_6(iLocal_33), 4) && !iLocal_34 < MISC::GET_GAME_TIMER())
						{
						}
						else
						{
							if (func_18(iLocal_33) || iLocal_34 < MISC::GET_GAME_TIMER())
							{
								func_19(iLocal_33, 4);
								iLocal_34 = (iLocal_30 + MISC::GET_GAME_TIMER());
								iLocal_31 = 7;
							...
							Jump @807; //curOff = 475
							if (iLocal_34 < MISC::GET_GAME_TIMER() || (func_20() != 0 || Global_1051260->f_3790))
							{
								func_21(iLocal_33);
								func_22();
								if (!func_23(2057, 0))
							...
							func_34(iLocal_33, Global_1898004);
							iLocal_31 = 10;
							Jump @807; //curOff = 616
							func_35(iLocal_33);
							if (func_20() != -1)
							...
							func_39(Global_1898004, iLocal_33);
							func_40(iLocal_33);
							func_19(iLocal_33, 8);
							if (func_41())
							{
...
void func_5(int iParam0)
{
	...
	func_46(-327351684, 1, -1f, 1, 1, 0, 0, 0);
	func_46(406215150, 1, 1f, 1, 1, 0, 0, 0);
	func_47(1934463007, 0, 0);
...
void func_28(int iParam0)
{
	...
	if (!func_53(iVar1, 0))
	{
		func_54(iVar0, iLocal_15, 1);
		func_54(735, iLocal_15, 0);
		VOLUME::_0x4A8FEFC43FD8AC9B(iLocal_15, 3, 1);
		VOLUME::_0x53D05D60E5F5B40C(iLocal_15, 3, 1, func_55(iVar0));
		VOLUME::_0x53D05D60E5F5B40C(iLocal_15, 3, 1, func_55(735));
...
void func_39(var uParam0, int iParam1)
{
	...
	if (func_20() == -1)
	{
		if (func_72() != bVar0)
		{
			...
			func_73();
			func_74(Global_1310750->f_16071, 0, iVar4, 0, 0);
		}
	}
	func_75(bVar0);
	if (func_20() == -1)
	{
		func_77((iParam1 == func_76() && bVar0));
	}
}
...
void func_46(int iParam0, bool bParam1, int iParam2, bool bParam3, bool bParam4, float fParam5, int iParam6, bool bParam7)
{
	func_47(iParam0, 0, 0);
	if (func_87(iParam0))
	{
		...
		if (bParam3)
		{
			func_88(iParam0, iParam2, 1, iParam6);
		}
		else if (bParam1)
		{
			if (bParam4)
...
void func_59()
{
	if (!func_102(vLocal_26))
	{
		func_103(&uLocal_20, vLocal_26, 2, -1082130432);
	}
}
...
void func_60()
{
	...
	if (func_104(func_52(735), 0) && !iLocal_29)
	{
		PED::_0x24C82EF607105FAA(func_52(735), -1049646341);
		iLocal_29 = 1;
	}
	else if (!func_104(func_52(735), 0) && iLocal_29)
	{
		iLocal_29 = 0;
	}
}
...
void func_61()
{
	...
	iVar0 = _NAMESPACE48::_0x112DDF56300BC6E5(-1956453623);
	if (!_NAMESPACE48::_0x800DF3FC913355F3(iVar0))
	{
...
void func_69(int iParam0, int iParam1, int iParam2, bool bParam3, int iParam4, int iParam5)
{
	var uVar0;
	char* sVar1;
	char* sVar2;
	...
	sVar1 = func_107(iParam0, iParam1, iParam2, iParam4, iParam5, bParam3, &uVar0);
	...
	if (func_108(iParam4))
	{
		iVar3 = func_110(iParam4);
	}
	if (uVar0 && bParam3)
	{
		sVar2 = func_112(func_111(iParam2));
	}
	...
	else if ((func_57(iParam0) && func_86(iParam0, 16777216)) && !Global_1894899->f_9)
	{
	...
	{
		iVar4 = func_116(func_115());
		iVar5 = func_117(func_115());
		if (iVar5 < 10)
		{
		...
		if (!MISC::_SHOULD_USE_24_HOUR_CLOCK())
		{
			...
			{
				fVar7 = func_118(fVar7);
				sVar8 = "TIME_AND_TEMP_F";
			}
			IntToString(&sVar10, BUILTIN::ROUND(fVar7), 8);
			sVar2 = MISC::_CREATE_VAR_STRING(674, sVar8, iVar4, func_119(&sVar6, 109029619), sVar9, func_119(&sVar10, 109029619));
		}
		else
		{
			...
			IntToString(&sVar10, BUILTIN::ROUND(fVar7), 8);
			sVar2 = MISC::_CREATE_VAR_STRING(162, sVar8, iVar4, func_119(&sVar6, 109029619), func_119(&sVar10, 109029619));
		}
		Global_1894899->f_9 = 0;
	}
	Global_1934266->f_148 = func_120(sVar1, sVar2, 4000, 0, 0, 0, 0, 1);
}
...
void func_71(int iParam0, bool bParam1)
{
	...
	func_125(func_124(-1532769513, -36357794), 1);
	switch (func_6(iParam0))
	{
		case 0:
		case 2:
		case 11:
			func_125(func_124(-1532769513, 213519508), 1);
			break;
		case 1:
		case 5:
		case 6:
		case 7:
		case 12:
			func_125(func_124(-1532769513, 242571679), 1);
			break;
		case 3:
		case 10:
			func_125(func_124(-1532769513, 1349449307), 1);
			break;
		case 4:
		case 9:
			func_125(func_124(-1532769513, 1140362070), 1);
			break;
		case 8:
			func_125(func_124(-1532769513, -172330899), 1);
			break;
		case 13:
		case 14:
		case 15:
		case 16:
			func_125(func_124(-1532769513, -910218296), 1);
			break;
	}
	switch (iParam0)
	{
...
bool func_72()
{
	return (Global_1894899 & 1 != 0 && func_126() != -1);
}
...
void func_74(int iParam0, bool bParam1, int iParam2, bool bParam3, bool bParam4)
{
	...
	while (iVar0 < 4)
	{
		...
		if (((func_127(iVar1) && !func_130(iVar1, iParam2)) && (!bParam3 || !func_131(iVar1))) && (!bParam4 || !func_132(iVar1)))
		{
			if (iVar1 != iParam0)
			{
				func_133(iVar0);
...
void func_84(int iParam0)
{
	...
	while (iVar1 < 4)
	{
		func_139(&((Global_1392240->f_1[iVar0 /*18*/])->f_6[iVar1]));
...
int func_98(int iParam0, bool bParam1)
{
	...
	{
		func_144(iParam0, _NAMESPACE48::_0x4F76E3676583D951(func_143(iParam0)));
		if (func_20() == -1)
		{
			if (func_140(iParam0, 2048))
			{
				_NAMESPACE48::_0x49A8C2CD97815215(func_55(iParam0));
				func_145(iParam0, 2048);
			}
			_NAMESPACE48::_0xFCC6DB8DBE709BC8(func_55(iParam0));
		}
		return 0;
	}
	...
	func_144(iParam0, _NAMESPACE48::_0x4F76E3676583D951(func_143(iParam0)));
	_NAMESPACE48::_0x4F81EAD1DE8FA19B(func_55(iParam0));
	if (func_140(iParam0, 2048))
	{
		_NAMESPACE48::_0x49A8C2CD97815215(func_55(iParam0));
		func_145(iParam0, 2048);
...
bool func_99(int iParam0, int iParam1)
{
	...
	if (iParam1 && !ENTITY::DOES_ENTITY_EXIST(func_52(iParam0)))
	{
		return false;
	}
...
int func_103(var uParam0, vector3 vParam1, int iParam4, float fParam5)
{
	char* sVar0;
	...
	if (func_147(uParam0->f_1, 1))
	{
		if (GRAPHICS::DOES_PARTICLE_FX_LOOPED_EXIST(*uParam0))
		{
			...
			{
				func_148(uParam0, vParam1, iParam4, fParam5);
			}
			else
			{
				func_149(uParam0, vParam1, iParam4, fParam5);
			}
		}
		return 1;
	}
	...
	if (STREAMING::HAS_NAMED_PTFX_ASSET_LOADED(-458373790))
	{
		if (!func_147(uParam0->f_1, 8))
		{
			if (!GRAPHICS::DOES_PARTICLE_FX_LOOPED_EXIST(*uParam0))
			{
				...
				*uParam0 = GRAPHICS::START_PARTICLE_FX_LOOPED_AT_COORD(sVar0, vParam1, 0f, 0f, 0f, func_154(iParam4), false, false, false, false);
				uParam0->f_4 = MISC::GET_FRAME_COUNT();
				if (func_155(vParam1, 1) > (CAM::GET_GAMEPLAY_CAM_FOV() + 15f))
				{
...
char* func_107(int iParam0, int iParam1, int iParam2, int iParam3, var uParam4, var uParam5, var uParam6)
{
	char* sVar0;

	if (!MISC::IS_STRING_NULL_OR_EMPTY(&(Global_1894899->f_162)))
	{
		sVar0 = func_161(Global_1894899->f_162);
	}
	if (MISC::IS_STRING_NULL_OR_EMPTY(sVar0) && uParam4)
	{
		sVar0 = func_163(func_162(Global_36));
	}
...
char* func_119(char* sParam0, int iParam1)
{
	...
	return func_166(MISC::_CREATE_VAR_STRING(10, "LITERAL_STRING", sParam0), iParam1);
}

var func_120(char* sParam0, char* sParam1, int iParam2, int iParam3, int iParam4, int iParam5, int iParam6, int iParam7)
{
	struct<4> Var0;
	vector3 vVar13;
	var uVar16;
...
int func_122(int iParam0)
{
	...
	if (func_167())
	{
		if (!func_168(((*Global_1835011)[3 /*74*/])->f_1, 1))
		{
...
{
	func_172((Global_1935369->f_5[iParam0 /*11*/])->f_6, 1);
	func_173((Global_1935369->f_5[iParam0 /*11*/])->f_6, 0);
...
void func_137(int iParam0)
{
	...
	{
		func_176((Global_1914319->f_3[iParam0 /*446*/])->f_21, 0, 1, 0, 0);
	}
	...
	func_177((Global_1914319->f_3[iParam0 /*446*/])->f_10, 0);
	...
	else
	{
		...
		while (iVar0 < iVar1)
		{
			func_139(&((Global_1914319->f_3[iParam0 /*446*/])->f_317[iVar0 /*6*/]));
...
void func_148(var uParam0, vector3 vParam1, int iParam4, float fParam5)
{
	float fVar0;

	fParam5 = func_185(vParam1, fParam5);
	fVar0 = func_186(fParam5, iParam4);
	if (fVar0 < 1f)
	{
		GRAPHICS::_0x9DDC222D85D5AF2A(*uParam0, uParam0->f_3);
...
void func_149(var uParam0, vector3 vParam1, int iParam4, float fParam5)
{
	float fVar0;
	float fVar1;
	float fVar2;
	...
	{
		fParam5 = func_185(vParam1, fParam5);
		fVar1 = func_186(fParam5, iParam4);
		uVar3 = func_187(uParam0->f_2, uParam0->f_3, fVar0);
		fVar2 = func_187(0f, fVar1, fVar0);
	}
	GRAPHICS::_0x9DDC222D85D5AF2A(*uParam0, uVar3);
	GRAPHICS::SET_PARTICLE_FX_LOOPED_ALPHA(*uParam0, fVar2);
}

var func_150(float fParam0)
{
	var uVar0;

	uVar0 = func_188(fParam0);
	return uVar0;
}
...
float func_155(vector3 vParam0, bool bParam3)
{
	vector3 vVar0;
	vector3 vVar3;

	vVar0 = { func_189(0) };
	vVar3 = { func_190(vParam0 - CAM::GET_GAMEPLAY_CAM_COORD()) };
	if (bParam3)
	{
...
char* func_161(var uParam0, var uParam1, var uParam2, var uParam3, var uParam4, var uParam5, var uParam6, var uParam7)
{
...
float func_185(vector3 vParam0, float fParam3)
{
	if (fParam3 > 0f)
	{
		return fParam3;
...
float func_186(float fParam0, int iParam1)
{
	float fVar0;

	fVar0 = (2f * BUILTIN::SIN((180f * (fParam0 / func_151(iParam1)))));
	if (fVar0 < 0f)
	{
		return 0f;
	}
...
Vector3 func_189(int iParam0)
{
	...
	return func_190((-fVar6 * fVar3), (fVar6 * fVar4), fVar5);
}
...
int func_196(vector3 vParam0, int iParam3)
{
	...
	func_211(iParam3, &vVar0, &Var3, &fVar6);
	if (func_212(vParam0, vVar0, Var3, Var3.f_1, fVar6))
	{
		return 1;
	}
	return 0;
...
bool func_212(vector3 vParam0, vector3 vParam3, float fParam6, float fParam7, float fParam8)
{
	vector3 vVar0;
	struct<2> Var3;
	float fVar6;
