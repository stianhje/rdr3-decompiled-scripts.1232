...
void __EntryFunction__()
{
	...
	fLocal_7 = 1f;
	fLocal_8 = 1f;
	vLocal_19 = { -1621.644f, -1390.907f, 82.7807f };
	Var0 = -1;
	Var0.f_1 = -1;
	Var0.f_2 = -1;
	Var0.f_17 = 10;
...
int func_1(var uParam0)
{
	if (iLocal_18)
	{
		VEHICLE::SET_VEHICLE_DOORS_LOCKED(Global_36602, 1);
	}
	return 1;
}
...
int func_72(var uParam0)
{
	...
	func_151(uParam0, -0.625f, 0.4125f, 0f, 0f, 2.4425f, 3.0175f, 5f, -1612834106, -1, 1, 1, 1);
	func_152(uParam0, 1058703817, 0f, 0f, 0f, "HAMMER", 0, 0, 1);
	iLocal_16 = func_153(uParam0, "script@vignette@beecher@charles_and_uncle_5@base", 1, 1, 0, 0);
	iLocal_17 = func_153(uParam0, "script@vignette@beecher@charles_and_uncle_5@action", 0, 0, 1, 0);
	func_154(uParam0, "BCNU5AU");
	func_155(uParam0, 947758399, -2066934724);
	func_156(uParam0, iLocal_14, 3, -472287783, "PROP_HUMAN_REPAIR_WAGON_WHEEL_ON_LARGE_MALE_A", -1, 0);
	func_157(uParam0, iLocal_14, 1, -1);
	func_156(uParam0, iLocal_15, 3, -1043454001, "WORLD_HUMAN_SIT_GROUND_TIRED_MALE_A", -1, 0);
	func_157(uParam0, iLocal_15, 1, -1);
	func_158(uParam0, iLocal_15, 2, -1043454001, "WORLD_HUMAN_SIT_GROUND_TIRED_MALE_A", -1, 0, -1073741824, 1065353216, 1);
	if (!ENTITY::DOES_ENTITY_EXIST(Global_36602))
	{
...
int func_83(var uParam0)
{
	if (ENTITY::DOES_ENTITY_EXIST(Global_36602))
	{
		if (PED::IS_PED_IN_VEHICLE(Global_35, Global_36602, true))
		{
			return 0;
		}
		if (!iLocal_18)
		{
			VEHICLE::SET_VEHICLE_DOORS_LOCKED(Global_36602, 2);
			iLocal_18 = 1;
			func_172(Global_36602, &(uParam0->f_1984[iLocal_16]), "CART");
			func_172(Global_36602, &(uParam0->f_1984[iLocal_17]), "CART");
		}
	}
	return iLocal_18;
}
...
void func_172(int iParam0, int iParam1, char* sParam2)
{
