		...
		switch (Var0)
		{
			...
			case 2:
				...
				else
				{
					...
					{
						TASK::_0xB35370D5353995CB(Global_35, -541529715, 1048576000);
					}
					func_4(&Var0, 3);
				}
				break;
...
void func_11(float fParam0, int iParam1)
{
	float fVar0;
	int iVar1;
...
int func_16(var uParam0, var uParam1, float fParam2)
{
	if (func_25() != -1)
	{
		return 1;
...
void func_23(int iParam0, bool bParam1, bool bParam2, int iParam3)
{
	...
	if (iParam3 || func_9(iParam0, -537818634))
	{
	...
	switch (iParam0)
	{
		...
		case 433340626:
		case 1895068170:
			func_52(func_55(1368284188, 1199394531), 1);
			break;
		case 1929383243:
		case 2036955137:
...
var func_27(var uParam0, char* sParam1, int iParam2, int iParam3, int iParam4, int iParam5, int iParam6, int iParam7)
{
	struct<7> Var0;
...
var func_58(var uParam0, var uParam1)
{
