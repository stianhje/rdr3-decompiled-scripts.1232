...
void func_6()
{
	...
	{
		case 0:
			iLocal_7 = CAM::CREATE_CAMERA_WITH_PARAMS(26379945, -287.0813f, 818.8734f, 119.85f, -11.269f, 0f, -171.0697f, 50f, false, 2);
			func_15(1);
			func_16(1);
			break;
		case 1:
		...
		case 2:
			...
			iLocal_8 = CAM::CREATE_CAMERA_WITH_PARAMS(26379945, vLocal_19, vLocal_22, 40f, false, 2);
