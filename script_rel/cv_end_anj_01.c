...
int func_72(var uParam0)
{
	...
	func_152(uParam0, -2102031605, 0f, 0f, 0f, "BOOK", 0, 0, 1);
	func_152(uParam0, -1335015498, 0f, 0f, 0f, "KNITTING", 0, 1, 1);
...
void func_200(var uParam0, int iParam1, int iParam2, float fParam3)
{
	if (iParam2 == -1)
	{
		iParam2 = 0;
