...
int func_72(var uParam0)
{
	...
	func_151(uParam0, -1.4f, 0.55f, 0.5f, 0f, 0.5f, 0.5f, 3f, 665633627, 1);
	func_152(uParam0, 264325500, 0f, 0f, 0f, "BASKET", 0, 0, 1);
	func_152(uParam0, joaat("p_cs_book03x"), 0f, 0f, 0f, "BOOK", 0, 0, 1);
	func_152(uParam0, joaat("p_cs_knitting01x"), 0f, 0f, 0f, "KNITTING", 0, 1, 1);
	func_153(uParam0, "script@vignette@beecher@abigail_and_jack_1@base", 1, 1, 0, 0);
	iLocal_16 = func_153(uParam0, "script@vignette@beecher@abigail_and_jack_1@action_a", 2, 0, 1, 0);
	iLocal_17 = func_153(uParam0, "script@vignette@beecher@abigail_and_jack_1@action_b", 2, 0, 0, 0);
	iLocal_18 = func_153(uParam0, "script@vignette@beecher@abigail_and_jack_1@action_b_front", 2, 0, 0, 1);
	iLocal_19 = func_153(uParam0, "script@vignette@beecher@abigail_and_jack_1@action_b_left", 2, 0, 0, 1);
	iLocal_21 = func_153(uParam0, "script@vignette@beecher@abigail_and_jack_1@action_b_seated", 2, 0, 0, 1);
	iLocal_20 = func_153(uParam0, "script@vignette@beecher@abigail_and_jack_1@action_b_right", 2, 0, 0, 1);
	iLocal_23 = func_153(uParam0, "script@vignette@beecher@abigail_and_jack_1@JACK_EXIT_STAND", 0, 0, 0, 0);
	func_154(uParam0, "BANJ1AU");
	func_155(uParam0, -40706570, -709196539);
	func_156(uParam0, iLocal_14, 2, 1530228672, "PROP_HUMAN_SEAT_CHAIR_KNITTING_FEMALE_A", -1, 1);
	func_157(uParam0, iLocal_14, 2, 1530228672, "PROP_HUMAN_SEAT_CHAIR_KNITTING_FEMALE_A", -1, 0, -1073741824, 1065353216, 1);
	func_158(uParam0, iLocal_14, 1, -1);
	func_158(uParam0, iLocal_15, 1, -1);
	func_159(uParam0, 2f, 5f);
	Local_24 = { func_160(uParam0, -0.365f, 1.782f, 0.982f, 180f, 4.455f, 0.125f, 0.5075f) };
	Local_34 = { func_160(uParam0, -0.365f, 1.782f, 0.982f, -164.75f, 5.2275f, 0.405f, 0.04f) };
	Local_44 = { func_160(uParam0, -0.365f, 1.782f, 0.982f, -107.5f, 5.2275f, 0.205f, 0.228f) };
	Local_54 = { func_160(uParam0, -0.365f, 1.782f, 0.982f, 97.75f, 3.4875f, 0.4025f, 0.0875f) };
	return 1;
}
...
void func_159(var uParam0, float fParam1, float fParam2)
{
		...
		else
		{
			...
			else
			{
				...
				while (iVar6 < uParam0->f_1984)
				{
					...
					{
						func_287((uParam0->f_1711[iVar0 /*15*/])->f_10, &(uParam0->f_1984[iVar6]), (uParam0->f_1711[iVar0 /*15*/])->f_4);
					}
					iVar6++;
				}
			}
			...
			else
			{
				...
				else
				{
					...
					while (iVar2 < uParam0->f_1984)
					{
						...
						{
							func_287((uParam0->f_1967[iVar1 /*4*/])->f_3, &(uParam0->f_1984[iVar2]), (uParam0->f_1967[iVar1 /*4*/])->f_2);
						}
						iVar2++;
					}
				}
...
void func_187(var uParam0)
{
	...
	while (iVar0 < uParam0->f_106)
	{
		...
		{
			func_288((uParam0->f_107[iVar0 /*113*/])->f_1, (uParam0->f_107[iVar0 /*113*/])->f_32.f_40, -1);
		}
		iVar0++;
	}
}
...
void func_189(var uParam0)
{
	...
	if (!uParam0->f_4)
	{
		...
		while (iVar2 < uParam0->f_106)
		{
			...
			{
				uVar0 = func_289(ENTITY::GET_ENTITY_COORDS((uParam0->f_107[iVar2 /*113*/])->f_5, true, false));
				uVar1 = func_289((uParam0->f_107[iVar2 /*113*/])->f_96);
				if (uVar0 || uVar1)
				{
...
int func_190(var uParam0, int iParam1, bool bParam2)
{
	...
	if (bParam2)
	{
		...
		while (iVar1 < uParam0->f_1984)
		{
			...
			else if (func_293(uParam0, iVar1) || func_198(uParam0, iVar1))
			{
...
int func_191(var uParam0)
{
	...
	if (func_22() == 3)
	{
		if (func_295(Global_35, 1))
		{
			fVar0 = 5f;
			fVar1 = 8f;
		}
	}
	if (func_296(uParam0, fVar0, fVar1))
	{
		return 1;
	}
	return 0;
...
void func_194(int iParam0)
{
	...
	if (func_298(iVar2, iVar0, 0))
	{
		if (func_298(iVar2, iVar1, 0))
		{
	...
	while (iVar0 < uParam0->f_106)
	{
		...
		else
		{
			if ((uParam0->f_107[iVar0 /*113*/])->f_32.f_32 > -1)
			{
				...
				func_299((uParam0->f_107[iVar0 /*113*/])->f_1, uVar1, iVar3, iVar2, 0, 0, 1);
			}
			fVar4 = (uParam0->f_107[iVar0 /*113*/])->f_32.f_35;
			if (fVar4 > 0f)
			{
				func_300((uParam0->f_107[iVar0 /*113*/])->f_1, fVar4);
				func_299((uParam0->f_107[iVar0 /*113*/])->f_1, 3, 0, 1, 0, 0, 1);
			}
		}
		iVar0++;
	}
...
int func_199(var uParam0, struct<4> Param1, var uParam5, var uParam6, var uParam7, var uParam8, var uParam9, var uParam10, bool bParam11, bool bParam12)
{
	...
	if (!func_303(Param1, Param1.f_6, Global_36))
	{
		return 0;
	}
	if (func_303(Param1, Param1.f_3, Global_36))
	{
		return 0;
	}
	if (bParam12)
...
void func_200(var uParam0, var uParam1, int iParam2, float fParam3)
{
	if (iParam2 == -1)
	{
		iParam2 = 0;
...
void func_201(var uParam0, int iParam1, bool bParam2, bool bParam3)
{
	var uVar0;
			...
			if (!(uParam0->f_107[iVar0 /*113*/])->f_32)
			{
				if (func_307(uParam0, iVar0))
				{
					if ((uParam0->f_107[iVar0 /*113*/])->f_32.f_48)
					{
						...
						func_201(uParam0, iVar0, 0, 1);
					}
					else
					{
						func_201(uParam0, iVar0, 1, 1);
					}
...
void func_207(var uParam0)
{
	...
	while (iVar0 < uParam0->f_106)
	{
		if (((uParam0->f_107[iVar0 /*113*/])->f_32.f_60 > 0f && !(uParam0->f_107[iVar0 /*113*/])->f_32.f_62) && func_301(uParam0, (uParam0->f_107[iVar0 /*113*/])->f_32.f_61, (uParam0->f_107[iVar0 /*113*/])->f_32.f_60))
		{
...
int func_258(int iParam0, int iParam1, bool bParam2, int iParam3, int iParam4, bool bParam5, float fParam6)
{
	...
	uVar6 = func_327(vVar0, vVar3.x, iParam1, bParam2, iParam3, iParam4, bParam5, fParam6);
	return uVar6;
}
	...
	while (iVar1 < uParam0->f_106)
	{
		...
		else
		{
			if (func_50((uParam0->f_107[iVar1 /*113*/])->f_7))
			{
				...
				{
					(uParam0->f_107[iVar1 /*113*/])->f_5 = func_328((uParam0->f_107[iVar1 /*113*/])->f_7, 1, 1, 0, 0, 1, 1, (uParam0->f_107[iVar1 /*113*/])->f_6, 0, 0, 0, 0, 0, 0, 0, 0, 0);
					return 0;
					if ((uParam0->f_107[iVar1 /*113*/])->f_102 || (uParam0->f_107[iVar1 /*113*/])->f_103)
					{
						if (!func_50((uParam0->f_107[iVar1 /*113*/])->f_1))
						{
							...
							{
								(uParam0->f_107[iVar1 /*113*/])->f_1 = func_329(uParam0, 1, 1);
							}
							else
							{
								(uParam0->f_107[iVar1 /*113*/])->f_1 = func_329(uParam0, 1, 0);
							}
						}
						if (!func_50((uParam0->f_107[iVar1 /*113*/])->f_1))
						{
					...
					if (!func_330(uParam0, iVar1, (uParam0->f_107[iVar1 /*113*/])->f_1))
					{
						if (!uParam0->f_21)
						{
							return 0;
...
int func_262(var uParam0)
{
	...
	while (iVar0 < uParam0->f_106)
	{
		...
		{
			if (ENTITY::IS_ENTITY_DEAD(func_331(iVar1)))
			{
				func_332(iVar1, 1);
				return 0;
			}
			(uParam0->f_107[iVar0 /*113*/])->f_5 = func_333(iVar1, 0, 0, 1, 1, 1);
			if (!ENTITY::DOES_ENTITY_EXIST((uParam0->f_107[iVar0 /*113*/])->f_5))
			{
				return 0;
			}
...
int func_279(var uParam0, int iParam1, vector3 vParam2)
{
	...
	{
		iVar5 = func_289(ENTITY::GET_ENTITY_COORDS((uParam0->f_107[iParam1 /*113*/])->f_5, true, false));
		iVar6 = func_289((uParam0->f_107[iParam1 /*113*/])->f_96);
		if (iVar5 != iVar6)
		{
...
int func_288(int iParam0, struct<8> Param1, int iParam9)
{
	int iVar0;
	var uVar1;
...
int func_296(var uParam0, float fParam1, float fParam2)
{
	float fVar0;
	int iVar1;
...
void func_299(int iParam0, int iParam1, int iParam2, int iParam3, int iParam4, bool bParam5, bool bParam6)
{
	bool bVar0;
	int iVar1;
...
int func_301(var uParam0, int iParam1, float fParam2)
{
	int iVar0;
...
bool func_303(struct<2> Param0, var uParam2, struct<2> Param3, var uParam5, struct<2> Param6, var uParam8)
{
...
int func_307(var uParam0, int iParam1)
{
	...
	{
		if (!func_335((uParam0->f_107[iParam1 /*113*/])->f_5, 1435919172))
		{
			return 1;
		}
	}
...
int func_327(vector3 vParam0, float fParam3, var uParam4, bool bParam5, int iParam6, int iParam7, bool bParam8, float fParam9)
{
	int iVar0;
	int iVar1;
	vector3 vVar2;
...
int func_328(int iParam0, bool bParam1, bool bParam2, int iParam3, int iParam4, int iParam5, bool bParam6, bool bParam7, bool bParam8, int iParam9, int iParam10, int iParam11, float fParam12, bool bParam13, bool bParam14, bool bParam15, bool bParam16)
{
	var uVar0;
	int iVar1;
		...
		else if (func_19(uParam0) == 355)
		{
			if (iVar3 == 5)
			{
				if (uParam0->f_3)
				{
					...
					else if (func_372(iVar3, func_99(uParam0->f_7), 1))
					{
					}
					else if (func_374(&uVar2, func_373(iVar3)))
					{
						...
						else
						{
							...
							if (bParam2)
							{
								...
								if (!func_375(iVar0, func_99(uParam0->f_7), 0, -1))
								{
									return -1;
								}
								return iVar0;
...
int func_333(int iParam0, bool bParam1, bool bParam2, bool bParam3, int iParam4, bool bParam5)
{
	int iVar0;
	int iVar1;
...
void func_345(var uParam0, int iParam1)
{
	...
	if (fVar0 > 0f)
	{
		func_300((uParam0->f_107[iParam1 /*113*/])->f_1, fVar0);
	}
}
