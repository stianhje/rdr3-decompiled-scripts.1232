...
{
	func_33(uParam0, 10723/*func_30*/, 10739/*func_31*/, 10893/*func_32*/);
}
...
{
	func_46(uParam0, "PUMP_CART", "", vParam1, vParam4);
}
...
{
	if (!STREAMING::HAS_MODEL_LOADED(iLocal_10))
	{
		return 0;
	}
	if (!ENTITY::DOES_ENTITY_EXIST(iLocal_11))
	{
		iLocal_11 = VEHICLE::_0xC239DBD9A57D2A71(1054492269, VEHICLE::_0x6DE03BCC15E81710(uParam0->f_483), 1, 0, 1, 1);
	}
	if (!VEHICLE::_0xBD3C4A2ED509205E(iLocal_11))
	{
		return 0;
	}
	return 1;
	...
	while (iVar12 < uParam0->f_19)
	{
		if ((uParam0->f_20[iVar12 /*14*/])->f_2 != 0)
		{
			...
			if (ENTITY::IS_ENTITY_DEAD(&(uParam0->f_20[iVar12 /*14*/])))
			{
				...
				{
					uParam0->f_20[iVar12 /*14*/] = func_52((uParam0->f_20[iVar12 /*14*/])->f_2, (uParam0->f_20[iVar12 /*14*/])->f_5, (uParam0->f_20[iVar12 /*14*/])->f_8, 1, 1, 0, 1, (uParam0->f_20[iVar12 /*14*/])->f_11, (uParam0->f_20[iVar12 /*14*/])->f_9, 0, 0, 0, 0);
				}
				...
				if (!PED::IS_PED_HUMAN(&(uParam0->f_20[iVar12 /*14*/])))
				{
					if (!func_53(&(uParam0->f_20[iVar12 /*14*/])))
					{
...
int func_38(int iParam0, vector3 vParam1, float fParam4)
{
	...
	if (func_60(vVar0, vVar0 + vVar3, vParam1))
	{
		return 3;
	}
	return 2;
...
int func_47(int iParam0, bool bParam1, int iParam2)
{
	...
	{
		iVar0 = func_72(&(Global_1898164->f_1[0 /*5*/]));
		if (func_73(iVar0) && func_74(((*Global_1347702)[iVar0 /*49*/])->f_12, 131072))
		{
			return 0;
		}
	}
...
bool func_50()
{
	return (Global_1894899 & 1 != 0 && func_58() != -1);
}
...
int func_52(int iParam0, vector3 vParam1, float fParam4, bool bParam5, bool bParam6, int iParam7, bool bParam8, bool bParam9, bool bParam10, bool bParam11, bool bParam12, bool bParam13, bool bParam14)
{
	int iVar0;
...
int func_55(var uParam0, float fParam1, float fParam2, int iParam3, float fParam4, float fParam5)
{
	...
	if ((MISC::GET_FRAME_COUNT() % 8) == 0)
	{
		...
		fVar7 = func_80(Global_36, uParam0->f_483);
		...
		while (iVar0 < uParam0->f_19)
		{
			...
			if (!ENTITY::IS_ENTITY_DEAD(&(uParam0->f_20[iVar0 /*14*/])))
			{
				...
				fVar8 = func_81(Global_35, &(uParam0->f_20[iVar0 /*14*/]), 1);
				if (fVar8 < fVar1)
				{
					return 1;
				}
...
bool func_60(struct<2> Param0, var uParam2, struct<2> Param3, Vector3 vParam5, struct<2> Param6, var uParam8)
{
	return (((Param3 - Param0) * (Param6.f_1 - Param0.f_1)) - ((Param3.f_1 - Param0.f_1) * (Param6 - Param0))) > 0f;
}

int func_61(vector3 vParam0, float fParam3)
{
	int iVar0;
	...
	while (iVar0 < 4)
	{
		...
		{
			if (func_88(vParam0, (Global_1415419->f_9721[iVar0 /*8*/])->f_4, fParam3, 0))
			{
				return 1;
			}
		}
...
int func_62(vector3 vParam0)
{
	...
	while (iVar0 < 10)
	{
		...
		{
			if (func_88(vParam0, (Global_32073.f_2697.f_1495[iVar0 /*4*/])->f_1, 1f, 0))
			{
				return 1;
			}
		}
...
{
	return (BUILTIN::SHIFT_RIGHT(iParam0, 26) & 31 * func_89(MISC::IS_BIT_SET(iParam0, 31), -1, 1)) + 1898;
}
...
void func_70(var uParam0, int iParam1, int iParam2, int iParam3, int iParam4, int iParam5, int iParam6)
{
	func_90(uParam0, iParam6);
	func_91(uParam0, iParam5);
...
void func_86(int iParam0)
{
	if (func_43(iParam0))
	{
		...
		{
			case 1:
				func_107(0, 1, 0, 0, ((Global_1415419->f_19[iParam0 /*12*/])->f_7 / 4), 0, 0, 1);
				func_107(1, 1, 0, 0, ((Global_1415419->f_19[iParam0 /*12*/])->f_7 / 4), 0, 0, 1);
				break;
			
			case 37:
				func_107(60, 1, 0, 0, ((Global_1415419->f_19[iParam0 /*12*/])->f_7 / 4), 0, 0, 1);
				break;
		}
	}
}

void func_87(int iParam0, vector3 vParam1)
{
	int iVar0;
	int iVar1;
	...
	while (iVar0 < 10)
	{
		...
		{
			if (func_88((Global_32073.f_2697.f_1495[iVar0 /*4*/])->f_1, vParam1, 1056964608, 1))
			{
				return;
			}
		}
...
int func_88(vector3 vParam0, vector3 vParam3, float fParam6, bool bParam7)
{
	if (fParam6 < 0f)
	{
		fParam6 = 0f;
...
void func_107(int iParam0, int iParam1, int iParam2, int iParam3, int iParam4, int iParam5, bool bParam6, int iParam7)
{
	int iVar0;
	
	iVar0 = (((iParam2 + (60 * iParam3)) + (3600 * iParam4)) + (86400 * iParam5));
	if (func_116(iParam0) == 1 && iParam7)
	{
		return;
	}
	if (bParam6)
