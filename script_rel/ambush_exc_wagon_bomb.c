...
void __EntryFunction__()
{
	...
	while (true)
	{
		func_2(bLocal_303, 961/*func_1*/, 0);
		if (bLocal_303)
		{
			BUILTIN::WAIT(0);
		}
		...
		if (func_61(&(uLocal_15[iVar0]), 0, 1))
		{
			...
			switch (iVar0)
			{
				...
				case 4:
					...
					func_129(&(uLocal_15[iVar0]), -594562071, -1, 1, 0, 1056964608, 1065353216, 0);
					break;
...
int func_89(int iParam0, bool bParam1, int iParam2, bool bParam3)
{
	...
	{
		return func_248(bParam1, iParam2, bParam3);
	}
	if (Global_1572887->f_12 != -1)
	{
...
int func_92(int iParam0)
{
	if (&uLocal_15.f_57[iParam0] == 0)
	{
		...
		{
			uLocal_15.f_57[iParam0] = func_251(997958153, 1);
		}
		else
		{
...
int func_95()
{
	...
	iVar0 = 1;
	if (((!STREAMING::HAS_MODEL_LOADED(-355385988) || !STREAMING::HAS_MODEL_LOADED(-628956517)) || !STREAMING::HAS_MODEL_LOADED(-21851829)) || !STREAMING::HAS_MODEL_LOADED(-370372976))
	{
		iVar0 = 0;
	}
	if (!PED::_0x5E420FF293EE5472())
	...
	while (iVar0 < uLocal_15.f_215)
	{
		if (func_61(&(uLocal_15[iVar0]), 0, 1))
		{
			...
			if (!*uParam0)
			{
				...
				{
					func_174(&(uLocal_15[iVar0]), Global_35, "AMBUSH_WAB_BYPASS", -1073741824, 0, -500314840);
					*uParam0 = 1;
				}
			}
			func_128(&uLocal_15, iVar0, 1);
			func_269(&(uLocal_15[iVar0]), uLocal_15.f_22[iVar0], 831283580, 0, 0, 0);
		}
		iVar0++;
	}
...
int func_141()
{
	...
	switch (iLocal_276)
	{
		case 0:
			if (ENTITY::DOES_ENTITY_EXIST(&(uLocal_15.f_52[0])))
			{
				if (VOLUME::_0xF256A75210C5C0EB(iVar3, vVar0))
				{
					PLAYER::SET_PLAYER_INVINCIBLE(PLAYER::PLAYER_ID(), true);
					func_144(&uLocal_289);
					func_25(&uLocal_15, 1);
...
int func_142()
{
	...
	if (ENTITY::DOES_ENTITY_EXIST(&(uLocal_15.f_52[0])))
	{
		...
		if (!func_277(Global_35))
		{
			...
			FIRE::ADD_EXPLOSION(vVar21, 25, 0.2f, 0, 1, 1f);
			PLAYER::SET_PLAYER_INVINCIBLE(PLAYER::PLAYER_ID(), true);
		}
		else
		{
...
int func_146()
{
	...
	{
		func_40(&uLocal_292, 0);
		func_174(&(uLocal_15[1]), Global_35, "AMBUSH_WAB_BYPASS", -1073741824, 0, -500314840);
		func_25(&uLocal_15, 1);
		func_270(uLocal_15.f_151, 1);
		...
		if (ENTITY::DOES_ENTITY_EXIST(&(uLocal_15[iVar1])))
		{
			...
			else
			{
				if (func_61(&(uLocal_15[iVar1]), 0, 0))
				{
					...
					PED::_0x24C82EF607105FAA(&(uLocal_15[iVar1]), -920810745);
			...
			if (!func_133(&uLocal_278, 2048))
			{
				if (func_47(&uLocal_289, 0.75f))
				{
					if (func_61(&(uLocal_15[4]), 0, 0))
					{
						...
						func_269(&(uLocal_15[4]), uLocal_15.f_22[4], 831283580, 0, 0, 0);
			...
			if (func_267(&uLocal_15, iVar0))
			{
				if (!bVar1)
				{
					if (func_97(iVar0) == -628956517)
					{
						if (!func_133(&uLocal_278, 8))
						{
							func_174(&(uLocal_15[iVar0]), Global_35, "AMBUSH_WAB_TRIGGER", -1073741824, 0, -500314840);
						}
						bVar1 = true;
					}
				}
				TASK::TASK_COMBAT_PED(&(uLocal_15[iVar0]), Global_35, 0, 0);
				func_269(&(uLocal_15[iVar0]), uLocal_15.f_22[iVar0], 831283580, 580546400, 0, 0);
			}
			else
			{
				PED::DELETE_PED(uLocal_15[iVar0]);
...
int func_170()
{
	...
	while (iVar0 <= 4)
	{
		if (func_61(&(uLocal_15[iVar0]), 0, 0))
		{
			if (ENTITY::GET_ENTITY_MODEL(&(uLocal_15[iVar0])) == -628956517)
			{
...
int func_171(float fParam0, int iParam1, int iParam2, int iParam3)
{
...
void func_250(int iParam0, var uParam1, int iParam2, bool bParam3, bool bParam4)
{
	if (!VOLUME::_0x92A78D0BEDB332A3(iParam0))
	{
		return;
...
int func_266(int iParam0, int iParam1, var uParam2, var uParam3, int iParam4, float fParam5)
{
	int iVar0;
	...
	if (!Global_1935630->f_12 && !ENTITY::IS_ENTITY_DEAD(iParam0))
	{
		...
		if (!uParam2->f_1 & 128 != 0)
		{
			...
			{
				*uParam3 = 128;
				func_383(iParam0, uParam2, *uParam3);
				return 1;
			}
		}
		if (Global_1935630->f_27)
		{
			if (!uParam2->f_1 & 8 != 0)
			{
				...
				else if (func_385(iParam0, iParam1, uParam2))
				{
					*uParam3 = 8;
					func_383(iParam0, uParam2, *uParam3);
					return 1;
		...
		{
			if (func_387(uParam2, 1065353216))
			{
				if (!uParam2->f_1 & 4 != 0)
				{
					if (func_388(Global_35, iParam0, uParam2))
					{
						*uParam3 = 4;
						func_383(iParam0, uParam2, *uParam3);
						return 1;
				...
				{
					if (func_389(Global_35, iParam0, uParam2))
					{
						*uParam3 = 256;
						func_383(iParam0, uParam2, *uParam3);
						return 1;
		...
		if (!uParam2->f_1 & 16 != 0)
		{
			...
			{
				if (func_390(Global_35, iParam0, uParam2, 0))
				{
					*uParam3 = 16;
					func_383(iParam0, uParam2, *uParam3);
					return 1;
			...
			else if (func_390(Global_35, iParam0, uParam2, 1))
			{
				*uParam3 = 16;
				func_383(iParam0, uParam2, *uParam3);
				return 1;
		...
		if (Global_1935630->f_30 || Global_1935630->f_31)
		{
			if (!uParam2->f_1 & 2 != 0)
			{
				if (func_393(uParam2, 4000))
				{
					if ((func_394(iParam0, Global_1935630->f_41, *uParam2 & 128 != 0, 0, *uParam2 & 256 != 0) && func_395(uParam2, iParam0)) && func_396(uParam2, iParam0))
					{
						*uParam3 = 2;
						func_383(iParam0, uParam2, *uParam3);
						return 1;
		...
		if (!uParam2->f_1 & 2 != 0)
		{
			if (uParam2->f_12 < 4f)
			{
				if ((func_394(iParam0, Global_1935630->f_41, *uParam2 & 128 != 0, 1, *uParam2 & 256 != 0) && func_395(uParam2, iParam0)) && func_396(uParam2, iParam0))
				{
					*uParam3 = 2;
					func_383(iParam0, uParam2, *uParam3);
					return 1;
			...
			if (uParam2->f_12 < 10f)
			{
				if (func_399(uParam2, iParam0) || (uParam2->f_9 > 0 && (func_181() - uParam2->f_9) < 2000))
				{
					if (PED::IS_PED_RAGDOLL(iParam0))
					{
						func_398();
		...
		if (uParam2->f_12 < uParam2->f_26)
		{
			...
			{
				if (func_402(iParam0, iParam1, uParam2))
				{
					*uParam3 = 2048;
					func_383(iParam0, uParam2, *uParam3);
					return 1;
	...
	if (func_61(&(uLocal_15[iVar0]), 0, 1))
	{
		if (func_47(&uLocal_289, fVar1) || bVar2)
		{
			if (!func_133(&uLocal_278, 4096))
			{
				...
				TASK::TASK_SHOOT_AT_COORD(0, ENTITY::GET_OFFSET_FROM_ENTITY_IN_WORLD_COORDS(&(uLocal_15.f_52[0]), vVar3), -1, -957453492, 1);
...
float func_278(struct<2> Param0, var uParam2, struct<2> Param3, Vector3 vParam5, int iParam6)
{
	float fVar0;
	float fVar1;
	float fVar2;
...
int func_285(int iParam0, var uParam1, bool bParam2, int iParam3, int iParam4, bool bParam5)
{
	int iVar0;
	bool bVar1;
	bool bVar2;
...
bool func_302(int iParam0, int iParam1)
{
	...
	if (ENTITY::DOES_ENTITY_EXIST(iParam0) && ENTITY::IS_ENTITY_A_PED(iParam0))
	{
		...
		return func_440(iParam0, 2084597891, iParam1, uVar0);
	}
...
bool func_315(int iParam0, int iParam1, char* sParam2, char* sParam3, float fParam4, var uParam5, bool bParam6, int iParam7, int iParam8, bool bParam9, int iParam10, int iParam11, bool bParam12, bool bParam13, int iParam14)
{
	return func_443(iParam0, iParam1, sParam2, sParam3, fParam4, uParam5, bParam6, iParam7, iParam8, bParam9, iParam10, iParam11, 0, bParam12, bParam13, iParam14) >= 0;
}
...
float func_351(int iParam0, bool bParam1, int iParam2)
{
	...
	switch (uParam0->f_6)
	{
		case 0:
			if (*uParam0 & 16 != 0)
			{
				...
				else if (!PED::IS_PED_PLANTING_BOMB(Global_35) && (!func_472(1) || *uParam0 & 8192 != 0))
				{
...
int func_384(int iParam0, var uParam1)
{
	...
	if (!ENTITY::IS_ENTITY_DEAD(iParam0))
	{
		if (func_481(iParam0, !*uParam1 & 268435456 != 0, !*uParam1 & 536870912 != 0, !*uParam1 & 1073741824 != 0, 0, 0))
		{
			if (uParam1->f_12 < 5f)
			{
				fVar0 = 95f;
			...
			fVar1 = func_482(uParam1);
			if (func_483(uParam1, iParam0, fVar0, fVar1))
			{
				if (uParam1->f_2 == 0)
				{
...
int func_385(int iParam0, int iParam1, var uParam2)
{
	...
	fVar0 = 85f;
	if (func_485(iParam1, !*uParam2 & 268435456 != 0, !*uParam2 & 536870912 != 0, !*uParam2 & 1073741824 != 0, 0))
	{
		if (uParam2->f_12 < 5f)
		{
			fVar0 = 95f;
		...
		fVar1 = func_482(uParam2);
		if (func_483(uParam2, iParam0, fVar0, fVar1))
		{
			if (uParam2->f_2 == 0)
			{
			...
			if (uParam2->f_2 != 0)
			{
				if (MISC::GET_GAME_TIMER() - uParam2->f_2) > func_484(uParam2)
				{
					func_479(uParam2, 1);
					return 1;
				}
...
int func_386(int iParam0, var uParam1)
{
	...
	if (func_475(iParam0, uParam1, iVar1))
	{
		...
		else if (MISC::GET_GAME_TIMER() - uParam1->f_3) > func_484(uParam1)
		{
			fVar3 = func_482(uParam1);
...
int func_389(var uParam0, int iParam1, var uParam2)
{
	var uVar0;
	
	if (uParam2->f_12 < IntToFloat(func_487(uParam2)))
	{
...
int func_390(var uParam0, int iParam1, var uParam2, bool bParam3)
{
	vector3 vVar0;
	int iVar3;
	vector3 vVar4;
...
int func_391(int iParam0, var uParam1)
{
	...
	while (iVar0 < Global_1935630->f_39)
	{
		...
		else
		{
			...
			if (func_492(uParam1, iParam0, fVar1, bVar12, bVar13))
			{
				*(vVar2[0 /*3*/]) = { ENTITY::GET_ENTITY_COORDS(&(Global_1935630->f_34[iVar0]), false, false) };
				*(vVar2[1 /*3*/]) = { vVar9 };
				uParam1->f_10 = iParam0;
			...
			else if (func_493(uParam1, iParam0, fVar1, bVar12, bVar13))
			{
				*(vVar2[0 /*3*/]) = { ENTITY::GET_ENTITY_COORDS(&(Global_1935630->f_34[iVar0]), false, false) };
				*(vVar2[1 /*3*/]) = { vVar9 };
				uParam1->f_10 = iParam0;
			...
			else if (func_494(uParam1, iParam0, fVar1, iVar0))
			{
				*(vVar2[0 /*3*/]) = { ENTITY::GET_ENTITY_COORDS(&(Global_1935630->f_34[iVar0]), false, false) };
				*(vVar2[1 /*3*/]) = { vVar9 };
				uParam1->f_10 = iParam0;
...
int func_407(int iParam0, var uParam1)
{
	...
	else if (func_181() - uParam1->f_4) > func_505(uParam1)
	{
...
var func_428(var uParam0, var uParam1, int iParam2, vector3 vParam3, float fParam6, bool bParam7, bool bParam8, bool bParam9, int iParam10, int iParam11, bool bParam12, float fParam13, bool bParam14, bool bParam15)
{
	int iVar0;
	var uVar1;
	...
	uVar1 = func_519(uParam0, uParam1, iParam2, iVar0, bParam7, bParam8, bParam9, iParam10, iParam11, bParam12, bParam14, bParam15);
	func_196(iVar0);
	return uVar1;
}
...
var func_432(int iParam0, var uParam1, int iParam2, vector3 vParam3, float fParam6)
{
	int iVar0;
	var uVar1;
	
	iVar0 = VOLUME::_0xB3FB80A32BAE3065(vParam3, 0f, 0f, 0f, fParam6, fParam6, fParam6);
	uVar1 = func_521(iParam0, uParam1, iVar0, iParam2);
	func_196(iVar0);
	return uVar1;
}

bool func_433(struct<2> Param0, Vector3 vParam2, struct<2> Param3, Vector3 vParam5, struct<2> Param6, var uParam8)
{
...
int func_443(int iParam0, int iParam1, char* sParam2, var uParam3, float fParam4, var uParam5, bool bParam6, var uParam7, var uParam8, bool bParam9, var uParam10, int iParam11, bool bParam12, bool bParam13, bool bParam14, var uParam15)
{
	...
	if ((!ENTITY::IS_ENTITY_DEAD(iParam0) || iParam11 == 1718175949) || bParam9 == 0)
	{
		...
		if (((bVar0 || uParam7) || fVar1 < fParam4) || bParam9 == 0)
		{
			...
			{
				iVar2 = func_524(func_523(iParam0, sParam2, iParam11, iParam1, NETWORK::NETWORK_IS_GAME_IN_PROGRESS(), 0, uParam5, uParam15), 1, -1);
			}
			if (iVar2 >= 0)
			{
			}
...
bool func_463(int iParam0, var uParam1, int iParam2, bool bParam3)
{
	return func_541(iParam0, *uParam1, iParam2, bParam3) > 0;
}
...
int func_483(var uParam0, int iParam1, float fParam2, float fParam3)
{
	float fVar0;
...
int func_493(var uParam0, int iParam1, float fParam2, bool bParam3, bool bParam4)
{
	float fVar0;
...
int func_494(var uParam0, int iParam1, float fParam2, int iParam3)
{
	float fVar0;
...
bool func_516(var uParam0, float fParam1, int iParam2)
{
	...
	return func_559(&iVar0, uParam0->f_209, fParam1, 0, 0, 1084227584, uVar6, iParam2);
}
...
int func_519(var uParam0, var uParam1, int iParam2, int iParam3, bool bParam4, bool bParam5, bool bParam6, int iParam7, var uParam8, bool bParam9, bool bParam10, bool bParam11)
{
	int iVar0;
	var uVar1;
	int iVar2;
	...
	if (iVar6 > 0)
	{
		...
		while (iVar5 < iVar6)
		{
			...
			{
				if (func_567(iVar2, bParam4, bParam6, uParam8, bParam9, bParam10) && !DECORATOR::DECOR_EXIST_ON(iVar2, "bIgnoreThisPed"))
				{
					if (!func_347(iVar2, uParam1))
					{
						bVar3 = false;
						if (iParam7 != -1)
						{
...
int func_521(var uParam0, var uParam1, int iParam2, int iParam3)
{
	int iVar0;
	var uVar1;
	int iVar2;
...
bool func_523(int iParam0, char* sParam1, int iParam2, int iParam3, bool bParam4, int iParam5, var uParam6, var uParam7)
{
	struct<7> Var0;
...
int func_536(int iParam0, bool bParam1)
{
	...
	if (WEAPON::_0xD955FEE4B87AFA07(iParam0))
	{
		if (bParam1)
		{
			return func_586(-1185145312, 0) > 0;
		}
		else
		{
			return 1;
...
int func_550(bool bParam0, var uParam1, var uParam2)
{
	int iVar0;
	int iVar1;
...
int func_555(int iParam0, int iParam1, bool bParam2, int iParam3)
{
...
int func_559(int iParam0, vector3 vParam1, float fParam4, bool bParam5, bool bParam6, float fParam7, var uParam8, int iParam9)
{
	int iVar0[5];
	vector3 vVar6;
	vector3 vVar9;
...
int func_560(var uParam0, var uParam1, int iParam2, int iParam3)
{
	int iVar0;
	var uVar1;
	int iVar2;
...
var func_561(var uParam0, var uParam1, int iParam2, vector3 vParam3, float fParam6)
{
	int iVar0;
	var uVar1;
	
	iVar0 = VOLUME::_CREATE_VOLUME_CYLINDER(vParam3, 0f, 0f, 0f, fParam6, fParam6, fParam6);
	uVar1 = func_560(uParam0, uParam1, iParam2, iVar0);
	func_196(iVar0);
	return uVar1;
}
...
int func_567(int iParam0, bool bParam1, bool bParam2, var uParam3, bool bParam4, bool bParam5)
{
...
var func_572(var uParam0, var uParam1)
{
...
void func_575(var uParam0)
{
	if (NETWORK::NETWORK_IS_GAME_IN_PROGRESS())
	{
		MAP::_0x9CB1A1623062F402(*uParam0, func_621(func_620(255), 109029619));
	}
	else if (func_622())
	{
...
int func_667(int iParam0, var uParam1, var uParam2, bool bParam3, bool bParam4)
{
	bool bVar0;
...
int func_668(int iParam0, var uParam1, int iParam2, bool bParam3)
{
	int iVar0;
	int iVar1;
	int iVar2;
...
int func_702(struct<4> Param0, int iParam4, bool bParam5)
{
	struct<10> Var0;
	
	Var0.f_9 = -1591664384;
	if (func_721(Param0, iParam4, &Var0, bParam5))
	{
		return Var0.f_4;
	}
	return 0;
...
int func_713(var uParam0, var uParam1, var uParam2, var uParam3, int iParam4, var uParam5, int iParam6, bool bParam7)
{
	int iVar0;
...
int func_715(struct<4> Param0, struct<4> Param4, int iParam8, bool bParam9, var uParam10, bool bParam11)
{
	struct<12> Var0;
	int iVar14;
	int iVar15;
...
int func_717(struct<4> Param0, struct<4> Param4, var uParam8, bool bParam9)
{
	struct<11> Var0;
	struct<11> Var14;
	struct<16> Var28;
...
int func_721(var uParam0, var uParam1, var uParam2, var uParam3, var uParam4, var uParam5, bool bParam6)
{
	struct<4> Var0;
	...
	if (!INVENTORY::_0x22E590F108289A9D(func_544(bParam6), &uParam0, uParam4, &Var0))
	{
		return 0;
	}
...
struct<28> func_729(var uParam0, var uParam1, var uParam2, var uParam3, bool bParam4)
{
	struct<28> Var0;
	struct<29> Var28;
...
struct<17> func_731(var uParam0, var uParam1, var uParam2, var uParam3, bool bParam4)
{
	struct<17> Var0;
	struct<15> Var17;
