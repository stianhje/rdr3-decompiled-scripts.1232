		...
		if (MISC::GET_GAME_TIMER() > iLocal_21)
		{
			...
			switch (iLocal_20)
			{
				...
				case 1:
					...
					LAW::_0x9BBDCB8DF789EBC1(PLAYER::PLAYER_ID(), func_9(iLocal_22));
					iVar1 = func_10(iLocal_22);
					if (iVar1 != -1)
					{
				...
				case 6:
					if (func_7(func_6(iLocal_22)))
					{
						...
						else
						{
							...
							Jump @788; //curOff = 456
							if (iLocal_23 < MISC::GET_GAME_TIMER() || (func_20() != 0 || Global_1051260->f_3790))
							{
								func_21(iLocal_22);
								func_22();
								if (!func_23(2057, 0))
...
{
	iParam0 = iParam0;
	func_54(95, iLocal_14, &uLocal_15);
	if (func_20() == -1)
	{
		if (!func_55(0, 0, 1))
		{
			func_56(515619039, 1, 0, 0, 0, 0, 0, 0);
		}
		else
		{
			func_56(515619039, 0, 0, 0, 1, 0, 0, 0);
		}
	}
	return 0;
}
...
void func_54(int iParam0, int iParam1, var uParam2)
{
	int iVar0;
	bool bVar1;
	bool bVar2;
	...
	if (iParam0 == 105 || iParam0 == 95)
	{
		...
		iVar0 = func_95(iParam0, func_94(17));
		bVar1 = func_96(2048);
		bVar2 = func_96(1024);
		if (!uParam2->f_3)
		{
	...
	func_97(iParam1, bVar1, bVar2);
	iVar3 = ZONE::_GET_MAP_ZONE_AT_COORDS(Global_36, 1);
	if (func_98(iVar3) == iParam0)
	{
		if (func_99() || func_100())
		{
			*uParam2 = 1;
...
int func_55(int iParam0, bool bParam1, int iParam2)
{
	...
	if ((Global_1898164->f_1[0 /*5*/])->f_2 == 8)
	{
		...
		if (func_106(iVar0) && func_107(((*Global_1347702)[iVar0 /*49*/])->f_12, 131072))
		{
			return 0;
		}
	}
...
void func_56(int iParam0, bool bParam1, int iParam2, bool bParam3, bool bParam4, float fParam5, int iParam6, bool bParam7)
{
	...
	if (func_110(iParam0))
	{
		...
		if (bParam3)
		{
			func_111(iParam0, iParam2, 1, iParam6);
		}
		else if (bParam1)
		{
			if (bParam4)
...
void func_64(int iParam0, int iParam1, int iParam2, bool bParam3, int iParam4, int iParam5)
{
	var uVar0;
	char* sVar1;
	char* sVar2;
...
int func_84(int iParam0, var uParam1, var uParam2, bool bParam3, bool bParam4)
{
	bool bVar0;
...
bool func_94(int iParam0)
{
	...
	if (Global_1572887->f_12 == -1)
	{
		return func_161(((*Global_1835011)[iParam0 /*74*/])->f_1, 1);
	}
...
char* func_118(int iParam0, int iParam1, int iParam2, int iParam3, var uParam4, var uParam5, var uParam6)
{
	...
	{
		sVar0 = func_173(Global_1894899->f_162);
	}
	if (MISC::IS_STRING_NULL_OR_EMPTY(sVar0) && uParam4)
	{
		sVar0 = func_175(func_174(Global_36));
	}
...
char* func_130(char* sParam0, int iParam1)
{
	...
	return func_178(MISC::_CREATE_VAR_STRING(10, "LITERAL_STRING", sParam0), iParam1);
}
...
int func_133(int iParam0)
{
	...
	if (func_179())
	{
		if (!func_161(((*Global_1835011)[3 /*74*/])->f_1, 1))
		{
...
{
	func_182((Global_1935369->f_5[iParam0 /*11*/])->f_6, 1);
	func_183((Global_1935369->f_5[iParam0 /*11*/])->f_6, 0);
...
void func_146(int iParam0)
{
	...
	{
		func_186((Global_1914319->f_3[iParam0 /*446*/])->f_21, 0, 1, 0, 0);
	}
	...
	func_187((Global_1914319->f_3[iParam0 /*446*/])->f_10, 0);
...
int func_157(int iParam0, int iParam1)
{
	...
	if (iParam1 == 255)
	{
		return func_195(&(Global_1109400->f_4), iVar0, 5);
	}
	if (iParam1 == func_196())
	{
		return func_195(&(Global_1109400->f_4), iVar0, 5);
	...
	{
		return func_195(&(((*Global_1108178)[iParam1 /*37*/])->f_4), iVar0, 5);
	}
	return 0;
}
...
var func_173(var uParam0, var uParam1, var uParam2, var uParam3, var uParam4, var uParam5, var uParam6, var uParam7)
{
...
char* func_178(char* sParam0, int iParam1)
{
...
void func_186(int iParam0, bool bParam1, int iParam2, bool bParam3, bool bParam4)
{
	int iVar0;
	int iVar1;
...
int func_203(int iParam0)
{
	...
	while (iVar0 < Global_40.f_7756)
	{
		if ((Global_40.f_7756[iVar0 /*3*/])->f_2 == iParam0)
		{
			...
			if (iVar2 < 1800 && func_204(iParam0, 32768))
			{
				return 1;
			}
		}
...
int func_208(vector3 vParam0, int iParam3)
{
	...
	func_222(iParam3, &vVar0, &Var3, &fVar6);
	if (func_223(vParam0, vVar0, Var3, Var3.f_1, fVar6))
	{
		return 1;
	}
	return 0;
...
bool func_223(vector3 vParam0, vector3 vParam3, float fParam6, float fParam7, float fParam8)
{
	vector3 vVar0;
	struct<2> Var3;
	float fVar6;
