...
int func_73(var uParam0)
{
	...
	func_152(uParam0, 0.64f, -0.72f, 0f, 31.68f, 3f, 3f, 5f, -1612834106, -2055224817, 1, 1, 1);
	func_152(uParam0, -0.3586f, 2.5571f, 0.9955f, 76.6025f, 1f, 1f, 3f, -1612834106, -950285770, 1, 1, 1);
	func_153(uParam0, joaat("p_cs_sock01x"), 0f, 0f, 0f, "SOCK", 0, 0, 1);
	func_154(uParam0, "script@vignette@abigail_13@base", 1, 1, 0, 0);
	iLocal_16 = func_154(uParam0, "script@vignette@abigail_13@action_a", 2, 0, 1, 0);
	iLocal_17 = func_154(uParam0, "script@vignette@abigail_13@action_b", 2, 0, 0, 0);
	iLocal_18 = func_154(uParam0, "script@vignette@abigail_13@action_b_alt", 2, 0, 0, 1);
	iLocal_19 = func_154(uParam0, "script@vignette@abigail_13@action_c", 2, 0, 0, 0);
	iLocal_20 = func_154(uParam0, "script@vignette@abigail_13@action_d", 0, 0, 0, 0);
	func_155(uParam0, "CAB13AU");
	func_156(uParam0, -1843013446, 1794319217);
	func_157(uParam0, iLocal_14, 2, -2118813809, 0, -1, 1, -1073741824, 1065353216, 1);
	...
	STREAMING::_0x19A6BE7D9C6884D3(-2118813809, 1, 0, 0);
	Local_22 = { func_160(uParam0, 1.2363f, -0.1641f, 1.0444f, 120.96f, 7f, 0.629f, 0.5f) };
	iLocal_32 = func_161(uParam0, 0.5875f, -1.025f, 0.95f, 0f, 0f, 80.98939f, 1.1f, 1.1f, 1.38f, "Grief", 665633627);
	return 1;
}
...
int func_92(var uParam0)
{
	...
	iVar0 = func_194(func_20(uParam0));
	func_195(iVar0);
...
int func_94(var uParam0)
{
	...
	{
		if (func_200(uParam0, Local_22, 1, 0))
		{
...
int func_144(var uParam0)
{
	...
	while (iVar0 < uParam0->f_106)
	{
		...
		else
		{
			...
			{
				if (func_123((uParam0->f_107[iVar0 /*113*/])->f_1, 29, 1) || func_244((uParam0->f_107[iVar0 /*113*/])->f_1))
				{
					return 1;
				}
				if (!uParam0->f_3)
		...
		else if (func_20(uParam0) == 355)
		{
			if (iVar3 == 5)
			{
				if (uParam0->f_3)
				{
					...
					else if (func_362(iVar3, func_100(uParam0->f_7), 1))
					{
					}
					else if (func_364(&uVar2, func_363(iVar3)))
					{
						...
						else
						{
							...
							if (bParam2)
							{
								...
								if (!func_365(iVar0, func_100(uParam0->f_7), 0, -1))
								{
									return -1;
								}
								return iVar0;
...
int func_331(int iParam0, bool bParam1)
{
	...
	{
		func_234(iParam0, _NAMESPACE48::_0x4F76E3676583D951(func_133(iParam0)));
		if (func_222() == -1)
		{
...
void func_389(int iParam0, bool bParam1, bool bParam2, bool bParam3)
{
	...
	if (bParam3)
	{
		func_423(func_105(iParam0), 1f, 0);
	}
	if (bParam1)
	{
		func_424(iParam0);
