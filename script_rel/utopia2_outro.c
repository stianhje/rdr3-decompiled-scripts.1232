...
void func_19(var uParam0)
{
	...
	while (iVar0 <= (1 - 1))
	{
		if (!VOLUME::_0x92A78D0BEDB332A3(&(iLocal_3[iVar0])))
		{
			if (iVar0 == 0)
			{
...
int func_22(var uParam0)
{
	...
	if (!ENTITY::IS_ENTITY_DEAD(&(uLocal_5[0])))
	{
		...
		if (VOLUME::_0x92A78D0BEDB332A3(&(iLocal_3[0])))
		{
...
int func_47(int iParam0, var uParam1, bool bParam2, int iParam3, int iParam4, bool bParam5, bool bParam6, bool bParam7)
{
	int iVar0;
	int iVar1;
	...
	while (iVar1 < *iParam0)
	{
		...
		{
			(*uParam1)[iVar1] = func_67(iParam0[iVar1], bParam2, iParam3, 0, 0, 0, 0, iParam4, 1, 0, bParam5, 0, 0, 0, 0, bParam6, 0, 1, 1, 1, 0, 0, 1, bParam7, 1);
		}
		iVar1++;
	}
	iVar1 = 0;
...
int func_67(int iParam0, bool bParam1, var uParam2, int iParam3, int iParam4, int iParam5, float fParam6, var uParam7, int iParam8, bool bParam9, bool bParam10, bool bParam11, int iParam12, int iParam13, bool bParam14, bool bParam15, bool bParam16, bool bParam17, bool bParam18, bool bParam19, bool bParam20, bool bParam21, bool bParam22, bool bParam23, bool bParam24)
{
	vector3 vVar0;
	bool bVar3;
	int iVar4;
	...
	switch (((*Global_1360165)[iParam0 /*1157*/])->f_11)
	{
		...
		case 1:
			...
			if (func_82(iParam0, vVar0, iParam13, 0, 1, bParam17, bParam20, -1, 1, 0))
			{
				func_81(iParam0, 2);
			}
			break;
		...
		case 3:
			if (!ENTITY::IS_ENTITY_DEAD(Global_1360165[iParam0 /*1157*/]) && !ANIMSCENE::_0x3AB6C7B0BB0DF4B1(Global_1360165[iParam0 /*1157*/], -1))
			{
				...
				func_85(Global_1360165[iParam0 /*1157*/], vVar0, fParam6, 2, 1073741824);
			}
			else if (bParam16)
			{
...
int func_82(int iParam0, vector3 vParam1, int iParam4, bool bParam5, bool bParam6, bool bParam7, bool bParam8, int iParam9, int iParam10, bool bParam11)
{
	if (!func_49(iParam0))
	{
		return 0;
	...
	switch (((*Global_1360165)[iParam0 /*1157*/])->f_3)
	{
		...
		case 1:
			...
			((*Global_1360165)[iParam0 /*1157*/])->f_4 = { func_102(iParam0, iParam4, vParam1, bParam5, bParam6, bParam8, (Global_40.f_4942[iParam0 /*60*/])->f_59, bParam11) };
			if (!bParam6)
			{
				func_33(iParam0, 44, 1);
			}
...
void func_92(int iParam0, int iParam1)
{
	...
	switch (iParam0)
	{
		case 11:
			...
			{
				func_120(iParam1, joaat("weapon_revolver_cattleman_sadie"), 0, 0, 2, 1, 0, 1056964608, 1065353216, -1, 0, 0, 0, 0);
				func_120(iParam1, joaat("weapon_revolver_cattleman_sadie_dualwield"), 0, 0, 3, 1, 1, 1056964608, 1065353216, -1, 0, 1, 0, 0);
			}
			break;
	}
}
...
bool func_120(int iParam0, int iParam1, bool bParam2, bool bParam3, int iParam4, bool bParam5, int iParam6, int iParam7, int iParam8, int iParam9, bool bParam10, bool bParam11, bool bParam12, bool bParam13)
{
	bool bVar0;
	int iVar1;
	int iVar2;
	...
	{
		func_142(bVar0, iParam9, bParam2, bParam5, iParam4, bParam11, 752097756, 0);
	}
	else if (!bParam13)
	{
		fVar25 = 0f;
		...
		while (iVar28 < 4)
		{
			...
			if (func_152(iParam0, &Var0, iVar5, 0))
			{
				...
				if (func_156(0))
				{
					...
					func_157(WEAPON::_0x5C2EA6C44F515F34(iParam0), iParam1, iParam6);
...
struct<5> func_150(int iParam0, bool bParam1, int iParam2)
{
	struct<5> Var0;
	struct<10> Var5;
	struct<10> Var27;
...
bool func_152(int iParam0, var uParam1, int iParam2, bool bParam3)
{
	return func_168(iParam0, *uParam1, iParam2, bParam3) > 0;
}
...
int func_155(int iParam0, var uParam1, var uParam2, int iParam3, int iParam4, int iParam5, bool bParam6)
{
	struct<12> Var0;
	int iVar14;
...
void func_158(int iParam0, int iParam1)
{
	...
	{
		iVar1 = func_174(WEAPON::_0xD3750CCC00635FC2(iParam0), iParam1);
...
int func_163(int iParam0, bool bParam1)
{
	...
	if (WEAPON::_0xD955FEE4B87AFA07(iParam0))
	{
		if (bParam1)
		{
			return func_177(-1185145312, 0) > 0;
		}
		else
		{
			return 1;
...
int func_167(var uParam0, var uParam1, var uParam2, var uParam3, var uParam4, bool bParam5, bool bParam6)
{
...
int func_169(int iParam0, var uParam1, var uParam2, int iParam3)
{
	int iVar0;
...
int func_177(int iParam0, bool bParam1)
{
	...
	return INVENTORY::_0xE787F05DFC977BDE(func_171(bParam1), iParam0, 0);
}
