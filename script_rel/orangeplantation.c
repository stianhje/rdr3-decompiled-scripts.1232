...
void func_55(var uParam0)
{
	...
	switch (*uParam0)
	{
		case 0:
			...
			if (!_NAMESPACE48::_0x800DF3FC913355F3(_NAMESPACE48::_0x112DDF56300BC6E5(func_92(uParam0->f_1))))
			{
				*uParam0 = 9;
			}
			*uParam0 = 1;
		...
		case 7:
			...
			{
				_NAMESPACE48::_0x187D65F3AEC5D679(func_92(uParam0->f_1), &(uParam0->f_3));
			}
			if (ENTITY::DOES_ENTITY_EXIST(_NAMESPACE48::_0x31C70A716CAE1FEE(_NAMESPACE48::_0x112DDF56300BC6E5(func_92(uParam0->f_1)))))
			{
				*uParam0 = 6;
			}
			else
			...
			break;
		case 6:
			if (_NAMESPACE48::_0xF8DE7154F7D1458F(_NAMESPACE48::_0x112DDF56300BC6E5(func_92(uParam0->f_1))) == uParam0->f_11)
			{
				*uParam0 = 9;
			}
			else
			{
				_NAMESPACE48::_0x669C25840C6F7AE2(_NAMESPACE48::_0x112DDF56300BC6E5(func_92(uParam0->f_1)), uParam0->f_11);
			}
			break;
		case 8:
...
int func_87(int iParam0, bool bParam1)
{
	...
	{
		func_138(iParam0, _NAMESPACE48::_0x4F76E3676583D951(func_92(iParam0)));
		if (func_20() == -1)
		{
			if (func_136(iParam0, 2048))
			{
				_NAMESPACE48::_0x49A8C2CD97815215(func_90(iParam0));
				func_139(iParam0, 2048);
			}
			_NAMESPACE48::_0xFCC6DB8DBE709BC8(func_90(iParam0));
		}
		return 0;
	}
	...
	func_138(iParam0, _NAMESPACE48::_0x4F76E3676583D951(func_92(iParam0)));
	_NAMESPACE48::_0x4F81EAD1DE8FA19B(func_90(iParam0));
	if (func_136(iParam0, 2048))
	{
		_NAMESPACE48::_0x49A8C2CD97815215(func_90(iParam0));
		func_139(iParam0, 2048);
...
int func_95(var uParam0)
{
	...
	iVar0 = _NAMESPACE48::_0x112DDF56300BC6E5(func_92(uParam0->f_1));
	if (_NAMESPACE48::_0x800DF3FC913355F3(iVar0))
	{
...
int func_137(int iParam0, bool bParam1)
{
	...
	func_170(iParam0);
	_NAMESPACE48::_0xFC77C5B44D5FF7C0(func_90(iParam0));
	func_138(iParam0, 0);
	return 1;
}
