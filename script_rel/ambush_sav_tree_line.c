	...
	if (func_61(&(uLocal_15[iVar0]), 0, 0))
	{
		...
		switch (iVar0)
		{
			case 0:
				...
				func_127(&(uLocal_15[iVar0]), -2002235300, -1, 1, 0, 1056964608, 1065353216, 0);
			...
			case 1:
				PED::SET_PED_COMBAT_ATTRIBUTES(&(uLocal_15[iVar0]), 98, true);
				func_127(&(uLocal_15[iVar0]), -618550132, 1, 0, 0, 1056964608, 1065353216, 0);
				func_127(&(uLocal_15[iVar0]), 379542007, -1, 1, 0, 1056964608, 1065353216, 0);
				PED::_0x7DE9692C6F64CFE8(&(uLocal_15[iVar0]), true, 0, 1);
				break;
	...
	while (iVar0 < uLocal_15.f_215)
	{
		if (func_61(&(uLocal_15[iVar0]), 0, 1))
		{
			...
			if (!func_133(&Local_274, 32))
			{
				...
				{
					func_289(&(uLocal_15[0]), Global_35, "ARRIVAL_COMBAT_RAID_MALE", -1073741824, 1, -500314840, 2);
				}
				else
				{
					func_289(&(uLocal_15[iVar0]), Global_35, "GENERIC_FRIGHTENED_HIGH", -1073741824, 1, 1744022339, 0);
				}
				func_290(&(uLocal_15[iVar0]), uLocal_15.f_22[iVar0], 831283580, 0, 0, 0);
...
void func_159()
{
	...
	while (iVar0 <= 4)
	{
		if (func_61(&(uLocal_15[iVar0]), 0, 1))
		{
			...
			{
				if (PED::IS_PED_SHOOTING(&(uLocal_15[iVar0])) || func_222(&(uLocal_15[iVar0]), 40f, 10f, -1082130432, -1082130432))
				{
					func_290(&(uLocal_15[iVar0]), uLocal_15.f_22[iVar0], 831283580, 0, 0, 0);
				}
			}
...
void func_160()
{
	...
	while (iVar0 <= 4)
	{
		if (func_61(&(uLocal_15[iVar0]), 0, 0))
		{
			...
			{
				func_289(&(uLocal_15[iVar0]), Global_35, "ARRIVAL_COMBAT_TRAP_MALE", -1073741824, 1, -69597692, -1);
	...
	switch (Local_274.f_7)
	{
		...
		case 1:
			if (func_47(Local_274.f_8[3 /*3*/], 8f) && func_327(-2f, 1, 0, 0))
			{
				...
				if (func_329(iVar0))
				{
					func_289(&(uLocal_15[iVar0]), Global_35, "GANG_TAUNT_GEN", -1073741824, 1, 1744022339, -1);
		...
		case 2:
			if (func_47(Local_274.f_8[3 /*3*/], 8f))
			{
				...
				if (func_329(iVar0))
				{
					func_289(&(uLocal_15[iVar0]), Global_35, "TAUNT_GEN_LOCATION", -1073741824, 1, 1744022339, -1);
					func_188(Local_274.f_8[3 /*3*/]);
		...
		case 3:
			if (func_47(Local_274.f_8[3 /*3*/], 8f))
			{
				...
				if (func_329(iVar0))
				{
					func_289(&(uLocal_15[iVar0]), Global_35, "TAUNT_GEN_MALE", -1073741824, 1, 1744022339, 4);
					func_188(Local_274.f_8[3 /*3*/]);
...
int func_169()
{
	...
	if (WEAPON::_0xF29A186ED428B552(&(uLocal_15[Local_274.f_41]), -618550132))
	{
		iVar0 = -618550132;
	}
	else if (WEAPON::_0xF29A186ED428B552(&(uLocal_15[Local_274.f_41]), 124604331))
	{
		iVar0 = 124604331;
	}
...
int func_585(int iParam0, int iParam1)
{
	...
	if (func_669(iParam0, 1, 0, 0) != 2055893578)
	{
		return 0;
	}
