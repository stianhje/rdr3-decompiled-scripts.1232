...
void __EntryFunction__()
{
	...
	StringCopy(&vLocal_153, "CDT33_CHAT", 24);
	Var0 = -1;
	Var0.f_1 = -1;
	Var0.f_2 = -1;
	Var0.f_17 = 10;
...
int func_97(var uParam0)
{
	if (!MAP::DOES_BLIP_EXIST(iLocal_54))
	{
		iLocal_54 = MAP::_0x554D9D53F696D002(-678244495, func_171(uParam0, vLocal_45));
		MAP::SET_BLIP_SPRITE(iLocal_54, 675509286, true);
	}
...
{
	uParam0->f_23 = { func_269(iParam1) + Vector(iParam4, iParam3, iParam2) };
...
int func_161(var uParam0, var uParam1, char* sParam2, int iParam3)
{
	int iVar0;
	char cVar1[64];
...
void func_213(var uParam0)
{
	...
	if (func_329(iLocal_41, 1))
	{
		...
		TASK::TASK_ENTER_ANIM_SCENE(Global_35, func_330(uParam0, iLocal_21), "ARTHUR", "PL_DanceAccept", 1069379748, 0, 0, 20000, -1082130432);
...
void func_320(var uParam0, int iParam1, bool bParam2, bool bParam3)
{
	...
	if (bParam3)
	{
		uVar0 = func_382(uParam0, iParam1);
	}
	if (bParam2)
	{
...
void func_334(var uParam0)
{
	...
	func_396(&uLocal_55, vLocal_153, 0, -1, 0, 0);
	iLocal_156 = 1;
}
...
{
	if (func_397(&vLocal_153))
	{
		func_398(&vLocal_153, 0, 0);
	}
	if (func_331(uParam0, iLocal_16))
	{
		func_9(&iLocal_43, 1, 1);
...
int func_364(int iParam0, bool bParam1, bool bParam2, int iParam3, int iParam4, int iParam5, bool bParam6, bool bParam7, bool bParam8, int iParam9, int iParam10, int iParam11, float fParam12, bool bParam13, bool bParam14, bool bParam15, bool bParam16)
{
	...
	iVar1 = func_409(&uVar0, iParam0, bParam1, bParam2, iParam3, iParam4, iParam5, bParam7, bParam8, iParam9, iParam10, iParam11, fParam12, bParam13, bParam14, bParam15, bParam6, bParam16);
	if (!ENTITY::DOES_ENTITY_EXIST(iVar1))
	{
		return 0;
	}
...
int func_368(int iParam0, bool bParam1)
{
	...
	{
		func_253(iParam0, _NAMESPACE48::_0x4F76E3676583D951(func_140(iParam0)));
		if (func_106() == -1)
		{
...
int func_409(var uParam0, int iParam1, bool bParam2, bool bParam3, var uParam4, var uParam5, var uParam6, bool bParam7, bool bParam8, var uParam9, var uParam10, var uParam11, float fParam12, bool bParam13, bool bParam14, bool bParam15, bool bParam16, bool bParam17)
{
	int iVar0;
	...
	if ((!ENTITY::DOES_ENTITY_EXIST(iVar0) || !func_129(iVar0, 0)) || (bParam3 && !func_58(iParam1)))
	{
		if (bParam2)
		{
			...
			{
				iVar0 = func_444(iParam1, bParam3, bParam8, uParam9, uParam10, uParam11, fParam12, bParam7, bParam15, bParam16, bParam17);
			}
			else
			{
				*uParam0 = 1;
...
int func_419(int iParam0, bool bParam1, int iParam2, int iParam3, int iParam4, int iParam5, float fParam6, int iParam7, int iParam8, bool bParam9, bool bParam10, bool bParam11, int iParam12, int iParam13, bool bParam14, bool bParam15, bool bParam16, bool bParam17, bool bParam18, bool bParam19, bool bParam20, bool bParam21, bool bParam22, bool bParam23, bool bParam24)
{
	vector3 vVar0;
	bool bVar3;
	int iVar4;
	...
	switch (((*Global_1360165)[iParam0 /*1157*/])->f_11)
	{
		...
		case 1:
			...
			if (func_453(iParam0, vVar0, iParam13, 0, 1, bParam17, bParam20, -1, 1, 0))
			{
				func_452(iParam0, 2);
			}
			break;
		...
		case 3:
			if (!ENTITY::IS_ENTITY_DEAD(Global_1360165[iParam0 /*1157*/]) && !ANIMSCENE::_0x3AB6C7B0BB0DF4B1(Global_1360165[iParam0 /*1157*/], -1))
			{
				...
				func_455(Global_1360165[iParam0 /*1157*/], vVar0, fParam6, 2, 1073741824);
			}
			else if (bParam16)
			{
...
int func_435(var uParam0, int iParam1)
{
	...
	while (iVar2 <= iVar1)
	{
		...
		else
		{
			...
			vVar13 = { func_470(ENTITY::GET_ENTITY_COORDS((uParam0->f_107[iParam1 /*113*/])->f_5, true, false), vVar3, 1065353216) };
...
void func_441(var uParam0, var uParam1, var uParam2, var uParam3)
{
	int iVar0;
...
int func_444(int iParam0, bool bParam1, bool bParam2, var uParam3, var uParam4, var uParam5, float fParam6, bool bParam7, bool bParam8, bool bParam9, bool bParam10)
{
	vector3 vVar0;
	int iVar3;
	char* sVar4;
	...
	switch (((*Global_1360165)[iParam0 /*1157*/])->f_70.f_12)
	{
		case 0:
			...
			{
				if (!func_473(iParam0) && func_474(iParam0, &sVar4))
				{
		...
		case 1:
			if (!Global_1359489->f_12)
			{
				...
				if (!func_476(iParam0, vVar0, fParam6, bParam10))
				{
					return func_475();
				}
				if (func_129(((*Global_1360165)[iParam0 /*1157*/])->f_124, 0))
		...
		case 3:
			...
			if ((bParam2 && !func_228(vVar0)) && !func_229(vVar0, ENTITY::GET_ENTITY_COORDS(((*Global_1360165)[iParam0 /*1157*/])->f_124, true, false), 1056964608, 1))
			{
				...
				func_455(((*Global_1360165)[iParam0 /*1157*/])->f_124, vVar0, fParam6, 2, 1073741824);
			}
			if (bParam1)
			{
				if (!ENTITY::_0x88AD6CC10D8D35B2(((*Global_1360165)[iParam0 /*1157*/])->f_124))
...
int func_453(int iParam0, vector3 vParam1, int iParam4, bool bParam5, bool bParam6, bool bParam7, bool bParam8, int iParam9, int iParam10, bool bParam11)
{
	if (!func_112(iParam0))
	{
		return 0;
	...
	switch (((*Global_1360165)[iParam0 /*1157*/])->f_3)
	{
		...
		case 1:
			...
			((*Global_1360165)[iParam0 /*1157*/])->f_4 = { func_491(iParam0, iParam4, vParam1, bParam5, bParam6, bParam8, (Global_40.f_4942[iParam0 /*60*/])->f_59, bParam11) };
			if (!bParam6)
			{
				func_111(iParam0, 44, 1);
			}
...
int func_476(int iParam0, vector3 vParam1, float fParam4, bool bParam5)
{
	int iVar0;
...
bool func_505(int iParam0, int iParam1, bool bParam2, bool bParam3, int iParam4, bool bParam5, int iParam6, int iParam7, int iParam8, int iParam9, bool bParam10, bool bParam11, bool bParam12, bool bParam13)
{
	bool bVar0;
	int iVar1;
	int iVar2;
...
bool func_534(int iParam0, var uParam1, int iParam2, bool bParam3)
{
	return func_551(iParam0, *uParam1, iParam2, bParam3) > 0;
}
...
struct<4> func_536(int iParam0, var uParam1, var uParam2, var uParam3, var uParam4, int iParam5, bool bParam6)
{
	struct<4> Var0;
...
int func_546(int iParam0, bool bParam1)
{
	...
	if (WEAPON::_0xD955FEE4B87AFA07(iParam0))
	{
		if (bParam1)
		{
			return func_559(-1185145312, 0) > 0;
		}
		else
		{
			return 1;
...
int func_550(var uParam0, var uParam1, var uParam2, var uParam3, var uParam4, bool bParam5, bool bParam6)
{
