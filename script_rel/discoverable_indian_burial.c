...
void func_8(var uParam0)
{
	...
	{
		if (!VOLUME::_0x92A78D0BEDB332A3(&(Local_24.f_12[0])))
		{
			return;
		}
		if (!VOLUME::_0x92A78D0BEDB332A3(&(Local_24.f_12[1])))
		{
			return;
		}
		if (VOLUME::_0x92A78D0BEDB332A3(&(Local_24.f_12[2])))
		{
		...
		{
			if (VOLUME::_0x92A78D0BEDB332A3(&(Local_24.f_12[3])))
			{
	...
	switch (Local_24)
	{
		...
		case 2:
			...
			break;
		case 7:
			MISC::_0x59174F1AFE095B5A(Local_24.f_1, false, false, true, 60f, false);
		...
		case 8:
			...
			break;
		case 3:
			MISC::_0x59174F1AFE095B5A(-702816767, false, true, true, 60f, false);
		...
		case 4:
			...
			else if (func_55(&(Local_24.f_8)) > 5f)
			{
				if (!func_39(Local_24.f_11, 2))
				{
					AUDIO::_0xCCE219C922737BFA(func_54(1), -2587.967f, -93.59087f, 167.5787f, func_54(0), 0, 0, 1, 0);
		...
		case 5:
			...
			MISC::_0x59174F1AFE095B5A(2082228755, false, true, true, 60f, false);
			func_25(&(Local_24.f_2));
			func_25(&uLocal_21);
			func_49(&Local_24, 6);
			break;
...
int func_50(var uParam0)
{
	...
	while (iVar0 <= 3)
	{
		iVar1 = iVar0;
		Var2 = { func_101(iVar1) };
		if (!VOLUME::_0x92A78D0BEDB332A3(&(uParam0->f_12[iVar1])))
		{
...
int func_53(var uParam0)
{
	...
	{
		if (VOLUME::_0xF256A75210C5C0EB(&(uParam0->f_12[1]), vVar11))
		{
			return 1;
		}
	}
...
int func_154(var uParam0)
{
	...
	if (!func_112(uParam0, 16) && !func_183(iVar0, 0))
	{
		return 0;
	}
	return 1;
...
int func_185(char* sParam0, var uParam1, var uParam2, int iParam3, bool bParam4)
{
...
int func_198(var uParam0, var uParam1, var uParam2, bool bParam3)
{
