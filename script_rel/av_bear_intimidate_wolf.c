...
void func_14(var uParam0, vector3 vParam1, vector3 vParam4)
{
	...
	func_47(uParam0, 1, "BIW_WOLF", joaat("a_c_wolf"), OBJECT::_GET_OBJECT_OFFSET_FROM_COORDS(vParam1, vParam4.z, 16f, 20f, 0f), (vParam4.z + 135f), 1, 1, 1, 1, 41788943, 1);
	func_47(uParam0, 2, "BIW_DEER", joaat("a_c_deer_01"), OBJECT::_GET_OBJECT_OFFSET_FROM_COORDS(vParam1, vParam4.z, -0.5f, 1f, 0f), (vParam4.z - 90f), 1, 1, 1, 1, 41788943, 1);
}
...
int func_203(int iParam0, int iParam1)
{
	...
	if (func_230(iParam0, 1, 0, 0) != joaat("weapon_lasso"))
	{
		return 0;
	}
