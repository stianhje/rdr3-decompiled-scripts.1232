...
{
	func_33(uParam0, 10978/*func_30*/, 11166/*func_31*/, 13226/*func_32*/);
}
...
{
	func_46(uParam0, "BEAR_INTIMIDATE_WOLF", "", vParam1, vParam4);
	func_47(uParam0, 0, "BIW_BEAR", iLocal_9, OBJECT::_GET_OBJECT_OFFSET_FROM_COORDS(vParam1, vParam4.z, 0f, 0f, 0f), (0f + vParam4.z), 1, 1, 1, 1, 41788943, 1);
	func_47(uParam0, 1, "BIW_WOLF", -1143398950, OBJECT::_GET_OBJECT_OFFSET_FROM_COORDS(vParam1, vParam4.z, 16f, 20f, 0f), (vParam4.z + 135f), 1, 1, 1, 1, 41788943, 1);
	func_47(uParam0, 2, "BIW_DEER", 1110710183, OBJECT::_GET_OBJECT_OFFSET_FROM_COORDS(vParam1, vParam4.z, -0.5f, 1f, 0f), (vParam4.z - 90f), 1, 1, 1, 1, 41788943, 1);
}
	...
	while (iVar12 < uParam0->f_19)
	{
		if ((uParam0->f_20[iVar12 /*14*/])->f_2 != 0)
		{
			...
			if (ENTITY::IS_ENTITY_DEAD(&(uParam0->f_20[iVar12 /*14*/])))
			{
				...
				{
					uParam0->f_20[iVar12 /*14*/] = func_54((uParam0->f_20[iVar12 /*14*/])->f_2, (uParam0->f_20[iVar12 /*14*/])->f_5, (uParam0->f_20[iVar12 /*14*/])->f_8, 1, 1, 0, 1, (uParam0->f_20[iVar12 /*14*/])->f_11, (uParam0->f_20[iVar12 /*14*/])->f_9, 0, 0, 0, 0);
				}
				...
				if (!PED::IS_PED_HUMAN(&(uParam0->f_20[iVar12 /*14*/])))
				{
					if (!func_55(&(uParam0->f_20[iVar12 /*14*/])))
					{
...
int func_31(var uParam0)
{
	...
	if (!&uParam0->f_469[2])
	{
		if (func_64(uParam0, &uLocal_21, 0))
		{
			uParam0->f_469[2] = 1;
		}
		if (!ENTITY::IS_ENTITY_DEAD(&(uParam0->f_20[1 /*14*/])))
		{
			if (func_65(&(uParam0->f_20[1 /*14*/]), Global_35, 1) < 625f)
			{
				uParam0->f_469[2] = 1;
			}
		}
		...
		{
			if (func_65(&(uParam0->f_20[0 /*14*/]), Global_35, 1) < 625f)
			{
				uParam0->f_469[2] = 1;
			}
		}
		if (&uParam0->f_469[2])
		{
			...
			if (!&uParam0->f_469[0])
			{
				func_67(*uParam0, uParam0->f_483, 1);
				uParam0->f_469[0] = 1;
			}
			if (!ENTITY::IS_ENTITY_DEAD(&(uParam0->f_20[1 /*14*/])))
			{
				TASK::_TASK_SMART_FLEE_STYLE_PED(&(uParam0->f_20[1 /*14*/]), Global_35, 3, 256, -1082130432, -1, 0);
			...
			if (!ENTITY::IS_ENTITY_DEAD(&(uParam0->f_20[0 /*14*/])))
			{
				if (func_65(Global_35, &(uParam0->f_20[0 /*14*/]), 1) < 1000f)
				{
				...
				else
				{
					...
					TASK::_TASK_SMART_FLEE_STYLE_PED(&(uParam0->f_20[0 /*14*/]), Global_35, 3, 256, -1082130432, -1, 0);
				}
	...
	if (!&uParam0->f_469[0])
	{
		...
		{
			if (func_69(uParam0, 4f, 90f, 4, -91962372, 0))
			{
				func_67(*uParam0, uParam0->f_483, 1);
				uParam0->f_469[0] = 1;
			}
	...
	switch (iLocal_11)
	{
		case 0:
			if (!ENTITY::IS_ENTITY_DEAD(&(uParam0->f_20[0 /*14*/])))
			{
				func_71(&((uParam0->f_20[0 /*14*/])->f_5), 50, 10, 0);
				TASK::TASK_START_SCENARIO_AT_POSITION(&(uParam0->f_20[0 /*14*/]), iLocal_10, (uParam0->f_20[0 /*14*/])->f_5, (uParam0->f_20[0 /*14*/])->f_8, 0, 0, 1, 0, -1082130432, 0);
				func_68(uParam0->f_20[0 /*14*/], 1, 1);
			}
			if (!ENTITY::IS_ENTITY_DEAD(&(uParam0->f_20[1 /*14*/])))
			{
				func_71(&((uParam0->f_20[1 /*14*/])->f_5), 50, 10, 0);
			...
			if (!ENTITY::IS_ENTITY_DEAD(&(uParam0->f_20[2 /*14*/])))
			{
				...
				PED::_0xCE6B874286D640BB(&(uParam0->f_20[2 /*14*/]), 0);
				TASK::TASK_PLAY_ANIM(&(uParam0->f_20[2 /*14*/]), "CREATURES_MAMMAL@DEER@NORMAL@DEAD", "dead_left", 1000f, -1000f, -1, 131072, 0, 0, 0, 0, 0, 0);
				_NAMESPACE49::_0x3CA5E58C9731A16B(&(uParam0->f_20[2 /*14*/]), iLocal_12);
				PED::SET_PED_KEEP_TASK(&(uParam0->f_20[2 /*14*/]), true);
			}
			iLocal_75 = VOLUME::_0xB3FB80A32BAE3065(OBJECT::_GET_OBJECT_OFFSET_FROM_COORDS(uParam0->f_483, uParam0->f_486.f_2, 8f, 10f, 0f), 0f, 0f, 0f, 20f, 20f, 20f);
			POPULATION::_0xB56D41A694E42E86(iLocal_75, 2016, 16384, 0, -1, -1, 0);
			POPULATION::_0x18262CAFEBB5FBE1(iLocal_75, 2016, 16384, 0, -1, -1, 0);
			iLocal_13 = EVENT::ADD_SHOCKING_EVENT_AT_POSITION(513747494, uParam0->f_483, -1f, -1f, -1f, -1082130432, -1082130432, -1, -1);
			iLocal_11 = 1;
			break;
		...
		case 3:
			if (!iLocal_74)
			{
				...
				{
					AUDIO::PLAY_ANIMAL_VOCALIZATION(&(uParam0->f_20[0 /*14*/]), "TOUGH", 0);
					iLocal_74 = 1;
				}
			}
		...
		case 4:
			if (!func_75(&(uParam0->f_20[1 /*14*/]), 1227113341))
			{
				if (func_74(&uLocal_18, 4.5f))
				{
					...
					TASK::TASK_PLAY_ANIM(0, "CREATURES_MAMMAL@BEAR@ACTION@IDLE@IDLE_VARIATION@ACTION_IDLE_A", "idle", 4f, -1056964608, -1, 0, 0, 0, 0, 0, 0, 0);
					TASK::TASK_PLAY_ANIM(0, "CREATURES_MAMMAL@BEAR@ACTION@IDLE@IDLE_VARIATION@ACTION_IDLE_C", "idle", 4f, -1056964608, -1, 0, 0, 0, 0, 0, 0, 0);
					TASK::TASK_PLAY_ANIM(0, "CREATURES_MAMMAL@BEAR@ACTION@IDLE", "idle", 1090519040, -1056964608, -1, 0, 0, 0, 0, 0, 0, 0);
					TASK::TASK_PLAY_ANIM(0, "creatures_mammal@bear@action_standing@transition@action_to_standing", "idle_transition", 4f, -1056964608, -1, 0, 0, 0, 0, 0, 0, 0);
					TASK::TASK_PLAY_ANIM(0, "CREATURES_MAMMAL@BEAR@ACTION_STANDING@IDLE@IDLE_VARIATION@ROAR", "idle", 1090519040, -1056964608, -1, 0, 0, 0, 0, 0, 0, 0);
					TASK::TASK_PLAY_ANIM(0, "CREATURES_MAMMAL@BEAR@ACTION_STANDING@TRANSITION@STANDING_TO_IDLE", "idle_transition", 1090519040, -1056964608, -1, 0, 0, 0, 0, 0, 0, 0);
					TASK::TASK_START_SCENARIO_AT_POSITION(0, iLocal_10, (uParam0->f_20[0 /*14*/])->f_5, (uParam0->f_20[0 /*14*/])->f_8, 0, 1, 0, 0, -1082130432, 0);
		...
		case 6:
			if (func_65(&(uParam0->f_20[0 /*14*/]), &(uParam0->f_20[1 /*14*/]), 1) <= 121f)
			{
				TASK::OPEN_SEQUENCE_TASK(&iVar1);
				TASK::TASK_GO_STRAIGHT_TO_COORD(0, OBJECT::_GET_OBJECT_OFFSET_FROM_COORDS((uParam0->f_20[2 /*14*/])->f_5, (uParam0->f_20[2 /*14*/])->f_8, -21.25f, 18.75f, 1f), 1.501f, -1, (uParam0->f_20[1 /*14*/])->f_8, 1056964608, 0);
		...
		case 5:
			...
			if (func_74(&uLocal_18, 11f))
			{
				...
				PED::_0x58F7DB5BD8FA2288(&(uParam0->f_20[1 /*14*/]));
				TASK::_TASK_SMART_FLEE_STYLE_PED(&(uParam0->f_20[1 /*14*/]), &(uParam0->f_20[0 /*14*/]), 0, 256, -1082130432, -1, 0);
				PED::SET_PED_KEEP_TASK(&(uParam0->f_20[1 /*14*/]), true);
				func_73(&uLocal_18);
				iLocal_11 = 7;
			}
...
void func_47(var uParam0, int iParam1, char* sParam2, int iParam3, vector3 vParam4, float fParam7, int iParam8, int iParam9, int iParam10, int iParam11, int iParam12, int iParam13)
{
...
int func_64(var uParam0, var uParam1, int iParam2)
{
	...
	{
		if (func_105(&(uParam0->f_20[uParam0->f_501 /*14*/]), 0, uParam1, &(uParam0->f_468), 0, 0))
		{
			return 1;
		}
		uParam0->f_501++;
...
float func_65(int iParam0, int iParam1, bool bParam2)
{
	...
	return func_106(ENTITY::GET_ENTITY_COORDS(iParam0, false, false), ENTITY::GET_ENTITY_COORDS(iParam1, false, false));
}
...
void func_67(int iParam0, vector3 vParam1, bool bParam4)
{
	if (func_40() > (Global_32073.f_2697.f_6[iParam0 /*6*/])->f_5)
	{
		(Global_32073.f_2697.f_6[iParam0 /*6*/])->f_5 = func_40();
...
void func_68(var uParam0, bool bParam1, int iParam2)
{
...
int func_69(var uParam0, float fParam1, float fParam2, int iParam3, int iParam4, bool bParam5)
{
	int iVar0;
		...
		while (iVar0 < uParam0->f_19)
		{
			...
			else
			{
				if (!ENTITY::IS_ENTITY_DEAD(&(uParam0->f_20[iVar0 /*14*/])))
				{
					...
					{
						if ((func_65(Global_35, &(uParam0->f_20[iVar0 /*14*/]), 1) < fParam2 && PED::_0x5102307CE88798EB(&(uParam0->f_20[iVar0 /*14*/]))) && PED::IS_TRACKED_PED_VISIBLE(&(uParam0->f_20[iVar0 /*14*/])))
						{
							if (!func_109(&(uParam0->f_490)))
							{
								func_110(&(uParam0->f_490), 0);
							}
...
int func_72(var uParam0, float fParam1, float fParam2, int iParam3, float fParam4, float fParam5)
{
	int iVar0;
	float fVar1;
	int iVar2;
	...
	if ((MISC::GET_FRAME_COUNT() % 8) == 0)
	{
		...
		fVar1 = (fVar1 * fVar1);
		fParam2 = func_108(fParam2);
		fVar7 = func_118(Global_36, uParam0->f_483);
		...
		while (iVar0 < uParam0->f_19)
		{
			...
			if (!ENTITY::IS_ENTITY_DEAD(&(uParam0->f_20[iVar0 /*14*/])))
			{
				...
				fVar8 = func_65(Global_35, &(uParam0->f_20[iVar0 /*14*/]), 1);
				if (fVar8 < fVar1)
				{
					return 1;
				}
...
int func_80(vector3 vParam0, float fParam3)
{
	...
	while (iVar0 < 4)
	{
		...
		{
			if (func_123(vParam0, (Global_1415419->f_9721[iVar0 /*8*/])->f_4, fParam3, 0))
			{
				return 1;
			}
		}
...
int func_81(vector3 vParam0)
{
	...
	while (iVar0 < 10)
	{
		...
		{
			if (func_123(vParam0, (Global_32073.f_2697.f_1495[iVar0 /*4*/])->f_1, 1f, 0))
			{
				return 1;
			}
		}
...
{
	func_125(uParam0, iParam6);
	func_126(uParam0, iParam5);
	func_127(uParam0, iParam4);
	func_128(uParam0, iParam3);
...
void func_91(int iParam0, vector3 vParam1)
{
	...
	while (iVar0 < 10)
	{
		...
		{
			if (func_123((Global_32073.f_2697.f_1495[iVar0 /*4*/])->f_1, vParam1, 1056964608, 1))
			{
				return;
			}
		}
...
int func_105(int iParam0, int iParam1, var uParam2, var uParam3, int iParam4, float fParam5)
{
	int iVar0;
	...
	if (!Global_1935630->f_12 && !ENTITY::IS_ENTITY_DEAD(iParam0))
	{
		...
		if (!uParam2->f_1 & 128 != 0)
		{
			...
			{
				*uParam3 = 128;
				func_140(iParam0, uParam2, *uParam3);
				return 1;
			}
		}
		if (Global_1935630->f_27)
		{
			if (!uParam2->f_1 & 8 != 0)
			{
				...
				else if (func_142(iParam0, iParam1, uParam2))
				{
					*uParam3 = 8;
					func_140(iParam0, uParam2, *uParam3);
					return 1;
		...
		if (Global_1935630->f_26 && func_144(PLAYER::PLAYER_ID(), 0, 1, uParam2->f_1 & 524288 == 0))
		{
		...
		{
			if (func_145(uParam2, 1065353216))
			{
				if (!uParam2->f_1 & 4 != 0)
				{
					if (func_146(Global_35, iParam0, uParam2))
					{
						*uParam3 = 4;
						func_140(iParam0, uParam2, *uParam3);
						return 1;
				...
				{
					if (func_147(Global_35, iParam0, uParam2))
					{
						*uParam3 = 256;
						func_140(iParam0, uParam2, *uParam3);
						return 1;
		...
		if (!uParam2->f_1 & 16 != 0)
		{
			...
			{
				if (func_148(Global_35, iParam0, uParam2, 0))
				{
					*uParam3 = 16;
					func_140(iParam0, uParam2, *uParam3);
					return 1;
			...
			else if (func_148(Global_35, iParam0, uParam2, 1))
			{
				*uParam3 = 16;
				func_140(iParam0, uParam2, *uParam3);
				return 1;
		...
		if (Global_1935630->f_30 || Global_1935630->f_31)
		{
			if (!uParam2->f_1 & 2 != 0)
			{
				if (func_151(uParam2, 4000))
				{
					if ((func_152(iParam0, Global_1935630->f_41, *uParam2 & 128 != 0, 0, *uParam2 & 256 != 0) && func_153(uParam2, iParam0)) && func_154(uParam2, iParam0))
					{
						*uParam3 = 2;
						func_140(iParam0, uParam2, *uParam3);
						return 1;
		...
		if (!uParam2->f_1 & 2 != 0)
		{
			if (uParam2->f_12 < 4f)
			{
				if ((func_152(iParam0, Global_1935630->f_41, *uParam2 & 128 != 0, 1, *uParam2 & 256 != 0) && func_153(uParam2, iParam0)) && func_154(uParam2, iParam0))
				{
					*uParam3 = 2;
					func_140(iParam0, uParam2, *uParam3);
					return 1;
				...
				if (Global_1935630->f_40 == 0)
				{
					if (Global_1935630->f_41 != 0)
					{
						if (*uParam2 & 131072 == 0)
						{
							if (func_155(iParam0, Global_1935630->f_41))
							{
								func_156();
								*uParam3 = 2;
								func_140(iParam0, uParam2, *uParam3);
			...
			if (uParam2->f_12 < 10f)
			{
				if (func_157(uParam2, iParam0) || (uParam2->f_9 > 0 && (func_158() - uParam2->f_9) < 2000))
				{
					if (PED::IS_PED_RAGDOLL(iParam0))
					{
						func_156();
			...
			if (Global_1935630->f_42 != 0)
			{
				if (*uParam2 & 131072 == 0)
				{
					if (func_159())
					{
						if (func_155(iParam0, Global_1935630->f_42))
						{
							func_156();
							*uParam3 = 2;
							func_140(iParam0, uParam2, *uParam3);
		...
		if (uParam2->f_12 < uParam2->f_26)
		{
			...
			{
				if (func_161(iParam0, iParam1, uParam2))
				{
					*uParam3 = 2048;
					func_140(iParam0, uParam2, *uParam3);
					return 1;
...
void func_107(int iParam0)
{
	if (func_43(iParam0))
	{
		...
		{
			case 1:
				func_168(0, 1, 0, 0, ((Global_1415419->f_19[iParam0 /*12*/])->f_7 / 4), 0, 0, 1);
				func_168(1, 1, 0, 0, ((Global_1415419->f_19[iParam0 /*12*/])->f_7 / 4), 0, 0, 1);
				break;
			
			case 37:
				func_168(60, 1, 0, 0, ((Global_1415419->f_19[iParam0 /*12*/])->f_7 / 4), 0, 0, 1);
				break;
		}
	}
}
...
bool func_115(vector3 vParam0, vector3 vParam3)
{
...
void func_138(var uParam0, bool bParam1, int iParam2)
{
	func_177(iParam2);
	if (Global_1572887->f_12 == -1)
	{
...
int func_144(int iParam0, bool bParam1, int iParam2, bool bParam3)
{
	struct<11> Var0;
	int iVar17;
	struct<11> Var18;
...
int func_146(var uParam0, int iParam1, var uParam2)
{
	float fVar0;
	int iVar1;
	float fVar2;
...
int func_147(var uParam0, int iParam1, var uParam2)
{
	var uVar0;
...
int func_148(var uParam0, int iParam1, var uParam2, bool bParam3)
{
	vector3 vVar0;
	int iVar3;
	vector3 vVar4;
...
int func_149(int iParam0, var uParam1)
{
	...
	while (iVar0 < Global_1935630->f_39)
	{
		...
		else
		{
			...
			if (func_55(&(Global_1935630->f_34[iVar0])))
			{
				if (fVar1 < 35f)
				{
...
int func_152(int iParam0, int iParam1, bool bParam2, bool bParam3, bool bParam4)
{
	int iVar0;
	int iVar1;
	int iVar2;
...
int func_166(int iParam0, var uParam1)
{
	...
	else if (func_158() - uParam1->f_4) > func_215(uParam1)
	{
...
void func_168(int iParam0, int iParam1, int iParam2, int iParam3, int iParam4, int iParam5, bool bParam6, int iParam7)
{
	int iVar0;
	
	iVar0 = (((iParam2 + (60 * iParam3)) + (3600 * iParam4)) + (86400 * iParam5));
	if (func_217(iParam0) == 1 && iParam7)
	{
		return;
	}
	if (bParam6)
...
int func_188(int iParam0, bool bParam1, bool bParam2, bool bParam3, int iParam4, int iParam5)
{
	...
	{
		if (WEAPON::_0x6AD66548840472E5(func_224(iVar0, 0)))
		{
			if (func_225(iParam0, 0.4f, 0.6f, 0.3f, 0.7f))
			{
				return 1;
			}
		}
...
int func_192(int iParam0, bool bParam1, bool bParam2, bool bParam3, int iParam4)
{
	...
	if (PLAYER::IS_PLAYER_FREE_AIMING(iVar1))
	{
		if (WEAPON::_0x6AD66548840472E5(func_224(iVar0, 0)))
		{
			if (func_226(ENTITY::GET_ENTITY_COORDS(iParam0, true, false), 0.4f, 0.6f, 0.3f, 0.7f))
			{
				return 1;
			}
		}
...
{
	if (func_227(iParam0, vParam4, 0.5f))
	{
...
int func_203(int iParam0, int iParam1)
{
	...
	if (func_230(iParam0, 1, 0, 0) != 2055893578)
	{
		return 0;
	}
...
int func_214(int iParam0)
{
	...
	return func_232(((*Global_1347702)[58 /*49*/])->f_15, 1);
}
...
int func_221(bool bParam0, var uParam1, var uParam2)
{
	int iVar0;
	int iVar1;
...
int func_225(int iParam0, float fParam1, float fParam2, float fParam3, float fParam4)
{
	if (!ENTITY::IS_ENTITY_DEAD(iParam0))
	{
		if (func_226(ENTITY::GET_ENTITY_COORDS(iParam0, true, false), fParam1, fParam2, fParam3, fParam4))
		{
			return 1;
		}
	}
...
int func_226(vector3 vParam0, float fParam3, float fParam4, float fParam5, float fParam6)
{
	float fVar0;
	float fVar1;
	bool bVar2;
