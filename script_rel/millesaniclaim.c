	...
	while (func_3())
	{
		if (MISC::GET_GAME_TIMER() > iLocal_26)
		{
			...
			switch (iLocal_25)
			{
				...
				case 1:
					func_5(iLocal_27);
					if (func_7(func_6(iLocal_27)))
					{
						func_8(func_6(iLocal_27), 4);
					}
					LAW::_0x9BBDCB8DF789EBC1(PLAYER::PLAYER_ID(), func_9(iLocal_27));
					iVar1 = func_10(iLocal_27);
					if (iVar1 != -1)
					{
				...
				case 2:
					...
					break;
				case 3:
					if (func_13(iLocal_27) || iLocal_28 < MISC::GET_GAME_TIMER())
					{
						func_14(iLocal_27);
						iLocal_28 = (MISC::GET_GAME_TIMER() + iLocal_24);
						iLocal_25 = 4;
				...
				case 6:
					if (func_7(func_6(iLocal_27)))
					{
						if (func_17(func_6(iLocal_27), 4) && !iLocal_28 < MISC::GET_GAME_TIMER())
						{
						}
						else
						{
							if (func_18(iLocal_27) || iLocal_28 < MISC::GET_GAME_TIMER())
							{
								func_19(iLocal_27, 4);
								iLocal_28 = (iLocal_24 + MISC::GET_GAME_TIMER());
								iLocal_25 = 7;
							...
							Jump @788; //curOff = 456
							if (iLocal_28 < MISC::GET_GAME_TIMER() || (func_20() != 0 || Global_1051260->f_3790))
							{
								func_21(iLocal_27);
								func_22();
								if (!func_23(2057, 0))
							...
							func_34(iLocal_27, Global_1898004);
							iLocal_25 = 10;
							Jump @788; //curOff = 597
							func_35(iLocal_27);
							if (func_20() != -1)
							...
							iLocal_25 = 11;
							Jump @788; //curOff = 667
							if (func_38(iLocal_27))
							{
								iLocal_26 = (1000 + MISC::GET_GAME_TIMER());
							}
							func_39(Global_1898004, iLocal_27);
							func_40(iLocal_27);
							func_19(iLocal_27, 8);
							if (func_41())
							{
...
{
	iParam0 = iParam0;
	func_46(-1382959706, 0, 0);
	func_46(-76557983, 0, 0);
...
int func_47(int iParam0, int iParam1, int iParam2, bool bParam3)
{
	...
	if (func_78(iParam0) && !func_79(iParam0))
	{
	}
	if (func_80(iParam0, &iVar0, &iVar1, 0, 0))
	{
		if (func_81(iParam1))
		{
			iVar0 = iParam1;
		...
		while (true)
		{
			if ((!func_78(iParam0) || func_79(iParam0)) || func_82(&Global_1897950))
			{
				func_83(&Global_1897950, 0);
			}
...
bool func_57(int iParam0)
{
	...
	return ((((*Global_1888801)[iParam0 /*35*/])->f_20 == 1 || ((*Global_1888801)[iParam0 /*35*/])->f_20 == 2) && !func_85(iParam0));
}
...
void func_60(int iParam0, int iParam1, int iParam2, bool bParam3, int iParam4, int iParam5)
{
	...
	sVar1 = func_87(iParam0, iParam1, iParam2, iParam4, iParam5, bParam3, &uVar0);
	...
	if (!func_88(iParam4))
	{
		if (func_51(iParam0))
		{
			iParam4 = func_89(func_6(iParam0));
		}
		else
		{
	...
	if (func_88(iParam4))
	{
		iVar3 = func_90(iParam4);
	}
	if (uVar0 && bParam3)
	{
		sVar2 = func_92(func_91(iParam2));
	}
	...
	{
		iVar4 = func_96(func_95());
		iVar5 = func_97(func_95());
		if (iVar5 < 10)
		{
		...
		if (!MISC::_SHOULD_USE_24_HOUR_CLOCK())
		{
			...
			sVar2 = MISC::_CREATE_VAR_STRING(674, sVar8, iVar4, func_99(&sVar6, 109029619), sVar9, func_99(&sVar10, 109029619));
		}
		else
		{
			...
			IntToString(&sVar10, BUILTIN::ROUND(fVar7), 8);
			sVar2 = MISC::_CREATE_VAR_STRING(162, sVar8, iVar4, func_99(&sVar6, 109029619), func_99(&sVar10, 109029619));
		}
		Global_1894899->f_9 = 0;
	}
	Global_1934266->f_148 = func_100(sVar1, sVar2, 4000, 0, 0, 0, 0, 1);
}
...
void func_62(int iParam0, bool bParam1)
{
	...
	func_105(func_104(-1532769513, -36357794), 1);
	switch (func_6(iParam0))
	{
		case 0:
		case 2:
		case 11:
			func_105(func_104(-1532769513, 213519508), 1);
			break;
		case 1:
		case 5:
		case 6:
		case 7:
		case 12:
			func_105(func_104(-1532769513, 242571679), 1);
			break;
		case 3:
		case 10:
			func_105(func_104(-1532769513, 1349449307), 1);
			break;
		case 4:
		case 9:
			func_105(func_104(-1532769513, 1140362070), 1);
			break;
		case 8:
			func_105(func_104(-1532769513, -172330899), 1);
			break;
		case 13:
		case 14:
		case 15:
		case 16:
			func_105(func_104(-1532769513, -910218296), 1);
			break;
	}
	switch (iParam0)
	{
...
void func_65(int iParam0, bool bParam1, int iParam2, bool bParam3, bool bParam4)
{
	...
	while (iVar0 < 4)
	{
		...
		if (((func_107(iVar1) && !func_110(iVar1, iParam2)) && (!bParam3 || !func_111(iVar1))) && (!bParam4 || !func_112(iVar1)))
		{
			if (iVar1 != iParam0)
			{
				func_113(iVar0);
...
void func_75(int iParam0)
{
	...
	while (iVar1 < 4)
	{
		func_117(&((Global_1392240->f_1[iVar0 /*18*/])->f_6[iVar1]));
...
int func_80(int iParam0, var uParam1, var uParam2, bool bParam3, bool bParam4)
{
	bool bVar0;
...
int func_83(int iParam0, bool bParam1)
{
	...
	{
		func_121(iParam0, _NAMESPACE48::_0x4F76E3676583D951(func_120(iParam0)));
		if (func_20() == -1)
		{
			if (func_118(iParam0, 2048))
			{
				_NAMESPACE48::_0x49A8C2CD97815215(func_122(iParam0));
				func_123(iParam0, 2048);
			}
			_NAMESPACE48::_0xFCC6DB8DBE709BC8(func_122(iParam0));
		}
		return 0;
	}
	...
	func_121(iParam0, _NAMESPACE48::_0x4F76E3676583D951(func_120(iParam0)));
	_NAMESPACE48::_0x4F81EAD1DE8FA19B(func_122(iParam0));
	if (func_118(iParam0, 2048))
	{
		_NAMESPACE48::_0x49A8C2CD97815215(func_122(iParam0));
		func_123(iParam0, 2048);
...
{
	if ((iParam0 == 22 || iParam0 == 37) && !func_125())
	{
		return 1;
	}
	if (iParam0 == 61)
...
char* func_87(int iParam0, int iParam1, int iParam2, int iParam3, var uParam4, var uParam5, var uParam6)
{
	char* sVar0;

	if (!MISC::IS_STRING_NULL_OR_EMPTY(&(Global_1894899->f_162)))
	{
		sVar0 = func_128(Global_1894899->f_162);
	}
	if (MISC::IS_STRING_NULL_OR_EMPTY(sVar0) && uParam4)
	{
		sVar0 = func_130(func_129(Global_36));
	}
...
char* func_99(char* sParam0, int iParam1)
{
	...
	return func_133(MISC::_CREATE_VAR_STRING(10, "LITERAL_STRING", sParam0), iParam1);
}

var func_100(char* sParam0, char* sParam1, int iParam2, int iParam3, int iParam4, int iParam5, int iParam6, int iParam7)
{
	struct<4> Var0;
	vector3 vVar13;
	var uVar16;
...
int func_102(int iParam0)
{
	...
	if (func_134())
	{
		if (!func_135(((*Global_1835011)[3 /*74*/])->f_1, 1))
		{
...
{
	func_139((Global_1935369->f_5[iParam0 /*11*/])->f_6, 1);
	func_140((Global_1935369->f_5[iParam0 /*11*/])->f_6, 0);
...
void func_115(int iParam0)
{
	...
	{
		func_143((Global_1914319->f_3[iParam0 /*446*/])->f_21, 0, 1, 0, 0);
	}
	...
	func_144((Global_1914319->f_3[iParam0 /*446*/])->f_10, 0);
	...
	else
	{
		...
		while (iVar0 < iVar1)
		{
			func_117(&((Global_1914319->f_3[iParam0 /*446*/])->f_317[iVar0 /*6*/]));
...
int func_127(int iParam0, bool bParam1, int iParam2)
{
	...
	{
		iVar0 = func_154(&(Global_1898164->f_1[0 /*5*/]));
		if (func_155(iVar0) && func_156(((*Global_1347702)[iVar0 /*49*/])->f_12, 131072))
		{
			return 0;
		}
	}
...
char* func_128(var uParam0, var uParam1, var uParam2, var uParam3, var uParam4, var uParam5, var uParam6, var uParam7)
{
...
char* func_133(char* sParam0, int iParam1)
{
...
int func_158(vector3 vParam0, int iParam3)
{
	...
	func_175(iParam3, &vVar0, &Var3, &fVar6);
	if (func_176(vParam0, vVar0, Var3, Var3.f_1, fVar6))
	{
		return 1;
	}
	return 0;
...
bool func_176(vector3 vParam0, vector3 vParam3, float fParam6, float fParam7, float fParam8)
{
	vector3 vVar0;
	struct<2> Var3;
	float fVar6;
