...
{
	func_33(uParam0, 11167/*func_30*/, 11226/*func_31*/, 11793/*func_32*/);
}
...
void func_14(var uParam0, vector3 vParam1, vector3 vParam4)
{
	...
	func_46(uParam0, "RIDGELINE_ANIMAL", "", vParam1, vParam4);
	iVar0 = 1;
	iVar1 = func_47();
	switch (*uParam0)
	{
		...
		case 203:
			...
			iLocal_40 = -95090138;
			iVar0 = 0;
			iLocal_11 = 1762054474;
			break;
		case 205:
			iLocal_9 = 1755643085;
			iLocal_40 = -1181541851;
			iVar0 = 0;
			if (((iVar1 == 13 || iVar1 == 14) || iVar1 == 15) || iVar1 == 16)
			{
				iLocal_11 = -1235944432;
			}
			else
			{
				iLocal_11 = 697666614;
		...
		case 206:
			iLocal_9 = -1568716381;
			iLocal_40 = -1177922299;
			iVar0 = 0;
			if (iVar1 == 12 || iVar1 == 1)
			{
				iLocal_11 = -163914005;
			}
			else if ((iVar1 == 13 || iVar1 == 14) || iVar1 == 15)
			{
				iLocal_11 = -2116663991;
			}
			else
			{
				iLocal_11 = -1151440774;
			}
			break;
		case 204:
			iLocal_9 = -1098441944;
		...
		case 190:
			iLocal_9 = 1007418994;
			iLocal_40 = -1887149323;
			break;
	}
	func_48(uParam0, 0, "RLA_ANIMAL", iLocal_9, OBJECT::_GET_OBJECT_OFFSET_FROM_COORDS(vParam1, vParam4.z, 0f, 0f, 0f), (0f + vParam4.z), iVar0, 1, 0, 1, iLocal_11, 1);
}
...
int func_31(var uParam0)
{
	if (*uParam0 == 190)
	{
		if (!&uParam0->f_469[1])
		{
			if (func_63(uParam0, &uLocal_12, 0) || func_64(&(uParam0->f_20[0 /*14*/]), Global_35, 1) <= 9f)
			{
				func_65(uParam0);
				func_66(uParam0);
				uParam0->f_469[1] = 1;
	...
	switch (iLocal_10)
	{
		case 0:
			...
			{
				func_67(&((uParam0->f_20[0 /*14*/])->f_5), 50, 10, 0);
				if ((*uParam0 == 129 || *uParam0 == 178) || *uParam0 == 190)
				{
					TASK::TASK_START_SCENARIO_AT_POSITION(&(uParam0->f_20[0 /*14*/]), iLocal_40, (uParam0->f_20[0 /*14*/])->f_5, (uParam0->f_20[0 /*14*/])->f_8, 0, 1, 1, 0, -1082130432, 0);
				}
				else
				{
					TASK::TASK_START_SCENARIO_AT_POSITION(&(uParam0->f_20[0 /*14*/]), iLocal_40, (uParam0->f_20[0 /*14*/])->f_5, (uParam0->f_20[0 /*14*/])->f_8, 0, 0, 1, 0, -1082130432, 0);
				}
		...
		case 1:
			if (func_69(uParam0, uParam0->f_493, uParam0->f_494, 4, uParam0->f_495, 1112014848))
			{
				...
				if (!ENTITY::IS_ENTITY_DEAD(&(uParam0->f_20[0 /*14*/])))
				{
					TASK::_0xE8C296B75EACC357(&(uParam0->f_20[0 /*14*/]), 0f);
...
float func_64(int iParam0, int iParam1, bool bParam2)
{
	if (!ENTITY::DOES_ENTITY_EXIST(iParam0))
	{
		return 0f;
	...
	return func_101(ENTITY::GET_ENTITY_COORDS(iParam0, false, false), ENTITY::GET_ENTITY_COORDS(iParam1, false, false));
}
	...
	if ((MISC::GET_FRAME_COUNT() % 8) == 0)
	{
		...
		while (iVar0 < uParam0->f_19)
		{
			...
			if (!ENTITY::IS_ENTITY_DEAD(&(uParam0->f_20[iVar0 /*14*/])))
			{
				...
				fVar8 = func_64(Global_35, &(uParam0->f_20[iVar0 /*14*/]), 1);
				if (fVar8 < fVar1)
				{
					return 1;
				}
...
bool func_104(vector3 vParam0, vector3 vParam3)
{
