...
{
	func_33(uParam0, 10689/*func_30*/, 10740/*func_31*/, 11023/*func_32*/);
}
...
{
	func_46(uParam0, "DEER_TREE_RUB", "", vParam1, vParam4);
	func_47(uParam0, 0, "DTRP_DEER", iLocal_9, vParam1, vParam4.z, 1, 1, 1, 1, 41788943, 1);
}
...
int func_31(var uParam0)
{
	if (!&uParam0->f_469[1])
	{
		if (func_61(uParam0, &uLocal_14, 0))
		{
			func_62(uParam0);
			uParam0->f_469[1] = 1;
			return 1;
	...
	switch (iLocal_10)
	{
		case 0:
			...
			{
				func_63(&((uParam0->f_20[0 /*14*/])->f_5), 50, 10, 0);
				TASK::TASK_START_SCENARIO_AT_POSITION(&(uParam0->f_20[0 /*14*/]), 1542936419, (uParam0->f_20[0 /*14*/])->f_5, (uParam0->f_20[0 /*14*/])->f_8, 0, 0, 1, 0, -1082130432, 0);
...
void func_62(var uParam0)
{
	...
	if (!&uParam0->f_469[2])
	{
		func_98(*uParam0, uParam0->f_483, 0);
		uParam0->f_469[2] = 1;
	}
}
...
int func_72(vector3 vParam0, float fParam3)
{
	...
	while (iVar0 < 4)
	{
		...
		{
			if (func_110(vParam0, (Global_1415419->f_9721[iVar0 /*8*/])->f_4, fParam3, 0))
			{
				return 1;
			}
		}
...
int func_73(vector3 vParam0)
{
	...
	while (iVar0 < 10)
	{
		...
		{
			if (func_110(vParam0, (Global_32073.f_2697.f_1495[iVar0 /*4*/])->f_1, 1f, 0))
			{
				return 1;
			}
		}
...
int func_96(int iParam0, int iParam1, var uParam2, var uParam3, int iParam4, float fParam5)
{
	...
	if (!Global_1935630->f_12 && !ENTITY::IS_ENTITY_DEAD(iParam0))
	{
		...
		if (!uParam2->f_1 & 128 != 0)
		{
			...
			{
				*uParam3 = 128;
				func_127(iParam0, uParam2, *uParam3);
				return 1;
			}
		}
		if (Global_1935630->f_27)
		{
			if (!uParam2->f_1 & 8 != 0)
			{
				...
				else if (func_129(iParam0, iParam1, uParam2))
				{
					*uParam3 = 8;
					func_127(iParam0, uParam2, *uParam3);
					return 1;
		...
		if (Global_1935630->f_26 && func_131(PLAYER::PLAYER_ID(), 0, 1, uParam2->f_1 & 524288 == 0))
		{
		...
		{
			if (func_132(uParam2, 1065353216))
			{
				if (!uParam2->f_1 & 4 != 0)
				{
					if (func_133(Global_35, iParam0, uParam2))
					{
						*uParam3 = 4;
						func_127(iParam0, uParam2, *uParam3);
						return 1;
		...
		if (!uParam2->f_1 & 16 != 0)
		{
			...
			{
				if (func_135(Global_35, iParam0, uParam2, 0))
				{
					*uParam3 = 16;
					func_127(iParam0, uParam2, *uParam3);
					return 1;
			...
			else if (func_135(Global_35, iParam0, uParam2, 1))
			{
				*uParam3 = 16;
				func_127(iParam0, uParam2, *uParam3);
				return 1;
		...
		if (Global_1935630->f_30 || Global_1935630->f_31)
		{
			if (!uParam2->f_1 & 2 != 0)
			{
				...
				{
					if ((func_139(iParam0, Global_1935630->f_41, *uParam2 & 128 != 0, 0, *uParam2 & 256 != 0) && func_140(uParam2, iParam0)) && func_141(uParam2, iParam0))
					{
						*uParam3 = 2;
						func_127(iParam0, uParam2, *uParam3);
						return 1;
		...
		if (!uParam2->f_1 & 2 != 0)
		{
			if (uParam2->f_12 < 4f)
			{
				if ((func_139(iParam0, Global_1935630->f_41, *uParam2 & 128 != 0, 1, *uParam2 & 256 != 0) && func_140(uParam2, iParam0)) && func_141(uParam2, iParam0))
				{
					*uParam3 = 2;
					func_127(iParam0, uParam2, *uParam3);
					return 1;
				...
				if (Global_1935630->f_40 == 0)
				{
					if (Global_1935630->f_41 != 0)
					{
						if (*uParam2 & 131072 == 0)
						{
							if (func_142(iParam0, Global_1935630->f_41))
							{
								func_143();
								*uParam3 = 2;
								func_127(iParam0, uParam2, *uParam3);
			...
			if (uParam2->f_12 < 10f)
			{
				if (func_144(uParam2, iParam0) || (uParam2->f_9 > 0 && (func_145() - uParam2->f_9) < 2000))
				{
			...
			if (Global_1935630->f_42 != 0)
			{
				if (*uParam2 & 131072 == 0)
				{
					if (func_146())
					{
						if (func_142(iParam0, Global_1935630->f_42))
						{
							func_143();
							*uParam3 = 2;
							func_127(iParam0, uParam2, *uParam3);
		...
		if (uParam2->f_12 < uParam2->f_26)
		{
			...
			{
				if (func_148(iParam0, iParam1, uParam2))
				{
					*uParam3 = 2048;
					func_127(iParam0, uParam2, *uParam3);
					return 1;
...
void func_98(int iParam0, vector3 vParam1, bool bParam4)
{
	if (func_40() > (Global_32073.f_2697.f_6[iParam0 /*6*/])->f_5)
	{
		(Global_32073.f_2697.f_6[iParam0 /*6*/])->f_5 = func_40();
...
int func_110(vector3 vParam0, vector3 vParam3, float fParam6, bool bParam7)
{
	if (fParam6 < 0f)
	{
		fParam6 = 0f;
...
void func_125(var uParam0, bool bParam1, int iParam2)
{
	func_167(iParam2);
	if (Global_1572887->f_12 == -1)
	{
	...
	if (!uParam0->f_1 & 1024 != 0)
	{
		if (!ENTITY::DOES_ENTITY_EXIST(uParam0->f_14))
		{
			if (func_170(uParam0))
			{
				uParam0->f_15 = func_145();
			}
		}
		else if (uParam0->f_15 > 0)
		{
			if ((func_145() - uParam0->f_15) > 500)
			{
...
int func_135(var uParam0, int iParam1, var uParam2, bool bParam3)
{
	vector3 vVar0;
	int iVar3;
	vector3 vVar4;
...
int func_139(int iParam0, int iParam1, bool bParam2, bool bParam3, bool bParam4)
{
	int iVar0;
	int iVar1;
	int iVar2;
...
int func_153(int iParam0, var uParam1)
{
	...
	if (uParam1->f_4 == 0)
	{
		uParam1->f_4 = func_145();
	}
	else if (func_145() - uParam1->f_4) > func_205(uParam1)
	{
...
void func_156(int iParam0, vector3 vParam1)
{
	int iVar0;
	int iVar1;
	...
	while (iVar0 < 10)
	{
		...
		{
			if (func_110((Global_32073.f_2697.f_1495[iVar0 /*4*/])->f_1, vParam1, 1056964608, 1))
			{
				return;
			}
		}
...
int func_178(int iParam0, bool bParam1, bool bParam2, bool bParam3, int iParam4, int iParam5)
{
	...
	{
		if (WEAPON::_0x6AD66548840472E5(func_214(iVar0, 0)))
		{
...
int func_182(int iParam0, bool bParam1, bool bParam2, bool bParam3, int iParam4)
{
	...
	if (PLAYER::IS_PLAYER_FREE_AIMING(iVar1))
	{
		if (WEAPON::_0x6AD66548840472E5(func_214(iVar0, 0)))
		{
			if (func_216(ENTITY::GET_ENTITY_COORDS(iParam0, true, false), 0.4f, 0.6f, 0.3f, 0.7f))
			{
				return 1;
			}
		}
...
int func_193(int iParam0, int iParam1)
{
	...
	if (func_220(iParam0, 1, 0, 0) != 2055893578)
	{
		return 0;
	}
...
int func_215(int iParam0, float fParam1, float fParam2, float fParam3, float fParam4)
{
	if (!ENTITY::IS_ENTITY_DEAD(iParam0))
	{
		if (func_216(ENTITY::GET_ENTITY_COORDS(iParam0, true, false), fParam1, fParam2, fParam3, fParam4))
		{
			return 1;
		}
	}
...
int func_216(vector3 vParam0, float fParam3, float fParam4, float fParam5, float fParam6)
{
	float fVar0;
	float fVar1;
	bool bVar2;
