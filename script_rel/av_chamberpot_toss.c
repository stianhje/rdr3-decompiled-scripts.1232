...
{
	func_33(uParam0, 10826/*func_30*/, 10916/*func_31*/, 11311/*func_32*/);
}
...
void func_14(var uParam0, vector3 vParam1, vector3 vParam4)
{
	...
	uVar0 = func_47(func_46());
	func_48(uParam0, "AV_CHAMBERPOT_TOSS", "", vParam1, vParam4);
	func_49(uParam0, 0, "Ped", uVar0, OBJECT::_GET_OBJECT_OFFSET_FROM_COORDS(vParam1, vParam4.z, 0f, -6f, 0f), vParam4.z, 1, 0, 1, 1, 41788943, 1);
}
...
void func_49(var uParam0, int iParam1, char* sParam2, var uParam3, vector3 vParam4, var uParam7, int iParam8, int iParam9, int iParam10, int iParam11, int iParam12, int iParam13)
{
...
var func_50(int iParam0, vector3 vParam1, float fParam4, float fParam5, float fParam6, int iParam7)
{
