...
bool func_44(int iParam0)
{
	...
	{
		return func_62(((*Global_1835011)[iParam0 /*74*/])->f_1, 1);
	}
...
int func_61(int iParam0, int iParam1, int iParam2, bool bParam3, bool bParam4)
{
	...
	if (func_32(iVar0, 0))
	{
		...
		{
			if (iParam2 || !(ENTITY::IS_ENTITY_ON_SCREEN(iVar0) && func_68(PLAYER::PLAYER_PED_ID(), iVar0, 1) < 10000f))
			{
				...
				if (iVar1 != 0)
				{
					...
					func_70(iParam0);
					_NAMESPACE48::_0x7B204F88F6C3D287(func_71(iParam0, 0));
					_NAMESPACE48::_0xFCC6DB8DBE709BC8(func_71(iParam0, 0));
					func_72(iParam0);
				}
			}
			else
...
float func_68(int iParam0, int iParam1, bool bParam2)
{
	...
	return func_79(ENTITY::GET_ENTITY_COORDS(iParam0, false, false), ENTITY::GET_ENTITY_COORDS(iParam1, false, false));
}
...
int func_69(int iParam0, bool bParam1)
{
	...
	if (bParam1)
	{
		((*Global_1360165)[iParam0 /*1157*/])->f_127 = func_80(iParam0);
		return ((*Global_1360165)[iParam0 /*1157*/])->f_127;
	}
	return 0;
}
...
int func_71(int iParam0, int iParam1)
{
	...
	{
		((*Global_1360165)[iParam0 /*1157*/])->f_126 = func_81(iParam0);
	}
