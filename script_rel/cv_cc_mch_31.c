...
int func_72(var uParam0)
{
	...
	func_151(uParam0, -3.175f, 0.3875f, 0.8695f, 109.25f, 6f, 2.5f, 3f, -1612834106, 1632043240, 1, 1, 1);
	func_151(uParam0, 0.3708f, 1.3727f, 1.06f, 101.2207f, 1.5f, 1.5f, 3f, -1612834106, 1267380940, 1, 1, 1);
	iLocal_51 = func_152(uParam0, -2.8292f, -0.1273f, 1.06f, 120.24f, 2.5f, 1.5f, 3f, 665633627, 1);
	func_153(uParam0, joaat("p_cs_book02x"), 0f, 0f, 0f, "BOOK", 0, 0, 1);
	func_153(uParam0, joaat("p_cigarette_cs01x"), 0f, 0f, 0f, "CIGARETTE", 0, 0, 1);
	func_154(uParam0, "script@vignette@micah_31@base", 1, 1, 0, 0);
	iLocal_16 = func_154(uParam0, "script@vignette@micah_31@action_a", 2, 0, 1, 0);
	iLocal_18 = func_154(uParam0, "script@vignette@micah_31@Action_A_Int_Front", 2, 0, 0, 1);
	iLocal_19 = func_154(uParam0, "script@vignette@micah_31@Action_A_Int_Right", 2, 0, 0, 1);
	iLocal_20 = func_154(uParam0, "script@vignette@micah_31@Action_A_Int_Back", 2, 0, 0, 1);
	iLocal_17 = func_154(uParam0, "script@vignette@micah_31@action_b", 0, 0, 0, 0);
	func_155(uParam0, "CCM31AU");
	func_156(uParam0, iLocal_14, 3, -22664287, "WORLD_HUMAN_SMOKE_MALE_C", -1, 1);
	func_157(uParam0, iLocal_14, 3, -1);
	func_156(uParam0, iLocal_15, 3, 1204099266, "WORLD_HUMAN_SIT_GROUND_READING_BOOK_MALE_A", -1, 1);
	Local_21 = { func_158(uParam0, -2.908f, 2.195f, 1.07f, 158.75f, 6.5f, 0f, 0.5325f) };
	Local_31 = { func_158(uParam0, -2.9075f, 2.195f, 1.07f, 110.84f, 6.5f, 0f, 0.467f) };
	Local_41 = { func_158(uParam0, -2.908f, 2.195f, 1.07f, 49.5f, 6.5f, 0.22f, 0.5075f) };
	return 1;
}
...
int func_93(var uParam0)
{
	if (!iLocal_53)
	{
		...
		{
			iLocal_52 = func_152(uParam0, -3.4692f, 1.9827f, 1.06f, 91.44f, 1.5f, 1.5f, 3f, 665633627, 1);
			func_197(uParam0, iLocal_52, 1);
			func_197(uParam0, iLocal_51, 0);
			iLocal_53 = 1;
		}
	}
	if (func_198(uParam0, iLocal_16))
	{
		if (func_199(uParam0, Local_21, 1, 0))
		{
			func_188(uParam0, iLocal_18, 1);
		}
		else if (func_199(uParam0, Local_31, 1, 0))
		{
			func_188(uParam0, iLocal_19, 1);
		}
		else if (func_199(uParam0, Local_41, 1, 0))
		{
...
int func_188(var uParam0, int iParam1, bool bParam2)
{
	...
	if (bParam2)
	{
		...
		while (iVar1 < uParam0->f_1984)
		{
			...
			else if (func_289(uParam0, iVar1) || func_198(uParam0, iVar1))
			{
...
void func_205(var uParam0)
{
	...
	while (iVar0 < uParam0->f_106)
	{
		if (((uParam0->f_107[iVar0 /*113*/])->f_32.f_60 > 0f && !(uParam0->f_107[iVar0 /*113*/])->f_32.f_62) && func_196(uParam0, (uParam0->f_107[iVar0 /*113*/])->f_32.f_61, (uParam0->f_107[iVar0 /*113*/])->f_32.f_60))
		{
...
int func_383(int iParam0, bool bParam1, bool bParam2, var uParam3, var uParam4, var uParam5, float fParam6, bool bParam7, bool bParam8, bool bParam9, bool bParam10)
{
	...
	switch (((*Global_1360165)[iParam0 /*1157*/])->f_70.f_12)
	{
		...
		case 3:
			...
			sVar12 = func_418(iParam0, func_280());
