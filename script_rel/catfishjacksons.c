...
int func_38(int iParam0)
{
		...
		if (!func_60(4))
		{
			if (TASK::_0x841475AC96E794D1(iLocal_16))
			{
				if (!ENTITY::DOES_ENTITY_EXIST(iLocal_18))
				{
					...
					TXD::_0xDB1BD07FB464584D(-451886707, 0);
				}
				else if (TXD::_0xBE72591D1509FFE4(-451886707))
				{
					if (DECORATOR::DECOR_SET_INT(iLocal_18, "letter_item", -2019549022))
					{
						OBJECT::_0xE124889AE0521FCF(iLocal_18, -451886707, 0, 0);
						func_61(4);
					}
				}
			}
	...
	{
		TXD::_0x8232F37DF762ACB2(-451886707);
		func_61(8);
	}
	func_63();
	func_64();
...
void func_73(int iParam0, int iParam1, int iParam2, bool bParam3, int iParam4, int iParam5)
{
	...
	else
	{
		...
		if (!MISC::_SHOULD_USE_24_HOUR_CLOCK())
		{
			...
			sVar2 = MISC::_CREATE_VAR_STRING(674, sVar8, iVar4, func_150(&sVar6, 109029619), sVar9, func_150(&sVar10, 109029619));
		}
		else
		{
			...
			IntToString(&sVar10, BUILTIN::ROUND(fVar7), 8);
			sVar2 = MISC::_CREATE_VAR_STRING(162, sVar8, iVar4, func_150(&sVar6, 109029619), func_150(&sVar10, 109029619));
		}
...
int func_96(int iParam0, bool bParam1)
{
	...
	if (func_171(iParam0, 32) && !bParam1)
	{
		...
		if (func_20() == -1)
		{
			...
			{
				_NAMESPACE48::_0x49A8C2CD97815215(func_175(iParam0));
				func_176(iParam0, 2048);
			}
			_NAMESPACE48::_0xFCC6DB8DBE709BC8(func_175(iParam0));
		}
		return 0;
	}
	...
	if (_NAMESPACE48::_0x800DF3FC913355F3(func_175(iParam0)))
	{
		func_176(iParam0, 128);
		return 1;
	}
	func_174(iParam0, _NAMESPACE48::_0x4F76E3676583D951(func_173(iParam0)));
	_NAMESPACE48::_0x4F81EAD1DE8FA19B(func_175(iParam0));
	if (func_171(iParam0, 2048))
	{
		_NAMESPACE48::_0x49A8C2CD97815215(func_175(iParam0));
		func_176(iParam0, 2048);
...
int func_172(int iParam0, bool bParam1)
{
	...
	func_221(iParam0);
	_NAMESPACE48::_0xFC77C5B44D5FF7C0(func_175(iParam0));
	func_174(iParam0, 0);
	return 1;
}
...
{
	*uParam1 = INVENTORY::_0x640F890C3E5A3FFD(func_194(bParam3), uParam0, uParam2);
	if (*uParam1 >= 0)
	{
		return 1;
	}
...
int func_247(vector3 vParam0, int iParam3)
{
	...
	func_267(iParam3, &vVar0, &Var3, &fVar6);
	if (func_268(vParam0, vVar0, Var3, Var3.f_1, fVar6))
	{
		return 1;
	}
	return 0;
...
struct<4> func_262(int iParam0, var uParam1, var uParam2, var uParam3, var uParam4, int iParam5, bool bParam6)
{
	struct<4> Var0;
