...
{
	func_34(uParam0, 10798/*func_31*/, 10863/*func_32*/, 11344/*func_33*/);
}
...
void func_15(var uParam0, vector3 vParam1, vector3 vParam4)
{
	...
	func_47(uParam0, "RIDGELINE_RIDER", "", vParam1, vParam4);
	uVar0 = func_49(func_48(), 1, 1, 1, 1, 0, 1);
	uVar1 = func_50(997958153, 1);
	func_51(uParam0, 0, "RR_HORSE", uVar1, vParam1, (0f + vParam4.z), 1, 1, 1, 1, 41788943, 1);
	func_51(uParam0, 1, "RR_MAN", uVar0, vParam1, (0f + vParam4.z), 1, 1, 1, 1, 41788943, 1);
}
...
int func_32(var uParam0)
{
	...
	if (!&uParam0->f_469[1])
	{
		if (func_66(uParam0, &uLocal_16, 0))
		{
			func_67(uParam0);
			uParam0->f_469[1] = 1;
			iLocal_9 = 2;
	...
	switch (iLocal_9)
	{
		case 0:
			if (!ENTITY::IS_ENTITY_DEAD(&(uParam0->f_20[1 /*14*/])))
			{
				...
				func_69(&(uParam0->f_20[1 /*14*/]), &(uParam0->f_20[0 /*14*/]), 1, -1, 1);
		...
		case 1:
			if (func_72(uParam0, uParam0->f_493, uParam0->f_494, 4, uParam0->f_495, 1112014848))
			{
				...
				if (!ENTITY::IS_ENTITY_DEAD(&(uParam0->f_20[1 /*14*/])))
				{
					...
					if (bLocal_15)
					{
						TASK::TASK_PLAY_ANIM(0, "AI_GESTURES@GEN_MALE@STANDING@SPEAKER", "NEUTRAL_WAVE_FL_001", 4f, -4f, 1000, 8, 0, 0, 0, 0, 0, 0);
					}
					TASK::_TASK_MOVE_IN_TRAFFIC(0, 1f, 4, 0);
		...
		case 2:
			...
			if ((TASK::GET_SEQUENCE_PROGRESS(&(uParam0->f_20[1 /*14*/])) == iLocal_13 || uParam0->f_469[1]) // PointerArith)
			{
				return 1;
			}
			break;
...
int func_39(int iParam0, vector3 vParam1, float fParam4)
{
	...
	if (func_76(vVar0, vVar0 + vVar3, vParam1))
	{
		return 3;
	}
	return 2;
...
void func_42(var uParam0, int iParam1, int iParam2, int iParam3, int iParam4, int iParam5, int iParam6, bool bParam7)
{
	...
	iVar2 = func_81(*uParam0);
	iVar3 = func_82(*uParam0);
	iVar4 = func_83(*uParam0);
	...
	func_86(uParam0, iVar5, iVar4, iVar3, iVar2, iVar1, iVar0);
}
...
void func_51(var uParam0, int iParam1, char* sParam2, var uParam3, vector3 vParam4, float fParam7, int iParam8, int iParam9, int iParam10, int iParam11, int iParam12, int iParam13)
{
...
int func_52(int iParam0, bool bParam1, int iParam2)
{
	...
	{
		iVar0 = func_88(&(Global_1898164->f_1[0 /*5*/]));
		if (func_89(iVar0) && func_90(((*Global_1347702)[iVar0 /*49*/])->f_12, 131072))
		{
			return 0;
		}
	}
...
bool func_55()
{
	return (Global_1894899 & 1 != 0 && func_74() != -1);
}
...
int func_66(var uParam0, var uParam1, int iParam2)
{
	...
	{
		if (func_101(&(uParam0->f_20[uParam0->f_501 /*14*/]), 0, uParam1, &(uParam0->f_468), 0, 0))
		{
			return 1;
		}
		uParam0->f_501++;
...
void func_67(var uParam0)
{
	...
	if (!&uParam0->f_469[2])
	{
		func_103(*uParam0, uParam0->f_483, 0);
		uParam0->f_469[2] = 1;
	}
}

void func_68(int iParam0, vector3 vParam1, float fParam4, int iParam5, int iParam6)
{
	int iVar0;
	int iVar1;
	int iVar2;
	...
	if (iParam0 == func_104(Global_35) && PLAYER::IS_PLAYER_TELEPORT_ACTIVE())
	{
	}
	if (func_105(iParam0))
	{
		if (func_106(ENTITY::GET_PED_INDEX_FROM_ENTITY_INDEX(iParam0)))
		{
			PHYSICS::_0x0348469DAA17576C(iParam0);
		}
	}
	if (func_107(iParam5, 4) && ENTITY::IS_ENTITY_A_PED(iParam0))
	{
		iVar1 = ENTITY::GET_PED_INDEX_FROM_ENTITY_INDEX(iParam0);
		if (PED::IS_PED_ON_VEHICLE(iVar1, false))
		{
			...
			if (ENTITY::DOES_ENTITY_EXIST(iVar0) && !ENTITY::IS_ENTITY_DEAD(iVar0))
			{
				...
				func_68(iVar0, vParam1, fParam4, iParam5, iParam6);
			}
			return;
		}
		else if (PED::IS_PED_ON_MOUNT(iVar1))
		{
			...
			{
				iParam5 = (iParam5 - iParam5 & 4);
				func_68(iVar2, vParam1, fParam4, iParam5, iParam6);
			}
			return;
		}
	}
	...
	if (func_107(iParam5, 2))
	{
		...
		{
			ENTITY::_0x203BEFFDBE12E96A(iParam0, vParam1, fParam4, 1, func_107(iParam5, 32), 1);
		}
		else
		{
			ENTITY::_0x203BEFFDBE12E96A(iParam0, vParam1, fParam4, 1, func_107(iParam5, 32), 1);
	...
	else if (func_107(iParam5, 129))
	{
		...
		ENTITY::SET_ENTITY_COORDS_NO_OFFSET(iParam0, vParam1, func_107(iParam5, 32), true, true);
	...
	if (bVar4)
	{
		...
		if (ENTITY::GET_PED_INDEX_FROM_ENTITY_INDEX(iParam0) == Global_35 && !func_107(iParam5, 64))
		{
...
int func_72(var uParam0, float fParam1, float fParam2, int iParam3, float fParam4, float fParam5)
{
	...
	if ((MISC::GET_FRAME_COUNT() % 8) == 0)
	{
		...
		fVar7 = func_112(Global_36, uParam0->f_483);
		...
		while (iVar0 < uParam0->f_19)
		{
			...
			if (!ENTITY::IS_ENTITY_DEAD(&(uParam0->f_20[iVar0 /*14*/])))
			{
				...
				fVar8 = func_113(Global_35, &(uParam0->f_20[iVar0 /*14*/]), 1);
				if (fVar8 < fVar1)
				{
					return 1;
				}
...
void func_73(var uParam0, bool bParam1, bool bParam2, bool bParam3)
{
	int iVar0;
...
bool func_76(struct<2> Param0, var uParam2, struct<2> Param3, Vector3 vParam5, struct<2> Param6, var uParam8)
{
...
int func_77(vector3 vParam0, float fParam3)
{
	...
	while (iVar0 < 4)
	{
		...
		{
			if (func_117(vParam0, (Global_1415419->f_9721[iVar0 /*8*/])->f_4, fParam3, 0))
			{
				return 1;
			}
		}
...
int func_78(vector3 vParam0)
{
	...
	while (iVar0 < 10)
	{
		...
		{
			if (func_117(vParam0, (Global_32073.f_2697.f_1495[iVar0 /*4*/])->f_1, 1f, 0))
			{
				return 1;
			}
		}
...
{
	return (BUILTIN::SHIFT_RIGHT(iParam0, 26) & 31 * func_118(MISC::IS_BIT_SET(iParam0, 31), -1, 1)) + 1898;
}
...
void func_86(var uParam0, int iParam1, int iParam2, int iParam3, int iParam4, int iParam5, int iParam6)
{
...
int func_101(int iParam0, int iParam1, var uParam2, var uParam3, int iParam4, float fParam5)
{
	int iVar0;
	...
	if (!Global_1935630->f_12 && !ENTITY::IS_ENTITY_DEAD(iParam0))
	{
		...
		if (!uParam2->f_1 & 128 != 0)
		{
			...
			{
				*uParam3 = 128;
				func_134(iParam0, uParam2, *uParam3);
				return 1;
			}
		}
		if (Global_1935630->f_27)
		{
			if (!uParam2->f_1 & 8 != 0)
			{
				...
				else if (func_136(iParam0, iParam1, uParam2))
				{
					*uParam3 = 8;
					func_134(iParam0, uParam2, *uParam3);
					return 1;
		...
		if (Global_1935630->f_26 && func_138(PLAYER::PLAYER_ID(), 0, 1, uParam2->f_1 & 524288 == 0))
		{
		...
		{
			if (func_139(uParam2, 1065353216))
			{
				if (!uParam2->f_1 & 4 != 0)
				{
				...
				{
					if (func_141(Global_35, iParam0, uParam2))
					{
						*uParam3 = 256;
						func_134(iParam0, uParam2, *uParam3);
						return 1;
		...
		if (!uParam2->f_1 & 16 != 0)
		{
			...
			{
				if (func_142(Global_35, iParam0, uParam2, 0))
				{
					*uParam3 = 16;
					func_134(iParam0, uParam2, *uParam3);
					return 1;
			...
			else if (func_142(Global_35, iParam0, uParam2, 1))
			{
				*uParam3 = 16;
				func_134(iParam0, uParam2, *uParam3);
				return 1;
		...
		if (Global_1935630->f_30 || Global_1935630->f_31)
		{
			if (!uParam2->f_1 & 2 != 0)
			{
				if (func_145(uParam2, 4000))
				{
					if ((func_146(iParam0, Global_1935630->f_41, *uParam2 & 128 != 0, 0, *uParam2 & 256 != 0) && func_147(uParam2, iParam0)) && func_148(uParam2, iParam0))
					{
						*uParam3 = 2;
						func_134(iParam0, uParam2, *uParam3);
						return 1;
		...
		if (!uParam2->f_1 & 2 != 0)
		{
			if (uParam2->f_12 < 4f)
			{
				if ((func_146(iParam0, Global_1935630->f_41, *uParam2 & 128 != 0, 1, *uParam2 & 256 != 0) && func_147(uParam2, iParam0)) && func_148(uParam2, iParam0))
				{
					*uParam3 = 2;
					func_134(iParam0, uParam2, *uParam3);
					return 1;
				...
				if (Global_1935630->f_40 == 0)
				{
					if (Global_1935630->f_41 != 0)
					{
						if (*uParam2 & 131072 == 0)
						{
							if (func_149(iParam0, Global_1935630->f_41))
							{
								func_150();
								*uParam3 = 2;
								func_134(iParam0, uParam2, *uParam3);
			...
			if (uParam2->f_12 < 10f)
			{
				if (func_151(uParam2, iParam0) || (uParam2->f_9 > 0 && (func_152() - uParam2->f_9) < 2000))
				{
			...
			if (Global_1935630->f_42 != 0)
			{
				if (*uParam2 & 131072 == 0)
				{
					if (func_153())
					{
						if (func_149(iParam0, Global_1935630->f_42))
						{
							func_150();
							*uParam3 = 2;
							func_134(iParam0, uParam2, *uParam3);
		...
		if (uParam2->f_12 < uParam2->f_26)
		{
			...
			{
				if (func_155(iParam0, iParam1, uParam2))
				{
					*uParam3 = 2048;
					func_134(iParam0, uParam2, *uParam3);
					return 1;
...
void func_103(int iParam0, vector3 vParam1, bool bParam4)
{
	if (func_41() > (Global_32073.f_2697.f_6[iParam0 /*6*/])->f_5)
	{
		(Global_32073.f_2697.f_6[iParam0 /*6*/])->f_5 = func_41();
...
float func_113(int iParam0, int iParam1, bool bParam2)
{
	...
	return func_167(ENTITY::GET_ENTITY_COORDS(iParam0, false, false), ENTITY::GET_ENTITY_COORDS(iParam1, false, false));
}
...
int func_117(vector3 vParam0, vector3 vParam3, float fParam6, bool bParam7)
{
	if (fParam6 < 0f)
	{
		fParam6 = 0f;
...
void func_132(var uParam0, bool bParam1, int iParam2)
{
	func_174(iParam2);
	if (Global_1572887->f_12 == -1)
	{
	...
	switch (uParam0->f_6)
	{
		case 0:
			if (*uParam0 & 16 != 0)
			{
				...
				else if (!PED::IS_PED_PLANTING_BOMB(Global_35) && (!func_176(1) || *uParam0 & 8192 != 0))
				{
	...
	if (!uParam0->f_1 & 1024 != 0)
	{
		if (!ENTITY::DOES_ENTITY_EXIST(uParam0->f_14))
		{
			if (func_177(uParam0))
			{
				uParam0->f_15 = func_152();
			}
		}
		else if (uParam0->f_15 > 0)
		{
			if ((func_152() - uParam0->f_15) > 500)
			{
...
int func_133(int iParam0, var uParam1)
{
	...
	switch (iVar0)
	{
		...
		case 1589923363:
			...
			if (!func_179(iParam0, uParam1, iVar2))
			{
				return 0;
			}
			if (func_180(iParam0, iVar2) <= func_181(uParam1))
			{
				return 1;
			}
			break;
...
int func_135(int iParam0, var uParam1)
{
	...
	if (!ENTITY::IS_ENTITY_DEAD(iParam0))
	{
		if (func_185(iParam0, !*uParam1 & 268435456 != 0, !*uParam1 & 536870912 != 0, !*uParam1 & 1073741824 != 0, 0, 0))
		{
			if (uParam1->f_12 < 5f)
			{
				fVar0 = 95f;
			...
			fVar1 = func_186(uParam1);
			if (func_187(uParam1, iParam0, fVar0, fVar1))
			{
				if (uParam1->f_2 == 0)
				{
...
int func_136(int iParam0, int iParam1, var uParam2)
{
	...
	fVar0 = 85f;
	if (func_189(iParam1, !*uParam2 & 268435456 != 0, !*uParam2 & 536870912 != 0, !*uParam2 & 1073741824 != 0, 0))
	{
		if (uParam2->f_12 < 5f)
		{
			fVar0 = 95f;
		...
		fVar1 = func_186(uParam2);
		if (func_187(uParam2, iParam0, fVar0, fVar1))
		{
			if (uParam2->f_2 == 0)
			{
			...
			if (uParam2->f_2 != 0)
			{
				if (MISC::GET_GAME_TIMER() - uParam2->f_2) > func_188(uParam2)
				{
					func_183(uParam2, 1);
					return 1;
				}
...
int func_137(int iParam0, var uParam1)
{
	...
	if (func_179(iParam0, uParam1, iVar1))
	{
		if (uParam1->f_3 == 0)
		{
			uParam1->f_3 = MISC::GET_GAME_TIMER();
		}
		else if (MISC::GET_GAME_TIMER() - uParam1->f_3) > func_188(uParam1)
		{
			fVar3 = func_186(uParam1);
...
int func_138(int iParam0, bool bParam1, int iParam2, bool bParam3)
{
	...
	{
		return func_190(bParam1, iParam2, bParam3);
	}
	if (Global_1572887->f_12 != -1)
	{
...
int func_141(var uParam0, int iParam1, var uParam2)
{
	...
	if (uParam2->f_12 < IntToFloat(func_192(uParam2)))
	{
...
int func_142(var uParam0, int iParam1, var uParam2, bool bParam3)
{
	vector3 vVar0;
	int iVar3;
	vector3 vVar4;
		...
		switch (iVar3)
		{
			...
			case 2:
				if (EVENT::IS_SHOCKING_EVENT_IN_SPHERE(-966930978, vVar0, uParam2->f_22))
				{
					...
					if (func_194(iParam1, vVar0, vVar4))
					{
						func_183(uParam2, 1);
						return 1;
					}
		...
		switch (iVar3)
		{
			...
			case 2:
				if (EVENT::IS_SHOCKING_EVENT_IN_SPHERE(-966930978, vVar0, uParam2->f_22))
				{
					...
					if (func_194(iParam1, vVar0, vVar7))
					{
						func_183(uParam2, 1);
						return 1;
					}
...
int func_143(int iParam0, var uParam1)
{
	...
	{
		if (!func_179(iParam0, uParam1, &(Global_1935630->f_34[iVar0])) || iParam0 == &Global_1935630->f_34[iVar0])
		{
		}
		else
		{
			bVar13 = func_195(&(Global_1935630->f_34[iVar0]));
			...
			if (func_196(uParam1, iParam0, fVar1, bVar12, bVar13))
			{
				*(vVar2[0 /*3*/]) = { ENTITY::GET_ENTITY_COORDS(&(Global_1935630->f_34[iVar0]), false, false) };
				*(vVar2[1 /*3*/]) = { vVar9 };
				uParam1->f_10 = iParam0;
			...
			else if (func_197(uParam1, iParam0, fVar1, bVar12, bVar13))
			{
				*(vVar2[0 /*3*/]) = { ENTITY::GET_ENTITY_COORDS(&(Global_1935630->f_34[iVar0]), false, false) };
				*(vVar2[1 /*3*/]) = { vVar9 };
				uParam1->f_10 = iParam0;
			...
			else if (func_198(uParam1, iParam0, fVar1, iVar0))
			{
				*(vVar2[0 /*3*/]) = { ENTITY::GET_ENTITY_COORDS(&(Global_1935630->f_34[iVar0]), false, false) };
				*(vVar2[1 /*3*/]) = { vVar9 };
				uParam1->f_10 = iParam0;
...
int func_146(int iParam0, int iParam1, bool bParam2, bool bParam3, bool bParam4)
{
	int iVar0;
	int iVar1;
	int iVar2;
...
int func_149(int iParam0, int iParam1)
{
	if (!ENTITY::IS_ENTITY_DEAD(iParam1))
	{
		...
		if (func_202(iParam0, iParam1, 1, 1) < 4f)
		{
...
int func_151(var uParam0, int iParam1)
{
	...
	if (iVar0 != 0 && !VEHICLE::IS_THIS_MODEL_A_TRAIN(ENTITY::GET_ENTITY_MODEL(iVar0)))
	{
		...
		if (func_203(iVar0, iParam1, vVar1))
		{
			uParam0->f_9 = func_152();
			return 1;
		}
...
int func_154(var uParam0, int iParam1)
{
	...
	fVar0 = func_181(uParam0);
	if (uParam0->f_12 > func_205(uParam0) && uParam0->f_12 > fVar0)
	{
		return 0;
	}
	iVar2 = func_206(iParam1);
	iVar1 = func_207(uParam0->f_14);
...
int func_155(int iParam0, int iParam1, var uParam2)
{
	...
	return func_208(iParam0, iParam1, bVar0, bVar2, uParam2->f_12, bVar1);
}
...
int func_160(int iParam0, var uParam1)
{
	...
	if (uParam1->f_4 == 0)
	{
		uParam1->f_4 = func_152();
	}
	else if (func_152() - uParam1->f_4) > func_212(uParam1)
	{
		return func_213(iParam0, uParam1, 0, -1082130432);
	}
	return 0;
}
...
void func_162(int iParam0)
{
	if (func_44(iParam0))
	{
		...
		{
			case 1:
				func_214(0, 1, 0, 0, ((Global_1415419->f_19[iParam0 /*12*/])->f_7 / 4), 0, 0, 1);
				func_214(1, 1, 0, 0, ((Global_1415419->f_19[iParam0 /*12*/])->f_7 / 4), 0, 0, 1);
				break;
			case 37:
				func_214(60, 1, 0, 0, ((Global_1415419->f_19[iParam0 /*12*/])->f_7 / 4), 0, 0, 1);
				break;
		}
	}
}

void func_163(int iParam0, vector3 vParam1)
{
	int iVar0;
	int iVar1;
	...
	while (iVar0 < 10)
	{
		...
		{
			if (func_117((Global_32073.f_2697.f_1495[iVar0 /*4*/])->f_1, vParam1, 1056964608, 1))
			{
				return;
			}
		}
...
int func_169(var uParam0, float fParam1)
{
	if (!func_114(uParam0))
	{
		return 0;
...
int func_176(bool bParam0)
{
	...
	if (func_218(bParam0, &uVar0, &uVar1))
	{
		return 1;
	}
	return 0;
...
int func_179(int iParam0, var uParam1, int iParam2)
{
	...
	{
		iVar1 = func_207(iParam2);
	}
	else
	{
		iVar1 = func_206(iParam2);
	}
	if (!PED::IS_PED_HUMAN(iParam0))
	{
...
{
	return func_202(iParam0, iParam1, 1, 1);
}
...
int func_185(int iParam0, bool bParam1, bool bParam2, bool bParam3, int iParam4, int iParam5)
{
	int iVar0;
	int iVar1;
	int iVar2;
	...
	if (bParam3)
	{
		if (((WEAPON::_0xCB690F680A3EA971(iVar0, 1) && PLAYER::IS_PLAYER_TARGETTING_ENTITY(iVar1, iParam0, iParam5)) && PLAYER::IS_PLAYER_FREE_AIMING_AT_ENTITY(iVar1, iParam0)) && func_202(iVar0, iParam0, 1, 1) <= 4f)
		{
			return 1;
		}
	}
	...
	{
		if (WEAPON::_0x6AD66548840472E5(func_222(iVar0, 0)))
		{
			if (func_223(iParam0, 0.4f, 0.6f, 0.3f, 0.7f))
			{
				return 1;
			}
		}
...
int func_187(var uParam0, int iParam1, float fParam2, float fParam3)
{
	float fVar0;
...
int func_189(int iParam0, bool bParam1, bool bParam2, bool bParam3, int iParam4)
{
	int iVar0;
	int iVar1;
	...
	if (PLAYER::IS_PLAYER_FREE_AIMING(iVar1))
	{
		if (WEAPON::_0x6AD66548840472E5(func_222(iVar0, 0)))
		{
			if (func_224(ENTITY::GET_ENTITY_COORDS(iParam0, true, false), 0.4f, 0.6f, 0.3f, 0.7f))
			{
				return 1;
			}
		}
...
int func_190(bool bParam0, var uParam1, var uParam2)
{
...
int func_194(int iParam0, vector3 vParam1, vector3 vParam4)
{
	if (func_225(iParam0, vParam4, 0.5f))
	{
...
int func_196(var uParam0, int iParam1, float fParam2, bool bParam3, bool bParam4)
{
	float fVar0;
...
int func_198(var uParam0, int iParam1, float fParam2, int iParam3)
{
	float fVar0;
...
int func_200(int iParam0, int iParam1)
{
	...
	if (func_228(iParam0, 1, 0, 0) != 2055893578)
	{
		return 0;
	}
...
float func_202(int iParam0, int iParam1, bool bParam2, int iParam3)
{
...
int func_203(int iParam0, int iParam1, vector3 vParam2)
{
	float fVar0;
...
int func_208(int iParam0, int iParam1, bool bParam2, bool bParam3, float fParam4, bool bParam5)
{
	bool bVar0;
	int iVar1;
	float fVar2;
	...
	if (fParam4 <= 0f)
	{
		fVar2 = func_202(iParam0, PLAYER::PLAYER_PED_ID(), 0, 1);
	}
	else
	{
		fVar2 = fParam4;
	...
	if (bVar0)
	{
		if (func_202(iParam0, Global_1935630->f_40, 0, 1) < 2.5f)
		{
...
int func_209(int iParam0, var uParam1, bool bParam2)
{
	int iVar0;
	int iVar1;

	func_218(1, &iVar0, &iVar1);
	...
	if (ENTITY::DOES_ENTITY_EXIST(iVar0))
	{
		if (iVar0 != iParam0)
		{
			if (PED::_0x06087579E7AA85A9(iParam0, Global_35, -1f, -1f, -1f, -1f))
			{
				if (ENTITY::HAS_ENTITY_CLEAR_LOS_TO_ENTITY(iParam0, Global_35, 17))
				{
					if (!bParam2 || !func_210(uParam1, iVar0))
					{
						return 1;
					}
				}
	...
	if (ENTITY::DOES_ENTITY_EXIST(iVar1))
	{
		if (iVar1 != iParam0)
		{
			...
			{
				if (!bParam2 || !func_210(uParam1, iVar1))
				{
...
int func_213(int iParam0, var uParam1, bool bParam2, float fParam3)
{
	if (!bParam2)
	{
		if (uParam1->f_4 == 0)
...
void func_214(int iParam0, int iParam1, int iParam2, int iParam3, int iParam4, int iParam5, bool bParam6, int iParam7)
{
	int iVar0;

	iVar0 = (((iParam2 + (60 * iParam3)) + (3600 * iParam4)) + (86400 * iParam5));
	if (func_231(iParam0) == 1 && iParam7)
	{
		return;
	}
	if (bParam6)
...
int func_218(bool bParam0, var uParam1, var uParam2)
{
	int iVar0;
	int iVar1;
...
int func_223(int iParam0, float fParam1, float fParam2, float fParam3, float fParam4)
{
	if (!ENTITY::IS_ENTITY_DEAD(iParam0))
	{
		if (func_224(ENTITY::GET_ENTITY_COORDS(iParam0, true, false), fParam1, fParam2, fParam3, fParam4))
		{
			return 1;
		}
	}
...
int func_224(vector3 vParam0, float fParam3, float fParam4, float fParam5, float fParam6)
{
	float fVar0;
	float fVar1;
	bool bVar2;
