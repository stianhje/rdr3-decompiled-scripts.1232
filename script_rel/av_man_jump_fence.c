...
{
	func_33(uParam0, 10689/*func_30*/, 10747/*func_31*/, 11133/*func_32*/);
}
...
void func_14(var uParam0, vector3 vParam1, vector3 vParam4)
{
	...
	func_46(uParam0, "MAN_JUMP_FENCE", "", vParam1, vParam4);
	iVar0 = joaat("a_m_m_lowersdtownfolk_01");
	func_47(uParam0, 0, "MJFP_MAN", iVar0, vParam1, vParam4.z, 1, 1, 1, 1, 41788943, 1);
}
...
int func_31(var uParam0)
{
	if (!&uParam0->f_469[1])
	{
		if (func_62(uParam0, &uLocal_10, 0))
		{
			func_63(uParam0);
			if (!&uParam0->f_469[2])
			{
				func_64(*uParam0, uParam0->f_483, 0);
				uParam0->f_469[2] = 1;
			}
			uParam0->f_469[1] = 1;
		}
	...
	switch (iLocal_9)
	{
		case 0:
			if (!ENTITY::IS_ENTITY_DEAD(&(uParam0->f_20[0 /*14*/])))
			{
				...
				PED::_0x89F5E7ADECCCB49C(&(uParam0->f_20[0 /*14*/]), "Nervous");
				func_65(uParam0->f_20[0 /*14*/], 0, 1);
		...
		case 2:
			if (!&uParam0->f_469[2])
			{
				if (func_67(uParam0, 0.1f, 1116471296, 4, -91962372, 0))
				{
					func_64(*uParam0, uParam0->f_483, 0);
					uParam0->f_469[2] = 1;
				}
			}
			if (!func_68(&(uParam0->f_20[0 /*14*/]), -1207763510))
			{
...
int func_38(int iParam0, vector3 vParam1, float fParam4)
{
	...
	if (func_72(vVar0, vVar0 + vVar3, vParam1))
	{
		return 3;
	}
	return 2;
...
void func_41(var uParam0, int iParam1, int iParam2, int iParam3, int iParam4, int iParam5, int iParam6, bool bParam7)
{
	...
	iVar3 = func_78(*uParam0);
	iVar4 = func_79(*uParam0);
	iVar5 = func_80(*uParam0);
...
int func_48(int iParam0, bool bParam1, int iParam2)
{
	...
	if ((Global_1898164->f_1[0 /*5*/])->f_2 == 8)
	{
		...
		if (func_85(iVar0) && func_86(((*Global_1347702)[iVar0 /*49*/])->f_12, 131072))
		{
			return 0;
		}
	}
...
void func_64(int iParam0, vector3 vParam1, bool bParam4)
{
	if (func_40() > (Global_32073.f_2697.f_6[iParam0 /*6*/])->f_5)
	{
		(Global_32073.f_2697.f_6[iParam0 /*6*/])->f_5 = func_40();
...
void func_69(var uParam0, bool bParam1, bool bParam2, bool bParam3)
{
	int iVar0;
...
bool func_72(struct<2> Param0, var uParam2, struct<2> Param3, Vector3 vParam5, struct<2> Param6, var uParam8)
{
	return (((Param3 - Param0) * (Param6.f_1 - Param0.f_1)) - ((Param3.f_1 - Param0.f_1) * (Param6 - Param0))) > 0f;
}

int func_73(vector3 vParam0, float fParam3)
{
	int iVar0;
...
void func_99(int iParam0)
{
	if (func_43(iParam0))
	{
		...
		{
			case 1:
				func_160(0, 1, 0, 0, ((Global_1415419->f_19[iParam0 /*12*/])->f_7 / 4), 0, 0, 1);
				func_160(1, 1, 0, 0, ((Global_1415419->f_19[iParam0 /*12*/])->f_7 / 4), 0, 0, 1);
				break;
			case 37:
				func_160(60, 1, 0, 0, ((Global_1415419->f_19[iParam0 /*12*/])->f_7 / 4), 0, 0, 1);
				break;
		}
	}
}

void func_100(int iParam0, vector3 vParam1)
{
	int iVar0;
	int iVar1;
...
float func_105(int iParam0, int iParam1, bool bParam2)
{
	...
	return func_161(ENTITY::GET_ENTITY_COORDS(iParam0, false, false), ENTITY::GET_ENTITY_COORDS(iParam1, false, false));
}
...
void func_119(var uParam0, int iParam1)
{
	...
	if (iParam1 < 1 || iParam1 > func_81(iVar0, iVar1))
	{
		return;
	}
...
int func_158(int iParam0, var uParam1)
{
	...
	else if (func_150() - uParam1->f_4) > func_210(uParam1)
	{
...
void func_160(int iParam0, int iParam1, int iParam2, int iParam3, int iParam4, int iParam5, bool bParam6, int iParam7)
{
	int iVar0;

	iVar0 = (((iParam2 + (60 * iParam3)) + (3600 * iParam4)) + (86400 * iParam5));
	if (func_212(iParam0) == 1 && iParam7)
	{
		return;
	}
	if (bParam6)
