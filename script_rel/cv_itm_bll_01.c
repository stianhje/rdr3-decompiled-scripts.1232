...
int func_76(var uParam0)
{
	...
	uLocal_15 = func_157(uParam0, -1006095118, 0f, 0f, 0f, 0, 1, 0, 1);
	iLocal_20 = func_158(uParam0, "script@vignette@ITM@bill_item_1@base", 1, 0, 0, 0);
	iLocal_16 = func_158(uParam0, "script@vignette@ITM@bill_item_1@CALLOVER_LEFT", 2, 0, 0, 0);
	iLocal_17 = func_158(uParam0, "script@vignette@ITM@bill_item_1@CALLOVER_RIGHT", 2, 0, 0, 0);
	iLocal_18 = func_158(uParam0, "script@vignette@ITM@bill_item_1@CALLOVER_FRONT", 2, 0, 0, 0);
...
void func_468(int iParam0, int iParam1)
{
	...
	switch (iParam0)
	{
		case 11:
			...
			{
				func_515(iParam1, 1240907314, 0, 0, 2, 1, 0, 1056964608, 1065353216, -1, 0, 0, 0, 0);
				func_515(iParam1, -2088446466, 0, 0, 3, 1, 1, 1056964608, 1065353216, -1, 0, 1, 0, 0);
			}
			break;
	}
}
