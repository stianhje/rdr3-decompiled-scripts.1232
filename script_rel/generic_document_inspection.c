...
struct<4> func_758(int iParam0, int iParam1)
{
	struct<5> Var0;
	
	Var0 = { func_767(iParam0) };
	return func_768(iParam0, iParam1, Var0, Var0.f_4);
}
...
struct<5> func_767(int iParam0)
{
	...
	Var0 = { func_768(iParam0, 1328661203, func_534(), -1591664384) };
	Var0.f_4 = 1084182731;
	return Var0;
}

struct<4> func_768(int iParam0, int iParam1, var uParam2, var uParam3, var uParam4, var uParam5, int iParam6)
{
	struct<4> Var0;
...
int func_773(int iParam0, int iParam1, int iParam2, int iParam3, bool bParam4)
{
	struct<5> Var0;
	struct<4> Var5;
	...
	return func_780(iParam0, iParam1, &Var5, iParam2, iParam3, bParam4);
}
...
int func_782(int iParam0, var uParam1, var uParam2, var uParam3, var uParam4, var uParam5, bool bParam6)
{
	if (!INVENTORY::_0xB881CA836CC4B6D4(&uParam1))
	{
		return 0;
