...
int func_72(var uParam0)
{
	...
	func_151(uParam0, 1.0564f, -1.585f, 0f, -46.75f, 1.2f, 1.2f, 5f, -1612834106, 1632043240, 1, 1, 1);
	func_151(uParam0, -0.6186f, 2.04f, 0f, 39.5f, 1.55f, 1.11f, 5f, -1612834106, -1, 1, 1, 1);
	func_152(uParam0, 0.24f, 2.24f, 0.9775f, 16.2f, 1f, 0.76f, 2f, 665633627, 1);
	func_153(uParam0, 1547859810, 0f, 0f, 0f, "Knife", 0, 1, 1);
	func_153(uParam0, -1419711042, 0f, 0f, 0f, "Woodwhittle", 0, 1, 1);
	iLocal_18 = func_153(uParam0, -1006095118, 1.2f, -1.868f, -0.0285f, 0, 1, 0, 1);
	iLocal_19 = func_153(uParam0, 1271647689, -1.372f, 1.604f, -0.0733f, 0, 1, 0, 1);
	func_154(uParam0, "script@vignette@dog_5@base", 1, 1, 0, 0);
	iLocal_17 = func_154(uParam0, "script@vignette@dog_5@action", 0, 0, 1, 0);
	func_155(uParam0, iLocal_14, 3, 825624686, "WORLD_ANIMAL_DOG_RESTING", -1, 1);
	func_156(uParam0, iLocal_14, 1);
	func_155(uParam0, iLocal_16, 3, -1426662425, "PROP_HUMAN_SEAT_CHAIR_GENERIC_MALE_A", iLocal_19, 0);
	func_157(uParam0, iLocal_16, 2, -1426662425, "PROP_HUMAN_SEAT_CHAIR_GENERIC_MALE_A", iLocal_19, 0, -1073741824, 1065353216, 1);
	func_155(uParam0, iLocal_15, 3, 953851965, "PROP_HUMAN_SEAT_CHAIR_WHITTLE_MALE_A", iLocal_18, 0);
	return 1;
}
	...
	if (bLocal_21)
	{
		if (!ENTITY::IS_ENTITY_DEAD(func_48(uParam0, iLocal_14)))
		{
			if (func_197(func_48(uParam0, iLocal_14), 258748395))
			{
				...
				func_198(uParam0, iLocal_14, 1, 1);
			}
			if (!iLocal_22 && !func_197(func_48(uParam0, iLocal_14), 242628503))
			{
...
int func_196(var uParam0, int iParam1)
{
	...
	{
		if (!func_197((uParam0->f_107[iParam1 /*113*/])->f_5, 1435919172))
		{
			return 1;
		}
	}
...
void func_204(var uParam0)
{
	...
	while (iVar0 < uParam0->f_106)
	{
		if (((uParam0->f_107[iVar0 /*113*/])->f_32.f_60 > 0f && !(uParam0->f_107[iVar0 /*113*/])->f_32.f_62) && func_195(uParam0, (uParam0->f_107[iVar0 /*113*/])->f_32.f_61, (uParam0->f_107[iVar0 /*113*/])->f_32.f_60))
		{
...
void func_338(var uParam0, int iParam1)
{
	...
	func_376(sVar1, uVar2, uVar3, iVar4);
}
...
int func_342(var uParam0, int iParam1)
{
	...
	while (iVar2 <= iVar1)
	{
		...
		else
		{
			...
			vVar10 = { func_379(fVar9) };
			vVar13 = { func_380(ENTITY::GET_ENTITY_COORDS((uParam0->f_107[iParam1 /*113*/])->f_5, true, false), vVar3, 1065353216) };
...
void func_376(char* sParam0, var uParam1, var uParam2, int iParam3)
{
...
Vector3 func_379(float fParam0)
{
...
{
	return func_407(vParam3 - vParam0) * Vector(fParam6, fParam6, fParam6);
}
...
int func_384(int iParam0, bool bParam1, bool bParam2, var uParam3, var uParam4, var uParam5, float fParam6, bool bParam7, bool bParam8, bool bParam9, bool bParam10)
{
	...
	switch (((*Global_1360165)[iParam0 /*1157*/])->f_70.f_12)
	{
		...
		case 3:
			...
			sVar12 = func_415(iParam0, func_281());
...
void func_414(int iParam0, int iParam1)
{
	...
	func_375(iParam0, func_444(iParam1));
	...
	func_386(iParam1, func_442(iParam1, 8192), func_442(iParam1, 16384), 1);
}
		...
		case 1:
			switch (iParam0)
			{
				...
				case 9:
					...
					break;
				case 10:
					if (func_387(((*Global_1347702)[63 /*49*/])->f_15, 1) || func_424(((*Global_1347702)[63 /*49*/])->f_15))
					{
						iVar1[0] = -268604689;
					}
					else
		...
		case 3:
			switch (iParam0)
			{
				...
				case 10:
					...
					break;
				case 11:
					if (func_387(((*Global_1347702)[134 /*49*/])->f_15, 1) || func_424(((*Global_1347702)[134 /*49*/])->f_15))
					{
						iVar1[0] = -2040275819;
						iVar1[1] = 1205492208;
						iVar7 = 2;
