...
int func_72(var uParam0)
{
	...
	if (uParam0->f_2 == 6)
	{
		...
		func_151(uParam0, 0.05f, -0.1375f, 0f, 0f, 1.17f, 1.2125f, 3.77f, -1612834106, -2055224817, 1, 1, 1);
		func_152(uParam0, iLocal_14, 3, -1426662425, "PROP_HUMAN_SEAT_CHAIR_GENERIC_FEMALE_C", -1, 0);
		func_153(uParam0, iLocal_14, 3, -1426662425, "PROP_HUMAN_SEAT_CHAIR_GENERIC_FEMALE_C", -1, 0, -1073741824, 1065353216, 1);
		func_154(uParam0, iLocal_14, "START_SEATED_FEMALE_B_TO_SEAT_BENCH_FEMALE_A");
		iLocal_16 = func_155(uParam0, "script@ambient@campfiregeneral@seat_chair_pet_dog_sitting@female_pet_dog", 0, 1, 0, 0);
	...
	else if (uParam0->f_2 == 7)
	{
		...
		iLocal_15 = func_150(uParam0, 12, "Dog");
		func_151(uParam0, 0.05f, -0.1375f, 0f, 0f, 1.17f, 1.2125f, 3.77f, -1612834106, -2087487524, 1, 1, 1);
		func_152(uParam0, iLocal_14, 3, -38747227, "PROP_CAMP_FIRE_SEATED_MALE_F", -1, 0);
		func_153(uParam0, iLocal_14, 3, -38747227, "PROP_CAMP_FIRE_SEATED_MALE_F", -1, 0, -1073741824, 1065353216, 1);
		func_154(uParam0, iLocal_14, "START_SEATED_MALE_F_TO_SEAT_BOX_MALE_A");
		iLocal_16 = func_155(uParam0, "script@ambient@campfiregeneral@seat_chair_pet_dog_sitting@male_pet_dog", 0, 1, 0, 0);
		iLocal_17 = func_156(uParam0, iLocal_16, "pl_Male_Pet_2_Right", 1);
	}
	func_152(uParam0, iLocal_15, 3, 1951165908, "WORLD_ANIMAL_DOG_SITTING", -1, 1);
	func_153(uParam0, iLocal_15, 2, 1951165908, "WORLD_ANIMAL_DOG_SITTING", -1, 1, -1073741824, 1065353216, 1);
...
{
	func_189(uParam0, iLocal_16, "BOOL_BASE_LOOP", 1);
	return 1;
}
...
void func_152(var uParam0, int iParam1, int iParam2, int iParam3, char* sParam4, int iParam5, int iParam6)
{
...
void func_153(var uParam0, int iParam1, int iParam2, int iParam3, char* sParam4, int iParam5, int iParam6, float fParam7, int iParam8, int iParam9)
{
...
void func_154(var uParam0, int iParam1, char* sParam2)
{
	if (!MISC::IS_STRING_NULL_OR_EMPTY(sParam2))
	{
...
int func_156(var uParam0, var uParam1, char* sParam2, int iParam3)
{
	int iVar0;
	char cVar1[64];
...
int func_189(var uParam0, int iParam1, char* sParam2, bool bParam3)
{
	int iVar0;
