...
int func_86(var uParam0)
{
	...
	if (func_148(uParam0) == 2)
	{
		...
		if (ENTITY::DOES_ENTITY_EXIST(iVar0))
		{
			ENTITY::_0x203BEFFDBE12E96A(iVar0, func_187(uParam0, -0.380632f, -6.0838f, 0.155003f), func_188(uParam0, 179.14f), 1, false, 1);
		}
	}
	return 1;
}
