...
int func_72(var uParam0)
{
	...
	iLocal_15 = func_151(uParam0, 843299161, 0f, 0f, 0f, "p_cs_rope03x", 0, 0, 1);
	func_152(uParam0, 0.3002f, -4.1348f, 0.9471f, 122.283f, 1f, 1f, 3f, -1612834106, 211687389, 1, 1, 1);
	func_153(uParam0, "script@vignette@kieran_4@base", 1, 1, 0, 0);
	func_153(uParam0, "script@vignette@kieran_4@action", 0, 0, 1, 1);
	func_154(uParam0, "KIE4AUD");
	func_155(uParam0, iLocal_14, 3, -1772467531, "WORLD_CAMP_KIERAN_TIED_TREE_MALE_A", -1, 1);
	func_156(uParam0, iLocal_14, 2, -1772467531, "WORLD_CAMP_KIERAN_TIED_TREE_MALE_A", -1, 1, -1f, 1065353216, 1);
	...
	func_161(uParam0, 950494989, 1665087456);
	iLocal_16 = func_162(uParam0, -2.6375f, -2.2877f, 1f, 0f, 0f, 0f, 4f, 9.9f, 5f, "TRIGGER", -1612834106);
	func_163(uParam0, 1);
...
{
	return func_196(Global_35, iLocal_16, 1, 0);
}
...
int func_93(var uParam0)
{
	if (!bLocal_17)
	{
		...
		{
			func_205(uParam0, iLocal_14, 0, 1);
			bLocal_17 = true;
		}
	}
	if (bLocal_17)
	{
		...
		{
			_NAMESPACE48::_0x631CD2D77FDC0316(_NAMESPACE48::_0x32A1E3B83D501096(func_48(uParam0, iLocal_14)));
			_NAMESPACE48::_0xD4B614179BCD0654(_NAMESPACE48::_0x32A1E3B83D501096(func_48(uParam0, iLocal_14)));
			func_56(10, 0, 0, 1, -1082130432, 1, 1, 0, 0, 0, 0);
		}
	}
	return 1;
}
...
int func_195(var uParam0, int iParam1, bool bParam2)
{
	...
	if (bParam2)
	{
		...
		while (iVar1 < uParam0->f_1984)
		{
			...
			else if (func_297(uParam0, iVar1) || func_298(uParam0, iVar1))
			{
...
int func_204(var uParam0, int iParam1)
{
	...
	{
		if (!func_307((uParam0->f_107[iParam1 /*113*/])->f_5, 1435919172))
		{
			return 1;
		}
	}
