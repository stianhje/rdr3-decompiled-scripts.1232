...
int func_72(var uParam0)
{
	...
	uLocal_17 = func_152(uParam0, joaat("p_chairfolding02x"), 1.19747f, -1.86925f, -0.0285034f, 0, 1, 0, 1);
	uLocal_18 = func_152(uParam0, joaat("p_chairfolding02x"), -11.5514f, 7.15822f, 0.346359f, 0, 1, 0, 1);
	uLocal_19 = func_152(uParam0, joaat("p_bench_log07x"), -1.35271f, 1.61457f, -0.0227356f, 0, 1, 0, 1);
	func_153(uParam0, iLocal_15, 3, -1426662425, "PROP_HUMAN_SEAT_CHAIR_GENERIC_MALE_D", uLocal_18, 0);
	func_154(uParam0, iLocal_15, 3, -1426662425, "PROP_HUMAN_SEAT_CHAIR_GENERIC_MALE_D", uLocal_18, 0, -1073741824, 0f, 1);
	func_155(uParam0, iLocal_15, 2, 4, 0, 0, 0);
	func_156(uParam0, iLocal_15, 1);
	func_153(uParam0, iLocal_16, 3, 660335536, "PROP_HUMAN_SEAT_CRATE_CLEAN_BOOTS_MALE_A", uLocal_17, 0);
	func_154(uParam0, iLocal_16, 3, 660335536, "PROP_HUMAN_SEAT_CRATE_CLEAN_BOOTS_MALE_A", uLocal_17, 0, -1073741824, 1065353216, 1);
	func_157(uParam0, iLocal_16, iLocal_20, "p_cs_rag02x_PH_R_HAND", 0, 0);
	func_155(uParam0, iLocal_16, 1, 1, 0, 0, 0);
	func_153(uParam0, iLocal_14, 3, -1074764191, "PROP_CAMP_FIRE_SEAT_BENCH_MALE_B", uLocal_19, 0);
	func_154(uParam0, iLocal_14, 2, -1074764191, "PROP_CAMP_FIRE_SEAT_BENCH_MALE_B", uLocal_19, 0, -1073741824, 0f, 1);
...
void func_153(var uParam0, int iParam1, int iParam2, int iParam3, char* sParam4, var uParam5, int iParam6)
{
...
void func_154(var uParam0, int iParam1, int iParam2, int iParam3, char* sParam4, var uParam5, int iParam6, float fParam7, float fParam8, int iParam9)
{
