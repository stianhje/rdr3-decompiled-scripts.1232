...
int func_72(var uParam0)
{
	...
	uLocal_20 = func_152(uParam0, joaat("p_chair_barrel04b"), -0.584518f, -1.37169f, -0.000602722f, "BARREL", 1, 0, 1);
	uLocal_21 = func_152(uParam0, joaat("p_chair_crate15x"), 0.636307f, 1.3249f, -0.00391388f, 0, 1, 0, 1);
	func_152(uParam0, joaat("p_chair_crate02x"), func_153(uParam0, vLocal_22), 0, 1, 0, 1);
	func_154(uParam0, iLocal_14, 3, 1627566189, "PROP_CAMP_SEAT_CHAIR_TABLE_STEW_EATING_FEMALE_A", uLocal_21, 0, -1073741824, 1065353216, 1);
	...
	func_156(uParam0, iLocal_15, 3, 1627566189, "PROP_CAMP_SEAT_CHAIR_TABLE_STEW_EATING_FEMALE_B", uLocal_20, 0);
