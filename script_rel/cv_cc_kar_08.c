...
int func_72(var uParam0)
{
	switch (func_148(uParam0))
	{
		case 1:
			...
			vLocal_22 = { -140.363f, -39.3589f, 94.5064f };
			break;
		case 2:
			func_149(uParam0, 85, 0, 0, 0);
			vLocal_22 = { 684.486f, -1246.86f, 42.9939f };
			break;
		default:
			return 0;
	}
	...
	func_151(uParam0, 0.6625f, 1.275f, 1f, -22f, 1.1f, 1.1f, 2.75f, -1612834106, -695792551, 1, 1, 1);
	func_151(uParam0, -0.5473f, -1.0901f, 1f, -21f, 1f, 1f, 2.5f, -1612834106, -1689743484, 1, 1, 1);
	func_151(uParam0, vLocal_22, 0f, 1f, 1f, 2.5f, -1612834106, -1689743484, 0, 1, 1);
	iLocal_16 = func_152(uParam0, 587066646, 0f, 0f, 0f, "BOWL1", 0, 0, 1);
	iLocal_17 = func_152(uParam0, -755866836, 0f, 0f, 0f, "SPOON1", 0, 0, 1);
	iLocal_18 = func_152(uParam0, 587066646, 0f, 0f, 0f, "BOWL0", 0, 0, 1);
	iLocal_19 = func_152(uParam0, -755866836, 0f, 0f, 0f, "SPOON0", 0, 0, 1);
	iLocal_20 = func_152(uParam0, 264425748, -0.584518f, -1.37169f, -0.000602722f, "BARREL", 1, 0, 1);
	iLocal_21 = func_152(uParam0, 1504738597, 0.636307f, 1.3249f, -0.00391388f, 0, 1, 0, 1);
	func_152(uParam0, 1230724566, func_153(uParam0, vLocal_22), 0, 1, 0, 1);
	func_154(uParam0, iLocal_14, 3, 1627566189, "PROP_CAMP_SEAT_CHAIR_TABLE_STEW_EATING_FEMALE_A", iLocal_21, 0, -1073741824, 1065353216, 1);
	...
	func_156(uParam0, iLocal_15, 3, 1627566189, "PROP_CAMP_SEAT_CHAIR_TABLE_STEW_EATING_FEMALE_B", iLocal_20, 0);
	func_157(uParam0, iLocal_15, 3, 0);
	func_154(uParam0, iLocal_15, 3, -1666245605, "PROP_CAMP_SEAT_CHAIR_STEW_EATING_FEMALE_A", -1, 0, 120f, 1065353216, 1);
	...
	func_158(uParam0, "script@vignette@karen_8@base", 1, 1, 0, 0);
	func_158(uParam0, "script@vignette@karen_8@action", 0, 0, 1, 0);
...
{
	return STREAMING::_0x9427C94D2E4094A4(1627566189, 0);
}
...
Vector3 func_153(var uParam0, vector3 vParam1)
{
	vector3 vVar0;
	float fVar3;
	float fVar4;
...
void func_154(var uParam0, int iParam1, int iParam2, int iParam3, char* sParam4, int iParam5, int iParam6, float fParam7, int iParam8, int iParam9)
{
...
void func_157(var uParam0, int iParam1, int iParam2, int iParam3)
{
	...
	{
		case 4:
			(uParam0->f_107[iParam1 /*113*/])->f_32.f_5 = { func_254(func_148(uParam0), func_253(uParam0, iParam1), func_19(uParam0), 1) };
			break;
		default:
			Var0 = { func_255(func_148(uParam0), func_253(uParam0, iParam1), func_19(uParam0), 1) };
...
void func_159(var uParam0, char* sParam1)
{
		...
		else
		{
			...
			else
			{
				...
				while (iVar6 < uParam0->f_1984)
				{
					...
					{
						func_286((uParam0->f_1711[iVar0 /*15*/])->f_10, &(uParam0->f_1984[iVar6]), (uParam0->f_1711[iVar0 /*15*/])->f_4);
					}
					iVar6++;
				}
			}
			...
			else
			{
				...
				else
				{
					...
					while (iVar2 < uParam0->f_1984)
					{
						...
						{
							func_286((uParam0->f_1967[iVar1 /*4*/])->f_3, &(uParam0->f_1984[iVar2]), (uParam0->f_1967[iVar1 /*4*/])->f_2);
						}
						iVar2++;
					}
				}
...
void func_186(var uParam0)
{
	...
	while (iVar0 < uParam0->f_106)
	{
		...
		{
			func_287((uParam0->f_107[iVar0 /*113*/])->f_1, (uParam0->f_107[iVar0 /*113*/])->f_32.f_40, -1);
		}
		iVar0++;
	}
}
...
void func_188(var uParam0)
{
	...
	if (!uParam0->f_4)
	{
		...
		while (iVar2 < uParam0->f_106)
		{
			...
			{
				uVar0 = func_288(ENTITY::GET_ENTITY_COORDS((uParam0->f_107[iVar2 /*113*/])->f_5, true, false));
				uVar1 = func_288((uParam0->f_107[iVar2 /*113*/])->f_96);
				if (uVar0 || uVar1)
				{
...
int func_189(var uParam0, int iParam1, bool bParam2)
{
	...
	if (bParam2)
	{
		...
		while (iVar1 < uParam0->f_1984)
		{
			...
			else if (func_292(uParam0, iVar1) || func_293(uParam0, iVar1))
			{
...
Vector3 func_254(int iParam0, int iParam1, int iParam2, bool bParam3)
{
	switch (iParam0)
	{
		case 0:
...
struct<4> func_255(int iParam0, int iParam1, int iParam2, bool bParam3)
{
	switch (iParam0)
	{
		case 1:
		...
		case 3:
			...
			switch (iParam1)
			{
				...
				case 14:
					...
					{
						case 156:
							return func_325(2329.663f, 1347.464f, 104.5794f, 155.2611f);
						default:
							break;
					}
					break;
				case 1:
					switch (iParam2)
					{
						...
						case 156:
							return func_325(2330.225f, 1345.275f, 104.7174f, 21.2991f);
						default:
							break;
					}
					break;
			...
			switch (iParam1)
			{
				...
				case 4:
					...
					{
						case 669:
							return func_325(-1603.036f, -1408.744f, 80.9423f, 69.6409f);
						default:
							break;
					}
					break;
...
int func_277(var uParam0, int iParam1, vector3 vParam2)
{
	...
	{
		iVar5 = func_288(ENTITY::GET_ENTITY_COORDS((uParam0->f_107[iParam1 /*113*/])->f_5, true, false));
		iVar6 = func_288((uParam0->f_107[iParam1 /*113*/])->f_96);
		if (iVar5 != iVar6)
		{
...
int func_287(int iParam0, struct<8> Param1, int iParam9)
{
	int iVar0;
	var uVar1;
...
struct<4> func_325(vector3 vParam0, float fParam3)
{
	struct<4> Var0;
...
int func_385(int iParam0, bool bParam1, bool bParam2, var uParam3, var uParam4, var uParam5, float fParam6, bool bParam7, bool bParam8, bool bParam9, bool bParam10)
{
	...
	switch (((*Global_1360165)[iParam0 /*1157*/])->f_70.f_12)
	{
		...
		case 3:
			...
			sVar12 = func_420(iParam0, func_282());
		...
		case 7:
			switch (iParam0)
			{
				...
				case 14:
					...
					break;
				case 4:
					if (func_323(747937920, 1) && !func_388(((*Global_1347702)[1 /*49*/])->f_15, 1))
					{
						iVar1[0] = -1155031950;
					}
					else
