...
int func_79(var uParam0)
{
	...
	if (!iLocal_16)
	{
		if (!CAM::IS_SPHERE_VISIBLE(vLocal_18, 1.4f))
		{
			...
			iLocal_21 = PROPSET::_CREATE_PROPSET_2(-910250514, vVar0, 0, fVar3, 1200f, false, true);
			iLocal_16 = 1;
		}
	}
	return iLocal_16;
...
int func_90(var uParam0)
{
	if (TASK::_0x841475AC96E794D1(iLocal_37) && ENTITY::DOES_ENTITY_EXIST(func_9(uParam0, iLocal_15)))
	{
		...
		TASK::_TASK_USE_SCENARIO_POINT(func_9(uParam0, iLocal_15), iLocal_37, sLocal_39, 0, 0, 1, 0, 0, -1082130432, 0);
	}
	return 1;
}
...
int func_112(int iParam0, int iParam1, int iParam2, bool bParam3, bool bParam4)
{
	...
	if (func_125(iVar0, 0))
	{
		...
		{
			if (iParam2 || !(ENTITY::IS_ENTITY_ON_SCREEN(iVar0) && func_223(PLAYER::PLAYER_PED_ID(), iVar0, 1) < 10000f))
			{
...
int func_172()
{
	...
	if (!PROPSET::_HAS_PROPSET_LOADED_2(-910250514))
	{
		PROPSET::_REQUEST_PROPSET_2(-910250514);
		return 0;
	}
...
void func_322(var uParam0, var uParam1, int iParam2)
{
...
int func_396(var uParam0, int iParam1, bool bParam2, bool bParam3, var uParam4, var uParam5, var uParam6, bool bParam7, bool bParam8, var uParam9, var uParam10, var uParam11, float fParam12, bool bParam13, bool bParam14, bool bParam15, bool bParam16, bool bParam17)
{
	...
	if ((!ENTITY::DOES_ENTITY_EXIST(iVar0) || !func_125(iVar0, 0)) || (bParam3 && !func_55(iParam1)))
	{
		if (bParam2)
		{
			...
			{
				iVar0 = func_443(iParam1, bParam3, bParam8, uParam9, uParam10, uParam11, fParam12, bParam7, bParam15, bParam16, bParam17);
			}
			else
			{
				*uParam0 = 1;
...
int func_406(int iParam0, bool bParam1, int iParam2, int iParam3, int iParam4, int iParam5, float fParam6, int iParam7, int iParam8, bool bParam9, bool bParam10, bool bParam11, int iParam12, int iParam13, bool bParam14, bool bParam15, bool bParam16, bool bParam17, bool bParam18, bool bParam19, bool bParam20, bool bParam21, bool bParam22, bool bParam23, bool bParam24)
{
	...
	switch (((*Global_1360165)[iParam0 /*1157*/])->f_11)
	{
		...
		case 1:
			...
			if (func_451(iParam0, vVar0, iParam13, 0, 1, bParam17, bParam20, -1, 1, 0))
			{
				func_450(iParam0, 2);
			}
			break;
		...
		case 3:
			if (!ENTITY::IS_ENTITY_DEAD(Global_1360165[iParam0 /*1157*/]) && !ANIMSCENE::_0x3AB6C7B0BB0DF4B1(Global_1360165[iParam0 /*1157*/], -1))
			{
				...
				func_453(Global_1360165[iParam0 /*1157*/], vVar0, fParam6, 2, 1073741824);
			}
			else if (bParam16)
			{
...
int func_436(var uParam0, int iParam1)
{
	...
	while (iVar2 <= iVar1)
	{
		...
		else
		{
			...
			vVar13 = { func_476(ENTITY::GET_ENTITY_COORDS((uParam0->f_107[iParam1 /*113*/])->f_5, true, false), vVar3, 1065353216) };
...
int func_443(int iParam0, bool bParam1, bool bParam2, var uParam3, var uParam4, var uParam5, float fParam6, bool bParam7, bool bParam8, bool bParam9, bool bParam10)
{
	vector3 vVar0;
	int iVar3;
	char* sVar4;
	...
	switch (((*Global_1360165)[iParam0 /*1157*/])->f_70.f_12)
	{
		case 0:
			...
			{
				if (!func_479(iParam0) && func_480(iParam0, &sVar4))
				{
					_NAMESPACE48::_0x187D65F3AEC5D679(func_224(iParam0, 1), &sVar4);
				}
		...
		case 1:
			if (!Global_1359489->f_12)
			{
				...
				if (!func_482(iParam0, vVar0, fParam6, bParam10))
				{
					return func_481();
				}
				if (func_125(((*Global_1360165)[iParam0 /*1157*/])->f_124, 0))
		...
		case 3:
			...
			if ((bParam2 && !func_221(vVar0)) && !func_222(vVar0, ENTITY::GET_ENTITY_COORDS(((*Global_1360165)[iParam0 /*1157*/])->f_124, true, false), 1056964608, 1))
			{
				...
				func_453(((*Global_1360165)[iParam0 /*1157*/])->f_124, vVar0, fParam6, 2, 1073741824);
			}
			if (bParam1)
			{
				if (!ENTITY::_0x88AD6CC10D8D35B2(((*Global_1360165)[iParam0 /*1157*/])->f_124))
...
int func_451(int iParam0, vector3 vParam1, int iParam4, bool bParam5, bool bParam6, bool bParam7, bool bParam8, int iParam9, int iParam10, bool bParam11)
{
	if (!func_108(iParam0))
	{
		return 0;
...
bool func_459(int iParam0, int iParam1)
{
	...
	if (iParam1 && !ENTITY::DOES_ENTITY_EXIST(func_245(iParam0)))
	{
		return false;
	}
...
int func_469(var uParam0, var uParam1, var uParam2, bool bParam3)
{
	*uParam1 = INVENTORY::_0x640F890C3E5A3FFD(func_419(bParam3), uParam0, uParam2);
	if (*uParam1 >= 0)
	{
		return 1;
	}
...
int func_482(int iParam0, vector3 vParam1, float fParam4, bool bParam5)
{
	int iVar0;
...
bool func_509(int iParam0, int iParam1, bool bParam2, bool bParam3, int iParam4, bool bParam5, int iParam6, int iParam7, int iParam8, int iParam9, bool bParam10, bool bParam11, bool bParam12, bool bParam13)
{
	bool bVar0;
	int iVar1;
	int iVar2;
...
struct<4> func_511(int iParam0, var uParam1, var uParam2, var uParam3, var uParam4, int iParam5, bool bParam6)
{
	struct<4> Var0;
...
{
	return func_554(iParam0, *uParam1, iParam2, bParam3) > 0;
}
