...
{
	func_33(uParam0, 10942/*func_30*/, 11001/*func_31*/, 12073/*func_32*/);
}
...
void func_14(var uParam0, vector3 vParam1, vector3 vParam4)
{
	...
	{
		case 138:
			func_46(uParam0, "WOLF_TAKEDOWN_MISS", "script@ambient@animal@COYOTE_TAKEDOWN_MISS_DEER@action", vParam1, vParam4);
			iLocal_9 = 480688259;
			sVar0 = "COYOTE";
			break;
		case 247:
			func_46(uParam0, "WOLF_TAKEDOWN_MISS", "script@ambient@animal@WOLF_TAKEDOWN_MISS_DEER@action", vParam1, vParam4);
			iLocal_9 = -885451903;
			sVar0 = "WOLF";
			break;
	}
	...
	func_48(uParam0, 0, sVar0, iLocal_9, 0f, 0f, 0f, 0f, 1, 1, 1, 1, 41788943, 0);
	func_48(uParam0, 1, "DEER", iLocal_10, 0f, 0f, 0f, 0f, 1, 1, 1, 1, 41788943, 0);
}
...
int func_28(var uParam0)
{
	...
	{
		func_56(uParam0->f_20[0 /*14*/], 1, 1);
	}
	if (!ENTITY::IS_ENTITY_DEAD(&(uParam0->f_20[1 /*14*/])))
	{
		func_56(uParam0->f_20[1 /*14*/], 1, 1);
	}
	return 1;
}
...
int func_31(var uParam0)
{
	...
	if (!&uParam0->f_469[0])
	{
		if (!bLocal_13 == 1)
		{
			if (func_64(uParam0, &uLocal_19, 1) || func_65(Global_35, &(uParam0->f_20[0 /*14*/]), 1) <= 625f)
			{
				bLocal_13 = true;
			}
		}
		if (bLocal_13)
		{
			if ((!ENTITY::HAS_ANIM_EVENT_FIRED(&(uParam0->f_20[0 /*14*/]), 725039534) || ENTITY::IS_ENTITY_DEAD(&(uParam0->f_20[1 /*14*/]))) || ENTITY::IS_ENTITY_DEAD(&(uParam0->f_20[0 /*14*/])))
			{
				...
				if (!&uParam0->f_469[7])
				{
					func_69(*uParam0, uParam0->f_483, 1);
					uParam0->f_469[7] = 1;
				}
				func_70(uParam0);
				uParam0->f_469[0] = 1;
	...
	if (!&uParam0->f_469[7])
	{
		if (func_73(uParam0, 1.5f, 1116471296, 4, -91962372, 1))
		{
			func_69(*uParam0, uParam0->f_483, 1);
			uParam0->f_469[7] = 1;
		}
	...
	if (!&uParam0->f_469[0] && !bLocal_13)
	{
		switch (iLocal_18)
		{
			case 0:
							...
							if (!&uParam0->f_469[6])
							{
								if (ANIMSCENE::_0x005E6F28DD7ED58D(uParam0->f_3.f_1, (uParam0->f_20[1 /*14*/])->f_1))
								{
									if (!ENTITY::IS_ENTITY_DEAD(&(uParam0->f_20[1 /*14*/])))
									{
										...
										PED::FORCE_PED_MOTION_STATE(&(uParam0->f_20[1 /*14*/]), -1115154469, false, 0, false);
							...
							if (!&uParam0->f_469[5])
							{
								if (ANIMSCENE::_0x005E6F28DD7ED58D(uParam0->f_3.f_1, (uParam0->f_20[0 /*14*/])->f_1))
								{
									if (!ENTITY::IS_ENTITY_DEAD(&(uParam0->f_20[0 /*14*/])))
									{
										...
										PED::FORCE_PED_MOTION_STATE(&(uParam0->f_20[0 /*14*/]), -530524, false, 0, false);
										TASK::SET_PED_DESIRED_MOVE_BLEND_RATIO(&(uParam0->f_20[0 /*14*/]), 2f);
										TASK::TASK_FOLLOW_TO_OFFSET_OF_ENTITY(&(uParam0->f_20[0 /*14*/]), &(uParam0->f_20[1 /*14*/]), 0f, 5f, 0f, 2f, 7500, 1036831949, 1, 1, 0, 1, 1);
				...
				break;
			case 1:
				if (!func_74(&(uParam0->f_20[0 /*14*/]), 1056466932))
				{
					func_56(uParam0->f_20[1 /*14*/], 0, 1);
					func_56(uParam0->f_20[0 /*14*/], 0, 1);
...
int func_38(int iParam0, vector3 vParam1, float fParam4)
{
	...
	if (func_78(vVar0, vVar0 + vVar3, vParam1))
	{
		return 3;
	}
	return 2;
...
void func_41(var uParam0, int iParam1, int iParam2, int iParam3, int iParam4, int iParam5, int iParam6, bool bParam7)
{
	...
	func_88(uParam0, iVar5, iVar4, iVar3, iVar2, iVar1, iVar0);
}
...
int func_49(int iParam0, bool bParam1, int iParam2)
{
	...
	if ((Global_1898164->f_1[0 /*5*/])->f_2 == 8)
	{
		...
		if (func_91(iVar0) && func_92(((*Global_1347702)[iVar0 /*49*/])->f_12, 131072))
		{
			return 0;
		}
	}
...
bool func_52()
{
	return (Global_1894899 & 1 != 0 && func_76() != -1);
}
...
int func_54(int iParam0, vector3 vParam1, float fParam4, bool bParam5, bool bParam6, int iParam7, bool bParam8, bool bParam9, bool bParam10, bool bParam11, bool bParam12, bool bParam13, bool bParam14)
{
	...
	func_94(iVar0, iParam0, iParam7, bParam8, bParam9, bParam10, bParam11, bParam12);
	return iVar0;
}
...
void func_56(var uParam0, bool bParam1, int iParam2)
{
...
int func_64(var uParam0, var uParam1, int iParam2)
{
	...
	{
		if (func_103(&(uParam0->f_20[uParam0->f_501 /*14*/]), 0, uParam1, &(uParam0->f_468), 0, 0))
		{
			return 1;
		}
		uParam0->f_501++;
...
void func_69(int iParam0, vector3 vParam1, bool bParam4)
{
	if (func_40() > (Global_32073.f_2697.f_6[iParam0 /*6*/])->f_5)
	{
		(Global_32073.f_2697.f_6[iParam0 /*6*/])->f_5 = func_40();
...
void func_70(var uParam0)
{
	if (*uParam0 == 247)
	{
		if (!ENTITY::IS_ENTITY_DEAD(&(uParam0->f_20[0 /*14*/])))
		{
			if (func_65(&(uParam0->f_20[0 /*14*/]), Global_35, 1) <= 3600f)
			{
				if (!func_74(&(uParam0->f_20[0 /*14*/]), 780511057))
				{
			...
			{
				TASK::_TASK_SMART_FLEE_STYLE_PED(&(uParam0->f_20[0 /*14*/]), Global_35, 4, 256, -1082130432, -1, 0);
				func_56(uParam0->f_20[0 /*14*/], 0, 1);
				PED::SET_PED_KEEP_TASK(&(uParam0->f_20[0 /*14*/]), true);
			}
		}
...
int func_73(var uParam0, float fParam1, float fParam2, int iParam3, int iParam4, bool bParam5)
{
	int iVar0;
...
bool func_78(struct<2> Param0, var uParam2, struct<2> Param3, Vector3 vParam5, struct<2> Param6, var uParam8)
{
...
int func_79(vector3 vParam0, float fParam3)
{
	...
	while (iVar0 < 4)
	{
		...
		{
			if (func_121(vParam0, (Global_1415419->f_9721[iVar0 /*8*/])->f_4, fParam3, 0))
			{
				return 1;
			}
		}
...
int func_80(vector3 vParam0)
{
	...
	while (iVar0 < 10)
	{
		...
		{
			if (func_121(vParam0, (Global_32073.f_2697.f_1495[iVar0 /*4*/])->f_1, 1f, 0))
			{
				return 1;
			}
		}
...
{
	return (BUILTIN::SHIFT_RIGHT(iParam0, 26) & 31 * func_122(MISC::IS_BIT_SET(iParam0, 31), -1, 1)) + 1898;
}
...
void func_88(var uParam0, int iParam1, int iParam2, int iParam3, int iParam4, int iParam5, int iParam6)
{
...
void func_94(int iParam0, int iParam1, int iParam2, bool bParam3, bool bParam4, bool bParam5, bool bParam6, bool bParam7)
{
	bool bVar0;
...
int func_103(int iParam0, int iParam1, var uParam2, var uParam3, int iParam4, float fParam5)
{
	...
	if (!Global_1935630->f_12 && !ENTITY::IS_ENTITY_DEAD(iParam0))
	{
		...
		if (!uParam2->f_1 & 128 != 0)
		{
			...
			{
				*uParam3 = 128;
				func_138(iParam0, uParam2, *uParam3);
				return 1;
			}
		}
		if (Global_1935630->f_27)
		{
			if (!uParam2->f_1 & 8 != 0)
			{
				...
				else if (func_140(iParam0, iParam1, uParam2))
				{
					*uParam3 = 8;
					func_138(iParam0, uParam2, *uParam3);
					return 1;
		...
		if (Global_1935630->f_26 && func_142(PLAYER::PLAYER_ID(), 0, 1, uParam2->f_1 & 524288 == 0))
		{
		...
		{
			if (func_143(uParam2, 1065353216))
			{
				if (!uParam2->f_1 & 4 != 0)
				{
				...
				{
					if (func_145(Global_35, iParam0, uParam2))
					{
						*uParam3 = 256;
						func_138(iParam0, uParam2, *uParam3);
						return 1;
		...
		if (!uParam2->f_1 & 16 != 0)
		{
			...
			{
				if (func_146(Global_35, iParam0, uParam2, 0))
				{
					*uParam3 = 16;
					func_138(iParam0, uParam2, *uParam3);
					return 1;
			...
			else if (func_146(Global_35, iParam0, uParam2, 1))
			{
				*uParam3 = 16;
				func_138(iParam0, uParam2, *uParam3);
				return 1;
		...
		if (Global_1935630->f_30 || Global_1935630->f_31)
		{
			if (!uParam2->f_1 & 2 != 0)
			{
				...
				{
					if ((func_150(iParam0, Global_1935630->f_41, *uParam2 & 128 != 0, 0, *uParam2 & 256 != 0) && func_151(uParam2, iParam0)) && func_152(uParam2, iParam0))
					{
						*uParam3 = 2;
						func_138(iParam0, uParam2, *uParam3);
						return 1;
		...
		if (!uParam2->f_1 & 2 != 0)
		{
			if (uParam2->f_12 < 4f)
			{
				if ((func_150(iParam0, Global_1935630->f_41, *uParam2 & 128 != 0, 1, *uParam2 & 256 != 0) && func_151(uParam2, iParam0)) && func_152(uParam2, iParam0))
				{
					*uParam3 = 2;
					func_138(iParam0, uParam2, *uParam3);
					return 1;
				...
				if (Global_1935630->f_40 == 0)
				{
					if (Global_1935630->f_41 != 0)
					{
						if (*uParam2 & 131072 == 0)
						{
							if (func_153(iParam0, Global_1935630->f_41))
							{
								func_154();
								*uParam3 = 2;
								func_138(iParam0, uParam2, *uParam3);
			...
			if (uParam2->f_12 < 10f)
			{
				if (func_155(uParam2, iParam0) || (uParam2->f_9 > 0 && (func_156() - uParam2->f_9) < 2000))
				{
			...
			if (Global_1935630->f_42 != 0)
			{
				if (*uParam2 & 131072 == 0)
				{
					if (func_157())
					{
						if (func_153(iParam0, Global_1935630->f_42))
						{
							func_154();
							*uParam3 = 2;
							func_138(iParam0, uParam2, *uParam3);
		...
		if (uParam2->f_12 < uParam2->f_26)
		{
			...
			{
				if (func_159(iParam0, iParam1, uParam2))
				{
					*uParam3 = 2048;
					func_138(iParam0, uParam2, *uParam3);
					return 1;
...
void func_108(int iParam0)
{
	if (func_43(iParam0))
	{
		...
		{
			case 1:
				func_169(0, 1, 0, 0, ((Global_1415419->f_19[iParam0 /*12*/])->f_7 / 4), 0, 0, 1);
				func_169(1, 1, 0, 0, ((Global_1415419->f_19[iParam0 /*12*/])->f_7 / 4), 0, 0, 1);
				break;
			case 37:
				func_169(60, 1, 0, 0, ((Global_1415419->f_19[iParam0 /*12*/])->f_7 / 4), 0, 0, 1);
				break;
		}
	}
}

void func_109(int iParam0, vector3 vParam1)
{
	int iVar0;
	int iVar1;
	...
	while (iVar0 < 10)
	{
		...
		{
			if (func_121((Global_32073.f_2697.f_1495[iVar0 /*4*/])->f_1, vParam1, 1056964608, 1))
			{
				return;
			}
		}
...
int func_121(vector3 vParam0, vector3 vParam3, float fParam6, bool bParam7)
{
	if (fParam6 < 0f)
	{
		fParam6 = 0f;
...
int func_122(bool bParam0, int iParam1, int iParam2)
{
	if (bParam0)
	{
		return iParam1;
...
void func_136(var uParam0, bool bParam1, int iParam2)
{
	func_174(iParam2);
	if (Global_1572887->f_12 == -1)
	{
	...
	if (!uParam0->f_1 & 1024 != 0)
	{
		if (!ENTITY::DOES_ENTITY_EXIST(uParam0->f_14))
		{
			if (func_177(uParam0))
			{
				uParam0->f_15 = func_156();
			}
		}
		else if (uParam0->f_15 > 0)
		{
			if ((func_156() - uParam0->f_15) > 500)
			{
...
int func_145(var uParam0, int iParam1, var uParam2)
{
	var uVar0;
...
int func_146(var uParam0, int iParam1, var uParam2, bool bParam3)
{
	vector3 vVar0;
	int iVar3;
	vector3 vVar4;
...
int func_150(int iParam0, int iParam1, bool bParam2, bool bParam3, bool bParam4)
{
	int iVar0;
	int iVar1;
	int iVar2;
...
int func_164(int iParam0, var uParam1)
{
	...
	if (uParam1->f_4 == 0)
	{
		uParam1->f_4 = func_156();
	}
	else if (func_156() - uParam1->f_4) > func_212(uParam1)
	{
...
void func_169(int iParam0, int iParam1, int iParam2, int iParam3, int iParam4, int iParam5, bool bParam6, int iParam7)
{
	int iVar0;

	iVar0 = (((iParam2 + (60 * iParam3)) + (3600 * iParam4)) + (86400 * iParam5));
	if (func_214(iParam0) == 1 && iParam7)
	{
		return;
	}
	if (bParam6)
...
int func_185(int iParam0, bool bParam1, bool bParam2, bool bParam3, int iParam4, int iParam5)
{
	...
	{
		if (WEAPON::_0x6AD66548840472E5(func_221(iVar0, 0)))
		{
			if (func_222(iParam0, 0.4f, 0.6f, 0.3f, 0.7f))
			{
				return 1;
			}
		}
...
int func_189(int iParam0, bool bParam1, bool bParam2, bool bParam3, int iParam4)
{
	...
	if (PLAYER::IS_PLAYER_FREE_AIMING(iVar1))
	{
		if (WEAPON::_0x6AD66548840472E5(func_221(iVar0, 0)))
		{
			if (func_223(ENTITY::GET_ENTITY_COORDS(iParam0, true, false), 0.4f, 0.6f, 0.3f, 0.7f))
			{
				return 1;
			}
		}
...
{
	if (func_224(iParam0, vParam4, 0.5f))
	{
...
int func_200(int iParam0, int iParam1)
{
	...
	if (func_227(iParam0, 1, 0, 0) != 2055893578)
	{
		return 0;
	}
...
int func_211(int iParam0)
{
	...
	return func_229(((*Global_1347702)[58 /*49*/])->f_15, 1);
}
...
int func_222(int iParam0, float fParam1, float fParam2, float fParam3, float fParam4)
{
	if (!ENTITY::IS_ENTITY_DEAD(iParam0))
	{
		if (func_223(ENTITY::GET_ENTITY_COORDS(iParam0, true, false), fParam1, fParam2, fParam3, fParam4))
		{
			return 1;
		}
	}
...
int func_223(vector3 vParam0, float fParam3, float fParam4, float fParam5, float fParam6)
{
	float fVar0;
	float fVar1;
	bool bVar2;
...
bool func_224(int iParam0, vector3 vParam1, float fParam4)
{
	vector3 vVar0;
	vector3 vVar3;
...
int func_227(int iParam0, bool bParam1, int iParam2, bool bParam3)
{
	int iVar0;
