...
int func_72(var uParam0)
{
	...
	func_151(uParam0, -1.8071f, -1.7113f, 1.0105f, -85f, 3f, 3f, 3f, -1612834106, -1, 1, 1, 1);
	func_152(uParam0, iLocal_14, 1.1f);
	func_153(uParam0, "script@vignette@dutch_18@intro_base", 1, 1, 0, 0);
	iLocal_15 = func_153(uParam0, "script@vignette@dutch_18@action_a", 2, 0, 1, 1);
	iLocal_16 = func_153(uParam0, "script@vignette@dutch_18@action_b", 0, 0, 0, 1);
	func_154(uParam0, iLocal_14, 2, -15193016, "WORLD_HUMAN_LEAN_POST_LEFT_HAND_PLANTED_MALE_B", -1, 0);
	func_155(uParam0, iLocal_14, 1, 3, 0, 0, 0);
	func_156(uParam0, iLocal_14, 2, 935336933, "PROP_HUMAN_SEAT_BENCH_MALE_B", -1, 0, -1073741824, 1065353216, 1);
	func_157(uParam0, iLocal_14, 2, -1);
	func_158(uParam0, "CDT18AU");
	Local_17 = { func_159(uParam0, -1.8076f, -1.7117f, 0.9806f, 180f, 8f, 0.7f, 0.55f) };
	func_160(uParam0, 1);
...
{
	return func_193(uParam0, Local_17, 1, 0);
}
...
int func_93(var uParam0)
{
	...
	{
		if (func_193(uParam0, Local_17, 1, 0))
		{
			func_192(uParam0, iLocal_16, 1);
		}
		else
		{
			func_156(uParam0, iLocal_14, 2, -15193016, "WORLD_HUMAN_LEAN_POST_LEFT_HAND_PLANTED_MALE_B", -1, 0, -1073741824, 1065353216, 1);
	...
	while (iVar12 < uParam0->f_106)
	{
		...
		else
		{
			if (!STREAMING::IS_MODEL_VALID((uParam0->f_107[iVar12 /*113*/])->f_3))
			{
				...
				{
					(uParam0->f_107[iVar12 /*113*/])->f_3 = _NAMESPACE48::_0xA00DF706C60173D1(func_271((uParam0->f_107[iVar12 /*113*/])->f_1));
				}
				else if (func_57((uParam0->f_107[iVar12 /*113*/])->f_2))
				{
					(uParam0->f_107[iVar12 /*113*/])->f_3 = func_272((uParam0->f_107[iVar12 /*113*/])->f_2);
				}
		...
		else
		{
			...
			else if (!(uParam0->f_107[iVar0 /*113*/])->f_8.f_22)
			{
				if (iVar1 < 0)
				{
					...
					func_273(&((uParam0->f_107[iVar0 /*113*/])->f_8.f_23), 1, 0);
				}
				else
				{
	...
	while (iVar1 < 27)
	{
		...
		else
		{
			...
			while (iVar0 < uParam0->f_36)
			{
				...
				else if (iVar1 == func_274((uParam0->f_36[iVar0 /*5*/])->f_1))
				{
				}
...
void func_178(var uParam0)
{
	...
	while (iVar0 < uParam0->f_106)
	{
		...
		{
			(uParam0->f_107[iVar0 /*113*/])->f_5 = func_282((uParam0->f_107[iVar0 /*113*/])->f_3, uParam0->f_23, 0, 1, 1, 0, 1, 1, 1, 0, 0, 0, 0);
		}
		iVar0++;
	}
}
	...
	while (iVar0 < uParam0->f_1984)
	{
		...
		else
		{
			if (bParam1)
			{
				if (func_283())
				{
					func_284(Global_35, &(uParam0->f_1984[iVar0]), "JOHN");
				}
				else
				{
					func_284(Global_35, &(uParam0->f_1984[iVar0]), "ARTHUR");
				}
			}
			iVar1 = 0;
			while (iVar1 < uParam0->f_106)
			{
				func_284((uParam0->f_107[iVar1 /*113*/])->f_5, &(uParam0->f_1984[iVar0]), (uParam0->f_107[iVar1 /*113*/])->f_4);
				iVar1++;
			}
		}
		iVar0++;
...
void func_181(var uParam0)
{
	...
	while (iVar0 < uParam0->f_106)
	{
		func_285((uParam0->f_107[iVar0 /*113*/])->f_5);
		iVar0++;
	}
}
...
int func_192(var uParam0, int iParam1, bool bParam2)
{
	...
	if (uParam0->f_2270)
	{
		uParam0->f_2274 = 0;
		uParam0->f_2275 = 0;
		if ((func_112() && ANIMSCENE::_0x6F1F0B17109309DA(uParam0->f_2046, "ARTHUR")) || (func_283() && ANIMSCENE::_0x6F1F0B17109309DA(uParam0->f_2046, "JOHN")))
		{
			uParam0->f_2274 = 1;
		}
	}
	if (bParam2)
	{
		...
		while (iVar1 < uParam0->f_1984)
		{
			...
			else if (func_293(uParam0, iVar1) || func_201(uParam0, iVar1))
			{
...
int func_193(var uParam0, struct<4> Param1, var uParam5, var uParam6, var uParam7, var uParam8, var uParam9, var uParam10, bool bParam11, bool bParam12)
{
	...
	if (!func_296(Param1, Param1.f_6, Global_36))
	{
		return 0;
	}
	if (func_296(Param1, Param1.f_3, Global_36))
	{
		return 0;
	}
	if (bParam12)
...
bool func_296(struct<2> Param0, var uParam2, struct<2> Param3, var uParam5, struct<2> Param6, var uParam8)
{
...
int func_352(var uParam0, int iParam1)
{
	...
	{
		func_273(&((uParam0->f_107[iParam1 /*113*/])->f_32.f_21), 1, (uParam0->f_107[iParam1 /*113*/])->f_32.f_13);
		bVar71 = Var1.f_10;
...
int func_376(int iParam0, bool bParam1, int iParam2, int iParam3, int iParam4, int iParam5, float fParam6, int iParam7, int iParam8, bool bParam9, bool bParam10, bool bParam11, int iParam12, int iParam13, bool bParam14, bool bParam15, bool bParam16, bool bParam17, bool bParam18, bool bParam19, bool bParam20, bool bParam21, bool bParam22, bool bParam23, bool bParam24)
{
	...
	switch (((*Global_1360165)[iParam0 /*1157*/])->f_11)
	{
		...
		case 7:
			...
			if (bParam20)
			{
				if (func_280(Global_1360165[iParam0 /*1157*/]))
				{
				}
			}
...
int func_393(int iParam0, bool bParam1, bool bParam2, var uParam3, var uParam4, var uParam5, float fParam6, bool bParam7, bool bParam8, bool bParam9, bool bParam10)
{
	...
	switch (((*Global_1360165)[iParam0 /*1157*/])->f_70.f_12)
	{
		...
		case 3:
			...
			sVar12 = func_424(iParam0, func_283());
...
int func_421(int iParam0, vector3 vParam1, float fParam4, bool bParam5)
{
	...
	if ((!bParam5 && !Global_1359489->f_12) || (bParam5 && Global_1359489->f_13 < 8))
	{
		...
		else
		{
			...
			{
				((*Global_1360165)[iParam0 /*1157*/])->f_124 = func_282(iVar0, vParam1, fParam4, 1, 1, 0, 1, 1, 1, 0, 0, 0, 0);
