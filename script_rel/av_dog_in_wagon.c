...
{
	func_33(uParam0, 10859/*func_30*/, 10924/*func_31*/, 11628/*func_32*/);
}
...
void func_14(var uParam0, vector3 vParam1, vector3 vParam4)
{
	...
	func_49(uParam0, 0, "DIWP_MAN", uVar0, OBJECT::_GET_OBJECT_OFFSET_FROM_COORDS(vParam1, vParam4.z, -3f, -2f, 0f), (94f + vParam4.z), 1, 1, 1, 1, 41788943, 1);
	func_49(uParam0, 1, "DIWP_DOG", 626176009, OBJECT::_GET_OBJECT_OFFSET_FROM_COORDS(vParam1, vParam4.z, -5f, -2f, 0f), (-85f + vParam4.z), 1, 1, 1, 1, 41788943, 1);
	...
	switch (iLocal_9)
	{
		case 0:
			if (!ENTITY::IS_ENTITY_DEAD(&(uParam0->f_20[0 /*14*/])))
			{
				...
				func_70(&(uParam0->f_20[0 /*14*/]), 1546182539, 0, 0, 0, -1082130432);
			...
			if (!ENTITY::IS_ENTITY_DEAD(&(uParam0->f_20[1 /*14*/])))
			{
				...
				func_70(&(uParam0->f_20[1 /*14*/]), 1951165908, 0, 0, 0, -1082130432);
...
void func_70(int iParam0, int iParam1, int iParam2, int iParam3, int iParam4, int iParam5)
{
...
void func_219(int iParam0, int iParam1, int iParam2, int iParam3, int iParam4, int iParam5, bool bParam6, int iParam7)
{
	int iVar0;
