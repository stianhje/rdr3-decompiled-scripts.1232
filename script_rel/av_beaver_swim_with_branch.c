...
{
	func_33(uParam0, 10784/*func_30*/, 10856/*func_31*/, 11614/*func_32*/);
}
...
{
	func_46(uParam0, "BEAVER_SWIM_WITH_BRANCH", "script@ambient@animal@beaver_swim_with_branch@action", vParam1, vParam4);
	func_47(uParam0, 1, "pbl_action", "", 0);
	func_48(uParam0, 0, "beaver", iLocal_9, vParam1, vParam4.z, 1, 1, 1, 1, 41788943, 1);
	func_49(uParam0, 0, "STICK", joaat("p_stickfirepoker01x"), vParam1, vParam4.z, 0);
}
...
int func_31(var uParam0)
{
	...
	if (!&uParam0->f_469[0])
	{
		if (!bLocal_38 == 1)
		{
			if (func_65(uParam0, &uLocal_10, 1) || func_66(Global_35, &(uParam0->f_20[0 /*14*/]), 1) <= 64f)
			{
				bLocal_38 = true;
			}
		}
	...
	if (!&uParam0->f_469[0])
	{
					...
					if (ANIMSCENE::_0x25557E324489393C(uParam0->f_3.f_1))
					{
						if (ANIMSCENE::_0x477122B8D05E7968(uParam0->f_3.f_1, 1, 0))
						{
							if (ANIMSCENE::_0x1F0E401031E20146(uParam0->f_3.f_1, "pbl_action"))
							{
								...
								ENTITY::ATTACH_ENTITY_TO_ENTITY(&(uParam0->f_372[0 /*8*/]), &(uParam0->f_20[0 /*14*/]), PED::GET_PED_BONE_INDEX(&(uParam0->f_20[0 /*14*/]), 61276), vVar0, vVar3, 1, 0, 0, 0, 2, 1, 1, 0);
		...
		if (&uParam0->f_469[2])
		{
			if (!&uParam0->f_469[4])
			{
				if (func_74(uParam0, 0.5f, 40f, 4, -91962372, 1))
				{
					func_69(*uParam0, uParam0->f_483, 0);
					uParam0->f_469[4] = 1;
				}
			...
			if (!&uParam0->f_469[3])
			{
				if (ANIMSCENE::_0x25557E324489393C(uParam0->f_3.f_1))
				{
					if (ANIMSCENE::_0x477122B8D05E7968(uParam0->f_3.f_1, 1, 0))
					{
						if (ANIMSCENE::_0x1F0E401031E20146(uParam0->f_3.f_1, "pbl_action"))
						{
							if (ANIMSCENE::_0xD8254CB2C586412B(uParam0->f_3.f_1, 0) || ANIMSCENE::_0xCDC5512A407CF08D(uParam0->f_3.f_1))
							{
								if (!ENTITY::IS_ENTITY_DEAD(&(uParam0->f_20[0 /*14*/])))
								{
...
void func_48(var uParam0, int iParam1, char* sParam2, int iParam3, vector3 vParam4, var uParam7, int iParam8, int iParam9, int iParam10, int iParam11, int iParam12, int iParam13)
{
...
void func_49(var uParam0, int iParam1, char* sParam2, int iParam3, vector3 vParam4, var uParam7, int iParam8)
{
...
int func_55(int iParam0, vector3 vParam1, float fParam4, bool bParam5, bool bParam6, int iParam7, bool bParam8, bool bParam9, bool bParam10, bool bParam11, bool bParam12, bool bParam13, bool bParam14)
{
	...
	func_95(iVar0, iParam0, iParam7, bParam8, bParam9, bParam10, bParam11, bParam12);
	return iVar0;
}
	...
	if ((MISC::GET_FRAME_COUNT() % 8) == 0)
	{
		...
		while (iVar0 < uParam0->f_19)
		{
			...
			if (!ENTITY::IS_ENTITY_DEAD(&(uParam0->f_20[iVar0 /*14*/])))
			{
				...
				fVar8 = func_66(Global_35, &(uParam0->f_20[iVar0 /*14*/]), 1);
				if (fVar8 < fVar1)
				{
					return 1;
				}
		...
		while (iVar0 < uParam0->f_19)
		{
			...
			else
			{
				if (!ENTITY::IS_ENTITY_DEAD(&(uParam0->f_20[iVar0 /*14*/])))
				{
					...
					{
						if ((func_66(Global_35, &(uParam0->f_20[iVar0 /*14*/]), 1) < fParam2 && PED::_0x5102307CE88798EB(&(uParam0->f_20[iVar0 /*14*/]))) && PED::IS_TRACKED_PED_VISIBLE(&(uParam0->f_20[iVar0 /*14*/])))
						{
							if (!func_67(&(uParam0->f_490)))
							{
...
void func_95(int iParam0, int iParam1, int iParam2, bool bParam3, bool bParam4, bool bParam5, bool bParam6, bool bParam7)
{
	bool bVar0;
