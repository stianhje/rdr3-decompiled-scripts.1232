...
int func_72(var uParam0)
{
	...
	func_151(uParam0, -6.2125f, 1.65f, 1.4875f, 0f, 0.8675f, 0.8925f, 3.2075f, -1612834106, 2017216891, 1, 1, 1);
	func_151(uParam0, 0.2875f, 5.2875f, 1.4875f, 0f, 1.125f, 1.1f, 3.2075f, -1612834106, -1689743484, 1, 1, 1);
	func_152(uParam0, "script@vignette@susan_12@base", 1, 1, 0, 0);
	func_152(uParam0, "script@vignette@susan_12@Action", 0, 0, 1, 0);
	func_153(uParam0, "CSN12AU");
	func_154(uParam0, -2043044896, -1151404439);
