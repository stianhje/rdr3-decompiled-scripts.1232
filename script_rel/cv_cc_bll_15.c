...
int func_72(var uParam0)
{
	...
	func_151(uParam0, -12.86f, 5.75f, 0.93f, 0f, 0.8f, 0.8f, 1f, -1612834106, -2087487524, 1, 1, 1);
	func_151(uParam0, -1.03f, -1.85f, 0.93f, -30f, 1.5f, 1f, 1f, -1612834106, -695792551, 1, 1, 1);
	func_152(uParam0, "script@vignette@bill_15@BASE", 1, 1, 0, 0);
	uLocal_16 = func_152(uParam0, "script@vignette@bill_15@ACTION", 0, 0, 1, 0);
	iLocal_17 = func_153(uParam0, uLocal_16, "PL_ACTION", 1);
	func_154(uParam0, "CBL15AU");
	func_155(uParam0, 1193854248, 228274598);
	func_156(uParam0, uLocal_16, -1, 0.6f);
	func_157(uParam0, iLocal_14, 3, 1858605558, "PROP_CAMP_FIRE_SEAT_CHAIR_MALE_C", -1, 0);
	func_157(uParam0, iLocal_15, 3, -1074764191, 0, -1, 0);
	func_158(uParam0, iLocal_15, 3, -1074764191, 0, -1, 0, -1073741824, 1065353216, 1);
