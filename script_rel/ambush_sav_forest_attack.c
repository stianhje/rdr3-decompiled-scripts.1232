...
int func_20()
{
	...
	while (iVar0 <= 6)
	{
		if (func_61(&(uLocal_15[iVar0]), 0, 0))
		{
			func_125(iVar0);
			func_126(iVar0);
			PED::SET_PED_HEARING_RANGE(&(uLocal_15[iVar0]), 10f);
			if (func_127(iVar0))
			{
			...
			(uLocal_15.f_118[iVar0 /*4*/])->f_1 = { vVar3 };
			switch (iVar0)
			{
				case 0:
					break;
				...
				case 4:
					...
					break;
				case 5:
					func_128(&(uLocal_15[iVar0]), &(uLocal_15.f_40[0]), 0, -1, 1);
					func_131(&uLocal_15, iVar0, 0);
					func_132(&uLocal_15, 0, 0);
					break;
				case 6:
					func_128(&(uLocal_15[iVar0]), &(uLocal_15.f_40[1]), 0, -1, 1);
					func_131(&uLocal_15, iVar0, 0);
					func_132(&uLocal_15, 1, 0);
					break;
			}
			func_133(&uLocal_15, iVar0, iVar1, iVar2);
			func_134(&uLocal_15, iVar0);
		}
		iVar0++;
	}
	return 1;
	...
	switch (Local_274.f_3)
	{
		case 0:
			...
			else
			{
				...
				{
					func_139();
					Local_274.f_66 = &uLocal_15.f_9[0];
					func_32(&uLocal_15, 1);
					func_25(&uLocal_15, 1);
					func_150();
...
int func_31()
{
	func_165();
	func_142();
	Local_274.f_61 = func_166(&uLocal_15);
	switch (Local_274.f_4)
	{
		case 0:
			...
			func_167(&uLocal_15, 1, 0, (uLocal_15.f_215 - 1));
			func_132(&uLocal_15, 0, 1);
			func_132(&uLocal_15, 1, 1);
		...
		case 1:
			...
			break;
		case 2:
			if (func_170(&uLocal_15, &(Local_274.f_57), &(uLocal_15.f_241), "AMBUSH_RA1_FLEE", 3f))
			{
				func_171();
...
void func_38()
{
	...
	while (iVar0 < uLocal_15.f_216)
	{
		if (!func_136(&uLocal_15, iVar0, 16))
		{
...
{
	func_171();
	func_193(&uLocal_15, func_192(&Local_274), 2f);
}
		...
		if (ENTITY::DOES_ENTITY_EXIST(&(uLocal_15[iVar0])))
		{
			...
			else
			{
				if (func_61(&(uLocal_15[iVar0]), 0, 0))
				{
					...
					if ((PED::IS_PED_IN_COMBAT(&(uLocal_15[iVar0]), Global_35) || PED::IS_PED_FLEEING(&(uLocal_15[iVar0]))) || func_135(&uLocal_15, iVar0, 256))
					{
				...
				else if ((!PED::IS_PED_FLEEING(&(uLocal_15[iVar0])) && !PED::IS_PED_IN_COMBAT(&(uLocal_15[iVar0]), Global_35)) && !func_135(&uLocal_15, iVar0, 128))
				{
...
int func_83()
{
	...
	*(vVar0[0 /*3*/]) = { func_84(uLocal_15.f_151, 0, uLocal_15.f_221) };
	*(vVar0[1 /*3*/]) = { func_84(uLocal_15.f_151, 1, uLocal_15.f_221) };
...
int func_92(int iParam0)
{
	if (&uLocal_15.f_57[iParam0] == 0)
	{
		...
		{
			uLocal_15.f_57[iParam0] = func_253(997958153, 1);
		}
		else
		{
...
void func_125(int iParam0)
{
	...
	func_267(&(uLocal_15[iParam0]), cVar0, 0);
}
...
void func_126(int iParam0)
{
	...
	func_268(&(uLocal_15[iParam0]), -618550132, -1, 0, 0, 1056964608, 1065353216, 0);
	iVar0 = func_269(iParam0);
	Local_274.f_67[iParam0] = func_268(&(uLocal_15[iParam0]), iVar0, -1, func_270(iParam0), 0, 0.8f, 1065353216, 0);
}
...
int func_138()
{
	if (func_274(&uLocal_15, &(uLocal_15.f_152), &(uLocal_15.f_180), &(Local_274.f_58), 0, 1, 1))
	{
		return 1;
	}
	if (Local_274.f_5 >= 4)
...
void func_140()
{
	...
	while (iVar0 <= 6)
	{
		...
		{
			func_131(&uLocal_15, iVar0, 1);
			PED::_0x7DE9692C6F64CFE8(&(uLocal_15[iVar0]), false, 0, 0);
			if (func_277(func_276(&(uLocal_15[iVar0]), 0)))
			{
				iVar2 = 67108864;
			}
			else
			...
			func_198(&(uLocal_15[iVar0]), &iVar1, 0.1f, 0.3f, 1, 1);
			func_278(&uLocal_15, iVar0, 831283580, 0);
			if (!func_137(&Local_274, 64))
			{
				func_279(&(uLocal_15[iVar0]), Global_35, "ARRIVAL_COMBAT_RAID_MALE", -1073741824, 1, -500314840, 1);
...
int func_143()
{
	...
	if (VOLUME::_0x92A78D0BEDB332A3(&(Local_274.f_49[1])))
	{
		...
		{
			if (func_281(&uLocal_15, &(uLocal_15.f_152), &(uLocal_15.f_180), &(Local_274.f_59), 0, (uLocal_15.f_215 - 1), 1))
			{
...
int func_144()
{
	...
	switch (Local_274.f_5)
	{
		case 0:
			func_278(&uLocal_15, iVar0, 831283580, 0);
			func_282(&(uLocal_15[iVar0]), Global_35, -1);
			func_283(&Local_274, 1);
			break;
		case 1:
			if (PED::IS_PED_FACING_PED(&(uLocal_15[iVar0]), Global_35, 60f))
			{
				TASK::TASK_AIM_AT_ENTITY(&(uLocal_15[iVar0]), Global_35, -1, 0, 0);
				if (!func_137(&Local_274, 64))
				{
					func_279(&(uLocal_15[iVar0]), Global_35, "ARRIVAL_COMBAT_RAID_MALE", -1073741824, 1, -500314840, 1);
					func_242(&Local_274, 64);
		...
		case 2:
			...
			{
				uVar5[0] = &uLocal_15[iVar0];
				uVar5[1] = Global_35;
				iVar8 = func_285(&uVar1, &uVar5, 3, ENTITY::GET_ENTITY_COORDS(&(uLocal_15[iVar0]), false, true), 15f, 0, 1, 1, -1, 1, 0, -1082130432, 0, 0);
				iVar9 = 0;
				while (iVar9 < iVar8)
				{
...
int func_151()
{
	...
	switch (Local_274.f_6)
	{
		...
		case 1:
			...
			break;
		case 2:
			if (func_47(Local_274.f_8[1 /*3*/], 1f) || func_220(&(uLocal_15[0]), 10f, -1082130432, -1082130432, -1082130432))
			{
		...
		case 3:
			...
			{
				func_278(&uLocal_15, 0, 831283580, 0);
				func_278(&uLocal_15, 1, 831283580, 0);
				func_186(Local_274.f_8[1 /*3*/]);
		...
		case 4:
			...
			{
				iVar0 = -1;
				iVar0 = func_309(&uLocal_15, 3, 6, 0);
				if (iVar0 >= 0)
				{
					if (func_279(&(uLocal_15[iVar0]), Global_35, "ITS_MALE_EXTREME_RECOGNIZE", -1073741824, 1, 1744022339, 0))
					{
...
void func_165()
{
	...
	while (iVar0 <= 6)
	{
		if (func_61(&(uLocal_15[iVar0]), 0, 1))
		{
			...
			{
				if (PED::IS_PED_SHOOTING(&(uLocal_15[iVar0])) || func_220(&(uLocal_15[iVar0]), 40f, 12f, &(uLocal_15.f_9[iVar0]), -1082130432))
				{
					func_278(&uLocal_15, iVar0, 831283580, 0);
				}
			}
...
int func_169()
{
	...
	else
	{
		if (!func_137(&Local_274, 16384))
		{
			if ((func_47(Local_274.f_8[0 /*3*/], 10f) || (ENTITY::DOES_ENTITY_EXIST(&(uLocal_15[5])) && ENTITY::HAS_ENTITY_BEEN_DAMAGED_BY_ANY_PED(&(uLocal_15[5])))) || (ENTITY::DOES_ENTITY_EXIST(&(uLocal_15[6])) && ENTITY::HAS_ENTITY_BEEN_DAMAGED_BY_ANY_PED(&(uLocal_15[6]))))
			{
				func_327(0);
				func_242(&Local_274, 16384);
			}
	...
	switch (Local_274.f_7)
	{
		case 0:
			...
			if (func_284(0, 1, 0, 0))
			{
				iVar0 = func_309(&uLocal_15, 0, (uLocal_15.f_215 - 1), 1);
				if (iVar0 >= 0)
				{
					if (func_279(&(uLocal_15[iVar0]), Global_35, "ARRIVAL_COMBAT_RAID_MALE", -1073741824, 1, 1744022339, 2))
					{
		...
		case 1:
			if (func_284(0, 1, 0, 0))
			{
				...
				if (iVar0 >= 0)
				{
					if (func_279(&(uLocal_15[iVar0]), Global_35, "ARRIVAL_COMBAT_RAID_MALE", -1073741824, 1, 1744022339, 3))
					{
...
void func_171()
{
	if (func_61(uLocal_15.f_56, 0, 0))
	{
		ENTITY::SET_ENTITY_CAN_BE_DAMAGED_BY_RELATIONSHIP_GROUP(uLocal_15.f_56, true, func_335(uLocal_15.f_181));
	}
}
...
int func_185(int iParam0)
{
	...
	{
		fVar0 = func_191(&(uLocal_15.f_247));
...
int func_195(int iParam0)
{
	...
	if (func_356(&uLocal_15, &(uLocal_15[iParam0])))
	{
		return 1;
	}
...
int func_200(int iParam0, int iParam1)
{
	...
	if (func_369(&(uLocal_15.f_40[iParam0]), iParam1))
	{
		return 1;
	}
	if (func_356(&uLocal_15, &(uLocal_15.f_40[iParam0])))
	{
		return 1;
	}
...
int func_201(int iParam0)
{
	...
	if (func_371(&(uLocal_15.f_84[iParam0]), fVar0))
	{
		return 0;
	}
	if (func_187(&(uLocal_15.f_84[iParam0]), Global_36, 1) < 10f)
	{
		return 0;
	}
	return 1;
...
int func_202(int iParam0)
{
	...
	if (func_357(&uLocal_15, &(uLocal_15.f_49[iParam0])))
	{
		return 1;
	}
...
void func_244()
{
	...
	func_303(&(uLocal_15.f_152), 1);
	func_235(&(uLocal_15.f_152), 1);
	func_384(&(uLocal_15.f_152), 1);
	func_385(&(uLocal_15.f_152), 1);
}
...
void func_245()
{
	...
	{
		case 0:
			func_386(&uLocal_15, &Local_274);
			break;
		case 1:
			func_387(&uLocal_15, &Local_274);
			break;
	}
}
...
{
	if (func_412(&(uLocal_15[iParam0]), "BATTLE_CRY", 1744022339, Global_35, 0, "0260_G_M_M_UniMountainMen_03_NATIVE_02", iParam1, 1))
	{
	}
}
...
void func_306()
{
	...
	while (iVar5 <= 1)
	{
		...
		else
		{
			...
			PED::_0x7DE9692C6F64CFE8(&(uLocal_15[iVar5]), false, 0, 0);
			TASK::OPEN_SEQUENCE_TASK(&iVar0);
			TASK::TASK_FOLLOW_NAV_MESH_TO_COORD(0, vVar1, 3f, 20000, 6f, false, 40000f);
			TASK::TASK_COMBAT_PED(0, Global_35, 0, 0);
			func_198(&(uLocal_15[iVar5]), &iVar0, fVar6, 0, 1, 1);
...
void func_307()
{
	...
	while (iVar0 <= 4)
	{
		...
		else
		{
			...
			func_131(&uLocal_15, iVar0, 1);
			PED::_0x7DE9692C6F64CFE8(&(uLocal_15[iVar0]), false, 0, 0);
			PED::FORCE_PED_MOTION_STATE(&(uLocal_15[iVar0]), -530524, false, 0, false);
			func_434(vVar2, iVar0);
			TASK::OPEN_SEQUENCE_TASK(&iVar1);
			TASK::TASK_FOLLOW_NAV_MESH_TO_COORD(0, vVar2, 3f, 20000, 6f, false, 40000f);
			TASK::TASK_COMBAT_PED(0, Global_35, 0, 0);
			func_198(&(uLocal_15[iVar0]), &iVar1, 0, 0, 1, 1);
		}
		iVar0++;
	}
...
void func_308()
{
	...
	while (iVar0 <= 1)
	{
		...
		{
			if (func_279(&(uLocal_15[iVar0]), Global_35, "PEDTYPE_WON_FIGHT", -1073741824, 1, -500314840, 3))
			{
				bVar1 = true;
			}
		}
...
void func_434(vector3 vParam0, int iParam3)
{
	...
	PED::SET_PED_SPHERE_DEFENSIVE_AREA(&(uLocal_15[iParam3]), vParam0, fVar0, iVar1, 0, 0);
	if (bVar2)
	{
		PED::SET_PED_COMBAT_ATTRIBUTES(&(uLocal_15[iParam3]), 51, true);
	}
}
...
int func_584(int iParam0, int iParam1)
{
	...
	if (func_680(iParam0, 1, 0, 0) != 2055893578)
	{
		return 0;
	}
