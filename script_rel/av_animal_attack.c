	...
	switch (iLocal_9)
	{
		case 0:
			if (!ENTITY::IS_ENTITY_DEAD(&(uParam0->f_20[0 /*14*/])))
			{
				...
				if (*uParam0 == 45)
				{
					WEAPON::_GIVE_WEAPON_TO_PED_2(&(uParam0->f_20[0 /*14*/]), joaat("weapon_rifle_varmint"), 5000, true, false, 0, false, 0.5f, 1f, 752097756, true, 0f, false);
