...
{
	func_33(uParam0, 10864/*func_30*/, 10941/*func_31*/, 11629/*func_32*/);
}
...
void func_14(var uParam0, vector3 vParam1, vector3 vParam4)
{
	...
	func_46(uParam0, "ANIMAL_ATTACK", "", vParam1, vParam4);
	switch (*uParam0)
	{
		case 36:
	...
	func_49(uParam0, 0, "AAP_MAN", func_48(func_47(), 0, 0, 0, 0, 0, 1), OBJECT::_GET_OBJECT_OFFSET_FROM_COORDS(vParam1, vParam4.z, 0f, 0f, 0f), vParam4.z, 1, 1, 1, 1, 41788943, 1);
	func_49(uParam0, 1, "AAP_ANIMAL", iVar0, OBJECT::_GET_OBJECT_OFFSET_FROM_COORDS(vParam1, vParam4.z, 0f, 4f, 0f), (180f + vParam4.z), 1, 1, 1, 1, 41788943, 1);
}
	...
	switch (iLocal_9)
	{
		case 0:
			if (!ENTITY::IS_ENTITY_DEAD(&(uParam0->f_20[0 /*14*/])))
			{
				...
				if (*uParam0 == 45)
				{
					WEAPON::_GIVE_WEAPON_TO_PED_2(&(uParam0->f_20[0 /*14*/]), -570967010, 5000, true, false, 0, false, 0.5f, 1f, 752097756, true, 0f, false);
					WEAPON::SET_CURRENT_PED_WEAPON(&(uParam0->f_20[0 /*14*/]), -570967010, true, 0, false, false);
					Var0.f_1 = { ENTITY::GET_OFFSET_FROM_ENTITY_IN_WORLD_COORDS(&(uParam0->f_20[0 /*14*/]), 0f, 1f, 0.24f) };
					Var0.f_4 = -1;
					Var0.f_6 = 1;
					Var0.f_7 = 1;
					TASK::TASK_SHOOT_WITH_WEAPON(&(uParam0->f_20[0 /*14*/]), &Var0);
				}
				else
				{
					WEAPON::REMOVE_ALL_PED_WEAPONS(&(uParam0->f_20[0 /*14*/]), true, true);
					TASK::TASK_PLAY_ANIM(&(uParam0->f_20[0 /*14*/]), sLocal_10, sLocal_11, 4f, -4f, -1, 1, 0, 0, 0, 0, 0, 0);
				}
			}
			if (!ENTITY::IS_ENTITY_DEAD(&(uParam0->f_20[1 /*14*/])))
			{
				func_66(&((uParam0->f_20[1 /*14*/])->f_5), 50, 10, 0);
				PED::SET_PED_CONFIG_FLAG(&(uParam0->f_20[1 /*14*/]), 263, true);
				PED::_0x89F5E7ADECCCB49C(&(uParam0->f_20[1 /*14*/]), sLocal_13);
				...
				func_65(uParam0->f_20[1 /*14*/], 1, 1);
			}
			iLocal_9 = 1;
			break;
		
		case 1:
			if (func_67(uParam0, uParam0->f_493, uParam0->f_494, 4, uParam0->f_495, 1112014848) || func_68(uParam0, &uLocal_16, 0))
			{
				if (!&uParam0->f_469[1])
				{
					func_69(*uParam0, 0);
		...
		case 3:
			if (!&uParam0->f_469[2])
			{
				if (func_71(uParam0, 1065353216, 105f, 4, -91962372, 0))
				{
					func_72(*uParam0, uParam0->f_483, 0);
					uParam0->f_469[2] = 1;
				}
			}
			if (!func_73(&(uParam0->f_20[1 /*14*/]), 242628503))
			{
				if (ENTITY::IS_ENTITY_DEAD(&(uParam0->f_20[0 /*14*/])))
				{
					if (*uParam0 == 45)
...
int func_67(var uParam0, float fParam1, float fParam2, int iParam3, float fParam4, float fParam5)
{
	...
	if ((MISC::GET_FRAME_COUNT() % 8) == 0)
	{
		...
		fVar7 = func_106(Global_36, uParam0->f_483);
		...
		while (iVar0 < uParam0->f_19)
		{
			...
			if (!ENTITY::IS_ENTITY_DEAD(&(uParam0->f_20[iVar0 /*14*/])))
			{
				...
				fVar8 = func_107(Global_35, &(uParam0->f_20[iVar0 /*14*/]), 1);
				if (fVar8 < fVar1)
				{
					return 1;
				}
...
int func_68(var uParam0, var uParam1, int iParam2)
{
	...
	{
		if (func_112(&(uParam0->f_20[uParam0->f_501 /*14*/]), 0, uParam1, &(uParam0->f_468), 0, 0))
		{
			return 1;
		}
		uParam0->f_501++;
		...
		while (iVar0 < uParam0->f_19)
		{
			...
			else
			{
				if (!ENTITY::IS_ENTITY_DEAD(&(uParam0->f_20[iVar0 /*14*/])))
				{
					...
					{
						if ((func_107(Global_35, &(uParam0->f_20[iVar0 /*14*/]), 1) < fParam2 && PED::_0x5102307CE88798EB(&(uParam0->f_20[iVar0 /*14*/]))) && PED::IS_TRACKED_PED_VISIBLE(&(uParam0->f_20[iVar0 /*14*/])))
						{
							if (!func_108(&(uParam0->f_490)))
							{
								func_113(&(uParam0->f_490), 0);
							}
...
void func_118(int iParam0)
{
	if (func_43(iParam0))
	{
		...
		{
			case 1:
				func_172(0, 1, 0, 0, ((Global_1415419->f_19[iParam0 /*12*/])->f_7 / 4), 0, 0, 1);
				func_172(1, 1, 0, 0, ((Global_1415419->f_19[iParam0 /*12*/])->f_7 / 4), 0, 0, 1);
				break;
			
			case 37:
				func_172(60, 1, 0, 0, ((Global_1415419->f_19[iParam0 /*12*/])->f_7 / 4), 0, 0, 1);
				break;
		}
	}
}
...
void func_172(int iParam0, int iParam1, int iParam2, int iParam3, int iParam4, int iParam5, bool bParam6, int iParam7)
{
	int iVar0;
