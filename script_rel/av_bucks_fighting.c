...
{
	func_33(uParam0, 10809/*func_30*/, 10868/*func_31*/, 11772/*func_32*/);
}
...
{
	func_46(uParam0, "BUCKS_FIGHTING", "script@ambient@animal@BUCKS_FIGHTING@action", vParam1, vParam4);
	uParam0->f_16 = 1;
	func_47(uParam0, 1, "pbl_action", "", 0);
	func_48(uParam0, 0, "BUCK1", iLocal_9, 0f, 0f, 0f, 0f, 1, 1, 1, 1, 41788943, 0);
	func_48(uParam0, 1, "BUCK2", iLocal_9, 0f, 0f, 0f, 0f, 1, 1, 1, 1, 41788943, 0);
}
...
int func_31(var uParam0)
{
	if (!&uParam0->f_469[0])
	{
		...
		if (func_63(uParam0, &uLocal_10, 1) || func_64(Global_35, uParam0->f_483, 1) <= 900f)
		{
			...
			if (!&uParam0->f_469[6])
			{
				func_68(*uParam0, uParam0->f_483, 1);
				uParam0->f_469[6] = 1;
			}
			func_69(uParam0);
			uParam0->f_469[0] = 1;
	...
	if (!&uParam0->f_469[0])
	{
		...
		if (uParam0->f_469[2] && !&uParam0->f_469[3])
		{
			if (!&uParam0->f_469[6])
			{
				if (func_72(uParam0, 1.5f, 1116471296, 4, -91962372, 1))
				{
					func_68(*uParam0, uParam0->f_483, 1);
					uParam0->f_469[6] = 1;
				}
			...
			if (ANIMSCENE::_0x25557E324489393C(uParam0->f_3.f_1))
			{
				if (ANIMSCENE::_0x477122B8D05E7968(uParam0->f_3.f_1, 1, 0))
				{
					if (ANIMSCENE::_0x1F0E401031E20146(uParam0->f_3.f_1, "pbl_action"))
					{
						if (!&uParam0->f_469[4])
						{
							if (ENTITY::HAS_ANIM_EVENT_FIRED(&(uParam0->f_20[0 /*14*/]), 811542464))
							{
								...
								TASK::_TASK_SMART_FLEE_STYLE_COORD(&(uParam0->f_20[0 /*14*/]), uParam0->f_483, 3, 0, -1f, -1, 0);
						...
						if (!&uParam0->f_469[5])
						{
							if (ENTITY::HAS_ANIM_EVENT_FIRED(&(uParam0->f_20[1 /*14*/]), 811542464))
							{
								...
								PED::FORCE_PED_MOTION_STATE(&(uParam0->f_20[1 /*14*/]), -530524, false, 0, false);
								PED::SET_PED_KEEP_TASK(&(uParam0->f_20[1 /*14*/]), true);
								PED::SET_PED_CONFIG_FLAG(&(uParam0->f_20[1 /*14*/]), 288, false);
								TASK::_TASK_SMART_FLEE_STYLE_COORD(&(uParam0->f_20[1 /*14*/]), uParam0->f_483, 3, 0, -1f, -1, 0);
...
float func_64(int iParam0, vector3 vParam1, bool bParam4)
{
	vector3 vVar0;
...
void func_68(int iParam0, vector3 vParam1, bool bParam4)
{
	if (func_40() > (Global_32073.f_2697.f_6[iParam0 /*6*/])->f_5)
	{
		(Global_32073.f_2697.f_6[iParam0 /*6*/])->f_5 = func_40();
		...
		while (iVar0 < uParam0->f_19)
		{
			...
			else
			{
				if (!ENTITY::IS_ENTITY_DEAD(&(uParam0->f_20[iVar0 /*14*/])))
				{
					...
					{
						if ((func_115(Global_35, &(uParam0->f_20[iVar0 /*14*/]), 1) < fParam2 && PED::_0x5102307CE88798EB(&(uParam0->f_20[iVar0 /*14*/]))) && PED::IS_TRACKED_PED_VISIBLE(&(uParam0->f_20[iVar0 /*14*/])))
						{
							if (!func_65(&(uParam0->f_490)))
							{
								func_118(&(uParam0->f_490), 0);
							}
...
void func_107(int iParam0)
{
	if (func_43(iParam0))
	{
		...
		{
			case 1:
				func_170(0, 1, 0, 0, ((Global_1415419->f_19[iParam0 /*12*/])->f_7 / 4), 0, 0, 1);
				func_170(1, 1, 0, 0, ((Global_1415419->f_19[iParam0 /*12*/])->f_7 / 4), 0, 0, 1);
				break;
			case 37:
				func_170(60, 1, 0, 0, ((Global_1415419->f_19[iParam0 /*12*/])->f_7 / 4), 0, 0, 1);
				break;
		}
	}
}
	...
	switch (uParam0->f_6)
	{
		case 0:
			if (*uParam0 & 16 != 0)
			{
				...
				else if (!PED::IS_PED_PLANTING_BOMB(Global_35) && (!func_177(1) || *uParam0 & 8192 != 0))
				{
...
int func_138(int iParam0, var uParam1)
{
	...
	switch (iVar0)
	{
		...
		case 1589923363:
			...
			if (!func_180(iParam0, uParam1, iVar2))
			{
				return 0;
			}
			if (func_181(iParam0, iVar2) <= func_182(uParam1))
			{
				return 1;
			}
			break;
...
int func_140(int iParam0, var uParam1)
{
	...
	if (!ENTITY::IS_ENTITY_DEAD(iParam0))
	{
		if (func_186(iParam0, !*uParam1 & 268435456 != 0, !*uParam1 & 536870912 != 0, !*uParam1 & 1073741824 != 0, 0, 0))
		{
			if (uParam1->f_12 < 5f)
			{
				fVar0 = 95f;
			...
			fVar1 = func_187(uParam1);
			if (func_188(uParam1, iParam0, fVar0, fVar1))
			{
				if (uParam1->f_2 == 0)
				{
...
int func_141(int iParam0, int iParam1, var uParam2)
{
	...
	fVar0 = 85f;
	if (func_190(iParam1, !*uParam2 & 268435456 != 0, !*uParam2 & 536870912 != 0, !*uParam2 & 1073741824 != 0, 0))
	{
		if (uParam2->f_12 < 5f)
		{
			fVar0 = 95f;
		...
		fVar1 = func_187(uParam2);
		if (func_188(uParam2, iParam0, fVar0, fVar1))
		{
			if (uParam2->f_2 == 0)
			{
			...
			if (uParam2->f_2 != 0)
			{
				if (MISC::GET_GAME_TIMER() - uParam2->f_2) > func_189(uParam2)
				{
					func_184(uParam2, 1);
					return 1;
				}
...
int func_142(int iParam0, var uParam1)
{
	...
	if (func_180(iParam0, uParam1, iVar1))
	{
		if (uParam1->f_3 == 0)
		{
			uParam1->f_3 = MISC::GET_GAME_TIMER();
		}
		else if (MISC::GET_GAME_TIMER() - uParam1->f_3) > func_189(uParam1)
		{
			fVar3 = func_187(uParam1);
...
int func_143(int iParam0, bool bParam1, int iParam2, bool bParam3)
{
	...
	{
		return func_191(bParam1, iParam2, bParam3);
	}
	if (Global_1572887->f_12 != -1)
	{
...
int func_146(var uParam0, int iParam1, var uParam2)
{
	...
	if (uParam2->f_12 < IntToFloat(func_193(uParam2)))
	{
		...
		switch (iVar3)
		{
			...
			case 2:
				if (EVENT::IS_SHOCKING_EVENT_IN_SPHERE(-966930978, vVar0, uParam2->f_22))
				{
					...
					if (func_195(iParam1, vVar0, vVar4))
					{
						func_184(uParam2, 1);
						return 1;
					}
		...
		switch (iVar3)
		{
			...
			case 2:
				if (EVENT::IS_SHOCKING_EVENT_IN_SPHERE(-966930978, vVar0, uParam2->f_22))
				{
					...
					if (func_195(iParam1, vVar0, vVar7))
					{
						func_184(uParam2, 1);
						return 1;
					}
...
int func_148(int iParam0, var uParam1)
{
	...
	{
		if (!func_180(iParam0, uParam1, &(Global_1935630->f_34[iVar0])) || iParam0 == &Global_1935630->f_34[iVar0])
		{
		}
		else
		{
			bVar13 = func_196(&(Global_1935630->f_34[iVar0]));
			...
			if (func_197(uParam1, iParam0, fVar1, bVar12, bVar13))
			{
				*(vVar2[0 /*3*/]) = { ENTITY::GET_ENTITY_COORDS(&(Global_1935630->f_34[iVar0]), false, false) };
				*(vVar2[1 /*3*/]) = { vVar9 };
				uParam1->f_10 = iParam0;
			...
			else if (func_198(uParam1, iParam0, fVar1, bVar12, bVar13))
			{
				*(vVar2[0 /*3*/]) = { ENTITY::GET_ENTITY_COORDS(&(Global_1935630->f_34[iVar0]), false, false) };
				*(vVar2[1 /*3*/]) = { vVar9 };
				uParam1->f_10 = iParam0;
			...
			else if (func_199(uParam1, iParam0, fVar1, iVar0))
			{
				*(vVar2[0 /*3*/]) = { ENTITY::GET_ENTITY_COORDS(&(Global_1935630->f_34[iVar0]), false, false) };
				*(vVar2[1 /*3*/]) = { vVar9 };
				uParam1->f_10 = iParam0;
...
int func_154(int iParam0, int iParam1)
{
	if (!ENTITY::IS_ENTITY_DEAD(iParam1))
	{
		...
		if (func_203(iParam0, iParam1, 1, 1) < 4f)
		{
...
int func_156(var uParam0, int iParam1)
{
	...
	if (iVar0 != 0 && !VEHICLE::IS_THIS_MODEL_A_TRAIN(ENTITY::GET_ENTITY_MODEL(iVar0)))
	{
		...
		if (func_204(iVar0, iParam1, vVar1))
		{
...
int func_159(var uParam0, int iParam1)
{
	...
	fVar0 = func_182(uParam0);
	if (uParam0->f_12 > func_206(uParam0) && uParam0->f_12 > fVar0)
	{
		return 0;
	}
	iVar2 = func_207(iParam1);
	iVar1 = func_208(uParam0->f_14);
...
int func_160(int iParam0, int iParam1, var uParam2)
{
	...
	return func_209(iParam0, iParam1, bVar0, bVar2, uParam2->f_12, bVar1);
}
...
int func_165(int iParam0, var uParam1)
{
	...
	else if (func_157() - uParam1->f_4) > func_213(uParam1)
	{
		return func_214(iParam0, uParam1, 0, -1082130432);
	}
	return 0;
}
...
void func_170(int iParam0, int iParam1, int iParam2, int iParam3, int iParam4, int iParam5, bool bParam6, int iParam7)
{
	int iVar0;
...
int func_177(bool bParam0)
{
	...
	if (func_219(bParam0, &uVar0, &uVar1))
	{
		return 1;
	}
	return 0;
...
{
	return func_203(iParam0, iParam1, 1, 1);
}
...
int func_186(int iParam0, bool bParam1, bool bParam2, bool bParam3, int iParam4, int iParam5)
{
	int iVar0;
	int iVar1;
	int iVar2;
	...
	if (bParam3)
	{
		if (((WEAPON::_0xCB690F680A3EA971(iVar0, 1) && PLAYER::IS_PLAYER_TARGETTING_ENTITY(iVar1, iParam0, iParam5)) && PLAYER::IS_PLAYER_FREE_AIMING_AT_ENTITY(iVar1, iParam0)) && func_203(iVar0, iParam0, 1, 1) <= 4f)
		{
			return 1;
		}
	}
...
int func_188(var uParam0, int iParam1, float fParam2, float fParam3)
{
	float fVar0;
...
int func_190(int iParam0, bool bParam1, bool bParam2, bool bParam3, int iParam4)
{
	int iVar0;
	int iVar1;
...
int func_191(bool bParam0, var uParam1, var uParam2)
{
...
int func_195(int iParam0, vector3 vParam1, vector3 vParam4)
{
...
int func_199(var uParam0, int iParam1, float fParam2, int iParam3)
{
	float fVar0;
...
float func_203(int iParam0, int iParam1, bool bParam2, int iParam3)
{
...
int func_204(int iParam0, int iParam1, vector3 vParam2)
{
	float fVar0;
...
int func_209(int iParam0, int iParam1, bool bParam2, bool bParam3, float fParam4, bool bParam5)
{
	bool bVar0;
	int iVar1;
	float fVar2;
	...
	if (fParam4 <= 0f)
	{
		fVar2 = func_203(iParam0, PLAYER::PLAYER_PED_ID(), 0, 1);
	}
	else
	{
		fVar2 = fParam4;
	...
	if (bVar0)
	{
		if (func_203(iParam0, Global_1935630->f_40, 0, 1) < 2.5f)
		{
...
int func_210(int iParam0, var uParam1, bool bParam2)
{
	...
	if (ENTITY::DOES_ENTITY_EXIST(iVar0))
	{
		if (iVar0 != iParam0)
		{
			if (PED::_0x06087579E7AA85A9(iParam0, Global_35, -1f, -1f, -1f, -1f))
			{
				if (ENTITY::HAS_ENTITY_CLEAR_LOS_TO_ENTITY(iParam0, Global_35, 17))
				{
					if (!bParam2 || !func_211(uParam1, iVar0))
					{
						return 1;
					}
				}
	...
	if (ENTITY::DOES_ENTITY_EXIST(iVar1))
	{
		if (iVar1 != iParam0)
		{
			...
			{
				if (!bParam2 || !func_211(uParam1, iVar1))
				{
...
int func_214(int iParam0, var uParam1, bool bParam2, float fParam3)
{
	if (!bParam2)
	{
		if (uParam1->f_4 == 0)
...
int func_219(bool bParam0, var uParam1, var uParam2)
{
	int iVar0;
	int iVar1;
