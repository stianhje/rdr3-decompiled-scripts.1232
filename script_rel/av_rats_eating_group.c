...
{
	func_33(uParam0, 11185/*func_30*/, 11236/*func_31*/, 11690/*func_32*/);
}
...
int func_112(int iParam0, bool bParam1, int iParam2, bool bParam3)
{
	...
	{
		return func_173(bParam1, iParam2, bParam3);
	}
	if (Global_1572887->f_12 != -1)
	{
...
void func_137(int iParam0, vector3 vParam1)
{
	...
	while (iVar0 < 10)
	{
		...
		{
			if (func_140((Global_32073.f_2697.f_1495[iVar0 /*4*/])->f_1, vParam1, 1056964608, 1))
			{
				return;
			}
		}
...
int func_173(bool bParam0, var uParam1, var uParam2)
{
...
float func_185(int iParam0, int iParam1, bool bParam2, int iParam3)
{
...
void func_197(int iParam0, int iParam1, int iParam2, int iParam3, int iParam4, int iParam5, bool bParam6, int iParam7)
{
	int iVar0;

	iVar0 = (((iParam2 + (60 * iParam3)) + (3600 * iParam4)) + (86400 * iParam5));
	if (func_221(iParam0) == 1 && iParam7)
	{
		return;
	}
	if (bParam6)
...
int func_208(bool bParam0, var uParam1, var uParam2)
{
	int iVar0;
	int iVar1;
