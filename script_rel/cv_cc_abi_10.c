...
int func_72(var uParam0)
{
	...
	uLocal_31 = func_152(uParam0, joaat("p_chair_crate15x"), 0f, 0f, 0f, "CRATE 2", 0, 0, 1);
	...
	func_156(uParam0, iLocal_14, 2, 935336933, "PROP_HUMAN_SEAT_BENCH_FEMALE_A", uLocal_31, 0, 20f, 1065353216, 1);
