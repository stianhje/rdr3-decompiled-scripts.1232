...
int func_72(var uParam0)
{
	...
	func_151(uParam0, -9.1875f, 4f, 0f, 18.5f, 1.8875f, 1.0825f, 4f, -1612834106, 271759394, 1, 1, 1);
	func_151(uParam0, 0f, 0f, 0f, 0f, 1.2f, 1.2f, 4f, -1612834106, -2087487524, 1, 1, 1);
	func_152(uParam0, 0.382276f, 0.59386f, 1.00287f, 0f, 1.1f, 1.1f, 4f, 665633627, 1);
	uLocal_20 = func_153(uParam0, iLocal_42, 0f, 0f, 0f, 0, 1, 0, 1);
	func_154(uParam0, "script@vignette@javier_1@base", 1, 1, 0, 0);
	iLocal_14 = func_154(uParam0, "script@vignette@javier_1@action_a", 2, 0, 1, 0);
	iLocal_15 = func_154(uParam0, "script@vignette@javier_1@action_b", 0, 0, 0, 0);
	iLocal_16 = func_154(uParam0, "script@vignette@javier_1@action_b_alt_front", 2, 0, 0, 1);
	iLocal_17 = func_154(uParam0, "script@vignette@javier_1@action_b_alt_left", 2, 0, 0, 1);
	iLocal_18 = func_154(uParam0, "script@vignette@javier_1@action_c_alt", 0, 0, 0, 1);
	func_155(uParam0, "CJA1AUD");
	func_156(uParam0, iLocal_19, 3, 2095565963, "PROP_HUMAN_CAMP_FIRE_SEAT_BOX_MALE_A", uLocal_20, 0);
	func_157(uParam0, iLocal_19, 3, 2095565963, "PROP_HUMAN_CAMP_FIRE_SEAT_BOX_MALE_A", uLocal_20, 0, -1073741824, 1065353216, 1);
	Local_21 = { func_158(uParam0, 0.215f, -0.26f, 0.988f, 0.88f, 6.5f, 0.625f, 0.375f) };
	Local_31 = { func_158(uParam0, 0.215f, -0.26f, 0.988f, 95f, 6.5f, 0.2575f, 0.42f) };
	return 1;
}
...
int func_93(var uParam0)
{
	...
	{
		if (func_197(uParam0, Local_21, 1, 0))
		{
			func_188(uParam0, iLocal_16, 1);
			bLocal_41 = true;
		}
		else if (func_197(uParam0, Local_31, 1, 0))
		{
			func_188(uParam0, iLocal_17, 1);
			bLocal_41 = true;
		}
		else
		{
			func_188(uParam0, iLocal_15, 1);
...
int func_188(var uParam0, int iParam1, bool bParam2)
{
	...
	if (bParam2)
	{
		...
		while (iVar1 < uParam0->f_1984)
		{
			...
			else if (func_290(uParam0, iVar1) || func_196(uParam0, iVar1))
			{
...
int func_197(var uParam0, struct<4> Param1, var uParam5, var uParam6, var uParam7, var uParam8, var uParam9, var uParam10, bool bParam11, bool bParam12)
{
	if (bParam11)
	{
...
void func_198(var uParam0, int iParam1, int iParam2, int iParam3, int iParam4, char* sParam5, char* sParam6)
{
