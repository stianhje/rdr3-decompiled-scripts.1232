...
int func_72(var uParam0)
{
	...
	func_151(uParam0, -5.1875f, -2.2f, 0f, 2f, 1.2f, 1.2f, 2.685f, -1612834106, 211687389, 1, 1, 1);
	func_151(uParam0, 0f, 0f, 0.6f, 2f, 3.665f, 3.37f, 2.685f, -1612834106, -695792551, 1, 1, 1);
	...
	uLocal_21 = func_152(uParam0, joaat("p_chair_crate02x"), 1.42059f, -0.462698f, 0.000679016f, 0, 1, 0, 1);
	func_153(uParam0, "script@vignette@kieran_14@base", 1, 1, 0, 0);
	iLocal_16 = func_153(uParam0, "script@vignette@kieran_14@action_a", 2, 0, 1, 0);
	iLocal_17 = func_153(uParam0, "script@vignette@kieran_14@action_a_int_left", 2, 0, 0, 1);
	iLocal_18 = func_153(uParam0, "script@vignette@kieran_14@action_a_int_front", 2, 0, 0, 1);
	iLocal_19 = func_153(uParam0, "script@vignette@kieran_14@action_a_int_right", 2, 0, 0, 1);
	iLocal_20 = func_153(uParam0, "script@vignette@kieran_14@action_b", 0, 0, 0, 0);
	func_154(uParam0, "CKI14AU");
	func_155(uParam0, iLocal_15, 3, -1489483851, "WORLD_HUMAN_COFFEE_DRINK_MALE_A", -1, 1);
	func_156(uParam0, iLocal_14, 3, -2097328111, "GENERIC_SEAT_CHAIR_TABLE_SCENARIO_RF_FWD_FEMALE_A", uLocal_21, 0, 25f, 1065353216, 1);
	Local_22 = { func_157(uParam0, 1.298f, -0.52f, 1.07f, 100.25f, 6.5f, 0.065f, 0.6375f) };
	Local_32 = { func_157(uParam0, 1.298f, -0.52f, 1.07f, 165.54f, 6.5f, 0.22f, 0.66f) };
	Local_42 = { func_157(uParam0, 1.298f, -0.52f, 1.07f, 9.84f, 6.5f, 0.3675f, 0.3175f) };
	return 1;
}
...
int func_91(var uParam0)
{
	...
	if (!uParam0->f_2265)
	{
		func_189(uParam0->f_2, 1);
	}
	iVar0 = func_190(func_19(uParam0));
	func_191(iVar0);
...
int func_93(var uParam0)
{
	...
	{
		if (func_196(uParam0, Local_22, 1, 0))
		{
			func_187(uParam0, iLocal_18, 1);
		}
		else if (func_196(uParam0, Local_32, 1, 0))
		{
			func_187(uParam0, iLocal_17, 1);
		}
		else if (func_196(uParam0, Local_42, 1, 0))
		{
			func_187(uParam0, iLocal_19, 1);
		}
		else
		{
			func_187(uParam0, iLocal_20, 1);
		}
	}
...
int func_151(var uParam0, vector3 vParam1, float fParam4, vector3 vParam5, int iParam8, int iParam9, bool bParam10, int iParam11, int iParam12)
{
	...
	if (bParam10)
	{
		vParam1 = { func_249(uParam0, vParam1) };
...
struct<10> func_157(var uParam0, vector3 vParam1, float fParam4, float fParam5, float fParam6, float fParam7)
{
	...
	fVar0 = func_250(uParam0, (fParam4 + (fParam6 * 90f)));
	fVar1 = func_250(uParam0, (fParam4 - (fParam7 * 90f)));
	Var2 = { func_249(uParam0, vParam1) };
	...
	while (iVar0 < uParam0->f_1711)
	{
		...
		else
		{
			...
			if (!(uParam0->f_1711[iVar0 /*15*/])->f_5 && !ENTITY::DOES_ENTITY_EXIST((uParam0->f_1711[iVar0 /*15*/])->f_10))
			{
				...
				{
					vVar3 = { func_249(uParam0, (uParam0->f_1711[iVar0 /*15*/])->f_1) };
				}
				else
				{
...
void func_182(var uParam0)
{
	...
	{
		uParam0->f_1976.f_6 = PROPSET::_CREATE_PROPSET_2(uParam0->f_1976, func_249(uParam0, uParam0->f_1976.f_1), 1, func_250(uParam0, uParam0->f_1976.f_4), 3f, false, true);
	}
}
...
int func_187(var uParam0, int iParam1, bool bParam2)
{
	...
	if (bParam2)
	{
		...
		while (iVar1 < uParam0->f_1984)
		{
			...
			else if (func_288(uParam0, iVar1) || func_195(uParam0, iVar1))
			{
...
int func_196(var uParam0, struct<4> Param1, var uParam5, var uParam6, var uParam7, var uParam8, var uParam9, var uParam10, bool bParam11, bool bParam12)
{
	if (bParam11)
	{
		if (!func_297(func_19(uParam0), 1))
		{
			return 0;
		}
	}
	...
	if (!func_298(Param1, Param1.f_6, Global_36))
	{
		return 0;
	}
	if (func_298(Param1, Param1.f_3, Global_36))
	{
		return 0;
	}
	if (bParam12)
...
Vector3 func_249(var uParam0, vector3 vParam1)
{
	return OBJECT::_GET_OBJECT_OFFSET_FROM_COORDS(uParam0->f_23, uParam0->f_26.f_2, vParam1);
}

float func_250(var uParam0, float fParam1)
{
	float fVar0;
...
int func_252(int iParam0, int iParam1, bool bParam2, int iParam3, int iParam4, bool bParam5, float fParam6)
{
	...
	uVar6 = func_322(vVar0, vVar3.x, iParam1, bParam2, iParam3, iParam4, bParam5, fParam6);
	return uVar6;
}
	...
	while (iVar1 < uParam0->f_106)
	{
		...
		else
		{
			if (func_50((uParam0->f_107[iVar1 /*113*/])->f_7))
			{
				...
				{
					(uParam0->f_107[iVar1 /*113*/])->f_5 = func_323((uParam0->f_107[iVar1 /*113*/])->f_7, 1, 1, 0, 0, 1, 1, (uParam0->f_107[iVar1 /*113*/])->f_6, 0, 0, 0, 0, 0, 0, 0, 0, 0);
					return 0;
					if ((uParam0->f_107[iVar1 /*113*/])->f_102 || (uParam0->f_107[iVar1 /*113*/])->f_103)
					{
						if (!func_50((uParam0->f_107[iVar1 /*113*/])->f_1))
						{
							...
							{
								(uParam0->f_107[iVar1 /*113*/])->f_1 = func_324(uParam0, 1, 1);
							}
							else
							{
								(uParam0->f_107[iVar1 /*113*/])->f_1 = func_324(uParam0, 1, 0);
							}
						}
						if (!func_50((uParam0->f_107[iVar1 /*113*/])->f_1))
						{
					...
					if (!func_325(uParam0, iVar1, (uParam0->f_107[iVar1 /*113*/])->f_1))
					{
						if (!uParam0->f_21)
						{
							return 0;
...
int func_256(var uParam0)
{
	...
	while (iVar0 < uParam0->f_106)
	{
		...
		{
			if (ENTITY::IS_ENTITY_DEAD(func_326(iVar1)))
			{
				func_327(iVar1, 1);
				return 0;
			}
			(uParam0->f_107[iVar0 /*113*/])->f_5 = func_328(iVar1, 0, 0, 1, 1, 1);
			if (!ENTITY::DOES_ENTITY_EXIST((uParam0->f_107[iVar0 /*113*/])->f_5))
			{
				return 0;
			}
...
int func_263(var uParam0)
{
	...
	while (iVar1 < uParam0->f_1711)
	{
		...
		else if ((uParam0->f_1711[iVar1 /*15*/])->f_5)
		{
			...
			{
				vVar2 = { func_249(uParam0, (uParam0->f_1711[iVar1 /*15*/])->f_1) };
			}
			else
			{
...
int func_272(var uParam0, int iParam1, vector3 vParam2)
{
	...
	{
		fVar4 = func_331(fVar3, fVar1, fVar2, uParam0->f_2254, uParam0->f_2255);
	}
...
int func_273(var uParam0, int iParam1, vector3 vParam2)
{
	...
	{
		fVar4 = func_331(fVar3, fVar1, fVar2, uParam0->f_2259, uParam0->f_2260);
	}
...
int func_277(int iParam0, vector3 vParam1, float fParam4, bool bParam5, bool bParam6, int iParam7, bool bParam8, bool bParam9, bool bParam10, bool bParam11, bool bParam12, bool bParam13, bool bParam14)
{
	...
	func_332(iVar0, iParam0, iParam7, bParam8, bParam9, bParam10, bParam11, bParam12);
	return iVar0;
}
...
int func_290(int iParam0, bool bParam1)
{
	...
	if (ENTITY::DOES_ENTITY_EXIST(iParam0))
	{
		if (!PED::IS_PED_INJURED(iParam0) || !bParam1)
		{
			...
			{
				if (func_334(iVar0) || func_335(iVar0))
				{
					return 0;
				}
				return 1;
...
int func_291(var uParam0, float fParam1, float fParam2)
{
	...
	while (iVar1 < uParam0->f_106)
	{
		...
		{
			fVar0 = func_336(Global_35, (uParam0->f_107[iVar1 /*113*/])->f_5, 1, 1);
			if (fVar0 > fParam2)
			{
			}
			else
...
int func_300(var uParam0, int iParam1)
{
	...
	{
		if (!func_330((uParam0->f_107[iParam1 /*113*/])->f_5, 1435919172))
		{
			return 1;
		}
	}
...
int func_322(vector3 vParam0, float fParam3, var uParam4, bool bParam5, int iParam6, int iParam7, bool bParam8, float fParam9)
{
	int iVar0;
	int iVar1;
	vector3 vVar2;
...
int func_323(int iParam0, bool bParam1, bool bParam2, int iParam3, int iParam4, int iParam5, bool bParam6, bool bParam7, bool bParam8, int iParam9, int iParam10, int iParam11, float fParam12, bool bParam13, bool bParam14, bool bParam15, bool bParam16)
{
	var uVar0;
	int iVar1;
...
int func_328(int iParam0, bool bParam1, bool bParam2, bool bParam3, int iParam4, bool bParam5)
{
	int iVar0;
	int iVar1;
...
float func_331(float fParam0, float fParam1, float fParam2, float fParam3, float fParam4)
{
	return ((((fParam0 - fParam1) / (fParam2 - fParam1)) * (fParam4 - fParam3)) + fParam3);
}

void func_332(int iParam0, int iParam1, int iParam2, bool bParam3, bool bParam4, bool bParam5, bool bParam6, bool bParam7)
{
	bool bVar0;
...
float func_336(int iParam0, int iParam1, bool bParam2, int iParam3)
{
