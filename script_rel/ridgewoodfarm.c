...
int func_84(int iParam0, bool bParam1)
{
	...
	if (func_122(iParam0, 32) && !bParam1)
	{
		...
		if (func_20() == -1)
		{
			...
			{
				_NAMESPACE48::_0x49A8C2CD97815215(func_86(iParam0));
				func_126(iParam0, 2048);
			}
			_NAMESPACE48::_0xFCC6DB8DBE709BC8(func_86(iParam0));
		}
		return 0;
	}
	...
	if (_NAMESPACE48::_0x800DF3FC913355F3(func_86(iParam0)))
	{
		func_126(iParam0, 128);
		return 1;
	}
	func_125(iParam0, _NAMESPACE48::_0x4F76E3676583D951(func_124(iParam0)));
	_NAMESPACE48::_0x4F81EAD1DE8FA19B(func_86(iParam0));
	if (func_122(iParam0, 2048))
	{
		_NAMESPACE48::_0x49A8C2CD97815215(func_86(iParam0));
		func_126(iParam0, 2048);
...
bool func_85(int iParam0, int iParam1)
{
	...
	return !_NAMESPACE48::_0xEB98B38CA60742D7(func_86(iParam0));
}
...
int func_123(int iParam0, bool bParam1)
{
	...
	func_156(iParam0);
	_NAMESPACE48::_0xFC77C5B44D5FF7C0(func_86(iParam0));
	func_125(iParam0, 0);
	return 1;
}
