		...
		if (MISC::GET_GAME_TIMER() > iLocal_20)
		{
			...
			switch (iLocal_19)
			{
				...
				case 1:
					...
					LAW::_0x9BBDCB8DF789EBC1(PLAYER::PLAYER_ID(), func_9(iLocal_21));
					iVar1 = func_10(iLocal_21);
					if (iVar1 != -1)
					{
				...
				case 6:
					if (func_7(func_6(iLocal_21)))
					{
						...
						else
						{
							...
							Jump @791; //curOff = 459
							if (iLocal_22 < MISC::GET_GAME_TIMER() || (func_20() != 0 || Global_1051260->f_3790))
							{
								func_21(iLocal_21);
								func_22();
								if (!func_23(2057, 0))
...
void func_39(var uParam0, int iParam1)
{
			...
			case 1:
				if (VOLUME::_0x92A78D0BEDB332A3(uParam0[iVar3 /*3*/]))
				{
					if (VOLUME::_0xF256A75210C5C0EB(uParam0[iVar3 /*3*/], Global_36))
					{
						if (!bVar1 && !bVar2)
						{
							if ((!func_59((*uParam0)[iVar3 /*3*/], 1) && func_60(iParam1)) && !func_61(iParam1, 16))
							{
								func_63(iParam1, func_62(), -1, 0, -1, 0);
								func_64((*uParam0)[iVar3 /*3*/], 1);
							}
							func_65(iParam1, 0);
						}
						bVar0 = true;
	...
	if (func_20() == -1)
	{
		if (func_66() != bVar0)
		{
			...
			func_67();
			func_68(Global_1310750->f_16071, 0, iVar4, 0, 0);
		}
	}
	func_69(bVar0);
	if (func_20() == -1)
	{
		func_71((iParam1 == func_70() && bVar0));
	}
}
...
void func_63(int iParam0, int iParam1, int iParam2, bool bParam3, int iParam4, int iParam5)
{
	var uVar0;
	char* sVar1;
	char* sVar2;
	...
	sVar1 = func_91(iParam0, iParam1, iParam2, iParam4, iParam5, bParam3, &uVar0);
	...
	else
	{
		...
		if (!MISC::_SHOULD_USE_24_HOUR_CLOCK())
		{
			...
			sVar2 = MISC::_CREATE_VAR_STRING(674, sVar8, iVar4, func_103(&sVar6, 109029619), sVar9, func_103(&sVar10, 109029619));
		}
		else
		{
			...
			IntToString(&sVar10, BUILTIN::ROUND(fVar7), 8);
			sVar2 = MISC::_CREATE_VAR_STRING(162, sVar8, iVar4, func_103(&sVar6, 109029619), func_103(&sVar10, 109029619));
		}
...
void func_65(int iParam0, bool bParam1)
{
	...
	func_109(func_108(-1532769513, -36357794), 1);
	switch (func_6(iParam0))
	{
		case 0:
		case 2:
		case 11:
			func_109(func_108(-1532769513, 213519508), 1);
			break;
		case 1:
		case 5:
		case 6:
		case 7:
		case 12:
			func_109(func_108(-1532769513, 242571679), 1);
			break;
		case 3:
		case 10:
			func_109(func_108(-1532769513, 1349449307), 1);
			break;
		case 4:
		case 9:
			func_109(func_108(-1532769513, 1140362070), 1);
			break;
		case 8:
			func_109(func_108(-1532769513, -172330899), 1);
			break;
		case 13:
		case 14:
		case 15:
		case 16:
			func_109(func_108(-1532769513, -910218296), 1);
			break;
	}
	switch (iParam0)
	{
...
int func_83(int iParam0, var uParam1, var uParam2, bool bParam3, bool bParam4)
{
	bool bVar0;
...
char* func_91(int iParam0, int iParam1, int iParam2, int iParam3, var uParam4, var uParam5, var uParam6)
{
	char* sVar0;

	if (!MISC::IS_STRING_NULL_OR_EMPTY(&(Global_1894899->f_162)))
	{
		sVar0 = func_132(Global_1894899->f_162);
	}
...
int func_106(int iParam0)
{
	...
	if (func_138())
	{
		if (!func_139(((*Global_1835011)[3 /*74*/])->f_1, 1))
		{
...
{
	func_143((Global_1935369->f_5[iParam0 /*11*/])->f_6, 1);
	func_144((Global_1935369->f_5[iParam0 /*11*/])->f_6, 0);
...
void func_119(int iParam0)
{
	...
	{
		func_147((Global_1914319->f_3[iParam0 /*446*/])->f_21, 0, 1, 0, 0);
	}
	...
	func_148((Global_1914319->f_3[iParam0 /*446*/])->f_10, 0);
...
int func_131(int iParam0, bool bParam1, int iParam2)
{
	...
	{
		iVar0 = func_158(&(Global_1898164->f_1[0 /*5*/]));
		if (func_159(iVar0) && func_160(((*Global_1347702)[iVar0 /*49*/])->f_12, 131072))
		{
			return 0;
		}
	}
...
int func_162(vector3 vParam0, int iParam3)
{
	vector3 vVar0;
	struct<2> Var3;
	float fVar6;

	func_179(iParam3, &vVar0, &Var3, &fVar6);
	if (func_180(vParam0, vVar0, Var3, Var3.f_1, fVar6))
	{
		return 1;
	}
	return 0;
