...
int func_72(var uParam0)
{
	...
	func_150(uParam0, -1.1351f, 0.0301f, 1f, 0f, 1.2f, 1f, 2.5f, -1612834106, 2017216891, 1, 1, 1);
	func_150(uParam0, -0.2921f, -0.706f, 1f, 0f, 1f, 1.2f, 2.5f, -1612834106, 1267380940, 1, 1, 1);
	uLocal_16 = func_151(uParam0, joaat("p_chair11x"), -1.28541f, -0.0281395f, 0.0136185f, "Chair", 1, 0, 1);
	func_151(uParam0, joaat("p_map03x"), 0f, 0f, 0f, "MAP", 0, 0, 1);
	func_152(uParam0, "script@vignette@dutch_and_hosea_12@base", 1, 1, 0, 0);
	iLocal_17 = func_152(uParam0, "script@vignette@dutch_and_hosea_12@ACTION_A", 2, 0, 1, 0);
	iLocal_18 = func_152(uParam0, "script@vignette@dutch_and_hosea_12@ACTION_B_FRONT", 0, 0, 0, 1);
	iLocal_19 = func_152(uParam0, "script@vignette@dutch_and_hosea_12@ACTION_B_LEFT", 0, 0, 0, 1);
	iLocal_20 = func_152(uParam0, "script@vignette@dutch_and_hosea_12@ACTION_B_RIGHT", 0, 0, 0, 1);
	func_153(uParam0, "CDH12AU");
	func_154(uParam0, -441850275, -1329073447);
	func_155(uParam0, iLocal_14, 3, -2097328111, "GENERIC_SEAT_CHAIR_TABLE_SCENARIO_RF_FWD_MALE_A", uLocal_16, 0, -1073741824, 1065353216, 1);
	...
	Local_21 = { func_158(uParam0, -1.2351f, 0.0301f, 1f, -90f, 5f, 0.3f, 0.4f) };
	Local_31 = { func_158(uParam0, -1.235f, 0.03f, 1f, -36f, 3.4875f, 0.5225f, 0.3f) };
	Local_41 = { func_158(uParam0, -1.235f, 0.03f, 1f, -152.5f, 4.0575f, 0.3f, 0.5798f) };
	return 1;
}
...
int func_93(var uParam0)
{
	if (func_196(uParam0, iLocal_17))
	{
		...
		{
			func_199(uParam0, iLocal_14, 1, 1);
		}
	}
	if (!iLocal_51 && ((func_197(uParam0, Local_21, 1, 1) || func_197(uParam0, Local_31, 1, 1)) || func_197(uParam0, Local_41, 1, 1)))
	{
		iLocal_51 = 1;
...
void func_155(var uParam0, int iParam1, int iParam2, int iParam3, char* sParam4, var uParam5, int iParam6, float fParam7, int iParam8, int iParam9)
{
...
int func_188(var uParam0, int iParam1, bool bParam2)
{
	...
	if (bParam2)
	{
		...
		while (iVar1 < uParam0->f_1984)
		{
			...
			else if (func_291(uParam0, iVar1) || func_196(uParam0, iVar1))
			{
...
void func_198(var uParam0, var uParam1, int iParam2, float fParam3)
{
	if (iParam2 == -1)
	{
		iParam2 = 0;
...
void func_199(var uParam0, int iParam1, bool bParam2, bool bParam3)
{
	...
	if (bParam3)
	{
		uVar0 = func_303(uParam0, iParam1);
	}
	if (bParam2)
	{
...
float func_209(int iParam0, int iParam1, bool bParam2)
{
	...
	return func_308(ENTITY::GET_ENTITY_COORDS(iParam0, false, false), ENTITY::GET_ENTITY_COORDS(iParam1, false, false));
}
...
int func_241(int iParam0, bool bParam1, int iParam2)
{
	...
	{
		iVar0 = func_316(&(Global_1898164->f_1[0 /*5*/]));
		if (func_317(iVar0) && func_318(((*Global_1347702)[iVar0 /*49*/])->f_12, 131072))
		{
			return 0;
		}
	}
...
int func_244(int iParam0)
{
	...
	fVar0 = func_320(iParam0);
	fVar1 = func_321(iParam0);
...
void func_254(var uParam0, int iParam1, float fParam2)
{
	if (fParam2 == -2f)
	{
		fParam2 = func_304(1101004800, 1123024896);
	}
	else if (fParam2 < 0f)
	{
		fParam2 = -1f;
...
float func_304(float fParam0, float fParam1)
{
...
float func_308(vector3 vParam0, vector3 vParam3)
{
	vParam0.f_2 = 0f;
	vParam3.f_2 = 0f;
...
int func_392(int iParam0, bool bParam1, bool bParam2, var uParam3, var uParam4, var uParam5, float fParam6, bool bParam7, bool bParam8, bool bParam9, bool bParam10)
{
	...
	switch (((*Global_1360165)[iParam0 /*1157*/])->f_70.f_12)
	{
		...
		case 3:
			...
			sVar12 = func_423(iParam0, func_281());
		...
		case 7:
			switch (iParam0)
			{
				...
				case 14:
					...
					break;
				case 4:
					if (func_325(747937920, 1) && !func_395(((*Global_1347702)[1 /*49*/])->f_15, 1))
					{
						iVar1[0] = -1155031950;
					}
					else
