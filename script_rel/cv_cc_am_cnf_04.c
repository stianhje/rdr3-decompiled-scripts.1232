...
int func_79(var uParam0)
{
	...
	func_168(uParam0, iLocal_18, 2, -1426662425, "PROP_HUMAN_SEAT_CHAIR_GENERIC_FEMALE_A", iLocal_37, 0, 110f, 1065353216, 1);
	...
	if (iLocal_49 >= 3 && iLocal_49 < 6)
	{
		...
		if (func_225(&uLocal_98))
		{
			...
			else
			{
				...
				func_168(uParam0, iLocal_18, 2, -1074764191, "PROP_CAMP_FIRE_SEAT_BENCH_FEMALE_A", iLocal_37, 0, 110f, 1065353216, 1);
			}
			func_227(uParam0, iLocal_23, "b_WaitLoop", 1);
			func_216(9);
			return 0;
...
void func_168(var uParam0, int iParam1, int iParam2, int iParam3, char* sParam4, int iParam5, int iParam6, float fParam7, int iParam8, int iParam9)
{
...
void func_476(int iParam0, int iParam1)
{
	...
	switch (iParam0)
	{
		case 11:
			...
			{
				func_517(iParam1, 1240907314, 0, 0, 2, 1, 0, 1056964608, 1065353216, -1, 0, 0, 0, 0);
				func_517(iParam1, -2088446466, 0, 0, 3, 1, 1, 1056964608, 1065353216, -1, 0, 1, 0, 0);
			}
			break;
	}
}
