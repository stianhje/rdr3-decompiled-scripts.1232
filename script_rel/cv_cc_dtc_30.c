...
int func_72(var uParam0)
{
	...
	iLocal_16 = func_152(uParam0, -1006095118, -0.171797f, -1.1855f, 0.00361633f, 0, 1, 0, 1);
...
void func_429(int iParam0, int iParam1)
{
	...
	switch (iParam0)
	{
		case 11:
			...
			{
				func_470(iParam1, 1240907314, 0, 0, 2, 1, 0, 1056964608, 1065353216, -1, 0, 0, 0, 0);
				func_470(iParam1, -2088446466, 0, 0, 3, 1, 1, 1056964608, 1065353216, -1, 0, 1, 0, 0);
			}
			break;
	}
}
