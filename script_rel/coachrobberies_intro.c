...
void func_13()
{
	...
	switch (iLocal_66)
	{
		...
		case 2:
			...
			if (iLocal_62 == 6)
			{
				STREAMING::REQUEST_MODEL(81104014, false);
			}
			iLocal_66 = 3;
			break;
		case 3:
			...
			if (iLocal_62 == 6)
			{
				if (!STREAMING::HAS_MODEL_LOADED(81104014))
				{
					bVar0 = false;
				}
			}
		...
		case 5:
			if (iLocal_62 == 6)
			{
				if (!ENTITY::DOES_ENTITY_EXIST(Local_73.f_159))
				{
					Local_73.f_159 = OBJECT::CREATE_OBJECT_NO_OFFSET(81104014, 1226.21f, -1294.86f, 76.9511f, true, true, false, true);
...
void func_67()
{
	...
	if (iLocal_62 == 2)
	{
		if (!WEAPON::HAS_PED_GOT_WEAPON(Global_35, -1504859554, 0, 0))
		{
			func_198(Global_35, -1504859554, 0, 0, 0, 0, 0, 1056964608, 1065353216, 3, 0, 0, 0, 0);
		}
		else
		{
			WEAPON::_0xB190BCA3F4042F95(Global_35, -1504859554, 3, 752097756);
		}
	}
	iLocal_15 = 1;
}
...
int func_77(bool bParam0, bool bParam1, bool bParam2)
{
	...
	if (func_70(Local_73.f_1))
	{
		...
		if (bParam1)
		{
			...
			ENTITY::_0x203BEFFDBE12E96A(Local_73, Local_73.f_2, Local_73.f_5, 1, false, 1);
			if (bParam2)
			{
...
void func_245()
{
	STREAMING::SET_MODEL_AS_NO_LONGER_NEEDED(81104014);
...
void func_427()
{
	if (iLocal_62 == 0)
	{
		...
		if (!ENTITY::DOES_ENTITY_EXIST(Local_73.f_159))
		{
			Local_73.f_159 = OBJECT::CREATE_OBJECT_NO_OFFSET(81104014, ENTITY::GET_ENTITY_COORDS(Local_73, true, false), true, true, false, true);
		}
	...
	{
		Local_73.f_161 = OBJECT::CREATE_OBJECT_NO_OFFSET(-1473388640, ENTITY::GET_ENTITY_COORDS(Local_73, true, false), true, true, false, true);
	}
