...
int func_72(var uParam0)
{
	...
	func_151(uParam0, -0.5225f, -0.0596f, 1f, 0f, 1.1f, 1.1f, 3f, -1612834106, 1418411488, 1, 1, 1);
	func_151(uParam0, -0.2943f, 7.2323f, 1f, -19f, 1.1f, 1.1f, 3f, -1612834106, -695792551, 1, 1, 1);
	iLocal_17 = func_152(uParam0, -82199229, 0f, 0f, 0f, "MUG0", 0, 0, 1);
	func_152(uParam0, -82199229, 0f, 0f, 0f, "MUG1", 0, 1, 1);
	func_153(uParam0, "script@vignette@sean_karen_par_3@base", 1, 1, 0, 0);
	uLocal_16 = func_153(uParam0, "script@vignette@sean_karen_par_3@action", 0, 0, 1, 0);
	func_154(uParam0, "CSKP3AU");
	func_155(uParam0, 1472097208, 983380613);
	func_156(uParam0, uLocal_16, -1, 0.67f);
	func_157(uParam0, iLocal_14, 3, 421625586, "WORLD_HUMAN_LEAN_WALL_DRINKING_MALE_B", -1, 1);
	func_158(uParam0, iLocal_14, 2, 421625586, "WORLD_HUMAN_LEAN_WALL_DRINKING_MALE_B", -1, 1, -1073741824, 1065353216, 1);
	...
	func_157(uParam0, iLocal_15, 3, -1489483851, "WORLD_HUMAN_COFFEE_DRINK_FEMALE_C", -1, 1);
...
int func_382(int iParam0, bool bParam1, bool bParam2, var uParam3, var uParam4, var uParam5, float fParam6, bool bParam7, bool bParam8, bool bParam9, bool bParam10)
{
	...
	switch (((*Global_1360165)[iParam0 /*1157*/])->f_70.f_12)
	{
		...
		case 3:
			...
			sVar12 = func_417(iParam0, func_280());
