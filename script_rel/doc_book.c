...
struct<5> func_746(int iParam0)
{
	...
	Var0 = { func_747(iParam0, 1328661203, func_513(), -1591664384) };
	Var0.f_4 = 1084182731;
	return Var0;
}

struct<4> func_747(int iParam0, int iParam1, var uParam2, var uParam3, var uParam4, var uParam5, int iParam6)
{
	struct<4> Var0;
...
int func_759(int iParam0, int iParam1, var uParam2, int iParam3, int iParam4, var uParam5)
{
	struct<12> Var0;
...
int func_761(int iParam0, var uParam1, var uParam2, var uParam3, var uParam4, var uParam5, bool bParam6)
{
	if (!INVENTORY::_0xB881CA836CC4B6D4(&uParam1))
	{
		return 0;
