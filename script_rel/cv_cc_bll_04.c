...
int func_72(var uParam0)
{
	...
	func_150(uParam0, 1.0585f, -0.4757f, 0.5633f, 0f, 1.1f, 1.1f, 4f, -1612834106, -2087487524, 1, 1, 1);
	func_150(uParam0, 8.6959f, -2.0924f, 0.8267f, 0f, 2f, 2f, 5f, -1612834106, 211687389, 1, 1, 1);
	uLocal_20 = func_151(uParam0, 1230724566, 1.42062f, -0.462748f, 0.00315094f, "CRATE", 1, 0, 1);
	iLocal_21 = func_151(uParam0, -1971689092, 0f, 0f, 0f, "BOTTLE", 0, 0, 1);
	func_151(uParam0, -261930923, 0f, 0f, 0f, "BRUSH", 0, 1, 1);
	func_151(uParam0, -1984279062, 0f, 0f, 0f, "SADDLE", 0, 1, 1);
	func_152(uParam0, "script@vignette@bill_4@base", 1, 1, 0, 0);
	iLocal_16 = func_152(uParam0, "script@vignette@bill_4@action_a", 2, 0, 1, 0);
	iLocal_17 = func_152(uParam0, "script@vignette@bill_4@action_b", 0, 0, 0, 0);
	iLocal_18 = func_152(uParam0, "script@vignette@bill_4@action_b_alt_left", 0, 0, 0, 0);
	iLocal_19 = func_152(uParam0, "script@vignette@bill_4@action_b_alt_right", 0, 0, 0, 0);
	func_153(uParam0, "CBLL4AU");
	func_154(uParam0, iLocal_14, 3, -120888770, "PROP_HUMAN_SEAT_CHAIR_TABLE_DRINKING_BADASS_MALE_D", uLocal_20, 0, -1073741824, 1065353216, 1);
	...
	Local_22 = { func_158(uParam0, 1.0585f, -0.4757f, 0.5633f, 75.25f, 6f, 0.35f, 0.35f) };
	Local_32 = { func_158(uParam0, 1.0952f, -0.4301f, 0.5478f, -66.75f, 6f, 0.6f, 0.4f) };
	vLocal_43 = { 667.1002f, -1274.696f, 43.43616f };
	return 1;
}
...
{
	if (!CAM::IS_SPHERE_VISIBLE(vLocal_43, 1f))
	{
		if (!func_108(&uLocal_46))
		{
			func_115(&uLocal_46, 1);
		}
	}
	else
	{
...
void func_172(vector3 vParam0, float fParam3, int iParam4)
{
	int iVar0;
...
int func_275(var uParam0, int iParam1, vector3 vParam2)
{
	...
	if (func_296(uParam0) == 3 || func_296(uParam0) == 8)
	{
...
int func_386(int iParam0, bool bParam1, bool bParam2, var uParam3, var uParam4, var uParam5, float fParam6, bool bParam7, bool bParam8, bool bParam9, bool bParam10)
{
	...
	switch (((*Global_1360165)[iParam0 /*1157*/])->f_70.f_12)
	{
		...
		case 3:
			...
			sVar12 = func_421(iParam0, func_280());
