...
int func_75(var uParam0)
{
	if (func_148(uParam0) == 3)
	{
		if (!ENTITY::DOES_ENTITY_EXIST(iLocal_70))
		{
			...
			if (STREAMING::HAS_MODEL_LOADED(-1623912517))
			{
				iLocal_70 = OBJECT::CREATE_OBJECT(-1623912517, func_165(uParam0, 0.778003f, -0.256235f, -0.0359992f), true, true, false, false, true);
...
int func_86(var uParam0)
{
	...
	{
		if (WEAPON::HAS_PED_GOT_WEAPON(func_48(uParam0, iLocal_14), 1845380267, 0, 0))
		{
			WEAPON::SET_CURRENT_PED_WEAPON(func_48(uParam0, iLocal_14), 1845380267, true, 0, false, false);
		}
	}
	return 1;
}
...
void func_399(int iParam0, int iParam1)
{
	...
	switch (iParam0)
	{
		case 11:
			...
			{
				func_444(iParam1, 1240907314, 0, 0, 2, 1, 0, 1056964608, 1065353216, -1, 0, 0, 0, 0);
				func_444(iParam1, -2088446466, 0, 0, 3, 1, 1, 1056964608, 1065353216, -1, 0, 1, 0, 0);
			}
			break;
	}
}
