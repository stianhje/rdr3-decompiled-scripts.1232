...
int func_72(var uParam0)
{
	...
	iLocal_16 = func_152(uParam0, -1074884633, 0f, 0f, 0f, "RAG", 0, 1, 1);
	iLocal_17 = func_152(uParam0, -1916489787, 0f, 0f, 0f, "WASHBOARD", 0, 1, 1);
	func_152(uParam0, -940999254, 0f, 0f, 0f, "BOOK", 0, 0, 1);
...
void func_396(int iParam0, int iParam1)
{
	...
	switch (iParam0)
	{
		case 11:
			...
			{
				func_441(iParam1, 1240907314, 0, 0, 2, 1, 0, 1056964608, 1065353216, -1, 0, 0, 0, 0);
				func_441(iParam1, -2088446466, 0, 0, 3, 1, 1, 1056964608, 1065353216, -1, 0, 1, 0, 0);
			}
			break;
	}
}
