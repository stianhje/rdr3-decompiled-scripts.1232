...
{
	func_33(uParam0, 11399/*func_30*/, 11492/*func_31*/, 11928/*func_32*/);
}
...
var func_53(var uParam0, int iParam1, int iParam2, vector3 vParam3, float fParam6)
{
	int iVar0;
	var uVar1;
...
int func_55(int iParam0, bool bParam1, bool bParam2, bool bParam3, int iParam4, bool bParam5)
{
	int iVar0;
	int iVar1;
...
bool func_108(int iParam0, int iParam1)
{
	...
	if (iParam1 && !ENTITY::DOES_ENTITY_EXIST(func_101(iParam0)))
	{
		return false;
	}
...
void func_129(int iParam0, vector3 vParam1)
{
	...
	while (iVar0 < 10)
	{
		...
		{
			if (func_148((Global_32073.f_2697.f_1495[iVar0 /*4*/])->f_1, vParam1, 1056964608, 1))
			{
				return;
			}
		}
...
int func_172(int iParam0, bool bParam1, int iParam2, bool bParam3)
{
	...
	{
		return func_224(bParam1, iParam2, bParam3);
	}
	if (Global_1572887->f_12 != -1)
	{
...
void func_196(int iParam0, int iParam1, int iParam2, int iParam3, int iParam4, int iParam5, bool bParam6, int iParam7)
{
	int iVar0;

	iVar0 = (((iParam2 + (60 * iParam3)) + (3600 * iParam4)) + (86400 * iParam5));
	if (func_248(iParam0) == 1 && iParam7)
	{
		return;
	}
	if (bParam6)
...
int func_224(bool bParam0, var uParam1, var uParam2)
{
...
float func_236(int iParam0, int iParam1, bool bParam2, int iParam3)
{
