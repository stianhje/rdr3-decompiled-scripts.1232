...
int func_72(var uParam0)
{
	...
	func_151(uParam0, -1.0491f, -1.0785f, 0f, 0f, 3.5f, 3.5f, 5f, -1612834106, 2017216891, 1, 1, 1);
	func_151(uParam0, -6.4407f, 3.7614f, 0f, 0f, 1f, 1f, 5f, -1612834106, 1267380940, 1, 1, 1);
	func_152(uParam0, -1.4875f, -0.0252f, 1.15f, 38.56f, 1.6425f, 1.335f, 2.685f, 665633627, 1);
	iLocal_16 = func_153(uParam0, joaat("p_cs_bookevelynmiller"), 0f, 0f, 0f, "BOOK", 0, 0, 1);
	func_154(uParam0, "script@vignette@dutch_and_hosea_4@base", 1, 1, 0, 0);
	iLocal_17 = func_154(uParam0, "script@vignette@dutch_and_hosea_4@action_a", 2, 0, 1, 0);
	iLocal_18 = func_154(uParam0, "script@vignette@dutch_and_hosea_4@action_b", 0, 0, 0, 0);
	iLocal_19 = func_154(uParam0, "script@vignette@dutch_and_hosea_4@action_b_alt", 0, 0, 0, 1);
	func_155(uParam0, "CCDH4AU");
	func_156(uParam0, iLocal_14, 2, -787460071, "SC_PROP_CAMP_DUTCH_SEAT_CHAIR_READING_MALE_A", -1, 0);
	func_157(uParam0, iLocal_14, 2, -787460071, "SC_PROP_CAMP_DUTCH_SEAT_CHAIR_READING_MALE_A", -1, 0, -1073741824, 1065353216, 1);
	func_158(uParam0, iLocal_14, iLocal_16, "p_cs_bookEvelynMiller_PH_R_HAND", 0, 0);
	func_159(uParam0, iLocal_15, 2, 1, 0, 0, 0);
	Local_20 = { func_160(uParam0, -1.2233f, 0.4f, 1.0699f, 177.84f, 9f, 0.41f, 0.38f) };
	Local_30 = { func_160(uParam0, -1.2233f, 0.4f, 1.0699f, 1.8775f, 9f, 0.482f, 0.4557f) };
	return 1;
}
...
int func_93(var uParam0)
{
	...
	{
		if (func_199(uParam0, Local_20, 1, 0) || func_199(uParam0, Local_30, 1, 0))
		{
			func_200(uParam0, 383097382, 2055271530);
