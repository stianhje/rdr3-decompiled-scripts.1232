...
int func_72(var uParam0)
{
	...
	func_151(uParam0, -0.7301f, 0.5311f, 0.5295f, -0.2848f, 2.2f, 2f, 3f, -1612834106, -1495061186, 1, 1, 1);
	func_152(uParam0, -1.0257f, 0.9388f, 1.0341f, 0f, 0.72f, 0.72f, 3f, 665633627, 1);
	iLocal_21 = func_153(uParam0, joaat("p_cs_rag02x"), 0f, 0f, 0f, "RAG", 0, 1, 1);
	uLocal_22 = func_153(uParam0, joaat("p_stoolfolding01x"), 0.0114404f, 1.02168f, 0.0306778f, 0, 1, 0, 1);
	func_154(uParam0, iLocal_14, joaat("weapon_revolver_cattleman_john"), "REVOLVER");
	func_155(uParam0, "script@vignette@hosea_12@base", 1, 1, 0, 0);
	iLocal_15 = func_155(uParam0, "script@vignette@hosea_12@action_a", 2, 0, 1, 0);
	iLocal_16 = func_155(uParam0, "script@vignette@hosea_12@action_a_int", 2, 0, 0, 0);
	iLocal_17 = func_155(uParam0, "script@vignette@hosea_12@action_b", 2, 0, 0, 0);
	iLocal_18 = func_155(uParam0, "script@vignette@hosea_12@action_c", 0, 0, 0, 0);
	iLocal_19 = func_155(uParam0, "script@vignette@hosea_12@action_c_alt", 0, 0, 0, 1);
	func_156(uParam0, "CH12AUD");
	func_157(uParam0, iLocal_14, 3, -407482490, "PROP_HUMAN_SEAT_CHAIR_TABLE_CLEAN_PISTOL_MALE_A", uLocal_22, 0, -1073741824, 1065353216, 1);
	func_158(uParam0, iLocal_14, iLocal_21, "p_cs_rag02x_PH_L_HAND", 0, 0);
	func_159(uParam0, iLocal_14, 1, 2, 0, 0, 0);
	Local_23 = { func_160(uParam0, -1.5559f, 0.4947f, 1.0665f, -3.96f, 7f, 0.6f, 0.6f) };
	return 1;
}
...
int func_93(var uParam0)
{
	...
	if (func_198(uParam0, iLocal_17))
	{
		if (func_199(uParam0, Local_23, 1, 0))
		{
			...
			func_201(uParam0, -1819938910, 1401090690);
...
{
	if (!iLocal_20 && TASK::PED_HAS_USE_SCENARIO_TASK(func_48(uParam0, iLocal_14)))
	{
		PED::_0xEC6935EBE0847B90(func_48(uParam0, iLocal_14), ENTITY::GET_OFFSET_FROM_ENTITY_IN_WORLD_COORDS(func_48(uParam0, iLocal_14), 1f, 0f, 0f));
		iLocal_20 = 1;
	}
	return 1;
}
...
int func_154(var uParam0, var uParam1, int iParam2, char* sParam3)
{
	int iVar0;
