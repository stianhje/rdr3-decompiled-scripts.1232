...
{
	func_33(uParam0, 10772/*func_30*/, 10844/*func_31*/, 11400/*func_32*/);
}
...
void func_14(var uParam0, vector3 vParam1, vector3 vParam4)
{
	...
	func_46(uParam0, "MAN_SIT_READ", "", vParam1, vParam4);
	uVar0 = func_48(func_47(), 1, 0, 1, 0, 0, 1);
	uVar1 = func_49(997958153, 1);
	func_50(uParam0, 0, "MSRP_HORSE", uVar1, OBJECT::_GET_OBJECT_OFFSET_FROM_COORDS(vParam1, vParam4.z, 2f, 2.2f, 0f), (60f + vParam4.z), 1, 1, 1, 1, 41788943, 1);
	func_50(uParam0, 1, "MSRP_MAN", uVar0, OBJECT::_GET_OBJECT_OFFSET_FROM_COORDS(vParam1, vParam4.z, 0f, 0f, 0f), vParam4.z, 1, 1, 1, 1, 41788943, 1);
}
...
int func_31(var uParam0)
{
	if (!&uParam0->f_469[0])
	{
		if (func_67(uParam0, &uLocal_10, 0))
		{
			func_68(uParam0);
			uParam0->f_469[0] = 1;
		}
		if (PED::_0x331550B212014B92(&(uParam0->f_20[1 /*14*/]), Global_35))
		{
	...
	{
		iLocal_41 = func_69();
		if (func_70(4) || func_71(iLocal_41))
		{
	...
	switch (iLocal_9)
	{
		case 0:
			if (!ENTITY::IS_ENTITY_DEAD(&(uParam0->f_20[1 /*14*/])))
			{
				...
				func_76(uParam0->f_20[1 /*14*/], 0, 1);
				PED::SET_PED_KEEP_TASK(&(uParam0->f_20[1 /*14*/]), true);
			}
			if (!ENTITY::IS_ENTITY_DEAD(&(uParam0->f_20[0 /*14*/])))
			{
				func_73(&((uParam0->f_20[0 /*14*/])->f_5), 1, 10, 0);
				TASK::TASK_START_SCENARIO_AT_POSITION(&(uParam0->f_20[0 /*14*/]), 696740378, (uParam0->f_20[0 /*14*/])->f_5, (uParam0->f_20[0 /*14*/])->f_8, 0, 0, 1, 0, -1082130432, 0);
				func_76(uParam0->f_20[0 /*14*/], 0, 1);
				PED::SET_PED_KEEP_TASK(&(uParam0->f_20[0 /*14*/]), true);
			}
			iLocal_38 = GRAPHICS::_0xFA50F79257745E74((uParam0->f_20[1 /*14*/])->f_5, 4f, 1, 36, 0);
			iLocal_39 = GRAPHICS::_0xFA50F79257745E74((uParam0->f_20[1 /*14*/])->f_5, 1.5f, 2, -1, 0);
			iLocal_9 = 1;
			break;
...
{
	func_78(uParam0, 0, 0, 0);
	if (iLocal_38 != -1)
	{
		GRAPHICS::_0x9CF1836C03FB67A2(&iLocal_38, 1);
	}
	if (iLocal_39 != -1)
	{
		GRAPHICS::_0x9CF1836C03FB67A2(&iLocal_39, 1);
	}
	return 1;
}
...
{
	func_110(uParam0, iParam1, iParam3);
...
int func_77(var uParam0, float fParam1, float fParam2, int iParam3, float fParam4, float fParam5)
{
	int iVar0;
	float fVar1;
	int iVar2;
...
int func_164(int iParam0, var uParam1)
{
	...
	else if (func_156() - uParam1->f_4) > func_214(uParam1)
	{
...
void func_166(int iParam0)
{
	if (func_43(iParam0))
	{
		...
		{
			case 1:
				func_216(0, 1, 0, 0, ((Global_1415419->f_19[iParam0 /*12*/])->f_7 / 4), 0, 0, 1);
				func_216(1, 1, 0, 0, ((Global_1415419->f_19[iParam0 /*12*/])->f_7 / 4), 0, 0, 1);
				break;
			
			case 37:
				func_216(60, 1, 0, 0, ((Global_1415419->f_19[iParam0 /*12*/])->f_7 / 4), 0, 0, 1);
				break;
		}
	}
}
