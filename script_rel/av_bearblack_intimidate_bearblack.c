...
{
	func_33(uParam0, 11170/*func_30*/, 11259/*func_31*/, 12125/*func_32*/);
}
...
{
	func_46(uParam0, "BEARBLACK_INTIMIDATE_BEARBLACK", "script@ambient@animal@bearblack_intimidate_bearblack_backdown@action", vParam1, vParam4);
	uParam0->f_16 = 1;
	func_47(uParam0, 1, "pbl_action", "", 0);
	func_48(uParam0, 0, "bear_a", iLocal_9, 0f, 0f, 0f, 0f, 1, 1, 1, 1, 41788943, 0);
	func_48(uParam0, 1, "bear_b", iLocal_9, 0f, 0f, 0f, 0f, 1, 1, 1, 1, 41788943, 0);
	func_48(uParam0, 2, "carcass", joaat("a_c_deer_01"), OBJECT::_GET_OBJECT_OFFSET_FROM_COORDS(vParam1, vParam4.z, 0f, 0f, 0f), (vParam4.z - 90f), 1, 0, 1, 1, 41788943, 1);
}
...
int func_18(var uParam0)
{
	...
	if (!STREAMING::_0x9427C94D2E4094A4(-1814089768, 0))
	{
		return 0;
	}
...
int func_28(var uParam0)
{
	...
	if (!ENTITY::IS_ENTITY_DEAD(&(uParam0->f_20[2 /*14*/])))
	{
		...
		TASK::TASK_PLAY_ANIM(&(uParam0->f_20[2 /*14*/]), sLocal_38, sLocal_39, 1000f, -1000f, -1, 131072, 0, 0, 0, 0, 0, 0);
		_NAMESPACE49::_0x3CA5E58C9731A16B(&(uParam0->f_20[2 /*14*/]), iLocal_40);
		MISC::_0x674B90BE1115846D(&(uParam0->f_20[2 /*14*/]), 1);
...
int func_30(var uParam0)
{
	...
	STREAMING::_0x19A6BE7D9C6884D3(-1814089768, 1, joaat("a_c_bearblack_01"), 0);
	func_58(&uLocal_10, 0);
	func_59(&uLocal_10, 1);
	func_60(&uLocal_10, 1);
	func_61(&uLocal_10, 1);
...
int func_31(var uParam0)
{
	...
	if (!&uParam0->f_469[0])
	{
		if (!bLocal_44 == 1)
		{
			if (func_66(uParam0, &uLocal_10, 1) || func_67(Global_35, uParam0->f_483, 1) <= 400f)
			{
				bLocal_44 = true;
			}
		}
		if (bLocal_44)
		{
			if ((!ENTITY::HAS_ANIM_EVENT_FIRED(&(uParam0->f_20[1 /*14*/]), 725039534) || ENTITY::IS_ENTITY_DEAD(&(uParam0->f_20[0 /*14*/]))) || ENTITY::IS_ENTITY_DEAD(&(uParam0->f_20[1 /*14*/])))
			{
				...
				if (!&uParam0->f_469[6])
				{
					func_70(*uParam0, uParam0->f_483, 1);
					uParam0->f_469[6] = 1;
				}
				func_71(uParam0);
				func_72(uParam0);
	...
	if (!&uParam0->f_469[0] && !bLocal_44)
	{
		...
		if (&uParam0->f_469[2])
		{
			if (!&uParam0->f_469[6])
			{
				if (func_75(uParam0, 1.5f, 80f, 4, -91962372, 1))
				{
					func_70(*uParam0, uParam0->f_483, 1);
					uParam0->f_469[6] = 1;
				}
					...
					if (ANIMSCENE::_0x477122B8D05E7968(uParam0->f_3.f_1, 1, 0))
					{
						if (ANIMSCENE::_0x1F0E401031E20146(uParam0->f_3.f_1, "pbl_action"))
						{
							if (!&uParam0->f_469[3])
							{
								...
								{
									TASK::_TASK_START_SCENARIO_IN_PLACE(&(uParam0->f_20[0 /*14*/]), -1814089768, 35000, 0, 0, -1082130432, 0);
							...
							if (!&uParam0->f_469[4])
							{
								...
								{
									TASK::_TASK_SMART_FLEE_STYLE_PED(&(uParam0->f_20[1 /*14*/]), &(uParam0->f_20[0 /*14*/]), 3, 256, -1082130432, -1, 0);
									PED::_0x2208438012482A1A(&(uParam0->f_20[1 /*14*/]), false, false);
									PED::SET_PED_KEEP_TASK(&(uParam0->f_20[1 /*14*/]), true);
									uParam0->f_469[4] = 1;
								}
							}
							if ((uParam0->f_469[3] && uParam0->f_469[4]) // PointerArith)
							{
								uParam0->f_469[5] = 1;
							}
						}
...
void func_47(var uParam0, int iParam1, char* sParam2, char* sParam3, int iParam4)
{
...
void func_48(var uParam0, int iParam1, char* sParam2, int iParam3, vector3 vParam4, float fParam7, int iParam8, int iParam9, int iParam10, int iParam11, int iParam12, int iParam13)
{
...
int func_49(var uParam0, vector3 vParam1)
{
	int iVar0;
...
void func_57(var uParam0, bool bParam1, int iParam2)
{
...
int func_66(var uParam0, var uParam1, int iParam2)
{
	...
	{
		if (func_104(&(uParam0->f_20[uParam0->f_501 /*14*/]), 0, uParam1, &(uParam0->f_468), 0, 0))
		{
			return 1;
		}
		uParam0->f_501++;
...
void func_70(int iParam0, vector3 vParam1, bool bParam4)
{
	if (func_40() > (Global_32073.f_2697.f_6[iParam0 /*6*/])->f_5)
	{
		(Global_32073.f_2697.f_6[iParam0 /*6*/])->f_5 = func_40();
...
void func_72(var uParam0)
{
	...
	if (!ENTITY::IS_ENTITY_DEAD(&(uParam0->f_20[1 /*14*/])))
	{
		if (!func_110(&(uParam0->f_20[1 /*14*/]), 518218985))
		{
			...
			func_57(uParam0->f_20[1 /*14*/], 0, 1);
			PED::SET_PED_KEEP_TASK(&(uParam0->f_20[1 /*14*/]), true);
		}
	}
}

int func_73(var uParam0, float fParam1)
{
	if (!func_68(uParam0))
	{
		return 0;
...
int func_74(var uParam0, float fParam1, float fParam2, int iParam3, float fParam4, float fParam5)
{
	...
	if ((MISC::GET_FRAME_COUNT() % 8) == 0)
	{
		...
		fVar7 = func_115(Global_36, uParam0->f_483);
		...
		while (iVar0 < uParam0->f_19)
		{
			...
			if (!ENTITY::IS_ENTITY_DEAD(&(uParam0->f_20[iVar0 /*14*/])))
			{
				...
				fVar8 = func_116(Global_35, &(uParam0->f_20[iVar0 /*14*/]), 1);
				if (fVar8 < fVar1)
				{
					return 1;
				}
		...
		while (iVar0 < uParam0->f_19)
		{
			...
			else
			{
				if (!ENTITY::IS_ENTITY_DEAD(&(uParam0->f_20[iVar0 /*14*/])))
				{
					...
					{
						if ((func_116(Global_35, &(uParam0->f_20[iVar0 /*14*/]), 1) < fParam2 && PED::_0x5102307CE88798EB(&(uParam0->f_20[iVar0 /*14*/]))) && PED::IS_TRACKED_PED_VISIBLE(&(uParam0->f_20[iVar0 /*14*/])))
						{
							if (!func_68(&(uParam0->f_490)))
							{
								func_119(&(uParam0->f_490), 0);
							}
...
void func_90(int iParam0, vector3 vParam1)
{
	int iVar0;
	int iVar1;
...
void func_108(int iParam0)
{
	if (func_43(iParam0))
	{
		...
		{
			case 1:
				func_171(0, 1, 0, 0, ((Global_1415419->f_19[iParam0 /*12*/])->f_7 / 4), 0, 0, 1);
				func_171(1, 1, 0, 0, ((Global_1415419->f_19[iParam0 /*12*/])->f_7 / 4), 0, 0, 1);
				break;
			case 37:
				func_171(60, 1, 0, 0, ((Global_1415419->f_19[iParam0 /*12*/])->f_7 / 4), 0, 0, 1);
				break;
		}
	}
}
...
float func_116(int iParam0, int iParam1, bool bParam2)
{
	...
	return func_105(ENTITY::GET_ENTITY_COORDS(iParam0, false, false), ENTITY::GET_ENTITY_COORDS(iParam1, false, false));
}
...
int func_139(int iParam0, var uParam1)
{
	...
	switch (iVar0)
	{
		...
		case 1589923363:
			...
			if (!func_181(iParam0, uParam1, iVar2))
			{
				return 0;
			}
			if (func_182(iParam0, iVar2) <= func_183(uParam1))
			{
				return 1;
			}
			break;
...
int func_141(int iParam0, var uParam1)
{
	...
	if (!ENTITY::IS_ENTITY_DEAD(iParam0))
	{
		if (func_187(iParam0, !*uParam1 & 268435456 != 0, !*uParam1 & 536870912 != 0, !*uParam1 & 1073741824 != 0, 0, 0))
		{
			if (uParam1->f_12 < 5f)
			{
				fVar0 = 95f;
			...
			fVar1 = func_188(uParam1);
			if (func_189(uParam1, iParam0, fVar0, fVar1))
			{
				if (uParam1->f_2 == 0)
				{
...
int func_142(int iParam0, int iParam1, var uParam2)
{
	...
	fVar0 = 85f;
	if (func_191(iParam1, !*uParam2 & 268435456 != 0, !*uParam2 & 536870912 != 0, !*uParam2 & 1073741824 != 0, 0))
	{
		if (uParam2->f_12 < 5f)
		{
			fVar0 = 95f;
		...
		fVar1 = func_188(uParam2);
		if (func_189(uParam2, iParam0, fVar0, fVar1))
		{
			if (uParam2->f_2 == 0)
			{
			...
			if (uParam2->f_2 != 0)
			{
				if (MISC::GET_GAME_TIMER() - uParam2->f_2) > func_190(uParam2)
				{
					func_185(uParam2, 1);
					return 1;
				}
...
int func_143(int iParam0, var uParam1)
{
	...
	if (func_181(iParam0, uParam1, iVar1))
	{
		if (uParam1->f_3 == 0)
		{
			uParam1->f_3 = MISC::GET_GAME_TIMER();
		}
		else if (MISC::GET_GAME_TIMER() - uParam1->f_3) > func_190(uParam1)
		{
			fVar3 = func_188(uParam1);
...
int func_144(int iParam0, bool bParam1, int iParam2, bool bParam3)
{
	...
	{
		return func_192(bParam1, iParam2, bParam3);
	}
	if (Global_1572887->f_12 != -1)
	{
...
int func_147(var uParam0, int iParam1, var uParam2)
{
	...
	if (uParam2->f_12 < IntToFloat(func_194(uParam2)))
	{
		...
		switch (iVar3)
		{
			...
			case 2:
				if (EVENT::IS_SHOCKING_EVENT_IN_SPHERE(-966930978, vVar0, uParam2->f_22))
				{
					...
					if (func_196(iParam1, vVar0, vVar4))
					{
						func_185(uParam2, 1);
						return 1;
					}
		...
		switch (iVar3)
		{
			...
			case 2:
				if (EVENT::IS_SHOCKING_EVENT_IN_SPHERE(-966930978, vVar0, uParam2->f_22))
				{
					...
					if (func_196(iParam1, vVar0, vVar7))
					{
						func_185(uParam2, 1);
						return 1;
					}
...
int func_149(int iParam0, var uParam1)
{
	...
	{
		if (!func_181(iParam0, uParam1, &(Global_1935630->f_34[iVar0])) || iParam0 == &Global_1935630->f_34[iVar0])
		{
		}
		else
		{
			bVar13 = func_197(&(Global_1935630->f_34[iVar0]));
			...
			if (func_198(uParam1, iParam0, fVar1, bVar12, bVar13))
			{
				*(vVar2[0 /*3*/]) = { ENTITY::GET_ENTITY_COORDS(&(Global_1935630->f_34[iVar0]), false, false) };
				*(vVar2[1 /*3*/]) = { vVar9 };
				uParam1->f_10 = iParam0;
			...
			else if (func_199(uParam1, iParam0, fVar1, bVar12, bVar13))
			{
				*(vVar2[0 /*3*/]) = { ENTITY::GET_ENTITY_COORDS(&(Global_1935630->f_34[iVar0]), false, false) };
				*(vVar2[1 /*3*/]) = { vVar9 };
				uParam1->f_10 = iParam0;
			...
			else if (func_200(uParam1, iParam0, fVar1, iVar0))
			{
				*(vVar2[0 /*3*/]) = { ENTITY::GET_ENTITY_COORDS(&(Global_1935630->f_34[iVar0]), false, false) };
				*(vVar2[1 /*3*/]) = { vVar9 };
				uParam1->f_10 = iParam0;
...
int func_157(var uParam0, int iParam1)
{
	...
	if (iVar0 != 0 && !VEHICLE::IS_THIS_MODEL_A_TRAIN(ENTITY::GET_ENTITY_MODEL(iVar0)))
	{
		...
		if (func_205(iVar0, iParam1, vVar1))
		{
...
int func_160(var uParam0, int iParam1)
{
	...
	fVar0 = func_183(uParam0);
	if (uParam0->f_12 > func_207(uParam0) && uParam0->f_12 > fVar0)
	{
		return 0;
	}
	iVar2 = func_208(iParam1);
	iVar1 = func_209(uParam0->f_14);
...
int func_161(int iParam0, int iParam1, var uParam2)
{
	...
	return func_210(iParam0, iParam1, bVar0, bVar2, uParam2->f_12, bVar1);
}
	...
	switch (iVar1)
	{
		...
		case -1601932249:
			...
			if (PED::_0x06087579E7AA85A9(iParam0, iVar4, -1f, -1f, -1f, -1f) && PED::_0x06087579E7AA85A9(iParam0, Global_35, -1f, -1f, -1f, -1f))
			{
				...
				{
					if (!func_212(uParam1, iParam0))
					{
						if (func_206(iVar4, Global_36, 1) < 7f)
						{
							return 1;
						}
					}
...
int func_166(int iParam0, var uParam1)
{
	...
	else if (func_158() - uParam1->f_4) > func_214(uParam1)
	{
		return func_215(iParam0, uParam1, 0, -1082130432);
	}
	return 0;
}
...
void func_171(int iParam0, int iParam1, int iParam2, int iParam3, int iParam4, int iParam5, bool bParam6, int iParam7)
{
	int iVar0;

	iVar0 = (((iParam2 + (60 * iParam3)) + (3600 * iParam4)) + (86400 * iParam5));
	if (func_216(iParam0) == 1 && iParam7)
	{
		return;
	}
	if (bParam6)
...
int func_178(bool bParam0)
{
	...
	if (func_220(bParam0, &uVar0, &uVar1))
	{
		return 1;
	}
	return 0;
...
int func_187(int iParam0, bool bParam1, bool bParam2, bool bParam3, int iParam4, int iParam5)
{
	int iVar0;
	int iVar1;
	int iVar2;
	...
	{
		if (WEAPON::_0x6AD66548840472E5(func_223(iVar0, 0)))
		{
			if (func_224(iParam0, 0.4f, 0.6f, 0.3f, 0.7f))
			{
				return 1;
			}
		}
...
int func_189(var uParam0, int iParam1, float fParam2, float fParam3)
{
	float fVar0;
...
int func_191(int iParam0, bool bParam1, bool bParam2, bool bParam3, int iParam4)
{
	int iVar0;
	int iVar1;
	...
	if (PLAYER::IS_PLAYER_FREE_AIMING(iVar1))
	{
		if (WEAPON::_0x6AD66548840472E5(func_223(iVar0, 0)))
		{
			if (func_225(ENTITY::GET_ENTITY_COORDS(iParam0, true, false), 0.4f, 0.6f, 0.3f, 0.7f))
			{
				return 1;
			}
		}
...
int func_192(bool bParam0, var uParam1, var uParam2)
{
...
int func_196(int iParam0, vector3 vParam1, vector3 vParam4)
{
	if (func_226(iParam0, vParam4, 0.5f))
	{
...
int func_198(var uParam0, int iParam1, float fParam2, bool bParam3, bool bParam4)
{
	float fVar0;
...
int func_200(var uParam0, int iParam1, float fParam2, int iParam3)
{
	float fVar0;
...
int func_202(int iParam0, int iParam1)
{
	...
	if (func_229(iParam0, 1, 0, 0) != joaat("weapon_lasso"))
	{
		return 0;
	}
...
int func_205(int iParam0, int iParam1, vector3 vParam2)
{
	float fVar0;

	fVar0 = func_206(iParam0, vParam2, 1);
	if (fVar0 < 4f)
	{
...
float func_206(int iParam0, vector3 vParam1, bool bParam4)
{
	if (!ENTITY::DOES_ENTITY_EXIST(iParam0))
	{
		return 0f;
...
int func_210(int iParam0, int iParam1, bool bParam2, bool bParam3, float fParam4, bool bParam5)
{
	bool bVar0;
	int iVar1;
	float fVar2;
...
int func_211(int iParam0, var uParam1, bool bParam2)
{
	int iVar0;
	int iVar1;

	func_220(1, &iVar0, &iVar1);
	...
	if (ENTITY::DOES_ENTITY_EXIST(iVar0))
	{
		if (iVar0 != iParam0)
		{
			if (PED::_0x06087579E7AA85A9(iParam0, Global_35, -1f, -1f, -1f, -1f))
			{
				if (ENTITY::HAS_ENTITY_CLEAR_LOS_TO_ENTITY(iParam0, Global_35, 17))
				{
					if (!bParam2 || !func_212(uParam1, iVar0))
					{
						return 1;
					}
				}
	...
	if (ENTITY::DOES_ENTITY_EXIST(iVar1))
	{
		if (iVar1 != iParam0)
		{
			...
			{
				if (!bParam2 || !func_212(uParam1, iVar1))
				{
					if (func_206(iVar1, Global_36, 1) < 5f)
					{
						return 1;
					}
				}
...
int func_213(int iParam0)
{
	...
	return func_231(((*Global_1347702)[58 /*49*/])->f_15, 1);
}
...
int func_215(int iParam0, var uParam1, bool bParam2, float fParam3)
{
	if (!bParam2)
	{
		if (uParam1->f_4 == 0)
...
int func_220(bool bParam0, var uParam1, var uParam2)
{
	int iVar0;
	int iVar1;
...
int func_224(int iParam0, float fParam1, float fParam2, float fParam3, float fParam4)
{
	if (!ENTITY::IS_ENTITY_DEAD(iParam0))
	{
...
int func_225(vector3 vParam0, float fParam3, float fParam4, float fParam5, float fParam6)
{
	float fVar0;
	float fVar1;
	bool bVar2;
...
bool func_226(int iParam0, vector3 vParam1, float fParam4)
{
	vector3 vVar0;
	vector3 vVar3;
