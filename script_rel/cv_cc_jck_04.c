...
int func_72(var uParam0)
{
	...
	func_153(uParam0, 0f, 0f, 1.3625f, 80f, 5f, 5f, 1.5f, 665633627, 1);
	func_154(uParam0, 3.1875f, -0.3125f, 0.782f, 80f, 5.8675f, 4.0925f, 2.505f, -1612834106, 211687389, 1, 1, 1);
	func_154(uParam0, -4.325f, 5.45f, 0.782f, 80f, 1.1f, 1f, 2.505f, -1612834106, -2055224817, 1, 1, 1);
	func_155(uParam0, 1);
	iLocal_18 = func_156(uParam0, 858540986, 0f, 0f, 0f, "BRUSH", 0, 1, 1);
	iLocal_19 = func_156(uParam0, -82199229, 0f, 0f, 0f, "COFFEEMUG", 0, 1, 1);
	func_156(uParam0, 430766991, 0f, 0f, 0f, "STONE", 0, 1, 1);
	func_156(uParam0, 430766991, 0f, 0f, 0f, "STONE01", 0, 1, 1);
	func_156(uParam0, 430766991, 0f, 0f, 0f, "STONE02", 0, 1, 1);
	func_156(uParam0, 430766991, 0f, 0f, 0f, "STONE03", 0, 1, 1);
	func_157(uParam0, "script@vignette@jack_4@base", 1, 1, 0, 0);
	uLocal_20 = func_157(uParam0, "script@vignette@jack_4@action", 0, 0, 1, 0);
	func_158(uParam0, "CJCK4AU");
	func_159(uParam0, uLocal_20, -1, 0.86f);
	func_160(uParam0, iLocal_16, 3, 1626779076, "WORLD_HUMAN_HORSE_TEND_BRUSH_LINK_MALE_A", -1, 1, 50f, 1065353216, 1);
	func_161(uParam0, iLocal_16, iLocal_18, "p_brushHorse01x_PH_R_HAND", 0, 0);
	func_162(uParam0, iLocal_16, 2, 2, 0, 0, 0);
	func_163(uParam0, iLocal_14, 3, -1489483851, "WORLD_HUMAN_COFFEE_DRINK_FEMALE_C", -1, 1);
	func_160(uParam0, iLocal_14, 3, -1489483851, "WORLD_HUMAN_COFFEE_DRINK_FEMALE_C", -1, 0, -1073741824, 1065353216, 1);
	func_164(uParam0, iLocal_14, 3, 0);
	func_161(uParam0, iLocal_14, iLocal_19, "p_mugCoffee01x_ph_r_hand", 0, 0);
	func_163(uParam0, iLocal_15, 3, 240644744, "WORLD_CAMP_JACK_THROWS_ROCKS_CASUAL", -1, 1);
	func_160(uParam0, iLocal_15, 3, 240644744, "WORLD_CAMP_JACK_THROWS_ROCKS_CASUAL", -1, 0, -1073741824, 1065353216, 1);
	func_164(uParam0, iLocal_15, 3, 0);
	func_165(uParam0, iLocal_15, 1, -1);
	func_166(uParam0, 45321810, -708630570);
	return 1;
}
...
int func_85(var uParam0)
{
	...
	if (!uParam0->f_4)
	{
		...
		while (iVar0 < uParam0->f_106)
		{
			...
			else if (func_180(uParam0, iVar0))
			{
			}
	...
	{
		func_195(uParam0);
		func_196(uParam0, uParam0->f_2047, 1);
	}
...
int func_91(var uParam0)
{
	...
	if (uParam0->f_2048 >= 0)
	{
		func_196(uParam0, uParam0->f_2048, 1);
	}
	func_203(uParam0);
...
int func_93(var uParam0)
{
	...
	{
		iLocal_21 = TASK::_0xF533D68FF970D190(-113.32f, -15.6f, 94.89f, -1805387726, 0.25f, 0, 0);
		if (TASK::_0x841475AC96E794D1(iLocal_21))
		{
			TASK::_TASK_USE_SCENARIO_POINT(func_48(uParam0, iLocal_17), iLocal_21, 0, 0, 0, 1, 0, 0, -1082130432, 0);
			PHYSICS::_0x06AADE17334F7A40(func_48(uParam0, iLocal_17), -114.838f, -14.87315f, 95.79354f);
			PED::SET_PED_KEEP_TASK(func_48(uParam0, iLocal_17), true);
			PED::_0x2208438012482A1A(func_48(uParam0, iLocal_17), false, false);
		}
		func_52(func_48(uParam0, iLocal_17), (uParam0->f_107[iLocal_17 /*113*/])->f_7, 0, 0, 0);
	}
	return 1;
}
...
int func_143(var uParam0)
{
	...
	{
		_NAMESPACE48::_0xD4B614179BCD0654(func_121(10, 0));
		_NAMESPACE48::_0xD4B614179BCD0654(func_217(10, 0));
		func_35(uParam0);
		return 1;
	}
	return 0;
...
void func_150(var uParam0, int iParam1, int iParam2, int iParam3, int iParam4)
{
...
int func_152(var uParam0, int iParam1, char* sParam2, int iParam3)
{
	int iVar0;
...
int func_153(var uParam0, vector3 vParam1, float fParam4, vector3 vParam5, int iParam8, bool bParam9)
{
	int iVar0;
...
int func_154(var uParam0, vector3 vParam1, float fParam4, vector3 vParam5, int iParam8, int iParam9, bool bParam10, int iParam11, int iParam12)
{
	int iVar0;
...
int func_156(var uParam0, int iParam1, vector3 vParam2, char* sParam5, int iParam6, int iParam7, int iParam8)
{
	int iVar0;
...
void func_159(var uParam0, var uParam1, int iParam2, float fParam3)
{
	if (iParam2 == -1)
	{
		iParam2 = 0;
...
void func_162(var uParam0, int iParam1, int iParam2, int iParam3, int iParam4, char* sParam5, char* sParam6)
{
...
void func_163(var uParam0, int iParam1, int iParam2, int iParam3, char* sParam4, int iParam5, int iParam6)
{
...
void func_164(var uParam0, int iParam1, int iParam2, int iParam3)
{
	...
	{
		case 4:
			(uParam0->f_107[iParam1 /*113*/])->f_32.f_5 = { func_261(func_149(uParam0), func_260(uParam0, iParam1), func_19(uParam0), 1) };
			break;
		
		default:
			Var0 = { func_262(func_149(uParam0), func_260(uParam0, iParam1), func_19(uParam0), 1) };
...
int func_179(var uParam0)
{
	...
	while (iVar3 < uParam0->f_106)
	{
		...
		else if (func_180(uParam0, iVar3))
		{
		}
...
int func_196(var uParam0, int iParam1, bool bParam2)
{
	...
	if (bParam2)
	{
		...
		while (iVar1 < uParam0->f_1984)
		{
			...
			else if (func_299(uParam0, iVar1) || func_300(uParam0, iVar1))
			{
...
int func_197(var uParam0)
{
	...
	if (func_22() == 3)
	{
		if (func_302(Global_35, 1))
		{
			fVar0 = 5f;
			fVar1 = 8f;
		}
	}
	if (func_303(uParam0, fVar0, fVar1))
	{
		return 1;
	}
	return 0;
...
void func_200(int iParam0)
{
	...
	if (func_305(iVar2, iVar0, 0))
	{
		if (func_305(iVar2, iVar1, 0))
		{
	...
	while (iVar0 < uParam0->f_106)
	{
		...
		else
		{
			if ((uParam0->f_107[iVar0 /*113*/])->f_32.f_32 > -1)
			{
				...
				func_306((uParam0->f_107[iVar0 /*113*/])->f_1, uVar1, iVar3, iVar2, 0, 0, 1);
			}
			fVar4 = (uParam0->f_107[iVar0 /*113*/])->f_32.f_35;
			if (fVar4 > 0f)
			{
				func_307((uParam0->f_107[iVar0 /*113*/])->f_1, fVar4);
				func_306((uParam0->f_107[iVar0 /*113*/])->f_1, 3, 0, 1, 0, 0, 1);
			}
		}
		iVar0++;
	}
...
void func_210(var uParam0)
{
	...
	while (iVar0 < uParam0->f_106)
	{
		if (((uParam0->f_107[iVar0 /*113*/])->f_32.f_60 > 0f && !(uParam0->f_107[iVar0 /*113*/])->f_32.f_62) && func_312(uParam0, (uParam0->f_107[iVar0 /*113*/])->f_32.f_61, (uParam0->f_107[iVar0 /*113*/])->f_32.f_60))
		{
...
Vector3 func_261(int iParam0, int iParam1, int iParam2, bool bParam3)
{
	switch (iParam0)
	{
		case 0:
...
struct<4> func_262(int iParam0, int iParam1, int iParam2, bool bParam3)
{
	switch (iParam0)
	{
		case 1:
		...
		case 6:
			switch (iParam1)
			{
				...
				case 14:
					...
					{
						case 156:
							return func_332(2329.663f, 1347.464f, 104.5794f, 155.2611f);
				...
				case 1:
					switch (iParam2)
					{
						...
						case 156:
							return func_332(2330.225f, 1345.275f, 104.7174f, 21.2991f);
		...
		case 8:
			switch (iParam1)
			{
				...
				case 4:
					...
					{
						case 669:
							return func_332(-1603.036f, -1408.744f, 80.9423f, 69.6409f);
...
int func_303(var uParam0, float fParam1, float fParam2)
{
	float fVar0;
	int iVar1;
...
void func_306(int iParam0, int iParam1, int iParam2, int iParam3, int iParam4, bool bParam5, bool bParam6)
{
	bool bVar0;
	int iVar1;
...
int func_312(var uParam0, int iParam1, float fParam2)
{
	int iVar0;
...
struct<4> func_332(vector3 vParam0, float fParam3)
{
	struct<4> Var0;
...
void func_379(var uParam0, int iParam1)
{
	...
	if (fVar0 > 0f)
	{
		func_307((uParam0->f_107[iParam1 /*113*/])->f_1, fVar0);
	}
}
...
int func_391(int iParam0, bool bParam1, bool bParam2, var uParam3, var uParam4, var uParam5, float fParam6, bool bParam7, bool bParam8, bool bParam9, bool bParam10)
{
	...
	switch (((*Global_1360165)[iParam0 /*1157*/])->f_70.f_12)
	{
		...
		case 3:
			...
			sVar12 = func_426(iParam0, func_289());
	...
	switch (iParam1)
	{
		...
		case 7:
			switch (iParam0)
			{
				...
				case 4:
					if (func_330(747937920, 1) && !func_394(((*Global_1347702)[1 /*49*/])->f_15, 1))
					{
						iVar1[0] = -1155031950;
					}
					else
