...
{
	func_33(uParam0, 10824/*func_30*/, 10881/*func_31*/, 11314/*func_32*/);
}
...
void func_14(var uParam0, vector3 vParam1, vector3 vParam4)
{
	...
	uLocal_9 = func_48(997958153, 1);
	func_49(uParam0, 0, "DHP_HORSE", uLocal_9, vParam1, vParam4.z, 1, 1, 0, 1, 41788943, 1);
	if (*uParam0 == 150)
	{
	...
	switch (iLocal_11)
	{
		case 0:
			...
			if (!ENTITY::IS_ENTITY_DEAD(&(uParam0->f_20[1 /*14*/])))
			{
				...
				TASK::TASK_START_SCENARIO_AT_POSITION(&(uParam0->f_20[1 /*14*/]), -622057267, (uParam0->f_20[1 /*14*/])->f_5, (uParam0->f_20[1 /*14*/])->f_8, 0, 0, 1, 0, -1082130432, 0);
...
void func_85(int iParam0, vector3 vParam1)
{
	...
	while (iVar0 < 10)
	{
		...
		{
			if (func_112((Global_32073.f_2697.f_1495[iVar0 /*4*/])->f_1, vParam1, 1056964608, 1))
			{
				return;
			}
		}
...
int func_134(int iParam0, bool bParam1, int iParam2, bool bParam3)
{
	...
	{
		return func_184(bParam1, iParam2, bParam3);
	}
	if (Global_1572887->f_12 != -1)
	{
...
int func_184(bool bParam0, var uParam1, var uParam2)
{
...
void func_208(int iParam0, int iParam1, int iParam2, int iParam3, int iParam4, int iParam5, bool bParam6, int iParam7)
{
	int iVar0;
