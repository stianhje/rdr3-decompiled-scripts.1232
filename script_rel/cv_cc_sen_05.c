...
int func_72(var uParam0)
{
	...
	func_153(uParam0, -7.13439f, -11.6913f, 0.418625f, 0f, 1.5f, 1.5f, 3f, -1612834106, 1418411488, 1, 1, 1);
	func_153(uParam0, -9.14886f, -2.50338f, 0.186272f, 0f, 1.5f, 1.5f, 3f, -1612834106, 1267380940, 1, 1, 1);
	func_154(uParam0, "script@vignette@sean_5@base", 1, 1, 0, 0);
	iLocal_15 = func_154(uParam0, "script@vignette@sean_5@action_a", 2, 0, 1, 0);
	iLocal_16 = func_154(uParam0, "script@vignette@sean_5@action_b", 0, 0, 0, 0);
	iLocal_17 = func_154(uParam0, "script@vignette@sean_5@action_b_alt_front", 0, 0, 0, 1);
	iLocal_18 = func_154(uParam0, "script@vignette@sean_5@action_b_alt_back", 0, 0, 0, 1);
	func_155(uParam0, "CSEN5AU");
	func_156(uParam0, 508618180, 1184542341);
	func_157(uParam0, iLocal_14, 2, -258459266, "WORLD_HUMAN_GUARD_SCOUT_MALE_C", -1, 1, -1073741824, 1065353216, 1);
	func_158(uParam0, iLocal_14, 4, 4, 0, 0, 0);
	func_159(uParam0, iLocal_14, 1, -1);
	Local_19 = { func_160(uParam0, -7.912f, -10.5553f, 0.3967f, -176.76f, 7f, 0.5f, 0.5f) };
	Local_29 = { func_160(uParam0, -7.912f, -10.555f, 0.397f, 0f, 7f, 0.5f, 0.5f) };
	return 1;
}
...
int func_93(var uParam0)
{
	...
	{
		if (func_199(uParam0, Local_19, 1, 0))
		{
			func_190(uParam0, iLocal_17, 1);
		}
		else if (func_199(uParam0, Local_29, 1, 0))
		{
			func_190(uParam0, iLocal_18, 1);
		}
		else
		{
			func_190(uParam0, iLocal_16, 1);
		}
	}
	return 1;
}
