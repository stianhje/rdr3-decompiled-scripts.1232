...
int func_79(var uParam0)
{
	...
	func_163(uParam0, 1210783447, 0f, 0f, 0f, "p_cs_book04x", 0, 1, 1);
	func_163(uParam0, 1623781586, 0f, 0f, 0f, "p_pocketMirror01x", 0, 1, 1);
	if (!func_159(14))
	{
...
void func_478(int iParam0, int iParam1)
{
	...
	switch (iParam0)
	{
		case 11:
			...
			{
				func_523(iParam1, 1240907314, 0, 0, 2, 1, 0, 1056964608, 1065353216, -1, 0, 0, 0, 0);
				func_523(iParam1, -2088446466, 0, 0, 3, 1, 1, 1056964608, 1065353216, -1, 0, 1, 0, 0);
			}
			break;
	}
}
