...
void func_61(int iParam0, int iParam1, int iParam2, bool bParam3, int iParam4, int iParam5)
{
	...
	sVar1 = func_89(iParam0, iParam1, iParam2, iParam4, iParam5, bParam3, &uVar0);
	...
	if (func_90(iParam4))
	{
		iVar3 = func_92(iParam4);
	}
	if (uVar0 && bParam3)
	{
		sVar2 = func_94(func_93(iParam2));
	}
	...
	{
		iVar4 = func_98(func_97());
		iVar5 = func_99(func_97());
		if (iVar5 < 10)
		{
		...
		if (!MISC::_SHOULD_USE_24_HOUR_CLOCK())
		{
			...
			{
				fVar7 = func_100(fVar7);
				sVar8 = "TIME_AND_TEMP_F";
			}
			IntToString(&sVar10, BUILTIN::ROUND(fVar7), 8);
			sVar2 = MISC::_CREATE_VAR_STRING(674, sVar8, iVar4, func_101(&sVar6, 109029619), sVar9, func_101(&sVar10, 109029619));
		}
		else
		{
			...
			IntToString(&sVar10, BUILTIN::ROUND(fVar7), 8);
			sVar2 = MISC::_CREATE_VAR_STRING(162, sVar8, iVar4, func_101(&sVar6, 109029619), func_101(&sVar10, 109029619));
		}
		Global_1894899->f_9 = 0;
	}
	Global_1934266->f_148 = func_102(sVar1, sVar2, 4000, 0, 0, 0, 0, 1);
}
...
void func_63(int iParam0, bool bParam1)
{
	...
	func_107(func_106(-1532769513, -36357794), 1);
	switch (func_6(iParam0))
	{
		case 0:
		case 2:
		case 11:
			func_107(func_106(-1532769513, 213519508), 1);
			break;
		case 1:
		case 5:
		case 6:
		case 7:
		case 12:
			func_107(func_106(-1532769513, 242571679), 1);
			break;
		case 3:
		case 10:
			func_107(func_106(-1532769513, 1349449307), 1);
			break;
		case 4:
		case 9:
			func_107(func_106(-1532769513, 1140362070), 1);
			break;
		case 8:
			func_107(func_106(-1532769513, -172330899), 1);
			break;
		case 13:
		case 14:
		case 15:
		case 16:
			func_107(func_106(-1532769513, -910218296), 1);
			break;
	}
	switch (iParam0)
	{
...
bool func_64()
{
	return (Global_1894899 & 1 != 0 && func_108() != -1);
}
...
void func_66(int iParam0, bool bParam1, int iParam2, bool bParam3, bool bParam4)
{
	...
	while (iVar0 < 4)
	{
		...
		if (((func_109(iVar1) && !func_112(iVar1, iParam2)) && (!bParam3 || !func_113(iVar1))) && (!bParam4 || !func_114(iVar1)))
		{
			if (iVar1 != iParam0)
			{
				func_115(iVar0);
...
void func_76(int iParam0)
{
	...
	while (iVar1 < 4)
	{
		func_119(&((Global_1392240->f_1[iVar0 /*18*/])->f_6[iVar1]));
...
char* func_89(int iParam0, int iParam1, int iParam2, int iParam3, var uParam4, var uParam5, var uParam6)
{
	char* sVar0;
...
char* func_101(char* sParam0, int iParam1)
{
...
var func_102(char* sParam0, char* sParam1, int iParam2, int iParam3, int iParam4, int iParam5, int iParam6, int iParam7)
{
	struct<4> Var0;
	vector3 vVar13;
	var uVar16;
...
void func_117(int iParam0)
{
	...
	else
	{
		...
		while (iVar0 < iVar1)
		{
			func_119(&((Global_1914319->f_3[iParam0 /*446*/])->f_317[iVar0 /*6*/]));
