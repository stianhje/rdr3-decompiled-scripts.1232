...
int func_72(var uParam0)
{
	...
	func_150(uParam0, 1.1315f, -1.743f, 0f, -56f, 1.2f, 1.2f, 5f, -1612834106, 271759394, 1, 1, 1);
	func_150(uParam0, -0.4685f, 1.932f, 0f, -56f, 1.0625f, 1.0275f, 5f, -1612834106, -1495061186, 1, 1, 1);
	func_151(uParam0, "script@vignette@javier_11@base", 1, 0, 0, 0);
	uLocal_17 = func_151(uParam0, "script@vignette@javier_11@action", 0, 0, 1, 0);
	func_152(uParam0, 245507163, 0f, 0f, 0f, "BRUSH", 0, 1, 1);
	iLocal_16 = func_152(uParam0, 1271647689, -1.35271f, 1.61457f, -0.0227356f, 0, 1, 0, 1);
	func_153(uParam0, iLocal_15, 3, 660335536, "PROP_HUMAN_SEAT_CRATE_CLEAN_BOOTS_MALE_A", -1, 0);
	func_154(uParam0, iLocal_15, 1, 1, 0, 0, 0);
	func_155(uParam0, iLocal_15, 1, 120);
	func_153(uParam0, iLocal_14, 3, -1074764191, "PROP_CAMP_FIRE_SEAT_BENCH_MALE_B", iLocal_16, 0);
	func_156(uParam0, iLocal_14, 2, -1074764191, "PROP_CAMP_FIRE_SEAT_BENCH_MALE_B", iLocal_16, 0, -1073741824, 1065353216, 1);
	func_154(uParam0, iLocal_14, 1, 1, 0, 0, 0);
	func_155(uParam0, iLocal_14, 1, 120);
	func_157(uParam0, -439102695, -1005886378);
	func_158(uParam0, uLocal_17, -1, 0.93f);
...
int func_151(var uParam0, char* sParam1, int iParam2, bool bParam3, bool bParam4, bool bParam5)
{
	int iVar0;
			...
			if (!(uParam0->f_107[iVar0 /*113*/])->f_32)
			{
				if (func_299(uParam0, iVar0))
				{
					if ((uParam0->f_107[iVar0 /*113*/])->f_32.f_48)
					{
						...
						func_300(uParam0, iVar0, 0, 1);
					}
					else
					{
						func_300(uParam0, iVar0, 1, 1);
					}
...
int func_273(var uParam0, int iParam1, vector3 vParam2)
{
	...
	if (func_295(uParam0) == 3 || func_295(uParam0) == 8)
	{
...
void func_300(var uParam0, int iParam1, bool bParam2, bool bParam3)
{
	...
	if (bParam3)
	{
		uVar0 = func_339(uParam0, iParam1);
	}
	if (bParam2)
	{
...
int func_381(int iParam0, bool bParam1, bool bParam2, var uParam3, var uParam4, var uParam5, float fParam6, bool bParam7, bool bParam8, bool bParam9, bool bParam10)
{
	...
	switch (((*Global_1360165)[iParam0 /*1157*/])->f_70.f_12)
	{
		...
		case 3:
			...
			sVar12 = func_416(iParam0, func_278());
	...
	switch (iParam1)
	{
		...
		case 7:
			switch (iParam0)
			{
				...
				case 4:
					if (func_320(747937920, 1) && !func_384(((*Global_1347702)[1 /*49*/])->f_15, 1))
					{
						iVar1[0] = -1155031950;
					}
					else
