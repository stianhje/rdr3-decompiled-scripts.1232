...
{
	func_51(0.775f, 0.2f, 0.025f, 0f);
	if (POPULATION::_0xA5BD585005EFCAD4(iLocal_15))
	{
		POPULATION::_0xA6E6A66FC4CA4224(iLocal_15);
	}
	iParam0 = iParam0;
}
...
int func_178(vector3 vParam0, int iParam3)
{
	...
	func_194(iParam3, &vVar0, &Var3, &fVar6);
	if (func_195(vParam0, vVar0, Var3, Var3.f_1, fVar6))
	{
		return 1;
	}
	return 0;
