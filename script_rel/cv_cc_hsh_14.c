...
int func_81(var uParam0)
{
	...
	iLocal_97 = 7;
	uParam0->f_106 += 4;
	iLocal_125 = -2087759666;
	iLocal_126 = -2087759666;
	iLocal_127 = -1038436471;
	STREAMING::REQUEST_MODEL(-2087759666, false);
	STREAMING::REQUEST_MODEL(-2087759666, false);
...
void func_172(var uParam0, int iParam1, int iParam2, float fParam3)
{
	if (iParam2 == -1)
	{
		iParam2 = 0;
...
void func_492(int iParam0, int iParam1)
{
	...
	switch (iParam0)
	{
		case 11:
			...
			{
				func_537(iParam1, 1240907314, 0, 0, 2, 1, 0, 1056964608, 1065353216, -1, 0, 0, 0, 0);
				func_537(iParam1, -2088446466, 0, 0, 3, 1, 1, 1056964608, 1065353216, -1, 0, 1, 0, 0);
			}
			break;
	}
}
