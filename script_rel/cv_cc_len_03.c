...
int func_72(var uParam0)
{
	...
	func_151(uParam0, 0f, 0f, 0f, 102.24f, 1.5f, 1.5f, 3f, -1612834106, -676766751, 1, 1, 1);
	func_152(uParam0, "script@vignette@lenny_3@base", 1, 1, 0, 0);
	func_152(uParam0, "script@vignette@lenny_3@action", 0, 0, 1, 1);
	func_153(uParam0, "LEN3AUD");
	func_154(uParam0, iLocal_14, 2, -258459266, "WORLD_HUMAN_GUARD_SCOUT_MALE_C", -1, 1);
	func_155(uParam0, iLocal_14, 2, -258459266, "WORLD_HUMAN_GUARD_SCOUT_MALE_C", -1, 1, -1073741824, 1065353216, 1);
	func_156(uParam0, iLocal_14, 2, -1);
	Local_16 = { func_157(uParam0, 0f, 0f, 0f, 0f, 8f, 0.6f, 0.6f) };
	func_158(uParam0, 1);
...
bool func_87(var uParam0)
{
	...
	if (!iLocal_15)
	{
		...
		{
			WEAPON::SET_CURRENT_PED_WEAPON(iVar0, joaat("weapon_sniperrifle_rollingblock_lenny"), true, 0, false, false);
			iLocal_15 = 1;
		}
	}
	return func_190(uParam0, Local_16, 1, 0);
}
...
int func_107(int iParam0, int iParam1, int iParam2, bool bParam3, bool bParam4)
{
	...
	if (func_120(iVar0, 0))
	{
		...
		if ((iParam1 || !func_105(iParam0)) || func_51(iParam0))
		{
			...
			{
				if (func_212(iParam0, 32768/*func_206*/, 1))
				{
...
int func_190(var uParam0, struct<4> Param1, var uParam5, var uParam6, var uParam7, var uParam8, var uParam9, var uParam10, bool bParam11, bool bParam12)
{
	if (bParam11)
	{
		if (!func_290(func_19(uParam0), 1))
		{
			return 0;
		}
	}
	...
	if (!func_291(Param1, Param1.f_6, Global_36))
	{
		return 0;
	}
	if (func_291(Param1, Param1.f_3, Global_36))
	{
		return 0;
	}
	if (bParam12)
...
bool func_291(struct<2> Param0, var uParam2, struct<2> Param3, var uParam5, struct<2> Param6, var uParam8)
{
...
int func_383(int iParam0, bool bParam1, bool bParam2, var uParam3, var uParam4, var uParam5, float fParam6, bool bParam7, bool bParam8, bool bParam9, bool bParam10)
{
	...
	switch (((*Global_1360165)[iParam0 /*1157*/])->f_70.f_12)
	{
		...
		case 3:
			...
			sVar12 = func_418(iParam0, func_277());
...
void func_441(int iParam0, int iParam1, bool bParam2)
{
	...
	if ((Global_40.f_4942[iParam0 /*60*/])->f_5 & 32768/*func_206*/ > 0 && func_401(iParam1, -1658942149))
	{
...
void func_442(int iParam0)
{
	...
	func_461(iParam0, 32768/*func_206*/);
