...
int func_72(var uParam0)
{
	...
	func_152(uParam0, 1.95f, -6.75f, 0f, 0f, 0.6f, 0.96f, 5f, 665633627, 1);
	func_153(uParam0, "script@vignette@beecher@uncle_7@base", 1, 1, 0, 0);
	iLocal_16 = func_153(uParam0, "script@vignette@beecher@uncle_7@action_a", 2, 0, 1, 0);
	iLocal_17 = func_153(uParam0, "script@vignette@beecher@uncle_7@action_b", 0, 0, 0, 0);
	iLocal_18 = func_153(uParam0, "script@vignette@beecher@uncle_7@action_b_alt_front", 0, 0, 0, 1);
	iLocal_19 = func_153(uParam0, "script@vignette@beecher@uncle_7@action_b_alt_left", 0, 0, 0, 1);
	iLocal_20 = func_153(uParam0, "script@vignette@beecher@uncle_7@action_b_alt_right", 0, 0, 0, 1);
	func_154(uParam0, "BUNC7AU");
	func_155(uParam0, 2018632191, 350294224);
	Local_23 = { func_156(uParam0, 39.08f, -18.14f, 0.7617f, -84.51f, 8.5f, 0.155f, 0.7225f) };
	Local_33 = { func_156(uParam0, 39.08f, -18.14f, 0.7617f, -36.39f, 8.5f, 0.175f, 0.383f) };
	Local_43 = { func_156(uParam0, 39.08f, -18.14f, 0.7617f, -153.72f, 8.5f, 0.048f, 0.61f) };
	func_157(uParam0, iLocal_14, 3, -1426662425, "PROP_HUMAN_SEAT_CHAIR_GENERIC_MALE_D", -1, 0);
	func_158(uParam0, iLocal_14, 3, -1426662425, "PROP_HUMAN_SEAT_CHAIR_GENERIC_MALE_D", iLocal_21, 0, -1073741824, 1065353216, 1);
	func_159(uParam0, iLocal_14, 1, -1);
	func_157(uParam0, iLocal_15, 3, 2090191561, "WORLD_CAMP_JACK_ES_READ_GROUND_MALE_A", -1, 1);
	func_158(uParam0, iLocal_15, 3, 2090191561, "WORLD_CAMP_JACK_ES_READ_GROUND_MALE_A", -1, 1, -1073741824, 0f, 1);
...
int func_190(var uParam0, int iParam1, bool bParam2)
{
	...
	if (bParam2)
	{
		...
		while (iVar1 < uParam0->f_1984)
		{
			...
			else if (func_291(uParam0, iVar1) || func_199(uParam0, iVar1))
			{
...
void func_201(var uParam0, int iParam1, int iParam2, float fParam3)
{
	if (iParam2 == -1)
	{
		iParam2 = 0;
