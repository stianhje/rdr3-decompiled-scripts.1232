...
{
	func_33(uParam0, 10910/*func_30*/, 10947/*func_31*/, 11891/*func_32*/);
}
...
void func_14(var uParam0, vector3 vParam1, vector3 vParam4)
{
	...
	switch (*uParam0)
	{
		case 174:
			...
			sLocal_38 = "hawk_exit_a";
			sLocal_39 = "snake_exit_a";
			func_46(uParam0, "HAWK_CATCH_SNAKE", "script@ambient@animal@HAWK_CATCH_SNAKE@action", vParam1, vParam4);
			break;
		
		case 175:
			sVar0 = "SQUIRREL";
			iLocal_47 = 1465438313;
			sLocal_37 = "script_amb@animal@HAWK_CATCH_SQUIRREL";
			sLocal_38 = "hawk_exit_a";
			sLocal_39 = "squirrel_exit_a";
			func_46(uParam0, "HAWK_CATCH_SQUIRREL", "script@ambient@animal@HAWK_CATCH_SQUIRREL@action", vParam1, vParam4);
			break;
		...
		case 177:
			...
			func_46(uParam0, "HAWK_VS_SNAKE", "script@ambient@animal@HAWK_VS_SNAKE@action", vParam1, vParam4);
			break;
	}
	func_47(uParam0, 1, "pbl_action", "", 0);
	func_48(uParam0, 0, "HAWK", iLocal_46, 0f, 0f, 0f, 0f, 1, 1, 1, 1, 41788943, 1);
	func_48(uParam0, 1, sVar0, iLocal_47, 0f, 0f, 0f, 0f, 1, 1, 1, 1, 41788943, 1);
}
...
int func_31(var uParam0)
{
	if (!&uParam0->f_469[0])
	{
		...
		if (!bLocal_51 == 1)
		{
			if ((func_60(uParam0, &uLocal_9, 0) || func_61(&(uParam0->f_20[0 /*14*/]), Global_35, 1) < 225f) || func_62(Global_35, uParam0->f_483, 1) < 100f)
			{
				bLocal_51 = true;
			}
		}
		if (bLocal_51)
		{
			if (!ENTITY::HAS_ANIM_EVENT_FIRED(&(uParam0->f_20[0 /*14*/]), 725039534) || ENTITY::IS_ENTITY_DEAD(&(uParam0->f_20[0 /*14*/])))
			{
				...
				if (!&uParam0->f_469[6])
				{
					func_66(*uParam0, uParam0->f_483, 1);
					uParam0->f_469[6] = 1;
				}
				func_67(uParam0);
				func_68(uParam0);
	...
	if (!&uParam0->f_469[0] && !bLocal_51)
	{
		...
		if (&uParam0->f_469[2])
		{
			if (!&uParam0->f_469[6])
			{
				if (func_71(uParam0, 0.75f, 1116471296, 4, -91962372, 1))
				{
					func_66(*uParam0, uParam0->f_483, 1);
					uParam0->f_469[6] = 1;
				}
			...
			if (!&uParam0->f_469[4])
			{
				if (ANIMSCENE::_0x25557E324489393C(uParam0->f_3.f_1))
				{
					if (ANIMSCENE::_0x005E6F28DD7ED58D(uParam0->f_3.f_1, (uParam0->f_20[0 /*14*/])->f_1))
					{
						...
						func_72(uParam0->f_20[1 /*14*/], 1, 1);
						PED::SET_PED_KEEP_TASK(&(uParam0->f_20[1 /*14*/]), true);
						ENTITY::ATTACH_ENTITY_TO_ENTITY(&(uParam0->f_20[1 /*14*/]), &(uParam0->f_20[0 /*14*/]), PED::GET_PED_BONE_INDEX(&(uParam0->f_20[0 /*14*/]), 38142), vLocal_40, vLocal_43, 1, 0, 0, 0, 2, 1, 1, 0);
						TASK::TASK_PLAY_ANIM(&(uParam0->f_20[1 /*14*/]), sLocal_37, sLocal_39, 8f, -1056964608, -1, 1, 0, 0, 0, 0, 0, 0);
						TASK::TASK_PLAY_ANIM(&(uParam0->f_20[0 /*14*/]), sLocal_37, sLocal_38, 8f, -1056964608, -1, 65553, 0, 0, 0, 0, "LegsOnlyBird_filter", 0);
						uParam0->f_469[4] = 1;
						return 1;
					}
				}
...
int func_32(var uParam0, bool bParam1)
{
	...
	if (!bParam1)
	{
		...
		while (iVar2 < uParam0->f_19)
		{
			...
			{
				if ((uParam0->f_469[4] && !&uParam0->f_469[5]) && func_61(&(uParam0->f_20[iVar2 /*14*/]), Global_35, 1) < 22500f)
				{
					return 0;
				}
			}
...
float func_61(int iParam0, int iParam1, bool bParam2)
{
	if (!ENTITY::DOES_ENTITY_EXIST(iParam0))
	{
		return 0f;
	...
	return func_103(ENTITY::GET_ENTITY_COORDS(iParam0, false, false), ENTITY::GET_ENTITY_COORDS(iParam1, false, false));
}
...
void func_66(int iParam0, vector3 vParam1, bool bParam4)
{
	if (func_40() > (Global_32073.f_2697.f_6[iParam0 /*6*/])->f_5)
	{
		(Global_32073.f_2697.f_6[iParam0 /*6*/])->f_5 = func_40();
...
void func_67(var uParam0)
{
	...
	if (!ENTITY::IS_ENTITY_DEAD(&(uParam0->f_20[0 /*14*/])))
	{
		...
		TASK::TASK_FORCE_MOTION_STATE(0, iVar1, false);
...
void func_68(var uParam0)
{
	...
	if (!ENTITY::IS_ENTITY_DEAD(&(uParam0->f_20[1 /*14*/])))
	{
		...
		else
		{
			...
			PED::FORCE_PED_MOTION_STATE(&(uParam0->f_20[1 /*14*/]), iVar0, true, 0, false);
...
int func_70(var uParam0, float fParam1, float fParam2, int iParam3, float fParam4, float fParam5)
{
	...
	if ((MISC::GET_FRAME_COUNT() % 8) == 0)
	{
		...
		fVar7 = func_113(Global_36, uParam0->f_483);
		...
		while (iVar0 < uParam0->f_19)
		{
			...
			if (!ENTITY::IS_ENTITY_DEAD(&(uParam0->f_20[iVar0 /*14*/])))
			{
				...
				fVar8 = func_61(Global_35, &(uParam0->f_20[iVar0 /*14*/]), 1);
				if (fVar8 < fVar1)
				{
					return 1;
				}
		...
		while (iVar0 < uParam0->f_19)
		{
			...
			else
			{
				if (!ENTITY::IS_ENTITY_DEAD(&(uParam0->f_20[iVar0 /*14*/])))
				{
					...
					{
						if ((func_61(Global_35, &(uParam0->f_20[iVar0 /*14*/]), 1) < fParam2 && PED::_0x5102307CE88798EB(&(uParam0->f_20[iVar0 /*14*/]))) && PED::IS_TRACKED_PED_VISIBLE(&(uParam0->f_20[iVar0 /*14*/])))
						{
							if (!func_63(&(uParam0->f_490)))
							{
...
int func_114(var uParam0, float fParam1)
{
...
int func_163(int iParam0, var uParam1)
{
	...
	else if (func_155() - uParam1->f_4) > func_211(uParam1)
	{
...
int func_175(bool bParam0)
{
	...
	if (func_217(bParam0, &uVar0, &uVar1))
	{
		return 1;
	}
	return 0;
...
int func_217(bool bParam0, var uParam1, var uParam2)
{
	int iVar0;
	int iVar1;
