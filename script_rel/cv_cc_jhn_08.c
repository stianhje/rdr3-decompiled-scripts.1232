...
int func_72(var uParam0)
{
	...
	func_151(uParam0, -967333571, 0f, 0f, 0f, "cigarette", 0, 0, 1);
	iLocal_17 = func_151(uParam0, 1600083684, 0.0114404f, 1.02168f, 0.0306778f, 0, 1, 0, 1);
	func_152(uParam0, -2.2725f, -3.645f, 0.85f, -65.75f, 1f, 1f, 3.2075f, -1612834106, -1495061186, 1, 1, 1);
	func_152(uParam0, -0.725f, 0.625f, 0.85f, 0f, 2.25f, 2.4f, 3.2075f, -1612834106, 1267380940, 1, 1, 1);
	func_153(uParam0, -0.793745f, 0.924917f, 1.03457f, 0f, 1.1f, 1.1f, 3.2075f, 665633627, 1);
	func_154(uParam0, "script@vignette@john_8@base", 65, 1, 0, 0);
	func_154(uParam0, "script@vignette@john_8@Action", 64, 0, 1, 0);
	...
	func_156(uParam0, iLocal_15, 3, 1348830223, "PROP_HUMAN_SEAT_CHAIR_READ_NEWSPAPER_MALE_B", iLocal_17, 0);
	func_158(uParam0, iLocal_15, 3, 1348830223, "PROP_HUMAN_SEAT_CHAIR_READ_NEWSPAPER_MALE_B", iLocal_17, 0, -1073741824, 1065353216, 1);
