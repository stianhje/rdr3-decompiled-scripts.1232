...
int func_101(var uParam0)
{
	switch (func_8(uParam0))
	{
		...
		case 622:
			func_209(func_8(uParam0), 1);
			((*Global_1347702)[22 /*49*/])->f_36 = 332378857;
...
int func_119(int iParam0, int iParam1, int iParam2, bool bParam3, bool bParam4)
{
	...
	if (func_132(iVar0, 0))
	{
		...
		{
			if (iParam2 || !(ENTITY::IS_ENTITY_ON_SCREEN(iVar0) && func_243(PLAYER::PLAYER_PED_ID(), iVar0, 1) < 10000f))
			{
...
void func_217(var uParam0, int iParam1, bool bParam2, bool bParam3)
{
	...
	if (bParam3)
	{
		uVar0 = func_369(uParam0, iParam1);
	}
	if (bParam2)
	{
...
void func_233(int iParam0, int iParam1)
{
	...
	if (MAP::DOES_BLIP_EXIST(((*Global_1347702)[iParam0 /*49*/])->f_37))
	{
		...
		func_394(iParam0);
		if ((!func_395(PLAYER::PLAYER_ID(), 1, 0, 1) || Global_43890) || iParam1)
		{
...
int func_309(int iParam0, int iParam1, bool bParam2, int iParam3, int iParam4, bool bParam5, float fParam6)
{
	vector3 vVar0;
	vector3 vVar3;
	var uVar6;
	...
	uVar6 = func_429(vVar0, vVar3.x, iParam1, bParam2, iParam3, iParam4, bParam5, fParam6);
	return uVar6;
}
...
void func_385(var uParam0, bool bParam1)
{
	...
	if (iVar0 == 761950088)
	{
		...
		sVar3 = func_499(&sVar4, 109029619);
		sVar2 = func_500(uParam0->f_3, 0);
		func_494(uParam0, 1896170705, MISC::_CREATE_VAR_STRING(168, iVar0, sVar2, sVar3, sVar1), 0, bParam1, 0);
	}
	else
	{
		func_494(uParam0, 1896170705, HUD::_GET_LABEL_TEXT_BY_HASH(iVar0), 0, bParam1, 0);
	}
}
...
int func_395(int iParam0, bool bParam1, int iParam2, int iParam3)
{
	if (func_505(iParam0, bParam1, iParam2, iParam3))
	{
		return 1;
	}
	if (bParam1)
...
int func_429(vector3 vParam0, float fParam3, var uParam4, bool bParam5, int iParam6, int iParam7, bool bParam8, float fParam9)
{
	int iVar0;
	int iVar1;
	vector3 vVar2;
...
int func_430(int iParam0, bool bParam1, bool bParam2, int iParam3, int iParam4, int iParam5, bool bParam6, bool bParam7, bool bParam8, int iParam9, int iParam10, int iParam11, float fParam12, bool bParam13, bool bParam14, bool bParam15, bool bParam16)
{
	var uVar0;
	int iVar1;
	...
	iVar1 = func_528(&uVar0, iParam0, bParam1, bParam2, iParam3, iParam4, iParam5, bParam7, bParam8, iParam9, iParam10, iParam11, fParam12, bParam13, bParam14, bParam15, bParam6, bParam16);
	if (!ENTITY::DOES_ENTITY_EXIST(iVar1))
	{
		return 0;
	}
...
float func_450(int iParam0, int iParam1, bool bParam2, int iParam3)
{
...
void func_451(int iParam0, int iParam1, var uParam2, vector3 vParam3, char* sParam6, int iParam7, int iParam8, float fParam9, float fParam10, float fParam11, float fParam12, int iParam13, int iParam14, bool bParam15, int iParam16, int iParam17, int iParam18, bool bParam19)
{
	struct<10> Var0;
	struct<10> Var11;
...
int func_462(var uParam0, int iParam1)
{
	...
	while (iVar2 <= iVar1)
	{
		...
		else
		{
			...
			vVar13 = { func_557(ENTITY::GET_ENTITY_COORDS((uParam0->f_107[iParam1 /*113*/])->f_5, true, false), vVar3, 1065353216) };
...
int func_505(int iParam0, bool bParam1, var uParam2, var uParam3)
{
	struct<11> Var0;
	int iVar17;
	struct<11> Var18;
	...
	{
		return func_585(bParam1, uParam2, uParam3);
	}
	if (Global_1572887->f_12 != -1)
	{
...
void func_510(int iParam0, vector3 vParam1, bool bParam4, bool bParam5)
{
	...
	if (func_255() == -1)
	{
		...
		if (func_596(iParam0, iVar1, iVar0))
		{
			func_597(((*Global_1347702)[iParam0 /*49*/])->f_15, bVar2, iVar1, iVar0);
		}
	}
	if (bParam4)
	{
...
int func_528(var uParam0, int iParam1, bool bParam2, bool bParam3, var uParam4, var uParam5, var uParam6, bool bParam7, bool bParam8, var uParam9, var uParam10, var uParam11, float fParam12, bool bParam13, bool bParam14, bool bParam15, bool bParam16, bool bParam17)
{
	int iVar0;
	...
	if ((!ENTITY::DOES_ENTITY_EXIST(iVar0) || !func_132(iVar0, 0)) || (bParam3 && !func_57(iParam1)))
	{
		if (bParam2)
		{
			...
			{
				iVar0 = func_607(iParam1, bParam3, bParam8, uParam9, uParam10, uParam11, fParam12, bParam7, bParam15, bParam16, bParam17);
			}
			else
			{
				*uParam0 = 1;
...
int func_538(int iParam0, bool bParam1, int iParam2, int iParam3, int iParam4, int iParam5, float fParam6, int iParam7, int iParam8, bool bParam9, bool bParam10, bool bParam11, int iParam12, int iParam13, bool bParam14, bool bParam15, bool bParam16, bool bParam17, bool bParam18, bool bParam19, bool bParam20, bool bParam21, bool bParam22, bool bParam23, bool bParam24)
{
	vector3 vVar0;
	bool bVar3;
	int iVar4;
	...
	switch (((*Global_1360165)[iParam0 /*1157*/])->f_11)
	{
		...
		case 1:
			...
			if (func_615(iParam0, vVar0, iParam13, 0, 1, bParam17, bParam20, -1, 1, 0))
			{
				func_614(iParam0, 2);
			}
			break;
		...
		case 3:
			if (!ENTITY::IS_ENTITY_DEAD(Global_1360165[iParam0 /*1157*/]) && !ANIMSCENE::_0x3AB6C7B0BB0DF4B1(Global_1360165[iParam0 /*1157*/], -1))
			{
				...
				func_617(Global_1360165[iParam0 /*1157*/], vVar0, fParam6, 2, 1073741824);
			}
			else if (bParam16)
			{
...
int func_585(bool bParam0, var uParam1, var uParam2)
{
...
void func_597(int iParam0, bool bParam1, int iParam2, int iParam3)
{
	...
	switch (func_651(iParam0))
	{
		case 1:
			...
			if (func_652(iVar0, bParam1, iParam2, iParam3) && Global_1357549->f_1709 > 1)
			{
		...
		case 8:
			...
			if (func_656(iVar1, bParam1, iParam2, iParam3) && Global_1357549->f_1709 > 1)
			{
...
int func_607(int iParam0, bool bParam1, bool bParam2, var uParam3, var uParam4, var uParam5, float fParam6, bool bParam7, bool bParam8, bool bParam9, bool bParam10)
{
	vector3 vVar0;
	int iVar3;
	char* sVar4;
	...
	switch (((*Global_1360165)[iParam0 /*1157*/])->f_70.f_12)
	{
		case 0:
			...
			else
			{
				...
				{
					_NAMESPACE48::_0x187D65F3AEC5D679(func_244(iParam0, 1), &sVar4);
				}
		...
		case 3:
			...
			if ((bParam2 && !func_241(vVar0)) && !func_242(vVar0, ENTITY::GET_ENTITY_COORDS(((*Global_1360165)[iParam0 /*1157*/])->f_124, true, false), 1056964608, 1))
			{
				...
				func_617(((*Global_1360165)[iParam0 /*1157*/])->f_124, vVar0, fParam6, 2, 1073741824);
			}
			if (bParam1)
			{
				if (!ENTITY::_0x88AD6CC10D8D35B2(((*Global_1360165)[iParam0 /*1157*/])->f_124))
...
int func_615(int iParam0, vector3 vParam1, int iParam4, bool bParam5, bool bParam6, bool bParam7, bool bParam8, int iParam9, int iParam10, bool bParam11)
{
	if (!func_115(iParam0))
	{
		return 0;
	...
	switch (((*Global_1360165)[iParam0 /*1157*/])->f_3)
	{
		...
		case 1:
			...
			((*Global_1360165)[iParam0 /*1157*/])->f_4 = { func_673(iParam0, iParam4, vParam1, bParam5, bParam6, bParam8, (Global_40.f_4942[iParam0 /*60*/])->f_59, bParam11) };
			if (!bParam6)
			{
				func_114(iParam0, 44, 1);
			}
...
int func_643(var uParam0, var uParam1, var uParam2, bool bParam3)
{
	*uParam1 = INVENTORY::_0x640F890C3E5A3FFD(func_573(bParam3), uParam0, uParam2);
	if (*uParam1 >= 0)
	{
		return 1;
	}
...
int func_652(int iParam0, bool bParam1, var uParam2, int iParam3)
{
	if (!bParam1 && func_692(iParam0, uParam2, iParam3))
	{
		return 1;
	}
	return 0;
...
int func_656(int iParam0, bool bParam1, int iParam2, int iParam3)
{
	if (!bParam1 && func_596(iParam0, iParam2, iParam3))
	{
		return 1;
	}
	return 0;
...
int func_660(int iParam0, vector3 vParam1, float fParam4, bool bParam5)
{
	...
	if ((!bParam5 && !Global_1359489->f_12) || (bParam5 && Global_1359489->f_13 < 8))
	{
		...
		else
		{
			...
			{
				((*Global_1360165)[iParam0 /*1157*/])->f_124 = func_340(iVar0, vParam1, fParam4, 1, 1, 0, 1, 1, 1, 0, 0, 0, 0);
...
int func_669(int iParam0, int iParam1, bool bParam2, int iParam3)
{
	...
	if (iParam3 && ENTITY::DOES_ENTITY_EXIST(func_180(iParam0)))
	{
		iVar10 = 0;
		while (iVar10 < iVar7)
		{
...
bool func_687(int iParam0, int iParam1, bool bParam2, bool bParam3, int iParam4, bool bParam5, int iParam6, int iParam7, int iParam8, int iParam9, bool bParam10, bool bParam11, bool bParam12, bool bParam13)
{
	bool bVar0;
	int iVar1;
	int iVar2;
...
struct<4> func_690(int iParam0, var uParam1, var uParam2, var uParam3, var uParam4, int iParam5, bool bParam6)
{
	struct<4> Var0;
...
bool func_721(int iParam0, var uParam1, int iParam2, bool bParam3)
{
...
int func_731(int iParam0, bool bParam1)
{
	...
	if (WEAPON::_0xD955FEE4B87AFA07(iParam0))
	{
		if (bParam1)
		{
			return func_741(-1185145312, 0) > 0;
		}
		else
		{
			return 1;
