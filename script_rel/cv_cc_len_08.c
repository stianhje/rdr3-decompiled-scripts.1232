...
int func_72(var uParam0)
{
	...
	func_150(uParam0, -0.75f, -0.1725f, 0f, 0f, 2.38f, 1.3975f, 5f, -1612834106, 2017216891, 1, 1, 1);
	iLocal_14 = func_151(uParam0, 0, "IG_Dutch");
	iLocal_15 = func_151(uParam0, 9, "IG_Lenny");
	iLocal_16 = func_152(uParam0, -946807796, 0f, 0f, 0f, "P_CS_BOOKEVELYNMILLER", 0, 0, 1);
	iLocal_17 = func_152(uParam0, -82199229, 0f, 0f, 0f, "P_MUGCOFFEE01X", 0, 0, 1);
	iLocal_18 = func_152(uParam0, -1006095118, 0f, 0f, 0f, 0, 1, 0, 1);
	func_153(uParam0, iLocal_15, 3, -1489483851, "WORLD_HUMAN_COFFEE_DRINK_MALE_A", -1, 1);
	func_154(uParam0, iLocal_15, 4, -1858511014, "WORLD_HUMAN_GLASS_PUT_DOWN_CRATE_TABLE_MALE_A", -1, 0, -1073741824, 1065353216, 1);
	func_155(uParam0, iLocal_15, 4, 0);
	func_156(uParam0, iLocal_15, iLocal_17, "p_mugCoffee01x_ph_r_hand", 0, 0);
	func_153(uParam0, iLocal_14, 3, -787460071, "SC_PROP_CAMP_DUTCH_SEAT_CHAIR_READING_MALE_A", iLocal_18, 0);
	func_154(uParam0, iLocal_14, 3, -787460071, "SC_PROP_CAMP_DUTCH_SEAT_CHAIR_READING_MALE_A", iLocal_18, 0, -1073741824, 1065353216, 1);
	func_156(uParam0, iLocal_14, iLocal_16, "p_cs_bookEvelynMiller_PH_R_HAND", 0, 0);
	func_157(uParam0, iLocal_14, 4, 1, 0, 0, 0);
	func_158(uParam0, "script@vignette@lenny_8@base", 1, 1, 0, 0);
	func_158(uParam0, "script@vignette@lenny_8@action", 0, 0, 1, 0);
	func_159(uParam0, "CLEN8AU");
	STREAMING::_0x19A6BE7D9C6884D3(-787460071, 1, 0, 0);
	return 1;
}
...
void func_98(vector3 vParam0, int iParam3)
{
	...
	while (iVar0 < &Global_1911670)
	{
		...
		if (VOLUME::_0xF6A8A652A6B186CD(iVar1))
		{
			...
			if (func_205(vVar2, vParam0, 2f, 1))
			{
...
int func_107(int iParam0, int iParam1, int iParam2, bool bParam3, bool bParam4)
{
	...
	if (func_120(iVar0, 0))
	{
		...
		{
			if (iParam2 || !(ENTITY::IS_ENTITY_ON_SCREEN(iVar0) && func_206(PLAYER::PLAYER_PED_ID(), iVar0, 1) < 10000f))
			{
				...
				if (iVar1 != 0)
				{
					...
					func_208(iParam0);
					_NAMESPACE48::_0x7B204F88F6C3D287(func_209(iParam0, 0));
					_NAMESPACE48::_0xFCC6DB8DBE709BC8(func_209(iParam0, 0));
					func_210(iParam0);
				}
			}
			else
			{
				if (func_211(iParam0, 32768, 1))
				{
					iVar2 = func_209(iParam0, 0);
...
void func_126(int iParam0, bool bParam1, bool bParam2, bool bParam3, bool bParam4)
{
	...
	iVar1 = func_224(iParam0);
	if (((ENTITY::DOES_ENTITY_EXIST(iVar1) && func_226(iParam0) < 10000f) && !bParam3) && !CAM::IS_SCREEN_FADED_OUT())
	{
		return;
	}
...
int func_143(var uParam0)
{
	...
	while (iVar0 < uParam0->f_106)
	{
		...
		{
			if (func_239((uParam0->f_107[iVar0 /*113*/])->f_1, 2048))
			{
				return 1;
			}
			if (func_32(uParam0) < 5)
			{
				if (func_122((uParam0->f_107[iVar0 /*113*/])->f_1, 29, 1) || func_240((uParam0->f_107[iVar0 /*113*/])->f_1))
				{
					return 1;
				}
				if (!uParam0->f_3)
...
{
	uParam0->f_23 = { func_246(iParam1) + Vector(iParam4, iParam3, iParam2) };
...
void func_153(var uParam0, int iParam1, int iParam2, int iParam3, char* sParam4, int iParam5, int iParam6)
{
...
void func_155(var uParam0, int iParam1, int iParam2, int iParam3)
{
	...
	{
		case 4:
			(uParam0->f_107[iParam1 /*113*/])->f_32.f_5 = { func_253(func_148(uParam0), func_252(uParam0, iParam1), func_19(uParam0), 1) };
			break;
		
		default:
			Var0 = { func_254(func_148(uParam0), func_252(uParam0, iParam1), func_19(uParam0), 1) };
	...
	while (iVar12 < uParam0->f_106)
	{
		...
		else
		{
			if (!STREAMING::IS_MODEL_VALID((uParam0->f_107[iVar12 /*113*/])->f_3))
			{
				...
				{
					(uParam0->f_107[iVar12 /*113*/])->f_3 = _NAMESPACE48::_0xA00DF706C60173D1(func_207((uParam0->f_107[iVar12 /*113*/])->f_7, 1));
				}
			}
			if (!func_204((uParam0->f_107[iVar12 /*113*/])->f_96))
			{
			}
			else
			{
...
int func_170(var uParam0)
{
	...
	while (iVar0 < uParam0->f_106)
	{
		...
		{
			if (func_204((uParam0->f_107[iVar0 /*113*/])->f_8.f_3))
			{
...
void func_188(var uParam0)
{
	...
	if (!uParam0->f_4)
	{
		...
		while (iVar2 < uParam0->f_106)
		{
			...
			else if (func_204((uParam0->f_107[iVar2 /*113*/])->f_96))
			{
			}
			else
			{
...
int func_189(var uParam0, int iParam1, bool bParam2)
{
	...
	if (bParam2)
	{
		...
		while (iVar1 < uParam0->f_1984)
		{
			...
			else if (func_291(uParam0, iVar1) || func_292(uParam0, iVar1))
			{
				func_293(uParam0, iVar1);
			}
			iVar1++;
		}
	}
...
int func_205(vector3 vParam0, vector3 vParam3, float fParam6, bool bParam7)
{
	if (fParam6 < 0f)
	{
		fParam6 = 0f;
...
bool func_211(int iParam0, int iParam1, bool bParam2)
{
	if (bParam2)
	{
		if (!func_103(iParam0))
...
void func_221(var uParam0, var uParam1, bool bParam2)
{
	if (bParam2)
	{
...
void func_251(var uParam0, int iParam1, float fParam2)
{
	if (fParam2 == -2f)
	{
...
Vector3 func_253(int iParam0, int iParam1, int iParam2, bool bParam3)
{
	switch (iParam0)
	{
		case 0:
...
struct<4> func_254(int iParam0, int iParam1, int iParam2, bool bParam3)
{
	switch (iParam0)
	{
		case 1:
		...
		case 6:
			switch (iParam1)
			{
				...
				case 14:
					...
					{
						case 156:
							return func_324(2329.663f, 1347.464f, 104.5794f, 155.2611f);
				...
				case 1:
					switch (iParam2)
					{
						...
						case 156:
							return func_324(2330.225f, 1345.275f, 104.7174f, 21.2991f);
		...
		case 8:
			switch (iParam1)
			{
				...
				case 4:
					...
					{
						case 669:
							return func_324(-1603.036f, -1408.744f, 80.9423f, 69.6409f);
...
struct<4> func_324(vector3 vParam0, float fParam3)
{
	struct<4> Var0;
...
int func_330(int iParam0, bool bParam1)
{
	...
	{
		func_230(iParam0, _NAMESPACE48::_0x4F76E3676583D951(func_132(iParam0)));
		if (func_218() == -1)
		{
	...
	switch (((*Global_1360165)[iParam0 /*1157*/])->f_70.f_12)
	{
		case 0:
			...
			else
			{
				...
				{
					_NAMESPACE48::_0x187D65F3AEC5D679(func_207(iParam0, 1), &sVar4);
				}
		...
		case 3:
			...
			if ((bParam2 && !func_204(vVar0)) && !func_205(vVar0, ENTITY::GET_ENTITY_COORDS(((*Global_1360165)[iParam0 /*1157*/])->f_124, true, false), 1056964608, 1))
			{
			...
			sVar12 = func_419(iParam0, func_281());
			if (!MISC::IS_STRING_NULL_OR_EMPTY(sVar12))
			{
				_NAMESPACE48::_0x63AA2B8EB087886A(func_207(iParam0, 1), MISC::GET_HASH_KEY(sVar12));
			}
...
void func_395(int iParam0, vector3 vParam1, float fParam4, int iParam5, int iParam6)
{
	...
	if (func_222(iParam5, 4) && ENTITY::IS_ENTITY_A_PED(iParam0))
	{
		iVar1 = ENTITY::GET_PED_INDEX_FROM_ENTITY_INDEX(iParam0);
	...
	if (func_222(iParam5, 2))
	{
		...
		{
			ENTITY::_0x203BEFFDBE12E96A(iParam0, vParam1, fParam4, 1, func_222(iParam5, 32), 1);
		}
		else
		{
			ENTITY::_0x203BEFFDBE12E96A(iParam0, vParam1, fParam4, 1, func_222(iParam5, 32), 1);
	...
	else if (func_222(iParam5, 129))
	{
		...
		ENTITY::SET_ENTITY_COORDS_NO_OFFSET(iParam0, vParam1, func_222(iParam5, 32), true, true);
	...
	if (bVar4)
	{
		...
		if (ENTITY::GET_PED_INDEX_FROM_ENTITY_INDEX(iParam0) == Global_35 && !func_222(iParam5, 64))
		{
			if (!CAM::IS_SCREEN_FADED_OUT())
			{
			}
...
int func_416(int iParam0, vector3 vParam1, float fParam4, bool bParam5)
{
	...
	if ((!bParam5 && !Global_1359489->f_12) || (bParam5 && Global_1359489->f_13 < 8))
	{
		...
		{
			iVar0 = _NAMESPACE48::_0xA00DF706C60173D1(func_207(iParam0, 1));
...
void func_418(int iParam0, int iParam1)
{
	...
	{
		PED::_0x931B241409216C1F(func_224(iParam1), iParam0, 0);
		PED::_0xED1C764997A86D5A(func_224(iParam1), iParam0);
		...
		case 1:
			switch (iParam0)
			{
				...
				case 16:
					...
					else if (func_211(18, 134217728, 1))
					{
						iVar1[0] = 961676983;
					}
					else
					...
					Jump @1186; //curOff = 1020
					iVar1[0] = -268604689;
					iVar1[1] = -1632589543;
					iVar7 = 2;
					Jump @1186; //curOff = 1046
					iVar1[0] = -268604689;
					iVar1[1] = -1632589543;
					iVar7 = 2;
					Jump @1186; //curOff = 1072
					iVar1[0] = -268604689;
					iVar1[1] = -1632589543;
					iVar7 = 2;
					Jump @1186; //curOff = 1098
					iVar1[0] = -268604689;
					iVar1[1] = -1632589543;
					iVar1[2] = -1862464078;
					iVar7 = 3;
					Jump @1186; //curOff = 1134
					iVar1[0] = -268604689;
					iVar1[1] = -1632589543;
					iVar1[2] = -23947011;
					iVar7 = 3;
					Jump @1186; //curOff = 1170
					iVar1[0] = -268604689;
					Jump @3416; //curOff = 1186
					switch (iParam0)
					{
						case 0:
							iVar1[0] = -922193456;
					...
					switch (iParam0)
					{
						...
						case 4:
							if (func_322(747937920, 1) && !func_387(((*Global_1347702)[1 /*49*/])->f_15, 1))
							{
								iVar1[0] = -1155031950;
							}
							else
					...
					if (iParam3 && ENTITY::DOES_ENTITY_EXIST(func_224(iParam0)))
					{
						iVar10 = 0;
						while (iVar10 < iVar7)
						{
