...
int func_47(int iParam0, bool bParam1, bool bParam2, int iParam3, int iParam4, int iParam5, bool bParam6, bool bParam7, bool bParam8, int iParam9, int iParam10, int iParam11, float fParam12, bool bParam13, bool bParam14, bool bParam15, bool bParam16)
{
	var uVar0;
	int iVar1;
...
int func_49(int iParam0, var uParam1, bool bParam2, int iParam3, int iParam4, bool bParam5, bool bParam6, bool bParam7)
{
	...
	while (iVar1 < *iParam0)
	{
		...
		{
			(*uParam1)[iVar1] = func_82(iParam0[iVar1], bParam2, iParam3, 0, 0, 0, 0, iParam4, 1, 0, bParam5, 0, 0, 0, 0, bParam6, 0, 1, 1, 1, 0, 0, 1, bParam7, 1);
		}
		iVar1++;
	}
	iVar1 = 0;
...
int func_54(var uParam0, var uParam1, var uParam2)
{
	int iVar0;
...
int func_81(var uParam0, int iParam1, bool bParam2, bool bParam3, var uParam4, var uParam5, var uParam6, bool bParam7, bool bParam8, var uParam9, var uParam10, var uParam11, float fParam12, bool bParam13, bool bParam14, bool bParam15, bool bParam16, bool bParam17)
{
	...
	if ((!ENTITY::DOES_ENTITY_EXIST(iVar0) || !func_36(iVar0, 0)) || (bParam3 && !func_58(iParam1)))
	{
		if (bParam2)
		{
			...
			{
				iVar0 = func_118(iParam1, bParam3, bParam8, uParam9, uParam10, uParam11, fParam12, bParam7, bParam15, bParam16, bParam17);
			}
			else
			{
				*uParam0 = 1;
...
int func_82(int iParam0, bool bParam1, var uParam2, int iParam3, int iParam4, int iParam5, float fParam6, var uParam7, int iParam8, bool bParam9, bool bParam10, bool bParam11, int iParam12, int iParam13, bool bParam14, bool bParam15, bool bParam16, bool bParam17, bool bParam18, bool bParam19, bool bParam20, bool bParam21, bool bParam22, bool bParam23, bool bParam24)
{
	vector3 vVar0;
	bool bVar3;
	int iVar4;
	...
	switch (((*Global_1360165)[iParam0 /*1157*/])->f_11)
	{
		...
		case 1:
			...
			if (func_123(iParam0, vVar0, iParam13, 0, 1, bParam17, bParam20, -1, 1, 0))
			{
				func_122(iParam0, 2);
			}
			break;
		...
		case 3:
			if (!ENTITY::IS_ENTITY_DEAD(Global_1360165[iParam0 /*1157*/]) && !ANIMSCENE::_0x3AB6C7B0BB0DF4B1(Global_1360165[iParam0 /*1157*/], -1))
			{
				...
				func_89(Global_1360165[iParam0 /*1157*/], vVar0, fParam6, 2, 1073741824);
			}
			else if (bParam16)
			{
...
void func_85(int iParam0, vector3 vParam1, float fParam4, int iParam5)
{
	int iVar0;
	int iVar1;
...
void func_90(int iParam0)
{
	...
	{
		if ((VEHICLE::_0xEA44E97849E9F3DD(iParam0) || func_134(iParam0)) && !ENTITY::IS_ENTITY_DEAD(iParam0))
		{
...
int func_118(int iParam0, bool bParam1, bool bParam2, var uParam3, var uParam4, var uParam5, float fParam6, bool bParam7, bool bParam8, bool bParam9, bool bParam10)
{
	vector3 vVar0;
	int iVar3;
	char* sVar4;
	...
	switch (((*Global_1360165)[iParam0 /*1157*/])->f_70.f_12)
	{
		case 0:
			...
			{
				if (!func_149(iParam0) && func_150(iParam0, &sVar4))
				{
					_NAMESPACE48::_0x187D65F3AEC5D679(func_101(iParam0, 1), &sVar4);
				}
		...
		case 1:
			if (!Global_1359489->f_12)
			{
				...
				if (!func_152(iParam0, vVar0, fParam6, bParam10))
				{
					return func_151();
				}
				if (func_36(((*Global_1360165)[iParam0 /*1157*/])->f_124, 0))
		...
		case 3:
			...
			if ((bParam2 && !func_124(vVar0)) && !func_154(vVar0, ENTITY::GET_ENTITY_COORDS(((*Global_1360165)[iParam0 /*1157*/])->f_124, true, false), 1056964608, 1))
			{
				...
				func_89(((*Global_1360165)[iParam0 /*1157*/])->f_124, vVar0, fParam6, 2, 1073741824);
			}
			if (bParam1)
			{
				if (!ENTITY::_0x88AD6CC10D8D35B2(((*Global_1360165)[iParam0 /*1157*/])->f_124))
...
int func_123(int iParam0, vector3 vParam1, int iParam4, bool bParam5, bool bParam6, bool bParam7, bool bParam8, int iParam9, int iParam10, bool bParam11)
{
	if (!func_53(iParam0))
	{
		return 0;
	...
	switch (((*Global_1360165)[iParam0 /*1157*/])->f_3)
	{
		...
		case 1:
			...
			((*Global_1360165)[iParam0 /*1157*/])->f_4 = { func_164(iParam0, iParam4, vParam1, bParam5, bParam6, bParam8, (Global_40.f_4942[iParam0 /*60*/])->f_59, bParam11) };
			if (!bParam6)
			{
				func_35(iParam0, 44, 1);
			}
...
int func_152(int iParam0, vector3 vParam1, float fParam4, bool bParam5)
{
	int iVar0;
	...
	if ((!bParam5 && !Global_1359489->f_12) || (bParam5 && Global_1359489->f_13 < 8))
	{
		...
		else
		{
			...
			{
				((*Global_1360165)[iParam0 /*1157*/])->f_124 = func_176(iVar0, vParam1, fParam4, 1, 1, 0, 1, 1, 1, 0, 0, 0, 0);
...
int func_159(int iParam0, int iParam1, bool bParam2, int iParam3)
{
	...
	if (iParam3 && ENTITY::DOES_ENTITY_EXIST(func_76(iParam0)))
	{
		iVar10 = 0;
		while (iVar10 < iVar7)
		{
		...
		while (iVar28 < 4)
		{
			...
			if (func_208(iParam0, &Var0, iVar5, 0))
			{
				...
				if (func_212(0))
				{
					...
					func_213(WEAPON::_0x5C2EA6C44F515F34(iParam0), iParam1, iParam6);
...
bool func_208(int iParam0, var uParam1, int iParam2, bool bParam3)
{
	return func_230(iParam0, *uParam1, iParam2, bParam3) > 0;
}
...
struct<4> func_210(int iParam0, var uParam1, var uParam2, var uParam3, var uParam4, int iParam5, bool bParam6)
{
	struct<4> Var0;
...
void func_214(int iParam0, int iParam1)
{
	...
	{
		iVar1 = func_236(WEAPON::_0xD3750CCC00635FC2(iParam0), iParam1);
...
int func_225(int iParam0, bool bParam1)
{
	...
	if (WEAPON::_0xD955FEE4B87AFA07(iParam0))
	{
		if (bParam1)
		{
			return func_239(-1185145312, 0) > 0;
		}
		else
		{
			return 1;
...
int func_229(var uParam0, var uParam1, var uParam2, var uParam3, var uParam4, bool bParam5, bool bParam6)
{
