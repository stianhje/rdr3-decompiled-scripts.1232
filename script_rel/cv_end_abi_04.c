...
int func_72(var uParam0)
{
	...
	func_153(uParam0, 1786194379, 0f, 0f, 0f, "HAYBALE", 0, 0, 1);
	func_154(uParam0, "script@vignette@beecher@abigail_4@base", 1, 1, 0, 0);
	iLocal_15 = func_154(uParam0, "script@vignette@beecher@abigail_4@action_a_left", 2, 0, 0, 1);
	iLocal_16 = func_154(uParam0, "script@vignette@beecher@abigail_4@action_a_right", 2, 0, 0, 1);
