...
int func_72(var uParam0)
{
	...
	func_152(uParam0, 4.8749f, -5.075f, 0.5f, -89.64f, 4f, 3f, 2.7425f, -1612834106, -1, 1, 1, 1);
	func_153(uParam0, joaat("p_haybale03x"), 0f, 0f, 0f, "HAYBALE", 0, 0, 1);
	func_154(uParam0, "script@vignette@beecher@abigail_4@base", 1, 1, 0, 0);
	uLocal_15 = func_154(uParam0, "script@vignette@beecher@abigail_4@action_a_left", 2, 0, 0, 1);
	uLocal_16 = func_154(uParam0, "script@vignette@beecher@abigail_4@action_a_right", 2, 0, 0, 1);
	iLocal_17 = func_154(uParam0, "script@vignette@beecher@abigail_4@action_b_left", 0, 0, 0, 1);
	iLocal_18 = func_154(uParam0, "script@vignette@beecher@abigail_4@action_b_right", 0, 0, 0, 1);
	func_155(uParam0, "BABI4AU");
	func_156(uParam0, 1446456423, 264538597);
	func_157(uParam0, iLocal_14, 1, -1);
	Local_20 = { func_158(uParam0, 4.998f, -6.248f, 1.07f, 78.575f, 7f, 0.3103f, 0.6927f) };
	Local_30 = { func_158(uParam0, 4.9975f, -6.2475f, 1.07f, -36.72f, 7f, 0.2282f, 0.735f) };
	func_159(uParam0, 1);
...
{
	if (func_191(uParam0, Local_20, 1, 0))
	{
		iLocal_19 = uLocal_15;
		return 1;
	}
	else if (func_191(uParam0, Local_30, 1, 0))
	{
		iLocal_19 = uLocal_16;
		return 1;
	}
...
int func_151(var uParam0, int iParam1, char* sParam2, int iParam3)
{
	int iVar0;
