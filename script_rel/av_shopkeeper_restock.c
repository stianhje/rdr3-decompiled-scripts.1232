...
{
	func_33(uParam0, 11022/*func_30*/, 11535/*func_31*/, 11901/*func_32*/);
}
...
void func_14(var uParam0, var uParam1, var uParam2, var uParam3, var uParam4, var uParam5, var uParam6)
{
	iLocal_11 = func_46(3);
	if (iLocal_11 == -1)
	{
	...
	switch (iLocal_10)
	{
		case 3:
			if (bLocal_9)
			{
				...
				{
					iLocal_57 = OBJECT::CREATE_OBJECT(iLocal_49, uParam0->f_483, true, true, false, false, true);
					return 0;
				}
			}
			if (ENTITY::IS_ENTITY_DEAD(iLocal_56))
			{
				iLocal_56 = OBJECT::CREATE_OBJECT(iLocal_49, uParam0->f_483, true, true, false, false, true);
				return 0;
			}
			iLocal_10 = 4;
			break;
		...
		case 4:
			if (ANIMSCENE::_0x477122B8D05E7968(uParam0->f_3.f_1, 1, 0))
			{
				...
				{
					TASK::CLEAR_PED_TASKS_IMMEDIATELY(&(uParam0->f_20[0 /*14*/]), 0, 1);
					ANIMSCENE::SET_ANIM_SCENE_ENTITY(uParam0->f_3.f_1, "MALE_SKELETON", &(uParam0->f_20[0 /*14*/]), 0);
				}
				if (!ENTITY::IS_ENTITY_DEAD(iLocal_56))
				{
					ANIMSCENE::SET_ANIM_SCENE_ENTITY(uParam0->f_3.f_1, "p_can01x", iLocal_56, 0);
				}
				if (!ENTITY::IS_ENTITY_DEAD(iLocal_57))
				{
					ANIMSCENE::SET_ANIM_SCENE_ENTITY(uParam0->f_3.f_1, "p_can03x", iLocal_57, 0);
				}
				func_57(&uLocal_61, 0);
				return 1;
			}
...
int func_30(var uParam0)
{
	...
	iVar0 = func_38(&(uParam0->f_20[0 /*14*/]), vLocal_50, 0.5f);
	if (*uParam0 == 16)
	{
		if (iVar0 == 1 || iVar0 == 0)
		{
	...
	func_62(uParam0, 0, "MALE_SKELETON", iLocal_41, 0f, 0f, 0f, 0f, 1, 1, 1, 1, 41788943, 1);
	func_63(&uLocal_12, 0);
	func_64(&uLocal_12, 1);
	func_65(&uLocal_12, 1);
	func_66(&uLocal_12, 1);
...
int func_31(var uParam0)
{
	...
	if (!&uParam0->f_469[0])
	{
		if (func_70(uParam0, &uLocal_12, 0))
		{
			TASK::TASK_SMART_FLEE_PED(&(uParam0->f_20[0 /*14*/]), Global_35, -1f, -1, 0, 3f, 0);
			func_71(uParam0);
			if (!&uParam0->f_469[3])
			{
				func_72(*uParam0, uParam0->f_483, 0);
				uParam0->f_469[3] = 1;
			}
			return 1;
		}
	...
	if (&uParam0->f_469[1])
	{
		if (!&uParam0->f_469[3])
		{
			if (func_75(uParam0, 1.3f, 20f, 4, -91962372, 0))
			{
				func_72(*uParam0, uParam0->f_483, 0);
				uParam0->f_469[3] = 1;
			}
		...
		if (!ENTITY::IS_ENTITY_DEAD(&(uParam0->f_20[0 /*14*/])))
		{
			if (ANIMSCENE::_0x005E6F28DD7ED58D(uParam0->f_3.f_1, "MALE_SKELETON"))
			{
...
int func_32(var uParam0, var uParam1)
{
	...
	if (ITEMSET::IS_ITEMSET_VALID(iLocal_60))
	{
		ITEMSET::DESTROY_ITEMSET(iLocal_60);
	}
...
int func_47(int iParam0, int iParam1)
{
	...
	if (!func_97(iParam0, 16384))
	{
		...
		{
			if (!func_99((Global_1914319->f_3[iParam0 /*446*/])->f_21, 0))
			{
				return 0;
			}
		}
...
int func_48(var uParam0)
{
	...
	if (ANIMSCENE::_GET_ANIM_SCENE_ENTITY_MATRIX(uParam0->f_3.f_1, "p_can01x", &Var0, false, 0, 2))
	{
		if (!VOLUME::_0x92A78D0BEDB332A3(iLocal_54))
		{
			iLocal_54 = VOLUME::_0xB3FB80A32BAE3065(Var0.f_6, 0f, 0f, 0f, 0.3f, 0.4f, 0.3f);
			iLocal_60 = ITEMSET::CREATE_ITEMSET(false);
			return 0;
		}
		else if (func_100(iLocal_54))
		{
			return 1;
		}
		else
...
int func_49(var uParam0)
{
	...
	iVar0 = ITEMSET::GET_INDEXED_ITEM_IN_ITEMSET(iLocal_59, iLocal_60);
	iVar1 = MISC::_0xEE04C0AFD4EFAF0E(iVar0);
	...
	while (iVar2 < 6)
	{
		if (&iLocal_42[iVar2] == 0)
		{
			iLocal_59++;
			return 0;
		}
		if (iVar3 == &iLocal_42[iVar2])
		{
			iLocal_49 = iVar3;
			return 1;
		}
...
int func_50(int iParam0, bool bParam1, int iParam2)
{
	...
	{
		iVar0 = func_102(&(Global_1898164->f_1[0 /*5*/]));
		if (func_103(iVar0) && func_104(((*Global_1347702)[iVar0 /*49*/])->f_12, 131072))
		{
			return 0;
		}
	}
...
int func_55(int iParam0, vector3 vParam1, float fParam4, bool bParam5, bool bParam6, int iParam7, bool bParam8, bool bParam9, bool bParam10, bool bParam11, bool bParam12, bool bParam13, bool bParam14)
{
	...
	func_106(iVar0, iParam0, iParam7, bParam8, bParam9, bParam10, bParam11, bParam12);
	return iVar0;
}
...
{
	if (iParam1 || !func_107(uParam0))
	{
		func_108(uParam0);
	}
}

int func_58(var uParam0, vector3 vParam1)
{
	int iVar0;
	...
	iVar0 = func_109(vParam1);
	if (iVar0 == -1)
	{
		return 0;
	}
	if (func_110(iVar0, uParam0))
	{
		if (ENTITY::IS_ENTITY_DEAD(*uParam0) || !ENTITY::DOES_ENTITY_EXIST(*uParam0))
		{
			return 0;
		}
		iLocal_40 = func_111(*uParam0, 0);
		if (!func_98(iLocal_40))
		{
			return 0;
		}
		if (func_112(iLocal_40, 0))
		{
			return 0;
		}
		*uParam0 = func_113(iLocal_40, 0, 0, 0, 1, 1);
		if (ENTITY::IS_ENTITY_DEAD(*uParam0) || !ENTITY::DOES_ENTITY_EXIST(*uParam0))
		{
			return 0;
		}
		iLocal_41 = func_114(iLocal_40);
		if (iLocal_41 == 0)
		{
			return 0;
		}
		iLocal_55 = TASK::_0xDF7993356F52359A(*uParam0, 0);
		if (!TASK::_0x841475AC96E794D1(iLocal_55))
		{
			vLocal_50 = { ENTITY::GET_ENTITY_COORDS(*uParam0, true, false) };
		}
		else
		{
			vLocal_50 = { TASK::_0xA8452DD321607029(iLocal_55, 1) };
		}
		return 1;
	}
	return 0;
...
void func_59()
{
	iLocal_42[0] = -1351393313;
	iLocal_42[1] = 1778928480;
	iLocal_42[2] = 2093699425;
	iLocal_42[3] = -1294598741;
	iLocal_42[4] = -1739507263;
	iLocal_42[5] = -982457342;
}

void func_60(var uParam0, char* sParam1, char* sParam2, vector3 vParam3, vector3 vParam6)
{
	uParam0->f_2 = sParam1;
	uParam0->f_3 = sParam2;
...
void func_61(var uParam0, int iParam1, char* sParam2, char* sParam3, int iParam4)
{
...
void func_62(var uParam0, int iParam1, char* sParam2, int iParam3, vector3 vParam4, float fParam7, int iParam8, int iParam9, int iParam10, int iParam11, int iParam12, int iParam13)
{
...
int func_70(var uParam0, var uParam1, int iParam2)
{
	if ((MISC::GET_FRAME_COUNT() % 3) == 0 || iParam2)
	{
		if (func_123(&(uParam0->f_20[uParam0->f_501 /*14*/]), 0, uParam1, &(uParam0->f_468), 0, 0))
		{
			return 1;
		}
		uParam0->f_501++;
...
void func_72(int iParam0, vector3 vParam1, bool bParam4)
{
	if (func_40() > (Global_32073.f_2697.f_6[iParam0 /*6*/])->f_5)
	{
		(Global_32073.f_2697.f_6[iParam0 /*6*/])->f_5 = func_40();
...
int func_74(var uParam0, float fParam1, float fParam2, int iParam3, float fParam4, float fParam5)
{
	int iVar0;
	float fVar1;
	int iVar2;
	...
	if ((MISC::GET_FRAME_COUNT() % 8) == 0)
	{
		...
		fVar7 = func_132(Global_36, uParam0->f_483);
		...
		while (iVar0 < uParam0->f_19)
		{
			...
			if (!ENTITY::IS_ENTITY_DEAD(&(uParam0->f_20[iVar0 /*14*/])))
			{
				...
				fVar8 = func_133(Global_35, &(uParam0->f_20[iVar0 /*14*/]), 1);
				if (fVar8 < fVar1)
				{
					return 1;
				}
				if (fVar8 < (fParam2 * fParam2))
				{
					if (PED::_0x5102307CE88798EB(&(uParam0->f_20[iVar0 /*14*/])) && PED::IS_TRACKED_PED_VISIBLE(&(uParam0->f_20[iVar0 /*14*/])))
					{
						...
						if (func_134(&(uParam0->f_490), fParam1))
						{
...
int func_75(var uParam0, float fParam1, float fParam2, int iParam3, int iParam4, bool bParam5)
{
	int iVar0;
		...
		while (iVar0 < uParam0->f_19)
		{
			...
			else
			{
				if (!ENTITY::IS_ENTITY_DEAD(&(uParam0->f_20[iVar0 /*14*/])))
				{
					...
					{
						if ((func_133(Global_35, &(uParam0->f_20[iVar0 /*14*/]), 1) < fParam2 && PED::_0x5102307CE88798EB(&(uParam0->f_20[iVar0 /*14*/]))) && PED::IS_TRACKED_PED_VISIBLE(&(uParam0->f_20[iVar0 /*14*/])))
						{
							if (!func_107(&(uParam0->f_490)))
							{
								func_57(&(uParam0->f_490), 0);
							}
...
int func_81(vector3 vParam0, float fParam3)
{
	...
	while (iVar0 < 4)
	{
		...
		{
			if (func_147(vParam0, (Global_1415419->f_9721[iVar0 /*8*/])->f_4, fParam3, 0))
			{
				return 1;
			}
		}
...
int func_82(vector3 vParam0)
{
	...
	while (iVar0 < 10)
	{
		...
		{
			if (func_147(vParam0, (Global_32073.f_2697.f_1495[iVar0 /*4*/])->f_1, 1f, 0))
			{
				return 1;
			}
		}
...
int func_96(int iParam0, int iParam1)
{
	...
	if (func_156() == -1)
	{
		...
		iVar0 = (func_157(iParam1) || func_159(func_158(iParam0)));
...
bool func_99(int iParam0, int iParam1)
{
	...
	if (iParam1 && !ENTITY::DOES_ENTITY_EXIST(func_160(iParam0)))
	{
		return false;
	}
...
void func_106(int iParam0, int iParam1, int iParam2, bool bParam3, bool bParam4, bool bParam5, bool bParam6, bool bParam7)
{
	bool bVar0;
...
{
	return func_172(iParam0, Global_1894899->f_2, bParam1);
}
...
int func_113(int iParam0, bool bParam1, bool bParam2, bool bParam3, int iParam4, bool bParam5)
{
	int iVar0;
	int iVar1;
	...
	if ((iParam4 && !func_76(iParam0)) && !ENTITY::IS_ENTITY_DEAD(iVar0))
	{
...
int func_123(int iParam0, int iParam1, var uParam2, var uParam3, int iParam4, float fParam5)
{
	int iVar0;
...
void func_125(int iParam0)
{
	if (func_43(iParam0))
	{
		...
		{
			case 1:
				func_206(0, 1, 0, 0, ((Global_1415419->f_19[iParam0 /*12*/])->f_7 / 4), 0, 0, 1);
				func_206(1, 1, 0, 0, ((Global_1415419->f_19[iParam0 /*12*/])->f_7 / 4), 0, 0, 1);
				break;
			
			case 37:
				func_206(60, 1, 0, 0, ((Global_1415419->f_19[iParam0 /*12*/])->f_7 / 4), 0, 0, 1);
				break;
		}
	}
}

void func_126(int iParam0, vector3 vParam1)
{
	int iVar0;
	int iVar1;
	...
	while (iVar0 < 10)
	{
		...
		{
			if (func_147((Global_32073.f_2697.f_1495[iVar0 /*4*/])->f_1, vParam1, 1056964608, 1))
			{
				return;
			}
		}
...
float func_133(int iParam0, int iParam1, bool bParam2)
{
	...
	return func_207(ENTITY::GET_ENTITY_COORDS(iParam0, false, false), ENTITY::GET_ENTITY_COORDS(iParam1, false, false));
}
...
int func_157(int iParam0)
{
	...
	if ((((((((((iVar0 == 2 && func_213(28)) || (iVar0 == 18 && iParam0 != 55)) || iVar0 == 1) || iVar0 == 11) || iParam0 == 69) || iVar0 == 33) || iVar0 == 20) || iVar0 == 19) || iVar0 == 9) || func_94(iParam0))
	{
		return 1;
	}
	return 0;
...
bool func_170(vector3 vParam0, int iParam3)
{
...
int func_172(int iParam0, int iParam1, bool bParam2)
{
	...
	if (!func_219(iParam1, &uVar0, &iVar1, 0, 0))
	{
		return -1;
	}
	return func_220(iParam0, uVar0, iVar1, bParam2);
}
...
int func_173(int iParam0, bool bParam1)
{
	...
	if ((func_139(iParam0, 1) && !func_76(iParam0)) && func_140(iParam0))
	{
		return 0;
	}
	if (!func_139(iParam0, 2))
	...
	switch (uParam0->f_6)
	{
		case 0:
			if (*uParam0 & 16 != 0)
			{
				...
				else if (!PED::IS_PED_PLANTING_BOMB(Global_35) && (!func_223(1) || *uParam0 & 8192 != 0))
				{
...
int func_177(int iParam0, var uParam1)
{
	...
	switch (iVar0)
	{
		...
		case 1589923363:
			...
			if (!func_226(iParam0, uParam1, iVar2))
			{
				return 0;
			}
			if (func_227(iParam0, iVar2) <= func_228(uParam1))
			{
				return 1;
			}
			break;
...
int func_179(int iParam0, var uParam1)
{
	...
	if (!ENTITY::IS_ENTITY_DEAD(iParam0))
	{
		if (func_232(iParam0, !*uParam1 & 268435456 != 0, !*uParam1 & 536870912 != 0, !*uParam1 & 1073741824 != 0, 0, 0))
		{
			if (uParam1->f_12 < 5f)
			{
				fVar0 = 95f;
			...
			fVar1 = func_233(uParam1);
			if (func_234(uParam1, iParam0, fVar0, fVar1))
			{
				if (uParam1->f_2 == 0)
				{
...
int func_180(int iParam0, int iParam1, var uParam2)
{
	...
	fVar0 = 85f;
	if (func_236(iParam1, !*uParam2 & 268435456 != 0, !*uParam2 & 536870912 != 0, !*uParam2 & 1073741824 != 0, 0))
	{
		if (uParam2->f_12 < 5f)
		{
			fVar0 = 95f;
		...
		fVar1 = func_233(uParam2);
		if (func_234(uParam2, iParam0, fVar0, fVar1))
		{
			if (uParam2->f_2 == 0)
			{
			...
			if (uParam2->f_2 != 0)
			{
				if (MISC::GET_GAME_TIMER() - uParam2->f_2) > func_235(uParam2)
				{
					func_230(uParam2, 1);
					return 1;
				}
...
int func_181(int iParam0, var uParam1)
{
	...
	if (func_226(iParam0, uParam1, iVar1))
	{
		if (uParam1->f_3 == 0)
		{
			uParam1->f_3 = MISC::GET_GAME_TIMER();
		}
		else if (MISC::GET_GAME_TIMER() - uParam1->f_3) > func_235(uParam1)
		{
			fVar3 = func_233(uParam1);
...
int func_182(int iParam0, bool bParam1, int iParam2, bool bParam3)
{
	...
	{
		return func_237(bParam1, iParam2, bParam3);
	}
	if (Global_1572887->f_12 != -1)
	{
...
int func_184(var uParam0, int iParam1, var uParam2)
{
	float fVar0;
	int iVar1;
	float fVar2;
...
int func_185(var uParam0, int iParam1, var uParam2)
{
	var uVar0;
	
	if (uParam2->f_12 < IntToFloat(func_239(uParam2)))
	{
...
int func_186(var uParam0, int iParam1, var uParam2, bool bParam3)
{
	vector3 vVar0;
	int iVar3;
	vector3 vVar4;
		...
		switch (iVar3)
		{
			...
			case 2:
				if (EVENT::IS_SHOCKING_EVENT_IN_SPHERE(-966930978, vVar0, uParam2->f_22))
				{
					...
					if (func_241(iParam1, vVar0, vVar4))
					{
						func_230(uParam2, 1);
						return 1;
					}
		...
		switch (iVar3)
		{
			...
			case 2:
				if (EVENT::IS_SHOCKING_EVENT_IN_SPHERE(-966930978, vVar0, uParam2->f_22))
				{
					...
					if (func_241(iParam1, vVar0, vVar7))
					{
						func_230(uParam2, 1);
						return 1;
					}
...
int func_187(int iParam0, var uParam1)
{
	...
	{
		if (!func_226(iParam0, uParam1, &(Global_1935630->f_34[iVar0])) || iParam0 == &Global_1935630->f_34[iVar0])
		{
		}
		else
		{
			bVar13 = func_242(&(Global_1935630->f_34[iVar0]));
			...
			if (func_243(uParam1, iParam0, fVar1, bVar12, bVar13))
			{
				*(vVar2[0 /*3*/]) = { ENTITY::GET_ENTITY_COORDS(&(Global_1935630->f_34[iVar0]), false, false) };
				*(vVar2[1 /*3*/]) = { vVar9 };
				uParam1->f_10 = iParam0;
			...
			else if (func_244(uParam1, iParam0, fVar1, bVar12, bVar13))
			{
				*(vVar2[0 /*3*/]) = { ENTITY::GET_ENTITY_COORDS(&(Global_1935630->f_34[iVar0]), false, false) };
				*(vVar2[1 /*3*/]) = { vVar9 };
				uParam1->f_10 = iParam0;
			...
			else if (func_245(uParam1, iParam0, fVar1, iVar0))
			{
				*(vVar2[0 /*3*/]) = { ENTITY::GET_ENTITY_COORDS(&(Global_1935630->f_34[iVar0]), false, false) };
				*(vVar2[1 /*3*/]) = { vVar9 };
				uParam1->f_10 = iParam0;
...
int func_193(int iParam0, int iParam1)
{
	if (!ENTITY::IS_ENTITY_DEAD(iParam1))
	{
		...
		if (func_249(iParam0, iParam1, 1, 1) < 4f)
		{
...
int func_195(var uParam0, int iParam1)
{
	...
	if (iVar0 != 0 && !VEHICLE::IS_THIS_MODEL_A_TRAIN(ENTITY::GET_ENTITY_MODEL(iVar0)))
	{
		...
		if (func_250(iVar0, iParam1, vVar1))
		{
...
int func_198(var uParam0, int iParam1)
{
	...
	fVar0 = func_228(uParam0);
	if (uParam0->f_12 > func_252(uParam0) && uParam0->f_12 > fVar0)
	{
		return 0;
	}
	iVar2 = func_253(iParam1);
	iVar1 = func_254(uParam0->f_14);
...
int func_199(int iParam0, int iParam1, var uParam2)
{
	...
	return func_255(iParam0, iParam1, bVar0, bVar2, uParam2->f_12, bVar1);
}
	...
	switch (iVar1)
	{
		...
		case -1601932249:
			...
			if (PED::_0x06087579E7AA85A9(iParam0, iVar4, -1f, -1f, -1f, -1f) && PED::_0x06087579E7AA85A9(iParam0, Global_35, -1f, -1f, -1f, -1f))
			{
				...
				{
					if (!func_257(uParam1, iParam0))
					{
						if (func_251(iVar4, Global_36, 1) < 7f)
						{
							return 1;
						}
					}
...
int func_204(int iParam0, var uParam1)
{
	...
	else if (func_196() - uParam1->f_4) > func_259(uParam1)
	{
		return func_260(iParam0, uParam1, 0, -1082130432);
	}
	return 0;
}
...
int func_219(int iParam0, var uParam1, var uParam2, bool bParam3, bool bParam4)
{
	bool bVar0;
...
int func_220(int iParam0, var uParam1, int iParam2, bool bParam3)
{
	int iVar0;
	int iVar1;
	int iVar2;
	...
	{
		iVar2 = iVar1;
		if (func_143(iVar2) != 0 && _NAMESPACE48::_0x800DF3FC913355F3(func_145(iVar2)))
		{
			if (func_145(iVar2) == iVar0)
			{
				return iVar2;
			}
		}
...
int func_223(bool bParam0)
{
	...
	if (func_266(bParam0, &uVar0, &uVar1))
	{
		return 1;
	}
	return 0;
...
int func_226(int iParam0, var uParam1, int iParam2)
{
	...
	{
		iVar1 = func_254(iParam2);
	}
	else
	{
		iVar1 = func_253(iParam2);
	}
	if (!PED::IS_PED_HUMAN(iParam0))
	{
...
{
	return func_249(iParam0, iParam1, 1, 1);
}
...
int func_232(int iParam0, bool bParam1, bool bParam2, bool bParam3, int iParam4, int iParam5)
{
	int iVar0;
	int iVar1;
	int iVar2;
	...
	if (bParam3)
	{
		if (((WEAPON::_0xCB690F680A3EA971(iVar0, 1) && PLAYER::IS_PLAYER_TARGETTING_ENTITY(iVar1, iParam0, iParam5)) && PLAYER::IS_PLAYER_FREE_AIMING_AT_ENTITY(iVar1, iParam0)) && func_249(iVar0, iParam0, 1, 1) <= 4f)
		{
			return 1;
		}
	}
	...
	{
		if (WEAPON::_0x6AD66548840472E5(func_269(iVar0, 0)))
		{
			if (func_270(iParam0, 0.4f, 0.6f, 0.3f, 0.7f))
			{
				return 1;
			}
		}
...
int func_234(var uParam0, int iParam1, float fParam2, float fParam3)
{
	float fVar0;
...
int func_236(int iParam0, bool bParam1, bool bParam2, bool bParam3, int iParam4)
{
	int iVar0;
	int iVar1;
	...
	if (PLAYER::IS_PLAYER_FREE_AIMING(iVar1))
	{
		if (WEAPON::_0x6AD66548840472E5(func_269(iVar0, 0)))
		{
			if (func_271(ENTITY::GET_ENTITY_COORDS(iParam0, true, false), 0.4f, 0.6f, 0.3f, 0.7f))
			{
				return 1;
			}
		}
...
int func_241(int iParam0, vector3 vParam1, vector3 vParam4)
{
	if (func_272(iParam0, vParam4, 0.5f))
	{
...
int func_244(var uParam0, int iParam1, float fParam2, bool bParam3, bool bParam4)
{
	float fVar0;
...
int func_245(var uParam0, int iParam1, float fParam2, int iParam3)
{
	float fVar0;
...
int func_247(int iParam0, int iParam1)
{
	...
	if (func_275(iParam0, 1, 0, 0) != 2055893578)
	{
		return 0;
	}
...
float func_249(int iParam0, int iParam1, bool bParam2, int iParam3)
{
...
int func_250(int iParam0, int iParam1, vector3 vParam2)
{
	float fVar0;
	
	fVar0 = func_251(iParam0, vParam2, 1);
	if (fVar0 < 4f)
	{
...
float func_251(int iParam0, vector3 vParam1, bool bParam4)
{
	if (!ENTITY::DOES_ENTITY_EXIST(iParam0))
	{
		return 0f;
...
int func_255(int iParam0, int iParam1, bool bParam2, bool bParam3, float fParam4, bool bParam5)
{
	bool bVar0;
	int iVar1;
	float fVar2;
	...
	if (fParam4 <= 0f)
	{
		fVar2 = func_249(iParam0, PLAYER::PLAYER_PED_ID(), 0, 1);
	}
	else
	{
		fVar2 = fParam4;
	...
	if (bVar0)
	{
		if (func_249(iParam0, Global_1935630->f_40, 0, 1) < 2.5f)
		{
...
int func_256(int iParam0, var uParam1, bool bParam2)
{
	...
	if (ENTITY::DOES_ENTITY_EXIST(iVar0))
	{
		if (iVar0 != iParam0)
		{
			if (PED::_0x06087579E7AA85A9(iParam0, Global_35, -1f, -1f, -1f, -1f))
			{
				if (ENTITY::HAS_ENTITY_CLEAR_LOS_TO_ENTITY(iParam0, Global_35, 17))
				{
					if (!bParam2 || !func_257(uParam1, iVar0))
					{
						return 1;
					}
				}
	...
	if (ENTITY::DOES_ENTITY_EXIST(iVar1))
	{
		if (iVar1 != iParam0)
		{
			...
			{
				if (!bParam2 || !func_257(uParam1, iVar1))
				{
					if (func_251(iVar1, Global_36, 1) < 5f)
					{
						return 1;
					}
				}
...
int func_260(int iParam0, var uParam1, bool bParam2, float fParam3)
{
	if (!bParam2)
	{
		if (uParam1->f_4 == 0)
...
int func_266(bool bParam0, var uParam1, var uParam2)
{
	int iVar0;
	int iVar1;
...
int func_270(int iParam0, float fParam1, float fParam2, float fParam3, float fParam4)
{
	if (!ENTITY::IS_ENTITY_DEAD(iParam0))
	{
		if (func_271(ENTITY::GET_ENTITY_COORDS(iParam0, true, false), fParam1, fParam2, fParam3, fParam4))
		{
			return 1;
		}
	}
...
int func_271(vector3 vParam0, float fParam3, float fParam4, float fParam5, float fParam6)
{
	float fVar0;
	float fVar1;
	bool bVar2;
...
bool func_272(int iParam0, vector3 vParam1, float fParam4)
{
	vector3 vVar0;
	vector3 vVar3;
