...
int func_72(var uParam0)
{
	...
	uLocal_17 = func_154(uParam0, "script@vignette@beecher@jack_6@ACTION_B", 2, 0, 0, 0);
	uLocal_18 = func_154(uParam0, "script@vignette@beecher@jack_6@ACTION_B_ALT_FRONT", 2, 0, 0, 0);
	uLocal_19 = func_154(uParam0, "script@vignette@beecher@jack_6@ACTION_B_ALT_LEFT", 2, 0, 0, 0);
	uLocal_20 = func_154(uParam0, "script@vignette@beecher@jack_6@ACTION_B_ALT_RIGHT", 2, 0, 0, 0);
