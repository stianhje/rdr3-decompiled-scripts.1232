...
{
	return func_48(&uLocal_14, 65536, &uLocal_14, func_46(), 0, func_47(), 0, 0, 0);
}
...
int func_48(var uParam0, int iParam1, var uParam2, int iParam3, int iParam4, char* sParam5, int iParam6, int iParam7, bool bParam8)
{
	int iVar0;
	vector3 vVar1;
	...
	if (!VOLUME::_0x92A78D0BEDB332A3(func_80(iParam3)))
	{
		return 0;
	}
	...
	if ((iParam6 && func_84(128, 0, 1)) && !iParam1 == 64)
	{
		return 0;
	}
...
void func_62(int iParam0, int iParam1, int iParam2, bool bParam3, int iParam4, int iParam5)
{
	...
	sVar1 = func_102(iParam0, iParam1, iParam2, iParam4, iParam5, bParam3, &uVar0);
	...
	else
	{
		...
		if (!MISC::_SHOULD_USE_24_HOUR_CLOCK())
		{
			...
			sVar2 = MISC::_CREATE_VAR_STRING(674, sVar8, iVar4, func_114(&sVar6, 109029619), sVar9, func_114(&sVar10, 109029619));
		}
		else
		{
			...
			IntToString(&sVar10, BUILTIN::ROUND(fVar7), 8);
			sVar2 = MISC::_CREATE_VAR_STRING(162, sVar8, iVar4, func_114(&sVar6, 109029619), func_114(&sVar10, 109029619));
		}
...
int func_83(vector3 vParam0, int iParam3, int iParam4, int iParam5)
{
	var uVar0[4];
	int iVar5[4];
...
int func_85(int iParam0, bool bParam1, int iParam2, int iParam3)
{
	...
	{
		return func_141(bParam1, iParam2, iParam3);
	}
	if (Global_1572887->f_12 != -1)
	{
...
char* func_102(int iParam0, int iParam1, int iParam2, int iParam3, var uParam4, var uParam5, var uParam6)
{
	char* sVar0;
...
int func_141(bool bParam0, var uParam1, var uParam2)
{
...
var func_143(int iParam0, int iParam1, int iParam2)
{
...
int func_145(int iParam0, int iParam1, int iParam2, int iParam3, int iParam4)
{
	...
	uVar0 = func_143(iParam0, iParam1, iParam2);
	iVar1 = iParam3;
	func_185(iVar1, 0);
	func_186(iVar1, 0);
	func_187(iVar1, 0);
...
char* func_158(var uParam0, var uParam1, var uParam2, var uParam3, var uParam4, var uParam5, var uParam6, var uParam7)
{
...
int func_201(vector3 vParam0, int iParam3)
{
	...
	func_221(iParam3, &vVar0, &Var3, &fVar6);
	if (func_222(vParam0, vVar0, Var3, Var3.f_1, fVar6))
	{
		return 1;
	}
	return 0;
