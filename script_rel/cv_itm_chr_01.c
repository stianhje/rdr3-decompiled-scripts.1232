...
int func_1(var uParam0)
{
	if (!iLocal_55)
	{
		...
		{
			TASK::_TASK_USE_SCENARIO_POINT((uParam0->f_107[iLocal_14 /*113*/])->f_5, (uParam0->f_107[iLocal_14 /*113*/])->f_8.f_23, (uParam0->f_107[iLocal_14 /*113*/])->f_8.f_2, 0, 0, 1, 0, 0, -1082130432, 0);
...
void func_8(int iParam0, int iParam1, bool bParam2, bool bParam3, float fParam4, bool bParam5, bool bParam6, bool bParam7, bool bParam8, bool bParam9, bool bParam10)
{
	bool bVar0;
	int iVar1;
	bool bVar2;
...
int func_93(var uParam0)
{
	...
	uLocal_19 = func_167(uParam0, joaat("p_chair_crate02x"), -1.863f, -0.829f, 0.479f, 0, 1, 0, 1);
	...
	func_172(uParam0, iLocal_14, 3, 665864199, "PROP_CAMP_CHARLES_SEAT_CHAIR_ARROW_FLETCH_MALE_A", uLocal_19, 0);
	func_173(uParam0, iLocal_14, -1.973365f, -0.825071f, 0.487279f, 103.88f, 1, 1);
	func_174(uParam0, iLocal_14, 3, 665864199, "PROP_CAMP_CHARLES_SEAT_CHAIR_ARROW_FLETCH_MALE_A", uLocal_19, 0, -1073741824, 1065353216, 1);
...
int func_134(int iParam0, int iParam1, int iParam2, bool bParam3, bool bParam4)
{
	...
	if (func_58(iVar0, 0))
	{
		...
		if ((iParam1 || !func_132(iParam0)) || func_75(iParam0))
		{
			if (iParam2 || !(ENTITY::IS_ENTITY_ON_SCREEN(iVar0) && func_236(PLAYER::PLAYER_PED_ID(), iVar0, 1) < 10000f))
			{
				...
				if (iVar1 != 0)
				{
					...
					func_238(iParam0);
					_NAMESPACE48::_0x7B204F88F6C3D287(func_239(iParam0, 0));
					_NAMESPACE48::_0xFCC6DB8DBE709BC8(func_239(iParam0, 0));
					func_240(iParam0);
				}
			}
			else
...
{
	uParam0->f_23 = { func_268(iParam1) + Vector(iParam4, iParam3, iParam2) };
...
void func_172(var uParam0, int iParam1, int iParam2, int iParam3, char* sParam4, var uParam5, int iParam6)
{
...
void func_174(var uParam0, int iParam1, int iParam2, int iParam3, char* sParam4, var uParam5, int iParam6, float fParam7, int iParam8, int iParam9)
{
	...
	while (iVar12 < uParam0->f_106)
	{
		...
		else
		{
			if (!STREAMING::IS_MODEL_VALID((uParam0->f_107[iVar12 /*113*/])->f_3))
			{
				...
				{
					(uParam0->f_107[iVar12 /*113*/])->f_3 = _NAMESPACE48::_0xA00DF706C60173D1(func_233((uParam0->f_107[iVar12 /*113*/])->f_1));
				}
				...
				{
					(uParam0->f_107[iVar12 /*113*/])->f_3 = _NAMESPACE48::_0xA00DF706C60173D1(func_237((uParam0->f_107[iVar12 /*113*/])->f_7, 1));
				}
			}
...
void func_219(var uParam0, int iParam1, bool bParam2, bool bParam3)
{
	...
	if (bParam3)
	{
		uVar0 = func_318(uParam0, iParam1);
	}
	if (bParam2)
	{
...
int func_222(var uParam0)
{
	...
	iLocal_45 = 0;
	PLAYER::_0x3EE1F7A8C32F24E1(PLAYER::PLAYER_ID(), &iLocal_45, 0, 0);
	if (iLocal_45 == 0)
	{
		func_9(&iLocal_44, 1, 1);
		return 0;
...
void func_329(var uParam0, bool bParam1)
{
	...
	if (iVar0 == 761950088)
	{
		...
		sVar3 = func_398(&sVar4, 109029619);
		sVar2 = func_399(uParam0->f_3, 0);
		func_393(uParam0, 1896170705, MISC::_CREATE_VAR_STRING(168, iVar0, sVar2, sVar3, sVar1), 0, bParam1, 0);
	}
	else
	{
		func_393(uParam0, 1896170705, HUD::_GET_LABEL_TEXT_BY_HASH(iVar0), 0, bParam1, 0);
	}
}
...
int func_359(int iParam0, bool bParam1)
{
	...
	{
		func_252(iParam0, _NAMESPACE48::_0x4F76E3676583D951(func_147(iParam0)));
		if (func_249() == -1)
		{
...
int func_360(int iParam0, bool bParam1, bool bParam2, bool bParam3, int iParam4, bool bParam5)
{
	...
	if ((iParam4 && !func_79(iParam0)) && !ENTITY::IS_ENTITY_DEAD(iVar0))
	{
...
int func_377(var uParam0, int iParam1)
{
	...
	while (iVar2 <= iVar1)
	{
		...
		else
		{
			...
			vVar13 = { func_433(ENTITY::GET_ENTITY_COORDS((uParam0->f_107[iParam1 /*113*/])->f_5, true, false), vVar3, 1065353216) };
...
void func_393(var uParam0, int iParam1, char* sParam2, int iParam3, bool bParam4, int iParam5)
{
	int iVar0;
	...
	if (UILOG::_UILOG_IS_ENTRY_REGISTERED(9, iVar0))
	{
		UILOG::_UILOG_ADD_OR_UPDATE_OBJECTIVE(9, func_387(*uParam0), iParam1, sParam2, iParam3, iParam5, 0);
		if (bParam4)
		{
			UILOG::_UILOG_SET_PENDING_DETAILS_ID(1, iVar0);
			Global_1359489->f_361.f_194 = func_444("CAMP_REQUEST", "CAMP_REQUEST_DETAIL", 1997120069, MISC::GET_HASH_KEY(func_389(uParam0->f_3)), 1433015236, "INPUT_FEED_INTERACT_GENERIC", -1507719118, 5000, 0, 0, 0, 0, 1, 1);
		}
	}
}
...
int func_410(var uParam0, int iParam1, bool bParam2, bool bParam3, var uParam4, var uParam5, var uParam6, bool bParam7, bool bParam8, var uParam9, var uParam10, var uParam11, float fParam12, bool bParam13, bool bParam14, bool bParam15, bool bParam16, bool bParam17)
{
	...
	if ((!ENTITY::DOES_ENTITY_EXIST(iVar0) || !func_58(iVar0, 0)) || (bParam3 && !func_75(iParam1)))
	{
		if (bParam2)
		{
			...
			{
				iVar0 = func_456(iParam1, bParam3, bParam8, uParam9, uParam10, uParam11, fParam12, bParam7, bParam15, bParam16, bParam17);
			}
			else
			{
				*uParam0 = 1;
...
int func_420(int iParam0, bool bParam1, int iParam2, int iParam3, int iParam4, int iParam5, float fParam6, int iParam7, int iParam8, bool bParam9, bool bParam10, bool bParam11, int iParam12, int iParam13, bool bParam14, bool bParam15, bool bParam16, bool bParam17, bool bParam18, bool bParam19, bool bParam20, bool bParam21, bool bParam22, bool bParam23, bool bParam24)
{
	...
	switch (((*Global_1360165)[iParam0 /*1157*/])->f_11)
	{
		...
		case 1:
			...
			if (func_464(iParam0, vVar0, iParam13, 0, 1, bParam17, bParam20, -1, 1, 0))
			{
				func_463(iParam0, 2);
			}
			break;
...
int func_456(int iParam0, bool bParam1, bool bParam2, var uParam3, var uParam4, var uParam5, float fParam6, bool bParam7, bool bParam8, bool bParam9, bool bParam10)
{
	vector3 vVar0;
	int iVar3;
	char* sVar4;
	...
	switch (((*Global_1360165)[iParam0 /*1157*/])->f_70.f_12)
	{
		case 0:
			...
			else
			{
				...
				{
					_NAMESPACE48::_0x187D65F3AEC5D679(func_237(iParam0, 1), &sVar4);
				}
		...
		case 3:
			...
			{
				_NAMESPACE48::_0x63AA2B8EB087886A(func_237(iParam0, 1), MISC::GET_HASH_KEY(sVar12));
			}
...
int func_464(int iParam0, vector3 vParam1, int iParam4, bool bParam5, bool bParam6, bool bParam7, bool bParam8, int iParam9, int iParam10, bool bParam11)
{
	if (!func_120(iParam0))
	{
		return 0;
...
bool func_472(int iParam0, int iParam1)
{
	...
	if (iParam1 && !ENTITY::DOES_ENTITY_EXIST(func_250(iParam0)))
	{
		return false;
	}
...
int func_484(var uParam0, var uParam1, var uParam2, bool bParam3)
{
...
int func_491(int iParam0, vector3 vParam1, float fParam4, bool bParam5)
{
	...
	if ((!bParam5 && !Global_1359489->f_12) || (bParam5 && Global_1359489->f_13 < 8))
	{
		...
		{
			iVar0 = _NAMESPACE48::_0xA00DF706C60173D1(func_237(iParam0, 1));
			STREAMING::REQUEST_MODEL(iVar0, false);
			if (STREAMING::HAS_MODEL_LOADED(iVar0))
			{
				((*Global_1360165)[iParam0 /*1157*/])->f_124 = func_297(iVar0, vParam1, fParam4, 1, 1, 0, 1, 1, 1, 0, 0, 0, 0);
...
void func_493(int iParam0, int iParam1)
{
	...
	{
		PED::_0x931B241409216C1F(func_128(iParam1), iParam0, 0);
...
int func_500(int iParam0, int iParam1, bool bParam2, int iParam3)
{
	...
	if (iParam3 && ENTITY::DOES_ENTITY_EXIST(func_128(iParam0)))
	{
		iVar10 = 0;
		while (iVar10 < iVar7)
		{
