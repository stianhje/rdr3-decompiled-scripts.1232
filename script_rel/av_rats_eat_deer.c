...
{
	func_33(uParam0, 11265/*func_30*/, 11322/*func_31*/, 12158/*func_32*/);
}
...
{
	func_46(uParam0, "RATS_EAT_DEER", "", vParam1, vParam4);
	iLocal_9 = joaat("a_m_m_unicorpse_01");
	sLocal_13 = "AI_DAMAGE@DEAD@BASE";
	sLocal_14 = "Dead_D";
	func_47(uParam0, 0, "RE1_DEER", iLocal_9, OBJECT::_GET_OBJECT_OFFSET_FROM_COORDS(vParam1, vParam4.z, 0f, 0f, 0f), (0f + vParam4.z), 1, 1, 1, 1, 41788943, 1);
	func_47(uParam0, 1, "RE1_RAT_1", iLocal_10, OBJECT::_GET_OBJECT_OFFSET_FROM_COORDS(vParam1, vParam4.z, 0.329f, -0.23f, 0f), (15f + vParam4.z), 1, 1, 1, 1, 41788943, 1);
	func_47(uParam0, 2, "RE1_RAT_2", iLocal_10, OBJECT::_GET_OBJECT_OFFSET_FROM_COORDS(vParam1, vParam4.z, 0.51f, 0.309f, 0f), (87f + vParam4.z), 1, 1, 1, 1, 41788943, 1);
	func_47(uParam0, 3, "RE1_RAT_3", iLocal_10, OBJECT::_GET_OBJECT_OFFSET_FROM_COORDS(vParam1, vParam4.z, 0.51f, 0.04f, 0f), (98f + vParam4.z), 1, 1, 1, 1, 41788943, 1);
	func_47(uParam0, 4, "RE1_RAT_4", iLocal_10, OBJECT::_GET_OBJECT_OFFSET_FROM_COORDS(vParam1, vParam4.z, 0.15f, 0.745f, 0f), (115f + vParam4.z), 1, 1, 1, 1, 41788943, 1);
	func_47(uParam0, 5, "RE1_RAT_5", iLocal_10, OBJECT::_GET_OBJECT_OFFSET_FROM_COORDS(vParam1, vParam4.z, -0.265f, 0.84f, 0f), (230f + vParam4.z), 1, 1, 1, 1, 41788943, 1);
	func_47(uParam0, 6, "RE1_RAT_6", iLocal_10, OBJECT::_GET_OBJECT_OFFSET_FROM_COORDS(vParam1, vParam4.z, -0.342f, 0.128f, 0f), (-90f + vParam4.z), 1, 1, 1, 1, 41788943, 1);
	func_47(uParam0, 7, "RE1_RAT_7", iLocal_10, OBJECT::_GET_OBJECT_OFFSET_FROM_COORDS(vParam1, vParam4.z, -0.63f, 0.77f, 0f), (-90f + vParam4.z), 1, 1, 1, 1, 41788943, 1);
	func_47(uParam0, 8, "RE1_VULTURE_1", iLocal_11, OBJECT::_GET_OBJECT_OFFSET_FROM_COORDS(vParam1, vParam4.z, 2f, 0f, 25f), (0f + vParam4.z), 1, 1, 1, 1, 41788943, 1);
	func_47(uParam0, 9, "RE1_VULTURE_2", iLocal_11, OBJECT::_GET_OBJECT_OFFSET_FROM_COORDS(vParam1, vParam4.z, -2f, 0f, 23f), (0f + vParam4.z), 1, 1, 1, 1, 41788943, 1);
}
			...
			if (!ENTITY::IS_ENTITY_DEAD(&(uParam0->f_20[0 /*14*/])))
			{
				...
				while (iVar0 <= 7)
				{
					if (!ENTITY::IS_ENTITY_DEAD(&(uParam0->f_20[iVar0 /*14*/])))
					{
						...
						func_62(&((uParam0->f_20[iVar0 /*14*/])->f_5), 50, 10, 0);
						TASK::TASK_START_SCENARIO_AT_POSITION(&(uParam0->f_20[iVar0 /*14*/]), -1756372705, (uParam0->f_20[iVar0 /*14*/])->f_5, (uParam0->f_20[iVar0 /*14*/])->f_8, 0, 0, 1, 0, -1082130432, 0);
						func_63(uParam0->f_20[iVar0 /*14*/], 1, 1);
					}
					iVar0++;
				}
			...
			if (ENTITY::DOES_ENTITY_EXIST(&(uParam0->f_20[0 /*14*/])) && ENTITY::IS_ENTITY_DEAD(&(uParam0->f_20[0 /*14*/])))
			{
				...
				else
				{
					...
					while (iVar0 < 10)
					{
						if (!ENTITY::IS_ENTITY_DEAD(&(uParam0->f_20[iVar0 /*14*/])))
						{
							if (func_65(&(uParam0->f_20[iVar0 /*14*/]), 0, &uLocal_21, &uVar2, 0, 0))
							{
								bVar1 = true;
							}
							else
							...
							if (ENTITY::DOES_ENTITY_EXIST(&(uParam0->f_20[iLocal_49 /*14*/])))
							{
								...
								{
									func_63(uParam0->f_20[iLocal_49 /*14*/], 0, 1);
									...
									TASK::_TASK_SMART_FLEE_STYLE_PED(&(uParam0->f_20[iLocal_49 /*14*/]), Global_35, 3, 0, -1082130432, -1, 0);
...
int func_64(var uParam0, float fParam1, float fParam2, int iParam3, float fParam4, float fParam5)
{
	int iVar0;
	float fVar1;
	int iVar2;
			...
			if (!ENTITY::IS_ENTITY_DEAD(&(uParam0->f_20[iVar0 /*14*/])))
			{
				...
				if (fVar8 < (fParam2 * fParam2))
				{
					if (PED::_0x5102307CE88798EB(&(uParam0->f_20[iVar0 /*14*/])) && PED::IS_TRACKED_PED_VISIBLE(&(uParam0->f_20[iVar0 /*14*/])))
					{
						...
						if (func_106(&(uParam0->f_490), fParam1))
						{
...
int func_65(int iParam0, int iParam1, var uParam2, var uParam3, int iParam4, float fParam5)
{
	int iVar0;
...
int func_73(vector3 vParam0, float fParam3)
{
	...
	while (iVar0 < 4)
	{
		...
		{
			if (func_141(vParam0, (Global_1415419->f_9721[iVar0 /*8*/])->f_4, fParam3, 0))
			{
				return 1;
			}
		}
...
int func_74(vector3 vParam0)
{
	...
	while (iVar0 < 10)
	{
		...
		{
			if (func_141(vParam0, (Global_32073.f_2697.f_1495[iVar0 /*4*/])->f_1, 1f, 0))
			{
				return 1;
			}
		}
...
float func_83(int iParam0, vector3 vParam1, bool bParam4)
{
	vector3 vVar0;
	...
	return func_149(vVar0, vParam1);
}

void func_84(int iParam0, vector3 vParam1)
{
	int iVar0;
	int iVar1;
	...
	while (iVar0 < 10)
	{
		...
		{
			if (func_141((Global_32073.f_2697.f_1495[iVar0 /*4*/])->f_1, vParam1, 1056964608, 1))
			{
				return;
			}
		}
...
bool func_99(vector3 vParam0, vector3 vParam3)
{
...
float func_104(int iParam0, int iParam1, bool bParam2)
{
	...
	return func_149(ENTITY::GET_ENTITY_COORDS(iParam0, false, false), ENTITY::GET_ENTITY_COORDS(iParam1, false, false));
}
...
int func_106(var uParam0, float fParam1)
{
	...
	switch (uParam0->f_6)
	{
		case 0:
			if (*uParam0 & 16 != 0)
			{
				...
				else if (!PED::IS_PED_PLANTING_BOMB(Global_35) && (!func_160(1) || *uParam0 & 8192 != 0))
				{
...
int func_109(int iParam0, var uParam1)
{
	...
	switch (iVar0)
	{
		...
		case 1589923363:
			...
			if (!func_163(iParam0, uParam1, iVar2))
			{
				return 0;
			}
			if (func_164(iParam0, iVar2) <= func_165(uParam1))
			{
				return 1;
			}
			break;
...
int func_111(int iParam0, var uParam1)
{
	...
	if (!ENTITY::IS_ENTITY_DEAD(iParam0))
	{
		if (func_169(iParam0, !*uParam1 & 268435456 != 0, !*uParam1 & 536870912 != 0, !*uParam1 & 1073741824 != 0, 0, 0))
		{
			if (uParam1->f_12 < 5f)
			{
				fVar0 = 95f;
			...
			fVar1 = func_170(uParam1);
			if (func_171(uParam1, iParam0, fVar0, fVar1))
			{
				if (uParam1->f_2 == 0)
				{
...
int func_112(int iParam0, int iParam1, var uParam2)
{
	...
	fVar0 = 85f;
	if (func_173(iParam1, !*uParam2 & 268435456 != 0, !*uParam2 & 536870912 != 0, !*uParam2 & 1073741824 != 0, 0))
	{
		if (uParam2->f_12 < 5f)
		{
			fVar0 = 95f;
		...
		fVar1 = func_170(uParam2);
		if (func_171(uParam2, iParam0, fVar0, fVar1))
		{
			if (uParam2->f_2 == 0)
			{
			...
			if (uParam2->f_2 != 0)
			{
				if (MISC::GET_GAME_TIMER() - uParam2->f_2) > func_172(uParam2)
				{
					func_167(uParam2, 1);
					return 1;
				}
...
int func_113(int iParam0, var uParam1)
{
	...
	if (func_163(iParam0, uParam1, iVar1))
	{
		if (uParam1->f_3 == 0)
		{
			uParam1->f_3 = MISC::GET_GAME_TIMER();
		}
		else if (MISC::GET_GAME_TIMER() - uParam1->f_3) > func_172(uParam1)
		{
			fVar3 = func_170(uParam1);
...
int func_114(int iParam0, bool bParam1, int iParam2, bool bParam3)
{
	struct<11> Var0;
	int iVar17;
	struct<11> Var18;
	...
	{
		return func_174(bParam1, iParam2, bParam3);
	}
	if (Global_1572887->f_12 != -1)
	{
...
int func_117(var uParam0, int iParam1, var uParam2)
{
	...
	if (uParam2->f_12 < IntToFloat(func_176(uParam2)))
	{
		...
		switch (iVar3)
		{
			...
			case 2:
				if (EVENT::IS_SHOCKING_EVENT_IN_SPHERE(-966930978, vVar0, uParam2->f_22))
				{
					...
					if (func_178(iParam1, vVar0, vVar4))
					{
						func_167(uParam2, 1);
						return 1;
					}
		...
		switch (iVar3)
		{
			...
			case 2:
				if (EVENT::IS_SHOCKING_EVENT_IN_SPHERE(-966930978, vVar0, uParam2->f_22))
				{
					...
					if (func_178(iParam1, vVar0, vVar7))
					{
						func_167(uParam2, 1);
						return 1;
					}
...
int func_119(int iParam0, var uParam1)
{
	...
	{
		if (!func_163(iParam0, uParam1, &(Global_1935630->f_34[iVar0])) || iParam0 == &Global_1935630->f_34[iVar0])
		{
		}
		else
		{
			bVar13 = func_179(&(Global_1935630->f_34[iVar0]));
			...
			if (func_180(uParam1, iParam0, fVar1, bVar12, bVar13))
			{
				*(vVar2[0 /*3*/]) = { ENTITY::GET_ENTITY_COORDS(&(Global_1935630->f_34[iVar0]), false, false) };
				*(vVar2[1 /*3*/]) = { vVar9 };
				uParam1->f_10 = iParam0;
			...
			else if (func_181(uParam1, iParam0, fVar1, bVar12, bVar13))
			{
				*(vVar2[0 /*3*/]) = { ENTITY::GET_ENTITY_COORDS(&(Global_1935630->f_34[iVar0]), false, false) };
				*(vVar2[1 /*3*/]) = { vVar9 };
				uParam1->f_10 = iParam0;
			...
			else if (func_182(uParam1, iParam0, fVar1, iVar0))
			{
				*(vVar2[0 /*3*/]) = { ENTITY::GET_ENTITY_COORDS(&(Global_1935630->f_34[iVar0]), false, false) };
				*(vVar2[1 /*3*/]) = { vVar9 };
				uParam1->f_10 = iParam0;
...
int func_127(var uParam0, int iParam1)
{
	...
	if (iVar0 != 0 && !VEHICLE::IS_THIS_MODEL_A_TRAIN(ENTITY::GET_ENTITY_MODEL(iVar0)))
	{
		...
		if (func_187(iVar0, iParam1, vVar1))
		{
...
int func_130(var uParam0, int iParam1)
{
	...
	fVar0 = func_165(uParam0);
	if (uParam0->f_12 > func_189(uParam0) && uParam0->f_12 > fVar0)
	{
		return 0;
	}
	iVar2 = func_190(iParam1);
	iVar1 = func_191(uParam0->f_14);
...
int func_131(int iParam0, int iParam1, var uParam2)
{
	...
	return func_192(iParam0, iParam1, bVar0, bVar2, uParam2->f_12, bVar1);
}
...
int func_136(int iParam0, var uParam1)
{
	...
	else if (func_128() - uParam1->f_4) > func_196(uParam1)
	{
		return func_197(iParam0, uParam1, 0, -1082130432);
	}
	return 0;
}
...
void func_138(int iParam0)
{
	if (func_43(iParam0))
	{
		...
		{
			case 1:
				func_198(0, 1, 0, 0, ((Global_1415419->f_19[iParam0 /*12*/])->f_7 / 4), 0, 0, 1);
				func_198(1, 1, 0, 0, ((Global_1415419->f_19[iParam0 /*12*/])->f_7 / 4), 0, 0, 1);
				break;
			case 37:
				func_198(60, 1, 0, 0, ((Global_1415419->f_19[iParam0 /*12*/])->f_7 / 4), 0, 0, 1);
				break;
		}
	}
}
...
int func_160(bool bParam0)
{
	...
	if (func_209(bParam0, &uVar0, &uVar1))
	{
		return 1;
	}
	return 0;
...
int func_163(int iParam0, var uParam1, int iParam2)
{
	...
	{
		iVar1 = func_191(iParam2);
	}
	else
	{
		iVar1 = func_190(iParam2);
	}
	if (!PED::IS_PED_HUMAN(iParam0))
	{
...
int func_166(int iParam0, int iParam1, int iParam2, int iParam3, int iParam4)
{
	switch (iParam0)
	{
		case 8:
...
int func_169(int iParam0, bool bParam1, bool bParam2, bool bParam3, int iParam4, int iParam5)
{
	int iVar0;
	int iVar1;
	int iVar2;
	...
	{
		if (WEAPON::_0x6AD66548840472E5(func_213(iVar0, 0)))
		{
			if (func_214(iParam0, 0.4f, 0.6f, 0.3f, 0.7f))
			{
				return 1;
			}
		}
...
int func_171(var uParam0, int iParam1, float fParam2, float fParam3)
{
	float fVar0;
...
int func_173(int iParam0, bool bParam1, bool bParam2, bool bParam3, int iParam4)
{
	int iVar0;
	int iVar1;
	...
	if (PLAYER::IS_PLAYER_FREE_AIMING(iVar1))
	{
		if (WEAPON::_0x6AD66548840472E5(func_213(iVar0, 0)))
		{
			if (func_215(ENTITY::GET_ENTITY_COORDS(iParam0, true, false), 0.4f, 0.6f, 0.3f, 0.7f))
			{
				return 1;
			}
		}
...
int func_178(int iParam0, vector3 vParam1, vector3 vParam4)
{
	if (func_216(iParam0, vParam4, 0.5f))
	{
...
int func_180(var uParam0, int iParam1, float fParam2, bool bParam3, bool bParam4)
{
	float fVar0;
...
int func_181(var uParam0, int iParam1, float fParam2, bool bParam3, bool bParam4)
{
	float fVar0;
...
int func_182(var uParam0, int iParam1, float fParam2, int iParam3)
{
	float fVar0;
...
int func_184(int iParam0, int iParam1)
{
	...
	if (func_219(iParam0, 1, 0, 0) != joaat("weapon_lasso"))
	{
		return 0;
	}
...
int func_187(int iParam0, int iParam1, vector3 vParam2)
{
	float fVar0;
...
int func_192(int iParam0, int iParam1, bool bParam2, bool bParam3, float fParam4, bool bParam5)
{
	bool bVar0;
	int iVar1;
	float fVar2;
...
int func_193(int iParam0, var uParam1, bool bParam2)
{
	int iVar0;
	int iVar1;

	func_209(1, &iVar0, &iVar1);
	...
	if (ENTITY::DOES_ENTITY_EXIST(iVar0))
	{
		if (iVar0 != iParam0)
		{
			if (PED::_0x06087579E7AA85A9(iParam0, Global_35, -1f, -1f, -1f, -1f))
			{
				if (ENTITY::HAS_ENTITY_CLEAR_LOS_TO_ENTITY(iParam0, Global_35, 17))
				{
					if (!bParam2 || !func_194(uParam1, iVar0))
					{
						return 1;
					}
				}
	...
	if (ENTITY::DOES_ENTITY_EXIST(iVar1))
	{
		if (iVar1 != iParam0)
		{
			...
			{
				if (!bParam2 || !func_194(uParam1, iVar1))
				{
...
int func_195(int iParam0)
{
	...
	return func_221(((*Global_1347702)[58 /*49*/])->f_15, 1);
}
...
int func_197(int iParam0, var uParam1, bool bParam2, float fParam3)
{
	if (!bParam2)
	{
		if (uParam1->f_4 == 0)
...
void func_198(int iParam0, int iParam1, int iParam2, int iParam3, int iParam4, int iParam5, bool bParam6, int iParam7)
{
	int iVar0;
...
int func_209(bool bParam0, var uParam1, var uParam2)
{
	int iVar0;
	int iVar1;
...
int func_214(int iParam0, float fParam1, float fParam2, float fParam3, float fParam4)
{
	if (!ENTITY::IS_ENTITY_DEAD(iParam0))
	{
		if (func_215(ENTITY::GET_ENTITY_COORDS(iParam0, true, false), fParam1, fParam2, fParam3, fParam4))
		{
			return 1;
		}
	}
...
int func_215(vector3 vParam0, float fParam3, float fParam4, float fParam5, float fParam6)
{
	float fVar0;
	float fVar1;
	bool bVar2;
...
bool func_216(int iParam0, vector3 vParam1, float fParam4)
{
	vector3 vVar0;
	vector3 vVar3;
