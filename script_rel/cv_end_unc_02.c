...
int func_72(var uParam0)
{
	...
	func_152(uParam0, 0f, 1.65f, 0f, 0f, 1.5f, 1.5f, 3f, 665633627, 1);
	func_153(uParam0, joaat("p_stool02x"), 0f, 0f, 0f, "STOOL", 0, 0, 1);
	func_153(uParam0, joaat("p_cs_bucket01x"), 0f, 0f, 0f, "BUCKET", 0, 0, 1);
	func_154(uParam0, "script@vignette@beecher@uncle_2@base", 1, 1, 0, 0);
	iLocal_16 = func_154(uParam0, "script@vignette@beecher@uncle_2@action_a", 2, 0, 1, 1);
	iLocal_17 = func_154(uParam0, "script@vignette@beecher@uncle_2@action_b", 2, 0, 0, 1);
	iLocal_18 = func_154(uParam0, "script@vignette@beecher@uncle_2@action_c", 2, 0, 0, 1);
	iLocal_21 = func_154(uParam0, "script@vignette@beecher@uncle_2@exit_to_base", 2, 0, 0, 0);
	iLocal_20 = func_154(uParam0, "script@vignette@beecher@uncle_2@idle_a", 1, 0, 0, 0);
	iLocal_19 = func_154(uParam0, "script@vignette@beecher@uncle_2@exit", 0, 0, 0, 0);
	func_155(uParam0, "BUNC2AU");
	Local_24 = { func_156(uParam0, 0.8885f, 2.365f, 0.938f, 32.76f, 7f, 0.7f, 0.5648f) };
	func_157(uParam0, 1);
	func_158(uParam0, iLocal_14, 1094713344, 1092616192);
	func_159(uParam0, iLocal_14, 2, -1);
	func_160(uParam0, iLocal_15, 2, -830507952, 0, -1, 0, -1f, 1065353216, 1);
	return 1;
}
...
int func_86(var uParam0)
{
	...
	iVar0 = func_48(uParam0, iLocal_15);
	if (!ENTITY::IS_ENTITY_DEAD(iVar0))
	{
		PED::SET_BLOCKING_OF_NON_TEMPORARY_EVENTS(iVar0, true);
		PED::SET_PED_CONFIG_FLAG(iVar0, 288, true);
		PED::SET_PED_KEEP_TASK(iVar0, true);
	}
	return 1;
}
...
bool func_87(var uParam0)
{
	...
	if (!iLocal_22)
	{
		iVar0 = func_48(uParam0, iLocal_14);
	...
	return func_191(uParam0, Local_24, 1, 0);
}
...
int func_93(var uParam0)
{
	...
	{
		if (func_191(uParam0, Local_24, 1, 0))
		{
	...
	if (ANIMSCENE::_0x005E6F28DD7ED58D(&(uParam0->f_1984[iLocal_20]), "COW"))
	{
...
{
	if (func_208(Global_35, uParam0->f_23, 1) > (50f * 50f) && !CAM::IS_SPHERE_VISIBLE(uParam0->f_23, 1f))
	{
...
int func_190(var uParam0, int iParam1, bool bParam2)
{
	...
	if (bParam2)
	{
		...
		while (iVar1 < uParam0->f_1984)
		{
			...
			else if (func_200(uParam0, iVar1) || func_199(uParam0, iVar1))
			{
...
int func_191(var uParam0, struct<4> Param1, var uParam5, var uParam6, var uParam7, var uParam8, var uParam9, var uParam10, bool bParam11, bool bParam12)
{
	if (bParam11)
	{
...
int func_386(int iParam0, bool bParam1, bool bParam2, var uParam3, var uParam4, var uParam5, float fParam6, bool bParam7, bool bParam8, bool bParam9, bool bParam10)
{
	...
	switch (((*Global_1360165)[iParam0 /*1157*/])->f_70.f_12)
	{
		...
		case 3:
			...
			sVar12 = func_421(iParam0, func_283());
