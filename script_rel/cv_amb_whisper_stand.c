...
int func_72(var uParam0)
{
	...
	func_152(uParam0, 0f, -1.4875f, 0f, 0f, 4.375f, 4.2125f, 5f, -1612834106, -1, 1, 1, 1);
	iLocal_15 = func_153(uParam0, "script@ambient@town@whisper@stand@action", 0, 0, 0, 0);
...
{
	func_195(uParam0, iLocal_15, "Loop", 1);
	return 1;
}
...
int func_154(var uParam0, var uParam1, char* sParam2, int iParam3)
{
	int iVar0;
	char cVar1[64];
...
int func_195(var uParam0, int iParam1, char* sParam2, bool bParam3)
{
	int iVar0;
