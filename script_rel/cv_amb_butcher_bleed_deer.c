...
int func_73(var uParam0)
{
	...
	func_153(uParam0, 0f, -0.5f, 1f, 0f, 2f, 2f, 3f, -1612834106, -1, 1, 1, 1);
	func_154(uParam0, joaat("p_knife03x"), 0f, 0f, 0f, "p_knife03x", 0, 1, 1);
	iLocal_17 = func_154(uParam0, joaat("p_cs_meathanger01x"), 0f, 0f, 0f, "HANGER", 0, 0, 1);
	iLocal_15 = func_155(uParam0, "script@ambient@campfiregeneral@BUTCHER_BLEED_HANGING_CARCASS@action", 0, 1, 0, 0);
...
{
	func_190(uParam0, iLocal_15, "BOOL_BASE", 1);
	return 1;
}
...
int func_108(int iParam0, int iParam1, int iParam2, bool bParam3, bool bParam4)
{
	...
	if (func_121(iVar0, 0))
	{
		...
		if ((iParam1 || !func_106(iParam0)) || func_52(iParam0))
		{
			...
			{
				if (func_213(iParam0, 32768/*func_203*/, 1))
				{
...
int func_144(var uParam0)
{
	...
	while (iVar0 < uParam0->f_106)
	{
		...
		else
		{
			...
			{
				if (func_123((uParam0->f_107[iVar0 /*113*/])->f_1, 29, 1) || func_242((uParam0->f_107[iVar0 /*113*/])->f_1))
				{
					return 1;
				}
				if (!uParam0->f_3)
...
int func_186(var uParam0, int iParam1, bool bParam2)
{
	...
	if (uParam0->f_2270)
	{
		uParam0->f_2274 = 0;
		uParam0->f_2275 = 0;
		if ((func_113() && ANIMSCENE::_0x6F1F0B17109309DA(uParam0->f_2046, "ARTHUR")) || (func_279() && ANIMSCENE::_0x6F1F0B17109309DA(uParam0->f_2046, "JOHN")))
		{
			uParam0->f_2274 = 1;
		}
	}
...
void func_187(var uParam0, int iParam1)
{
	...
	{
		func_292(func_49(uParam0, iParam1), 0);
...
int func_190(var uParam0, int iParam1, char* sParam2, bool bParam3)
{
	int iVar0;
...
void func_198(var uParam0)
{
	...
	iVar2 = ENTITY::GET_ENTITY_BONE_INDEX_BY_NAME(func_22(uParam0, iLocal_17), "bottomHookInd02");
	iVar3 = ENTITY::GET_ENTITY_BONE_INDEX_BY_NAME(func_22(uParam0, iLocal_17), "bottomHookInd01");
	vVar4 = { ENTITY::GET_WORLD_POSITION_OF_ENTITY_BONE(func_22(uParam0, iLocal_17), iVar2) };
	vVar7 = { ENTITY::GET_WORLD_POSITION_OF_ENTITY_BONE(func_22(uParam0, iLocal_17), iVar3) };
	PED::SET_PED_TO_RAGDOLL(func_49(uParam0, iLocal_14), 10000, 15000, 0, false, true, false);
	PED::_0xE1AADD0055D76603(func_49(uParam0, iLocal_14), func_22(uParam0, iLocal_17), iVar0, iVar2, vVar4, -1f, 0, 0, 0);
	PED::_0xE1AADD0055D76603(func_49(uParam0, iLocal_14), func_22(uParam0, iLocal_17), iVar1, iVar3, vVar7, -1f, 0, 0, 0);
}
		...
		else if (func_19(uParam0) == 355)
		{
			if (iVar3 == 5)
			{
				if (uParam0->f_3)
				{
					...
					else if (func_357(iVar3, func_100(uParam0->f_7), 1))
					{
					}
					else if (func_359(&uVar2, func_358(iVar3)))
					{
						...
						else
						{
							...
							if (bParam2)
							{
								...
								if (!func_360(iVar0, func_100(uParam0->f_7), 0, -1))
								{
									return -1;
								}
								return iVar0;
...
int func_327(int iParam0, bool bParam1)
{
	...
	{
		func_232(iParam0, _NAMESPACE48::_0x4F76E3676583D951(func_133(iParam0)));
		if (func_220() == -1)
		{
...
int func_382(int iParam0, bool bParam1, bool bParam2, var uParam3, var uParam4, var uParam5, float fParam6, bool bParam7, bool bParam8, bool bParam9, bool bParam10)
{
	...
	switch (((*Global_1360165)[iParam0 /*1157*/])->f_70.f_12)
	{
		...
		case 3:
			...
			sVar12 = func_417(iParam0, func_279());
...
void func_384(int iParam0, bool bParam1, bool bParam2, bool bParam3)
{
	...
	if (bParam3)
	{
		func_418(func_105(iParam0), 1f, 0);
	}
	if (bParam1)
	{
		func_419(iParam0);
...
void func_440(int iParam0, int iParam1, bool bParam2)
{
	...
	if ((Global_40.f_4942[iParam0 /*60*/])->f_5 & 32768/*func_203*/ > 0 && func_400(iParam1, -1658942149))
	{
...
void func_441(int iParam0)
{
	...
	func_460(iParam0, 32768/*func_203*/);
