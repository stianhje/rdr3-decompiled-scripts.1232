...
int func_72(var uParam0)
{
	...
	func_151(uParam0, 7.4f, 32.62f, -1.5769f, -22.68f, 6f, 3f, 3f, -1612834106, 2017216891, 1, 1, 1);
	func_152(uParam0, 6.1972f, 33.3594f, -1.56593f, 0f, 1.3f, 1.3f, 3f, 665633627, 1);
	iLocal_22 = func_153(uParam0, joaat("p_fishingpole02x"), 0f, 0f, 0f, "FISHINGPOLE", 0, 1, 1);
	func_154(uParam0, "script@vignette@dutch_and_javier_2@base", 1, 1, 0, 0);
	iLocal_16 = func_154(uParam0, "script@vignette@dutch_and_javier_2@action_a", 2, 0, 1, 0);
	iLocal_17 = func_154(uParam0, "script@vignette@dutch_and_javier_2@action_a_int_left", 2, 0, 0, 1);
	iLocal_18 = func_154(uParam0, "script@vignette@dutch_and_javier_2@action_a_int_right", 2, 0, 0, 1);
	iLocal_19 = func_154(uParam0, "script@vignette@dutch_and_javier_2@action_b", 2, 0, 0, 0);
	iLocal_20 = func_154(uParam0, "script@vignette@dutch_and_javier_2@action_c_alt_left", 0, 0, 0, 1);
	iLocal_21 = func_154(uParam0, "script@vignette@dutch_and_javier_2@action_c_alt_right", 0, 0, 0, 1);
	func_155(uParam0, "CCDV2AU");
	func_156(uParam0, iLocal_14, 2, -326901185, "WORLD_HUMAN_STAND_FISHING_MALE_A", -1, 1, -1073741824, 1065353216, 1);
	...
	Local_23 = { func_159(uParam0, 5.5496f, 33.5317f, -1.5066f, 81.72f, 8f, 0.5f, 0.5f) };
	Local_33 = { func_159(uParam0, 5.55f, 33.532f, -1.507f, -129.24f, 8f, 0.5f, 0.5f) };
	func_160(uParam0, 40412816, 417135371);
	return 1;
}
...
int func_93(var uParam0)
{
	if (func_198(uParam0, iLocal_16))
	{
		...
		else if (func_199(uParam0, Local_33, 1, 0))
		{
...
void func_98(vector3 vParam0, int iParam3)
{
	...
	while (iVar0 < &Global_1911670)
	{
		...
		if (VOLUME::_0xF6A8A652A6B186CD(iVar1))
		{
			...
			if (func_209(vVar2, vParam0, 2f, 1))
			{
...
int func_107(int iParam0, int iParam1, int iParam2, bool bParam3, bool bParam4)
{
	...
	if (func_120(iVar0, 0))
	{
		...
		{
			if (iParam2 || !(ENTITY::IS_ENTITY_ON_SCREEN(iVar0) && func_210(PLAYER::PLAYER_PED_ID(), iVar0, 1) < 10000f))
			{
				...
				if (iVar1 != 0)
				{
					...
					func_212(iParam0);
					_NAMESPACE48::_0x7B204F88F6C3D287(func_213(iParam0, 0));
					_NAMESPACE48::_0xFCC6DB8DBE709BC8(func_213(iParam0, 0));
					func_214(iParam0);
				}
			}
			else
...
void func_126(int iParam0, bool bParam1, bool bParam2, bool bParam3, bool bParam4)
{
	...
	iVar1 = func_228(iParam0);
	if (((ENTITY::DOES_ENTITY_EXIST(iVar1) && func_230(iParam0) < 10000f) && !bParam3) && !CAM::IS_SCREEN_FADED_OUT())
	{
		return;
	}
...
int func_143(var uParam0)
{
	...
	while (iVar0 < uParam0->f_106)
	{
		...
		{
			if (func_243((uParam0->f_107[iVar0 /*113*/])->f_1, 2048))
			{
				return 1;
			}
			if (func_32(uParam0) < 5)
			{
				if (func_122((uParam0->f_107[iVar0 /*113*/])->f_1, 29, 1) || func_244((uParam0->f_107[iVar0 /*113*/])->f_1))
				{
					return 1;
				}
				if (!uParam0->f_3)
...
{
	uParam0->f_23 = { func_250(iParam1) + Vector(iParam4, iParam3, iParam2) };
	...
	if (!uParam0->f_72)
	{
		...
		while (iVar0 < uParam0->f_33)
		{
			...
			else
			{
				...
				{
					func_257(&(uParam0->f_33[iVar0]), 0, 1, 0, 2048, 0, -1082130432);
					iVar0++;
				}
				if (!uParam0->f_71)
				{
	...
	while (iVar12 < uParam0->f_106)
	{
		...
		else
		{
			if (!STREAMING::IS_MODEL_VALID((uParam0->f_107[iVar12 /*113*/])->f_3))
			{
				...
				{
					(uParam0->f_107[iVar12 /*113*/])->f_3 = _NAMESPACE48::_0xA00DF706C60173D1(func_211((uParam0->f_107[iVar12 /*113*/])->f_7, 1));
				}
			}
			if (!func_208((uParam0->f_107[iVar12 /*113*/])->f_96))
			{
			}
			else
			{
...
int func_171(var uParam0)
{
	...
	while (iVar0 < uParam0->f_106)
	{
		...
		{
			if (func_208((uParam0->f_107[iVar0 /*113*/])->f_8.f_3))
			{
...
void func_189(var uParam0)
{
	...
	if (!uParam0->f_4)
	{
		...
		while (iVar2 < uParam0->f_106)
		{
			...
			else if (func_208((uParam0->f_107[iVar2 /*113*/])->f_96))
			{
			}
			else
			{
...
int func_190(var uParam0, int iParam1, bool bParam2)
{
	...
	if (bParam2)
	{
		...
		while (iVar1 < uParam0->f_1984)
		{
			...
			else if (func_292(uParam0, iVar1) || func_198(uParam0, iVar1))
			{
...
int func_209(vector3 vParam0, vector3 vParam3, float fParam6, bool bParam7)
{
	if (fParam6 < 0f)
	{
		fParam6 = 0f;
...
void func_225(var uParam0, var uParam1, bool bParam2)
{
	if (bParam2)
	{
...
int func_257(int iParam0, int iParam1, bool bParam2, int iParam3, int iParam4, bool bParam5, float fParam6)
{
	vector3 vVar0;
	vector3 vVar3;
	var uVar6;
...
int func_331(int iParam0, bool bParam1)
{
	...
	{
		func_234(iParam0, _NAMESPACE48::_0x4F76E3676583D951(func_132(iParam0)));
		if (func_222() == -1)
		{
	...
	switch (((*Global_1360165)[iParam0 /*1157*/])->f_70.f_12)
	{
		case 0:
			...
			else
			{
				...
				{
					_NAMESPACE48::_0x187D65F3AEC5D679(func_211(iParam0, 1), &sVar4);
				}
		...
		case 3:
			...
			if ((bParam2 && !func_208(vVar0)) && !func_209(vVar0, ENTITY::GET_ENTITY_COORDS(((*Global_1360165)[iParam0 /*1157*/])->f_124, true, false), 1056964608, 1))
			{
			...
			sVar12 = func_422(iParam0, func_283());
			if (!MISC::IS_STRING_NULL_OR_EMPTY(sVar12))
			{
				_NAMESPACE48::_0x63AA2B8EB087886A(func_211(iParam0, 1), MISC::GET_HASH_KEY(sVar12));
			}
...
void func_398(int iParam0, vector3 vParam1, float fParam4, int iParam5, int iParam6)
{
	...
	if (func_226(iParam5, 4) && ENTITY::IS_ENTITY_A_PED(iParam0))
	{
		iVar1 = ENTITY::GET_PED_INDEX_FROM_ENTITY_INDEX(iParam0);
	...
	if (func_226(iParam5, 2))
	{
		...
		{
			ENTITY::_0x203BEFFDBE12E96A(iParam0, vParam1, fParam4, 1, func_226(iParam5, 32), 1);
		}
		else
		{
			ENTITY::_0x203BEFFDBE12E96A(iParam0, vParam1, fParam4, 1, func_226(iParam5, 32), 1);
	...
	else if (func_226(iParam5, 129))
	{
		...
		ENTITY::SET_ENTITY_COORDS_NO_OFFSET(iParam0, vParam1, func_226(iParam5, 32), true, true);
	...
	if (bVar4)
	{
		...
		if (ENTITY::GET_PED_INDEX_FROM_ENTITY_INDEX(iParam0) == Global_35 && !func_226(iParam5, 64))
		{
			if (!CAM::IS_SCREEN_FADED_OUT())
			{
			}
...
bool func_404(int iParam0, int iParam1)
{
	...
	if (iParam1 && !ENTITY::DOES_ENTITY_EXIST(func_232(iParam0)))
	{
		return false;
	}
...
int func_419(int iParam0, vector3 vParam1, float fParam4, bool bParam5)
{
	...
	if ((!bParam5 && !Global_1359489->f_12) || (bParam5 && Global_1359489->f_13 < 8))
	{
		...
		{
			iVar0 = _NAMESPACE48::_0xA00DF706C60173D1(func_211(iParam0, 1));
...
void func_421(int iParam0, int iParam1)
{
	...
	{
		PED::_0x931B241409216C1F(func_228(iParam1), iParam0, 0);
		PED::_0xED1C764997A86D5A(func_228(iParam1), iParam0);
...
int func_429(int iParam0, int iParam1, bool bParam2, int iParam3)
{
	...
	if (iParam3 && ENTITY::DOES_ENTITY_EXIST(func_228(iParam0)))
	{
		iVar10 = 0;
		while (iVar10 < iVar7)
		{
