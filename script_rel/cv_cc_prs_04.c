...
int func_72(var uParam0)
{
	...
	{
		case 1:
			vLocal_32 = { -137.6493f, -19.38938f, 96.22693f };
			func_149(uParam0, 149, 0, 0, 0);
			break;
		
		case 2:
			vLocal_32 = { 679.4728f, -1254.775f, 43.81953f };
			func_149(uParam0, 82, 0, 0, 0);
			break;
		
		case 3:
			vLocal_32 = { 1879.968f, -1862.575f, 42.77949f };
	...
	func_151(uParam0, -2.25f, 0.75f, 0f, 0f, 3f, 3f, 5f, -1612834106, -1386303207, 1, 1, 1);
	iLocal_18 = func_152(uParam0, -1758388913, 0f, 0f, 0f, "CARROT", 0, 1, 1);
	iLocal_17 = func_152(uParam0, -1874205952, 0f, 0f, 0f, "KNIFE", 0, 0, 1);
	iLocal_15 = func_152(uParam0, 412658482, 0f, 0f, 0f, "SACK_1", 0, 0, 1);
	iLocal_16 = func_152(uParam0, -642995531, 0f, 0f, 0f, "SACK_2", 0, 0, 1);
	func_153(uParam0, "script@vignette@pearson_4@base", 1, 1, 0, 0);
	func_153(uParam0, "script@vignette@pearson_4@action_back", 0, 0, 1, 1);
	func_154(uParam0, "CPRAUD4");
	func_155(uParam0, iLocal_14, 4, -717884433, "PROP_HUMAN_FOODPREP_STEW_CHOP_CARROT_MALE_B", -1, 1, -1073741824, 1065353216, 1);
	...
	Local_22 = { func_159(uParam0, -1.92f, -0.8f, 0f, 64.08f, 7f, 1f, 1f) };
	func_160(uParam0, 1);
...
{
	return func_194(uParam0, Local_22, 1, 0);
}
...
{
	if (PED::_0x569F1E1237508DEB(func_48(uParam0, iLocal_14)) == -349980427)
	{
		if (!iLocal_21)
		{
			iLocal_21 = 1;
	...
	if (!CAM::IS_SPHERE_VISIBLE(vLocal_32, 1f))
	{
		switch (func_148(uParam0))
		{
			case 1:
		...
		uLocal_19 = func_193(uParam0, iLocal_15);
		uLocal_20 = func_193(uParam0, iLocal_16);
		OBJECT::DELETE_OBJECT(&uLocal_19);
		OBJECT::DELETE_OBJECT(&uLocal_20);
		return 1;
	}
	return 0;
}
