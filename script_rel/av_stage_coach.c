...
{
	func_33(uParam0, 11042/*func_30*/, 11165/*func_31*/, 11591/*func_32*/);
}
...
void func_14(var uParam0, vector3 vParam1, vector3 vParam4)
{
	...
	func_46(uParam0, "AV_STAGE_COACH", "", vParam1, vParam4);
	uVar0 = func_48(func_47());
	func_49(uParam0, 0, "PASSENGER", uVar0, OBJECT::_GET_OBJECT_OFFSET_FROM_COORDS(vParam1, vParam4.z, -4.5f, 1.5f, 0f), (vParam4.z - 75f), 1, 0, 1, 1, 41788943, 1);
	func_49(uParam0, 1, "WAGON_DRIVER", 1995969965, OBJECT::_GET_OBJECT_OFFSET_FROM_COORDS(vParam1, vParam4.z, -1f, 1.5f, 0f), (vParam4.z + 110f), 1, 0, 1, 1, 41788943, 1);
	func_49(uParam0, 2, "STAGE_COACH_HORSE_1", 0, 0f, 0f, 0f, 0f, 1, 1, 1, 1, 41788943, 1);
	func_49(uParam0, 3, "STAGE_COACH_HORSE_2", 0, 0f, 0f, 0f, 0f, 1, 1, 1, 1, 41788943, 1);
	func_49(uParam0, 4, "STAGE_COACH_HORSE_3", 0, 0f, 0f, 0f, 0f, 1, 1, 1, 1, 41788943, 1);
	func_49(uParam0, 5, "STAGE_COACH_HORSE_4", 0, 0f, 0f, 0f, 0f, 1, 1, 1, 1, 41788943, 1);
	func_50(uParam0, "COACH", iLocal_38, vParam1, vParam4.z, 0, 0, 0, 0);
}
...
int func_28(var uParam0)
{
	if (!ENTITY::IS_ENTITY_DEAD(&(uParam0->f_20[1 /*14*/])))
	{
		...
		PED::SET_PED_AS_GROUP_LEADER(&(uParam0->f_20[1 /*14*/]), iLocal_37, 0);
		func_58(&(uParam0->f_20[1 /*14*/]), -22664287, 0, 0, 1317331863, -1082130432);
	}
	if (!ENTITY::IS_ENTITY_DEAD(&(uParam0->f_20[0 /*14*/])))
	{
		PED::SET_PED_AS_GROUP_MEMBER(&(uParam0->f_20[0 /*14*/]), iLocal_37);
		func_58(&(uParam0->f_20[0 /*14*/]), 830847823, 0, 0, 0, -1082130432);
	}
	return 1;
}
...
int func_30(var uParam0)
{
	...
	func_59(-22664287, 15, 0, 1317331863);
	if (!func_60(830847823) || !func_60(-22664287))
	{
		return 0;
	}
	func_61(&uLocal_9, 0);
...
int func_31(var uParam0)
{
	...
	if (!&uParam0->f_469[0])
	{
		if (func_68(uParam0, &uLocal_9, 0))
		{
			...
			if (!&uParam0->f_469[6])
			{
				func_71(*uParam0, uParam0->f_483, 1);
				uParam0->f_469[6] = 1;
			}
			uParam0->f_469[0] = 1;
		}
	...
	if (!&uParam0->f_469[2])
	{
		if (func_72(uParam0, 1065353216, 80f, 4, 60f, 1112014848))
		{
			...
			TASK::_TASK_PERFORM_SEQUENCE_2(&(uParam0->f_20[1 /*14*/]), iVar0, 3f, 6f);
	...
	if (&uParam0->f_469[2])
	{
		if (!&uParam0->f_469[6])
		{
			if (func_73(uParam0, 1.5f, 1116471296, 4, -91962372, 0))
			{
				func_71(*uParam0, uParam0->f_483, 1);
				uParam0->f_469[6] = 1;
			}
	...
	if (&uParam0->f_469[2])
	{
		if (PED::IS_PED_IN_VEHICLE(&(uParam0->f_20[1 /*14*/]), uParam0->f_453, false) && !func_74(&(uParam0->f_20[0 /*14*/]), -1794415470))
		{
...
void func_50(var uParam0, char* sParam1, int iParam2, vector3 vParam3, var uParam6, int iParam7, int iParam8, int iParam9, int iParam10)
{
...
void func_58(int iParam0, int iParam1, int iParam2, int iParam3, int iParam4, int iParam5)
{
...
void func_69(var uParam0)
{
	...
	while (iVar0 < 6)
	{
		...
		{
			TASK::CLEAR_PED_TASKS_IMMEDIATELY(&(uParam0->f_20[iVar0 /*14*/]), 0, 1);
			if (PED::IS_PED_IN_VEHICLE(&(uParam0->f_20[iVar0 /*14*/]), uParam0->f_453, false))
			{
...
int func_72(var uParam0, float fParam1, float fParam2, int iParam3, float fParam4, float fParam5)
{
	...
	if ((MISC::GET_FRAME_COUNT() % 8) == 0)
	{
		...
		fVar7 = func_111(Global_36, uParam0->f_483);
		...
		while (iVar0 < uParam0->f_19)
		{
			...
			if (!ENTITY::IS_ENTITY_DEAD(&(uParam0->f_20[iVar0 /*14*/])))
			{
				...
				fVar8 = func_112(Global_35, &(uParam0->f_20[iVar0 /*14*/]), 1);
				if (fVar8 < fVar1)
				{
					return 1;
				}
		...
		while (iVar0 < uParam0->f_19)
		{
			...
			else
			{
				if (!ENTITY::IS_ENTITY_DEAD(&(uParam0->f_20[iVar0 /*14*/])))
				{
					...
					{
						if ((func_112(Global_35, &(uParam0->f_20[iVar0 /*14*/]), 1) < fParam2 && PED::_0x5102307CE88798EB(&(uParam0->f_20[iVar0 /*14*/]))) && PED::IS_TRACKED_PED_VISIBLE(&(uParam0->f_20[iVar0 /*14*/])))
						{
							if (!func_113(&(uParam0->f_490)))
							{
...
int func_103(int iParam0, int iParam1, var uParam2, var uParam3, int iParam4, float fParam5)
{
	...
	if (!Global_1935630->f_12 && !ENTITY::IS_ENTITY_DEAD(iParam0))
	{
		...
		if (!uParam2->f_1 & 128 != 0)
		{
			...
			{
				*uParam3 = 128;
				func_139(iParam0, uParam2, *uParam3);
				return 1;
			}
		}
		if (Global_1935630->f_27)
		{
			if (!uParam2->f_1 & 8 != 0)
			{
				...
				else if (func_141(iParam0, iParam1, uParam2))
				{
					*uParam3 = 8;
					func_139(iParam0, uParam2, *uParam3);
					return 1;
		...
		if (Global_1935630->f_26 && func_143(PLAYER::PLAYER_ID(), 0, 1, uParam2->f_1 & 524288 == 0))
		{
		...
		{
			if (func_144(uParam2, 1065353216))
			{
				if (!uParam2->f_1 & 4 != 0)
				{
		...
		if (!uParam2->f_1 & 16 != 0)
		{
			...
			{
				if (func_147(Global_35, iParam0, uParam2, 0))
				{
					*uParam3 = 16;
					func_139(iParam0, uParam2, *uParam3);
					return 1;
			...
			else if (func_147(Global_35, iParam0, uParam2, 1))
			{
				*uParam3 = 16;
				func_139(iParam0, uParam2, *uParam3);
				return 1;
		...
		if (Global_1935630->f_30 || Global_1935630->f_31)
		{
			if (!uParam2->f_1 & 2 != 0)
			{
				if (func_150(uParam2, 4000))
				{
					if ((func_151(iParam0, Global_1935630->f_41, *uParam2 & 128 != 0, 0, *uParam2 & 256 != 0) && func_152(uParam2, iParam0)) && func_153(uParam2, iParam0))
					{
						*uParam3 = 2;
						func_139(iParam0, uParam2, *uParam3);
						return 1;
		...
		if (!uParam2->f_1 & 2 != 0)
		{
			if (uParam2->f_12 < 4f)
			{
				if ((func_151(iParam0, Global_1935630->f_41, *uParam2 & 128 != 0, 1, *uParam2 & 256 != 0) && func_152(uParam2, iParam0)) && func_153(uParam2, iParam0))
				{
					*uParam3 = 2;
					func_139(iParam0, uParam2, *uParam3);
					return 1;
			...
			if (uParam2->f_12 < 10f)
			{
				if (func_156(uParam2, iParam0) || (uParam2->f_9 > 0 && (func_157() - uParam2->f_9) < 2000))
				{
		...
		if (uParam2->f_12 < uParam2->f_26)
		{
			...
			{
				if (func_160(iParam0, iParam1, uParam2))
				{
					*uParam3 = 2048;
					func_139(iParam0, uParam2, *uParam3);
					return 1;
...
void func_104(var uParam0, int iParam1)
{
	...
	if (VEHICLE::IS_VEHICLE_SEAT_FREE(uParam0->f_453, -1))
	{
		...
		TASK::CLOSE_SEQUENCE_TASK(iVar0);
		TASK::TASK_PERFORM_SEQUENCE(&(uParam0->f_20[iParam1 /*14*/]), iVar0);
		TASK::CLEAR_SEQUENCE_TASK(&iVar0);
		PED::SET_PED_KEEP_TASK(&(uParam0->f_20[iParam1 /*14*/]), true);
	}
	else
	{
		TASK::TASK_SMART_FLEE_PED(&(uParam0->f_20[iParam1 /*14*/]), Global_35, -1f, -1, 0, 3f, 0);
	}
}
...
void func_106(int iParam0)
{
	if (func_43(iParam0))
	{
		...
		{
			case 1:
				func_167(0, 1, 0, 0, ((Global_1415419->f_19[iParam0 /*12*/])->f_7 / 4), 0, 0, 1);
				func_167(1, 1, 0, 0, ((Global_1415419->f_19[iParam0 /*12*/])->f_7 / 4), 0, 0, 1);
				break;
			case 37:
				func_167(60, 1, 0, 0, ((Global_1415419->f_19[iParam0 /*12*/])->f_7 / 4), 0, 0, 1);
				break;
		}
	}
}

void func_107(int iParam0, vector3 vParam1)
{
	int iVar0;
	int iVar1;
...
void func_137(var uParam0, bool bParam1, int iParam2)
{
	func_179(iParam2);
	if (Global_1572887->f_12 == -1)
	{
	...
	if (!uParam0->f_1 & 1024 != 0)
	{
		if (!ENTITY::DOES_ENTITY_EXIST(uParam0->f_14))
		{
			if (func_182(uParam0))
			{
				uParam0->f_15 = func_157();
			}
		}
		else if (uParam0->f_15 > 0)
		{
			if ((func_157() - uParam0->f_15) > 500)
			{
...
int func_147(var uParam0, int iParam1, var uParam2, bool bParam3)
{
	vector3 vVar0;
	int iVar3;
	vector3 vVar4;
...
int func_165(int iParam0, var uParam1)
{
	...
	if (uParam1->f_4 == 0)
	{
		uParam1->f_4 = func_157();
	}
	else if (func_157() - uParam1->f_4) > func_217(uParam1)
	{
...
void func_167(int iParam0, int iParam1, int iParam2, int iParam3, int iParam4, int iParam5, bool bParam6, int iParam7)
{
	int iVar0;
