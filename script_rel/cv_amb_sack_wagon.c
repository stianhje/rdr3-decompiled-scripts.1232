...
int func_83(var uParam0)
{
	...
	if (!ENTITY::DOES_ENTITY_EXIST(iLocal_16))
	{
		iLocal_16 = VEHICLE::CREATE_VEHICLE(joaat("wagon02x"), uParam0->f_23, 0f, true, true, true, false);
	}
	else
	{
...
void func_390(int iParam0, int iParam1)
{
	...
	switch (iParam0)
	{
		case 11:
			...
			{
				func_435(iParam1, joaat("weapon_revolver_cattleman_sadie"), 0, 0, 2, 1, 0, 1056964608, 1065353216, -1, 0, 0, 0, 0);
				func_435(iParam1, joaat("weapon_revolver_cattleman_sadie_dualwield"), 0, 0, 3, 1, 1, 1056964608, 1065353216, -1, 0, 1, 0, 0);
			}
			break;
	}
}
