		...
		if (MISC::GET_GAME_TIMER() > iLocal_23)
		{
			...
			switch (iLocal_22)
			{
				...
				case 1:
					...
					LAW::_0x9BBDCB8DF789EBC1(PLAYER::PLAYER_ID(), func_9(iLocal_24));
				...
				case 6:
					if (func_7(func_6(iLocal_24)))
					{
						...
						else
						{
							...
							Jump @788; //curOff = 456
							if (iLocal_25 < MISC::GET_GAME_TIMER() || (func_20() != 0 || Global_1051260->f_3790))
							{
								func_21(iLocal_24);
								func_22();
								if (!func_23(2057, 0))
...
void func_52(int iParam0, int iParam1, int iParam2)
{
	...
	(Global_1392240->f_1[iParam0 /*18*/])->f_6[iParam1] = func_98(iParam2, 0, 0);
}
...
void func_60()
{
	...
	iLocal_14 = INTERIOR::GET_INTERIOR_AT_COORDS(func_106(0));
	...
	{
		func_108((Global_40.f_9422[0 /*7*/])->f_1, &uVar6, &uVar5, &uVar4, &iVar3, &uVar2, &uVar1);
	}
	if (func_99(0, 2))
	{
...
void func_61()
{
	...
	if (func_107((Global_40.f_9422[0 /*7*/])->f_1))
	{
		func_108((Global_40.f_9422[0 /*7*/])->f_1, &uVar5, &uVar4, &uVar3, &iVar2, &uVar1, &uVar0);
	}
...
void func_63()
{
	...
	switch (iLocal_20)
	{
		...
		case 3:
			...
			func_124((func_123(1731462646) + (Global_40.f_9422[0 /*7*/])->f_3), 0, 1065353216, 1, 0, 0, 1, 752097756);
			func_125(0);
...
void func_86(int iParam0)
{
	...
	while (iVar1 < 4)
	{
		func_160(&((Global_1392240->f_1[iVar0 /*18*/])->f_6[iVar1]));
...
int func_94(int iParam0, bool bParam1)
{
	...
	{
		func_164(iParam0, _NAMESPACE48::_0x4F76E3676583D951(func_163(iParam0)));
		if (func_20() == -1)
		{
...
void func_108(int iParam0, var uParam1, var uParam2, var uParam3, var uParam4, var uParam5, var uParam6)
{
...
void func_110(int iParam0)
{
	...
	{
		INTERIOR::DEACTIVATE_INTERIOR_ENTITY_SET(iLocal_14, "clean_abe", 1);
	}
	if (iParam0 != 1 && INTERIOR::IS_INTERIOR_ENTITY_SET_ACTIVE(iLocal_14, "ransacked_abe01"))
	{
		INTERIOR::DEACTIVATE_INTERIOR_ENTITY_SET(iLocal_14, "ransacked_abe01", 1);
	}
	if (iParam0 != 2 && INTERIOR::IS_INTERIOR_ENTITY_SET_ACTIVE(iLocal_14, "ransacked_abe"))
	{
		INTERIOR::DEACTIVATE_INTERIOR_ENTITY_SET(iLocal_14, "ransacked_abe", 1);
	}
	if (iParam0 != 3 && INTERIOR::IS_INTERIOR_ENTITY_SET_ACTIVE(iLocal_14, "ransacked_abe03"))
	{
		INTERIOR::DEACTIVATE_INTERIOR_ENTITY_SET(iLocal_14, "ransacked_abe03", 1);
	}
	if ((iParam0 != 0 && iParam0 != 1) && INTERIOR::IS_INTERIOR_ENTITY_SET_ACTIVE(iLocal_14, "abe_SP_armoir"))
	{
		INTERIOR::DEACTIVATE_INTERIOR_ENTITY_SET(iLocal_14, "abe_SP_armoir", 1);
	}
	switch (iParam0)
	{
		case 0:
...
int func_121(int iParam0, var uParam1, var uParam2, vector3 vParam3, int iParam6, bool bParam7)
{
	int iVar0;
...
int func_144(int iParam0)
{
	...
	if (func_199())
	{
		if (!func_200(((*Global_1835011)[3 /*74*/])->f_1, 1))
		{
...
{
	func_205((Global_1935369->f_5[iParam0 /*11*/])->f_6, 1);
	func_206((Global_1935369->f_5[iParam0 /*11*/])->f_6, 0);
...
void func_158(int iParam0)
{
	...
	{
		func_209((Global_1914319->f_3[iParam0 /*446*/])->f_21, 0, 1, 0, 0);
	}
	...
	func_210((Global_1914319->f_3[iParam0 /*446*/])->f_10, 0);
	...
	else
	{
		...
		while (iVar0 < iVar1)
		{
			func_160(&((Global_1914319->f_3[iParam0 /*446*/])->f_317[iVar0 /*6*/]));
...
void func_182(int iParam0, int iParam1, var uParam2, var uParam3, var uParam4, var uParam5, var uParam6, var uParam7)
{
	...
	while (iVar4 < 0)
	{
		...
		iVar3 = (iVar3 - 1);
		iVar0 = BUILTIN::ROUND(func_227(BUILTIN::TO_FLOAT(iVar0 + 1), 0f, 12f));
	}
	while (iVar3 < 0)
	{
		iVar3 += 12;
...
void func_187(int iParam0, char* sParam1, var uParam2)
{
	if (iParam0 == 0)
	{
		return;
	...
	func_229(MISC::_CREATE_VAR_STRING(2, sParam1, iParam0), "ITEMTYPE_TEXTURES", 1831944558, 0, 109029619, 0, 0, 0, 1);
}
...
void func_188(int iParam0, bool bParam1, float fParam2, int iParam3, int iParam4)
{
	...
	if (bParam1)
	{
		...
		iVar1 = (iVar1 + iVar2);
		func_229(MISC::_CREATE_VAR_STRING(2, "FEED_GANG_TOTAL_EARN", iParam0), "ITEMTYPE_TEXTURES", -1957849484, 0, 109029619, 0, 0, 0, 1);
		...
		func_229(MISC::_CREATE_VAR_STRING(2, "FEED_GANG_PLAYER_EARN", iVar1), "ITEMTYPE_TEXTURES", 1831944558, 0, 109029619, 0, 0, 0, 1);
	}
	else
	{
		iVar1 = iParam0;
...
int func_192(int iParam0, bool bParam1, int iParam2)
{
	...
	{
		iVar0 = func_238(&(Global_1898164->f_1[0 /*5*/]));
		if (func_222(iVar0) && func_239(((*Global_1347702)[iVar0 /*49*/])->f_12, 131072))
		{
			return 0;
		}
	}
...
{
	return ((Global_1392240->f_1[iParam0 /*18*/])->f_15 && uParam1) != 0;
}
...
void func_209(int iParam0, bool bParam1, int iParam2, bool bParam3, bool bParam4)
{
	int iVar0;
	int iVar1;
...
void func_232(int iParam0, char* sParam1, int iParam2)
{
	...
	if (func_230())
	{
		func_229(MISC::_CREATE_VAR_STRING(2, sParam1, iParam0), "ITEMTYPE_TEXTURES", -329231034, 0, -585750914, 0, 0, 0, 1);
	}
	else
	{
		func_229(MISC::_CREATE_VAR_STRING(2, sParam1, iParam0), "ITEMTYPE_TEXTURES", 2124880615, 0, -585750914, 0, 0, 0, 1);
	}
}
...
int func_235(int iParam0, var uParam1, var uParam2)
{
	if (!func_234(iParam0))
	{
		return 0;
