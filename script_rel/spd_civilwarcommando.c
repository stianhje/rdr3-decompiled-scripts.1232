		...
		switch (iLocal_179)
		{
			...
			case 8:
				if (!MAP::DOES_BLIP_EXIST(iLocal_243))
				{
					...
					{
						iLocal_243 = MAP::_0x23F74C2FDA6E7C61(831283580, iLocal_240);
					}
				}
			...
			case 7:
				if (MISC::GET_GAME_TIMER() >= iLocal_184)
				{
					...
					{
						TASK::TASK_TURN_PED_TO_FACE_ENTITY(iLocal_240, Global_35, 1000, -1082130432, -1082130432, -1082130432);
					}
					else
					{
	...
	else
	{
		if (!func_14(iLocal_183, 8388608))
		{
			if (!func_14(iLocal_183, 4194304))
			{
				...
				AUDIO::STOP_SCRIPTED_CONVERSATION(func_18(0), 0, 0);
...
int func_9(int iParam0, int* iParam1, float fParam2, var uParam3, int iParam4, float fParam5, int iParam6, int iParam7, char* sParam8, int iParam9, int iParam10, int iParam11, int iParam12, int iParam13, float fParam14, bool bParam15)
{
	...
	uVar0 = iParam9;
	func_56(&uVar0);
	if (func_57(uVar0, 16) && !bParam15)
	{
		iParam9 |= 8388608;
	}
	uVar1 = func_58(iParam0, iParam1, fParam2, uParam3, fParam5, iParam6, iParam7, sParam8, iParam9, iParam10, iParam11, iParam12, fParam14);
	if (!func_57(uVar0, 134217728))
	{
...
{
	func_62();
	HUD::_0xF66090013DE648D5("SPCWCAU");
	HUD::_0xF66090013DE648D5("SPCW");
...
void func_11(int iParam0)
{
	...
	switch (iParam0)
	{
		case 5:
			...
			TASK::TASK_AIM_GUN_AT_ENTITY(iLocal_240, Global_35, -1, 0, 1);
		...
		case 6:
			...
			TASK::TASK_TURN_PED_TO_FACE_ENTITY(Global_35, iLocal_240, 2000, -1082130432, -1082130432, -1082130432);
			PLAYER::SET_PLAYER_CONTROL(PLAYER::PLAYER_ID(), 0, 0, 0);
			TASK::CLEAR_PED_TASKS(iLocal_240, 1, 0);
			if (func_81())
			{
		...
		case 8:
			func_50(7);
			PED::SET_PED_SPHERE_DEFENSIVE_AREA(iLocal_240, ENTITY::GET_ENTITY_COORDS(iLocal_240, true, false), 6f, 0, 0, 0);
...
int func_12()
{
	if (!HUD::_0xD0976CC34002DB57("SPCWCAU") || !HUD::_0xD0976CC34002DB57("SPCW"))
	{
		return 0;
	}
...
int func_13()
{
	...
	{
		PED::SET_PED_RELATIONSHIP_GROUP_HASH(iLocal_240, 623901053);
...
bool func_17(int iParam0, int iParam1, bool bParam2, float fParam3, int iParam4)
{
	if (bParam2)
	{
...
int func_44(int iParam0, int iParam1, var uParam2, var uParam3, int iParam4, float fParam5)
{
	int iVar0;
...
int func_47(int iParam0, int iParam1, float fParam2, bool bParam3)
{
	if (!ENTITY::DOES_ENTITY_EXIST(iParam0))
	{
		return 0;
...
int func_58(var uParam0, int* iParam1, float fParam2, var uParam3, float fParam4, int iParam5, int iParam6, char* sParam7, int iParam8, int iParam9, int iParam10, int iParam11, float fParam12)
{
	int iVar0;
	bool bVar1;
	bool bVar2;
	...
	if (!ENTITY::IS_ENTITY_DEAD(*uParam0))
	{
		...
		fVar8 = func_155(fParam12 >= 0f, fParam12, BUILTIN::VDIST(Global_36, ENTITY::GET_ENTITY_COORDS(*uParam0, true, false)));
		...
		if (func_156(*uParam0, iParam1, uParam3))
		{
			return -1;
		}
		switch (iParam1->f_2)
		{
			case 0:
				if (bVar2)
				{
					if (func_157(uParam0, iParam1, uParam3, fParam2, iParam8, sParam7, iParam11, fVar8))
					{
						iParam1->f_1 = -1;
						iParam1->f_2 = 1;
						return func_58(uParam0, iParam1, fParam2, uParam3, fParam4, iParam5, iParam6, sParam7, iParam8, iParam9, iParam10, iParam11, fParam12);
					}
				}
				break;
			case 1:
				...
				if (func_161(uParam0, iParam8, iParam9, MISC::IS_BIT_SET(*iParam1, 4)))
				{
					func_162(uParam0, 1, iParam1, fParam2, uParam3, bVar3, fParam4, iParam5, iParam6, sParam7, iParam8, iParam9, iParam10, iParam11, bVar4);
					func_163(iParam8);
					if (func_164(uParam0, iParam1, fVar8, fParam2, uParam3, bVar3, fParam4, iParam5, iParam6, sParam7, iParam8, iParam9, iParam10, iParam11, bVar4, bVar7, bVar5, bVar1, 0))
					{
				...
				else
				{
					...
					if (func_167(*uParam0, iParam1, uParam3))
					{
						return iParam1->f_1;
					}
			...
			case 3:
				break;
			case 4:
				if (func_169(uParam0, iParam1, fParam4, bVar6))
				{
					iVar0 = iParam1->f_1;
					iParam1->f_9 = 0;
					iParam1->f_1 = -1;
			...
			case 2:
				if (func_161(uParam0, iParam8, iParam9, MISC::IS_BIT_SET(*iParam1, 4)))
				{
					func_170(*uParam0, iParam1, uParam3, fParam2, iParam5, iParam6, iParam10, bVar3);
					func_164(uParam0, iParam1, fVar8, fParam2, uParam3, bVar3, fParam4, iParam5, iParam6, sParam7, iParam8, iParam9, iParam10, iParam11, bVar4, bVar7, bVar5, bVar1, 1);
					func_162(uParam0, func_161(uParam0, iParam8, iParam9, 0), iParam1, fParam2, uParam3, bVar3, fParam4, iParam5, iParam6, sParam7, iParam8, iParam9, iParam10, iParam11, bVar4);
					func_163(iParam8);
				}
...
void func_59(int* iParam0, var uParam1, var uParam2)
{
	...
	if (iVar0 != -1)
	{
		...
		{
			func_173(Global_35, *uParam2, sVar1, "", -1082130432, uVar2, 0, 0, 1, 1, 1, 291934926, 1, 0, 0);
		}
	}
}
...
void func_64()
{
	iLocal_17[0] = VOLUME::_0x10157BC3247FF3BA(2015.593f, 623.3331f, 157.6585f, 0f, 0f, 0f, 100f, 100f, 100f, "CWC_VOL_RANDOM_EVENT_BLOCKER");
...
int func_65(int iParam0, char* sParam1, bool bParam2, int iParam3, int iParam4, bool bParam5, float fParam6)
{
	vector3 vVar0;
	vector3 vVar3;
	var uVar6;
	...
	uVar6 = func_179(vVar0, vVar3.x, sParam1, bParam2, iParam3, iParam4, bParam5, fParam6);
	return uVar6;
}
...
int func_84(var uParam0, vector3 vParam1, float fParam4)
{
	if (*uParam0)
	{
		return 0;
	...
	iLocal_240 = func_190(iLocal_14, vParam1, fParam4, 0, 1, 0, 1, 1, 1, 0, 0, 0, 0);
	if (ENTITY::DOES_ENTITY_EXIST(iLocal_240))
	{
		*uParam0 = 1;
		return 1;
...
int func_86(var uParam0)
{
	...
	ENTITY::_0x203BEFFDBE12E96A(iLocal_242, 2015.818f, 623.6882f, 157.6772f, 48.79f, 1, false, 1);
	if (ENTITY::DOES_ENTITY_EXIST(iLocal_242))
	{
		*uParam0 = 1;
		return 1;
...
void func_91()
{
	...
	func_194(Local_144[0 /*17*/], "INTERACT_GREET", func_193(), -163964935, 0, 0, 0, 1, 0);
	func_194(Local_144[1 /*17*/], "INTERACT_INSULT", uVar0, 648122183, 0, 0, 0, 1, iVar1);
...
bool func_93(var uParam0, char[12] cParam1, bool bParam4, int iParam5, bool bParam6, bool bParam7)
{
	bool bVar0;
...
int func_117(var uParam0, var uParam1, float fParam2, float fParam3)
{
	vector3 vVar0;
	vector3 vVar3;
	...
	if (func_205(uParam1, vVar3, fParam3))
	{
		return 1;
	}
	return 0;
...
int func_118(var uParam0, var uParam1, var uParam2, float fParam3, float fParam4, int iParam5)
{
	float fVar0;
	int iVar1;
	vector3 vVar2;
...
int func_129(int iParam0, bool bParam1, int iParam2, bool bParam3)
{
	...
	{
		return func_225(bParam1, iParam2, bParam3);
	}
	if (Global_1572887->f_12 != -1)
	{
...
int func_156(int iParam0, var uParam1, var uParam2)
{
	if (uParam1->f_11 != 0)
	{
		...
		else if (func_57(uParam1->f_10, 1))
		{
			func_251(uParam2);
			...
			func_186(&(uParam1->f_10), 1);
		}
	}
	return 0;
}

int func_157(var uParam0, int* iParam1, var uParam2, float fParam3, var uParam4, char* sParam5, int iParam6, float fParam7)
{
	char cVar0[32];
	bool bVar4;
	int iVar5;
	...
	if (!ENTITY::IS_ENTITY_DEAD(*uParam0))
	{
		...
		bVar4 = func_57(uParam4, 32);
		func_189(iParam1, uParam2, 0);
		iVar5 = func_252(*uParam0, iParam1, uParam2, fParam3, bVar4);
		if (bVar4)
		{
		...
		func_168(uParam2, 0, 0, 1, 0);
		iVar6 = 0;
		if (!func_57(uParam4, 16))
		{
			iVar6 |= 8;
		}
		if (func_57(uParam4, 2048))
		{
			iVar6 |= 4;
		}
		if (func_57(uParam4, 32768))
		{
			iVar6 |= 128;
		}
		if (func_57(uParam4, 4096))
		{
			iVar6 |= 16;
		}
		if (func_57(uParam4, 8388608) || func_57(uParam4, 8192))
		{
			iVar6 |= 256;
		}
		if (func_57(uParam4, 4194304))
		{
			iVar6 |= 64;
		}
		if (func_57(uParam4, 268435456))
		{
			iVar6 |= 8192;
		}
		...
		if (MISC::_0x870708A6E147A9AD(*uParam0, &cVar0, fParam3, fParam3, iVar6, iParam1->f_7, iParam1->f_8, iVar5, 0, iParam1->f_6))
		{
			...
			if (func_57(uParam4, 2) || func_57(uParam4, 16))
			{
				func_159(*uParam0, 1, 1);
			}
			else
...
int func_161(var uParam0, int iParam1, int iParam2, bool bParam3)
{
	bool bVar0;
	bool bVar1;
	bool bVar2;
	...
	if (bVar0)
	{
		...
		if (func_256(*uParam0, bParam3, bVar2, bVar3))
		{
			return 1;
		}
	}
...
void func_162(var uParam0, bool bParam1, int* iParam2, float fParam3, var uParam4, bool bParam5, float fParam6, int iParam7, int iParam8, char* sParam9, int iParam10, int iParam11, int iParam12, int iParam13, bool bParam14)
{
	int iVar0;
	...
	if (bParam1)
	{
		if (!MISC::IS_BIT_SET(*iParam2, 1))
		{
			...
			func_195(*uParam0, uParam4, fParam3, iParam7, iParam8, iParam12, func_57(iParam10, 32), 1, 0);
...
bool func_164(var uParam0, int* iParam1, float fParam2, float fParam3, var uParam4, bool bParam5, float fParam6, int iParam7, int iParam8, char* sParam9, int iParam10, int iParam11, int iParam12, int iParam13, bool bParam14, bool bParam15, bool bParam16, bool bParam17, bool bParam18)
{
	int iVar0;
	int iVar1;
	bool bVar2;
	...
	while (iVar0 < *uParam4)
	{
		...
		func_261(*uParam0, (*uParam4)[iVar0 /*17*/], fParam3, iParam7, iParam8, iParam12, bParam5);
		if (MISC::IS_BIT_SET(uParam4[iVar0 /*17*/], 20))
		{
			bVar3 = true;
		}
		if (func_262(*uParam0, iParam1, (*uParam4)[iVar0 /*17*/], bVar4, fParam3, fParam2, iParam7, iParam8, bParam14, bParam16, bParam17, bVar9, bVar10, bParam15, fVar12, bVar11, iVar1))
		{
			if (!bParam18 && !bVar5)
			{
...
bool func_173(int iParam0, int iParam1, char* sParam2, char* sParam3, float fParam4, var uParam5, bool bParam6, int iParam7, int iParam8, bool bParam9, int iParam10, int iParam11, bool bParam12, bool bParam13, int iParam14)
{
	return func_272(iParam0, iParam1, sParam2, sParam3, fParam4, uParam5, bParam6, iParam7, iParam8, bParam9, iParam10, iParam11, 0, bParam12, bParam13, iParam14) >= 0;
}
...
int func_179(vector3 vParam0, float fParam3, var uParam4, bool bParam5, int iParam6, int iParam7, bool bParam8, float fParam9)
{
	int iVar0;
	int iVar1;
	vector3 vVar2;
...
void func_195(int iParam0, var uParam1, float fParam2, int iParam3, int iParam4, int iParam5, bool bParam6, int iParam7, bool bParam8)
{
	int iVar0;
	...
	while (iVar0 < *uParam1)
	{
		func_285(iParam0, (*uParam1)[iVar0 /*17*/], fParam2, iParam3, iParam4, iParam5, bParam6, iParam7);
		if (bParam8)
		{
...
int func_205(var uParam0, vector3 vParam1, float fParam4)
{
...
int func_206(var uParam0, var uParam1, vector3 vParam2, float fParam5, float fParam6)
{
	int iVar0;
	int iVar1;
	int iVar2;
		...
		*uParam1 = iVar0;
		if (ENTITY::DOES_ENTITY_EXIST(*uParam1))
		{
			if (!ENTITY::IS_ENTITY_DEAD(*uParam1))
			{
				...
				{
					if (func_289(Global_35, *uParam1, 0))
					{
					}
					else
					{
...
int func_220(int iParam0, bool bParam1, bool bParam2, bool bParam3, int iParam4, int iParam5)
{
	int iVar0;
	int iVar1;
	int iVar2;
	...
	{
		if (WEAPON::_0x6AD66548840472E5(func_296(iVar0, 0)))
		{
...
int func_222(var uParam0, int iParam1, float fParam2, float fParam3)
{
	float fVar0;
...
int func_224(int iParam0, bool bParam1, bool bParam2, bool bParam3, int iParam4)
{
	int iVar0;
	int iVar1;
...
int func_225(bool bParam0, var uParam1, var uParam2)
{
...
int func_229(int iParam0, vector3 vParam1, vector3 vParam4)
{
...
int func_256(int iParam0, var uParam1, bool bParam2, bool bParam3)
{
	int iVar0;
...
int func_262(int iParam0, int* iParam1, int* iParam2, bool bParam3, float fParam4, float fParam5, int iParam6, int iParam7, bool bParam8, bool bParam9, bool bParam10, bool bParam11, bool bParam12, var uParam13, float fParam14, bool bParam15, int iParam16)
{
	int iVar0;
	bool bVar1;
	...
	{
		bVar1 = false;
		if (func_309(iParam1, iParam2, iParam0, bParam9, bParam10, fParam5, bParam11, bParam12, uParam13, fParam14, bParam15, iParam16))
		{
			bVar1 = true;
		}
...
void func_264(var uParam0, int iParam1, bool bParam2)
{
	...
	while (iVar0 < *uParam0)
	{
		func_20((*uParam0)[iVar0 /*17*/], iParam1, bParam2);
		iVar0++;
	}
}

int func_265(int* iParam0, float fParam1, var uParam2)
{
	if (iParam0->f_2 != 3)
	{
...
void func_285(int iParam0, int* iParam1, float fParam2, int iParam3, int iParam4, int iParam5, bool bParam6, int iParam7)
{
	char* sVar0;
	int iVar1;
...
int func_293(bool bParam0, var uParam1, var uParam2)
{
	int iVar0;
	int iVar1;
...
int func_297(int iParam0, float fParam1, float fParam2, float fParam3, float fParam4)
{
	if (!ENTITY::IS_ENTITY_DEAD(iParam0))
	{
...
bool func_309(int* iParam0, int* iParam1, var uParam2, bool bParam3, bool bParam4, float fParam5, bool bParam6, bool bParam7, var uParam8, float fParam9, bool bParam10, int iParam11)
{
	bool bVar0;
	int iVar1;
...
float func_317(int iParam0, bool bParam1, int iParam2)
{
	...
	return func_238(Global_35, iParam0, bParam1, iParam2);
}
...
bool func_319(int iParam0, char* sParam1, int iParam2, int iParam3, bool bParam4, int iParam5, var uParam6, var uParam7)
{
	struct<7> Var0;
...
int func_330(char* sParam0, int iParam1, int iParam2, int iParam3, int iParam4, bool bParam5, int iParam6, int iParam7, float fParam8, int iParam9, int iParam10, int iParam11, int iParam12, int iParam13, int iParam14, bool bParam15, bool bParam16)
{
	...
	while (iVar0 < 48)
	{
		if (func_333(iVar0, 2))
		{
			...
			if (iVar1 != 0)
			{
				func_343(iVar1, iParam1, sParam0, 5, iParam3, iParam4, 0f, 0f, 0f, fParam8, 0, iParam2, 3, iParam6, iParam7, iParam9, iParam10, iParam11, iParam12, iParam13, 1065353216, 0, bParam5, 0, iParam14, bParam16);
				return iVar1;
			}
			return 0;
		}
...
void func_332(int iParam0, char* sParam1, char* sParam2, char* sParam3, int iParam4)
{
	int iVar0;

	if (iParam4 && !func_97(iParam0))
	{
		return;
	}
	iVar0 = func_198(iParam0);
