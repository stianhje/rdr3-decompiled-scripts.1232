...
{
	func_33(uParam0, 10949/*func_30*/, 11007/*func_31*/, 11697/*func_32*/);
}
...
void func_14(var uParam0, vector3 vParam1, vector3 vParam4)
{
	...
	{
		case 0:
			iVar0 = func_47(func_46());
			break;
		
		case 1:
			iVar0 = func_49(func_48());
			break;
	...
	func_50(uParam0, "WAGON_SWEEPER", "script@ambient@town@wagon_sweeper@action", vParam1, vParam4);
	func_51(uParam0, 1, "pbl_action", "", 0);
	func_52(uParam0, 0, "male", iVar0, 0f, 0f, 0f, 0f, 1, 1, 1, 1, 41788943, 1);
	func_53(uParam0, 0, "Broom", 663716280, 0f, 0f, 0f, 0f, 1);
}
...
{
	return STREAMING::HAS_MODEL_LOADED(iLocal_37);
}
...
int func_28(var uParam0)
{
	...
	{
		uParam0->f_453 = VEHICLE::CREATE_VEHICLE(iLocal_37, uParam0->f_483, uParam0->f_486.f_2, true, true, true, false);
		return 0;
	}
	if (ENTITY::DOES_ENTITY_EXIST(uParam0->f_453))
	{
		if (!ENTITY::IS_ENTITY_DEAD(uParam0->f_453))
		{
			...
			while (iVar0 <= 10)
			{
				if (VEHICLE::DOES_EXTRA_EXIST(uParam0->f_453, iVar0))
				{
					VEHICLE::SET_VEHICLE_EXTRA(uParam0->f_453, iVar0, true);
				}
				iVar0++;
			}
...
int func_31(var uParam0)
{
		...
		if (!ENTITY::IS_ENTITY_DEAD(&(uParam0->f_20[0 /*14*/])))
		{
			if (func_71(uParam0, 1065353216, 55f, 4, 15f, 1112014848))
			{
				if (ANIMSCENE::_0x25557E324489393C(uParam0->f_3.f_1))
				{
					...
					PED::_0xBEC65C6049B3219D(&(uParam0->f_20[0 /*14*/]), &(uParam0->f_372[0 /*8*/]), "p_broom02x_PH_R_HAND", "WORLD_HUMAN_BROOM_PUTDOWN", "", 1);
					uParam0->f_469[1] = 1;
					uParam0->f_469[2] = 1;
					return 0;
				}
	...
	if (&uParam0->f_469[2])
	{
		if (!&uParam0->f_469[6])
		{
			if (func_72(uParam0, 1065353216, 1116471296, 4, -91962372, 1))
			{
				func_70(*uParam0, uParam0->f_483, 0);
				uParam0->f_469[6] = 1;
			}
...
void func_50(var uParam0, char* sParam1, char* sParam2, vector3 vParam3, vector3 vParam6)
{
	uParam0->f_2 = sParam1;
	uParam0->f_3 = sParam2;
...
void func_51(var uParam0, int iParam1, char* sParam2, char* sParam3, int iParam4)
{
...
void func_53(var uParam0, int iParam1, char* sParam2, int iParam3, vector3 vParam4, float fParam7, int iParam8)
{
...
bool func_57()
{
	return (Global_1894899 & 1 != 0 && func_48() != -1);
}
...
int func_71(var uParam0, float fParam1, float fParam2, int iParam3, float fParam4, float fParam5)
{
	...
	if ((MISC::GET_FRAME_COUNT() % 8) == 0)
	{
		...
		fVar7 = func_108(Global_36, uParam0->f_483);
		...
		while (iVar0 < uParam0->f_19)
		{
			...
			if (!ENTITY::IS_ENTITY_DEAD(&(uParam0->f_20[iVar0 /*14*/])))
			{
				...
				fVar8 = func_109(Global_35, &(uParam0->f_20[iVar0 /*14*/]), 1);
				if (fVar8 < fVar1)
				{
					return 1;
				}
		...
		while (iVar0 < uParam0->f_19)
		{
			...
			else
			{
				if (!ENTITY::IS_ENTITY_DEAD(&(uParam0->f_20[iVar0 /*14*/])))
				{
					...
					{
						if ((func_109(Global_35, &(uParam0->f_20[iVar0 /*14*/]), 1) < fParam2 && PED::_0x5102307CE88798EB(&(uParam0->f_20[iVar0 /*14*/]))) && PED::IS_TRACKED_PED_VISIBLE(&(uParam0->f_20[iVar0 /*14*/])))
						{
							if (!func_110(&(uParam0->f_490)))
							{
								func_114(&(uParam0->f_490), 0);
							}
...
Vector3 func_73(var uParam0)
{
	...
	switch (func_46())
	{
		case 0:
			...
			{
				case 5:
					*(vVar4[0 /*3*/]) = { 2601.62f, -1490.32f, 44.97f };
					break;
			}
			break;
		...
		case 9:
			...
			{
				case 76:
					*(vVar4[0 /*3*/]) = { -283.55f, 775.36f, 117.82f };
					*(vVar4[1 /*3*/]) = { -269.29f, 641.98f, 112.46f };
					*(vVar4[2 /*3*/]) = { -366.72f, 778.44f, 115.18f };
					break;
			}
			break;
		...
		case 11:
			...
			{
				case 105:
					*(vVar4[0 /*3*/]) = { 1326.37f, -1370.9f, 78.99f };
					break;
				
				default:
					*(vVar4[0 /*3*/]) = { 1051.79f, -1126.71f, 66.9f };
					break;
			}
			break;
	}
...
int func_77(vector3 vParam0, float fParam3)
{
	...
	while (iVar0 < 4)
	{
		...
		{
			if (func_119(vParam0, (Global_1415419->f_9721[iVar0 /*8*/])->f_4, fParam3, 0))
			{
				return 1;
			}
		}
...
int func_78(vector3 vParam0)
{
	...
	while (iVar0 < 10)
	{
		...
		{
			if (func_119(vParam0, (Global_32073.f_2697.f_1495[iVar0 /*4*/])->f_1, 1f, 0))
			{
				return 1;
			}
		}
...
{
	return (BUILTIN::SHIFT_RIGHT(iParam0, 26) & 31 * func_120(MISC::IS_BIT_SET(iParam0, 31), -1, 1)) + 1898;
}
...
int func_101(int iParam0, int iParam1, var uParam2, var uParam3, int iParam4, float fParam5)
{
	...
	if (!Global_1935630->f_12 && !ENTITY::IS_ENTITY_DEAD(iParam0))
	{
		...
		if (!uParam2->f_1 & 128 != 0)
		{
			...
			{
				*uParam3 = 128;
				func_136(iParam0, uParam2, *uParam3);
				return 1;
			}
		}
		if (Global_1935630->f_27)
		{
			if (!uParam2->f_1 & 8 != 0)
			{
				...
				else if (func_138(iParam0, iParam1, uParam2))
				{
					*uParam3 = 8;
					func_136(iParam0, uParam2, *uParam3);
					return 1;
		...
		if (Global_1935630->f_26 && func_140(PLAYER::PLAYER_ID(), 0, 1, uParam2->f_1 & 524288 == 0))
		{
		...
		{
			if (func_141(uParam2, 1065353216))
			{
				if (!uParam2->f_1 & 4 != 0)
				{
					if (func_142(Global_35, iParam0, uParam2))
					{
						*uParam3 = 4;
						func_136(iParam0, uParam2, *uParam3);
						return 1;
		...
		if (!uParam2->f_1 & 16 != 0)
		{
			...
			{
				if (func_144(Global_35, iParam0, uParam2, 0))
				{
					*uParam3 = 16;
					func_136(iParam0, uParam2, *uParam3);
					return 1;
			...
			else if (func_144(Global_35, iParam0, uParam2, 1))
			{
				*uParam3 = 16;
				func_136(iParam0, uParam2, *uParam3);
				return 1;
		...
		if (Global_1935630->f_30 || Global_1935630->f_31)
		{
			if (!uParam2->f_1 & 2 != 0)
			{
				if (func_147(uParam2, 4000))
				{
					if ((func_148(iParam0, Global_1935630->f_41, *uParam2 & 128 != 0, 0, *uParam2 & 256 != 0) && func_149(uParam2, iParam0)) && func_150(uParam2, iParam0))
					{
						*uParam3 = 2;
						func_136(iParam0, uParam2, *uParam3);
						return 1;
		...
		if (!uParam2->f_1 & 2 != 0)
		{
			if (uParam2->f_12 < 4f)
			{
				if ((func_148(iParam0, Global_1935630->f_41, *uParam2 & 128 != 0, 1, *uParam2 & 256 != 0) && func_149(uParam2, iParam0)) && func_150(uParam2, iParam0))
				{
					*uParam3 = 2;
					func_136(iParam0, uParam2, *uParam3);
					return 1;
				...
				if (Global_1935630->f_40 == 0)
				{
					if (Global_1935630->f_41 != 0)
					{
						if (*uParam2 & 131072 == 0)
						{
							if (func_151(iParam0, Global_1935630->f_41))
							{
								func_152();
								*uParam3 = 2;
								func_136(iParam0, uParam2, *uParam3);
			...
			if (uParam2->f_12 < 10f)
			{
				if (func_153(uParam2, iParam0) || (uParam2->f_9 > 0 && (func_154() - uParam2->f_9) < 2000))
				{
			...
			if (Global_1935630->f_42 != 0)
			{
				if (*uParam2 & 131072 == 0)
				{
					if (func_155())
					{
						if (func_151(iParam0, Global_1935630->f_42))
						{
							func_152();
							*uParam3 = 2;
							func_136(iParam0, uParam2, *uParam3);
		...
		if (uParam2->f_12 < uParam2->f_26)
		{
			...
			{
				if (func_157(iParam0, iParam1, uParam2))
				{
					*uParam3 = 2048;
					func_136(iParam0, uParam2, *uParam3);
					return 1;
...
void func_103(int iParam0)
{
	if (func_43(iParam0))
	{
		...
		{
			case 1:
				func_164(0, 1, 0, 0, ((Global_1415419->f_19[iParam0 /*12*/])->f_7 / 4), 0, 0, 1);
				func_164(1, 1, 0, 0, ((Global_1415419->f_19[iParam0 /*12*/])->f_7 / 4), 0, 0, 1);
				break;
			
			case 37:
				func_164(60, 1, 0, 0, ((Global_1415419->f_19[iParam0 /*12*/])->f_7 / 4), 0, 0, 1);
				break;
		}
	}
}

void func_104(int iParam0, vector3 vParam1)
{
	int iVar0;
	int iVar1;
	...
	while (iVar0 < 10)
	{
		...
		{
			if (func_119((Global_32073.f_2697.f_1495[iVar0 /*4*/])->f_1, vParam1, 1056964608, 1))
			{
				return;
			}
		}
...
int func_119(vector3 vParam0, vector3 vParam3, float fParam6, bool bParam7)
{
	if (fParam6 < 0f)
	{
		fParam6 = 0f;
...
void func_134(var uParam0, bool bParam1, int iParam2)
{
	...
	if (!uParam0->f_1 & 1024 != 0)
	{
		if (!ENTITY::DOES_ENTITY_EXIST(uParam0->f_14))
		{
			if (func_179(uParam0))
			{
				uParam0->f_15 = func_154();
			}
		}
		else if (uParam0->f_15 > 0)
		{
			if ((func_154() - uParam0->f_15) > 500)
			{
...
int func_140(int iParam0, bool bParam1, int iParam2, bool bParam3)
{
	struct<11> Var0;
	int iVar17;
	struct<11> Var18;
...
int func_142(var uParam0, int iParam1, var uParam2)
{
	float fVar0;
	int iVar1;
	float fVar2;
...
int func_144(var uParam0, int iParam1, var uParam2, bool bParam3)
{
	vector3 vVar0;
	int iVar3;
	vector3 vVar4;
...
int func_162(int iParam0, var uParam1)
{
	...
	if (uParam1->f_4 == 0)
	{
		uParam1->f_4 = func_154();
	}
	else if (func_154() - uParam1->f_4) > func_214(uParam1)
	{
...
void func_164(int iParam0, int iParam1, int iParam2, int iParam3, int iParam4, int iParam5, bool bParam6, int iParam7)
{
	int iVar0;
