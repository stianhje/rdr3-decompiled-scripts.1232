...
int func_72(var uParam0)
{
	...
	func_155(uParam0, iLocal_14, 3, 1904532698, 0, -1, 0, MISC::GET_RANDOM_FLOAT_IN_RANGE(30f, 50f), 1065353216, 1);
...
int func_93(var uParam0)
{
	if (!func_108(&uLocal_26))
	{
		if (func_200(uParam0, iLocal_15) || func_201(uParam0, iLocal_14))
		{
			...
			PED::FORCE_PED_MOTION_STATE(func_48(uParam0, iLocal_14), -668482597, false, 0, false);
		}
	}
