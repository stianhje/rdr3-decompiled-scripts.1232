...
int func_1(var uParam0)
{
	if (!iLocal_43)
	{
		if (uParam0->f_9 && TASK::_0x841475AC96E794D1((uParam0->f_107[iLocal_14 /*113*/])->f_8.f_23))
		{
			...
			TASK::_TASK_USE_SCENARIO_POINT((uParam0->f_107[iLocal_14 /*113*/])->f_5, (uParam0->f_107[iLocal_14 /*113*/])->f_8.f_23, (uParam0->f_107[iLocal_14 /*113*/])->f_8.f_2, 0, 0, 1, 0, 0, 1f, 0);
...
bool func_109(var uParam0)
{
	...
	if (ENTITY::DOES_ENTITY_EXIST(iLocal_35) && !iLocal_32)
	{
...
void func_126(var uParam0, var uParam1, bool bParam2)
{
	if (bParam2)
	{
...
int func_135(int iParam0, int iParam1, int iParam2, bool bParam3, bool bParam4)
{
	...
	if (func_59(iVar0, 0))
	{
		...
		if ((iParam1 || !func_133(iParam0)) || func_76(iParam0))
		{
...
void func_165(var uParam0, int iParam1, int iParam2, int iParam3, int iParam4)
{
	...
	while (iVar12 < uParam0->f_106)
	{
		...
		else
		{
			if (!STREAMING::IS_MODEL_VALID((uParam0->f_107[iVar12 /*113*/])->f_3))
			{
				...
				{
					(uParam0->f_107[iVar12 /*113*/])->f_3 = _NAMESPACE48::_0xA00DF706C60173D1(func_229((uParam0->f_107[iVar12 /*113*/])->f_1));
				}
...
int func_269(int iParam0, int iParam1, bool bParam2, int iParam3, int iParam4, bool bParam5, float fParam6)
{
	vector3 vVar0;
	vector3 vVar3;
	var uVar6;
...
void func_322(var uParam0, bool bParam1)
{
	...
	if (iVar0 == 761950088)
	{
		...
		sVar3 = func_384(&sVar4, 109029619);
		sVar2 = func_385(uParam0->f_3, 0);
		func_379(uParam0, 1896170705, MISC::_CREATE_VAR_STRING(168, iVar0, sVar2, sVar3, sVar1), 0, bParam1, 0);
	}
	else
	{
		func_379(uParam0, 1896170705, HUD::_GET_LABEL_TEXT_BY_HASH(iVar0), 0, bParam1, 0);
	}
}
...
void func_329(var uParam0, int iParam1, bool bParam2, bool bParam3)
{
	...
	if (bParam3)
	{
		uVar0 = func_387(uParam0, iParam1);
	}
	if (bParam2)
	{
...
int func_351(int iParam0, bool bParam1, bool bParam2, int iParam3, int iParam4, int iParam5, bool bParam6, bool bParam7, bool bParam8, int iParam9, int iParam10, int iParam11, float fParam12, bool bParam13, bool bParam14, bool bParam15, bool bParam16)
{
	...
	iVar1 = func_397(&uVar0, iParam0, bParam1, bParam2, iParam3, iParam4, iParam5, bParam7, bParam8, iParam9, iParam10, iParam11, fParam12, bParam13, bParam14, bParam15, bParam6, bParam16);
	if (!ENTITY::DOES_ENTITY_EXIST(iVar1))
	{
		return 0;
	}
...
int func_355(int iParam0, bool bParam1)
{
	...
	{
		func_248(iParam0, _NAMESPACE48::_0x4F76E3676583D951(func_148(iParam0)));
		if (func_245() == -1)
		{
...
int func_356(int iParam0, bool bParam1, bool bParam2, bool bParam3, int iParam4, bool bParam5)
{
	...
	if ((iParam4 && !func_80(iParam0)) && !ENTITY::IS_ENTITY_DEAD(iVar0))
	{
...
void func_379(var uParam0, int iParam1, char* sParam2, int iParam3, bool bParam4, int iParam5)
{
	int iVar0;
	...
	if (UILOG::_UILOG_IS_ENTRY_REGISTERED(9, iVar0))
	{
		UILOG::_UILOG_ADD_OR_UPDATE_OBJECTIVE(9, func_373(*uParam0), iParam1, sParam2, iParam3, iParam5, 0);
		if (bParam4)
		{
			UILOG::_UILOG_SET_PENDING_DETAILS_ID(1, iVar0);
			Global_1359489->f_361.f_194 = func_427("CAMP_REQUEST", "CAMP_REQUEST_DETAIL", 1997120069, MISC::GET_HASH_KEY(func_375(uParam0->f_3)), 1433015236, "INPUT_FEED_INTERACT_GENERIC", -1507719118, 5000, 0, 0, 0, 0, 1, 1);
		}
	}
}
...
int func_397(var uParam0, int iParam1, bool bParam2, bool bParam3, var uParam4, var uParam5, var uParam6, bool bParam7, bool bParam8, var uParam9, var uParam10, var uParam11, float fParam12, bool bParam13, bool bParam14, bool bParam15, bool bParam16, bool bParam17)
{
	int iVar0;
...
int func_407(int iParam0, bool bParam1, int iParam2, int iParam3, int iParam4, int iParam5, float fParam6, int iParam7, int iParam8, bool bParam9, bool bParam10, bool bParam11, int iParam12, int iParam13, bool bParam14, bool bParam15, bool bParam16, bool bParam17, bool bParam18, bool bParam19, bool bParam20, bool bParam21, bool bParam22, bool bParam23, bool bParam24)
{
	vector3 vVar0;
	bool bVar3;
	int iVar4;
	...
	switch (((*Global_1360165)[iParam0 /*1157*/])->f_11)
	{
		...
		case 3:
			if (!ENTITY::IS_ENTITY_DEAD(Global_1360165[iParam0 /*1157*/]) && !ANIMSCENE::_0x3AB6C7B0BB0DF4B1(Global_1360165[iParam0 /*1157*/], -1))
			{
				...
				func_459(Global_1360165[iParam0 /*1157*/], vVar0, fParam6, 2, 1073741824);
			}
			else if (bParam16)
			{
...
int func_442(var uParam0, int iParam1)
{
	...
	while (iVar2 <= iVar1)
	{
		...
		else
		{
			...
			vVar13 = { func_482(ENTITY::GET_ENTITY_COORDS((uParam0->f_107[iParam1 /*113*/])->f_5, true, false), vVar3, 1065353216) };
	...
	switch (((*Global_1360165)[iParam0 /*1157*/])->f_70.f_12)
	{
		...
		case 3:
			...
			if ((bParam2 && !func_239(vVar0)) && !func_240(vVar0, ENTITY::GET_ENTITY_COORDS(((*Global_1360165)[iParam0 /*1157*/])->f_124, true, false), 1056964608, 1))
			{
				...
				func_459(((*Global_1360165)[iParam0 /*1157*/])->f_124, vVar0, fParam6, 2, 1073741824);
			}
			if (bParam1)
			{
				if (!ENTITY::_0x88AD6CC10D8D35B2(((*Global_1360165)[iParam0 /*1157*/])->f_124))
...
void func_459(int iParam0, vector3 vParam1, float fParam4, int iParam5, int iParam6)
{
	...
	if (func_127(iParam5, 2))
	{
		...
		{
			ENTITY::_0x203BEFFDBE12E96A(iParam0, vParam1, fParam4, 1, func_127(iParam5, 32), 1);
		}
		else
		{
			ENTITY::_0x203BEFFDBE12E96A(iParam0, vParam1, fParam4, 1, func_127(iParam5, 32), 1);
...
int func_475(var uParam0, var uParam1, var uParam2, bool bParam3)
{
	*uParam1 = INVENTORY::_0x640F890C3E5A3FFD(func_425(bParam3), uParam0, uParam2);
	if (*uParam1 >= 0)
	{
		return 1;
	}
...
void func_490(int iParam0, int iParam1)
{
	...
	{
		PED::_0x931B241409216C1F(func_129(iParam1), iParam0, 0);
...
int func_497(int iParam0, int iParam1, bool bParam2, int iParam3)
{
	...
	if (iParam3 && ENTITY::DOES_ENTITY_EXIST(func_129(iParam0)))
	{
		iVar10 = 0;
		while (iVar10 < iVar7)
		{
...
bool func_515(int iParam0, int iParam1, bool bParam2, bool bParam3, int iParam4, bool bParam5, int iParam6, int iParam7, int iParam8, int iParam9, bool bParam10, bool bParam11, bool bParam12, bool bParam13)
{
	...
	if (iParam9 < 0)
	{
		if (iParam0 != Global_35 && func_535(bVar0))
		{
	...
	{
		func_537(bVar0, iParam9, bParam2, bParam5, iParam4, bParam11, 752097756, 0);
	}
	else if (!bParam13)
	{
		fVar25 = 0f;
		func_538(iParam0, &bVar0, &fVar25);
...
{
	return func_560(iParam0, *uParam1, iParam2, bParam3) > 0;
}
...
int func_555(int iParam0, bool bParam1)
{
	...
	if (WEAPON::_0xD955FEE4B87AFA07(iParam0))
	{
		if (bParam1)
		{
			return func_565(-1185145312, 0) > 0;
		}
		else
		{
			return 1;
