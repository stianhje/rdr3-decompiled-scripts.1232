#region Local Var
	...
	var uLocal_12 = 0;
	var uLocal_13 = 0;
	struct<8> Local_14 = { 0, 0, 0, 0, 0, 1, 0, 0 } ;
	int iLocal_22 = 0;
	int iLocal_23 = 0;
...
void func_8(var uParam0)
{
	...
	switch (Local_14)
	{
		case 0:
			...
			while (iVar2 <= 0)
			{
				if (!func_54(Local_14.f_5[iVar2], func_53(iVar2)))
				{
					return;
				}
				iVar2++;
			...
			break;
		case 1:
			if (!func_55(Global_35, &(Local_14.f_5[0]), 1, 0))
			{
				return;
			}
			if (!func_56(iVar1, 2, 4))
			{
				return;
			}
			func_52(&Local_14, 2);
		...
		case 2:
			...
			break;
		case 3:
			Local_14.f_7 = GRAPHICS::START_PARTICLE_FX_LOOPED_AT_COORD(func_57(), func_58(0), 0f, 0f, 0f, 1f, false, false, false, false);
			func_25(&(Local_14.f_1));
			func_52(&Local_14, 4);
			break;
		case 4:
			if (func_59(&(Local_14.f_1)) > 60f)
			{
				GRAPHICS::STOP_PARTICLE_FX_LOOPED(Local_14.f_7, false);
				func_60(uParam0);
				func_52(&Local_14, 5);
			}
			break;
...
void func_9(var uParam0)
{
	...
	while (iVar0 <= 0)
	{
		func_61(Local_14.f_5[iVar0]);
		iVar0++;
	}
	if (GRAPHICS::DOES_PARTICLE_FX_LOOPED_EXIST(Local_14.f_7))
	{
		GRAPHICS::STOP_PARTICLE_FX_LOOPED(Local_14.f_7, false);
	}
...
bool func_11(int iParam0, int iParam1)
{
	...
	return (Global_40.f_8863[func_63(iParam0, 1)] && iParam1) != 0;
}
...
bool func_16(int iParam0)
{
	...
	{
		return func_68(((*Global_1835011)[iParam0 /*74*/])->f_1, 1);
	}
...
int func_27(var uParam0, bool bParam1)
{
	...
	if (bParam1)
	{
		...
		else if (func_14(Global_35, uParam0->f_6.f_2, 1) > (uParam0->f_6.f_1 + 0.5f) || !func_77(Global_35, uParam0->f_6.f_2, 0))
		{
			return 1;
		}
	}
	else
	{
		...
		else if (func_14(Global_35, uParam0->f_6.f_2, 1) <= uParam0->f_6.f_1 && func_77(Global_35, uParam0->f_6.f_2, 0))
		{
			return 1;
		}
	}
...
void func_28(var uParam0)
{
	if (!func_33(uParam0->f_6.f_8))
	{
		if (*uParam0 == 404434344)
		{
			if (func_51(*uParam0))
			{
				uParam0->f_6.f_8 = func_78("DISCO_FOCUS", -719620017, Global_35, 0, 0, 0, 0, 5, 1070386381, 570, 4000, 10, 1073741824, 0, 1704213876, 0, 0);
				func_34(uParam0->f_6.f_8, 0, 1);
			}
			else
			{
				uParam0->f_6.f_8 = func_78("DISCO_EXAMINE", -719620017, Global_35, 0, 0, 0, 0, 5, 1070386381, 570, 4000, 10, 1073741824, 0, 1704213876, 0, 0);
			}
		}
		else if (*uParam0 == -1761578407)
		{
		...
		else if (*uParam0 == 1861313914)
		{
			...
			{
				uParam0->f_6.f_8 = func_78("DISCO_EXAMINE", -719620017, Global_35, 2, 0, 0, 0, 5, 1070386381, 570, 4000, 10, 1073741824, 0, 1753096650, 0, 0);
			}
		}
		...
		{
			uParam0->f_6.f_8 = func_78("DISCO_EXAMINE", -719620017, Global_35, 0, 0, 0, 0, 5, 1070386381, 570, 4000, 10, 1073741824, 0, 1753096650, 0, 0);
		}
		func_79(uParam0->f_6.f_8, 13, 1, 1);
...
void func_32(int iParam0, int iParam1)
{
	...
	Global_40.f_8863[func_63(iParam0, 1)] = (Global_40.f_8863[func_63(iParam0, 1)] || iParam1);
}
...
void func_35(var uParam0)
{
	...
	if (*uParam0 == -321841939)
	{
		if (func_84(uParam0->f_4) != 0)
		{
			...
			{
				MAP::_0xD8C7162AB2E2AF45(func_84(uParam0->f_4));
			}
			func_32(*uParam0, 8);
		}
	}
	else
	{
		...
		{
			if (!MAP::_0x3F81EA4275D39D6F(func_85(*uParam0, uParam0->f_4)))
			{
				MAP::_0xD8C7162AB2E2AF45(func_85(*uParam0, uParam0->f_4));
			}
			func_32(*uParam0, 8);
		}
		func_86(uParam0);
...
void func_36(var uParam0, bool bParam1)
{
	...
	if (bParam1)
	{
		iVar0 = func_90(*uParam0, func_89(), uParam0->f_4);
	}
	else
	{
		iVar0 = func_91(*uParam0, uParam0->f_4);
	}
	if (iVar0 != 0)
	{
		if (bParam1)
...
int func_46(var uParam0)
{
	...
	{
		func_99(*uParam0, &Var0);
		if (FIRE::_GET_ENTITY_INSIDE_EXPLOSION_AREA(-1, Var0, Var0.f_3, Var0.f_6) == func_100(Global_35))
		{
			return 1;
		}
...
void func_47(int iParam0, int iParam1, int iParam2, char* sParam3, int iParam4, bool bParam5, float fParam6, int iParam7)
{
	...
	if ((Global_36615 && func_101(iParam1)) != 0)
	{
		return;
	}
	...
	{
		func_103(iVar0, 0, iParam0, iParam1, sParam3, iParam4, bParam5, iParam7);
	}
	else
	{
		iVar1 = -1;
		...
		if (iVar1 >= 0)
		{
			func_104(iVar1, iVar0, iParam0, iParam1, iParam4, bParam5);
		}
		else
		{
			func_103(iVar0, 1, iParam0, iParam1, sParam3, iParam4, bParam5, 0);
		}
	}
}
...
struct<11> func_53(int iParam0)
{
	...
	{
		case 0:
			Var0 = { 2383.667f, 2032.578f, 171.6665f };
			Var0.f_3 = { 0f, 0f, 0f };
			Var0.f_6 = { 5f, 5f, 5f };
			Var0.f_9 = "METEOR_SHOWER_CLIFF_SPAWN";
			Var0.f_10 = 665633627;
			break;
	}
	return Var0;
...
int func_54(var uParam0, struct<10> Param1, var uParam11)
{
	if (!VOLUME::_0x92A78D0BEDB332A3(*uParam0))
	{
...
Vector3 func_58(int iParam0)
{
	...
	{
		case 0:
			return 2895.893f, 1650.213f, 1000.863f;
		default:
			break;
	}
	return 0f, 0f, 0f;
...
void func_70(var uParam0)
{
	...
	if (*uParam0 == 404434344)
	{
		...
		if (!VOLUME::_0x92A78D0BEDB332A3(uParam0->f_6.f_9))
		{
			uParam0->f_6.f_9 = VOLUME::_CREATE_VOLUME_BOX_WITH_CUSTOM_NAME(vVar0, vVar3, vVar6, func_111(uParam0));
		}
	}
	else if (*uParam0 == -1761578407)
	{
	...
	else if ((*uParam0 == -1243267511 || *uParam0 == 1535254161) || *uParam0 == -607940493)
	{
		...
		if (!VOLUME::_0x92A78D0BEDB332A3(uParam0->f_6.f_9))
		{
			...
			{
				uParam0->f_6.f_9 = VOLUME::_CREATE_VOLUME_CYLINDER_WITH_CUSTOM_NAME(vVar0, vVar3, vVar6, func_111(uParam0));
			}
		}
	}
	else if (*uParam0 == -890175011)
...
int func_75(var uParam0)
{
	...
	{
		case -1300082860:
			if (func_114(Global_35, func_107(uParam0, 0), 3f, 1, 1))
			{
				return 1;
			}
			break;
...
int func_76(var uParam0, int iParam1)
{
	...
	if (!func_115(iParam1, 2048) && !func_119(0))
	{
		return 0;
	}
	...
	else if (func_122(Global_35, 713668775))
	{
		return 0;
	}
	return 1;
...
bool func_77(int iParam0, vector3 vParam1, float fParam4)
{
	vector3 vVar0;
	vector3 vVar3;
...
void func_86(var uParam0)
{
	...
	{
		if (!MAP::_0x3F81EA4275D39D6F(func_125(*uParam0)))
		{
			MAP::_0xD8C7162AB2E2AF45(func_125(*uParam0));
		}
		func_32(*uParam0, 8);
	}
}
...
int func_91(int iParam0, int iParam1)
{
	...
	iVar0 = func_90(iParam0, 1, iParam1);
	if (!HUD::_JOURNAL_CAN_WRITE_ENTRY(iVar0))
	{
		return iVar0;
	}
	iVar0 = func_90(iParam0, 0, iParam1);
	if (!HUD::_JOURNAL_CAN_WRITE_ENTRY(iVar0))
	{
		return iVar0;
	}
...
int func_94()
{
	...
	if (ANIMSCENE::_0x3AB6C7B0BB0DF4B1(Global_35, -1) || func_122(Global_35, 1369124074))
	{
		return 0;
	}
	...
	if (INVENTORY::_0x3D10D7179D7034AF(func_130(0), iVar0, 0))
	{
		return 0;
	}
...
void func_103(int iParam0, bool bParam1, int iParam2, int iParam3, char* sParam4, int iParam5, bool bParam6, int iParam7)
{
	int iVar0;
	int iVar1;
	int iVar2;
	...
	Global_40.f_11095.f_35 = func_135(Global_40.f_11095.f_35, iVar3, iVar2);
	iVar1 = func_132();
	if ((iVar1 != iVar0 && (iVar1 != 0 || iParam3 == -1091304842)) || iParam7)
	{
		iVar6 = func_136(iVar1);
		func_138(func_137(), 0, 4000);
	...
	if (iParam0 != 0)
	{
		if (iParam0 > 0)
		{
			...
			if (!bParam1)
			{
				...
				{
					sParam4 = func_143(iParam3);
				}
				if (MISC::IS_STRING_NULL_OR_EMPTY(sParam4))
				{
					func_144(MISC::_CREATE_VAR_STRING(2, "PLAYER_HONOR_CHANGE_POS"), "ITEMTYPE_TEXTURES", MISC::GET_HASH_KEY("TRANSACTION_HONOR_GOOD"), 0, 109029619, "Honor_Display_Sounds", sVar7, 0, 1);
				}
				else
				{
					func_144(MISC::_CREATE_VAR_STRING(2, "PLAYER_HONOR_CHANGE_POS_EVENT"), "ITEMTYPE_TEXTURES", MISC::GET_HASH_KEY("TRANSACTION_HONOR_GOOD"), 0, 109029619, "Honor_Display_Sounds", sVar7, 0, 1);
				}
			}
		}
		else
		{
			func_142(func_141(-1636809477), 1);
			...
			if (!bParam1)
			{
				...
				if (MISC::IS_STRING_NULL_OR_EMPTY(sParam4))
				{
					func_144(MISC::_CREATE_VAR_STRING(2, "PLAYER_HONOR_CHANGE_NEG"), "ITEMTYPE_TEXTURES", MISC::GET_HASH_KEY("TRANSACTION_HONOR_BAD"), 1, 859817522, "Honor_Display_Sounds", sVar7, 0, 1);
				}
				else
				{
					func_144(MISC::_CREATE_VAR_STRING(2, "PLAYER_HONOR_CHANGE_NEG_EVENT"), "ITEMTYPE_TEXTURES", MISC::GET_HASH_KEY("TRANSACTION_HONOR_BAD"), 1, 859817522, "Honor_Display_Sounds", sVar7, 0, 1);
				}
			}
		}
	}
	Var8 = { func_141(-1990689970) };
...
void func_104(int iParam0, int iParam1, int iParam2, int iParam3, int iParam4, bool bParam5)
{
...
Vector3 func_108(var uParam0, int iParam1)
{
	switch (*uParam0)
	{
		case -777592153:
...
int func_114(int iParam0, vector3 vParam1, float fParam4, bool bParam5, bool bParam6)
{
	if (!ENTITY::DOES_ENTITY_EXIST(iParam0))
	{
		return 0;
...
int func_120(var uParam0)
{
	...
	else if (PED::IS_PED_IN_ANY_VEHICLE(Global_35, true))
	{
		...
		if ((!func_115(uParam0, 16) && !PED::IS_PED_ON_MOUNT(Global_35)) && VEHICLE::_0x2963B5C1637E8A27(iVar0) == Global_35)
		{
			return 0;
		}
	}
...
var func_144(char* sParam0, char* sParam1, int iParam2, int iParam3, int iParam4, char* sParam5, char* sParam6, int iParam7, int iParam8)
{
	struct<4> Var0;
	struct<7> Var13;
	var uVar20;
...
int func_157(var uParam0)
{
	...
	if (!func_115(uParam0, 16) && !func_186(iVar0, 0))
	{
		return 0;
	}
	return 1;
...
int func_165(int iParam0, int iParam1, bool bParam2)
{
	...
	iVar2 = INVENTORY::_0xE787F05DFC977BDE(func_130(bParam2), iParam0, 0);
	return iVar2;
}
...
{
	*uParam1 = INVENTORY::_0x80D78BDC9D88EF07(func_130(bParam4), sParam0, iParam3, uParam2);
	if (*uParam1 >= 0)
	{
		return 1;
	}
...
{
	*uParam1 = INVENTORY::_0x640F890C3E5A3FFD(func_130(bParam3), uParam0, uParam2);
	if (*uParam1 >= 0)
	{
		return 1;
	}
...
struct<4> func_205(int iParam0, var uParam1, var uParam2, var uParam3, var uParam4, int iParam5, bool bParam6)
{
	...
	INVENTORY::_0x886DFD3E185C8A89(func_130(bParam6), &uParam1, iParam0, iParam5, &Var0);
	return Var0;
}
