...
void func_64(int iParam0, int iParam1, int iParam2, bool bParam3, int iParam4, int iParam5)
{
	...
	sVar1 = func_113(iParam0, iParam1, iParam2, iParam4, iParam5, bParam3, &uVar0);
	...
	else
	{
		...
		if (!MISC::_SHOULD_USE_24_HOUR_CLOCK())
		{
			...
			sVar2 = MISC::_CREATE_VAR_STRING(674, sVar8, iVar4, func_125(&sVar6, 109029619), sVar9, func_125(&sVar10, 109029619));
		}
		else
		{
			...
			IntToString(&sVar10, BUILTIN::ROUND(fVar7), 8);
			sVar2 = MISC::_CREATE_VAR_STRING(162, sVar8, iVar4, func_125(&sVar6, 109029619), func_125(&sVar10, 109029619));
		}
...
int func_87(int iParam0, bool bParam1)
{
	...
	{
		func_146(iParam0, _NAMESPACE48::_0x4F76E3676583D951(func_145(iParam0)));
		if (func_20() == -1)
		{
			if (func_143(iParam0, 2048))
			{
				_NAMESPACE48::_0x49A8C2CD97815215(func_108(iParam0));
				func_147(iParam0, 2048);
			}
			_NAMESPACE48::_0xFCC6DB8DBE709BC8(func_108(iParam0));
		}
		return 0;
	}
	...
	if (_NAMESPACE48::_0x800DF3FC913355F3(func_108(iParam0)))
	{
		func_147(iParam0, 128);
		return 1;
	}
	func_146(iParam0, _NAMESPACE48::_0x4F76E3676583D951(func_145(iParam0)));
	_NAMESPACE48::_0x4F81EAD1DE8FA19B(func_108(iParam0));
	if (func_143(iParam0, 2048))
	{
		_NAMESPACE48::_0x49A8C2CD97815215(func_108(iParam0));
		func_147(iParam0, 2048);
...
int func_96(int iParam0, var uParam1, int iParam2, int iParam3)
{
	int iVar0;
	int iVar1;
	int iVar2;
...
bool func_107(int iParam0, int iParam1)
{
	...
	if (iParam1 && !ENTITY::DOES_ENTITY_EXIST(func_162(iParam0)))
	{
		return false;
	}
	return !_NAMESPACE48::_0xEB98B38CA60742D7(func_108(iParam0));
}
...
char* func_113(int iParam0, int iParam1, int iParam2, int iParam3, var uParam4, var uParam5, var uParam6)
{
	char* sVar0;
...
int func_144(int iParam0, bool bParam1)
{
	...
	func_190(iParam0);
	_NAMESPACE48::_0xFC77C5B44D5FF7C0(func_108(iParam0));
	func_146(iParam0, 0);
	return 1;
}
...
var func_158(int iParam0, int iParam1, int iParam2)
{
...
int func_160(int iParam0, int iParam1, int iParam2, int iParam3, int iParam4)
{
	...
	uVar0 = func_158(iParam0, iParam1, iParam2);
	iVar1 = iParam3;
	func_196(iVar1, 0);
	func_197(iVar1, 0);
	func_198(iVar1, 0);
	func_199(iVar1, 0);
	func_200(iVar1, uVar0);
	if (iParam4 != 0)
	{
...
int func_208(vector3 vParam0, int iParam3)
{
	...
	func_220(iParam3, &vVar0, &Var3, &fVar6);
	if (func_221(vParam0, vVar0, Var3, Var3.f_1, fVar6))
	{
		return 1;
	}
	return 0;
