...
int func_72(var uParam0)
{
	...
	func_151(uParam0, 1.1188f, -1.318f, 1f, 0f, 1f, 1f, 3f, -1612834106, 2017216891, 1, 1, 1);
	func_151(uParam0, -2.1437f, -0.9055f, 1f, 0f, 1f, 1f, 3f, -1612834106, 2017216891, 1, 1, 1);
	func_151(uParam0, 1.685f, 0.1375f, 0f, 0f, 1f, 1f, 3f, -1612834106, 1267380940, 1, 1, 1);
	iLocal_16 = func_152(uParam0, -1510839859, 1.61377f, -0.530518f, -0.0831604f, "p_chair02x", 1, 0, 1);
	func_152(uParam0, -1510839859, -2.06982f, -0.913086f, -0.0831604f, "p_chair02x^1", 1, 0, 1);
	iLocal_17 = func_152(uParam0, 1210783447, 0f, 0f, 0f, "p_cs_book04x", 0, 0, 1);
	iLocal_18 = func_152(uParam0, -548150401, 0f, 0f, 0f, "p_cigar02x", 0, 1, 1);
	func_153(uParam0, "script@vignette@dutch_and_hosea_11@base", 1, 1, 0, 0);
	uLocal_19 = func_153(uParam0, "script@vignette@dutch_and_hosea_11@action", 0, 0, 1, 0);
	func_154(uParam0, "CDH11AU");
	func_155(uParam0, -1276706088, -971301505);
	func_156(uParam0, uLocal_19, -1, 0.7f);
	func_157(uParam0, iLocal_14, 3, 920578187, "WORLD_CAMP_DUTCH_SMOKE_CIGAR_MALE_A", -1, 1);
	func_158(uParam0, iLocal_14, 2, -1426662425, "PROP_HUMAN_SEAT_CHAIR_GENERIC_MALE_A", -1, 0, -1073741824, 1065353216, 1);
	func_159(uParam0, iLocal_14, 1, -1);
	func_157(uParam0, iLocal_15, 3, 935336933, "PROP_HUMAN_SEAT_BENCH_MALE_B", iLocal_16, 0);
	func_158(uParam0, iLocal_15, 3, 1253642035, "PROP_HUMAN_SEAT_CHAIR_READING_MALE_A", iLocal_16, 0, -1073741824, 0f, 1);
...
{
	func_195(func_194(uParam0, iLocal_18), 0);
	return 1;
}
...
void func_163(var uParam0, int iParam1, char* sParam2)
{
...
int func_387(int iParam0, bool bParam1, bool bParam2, var uParam3, var uParam4, var uParam5, float fParam6, bool bParam7, bool bParam8, bool bParam9, bool bParam10)
{
	...
	switch (((*Global_1360165)[iParam0 /*1157*/])->f_70.f_12)
	{
		...
		case 3:
			...
			sVar12 = func_422(iParam0, func_284());
		...
		case 7:
			switch (iParam0)
			{
				...
				case 14:
					...
					break;
				case 4:
					if (func_326(747937920, 1) && !func_390(((*Global_1347702)[1 /*49*/])->f_15, 1))
					{
						iVar1[0] = -1155031950;
					}
					else
