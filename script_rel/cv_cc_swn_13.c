...
int func_72(var uParam0)
{
	...
	func_151(uParam0, -1.4436f, 1.4525f, 0f, 129f, 1.3475f, 2.5425f, 5f, -1612834106, 1243438920, 1, 1, 1);
	func_151(uParam0, -1.6811f, -0.8475f, 0f, 103.5f, 1.1f, 1.1f, 5f, -1612834106, 1632043240, 1, 1, 1);
	func_151(uParam0, 4.3064f, 2.9775f, 0f, 0f, 1.2f, 1.2f, 5f, -1612834106, -1689743484, 1, 1, 1);
	func_152(uParam0, 927991752, 0f, 0f, 0f, "CIGARETTE", 0, 1, 1);
	iLocal_18 = func_152(uParam0, -82199229, 0f, 0f, 0f, "MUG", 0, 0, 1);
	func_153(uParam0, "script@vignette@swanson_13@base", 1, 1, 0, 0);
	uLocal_17 = func_153(uParam0, "script@vignette@swanson_13@action", 2, 0, 1, 0);
	func_154(uParam0, "CSW13AU");
	func_155(uParam0, -1246921074, 949570959);
	func_156(uParam0, uLocal_17, -1, 0.87f);
	func_157(uParam0, iLocal_14, 3, 984062573, "WORLD_HUMAN_DRUNK_BAR_SLUMPED_MALE_A", -1, 1);
	func_158(uParam0, iLocal_14, 0.625f);
	func_159(uParam0, iLocal_14, 3, -1);
	func_157(uParam0, iLocal_15, 3, -2036140949, "PROP_HUMAN_SEAT_BENCH_PORCH_SMOKING_MALE_A", -1, 0);
	func_157(uParam0, iLocal_16, 3, -1489483851, "WORLD_HUMAN_COFFEE_DRINK_FEMALE_C", -1, 1);
	func_160(uParam0, iLocal_16, 1, -1489483851, 0, -1, 0, -1073741824, 1065353216, 1);
...
void func_158(var uParam0, int iParam1, float fParam2)
{
