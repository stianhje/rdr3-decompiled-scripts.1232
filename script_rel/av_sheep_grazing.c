...
void func_14(var uParam0, vector3 vParam1, vector3 vParam4)
{
	...
	func_49(uParam0, 1, "SGP_DOG", joaat("a_c_dogamericanfoxhound_01"), OBJECT::_GET_OBJECT_OFFSET_FROM_COORDS(vParam1, vParam4.z, 1.25f, 0f, 0f), vParam4.z, 1, 1, 1, 1, 41788943, 1);
...
int func_209(int iParam0, int iParam1)
{
	...
	if (func_251(iParam0, 1, 0, 0) != joaat("weapon_lasso"))
	{
		return 0;
	}
