	...
	if (iLocal_145 < 13)
	{
		if (!func_47(*(Local_65[iLocal_145 /*6*/])))
		{
			...
			if (func_8((Local_65[iLocal_145 /*6*/])->f_5, 0))
			{
				...
				WEAPON::_GIVE_WEAPON_TO_PED_2((Local_65[iLocal_145 /*6*/])->f_5, -183018591, 100, true, true, 0, false, 0.5f, 1f, 752097756, false, 0f, false);
...
int func_23()
{
	...
	if (iLocal_145 < 3)
	{
		...
		else if ((iLocal_145 % 3) == 0)
		{
			...
			{
				WEAPON::_GIVE_WEAPON_TO_PED_2(Local_44[iLocal_144 /*5*/][iLocal_145], 1742487518, 100, true, false, 1, false, 0.5f, 1f, 752097756, false, 0f, false);
			}
		}
		else
		{
			WEAPON::_GIVE_WEAPON_TO_PED_2(Local_44[iLocal_144 /*5*/][iLocal_145], -183018591, 100, true, true, 0, false, 0.5f, 1f, 752097756, false, 0f, false);
		}
		iLocal_145++;
	}
	else
