...
int func_72(var uParam0)
{
	...
	func_151(uParam0, -1.36f, -0.02f, 0.5f, 0f, 1.4f, 1.4f, 3f, -1612834106, 1632043240, 1, 1, 1);
	func_151(uParam0, -0.2379f, -1.0318f, 0.5f, 0f, 1.4f, 1.4f, 3f, -1612834106, 1243438920, 1, 1, 1);
	func_152(uParam0, -755866836, 0f, 0f, 0f, "SPOON", 0, 1, 1);
	iLocal_17 = func_152(uParam0, 587066646, 0f, 0f, 0f, "BOWL", 0, 1, 1);
	STREAMING::REQUEST_MODEL(iLocal_19, false);
	func_153(uParam0, "script@vignette@swanson_9@base", 1, 1, 0, 0);
	uLocal_16 = func_153(uParam0, "script@vignette@swanson_9@action", 0, 0, 1, 0);
	func_154(uParam0, "CSWN9AU");
	func_155(uParam0, -766693256, -252534689);
	func_156(uParam0, uLocal_16, -1, 0.92f);
	func_157(uParam0, iLocal_14, 2, 1, 0, 0, 0);
	func_158(uParam0, iLocal_15, 2, -2097328111, "GENERIC_SEAT_CHAIR_TABLE_SCENARIO_LF_FWD_MALE_A", -1, 0, -1073741824, 1065353216, 1);
...
{
	return STREAMING::HAS_MODEL_LOADED(iLocal_19);
}
...
{
	iLocal_18 = WEAPON::_0x9888652B8BA77F73(-618550132, 1, uParam0->f_23, 1, 1065353216);
...
{
	if (!iLocal_20 && ENTITY::DOES_ENTITY_EXIST(iLocal_18))
	{
		func_192(uParam0, iLocal_18, "KNIFE");
		iLocal_20 = 1;
		return 0;
	}
	return 1;
...
int func_93(var uParam0)
{
	...
	{
		func_202(uParam0, iLocal_15, 1, 0);
	}
	return 1;
}
...
void func_157(var uParam0, int iParam1, int iParam2, int iParam3, int iParam4, char* sParam5, char* sParam6)
{
...
void func_160(var uParam0, int iParam1, char* sParam2, int iParam3, int iParam4)
{
...
void func_192(var uParam0, int iParam1, char[4] cParam2)
{
	int iVar0;
	...
	while (iVar0 < uParam0->f_1984)
	{
		...
		{
			func_289(iParam1, &(uParam0->f_1984[iVar0]), cParam2);
		}
		iVar0++;
	}
}
...
int func_201(var uParam0)
{
	...
	switch (uParam0->f_1699)
	{
		case 0:
			...
			break;
		case 1:
			uParam0->f_1707 = func_306("INTERACT_INSULT", 648122183, 0, 570, 4000, 10, 1073741824, 0, 1065353216, 0, 3, 1704213876, 0);
			func_307(uParam0->f_1707, iVar0, 0, 1, -1);
			if (uParam0->f_1709)
			{
				uParam0->f_1708 = func_306("INTERACT_GREET", -163964935, 0, 570, 4000, 10, 1073741824, 0, 1065353216, 0, 3, 1704213876, 0);
				func_307(uParam0->f_1708, iVar0, 0, 1, -1);
			}
			uParam0->f_1700 = (MISC::GET_GAME_TIMER() + uParam0->f_1701);
			uParam0->f_1699++;
			break;
		case 2:
			if (func_308(uParam0->f_1707, 1) || func_308(uParam0->f_1708, 1))
			{
				func_309(&(uParam0->f_1707), 1, 1);
				func_309(&(uParam0->f_1708), 1, 1);
		...
		case 3:
			...
			func_310(Global_35, &Var1, 0, iVar0, 1, 0, 0, 1);
			uParam0->f_1699++;
			break;
		case 4:
			if (!AUDIO::IS_ANY_SPEECH_PLAYING(Global_35))
			{
				...
				func_310(iVar0, &Var1, 0, Global_35, 1, 0, 0, 1);
				uParam0->f_1699++;
			}
			break;
		case 5:
...
int func_306(char* sParam0, int iParam1, int iParam2, int iParam3, int iParam4, int iParam5, int iParam6, int iParam7, int iParam8, int iParam9, int iParam10, int iParam11, bool bParam12)
{
	int iVar0;
	int iVar1;
...
void func_307(int iParam0, int iParam1, int iParam2, int iParam3, int iParam4)
{
	int iVar0;
...
var func_310(int iParam0, var uParam1, int iParam2, int iParam3, int iParam4, int iParam5, int iParam6, int iParam7)
{
	struct<7> Var0;
		...
		case 7:
			switch (iParam0)
			{
				...
				case 14:
					...
					break;
				case 4:
					if (func_333(747937920, 1) && !func_412(((*Global_1347702)[1 /*49*/])->f_15, 1))
					{
						iVar1[0] = -1155031950;
					}
					else
