...
int func_15(int iParam0)
{
	...
	uVar0 = func_48(func_46(8192), 0, 3, func_47(8192));
	func_49(&uVar0, &uVar1);
	uVar3 = func_50(8192, &fVar2);
	if (!func_51(uVar1, 8))
	{
		if (!func_51(uVar1, 4) || (uVar3 && (func_52() - fVar2) >= 24f))
		{
			return func_55(&uLocal_14, 8192, &uLocal_14, func_53(), 0, func_54(), 0, 0, 0);
		}
	}
	return 1;
}
...
int func_48(int iParam0, int iParam1, int iParam2, int iParam3)
{
	...
	iVar5 = func_88(iVar3, iVar4, iParam2);
	if (Global_1572887->f_12 == -1)
	{
		iVar0 = iVar1;
		iVar0 = iVar1;
		...
		{
			iVar6 = iVar0;
			if (func_89(iVar6) == iVar5)
			{
				return iVar6;
			}
			if (func_89(iVar6) == 0)
			{
				return func_90(iVar3, iVar4, iParam2, iVar0, iParam3);
			}
			iVar0++;
		}
		iVar1 = 751;
	...
	else
	{
		...
		while (iVar0 <= iVar2)
		{
			...
			{
				return func_90(iVar3, iVar4, iParam2, iVar0, 0);
			}
			iVar0++;
		}
	}
...
float func_52()
{
	...
	iVar4 = func_97(iVar6);
	iVar5 = func_98(iVar6);
	iVar3 = func_99(iVar5, iVar4);
	iVar2 = func_100(iVar6);
	iVar1 = func_101(iVar6);
...
int func_55(var uParam0, int iParam1, var uParam2, int iParam3, int iParam4, char* sParam5, int iParam6, int iParam7, bool bParam8)
{
	int iVar0;
	vector3 vVar1;
	...
	if (!VOLUME::_0x92A78D0BEDB332A3(func_102(iParam3)))
	{
		return 0;
	}
	...
	if (bParam8)
	{
		...
		if (!func_104(vVar1))
		{
			if (func_105(vVar1, 1, 776, 0))
			{
				return 0;
			}
		}
	}
	if ((iParam6 && func_106(128, 0, 1)) && !iParam1 == 64)
	{
		return 0;
	}
	if (iParam7 && func_107(PLAYER::GET_PLAYER_INDEX(), 1, 1, 1))
	{
		return 0;
	}
	uParam0->f_1 = iParam1;
	uParam0->f_5 = func_48(func_46(iParam1), 0, 3, func_47(iParam1));
	func_49(&(uParam0->f_5), &(uParam0->f_3));
	if (!func_51(uParam0->f_3, 4))
	{
		iVar0 = 4;
	}
	else if (!func_51(uParam0->f_3, 8))
	{
		iVar0 = 8;
	}
	else if (!func_51(uParam0->f_3, 16))
	{
		iVar0 = 16;
	}
	else if (!func_51(uParam0->f_3, 32))
	{
		iVar0 = 32;
	}
	else if (!func_51(uParam0->f_3, 64))
	{
		iVar0 = 64;
	}
	if (iParam1 == 32768)
	...
	if (!func_51(uParam0->f_3, iVar0))
	{
		if (func_51(uParam0->f_3, 2))
		{
			if (!SCRIPTS::IS_THREAD_ACTIVE(*uParam2, false))
			{
...
int func_56(int iParam0, int iParam1, int iParam2, bool bParam3)
{
	...
	if (func_110(iParam0) && !func_111(iParam0))
	{
	}
	if (func_112(iParam0, &iVar0, &iVar1, 0, 0))
	{
		if (func_113(iParam1))
		{
			iVar0 = iParam1;
		...
		while (true)
		{
			if ((!func_110(iParam0) || func_111(iParam0)) || func_114(&Global_1897950))
			{
				func_115(&Global_1897950, 0);
			}
...
void func_69(int iParam0, int iParam1, int iParam2, bool bParam3, int iParam4, int iParam5)
{
	...
	sVar1 = func_119(iParam0, iParam1, iParam2, iParam4, iParam5, bParam3, &uVar0);
	...
	if (func_120(iParam4))
	{
		iVar3 = func_122(iParam4);
	}
	if (uVar0 && bParam3)
	{
		sVar2 = func_124(func_123(iParam2));
	}
	...
	else if ((func_60(iParam0) && func_86(iParam0, 16777216)) && !Global_1894899->f_9)
	{
	...
	{
		iVar4 = func_101(func_96());
		iVar5 = func_127(func_96());
		if (iVar5 < 10)
		{
		...
		if (!MISC::_SHOULD_USE_24_HOUR_CLOCK())
		{
			...
			{
				fVar7 = func_128(fVar7);
				sVar8 = "TIME_AND_TEMP_F";
			}
			IntToString(&sVar10, BUILTIN::ROUND(fVar7), 8);
			sVar2 = MISC::_CREATE_VAR_STRING(674, sVar8, iVar4, func_129(&sVar6, 109029619), sVar9, func_129(&sVar10, 109029619));
		}
		else
		{
			...
			IntToString(&sVar10, BUILTIN::ROUND(fVar7), 8);
			sVar2 = MISC::_CREATE_VAR_STRING(162, sVar8, iVar4, func_129(&sVar6, 109029619), func_129(&sVar10, 109029619));
		}
		Global_1894899->f_9 = 0;
	}
	Global_1934266->f_148 = func_130(sVar1, sVar2, 4000, 0, 0, 0, 0, 1);
}
...
void func_71(int iParam0, bool bParam1)
{
	...
	func_135(func_134(-1532769513, -36357794), 1);
	switch (func_6(iParam0))
	{
		case 0:
		case 2:
		case 11:
			func_135(func_134(-1532769513, 213519508), 1);
			break;
		case 1:
		case 5:
		case 6:
		case 7:
		case 12:
			func_135(func_134(-1532769513, 242571679), 1);
			break;
		case 3:
		case 10:
			func_135(func_134(-1532769513, 1349449307), 1);
			break;
		case 4:
		case 9:
			func_135(func_134(-1532769513, 1140362070), 1);
			break;
		case 8:
			func_135(func_134(-1532769513, -172330899), 1);
			break;
		case 13:
		case 14:
		case 15:
		case 16:
			func_135(func_134(-1532769513, -910218296), 1);
			break;
	}
	switch (iParam0)
	{
...
void func_74(int iParam0, bool bParam1, int iParam2, bool bParam3, bool bParam4)
{
	...
	while (iVar0 < 4)
	{
		...
		if (((func_137(iVar1) && !func_140(iVar1, iParam2)) && (!bParam3 || !func_141(iVar1))) && (!bParam4 || !func_142(iVar1)))
		{
			if (iVar1 != iParam0)
			{
				func_143(iVar0);
...
var func_88(int iParam0, int iParam1, int iParam2)
{
...
int func_90(int iParam0, int iParam1, int iParam2, int iParam3, int iParam4)
{
	...
	uVar0 = func_88(iParam0, iParam1, iParam2);
	iVar1 = iParam3;
	func_152(iVar1, 0);
	func_153(iVar1, 0);
	func_154(iVar1, 0);
	func_155(iVar1, 0);
	func_156(iVar1, uVar0);
	if (iParam4 != 0)
	{
		func_157(iVar1, iParam4);
	}
	return iVar1;
}
...
{
	return (BUILTIN::SHIFT_RIGHT(iParam0, 26) & 31 * func_160(MISC::IS_BIT_SET(iParam0, 31), -1, 1)) + 1898;
}
...
int func_99(int iParam0, int iParam1)
{
	...
	if (iVar1 > 0)
	{
		...
		while (iVar0 < iVar1)
		{
			iVar2 = (iVar2 + func_161(iVar1, iParam1));
			iVar0++;
		}
	}
	return iVar2;
...
int func_105(vector3 vParam0, int iParam3, int iParam4, int iParam5)
{
	var uVar0[4];
	int iVar5[4];
...
int func_106(int iParam0, bool bParam1, int iParam2)
{
	...
	if ((Global_1898164->f_1[0 /*5*/])->f_2 == 8)
	{
		...
		if (func_164(iVar0) && func_165(((*Global_1347702)[iVar0 /*49*/])->f_12, 131072))
		{
			return 0;
		}
	}
...
int func_107(int iParam0, bool bParam1, int iParam2, int iParam3)
{
	...
	{
		return func_166(bParam1, iParam2, iParam3);
	}
	if (Global_1572887->f_12 != -1)
	{
...
int func_108(var uParam0)
{
	...
	if ((!func_51(uParam0->f_3, 32768) && func_50(uParam0->f_1, &fVar1)) && func_167(uParam0->f_1, 0, &fVar0))
	{
		fVar2 = func_52();
		if ((func_52() - fVar1) >= fVar0)
		{
			func_93(&(uParam0->f_3), 32768);
		}
	}
	if (func_51(uParam0->f_3, 32768))
	{
		return 1;
	}
	return 0;
...
int func_112(int iParam0, var uParam1, var uParam2, bool bParam3, bool bParam4)
{
	bool bVar0;
...
{
	if ((iParam0 == 22 || iParam0 == 37) && !func_173())
	{
		return 1;
	}
	if (iParam0 == 61)
...
char* func_119(int iParam0, int iParam1, int iParam2, int iParam3, var uParam4, var uParam5, var uParam6)
{
	char* sVar0;

	if (!MISC::IS_STRING_NULL_OR_EMPTY(&(Global_1894899->f_162)))
	{
		sVar0 = func_175(Global_1894899->f_162);
	}
	if (MISC::IS_STRING_NULL_OR_EMPTY(sVar0) && uParam4)
	{
		sVar0 = func_177(func_176(Global_36));
	}
...
var func_130(char* sParam0, char* sParam1, int iParam2, int iParam3, int iParam4, int iParam5, int iParam6, int iParam7)
{
	struct<4> Var0;
	vector3 vVar13;
	var uVar16;
...
int func_132(int iParam0)
{
	...
	if (func_181())
	{
		if (!func_182(((*Global_1835011)[3 /*74*/])->f_1, 1))
		{
...
{
	func_186((Global_1935369->f_5[iParam0 /*11*/])->f_6, 1);
	func_187((Global_1935369->f_5[iParam0 /*11*/])->f_6, 0);
...
void func_146(int iParam0)
{
	...
	{
		func_190((Global_1914319->f_3[iParam0 /*446*/])->f_21, 0, 1, 0, 0);
	}
	...
	func_191((Global_1914319->f_3[iParam0 /*446*/])->f_10, 0);
...
int func_167(int iParam0, int iParam1, var uParam2)
{
	...
	if (!func_91(iVar0))
	{
		iVar0 = func_48(func_46(iParam0), iParam1, 3, func_47(iParam0));
	}
...
char* func_175(var uParam0, var uParam1, var uParam2, var uParam3, var uParam4, var uParam5, var uParam6, var uParam7)
{
...
int func_206(vector3 vParam0, int iParam3)
{
	...
	func_224(iParam3, &vVar0, &Var3, &fVar6);
	if (func_225(vParam0, vVar0, Var3, Var3.f_1, fVar6))
	{
		return 1;
	}
	return 0;
...
bool func_225(vector3 vParam0, vector3 vParam3, float fParam6, float fParam7, float fParam8)
{
	vector3 vVar0;
	struct<2> Var3;
	float fVar6;
