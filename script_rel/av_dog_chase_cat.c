...
{
	func_33(uParam0, 10766/*func_30*/, 10824/*func_31*/, 11722/*func_32*/);
}
...
{
	func_46(uParam0, "DOG_CHASE_CAT", "", vParam1, vParam4);
	func_47(uParam0, 0, "DCCP_CAT", iLocal_10, OBJECT::_GET_OBJECT_OFFSET_FROM_COORDS(vParam1, vParam4.z, 4f, 3.5f, 0f), (90f + vParam4.z), 1, 1, 1, 1, 41788943, 1);
	func_47(uParam0, 1, "DCCP_DOG", iLocal_11, vParam1, vParam4.z, 1, 1, 1, 1, 41788943, 1);
}
...
int func_31(var uParam0)
{
	...
	if (!&uParam0->f_469[2])
	{
		if (func_62(uParam0, &uLocal_21, 0))
		{
			func_63(uParam0);
			func_64(uParam0);
			uParam0->f_469[2] = 1;
	...
	{
		if (!TASK::_0x916B8E075ABC8B4E(&(uParam0->f_20[1 /*14*/]), 1))
		{
			TASK::_0xE7FA07624574B79A(&(uParam0->f_20[1 /*14*/]), &(uParam0->f_20[0 /*14*/]), 1, 1, 25f, 1, 0, 0, 0);
		}
	}
	switch (iLocal_9)
	{
		case 0:
			...
			{
				func_65(&((uParam0->f_20[0 /*14*/])->f_5), 50, 10, 0);
				uLocal_15[0] = func_66(iLocal_12, (uParam0->f_20[0 /*14*/])->f_5, (uParam0->f_20[0 /*14*/])->f_8, 0, 0, 0);
				TASK::_TASK_USE_SCENARIO_POINT(&(uParam0->f_20[0 /*14*/]), &(uLocal_15[0]), 0, 0, 0, 1, 0, 0, -1082130432, 0);
				func_67(uParam0->f_20[0 /*14*/], 1, 1);
				PED::SET_PED_KEEP_TASK(&(uParam0->f_20[0 /*14*/]), true);
			}
			if (!ENTITY::IS_ENTITY_DEAD(&(uParam0->f_20[1 /*14*/])))
			{
				func_65(&((uParam0->f_20[1 /*14*/])->f_5), 50, 10, 0);
				uLocal_15[1] = func_66(iLocal_13, (uParam0->f_20[1 /*14*/])->f_5, (uParam0->f_20[1 /*14*/])->f_8, 0, 0, 0);
				TASK::_TASK_USE_SCENARIO_POINT(&(uParam0->f_20[1 /*14*/]), &(uLocal_15[1]), 0, 0, 0, 1, 0, 0, -1082130432, 0);
		...
		case 1:
			if (func_68(uParam0, uParam0->f_493, uParam0->f_494, 4, uParam0->f_495, 1112014848))
			{
				...
				TASK::TASK_FOLLOW_NAV_MESH_TO_COORD(&(uParam0->f_20[0 /*14*/]), ENTITY::GET_OFFSET_FROM_ENTITY_IN_WORLD_COORDS(&(uParam0->f_20[0 /*14*/]), 0f, 3.5f, 0f), 1f, -1, 0.25f, 8192, 40000f);
				func_69(&uLocal_18);
				iLocal_9 = 2;
			}
			break;
		case 2:
			if (!func_70(&(uParam0->f_20[0 /*14*/]), 713668775))
			{
			...
			break;
		case 3:
			if (func_71(&(uParam0->f_20[1 /*14*/]), &(uParam0->f_20[0 /*14*/]), 1) < 16f && func_72(&uLocal_18, 2f))
			{
				if (!ENTITY::IS_ENTITY_DEAD(&(uParam0->f_20[1 /*14*/])) && !ENTITY::IS_ENTITY_DEAD(&(uParam0->f_20[0 /*14*/])))
				{
					PED::_0x802092B07E3B1EEA(&(uParam0->f_20[1 /*14*/]), (uParam0->f_20[0 /*14*/])->f_5, 0);
					func_73(&(uParam0->f_20[0 /*14*/]));
					TASK::_TASK_SMART_FLEE_STYLE_PED(&(uParam0->f_20[0 /*14*/]), &(uParam0->f_20[1 /*14*/]), 0, 256, -1082130432, -1, 0);
					TASK::OPEN_SEQUENCE_TASK(&iVar0);
					TASK::TASK_FOLLOW_TO_OFFSET_OF_ENTITY(0, &(uParam0->f_20[0 /*14*/]), 0f, 3.5f, 0f, 1.2f, iLocal_14, 1036831949, 1, 1, 1, 1, 1);
					func_74(0, iLocal_13, (uParam0->f_20[1 /*14*/])->f_5, (uParam0->f_20[1 /*14*/])->f_8, 0, 1, 0, 0, -1082130432);
					TASK::CLOSE_SEQUENCE_TASK(iVar0);
					TASK::_TASK_PERFORM_SEQUENCE_2(&(uParam0->f_20[1 /*14*/]), iVar0, 0.55f, 0.55f);
...
int func_32(var uParam0, var uParam1)
{
	...
	while (iVar0 < uParam0->f_19)
	{
		if (TASK::_0x841475AC96E794D1(&(uLocal_15[iVar0])))
		{
			TASK::_0x81948DFE4F5A0283(&(uLocal_15[iVar0]));
		}
		iVar0++;
	}
	return 1;
...
void func_64(var uParam0)
{
	...
	while (iVar0 <= 1)
	{
		if (!ENTITY::IS_ENTITY_DEAD(&(uParam0->f_20[iVar0 /*14*/])))
		{
			TASK::_TASK_SMART_FLEE_STYLE_PED(&(uParam0->f_20[iVar0 /*14*/]), Global_35, 3, 256, -1082130432, -1, 0);
		}
		iVar0++;
	}
}

int func_65(var uParam0, int iParam1, int iParam2, int iParam3)
{
	var uVar0;
	int iVar1;
	bool bVar2;
...
var func_66(int iParam0, vector3 vParam1, float fParam4, float fParam5, int iParam6, int iParam7)
{
	return TASK::CREATE_SCENARIO_POINT(iParam0, vParam1, fParam4, fParam5, iParam6, iParam7);
}

void func_67(var uParam0, bool bParam1, int iParam2)
{
...
int func_68(var uParam0, float fParam1, float fParam2, int iParam3, float fParam4, float fParam5)
{
	int iVar0;
	float fVar1;
	int iVar2;
	...
	if ((MISC::GET_FRAME_COUNT() % 8) == 0)
	{
		...
		while (iVar0 < uParam0->f_19)
		{
			...
			if (!ENTITY::IS_ENTITY_DEAD(&(uParam0->f_20[iVar0 /*14*/])))
			{
				...
				fVar8 = func_71(Global_35, &(uParam0->f_20[iVar0 /*14*/]), 1);
				if (fVar8 < fVar1)
				{
					return 1;
				}
...
float func_71(int iParam0, int iParam1, bool bParam2)
{
	...
	return func_114(ENTITY::GET_ENTITY_COORDS(iParam0, false, false), ENTITY::GET_ENTITY_COORDS(iParam1, false, false));
}
...
void func_74(int iParam0, int iParam1, vector3 vParam2, float fParam5, int iParam6, int iParam7, int iParam8, int iParam9, int iParam10)
{
	...
	switch (uParam0->f_6)
	{
		case 0:
			if (*uParam0 & 16 != 0)
			{
				...
				else if (!PED::IS_PED_PLANTING_BOMB(Global_35) && (!func_174(1) || *uParam0 & 8192 != 0))
				{
...
int func_132(int iParam0, var uParam1)
{
	...
	switch (iVar0)
	{
		...
		case 1589923363:
			...
			if (!func_177(iParam0, uParam1, iVar2))
			{
				return 0;
			}
			if (func_178(iParam0, iVar2) <= func_179(uParam1))
			{
				return 1;
			}
			break;
...
int func_134(int iParam0, var uParam1)
{
	...
	if (!ENTITY::IS_ENTITY_DEAD(iParam0))
	{
		if (func_183(iParam0, !*uParam1 & 268435456 != 0, !*uParam1 & 536870912 != 0, !*uParam1 & 1073741824 != 0, 0, 0))
		{
			if (uParam1->f_12 < 5f)
			{
				fVar0 = 95f;
			...
			fVar1 = func_184(uParam1);
			if (func_185(uParam1, iParam0, fVar0, fVar1))
			{
				if (uParam1->f_2 == 0)
				{
...
int func_135(int iParam0, int iParam1, var uParam2)
{
	...
	fVar0 = 85f;
	if (func_187(iParam1, !*uParam2 & 268435456 != 0, !*uParam2 & 536870912 != 0, !*uParam2 & 1073741824 != 0, 0))
	{
		if (uParam2->f_12 < 5f)
		{
			fVar0 = 95f;
		...
		fVar1 = func_184(uParam2);
		if (func_185(uParam2, iParam0, fVar0, fVar1))
		{
			if (uParam2->f_2 == 0)
			{
			...
			if (uParam2->f_2 != 0)
			{
				if (MISC::GET_GAME_TIMER() - uParam2->f_2) > func_186(uParam2)
				{
					func_181(uParam2, 1);
					return 1;
				}
...
int func_136(int iParam0, var uParam1)
{
	...
	if (func_177(iParam0, uParam1, iVar1))
	{
		if (uParam1->f_3 == 0)
		{
			uParam1->f_3 = MISC::GET_GAME_TIMER();
		}
		else if (MISC::GET_GAME_TIMER() - uParam1->f_3) > func_186(uParam1)
		{
			fVar3 = func_184(uParam1);
...
int func_137(int iParam0, bool bParam1, int iParam2, bool bParam3)
{
	...
	{
		return func_188(bParam1, iParam2, bParam3);
	}
	if (Global_1572887->f_12 != -1)
	{
...
int func_140(var uParam0, int iParam1, var uParam2)
{
	...
	if (uParam2->f_12 < IntToFloat(func_190(uParam2)))
	{
		...
		switch (iVar3)
		{
			...
			case 2:
				if (EVENT::IS_SHOCKING_EVENT_IN_SPHERE(-966930978, vVar0, uParam2->f_22))
				{
					...
					if (func_192(iParam1, vVar0, vVar4))
					{
						func_181(uParam2, 1);
						return 1;
					}
		...
		switch (iVar3)
		{
			...
			case 2:
				if (EVENT::IS_SHOCKING_EVENT_IN_SPHERE(-966930978, vVar0, uParam2->f_22))
				{
					...
					if (func_192(iParam1, vVar0, vVar7))
					{
						func_181(uParam2, 1);
						return 1;
					}
...
int func_142(int iParam0, var uParam1)
{
	...
	{
		if (!func_177(iParam0, uParam1, &(Global_1935630->f_34[iVar0])) || iParam0 == &Global_1935630->f_34[iVar0])
		{
		}
		else
		{
			bVar13 = func_193(&(Global_1935630->f_34[iVar0]));
			...
			if (func_194(uParam1, iParam0, fVar1, bVar12, bVar13))
			{
				*(vVar2[0 /*3*/]) = { ENTITY::GET_ENTITY_COORDS(&(Global_1935630->f_34[iVar0]), false, false) };
				*(vVar2[1 /*3*/]) = { vVar9 };
				uParam1->f_10 = iParam0;
			...
			else if (func_195(uParam1, iParam0, fVar1, bVar12, bVar13))
			{
				*(vVar2[0 /*3*/]) = { ENTITY::GET_ENTITY_COORDS(&(Global_1935630->f_34[iVar0]), false, false) };
				*(vVar2[1 /*3*/]) = { vVar9 };
				uParam1->f_10 = iParam0;
			...
			else if (func_196(uParam1, iParam0, fVar1, iVar0))
			{
				*(vVar2[0 /*3*/]) = { ENTITY::GET_ENTITY_COORDS(&(Global_1935630->f_34[iVar0]), false, false) };
				*(vVar2[1 /*3*/]) = { vVar9 };
				uParam1->f_10 = iParam0;
...
int func_150(var uParam0, int iParam1)
{
	...
	if (iVar0 != 0 && !VEHICLE::IS_THIS_MODEL_A_TRAIN(ENTITY::GET_ENTITY_MODEL(iVar0)))
	{
		...
		if (func_201(iVar0, iParam1, vVar1))
		{
...
int func_153(var uParam0, int iParam1)
{
	...
	fVar0 = func_179(uParam0);
	if (uParam0->f_12 > func_203(uParam0) && uParam0->f_12 > fVar0)
	{
		return 0;
	}
	iVar2 = func_204(iParam1);
	iVar1 = func_205(uParam0->f_14);
...
int func_154(int iParam0, int iParam1, var uParam2)
{
	...
	return func_206(iParam0, iParam1, bVar0, bVar2, uParam2->f_12, bVar1);
}
...
int func_159(int iParam0, var uParam1)
{
	...
	else if (func_151() - uParam1->f_4) > func_210(uParam1)
	{
		return func_211(iParam0, uParam1, 0, -1082130432);
	}
	return 0;
}
...
void func_161(int iParam0)
{
	if (func_43(iParam0))
	{
		...
		{
			case 1:
				func_212(0, 1, 0, 0, ((Global_1415419->f_19[iParam0 /*12*/])->f_7 / 4), 0, 0, 1);
				func_212(1, 1, 0, 0, ((Global_1415419->f_19[iParam0 /*12*/])->f_7 / 4), 0, 0, 1);
				break;
			case 37:
				func_212(60, 1, 0, 0, ((Global_1415419->f_19[iParam0 /*12*/])->f_7 / 4), 0, 0, 1);
				break;
		}
	}
}
...
int func_174(bool bParam0)
{
	...
	if (func_215(bParam0, &uVar0, &uVar1))
	{
		return 1;
	}
	return 0;
...
int func_180(int iParam0, int iParam1, int iParam2, int iParam3, int iParam4)
{
	switch (iParam0)
	{
		case 8:
...
int func_183(int iParam0, bool bParam1, bool bParam2, bool bParam3, int iParam4, int iParam5)
{
	int iVar0;
	int iVar1;
	int iVar2;
	...
	{
		if (WEAPON::_0x6AD66548840472E5(func_219(iVar0, 0)))
		{
			if (func_220(iParam0, 0.4f, 0.6f, 0.3f, 0.7f))
			{
				return 1;
			}
		}
...
int func_187(int iParam0, bool bParam1, bool bParam2, bool bParam3, int iParam4)
{
	int iVar0;
	int iVar1;
	...
	if (PLAYER::IS_PLAYER_FREE_AIMING(iVar1))
	{
		if (WEAPON::_0x6AD66548840472E5(func_219(iVar0, 0)))
		{
			if (func_221(ENTITY::GET_ENTITY_COORDS(iParam0, true, false), 0.4f, 0.6f, 0.3f, 0.7f))
			{
				return 1;
			}
		}
...
int func_188(bool bParam0, var uParam1, var uParam2)
{
...
int func_192(int iParam0, vector3 vParam1, vector3 vParam4)
{
	if (func_222(iParam0, vParam4, 0.5f))
	{
...
int func_196(var uParam0, int iParam1, float fParam2, int iParam3)
{
	float fVar0;
...
int func_198(int iParam0, int iParam1)
{
	...
	if (func_225(iParam0, 1, 0, 0) != 2055893578)
	{
		return 0;
	}
...
int func_201(int iParam0, int iParam1, vector3 vParam2)
{
	float fVar0;
...
int func_206(int iParam0, int iParam1, bool bParam2, bool bParam3, float fParam4, bool bParam5)
{
	bool bVar0;
	int iVar1;
	float fVar2;
...
int func_207(int iParam0, var uParam1, bool bParam2)
{
	int iVar0;
	int iVar1;

	func_215(1, &iVar0, &iVar1);
	...
	if (ENTITY::DOES_ENTITY_EXIST(iVar0))
	{
		if (iVar0 != iParam0)
		{
			if (PED::_0x06087579E7AA85A9(iParam0, Global_35, -1f, -1f, -1f, -1f))
			{
				if (ENTITY::HAS_ENTITY_CLEAR_LOS_TO_ENTITY(iParam0, Global_35, 17))
				{
					if (!bParam2 || !func_208(uParam1, iVar0))
					{
						return 1;
					}
				}
	...
	if (ENTITY::DOES_ENTITY_EXIST(iVar1))
	{
		if (iVar1 != iParam0)
		{
			...
			{
				if (!bParam2 || !func_208(uParam1, iVar1))
				{
...
int func_209(int iParam0)
{
	...
	return func_227(((*Global_1347702)[58 /*49*/])->f_15, 1);
}
...
int func_211(int iParam0, var uParam1, bool bParam2, float fParam3)
{
	if (!bParam2)
	{
		if (uParam1->f_4 == 0)
...
void func_212(int iParam0, int iParam1, int iParam2, int iParam3, int iParam4, int iParam5, bool bParam6, int iParam7)
{
	int iVar0;

	iVar0 = (((iParam2 + (60 * iParam3)) + (3600 * iParam4)) + (86400 * iParam5));
	if (func_228(iParam0) == 1 && iParam7)
	{
		return;
	}
	if (bParam6)
...
int func_215(bool bParam0, var uParam1, var uParam2)
{
	int iVar0;
	int iVar1;
...
int func_220(int iParam0, float fParam1, float fParam2, float fParam3, float fParam4)
{
	if (!ENTITY::IS_ENTITY_DEAD(iParam0))
	{
		if (func_221(ENTITY::GET_ENTITY_COORDS(iParam0, true, false), fParam1, fParam2, fParam3, fParam4))
		{
			return 1;
		}
	}
...
int func_221(vector3 vParam0, float fParam3, float fParam4, float fParam5, float fParam6)
{
	float fVar0;
	float fVar1;
	bool bVar2;
...
bool func_222(int iParam0, vector3 vParam1, float fParam4)
{
	vector3 vVar0;
	vector3 vVar3;
