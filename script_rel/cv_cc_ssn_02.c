...
int func_72(var uParam0)
{
	...
	iLocal_19 = func_152(uParam0, 463271055, 0f, 0f, 0f, "p_stool03x", 0, 0, 1);
	func_153(uParam0, "script@vignette@susan_2@base", 1, 1, 0, 0);
	iLocal_16 = func_153(uParam0, "script@vignette@susan_2@action_Left", 0, 0, 0, 1);
	iLocal_17 = func_153(uParam0, "script@vignette@susan_2@action_Right", 0, 0, 0, 1);
...
void func_195(var uParam0, int iParam1, int iParam2, float fParam3)
{
	if (iParam2 == -1)
	{
		iParam2 = 0;
