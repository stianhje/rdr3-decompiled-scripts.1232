...
int func_1(var uParam0)
{
	...
	iVar0 = func_8(uParam0, iLocal_16);
	PED::SET_BLOCKING_OF_NON_TEMPORARY_EVENTS(iVar0, false);
	PED::SET_PED_CONFIG_FLAG(iVar0, 441, false);
	...
	PED::SET_PED_CONFIG_FLAG(iVar0, 419, false);
	PED::SET_PED_CONFIG_FLAG(iVar0, 471, false);
	func_9(iVar0, 0);
...
int func_73(var uParam0)
{
	...
	uParam0->f_23 = { uParam0->f_23 + Vector(0.04f, 0f, 0f) };
	iLocal_14 = func_151(uParam0, 18, "LeoStrauss");
	iLocal_15 = func_152(uParam0, -450226655, "EdithDown");
	iLocal_16 = func_152(uParam0, func_153(997958153, 1), "Horse");
	func_154(uParam0, -8.7436f, 6.0821f, 0f, 0f, 1.2f, 1.2f, 5f, -1612834106, -1, 1, 1, 1);
	func_154(uParam0, -0.15f, -0.1125f, 0f, 0f, 3.335f, 2.7475f, 5f, -1612834106, -1, 1, 1, 1);
	uLocal_17 = func_155(uParam0, -1006095118, -0.274352f, -1.19492f, -0.00502014f, "p_chairfolding02x", 1, 0, 1);
	iLocal_18 = func_155(uParam0, 1210783447, 0f, 0f, 0f, "p_cs_ledger01x", 0, 1, 1);
	func_155(uParam0, 531516298, 0f, 0f, 0f, "P_FOLDEDBILLS01X", 0, 1, 1);
	func_156(uParam0, "script@vignette@strauss_2@base", 1, 1, 0, 0);
	func_156(uParam0, "script@vignette@strauss_2@action", 0, 0, 1, 0);
	func_157(uParam0, "CSTR2AU");
	func_158(uParam0, 1900218338, 1995649462);
	func_159(uParam0, iLocal_14, 3, 1253642035, "PROP_HUMAN_SEAT_CHAIR_READING_MALE_A", uLocal_17, 0, -1073741824, 1065353216, 1);
...
int func_87(var uParam0)
{
	...
	PED::SET_PED_CONFIG_FLAG(iVar0, 441, true);
	...
	PED::SET_PED_CONFIG_FLAG(iVar0, 419, true);
	PED::SET_PED_CONFIG_FLAG(iVar0, 471, true);
	PED::SET_PED_RELATIONSHIP_GROUP_HASH(func_8(uParam0, iLocal_15), -1538724068);
	func_9(iVar0, 1);
	TASK::TASK_START_SCENARIO_AT_POSITION(iVar0, 696740378, -104.9883f, -18.30921f, 94.85979f, -48.94f, 0, 0, 1, 0, -1082130432, 0);
	return 1;
}
...
int func_92(var uParam0)
{
	...
	iVar0 = func_194(func_21(uParam0));
	func_195(iVar0);
...
int func_96(var uParam0)
{
	...
	if (iLocal_19)
	{
		if (func_206(Global_35, func_8(uParam0, iLocal_15), 1) < 5625f && func_207(Global_35))
		{
		...
		if (ENTITY::DOES_ENTITY_EXIST(func_8(uParam0, iLocal_15)))
		{
			...
			if (func_206(Global_35, func_8(uParam0, iLocal_15), 1) > 10000f || func_110(&uLocal_20) > 2f)
			{
				PED::DELETE_PED(&((uParam0->f_107[iLocal_15 /*113*/])->f_5));
				PED::DELETE_PED(&((uParam0->f_107[iLocal_16 /*113*/])->f_5));
				return 1;
	...
	if (!iLocal_19)
	{
		...
		vVar0.f_3 = 1.2f;
		vVar0.f_4 = -1;
		vVar0 = { -106.2463f, -18.00144f, 94.88023f };
		TASK::OPEN_SEQUENCE_TASK(&iVar7);
		TASK::TASK_FOLLOW_PAVEMENT_TO_COORD(0, &vVar0);
		TASK::TASK_MOUNT_ANIMAL(0, func_8(uParam0, iLocal_16), 20000, -1, 1f, 1, 0, 0);
		TASK::_TASK_MOVE_IN_TRAFFIC_4(0, 3f, -22.18789f, 57.58458f, 90.87619f, 1);
		TASK::_TASK_MOVE_IN_TRAFFIC(0, 3f, 256, 0);
		TASK::CLOSE_SEQUENCE_TASK(iVar7);
		TASK::TASK_PERFORM_SEQUENCE(func_8(uParam0, iLocal_15), iVar7);
...
int func_191(var uParam0, int iParam1, bool bParam2)
{
	...
	if (uParam0->f_2270)
	{
		uParam0->f_2274 = 0;
		uParam0->f_2275 = 0;
		if ((func_113() && ANIMSCENE::_0x6F1F0B17109309DA(uParam0->f_2046, "ARTHUR")) || (func_281() && ANIMSCENE::_0x6F1F0B17109309DA(uParam0->f_2046, "JOHN")))
		{
			uParam0->f_2274 = 1;
		}
	}
