...
struct<4> func_756(int iParam0, int iParam1)
{
	struct<5> Var0;

	Var0 = { func_765(iParam0) };
	return func_766(iParam0, iParam1, Var0, Var0.f_4);
}
...
struct<5> func_765(int iParam0)
{
	struct<5> Var0;

	Var0 = { func_766(iParam0, 1328661203, func_533(), -1591664384) };
	Var0.f_4 = 1084182731;
	return Var0;
}

struct<4> func_766(int iParam0, int iParam1, var uParam2, var uParam3, var uParam4, var uParam5, int iParam6)
{
	struct<4> Var0;
...
int func_771(int iParam0, int iParam1, int iParam2, int iParam3, bool bParam4)
{
	struct<5> Var0;
	struct<4> Var5;
	...
	return func_778(iParam0, iParam1, &Var5, iParam2, iParam3, bParam4);
}
...
int func_778(int iParam0, int iParam1, var uParam2, int iParam3, int iParam4, var uParam5)
{
	...
	Var0.f_9 = -1591664384;
	if (!func_780(iParam0, *uParam2, &Var0, 0))
	{
		return 0;
	}
	if (iParam3 < 0)
...
int func_780(int iParam0, var uParam1, var uParam2, var uParam3, var uParam4, var uParam5, bool bParam6)
{
	if (!INVENTORY::_0xB881CA836CC4B6D4(&uParam1))
	{
		return 0;
