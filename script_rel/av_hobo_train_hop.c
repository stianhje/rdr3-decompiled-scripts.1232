...
{
	func_33(uParam0, 10908/*func_30*/, 10979/*func_31*/, 11867/*func_32*/);
}
...
int func_31(var uParam0)
{
	...
	if (!&uParam0->f_469[2])
	{
		...
		{
			if ((!iLocal_10 && func_78(Global_36, uParam0->f_483) < 15625f) && !ENTITY::IS_ENTITY_DEAD(iLocal_42))
			{
		...
		if (!ENTITY::IS_ENTITY_DEAD(&(uParam0->f_20[0 /*14*/])))
		{
			if (ANIMSCENE::_0x73616E64696C616E(uParam0->f_3.f_1, (uParam0->f_20[0 /*14*/])->f_1, 1, 0))
			{
				if (&uParam0->f_469[6])
				{
					...
					ENTITY::ATTACH_ENTITY_TO_ENTITY(&(uParam0->f_20[0 /*14*/]), iLocal_44, 0, vVar3, 0f, 0f, 86.11757f, 0, 0, 0, 0, 2, 1, 1, 0);
					TASK::_TASK_START_SCENARIO_IN_PLACE(&(uParam0->f_20[0 /*14*/]), -980725198, -1, 0, 0, 0f, 1);
...
int func_57(vector3 vParam0, int iParam3)
{
	if (!ENTITY::DOES_ENTITY_EXIST(iLocal_42))
	{
		...
		VEHICLE::SET_VEHICLE_ENGINE_ON(iLocal_42, 0, 1);
...
void func_150(int iParam0, int iParam1, int iParam2, int iParam3, int iParam4, int iParam5, bool bParam6, int iParam7)
{
	int iVar0;

	iVar0 = (((iParam2 + (60 * iParam3)) + (3600 * iParam4)) + (86400 * iParam5));
	if (func_158(iParam0) == 1 && iParam7)
	{
		return;
	}
	if (bParam6)
