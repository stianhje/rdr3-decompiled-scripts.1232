...
int func_72(var uParam0)
{
	...
	uLocal_17 = func_153(uParam0, joaat("p_chair_crate02x"), 0f, 0f, 0f, 0, 1, 0, 1);
	func_154(uParam0, iLocal_14, 3, 1530228672, "PROP_HUMAN_SEAT_CHAIR_KNITTING_FEMALE_A", uLocal_17, 0);
	func_155(uParam0, iLocal_14, 3, 1530228672, "PROP_HUMAN_SEAT_CHAIR_KNITTING_FEMALE_A", uLocal_17, 0, -1073741824, 1065353216, 1);
