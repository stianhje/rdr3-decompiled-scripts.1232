...
int func_72(var uParam0)
{
	...
	iLocal_15 = func_151(uParam0, -811821899, 0f, 0f, 0f, "PITCHFORK", 0, 0, 1);
	...
	func_151(uParam0, -1827121226, 0f, 0f, 0f, "WHEELBARROW", 0, 0, 1);
...
void func_161(var uParam0, int iParam1, int iParam2, float fParam3)
{
	if (iParam2 == -1)
	{
		iParam2 = 0;
