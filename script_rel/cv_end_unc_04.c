...
int func_72(var uParam0)
{
	...
	func_151(uParam0, -1814467767, 0f, 0f, 0f, "POOP_01", 0, 0, 1);
	func_151(uParam0, -1651147359, 0f, 0f, 0f, "POOP_02", 0, 0, 1);
	func_151(uParam0, -1651147359, 0f, 0f, 0f, "POOP_02^1", 0, 0, 1);
	func_151(uParam0, 1922020242, 0f, 0f, 0f, "POOP_03", 0, 0, 1);
	func_151(uParam0, joaat("p_wheelbarrow01x"), 0f, 0f, 0f, "WHEELBARROW", 0, 0, 1);
	func_152(uParam0, "script@vignette@beecher@uncle_4@base", 1, 1, 0, 0);
	iLocal_16 = func_152(uParam0, "script@vignette@beecher@uncle_4@action", 2, 0, 1, 1);
	iLocal_17 = func_152(uParam0, "script@vignette@beecher@uncle_4@base", 1, 0, 0, 0);
	func_153(uParam0, "BUNC4AU");
	uLocal_18 = func_154(uParam0, -0.18f, 3.03f, 1.9f, 0f, 0f, 136.28f, 10.12f, 9.24f, 4f, "volTriggerBeecherUncle4", -1612834106);
	func_155(uParam0, 1);
	func_156(uParam0, iLocal_14, 1094713344, 1092616192);
	func_157(uParam0, iLocal_14, 1, -1);
	func_158(uParam0, iLocal_14, 3, 2009862572, "WORLD_HUMAN_PITCH_FORK_PUT_DOWN_MALE_A", -1, 1, -1073741824, 1065353216, 1);
...
{
	return func_192(uParam0, &uLocal_18, 1);
}
...
int func_93(var uParam0)
{
	...
	if (((func_201(uParam0, iLocal_17) && MISC::GET_GAME_TIMER() > iLocal_19) && !func_192(uParam0, &uLocal_18, 1)) && !ENTITY::IS_ENTITY_ON_SCREEN(func_48(uParam0, iLocal_14)))
	{
...
int func_154(var uParam0, vector3 vParam1, vector3 vParam4, vector3 vParam7, char* sParam10, int iParam11)
{
	int iVar0;
	vector3 vVar1;
	...
	vVar1 = { func_253(uParam0, vParam1) };
...
void func_160(var uParam0, int iParam1, int iParam2, int iParam3)
{
	...
	{
		case 4:
			(uParam0->f_107[iParam1 /*113*/])->f_32.f_5 = { func_256(func_148(uParam0), func_255(uParam0, iParam1), func_19(uParam0), 1) };
			break;
		default:
			Var0 = { func_257(func_148(uParam0), func_255(uParam0, iParam1), func_19(uParam0), 1) };
...
void func_186(var uParam0)
{
	...
	{
		uParam0->f_1976.f_6 = PROPSET::_CREATE_PROPSET_2(uParam0->f_1976, func_253(uParam0, uParam0->f_1976.f_1), 1, func_289(uParam0, uParam0->f_1976.f_4), 3f, false, true);
	}
}
...
int func_191(var uParam0, int iParam1, bool bParam2)
{
	...
	if (bParam2)
	{
		...
		while (iVar1 < uParam0->f_1984)
		{
			...
			else if (func_201(uParam0, iVar1) || func_200(uParam0, iVar1))
			{
...
int func_192(var uParam0, var uParam1, bool bParam2)
{
	if (bParam2)
	{
	...
	return func_297(Global_35, *uParam1, 1, 0);
}
...
void func_202(var uParam0, int iParam1, bool bParam2, bool bParam3)
{
	...
	if (bParam3)
	{
		uVar0 = func_305(uParam0, iParam1);
	}
	if (bParam2)
	{
...
Vector3 func_256(int iParam0, int iParam1, int iParam2, bool bParam3)
{
	switch (iParam0)
	{
		case 0:
...
struct<4> func_257(int iParam0, int iParam1, int iParam2, bool bParam3)
{
	switch (iParam0)
	{
		case 1:
		...
		case 6:
			switch (iParam1)
			{
				...
				case 14:
					...
					{
						case 156:
							return func_328(2329.663f, 1347.464f, 104.5794f, 155.2611f);
						default:
							break;
					}
					break;
				case 1:
					switch (iParam2)
					{
						...
						case 156:
							return func_328(2330.225f, 1345.275f, 104.7174f, 21.2991f);
						default:
							break;
					}
					break;
		...
		case 8:
			switch (iParam1)
			{
				...
				case 4:
					...
					{
						case 669:
							return func_328(-1603.036f, -1408.744f, 80.9423f, 69.6409f);
						default:
							break;
					}
					break;
...
float func_306(float fParam0, float fParam1)
{
...
struct<4> func_328(vector3 vParam0, float fParam3)
{
	struct<4> Var0;
...
int func_395(int iParam0, bool bParam1, bool bParam2, var uParam3, var uParam4, var uParam5, float fParam6, bool bParam7, bool bParam8, bool bParam9, bool bParam10)
{
	...
	switch (((*Global_1360165)[iParam0 /*1157*/])->f_70.f_12)
	{
		...
		case 3:
			...
			sVar12 = func_426(iParam0, func_284());
		...
		case 7:
			switch (iParam0)
			{
				...
				case 14:
					...
					break;
				case 4:
					if (func_327(747937920, 1) && !func_398(((*Global_1347702)[1 /*49*/])->f_15, 1))
					{
						iVar1[0] = -1155031950;
					}
					else
