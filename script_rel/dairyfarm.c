		...
		if (MISC::GET_GAME_TIMER() > iLocal_61)
		{
			...
			switch (iLocal_60)
			{
				...
				case 1:
					...
					LAW::_0x9BBDCB8DF789EBC1(PLAYER::PLAYER_ID(), func_9(iLocal_62));
...
void func_51()
{
	ENTITY::CREATE_MODEL_HIDE(1399.447f, -844.6359f, 64.8634f, 5f, 829415368, true);
	ENTITY::CREATE_MODEL_HIDE(1399.883f, -847.0065f, 65.6747f, 1f, -1127014626, true);
}
...
void func_56(var uParam0)
{
	...
	switch (*uParam0)
	{
		case 0:
			...
			if (!_NAMESPACE48::_0x800DF3FC913355F3(_NAMESPACE48::_0x112DDF56300BC6E5(func_96(uParam0->f_1))))
			{
				*uParam0 = 9;
			}
			*uParam0 = 1;
		...
		case 7:
			...
			{
				_NAMESPACE48::_0x187D65F3AEC5D679(func_96(uParam0->f_1), &(uParam0->f_3));
			}
			if (ENTITY::DOES_ENTITY_EXIST(_NAMESPACE48::_0x31C70A716CAE1FEE(_NAMESPACE48::_0x112DDF56300BC6E5(func_96(uParam0->f_1)))))
			{
				*uParam0 = 6;
			}
			else
			...
			break;
		case 6:
			if (_NAMESPACE48::_0xF8DE7154F7D1458F(_NAMESPACE48::_0x112DDF56300BC6E5(func_96(uParam0->f_1))) == uParam0->f_11)
			{
				*uParam0 = 9;
			}
			else
			{
				_NAMESPACE48::_0x669C25840C6F7AE2(_NAMESPACE48::_0x112DDF56300BC6E5(func_96(uParam0->f_1)), uParam0->f_11);
			}
			break;
		case 8:
...
void func_57()
{
	...
	iVar0 = _NAMESPACE48::_0x112DDF56300BC6E5(-1110918177);
	iVar1 = _NAMESPACE48::_0x112DDF56300BC6E5(1297060780);
	iVar2 = 936;
	iVar3 = 937;
	iVar4 = func_93(iVar2);
	iVar5 = func_93(iVar3);
	if (!func_105(iVar4, 0) && TASK::_IS_SCENARIO_GROUP_ENABLED_HASH(-1625875143))
	{
		TASK::_SET_SCENARIO_GROUP_ENABLED_HASH(-1625875143, false);
		return;
	}
	if (!func_105(iVar5, 0) && TASK::_IS_SCENARIO_GROUP_ENABLED_HASH(-1625875143))
	{
		TASK::_SET_SCENARIO_GROUP_ENABLED_HASH(-1625875143, false);
		return;
	}
...
void func_65(int iParam0, int iParam1, int iParam2, bool bParam3, int iParam4, int iParam5)
{
	var uVar0;
	char* sVar1;
	char* sVar2;
	...
	sVar1 = func_108(iParam0, iParam1, iParam2, iParam4, iParam5, bParam3, &uVar0);
	...
	else
	{
		...
		if (!MISC::_SHOULD_USE_24_HOUR_CLOCK())
		{
			...
			sVar2 = MISC::_CREATE_VAR_STRING(674, sVar8, iVar4, func_120(&sVar6, 109029619), sVar9, func_120(&sVar10, 109029619));
		}
		else
		{
			...
			IntToString(&sVar10, BUILTIN::ROUND(fVar7), 8);
			sVar2 = MISC::_CREATE_VAR_STRING(162, sVar8, iVar4, func_120(&sVar6, 109029619), func_120(&sVar10, 109029619));
		}
...
int func_89(int iParam0, bool bParam1)
{
	...
	{
		func_143(iParam0, _NAMESPACE48::_0x4F76E3676583D951(func_96(iParam0)));
		if (func_20() == -1)
		{
...
int func_99(var uParam0)
{
	...
	iVar0 = _NAMESPACE48::_0x112DDF56300BC6E5(func_96(uParam0->f_1));
	if (_NAMESPACE48::_0x800DF3FC913355F3(iVar0))
	{
...
char* func_108(int iParam0, int iParam1, int iParam2, int iParam3, var uParam4, var uParam5, var uParam6)
{
	char* sVar0;
...
void func_136()
{
	ENTITY::REMOVE_MODEL_HIDE(1399.447f, -844.6359f, 64.8634f, 5f, 829415368, 0);
	ENTITY::REMOVE_MODEL_HIDE(1399.883f, -847.0065f, 65.6747f, 1f, -1127014626, 0);
}
...
bool func_177(int iParam0, int iParam1)
{
	...
	if (iParam1 && !ENTITY::DOES_ENTITY_EXIST(func_93(iParam0)))
	{
		return false;
	}
	return !_NAMESPACE48::_0xEB98B38CA60742D7(func_144(iParam0));
}
...
int func_183(vector3 vParam0, int iParam3)
{
	...
	func_199(iParam3, &vVar0, &Var3, &fVar6);
	if (func_200(vParam0, vVar0, Var3, Var3.f_1, fVar6))
	{
		return 1;
	}
	return 0;
