...
{
	func_33(uParam0, 10920/*func_30*/, 10986/*func_31*/, 11855/*func_32*/);
}
...
void func_14(var uParam0, vector3 vParam1, vector3 vParam4)
{
	...
	{
		case 243:
			func_46(uParam0, "WOLVES_PLAYING_TOGETHER", "script@ambient@animal@WOLVES_PLAYING_TOGETHER@action", vParam1, vParam4);
			iLocal_37 = -1143398950;
			sLocal_38 = "WOLF1";
			sLocal_39 = "WOLF2";
			break;
		...
		case 244:
			func_46(uParam0, "WOLVES_PLAYING_TOGETHER_B", "script@ambient@animal@wolves_playing_together_b@wolf_small@action", vParam1, vParam4);
			iLocal_37 = -829273561;
		...
		case 245:
			func_46(uParam0, "WOLVES_PLAYING_TOGETHER_C", "script@ambient@animal@wolves_playing_together_c@wolf_small@action", vParam1, vParam4);
			iLocal_37 = -829273561;
			sLocal_38 = "WOLF_SMALL_1";
			sLocal_39 = "WOLF_SMALL_2";
			break;
	...
	func_48(uParam0, 0, sLocal_38, iLocal_37, 0f, 0f, 0f, 0f, 1, 1, 1, 1, 41788943, 0);
	func_48(uParam0, 1, sLocal_39, iLocal_37, 0f, 0f, 0f, 0f, 1, 1, 1, 1, 41788943, 0);
}
...
int func_31(var uParam0)
{
	...
	if (!&uParam0->f_469[0])
	{
		if (!bLocal_40 == 1)
		{
			if (func_65(uParam0, &uLocal_9, 1) || func_66(Global_35, uParam0->f_483, 1) < 625f)
			{
				bLocal_40 = true;
			}
		}
	...
	if (!&uParam0->f_469[0] && !bLocal_40)
	{
		...
		if (&uParam0->f_469[2])
		{
			if (!&uParam0->f_469[6])
			{
				if (func_74(uParam0, 3f, 50f, 4, -91962372, 1))
				{
					func_70(*uParam0, uParam0->f_483, 1);
					uParam0->f_469[6] = 1;
				}
...
{
	if (func_66(Global_35, uParam0->f_483, 1) <= 2500f)
	{
		if (!ENTITY::IS_ENTITY_DEAD(&(uParam0->f_20[0 /*14*/])))
		{
			if (!func_110(&(uParam0->f_20[0 /*14*/]), 780511057))
			{
		...
		if (!ENTITY::IS_ENTITY_DEAD(&(uParam0->f_20[1 /*14*/])))
		{
			if (!func_110(&(uParam0->f_20[1 /*14*/]), 780511057))
			{
...
int func_73(var uParam0, float fParam1, float fParam2, int iParam3, float fParam4, float fParam5)
{
	int iVar0;
	float fVar1;
	int iVar2;
...
int func_74(var uParam0, float fParam1, float fParam2, int iParam3, int iParam4, bool bParam5)
{
	int iVar0;
