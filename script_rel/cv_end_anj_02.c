...
void func_59(int iParam0, int iParam1, bool bParam2, bool bParam3, float fParam4, bool bParam5, bool bParam6, bool bParam7, bool bParam8, bool bParam9, bool bParam10)
{
	bool bVar0;
	int iVar1;
	bool bVar2;
...
int func_86(var uParam0)
{
	if (!iLocal_31)
	{
		uLocal_32 = STREAMING::_0xB223249B7798EEED(func_51(uParam0, iLocal_15), -393300674, 1, -1932751089);
		iLocal_31 = 1;
		return 0;
	}
...
int func_111(int iParam0, int iParam1, int iParam2, bool bParam3, bool bParam4)
{
	...
	if (func_124(iVar0, 0))
	{
		...
		if ((iParam1 || !func_109(iParam0)) || func_54(iParam0))
		{
...
int func_343(int iParam0, bool bParam1)
{
	...
	{
		func_245(iParam0, _NAMESPACE48::_0x4F76E3676583D951(func_136(iParam0)));
		if (func_233() == -1)
		{
