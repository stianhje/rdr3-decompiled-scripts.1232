...
int func_72(var uParam0)
{
	...
	func_151(uParam0, 5.2264f, -6.6722f, 0.5193f, 170.3144f, 1.5f, 1.5f, 3f, -1612834106, -2087487524, 1, 1, 1);
	func_151(uParam0, 0.4954f, -2.8251f, 0.6547f, -90.36f, 1.5f, 1.8f, 3f, -1612834106, 2017216891, 1, 1, 1);
	iLocal_16 = func_152(uParam0, joaat("p_cs_bookevelynmiller"), 0f, 0f, 0f, "BOOK", 0, 0, 1);
	func_152(uParam0, 2055697445, 0f, 0f, 0f, "LANTERN", 0, 0, 1);
	func_152(uParam0, joaat("p_chairfolding02x"), 0f, 0f, 0f, "CHAIR", 0, 0, 1);
	func_153(uParam0, "script@vignette@bill_8@base", 1, 1, 0, 0);
	iLocal_17 = func_153(uParam0, "script@vignette@bill_8@action_a", 2, 0, 1, 0);
	iLocal_18 = func_153(uParam0, "script@vignette@bill_8@action_a_int", 0, 0, 0, 1);
	iLocal_19 = func_153(uParam0, "script@vignette@bill_8@action_exit", 0, 0, 0, 0);
	func_154(uParam0, "CBLL8AU");
	func_155(uParam0, iLocal_14, 1, 12, 0, 0, 0);
	func_156(uParam0, iLocal_15, 3, -787460071, "SC_PROP_CAMP_DUTCH_SEAT_CHAIR_READING_MALE_A", -1, 0);
	func_157(uParam0, iLocal_15, 3, -787460071, "SC_PROP_CAMP_DUTCH_SEAT_CHAIR_READING_MALE_A", -1, 0, -1073741824, 1065353216, 1);
	func_158(uParam0, iLocal_15, iLocal_16, "p_cs_bookEvelynMiller_PH_R_HAND", 0, 0);
	Local_20 = { func_159(uParam0, 0.0939f, -2.8236f, 0.6519f, -145.319f, 7f, 0.8f, 0.8f) };
	return 1;
}
...
int func_93(var uParam0)
{
	...
	{
		if (func_198(uParam0, Local_20, 1, 0))
		{
			func_189(uParam0, iLocal_18, 1);
		}
		else
		{
			func_199(uParam0, iLocal_15, 1, 1);
		}
...
int func_151(var uParam0, vector3 vParam1, float fParam4, vector3 vParam5, int iParam8, int iParam9, bool bParam10, int iParam11, int iParam12)
{
	...
	if (bParam10)
	{
		vParam1 = { func_250(uParam0, vParam1) };
...
struct<10> func_159(var uParam0, vector3 vParam1, float fParam4, float fParam5, float fParam6, float fParam7)
{
	...
	fVar0 = func_251(uParam0, (fParam4 + (fParam6 * 90f)));
	fVar1 = func_251(uParam0, (fParam4 - (fParam7 * 90f)));
	Var2 = { func_250(uParam0, vParam1) };
	...
	if (!uParam0->f_72)
	{
		...
		while (iVar0 < uParam0->f_33)
		{
			...
			else
			{
				...
				{
					func_253(&(uParam0->f_33[iVar0]), 0, 1, 0, 2048, 0, -1082130432);
					iVar0++;
				}
				if (!uParam0->f_71)
				{
	...
	while (iVar12 < uParam0->f_106)
	{
		...
		else
		{
			if (!STREAMING::IS_MODEL_VALID((uParam0->f_107[iVar12 /*113*/])->f_3))
			{
				...
				{
					(uParam0->f_107[iVar12 /*113*/])->f_3 = _NAMESPACE48::_0xA00DF706C60173D1(func_267((uParam0->f_107[iVar12 /*113*/])->f_1));
				}
				else if (func_57((uParam0->f_107[iVar12 /*113*/])->f_2))
				{
					(uParam0->f_107[iVar12 /*113*/])->f_3 = func_268((uParam0->f_107[iVar12 /*113*/])->f_2);
				}
		...
		else
		{
			...
			else if (!(uParam0->f_107[iVar0 /*113*/])->f_8.f_22)
			{
				if (iVar1 < 0)
				{
					...
					func_269(&((uParam0->f_107[iVar0 /*113*/])->f_8.f_23), 1, 0);
				}
				else
				{
	...
	while (iVar1 < 27)
	{
		...
		else
		{
			...
			while (iVar0 < uParam0->f_36)
			{
				...
				else if (iVar1 == func_270((uParam0->f_36[iVar0 /*5*/])->f_1))
				{
				}
		...
		else if ((uParam0->f_107[iVar3 /*113*/])->f_8.f_14)
		{
			...
			else if (ANIMSCENE::_0x3AB6C7B0BB0DF4B1((uParam0->f_107[iVar3 /*113*/])->f_5, -1))
			{
				...
				else
				{
					...
					{
						if (!func_273(uParam0, iVar3, vVar4))
						{
							iVar1 = 0;
							bVar0 = false;
						}
...
void func_175(var uParam0)
{
	...
	while (iVar0 < uParam0->f_106)
	{
		...
		{
			(uParam0->f_107[iVar0 /*113*/])->f_5 = func_278((uParam0->f_107[iVar0 /*113*/])->f_3, uParam0->f_23, 0, 1, 1, 0, 1, 1, 1, 0, 0, 0, 0);
		}
		iVar0++;
	}
}
	...
	while (iVar0 < uParam0->f_1984)
	{
		...
		else
		{
			if (bParam1)
			{
				if (func_279())
				{
					func_280(Global_35, &(uParam0->f_1984[iVar0]), "JOHN");
				}
				else
				{
					func_280(Global_35, &(uParam0->f_1984[iVar0]), "ARTHUR");
				}
			}
			iVar1 = 0;
			while (iVar1 < uParam0->f_106)
			{
				func_280((uParam0->f_107[iVar1 /*113*/])->f_5, &(uParam0->f_1984[iVar0]), (uParam0->f_107[iVar1 /*113*/])->f_4);
				iVar1++;
			}
		}
		iVar0++;
...
void func_178(var uParam0)
{
	...
	while (iVar0 < uParam0->f_106)
	{
		func_281((uParam0->f_107[iVar0 /*113*/])->f_5);
		iVar0++;
	}
}
	...
	while (iVar0 < uParam0->f_1711)
	{
		...
		else
		{
			...
			if (!(uParam0->f_1711[iVar0 /*15*/])->f_5 && !ENTITY::DOES_ENTITY_EXIST((uParam0->f_1711[iVar0 /*15*/])->f_10))
			{
				...
				{
					vVar3 = { func_250(uParam0, (uParam0->f_1711[iVar0 /*15*/])->f_1) };
				}
				else
				{
			...
			else
			{
				...
				{
					if (!func_266(uParam0, iVar6))
					{
					}
					else
					{
						func_283((uParam0->f_1711[iVar0 /*15*/])->f_10, &(uParam0->f_1984[iVar6]), (uParam0->f_1711[iVar0 /*15*/])->f_4);
					}
					iVar6++;
				}
			}
		...
		else
		{
			...
			else
			{
				...
				else
				{
					...
					{
						if (!func_266(uParam0, iVar2))
						{
						}
						else
						{
							func_283((uParam0->f_1967[iVar1 /*4*/])->f_3, &(uParam0->f_1984[iVar2]), (uParam0->f_1967[iVar1 /*4*/])->f_2);
						}
						iVar2++;
					}
				}
...
void func_184(var uParam0)
{
	...
	{
		uParam0->f_1976.f_6 = PROPSET::_CREATE_PROPSET_2(uParam0->f_1976, func_250(uParam0, uParam0->f_1976.f_1), 1, func_251(uParam0, uParam0->f_1976.f_4), 3f, false, true);
	}
}
...
void func_186(var uParam0)
{
	...
	while (iVar0 < uParam0->f_106)
	{
		...
		{
			func_284((uParam0->f_107[iVar0 /*113*/])->f_1, (uParam0->f_107[iVar0 /*113*/])->f_32.f_40, -1);
		}
		iVar0++;
	}
}
...
void func_188(var uParam0)
{
	...
	if (!uParam0->f_4)
	{
		...
		while (iVar2 < uParam0->f_106)
		{
			...
			{
				uVar0 = func_285(ENTITY::GET_ENTITY_COORDS((uParam0->f_107[iVar2 /*113*/])->f_5, true, false));
				uVar1 = func_285((uParam0->f_107[iVar2 /*113*/])->f_96);
				if (uVar0 || uVar1)
				{
...
int func_189(var uParam0, int iParam1, bool bParam2)
{
	...
	if (uParam0->f_2270)
	{
		uParam0->f_2274 = 0;
		uParam0->f_2275 = 0;
		if ((func_112() && ANIMSCENE::_0x6F1F0B17109309DA(uParam0->f_2046, "ARTHUR")) || (func_279() && ANIMSCENE::_0x6F1F0B17109309DA(uParam0->f_2046, "JOHN")))
		{
			uParam0->f_2274 = 1;
		}
	}
	if (bParam2)
	{
		...
		while (iVar1 < uParam0->f_1984)
		{
			...
			else if (func_289(uParam0, iVar1) || func_197(uParam0, iVar1))
			{
...
int func_190(var uParam0)
{
	...
	if (func_22() == 3)
	{
		if (func_291(Global_35, 1))
		{
			fVar0 = 5f;
			fVar1 = 8f;
		}
	}
	if (func_292(uParam0, fVar0, fVar1))
	{
		return 1;
	}
	return 0;
...
void func_193(int iParam0)
{
	...
	if (func_294(iVar2, iVar0, 0))
	{
		if (func_294(iVar2, iVar1, 0))
		{
	...
	while (iVar0 < uParam0->f_106)
	{
		...
		else
		{
			if ((uParam0->f_107[iVar0 /*113*/])->f_32.f_32 > -1)
			{
				...
				func_295((uParam0->f_107[iVar0 /*113*/])->f_1, uVar1, iVar3, iVar2, 0, 0, 1);
			}
			fVar4 = (uParam0->f_107[iVar0 /*113*/])->f_32.f_35;
			if (fVar4 > 0f)
			{
				func_296((uParam0->f_107[iVar0 /*113*/])->f_1, fVar4);
				func_295((uParam0->f_107[iVar0 /*113*/])->f_1, 3, 0, 1, 0, 0, 1);
			}
		}
		iVar0++;
	}
...
int func_198(var uParam0, struct<4> Param1, var uParam5, var uParam6, var uParam7, var uParam8, var uParam9, var uParam10, bool bParam11, bool bParam12)
{
	...
	if (!func_299(Param1, Param1.f_6, Global_36))
	{
		return 0;
	}
	if (func_299(Param1, Param1.f_3, Global_36))
	{
		return 0;
	}
	if (bParam12)
...
void func_199(var uParam0, int iParam1, bool bParam2, bool bParam3)
{
	var uVar0;
	...
	if (bParam3)
	{
		uVar0 = func_300(uParam0, iParam1);
	}
	if (bParam2)
	{
			...
			if (!(uParam0->f_107[iVar0 /*113*/])->f_32)
			{
				if (func_303(uParam0, iVar0))
				{
					if ((uParam0->f_107[iVar0 /*113*/])->f_32.f_48)
					{
						...
						func_199(uParam0, iVar0, 0, 1);
					}
					else
					{
						func_199(uParam0, iVar0, 1, 1);
					}
...
void func_205(var uParam0)
{
	...
	while (iVar0 < uParam0->f_106)
	{
		if (((uParam0->f_107[iVar0 /*113*/])->f_32.f_60 > 0f && !(uParam0->f_107[iVar0 /*113*/])->f_32.f_62) && func_297(uParam0, (uParam0->f_107[iVar0 /*113*/])->f_32.f_61, (uParam0->f_107[iVar0 /*113*/])->f_32.f_60))
		{
...
Vector3 func_250(var uParam0, vector3 vParam1)
{
	return OBJECT::_GET_OBJECT_OFFSET_FROM_COORDS(uParam0->f_23, uParam0->f_26.f_2, vParam1);
}

float func_251(var uParam0, float fParam1)
{
	float fVar0;
...
void func_252(var uParam0, int iParam1, float fParam2)
{
	if (fParam2 == -2f)
	{
		fParam2 = func_301(1101004800, 1123024896);
	}
	else if (fParam2 < 0f)
	{
		fParam2 = -1f;
...
int func_253(int iParam0, int iParam1, bool bParam2, int iParam3, int iParam4, bool bParam5, float fParam6)
{
	vector3 vVar0;
	vector3 vVar3;
	var uVar6;
...
int func_264(var uParam0)
{
	...
	while (iVar1 < uParam0->f_1711)
	{
		...
		else if ((uParam0->f_1711[iVar1 /*15*/])->f_5)
		{
			...
			{
				vVar2 = { func_250(uParam0, (uParam0->f_1711[iVar1 /*15*/])->f_1) };
			}
			else
			{
...
int func_273(var uParam0, int iParam1, vector3 vParam2)
{
	float fVar0;
	float fVar1;
	float fVar2;
...
int func_274(var uParam0, int iParam1, vector3 vParam2)
{
	...
	{
		iVar5 = func_285(ENTITY::GET_ENTITY_COORDS((uParam0->f_107[iParam1 /*113*/])->f_5, true, false));
		iVar6 = func_285((uParam0->f_107[iParam1 /*113*/])->f_96);
		if (iVar5 != iVar6)
		{
...
int func_278(int iParam0, vector3 vParam1, float fParam4, bool bParam5, bool bParam6, int iParam7, bool bParam8, bool bParam9, bool bParam10, bool bParam11, bool bParam12, bool bParam13, bool bParam14)
{
	int iVar0;
...
int func_284(int iParam0, struct<8> Param1, int iParam9)
{
	int iVar0;
	var uVar1;
...
int func_291(int iParam0, bool bParam1)
{
	...
	if (ENTITY::DOES_ENTITY_EXIST(iParam0))
	{
		if (!PED::IS_PED_INJURED(iParam0) || !bParam1)
		{
			...
			{
				if (func_335(iVar0) || func_336(iVar0))
				{
					return 0;
				}
				return 1;
...
int func_292(var uParam0, float fParam1, float fParam2)
{
	float fVar0;
	int iVar1;
	...
	while (iVar1 < uParam0->f_106)
	{
		...
		{
			fVar0 = func_337(Global_35, (uParam0->f_107[iVar1 /*113*/])->f_5, 1, 1);
			if (fVar0 > fParam2)
			{
			}
			else
...
void func_295(int iParam0, int iParam1, int iParam2, int iParam3, int iParam4, bool bParam5, bool bParam6)
{
	bool bVar0;
	int iVar1;
...
int func_297(var uParam0, int iParam1, float fParam2)
{
	int iVar0;
...
bool func_299(struct<2> Param0, var uParam2, struct<2> Param3, var uParam5, struct<2> Param6, var uParam8)
{
...
float func_301(float fParam0, float fParam1)
{
...
float func_337(int iParam0, int iParam1, bool bParam2, int iParam3)
{
...
void func_341(var uParam0, int iParam1)
{
	...
	if (fVar0 > 0f)
	{
		func_296((uParam0->f_107[iParam1 /*113*/])->f_1, fVar0);
	}
}
...
void func_342(var uParam0, int iParam1)
{
	...
	func_381(sVar1, uVar2, uVar3, iVar4);
}
...
int func_346(var uParam0, int iParam1)
{
	...
	while (iVar2 <= iVar1)
	{
		...
		else
		{
			...
			vVar10 = { func_384(fVar9) };
			vVar13 = { func_385(ENTITY::GET_ENTITY_COORDS((uParam0->f_107[iParam1 /*113*/])->f_5, true, false), vVar3, 1065353216) };
...
int func_348(var uParam0, int iParam1)
{
	...
	{
		func_269(&((uParam0->f_107[iParam1 /*113*/])->f_32.f_21), 1, (uParam0->f_107[iParam1 /*113*/])->f_32.f_13);
		bVar71 = Var1.f_10;
...
int func_372(int iParam0, bool bParam1, int iParam2, int iParam3, int iParam4, int iParam5, float fParam6, int iParam7, int iParam8, bool bParam9, bool bParam10, bool bParam11, int iParam12, int iParam13, bool bParam14, bool bParam15, bool bParam16, bool bParam17, bool bParam18, bool bParam19, bool bParam20, bool bParam21, bool bParam22, bool bParam23, bool bParam24)
{
	...
	switch (((*Global_1360165)[iParam0 /*1157*/])->f_11)
	{
		...
		case 7:
			...
			if (bParam20)
			{
				if (func_276(Global_1360165[iParam0 /*1157*/]))
				{
				}
			}
...
void func_381(char* sParam0, var uParam1, var uParam2, int iParam3)
{
...
Vector3 func_384(float fParam0)
{
...
{
	return func_412(vParam3 - vParam0) * Vector(fParam6, fParam6, fParam6);
}
...
int func_389(int iParam0, bool bParam1, bool bParam2, var uParam3, var uParam4, var uParam5, float fParam6, bool bParam7, bool bParam8, bool bParam9, bool bParam10)
{
	...
	switch (((*Global_1360165)[iParam0 /*1157*/])->f_70.f_12)
	{
		...
		case 3:
			...
			sVar12 = func_420(iParam0, func_279());
...
int func_417(int iParam0, vector3 vParam1, float fParam4, bool bParam5)
{
	...
	if ((!bParam5 && !Global_1359489->f_12) || (bParam5 && Global_1359489->f_13 < 8))
	{
		...
		else
		{
			...
			{
				((*Global_1360165)[iParam0 /*1157*/])->f_124 = func_278(iVar0, vParam1, fParam4, 1, 1, 0, 1, 1, 1, 0, 0, 0, 0);
...
int func_418(int iParam0, int iParam1, bool bParam2)
{
	...
	PED::_0x1902C4CFCC5BE57C(iParam1, func_448(iParam0));
	PED::_0xCC8CA3E88256E58F(iParam1, 0, 1, 1, 1, 0);
...
void func_419(int iParam0, int iParam1)
{
	...
	func_380(iParam0, func_449(iParam1));
	...
	func_391(iParam1, func_447(iParam1, 8192), func_447(iParam1, 16384), 1);
}
		...
		case 1:
			switch (iParam0)
			{
				...
				case 9:
					...
					break;
				case 10:
					if (func_392(((*Global_1347702)[63 /*49*/])->f_15, 1) || func_429(((*Global_1347702)[63 /*49*/])->f_15))
					{
						iVar1[0] = -268604689;
					}
					else
		...
		case 3:
			switch (iParam0)
			{
				...
				case 10:
					...
					break;
				case 11:
					if (func_392(((*Global_1347702)[134 /*49*/])->f_15, 1) || func_429(((*Global_1347702)[134 /*49*/])->f_15))
					{
						iVar1[0] = -2040275819;
						iVar1[1] = 1205492208;
						iVar7 = 2;
		...
		case 7:
			switch (iParam0)
			{
				...
				case 14:
					...
					break;
				case 4:
					if (func_322(747937920, 1) && !func_392(((*Global_1347702)[1 /*49*/])->f_15, 1))
					{
						iVar1[0] = -1155031950;
					}
					else
...
int func_442(int iParam0, int iParam1)
{
	...
	switch (iParam0)
	{
		...
		case -1862464078:
			return 1895628185;
		case 296923297:
			iVar0 = func_459(296923297, iParam1);
		...
		case -1414977761:
			return 1059434053;
		case 1237718549:
			iVar0 = func_459(1237718549, iParam1);
			return func_460(iVar0);
		case -23947011:
			return -456769142;
		case 1295334688:
...
bool func_446(int iParam0, int iParam1, bool bParam2, bool bParam3, int iParam4, bool bParam5, int iParam6, int iParam7, int iParam8, int iParam9, bool bParam10, bool bParam11, bool bParam12, bool bParam13)
{
		...
		default:
			...
			if ((WEAPON::_0x705BE297EEBDB95D(bVar0) || WEAPON::_0x959383DCD42040DA(bVar0)) && PED::GET_PED_RELATIONSHIP_GROUP_HASH(iParam0) == 1030835986)
			{
				...
				if (!Global_43890 && MISC::_DOES_STRING_EXIST_IN_STRING(&cVar5, "_DUALWIELD"))
				{
					...
					if (func_462(iVar3) && WEAPON::_0xF252A85B8F3F8C58(iVar2, iVar3))
					{
						bVar21 = true;
					}
				}
	...
	if (iParam9 < 0)
	{
		if (iParam0 != Global_35 && func_462(bVar0))
		{
	...
	{
		func_464(bVar0, iParam9, bParam2, bParam5, iParam4, bParam11, 752097756, 0);
	}
	else if (!bParam13)
	{
		fVar25 = 0f;
		func_465(iParam0, &bVar0, &fVar25);
...
float func_450(float fParam0, float fParam1, float fParam2)
{
	if (fParam0 > fParam2)
	{
		return fParam2;
...
int func_464(int iParam0, int iParam1, bool bParam2, bool bParam3, int iParam4, bool bParam5, int iParam6, bool bParam7)
{
	struct<4> Var0;
	int iVar5;
	struct<10> Var6;
	...
	{
		Var0 = { func_471(iParam0, 0, 1) };
		iVar5 = 1728382685; /* GXTEntry: "Right" */
		Var6.f_9 = -1591664384;
		iVar28 = 0;
		while (iVar28 < 4)
		{
			iVar5 = func_472((375 + iVar28), 1);
			if (func_473(iParam0, &Var0, iVar5, 0))
			{
				if (func_474(iParam0, &Var6, iVar5))
				{
					Var29 = { func_475(iParam0, Var0, iVar5, 0) };
					func_476(iParam0, &Var29, &Var0, 1, -142743235, 1, 0);
				}
				else
				{
					iVar28++;
				...
				if (func_477(0))
				{
					...
					func_478(WEAPON::_0x5C2EA6C44F515F34(iParam0), iParam1, iParam6);
...
void func_465(int iParam0, int iParam1, float fParam2)
{
	bool bVar0;
	int iVar1;
...
struct<5> func_471(int iParam0, bool bParam1, int iParam2)
{
	struct<5> Var0;
	struct<10> Var5;
	struct<10> Var27;
	...
	switch (func_483(iParam0))
	{
		...
		case -427144552:
			...
			if (iParam2 && func_485(iParam0, 1))
			{
				Var5.f_9 = -1591664384;
				if (!func_473(iParam0, &Var0, 1728382685, 0))
				{
					Var0.f_4 = 1728382685; /* GXTEntry: "Right" */
				}
				else if (!func_473(iParam0, &Var0, -649335959, 0))
				{
					Var0.f_4 = -649335959; /* GXTEntry: "Left" */
				}
				else if (func_474(iParam0, &Var5, 1728382685))
				{
					Var0.f_4 = 1728382685; /* GXTEntry: "Right" */
				}
				else
		...
		case -1650247667:
			...
			break;
		case -2130996531:
			if (func_488(iParam0, -1823706425))
			{
				Var0 = { func_475(-1838434463, Var0, 1084182731, bParam1) };
				Var0.f_4 = INVENTORY::_0x6452B1D357D81742(iParam0, -1838434463);
			}
			else if (func_488(iParam0, -1483207246))
			{
				Var0 = { func_475(889965687, Var0, 1034665895, bParam1) };
				Var0.f_4 = INVENTORY::_0x6452B1D357D81742(iParam0, 889965687);
			}
		...
		default:
			...
			else if (INVENTORY::_0x780C5B9AE2819807(iParam0, -833319691))
			{
				...
				if (!func_489(Var0, &Var27, bParam1, 0))
				{
					Var0.f_4 = 0;
				}
				else
...
bool func_473(int iParam0, var uParam1, int iParam2, bool bParam3)
{
	return func_490(iParam0, *uParam1, iParam2, bParam3) > 0;
}

int func_474(int iParam0, var uParam1, int iParam2)
{
	var uVar0;

	if (func_491(iParam0, &uVar0, uParam1, iParam2))
	{
...
struct<4> func_475(int iParam0, var uParam1, var uParam2, var uParam3, var uParam4, int iParam5, bool bParam6)
{
	...
	INVENTORY::_0x886DFD3E185C8A89(func_493(bParam6), &uParam1, iParam0, iParam5, &Var0);
	return Var0;
}

int func_476(int iParam0, var uParam1, var uParam2, int iParam3, int iParam4, int iParam5, bool bParam6)
{
	struct<12> Var0;
	int iVar14;
	...
	Var0.f_9 = -1591664384;
	if (!func_489(*uParam1, &Var0, bParam6, 0))
	{
		return 0;
	}
	if (iParam3 < 0)
	...
	if (!INVENTORY::_0x3E4E811480B3AE79(func_493(bParam6), uParam1, iParam3, iParam4))
	{
		return 0;
	}
	return 1;
...
int func_477(bool bParam0)
{
	...
	return INVENTORY::_0x0FBBFFC891A97C81(func_493(bParam0));
}
...
void func_479(int iParam0, int iParam1)
{
	...
	{
		iVar1 = func_496(WEAPON::_0xD3750CCC00635FC2(iParam0), iParam1);
...
{
	return func_475(1328661203, func_497(), -1591664384, bParam0);
}
...
struct<4> func_484(bool bParam0)
{
	...
	if (iVar0 == 2)
	{
		...
		{
			*Global_1224214 = { func_475(923904168, func_482(bParam0), -740156546, bParam0) };
		}
	...
	else if (iVar0 == 3)
	{
		...
		{
			*Global_1224222 = { func_475(923904168, func_482(bParam0), -740156546, 0) };
		}
		return *Global_1224222;
	}
	return func_475(923904168, func_482(bParam0), -740156546, 0);
}

int func_485(int iParam0, bool bParam1)
{
	if (func_487(iParam0) == 1779021115)
	{
		return 0;
	}
	if (WEAPON::_0xD955FEE4B87AFA07(iParam0))
	{
		if (bParam1)
		{
			return func_498(-1185145312, 0) > 0;
		}
		else
		{
			return 1;
...
struct<4> func_486(bool bParam0)
{
	...
	if (iVar0 == 2 || iVar0 == 3)
	{
		...
		{
			*Global_1224218 = { func_475(271701509, func_482(bParam0), 12999093, 0) };
		}
		return *Global_1224218;
	}
	return func_475(271701509, func_482(bParam0), 12999093, 0);
}
...
int func_489(var uParam0, var uParam1, var uParam2, var uParam3, var uParam4, bool bParam5, bool bParam6)
{
	if (!INVENTORY::_0xB881CA836CC4B6D4(&uParam0))
	{
		return 0;
	}
	if (!INVENTORY::_0x9700E8EFC4AB9089(func_493(bParam5), &uParam0, uParam4, !bParam6))
	{
		return 0;
	}
	return 1;
...
int func_490(int iParam0, struct<4> Param1, int iParam5, bool bParam6)
{
	...
	uVar4 = INVENTORY::_0xC97E0D2302382211(func_493(bParam6), &Var0, 0);
	return uVar4;
}

int func_491(int iParam0, var uParam1, var uParam2, int iParam3)
{
	int iVar0;

	iVar0 = func_493(0);
	*uParam1 = { func_475(iParam0, func_484(0), iParam3, 0) };
	if (!INVENTORY::_0xB881CA836CC4B6D4(uParam1))
	{
		return 0;
	}
...
int func_498(int iParam0, bool bParam1)
{
	...
	return INVENTORY::_0xE787F05DFC977BDE(func_493(bParam1), iParam0, 0);
}
