...
{
	func_33(uParam0, 10770/*func_30*/, 10855/*func_31*/, 11791/*func_32*/);
}
...
{
	func_46(uParam0, "WHORE_GIVE_MONEY", "script@ambient@town@WHORE_GIVE_MONEY_MADAM@action", vParam1, vParam4);
	func_47(uParam0, 1, "pbl_Action", "", 0);
	func_50(uParam0, 0, "FEMALE_A", func_49(func_48()), 0f, 0f, 0f, 0f, 1, 1, 1, 1, 41788943, 1);
	func_50(uParam0, 1, "FEMALE_B", func_49(func_48()), 0f, 0f, 0f, 0f, 1, 1, 1, 1, 41788943, 1);
	func_51(uParam0, 0, "p_cigarette01x", -967333571, 0f, 0f, 0f, 0f, 1);
	func_51(uParam0, 1, "MONEY", 531516298, 0f, 0f, 0f, 0f, 1);
}
...
{
	func_59(-22664287, 1, 0, -432460005);
	if (!func_60(-22664287))
	{
		return 0;
	}
...
int func_31(var uParam0)
{
		...
		if (ANIMSCENE::_0x25557E324489393C(uParam0->f_3.f_1))
		{
			if (ANIMSCENE::_0x477122B8D05E7968(uParam0->f_3.f_1, 1, 0))
			{
				...
				if (ENTITY::DOES_ENTITY_EXIST(&(uParam0->f_20[0 /*14*/])))
				{
					...
					else if (func_67(&(uParam0->f_20[0 /*14*/]), 0, &uLocal_9, &uVar0, 0, 0))
					{
						bVar1 = true;
					}
				}
				if (bVar1)
				{
					...
					if (!ENTITY::IS_ENTITY_DEAD(&(uParam0->f_20[0 /*14*/])))
					{
						TASK::_TASK_SMART_FLEE_STYLE_PED(&(uParam0->f_20[0 /*14*/]), Global_35, 3, 32832, -1082130432, -1, 0);
					}
					func_68(uParam0);
					if (!&uParam0->f_469[6])
					{
						func_69(*uParam0, uParam0->f_483, 0);
						uParam0->f_469[6] = 1;
					}
					uParam0->f_469[0] = 1;
				}
	...
	if (!&uParam0->f_469[0])
	{
		...
		if (uParam0->f_469[2] && !&uParam0->f_469[3])
		{
			if (!&uParam0->f_469[6])
			{
				if (func_71(uParam0, 1065353216, 1116471296, 4, -91962372, 1))
				{
					func_69(*uParam0, uParam0->f_483, 0);
					uParam0->f_469[6] = 1;
				}
					...
					if (ANIMSCENE::_0x1F0E401031E20146(uParam0->f_3.f_1, "pbl_action"))
					{
						if (!&uParam0->f_469[4])
						{
							if (ANIMSCENE::_0x005E6F28DD7ED58D(uParam0->f_3.f_1, (uParam0->f_20[1 /*14*/])->f_1))
							{
								...
								PED::_0x3BBDD6143FF16F98(&(uParam0->f_20[1 /*14*/]), &(uParam0->f_372[0 /*8*/]), "p_cigarette_cs01x_PH_R_HAND", "WORLD_HUMAN_SMOKE", 0, 1);
								func_72(&(uParam0->f_20[1 /*14*/]), -22664287, 15000, 0, -432460005, 0.8f);
						...
						if (!&uParam0->f_469[5])
						{
							if (ANIMSCENE::_0x005E6F28DD7ED58D(uParam0->f_3.f_1, (uParam0->f_20[0 /*14*/])->f_1))
							{
								...
								if (func_74(uParam0->f_483, -315.5648f, 812.581f, 120.9763f, 2f, 0))
								{
									TASK::_TASK_USE_NEAREST_SCENARIO_TO_COORD(&(uParam0->f_20[0 /*14*/]), -313.02f, 812.19f, 117.98f, 0.5f, 0, 0, 1, 0, 0);
								}
								else
								{
									TASK::_TASK_SMART_FLEE_STYLE_PED(&(uParam0->f_20[0 /*14*/]), &(uParam0->f_20[1 /*14*/]), 0, 256, 1000f, 30000, 0);
								}
						...
						if ((uParam0->f_469[4] && uParam0->f_469[5]) // PointerArith)
						{
							uParam0->f_469[3] = 1;
						}
					}
...
void func_50(var uParam0, int iParam1, char* sParam2, var uParam3, vector3 vParam4, float fParam7, int iParam8, int iParam9, int iParam10, int iParam11, int iParam12, int iParam13)
{
...
void func_51(var uParam0, int iParam1, char* sParam2, int iParam3, vector3 vParam4, float fParam7, int iParam8)
{
...
var func_59(int iParam0, int iParam1, int iParam2, int iParam3)
{
...
int func_67(int iParam0, int iParam1, var uParam2, var uParam3, int iParam4, float fParam5)
{
	int iVar0;
	...
	if (!Global_1935630->f_12 && !ENTITY::IS_ENTITY_DEAD(iParam0))
	{
		...
		{
			if (func_104(iParam0, uParam2))
			{
				*uParam3 = 128;
				func_105(iParam0, uParam2, *uParam3);
				return 1;
			}
		}
		if (Global_1935630->f_27)
		{
			if (!uParam2->f_1 & 8 != 0)
			{
				...
				else if (func_107(iParam0, iParam1, uParam2))
				{
					*uParam3 = 8;
					func_105(iParam0, uParam2, *uParam3);
					return 1;
		...
		if (Global_1935630->f_26 && func_109(PLAYER::PLAYER_ID(), 0, 1, uParam2->f_1 & 524288 == 0))
		{
		...
		{
			if (func_110(uParam2, 1065353216))
			{
				if (!uParam2->f_1 & 4 != 0)
				{
				...
				{
					if (func_112(Global_35, iParam0, uParam2))
					{
						*uParam3 = 256;
						func_105(iParam0, uParam2, *uParam3);
						return 1;
		...
		if (!uParam2->f_1 & 16 != 0)
		{
			...
			{
				if (func_113(Global_35, iParam0, uParam2, 0))
				{
					*uParam3 = 16;
					func_105(iParam0, uParam2, *uParam3);
					return 1;
			...
			else if (func_113(Global_35, iParam0, uParam2, 1))
			{
				*uParam3 = 16;
				func_105(iParam0, uParam2, *uParam3);
				return 1;
		...
		if (Global_1935630->f_30 || Global_1935630->f_31)
		{
			if (!uParam2->f_1 & 2 != 0)
			{
				if (func_116(uParam2, 4000))
				{
					if ((func_117(iParam0, Global_1935630->f_41, *uParam2 & 128 != 0, 0, *uParam2 & 256 != 0) && func_118(uParam2, iParam0)) && func_119(uParam2, iParam0))
					{
						*uParam3 = 2;
						func_105(iParam0, uParam2, *uParam3);
						return 1;
		...
		if (!uParam2->f_1 & 2 != 0)
		{
			if (uParam2->f_12 < 4f)
			{
				if ((func_117(iParam0, Global_1935630->f_41, *uParam2 & 128 != 0, 1, *uParam2 & 256 != 0) && func_118(uParam2, iParam0)) && func_119(uParam2, iParam0))
				{
					*uParam3 = 2;
					func_105(iParam0, uParam2, *uParam3);
					return 1;
				...
				if (Global_1935630->f_40 == 0)
				{
					if (Global_1935630->f_41 != 0)
					{
						if (*uParam2 & 131072 == 0)
						{
							if (func_120(iParam0, Global_1935630->f_41))
							{
								func_121();
								*uParam3 = 2;
								func_105(iParam0, uParam2, *uParam3);
			...
			if (uParam2->f_12 < 10f)
			{
				if (func_122(uParam2, iParam0) || (uParam2->f_9 > 0 && (func_123() - uParam2->f_9) < 2000))
				{
			...
			if (Global_1935630->f_42 != 0)
			{
				if (*uParam2 & 131072 == 0)
				{
					if (func_124())
					{
						if (func_120(iParam0, Global_1935630->f_42))
						{
							func_121();
							*uParam3 = 2;
							func_105(iParam0, uParam2, *uParam3);
		...
		if (uParam2->f_12 < uParam2->f_26)
		{
			...
			{
				if (func_126(iParam0, iParam1, uParam2))
				{
					*uParam3 = 2048;
					func_105(iParam0, uParam2, *uParam3);
					return 1;
...
void func_69(int iParam0, vector3 vParam1, bool bParam4)
{
	...
	func_134(iParam0);
	func_135(iParam0, vParam1);
	Global_32073.f_2697.f_6[iParam0 /*6*/] = &Global_32073.f_2697.f_6[iParam0 /*6*/] + 1;
	Global_32073.f_2697.f_2++;
}

int func_70(var uParam0, float fParam1, float fParam2, int iParam3, float fParam4, float fParam5)
{
	int iVar0;
	float fVar1;
	int iVar2;
	...
	if ((MISC::GET_FRAME_COUNT() % 8) == 0)
	{
		...
		fVar7 = func_139(Global_36, uParam0->f_483);
		...
		while (iVar0 < uParam0->f_19)
		{
			...
			if (!ENTITY::IS_ENTITY_DEAD(&(uParam0->f_20[iVar0 /*14*/])))
			{
				...
				fVar8 = func_140(Global_35, &(uParam0->f_20[iVar0 /*14*/]), 1);
				if (fVar8 < fVar1)
				{
					return 1;
				}
...
int func_71(var uParam0, float fParam1, float fParam2, int iParam3, int iParam4, bool bParam5)
{
	int iVar0;
		...
		while (iVar0 < uParam0->f_19)
		{
			...
			else
			{
				if (!ENTITY::IS_ENTITY_DEAD(&(uParam0->f_20[iVar0 /*14*/])))
				{
					...
					{
						if ((func_140(Global_35, &(uParam0->f_20[iVar0 /*14*/]), 1) < fParam2 && PED::_0x5102307CE88798EB(&(uParam0->f_20[iVar0 /*14*/]))) && PED::IS_TRACKED_PED_VISIBLE(&(uParam0->f_20[iVar0 /*14*/])))
						{
							if (!func_141(&(uParam0->f_490)))
							{
								func_145(&(uParam0->f_490), 0);
							}
...
void func_72(int iParam0, int iParam1, int iParam2, int iParam3, int iParam4, int iParam5)
{
...
int func_79(vector3 vParam0, float fParam3)
{
	...
	while (iVar0 < 4)
	{
		...
		{
			if (func_74(vParam0, (Global_1415419->f_9721[iVar0 /*8*/])->f_4, fParam3, 0))
			{
				return 1;
			}
		}
...
int func_80(vector3 vParam0)
{
	...
	while (iVar0 < 10)
	{
		...
		{
			if (func_74(vParam0, (Global_32073.f_2697.f_1495[iVar0 /*4*/])->f_1, 1f, 0))
			{
				return 1;
			}
		}
...
{
	return (BUILTIN::SHIFT_RIGHT(iParam0, 26) & 31 * func_150(MISC::IS_BIT_SET(iParam0, 31), -1, 1)) + 1898;
}
...
void func_103(var uParam0, bool bParam1, int iParam2)
{
	...
	if (!uParam0->f_1 & 1024 != 0)
	{
		if (!ENTITY::DOES_ENTITY_EXIST(uParam0->f_14))
		{
			if (func_167(uParam0))
			{
				uParam0->f_15 = func_123();
			}
		}
		else if (uParam0->f_15 > 0)
		{
			if ((func_123() - uParam0->f_15) > 500)
			{
...
int func_104(int iParam0, var uParam1)
{
	...
	switch (iVar0)
	{
		...
		case 1589923363:
			...
			if (!func_169(iParam0, uParam1, iVar2))
			{
				return 0;
			}
			if (func_170(iParam0, iVar2) <= func_171(uParam1))
			{
				return 1;
			}
			break;
...
int func_106(int iParam0, var uParam1)
{
	...
	{
		if (func_175(iParam0, !*uParam1 & 268435456 != 0, !*uParam1 & 536870912 != 0, !*uParam1 & 1073741824 != 0, 0, 0))
		{
			if (uParam1->f_12 < 5f)
			{
				fVar0 = 95f;
			...
			fVar1 = func_176(uParam1);
			if (func_177(uParam1, iParam0, fVar0, fVar1))
			{
				if (uParam1->f_2 == 0)
				{
...
int func_107(int iParam0, int iParam1, var uParam2)
{
	...
	fVar0 = 85f;
	if (func_179(iParam1, !*uParam2 & 268435456 != 0, !*uParam2 & 536870912 != 0, !*uParam2 & 1073741824 != 0, 0))
	{
		if (uParam2->f_12 < 5f)
		{
			fVar0 = 95f;
		...
		fVar1 = func_176(uParam2);
		if (func_177(uParam2, iParam0, fVar0, fVar1))
		{
			if (uParam2->f_2 == 0)
			{
			...
			if (uParam2->f_2 != 0)
			{
				if (MISC::GET_GAME_TIMER() - uParam2->f_2) > func_178(uParam2)
				{
					func_173(uParam2, 1);
					return 1;
				}
...
int func_108(int iParam0, var uParam1)
{
	...
	if (func_169(iParam0, uParam1, iVar1))
	{
		if (uParam1->f_3 == 0)
		{
			uParam1->f_3 = MISC::GET_GAME_TIMER();
		}
		else if (MISC::GET_GAME_TIMER() - uParam1->f_3) > func_178(uParam1)
		{
			fVar3 = func_176(uParam1);
...
int func_109(int iParam0, bool bParam1, int iParam2, bool bParam3)
{
	...
	{
		return func_180(bParam1, iParam2, bParam3);
	}
	if (Global_1572887->f_12 != -1)
	{
...
int func_110(var uParam0, float fParam1)
{
	int iVar0;
	int iVar1;
...
int func_112(var uParam0, int iParam1, var uParam2)
{
	var uVar0;
	
	if (uParam2->f_12 < IntToFloat(func_182(uParam2)))
	{
		...
		switch (iVar3)
		{
			...
			case 2:
				if (EVENT::IS_SHOCKING_EVENT_IN_SPHERE(-966930978, vVar0, uParam2->f_22))
				{
					...
					if (func_184(iParam1, vVar0, vVar4))
					{
						func_173(uParam2, 1);
						return 1;
					}
		...
		switch (iVar3)
		{
			...
			case 2:
				if (EVENT::IS_SHOCKING_EVENT_IN_SPHERE(-966930978, vVar0, uParam2->f_22))
				{
					...
					if (func_184(iParam1, vVar0, vVar7))
					{
						func_173(uParam2, 1);
						return 1;
					}
...
int func_114(int iParam0, var uParam1)
{
	...
	{
		if (!func_169(iParam0, uParam1, &(Global_1935630->f_34[iVar0])) || iParam0 == &Global_1935630->f_34[iVar0])
		{
		}
		else
		{
			bVar13 = func_185(&(Global_1935630->f_34[iVar0]));
			...
			if (func_186(uParam1, iParam0, fVar1, bVar12, bVar13))
			{
				*(vVar2[0 /*3*/]) = { ENTITY::GET_ENTITY_COORDS(&(Global_1935630->f_34[iVar0]), false, false) };
				*(vVar2[1 /*3*/]) = { vVar9 };
				uParam1->f_10 = iParam0;
			...
			else if (func_187(uParam1, iParam0, fVar1, bVar12, bVar13))
			{
				*(vVar2[0 /*3*/]) = { ENTITY::GET_ENTITY_COORDS(&(Global_1935630->f_34[iVar0]), false, false) };
				*(vVar2[1 /*3*/]) = { vVar9 };
				uParam1->f_10 = iParam0;
			...
			else if (func_188(uParam1, iParam0, fVar1, iVar0))
			{
				*(vVar2[0 /*3*/]) = { ENTITY::GET_ENTITY_COORDS(&(Global_1935630->f_34[iVar0]), false, false) };
				*(vVar2[1 /*3*/]) = { vVar9 };
				uParam1->f_10 = iParam0;
...
int func_120(int iParam0, int iParam1)
{
	if (!ENTITY::IS_ENTITY_DEAD(iParam1))
	{
		...
		if (func_192(iParam0, iParam1, 1, 1) < 4f)
		{
...
int func_122(var uParam0, int iParam1)
{
	...
	if (iVar0 != 0 && !VEHICLE::IS_THIS_MODEL_A_TRAIN(ENTITY::GET_ENTITY_MODEL(iVar0)))
	{
		...
		if (func_193(iVar0, iParam1, vVar1))
		{
			uParam0->f_9 = func_123();
			return 1;
		}
...
int func_125(var uParam0, int iParam1)
{
	...
	fVar0 = func_171(uParam0);
	if (uParam0->f_12 > func_195(uParam0) && uParam0->f_12 > fVar0)
	{
		return 0;
	}
	iVar2 = func_196(iParam1);
	iVar1 = func_197(uParam0->f_14);
...
int func_126(int iParam0, int iParam1, var uParam2)
{
	...
	return func_198(iParam0, iParam1, bVar0, bVar2, uParam2->f_12, bVar1);
}
...
int func_131(int iParam0, var uParam1)
{
	...
	if (uParam1->f_4 == 0)
	{
		uParam1->f_4 = func_123();
	}
	else if (func_123() - uParam1->f_4) > func_202(uParam1)
	{
		return func_203(iParam0, uParam1, 0, -1082130432);
	}
	return 0;
}
...
void func_134(int iParam0)
{
	if (func_43(iParam0))
	{
		...
		{
			case 1:
				func_204(0, 1, 0, 0, ((Global_1415419->f_19[iParam0 /*12*/])->f_7 / 4), 0, 0, 1);
				func_204(1, 1, 0, 0, ((Global_1415419->f_19[iParam0 /*12*/])->f_7 / 4), 0, 0, 1);
				break;
			
			case 37:
				func_204(60, 1, 0, 0, ((Global_1415419->f_19[iParam0 /*12*/])->f_7 / 4), 0, 0, 1);
				break;
		}
	}
}
...
void func_135(int iParam0, vector3 vParam1)
{
	...
	while (iVar0 < 10)
	{
		...
		{
			if (func_74((Global_32073.f_2697.f_1495[iVar0 /*4*/])->f_1, vParam1, 1056964608, 1))
			{
				return;
			}
		}
...
float func_139(vector3 vParam0, vector3 vParam3)
{
	vParam0.f_2 = 0f;
	vParam3.f_2 = 0f;
...
float func_140(int iParam0, int iParam1, bool bParam2)
{
	...
	return func_205(ENTITY::GET_ENTITY_COORDS(iParam0, false, false), ENTITY::GET_ENTITY_COORDS(iParam1, false, false));
}
...
int func_169(int iParam0, var uParam1, int iParam2)
{
	...
	{
		iVar1 = func_197(iParam2);
	}
	else
	{
		iVar1 = func_196(iParam2);
	}
	if (!PED::IS_PED_HUMAN(iParam0))
	{
...
{
	return func_192(iParam0, iParam1, 1, 1);
}
...
int func_172(int iParam0, int iParam1, int iParam2, int iParam3, int iParam4)
{
	switch (iParam0)
	{
		case 8:
...
int func_175(int iParam0, bool bParam1, bool bParam2, bool bParam3, int iParam4, int iParam5)
{
	int iVar0;
	int iVar1;
	int iVar2;
	...
	if (bParam3)
	{
		if (((WEAPON::_0xCB690F680A3EA971(iVar0, 1) && PLAYER::IS_PLAYER_TARGETTING_ENTITY(iVar1, iParam0, iParam5)) && PLAYER::IS_PLAYER_FREE_AIMING_AT_ENTITY(iVar1, iParam0)) && func_192(iVar0, iParam0, 1, 1) <= 4f)
		{
			return 1;
		}
	}
...
int func_177(var uParam0, int iParam1, float fParam2, float fParam3)
{
	float fVar0;
...
int func_179(int iParam0, bool bParam1, bool bParam2, bool bParam3, int iParam4)
{
	int iVar0;
	int iVar1;
...
int func_180(bool bParam0, var uParam1, var uParam2)
{
...
int func_184(int iParam0, vector3 vParam1, vector3 vParam4)
{
...
int func_186(var uParam0, int iParam1, float fParam2, bool bParam3, bool bParam4)
{
	float fVar0;
...
int func_188(var uParam0, int iParam1, float fParam2, int iParam3)
{
	float fVar0;
...
int func_193(int iParam0, int iParam1, vector3 vParam2)
{
	float fVar0;
...
int func_198(int iParam0, int iParam1, bool bParam2, bool bParam3, float fParam4, bool bParam5)
{
	bool bVar0;
	int iVar1;
	float fVar2;
	...
	if (fParam4 <= 0f)
	{
		fVar2 = func_192(iParam0, PLAYER::PLAYER_PED_ID(), 0, 1);
	}
	else
	{
		fVar2 = fParam4;
	...
	if (bVar0)
	{
		if (func_192(iParam0, Global_1935630->f_40, 0, 1) < 2.5f)
		{
...
int func_199(int iParam0, var uParam1, bool bParam2)
{
	int iVar0;
	int iVar1;
	...
	if (ENTITY::DOES_ENTITY_EXIST(iVar0))
	{
		if (iVar0 != iParam0)
		{
			if (PED::_0x06087579E7AA85A9(iParam0, Global_35, -1f, -1f, -1f, -1f))
			{
				if (ENTITY::HAS_ENTITY_CLEAR_LOS_TO_ENTITY(iParam0, Global_35, 17))
				{
					if (!bParam2 || !func_200(uParam1, iVar0))
					{
						return 1;
					}
				}
	...
	if (ENTITY::DOES_ENTITY_EXIST(iVar1))
	{
		if (iVar1 != iParam0)
		{
			...
			{
				if (!bParam2 || !func_200(uParam1, iVar1))
				{
...
int func_203(int iParam0, var uParam1, bool bParam2, float fParam3)
{
	if (!bParam2)
	{
		if (uParam1->f_4 == 0)
...
void func_204(int iParam0, int iParam1, int iParam2, int iParam3, int iParam4, int iParam5, bool bParam6, int iParam7)
{
	int iVar0;
...
float func_205(vector3 vParam0, vector3 vParam3)
{
	vParam0.f_2 = 0f;
	vParam3.f_2 = 0f;
