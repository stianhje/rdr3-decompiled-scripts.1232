...
int func_72(var uParam0)
{
	...
	uLocal_16 = func_155(uParam0, "script@vignette@micah_2@actionA_-90", 2, 0, 0, 0);
	uLocal_17 = func_155(uParam0, "script@vignette@micah_2@actionA_-45", 2, 0, 0, 0);
	uLocal_18 = func_155(uParam0, "script@vignette@micah_2@actionA_0", 2, 0, 0, 0);
	uLocal_19 = func_155(uParam0, "script@vignette@micah_2@actionA_45", 2, 0, 0, 0);
	uLocal_20 = func_155(uParam0, "script@vignette@micah_2@actionA_90", 2, 0, 0, 0);
...
int func_86(var uParam0)
{
	...
	{
		if (WEAPON::HAS_PED_GOT_WEAPON(func_48(uParam0, iLocal_14), joaat("weapon_revolver_doubleaction_micah"), 0, 0))
		{
