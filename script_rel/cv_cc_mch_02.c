...
int func_86(var uParam0)
{
	...
	{
		if (WEAPON::HAS_PED_GOT_WEAPON(func_48(uParam0, iLocal_14), 36703333, 0, 0))
		{
			WEAPON::SET_CURRENT_PED_WEAPON(func_48(uParam0, iLocal_14), 36703333, true, 0, false, false);
		}
	}
	return 1;
}
