...
{
	func_33(uParam0, 10727/*func_30*/, 10786/*func_31*/, 11454/*func_32*/);
}
...
{
	func_46(uParam0, "BEAR_SCRATCH_BACK", "script@ambient@animal@bear_scratch_back_on_tree@action", vParam1, vParam4);
	func_47(uParam0, 1, "pbl_action", "", 0);
	func_48(uParam0, 0, "BEAR", iLocal_9, 0f, 0f, 0f, 0f, 1, 1, 1, 1, 41788943, 0);
}
...
int func_31(var uParam0)
{
	if (!ENTITY::IS_ENTITY_DEAD(&(uParam0->f_20[0 /*14*/])))
	{
		...
		bLocal_39 = ANIMSCENE::_0x3AB6C7B0BB0DF4B1(&(uParam0->f_20[0 /*14*/]), -1);
	}
	if (!&uParam0->f_469[0])
	{
		if (!bLocal_38)
		{
			if (func_64(uParam0, &uLocal_10, 1) || func_65(Global_35, &(uParam0->f_20[0 /*14*/]), 1) < 900f)
			{
				bLocal_38 = true;
			}
		}
	...
	if (!&uParam0->f_469[0] && !bLocal_38)
	{
		...
		if (&uParam0->f_469[2])
		{
			if (!&uParam0->f_469[4])
			{
				if (func_73(uParam0, 3f, 1116471296, 4, -91962372, 1))
				{
					func_69(*uParam0, uParam0->f_483, 1);
					uParam0->f_469[4] = 1;
				}
...
void func_70(var uParam0)
{
	if (!ENTITY::IS_ENTITY_DEAD(&(uParam0->f_20[0 /*14*/])))
	{
		if (func_109(Global_35, uParam0->f_483, 1) < 2500f)
		{
