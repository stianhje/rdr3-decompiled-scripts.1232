...
int func_52(var uParam0, int iParam1, var uParam2, int iParam3, int iParam4, char* sParam5, int iParam6, int iParam7, bool bParam8)
{
	int iVar0;
	vector3 vVar1;
	...
	if (!VOLUME::_0x92A78D0BEDB332A3(func_91(iParam3)))
	{
		return 0;
	}
	...
	if ((iParam6 && func_95(128, 0, 1)) && !iParam1 == 64)
	{
		return 0;
	}
...
int func_106(int iParam0, bool bParam1)
{
	...
	{
		func_160(iParam0, _NAMESPACE48::_0x4F76E3676583D951(func_159(iParam0)));
		if (func_20() == -1)
		{
			if (func_142(iParam0, 2048))
			{
				_NAMESPACE48::_0x49A8C2CD97815215(func_161(iParam0));
				func_162(iParam0, 2048);
			}
			_NAMESPACE48::_0xFCC6DB8DBE709BC8(func_161(iParam0));
		}
		return 0;
	}
	...
	if (_NAMESPACE48::_0x800DF3FC913355F3(func_161(iParam0)))
	{
		func_162(iParam0, 128);
		return 1;
	}
	func_160(iParam0, _NAMESPACE48::_0x4F76E3676583D951(func_159(iParam0)));
	_NAMESPACE48::_0x4F81EAD1DE8FA19B(func_161(iParam0));
	if (func_142(iParam0, 2048))
	{
		_NAMESPACE48::_0x49A8C2CD97815215(func_161(iParam0));
		func_162(iParam0, 2048);
...
int func_143(int iParam0, bool bParam1)
{
	...
	func_190(iParam0);
	_NAMESPACE48::_0xFC77C5B44D5FF7C0(func_161(iParam0));
	func_160(iParam0, 0);
	return 1;
}
...
var func_146(int iParam0, int iParam1, int iParam2)
{
...
int func_148(int iParam0, int iParam1, int iParam2, int iParam3, int iParam4)
{
	...
	uVar0 = func_146(iParam0, iParam1, iParam2);
	iVar1 = iParam3;
	func_193(iVar1, 0);
	func_194(iVar1, 0);
	func_195(iVar1, 0);
