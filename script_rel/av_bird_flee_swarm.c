...
{
	func_33(uParam0, 14251/*func_30*/, 14260/*func_31*/, 14943/*func_32*/);
}
...
void func_14(var uParam0, vector3 vParam1, vector3 vParam4)
{
	...
	func_46(uParam0, "BIRD_FLEE_SWARM", "", vParam1, vParam4);
	iVar0 = 1;
	switch (*uParam0)
	{
		case 79:
		...
		case 99:
			...
			iLocal_9 = -164963696;
			iLocal_34 = 1900682975;
			break;
		case 100:
			iLocal_9 = -1910795227;
			iLocal_34 = 2125854612;
			break;
		case 101:
			iLocal_9 = -1028170431;
			iLocal_34 = 2125854612;
...
int func_31(var uParam0)
{
	...
	switch (iLocal_10)
	{
		case 0:
			if (!ENTITY::IS_ENTITY_DEAD(&(uParam0->f_20[iLocal_41 /*14*/])))
			{
				if (!TASK::_0x841475AC96E794D1(&(uLocal_12[iLocal_41])))
				{
					...
					TASK::_TASK_USE_SCENARIO_POINT(&(uParam0->f_20[iLocal_41 /*14*/]), &(uLocal_12[iLocal_41]), 0, 0, 0, iVar2, 0, 0, -1082130432, 0);
					func_57(uParam0->f_20[iLocal_41 /*14*/], 0, 1);
				}
			}
			iLocal_41++;
		...
		case 1:
			...
			else if (fVar0 < 3600f && !func_50(uParam0->f_503, 1))
			{
					...
					else
					{
						...
						while (iVar1 < iLocal_43)
						{
							if (!ENTITY::IS_ENTITY_DEAD(&(uParam0->f_20[iVar1 /*14*/])))
							{
								...
								{
									func_60(*uParam0, 0);
									func_61(*uParam0, uParam0->f_483, 0);
									func_62(&uLocal_35);
									iLocal_10 = 3;
								}
								Jump @679; //curOff = 519
								if (ENTITY::DOES_ENTITY_EXIST(&(uParam0->f_20[iLocal_41 /*14*/])))
								{
									...
									{
										TASK::_TASK_SMART_FLEE_STYLE_PED(&(uParam0->f_20[iLocal_41 /*14*/]), Global_35, 3, 0, -1082130432, -1, 0);
...
int func_32(var uParam0, bool bParam1)
{
	...
	if (VOLUME::_0x92A78D0BEDB332A3(iLocal_39))
	{
		VOLUME::_0x43F867EF5C463A53(iLocal_39);
	}
	if (VOLUME::_0x92A78D0BEDB332A3(iLocal_11))
	{
		VOLUME::_0x43F867EF5C463A53(iLocal_11);
	}
...
int func_58(var uParam0, float fParam1, float fParam2, int iParam3, float fParam4, float fParam5)
{
	...
	if ((MISC::GET_FRAME_COUNT() % 8) == 0)
	{
		...
		fVar7 = func_86(Global_36, uParam0->f_483);
		...
		while (iVar0 < uParam0->f_19)
		{
			...
			if (!ENTITY::IS_ENTITY_DEAD(&(uParam0->f_20[iVar0 /*14*/])))
			{
				...
				fVar8 = func_87(Global_35, &(uParam0->f_20[iVar0 /*14*/]), 1);
				if (fVar8 < fVar1)
				{
					return 1;
				}
...
int func_59(var uParam0)
{
	...
	if ((MISC::GET_GAME_TIMER() - iLocal_38) > 1000)
	{
		...
		{
			ITEMSET::_0x20A4BF0E09BEE146(iLocal_40);
		}
		if (!VOLUME::_0x92A78D0BEDB332A3(iLocal_39))
		{
			if (*uParam0 == 90)
			{
				iLocal_39 = VOLUME::_0xB3FB80A32BAE3065((uParam0->f_20[0 /*14*/])->f_5, 0f, 0f, 0f, 6f, 6f, 10f);
			}
			else if (*uParam0 == 93)
			{
				iLocal_39 = VOLUME::_0xB3FB80A32BAE3065((uParam0->f_20[0 /*14*/])->f_5, 0f, 0f, 0f, 20f, 20f, 10f);
			}
			else
			{
				iLocal_39 = VOLUME::_0xB3FB80A32BAE3065((uParam0->f_20[0 /*14*/])->f_5, 0f, 0f, 0f, 25f, 25f, 10f);
			}
		}
		...
		while (iVar2 < iVar0)
		{
			...
			iVar3 = ENTITY::GET_PED_INDEX_FROM_ENTITY_INDEX(MISC::_0xEE04C0AFD4EFAF0E(iVar1));
...
void func_61(int iParam0, vector3 vParam1, bool bParam4)
{
	if (func_40() > (Global_32073.f_2697.f_6[iParam0 /*6*/])->f_5)
	{
		(Global_32073.f_2697.f_6[iParam0 /*6*/])->f_5 = func_40();
...
int func_67(vector3 vParam0, float fParam3)
{
	...
	while (iVar0 < 4)
	{
		...
		{
			if (func_95(vParam0, (Global_1415419->f_9721[iVar0 /*8*/])->f_4, fParam3, 0))
			{
				return 1;
			}
		}
...
int func_68(vector3 vParam0)
{
	...
	while (iVar0 < 10)
	{
		...
		{
			if (func_95(vParam0, (Global_32073.f_2697.f_1495[iVar0 /*4*/])->f_1, 1f, 0))
			{
				return 1;
			}
		}
...
void func_91(int iParam0)
{
	if (func_43(iParam0))
	{
		...
		{
			case 1:
				func_112(0, 1, 0, 0, ((Global_1415419->f_19[iParam0 /*12*/])->f_7 / 4), 0, 0, 1);
				func_112(1, 1, 0, 0, ((Global_1415419->f_19[iParam0 /*12*/])->f_7 / 4), 0, 0, 1);
				break;
			case 37:
				func_112(60, 1, 0, 0, ((Global_1415419->f_19[iParam0 /*12*/])->f_7 / 4), 0, 0, 1);
				break;
		}
	}
}

void func_92(int iParam0, vector3 vParam1)
{
	int iVar0;
	int iVar1;
	...
	while (iVar0 < 10)
	{
		...
		{
			if (func_95((Global_32073.f_2697.f_1495[iVar0 /*4*/])->f_1, vParam1, 1056964608, 1))
			{
				return;
			}
		}
...
void func_112(int iParam0, int iParam1, int iParam2, int iParam3, int iParam4, int iParam5, bool bParam6, int iParam7)
{
	int iVar0;

	iVar0 = (((iParam2 + (60 * iParam3)) + (3600 * iParam4)) + (86400 * iParam5));
	if (func_121(iParam0) == 1 && iParam7)
	{
		return;
	}
	if (bParam6)
