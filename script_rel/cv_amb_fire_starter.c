...
int func_72(var uParam0)
{
	...
	func_152(uParam0, 617552302, 0f, 0f, 0f, "MATCH", 0, 0, 1);
	func_152(uParam0, -1413776846, 0f, 0f, 0f, "MATCHBOX", 0, 0, 1);
	func_152(uParam0, 1810315535, 0f, 0f, 0f, "STICK", 0, 0, 1);
	iLocal_16 = func_153(uParam0, "script@vignette@ambient@av_fire_starter@pl_action", 0, 1, 0, 0);
	switch (func_19(uParam0))
	{
		case 12:
			...
			iLocal_15 = func_152(uParam0, -1006095118, 1.198f, -1.869f, 0.472f, 0, 1, 0, 1);
			func_156(uParam0, iLocal_14, 3, -38747227, "PROP_CAMP_FIRE_SEATED_MALE_Q", iLocal_15, 0, -1073741824, 1065353216, 1);
			break;
		case 13:
			...
			func_156(uParam0, iLocal_14, 2, 2087366558, "WORLD_HUMAN_STAND_WAITING_MALE_A", -1, 1, -1073741824, 1065353216, 1);
			break;
		case 14:
			switch (func_148(uParam0))
			{
				case 1:
					iVar0 = func_152(uParam0, 1872659725, 2.07f, -0.78f, 0f, 0, 1, 0, 1);
					break;
				case 2:
					iVar0 = func_152(uParam0, 737690157, 2.07f, -0.78f, 0f, 0, 1, 0, 1);
					break;
				case 3:
					iVar0 = func_152(uParam0, -441696329, 2.07f, -0.78f, 0f, 0, 1, 0, 1);
					break;
				case 6:
					iVar0 = func_152(uParam0, -441696329, 2.07f, -0.78f, 0f, 0, 1, 0, 1);
					break;
			...
			func_156(uParam0, iLocal_14, 2, 1446817251, "WORLD_CAMP_FIRE_SIT_GROUND_MALE_C", iVar0, 1, -1073741824, 1065353216, 1);
			break;
		default:
			return 0;
	}
...
int func_150(var uParam0, vector3 vParam1, float fParam4, vector3 vParam5, int iParam8, bool bParam9)
{
	int iVar0;

	if (bParam9)
	{
		vParam1 = { func_247(uParam0, vParam1) };
...
int func_155(var uParam0, int iParam1, char* sParam2, int iParam3)
{
	int iVar0;
	char cVar1[64];
	...
	while (iVar0 < uParam0->f_1711)
	{
		...
		else
		{
			...
			if (!(uParam0->f_1711[iVar0 /*15*/])->f_5 && !ENTITY::DOES_ENTITY_EXIST((uParam0->f_1711[iVar0 /*15*/])->f_10))
			{
				...
				{
					vVar3 = { func_247(uParam0, (uParam0->f_1711[iVar0 /*15*/])->f_1) };
				}
				else
				{
...
void func_182(var uParam0)
{
	...
	{
		uParam0->f_1976.f_6 = PROPSET::_CREATE_PROPSET_2(uParam0->f_1976, func_247(uParam0, uParam0->f_1976.f_1), 1, func_248(uParam0, uParam0->f_1976.f_4), 3f, false, true);
	}
}
...
Vector3 func_247(var uParam0, vector3 vParam1)
{
	return OBJECT::_GET_OBJECT_OFFSET_FROM_COORDS(uParam0->f_23, uParam0->f_26.f_2, vParam1);
}

float func_248(var uParam0, float fParam1)
{
	float fVar0;
...
int func_262(var uParam0)
{
	...
	while (iVar1 < uParam0->f_1711)
	{
		...
		else if ((uParam0->f_1711[iVar1 /*15*/])->f_5)
		{
			...
			{
				vVar2 = { func_247(uParam0, (uParam0->f_1711[iVar1 /*15*/])->f_1) };
			}
			else
			{
