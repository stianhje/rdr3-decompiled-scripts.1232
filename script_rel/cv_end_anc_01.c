...
int func_109(int iParam0, int iParam1, int iParam2, bool bParam3, bool bParam4)
{
	...
	if (func_122(iVar0, 0))
	{
		...
		if ((iParam1 || !func_107(iParam0)) || func_53(iParam0))
		{
...
void func_151(var uParam0, int iParam1, int iParam2, int iParam3, int iParam4)
{
...
int func_156(var uParam0, var uParam1, int iParam2, char* sParam3)
{
	int iVar0;
...
void func_313(var uParam0, int iParam1, bool bParam2, bool bParam3)
{
	...
	if (bParam3)
	{
		uVar0 = func_354(uParam0, iParam1);
	}
	if (bParam2)
	{
...
int func_341(int iParam0, bool bParam1, bool bParam2, bool bParam3, int iParam4, bool bParam5)
{
	...
	if ((iParam4 && !func_60(iParam0)) && !ENTITY::IS_ENTITY_DEAD(iVar0))
	{
...
int func_365(var uParam0, int iParam1, bool bParam2, bool bParam3, var uParam4, var uParam5, var uParam6, bool bParam7, bool bParam8, var uParam9, var uParam10, var uParam11, float fParam12, bool bParam13, bool bParam14, bool bParam15, bool bParam16, bool bParam17)
{
	...
	if ((!ENTITY::DOES_ENTITY_EXIST(iVar0) || !func_122(iVar0, 0)) || (bParam3 && !func_53(iParam1)))
	{
		if (bParam2)
		{
			...
			{
				iVar0 = func_396(iParam1, bParam3, bParam8, uParam9, uParam10, uParam11, fParam12, bParam7, bParam15, bParam16, bParam17);
			}
			else
			{
				*uParam0 = 1;
...
int func_396(int iParam0, bool bParam1, bool bParam2, var uParam3, var uParam4, var uParam5, float fParam6, bool bParam7, bool bParam8, bool bParam9, bool bParam10)
{
	vector3 vVar0;
	int iVar3;
	char* sVar4;
