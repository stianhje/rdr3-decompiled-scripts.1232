...
{
	func_33(uParam0, 10798/*func_30*/, 10849/*func_31*/, 11556/*func_32*/);
}
...
var func_65(int iParam0, vector3 vParam1, float fParam4, float fParam5, float fParam6, int iParam7)
{
