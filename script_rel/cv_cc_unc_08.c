...
{
	uParam0->f_23 = { func_149(iParam1) + Vector(iParam4, iParam3, iParam2) };
...
void func_440(int iParam0, int iParam1, bool bParam2)
{
	...
	if ((Global_40.f_4942[iParam0 /*60*/])->f_5 & 65536/*func_400*/ > 0 && func_400(iParam1, -972364774))
	{
...
void func_441(int iParam0)
{
	...
	func_460(iParam0, 65536/*func_400*/);
