...
{
	if (!TASK::_IS_SCENARIO_GROUP_ENABLED_HASH(iLocal_59))
	{
		TASK::_SET_SCENARIO_GROUP_ENABLED_HASH(iLocal_59, true);
	}
	return 1;
}
...
int func_72(var uParam0)
{
	...
	{
		case 1:
			vLocal_56 = { -111.98f, -37.59f, 94.73f };
			func_149(uParam0, 145, 0, 0, 0);
			break;
		
		case 2:
			vLocal_56 = { 678.39f, -1265.06f, 42.98f };
			func_149(uParam0, 78, 0, 0, 0);
			break;
		
		case 3:
			vLocal_56 = { 1882.42f, -1882.1f, 41.81f };
	...
	func_151(uParam0, -3.675f, 0.855f, 0.85f, -51.5f, 1.2975f, 1.285f, 3.2075f, -1612834106, -950285770, 1, 1, 1);
	func_151(uParam0, 2.15f, -0.75f, 0.85f, -50.5f, 3.2175f, 1.8725f, 3.2075f, -1612834106, -1377448058, 1, 1, 1);
	func_151(uParam0, -0.425f, -0.8875f, 0.85f, -27.25f, 1.2175f, 2.805f, 3.2075f, -1612834106, -1, 1, 1, 1);
	func_152(uParam0, 0.45f, -0.6f, 0f, 0f, 1.15f, 1.18f, 3f, 665633627, 1);
	iLocal_24 = func_153(uParam0, 1504738597, -0.938435f, -1.52674f, -0.00881958f, 0, 1, 0, 1);
	iLocal_23 = func_153(uParam0, 1210783447, 0f, 0f, 0f, "BOOK", 0, 0, 1);
	iLocal_21 = func_153(uParam0, -1074884633, 0f, 0f, 0f, "RAG", 0, 1, 1);
	iLocal_22 = func_153(uParam0, -1916489787, 0f, 0f, 0f, "WASHBOARD", 0, 1, 1);
	func_154(uParam0, "script@vignette@tilly_2@base", 1, 1, 0, 0);
	iLocal_16 = func_154(uParam0, "script@vignette@tilly_2@Action_A", 2, 0, 1, 0);
	iLocal_17 = func_154(uParam0, "script@vignette@tilly_2@Action_A_Int_Front", 2, 0, 0, 1);
	iLocal_18 = func_154(uParam0, "script@vignette@tilly_2@Action_A_Int_Left", 2, 0, 0, 1);
	iLocal_19 = func_154(uParam0, "script@vignette@tilly_2@Action_A_Int_Right", 2, 0, 0, 1);
	iLocal_20 = func_154(uParam0, "script@vignette@tilly_2@Action_B", 0, 0, 0, 0);
	func_155(uParam0, iLocal_15, 4, 3, 0, 0, 0);
	func_156(uParam0, "CCTL2AU");
	func_157(uParam0, iLocal_14, 3, -1147740400, "WORLD_HUMAN_WASHBOARD_FEMALE_A", -1, 1, 10f, 1065353216, 1);
	...
	func_159(uParam0, iLocal_15, 3, -716577201, "WORLD_HUMAN_SIT_GROUND_READING_BOOK_FEMALE_A", -1, 1);
	func_157(uParam0, iLocal_15, 3, 1253642035, "PROP_HUMAN_SEAT_CHAIR_READING_FEMALE_A", iLocal_24, 0, -1073741824, 1065353216, 1);
	func_158(uParam0, iLocal_15, iLocal_23, "p_cs_book04x_PH_R_HAND", 0, 0);
	Local_26 = { func_160(uParam0, -0.1395f, -0.423f, 1.8254f, -172.6f, 6.5f, 0f, 0.715f) };
	Local_36 = { func_160(uParam0, -0.14f, -0.423f, 1.8254f, -104.5f, 6.5f, 0.0075f, 0.7575f) };
	Local_46 = { func_160(uParam0, -0.14f, -0.423f, 1.8254f, 116f, 6f, 0.078f, 0.6825f) };
	return 1;
}
...
{
	TASK::_SET_SCENARIO_GROUP_ENABLED_HASH(iLocal_59, false);
	return 1;
}
...
int func_93(var uParam0)
{
	if (!iLocal_25)
	{
		...
		{
			if (func_199(uParam0, Local_26, 1, 0))
			{
				func_190(uParam0, iLocal_17, 1);
			}
			else if (func_199(uParam0, Local_36, 1, 0))
			{
				func_190(uParam0, iLocal_18, 1);
			}
			else if (func_199(uParam0, Local_46, 1, 0))
			{
...
int func_95(var uParam0)
{
	...
	if (!CAM::IS_SPHERE_VISIBLE(vLocal_56, 1f))
	{
		TASK::_SET_SCENARIO_GROUP_ENABLED_HASH(iLocal_59, true);
		return 1;
	}
...
int func_153(var uParam0, int iParam1, vector3 vParam2, int iParam5, int iParam6, int iParam7, int iParam8)
{
	int iVar0;
	...
	if (!uParam0->f_72)
	{
		...
		while (iVar0 < uParam0->f_33)
		{
			...
			else
			{
				...
				{
					func_256(&(uParam0->f_33[iVar0]), 0, 1, 0, 2048, 0, -1082130432);
					iVar0++;
				}
				if (!uParam0->f_71)
				{
	...
	while (iVar12 < uParam0->f_106)
	{
		...
		else
		{
			if (!STREAMING::IS_MODEL_VALID((uParam0->f_107[iVar12 /*113*/])->f_3))
			{
				...
				{
					(uParam0->f_107[iVar12 /*113*/])->f_3 = _NAMESPACE48::_0xA00DF706C60173D1(func_270((uParam0->f_107[iVar12 /*113*/])->f_1));
				}
				else if (func_57((uParam0->f_107[iVar12 /*113*/])->f_2))
				{
					(uParam0->f_107[iVar12 /*113*/])->f_3 = func_271((uParam0->f_107[iVar12 /*113*/])->f_2);
				}
		...
		else
		{
			...
			else if (!(uParam0->f_107[iVar0 /*113*/])->f_8.f_22)
			{
				if (iVar1 < 0)
				{
					...
					func_272(&((uParam0->f_107[iVar0 /*113*/])->f_8.f_23), 1, 0);
				}
				else
				{
	...
	while (iVar1 < 27)
	{
		...
		else
		{
			...
			while (iVar0 < uParam0->f_36)
			{
				...
				else if (iVar1 == func_273((uParam0->f_36[iVar0 /*5*/])->f_1))
				{
				}
			...
			else if (ANIMSCENE::_0x3AB6C7B0BB0DF4B1((uParam0->f_107[iVar3 /*113*/])->f_5, -1))
			{
				...
				else
				{
					...
					else
					{
						...
						if (!func_277(uParam0, iVar3, vVar4))
						{
							iVar1 = 0;
							bVar0 = false;
						}
...
void func_176(var uParam0)
{
	...
	while (iVar0 < uParam0->f_106)
	{
		...
		{
			(uParam0->f_107[iVar0 /*113*/])->f_5 = func_281((uParam0->f_107[iVar0 /*113*/])->f_3, uParam0->f_23, 0, 1, 1, 0, 1, 1, 1, 0, 0, 0, 0);
		}
		iVar0++;
	}
}
	...
	while (iVar0 < uParam0->f_1984)
	{
		...
		else
		{
			if (bParam1)
			{
				if (func_282())
				{
					func_283(Global_35, &(uParam0->f_1984[iVar0]), "JOHN");
				}
				else
				{
					func_283(Global_35, &(uParam0->f_1984[iVar0]), "ARTHUR");
				}
			}
			iVar1 = 0;
			while (iVar1 < uParam0->f_106)
			{
				func_283((uParam0->f_107[iVar1 /*113*/])->f_5, &(uParam0->f_1984[iVar0]), (uParam0->f_107[iVar1 /*113*/])->f_4);
				iVar1++;
			}
		}
		iVar0++;
...
void func_179(var uParam0)
{
	...
	while (iVar0 < uParam0->f_106)
	{
		func_284((uParam0->f_107[iVar0 /*113*/])->f_5);
		iVar0++;
	}
}
...
int func_190(var uParam0, int iParam1, bool bParam2)
{
	...
	if (uParam0->f_2270)
	{
		uParam0->f_2274 = 0;
		uParam0->f_2275 = 0;
		if ((func_112() && ANIMSCENE::_0x6F1F0B17109309DA(uParam0->f_2046, "ARTHUR")) || (func_282() && ANIMSCENE::_0x6F1F0B17109309DA(uParam0->f_2046, "JOHN")))
		{
			uParam0->f_2274 = 1;
		}
	}
	if (bParam2)
	{
		...
		while (iVar1 < uParam0->f_1984)
		{
			...
			else if (func_291(uParam0, iVar1) || func_198(uParam0, iVar1))
			{
			...
			if (!(uParam0->f_107[iVar0 /*113*/])->f_32)
			{
				if (func_303(uParam0, iVar0))
				{
					if ((uParam0->f_107[iVar0 /*113*/])->f_32.f_48)
					{
						...
						func_304(uParam0, iVar0, 0, 1);
					}
					else
					{
						func_304(uParam0, iVar0, 1, 1);
					}
...
void func_255(var uParam0, int iParam1, float fParam2)
{
	if (fParam2 == -2f)
	{
...
int func_256(int iParam0, int iParam1, bool bParam2, int iParam3, int iParam4, bool bParam5, float fParam6)
{
	vector3 vVar0;
	vector3 vVar3;
	var uVar6;
...
int func_277(var uParam0, int iParam1, vector3 vParam2)
{
	float fVar0;
	float fVar1;
	float fVar2;
...
int func_281(int iParam0, vector3 vParam1, float fParam4, bool bParam5, bool bParam6, int iParam7, bool bParam8, bool bParam9, bool bParam10, bool bParam11, bool bParam12, bool bParam13, bool bParam14)
{
	int iVar0;
...
void func_283(int iParam0, int iParam1, char* sParam2)
{
	if (ENTITY::IS_ENTITY_DEAD(iParam0))
	{
		return;
...
void func_304(var uParam0, int iParam1, bool bParam2, bool bParam3)
{
	var uVar0;
	...
	if (bParam3)
	{
		uVar0 = func_344(uParam0, iParam1);
	}
	if (bParam2)
	{
...
int func_365(int iParam0, bool bParam1, int iParam2, int iParam3, int iParam4, int iParam5, float fParam6, int iParam7, int iParam8, bool bParam9, bool bParam10, bool bParam11, int iParam12, int iParam13, bool bParam14, bool bParam15, bool bParam16, bool bParam17, bool bParam18, bool bParam19, bool bParam20, bool bParam21, bool bParam22, bool bParam23, bool bParam24)
{
	...
	switch (((*Global_1360165)[iParam0 /*1157*/])->f_11)
	{
		...
		case 7:
			...
			if (bParam20)
			{
				if (func_279(Global_1360165[iParam0 /*1157*/]))
				{
				}
			}
...
int func_381(var uParam0, int iParam1)
{
	...
	{
		func_272(&((uParam0->f_107[iParam1 /*113*/])->f_32.f_21), 1, (uParam0->f_107[iParam1 /*113*/])->f_32.f_13);
		bVar71 = Var1.f_10;
...
int func_386(int iParam0, bool bParam1, bool bParam2, var uParam3, var uParam4, var uParam5, float fParam6, bool bParam7, bool bParam8, bool bParam9, bool bParam10)
{
	...
	switch (((*Global_1360165)[iParam0 /*1157*/])->f_70.f_12)
	{
		...
		case 3:
			...
			sVar12 = func_421(iParam0, func_282());
...
int func_418(int iParam0, vector3 vParam1, float fParam4, bool bParam5)
{
	...
	if ((!bParam5 && !Global_1359489->f_12) || (bParam5 && Global_1359489->f_13 < 8))
	{
		...
		else
		{
			...
			{
				((*Global_1360165)[iParam0 /*1157*/])->f_124 = func_281(iVar0, vParam1, fParam4, 1, 1, 0, 1, 1, 1, 0, 0, 0, 0);
