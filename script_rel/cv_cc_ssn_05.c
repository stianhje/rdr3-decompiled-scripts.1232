...
int func_72(var uParam0)
{
	...
	func_151(uParam0, 0.0202455f, 1.08015f, 0.533295f, 0f, 1.5f, 1.5f, 3f, -1612834106, -1689743484, 1, 1, 1);
	iLocal_14 = func_152(uParam0, 19, 0);
	func_153(uParam0, joaat("p_mugcoffee01x"), 0f, 0f, 0f, "MUG", 0, 0, 1);
	uLocal_22 = func_153(uParam0, joaat("p_stoolfolding01x"), 0.011f, 1.022f, 0.031f, 0, 1, 0, 1);
	func_154(uParam0, "script@vignette@susan_5@base", 1, 1, 0, 0);
	iLocal_15 = func_154(uParam0, "script@vignette@susan_5@action_front_a", 2, 0, 0, 1);
	iLocal_16 = func_154(uParam0, "script@vignette@susan_5@action_left_a", 2, 0, 0, 1);
	iLocal_17 = func_154(uParam0, "script@vignette@susan_5@action_right_a", 2, 0, 0, 1);
	iLocal_18 = func_154(uParam0, "script@vignette@susan_5@action_front_b", 0, 0, 0, 1);
	iLocal_19 = func_154(uParam0, "script@vignette@susan_5@action_left_b", 0, 0, 0, 1);
	iLocal_20 = func_154(uParam0, "script@vignette@susan_5@action_right_b", 0, 0, 0, 1);
	func_155(uParam0, "CSSN5AU");
	func_156(uParam0, -1288525144, -1822967542);
	func_157(uParam0, iLocal_14, 3, -2097328111, "GENERIC_SEAT_CHAIR_TABLE_SCENARIO_LF_FWD_FEMALE_A", uLocal_22, 0);
	func_158(uParam0, iLocal_14, 2, -2097328111, "GENERIC_SEAT_CHAIR_TABLE_SCENARIO_LF_FWD_FEMALE_A", uLocal_22, 0, -1073741824, 1065353216, 1);
	func_159(uParam0, iLocal_14, 1, -1);
	Local_23 = { func_160(uParam0, 0.0202f, 1.0802f, 1f, 180f, 5f, 0.4f, 0.4f) };
	Local_33 = { func_160(uParam0, 0.0202f, 1.0802f, 1f, -108.15f, 5f, 0.2f, 0.4f) };
	Local_43 = { func_160(uParam0, 0.0202f, 1.0802f, 1f, 108.15f, 5f, 0.4f, 0.2f) };
...
{
	if (func_192(Global_35, uParam0->f_23, 1) < 4f)
	{
	}
	if (func_193(uParam0, Local_23, 1, 0))
	{
		func_191(uParam0, iLocal_15, 1);
		iLocal_21 = iLocal_15;
		return 1;
	}
	else if (func_193(uParam0, Local_33, 1, 0))
	{
		func_191(uParam0, iLocal_16, 1);
		iLocal_21 = iLocal_16;
		return 1;
	}
	else if (func_193(uParam0, Local_43, 1, 0))
	{
		func_191(uParam0, iLocal_17, 1);
		iLocal_21 = iLocal_17;
		return 1;
	}
	return 0;
...
int func_93(var uParam0)
{
	...
	{
		if (func_193(uParam0, Local_33, 1, 0))
		{
...
void func_150(var uParam0, float fParam1, int iParam2)
{
	...
	if (!uParam0->f_72)
	{
		...
		while (iVar0 < uParam0->f_33)
		{
			...
			else
			{
				...
				{
					func_258(&(uParam0->f_33[iVar0]), 0, 1, 0, 2048, 0, -1082130432);
					iVar0++;
				}
				if (!uParam0->f_71)
				{
	...
	while (iVar12 < uParam0->f_106)
	{
		...
		else
		{
			if (!STREAMING::IS_MODEL_VALID((uParam0->f_107[iVar12 /*113*/])->f_3))
			{
				...
				{
					(uParam0->f_107[iVar12 /*113*/])->f_3 = _NAMESPACE48::_0xA00DF706C60173D1(func_272((uParam0->f_107[iVar12 /*113*/])->f_1));
				}
				else if (func_57((uParam0->f_107[iVar12 /*113*/])->f_2))
				{
					(uParam0->f_107[iVar12 /*113*/])->f_3 = func_273((uParam0->f_107[iVar12 /*113*/])->f_2);
				}
		...
		else
		{
			...
			else if (!(uParam0->f_107[iVar0 /*113*/])->f_8.f_22)
			{
				if (iVar1 < 0)
				{
					...
					func_274(&((uParam0->f_107[iVar0 /*113*/])->f_8.f_23), 1, 0);
				}
				else
				{
	...
	while (iVar1 < 27)
	{
		...
		else
		{
			...
			while (iVar0 < uParam0->f_36)
			{
				...
				else if (iVar1 == func_275((uParam0->f_36[iVar0 /*5*/])->f_1))
				{
				}
		...
		else if ((uParam0->f_107[iVar3 /*113*/])->f_8.f_14)
		{
			...
			else if (ANIMSCENE::_0x3AB6C7B0BB0DF4B1((uParam0->f_107[iVar3 /*113*/])->f_5, -1))
			{
				...
				else
				{
					...
					{
						if (!func_278(uParam0, iVar3, vVar4))
						{
							iVar1 = 0;
							bVar0 = false;
						}
...
void func_177(var uParam0)
{
	...
	while (iVar0 < uParam0->f_106)
	{
		...
		{
			(uParam0->f_107[iVar0 /*113*/])->f_5 = func_283((uParam0->f_107[iVar0 /*113*/])->f_3, uParam0->f_23, 0, 1, 1, 0, 1, 1, 1, 0, 0, 0, 0);
		}
		iVar0++;
	}
}
	...
	while (iVar0 < uParam0->f_1984)
	{
		...
		else
		{
			if (bParam1)
			{
				if (func_284())
				{
					func_285(Global_35, &(uParam0->f_1984[iVar0]), "JOHN");
				}
				else
				{
					func_285(Global_35, &(uParam0->f_1984[iVar0]), "ARTHUR");
				}
			}
			iVar1 = 0;
			while (iVar1 < uParam0->f_106)
			{
				func_285((uParam0->f_107[iVar1 /*113*/])->f_5, &(uParam0->f_1984[iVar0]), (uParam0->f_107[iVar1 /*113*/])->f_4);
				iVar1++;
			}
		}
		iVar0++;
...
void func_180(var uParam0)
{
	...
	while (iVar0 < uParam0->f_106)
	{
		func_286((uParam0->f_107[iVar0 /*113*/])->f_5);
		iVar0++;
	}
}
...
int func_191(var uParam0, int iParam1, bool bParam2)
{
	...
	if (uParam0->f_2270)
	{
		uParam0->f_2274 = 0;
		uParam0->f_2275 = 0;
		if ((func_112() && ANIMSCENE::_0x6F1F0B17109309DA(uParam0->f_2046, "ARTHUR")) || (func_284() && ANIMSCENE::_0x6F1F0B17109309DA(uParam0->f_2046, "JOHN")))
		{
			uParam0->f_2274 = 1;
		}
	}
...
int func_193(var uParam0, struct<4> Param1, var uParam5, var uParam6, var uParam7, var uParam8, var uParam9, var uParam10, bool bParam11, bool bParam12)
{
	if (bParam11)
	{
		if (!func_296(func_19(uParam0), 1))
		{
			return 0;
		}
	}
	...
	if (!func_297(Param1, Param1.f_6, Global_36))
	{
		return 0;
	}
	if (func_297(Param1, Param1.f_3, Global_36))
	{
		return 0;
	}
	if (bParam12)
...
void func_202(var uParam0, var uParam1, int iParam2, float fParam3)
{
	if (iParam2 == -1)
	{
		iParam2 = 0;
...
int func_258(int iParam0, int iParam1, bool bParam2, int iParam3, int iParam4, bool bParam5, float fParam6)
{
	vector3 vVar0;
	vector3 vVar3;
	var uVar6;
...
int func_278(var uParam0, int iParam1, vector3 vParam2)
{
	float fVar0;
	float fVar1;
	float fVar2;
...
bool func_297(struct<2> Param0, var uParam2, struct<2> Param3, var uParam5, struct<2> Param6, var uParam8)
{
...
int func_368(int iParam0, bool bParam1, int iParam2, int iParam3, int iParam4, int iParam5, float fParam6, int iParam7, int iParam8, bool bParam9, bool bParam10, bool bParam11, int iParam12, int iParam13, bool bParam14, bool bParam15, bool bParam16, bool bParam17, bool bParam18, bool bParam19, bool bParam20, bool bParam21, bool bParam22, bool bParam23, bool bParam24)
{
	...
	switch (((*Global_1360165)[iParam0 /*1157*/])->f_11)
	{
		...
		case 7:
			...
			if (bParam20)
			{
				if (func_281(Global_1360165[iParam0 /*1157*/]))
				{
				}
			}
...
int func_384(var uParam0, int iParam1)
{
	...
	{
		func_274(&((uParam0->f_107[iParam1 /*113*/])->f_32.f_21), 1, (uParam0->f_107[iParam1 /*113*/])->f_32.f_13);
		bVar71 = Var1.f_10;
...
int func_389(int iParam0, bool bParam1, bool bParam2, var uParam3, var uParam4, var uParam5, float fParam6, bool bParam7, bool bParam8, bool bParam9, bool bParam10)
{
	...
	switch (((*Global_1360165)[iParam0 /*1157*/])->f_70.f_12)
	{
		...
		case 3:
			...
			sVar12 = func_424(iParam0, func_284());
...
int func_421(int iParam0, vector3 vParam1, float fParam4, bool bParam5)
{
	...
	if ((!bParam5 && !Global_1359489->f_12) || (bParam5 && Global_1359489->f_13 < 8))
	{
		...
		else
		{
			...
			{
				((*Global_1360165)[iParam0 /*1157*/])->f_124 = func_283(iVar0, vParam1, fParam4, 1, 1, 0, 1, 1, 1, 0, 0, 0, 0);
