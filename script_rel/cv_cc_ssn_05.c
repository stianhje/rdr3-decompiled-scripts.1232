...
int func_72(var uParam0)
{
	...
	func_153(uParam0, -82199229, 0f, 0f, 0f, "MUG", 0, 0, 1);
	uLocal_22 = func_153(uParam0, 1600083684, 0.011f, 1.022f, 0.031f, 0, 1, 0, 1);
...
void func_202(var uParam0, int iParam1, int iParam2, float fParam3)
{
	if (iParam2 == -1)
	{
		iParam2 = 0;
