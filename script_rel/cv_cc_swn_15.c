...
int func_72(var uParam0)
{
	...
	uLocal_18 = func_151(uParam0, joaat("p_chairfolding02x"), 1.197f, -1.869f, -0.028f, 0, 1, 0, 1);
	uLocal_17 = func_151(uParam0, joaat("p_chairfolding02x"), -1.814f, 12.908f, 0.148f, 0, 1, 0, 1);
	func_152(uParam0, 1.6249f, -0.1375f, 1.15f, 6.81f, 1.59f, 3.255f, 2.685f, -1612834106, -1, 1, 1, 1);
	func_152(uParam0, -1.775f, 12.5374f, 1.15f, 11.06f, 0.7075f, 1.2725f, 2.685f, -1612834106, -1, 1, 1, 1);
	func_153(uParam0, 1.60061f, 0.0465245f, 0.981934f, 0f, 1f, 1f, 2f, 665633627, 1);
	func_154(uParam0, iLocal_15, 3, 1253642035, "PROP_HUMAN_SEAT_CHAIR_READING_MALE_A", uLocal_18, 0);
	func_155(uParam0, iLocal_15, 3, 1253642035, "PROP_HUMAN_SEAT_CHAIR_READING_MALE_A", uLocal_18, 0, 30f, 1065353216, 1);
	func_156(uParam0, iLocal_15, 1, -1);
	func_154(uParam0, iLocal_14, 3, -1426662425, "PROP_HUMAN_SEAT_CHAIR_GENERIC_MALE_A", uLocal_17, 0);
	func_155(uParam0, iLocal_14, 3, -1426662425, "PROP_HUMAN_SEAT_CHAIR_GENERIC_MALE_A", uLocal_17, 0, 30f, 1065353216, 1);
	func_157(uParam0, iLocal_14, 1, 4, 0, 0, 0);
	func_156(uParam0, iLocal_14, 1, -1);
	func_158(uParam0, "script@vignette@swanson_15@base", 1, 1, 0, 0);
	uLocal_16 = func_158(uParam0, "script@vignette@swanson_15@action", 0, 0, 1, 0);
	func_159(uParam0, -951443001, 478844274);
...
void func_154(var uParam0, int iParam1, int iParam2, int iParam3, char* sParam4, var uParam5, int iParam6)
{
...
int func_382(int iParam0, bool bParam1, bool bParam2, var uParam3, var uParam4, var uParam5, float fParam6, bool bParam7, bool bParam8, bool bParam9, bool bParam10)
{
	...
	switch (((*Global_1360165)[iParam0 /*1157*/])->f_70.f_12)
	{
		...
		case 3:
			...
			sVar12 = func_417(iParam0, func_281());
		...
		case 7:
			switch (iParam0)
			{
				...
				case 14:
					...
					break;
				case 4:
					if (func_321(747937920, 1) && !func_385(((*Global_1347702)[1 /*49*/])->f_15, 1))
					{
						iVar1[0] = -1155031950;
					}
					else
