...
int func_72(var uParam0)
{
	...
	func_151(uParam0, 0f, 0f, 0f, -9.5f, 1f, 1f, 5f, -1612834106, 2017216891, 1, 1, 1);
	func_151(uParam0, -1.525f, -2.075f, 0f, -9.5f, 1f, 1f, 5f, -1612834106, -1689743484, 1, 1, 1);
	iLocal_18 = func_152(uParam0, -1006095118, 0f, 0f, 0f, "P_CHAIRFOLDING02X", 1, 0, 1);
	iLocal_19 = func_152(uParam0, -946807796, 0f, 0f, 0f, "P_CS_BOOKEVELYNMILLER", 0, 0, 1);
	func_153(uParam0, "script@vignette@susan_16@base", 1, 1, 0, 0);
	iLocal_16 = func_153(uParam0, "script@vignette@susan_16@action", 2, 0, 1, 0);
	...
	func_159(uParam0, iLocal_15, 3, -787460071, "SC_PROP_CAMP_DUTCH_SEAT_CHAIR_READING_MALE_A", iLocal_18, 0, -1073741824, 1065353216, 1);
	func_160(uParam0, iLocal_15, iLocal_19, "p_cs_bookEvelynMiller_PH_R_HAND", 0, 0);
	func_158(uParam0, iLocal_15, 1, -1);
	Local_20 = { func_161(uParam0, 0f, 0f, 0.988f, 171f, 6.5f, 0.515f, 0.465f) };
	return 1;
}
...
int func_93(var uParam0)
{
	...
	{
		if (func_200(uParam0, Local_20, 1, 1))
		{
...
int func_191(var uParam0, int iParam1, bool bParam2)
{
	...
	if (bParam2)
	{
		...
		while (iVar1 < uParam0->f_1984)
		{
			...
			else if (func_293(uParam0, iVar1) || func_199(uParam0, iVar1))
			{
