...
int func_72(var uParam0)
{
	...
	func_151(uParam0, -3.3384f, -3.0037f, 1.156f, 17.0847f, 1.5f, 1.5f, 3f, -1612834106, 1267380940, 1, 1, 1);
	func_151(uParam0, 0.0199f, 1.0811f, 0.5295f, -0.2848f, 1.5f, 1.5f, 3f, -1612834106, -1495061186, 1, 1, 1);
	iLocal_20 = func_152(uParam0, joaat("p_cs_newspaper_03x"), 0f, 0f, 0f, "NEWSPAPER", 0, 1, 1);
	func_153(uParam0, "script@vignette@hosea_11@base", 1, 1, 0, 0);
	iLocal_15 = func_153(uParam0, "script@vignette@hosea_11@action_a", 2, 0, 1, 0);
	iLocal_16 = func_153(uParam0, "script@vignette@hosea_11@action_b", 0, 0, 0, 0);
	iLocal_17 = func_153(uParam0, "script@vignette@hosea_11@action_b_alt_back", 0, 0, 0, 1);
	iLocal_18 = func_153(uParam0, "script@vignette@hosea_11@action_b_alt_left", 0, 0, 0, 1);
	iLocal_19 = func_153(uParam0, "script@vignette@hosea_11@action_b_alt_right", 0, 0, 0, 1);
	func_154(uParam0, "CHS11AU");
	func_155(uParam0, iLocal_14, 2, 1348830223, "PROP_HUMAN_SEAT_CHAIR_READ_NEWSPAPER_MALE_B", -1, 0, -1073741824, 1065353216, 1);
	func_156(uParam0, iLocal_14, iLocal_20, "p_cs_newspaper_03x_PH_R_HAND", 0, 0);
	Local_21 = { func_157(uParam0, -1.0005f, 1.911f, 0.9824f, -63f, 8f, 0.4f, 0.4f) };
	Local_31 = { func_157(uParam0, -1.001f, 1.911f, 0.982f, -139.5f, 8f, 0.45f, 0.45f) };
	Local_41 = { func_157(uParam0, -1.001f, 1.911f, 0.982f, 143.98f, 8f, 0.4f, 0.4f) };
	return 1;
}
...
int func_93(var uParam0)
{
	...
	{
		if (func_196(uParam0, Local_21, 1, 0))
		{
			func_187(uParam0, iLocal_17, 1);
		}
		else if (func_196(uParam0, Local_31, 1, 0))
		{
			func_187(uParam0, iLocal_18, 1);
		}
		else if (func_196(uParam0, Local_41, 1, 0))
		{
			func_187(uParam0, iLocal_19, 1);
		}
		else
		{
			func_187(uParam0, iLocal_16, 1);
		}
	}
	return 1;
}
