...
int func_72(var uParam0)
{
	...
	func_150(uParam0, 0f, 0f, 0f, 0f, 3f, 3f, 5f, 665633627, 1);
	func_151(uParam0, 0.7058f, 2.1098f, 0f, 49.32f, 1.2f, 1.26f, 5f, -1612834106, -1495061186, 1, 1, 1);
	func_151(uParam0, -1.59f, -0.7f, 0f, 14.4f, 1.2f, 1.2f, 5f, -1612834106, 1418411488, 1, 1, 1);
	iLocal_14 = func_152(uParam0, 1, "MALE_A");
	iLocal_15 = func_152(uParam0, 8, "MALE_B");
	iLocal_16 = func_153(uParam0, 1230724566, -1.86272f, -0.829352f, -0.0207291f, 0, 1, 0, 1);
	func_153(uParam0, -1971689092, 0f, 0f, 0f, "BOTTLE", 0, 1, 1);
	switch (func_19(uParam0))
	{
		case 11:
			func_153(uParam0, -269536141, 0f, 0f, 0f, "CIGARETTE", 0, 1, 1);
			func_154(uParam0, "script@vignette@ambient@av_drunk_campfire@male_d@base", 1, 1, 0, 0);
			func_154(uParam0, "script@vignette@ambient@av_drunk_campfire@male_d@action", 0, 0, 1, 0);
			break;
		
		default:
			return 0;
	}
	func_155(uParam0, iLocal_14, 3, 1446817251, "WORLD_CAMP_FIRE_SIT_GROUND_MALE_C", -1, 1);
	func_156(uParam0, iLocal_14, 2, 1284064417, "WORLD_HUMAN_SIT_GROUND_DRINK_DRUNK_MALE_B", -1, 1, -1073741824, 1065353216, 1);
	func_156(uParam0, iLocal_15, 3, -473529865, "PROP_HUMAN_SEAT_CHAIR_SMOKE_ROLL_MALE_A", iLocal_16, 0, -1073741824, 1065353216, 1);
	func_157(uParam0, 1);
	return 1;
}
...
int func_150(var uParam0, vector3 vParam1, float fParam4, vector3 vParam5, int iParam8, bool bParam9)
{
	...
	if (bParam9)
	{
		vParam1 = { func_246(uParam0, vParam1) };
	...
	while (iVar0 < uParam0->f_1711)
	{
		...
		else
		{
			...
			if (!(uParam0->f_1711[iVar0 /*15*/])->f_5 && !ENTITY::DOES_ENTITY_EXIST((uParam0->f_1711[iVar0 /*15*/])->f_10))
			{
				...
				{
					vVar3 = { func_246(uParam0, (uParam0->f_1711[iVar0 /*15*/])->f_1) };
				}
				else
				{
...
void func_182(var uParam0)
{
	...
	{
		uParam0->f_1976.f_6 = PROPSET::_CREATE_PROPSET_2(uParam0->f_1976, func_246(uParam0, uParam0->f_1976.f_1), 1, func_247(uParam0, uParam0->f_1976.f_4), 3f, false, true);
	}
}
...
Vector3 func_246(var uParam0, vector3 vParam1)
{
	return OBJECT::_GET_OBJECT_OFFSET_FROM_COORDS(uParam0->f_23, uParam0->f_26.f_2, vParam1);
}

float func_247(var uParam0, float fParam1)
{
	float fVar0;
...
int func_261(var uParam0)
{
	...
	while (iVar1 < uParam0->f_1711)
	{
		...
		else if ((uParam0->f_1711[iVar1 /*15*/])->f_5)
		{
			...
			{
				vVar2 = { func_246(uParam0, (uParam0->f_1711[iVar1 /*15*/])->f_1) };
			}
			else
			{
