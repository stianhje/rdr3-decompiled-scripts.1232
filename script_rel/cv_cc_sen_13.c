...
int func_72(var uParam0)
{
	...
	func_151(uParam0, 4.115f, 2.36f, 1.1875f, -44f, 1.0975f, 1.145f, 3.2075f, -1612834106, -676766751, 1, 1, 1);
	func_151(uParam0, -0.0675f, 2.0425f, 1.1875f, 16f, 3.4425f, 1.2525f, 3.2075f, -1612834106, 1418411488, 1, 1, 1);
	func_152(uParam0, joaat("p_cigarette_cs02x"), 0f, 0f, 0f, "CIGARETTE", 0, 1, 1);
	uLocal_21 = func_152(uParam0, joaat("p_bench_log07x"), -1.372f, 1.604f, -0.0733f, 0, 1, 0, 1);
	func_153(uParam0, "script@vignette@sean_13@base", 1, 1, 0, 0);
	iLocal_16 = func_153(uParam0, "script@vignette@sean_13@action_a", 2, 0, 1, 0);
	iLocal_18 = func_153(uParam0, "script@vignette@sean_13@Action_A_Int_Front", 2, 0, 0, 1);
	iLocal_19 = func_153(uParam0, "script@vignette@sean_13@Action_A_Int_Left", 2, 0, 0, 1);
	iLocal_20 = func_153(uParam0, "script@vignette@sean_13@Action_A_Int_Right", 2, 0, 0, 1);
	iLocal_17 = func_153(uParam0, "script@vignette@sean_13@action_b", 0, 0, 0, 0);
	func_154(uParam0, "CSE13AU");
	func_155(uParam0, 34981806, 2031173023);
	func_156(uParam0, iLocal_14, 3, -38747227, "PROP_CAMP_FIRE_SEAT_BENCH_MALE_B", uLocal_21, 0);
	func_157(uParam0, iLocal_14, 2, -38747227, "PROP_CAMP_FIRE_SEAT_BENCH_MALE_B", uLocal_21, 0, -1073741824, 1065353216, 1);
	func_158(uParam0, iLocal_14, 1, -1);
	func_156(uParam0, iLocal_15, 3, -22664287, "WORLD_HUMAN_SMOKE_MALE_D", -1, 1);
	Local_22 = { func_159(uParam0, -0.5575f, 2.325f, 1.07f, 159f, 6.5f, 0.1725f, 0.66f) };
	Local_32 = { func_159(uParam0, -0.5575f, 2.325f, 1.07f, -126.25f, 6.5f, 0.22f, 0.6575f) };
	Local_42 = { func_159(uParam0, -0.558f, 2.325f, 1.07f, -47.16f, 6.5f, 0.22f, 0.66f) };
	return 1;
}
...
int func_93(var uParam0)
{
	...
	{
		if (func_198(uParam0, Local_22, 1, 0))
		{
			func_189(uParam0, iLocal_18, 1);
		}
		else if (func_198(uParam0, Local_32, 1, 0))
		{
			func_189(uParam0, iLocal_19, 1);
		}
		else if (func_198(uParam0, Local_42, 1, 0))
		{
