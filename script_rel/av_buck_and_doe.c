#region Local Var
	...
	struct<23> Local_45 = { 0, 0, 0, 0, -1, 0, 0, 0, 2, 1, 1, 1, 0, 1, 2, 2, 3, 0, 0, 3, 1, 3, 3 } ;
	var uLocal_68 = 0;
	var uLocal_69 = 0;
	struct<23> Local_70 = { 0, 0, 0, 0, -1, 0, 0, 0, 2, 1, 1, 1, 0, 1, 2, 2, 3, 0, 0, 3, 1, 3, 3 } ;
	var uLocal_93 = 0;
	var uLocal_94 = 0;
...
{
	func_33(uParam0, 10767/*func_30*/, 10933/*func_31*/, 12079/*func_32*/);
}
...
{
	func_46(uParam0, "BUCK_AND_DOE", "", vParam1, vParam4);
	func_47(uParam0, 0, "BADP_BUCK_1", joaat("a_c_buck_01"), OBJECT::_GET_OBJECT_OFFSET_FROM_COORDS(vParam1, vParam4.z, 0f, 0f, 0f), (-180f + vParam4.z), 1, 1, 1, 1, 41788943, 1);
	func_47(uParam0, 1, "BADP_DOE_1", joaat("a_c_deer_01"), OBJECT::_GET_OBJECT_OFFSET_FROM_COORDS(vParam1, vParam4.z, 0.25f, -4f, 0f), (75f + vParam4.z), 1, 1, 1, 1, 41788943, 1);
}
...
int func_31(var uParam0)
{
	if (!&uParam0->f_469[1])
	{
		if (func_62(uParam0, &uLocal_17, 0) || func_63(&(uParam0->f_20[0 /*14*/]), Global_35, 1, 1) < 20f)
		{
			func_64(uParam0);
			func_65(uParam0);
			iLocal_9 = 8;
	...
	switch (iLocal_9)
	{
		case 0:
			...
			{
				func_66(&((uParam0->f_20[0 /*14*/])->f_5), 50, 10, 0);
			...
			if (!ENTITY::IS_ENTITY_DEAD(&(uParam0->f_20[1 /*14*/])))
			{
				...
				TASK::TASK_START_SCENARIO_AT_POSITION(&(uParam0->f_20[1 /*14*/]), iLocal_10, (uParam0->f_20[1 /*14*/])->f_5, (uParam0->f_20[1 /*14*/])->f_8, 0, 0, 1, 0, -1082130432, 0);
		...
		case 1:
			...
			{
				func_65(uParam0);
				Local_45.f_3 = &uParam0->f_20[0 /*14*/];
				Local_45.f_7 = 0;
				func_69(&uLocal_14);
				PED::_0xEEED8FAFEC331A70(&(uParam0->f_20[1 /*14*/]), (uParam0->f_20[1 /*14*/])->f_5, 1);
				PED::_0xEEED8FAFEC331A70(&(uParam0->f_20[0 /*14*/]), (uParam0->f_20[0 /*14*/])->f_5, 1);
				TASK::_0xE7FA07624574B79A(&(uParam0->f_20[1 /*14*/]), &(uParam0->f_20[0 /*14*/]), 1, 1, 6f, 1, 0, 0, 0);
				iLocal_9 = 2;
			}
			break;
		case 2:
			...
			{
				_NAMESPACE29::_0x66F9EB44342BB4C5(&(uParam0->f_20[1 /*14*/]), &Local_45);
				if (func_70(&uLocal_14, 5f))
				{
					TASK::TASK_GO_TO_ENTITY(&(uParam0->f_20[1 /*14*/]), &(uParam0->f_20[0 /*14*/]), -1, 3f, 1f, 2f, 0);
					TASK::_0xE7FA07624574B79A(&(uParam0->f_20[0 /*14*/]), &(uParam0->f_20[1 /*14*/]), 1, 1, 100f, 1, 0, 0, 0);
					iLocal_9 = 3;
				}
			}
			break;
		...
		case 4:
			...
			{
				_NAMESPACE29::_0x66F9EB44342BB4C5(&(uParam0->f_20[1 /*14*/]), &Local_45);
				if (!func_71(&(uParam0->f_20[1 /*14*/]), 1227113341))
				{
					Local_70.f_3 = &uParam0->f_20[1 /*14*/];
					Local_70.f_7 = 0;
					func_69(&uLocal_14);
					iLocal_9 = 5;
				}
		...
		case 5:
			...
			{
				_NAMESPACE29::_0x66F9EB44342BB4C5(&(uParam0->f_20[1 /*14*/]), &Local_45);
				_NAMESPACE29::_0x66F9EB44342BB4C5(&(uParam0->f_20[0 /*14*/]), &Local_70);
		...
		case 6:
			if (!ENTITY::IS_ENTITY_DEAD(&(uParam0->f_20[1 /*14*/])) && !ENTITY::IS_ENTITY_DEAD(&(uParam0->f_20[0 /*14*/])))
			{
				...
				if (func_72(&(uParam0->f_20[0 /*14*/]), &(uParam0->f_20[1 /*14*/]), 1) > 16f)
				{
					TASK::TASK_FOLLOW_TO_OFFSET_OF_ENTITY(&(uParam0->f_20[0 /*14*/]), &(uParam0->f_20[1 /*14*/]), -2f, -4f, 0f, 1.5f, -1, 1036831949, 1, 1, 0, 0, 1);
					func_69(&uLocal_14);
					iLocal_9 = 7;
				}
			}
...
int func_32(var uParam0, var uParam1)
{
	...
	while (iVar0 < uParam0->f_19)
	{
		if (TASK::_0x841475AC96E794D1(&(uLocal_11[iVar0])))
		{
			TASK::_0x81948DFE4F5A0283(&(uLocal_11[iVar0]));
		}
		iVar0++;
	}
	return 1;
...
int func_62(var uParam0, var uParam1, int iParam2)
{
	...
	{
		if (func_100(&(uParam0->f_20[uParam0->f_501 /*14*/]), 0, uParam1, &(uParam0->f_468), 0, 0))
		{
			return 1;
		}
		uParam0->f_501++;
...
float func_63(int iParam0, int iParam1, bool bParam2, int iParam3)
{
...
void func_64(var uParam0)
{
	...
	while (iVar0 <= 1)
	{
		if (!ENTITY::IS_ENTITY_DEAD(&(uParam0->f_20[iVar0 /*14*/])))
		{
			PED::_0xEEED8FAFEC331A70(&(uParam0->f_20[iVar0 /*14*/]), Global_36, 0);
			func_67(uParam0->f_20[iVar0 /*14*/], 0, 1);
		}
		iVar0++;
	}
}
...
void func_65(var uParam0)
{
	...
	if (!&uParam0->f_469[2])
	{
		func_102(*uParam0, uParam0->f_483, 0);
		uParam0->f_469[2] = 1;
	}
}
	...
	if ((MISC::GET_FRAME_COUNT() % 8) == 0)
	{
		...
		while (iVar0 < uParam0->f_19)
		{
			...
			if (!ENTITY::IS_ENTITY_DEAD(&(uParam0->f_20[iVar0 /*14*/])))
			{
				...
				fVar8 = func_72(Global_35, &(uParam0->f_20[iVar0 /*14*/]), 1);
				if (fVar8 < fVar1)
				{
					return 1;
				}
...
float func_72(int iParam0, int iParam1, bool bParam2)
{
	...
	return func_113(ENTITY::GET_ENTITY_COORDS(iParam0, false, false), ENTITY::GET_ENTITY_COORDS(iParam1, false, false));
}
...
void func_102(int iParam0, vector3 vParam1, bool bParam4)
{
	if (func_40() > (Global_32073.f_2697.f_6[iParam0 /*6*/])->f_5)
	{
		(Global_32073.f_2697.f_6[iParam0 /*6*/])->f_5 = func_40();
...
int func_135(int iParam0, bool bParam1, int iParam2, bool bParam3)
{
	...
	{
		return func_186(bParam1, iParam2, bParam3);
	}
	if (Global_1572887->f_12 != -1)
	{
...
int func_146(int iParam0, int iParam1)
{
	if (!ENTITY::IS_ENTITY_DEAD(iParam1))
	{
		...
		if (func_63(iParam0, iParam1, 1, 1) < 4f)
		{
...
void func_159(int iParam0)
{
	if (func_43(iParam0))
	{
		...
		{
			case 1:
				func_209(0, 1, 0, 0, ((Global_1415419->f_19[iParam0 /*12*/])->f_7 / 4), 0, 0, 1);
				func_209(1, 1, 0, 0, ((Global_1415419->f_19[iParam0 /*12*/])->f_7 / 4), 0, 0, 1);
				break;
			case 37:
				func_209(60, 1, 0, 0, ((Global_1415419->f_19[iParam0 /*12*/])->f_7 / 4), 0, 0, 1);
				break;
		}
	}
}

void func_160(int iParam0, vector3 vParam1)
{
	int iVar0;
	int iVar1;
...
int func_172(bool bParam0)
{
	...
	if (func_212(bParam0, &uVar0, &uVar1))
	{
		return 1;
	}
	return 0;
...
{
	return func_63(iParam0, iParam1, 1, 1);
}
...
int func_178(int iParam0, int iParam1, int iParam2, int iParam3, int iParam4)
{
	switch (iParam0)
	{
		case 8:
...
int func_181(int iParam0, bool bParam1, bool bParam2, bool bParam3, int iParam4, int iParam5)
{
	...
	if (bParam3)
	{
		if (((WEAPON::_0xCB690F680A3EA971(iVar0, 1) && PLAYER::IS_PLAYER_TARGETTING_ENTITY(iVar1, iParam0, iParam5)) && PLAYER::IS_PLAYER_FREE_AIMING_AT_ENTITY(iVar1, iParam0)) && func_63(iVar0, iParam0, 1, 1) <= 4f)
		{
			return 1;
		}
	}
...
int func_183(var uParam0, int iParam1, float fParam2, float fParam3)
{
	float fVar0;
...
int func_185(int iParam0, bool bParam1, bool bParam2, bool bParam3, int iParam4)
{
	int iVar0;
	int iVar1;
...
int func_186(bool bParam0, var uParam1, var uParam2)
{
...
int func_190(int iParam0, vector3 vParam1, vector3 vParam4)
{
...
int func_193(var uParam0, int iParam1, float fParam2, bool bParam3, bool bParam4)
{
	float fVar0;
...
int func_194(var uParam0, int iParam1, float fParam2, int iParam3)
{
	float fVar0;
...
int func_203(int iParam0, int iParam1, bool bParam2, bool bParam3, float fParam4, bool bParam5)
{
	...
	if (fParam4 <= 0f)
	{
		fVar2 = func_63(iParam0, PLAYER::PLAYER_PED_ID(), 0, 1);
	}
	else
	{
		fVar2 = fParam4;
	...
	if (bVar0)
	{
		if (func_63(iParam0, Global_1935630->f_40, 0, 1) < 2.5f)
		{
...
void func_209(int iParam0, int iParam1, int iParam2, int iParam3, int iParam4, int iParam5, bool bParam6, int iParam7)
{
	int iVar0;
