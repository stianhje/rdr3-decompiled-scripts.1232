...
int func_72(var uParam0)
{
	...
	func_151(uParam0, 0.025f, -0.0376f, 1.15f, 11.06f, 1f, 1f, 2.685f, -1612834106, -2055224817, 1, 1, 1);
	func_151(uParam0, 1.85f, 2.5249f, 1.15f, 19.31f, 1.165f, 1.03f, 2.685f, -1612834106, 1877049591, 1, 1, 1);
	func_151(uParam0, -5.025f, 5.9499f, 1.15f, 11.06f, 1f, 1f, 2.685f, -1612834106, -2087487524, 1, 1, 1);
	func_152(uParam0, 1.0625f, 1.0873f, 1.15f, 38.56f, 1f, 1f, 2.685f, 665633627, 1);
	func_153(uParam0, iLocal_14, 1f);
	func_153(uParam0, iLocal_16, 1f);
	iLocal_18 = func_154(uParam0, 1504738597, 0f, 0f, 0f, 0, 1, 0, 1);
	iLocal_19 = func_154(uParam0, 1504738597, 1.78505f, 2.41607f, 0.00650024f, 0, 1, 0, 1);
	iLocal_23 = func_154(uParam0, 587066646, 0f, 0f, 0f, "BOWL", 0, 0, 1);
	iLocal_22 = func_154(uParam0, 587066646, 0f, 0f, 0f, "Bowl_01", 0, 0, 1);
	func_154(uParam0, -967333571, 0f, 0f, 0f, "CIGARETTE", 0, 1, 1);
	iLocal_21 = func_154(uParam0, -755866836, 0f, 0f, 0f, "SPOON", 0, 0, 1);
	iLocal_20 = func_154(uParam0, -755866836, 0f, 0f, 0f, "SPOON_01", 0, 0, 1);
	func_155(uParam0, "script@vignette@bill_14@base", 1, 1, 0, 0);
	uLocal_17 = func_155(uParam0, "script@vignette@bill_14@action", 0, 0, 1, 0);
	func_156(uParam0, "CBL14AU");
	func_157(uParam0, 1499982246, -1202190567);
	func_158(uParam0, uLocal_17, -1, 0.88f);
	func_159(uParam0, iLocal_14, 3, -1666245605, "PROP_CAMP_SEAT_CHAIR_STEW_EATING_FEMALE_A", iLocal_18, 0);
	func_160(uParam0, iLocal_14, 3, -1666245605, "PROP_CAMP_SEAT_CHAIR_STEW_EATING_FEMALE_A", iLocal_18, 0, -1073741824, 1065353216, 1);
	...
	func_159(uParam0, iLocal_15, 3, -1666245605, "PROP_CAMP_SEAT_CHAIR_STEW_EATING_MALE_A", iLocal_19, 0);
	func_160(uParam0, iLocal_15, 3, -1666245605, "PROP_CAMP_SEAT_CHAIR_STEW_EATING_MALE_A", iLocal_19, 0, -1073741824, 1065353216, 1);
...
{
	return STREAMING::_0x9427C94D2E4094A4(-1666245605, 0);
}
...
void func_153(var uParam0, int iParam1, float fParam2)
{
	(uParam0->f_107[iParam1 /*113*/])->f_100 = fParam2;
}

int func_154(var uParam0, int iParam1, vector3 vParam2, int iParam5, int iParam6, int iParam7, int iParam8)
{
	int iVar0;
...
void func_158(var uParam0, var uParam1, int iParam2, float fParam3)
{
	if (iParam2 == -1)
	{
		iParam2 = 0;
...
void func_163(var uParam0, int iParam1, int iParam2, int iParam3, int iParam4, char* sParam5, char* sParam6)
{
...
void func_164(var uParam0, int iParam1, float fParam2, int iParam3, int iParam4)
{
...
int func_194(var uParam0, int iParam1, bool bParam2)
{
	...
	if (bParam2)
	{
		...
		while (iVar1 < uParam0->f_1984)
		{
			...
			else if (func_293(uParam0, iVar1) || func_294(uParam0, iVar1))
			{
...
int func_385(int iParam0, bool bParam1, bool bParam2, var uParam3, var uParam4, var uParam5, float fParam6, bool bParam7, bool bParam8, bool bParam9, bool bParam10)
{
	...
	switch (((*Global_1360165)[iParam0 /*1157*/])->f_70.f_12)
	{
		...
		case 3:
			...
			sVar12 = func_420(iParam0, func_284());
	...
	switch (iParam1)
	{
		...
		case 7:
			switch (iParam0)
			{
				...
				case 4:
					if (func_324(747937920, 1) && !func_388(((*Global_1347702)[1 /*49*/])->f_15, 1))
					{
						iVar1[0] = -1155031950;
					}
					else
