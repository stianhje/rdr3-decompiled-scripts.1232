...
int func_72(var uParam0)
{
	switch (func_148(uParam0))
	{
		...
		case 3:
			func_150(uParam0, 1886.526f, -1883.668f, 41.675f, 0f, 0f, 130.415f);
	}
	iLocal_14 = func_151(uParam0, 12, "DOG");
	iLocal_15 = func_151(uParam0, 6, "MicahBell");
	func_152(uParam0, -967333571, 0f, 0f, 0f, "p_cigarette_cs01x", 0, 0, 1);
	func_153(uParam0, 5.3689f, 1.39f, 0f, 0f, 1.2f, 1.2f, 5f, -1612834106, 1632043240, 1, 1, 1);
	func_153(uParam0, -1.2936f, 1.19f, 0f, 0f, 1.2f, 1.2f, 5f, -1612834106, -1, 1, 1, 1);
	func_154(uParam0, -0.311109f, 1.6829f, 1.13478f, 0f, 1f, 1f, 5f, 665633627, 1);
	func_155(uParam0, "script@vignette@dog_4@base", 1, 1, 0, 0);
	iLocal_16 = func_155(uParam0, "script@vignette@dog_4@action", 0, 0, 1, 0);
	func_156(uParam0, "CCDG4AU");
	func_157(uParam0, iLocal_16, -1, 0.75f);
	func_158(uParam0, iLocal_14, 3, 825624686, "WORLD_ANIMAL_DOG_RESTING", -1, 1);
	func_159(uParam0, iLocal_14, 1);
	func_160(uParam0, iLocal_14, 0, 0, 0, -1, 0, -1073741824, 1065353216, 1);
	func_158(uParam0, iLocal_15, 3, -22664287, "WORLD_HUMAN_SMOKE_MALE_D", -1, 1);
	func_161(uParam0, iLocal_15, 1, -1);
	func_162(uParam0, 1879624234, 136786459);
...
int func_93(var uParam0)
{
	...
	if (bLocal_18)
	{
		if (!ENTITY::IS_ENTITY_DEAD(func_48(uParam0, iLocal_14)))
		{
			...
			if (!iLocal_19 && !func_203(func_48(uParam0, iLocal_14), 242628503))
			{
	...
	{
		func_204(uParam0, iLocal_15, 1, 0);
	}
	return 1;
}
...
int func_154(var uParam0, vector3 vParam1, float fParam4, vector3 vParam5, int iParam8, bool bParam9)
{
	int iVar0;
...
void func_163(var uParam0, int iParam1, char* sParam2, int iParam3, int iParam4)
{
...
int func_206(var uParam0)
{
	...
	switch (uParam0->f_1699)
	{
		...
		case 1:
			uParam0->f_1707 = func_311("INTERACT_INSULT", 648122183, 0, 570, 4000, 10, 1073741824, 0, 1065353216, 0, 3, 1704213876, 0);
			func_312(uParam0->f_1707, iVar0, 0, 1, -1);
			if (uParam0->f_1709)
			{
				uParam0->f_1708 = func_311("INTERACT_GREET", -163964935, 0, 570, 4000, 10, 1073741824, 0, 1065353216, 0, 3, 1704213876, 0);
				func_312(uParam0->f_1708, iVar0, 0, 1, -1);
			}
		...
		case 2:
			if (func_313(uParam0->f_1707, 1) || func_313(uParam0->f_1708, 1))
			{
				func_314(&(uParam0->f_1707), 1, 1);
				func_314(&(uParam0->f_1708), 1, 1);
		...
		case 3:
			...
			func_315(Global_35, &Var1, 0, iVar0, 1, 0, 0, 1);
			uParam0->f_1699++;
			break;
		...
		case 4:
			if (!AUDIO::IS_ANY_SPEECH_PLAYING(Global_35))
			{
				...
				func_315(iVar0, &Var1, 0, Global_35, 1, 0, 0, 1);
				uParam0->f_1699++;
			}
			break;
...
void func_212(var uParam0)
{
	...
	while (iVar0 < uParam0->f_106)
	{
		if (((uParam0->f_107[iVar0 /*113*/])->f_32.f_60 > 0f && !(uParam0->f_107[iVar0 /*113*/])->f_32.f_62) && func_201(uParam0, (uParam0->f_107[iVar0 /*113*/])->f_32.f_61, (uParam0->f_107[iVar0 /*113*/])->f_32.f_60))
		{
...
var func_315(int iParam0, var uParam1, int iParam2, int iParam3, int iParam4, int iParam5, int iParam6, int iParam7)
{
	struct<7> Var0;
...
void func_352(var uParam0, int iParam1)
{
	...
	func_397(sVar1, uVar2, uVar3, iVar4);
}
...
int func_356(var uParam0, int iParam1)
{
	...
	while (iVar2 <= iVar1)
	{
		...
		else
		{
			...
			vVar10 = { func_400(fVar9) };
			vVar13 = { func_401(ENTITY::GET_ENTITY_COORDS((uParam0->f_107[iParam1 /*113*/])->f_5, true, false), vVar3, 1065353216) };
...
void func_397(char* sParam0, var uParam1, var uParam2, int iParam3)
{
...
Vector3 func_400(float fParam0)
{
	return -BUILTIN::SIN(fParam0), BUILTIN::COS(fParam0), 0f;
}

Vector3 func_401(vector3 vParam0, vector3 vParam3, float fParam6)
{
...
int func_409(int iParam0, bool bParam1, bool bParam2, var uParam3, var uParam4, var uParam5, float fParam6, bool bParam7, bool bParam8, bool bParam9, bool bParam10)
{
	...
	switch (((*Global_1360165)[iParam0 /*1157*/])->f_70.f_12)
	{
		...
		case 3:
			...
			sVar12 = func_440(iParam0, func_289());
