...
{
	func_33(uParam0, 11129/*func_30*/, 11218/*func_31*/, 12306/*func_32*/);
}
...
void func_14(var uParam0, vector3 vParam1, vector3 vParam4)
{
	...
	func_48(uParam0, 4, "carcass", 1110710183, OBJECT::_GET_OBJECT_OFFSET_FROM_COORDS(vParam1, vParam4.z, 0f, 0.3f, 0f), (vParam4.z - 270f), 1, 0, 1, 1, 41788943, 1);
}
...
int func_28(var uParam0)
{
	...
	if (!ENTITY::IS_ENTITY_DEAD(&(uParam0->f_20[4 /*14*/])))
	{
		...
		TASK::TASK_PLAY_ANIM(&(uParam0->f_20[4 /*14*/]), sLocal_38, sLocal_39, 1000f, -1000f, -1, 131072, 0, 0, 0, 0, 0, 0);
...
int func_30(var uParam0)
{
	...
	STREAMING::_0x19A6BE7D9C6884D3(1974927641, 1, -885451903, 0);
	func_58(&uLocal_10, 0);
	func_59(&uLocal_10, 1);
	func_60(&uLocal_10, 1);
	func_61(&uLocal_10, 1);
					...
					if (ANIMSCENE::_0x477122B8D05E7968(uParam0->f_3.f_1, 1, 0))
					{
						if (ANIMSCENE::_0x1F0E401031E20146(uParam0->f_3.f_1, "pbl_action"))
						{
							...
							if (!&uParam0->f_469[5])
							{
								...
								{
									TASK::_TASK_START_SCENARIO_IN_PLACE(&(uParam0->f_20[2 /*14*/]), 1974927641, 70000, 0, 0, -1082130432, 0);
							...
							if (!&uParam0->f_469[6])
							{
								...
								{
									TASK::_TASK_START_SCENARIO_IN_PLACE(&(uParam0->f_20[3 /*14*/]), 1974927641, 70000, 0, 0, -1082130432, 0);
...
void func_92(int iParam0, vector3 vParam1)
{
	...
	while (iVar0 < 10)
	{
		...
		{
			if (func_124((Global_32073.f_2697.f_1495[iVar0 /*4*/])->f_1, vParam1, 1056964608, 1))
			{
				return;
			}
		}
