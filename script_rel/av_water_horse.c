...
{
	func_33(uParam0, 10954/*func_30*/, 11033/*func_31*/, 12110/*func_32*/);
}
				...
				switch (iLocal_9)
				{
					case 0:
						...
						if (!ENTITY::IS_ENTITY_DEAD(&(uParam0->f_20[0 /*14*/])))
						{
							...
							if (*uParam0 == 54)
							{
								func_70(&(uParam0->f_20[0 /*14*/]), -1043454001, 0, 0, 0, -1082130432);
					...
					case 1:
						if (*uParam0 == 54)
						{
							if (PLAYER::_0x3EE1F7A8C32F24E1(PLAYER::GET_PLAYER_INDEX(), &iVar2, 0, 0))
							{
								...
								{
									if (ENTITY::GET_PED_INDEX_FROM_ENTITY_INDEX(iVar2) == &uParam0->f_20[0 /*14*/] && (PAD::IS_CONTROL_JUST_PRESSED(0, -163964935) || PAD::IS_CONTROL_JUST_PRESSED(0, 648122183)))
									{
...
void func_150(int iParam0, vector3 vParam1)
{
	...
	while (iVar0 < 10)
	{
		...
		{
			if (func_155((Global_32073.f_2697.f_1495[iVar0 /*4*/])->f_1, vParam1, 1056964608, 1))
			{
				return;
			}
		}
