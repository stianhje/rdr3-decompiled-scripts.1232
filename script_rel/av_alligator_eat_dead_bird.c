...
{
	func_33(uParam0, 10761/*func_30*/, 10805/*func_31*/, 11208/*func_32*/);
}
...
{
	func_46(uParam0, "GATOR_EAT_DEAD_BIRD", "script@ambient@animal@alligator_eat_dead_bird@action", vParam1, vParam4);
	func_47(uParam0, 1, "pbl_action", "", 0);
	func_48(uParam0, 0, "alligator", iLocal_9, 0f, 0f, 0f, 0f, 1, 1, 1, 1, 41788943, 0);
	func_48(uParam0, 1, "EGRET", iLocal_10, 0f, 0f, 0f, 0f, 1, 1, 1, 1, 41788943, 0);
}
...
int func_31(var uParam0)
{
	if (!&uParam0->f_469[0])
	{
		if (!&uParam0->f_469[1])
		{
			...
			{
				if (func_61(uParam0, uParam0->f_493, uParam0->f_494, 4, uParam0->f_495, 1112014848))
				{
					if (ANIMSCENE::_0x25557E324489393C(uParam0->f_3.f_1))
					{
						if (ANIMSCENE::_0x477122B8D05E7968(uParam0->f_3.f_1, 1, 0))
		...
		if (&uParam0->f_469[2])
		{
			if (!&uParam0->f_469[5])
			{
				if (func_63(uParam0, 0.5f, 40f, 4, -91962372, 1))
				{
					func_64(*uParam0, uParam0->f_483, 1);
					uParam0->f_469[5] = 1;
				}
			}
			if (!&uParam0->f_469[3])
					...
					if (ANIMSCENE::_0x477122B8D05E7968(uParam0->f_3.f_1, 1, 0))
					{
						if (ANIMSCENE::_0x1F0E401031E20146(uParam0->f_3.f_1, "pbl_action"))
						{
							if (ANIMSCENE::_0xD8254CB2C586412B(uParam0->f_3.f_1, 0) || ANIMSCENE::_0xCDC5512A407CF08D(uParam0->f_3.f_1))
							{
								...
								{
									func_65(uParam0->f_20[1 /*14*/]);
									func_65(uParam0->f_20[0 /*14*/]);
									uParam0->f_469[3] = 1;
									return 1;
								}
							}
...
int func_38(int iParam0, vector3 vParam1, float fParam4)
{
	...
	if (func_69(vVar0, vVar0 + vVar3, vParam1))
	{
		return 3;
	}
	return 2;
...
int func_49(int iParam0, bool bParam1, int iParam2)
{
	...
	{
		iVar0 = func_81(&(Global_1898164->f_1[0 /*5*/]));
		if (func_82(iVar0) && func_83(((*Global_1347702)[iVar0 /*49*/])->f_12, 131072))
		{
			return 0;
		}
	}
	if (iParam0 == 0 && func_84(&(Global_1898164->f_1[0 /*5*/])))
	{
		return 1;
	}
...
bool func_52()
{
	return (Global_1894899 & 1 != 0 && func_67() != -1);
}
...
int func_61(var uParam0, float fParam1, float fParam2, int iParam3, float fParam4, float fParam5)
{
	int iVar0;
	float fVar1;
	int iVar2;
	...
	if ((MISC::GET_FRAME_COUNT() % 8) == 0)
	{
		...
		fVar1 = (fVar1 * fVar1);
		fParam2 = func_96(fParam2);
		fVar7 = func_97(Global_36, uParam0->f_483);
		...
		while (iVar0 < uParam0->f_19)
		{
			...
			if (!ENTITY::IS_ENTITY_DEAD(&(uParam0->f_20[iVar0 /*14*/])))
			{
				...
				fVar8 = func_98(Global_35, &(uParam0->f_20[iVar0 /*14*/]), 1);
				if (fVar8 < fVar1)
				{
					return 1;
				}
				if (fVar8 < (fParam2 * fParam2))
				{
					...
					{
						if (!func_99(&(uParam0->f_490)))
						{
							func_100(&(uParam0->f_490));
						}
						if (func_101(&(uParam0->f_490), fParam1))
						{
...
int func_63(var uParam0, float fParam1, float fParam2, int iParam3, int iParam4, bool bParam5)
{
	int iVar0;
	...
	if ((MISC::GET_FRAME_COUNT() % 8) == 0)
	{
		...
		while (iVar0 < uParam0->f_19)
		{
			...
			else
			{
				if (!ENTITY::IS_ENTITY_DEAD(&(uParam0->f_20[iVar0 /*14*/])))
				{
					...
					{
						if ((func_98(Global_35, &(uParam0->f_20[iVar0 /*14*/]), 1) < fParam2 && PED::_0x5102307CE88798EB(&(uParam0->f_20[iVar0 /*14*/]))) && PED::IS_TRACKED_PED_VISIBLE(&(uParam0->f_20[iVar0 /*14*/])))
						{
							if (!func_99(&(uParam0->f_490)))
							{
								func_104(&(uParam0->f_490), 0);
							}
		...
		if (func_99(&(uParam0->f_490)) && !func_105(&(uParam0->f_490)))
		{
...
void func_66(var uParam0, bool bParam1, bool bParam2, bool bParam3)
{
	int iVar0;
...
bool func_69(struct<2> Param0, var uParam2, struct<2> Param3, Vector3 vParam5, struct<2> Param6, var uParam8)
{
	return (((Param3 - Param0) * (Param6.f_1 - Param0.f_1)) - ((Param3.f_1 - Param0.f_1) * (Param6 - Param0))) > 0f;
}

int func_70(vector3 vParam0, float fParam3)
{
	int iVar0;
...
float func_98(int iParam0, int iParam1, bool bParam2)
{
	if (!ENTITY::DOES_ENTITY_EXIST(iParam0))
	{
		return 0f;
	...
	return func_126(ENTITY::GET_ENTITY_COORDS(iParam0, false, false), ENTITY::GET_ENTITY_COORDS(iParam1, false, false));
}
...
void func_106(var uParam0)
{
	...
	if (func_105(uParam0))
	{
		uParam0->f_1 = (func_129() - uParam0->f_2);
		uParam0->f_2 = 0f;
		func_130(uParam0, 2);
	}
}
...
void func_108(var uParam0)
{
	...
	if (!func_105(uParam0))
	{
		uParam0->f_2 = (func_129() - uParam0->f_1);
		func_132(uParam0, 2);
	}
}
...
void func_109(int iParam0)
{
	if (func_43(iParam0))
	{
		...
		{
			case 1:
				func_133(0, 1, 0, 0, ((Global_1415419->f_19[iParam0 /*12*/])->f_7 / 4), 0, 0, 1);
				func_133(1, 1, 0, 0, ((Global_1415419->f_19[iParam0 /*12*/])->f_7 / 4), 0, 0, 1);
				break;
			case 37:
				func_133(60, 1, 0, 0, ((Global_1415419->f_19[iParam0 /*12*/])->f_7 / 4), 0, 0, 1);
				break;
		}
	}
}

void func_110(int iParam0, vector3 vParam1)
{
	int iVar0;
	int iVar1;
...
void func_133(int iParam0, int iParam1, int iParam2, int iParam3, int iParam4, int iParam5, bool bParam6, int iParam7)
{
	int iVar0;

	iVar0 = (((iParam2 + (60 * iParam3)) + (3600 * iParam4)) + (86400 * iParam5));
	if (func_138(iParam0) == 1 && iParam7)
	{
		return;
	}
	if (bParam6)
