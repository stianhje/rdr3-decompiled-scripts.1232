...
int func_72(var uParam0)
{
	...
	func_151(uParam0, 2.5206f, -3.032f, 0.4558f, 10.44f, 1.5f, 1.5f, 3f, -1612834106, -2055224817, 1, 1, 1);
	func_151(uParam0, 1.0272f, -3.2717f, 0.5389f, 10.68f, 1.5f, 1.5f, 3f, -1612834106, 1877049591, 1, 1, 1);
	func_152(uParam0, 1.75f, -3.35f, 0.5f, 12f, 1f, 0.56f, 3f, 665633627, 1);
	func_153(uParam0, -289651159, 0f, 0f, 0f, "CHAIR_0", 0, 0, 1);
	iLocal_21 = func_153(uParam0, -289651159, 0f, 0f, 0f, "CHAIR_1", 0, 0, 1);
	func_153(uParam0, 1789147356, 0f, 0f, 0f, "SOCK", 0, 0, 1);
	func_154(uParam0, "script@vignette@beecher@abigail_and_uncle_1@base", 1, 1, 0, 0);
	iLocal_16 = func_154(uParam0, "script@vignette@beecher@abigail_and_uncle_1@action_a", 2, 0, 1, 0);
	iLocal_17 = func_154(uParam0, "script@vignette@beecher@abigail_and_uncle_1@action_b", 0, 0, 0, 0);
	iLocal_18 = func_154(uParam0, "script@vignette@beecher@abigail_and_uncle_1@action_b_alt_front", 0, 0, 0, 1);
	iLocal_19 = func_154(uParam0, "script@vignette@beecher@abigail_and_uncle_1@action_b_alt_left", 0, 0, 0, 1);
	iLocal_20 = func_154(uParam0, "script@vignette@beecher@abigail_and_uncle_1@action_b_alt_right", 0, 0, 0, 1);
	func_155(uParam0, "BANU1AU");
	func_156(uParam0, -752540484, -900956559);
	func_157(uParam0, iLocal_14, 2, -360309995, "PROP_HUMAN_SEAT_CHAIR_SEWING_FEMALE_A", -1, 0, -1073741824, 1065353216, 1);
	func_158(uParam0, iLocal_14, 1, -1);
	func_157(uParam0, iLocal_15, 3, -1133174268, "PROP_HUMAN_SEAT_CHAIR_PORCH_MALE_A", iLocal_21, 0, -1073741824, 1065353216, 1);
	func_158(uParam0, iLocal_15, 1, -1);
	Local_22 = { func_159(uParam0, 1.027f, -3.272f, 0.539f, -165.24f, 7f, 0.5f, 0.5f) };
	Local_32 = { func_159(uParam0, 1.027f, -3.272f, 0.539f, 96.02f, 7f, 0.597f, 0.4f) };
	Local_42 = { func_159(uParam0, 1.027f, -3.272f, 0.539f, -84.23f, 7f, 0.597f, 0.4f) };
	return 1;
}
