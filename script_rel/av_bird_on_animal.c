...
{
	func_33(uParam0, 11068/*func_30*/, 11127/*func_31*/, 11681/*func_32*/);
}
...
void func_14(var uParam0, vector3 vParam1, vector3 vParam4)
{
	...
	func_46(uParam0, "BIRD_ON_ANIMAL", "", vParam1, vParam4);
	iVar0 = 1;
	bVar1 = func_47();
	switch (*uParam0)
	{
		case 116:
			...
			break;
		case 117:
			iLocal_11 = -1181541851;
			iLocal_9 = -1963605336;
			break;
		case 118:
			iLocal_11 = 1552582728;
			iLocal_9 = 1556473961;
			break;
		case 119:
			iLocal_11 = 1728076958;
		...
		case 121:
			...
			{
				iVar0 = 0;
				iLocal_12 = 2146685523;
			}
			break;
	}
	if (*uParam0 == 116)
	{
		iLocal_10 = 1095117488;
	}
	else
	{
	...
	func_48(uParam0, 1, "BOA_BIRD_1", iLocal_10, OBJECT::_GET_OBJECT_OFFSET_FROM_COORDS(vParam1, vParam4.z, 0.25f, -1f, 1f), (0f + vParam4.z), 1, 1, 1, 1, 41788943, 1);
	func_48(uParam0, 0, "BOA_ANIMAL_1", iLocal_9, OBJECT::_GET_OBJECT_OFFSET_FROM_COORDS(vParam1, vParam4.z, 0f, 0f, 1f), (0f + vParam4.z), iVar0, 1, 1, 1, iLocal_12, 1);
}
...
int func_31(var uParam0)
{
	...
	if (!&uParam0->f_469[1])
	{
		...
		while (iVar1 < 2)
		{
			if (ENTITY::IS_ENTITY_DEAD(&(uParam0->f_20[iVar1 /*14*/])) || func_63(&(uParam0->f_20[iVar1 /*14*/]), 0, &uLocal_17, &uVar0, 0, 0))
			{
				iLocal_13 = 1;
				uParam0->f_469[1] = 1;
			}
	...
	switch (iLocal_13)
	{
		case 0:
			...
			{
				func_64(&((uParam0->f_20[0 /*14*/])->f_5), 50, 10, 0);
				TASK::TASK_START_SCENARIO_AT_POSITION(&(uParam0->f_20[0 /*14*/]), iLocal_11, (uParam0->f_20[0 /*14*/])->f_5, (uParam0->f_20[0 /*14*/])->f_8, 0, 0, 1, 0, -1082130432, 0);
				func_65(uParam0->f_20[0 /*14*/], 1, 1);
			}
			if (!ENTITY::IS_ENTITY_DEAD(&(uParam0->f_20[1 /*14*/])))
			{
				ENTITY::ATTACH_ENTITY_TO_ENTITY(&(uParam0->f_20[1 /*14*/]), &(uParam0->f_20[0 /*14*/]), func_66(uParam0), func_67(uParam0), func_68(uParam0), 1, 1, 0, 1, 2, 1, 0, 0);
		...
		case 2:
			if (func_73(&(uParam0->f_20[0 /*14*/]), 0))
			{
				if (*uParam0 != 119)
				{
					TASK::_TASK_SMART_FLEE_STYLE_PED(&(uParam0->f_20[0 /*14*/]), Global_35, 3, 0, -1082130432, -1, 0);
				}
				else
				{
...
int func_63(int iParam0, int iParam1, var uParam2, var uParam3, int iParam4, float fParam5)
{
	int iVar0;
...
int func_69(var uParam0, float fParam1, float fParam2, int iParam3, float fParam4, float fParam5)
{
	int iVar0;
	float fVar1;
	int iVar2;
	...
	if ((MISC::GET_FRAME_COUNT() % 8) == 0)
	{
		...
		fVar7 = func_137(Global_36, uParam0->f_483);
		...
		while (iVar0 < uParam0->f_19)
		{
			...
			if (!ENTITY::IS_ENTITY_DEAD(&(uParam0->f_20[iVar0 /*14*/])))
			{
				...
				fVar8 = func_138(Global_35, &(uParam0->f_20[iVar0 /*14*/]), 1);
				if (fVar8 < fVar1)
				{
					return 1;
				}
...
void func_70(var uParam0)
{
	...
	if (!&uParam0->f_469[4])
	{
		func_143(*uParam0, uParam0->f_483, 0);
		uParam0->f_469[4] = 1;
	}
}
	...
	switch (uParam0->f_6)
	{
		case 0:
			if (*uParam0 & 16 != 0)
			{
				...
				else if (!PED::IS_PED_PLANTING_BOMB(Global_35) && (!func_164(1) || *uParam0 & 8192 != 0))
				{
...
int func_104(int iParam0, var uParam1)
{
	...
	switch (iVar0)
	{
		...
		case 1589923363:
			...
			if (!func_167(iParam0, uParam1, iVar2))
			{
				return 0;
			}
			if (func_168(iParam0, iVar2) <= func_169(uParam1))
			{
				return 1;
			}
			break;
...
int func_106(int iParam0, var uParam1)
{
	...
	if (!ENTITY::IS_ENTITY_DEAD(iParam0))
	{
		if (func_173(iParam0, !*uParam1 & 268435456 != 0, !*uParam1 & 536870912 != 0, !*uParam1 & 1073741824 != 0, 0, 0))
		{
			if (uParam1->f_12 < 5f)
			{
				fVar0 = 95f;
			...
			fVar1 = func_174(uParam1);
			if (func_175(uParam1, iParam0, fVar0, fVar1))
			{
				if (uParam1->f_2 == 0)
				{
...
int func_107(int iParam0, int iParam1, var uParam2)
{
	...
	fVar0 = 85f;
	if (func_177(iParam1, !*uParam2 & 268435456 != 0, !*uParam2 & 536870912 != 0, !*uParam2 & 1073741824 != 0, 0))
	{
		if (uParam2->f_12 < 5f)
		{
			fVar0 = 95f;
		...
		fVar1 = func_174(uParam2);
		if (func_175(uParam2, iParam0, fVar0, fVar1))
		{
			if (uParam2->f_2 == 0)
			{
			...
			if (uParam2->f_2 != 0)
			{
				if (MISC::GET_GAME_TIMER() - uParam2->f_2) > func_176(uParam2)
				{
					func_171(uParam2, 1);
					return 1;
				}
...
int func_108(int iParam0, var uParam1)
{
	...
	if (func_167(iParam0, uParam1, iVar1))
	{
		if (uParam1->f_3 == 0)
		{
			uParam1->f_3 = MISC::GET_GAME_TIMER();
		}
		else if (MISC::GET_GAME_TIMER() - uParam1->f_3) > func_176(uParam1)
		{
			fVar3 = func_174(uParam1);
...
int func_112(var uParam0, int iParam1, var uParam2)
{
	...
	if (uParam2->f_12 < IntToFloat(func_180(uParam2)))
	{
		...
		switch (iVar3)
		{
			...
			case 2:
				if (EVENT::IS_SHOCKING_EVENT_IN_SPHERE(-966930978, vVar0, uParam2->f_22))
				{
					...
					if (func_182(iParam1, vVar0, vVar4))
					{
						func_171(uParam2, 1);
						return 1;
					}
		...
		switch (iVar3)
		{
			...
			case 2:
				if (EVENT::IS_SHOCKING_EVENT_IN_SPHERE(-966930978, vVar0, uParam2->f_22))
				{
					...
					if (func_182(iParam1, vVar0, vVar7))
					{
						func_171(uParam2, 1);
						return 1;
					}
...
int func_114(int iParam0, var uParam1)
{
	...
	{
		if (!func_167(iParam0, uParam1, &(Global_1935630->f_34[iVar0])) || iParam0 == &Global_1935630->f_34[iVar0])
		{
		}
		else
		{
			bVar13 = func_183(&(Global_1935630->f_34[iVar0]));
			...
			if (func_184(uParam1, iParam0, fVar1, bVar12, bVar13))
			{
				*(vVar2[0 /*3*/]) = { ENTITY::GET_ENTITY_COORDS(&(Global_1935630->f_34[iVar0]), false, false) };
				*(vVar2[1 /*3*/]) = { vVar9 };
				uParam1->f_10 = iParam0;
			...
			else if (func_185(uParam1, iParam0, fVar1, bVar12, bVar13))
			{
				*(vVar2[0 /*3*/]) = { ENTITY::GET_ENTITY_COORDS(&(Global_1935630->f_34[iVar0]), false, false) };
				*(vVar2[1 /*3*/]) = { vVar9 };
				uParam1->f_10 = iParam0;
			...
			else if (func_186(uParam1, iParam0, fVar1, iVar0))
			{
				*(vVar2[0 /*3*/]) = { ENTITY::GET_ENTITY_COORDS(&(Global_1935630->f_34[iVar0]), false, false) };
				*(vVar2[1 /*3*/]) = { vVar9 };
				uParam1->f_10 = iParam0;
...
int func_120(int iParam0, int iParam1)
{
	if (!ENTITY::IS_ENTITY_DEAD(iParam1))
	{
		...
		if (func_190(iParam0, iParam1, 1, 1) < 4f)
		{
...
int func_122(var uParam0, int iParam1)
{
	...
	if (iVar0 != 0 && !VEHICLE::IS_THIS_MODEL_A_TRAIN(ENTITY::GET_ENTITY_MODEL(iVar0)))
	{
		...
		if (func_191(iVar0, iParam1, vVar1))
		{
...
int func_125(var uParam0, int iParam1)
{
	...
	fVar0 = func_169(uParam0);
	if (uParam0->f_12 > func_193(uParam0) && uParam0->f_12 > fVar0)
	{
		return 0;
	}
	iVar2 = func_194(iParam1);
	iVar1 = func_195(uParam0->f_14);
...
int func_126(int iParam0, int iParam1, var uParam2)
{
	...
	return func_196(iParam0, iParam1, bVar0, bVar2, uParam2->f_12, bVar1);
}
...
int func_131(int iParam0, var uParam1)
{
	...
	else if (func_123() - uParam1->f_4) > func_200(uParam1)
	{
		return func_201(iParam0, uParam1, 0, -1082130432);
	}
	return 0;
}
...
bool func_133(vector3 vParam0, vector3 vParam3)
{
...
float func_138(int iParam0, int iParam1, bool bParam2)
{
	...
	return func_202(ENTITY::GET_ENTITY_COORDS(iParam0, false, false), ENTITY::GET_ENTITY_COORDS(iParam1, false, false));
}
...
void func_143(int iParam0, vector3 vParam1, bool bParam4)
{
	if (func_40() > (Global_32073.f_2697.f_6[iParam0 /*6*/])->f_5)
	{
		(Global_32073.f_2697.f_6[iParam0 /*6*/])->f_5 = func_40();
...
int func_167(int iParam0, var uParam1, int iParam2)
{
	...
	{
		iVar1 = func_195(iParam2);
	}
	else
	{
		iVar1 = func_194(iParam2);
	}
	if (!PED::IS_PED_HUMAN(iParam0))
	{
...
{
	return func_190(iParam0, iParam1, 1, 1);
}
...
int func_173(int iParam0, bool bParam1, bool bParam2, bool bParam3, int iParam4, int iParam5)
{
	int iVar0;
	int iVar1;
	int iVar2;
	...
	if (bParam3)
	{
		if (((WEAPON::_0xCB690F680A3EA971(iVar0, 1) && PLAYER::IS_PLAYER_TARGETTING_ENTITY(iVar1, iParam0, iParam5)) && PLAYER::IS_PLAYER_FREE_AIMING_AT_ENTITY(iVar1, iParam0)) && func_190(iVar0, iParam0, 1, 1) <= 4f)
		{
			return 1;
		}
	}
...
int func_177(int iParam0, bool bParam1, bool bParam2, bool bParam3, int iParam4)
{
	int iVar0;
	int iVar1;
...
int func_182(int iParam0, vector3 vParam1, vector3 vParam4)
{
...
int func_186(var uParam0, int iParam1, float fParam2, int iParam3)
{
	float fVar0;
...
float func_190(int iParam0, int iParam1, bool bParam2, int iParam3)
{
...
int func_191(int iParam0, int iParam1, vector3 vParam2)
{
	float fVar0;
...
int func_196(int iParam0, int iParam1, bool bParam2, bool bParam3, float fParam4, bool bParam5)
{
	bool bVar0;
	int iVar1;
	float fVar2;
	...
	if (fParam4 <= 0f)
	{
		fVar2 = func_190(iParam0, PLAYER::PLAYER_PED_ID(), 0, 1);
	}
	else
	{
		fVar2 = fParam4;
	...
	if (bVar0)
	{
		if (func_190(iParam0, Global_1935630->f_40, 0, 1) < 2.5f)
		{
...
int func_197(int iParam0, var uParam1, bool bParam2)
{
	int iVar0;
	int iVar1;
	...
	if (ENTITY::DOES_ENTITY_EXIST(iVar0))
	{
		if (iVar0 != iParam0)
		{
			if (PED::_0x06087579E7AA85A9(iParam0, Global_35, -1f, -1f, -1f, -1f))
			{
				if (ENTITY::HAS_ENTITY_CLEAR_LOS_TO_ENTITY(iParam0, Global_35, 17))
				{
					if (!bParam2 || !func_198(uParam1, iVar0))
					{
						return 1;
					}
				}
	...
	if (ENTITY::DOES_ENTITY_EXIST(iVar1))
	{
		if (iVar1 != iParam0)
		{
			...
			{
				if (!bParam2 || !func_198(uParam1, iVar1))
				{
...
int func_201(int iParam0, var uParam1, bool bParam2, float fParam3)
{
	if (!bParam2)
	{
		if (uParam1->f_4 == 0)
...
float func_202(vector3 vParam0, vector3 vParam3)
{
	vParam0.f_2 = 0f;
	vParam3.f_2 = 0f;
...
void func_204(int iParam0)
{
	if (func_43(iParam0))
	{
		...
		{
			case 1:
				func_229(0, 1, 0, 0, ((Global_1415419->f_19[iParam0 /*12*/])->f_7 / 4), 0, 0, 1);
				func_229(1, 1, 0, 0, ((Global_1415419->f_19[iParam0 /*12*/])->f_7 / 4), 0, 0, 1);
				break;
			case 37:
				func_229(60, 1, 0, 0, ((Global_1415419->f_19[iParam0 /*12*/])->f_7 / 4), 0, 0, 1);
				break;
		}
	}
}

void func_205(int iParam0, vector3 vParam1)
{
	int iVar0;
	int iVar1;
...
void func_229(int iParam0, int iParam1, int iParam2, int iParam3, int iParam4, int iParam5, bool bParam6, int iParam7)
{
	int iVar0;
