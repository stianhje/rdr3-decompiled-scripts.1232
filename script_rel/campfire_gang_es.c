...
int func_57(bool bParam0, vector3 vParam1, int iParam4, int iParam5)
{
	bool bVar0;
	...
	{
		if (&Global_1393237 != 0 && (&Global_1393237 - MISC::GET_GAME_TIMER()) < func_83())
		{
			return 0;
		}
		if (Global_1393237->f_2 != 0)
...
void func_60(int iParam0, var uParam1, var uParam2, var uParam3, var uParam4, var uParam5, var uParam6)
{
...
int func_62(int iParam0, vector3 vParam1)
{
	float fVar0;
	float fVar1;
...
int func_70(int iParam0, bool bParam1, int iParam2, int iParam3)
{
	...
	{
		return func_94(bParam1, iParam2, iParam3);
	}
...
void func_91(int iParam0, int iParam1, var uParam2, var uParam3, var uParam4, var uParam5, var uParam6, var uParam7)
{
	...
	while (iVar4 < 0)
	{
		...
		iVar3 = (iVar3 - 1);
		iVar0 = BUILTIN::ROUND(func_105(BUILTIN::TO_FLOAT(iVar0 + 1), 0f, 12f));
	}
	while (iVar3 < 0)
	{
		iVar3 += 12;
