...
int func_72(var uParam0)
{
	...
	func_151(uParam0, 0.45f, -0.15f, 1.007f, 85.5f, 2.5575f, 1.875f, 2.365f, -1612834106, -695792551, 1, 1, 1);
	func_151(uParam0, -3.575f, -0.7f, 1.0195f, 87.75f, 2f, 2f, 2.335f, -1612834106, -1377448058, 1, 1, 1);
	func_152(uParam0, -3.87134f, -1.09542f, 1.00508f, 0f, 1f, 1f, 2f, 665633627, 1);
	func_153(uParam0, -1510839859, -4.62596f, -1.37365f, -0.000255585f, "p_chair24x", 1, 0, 1);
	func_153(uParam0, -1671495534, 0f, 0f, 0f, "p_cigarette01x", 0, 1, 1);
	iLocal_16 = func_153(uParam0, 1210783447, 0f, 0f, 0f, "p_cs_book03x", 0, 0, 1);
	func_154(uParam0, "script@vignette@karen_11@base", 1, 1, 0, 0);
	iLocal_17 = func_154(uParam0, "script@vignette@karen_11@action_a", 2, 0, 1, 0);
	iLocal_18 = func_154(uParam0, "script@vignette@karen_11@action_b_alt", 0, 0, 0, 1);
	func_155(uParam0, "CKR11AU");
	func_156(uParam0, iLocal_15, 4, 1, 0, 0, 0);
	func_157(uParam0, iLocal_14, 3, 1253642035, "PROP_HUMAN_SEAT_CHAIR_READING_FEMALE_A", -1, 0);
	func_158(uParam0, iLocal_14, 3, 1253642035, "PROP_HUMAN_SEAT_CHAIR_READING_FEMALE_A", -1, 0, -1073741824, 1065353216, 1);
	func_159(uParam0, iLocal_14, iLocal_16, "p_cs_book04x_PH_R_HAND", 0, 0);
	func_156(uParam0, iLocal_14, 4, 2, 0, 0, 0);
	Local_19 = { func_160(uParam0, -4.265f, -1.51f, 1.07f, -62.75f, 4.8025f, 0f, 0.82f) };
	iLocal_29 = func_161(uParam0, 3.3625f, 1.3387f, 2.4264f, 0f, 0f, 174.515f, 16.4725f, 16.24f, 5f, "Start_Trigger", -1612834106);
	func_162(uParam0, 1);
	return 1;
}
...
{
	return func_193(Global_35, iLocal_29, 1, 0);
}
...
int func_93(var uParam0)
{
	...
	{
		if (func_202(uParam0, Local_19, 1, 1))
		{
...
bool func_193(int iParam0, int iParam1, bool bParam2, int iParam3)
{
