...
int func_73(var uParam0)
{
	...
	func_151(uParam0, 0f, 0f, 0.625f, 0f, 2f, 2f, 2f, 665633627, 1);
	func_152(uParam0, -1.5f, -0.075f, 0.85f, 0f, 1.2025f, 1.8925f, 2.0875f, -1612834106, -1, 1, 1, 1);
	func_153(uParam0, 7, "MALE");
	iLocal_14 = func_154(uParam0, joaat("a_c_rabbit_01"), "RABBIT");
	iLocal_15 = func_155(uParam0, "script@ambient@campfireGeneral@Drop_Rabbit_Table@Action", 0, 1, 0, 0);
	iLocal_16 = func_156(uParam0, iLocal_15, "Pl_Drop_Exit_Back", 1);
	iLocal_17 = func_156(uParam0, iLocal_15, "PL_DROP_ADDRESS_EXIT", 1);
	iLocal_18 = func_157(uParam0, 1.3375f, -0.4125f, 0.85f, 0f, 0f, 0f, 2.2825f, 2.6175f, 2.0875f, "Pearson Volume", -1612834106);
	return 1;
}
...
int func_91(var uParam0)
{
	...
	if (ENTITY::DOES_ENTITY_EXIST(iVar0))
	{
		if (func_192(iVar0, iLocal_18, 1, 0))
		{
			func_172(uParam0, iLocal_17, 1);
		}
	}
	func_193(uParam0, iLocal_15, "BOOL_BASE_LOOP", 1);
	return 1;
}
...
int func_94(var uParam0)
{
	...
	{
		PED::SET_PED_TO_RAGDOLL(func_49(uParam0, iLocal_14), 1000, 5000, 0, false, true, false);
...
int func_144(var uParam0)
{
	...
	while (iVar0 < uParam0->f_106)
	{
		...
		else
		{
			...
			{
				if (func_123((uParam0->f_107[iVar0 /*113*/])->f_1, 29, 1) || func_245((uParam0->f_107[iVar0 /*113*/])->f_1))
				{
					return 1;
				}
				if (!uParam0->f_3)
...
int func_157(var uParam0, vector3 vParam1, vector3 vParam4, vector3 vParam7, char* sParam10, int iParam11)
{
	int iVar0;
	vector3 vVar1;
...
int func_189(var uParam0, int iParam1, bool bParam2)
{
	...
	if (uParam0->f_2270)
	{
		uParam0->f_2274 = 0;
		uParam0->f_2275 = 0;
		if ((func_113() && ANIMSCENE::_0x6F1F0B17109309DA(uParam0->f_2046, "ARTHUR")) || (func_283() && ANIMSCENE::_0x6F1F0B17109309DA(uParam0->f_2046, "JOHN")))
		{
			uParam0->f_2274 = 1;
		}
	}
...
int func_193(var uParam0, int iParam1, char* sParam2, bool bParam3)
{
	int iVar0;
...
int func_330(int iParam0, bool bParam1)
{
	...
	{
		func_235(iParam0, _NAMESPACE48::_0x4F76E3676583D951(func_133(iParam0)));
		if (func_223() == -1)
		{
...
int func_385(int iParam0, bool bParam1, bool bParam2, var uParam3, var uParam4, var uParam5, float fParam6, bool bParam7, bool bParam8, bool bParam9, bool bParam10)
{
	...
	switch (((*Global_1360165)[iParam0 /*1157*/])->f_70.f_12)
	{
		...
		case 3:
			...
			sVar12 = func_420(iParam0, func_283());
