...
int func_72(var uParam0)
{
	...
	func_151(uParam0, -4.8914f, 4.5717f, 1.3249f, 0f, 1.5f, 1.5f, 3f, -1612834106, 2017216891, 1, 1, 1);
	func_151(uParam0, 1.419f, -2.8019f, 1.0068f, 0f, 1.5f, 1.75f, 3f, -1612834106, -1377448058, 1, 1, 1);
	func_152(uParam0, joaat("p_cs_book04x"), 0f, 0f, 0f, "BOOK", 0, 1, 1);
	iLocal_22 = func_152(uParam0, joaat("p_cigar02x"), 0f, 0f, 0f, "CIGAR", 0, 1, 1);
	iLocal_17 = func_153(uParam0, "script@vignette@dutch_25@base", 1, 0, 0, 0);
	iLocal_16 = func_153(uParam0, "script@vignette@dutch_25@trans@DTC_scenario_trans_base", 2, 0, 0, 0);
	iLocal_18 = func_153(uParam0, "script@vignette@dutch_25@action_a", 2, 0, 1, 0);
	iLocal_19 = func_153(uParam0, "script@vignette@dutch_25@action_b", 0, 0, 0, 0);
	iLocal_20 = func_153(uParam0, "script@vignette@dutch_25@action_b_alt_front", 0, 0, 0, 1);
	iLocal_21 = func_153(uParam0, "script@vignette@dutch_25@action_b_alt_right", 0, 0, 0, 1);
	func_154(uParam0, "CDT25AU");
	func_155(uParam0, -1279959174, 272167003);
	func_156(uParam0, iLocal_14, 3, 920578187, "WORLD_CAMP_DUTCH_SMOKE_CIGAR_MALE_A", -1, 1);
	func_156(uParam0, iLocal_15, 3, 1204099266, "WORLD_HUMAN_SIT_GROUND_READING_BOOK_FEMALE_A", -1, 1);
	func_157(uParam0, iLocal_15, 2, 1204099266, "WORLD_HUMAN_SIT_GROUND_READING_BOOK_FEMALE_A", -1, 0, -1073741824, 1065353216, 1);
	func_158(uParam0, iLocal_15, 1, -1);
	Local_23 = { func_159(uParam0, 2.2422f, -4.2411f, 1.0206f, -0.2165f, 8f, 0.27f, 0.7f) };
	Local_33 = { func_159(uParam0, 2.242f, -4.241f, 1.021f, -90.25f, 8f, 0.3f, 0.3f) };
	return 1;
}
...
{
	func_191(func_190(uParam0, iLocal_22), 0);
	return 1;
}

int func_87(var uParam0)
{
	if ((iLocal_43 && func_192(uParam0, iLocal_16)) && !func_193(uParam0, iLocal_17))
	{
...
int func_93(var uParam0)
{
	...
	{
		if (func_201(uParam0, Local_23, 1, 1))
		{
			func_202(uParam0, iLocal_20, -1, 0.68f);
			func_189(uParam0, iLocal_20, 1);
		}
		else if (func_201(uParam0, Local_33, 1, 1))
		{
			func_202(uParam0, iLocal_21, -1, 0.68f);
			func_189(uParam0, iLocal_21, 1);
		}
		else
		{
			func_202(uParam0, iLocal_19, -1, 0.68f);
			func_189(uParam0, iLocal_19, 1);
		}
	}
	return 1;
}
...
int func_189(var uParam0, int iParam1, bool bParam2)
{
	...
	if (bParam2)
	{
		...
		while (iVar1 < uParam0->f_1984)
		{
			...
			else if (func_193(uParam0, iVar1) || func_192(uParam0, iVar1))
			{
				func_294(uParam0, iVar1);
			}
			iVar1++;
		}
	}
...
void func_208(var uParam0)
{
	...
	while (iVar0 < uParam0->f_106)
	{
		if (((uParam0->f_107[iVar0 /*113*/])->f_32.f_60 > 0f && !(uParam0->f_107[iVar0 /*113*/])->f_32.f_62) && func_296(uParam0, (uParam0->f_107[iVar0 /*113*/])->f_32.f_61, (uParam0->f_107[iVar0 /*113*/])->f_32.f_60))
		{
