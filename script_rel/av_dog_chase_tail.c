...
{
	func_33(uParam0, 10800/*func_30*/, 10851/*func_31*/, 11489/*func_32*/);
}
...
{
	func_46(uParam0, "DOG_CHASE_TAIL", "script@ambient@animal@dog_chase_tail@action", vParam1, vParam4);
	uParam0->f_16 = 1;
	func_47(uParam0, 1, "pbl_action", "", 0);
	func_48(uParam0, 0, "DOG", iLocal_9, 0f, 0f, 0f, 0f, 1, 1, 1, 1, 41788943, 1);
}
...
int func_31(var uParam0)
{
	...
	if (!&uParam0->f_469[0])
	{
		if (ANIMSCENE::_0x25557E324489393C(uParam0->f_3.f_1))
		{
			if (ANIMSCENE::_0x477122B8D05E7968(uParam0->f_3.f_1, 1, 0))
			{
				if (func_63(uParam0, &uLocal_10, 1))
				{
					func_64(uParam0);
					if (!&uParam0->f_469[5])
					{
						func_65(*uParam0, uParam0->f_483, 0);
						uParam0->f_469[5] = 1;
					}
					uParam0->f_469[0] = 1;
				}
	...
	if (&uParam0->f_469[0])
	{
		...
		if (!ANIMSCENE::_0x3AB6C7B0BB0DF4B1(&(uParam0->f_20[0 /*14*/]), -1))
		{
			return 1;
		}
	}
	if (!&uParam0->f_469[0])
	{
		...
		if (uParam0->f_469[2] && !&uParam0->f_469[3])
		{
			if (!&uParam0->f_469[5])
			{
				if (func_67(uParam0, 1.5f, 1116471296, 4, -91962372, 1))
				{
					func_65(*uParam0, uParam0->f_483, 0);
					uParam0->f_469[5] = 1;
				}
...
int func_38(int iParam0, vector3 vParam1, float fParam4)
{
	...
	if (func_71(vVar0, vVar0 + vVar3, vParam1))
	{
		return 3;
	}
	return 2;
...
void func_41(var uParam0, int iParam1, int iParam2, int iParam3, int iParam4, int iParam5, int iParam6, bool bParam7)
{
	...
	func_81(uParam0, iVar5, iVar4, iVar3, iVar2, iVar1, iVar0);
}
...
bool func_52()
{
	return (Global_1894899 & 1 != 0 && func_69() != -1);
}
...
int func_54(int iParam0, vector3 vParam1, float fParam4, bool bParam5, bool bParam6, int iParam7, bool bParam8, bool bParam9, bool bParam10, bool bParam11, bool bParam12, bool bParam13, bool bParam14)
{
	...
	func_87(iVar0, iParam0, iParam7, bParam8, bParam9, bParam10, bParam11, bParam12);
	return iVar0;
}
...
int func_63(var uParam0, var uParam1, int iParam2)
{
	...
	{
		if (func_96(&(uParam0->f_20[uParam0->f_501 /*14*/]), 0, uParam1, &(uParam0->f_468), 0, 0))
		{
			return 1;
		}
		uParam0->f_501++;
...
int func_67(var uParam0, float fParam1, float fParam2, int iParam3, int iParam4, bool bParam5)
{
	int iVar0;
...
bool func_71(struct<2> Param0, var uParam2, struct<2> Param3, Vector3 vParam5, struct<2> Param6, var uParam8)
{
	return (((Param3 - Param0) * (Param6.f_1 - Param0.f_1)) - ((Param3.f_1 - Param0.f_1) * (Param6 - Param0))) > 0f;
}

int func_72(vector3 vParam0, float fParam3)
{
	int iVar0;
...
void func_87(int iParam0, int iParam1, int iParam2, bool bParam3, bool bParam4, bool bParam5, bool bParam6, bool bParam7)
{
	bool bVar0;
...
void func_98(int iParam0)
{
	if (func_43(iParam0))
	{
		...
		{
			case 1:
				func_159(0, 1, 0, 0, ((Global_1415419->f_19[iParam0 /*12*/])->f_7 / 4), 0, 0, 1);
				func_159(1, 1, 0, 0, ((Global_1415419->f_19[iParam0 /*12*/])->f_7 / 4), 0, 0, 1);
				break;
			
			case 37:
				func_159(60, 1, 0, 0, ((Global_1415419->f_19[iParam0 /*12*/])->f_7 / 4), 0, 0, 1);
				break;
		}
	}
}

void func_99(int iParam0, vector3 vParam1)
{
	int iVar0;
	int iVar1;
...
float func_104(int iParam0, int iParam1, bool bParam2)
{
	...
	return func_160(ENTITY::GET_ENTITY_COORDS(iParam0, false, false), ENTITY::GET_ENTITY_COORDS(iParam1, false, false));
}
...
void func_118(var uParam0, int iParam1)
{
	...
	if (iParam1 < 1 || iParam1 > func_80(iVar0, iVar1))
	{
		return;
	}
...
int func_130(int iParam0, var uParam1)
{
	...
	switch (iVar0)
	{
		...
		case 1589923363:
			...
			if (!func_176(iParam0, uParam1, iVar2))
			{
				return 0;
			}
			if (func_177(iParam0, iVar2) <= func_178(uParam1))
			{
				return 1;
			}
			break;
...
int func_132(int iParam0, var uParam1)
{
	...
	if (!ENTITY::IS_ENTITY_DEAD(iParam0))
	{
		if (func_182(iParam0, !*uParam1 & 268435456 != 0, !*uParam1 & 536870912 != 0, !*uParam1 & 1073741824 != 0, 0, 0))
		{
			if (uParam1->f_12 < 5f)
			{
				fVar0 = 95f;
			...
			fVar1 = func_183(uParam1);
			if (func_184(uParam1, iParam0, fVar0, fVar1))
			{
				if (uParam1->f_2 == 0)
				{
...
int func_133(int iParam0, int iParam1, var uParam2)
{
	...
	fVar0 = 85f;
	if (func_186(iParam1, !*uParam2 & 268435456 != 0, !*uParam2 & 536870912 != 0, !*uParam2 & 1073741824 != 0, 0))
	{
		if (uParam2->f_12 < 5f)
		{
			fVar0 = 95f;
		...
		fVar1 = func_183(uParam2);
		if (func_184(uParam2, iParam0, fVar0, fVar1))
		{
			if (uParam2->f_2 == 0)
			{
			...
			if (uParam2->f_2 != 0)
			{
				if (MISC::GET_GAME_TIMER() - uParam2->f_2) > func_185(uParam2)
				{
					func_180(uParam2, 1);
					return 1;
				}
...
int func_134(int iParam0, var uParam1)
{
	...
	if (func_176(iParam0, uParam1, iVar1))
	{
		if (uParam1->f_3 == 0)
		{
			uParam1->f_3 = MISC::GET_GAME_TIMER();
		}
		else if (MISC::GET_GAME_TIMER() - uParam1->f_3) > func_185(uParam1)
		{
			fVar3 = func_183(uParam1);
...
int func_135(int iParam0, bool bParam1, int iParam2, bool bParam3)
{
	...
	{
		return func_187(bParam1, iParam2, bParam3);
	}
	if (Global_1572887->f_12 != -1)
	{
...
int func_138(var uParam0, int iParam1, var uParam2)
{
	...
	if (uParam2->f_12 < IntToFloat(func_189(uParam2)))
	{
		...
		switch (iVar3)
		{
			...
			case 2:
				if (EVENT::IS_SHOCKING_EVENT_IN_SPHERE(-966930978, vVar0, uParam2->f_22))
				{
					...
					if (func_191(iParam1, vVar0, vVar4))
					{
						func_180(uParam2, 1);
						return 1;
					}
		...
		switch (iVar3)
		{
			...
			case 2:
				if (EVENT::IS_SHOCKING_EVENT_IN_SPHERE(-966930978, vVar0, uParam2->f_22))
				{
					...
					if (func_191(iParam1, vVar0, vVar7))
					{
						func_180(uParam2, 1);
						return 1;
					}
...
int func_140(int iParam0, var uParam1)
{
	...
	{
		if (!func_176(iParam0, uParam1, &(Global_1935630->f_34[iVar0])) || iParam0 == &Global_1935630->f_34[iVar0])
		{
		}
		else
		{
			bVar13 = func_192(&(Global_1935630->f_34[iVar0]));
			...
			if (func_193(uParam1, iParam0, fVar1, bVar12, bVar13))
			{
				*(vVar2[0 /*3*/]) = { ENTITY::GET_ENTITY_COORDS(&(Global_1935630->f_34[iVar0]), false, false) };
				*(vVar2[1 /*3*/]) = { vVar9 };
				uParam1->f_10 = iParam0;
			...
			else if (func_194(uParam1, iParam0, fVar1, bVar12, bVar13))
			{
				*(vVar2[0 /*3*/]) = { ENTITY::GET_ENTITY_COORDS(&(Global_1935630->f_34[iVar0]), false, false) };
				*(vVar2[1 /*3*/]) = { vVar9 };
				uParam1->f_10 = iParam0;
			...
			else if (func_195(uParam1, iParam0, fVar1, iVar0))
			{
				*(vVar2[0 /*3*/]) = { ENTITY::GET_ENTITY_COORDS(&(Global_1935630->f_34[iVar0]), false, false) };
				*(vVar2[1 /*3*/]) = { vVar9 };
				uParam1->f_10 = iParam0;
...
int func_146(int iParam0, int iParam1)
{
	if (!ENTITY::IS_ENTITY_DEAD(iParam1))
	{
		...
		if (func_199(iParam0, iParam1, 1, 1) < 4f)
		{
...
int func_148(var uParam0, int iParam1)
{
	...
	if (iVar0 != 0 && !VEHICLE::IS_THIS_MODEL_A_TRAIN(ENTITY::GET_ENTITY_MODEL(iVar0)))
	{
		...
		if (func_200(iVar0, iParam1, vVar1))
		{
...
int func_151(var uParam0, int iParam1)
{
	...
	fVar0 = func_178(uParam0);
	if (uParam0->f_12 > func_202(uParam0) && uParam0->f_12 > fVar0)
	{
		return 0;
	}
	iVar2 = func_203(iParam1);
	iVar1 = func_204(uParam0->f_14);
...
int func_152(int iParam0, int iParam1, var uParam2)
{
	...
	return func_205(iParam0, iParam1, bVar0, bVar2, uParam2->f_12, bVar1);
}
	...
	switch (iVar1)
	{
		...
		case -1601932249:
			...
			if (PED::_0x06087579E7AA85A9(iParam0, iVar4, -1f, -1f, -1f, -1f) && PED::_0x06087579E7AA85A9(iParam0, Global_35, -1f, -1f, -1f, -1f))
			{
				...
				{
					if (!func_207(uParam1, iParam0))
					{
						if (func_201(iVar4, Global_36, 1) < 7f)
						{
							return 1;
						}
					}
...
int func_157(int iParam0, var uParam1)
{
	...
	else if (func_149() - uParam1->f_4) > func_209(uParam1)
	{
		return func_210(iParam0, uParam1, 0, -1082130432);
	}
	return 0;
}
...
void func_159(int iParam0, int iParam1, int iParam2, int iParam3, int iParam4, int iParam5, bool bParam6, int iParam7)
{
	int iVar0;
...
{
	return func_199(iParam0, iParam1, 1, 1);
}
...
int func_182(int iParam0, bool bParam1, bool bParam2, bool bParam3, int iParam4, int iParam5)
{
	int iVar0;
	int iVar1;
	int iVar2;
	...
	if (bParam3)
	{
		if (((WEAPON::_0xCB690F680A3EA971(iVar0, 1) && PLAYER::IS_PLAYER_TARGETTING_ENTITY(iVar1, iParam0, iParam5)) && PLAYER::IS_PLAYER_FREE_AIMING_AT_ENTITY(iVar1, iParam0)) && func_199(iVar0, iParam0, 1, 1) <= 4f)
		{
			return 1;
		}
	}
	...
	{
		if (WEAPON::_0x6AD66548840472E5(func_218(iVar0, 0)))
		{
			if (func_219(iParam0, 0.4f, 0.6f, 0.3f, 0.7f))
			{
				return 1;
			}
		}
...
int func_184(var uParam0, int iParam1, float fParam2, float fParam3)
{
	float fVar0;
...
int func_186(int iParam0, bool bParam1, bool bParam2, bool bParam3, int iParam4)
{
	int iVar0;
	int iVar1;
	...
	if (PLAYER::IS_PLAYER_FREE_AIMING(iVar1))
	{
		if (WEAPON::_0x6AD66548840472E5(func_218(iVar0, 0)))
		{
			if (func_220(ENTITY::GET_ENTITY_COORDS(iParam0, true, false), 0.4f, 0.6f, 0.3f, 0.7f))
			{
				return 1;
			}
		}
...
int func_187(bool bParam0, var uParam1, var uParam2)
{
...
int func_191(int iParam0, vector3 vParam1, vector3 vParam4)
{
	if (func_221(iParam0, vParam4, 0.5f))
	{
...
int func_195(var uParam0, int iParam1, float fParam2, int iParam3)
{
	float fVar0;
...
int func_197(int iParam0, int iParam1)
{
	...
	if (func_224(iParam0, 1, 0, 0) != 2055893578)
	{
		return 0;
	}
...
float func_199(int iParam0, int iParam1, bool bParam2, int iParam3)
{
...
int func_200(int iParam0, int iParam1, vector3 vParam2)
{
	float fVar0;
	
	fVar0 = func_201(iParam0, vParam2, 1);
	if (fVar0 < 4f)
	{
...
int func_205(int iParam0, int iParam1, bool bParam2, bool bParam3, float fParam4, bool bParam5)
{
	bool bVar0;
	int iVar1;
	float fVar2;
	...
	if (fParam4 <= 0f)
	{
		fVar2 = func_199(iParam0, PLAYER::PLAYER_PED_ID(), 0, 1);
	}
	else
	{
		fVar2 = fParam4;
	...
	if (bVar0)
	{
		if (func_199(iParam0, Global_1935630->f_40, 0, 1) < 2.5f)
		{
...
int func_206(int iParam0, var uParam1, bool bParam2)
{
	int iVar0;
	int iVar1;
	...
	if (ENTITY::DOES_ENTITY_EXIST(iVar0))
	{
		if (iVar0 != iParam0)
		{
			if (PED::_0x06087579E7AA85A9(iParam0, Global_35, -1f, -1f, -1f, -1f))
			{
				if (ENTITY::HAS_ENTITY_CLEAR_LOS_TO_ENTITY(iParam0, Global_35, 17))
				{
					if (!bParam2 || !func_207(uParam1, iVar0))
					{
						return 1;
					}
				}
	...
	if (ENTITY::DOES_ENTITY_EXIST(iVar1))
	{
		if (iVar1 != iParam0)
		{
			...
			{
				if (!bParam2 || !func_207(uParam1, iVar1))
				{
					if (func_201(iVar1, Global_36, 1) < 5f)
					{
						return 1;
					}
				}
...
int func_208(int iParam0)
{
	...
	return func_226(((*Global_1347702)[58 /*49*/])->f_15, 1);
}
...
int func_210(int iParam0, var uParam1, bool bParam2, float fParam3)
{
	if (!bParam2)
	{
		if (uParam1->f_4 == 0)
...
int func_219(int iParam0, float fParam1, float fParam2, float fParam3, float fParam4)
{
	if (!ENTITY::IS_ENTITY_DEAD(iParam0))
	{
		if (func_220(ENTITY::GET_ENTITY_COORDS(iParam0, true, false), fParam1, fParam2, fParam3, fParam4))
		{
			return 1;
		}
	}
...
int func_220(vector3 vParam0, float fParam3, float fParam4, float fParam5, float fParam6)
{
	float fVar0;
	float fVar1;
	bool bVar2;
...
bool func_221(int iParam0, vector3 vParam1, float fParam4)
{
	vector3 vVar0;
	vector3 vVar3;
