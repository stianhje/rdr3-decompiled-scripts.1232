...
int func_72(var uParam0)
{
	...
	func_151(uParam0, 0.172701f, 4.05512f, 1.00882f, 0f, 1f, 1f, 2.75f, -1612834106, 211687389, 1, 1, 1);
	func_151(uParam0, 1.16504f, -2.50478f, 1.1337f, 14f, 1f, 1f, 4f, -1612834106, 211687389, 1, 1, 1);
	func_151(uParam0, 0.88f, -1.44f, 0f, 65f, 2.765f, 1.745f, 4f, -1612834106, -1377448058, 1, 1, 1);
	func_152(uParam0, 1.272f, -1.52794f, 1.10083f, -7f, 1f, 1.6f, 4f, 665633627, 1);
	func_153(uParam0, -1671495534, 0f, 0f, 0f, "CIGARETTE", 0, 1, 1);
	func_153(uParam0, 1230724566, 0.07143f, -1.04836f, 0.151794f, "CRATE", 1, 0, 1);
	iLocal_16 = func_153(uParam0, 1210783447, 0f, 0f, 0f, "BOOK", 0, 0, 1);
	func_154(uParam0, iLocal_14, 3, -22664287, "WORLD_HUMAN_SMOKE_MALE_C", -1, 1);
	func_155(uParam0, iLocal_14, 4, 1, 0, 0, 0);
	func_154(uParam0, iLocal_15, 3, -716577201, "WORLD_HUMAN_SIT_GROUND_READING_BOOK_FEMALE_A", -1, 1);
	func_156(uParam0, iLocal_15, 2, -716577201, "WORLD_HUMAN_SIT_GROUND_READING_BOOK_FEMALE_A", -1, 1, -1073741824, 1065353216, 1);
	func_157(uParam0, iLocal_15, iLocal_16, "p_cs_book04x_PH_R_HAND", 0, 0);
	func_155(uParam0, iLocal_15, 4, 2, 0, 0, 0);
	func_158(uParam0, "script@vignette@kieran_13@base", 1, 1, 0, 0);
	func_158(uParam0, "script@vignette@kieran_13@action", 0, 0, 1, 0);
...
int func_380(int iParam0, bool bParam1, bool bParam2, var uParam3, var uParam4, var uParam5, float fParam6, bool bParam7, bool bParam8, bool bParam9, bool bParam10)
{
	...
	switch (((*Global_1360165)[iParam0 /*1157*/])->f_70.f_12)
	{
		...
		case 3:
			...
			sVar12 = func_415(iParam0, func_279());
