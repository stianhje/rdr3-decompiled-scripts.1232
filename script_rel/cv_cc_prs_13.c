...
int func_72(var uParam0)
{
	...
	uLocal_18 = func_153(uParam0, "script@vignette@pearson_13@action_b_alt_backright", 0, 0, 0, 1);
	uLocal_19 = func_153(uParam0, "script@vignette@pearson_13@action_b_alt_backleft", 0, 0, 0, 1);
	uLocal_20 = func_153(uParam0, "script@vignette@pearson_13@action_b_alt_front", 0, 0, 0, 1);
	uLocal_21 = func_153(uParam0, "script@vignette@pearson_13@action_b_alt_left", 0, 0, 0, 1);
	uLocal_22 = func_153(uParam0, "script@vignette@pearson_13@action_b_alt_discovered", 0, 0, 0, 1);
	uLocal_23 = func_153(uParam0, "script@vignette@pearson_13@action_b_alt_undiscovered", 0, 0, 0, 1);
...
int func_390(var uParam0, int iParam1)
{
	...
	while (iVar2 <= iVar1)
	{
		...
		else
		{
			...
			vVar13 = { func_424(ENTITY::GET_ENTITY_COORDS((uParam0->f_107[iParam1 /*113*/])->f_5, true, false), vVar3, 1065353216) };
