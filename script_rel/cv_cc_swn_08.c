...
int func_72(var uParam0)
{
	...
	uLocal_20 = func_152(uParam0, joaat("p_chairfolding02x"), -0.0286035f, 1.09429f, 0.00270844f, "CHAIR", 1, 0, 1);
	...
	func_159(uParam0, iLocal_19, 3, 1271499410, "PROP_HUMAN_SEAT_CHAIR_DESK_WRITING_MALE_A", uLocal_20, 0, -1073741824, 1065353216, 1);
...
{
	if (!iLocal_26 && func_198(uParam0, iLocal_14))
	{
