...
int func_31()
{
	...
	switch (Local_274.f_4)
	{
		...
		case 2:
			if (func_171(&uLocal_15, &(Local_274.f_34), &(uLocal_15.f_241), "COMBAT_FLEE", 1092616192))
			{
...
void func_75()
{
	...
	if (uLocal_15.f_19 < uLocal_15.f_215)
	{
		...
		if (ENTITY::DOES_ENTITY_EXIST(&(uLocal_15[iVar0])))
		{
			...
			{
				if (func_219(&(uLocal_15[iVar0]), 200f, -1082130432, &(uLocal_15.f_9[iVar0]), -1082130432))
				{
	...
	else if (uLocal_15.f_19 < (uLocal_15.f_215 + uLocal_15.f_216))
	{
		...
		if (ENTITY::DOES_ENTITY_EXIST(&(uLocal_15.f_40[iVar0])))
		{
			...
			{
				if (func_219(&(uLocal_15.f_40[iVar0]), 200f, -1082130432, -1082130432, -1082130432))
				{
	...
	else if (uLocal_15.f_19 < ((uLocal_15.f_215 + uLocal_15.f_216) + uLocal_15.f_217))
	{
		...
		if (ENTITY::DOES_ENTITY_EXIST(&(uLocal_15.f_49[iVar0])))
		{
			if (!func_226(&uLocal_15, iVar0, 8))
			{
				...
				{
					if (func_227(&(uLocal_15.f_49[iVar0]), 200f, -1082130432))
					{
...
void func_139()
{
	...
	if (!bVar2)
	{
		...
		{
			func_274(&Local_274, &(uLocal_15[0]), Global_35, "OPENS_FIRE", -1073741824, 1, 1744022339, 0);
			bVar2 = true;
		}
	}
	iVar0 = 0;
	while (iVar0 <= 4)
	{
		...
		else
		{
			...
			func_275(&uLocal_15, iVar0, 831283580, 0);
			if (!bVar2)
			{
				func_274(&Local_274, &(uLocal_15[iVar0]), Global_35, "OPENS_FIRE", -1073741824, 1, 1744022339, 0);
				bVar2 = true;
			}
		}
		iVar0++;
	...
	switch (Local_274.f_5)
	{
		...
		case 1:
			if (func_294())
			{
				...
				func_274(&Local_274, &(uLocal_15[iVar0]), Global_35, &cVar1, -1073741824, 1, -500314840, iVar9);
		...
		case 2:
			...
			{
				func_275(&uLocal_15, 0, 831283580, 0);
				func_296();
				func_297();
				func_187(Local_274.f_7[1 /*3*/]);
		...
		case 3:
			...
			if ((func_299(0f, 1, &(uLocal_15[1]), 1) && func_299(0f, 1, &(uLocal_15[0]), 1)) && func_299(-4f, 1, 0, 0))
			{
				...
				func_274(&Local_274, &(uLocal_15[1]), Global_35, "GANG_TAUNT_GEN", -1073741824, 1, -500314840, 2);
	...
	while (iVar0 <= 1)
	{
		if (func_61(&(uLocal_15[iVar0]), 0, 0))
		{
			...
			if (!bVar3)
			{
				...
				{
					func_274(&Local_274, &(uLocal_15[iVar0]), Global_35, "CALLOUT_GET_FLEEING_MALE", -1073741824, 1, 1744022339, 0);
					bVar3 = true;
				}
				else
				{
...
int func_170()
{
	...
	func_322(&uLocal_15, &Local_274, &sVar0, &uVar8);
	iVar10 = 2;
	while (iVar10 <= 4)
	{
		if (func_61(&(uLocal_15[iVar10]), 0, 0))
		{
			...
			if (!bVar9)
			{
				func_274(&Local_274, &(uLocal_15[iVar10]), Global_35, &sVar0, 100f, 1, 1744022339, 0);
				bVar9 = true;
			}
		}
		iVar10++;
...
void func_296()
{
	...
	func_275(&uLocal_15, 0, 831283580, 0);
	func_275(&uLocal_15, 1, 831283580, 0);
	func_240(&Local_274, 16);
}
...
void func_298()
{
	...
	while (iVar0 <= 4)
	{
		if (func_61(&(uLocal_15[iVar0]), 0, 1))
		{
			...
			{
				if (func_219(&(uLocal_15[iVar0]), 80f, 30f, &(uLocal_15.f_9[iVar0]), -1082130432))
				{
					func_275(&uLocal_15, iVar0, 831283580, 0);
				}
			}
