...
int func_11()
{
	iLocal_14 = VOLUME::_CREATE_VOLUME_CYLINDER(1621.408f, -369.203f, 77.527f, 0f, 0f, 0f, 55f, 50f, 20f);
	return 1;
}
...
void func_53(int iParam0, int iParam1, int iParam2)
{
	...
	(Global_1392240->f_1[iParam0 /*18*/])->f_6[iParam1] = func_94(iParam2, 0, 0);
}
...
void func_65(int iParam0, int iParam1, int iParam2, bool bParam3, int iParam4, int iParam5)
{
	...
	else if ((func_55(iParam0) && func_82(iParam0, 16777216)) && !Global_1894899->f_9)
	{
...
int func_92(int iParam0)
{
	...
	if (((!func_146(94) && !func_147(94)) && !func_146(95)) && !func_147(95))
	{
	}
	func_141(iParam0, 1);
	return 1;
...
char* func_103(int iParam0, int iParam1, int iParam2, int iParam3, var uParam4, var uParam5, var uParam6)
{
	...
	{
		sVar0 = func_153(Global_1894899->f_162);
	}
	if (MISC::IS_STRING_NULL_OR_EMPTY(sVar0) && uParam4)
	{
		sVar0 = func_155(func_154(Global_36));
	}
...
char* func_115(char* sParam0, int iParam1)
{
	...
	return func_158(MISC::_CREATE_VAR_STRING(10, "LITERAL_STRING", sParam0), iParam1);
}
...
int func_118(int iParam0)
{
	...
	if (func_159())
	{
		if (!func_160(((*Global_1835011)[3 /*74*/])->f_1, 1))
		{
...
{
	func_164((Global_1935369->f_5[iParam0 /*11*/])->f_6, 1);
	func_165((Global_1935369->f_5[iParam0 /*11*/])->f_6, 0);
...
void func_131(int iParam0)
{
	...
	{
		func_168((Global_1914319->f_3[iParam0 /*446*/])->f_21, 0, 1, 0, 0);
	}
	...
	func_169((Global_1914319->f_3[iParam0 /*446*/])->f_10, 0);
...
void func_143(int iParam0, int iParam1, vector3 vParam2, char* sParam5)
{
	int iVar0;
	int iVar1;

	iVar0 = func_178(vParam2);
	iVar1 = 0;
	while (iVar1 < Global_36307)
	{
		if ((func_179(iVar1) == iParam0 && func_180(iVar1) == iParam1) && func_181(iVar1) == iVar0)
		{
...
int func_152(int iParam0, bool bParam1, int iParam2)
{
	...
	if ((Global_1898164->f_1[0 /*5*/])->f_2 == 8)
	{
		...
		if (func_182(iVar0) && func_187(((*Global_1347702)[iVar0 /*49*/])->f_12, 131072))
		{
			return 0;
		}
	}
...
char* func_153(var uParam0, var uParam1, var uParam2, var uParam3, var uParam4, var uParam5, var uParam6, var uParam7)
{
...
int func_178(struct<2> Param0, var uParam2)
{
	int iVar0;
...
int func_189(vector3 vParam0, int iParam3)
{
	vector3 vVar0;
	struct<2> Var3;
	float fVar6;

	func_207(iParam3, &vVar0, &Var3, &fVar6);
	if (func_208(vParam0, vVar0, Var3, Var3.f_1, fVar6))
	{
		return 1;
	}
	return 0;
...
bool func_208(vector3 vParam0, vector3 vParam3, float fParam6, float fParam7, float fParam8)
{
	vector3 vVar0;
	struct<2> Var3;
	float fVar6;
