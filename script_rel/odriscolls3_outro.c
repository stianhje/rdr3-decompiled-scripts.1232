...
int func_26(var uParam0)
{
	...
	switch (iLocal_16)
	{
		...
		case 2:
			...
			ENTITY::_0x203BEFFDBE12E96A(Global_35, ENTITY::GET_ENTITY_COORDS(&(iLocal_17[0]), true, false) + Vector(-0.5f, 0f, 0f), (ENTITY::GET_ENTITY_HEADING(&(iLocal_17[0])) + 180f), 1, 0, 1);
			func_28(&uLocal_21, 1);
			iLocal_16 = 3;
			break;
		case 3:
...
void func_256(var uParam0, int iParam1, int iParam2, bool bParam3)
{
	int iVar0;
...
void func_313(int iParam0, int iParam1)
{
	...
	switch (iParam0)
	{
		case 11:
			...
			{
				func_240(iParam1, joaat("weapon_revolver_cattleman_sadie"), 0, 0, 2, 1, 0, 1056964608, 1065353216, -1, 0, 0, 0, 0);
				func_240(iParam1, joaat("weapon_revolver_cattleman_sadie_dualwield"), 0, 0, 3, 1, 1, 1056964608, 1065353216, -1, 0, 1, 0, 0);
			}
			break;
	}
}
