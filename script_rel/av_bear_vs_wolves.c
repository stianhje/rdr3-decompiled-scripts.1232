...
{
	func_33(uParam0, 11241/*func_30*/, 11330/*func_31*/, 12637/*func_32*/);
}
...
int func_30(var uParam0)
{
	...
	STREAMING::_0x19A6BE7D9C6884D3(2075717199, 1, -1124266369, 0);
	func_58(&uLocal_11, 0);
	func_59(&uLocal_11, 1);
	func_60(&uLocal_11, 1);
	func_61(&uLocal_11, 1);
							...
							if (!&uParam0->f_469[5])
							{
								if (ANIMSCENE::_0x005E6F28DD7ED58D(uParam0->f_3.f_1, (uParam0->f_20[2 /*14*/])->f_1))
								{
									if (ENTITY::HAS_ANIM_EVENT_FIRED(&(uParam0->f_20[2 /*14*/]), 811542464))
									{
										...
										PED::FORCE_PED_MOTION_STATE(&(uParam0->f_20[2 /*14*/]), -530524, false, 0, false);
										if (!ENTITY::IS_ENTITY_DEAD(&(uParam0->f_20[3 /*14*/])))
										{
