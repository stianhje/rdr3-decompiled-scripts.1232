...
{
	func_33(uParam0, 10853/*func_30*/, 10943/*func_31*/, 11512/*func_32*/);
}
...
void func_14(var uParam0, vector3 vParam1, vector3 vParam4)
{
	...
	{
		case 31:
			func_46(uParam0, "WHISPER_SIT", "script@ambient@town@WHISPER@SIT@action", vParam1, vParam4);
			break;
		case 32:
			func_46(uParam0, "WHISPER_STAND", "script@ambient@town@whisper@stand@action", vParam1, vParam4);
			uParam0->f_16 = 1;
			break;
	}
	switch (uParam0->f_489)
	{
		case 0:
			...
			iVar1 = func_48(func_47());
			break;
		case 1:
			iVar0 = joaat("a_m_m_sddockforeman_01");
			iVar1 = joaat("a_m_m_sddockworkers_02");
			break;
	}
	func_49(uParam0, 1, "pbl_action", "", 0);
	func_50(uParam0, 0, "MALE_A", iVar0, 0f, 0f, 0f, 0f, 1, 1, 1, 1, 41788943, 1);
	func_50(uParam0, 1, "MALE_B", iVar1, 0f, 0f, 0f, 0f, 1, 1, 1, 1, 41788943, 1);
}
...
int func_30(var uParam0)
{
	if (*uParam0 == 31)
	{
		func_59(1858605558, 1, 0, 43618282);
	}
	func_60(&uLocal_9, 0);
	func_61(&uLocal_9, 1);
	func_62(&uLocal_9, 1);
...
int func_31(var uParam0)
{
	...
	if (&uParam0->f_469[2])
	{
		if (!&uParam0->f_469[7])
		{
			if (func_72(uParam0, 1.1f, 1116471296, 4, -91962372, 1))
			{
				func_70(*uParam0, uParam0->f_483, 0);
				uParam0->f_469[7] = 1;
			}
	...
	if (&uParam0->f_469[2])
	{
		...
		if (ANIMSCENE::_0x005E6F28DD7ED58D(uParam0->f_3.f_1, (uParam0->f_20[1 /*14*/])->f_1))
		{
			...
			{
				func_73(&(uParam0->f_20[1 /*14*/]), 1858605558, 60000, 0, 43618282, -1082130432);
...
bool func_55()
{
	return (Global_1894899 & 1 != 0 && func_47() != -1);
}
...
void func_68(var uParam0)
{
	...
	while (iVar0 < 2)
	{
		...
		{
			TASK::CLEAR_PED_TASKS(&(uParam0->f_20[iVar0 /*14*/]), 1, 0);
			TASK::TASK_SMART_FLEE_PED(&(uParam0->f_20[iVar0 /*14*/]), Global_35, -1f, -1, 0, 3f, 0);
