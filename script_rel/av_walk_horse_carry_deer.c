...
var func_1(int iParam0, int iParam1)
{
	switch (iParam0)
	{
		case 997958153:
	...
	switch (iLocal_9)
	{
		case 0:
			...
			if (!ENTITY::IS_ENTITY_DEAD(&(uParam0->f_20[1 /*14*/])))
			{
				...
				WEAPON::_GIVE_WEAPON_TO_PED_2(&(uParam0->f_20[1 /*14*/]), joaat("weapon_repeater_carbine"), 999, bLocal_72, true, 0, false, 0.5f, 1f, 752097756, false, 0f, false);
...
int func_203(int iParam0, int iParam1)
{
	...
	if (func_249(iParam0, 1, 0, 0) != joaat("weapon_lasso"))
	{
		return 0;
	}
...
struct<5> func_222(var uParam0)
{
	struct<5> Var0;

	Var0 = { func_223(uParam0, 1328661203, func_253(), -1591664384) };
	Var0.f_4 = 1084182731;
	return Var0;
}

struct<4> func_223(var uParam0, int iParam1, var uParam2, var uParam3, var uParam4, var uParam5, int iParam6)
{
	struct<4> Var0;
