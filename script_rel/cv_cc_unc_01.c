...
int func_72(var uParam0)
{
	...
	func_151(uParam0, -2.4573f, -0.9856f, 0.0289f, 100.97f, 1.5f, 1.9f, 3f, -1612834106, 1877049591, 1, 1, 1);
	func_152(uParam0, joaat("p_bottlejd01x"), -2.486f, -1.599f, 0f, 0, 0, 0, 1);
	func_153(uParam0, "script@vignette@uncle_1@base", 1, 1, 0, 0);
	iLocal_15 = func_153(uParam0, "script@vignette@uncle_1@action", 2, 0, 1, 1);
	iLocal_16 = func_153(uParam0, "script@vignette@uncle_1@idle", 2, 0, 0, 0);
	iLocal_17 = func_153(uParam0, "script@vignette@uncle_1@exit_stand", 0, 0, 0, 0);
	Local_18 = { func_154(uParam0, -2.4332f, -1.0036f, 0.6719f, 101.3764f, 7.5f, 0.75f, 0.75f) };
	func_155(uParam0, "CUN1AUD");
	func_156(uParam0, -1030553162, -374224278);
...
{
	return func_191(uParam0, Local_18, 1, 0);
}
...
struct<10> func_154(var uParam0, vector3 vParam1, float fParam4, float fParam5, float fParam6, float fParam7)
{
	float fVar0;
	float fVar1;
	struct<10> Var2;
...
int func_190(var uParam0, int iParam1, bool bParam2)
{
	...
	if (bParam2)
	{
		...
		while (iVar1 < uParam0->f_1984)
		{
			...
			else if (func_199(uParam0, iVar1) || func_200(uParam0, iVar1))
			{
