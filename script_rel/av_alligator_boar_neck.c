...
{
	func_33(uParam0, 10828/*func_30*/, 10886/*func_31*/, 11576/*func_32*/);
}
...
{
	func_46(uParam0, "GATOR_BOAR_NECK", "script@ambient@animal@alligator_ambush_boar_neck@action", vParam1, vParam4);
	func_47(uParam0, 1, "pbl_action", "", 0);
	func_48(uParam0, 0, "alligator", iLocal_9, 0f, 0f, 0f, 0f, 1, 1, 1, 1, 41788943, 0);
	func_48(uParam0, 1, "BOAR", iLocal_10, 0f, 0f, 0f, 0f, 1, 1, 1, 1, 41788943, 0);
}
...
int func_31(var uParam0)
{
	...
	if (!&uParam0->f_469[0])
	{
		if (!bLocal_39)
		{
			if (func_64(uParam0, &uLocal_11, 1) || func_65(Global_35, uParam0->f_483, 1) < 225f)
			{
				bLocal_39 = true;
			}
		}
	...
	if (!&uParam0->f_469[0] && !bLocal_39)
	{
		...
		if (&uParam0->f_469[2])
		{
			if (!&uParam0->f_469[5])
			{
				if (func_73(uParam0, 2f, 1116471296, 4, -91962372, 1))
				{
					func_66(*uParam0, uParam0->f_483, 1);
					uParam0->f_469[5] = 1;
				}
...
void func_70(var uParam0)
{
	if (!ENTITY::IS_ENTITY_DEAD(&(uParam0->f_20[1 /*14*/])))
	{
		if (ENTITY::HAS_ANIM_EVENT_FIRED(&(uParam0->f_20[1 /*14*/]), 1899357633))
		{
			PED::SET_PED_TO_RAGDOLL(&(uParam0->f_20[1 /*14*/]), 2000, 2000, 0, false, false, false);
			func_109(&(uParam0->f_20[1 /*14*/]), 0, 0);
		}
...
void func_105(int iParam0, vector3 vParam1)
{
	int iVar0;
	int iVar1;
