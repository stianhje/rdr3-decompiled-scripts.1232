...
int func_1(var uParam0)
{
	...
	while (iVar0 < 3)
	{
		ENTITY::_0xD2B9C78537ED5759(&(iLocal_28[iVar0]));
		iVar0++;
	}
	return 1;
}
...
int func_72(var uParam0)
{
	...
	func_151(uParam0, -0.4266f, -0.9593f, 0.5026f, -22.5144f, 1.2f, 1.2f, 3f, -1612834106, -2087487524, 1, 1, 1);
	func_151(uParam0, -1.1439f, 0.6703f, 0.5028f, -125.6407f, 1.2f, 1.2f, 3f, -1612834106, 1418411488, 1, 1, 1);
	func_151(uParam0, 0.5733f, 1.1645f, 0.4966f, 155.6634f, 1.2f, 1.2f, 3f, -1612834106, -676766751, 1, 1, 1);
	uLocal_19 = func_152(uParam0, 264425748, -0.584518f, -1.37169f, -0.000602722f, 0, 1, 0, 1);
	uLocal_20 = func_152(uParam0, -1618805595, -1.28888f, 0.763515f, -0.000335693f, 0, 1, 0, 1);
	uLocal_21 = func_152(uParam0, 1504738597, 0.636307f, 1.3249f, -0.00391388f, 0, 1, 0, 1);
	iLocal_22 = func_152(uParam0, -1971689092, 0f, 0f, 0f, "BOTTLE", 0, 0, 1);
	iLocal_23 = func_152(uParam0, -1971689092, 0f, 0f, 0f, "BOTTLE^2", 0, 0, 1);
	func_152(uParam0, 1843407141, 0f, 0f, 0f, "BOTTLE^1", 0, 0, 1);
	func_153(uParam0, "script@vignette@bill_13@base", 1, 1, 0, 0);
	uLocal_18 = func_153(uParam0, "script@vignette@bill_13@action", 0, 0, 1, 0);
	func_154(uParam0, "CBL13AU");
	func_155(uParam0, -358249437, -515876631);
	func_156(uParam0, uLocal_18, -1, 0.97f);
	func_157(uParam0, iLocal_15, 3, -120888770, "PROP_HUMAN_SEAT_CHAIR_TABLE_DRINKING_BADASS_MALE_D", uLocal_19, 0);
	func_157(uParam0, iLocal_16, 3, -120888770, "PROP_HUMAN_SEAT_CHAIR_TABLE_DRINKING_BADASS_MALE_D", uLocal_20, 0);
	func_157(uParam0, iLocal_17, 3, -120888770, "PROP_HUMAN_SEAT_CHAIR_TABLE_DRINKING_BADASS_MALE_A", uLocal_21, 0);
	func_158(uParam0, iLocal_15, 3, -120888770, "PROP_HUMAN_SEAT_CHAIR_TABLE_DRINKING_BADASS_MALE_D", uLocal_19, 0, -1073741824, 1065353216, 1);
	...
	func_158(uParam0, iLocal_16, 3, -120888770, "PROP_HUMAN_SEAT_CHAIR_TABLE_DRINKING_BADASS_MALE_D", uLocal_20, 0, -1073741824, 1065353216, 1);
	func_159(uParam0, iLocal_16, iLocal_23, "p_bottleJD01x_ph_r_hand", 0, 0);
	func_161(uParam0, iLocal_17, 1, -1);
	STREAMING::_0x19A6BE7D9C6884D3(-120888770, 1, 0, 0);
	return 1;
}
...
{
	if (!func_169(func_148(uParam0)))
	{
		return false;
	}
	return STREAMING::_0x9427C94D2E4094A4(-120888770, 0);
}
...
int func_169(int iParam0)
{
	...
	switch (iLocal_14)
	{
		case 0:
			...
			iLocal_32[0] = 1504738597;
			iLocal_32[1] = -1618805595;
			iLocal_32[2] = 264425748;
			iVar0 = 0;
			while (iVar0 < 3)
			{
		...
		case 1:
			...
			while (iVar0 < 3)
			{
				...
				{
					if (&iLocal_28[iVar0] == 0)
					{
						iLocal_28[iVar0] = ENTITY::_0x6F3068258A499E52(&(iLocal_32[iVar0]), *(vLocal_36[iVar0 /*3*/]), 15);
					}
					else if (ENTITY::_0x1FF441D7954F8709(&(iLocal_28[iVar0])))
					{
						iLocal_24[iVar0] = ENTITY::GET_OBJECT_INDEX_FROM_ENTITY_INDEX(ENTITY::_0x4735E2A4BB83D9DA(&(iLocal_28[iVar0])));
						if (ENTITY::DOES_ENTITY_EXIST(&(iLocal_24[iVar0])))
						{
...
int func_383(int iParam0, bool bParam1, bool bParam2, var uParam3, var uParam4, var uParam5, float fParam6, bool bParam7, bool bParam8, bool bParam9, bool bParam10)
{
	...
	switch (((*Global_1360165)[iParam0 /*1157*/])->f_70.f_12)
	{
		...
		case 3:
			...
			sVar12 = func_418(iParam0, func_281());
		...
		case 7:
			switch (iParam0)
			{
				...
				case 14:
					...
					break;
				case 4:
					if (func_322(747937920, 1) && !func_386(((*Global_1347702)[1 /*49*/])->f_15, 1))
					{
						iVar1[0] = -1155031950;
					}
					else
...
void func_441(int iParam0, int iParam1, bool bParam2)
{
	...
	if ((Global_40.f_4942[iParam0 /*60*/])->f_5 & 65536 > 0 && func_401(iParam1, -972364774))
	{
