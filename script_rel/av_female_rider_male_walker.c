...
{
	func_34(uParam0, 11381/*func_31*/, 11453/*func_32*/, 12734/*func_33*/);
}
		...
		case 0:
			if (!ENTITY::IS_ENTITY_DEAD(&(uParam0->f_20[0 /*14*/])))
			{
				if (*uParam0 != 56)
				{
					...
					PED::SET_PED_AS_GROUP_LEADER(&(uParam0->f_20[0 /*14*/]), iLocal_56, 0);
				...
				WEAPON::_GIVE_WEAPON_TO_PED_2(&(uParam0->f_20[0 /*14*/]), 379542007, 500, false, true, 0, false, 0.5f, 1f, 752097756, false, 0f, false);
				if (*uParam0 == 42)
				{
			...
			if (!ENTITY::IS_ENTITY_DEAD(&(uParam0->f_20[1 /*14*/])))
			{
				...
				if (*uParam0 != 56)
				{
					...
					WEAPON::_GIVE_WEAPON_TO_PED_2(&(uParam0->f_20[1 /*14*/]), 379542007, 500, false, true, 0, false, 0.5f, 1f, 752097756, false, 0f, false);
...
void func_74(int iParam0, vector3 vParam1, float fParam4, int iParam5, int iParam6)
{
	...
	if (func_124(iParam5, 2))
	{
		...
		{
			ENTITY::_0x203BEFFDBE12E96A(iParam0, vParam1, fParam4, 1, func_124(iParam5, 32), 1);
		}
		else
		{
			ENTITY::_0x203BEFFDBE12E96A(iParam0, vParam1, fParam4, 1, func_124(iParam5, 32), 1);
	...
	if (func_116(&uLocal_44, 2.5f))
	{
		switch (iLocal_54)
		{
			...
			case 1:
				if (*uParam0 != 42)
				{
					func_132(&(uParam0->f_20[0 /*14*/]), &(uParam0->f_20[1 /*14*/]), "HOWS_IT_GOING", 0, -1082130432, 1, 0, 0, 1, 1, 1, -417894478, 1, 0, 0);
				}
				else
				{
					func_132(&(uParam0->f_20[0 /*14*/]), &(uParam0->f_20[1 /*14*/]), "CHAT_RESPONSE_A", 0, -1082130432, 0, 0, 0, 1, 1, 1, -417894478, 1, 0, 0);
				}
			...
			case 2:
				if (*uParam0 != 42)
				{
					func_132(&(uParam0->f_20[1 /*14*/]), &(uParam0->f_20[0 /*14*/]), "GOING_WELL", 0, -1082130432, 1, 0, 0, 1, 1, 1, -417894478, 1, 0, 0);
				}
				else
				{
					func_132(&(uParam0->f_20[1 /*14*/]), &(uParam0->f_20[0 /*14*/]), "RESPONSE_A", 0, -1082130432, 0, 0, 0, 1, 1, 1, -417894478, 1, 0, 0);
				}
			...
			case 3:
				if (*uParam0 == 42)
				{
					func_132(&(uParam0->f_20[1 /*14*/]), &(uParam0->f_20[0 /*14*/]), "CONVO_TAIL_OFF", 0, -1082130432, 0, 0, 0, 1, 1, 1, -417894478, 1, 0, 0);
					iLocal_55 = &uParam0->f_20[1 /*14*/];
				}
				else
				{
					func_132(&(uParam0->f_20[0 /*14*/]), &(uParam0->f_20[1 /*14*/]), "GLAD_TO_HEAR_THAT", 0, -1082130432, 1, 0, 0, 1, 1, 1, -417894478, 1, 0, 0);
					iLocal_55 = &uParam0->f_20[0 /*14*/];
				}
				iLocal_54++;
				func_78(&uLocal_44);
...
int func_82(int iParam0, int iParam1, float fParam2)
{
	...
	return func_39(iParam0, vVar0, fParam2);
}
		...
		switch (iLocal_54)
		{
			case 4:
				if (!AUDIO::IS_ANY_SPEECH_PLAYING(Global_35))
				{
					...
					{
						func_132(&(uParam0->f_20[1 /*14*/]), &(uParam0->f_20[0 /*14*/]), "CHAT_GOOD_WEATHER", 0, -1082130432, 0, 0, 0, 1, 1, 1, -417894478, 1, 0, 0);
					}
					else
					{
						func_132(&(uParam0->f_20[1 /*14*/]), &(uParam0->f_20[0 /*14*/]), "CHAT_BAD_WEATHER", 0, -1082130432, 0, 0, 0, 1, 1, 1, -417894478, 1, 0, 0);
					}
					iLocal_55 = &uParam0->f_20[1 /*14*/];
					iLocal_54++;
					func_78(&uLocal_44);
			...
			case 5:
				if (!func_135(func_134()))
				{
					func_132(&(uParam0->f_20[0 /*14*/]), &(uParam0->f_20[1 /*14*/]), "RESPONSE_GOOD_WEATHER", 0, -1082130432, 0, 0, 0, 1, 1, 1, -417894478, 1, 0, 0);
				}
				else
				{
					func_132(&(uParam0->f_20[0 /*14*/]), &(uParam0->f_20[1 /*14*/]), "RESPONSE_BAD_WEATHER", 0, -1082130432, 0, 0, 0, 1, 1, 1, -417894478, 1, 0, 0);
				}
				iLocal_55 = &uParam0->f_20[0 /*14*/];
				iLocal_54++;
				func_78(&uLocal_44);
...
int func_131(float fParam0, int iParam1, int iParam2, int iParam3)
{
...
bool func_132(int iParam0, int iParam1, char* sParam2, int iParam3, float fParam4, int iParam5, bool bParam6, int iParam7, int iParam8, bool bParam9, int iParam10, int iParam11, bool bParam12, bool bParam13, int iParam14)
{
	return func_190(iParam0, iParam1, sParam2, iParam3, fParam4, iParam5, bParam6, iParam7, iParam8, bParam9, iParam10, iParam11, 0, bParam12, bParam13, iParam14) >= 0;
}
...
int func_162(int iParam0, bool bParam1, int iParam2, bool bParam3)
{
	...
	{
		return func_212(bParam1, iParam2, bParam3);
	}
	if (Global_1572887->f_12 != -1)
	{
...
int func_190(int iParam0, int iParam1, char* sParam2, var uParam3, float fParam4, var uParam5, bool bParam6, var uParam7, var uParam8, bool bParam9, var uParam10, int iParam11, bool bParam12, bool bParam13, bool bParam14, var uParam15)
{
	bool bVar0;
	float fVar1;
	int iVar2;
	...
	if ((!ENTITY::IS_ENTITY_DEAD(iParam0) || iParam11 == 1718175949) || bParam9 == 0)
	{
		...
		if (((bVar0 || uParam7) || fVar1 < fParam4) || bParam9 == 0)
		{
			...
			{
				iVar2 = func_137(func_241(iParam0, sParam2, iParam11, iParam1, NETWORK::NETWORK_IS_GAME_IN_PROGRESS(), 0, uParam5, uParam15), 1, -1);
			}
			if (iVar2 >= 0)
			{
			}
...
float func_239(int iParam0, bool bParam1, int iParam2)
{
...
bool func_241(int iParam0, char* sParam1, int iParam2, int iParam3, bool bParam4, int iParam5, var uParam6, var uParam7)
{
	struct<7> Var0;
...
int func_252(int iParam0, int iParam1, bool bParam2, int iParam3)
{
