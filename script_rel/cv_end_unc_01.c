...
int func_93(var uParam0)
{
	...
	if (ANIMSCENE::_0x005E6F28DD7ED58D(&(uParam0->f_1984[iLocal_18]), "SHEEP"))
	{
		...
		TASK::TASK_START_SCENARIO_AT_POSITION(0, 1923438725, -1608.52f, -1419.41f, 80.95f, 44.308f, 30000, 1, 0, 0, -1082130432, 0);
...
int func_95(var uParam0)
{
	...
	if (PED::_0x34D6AC1157C8226C(func_8(uParam0, iLocal_14), 1923438725) && TASK::IS_PED_ACTIVE_IN_SCENARIO(func_8(uParam0, iLocal_14), 0))
	{
