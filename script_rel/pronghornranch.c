...
void __EntryFunction__()
{
	...
	while (func_3())
	{
		if (MISC::GET_GAME_TIMER() > iLocal_227)
		{
			iLocal_227 = 0;
			...
			switch (iLocal_226)
			{
				...
				case 1:
					...
					LAW::_0x9BBDCB8DF789EBC1(PLAYER::PLAYER_ID(), func_9(iLocal_228));
					...
					Global_1897950 = -1;
					iLocal_229 = (MISC::GET_GAME_TIMER() + iLocal_225);
					iLocal_226 = 2;
					break;
				case 2:
					if (func_11() || iLocal_229 < MISC::GET_GAME_TIMER())
					{
						func_12(iLocal_228);
						iLocal_229 = (MISC::GET_GAME_TIMER() + iLocal_225);
						iLocal_226 = 3;
					...
					break;
				case 3:
					if (func_13(iLocal_228) || iLocal_229 < MISC::GET_GAME_TIMER())
					{
						func_14(iLocal_228);
						iLocal_229 = (MISC::GET_GAME_TIMER() + iLocal_225);
						iLocal_226 = 4;
					...
					break;
				case 4:
					if (func_15(iLocal_228) || iLocal_229 < MISC::GET_GAME_TIMER())
					{
						func_16(iLocal_228);
						iLocal_229 = (iLocal_225 + MISC::GET_GAME_TIMER());
						iLocal_226 = 6;
					}
					break;
				case 6:
					if (func_7(func_6(iLocal_228)))
					{
						if (func_17(func_6(iLocal_228), 4) && !iLocal_229 < MISC::GET_GAME_TIMER())
						{
						}
						else
						{
							if (func_18(iLocal_228) || iLocal_229 < MISC::GET_GAME_TIMER())
							{
							...
							Jump @788; //curOff = 456
							if (iLocal_229 < MISC::GET_GAME_TIMER() || (func_20() != 0 || Global_1051260->f_3790))
							{
								func_21(iLocal_228);
								func_22();
								if (!func_23(2057, 0))
							...
							{
								iLocal_227 = (1000 + MISC::GET_GAME_TIMER());
							}
							...
							PATHFIND::SET_AMBIENT_PED_RANGE_MULTIPLIER_THIS_FRAME(((*Global_1888801)[iLocal_228 /*35*/])->f_10);
							if (((*Global_1888801)[iLocal_228 /*35*/])->f_11 > 0f)
							{
								PED::_0xA77FA7BE9312F8C0(((*Global_1888801)[iLocal_228 /*35*/])->f_11);
							}
							Jump @788; //curOff = 769
							func_42(iVar0);
							iVar0++;
						}
						if (((*Global_1888801)[iLocal_228 /*35*/])->f_12 == 0)
						{
						}
						else
						{
							PED::_0x95423627A9CA598E(((*Global_1888801)[iLocal_228 /*35*/])->f_12);
						}
						BUILTIN::WAIT(0);
						iVar0 = 0;
						while (!func_42(iVar0))
...
int func_11()
{
	...
	iLocal_221 = ((*Global_1888801)[22 /*35*/])->f_4;
	VOLUME::_0xB469CFD9E065EB99(iLocal_221, 5);
	return 1;
}
...
int func_38(int iParam0)
{
	...
	if (func_20() == -1)
	{
		if ((ENTITY::DOES_ENTITY_EXIST(Global_35) && !ENTITY::IS_ENTITY_DEAD(Global_35)) && MISC::GET_DISTANCE_BETWEEN_COORDS(ENTITY::GET_ENTITY_COORDS(Global_35, false, false), func_60(), true) <= 100f)
		{
...
void func_46()
{
	...
	if (!func_92(((*Global_1835011)[67 /*74*/])->f_1, 1))
	{
		return;
	}
	iLocal_222 = VOLUME::_CREATE_VOLUME_AGGREGATE_WITH_CUSTOM_NAME("PronghornRanch volCampAreas[CVA_SURROUNDING]");
	iLocal_223 = VOLUME::_CREATE_VOLUME_AGGREGATE_WITH_CUSTOM_NAME("PronghornRanch volCampAreas[CVA_OUTER]");
...
int func_63(var uParam0, int iParam1, var uParam2, int iParam3, int iParam4, char* sParam5, int iParam6, int iParam7, bool bParam8)
{
	int iVar0;
	vector3 vVar1;
	...
	if (!VOLUME::_0x92A78D0BEDB332A3(func_112(iParam3)))
	{
		return 0;
	}
	if (!ENTITY::IS_ENTITY_IN_VOLUME(Global_35, func_112(iParam3), true, 0))
	{
		return 0;
	}
	if (bParam8)
	...
	if ((iParam6 && func_115(128, 0, 1)) && !iParam1 == 64)
	{
		return 0;
	}
	if (iParam7 && func_116(PLAYER::GET_PLAYER_INDEX(), 1, 1, 1))
	{
		return 0;
	}
	uParam0->f_1 = iParam1;
...
int func_66()
{
	...
	if (VOLUME::_0x92A78D0BEDB332A3(iLocal_223) && VOLUME::_0xF256A75210C5C0EB(iLocal_223, Global_36))
	{
...
bool func_71(int iParam0)
{
	...
	return ((((*Global_1888801)[iParam0 /*35*/])->f_20 == 1 || ((*Global_1888801)[iParam0 /*35*/])->f_20 == 2) && !func_126(iParam0));
}
...
void func_74(int iParam0, int iParam1, int iParam2, bool bParam3, int iParam4, int iParam5)
{
	...
	sVar1 = func_128(iParam0, iParam1, iParam2, iParam4, iParam5, bParam3, &uVar0);
	...
	else
	{
		...
		if (!MISC::_SHOULD_USE_24_HOUR_CLOCK())
		{
			...
			sVar2 = MISC::_CREATE_VAR_STRING(674, sVar8, iVar4, func_140(&sVar6, 109029619), sVar9, func_140(&sVar10, 109029619));
		}
		else
		{
			...
			IntToString(&sVar10, BUILTIN::ROUND(fVar7), 8);
			sVar2 = MISC::_CREATE_VAR_STRING(162, sVar8, iVar4, func_140(&sVar6, 109029619), func_140(&sVar10, 109029619));
		}
...
void func_89(int iParam0)
{
	...
	while (iVar1 < 4)
	{
		func_161(&((Global_1392240->f_1[iVar0 /*18*/])->f_6[iVar1]));
...
void func_93(int iParam0, vector3 vParam1, vector3 vParam4, vector3 vParam7, int iParam10)
{
	...
	if (*iParam0 != 0 && VOLUME::_0x92A78D0BEDB332A3(*iParam0))
	{
		uVar0 = func_165((vParam7.x - 4f), 0.1f);
		uVar1 = func_165((vParam7.y - 4f), 0.1f);
		vVar2 = { uVar0, uVar1, vParam7.z };
		iVar5 = VOLUME::_CREATE_VOLUME_BY_HASH(iParam10, vParam1, vParam4, vVar2);
		VOLUME::_0x6E0D3C3F828DA773(*iParam0, iVar5);
	}
}
...
void func_94(int iParam0, vector3 vParam1, vector3 vParam4, vector3 vParam7, int iParam10)
{
	...
	VOLUME::_0x6E0D3C3F828DA773(*iParam0, iVar0);
	func_166(&iVar1, vParam1, vParam4, vParam7, 6, iParam10, 0, 1);
	VOLUME::_0x6E0D3C3F828DA773(*iParam0, iVar1);
}
...
int func_106(int iParam0, var uParam1, var uParam2, bool bParam3, bool bParam4)
{
	bool bVar0;
...
int func_109(int iParam0, bool bParam1)
{
	...
	{
		func_169(iParam0, _NAMESPACE48::_0x4F76E3676583D951(func_168(iParam0)));
		if (func_20() == -1)
		{
			if (func_162(iParam0, 2048))
			{
				_NAMESPACE48::_0x49A8C2CD97815215(func_170(iParam0));
				func_171(iParam0, 2048);
			}
			_NAMESPACE48::_0xFCC6DB8DBE709BC8(func_170(iParam0));
		}
		return 0;
	}
	...
	if (_NAMESPACE48::_0x800DF3FC913355F3(func_170(iParam0)))
	{
		func_171(iParam0, 128);
		return 1;
	}
	func_169(iParam0, _NAMESPACE48::_0x4F76E3676583D951(func_168(iParam0)));
	_NAMESPACE48::_0x4F81EAD1DE8FA19B(func_170(iParam0));
	if (func_162(iParam0, 2048))
	{
		_NAMESPACE48::_0x49A8C2CD97815215(func_170(iParam0));
		func_171(iParam0, 2048);
...
int func_114(vector3 vParam0, int iParam3, int iParam4, int iParam5)
{
	var uVar0[4];
	int iVar5[4];
...
int func_116(int iParam0, bool bParam1, int iParam2, int iParam3)
{
	struct<11> Var0;
	int iVar17;
	struct<11> Var18;
	...
	{
		return func_178(bParam1, iParam2, iParam3);
	}
	if (Global_1572887->f_12 != -1)
	{
...
int func_124()
{
	...
	(Local_116[0 /*45*/])->f_43 = 27471/*func_189*/;
	(Local_116[0 /*45*/])->f_44 = 27771/*func_190*/;
	func_191(Local_116[0 /*45*/], 512);
	return 1;
}
...
char* func_128(int iParam0, int iParam1, int iParam2, int iParam3, var uParam4, var uParam5, var uParam6)
{
	char* sVar0;
...
void func_157()
{
	if (func_205(&((Local_116[0 /*45*/])->f_34)))
	{
		func_206(&((Local_116[0 /*45*/])->f_34));
	}
	func_207((Local_116[0 /*45*/])->f_38);
	func_207((Local_116[0 /*45*/])->f_39);
}
...
void func_159(int iParam0)
{
	...
	if (func_107((Global_1914319->f_3[iParam0 /*446*/])->f_21) && func_211((Global_1914319->f_3[iParam0 /*446*/])->f_21))
	{
	...
	else
	{
		...
		while (iVar0 < iVar1)
		{
			func_161(&((Global_1914319->f_3[iParam0 /*446*/])->f_317[iVar0 /*6*/]));
...
int func_163(int iParam0, bool bParam1)
{
	...
	func_221(iParam0);
	_NAMESPACE48::_0xFC77C5B44D5FF7C0(func_170(iParam0));
	func_169(iParam0, 0);
	return 1;
}
...
void func_166(var uParam0, vector3 vParam1, vector3 vParam4, vector3 vParam7, int iParam10, var uParam11, int iParam12, bool bParam13)
{
	float fVar0[4];
	int iVar5;
	int iVar6;
	...
	*uParam0 = VOLUME::_0xBBE768E3AE76E07C(uParam11, vParam1, vParam4, vParam7, iVar5, iVar6, &fVar0, iParam12, bParam13);
}
...
var func_180(int iParam0, int iParam1, int iParam2)
{
...
int func_182(int iParam0, int iParam1, int iParam2, int iParam3, int iParam4)
{
	...
	uVar0 = func_180(iParam0, iParam1, iParam2);
	iVar1 = iParam3;
	func_225(iVar1, 0);
	func_226(iVar1, 0);
	func_227(iVar1, 0);
	func_228(iVar1, 0);
	func_229(iVar1, uVar0);
	if (iParam4 != 0)
	{
...
void func_188(var uParam0, int iParam1, var uParam2, int iParam3, bool bParam4)
{
	...
	if (bParam4)
	{
		...
		func_191((*uParam0)[iParam3 /*45*/], 128);
	}
	if (!func_205(&(((*uParam0)[iParam3 /*45*/])->f_34)))
	{
		func_242(&(((*uParam0)[iParam3 /*45*/])->f_34), 1);
	}
	func_191((*uParam0)[iParam3 /*45*/], 32768);
	func_191((*uParam0)[iParam3 /*45*/], 1024);
...
{
	if (func_249((*uParam0)[0 /*45*/], 1, 1))
	{
		func_250((*uParam0)[0 /*45*/]);
	}
}
...
{
	return (BUILTIN::SHIFT_RIGHT(iParam0, 26) & 31 * func_266(MISC::IS_BIT_SET(iParam0, 31), -1, 1)) + 1898;
}
...
void func_247(int iParam0, int iParam1, int iParam2)
{
	...
	func_248(Global_23117.f_1651[iVar1], iParam2);
}
...
void func_250(var uParam0)
{
	...
	if (MISC::IS_STRING_NULL_OR_EMPTY(func_281(&vVar0)))
	{
		return;
	}
	...
	if (!func_245(uParam0, 65536))
	{
		...
		{
			iVar4 = uParam0->f_21;
			iVar5 = func_243(&(uParam0->f_3[iVar4 /*3*/]));
			if (!func_282(iVar5, 0))
			{
				return;
			}
...
int func_251(vector3 vParam0, int iParam3)
{
	vector3 vVar0;
	struct<2> Var3;
	float fVar6;

	func_288(iParam3, &vVar0, &Var3, &fVar6);
	if (func_289(vParam0, vVar0, Var3, Var3.f_1, fVar6))
	{
		return 1;
	}
	return 0;
...
int func_270(int iParam0, int iParam1, int iParam2)
{
	...
	iVar1 = (iVar0 * 10 + iParam1);
	return func_269(&(Global_23117.f_1651[iVar1]), iParam2);
}
...
int func_274(var uParam0, bool bParam1)
{
	...
	if ((((func_116(PLAYER::PLAYER_ID(), 1, 0, 1) || func_304()) || LAW::_0xF46108C50A22B029()) || LAW::_0x69E181772886F48B(PLAYER::PLAYER_ID())) || PLAYER::_0xD1F6B912785BFD35(PLAYER::PLAYER_ID()))
	{
		return 0;
	}
...
void func_278(var uParam0)
{
	...
	if (uParam0->f_2)
	{
		...
		while (iVar1 < 5)
		{
			if (func_107(&(uParam0->f_3[iVar1 /*3*/])) && (uParam0->f_3[iVar1 /*3*/])->f_2)
			{
				iVar2 = func_243(&(uParam0->f_3[iVar1 /*3*/]));
...
int func_279(var uParam0, int iParam1)
{
	...
	if (func_245(uParam0, 128))
	{
		...
		while (iVar0 < 5)
		{
			iVar1 = func_243(&(uParam0->f_3[iVar0 /*3*/]));
...
int func_285(var uParam0, vector3 vParam1, vector3 vParam4, bool bParam7, bool bParam8)
{
	int iVar0;
	int iVar1;
	...
	else if (func_319(uParam0, vParam1, bParam8, -1, 0, 0))
	{
		iVar0 = uParam0[0 /*4*/];
		iVar1 = uParam0[1 /*4*/];
		if ((ENTITY::DOES_ENTITY_EXIST(iVar0) && !func_320(iVar0, 0)) && (ENTITY::DOES_ENTITY_EXIST(iVar1) && !func_320(iVar1, 0)))
		{
			if (!func_101(vParam4))
			{
...
bool func_296(int iParam0, int iParam1)
{
	...
	return !_NAMESPACE48::_0xEB98B38CA60742D7(func_170(iParam0));
}
...
int func_304()
{
	if (PED::_0xA911EE21EDF69DAF(Global_35) || func_333(Global_35))
	{
		return 1;
	}
	return 0;
...
{
	if (!ENTITY::DOES_ENTITY_EXIST(iParam0) || func_320(iParam0, 0))
	{
		return 0;
	}
	if (func_334(iParam0))
...
float func_311(int iParam0, int iParam1, bool bParam2, int iParam3)
{
...
int func_314(int iParam0)
{
	...
	return func_337(((*Global_1835011)[iParam0 /*74*/])->f_1);
}
...
int func_316(int iParam0)
{
	...
	return func_337(((*Global_1347702)[iParam0 /*49*/])->f_15);
}
...
int func_317(int iParam0, int iParam1)
{
	...
	return func_256((Global_1914319->f_3[iParam0 /*446*/])->f_10, 1024);
}
...
int func_332(vector3 vParam0, float fParam3, float fParam4, float fParam5, float fParam6)
{
	float fVar0;
	float fVar1;
	bool bVar2;
...
{
	if (((func_328(1) || AUDIO::_0x2B101AD9F651243A()) || AUDIO::IS_SCRIPTED_SPEECH_PLAYING(iParam0)) || AUDIO::IS_ANY_SPEECH_PLAYING(iParam0))
	{
		return 1;
	}
	return 0;
