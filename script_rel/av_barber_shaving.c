...
{
	func_33(uParam0, 10897/*func_30*/, 10948/*func_31*/, 11591/*func_32*/);
}
...
void func_14(var uParam0, vector3 vParam1, vector3 vParam4)
{
	...
	if (!func_48(iLocal_38, 1))
	{
		uParam0->f_499 = 1;
		return;
	}
	uVar0 = func_49(func_46());
	uVar1 = func_50();
	func_51(uParam0, "BARBER_SHAVING", "script@ambient@town@barber_shave@action", vParam1, vParam4);
	func_52(uParam0, 1, "pl_action", "", 0);
	func_53(uParam0, 0, "BARBER", uVar1, vParam1, vParam4.z, 1, 1, 1, 1, 41788943, 1);
	func_53(uParam0, 1, "CUSTOMER", uVar0, vParam1, vParam4.z, 1, 1, 1, 1, 41788943, 1);
	func_54(uParam0, 0, "RAZOR", -738547179, 0f, 0f, 0f, 0f, 1);
}
...
int func_18(var uParam0)
{
	...
	if (ENTITY::IS_ENTITY_DEAD(&(uParam0->f_20[0 /*14*/])))
	{
		...
		{
			uParam0->f_20[0 /*14*/] = func_56(iLocal_38, 0, 0, 1, 1, 1);
		}
		else
		{
			func_57(iLocal_38, 0, 0, 0, 0, 0);
		}
		return 0;
	}
	if (!func_58(8, 524288))
	...
	while (iVar12 < uParam0->f_19)
	{
		if ((uParam0->f_20[iVar12 /*14*/])->f_2 != 0)
		{
			...
			if (ENTITY::IS_ENTITY_DEAD(&(uParam0->f_20[iVar12 /*14*/])))
			{
				...
				{
					uParam0->f_20[iVar12 /*14*/] = func_65((uParam0->f_20[iVar12 /*14*/])->f_2, (uParam0->f_20[iVar12 /*14*/])->f_5, (uParam0->f_20[iVar12 /*14*/])->f_8, 1, 1, 0, 1, (uParam0->f_20[iVar12 /*14*/])->f_11, (uParam0->f_20[iVar12 /*14*/])->f_9, 0, 0, 0, 0);
				}
				...
				if (!PED::IS_PED_HUMAN(&(uParam0->f_20[iVar12 /*14*/])))
				{
					if (!func_66(&(uParam0->f_20[iVar12 /*14*/])))
					{
...
int func_31(var uParam0)
{
	...
	if (!&uParam0->f_469[0])
	{
		...
		while (iVar1 < 2)
		{
			...
			{
				if (func_73(&(uParam0->f_20[iVar1 /*14*/]), 0, &uLocal_9, &uVar0, 0, 0))
				{
					func_74(uParam0);
					if (!&uParam0->f_469[2])
					{
				...
				if (&uParam0->f_469[1])
				{
					if (!&uParam0->f_469[2])
					{
						if (func_77(uParam0, 1f, 15f, 4, -91962372, 0))
						{
							func_75(*uParam0, uParam0->f_483, 1);
							uParam0->f_469[2] = 1;
						}
				...
				if (&uParam0->f_469[1])
				{
					if (ENTITY::DOES_ENTITY_EXIST(&(uParam0->f_20[0 /*14*/])))
					{
						if (ANIMSCENE::_0x005E6F28DD7ED58D(uParam0->f_3.f_1, (uParam0->f_20[0 /*14*/])->f_1))
						{
							...
							TASK::_TASK_USE_NEAREST_SCENARIO_TO_COORD(&(uParam0->f_20[0 /*14*/]), -306.483f, 814.287f, 117.984f, 1f, 65000, 0, 1, 0, 0);
							PED::SET_PED_KEEP_TASK(&(uParam0->f_20[0 /*14*/]), true);
							if (iLocal_38 != -1)
							{
								if (func_78(iLocal_38))
								{
									func_79(iLocal_38, 0, 1, 0, 0);
								}
							}
							uParam0->f_469[3] = 1;
						}
					...
					{
						if (ANIMSCENE::_0x005E6F28DD7ED58D(uParam0->f_3.f_1, (uParam0->f_372[0 /*8*/])->f_1))
						{
...
bool func_48(int iParam0, int iParam1)
{
	...
	if (iParam1 && !ENTITY::DOES_ENTITY_EXIST(func_97(iParam0)))
	{
		return false;
	}
...
void func_51(var uParam0, char* sParam1, char* sParam2, vector3 vParam3, vector3 vParam6)
{
	uParam0->f_2 = sParam1;
	uParam0->f_3 = sParam2;
...
void func_53(var uParam0, int iParam1, char* sParam2, var uParam3, vector3 vParam4, var uParam7, int iParam8, int iParam9, int iParam10, int iParam11, int iParam12, int iParam13)
{
...
void func_54(var uParam0, int iParam1, char* sParam2, int iParam3, vector3 vParam4, float fParam7, int iParam8)
{
...
int func_56(int iParam0, bool bParam1, bool bParam2, bool bParam3, int iParam4, bool bParam5)
{
	int iVar0;
	int iVar1;
	...
	if ((iParam4 && !func_78(iParam0)) && !ENTITY::IS_ENTITY_DEAD(iVar0))
	{
...
int func_57(int iParam0, bool bParam1, int iParam2, int iParam3, int iParam4, bool bParam5)
{
	vector3 vVar0;
	int iVar3;
...
int func_60(int iParam0, bool bParam1, int iParam2)
{
	...
	{
		iVar0 = func_110(&(Global_1898164->f_1[0 /*5*/]));
		if (func_111(iVar0) && func_112(((*Global_1347702)[iVar0 /*49*/])->f_12, 131072))
		{
			return 0;
		}
	}
...
int func_65(int iParam0, vector3 vParam1, float fParam4, bool bParam5, bool bParam6, int iParam7, bool bParam8, bool bParam9, bool bParam10, bool bParam11, bool bParam12, bool bParam13, bool bParam14)
{
	...
	func_114(iVar0, iParam0, iParam7, bParam8, bParam9, bParam10, bParam11, bParam12);
	return iVar0;
}
...
int func_73(int iParam0, int iParam1, var uParam2, var uParam3, int iParam4, float fParam5)
{
	int iVar0;
	...
	if (!Global_1935630->f_12 && !ENTITY::IS_ENTITY_DEAD(iParam0))
	{
		...
		if (!uParam2->f_1 & 128 != 0)
		{
			...
			{
				*uParam3 = 128;
				func_124(iParam0, uParam2, *uParam3);
				return 1;
			}
		}
		if (Global_1935630->f_27)
		{
			if (!uParam2->f_1 & 8 != 0)
			{
				...
				else if (func_126(iParam0, iParam1, uParam2))
				{
					*uParam3 = 8;
					func_124(iParam0, uParam2, *uParam3);
					return 1;
		...
		if (Global_1935630->f_26 && func_128(PLAYER::PLAYER_ID(), 0, 1, uParam2->f_1 & 524288 == 0))
		{
		...
		{
			if (func_129(uParam2, 1065353216))
			{
				if (!uParam2->f_1 & 4 != 0)
				{
					if (func_130(Global_35, iParam0, uParam2))
					{
						*uParam3 = 4;
						func_124(iParam0, uParam2, *uParam3);
						return 1;
		...
		if (!uParam2->f_1 & 16 != 0)
		{
			...
			{
				if (func_132(Global_35, iParam0, uParam2, 0))
				{
					*uParam3 = 16;
					func_124(iParam0, uParam2, *uParam3);
					return 1;
			...
			else if (func_132(Global_35, iParam0, uParam2, 1))
			{
				*uParam3 = 16;
				func_124(iParam0, uParam2, *uParam3);
				return 1;
		...
		if (Global_1935630->f_30 || Global_1935630->f_31)
		{
			if (!uParam2->f_1 & 2 != 0)
			{
				...
				{
					if ((func_136(iParam0, Global_1935630->f_41, *uParam2 & 128 != 0, 0, *uParam2 & 256 != 0) && func_137(uParam2, iParam0)) && func_138(uParam2, iParam0))
					{
						*uParam3 = 2;
						func_124(iParam0, uParam2, *uParam3);
						return 1;
		...
		if (!uParam2->f_1 & 2 != 0)
		{
			if (uParam2->f_12 < 4f)
			{
				if ((func_136(iParam0, Global_1935630->f_41, *uParam2 & 128 != 0, 1, *uParam2 & 256 != 0) && func_137(uParam2, iParam0)) && func_138(uParam2, iParam0))
				{
					*uParam3 = 2;
					func_124(iParam0, uParam2, *uParam3);
					return 1;
				...
				if (Global_1935630->f_40 == 0)
				{
					if (Global_1935630->f_41 != 0)
					{
						if (*uParam2 & 131072 == 0)
						{
							if (func_139(iParam0, Global_1935630->f_41))
							{
								func_140();
								*uParam3 = 2;
								func_124(iParam0, uParam2, *uParam3);
			...
			if (uParam2->f_12 < 10f)
			{
				if (func_141(uParam2, iParam0) || (uParam2->f_9 > 0 && (func_142() - uParam2->f_9) < 2000))
				{
			...
			if (Global_1935630->f_42 != 0)
			{
				if (*uParam2 & 131072 == 0)
				{
					if (func_143())
					{
						if (func_139(iParam0, Global_1935630->f_42))
						{
							func_140();
							*uParam3 = 2;
							func_124(iParam0, uParam2, *uParam3);
		...
		if (uParam2->f_12 < uParam2->f_26)
		{
			...
			{
				if (func_145(iParam0, iParam1, uParam2))
				{
					*uParam3 = 2048;
					func_124(iParam0, uParam2, *uParam3);
					return 1;
...
int func_76(var uParam0, float fParam1, float fParam2, int iParam3, float fParam4, float fParam5)
{
	...
	if ((MISC::GET_FRAME_COUNT() % 8) == 0)
	{
		...
		fVar7 = func_158(Global_36, uParam0->f_483);
		...
		while (iVar0 < uParam0->f_19)
		{
			...
			if (!ENTITY::IS_ENTITY_DEAD(&(uParam0->f_20[iVar0 /*14*/])))
			{
				...
				fVar8 = func_159(Global_35, &(uParam0->f_20[iVar0 /*14*/]), 1);
				if (fVar8 < fVar1)
				{
					return 1;
				}
...
int func_77(var uParam0, float fParam1, float fParam2, int iParam3, int iParam4, bool bParam5)
{
	int iVar0;
		...
		while (iVar0 < uParam0->f_19)
		{
			...
			else
			{
				if (!ENTITY::IS_ENTITY_DEAD(&(uParam0->f_20[iVar0 /*14*/])))
				{
					...
					{
						if ((func_159(Global_35, &(uParam0->f_20[iVar0 /*14*/]), 1) < fParam2 && PED::_0x5102307CE88798EB(&(uParam0->f_20[iVar0 /*14*/]))) && PED::IS_TRACKED_PED_VISIBLE(&(uParam0->f_20[iVar0 /*14*/])))
						{
							if (!func_160(&(uParam0->f_490)))
							{
								func_164(&(uParam0->f_490), 0);
							}
...
int func_84(vector3 vParam0, float fParam3)
{
	...
	while (iVar0 < 4)
	{
		...
		{
			if (func_173(vParam0, (Global_1415419->f_9721[iVar0 /*8*/])->f_4, fParam3, 0))
			{
				return 1;
			}
		}
...
int func_85(vector3 vParam0)
{
	...
	while (iVar0 < 10)
	{
		...
		{
			if (func_173(vParam0, (Global_32073.f_2697.f_1495[iVar0 /*4*/])->f_1, 1f, 0))
			{
				return 1;
			}
		}
...
{
	return (BUILTIN::SHIFT_RIGHT(iParam0, 26) & 31 * func_174(MISC::IS_BIT_SET(iParam0, 31), -1, 1)) + 1898;
}
...
int func_102(int iParam0, bool bParam1)
{
	...
	if ((func_98(iParam0, 1) && !func_78(iParam0)) && func_169(iParam0))
	{
		return 0;
	}
	if (!func_98(iParam0, 2))
...
int func_105(int iParam0, bool bParam1)
{
	...
	{
		func_181(iParam0, _NAMESPACE48::_0x4F76E3676583D951(func_99(iParam0)));
		if (func_94() == -1)
		{
...
void func_114(int iParam0, int iParam1, int iParam2, bool bParam3, bool bParam4, bool bParam5, bool bParam6, bool bParam7)
{
	bool bVar0;
...
void func_122(var uParam0, bool bParam1, int iParam2)
{
	func_190(iParam2);
	if (Global_1572887->f_12 == -1)
	{
	...
	switch (uParam0->f_6)
	{
		case 0:
			if (*uParam0 & 16 != 0)
			{
				...
				else if (!PED::IS_PED_PLANTING_BOMB(Global_35) && (!func_192(1) || *uParam0 & 8192 != 0))
				{
	...
	if (!uParam0->f_1 & 1024 != 0)
	{
		if (!ENTITY::DOES_ENTITY_EXIST(uParam0->f_14))
		{
			if (func_193(uParam0))
			{
				uParam0->f_15 = func_142();
			}
		}
		else if (uParam0->f_15 > 0)
		{
			if ((func_142() - uParam0->f_15) > 500)
			{
...
int func_123(int iParam0, var uParam1)
{
	...
	switch (iVar0)
	{
		...
		case 1589923363:
			...
			if (!func_195(iParam0, uParam1, iVar2))
			{
				return 0;
			}
			if (func_196(iParam0, iVar2) <= func_197(uParam1))
			{
				return 1;
			}
			break;
...
int func_125(int iParam0, var uParam1)
{
	...
	{
		if (func_201(iParam0, !*uParam1 & 268435456 != 0, !*uParam1 & 536870912 != 0, !*uParam1 & 1073741824 != 0, 0, 0))
		{
			if (uParam1->f_12 < 5f)
			{
				fVar0 = 95f;
			...
			fVar1 = func_202(uParam1);
			if (func_203(uParam1, iParam0, fVar0, fVar1))
			{
				if (uParam1->f_2 == 0)
				{
...
int func_126(int iParam0, int iParam1, var uParam2)
{
	...
	fVar0 = 85f;
	if (func_205(iParam1, !*uParam2 & 268435456 != 0, !*uParam2 & 536870912 != 0, !*uParam2 & 1073741824 != 0, 0))
	{
		if (uParam2->f_12 < 5f)
		{
			fVar0 = 95f;
		...
		fVar1 = func_202(uParam2);
		if (func_203(uParam2, iParam0, fVar0, fVar1))
		{
			if (uParam2->f_2 == 0)
			{
			...
			if (uParam2->f_2 != 0)
			{
				if (MISC::GET_GAME_TIMER() - uParam2->f_2) > func_204(uParam2)
				{
					func_199(uParam2, 1);
					return 1;
				}
...
int func_127(int iParam0, var uParam1)
{
	...
	if (func_195(iParam0, uParam1, iVar1))
	{
		if (uParam1->f_3 == 0)
		{
			uParam1->f_3 = MISC::GET_GAME_TIMER();
		}
		else if (MISC::GET_GAME_TIMER() - uParam1->f_3) > func_204(uParam1)
		{
			fVar3 = func_202(uParam1);
...
int func_128(int iParam0, bool bParam1, int iParam2, bool bParam3)
{
	...
	{
		return func_206(bParam1, iParam2, bParam3);
	}
	if (Global_1572887->f_12 != -1)
	{
...
int func_130(var uParam0, int iParam1, var uParam2)
{
	float fVar0;
	int iVar1;
	float fVar2;
...
int func_131(var uParam0, int iParam1, var uParam2)
{
	...
	if (uParam2->f_12 < IntToFloat(func_208(uParam2)))
	{
...
int func_132(var uParam0, int iParam1, var uParam2, bool bParam3)
{
	vector3 vVar0;
	int iVar3;
	vector3 vVar4;
		...
		switch (iVar3)
		{
			...
			case 2:
				if (EVENT::IS_SHOCKING_EVENT_IN_SPHERE(-966930978, vVar0, uParam2->f_22))
				{
					...
					if (func_210(iParam1, vVar0, vVar4))
					{
						func_199(uParam2, 1);
						return 1;
					}
		...
		switch (iVar3)
		{
			...
			case 2:
				if (EVENT::IS_SHOCKING_EVENT_IN_SPHERE(-966930978, vVar0, uParam2->f_22))
				{
					...
					if (func_210(iParam1, vVar0, vVar7))
					{
						func_199(uParam2, 1);
						return 1;
					}
...
int func_133(int iParam0, var uParam1)
{
	...
	{
		if (!func_195(iParam0, uParam1, &(Global_1935630->f_34[iVar0])) || iParam0 == &Global_1935630->f_34[iVar0])
		{
		}
		else
		{
			bVar13 = func_211(&(Global_1935630->f_34[iVar0]));
			fVar1 = BUILTIN::VDIST(ENTITY::GET_ENTITY_COORDS(&(Global_1935630->f_34[iVar0]), false, false), vVar9);
			if (func_66(&(Global_1935630->f_34[iVar0])))
			{
				if (fVar1 < 35f)
				{
			...
			if (func_212(uParam1, iParam0, fVar1, bVar12, bVar13))
			{
				*(vVar2[0 /*3*/]) = { ENTITY::GET_ENTITY_COORDS(&(Global_1935630->f_34[iVar0]), false, false) };
				*(vVar2[1 /*3*/]) = { vVar9 };
				uParam1->f_10 = iParam0;
			...
			else if (func_213(uParam1, iParam0, fVar1, bVar12, bVar13))
			{
				*(vVar2[0 /*3*/]) = { ENTITY::GET_ENTITY_COORDS(&(Global_1935630->f_34[iVar0]), false, false) };
				*(vVar2[1 /*3*/]) = { vVar9 };
				uParam1->f_10 = iParam0;
			...
			else if (func_214(uParam1, iParam0, fVar1, iVar0))
			{
				*(vVar2[0 /*3*/]) = { ENTITY::GET_ENTITY_COORDS(&(Global_1935630->f_34[iVar0]), false, false) };
				*(vVar2[1 /*3*/]) = { vVar9 };
				uParam1->f_10 = iParam0;
...
int func_136(int iParam0, int iParam1, bool bParam2, bool bParam3, bool bParam4)
{
	int iVar0;
	int iVar1;
	int iVar2;
...
int func_141(var uParam0, int iParam1)
{
	...
	if (iVar0 != 0 && !VEHICLE::IS_THIS_MODEL_A_TRAIN(ENTITY::GET_ENTITY_MODEL(iVar0)))
	{
		...
		if (func_219(iVar0, iParam1, vVar1))
		{
			uParam0->f_9 = func_142();
			return 1;
		}
...
int func_144(var uParam0, int iParam1)
{
	...
	if (uParam0->f_12 > func_221(uParam0) && uParam0->f_12 > fVar0)
	{
		return 0;
	}
	iVar2 = func_222(iParam1);
	iVar1 = func_223(uParam0->f_14);
...
int func_145(int iParam0, int iParam1, var uParam2)
{
	...
	return func_224(iParam0, iParam1, bVar0, bVar2, uParam2->f_12, bVar1);
}
	...
	switch (iVar1)
	{
		...
		case -1601932249:
			...
			if (PED::_0x06087579E7AA85A9(iParam0, iVar4, -1f, -1f, -1f, -1f) && PED::_0x06087579E7AA85A9(iParam0, Global_35, -1f, -1f, -1f, -1f))
			{
				...
				{
					if (!func_226(uParam1, iParam0))
					{
						if (func_220(iVar4, Global_36, 1) < 7f)
						{
							return 1;
						}
					}
...
int func_150(int iParam0, var uParam1)
{
	...
	if (uParam1->f_4 == 0)
	{
		uParam1->f_4 = func_142();
	}
	else if (func_142() - uParam1->f_4) > func_228(uParam1)
	{
		return func_229(iParam0, uParam1, 0, -1082130432);
	}
	return 0;
}
...
void func_154(int iParam0, vector3 vParam1)
{
	int iVar0;
	int iVar1;
	...
	while (iVar0 < 10)
	{
		...
		{
			if (func_173((Global_32073.f_2697.f_1495[iVar0 /*4*/])->f_1, vParam1, 1056964608, 1))
			{
				return;
			}
		}
...
int func_173(vector3 vParam0, vector3 vParam3, float fParam6, bool bParam7)
{
	if (fParam6 < 0f)
	{
		fParam6 = 0f;
...
int func_192(bool bParam0)
{
	...
	if (func_244(bParam0, &uVar0, &uVar1))
	{
		return 1;
	}
	return 0;
...
int func_201(int iParam0, bool bParam1, bool bParam2, bool bParam3, int iParam4, int iParam5)
{
	int iVar0;
	int iVar1;
	int iVar2;
	...
	{
		if (WEAPON::_0x6AD66548840472E5(func_247(iVar0, 0)))
		{
			if (func_248(iParam0, 0.4f, 0.6f, 0.3f, 0.7f))
			{
				return 1;
			}
		}
...
int func_203(var uParam0, int iParam1, float fParam2, float fParam3)
{
	float fVar0;
...
int func_205(int iParam0, bool bParam1, bool bParam2, bool bParam3, int iParam4)
{
	int iVar0;
	int iVar1;
	...
	if (PLAYER::IS_PLAYER_FREE_AIMING(iVar1))
	{
		if (WEAPON::_0x6AD66548840472E5(func_247(iVar0, 0)))
		{
			if (func_249(ENTITY::GET_ENTITY_COORDS(iParam0, true, false), 0.4f, 0.6f, 0.3f, 0.7f))
			{
				return 1;
			}
		}
...
int func_206(bool bParam0, var uParam1, var uParam2)
{
...
int func_210(int iParam0, vector3 vParam1, vector3 vParam4)
{
	if (func_250(iParam0, vParam4, 0.5f))
	{
...
int func_212(var uParam0, int iParam1, float fParam2, bool bParam3, bool bParam4)
{
	float fVar0;
...
int func_213(var uParam0, int iParam1, float fParam2, bool bParam3, bool bParam4)
{
	float fVar0;
...
int func_214(var uParam0, int iParam1, float fParam2, int iParam3)
{
	float fVar0;
...
int func_216(int iParam0, int iParam1)
{
	...
	if (func_253(iParam0, 1, 0, 0) != 2055893578)
	{
		return 0;
	}
...
int func_219(int iParam0, int iParam1, vector3 vParam2)
{
	float fVar0;
	
	fVar0 = func_220(iParam0, vParam2, 1);
	if (fVar0 < 4f)
	{
...
int func_224(int iParam0, int iParam1, bool bParam2, bool bParam3, float fParam4, bool bParam5)
{
	bool bVar0;
	int iVar1;
	float fVar2;
...
int func_225(int iParam0, var uParam1, bool bParam2)
{
	int iVar0;
	int iVar1;
	
	func_244(1, &iVar0, &iVar1);
	...
	if (ENTITY::DOES_ENTITY_EXIST(iVar0))
	{
		if (iVar0 != iParam0)
		{
			if (PED::_0x06087579E7AA85A9(iParam0, Global_35, -1f, -1f, -1f, -1f))
			{
				if (ENTITY::HAS_ENTITY_CLEAR_LOS_TO_ENTITY(iParam0, Global_35, 17))
				{
					if (!bParam2 || !func_226(uParam1, iVar0))
					{
						return 1;
					}
				}
	...
	if (ENTITY::DOES_ENTITY_EXIST(iVar1))
	{
		if (iVar1 != iParam0)
		{
			...
			{
				if (!bParam2 || !func_226(uParam1, iVar1))
				{
					if (func_220(iVar1, Global_36, 1) < 5f)
					{
						return 1;
					}
				}
...
int func_227(int iParam0)
{
	...
	return func_255(((*Global_1347702)[58 /*49*/])->f_15, 1);
}
...
int func_229(int iParam0, var uParam1, bool bParam2, float fParam3)
{
	if (!bParam2)
	{
		if (uParam1->f_4 == 0)
...
int func_248(int iParam0, float fParam1, float fParam2, float fParam3, float fParam4)
{
	if (!ENTITY::IS_ENTITY_DEAD(iParam0))
	{
		if (func_249(ENTITY::GET_ENTITY_COORDS(iParam0, true, false), fParam1, fParam2, fParam3, fParam4))
		{
			return 1;
		}
	}
...
int func_249(vector3 vParam0, float fParam3, float fParam4, float fParam5, float fParam6)
{
	float fVar0;
	float fVar1;
	bool bVar2;
...
bool func_250(int iParam0, vector3 vParam1, float fParam4)
{
	vector3 vVar0;
	vector3 vVar3;
...
int func_253(int iParam0, bool bParam1, int iParam2, bool bParam3)
{
	int iVar0;
