...
int func_61(int iParam0, int iParam1, int iParam2, bool bParam3, bool bParam4)
{
	...
	if (func_33(iVar0, 0))
	{
		...
		{
			if (iParam2 || !(ENTITY::IS_ENTITY_ON_SCREEN(iVar0) && func_67(PLAYER::PLAYER_PED_ID(), iVar0, 1) < 10000f))
			{
				...
				if (iVar1 != 0)
				{
					...
					func_69(iParam0);
					_NAMESPACE48::_0x7B204F88F6C3D287(func_70(iParam0, 0));
					_NAMESPACE48::_0xFCC6DB8DBE709BC8(func_70(iParam0, 0));
					func_71(iParam0);
				}
			}
			else
