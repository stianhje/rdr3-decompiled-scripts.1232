...
int func_72(var uParam0)
{
	...
	func_151(uParam0, 0.0875f, 0.1625f, 1.4875f, 0f, 3.345f, 3.06f, 3.2075f, -1612834106, -2055224817, 1, 1, 1);
	func_151(uParam0, -2.2875f, -5.8625f, 1.4875f, 0f, 1.2f, 1.2f, 3.2075f, -1612834106, 211687389, 1, 1, 1);
	iLocal_17 = func_152(uParam0, -1618805595, -1.28962f, 0.762005f, -0.0126915f, 0, 1, 0, 1);
	func_152(uParam0, -1984279062, 0f, 0f, 0f, "p_cs_saddle02x", 0, 1, 1);
	func_152(uParam0, 858540986, 0f, 0f, 0f, "BRUSH", 0, 1, 1);
	func_153(uParam0, "script@vignette@abigail_23@base", 1, 1, 0, 0);
	uLocal_18 = func_153(uParam0, "script@vignette@abigail_23@action_a", 0, 0, 1, 0);
	func_154(uParam0, "CAB23AU");
	func_155(uParam0, 127712234, -510553568);
	func_156(uParam0, uLocal_18, -1, 0.95f);
	func_157(uParam0, iLocal_14, 3, -2097328111, "GENERIC_SEAT_CHAIR_TABLE_SCENARIO_LF_FWD_FEMALE_A", iLocal_17, 0, 0.1f, 1.75f, 0);
	...
	func_157(uParam0, iLocal_16, 3, 830847823, 0, -1, 1, 55f, 1065353216, 1);
