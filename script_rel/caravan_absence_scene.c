			...
			case 1:
				if (CAM::IS_SCREEN_FADED_OUT())
				{
					...
					if (func_6(Global_35))
					{
						...
						ENTITY::_0x203BEFFDBE12E96A(iVar4, -2589.782f, 466.6921f, 145.0417f, 75.2096f, 1, false, 1);
					}
					else if (PED::IS_PED_IN_ANY_VEHICLE(Global_35, false))
					{
						iVar3 = PED::GET_VEHICLE_PED_IS_USING(Global_35);
						PED::_0xE0B61ED8BB37712F(Global_35);
						ENTITY::_0x203BEFFDBE12E96A(iVar3, -2618.071f, 460.2562f, 144.8576f, 7.2663f, 1, false, 1);
					}
					func_4(1);
...
void func_7()
{
	...
	while (iVar4 < iVar3)
	{
		...
		if (ENTITY::DOES_ENTITY_EXIST(iVar6))
		{
			...
			{
				ENTITY::_0x203BEFFDBE12E96A(iVar6, -2589.73f, 462.719f, 145.099f, 1.44f, 1, false, 1);
			}
			else
			{
				ENTITY::_0x203BEFFDBE12E96A(iVar6, -2595.92f, 474.3518f, 144.948f, 83.4473f, 1, false, 1);
			}
		}
		iVar4++;
	}
...
int func_15(int iParam0)
{
	switch (iParam0)
	{
		case 4:
			...
			STREAMING::REQUEST_MODEL(1786194379, false);
			if (STREAMING::HAS_MODEL_LOADED(219205323) && STREAMING::HAS_MODEL_LOADED(1786194379))
			{
				return 1;
			}
			break;
		...
		case 2:
			STREAMING::REQUEST_MODEL(-1679658797, false);
			STREAMING::REQUEST_MODEL(858540986, false);
			if (STREAMING::HAS_MODEL_LOADED(-1679658797) && STREAMING::HAS_MODEL_LOADED(858540986))
			{
				return 1;
			}
			break;
		...
		case 1:
			...
			STREAMING::REQUEST_MODEL(-197909103, false);
			STREAMING::REQUEST_MODEL(-1937484496, false);
			STREAMING::REQUEST_MODEL(-1403420972, false);
			if (((STREAMING::HAS_MODEL_LOADED(joaat("a_c_cow")) && STREAMING::HAS_MODEL_LOADED(-197909103)) && STREAMING::HAS_MODEL_LOADED(-1937484496)) && STREAMING::HAS_MODEL_LOADED(-1403420972))
			{
				return 1;
			}
			break;
	...
	switch (iParam0)
	{
		case 2:
			if (ENTITY::DOES_ENTITY_EXIST(iLocal_2))
			{
				...
				{
					iLocal_3 = OBJECT::CREATE_OBJECT(858540986, -2552.5f, 422.8f, 148.7f, true, true, false, false, true);
				}
			}
			else
			{
		...
		case 4:
			if (ENTITY::DOES_ENTITY_EXIST(iLocal_0))
			{
				...
				{
					iLocal_1 = OBJECT::CREATE_OBJECT(1786194379, -2565.166f, 404.6969f, 147.5132f, true, true, false, false, true);
					return 0;
				}
			}
			else
			{
				iLocal_0 = VEHICLE::CREATE_VEHICLE(219205323, -2564.759f, 405.6364f, 147.536f, 0f, true, true, false, false);
				return 0;
			}
			break;
				...
				if (ENTITY::DOES_ENTITY_EXIST(iLocal_5))
				{
					if (ENTITY::DOES_ENTITY_EXIST(iLocal_6))
					{
						...
						else
						{
							...
							{
								iLocal_11 = 1;
								iLocal_7 = ENTITY::_0x6F3068258A499E52(-1403420972, -2515.028f, 430.2761f, 146.9727f, 11);
							}
							return 0;
						}
					}
					...
					{
						iLocal_6 = OBJECT::CREATE_OBJECT(-1937484496, -2515.2f, 415.7121f, 146.7645f, true, true, false, false, true);
						return 0;
					}
				}
				else
				{
					iLocal_5 = OBJECT::CREATE_OBJECT(-197909103, -2515.2f, 415.7121f, 146.7645f, true, true, false, false, true);
					return 0;
				}
			}
			else
		...
		case 8:
			...
			else
			{
				...
				{
					iLocal_11 = 1;
					iLocal_8 = ENTITY::_0x6F3068258A499E52(-542955242, -2590.841f, 457.838f, 146.014f, 15);
				}
				return 0;
			}
			break;
...
void func_31(int iParam0)
{
	switch (iParam0)
	{
		...
		case 16:
			if (ENTITY::_0x1FF441D7954F8709(iLocal_8))
			{
				STREAMING::SET_MODEL_AS_NO_LONGER_NEEDED(-542955242);
		...
		case 4:
			if (ENTITY::DOES_ENTITY_EXIST(iLocal_1))
			{
				...
				STREAMING::SET_MODEL_AS_NO_LONGER_NEEDED(1786194379);
			}
			if (ENTITY::DOES_ENTITY_EXIST(iLocal_0))
			{
		...
		case 2:
			if (ENTITY::DOES_ENTITY_EXIST(iLocal_2))
			{
				...
				STREAMING::SET_MODEL_AS_NO_LONGER_NEEDED(-1679658797);
			}
			if (ENTITY::DOES_ENTITY_EXIST(iLocal_3))
			{
		...
		case 1:
			if (ENTITY::DOES_ENTITY_EXIST(iLocal_5))
			{
				...
				STREAMING::SET_MODEL_AS_NO_LONGER_NEEDED(-197909103);
			}
			if (ENTITY::DOES_ENTITY_EXIST(iLocal_4))
			{
			...
			if (ENTITY::_0x1FF441D7954F8709(iLocal_7))
			{
				STREAMING::SET_MODEL_AS_NO_LONGER_NEEDED(-1403420972);
