...
{
	func_33(uParam0, 11805/*func_30*/, 11814/*func_31*/, 12221/*func_32*/);
}
...
var func_57(int iParam0, vector3 vParam1, float fParam4, float fParam5, float fParam6, int iParam7)
{
...
void func_96(int iParam0, vector3 vParam1)
{
	...
	while (iVar0 < 10)
	{
		...
		{
			if (func_101((Global_32073.f_2697.f_1495[iVar0 /*4*/])->f_1, vParam1, 1056964608, 1))
			{
				return;
			}
		}
...
void func_120(int iParam0, int iParam1, int iParam2, int iParam3, int iParam4, int iParam5, bool bParam6, int iParam7)
{
	int iVar0;

	iVar0 = (((iParam2 + (60 * iParam3)) + (3600 * iParam4)) + (86400 * iParam5));
	if (func_129(iParam0) == 1 && iParam7)
	{
		return;
	}
	if (bParam6)
