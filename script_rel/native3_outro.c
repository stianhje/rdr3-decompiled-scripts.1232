...
int func_21(var uParam0)
{
	...
	if (!VOLUME::_0x92A78D0BEDB332A3(&(iLocal_256[0])))
	{
		...
		iLocal_259[0] = PED::_0x4C39C95AE5DB1329(&(iLocal_256[0]), false, 15);
	...
	if (!VOLUME::_0x92A78D0BEDB332A3(&(iLocal_256[1])))
	{
		...
		iLocal_259[1] = PED::_0x4C39C95AE5DB1329(&(iLocal_256[1]), false, 15);
...
int func_23(var uParam0)
{
	...
	switch (iLocal_3)
	{
		...
		case 7:
			...
			ENTITY::_0x203BEFFDBE12E96A(Global_35, 2918.51f, 1339.779f, 37.6952f, 339.7957f, 1, false, 1);
					...
					if (STREAMING::_0xCF45DF50C7775F2A())
					{
						if (STREAMING::_0x0909F71B5C070797() || (func_47(&uLocal_6) && func_55(&uLocal_6) >= 15f))
						{
							...
							if (!PED::IS_PED_INJURED(iLocal_5))
							{
								...
								ENTITY::_0x203BEFFDBE12E96A(iLocal_5, 2920.626f, 1324.657f, 43.1178f, 67.9963f, 1, false, 1);
