...
{
	STREAMING::REQUEST_MODEL(-1088485514, false);
	if (!STREAMING::HAS_MODEL_LOADED(-1088485514))
	{
		return 0;
	}
	return 1;
...
int func_44()
{
	...
	while (iVar0 < 4)
	{
		if (!ENTITY::DOES_ENTITY_EXIST(&(Local_5[iVar0 /*6*/])) && !func_62((Local_5[iVar0 /*6*/])->f_5, 1))
		{
			if (iVar0 == 0)
			{
				Local_5[iVar0 /*6*/] = func_63(-1088485514, 1321.848f, -639.7525f, 60.6564f, 50.7916f, 1, 1, 0, 1, 1, 1, 0, 0, 0, 0);
				PED::SET_PED_NAME_DEBUG(&(Local_5[iVar0 /*6*/]), "Group01_01");
			}
			else if (iVar0 == 1)
			{
				Local_5[iVar0 /*6*/] = func_63(-1088485514, 1323.208f, -638.7339f, 61.351f, 52.7915f, 1, 1, 0, 1, 1, 1, 0, 0, 0, 0);
				PED::SET_PED_NAME_DEBUG(&(Local_5[iVar0 /*6*/]), "Group01_02");
			}
			else if (iVar0 == 2)
			{
				Local_5[iVar0 /*6*/] = func_63(-1088485514, 1231.225f, -479.1585f, 82.4746f, 181.6388f, 1, 1, 0, 1, 1, 1, 0, 0, 0, 0);
				PED::SET_PED_NAME_DEBUG(&(Local_5[iVar0 /*6*/]), "Group02_01");
			}
			else if (iVar0 == 3)
			{
				Local_5[iVar0 /*6*/] = func_63(-1088485514, 1229.978f, -478.3989f, 82.5741f, 186.8161f, 1, 1, 0, 1, 1, 1, 0, 0, 0, 0);
			...
			func_64(&(Local_5[iVar0 /*6*/]), -164645981, 1, 0, 1, 1, 1, 1056964608, 1065353216, -1, 0, 0, 0, 0);
			func_64(&(Local_5[iVar0 /*6*/]), 379542007, 1, 0, 0, 1, 0, 1056964608, 1065353216, -1, 0, 0, 0, 0);
...
bool func_45()
{
	...
	while (iVar0 < 4)
	{
		if (!ENTITY::IS_ENTITY_DEAD(&(Local_5[iVar0 /*6*/])))
		{
			...
			{
				(Local_5[iVar0 /*6*/])->f_1 = MAP::_0x23F74C2FDA6E7C61(831283580, &(Local_5[iVar0 /*6*/]));
...
bool func_137(int iParam0, var uParam1, int iParam2, bool bParam3)
{
	return func_201(iParam0, *uParam1, iParam2, bParam3) > 0;
}
...
struct<4> func_139(int iParam0, var uParam1, var uParam2, var uParam3, var uParam4, int iParam5, bool bParam6)
{
	struct<4> Var0;
...
int func_200(var uParam0, var uParam1, var uParam2, var uParam3, var uParam4, bool bParam5, bool bParam6)
{
