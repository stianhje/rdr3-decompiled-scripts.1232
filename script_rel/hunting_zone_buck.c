...
int func_42(var uParam0)
{
	*uParam0 = 5;
	uParam0->f_1 = 1;
	uParam0->f_572[0] = 1407233505;
	uParam0->f_572[1] = -445968941;
	uParam0->f_572[2] = -445968941;
	uParam0->f_580[0] = 1;
	uParam0->f_580[1] = 0;
	uParam0->f_580[2] = 0;
	uParam0->f_588[0] = 4;
...
Vector3 func_160()
{
	return func_203("ATZ_INS_EXC_BK");
}

Vector3 func_161()
{
	return func_203("ATZ_INS_FUR_BK");
}
...
Vector3 func_165()
{
	return func_203("ATZ_INS_TRB_BU");
}
...
Vector3 func_202(int iParam0, int iParam1)
{
	switch (iParam0)
	{
		case 0:
			...
			{
				case 0:
					return -2548.915f, -17.2721f, 170.488f;
				
				case 1:
					return -2510.866f, 3.0647f, 175.7746f;
				
				case 2:
					return -2516.74f, 72.1964f, 174.3078f;
			}
			break;
		...
		case 1:
			...
			{
				case 0:
					return -2588.639f, 109.9716f, 163.9202f;
				
				case 1:
					return -2636.783f, 67.0903f, 161.4891f;
				
				case 2:
					return -2653.483f, 18.0837f, 160.3569f;
			}
			break;
		...
		case 2:
			...
			{
				case 0:
					return -2560.919f, 88.8312f, 172.3058f;
				
				case 1:
					return -2630.401f, 4.9574f, 159.2041f;
				
				case 2:
					return -2612.791f, 34.4457f, 161.8282f;
			}
			break;
		...
		case 3:
			switch (iParam1)
			{
				...
				case 1:
					return -2580.027f, 0.224f, 162.049f;
