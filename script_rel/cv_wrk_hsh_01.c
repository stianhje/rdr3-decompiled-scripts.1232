...
int func_73(var uParam0)
{
	...
	func_154(uParam0, 3.975f, -3.15f, 0.85f, 0f, 1f, 1f, 3.2075f, -1612834106, -1386303207, 1, 1, 1);
	func_154(uParam0, 0.0375f, -0.425f, 0.85f, 0f, 3.345f, 3.345f, 3.2075f, -1612834106, -1386303207, 1, 1, 1);
	func_155(uParam0, -2010730742, 0f, 0f, 0f, "p_filletKnife01x", 0, 1, 1);
	func_155(uParam0, 1475285783, 0f, 0f, 0f, "p_knifesharpener01x", 0, 1, 1);
	if (!func_156(16))
	{
		func_155(uParam0, -199311305, 0f, 0f, 0f, "p_cs_fishbag01x", 0, 1, 1);
	}
	...
	func_159(uParam0, iLocal_14, 3, 2087366558, 0, -1, 0, 55f, 1065353216, 1);
...
int func_85(var uParam0)
{
	if (func_156(16))
	{
		...
		PED::_0xED00D72F81CF7278(iLocal_18, 0, 0);
		func_176(iLocal_18, &(uParam0->f_1984[iLocal_16]), "p_cs_fishbag01x");
		func_176(iLocal_18, &(uParam0->f_1984[iLocal_17]), "p_cs_fishbag01x");
	}
	func_177(126970802);
	return 1;
}
...
void func_160(var uParam0, int iParam1, int iParam2, int iParam3)
{
	...
	{
		case 4:
			(uParam0->f_107[iParam1 /*113*/])->f_32.f_5 = { func_258(func_256(uParam0), func_257(uParam0, iParam1), func_20(uParam0), 1) };
			break;
		
		default:
			Var0 = { func_259(func_256(uParam0), func_257(uParam0, iParam1), func_20(uParam0), 1) };
...
void func_176(int iParam0, int iParam1, char* sParam2)
{
		...
		else
		{
			...
			else
			{
				...
				while (iVar6 < uParam0->f_1984)
				{
					...
					{
						func_176((uParam0->f_1711[iVar0 /*15*/])->f_10, &(uParam0->f_1984[iVar6]), (uParam0->f_1711[iVar0 /*15*/])->f_4);
					}
					iVar6++;
				}
			}
			...
			else
			{
				...
				else
				{
					...
					while (iVar2 < uParam0->f_1984)
					{
						...
						{
							func_176((uParam0->f_1967[iVar1 /*4*/])->f_3, &(uParam0->f_1984[iVar2]), (uParam0->f_1967[iVar1 /*4*/])->f_2);
						}
						iVar2++;
					}
				}
...
void func_251(var uParam0, int iParam1, int iParam2, int iParam3, int iParam4)
{
...
int func_281(var uParam0, int iParam1, vector3 vParam2)
{
	...
	if (func_256(uParam0) == 3 || func_256(uParam0) == 8)
	{
		...
		else if (func_20(uParam0) == 355)
		{
			if (iVar3 == 5)
			{
				if (uParam0->f_3)
				{
					...
					else if (func_365(iVar3, func_100(uParam0->f_7), 1))
					{
					}
					else if (func_367(&uVar2, func_366(iVar3)))
					{
						...
						else
						{
							...
							if (bParam2)
							{
								...
								if (!func_368(iVar0, func_100(uParam0->f_7), 0, -1))
								{
									return -1;
								}
								return iVar0;
...
int func_390(int iParam0, bool bParam1, bool bParam2, var uParam3, var uParam4, var uParam5, float fParam6, bool bParam7, bool bParam8, bool bParam9, bool bParam10)
{
	...
	switch (((*Global_1360165)[iParam0 /*1157*/])->f_70.f_12)
	{
		...
		case 3:
			...
			sVar12 = func_425(iParam0, func_286());
...
void func_392(int iParam0, bool bParam1, bool bParam2, bool bParam3)
{
	...
	if (bParam3)
	{
		func_426(func_105(iParam0), 1f, 0);
	}
	if (bParam1)
	{
		func_427(iParam0);
		...
		case 1:
			switch (iParam0)
			{
				...
				case 13:
					...
					iVar1[2] = -1862464078;
					iVar7 = 3;
					Jump @1186; //curOff = 808
					iVar1[0] = -268604689;
					Jump @1186; //curOff = 821
					iVar1[0] = -268604689;
					iVar1[1] = -1632589543;
					iVar7 = 2;
					Jump @1186; //curOff = 847
					iVar1[0] = -268604689;
					iVar1[1] = -1632589543;
					iVar7 = 2;
					...
					switch (iParam0)
					{
						...
						case 4:
							if (func_326(747937920, 1) && !func_393(((*Global_1347702)[1 /*49*/])->f_15, 1))
							{
								iVar1[0] = -1155031950;
							}
							else
