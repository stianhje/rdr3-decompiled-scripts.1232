...
{
	func_33(uParam0, 10857/*func_30*/, 10908/*func_31*/, 11667/*func_32*/);
}
...
{
	func_46(uParam0, "WOLVES_ALARMED", "", vParam1, vParam4);
	func_47(uParam0, 0, "WAP_WOLF_1", iLocal_9, vParam1, vParam4.z, 1, 1, 1, 1, 41788943, 1);
	func_47(uParam0, 1, "WAP_WOLF_2", iLocal_9, OBJECT::_GET_OBJECT_OFFSET_FROM_COORDS(vParam1, vParam4.z, 0.75f, 0.5f, 0f), (20f + vParam4.z), 1, 1, 1, 1, 41788943, 1);
	func_47(uParam0, 2, "WAP_WOLF_3", iLocal_9, OBJECT::_GET_OBJECT_OFFSET_FROM_COORDS(vParam1, vParam4.z, 4f, 3.5f, 0f), (120f + vParam4.z), 1, 1, 1, 1, 41788943, 1);
	func_47(uParam0, 3, "WAP_WOLF_4", iLocal_10, OBJECT::_GET_OBJECT_OFFSET_FROM_COORDS(vParam1, vParam4.z, 3.5f, -2.5f, 0f), (-110f + vParam4.z), 1, 1, 1, 1, 41788943, 1);
}
...
int func_31(var uParam0)
{
	...
	if (!&uParam0->f_469[1])
	{
		if (func_61(uParam0, &uLocal_18, 0))
		{
			func_62(uParam0);
			func_63(uParam0);
			iLocal_11 = 4;
	...
	switch (iLocal_11)
	{
		case 0:
			if (!ENTITY::IS_ENTITY_DEAD(&(uParam0->f_20[0 /*14*/])))
			{
				...
				TASK::TASK_START_SCENARIO_AT_POSITION(&(uParam0->f_20[0 /*14*/]), -1838821137, (uParam0->f_20[0 /*14*/])->f_5, (uParam0->f_20[0 /*14*/])->f_8, 0, 0, 1, 0, -1082130432, 0);
				func_65(uParam0->f_20[0 /*14*/], 1, 1);
			}
			if (!ENTITY::IS_ENTITY_DEAD(&(uParam0->f_20[1 /*14*/])))
			{
				func_64(&((uParam0->f_20[1 /*14*/])->f_5), 50, 10, 0);
				TASK::TASK_START_SCENARIO_AT_POSITION(&(uParam0->f_20[1 /*14*/]), -1369415261, (uParam0->f_20[1 /*14*/])->f_5, (uParam0->f_20[1 /*14*/])->f_8, 0, 0, 1, 0, -1082130432, 0);
			...
			while (iVar0 <= 3)
			{
				if (!ENTITY::IS_ENTITY_DEAD(&(uParam0->f_20[iVar0 /*14*/])))
				{
					func_64(&((uParam0->f_20[iVar0 /*14*/])->f_5), 50, 10, 0);
					TASK::TASK_START_SCENARIO_AT_POSITION(&(uParam0->f_20[iVar0 /*14*/]), 1588806187, (uParam0->f_20[iVar0 /*14*/])->f_5, (uParam0->f_20[iVar0 /*14*/])->f_8, 0, 0, 1, 0, -1082130432, 0);
					func_65(uParam0->f_20[iVar0 /*14*/], 1, 1);
				}
				iVar0++;
			}
			iLocal_11 = 1;
		...
		case 1:
			if (func_66(uParam0, uParam0->f_493, uParam0->f_494, 4, uParam0->f_495, 1112014848))
			{
				...
				TASK::CLEAR_PED_TASKS(&(uParam0->f_20[2 /*14*/]), 1, 0);
				...
				TASK::_0xE7FA07624574B79A(&(uParam0->f_20[1 /*14*/]), Global_35, 1, 1, 15f, 1, 0, 0, 0);
				TASK::_0xE7FA07624574B79A(&(uParam0->f_20[3 /*14*/]), Global_35, 1, 1, 15f, 1, 0, 0, 0);
				func_67(&uLocal_15);
				iLocal_11 = 3;
			}
			break;
		case 3:
			if (!func_68(&(uParam0->f_20[0 /*14*/]), -875674219))
			{
				TASK::TASK_TURN_PED_TO_FACE_ENTITY(&(uParam0->f_20[0 /*14*/]), Global_35, 0, -1082130432, -1082130432, -1082130432);
			}
			if (!func_68(&(uParam0->f_20[2 /*14*/]), -875674219))
			{
				TASK::TASK_TURN_PED_TO_FACE_ENTITY(&(uParam0->f_20[2 /*14*/]), Global_35, 0, -1082130432, -1082130432, -1082130432);
			}
			if (func_69(&(uParam0->f_20[0 /*14*/]), Global_35, 1) < 324f || func_70(&uLocal_15, 12.5f))
			{
...
void func_62(var uParam0)
{
	...
	while (iVar0 <= 4)
	{
		if (!ENTITY::IS_ENTITY_DEAD(&(uParam0->f_20[iVar0 /*14*/])))
		{
			...
			TASK::_TASK_SMART_FLEE_STYLE_PED(0, Global_35, 2, 256, -1082130432, -1, 0);
			TASK::CLOSE_SEQUENCE_TASK(iVar6);
			TASK::_TASK_PERFORM_SEQUENCE_2(&(uParam0->f_20[iVar0 /*14*/]), iVar6, &(fVar1[iVar0]), &(fVar1[iVar0]));
...
int func_157(int iParam0, var uParam1)
{
	...
	else if (func_149() - uParam1->f_4) > func_208(uParam1)
	{
		return func_209(iParam0, uParam1, 0, -1082130432);
	}
	return 0;
}
...
int func_181(int iParam0, bool bParam1, bool bParam2, bool bParam3, int iParam4, int iParam5)
{
	...
	if (bParam3)
	{
		if (((WEAPON::_0xCB690F680A3EA971(iVar0, 1) && PLAYER::IS_PLAYER_TARGETTING_ENTITY(iVar1, iParam0, iParam5)) && PLAYER::IS_PLAYER_FREE_AIMING_AT_ENTITY(iVar1, iParam0)) && func_198(iVar0, iParam0, 1, 1) <= 4f)
		{
			return 1;
		}
	}
...
int func_185(int iParam0, bool bParam1, bool bParam2, bool bParam3, int iParam4)
{
	...
	if (PLAYER::IS_PLAYER_FREE_AIMING(iVar1))
	{
		if (WEAPON::_0x6AD66548840472E5(func_217(iVar0, 0)))
		{
			if (func_219(ENTITY::GET_ENTITY_COORDS(iParam0, true, false), 0.4f, 0.6f, 0.3f, 0.7f))
			{
				return 1;
			}
		}
...
{
	if (func_220(iParam0, vParam4, 0.5f))
	{
...
int func_196(int iParam0, int iParam1)
{
	...
	if (func_223(iParam0, 1, 0, 0) != 2055893578)
	{
		return 0;
	}
...
float func_198(int iParam0, int iParam1, bool bParam2, int iParam3)
{
...
int func_199(int iParam0, int iParam1, vector3 vParam2)
{
	float fVar0;
...
int func_207(int iParam0)
{
	...
	return func_225(((*Global_1347702)[58 /*49*/])->f_15, 1);
}
...
void func_210(int iParam0, int iParam1, int iParam2, int iParam3, int iParam4, int iParam5, bool bParam6, int iParam7)
{
	int iVar0;

	iVar0 = (((iParam2 + (60 * iParam3)) + (3600 * iParam4)) + (86400 * iParam5));
	if (func_226(iParam0) == 1 && iParam7)
	{
		return;
	}
	if (bParam6)
...
int func_218(int iParam0, float fParam1, float fParam2, float fParam3, float fParam4)
{
	if (!ENTITY::IS_ENTITY_DEAD(iParam0))
	{
		if (func_219(ENTITY::GET_ENTITY_COORDS(iParam0, true, false), fParam1, fParam2, fParam3, fParam4))
		{
			return 1;
		}
	}
...
int func_219(vector3 vParam0, float fParam3, float fParam4, float fParam5, float fParam6)
{
	float fVar0;
	float fVar1;
	bool bVar2;
