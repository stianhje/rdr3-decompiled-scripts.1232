		...
		if (func_61(&(uLocal_15[iVar0]), 0, 0))
		{
			...
			switch (iVar0)
			{
				...
				case 2:
					...
					TASK::_TASK_USE_SCENARIO_POINT(&(uLocal_15[iVar0]), &(Local_274.f_47[0]), 0, -1, 0, 1, 0, 0, -1082130432, 0);
					break;
			}
	...
	else if (uLocal_15.f_19 < ((uLocal_15.f_215 + uLocal_15.f_216) + uLocal_15.f_217))
	{
		...
		if (ENTITY::DOES_ENTITY_EXIST(&(uLocal_15.f_49[iVar0])))
		{
			if (!func_228(&uLocal_15, iVar0, 8))
			{
				...
				{
					if (func_229(&(uLocal_15.f_49[iVar0]), 200f, -1082130432))
					{
...
void func_126(int iParam0)
{
	...
	func_272(&(uLocal_15[iParam0]), -618550132, -1, 0, 0, 1056964608, 1065353216, 0);
	iVar0 = func_273(iParam0);
	switch (iVar0)
	{
		case 1845102363:
			func_274(&uLocal_15, &(uLocal_15[iParam0]), 1845102363, 1);
			break;
		default:
...
var func_134(int iParam0, vector3 vParam1, float fParam4, float fParam5, int iParam6, int iParam7)
{
...
void func_144()
{
	...
	if (AUDIO::_0x4A98E228A936DBCC(&(uLocal_15[0])) == 841045117)
	{
		bVar2 = true;
	}
	...
	{
		func_283(&(uLocal_15[0]), Global_35, "OPENS_FIRE", -1073741824, 1, 1744022339, 0);
		bVar2 = true;
	}
	iVar0 = 0;
	while (iVar0 <= 4)
	{
		...
		else
		{
			...
			if (!bVar2)
			{
				func_283(&(uLocal_15[iVar0]), Global_35, "OPENS_FIRE", -1073741824, 1, 1744022339, 0);
				bVar2 = true;
			}
		}
		iVar0++;
	...
	switch (Local_274.f_5)
	{
		...
		case 1:
			...
			if (func_47(Local_274.f_8[1 /*3*/], 0.5f))
			{
				...
				func_283(&(uLocal_15[2]), Global_35, "CALL_FOR_SUPPORT", -1073741824, 1, -500314840, 1);
		...
		case 2:
			func_306();
			if (func_47(Local_274.f_8[1 /*3*/], 1.5f) || func_222(&(uLocal_15[0]), 1116471296, -1082130432, -1082130432, -1082130432))
			{
				func_307();
				func_190(Local_274.f_8[1 /*3*/]);
		...
		case 3:
			...
			if (func_47(Local_274.f_8[1 /*3*/], 2.5f))
			{
				...
				if (func_283(&(uLocal_15[0]), Global_35, "TAUNT_GEN_LOCATION", -1073741824, 1, -500314840, 0))
				{
			...
			if (!func_139(&Local_274, 4096))
			{
				if (func_327(-2f, 1, 0, 0))
				{
					...
					while (iVar0 <= 4)
					{
						...
						{
							func_283(&(uLocal_15[iVar0]), Global_35, "TAUNT_GEN_LOCATION", -1073741824, 1, -500314840, 0);
						}
						else
						{
							iVar0++;
	...
	if (Local_274.f_5 >= 2)
	{
		if (func_61(&(uLocal_15[2]), 0, 0))
		{
			if ((func_152(&(uLocal_15[2]), Global_36, 0) < 9f || func_280(*(Local_274.f_58[0 /*3*/]), *(Local_274.f_58[1 /*3*/]), ENTITY::GET_ENTITY_COORDS(&(uLocal_15[2]), true, false))) || ENTITY::HAS_ENTITY_BEEN_DAMAGED_BY_ANY_PED(&(uLocal_15[2])))
			{
				...
				func_285(&uLocal_15, 2, 831283580, 0);
...
void func_306()
{
	...
	func_420(&(uLocal_15[2]), &(Local_274.f_65), vVar0, 1, 30f, (Local_274.f_46 + 2f), 3000, 4000, 1000, 1075838976, 0, 1, 1084227584);
}
...
void func_310(int iParam0)
{
	...
	if (ENTITY::WOULD_ENTITY_BE_OCCLUDED(363815774, ENTITY::GET_ENTITY_COORDS(&(uLocal_15[iParam0]), true, false), true))
	{
		...
		func_285(&uLocal_15, iParam0, 831283580, 0);
	}
	else
	{
