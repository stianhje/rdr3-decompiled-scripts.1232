...
int func_167(var uParam0, vector3 vParam1, int iParam4, var uParam5, char* sParam6, bool bParam7)
{
	if (ENTITY::DOES_ENTITY_EXIST(iLocal_23))
	{
		return 1;
	...
	if (!TASK::_0x841475AC96E794D1(*uParam5))
	{
		*uParam5 = TASK::_0xF533D68FF970D190(vParam1, iParam4, 1f, 0, 0);
		return 0;
	}
	if (!ENTITY::DOES_ENTITY_EXIST(iLocal_23))
	{
		iLocal_23 = ENTITY::GET_OBJECT_INDEX_FROM_ENTITY_INDEX(TASK::_0x295514F198EFD0CA(*uParam5, sParam6));
	}
	if (TASK::_0x6EF4E31B4D5D2DA0(*uParam5, sParam6))
	{
	}
	return 0;
}
