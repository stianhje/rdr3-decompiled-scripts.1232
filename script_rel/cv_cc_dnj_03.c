...
int func_72(var uParam0)
{
	...
	func_151(uParam0, 2f, -1f, 0f, -7.92f, 5f, 5f, 5f, -1612834106, -1495061186, 1, 1, 1);
	...
	func_153(uParam0, "script@vignette@dutch_and_john_3@base", 1, 1, 0, 0);
	iLocal_14 = func_153(uParam0, "script@vignette@dutch_and_john_3@action_a", 2, 0, 1, 0);
	iLocal_15 = func_153(uParam0, "script@vignette@dutch_and_john_3@action_b", 0, 0, 0, 0);
	iLocal_16 = func_153(uParam0, "script@vignette@dutch_and_john_3@action_b_alt_left", 0, 0, 0, 1);
	iLocal_17 = func_153(uParam0, "script@vignette@dutch_and_john_3@action_b_alt_right", 0, 0, 0, 1);
	func_154(uParam0, "DNJ3AUD");
	iLocal_20 = func_155(uParam0, 4.475f, 3.5762f, 2.4264f, 0f, 0f, 169.265f, 16.4725f, 17.09f, 5f, "Start_Trigger", -1612834106);
	func_156(uParam0, 1);
	Local_22 = { func_157(uParam0, -0.1365f, -0.621f, 0.9877f, -112.32f, 6.1f, 0.3625f, 0.005f) };
	Local_32 = { func_157(uParam0, -0.1185f, -0.6235f, 0.9877f, -147.24f, 3.475f, 0.384f, 0.7465f) };
...
{
	return func_190(Global_35, iLocal_20, 1, 0);
}
...
int func_93(var uParam0)
{
	...
	{
		if (func_199(uParam0, Local_22, 1, 1))
		{
			func_188(uParam0, iLocal_16, 1);
		}
		else if (func_199(uParam0, Local_32, 1, 1))
		{
...
int func_155(var uParam0, vector3 vParam1, vector3 vParam4, vector3 vParam7, char* sParam10, int iParam11)
{
	int iVar0;
	vector3 vVar1;
	...
	vVar1 = { func_252(uParam0, vParam1) };
...
struct<10> func_157(var uParam0, vector3 vParam1, float fParam4, float fParam5, float fParam6, float fParam7)
{
	float fVar0;
	float fVar1;
	struct<10> Var2;
...
int func_188(var uParam0, int iParam1, bool bParam2)
{
	...
	if (bParam2)
	{
		...
		while (iVar1 < uParam0->f_1984)
		{
			...
			else if (func_290(uParam0, iVar1) || func_198(uParam0, iVar1))
			{
