		...
		if (MISC::GET_GAME_TIMER() > iLocal_170)
		{
			...
			switch (iLocal_169)
			{
				...
				case 1:
					...
					LAW::_0x9BBDCB8DF789EBC1(PLAYER::PLAYER_ID(), func_9(iLocal_171));
...
void func_28(int iParam0)
{
	...
	if (VOLUME::_0x92A78D0BEDB332A3(iLocal_165))
	{
...
void func_79(int iParam0)
{
	...
	if (VOLUME::_0x92A78D0BEDB332A3(iLocal_166))
	{
...
int func_94(int iParam0, bool bParam1)
{
	...
	{
		func_149(iParam0, _NAMESPACE48::_0x4F76E3676583D951(func_148(iParam0)));
		if (func_20() == -1)
		{
...
int func_190(var uParam0, bool bParam1)
{
	...
	if ((Global_1914319->f_17371 || func_231(func_54(*uParam0), 1, 1, 1, 0)) || PED::_0x3AA24CCC0D451379(func_54(*uParam0)))
	{
		func_226(uParam0);
		return uParam0->f_30;
	}
...
int func_233()
{
	if (PED::_0xA911EE21EDF69DAF(Global_35) || func_270(Global_35))
	{
		return 1;
	}
	return 0;
