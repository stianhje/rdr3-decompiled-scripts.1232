...
{
	func_36(uParam0, 11213/*func_33*/, 11284/*func_34*/, 12077/*func_35*/);
}
...
int func_11(int iParam0, int iParam1, int iParam2, bool bParam3, bool bParam4)
{
	int iVar0;
	int iVar1;
	float fVar2;
	...
	{
		fVar3 = func_38(iParam0);
		fVar3 = (fVar3 * fVar3);
		fVar4 = func_39(iParam0);
		fVar4 = (fVar4 * fVar4);
		iVar0 = (Global_1415419->f_19[iParam0 /*12*/])->f_8;
		while (iVar0 <= (Global_1415419->f_19[iParam0 /*12*/])->f_9)
		{
			*iParam1++;
			if (!func_40(iParam0, *(Global_1415419->f_2996[iVar0 /*7*/])))
			{
			}
			else
			{
				...
				if (iParam2 && iParam0 != 34)
				{
					...
					{
						if (func_42(*(Global_1415419->f_2996[iVar0 /*7*/]), fVar6, (iParam0 <= 33 || iParam0 == 72), bParam4, fVar3, fVar4, iParam0))
						{
							iVar1 = iVar0;
							fVar2 = fVar6;
							if (bParam3)
...
int func_42(vector3 vParam0, float fParam3, bool bParam4, bool bParam5, float fParam6, float fParam7, int iParam8)
{
	float fVar0;
	int iVar1[3];
	var uVar5;
