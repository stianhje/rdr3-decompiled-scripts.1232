...
{
	func_33(uParam0, 10977/*func_30*/, 11086/*func_31*/, 11403/*func_32*/);
}
...
int func_28(var uParam0)
{
	if (!ENTITY::IS_ENTITY_DEAD(&(uParam0->f_20[0 /*14*/])))
	{
		...
		if (TASK::_0x02EBBB3989B7E695(&(uParam0->f_20[0 /*14*/])) && func_61(uParam0, 1065353216, 40f, 4, 15f, 15f))
		{
			func_62(uParam0);
			return 1;
		}
...
void func_166(int iParam0, int iParam1, int iParam2, int iParam3, int iParam4, int iParam5, bool bParam6, int iParam7)
{
	int iVar0;
