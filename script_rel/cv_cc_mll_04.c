...
int func_72(var uParam0)
{
	...
	func_151(uParam0, -6.2199f, -0.4333f, 0.8367f, 0f, 1.5f, 1.5f, 3f, -1612834106, -727195357, 1, 1, 1);
	func_151(uParam0, -0.0006f, -0.0029f, 0.5041f, 0f, 1.5f, 2.02f, 3f, -1612834106, 2017216891, 1, 1, 1);
	uLocal_19 = func_152(uParam0, 531527393, 0f, 0f, 0f, 0, 1, 0, 1);
	func_152(uParam0, joaat("p_cs_pillow01x"), 0f, 0f, 0f, "PILLOW", 0, 0, 1);
	func_153(uParam0, "script@vignette@molly_4@base", 1, 1, 0, 0);
	iLocal_16 = func_153(uParam0, "script@vignette@molly_4@action_a", 2, 0, 1, 0);
	iLocal_17 = func_153(uParam0, "script@vignette@molly_4@action_b", 0, 0, 0, 0);
	iLocal_18 = func_153(uParam0, "script@vignette@molly_4@action_b_alt", 0, 0, 0, 1);
	...
	func_157(uParam0, iLocal_15, 3, 343112864, "PROP_HUMAN_SLEEP_BED_PILLOW_MALE_B", uLocal_19, 0, -1073741824, 1065353216, 1);
	func_158(uParam0, iLocal_15, 0);
	Local_20 = { func_159(uParam0, -2.6633f, -1.8669f, 1.0082f, -162.72f, 8f, 0.5f, 0.5f) };
	return 1;
}
...
bool func_77(var uParam0)
{
	if (!iLocal_31)
	{
		uLocal_30 = STREAMING::_0xB223249B7798EEED(func_48(uParam0, iLocal_15), 343112864, 5, -1580271320);
		iLocal_31 = 1;
	}
...
int func_189(var uParam0, int iParam1, bool bParam2)
{
	...
	if (bParam2)
	{
		...
		while (iVar1 < uParam0->f_1984)
		{
			...
			else if (func_199(uParam0, iVar1) || func_197(uParam0, iVar1))
			{
