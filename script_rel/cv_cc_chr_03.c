...
int func_72(var uParam0)
{
	...
	func_151(uParam0, -0.5266f, -1.2093f, 0.5026f, -22.5144f, 1.5f, 1.5f, 3f, -1612834106, 463023307, 1, 1, 1);
	func_151(uParam0, 0.5733f, 1.1645f, 0.4966f, 155.6634f, 1.5f, 1.5f, 3f, -1612834106, -676766751, 1, 1, 1);
	uLocal_16 = func_152(uParam0, 264425748, -0.585f, -1.372f, -0.001f, 0, 1, 0, 1);
	uLocal_17 = func_152(uParam0, 1504738597, 0.636f, 0.636f, -0.004f, 0, 1, 0, 1);
	iLocal_18 = func_152(uParam0, 587066646, 0f, 0f, 0f, "CHARLES_BOWL", 0, 0, 1);
	func_152(uParam0, -755866836, 0f, 0f, 0f, "CHARLES_SPOON", 0, 1, 1);
	iLocal_19 = func_152(uParam0, 587066646, 0f, 0f, 0f, "LENNY_BOWL", 0, 0, 1);
	func_152(uParam0, -755866836, 0f, 0f, 0f, "LENNY_SPOON", 0, 1, 1);
	func_153(uParam0, "script@vignette@charles_3@base", 1, 1, 0, 0);
	func_153(uParam0, "script@vignette@charles_3@action", 0, 0, 1, 0);
	func_154(uParam0, "CCHR3AU");
	func_155(uParam0, iLocal_14, 3, 1627566189, "PROP_CAMP_SEAT_CHAIR_TABLE_STEW_EATING_MALE_A", uLocal_16, 0);
	func_156(uParam0, iLocal_14, 3, -726772127, "PROP_CAMP_SEAT_CHAIR_TABLE_STEW_RESTING_LAZY_MALE_A", uLocal_16, 0, -1073741824, 1065353216, 1);
	func_157(uParam0, iLocal_14, 1, 1, 0, 0, 0);
	func_155(uParam0, iLocal_15, 3, 1627566189, "PROP_CAMP_SEAT_CHAIR_TABLE_STEW_EATING_MALE_B", uLocal_17, 0);
	func_156(uParam0, iLocal_15, 3, -726772127, "PROP_CAMP_SEAT_CHAIR_TABLE_STEW_RESTING_LAZY_MALE_B", uLocal_17, 0, -1073741824, 1065353216, 1);
	STREAMING::_0x19A6BE7D9C6884D3(1627566189, 1, 0, 0);
	STREAMING::_0x19A6BE7D9C6884D3(-726772127, 1, 0, 0);
	return 1;
}
