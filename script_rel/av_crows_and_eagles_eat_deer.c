...
{
	func_33(uParam0, 11174/*func_30*/, 11247/*func_31*/, 11640/*func_32*/);
}
...
{
	func_46(uParam0, "CROWS_AND_EAGLES_EAT_DEER", "script@ambient@animal@scavengers@crows_eagle_eating_deer@action", vParam1, vParam4);
	func_47(uParam0, 1, "pbl_action", "", 0);
	func_48(uParam0, 0, "CROW_1", iLocal_9, 0f, 0f, 0f, 0f, 1, 1, 1, 1, 41788943, 1);
	func_48(uParam0, 1, "CROW_2", iLocal_9, 0f, 0f, 0f, 0f, 1, 1, 1, 1, 41788943, 1);
	func_48(uParam0, 2, "CROW_3", iLocal_9, 0f, 0f, 0f, 0f, 1, 1, 1, 1, 41788943, 1);
	func_48(uParam0, 3, "CROW_4", iLocal_9, 0f, 0f, 0f, 0f, 1, 1, 1, 1, 41788943, 1);
	func_48(uParam0, 4, "EAGLE_1", iLocal_10, 0f, 0f, 0f, 0f, 1, 1, 1, 1, 41788943, 1);
	func_48(uParam0, 5, "EAGLE_2", iLocal_10, 0f, 0f, 0f, 0f, 1, 1, 1, 1, 41788943, 1);
	func_48(uParam0, 6, "EAGLE_3", iLocal_10, 0f, 0f, 0f, 0f, 1, 1, 1, 1, 41788943, 1);
	func_48(uParam0, 7, "DEER", iLocal_11, vParam1, (-90f + vParam4.z), 1, 0, 1, 1, 41788943, 1);
}
...
int func_28(var uParam0)
{
	...
	while (iVar0 <= 6)
	{
		if (!ENTITY::IS_ENTITY_DEAD(&(uParam0->f_20[iVar0 /*14*/])))
		{
			func_57(uParam0->f_20[iVar0 /*14*/], 1, 1);
			ENTITY::SET_ENTITY_NO_COLLISION_ENTITY(&(uParam0->f_20[iVar0 /*14*/]), &(uParam0->f_20[7 /*14*/]), true);
			ENTITY::SET_ENTITY_NO_COLLISION_ENTITY(&(uParam0->f_20[7 /*14*/]), &(uParam0->f_20[iVar0 /*14*/]), true);
		}
		iVar0++;
	}
	if (!ENTITY::IS_ENTITY_DEAD(&(uParam0->f_20[7 /*14*/])))
	{
		...
		PED::_0xCE6B874286D640BB(&(uParam0->f_20[7 /*14*/]), 0);
...
int func_31(var uParam0)
{
	...
	if (!&uParam0->f_469[1])
	{
		...
		{
			if (func_66(uParam0, uParam0->f_493, uParam0->f_494, 4, uParam0->f_495, 1112014848) || func_67(uParam0, &uLocal_13, 1))
			{
				if (ANIMSCENE::_0x25557E324489393C(uParam0->f_3.f_1))
				{
					if (ANIMSCENE::_0x477122B8D05E7968(uParam0->f_3.f_1, 1, 0))
	...
	{
		if (func_69(uParam0, 1.5f, 40f, 4, -91962372, 1))
		{
				...
				if (ANIMSCENE::_0x477122B8D05E7968(uParam0->f_3.f_1, 1, 0))
				{
					if (ANIMSCENE::_0x1F0E401031E20146(uParam0->f_3.f_1, "pbl_action"))
					{
						...
						while (iVar0 <= 6)
						{
							...
							if (func_72(&(uParam0->f_20[iVar0 /*14*/]), 518218985))
							{
								Jump @358; //curOff = 344
							}
							else
...
int func_66(var uParam0, float fParam1, float fParam2, int iParam3, float fParam4, float fParam5)
{
	...
	if ((MISC::GET_FRAME_COUNT() % 8) == 0)
	{
		...
		fVar7 = func_107(Global_36, uParam0->f_483);
		...
		while (iVar0 < uParam0->f_19)
		{
			...
			if (!ENTITY::IS_ENTITY_DEAD(&(uParam0->f_20[iVar0 /*14*/])))
			{
				...
				fVar8 = func_108(Global_35, &(uParam0->f_20[iVar0 /*14*/]), 1);
				if (fVar8 < fVar1)
				{
					return 1;
				}
...
int func_67(var uParam0, var uParam1, int iParam2)
{
	...
	{
		if (func_113(&(uParam0->f_20[uParam0->f_501 /*14*/]), 0, uParam1, &(uParam0->f_468), 0, 0))
		{
			return 1;
		}
		uParam0->f_501++;
		...
		while (iVar0 < uParam0->f_19)
		{
			...
			else
			{
				if (!ENTITY::IS_ENTITY_DEAD(&(uParam0->f_20[iVar0 /*14*/])))
				{
					...
					{
						if ((func_108(Global_35, &(uParam0->f_20[iVar0 /*14*/]), 1) < fParam2 && PED::_0x5102307CE88798EB(&(uParam0->f_20[iVar0 /*14*/]))) && PED::IS_TRACKED_PED_VISIBLE(&(uParam0->f_20[iVar0 /*14*/])))
						{
							if (!func_109(&(uParam0->f_490)))
							{
...
float func_89(int iParam0, vector3 vParam1, bool bParam4)
{
	vector3 vVar0;
...
int func_113(int iParam0, int iParam1, var uParam2, var uParam3, int iParam4, float fParam5)
{
	int iVar0;
