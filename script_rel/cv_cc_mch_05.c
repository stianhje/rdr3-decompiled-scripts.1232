...
int func_72(var uParam0)
{
	switch (func_148(uParam0))
	{
		...
		case 3:
			...
			break;
		case 6:
			func_149(uParam0, 2351.282f, 1362.077f, 104.9752f, 0f, 0.3f, -100.7f);
			break;
	}
	func_151(uParam0, -1.4625f, 1.1049f, 1.0409f, 32.76f, 2.02f, 1.21f, 2.5f, -1612834106, 1632043240, 1, 1, 1);
	func_151(uParam0, 1.2062f, -1.9135f, 0.4965f, 34.92f, 1f, 1f, 2.5f, -1612834106, -1495061186, 1, 1, 1);
	func_152(uParam0, 0f, 0f, 0.4965f, 0f, 1.75f, 1.75f, 2.5f, 665633627, 1);
	...
	uLocal_21 = func_154(uParam0, joaat("p_chairfolding02x"), 1.20082f, -1.86806f, -0.0284729f, 0, 1, 0, 1);
	func_155(uParam0, "script@vignette@micah_5@base", 1, 1, 0, 0);
	iLocal_16 = func_155(uParam0, "script@vignette@micah_5@action_a", 2, 0, 1, 0);
	iLocal_17 = func_155(uParam0, "script@vignette@micah_5@action_b", 0, 0, 0, 0);
	iLocal_18 = func_155(uParam0, "script@vignette@micah_5@action_b_alt_left", 0, 0, 0, 1);
	iLocal_19 = func_155(uParam0, "script@vignette@micah_5@action_b_alt_right", 0, 0, 0, 1);
	func_156(uParam0, "CMCH5AU");
	func_157(uParam0, iLocal_15, 3, -1);
	func_158(uParam0, iLocal_14, 3, -38747227, "PROP_CAMP_FIRE_SEAT_CHAIR_MALE_B", uLocal_21, 0);
	func_159(uParam0, iLocal_14, 3, -38747227, "PROP_CAMP_FIRE_SEAT_CHAIR_MALE_B", uLocal_21, 0, -1073741824, 1065353216, 1);
	func_160(uParam0, iLocal_14, iLocal_20, "p_stickFirePoker01x_PH_R_HAND", 0, 0);
	func_157(uParam0, iLocal_14, 1, -1);
	func_161(uParam0, -1481567772, 2127206375);
	Local_22 = { func_162(uParam0, -1.3125f, 1.7049f, 1.0409f, -44.28f, 8f, 0.5f, 0.5f) };
	Local_32 = { func_162(uParam0, -1.3125f, 1.7049f, 1.0409f, 117f, 7f, 0.5f, 0.5f) };
	return 1;
}
...
void func_158(var uParam0, int iParam1, int iParam2, int iParam3, char* sParam4, var uParam5, int iParam6)
{
...
void func_159(var uParam0, int iParam1, int iParam2, int iParam3, char* sParam4, var uParam5, int iParam6, float fParam7, int iParam8, int iParam9)
{
...
int func_192(var uParam0, int iParam1, bool bParam2)
{
	...
	if (bParam2)
	{
		...
		while (iVar1 < uParam0->f_1984)
		{
			...
			else if (func_293(uParam0, iVar1) || func_200(uParam0, iVar1))
			{
			...
			if (!(uParam0->f_107[iVar0 /*113*/])->f_32)
			{
				if (func_305(uParam0, iVar0))
				{
					if ((uParam0->f_107[iVar0 /*113*/])->f_32.f_48)
					{
						...
						func_306(uParam0, iVar0, 0, 1);
					}
					else
					{
						func_306(uParam0, iVar0, 1, 1);
					}
...
void func_306(var uParam0, int iParam1, bool bParam2, bool bParam3)
{
	var uVar0;
		...
		case 7:
			switch (iParam0)
			{
				...
				case 14:
					...
					break;
				case 4:
					if (func_325(747937920, 1) && !func_391(((*Global_1347702)[1 /*49*/])->f_15, 1))
					{
						iVar1[0] = -1155031950;
					}
					else
