...
int func_72(var uParam0)
{
	...
	{
		case 0:
			func_149(uParam0, -1347.485f, 2407.773f, 306.0743f, 0f, 0f, 162.8f);
			break;
		default:
			return 0;
	}
	func_150(uParam0, -0.5962f, 0.1022f, 1.0076f, 84.6f, 1f, 1f, 3f, -1612834106, 1267380940, 1, 1, 1);
	iLocal_14 = func_151(uParam0, 5, 0);
	func_152(uParam0, "script@vignette@hosea_1@base", 1, 1, 0, 0);
	iLocal_15 = func_152(uParam0, "script@vignette@hosea_1@action_a", 2, 0, 1, 1);
	iLocal_16 = func_152(uParam0, "script@vignette@hosea_1@action_b", 0, 0, 0, 1);
	func_153(uParam0, "CCHSAUD");
	Local_17 = { func_154(uParam0, -0.4469f, -0.1258f, 1.1107f, 150.84f, 7f, 0.6f, 0.6f) };
	Local_27 = { func_154(uParam0, -0.4469f, -0.1258f, 1.1107f, 166.32f, 10f, 0.8f, 0.8f) };
	func_155(uParam0, iLocal_14, 3, 421625586, "WORLD_HUMAN_LEAN_BACK_WALL_MALE_D", -1, 1);
	func_156(uParam0, 1);
...
{
	return func_189(uParam0, Local_17, 1, 0);
}
...
int func_93(var uParam0)
{
	...
	{
		if (func_189(uParam0, Local_27, 1, 0))
		{
...
int func_188(var uParam0, int iParam1, bool bParam2)
{
	...
	if (bParam2)
	{
		...
		while (iVar1 < uParam0->f_1984)
		{
			...
			else if (func_287(uParam0, iVar1) || func_197(uParam0, iVar1))
			{
...
int func_189(var uParam0, struct<4> Param1, var uParam5, var uParam6, var uParam7, var uParam8, var uParam9, var uParam10, bool bParam11, bool bParam12)
{
	if (bParam11)
	{
		if (!func_289(func_19(uParam0), 1))
		{
			return 0;
		}
	}
	...
	if (!func_290(Param1, Param1.f_6, Global_36))
	{
		return 0;
	}
	if (func_290(Param1, Param1.f_3, Global_36))
	{
		return 0;
	}
	if (bParam12)
...
void func_198(var uParam0, int iParam1, bool bParam2, bool bParam3)
{
	...
	if (bParam3)
	{
		uVar0 = func_298(uParam0, iParam1);
	}
	if (bParam2)
	{
...
bool func_290(struct<2> Param0, var uParam2, struct<2> Param3, var uParam5, struct<2> Param6, var uParam8)
{
...
void func_340(var uParam0, int iParam1)
{
	...
	func_379(sVar1, uVar2, uVar3, iVar4);
}
...
int func_344(var uParam0, int iParam1)
{
	...
	while (iVar2 <= iVar1)
	{
		...
		else
		{
			...
			vVar10 = { func_382(fVar9) };
			vVar13 = { func_383(ENTITY::GET_ENTITY_COORDS((uParam0->f_107[iParam1 /*113*/])->f_5, true, false), vVar3, 1065353216) };
...
void func_379(char* sParam0, var uParam1, var uParam2, int iParam3)
{
...
Vector3 func_382(float fParam0)
{
	return -BUILTIN::SIN(fParam0), BUILTIN::COS(fParam0), 0f;
}

Vector3 func_383(vector3 vParam0, vector3 vParam3, float fParam6)
{
	return func_410(vParam3 - vParam0) * Vector(fParam6, fParam6, fParam6);
}
...
void func_417(int iParam0, int iParam1)
{
	...
	func_378(iParam0, func_447(iParam1));
	...
	func_389(iParam1, func_445(iParam1, 8192), func_445(iParam1, 16384), 1);
}
		...
		case 1:
			switch (iParam0)
			{
				...
				case 9:
					...
					break;
				case 10:
					if (func_390(((*Global_1347702)[63 /*49*/])->f_15, 1) || func_427(((*Global_1347702)[63 /*49*/])->f_15))
					{
						iVar1[0] = -268604689;
					}
					else
		...
		case 3:
			switch (iParam0)
			{
				...
				case 10:
					...
					break;
				case 11:
					if (func_390(((*Global_1347702)[134 /*49*/])->f_15, 1) || func_427(((*Global_1347702)[134 /*49*/])->f_15))
					{
						iVar1[0] = -2040275819;
						iVar1[1] = 1205492208;
						iVar7 = 2;
		...
		case 7:
			switch (iParam0)
			{
				...
				case 14:
					...
					break;
				case 4:
					if (func_320(747937920, 1) && !func_390(((*Global_1347702)[1 /*49*/])->f_15, 1))
					{
						iVar1[0] = -1155031950;
					}
					else
