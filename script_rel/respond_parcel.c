...
struct<5> func_502(int iParam0)
{
	...
	Var0 = { func_503(iParam0, 1328661203, func_395(), -1591664384) };
	Var0.f_4 = 1084182731;
	return Var0;
}

struct<4> func_503(int iParam0, int iParam1, var uParam2, var uParam3, var uParam4, var uParam5, int iParam6)
{
	struct<4> Var0;
