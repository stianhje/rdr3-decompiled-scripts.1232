...
{
	func_33(uParam0, 10809/*func_30*/, 10875/*func_31*/, 11718/*func_32*/);
}
...
{
	func_46(uParam0, "BUFFALO_VS_BUFFALO", "script@ambient@animal@buffalo_vs_buffalo@action", vParam1, vParam4);
	uParam0->f_16 = 1;
	func_47(uParam0, 1, "pbl_action", "", 0);
	func_48(uParam0, 0, "BUFFALO1", iLocal_9, 0f, 0f, 0f, 0f, 1, 1, 1, 1, 41788943, 0);
	func_48(uParam0, 1, "BUFFALO2", iLocal_9, 0f, 0f, 0f, 0f, 1, 1, 1, 1, 41788943, 0);
}
...
int func_31(var uParam0)
{
	...
	if (!&uParam0->f_469[0])
	{
		if (!bLocal_38 == 1)
		{
			if (func_64(uParam0, &uLocal_10, 1) || func_65(Global_35, uParam0->f_483, 1) <= 400f)
			{
				bLocal_38 = true;
			}
		}
...
void func_70(var uParam0)
{
	if (!ENTITY::IS_ENTITY_DEAD(&(uParam0->f_20[0 /*14*/])))
	{
		if (!func_108(&(uParam0->f_20[0 /*14*/]), 518218985))
		{
			...
			func_109(uParam0->f_20[0 /*14*/], 0, 1);
	...
	if (!ENTITY::IS_ENTITY_DEAD(&(uParam0->f_20[1 /*14*/])))
	{
		if (!func_108(&(uParam0->f_20[1 /*14*/]), 518218985))
		{
			...
			func_109(uParam0->f_20[1 /*14*/], 0, 1);
...
float func_116(int iParam0, int iParam1, bool bParam2)
{
	...
	return func_102(ENTITY::GET_ENTITY_COORDS(iParam0, false, false), ENTITY::GET_ENTITY_COORDS(iParam1, false, false));
}
...
int func_164(int iParam0, var uParam1)
{
	...
	else if (func_156() - uParam1->f_4) > func_213(uParam1)
	{
