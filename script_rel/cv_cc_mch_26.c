...
int func_72(var uParam0)
{
	...
	iLocal_22 = func_152(uParam0, -1006095118, 1.83629f, -3.58281f, 0.0174561f, "CHAIR", 1, 0, 1);
	...
	func_157(uParam0, iLocal_15, 3, -1426662425, "PROP_HUMAN_SEAT_CHAIR_GENERIC_MALE_D", iLocal_22, 0, -1073741824, 1065353216, 1);
...
void func_434(int iParam0, int iParam1)
{
	...
	switch (iParam0)
	{
		case 11:
			...
			{
				func_475(iParam1, 1240907314, 0, 0, 2, 1, 0, 1056964608, 1065353216, -1, 0, 0, 0, 0);
				func_475(iParam1, -2088446466, 0, 0, 3, 1, 1, 1056964608, 1065353216, -1, 0, 1, 0, 0);
			}
			break;
	}
}
