...
{
	func_33(uParam0, 10745/*func_30*/, 10864/*func_31*/, 11206/*func_32*/);
}
	...
	switch (iLocal_9)
	{
		case 0:
			if (!ENTITY::IS_ENTITY_DEAD(&(uParam0->f_20[0 /*14*/])))
			{
				...
				WEAPON::_GIVE_WEAPON_TO_PED_2(&(uParam0->f_20[0 /*14*/]), -183018591, 500, true, false, 0, false, 0.5f, 1f, 752097756, true, 0f, false);
...
void func_49(var uParam0, int iParam1, char* sParam2, var uParam3, vector3 vParam4, float fParam7, int iParam8, int iParam9, int iParam10, int iParam11, int iParam12, int iParam13)
{
