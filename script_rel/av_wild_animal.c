...
{
	func_33(uParam0, 10814/*func_30*/, 10872/*func_31*/, 11242/*func_32*/);
}
...
{
	func_46(uParam0, "WILD_ANIMAL", "", vParam1, vParam4);
	switch (*uParam0)
	{
		case 233:
			iLocal_9 = 195700131;
			iLocal_10 = 1672546883;
			break;
	...
	func_48(uParam0, 0, "WAP_ANIMAL_1", iLocal_9, vParam1, vParam4.z, 1, 1, 1, 1, 41788943, 1);
}
...
int func_31(var uParam0)
{
	if (!&uParam0->f_469[1])
	{
		if (func_63(uParam0, &uLocal_12, 0))
		{
			func_64(uParam0);
			func_65(uParam0);
			uParam0->f_469[1] = 1;
	...
	switch (iLocal_11)
	{
		...
		case 3:
			if (*uParam0 == 236)
			{
				if (func_69(uParam0, 1f, 85f, 4, -91962372, 0))
				{
					func_65(uParam0);
					return 1;
				}
...
int func_38(int iParam0, vector3 vParam1, float fParam4)
{
	...
	if (func_73(vVar0, vVar0 + vVar3, vParam1))
	{
		return 3;
	}
	return 2;
...
void func_41(var uParam0, int iParam1, int iParam2, int iParam3, int iParam4, int iParam5, int iParam6, bool bParam7)
{
	...
	iVar2 = func_78(*uParam0);
	iVar3 = func_79(*uParam0);
	iVar4 = func_80(*uParam0);
	iVar5 = func_81(*uParam0);
...
int func_49(int iParam0, bool bParam1, int iParam2)
{
	...
	if ((Global_1898164->f_1[0 /*5*/])->f_2 == 8)
	{
		...
		if (func_86(iVar0) && func_87(((*Global_1347702)[iVar0 /*49*/])->f_12, 131072))
		{
			return 0;
		}
	}
...
bool func_52()
{
	return (Global_1894899 & 1 != 0 && func_71() != -1);
}
...
int func_54(int iParam0, vector3 vParam1, float fParam4, bool bParam5, bool bParam6, int iParam7, bool bParam8, bool bParam9, bool bParam10, bool bParam11, bool bParam12, bool bParam13, bool bParam14)
{
	...
	func_89(iVar0, iParam0, iParam7, bParam8, bParam9, bParam10, bParam11, bParam12);
	return iVar0;
}
...
int func_63(var uParam0, var uParam1, int iParam2)
{
	...
	{
		if (func_97(&(uParam0->f_20[uParam0->f_501 /*14*/]), 0, uParam1, &(uParam0->f_468), 0, 0))
		{
			return 1;
		}
		uParam0->f_501++;
...
void func_65(var uParam0)
{
	if (!&uParam0->f_469[2])
	{
		func_99(*uParam0, uParam0->f_483, 0);
		uParam0->f_469[2] = 1;
	}
}
		...
		while (iVar0 < uParam0->f_19)
		{
			...
			else
			{
				if (!ENTITY::IS_ENTITY_DEAD(&(uParam0->f_20[iVar0 /*14*/])))
				{
					...
					{
						if ((func_105(Global_35, &(uParam0->f_20[iVar0 /*14*/]), 1) < fParam2 && PED::_0x5102307CE88798EB(&(uParam0->f_20[iVar0 /*14*/]))) && PED::IS_TRACKED_PED_VISIBLE(&(uParam0->f_20[iVar0 /*14*/])))
						{
							if (!func_106(&(uParam0->f_490)))
							{
...
bool func_73(struct<2> Param0, var uParam2, struct<2> Param3, Vector3 vParam5, struct<2> Param6, var uParam8)
{
...
int func_74(vector3 vParam0, float fParam3)
{
	...
	while (iVar0 < 4)
	{
		...
		{
			if (func_115(vParam0, (Global_1415419->f_9721[iVar0 /*8*/])->f_4, fParam3, 0))
			{
				return 1;
			}
		}
...
int func_75(vector3 vParam0)
{
	...
	while (iVar0 < 10)
	{
		...
		{
			if (func_115(vParam0, (Global_32073.f_2697.f_1495[iVar0 /*4*/])->f_1, 1f, 0))
			{
				return 1;
			}
		}
...
void func_89(int iParam0, int iParam1, int iParam2, bool bParam3, bool bParam4, bool bParam5, bool bParam6, bool bParam7)
{
	bool bVar0;
...
int func_97(int iParam0, int iParam1, var uParam2, var uParam3, int iParam4, float fParam5)
{
	int iVar0;
	...
	if (!Global_1935630->f_12 && !ENTITY::IS_ENTITY_DEAD(iParam0))
	{
		...
		if (!uParam2->f_1 & 128 != 0)
		{
			...
			{
				*uParam3 = 128;
				func_132(iParam0, uParam2, *uParam3);
				return 1;
			}
		}
		if (Global_1935630->f_27)
		{
			if (!uParam2->f_1 & 8 != 0)
			{
				...
				else if (func_134(iParam0, iParam1, uParam2))
				{
					*uParam3 = 8;
					func_132(iParam0, uParam2, *uParam3);
					return 1;
		...
		if (Global_1935630->f_26 && func_136(PLAYER::PLAYER_ID(), 0, 1, uParam2->f_1 & 524288 == 0))
		{
		...
		{
			if (func_137(uParam2, 1065353216))
			{
				if (!uParam2->f_1 & 4 != 0)
				{
		...
		if (!uParam2->f_1 & 16 != 0)
		{
			...
			{
				if (func_140(Global_35, iParam0, uParam2, 0))
				{
					*uParam3 = 16;
					func_132(iParam0, uParam2, *uParam3);
					return 1;
			...
			else if (func_140(Global_35, iParam0, uParam2, 1))
			{
				*uParam3 = 16;
				func_132(iParam0, uParam2, *uParam3);
				return 1;
		...
		if (Global_1935630->f_30 || Global_1935630->f_31)
		{
			if (!uParam2->f_1 & 2 != 0)
			{
				if (func_143(uParam2, 4000))
				{
					if ((func_144(iParam0, Global_1935630->f_41, *uParam2 & 128 != 0, 0, *uParam2 & 256 != 0) && func_145(uParam2, iParam0)) && func_146(uParam2, iParam0))
					{
						*uParam3 = 2;
						func_132(iParam0, uParam2, *uParam3);
						return 1;
		...
		if (!uParam2->f_1 & 2 != 0)
		{
			if (uParam2->f_12 < 4f)
			{
				if ((func_144(iParam0, Global_1935630->f_41, *uParam2 & 128 != 0, 1, *uParam2 & 256 != 0) && func_145(uParam2, iParam0)) && func_146(uParam2, iParam0))
				{
					*uParam3 = 2;
					func_132(iParam0, uParam2, *uParam3);
					return 1;
				...
				if (Global_1935630->f_40 == 0)
				{
					if (Global_1935630->f_41 != 0)
					{
						if (*uParam2 & 131072 == 0)
						{
							if (func_147(iParam0, Global_1935630->f_41))
							{
								func_148();
								*uParam3 = 2;
								func_132(iParam0, uParam2, *uParam3);
			...
			if (uParam2->f_12 < 10f)
			{
				if (func_149(uParam2, iParam0) || (uParam2->f_9 > 0 && (func_150() - uParam2->f_9) < 2000))
				{
			...
			if (Global_1935630->f_42 != 0)
			{
				if (*uParam2 & 131072 == 0)
				{
					if (func_151())
					{
						if (func_147(iParam0, Global_1935630->f_42))
						{
							func_148();
							*uParam3 = 2;
							func_132(iParam0, uParam2, *uParam3);
		...
		if (uParam2->f_12 < uParam2->f_26)
		{
			...
			{
				if (func_153(iParam0, iParam1, uParam2))
				{
					*uParam3 = 2048;
					func_132(iParam0, uParam2, *uParam3);
					return 1;
...
void func_99(int iParam0, vector3 vParam1, bool bParam4)
{
	if (func_40() > (Global_32073.f_2697.f_6[iParam0 /*6*/])->f_5)
	{
		(Global_32073.f_2697.f_6[iParam0 /*6*/])->f_5 = func_40();
...
float func_105(int iParam0, int iParam1, bool bParam2)
{
	...
	return func_162(ENTITY::GET_ENTITY_COORDS(iParam0, false, false), ENTITY::GET_ENTITY_COORDS(iParam1, false, false));
}
...
int func_108(var uParam0, float fParam1)
{
...
int func_115(vector3 vParam0, vector3 vParam3, float fParam6, bool bParam7)
{
	if (fParam6 < 0f)
	{
		fParam6 = 0f;
...
void func_130(var uParam0, bool bParam1, int iParam2)
{
	func_173(iParam2);
	if (Global_1572887->f_12 == -1)
	{
	...
	if (!uParam0->f_1 & 1024 != 0)
	{
		if (!ENTITY::DOES_ENTITY_EXIST(uParam0->f_14))
		{
			if (func_176(uParam0))
			{
				uParam0->f_15 = func_150();
			}
		}
		else if (uParam0->f_15 > 0)
		{
			if ((func_150() - uParam0->f_15) > 500)
			{
...
int func_140(var uParam0, int iParam1, var uParam2, bool bParam3)
{
	vector3 vVar0;
	int iVar3;
	vector3 vVar4;
...
int func_158(int iParam0, var uParam1)
{
	...
	if (uParam1->f_4 == 0)
	{
		uParam1->f_4 = func_150();
	}
	else if (func_150() - uParam1->f_4) > func_211(uParam1)
	{
...
void func_161(int iParam0, vector3 vParam1)
{
	int iVar0;
	int iVar1;
	...
	while (iVar0 < 10)
	{
		...
		{
			if (func_115((Global_32073.f_2697.f_1495[iVar0 /*4*/])->f_1, vParam1, 1056964608, 1))
			{
				return;
			}
		}
