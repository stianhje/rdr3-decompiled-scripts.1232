		...
		if (MISC::GET_GAME_TIMER() > iLocal_237)
		{
			...
			switch (iLocal_236)
			{
				...
				case 1:
					...
					LAW::_0x9BBDCB8DF789EBC1(PLAYER::PLAYER_ID(), func_9(iLocal_238));
					...
					Global_1897950 = -1;
					iLocal_239 = (MISC::GET_GAME_TIMER() + iLocal_235);
					iLocal_236 = 2;
					break;
				case 2:
					if (func_11() || iLocal_239 < MISC::GET_GAME_TIMER())
					{
						func_12(iLocal_238);
						iLocal_239 = (MISC::GET_GAME_TIMER() + iLocal_235);
						iLocal_236 = 3;
					...
					break;
				case 3:
					if (func_13(iLocal_238) || iLocal_239 < MISC::GET_GAME_TIMER())
					{
						func_14(iLocal_238);
						iLocal_239 = (MISC::GET_GAME_TIMER() + iLocal_235);
						iLocal_236 = 4;
					...
					break;
				case 4:
					if (func_15(iLocal_238) || iLocal_239 < MISC::GET_GAME_TIMER())
					{
						func_16(iLocal_238);
						iLocal_239 = (iLocal_235 + MISC::GET_GAME_TIMER());
						iLocal_236 = 6;
					}
					break;
				case 6:
					if (func_7(func_6(iLocal_238)))
					{
						if (func_17(func_6(iLocal_238), 4) && !iLocal_239 < MISC::GET_GAME_TIMER())
						{
						}
						else
						{
							if (func_18(iLocal_238) || iLocal_239 < MISC::GET_GAME_TIMER())
							{
							...
							Jump @791; //curOff = 459
							if (iLocal_239 < MISC::GET_GAME_TIMER() || (func_20() != 0 || Global_1051260->f_3790))
							{
								func_21(iLocal_238);
								func_22();
								if (!func_23(2057, 0))
							...
							{
								iLocal_237 = (1000 + MISC::GET_GAME_TIMER());
							}
							...
							PATHFIND::SET_AMBIENT_PED_RANGE_MULTIPLIER_THIS_FRAME(((*Global_1888801)[iLocal_238 /*35*/])->f_10);
							if (((*Global_1888801)[iLocal_238 /*35*/])->f_11 > 0f)
							{
								PED::_0xA77FA7BE9312F8C0(((*Global_1888801)[iLocal_238 /*35*/])->f_11);
							}
							Jump @791; //curOff = 772
							func_42(iVar0);
							iVar0++;
						}
						if (((*Global_1888801)[iLocal_238 /*35*/])->f_12 == 0)
						{
						}
						else
						{
							PED::_0x95423627A9CA598E(((*Global_1888801)[iLocal_238 /*35*/])->f_12);
						}
						BUILTIN::WAIT(0);
						iVar0 = 0;
						while (!func_42(iVar0))
...
int func_11()
{
	iLocal_229 = VOLUME::_CREATE_VOLUME_BOX_WITH_CUSTOM_NAME(1209.053f, -193.1814f, 101.852f, 0f, 0f, 19.83985f, 6.216366f, 11.62523f, 3.695f, "ScarlettMeadows Horse Shop - m_volHorseShop");
...
void func_39(var uParam0, int iParam1)
{
	...
	if ((BUILTIN::VDIST(Global_36, 0f, 0f, 0f) <= 5f || func_67(&Global_1935630, 16384)) || func_67(&Global_1935630, 8388608))
	{
		return;
	}
...
void func_47()
{
	...
	(Local_183[0 /*45*/])->f_43 = 10142/*func_93*/;
	(Local_183[0 /*45*/])->f_44 = 10237/*func_94*/;
	func_95(Local_183[0 /*45*/], 512);
}
...
int func_50(var uParam0, int iParam1, var uParam2, int iParam3, int iParam4, char* sParam5, int iParam6, int iParam7, bool bParam8)
{
	int iVar0;
	vector3 vVar1;
	...
	if (!VOLUME::_0x92A78D0BEDB332A3(func_96(iParam3)))
	{
		return 0;
	}
	if (!ENTITY::IS_ENTITY_IN_VOLUME(Global_35, func_96(iParam3), true, 0))
	{
		return 0;
	}
	if (bParam8)
	...
	if ((iParam6 && func_100(128, 0, 1)) && !iParam1 == 64)
	{
		return 0;
	}
	if (iParam7 && func_101(PLAYER::GET_PLAYER_INDEX(), 1, 1, 1))
	{
		return 0;
	}
	uParam0->f_1 = iParam1;
...
void func_55(int iParam0, int iParam1, int iParam2, int iParam3, int iParam4, int iParam5, int iParam6, float fParam7, int iParam8, int iParam9)
{
	...
	if (func_120(iVar0) || func_121(iVar0, iParam0))
	{
		...
		(Global_1914319->f_3[iParam0 /*446*/])->f_20 = func_104(5, (Global_1914319->f_3[iParam0 /*446*/])->f_10, 2, iVar7);
	}
	*(Global_1393529->f_114[iParam0 /*3*/]) = { 0f, 0f, 0f };
	...
	func_129((Global_1914319->f_3[iParam0 /*446*/])->f_10);
	func_130(iParam0, 16);
	func_131(iParam0, 4);
...
{
	func_132(&((Global_1914319->f_3[iParam0 /*446*/])->f_5), iParam1);
}

void func_57(int iParam0, int iParam1)
{
	func_132(&((Global_1914319->f_3[iParam0 /*446*/])->f_6), iParam1);
}
...
{
	if (((*uParam0)[0 /*45*/])->f_29 == 1)
	{
		if (func_143((*uParam0)[0 /*45*/], 1, 1))
		{
			func_144((*uParam0)[0 /*45*/]);
		}
	}
}
...
bool func_71(int iParam0)
{
	...
	return ((((*Global_1888801)[iParam0 /*35*/])->f_20 == 1 || ((*Global_1888801)[iParam0 /*35*/])->f_20 == 2) && !func_150(iParam0));
}
...
void func_74(int iParam0, int iParam1, int iParam2, bool bParam3, int iParam4, int iParam5)
{
	...
	sVar1 = func_152(iParam0, iParam1, iParam2, iParam4, iParam5, bParam3, &uVar0);
	...
	else
	{
		...
		if (!MISC::_SHOULD_USE_24_HOUR_CLOCK())
		{
			...
			sVar2 = MISC::_CREATE_VAR_STRING(674, sVar8, iVar4, func_164(&sVar6, 109029619), sVar9, func_164(&sVar10, 109029619));
		}
		else
		{
			...
			IntToString(&sVar10, BUILTIN::ROUND(fVar7), 8);
			sVar2 = MISC::_CREATE_VAR_STRING(162, sVar8, iVar4, func_164(&sVar6, 109029619), func_164(&sVar10, 109029619));
		}
...
void func_86(int iParam0)
{
	if (func_20() == -1)
	{
		...
		if (iLocal_234)
		{
			LAW::_REMOVE_GUARD_ZONE("SCARLET_HORSE_SHOP_OUTSIDE_PENS");
			iLocal_234 = 0;
		}
		func_179();
	}
...
void func_89(int iParam0)
{
	...
	while (iVar1 < 4)
	{
		func_183(&((Global_1392240->f_1[iVar0 /*18*/])->f_6[iVar1]));
...
void func_92(var uParam0, int iParam1, var uParam2, int iParam3, bool bParam4)
{
	...
	if (bParam4)
	{
		...
		func_95((*uParam0)[iParam3 /*45*/], 128);
	}
	if (!func_187(&(((*uParam0)[iParam3 /*45*/])->f_34)))
	{
		func_188(&(((*uParam0)[iParam3 /*45*/])->f_34), 1);
	}
	func_95((*uParam0)[iParam3 /*45*/], 32768);
	func_95((*uParam0)[iParam3 /*45*/], 1024);
...
int func_99(vector3 vParam0, int iParam3, int iParam4, int iParam5)
{
	var uVar0[4];
	int iVar5[4];
...
int func_101(int iParam0, bool bParam1, int iParam2, int iParam3)
{
	...
	{
		return func_196(bParam1, iParam2, iParam3);
	}
	if (Global_1572887->f_12 != -1)
	{
...
int func_111(int iParam0, var uParam1, var uParam2, bool bParam3, bool bParam4)
{
	bool bVar0;
...
int func_114(int iParam0, bool bParam1)
{
	...
	{
		func_207(iParam0, _NAMESPACE48::_0x4F76E3676583D951(func_206(iParam0)));
		if (func_20() == -1)
		{
...
{
	return func_211((Global_1914319->f_3[iParam0 /*446*/])->f_5, iParam1);
}
...
void func_119(int iParam0)
{
	...
	if (func_112((Global_1914319->f_3[iParam0 /*446*/])->f_21) && func_212((Global_1914319->f_3[iParam0 /*446*/])->f_21))
	{
		func_213((Global_1914319->f_3[iParam0 /*446*/])->f_21, 0, 1, 0, 0);
	}
	...
	func_214((Global_1914319->f_3[iParam0 /*446*/])->f_10, 0);
	...
	else
	{
		...
		while (iVar0 < iVar1)
		{
			func_183(&((Global_1914319->f_3[iParam0 /*446*/])->f_317[iVar0 /*6*/]));
...
bool func_140(int iParam0, int iParam1)
{
	...
	if (iParam1 && !ENTITY::DOES_ENTITY_EXIST(func_145(iParam0)))
	{
		return false;
	}
...
void func_144(var uParam0)
{
	...
	if (MISC::IS_STRING_NULL_OR_EMPTY(func_236(&vVar0)))
	{
		return;
	}
	...
	if (!func_226(uParam0, 65536))
	{
		...
		{
			iVar4 = uParam0->f_21;
			iVar5 = func_145(&(uParam0->f_3[iVar4 /*3*/]));
			if (!func_237(iVar5, 0))
			{
				return;
			}
...
char* func_152(int iParam0, int iParam1, int iParam2, int iParam3, var uParam4, var uParam5, var uParam6)
{
	char* sVar0;
...
char* func_164(char* sParam0, int iParam1)
{
	...
	return func_251(MISC::_CREATE_VAR_STRING(10, "LITERAL_STRING", sParam0), iParam1);
}
...
int func_167(int iParam0)
{
	...
	if (func_252())
	{
		if (!func_134(((*Global_1835011)[3 /*74*/])->f_1, 1))
		{
...
void func_178(int iParam0)
{
	...
	if (!func_172(&(Global_1310750->f_13321[iParam0 /*9*/])))
	{
		return;
	}
...
void func_179()
{
	if (func_187(&((Local_183[0 /*45*/])->f_34)))
	{
		func_256(&((Local_183[0 /*45*/])->f_34));
	}
	func_257((Local_183[0 /*45*/])->f_38);
	func_257((Local_183[0 /*45*/])->f_39);
}
...
{
	func_258((Global_1935369->f_5[iParam0 /*11*/])->f_6, 1);
	func_259((Global_1935369->f_5[iParam0 /*11*/])->f_6, 0);
...
int func_196(bool bParam0, var uParam1, var uParam2)
{
...
{
	return func_211((Global_1914319->f_3[iParam0 /*446*/])->f_6, iParam1);
}
...
float func_227(int iParam0, int iParam1, bool bParam2)
{
	...
	return func_295(ENTITY::GET_ENTITY_COORDS(iParam0, false, false), ENTITY::GET_ENTITY_COORDS(iParam1, false, false));
}
...
int func_229(var uParam0, bool bParam1)
{
	...
	if ((((func_101(PLAYER::PLAYER_ID(), 1, 0, 1) || func_303()) || LAW::_0xF46108C50A22B029()) || LAW::_0x69E181772886F48B(PLAYER::PLAYER_ID())) || PLAYER::_0xD1F6B912785BFD35(PLAYER::PLAYER_ID()))
	{
		return 0;
	}
...
void func_233(var uParam0)
{
	...
	if (uParam0->f_2)
	{
		...
		while (iVar1 < 5)
		{
			if (func_112(&(uParam0->f_3[iVar1 /*3*/])) && (uParam0->f_3[iVar1 /*3*/])->f_2)
			{
				iVar2 = func_145(&(uParam0->f_3[iVar1 /*3*/]));
				if (ENTITY::DOES_ENTITY_EXIST(iVar2))
				{
...
int func_234(var uParam0, int iParam1)
{
	...
	if (func_226(uParam0, 128))
	{
		...
		while (iVar0 < 5)
		{
			iVar1 = func_145(&(uParam0->f_3[iVar0 /*3*/]));
...
int func_240(var uParam0, vector3 vParam1, vector3 vParam4, bool bParam7, bool bParam8)
{
	int iVar0;
	int iVar1;
	...
	else if (func_315(uParam0, vParam1, bParam8, -1, 0, 0))
	{
		iVar0 = uParam0[0 /*4*/];
		iVar1 = uParam0[1 /*4*/];
		if ((ENTITY::DOES_ENTITY_EXIST(iVar0) && !func_316(iVar0, 0)) && (ENTITY::DOES_ENTITY_EXIST(iVar1) && !func_316(iVar1, 0)))
		{
			if (!func_98(vParam4))
			{
...
char* func_246(var uParam0, var uParam1, var uParam2, var uParam3, var uParam4, var uParam5, var uParam6, var uParam7)
{
...
{
	func_323(&((Global_1935369->f_5[iParam0 /*11*/])->f_7), iParam1);
}
...
int func_268(int iParam0)
{
	...
	return func_134(((*Global_1347702)[58 /*49*/])->f_15, 1);
}
...
{
	return (BUILTIN::SHIFT_RIGHT(iParam0, 26) & 31 * func_329(MISC::IS_BIT_SET(iParam0, 31), -1, 1)) + 1898;
}
...
int func_302(int iParam0, int iParam1, int iParam2, bool bParam3, int iParam4)
{
	...
	{
		if (WEAPON::_0x6AD66548840472E5(func_336(iVar0, 0)))
		{
			if (func_337(ENTITY::GET_ENTITY_COORDS(iParam0, true, false), 0.4f, 0.6f, 0.3f, 0.7f))
			{
				return 1;
			}
		}
...
{
	if (!ENTITY::DOES_ENTITY_EXIST(iParam0) || func_316(iParam0, 0))
	{
		return 0;
	}
	if (func_339(iParam0))
...
float func_309(int iParam0, int iParam1, bool bParam2, int iParam3)
{
...
int func_313(int iParam0, int iParam1)
{
	...
	return func_221((Global_1914319->f_3[iParam0 /*446*/])->f_10, 1024);
}
...
int func_320(vector3 vParam0, int iParam3)
{
	...
	func_345(iParam3, &vVar0, &Var3, &fVar6);
	if (func_346(vParam0, vVar0, Var3, Var3.f_1, fVar6))
	{
		return 1;
	}
	return 0;
...
int func_337(vector3 vParam0, float fParam3, float fParam4, float fParam5, float fParam6)
{
	float fVar0;
	float fVar1;
	bool bVar2;
...
{
	if (((func_333(1) || AUDIO::_0x2B101AD9F651243A()) || AUDIO::IS_SCRIPTED_SPEECH_PLAYING(iParam0)) || AUDIO::IS_ANY_SPEECH_PLAYING(iParam0))
	{
		return 1;
	}
	return 0;
