...
void func_66(int iParam0, int iParam1, int iParam2, bool bParam3, int iParam4, int iParam5)
{
	...
	else
	{
		...
		if (!MISC::_SHOULD_USE_24_HOUR_CLOCK())
		{
			...
			sVar2 = MISC::_CREATE_VAR_STRING(674, sVar8, iVar4, func_131(&sVar6, 109029619), sVar9, func_131(&sVar10, 109029619));
		}
		else
		{
			...
			IntToString(&sVar10, BUILTIN::ROUND(fVar7), 8);
			sVar2 = MISC::_CREATE_VAR_STRING(162, sVar8, iVar4, func_131(&sVar6, 109029619), func_131(&sVar10, 109029619));
		}
...
int func_89(int iParam0, bool bParam1)
{
	...
	{
		func_154(iParam0, _NAMESPACE48::_0x4F76E3676583D951(func_153(iParam0)));
		if (func_20() == -1)
		{
...
void func_109(var uParam0, char* sParam1)
{
	...
	INTERIOR::DEACTIVATE_INTERIOR_ENTITY_SET(*uParam0, sParam1, 1);
}
...
void func_188(int iParam0, bool bParam1, int iParam2, bool bParam3, bool bParam4)
{
	int iVar0;
	int iVar1;
...
int func_211(vector3 vParam0, int iParam3)
{
	...
	func_236(iParam3, &vVar0, &Var3, &fVar6);
	if (func_237(vParam0, vVar0, Var3, Var3.f_1, fVar6))
	{
		return 1;
	}
	return 0;
