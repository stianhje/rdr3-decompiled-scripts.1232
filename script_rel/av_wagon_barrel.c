...
{
	func_33(uParam0, 11061/*func_30*/, 11177/*func_31*/, 11752/*func_32*/);
}
...
int func_18(var uParam0)
{
	...
	iLocal_41 = VOLUME::_CREATE_VOLUME_BOX_WITH_CUSTOM_NAME(TASK::_0xA8452DD321607029(iLocal_39, 1), 0f, 0f, 0f, 1f, 1f, 3f, "AV_WAGON_BARREL_PED1_SCENARIO");
	iLocal_42 = VOLUME::_CREATE_VOLUME_BOX_WITH_CUSTOM_NAME(TASK::_0xA8452DD321607029(iLocal_40, 1), 0f, 0f, 0f, 1f, 1f, 3f, "AV_WAGON_BARREL_PED2_SCENARIO");
	return 1;
}
...
void func_52(var uParam0, char* sParam1, int iParam2, vector3 vParam3, var uParam6, int iParam7, int iParam8, int iParam9, int iParam10)
{
...
void func_202(int iParam0, int iParam1, int iParam2, int iParam3, int iParam4, int iParam5, bool bParam6, int iParam7)
{
	int iVar0;
