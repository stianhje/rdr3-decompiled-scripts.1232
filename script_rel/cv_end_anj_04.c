...
int func_72(var uParam0)
{
	...
	iLocal_21 = func_152(uParam0, "script@vignette@abigail_and_jack_4@action_b_alt_front", 2, 0, 0, 1);
	iLocal_22 = func_152(uParam0, "script@vignette@abigail_and_jack_4@action_b_alt_left", 2, 0, 0, 1);
	iLocal_23 = func_152(uParam0, "script@vignette@abigail_and_jack_4@action_b_alt_back", 2, 0, 0, 1);
