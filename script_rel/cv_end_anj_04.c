...
int func_72(var uParam0)
{
	...
	Local_24 = { func_151(uParam0, 14.655f, 9.502f, -1.942f, 180f, 7.56f, 0.239f, 0.5075f) };
	Local_34 = { func_151(uParam0, 14.655f, 9.5f, -1.942f, -120f, 3.4875f, 0.405f, 0.45f) };
	Local_44 = { func_151(uParam0, 14.655f, 9.5f, -1.942f, -51f, 5f, 0.4025f, 0.4f) };
	func_152(uParam0, "script@vignette@abigail_and_jack_4@base", 1, 1, 0, 0);
	iLocal_17 = func_152(uParam0, "script@vignette@abigail_and_jack_4@action_a", 2, 0, 1, 0);
	iLocal_19 = func_152(uParam0, "script@vignette@abigail_and_jack_4@action_b", 2, 0, 0, 0);
	uLocal_21 = func_152(uParam0, "script@vignette@abigail_and_jack_4@action_b_alt_front", 2, 0, 0, 1);
	uLocal_22 = func_152(uParam0, "script@vignette@abigail_and_jack_4@action_b_alt_left", 2, 0, 0, 1);
	uLocal_23 = func_152(uParam0, "script@vignette@abigail_and_jack_4@action_b_alt_back", 2, 0, 0, 1);
	iLocal_20 = func_152(uParam0, "script@vignette@abigail_and_jack_4@action_c", 0, 0, 0, 0);
	func_153(uParam0, "BANJ4AU");
	func_154(uParam0, -439210379, 1155195716);
	func_155(uParam0, iLocal_14, 3, 2087366558, "WORLD_HUMAN_STAND_WAITING_FEMALE_A", -1, 1);
	func_156(uParam0, iLocal_14, 1, -1);
	func_157(uParam0, iLocal_15, 2, 1546182539, "WORLD_HUMAN_CROUCH_INSPECT_MALE_C", -1, 1, 1f, 1065353216, 1);
	func_156(uParam0, iLocal_15, 1, -1);
	func_155(uParam0, iLocal_16, 3, -363194080, "WORLD_ANIMAL_DOG_SLEEPING", -1, 1);
	func_157(uParam0, iLocal_16, 2, -363194080, "WORLD_ANIMAL_DOG_SLEEPING", -1, 0, -1073741824, 1065353216, 1);
...
int func_93(var uParam0)
{
	...
	{
		if (func_197(uParam0, Local_44, 1, 0))
		{
			iLocal_18 = uLocal_23;
		}
		else if (func_197(uParam0, Local_24, 1, 0))
		{
			iLocal_18 = uLocal_21;
		}
		else if (func_197(uParam0, Local_34, 1, 0))
		{
			iLocal_18 = uLocal_22;
		}
		else
	...
	if (func_196(uParam0, iLocal_18))
	{
		...
		{
			func_198(uParam0, iLocal_15, 1, 1);
			func_198(uParam0, iLocal_16, 1, 1);
		}
		else
		{
...
struct<10> func_151(var uParam0, vector3 vParam1, float fParam4, float fParam5, float fParam6, float fParam7)
{
	float fVar0;
	float fVar1;
	struct<10> Var2;
...
void func_158(var uParam0, float fParam1, float fParam2)
{
...
void func_183(var uParam0)
{
	...
	{
		uParam0->f_1976.f_6 = PROPSET::_CREATE_PROPSET_2(uParam0->f_1976, func_250(uParam0, uParam0->f_1976.f_1), 1, func_249(uParam0, uParam0->f_1976.f_4), 3f, false, true);
	}
}
...
void func_198(var uParam0, int iParam1, bool bParam2, bool bParam3)
{
	...
	if (bParam3)
	{
		uVar0 = func_299(uParam0, iParam1);
	}
	if (bParam2)
	{
			...
			if (!(uParam0->f_107[iVar0 /*113*/])->f_32)
			{
				if (func_302(uParam0, iVar0))
				{
					if ((uParam0->f_107[iVar0 /*113*/])->f_32.f_48)
					{
						...
						func_198(uParam0, iVar0, 0, 1);
					}
					else
					{
						func_198(uParam0, iVar0, 1, 1);
					}
...
float func_300(float fParam0, float fParam1)
{
...
void func_341(var uParam0, int iParam1)
{
	...
	func_380(sVar1, uVar2, uVar3, iVar4);
}
...
int func_345(var uParam0, int iParam1)
{
	...
	while (iVar2 <= iVar1)
	{
		...
		else
		{
			...
			vVar10 = { func_383(fVar9) };
			vVar13 = { func_384(ENTITY::GET_ENTITY_COORDS((uParam0->f_107[iParam1 /*113*/])->f_5, true, false), vVar3, 1065353216) };
...
void func_380(char* sParam0, var uParam1, var uParam2, int iParam3)
{
...
Vector3 func_383(float fParam0)
{
...
{
	return func_411(vParam3 - vParam0) * Vector(fParam6, fParam6, fParam6);
}
...
int func_388(int iParam0, bool bParam1, bool bParam2, var uParam3, var uParam4, var uParam5, float fParam6, bool bParam7, bool bParam8, bool bParam9, bool bParam10)
{
	...
	switch (((*Global_1360165)[iParam0 /*1157*/])->f_70.f_12)
	{
		...
		case 3:
			...
			sVar12 = func_419(iParam0, func_278());
...
int func_417(int iParam0, int iParam1, bool bParam2)
{
	...
	PED::_0x1902C4CFCC5BE57C(iParam1, func_447(iParam0));
	PED::_0xCC8CA3E88256E58F(iParam1, 0, 1, 1, 1, 0);
...
void func_418(int iParam0, int iParam1)
{
	...
	func_379(iParam0, func_448(iParam1));
	...
	func_390(iParam1, func_446(iParam1, 8192), func_446(iParam1, 16384), 1);
}
		...
		case 1:
			switch (iParam0)
			{
				...
				case 9:
					...
					break;
				case 10:
					if (func_391(((*Global_1347702)[63 /*49*/])->f_15, 1) || func_428(((*Global_1347702)[63 /*49*/])->f_15))
					{
						iVar1[0] = -268604689;
					}
					else
		...
		case 3:
			switch (iParam0)
			{
				...
				case 10:
					...
					break;
				case 11:
					if (func_391(((*Global_1347702)[134 /*49*/])->f_15, 1) || func_428(((*Global_1347702)[134 /*49*/])->f_15))
					{
						iVar1[0] = -2040275819;
						iVar1[1] = 1205492208;
						iVar7 = 2;
		...
		case 7:
			switch (iParam0)
			{
				...
				case 14:
					...
					break;
				case 4:
					if (func_321(747937920, 1) && !func_391(((*Global_1347702)[1 /*49*/])->f_15, 1))
					{
						iVar1[0] = -1155031950;
					}
					else
...
int func_441(int iParam0, int iParam1)
{
	...
	switch (iParam0)
	{
		...
		case -1862464078:
			return 1895628185;
		case 296923297:
			iVar0 = func_458(296923297, iParam1);
		...
		case -1414977761:
			return 1059434053;
		case 1237718549:
			iVar0 = func_458(1237718549, iParam1);
			return func_459(iVar0);
		case -23947011:
			return -456769142;
		case 1295334688:
...
bool func_445(int iParam0, int iParam1, bool bParam2, bool bParam3, int iParam4, bool bParam5, int iParam6, int iParam7, int iParam8, int iParam9, bool bParam10, bool bParam11, bool bParam12, bool bParam13)
{
	...
	{
		func_463(bVar0, iParam9, bParam2, bParam5, iParam4, bParam11, 752097756, 0);
	}
	else if (!bParam13)
	{
		fVar25 = 0f;
		func_464(iParam0, &bVar0, &fVar25);
...
float func_449(float fParam0, float fParam1, float fParam2)
{
	if (fParam0 > fParam2)
	{
		return fParam2;
		...
		while (iVar28 < 4)
		{
			...
			if (func_472(iParam0, &Var0, iVar5, 0))
			{
				...
				if (func_476(0))
				{
					...
					func_477(WEAPON::_0x5C2EA6C44F515F34(iParam0), iParam1, iParam6);
...
struct<5> func_470(int iParam0, bool bParam1, int iParam2)
{
	...
	switch (func_482(iParam0))
	{
		...
		case -1650247667:
			...
			break;
		case -2130996531:
			if (func_487(iParam0, -1823706425))
			{
				Var0 = { func_474(-1838434463, Var0, 1084182731, bParam1) };
				Var0.f_4 = INVENTORY::_0x6452B1D357D81742(iParam0, -1838434463);
			}
			else if (func_487(iParam0, -1483207246))
			{
				Var0 = { func_474(889965687, Var0, 1034665895, bParam1) };
				Var0.f_4 = INVENTORY::_0x6452B1D357D81742(iParam0, 889965687);
			}
		...
		default:
			...
			else if (INVENTORY::_0x780C5B9AE2819807(iParam0, -833319691))
			{
				...
				if (!func_488(Var0, &Var27, bParam1, 0))
				{
					Var0.f_4 = 0;
				}
				else
...
{
	return func_489(iParam0, *uParam1, iParam2, bParam3) > 0;
}
...
int func_473(int iParam0, var uParam1, int iParam2)
{
	...
	if (func_490(iParam0, &uVar0, uParam1, iParam2))
	{
...
struct<4> func_474(int iParam0, var uParam1, var uParam2, var uParam3, var uParam4, int iParam5, bool bParam6)
{
	...
	INVENTORY::_0x886DFD3E185C8A89(func_492(bParam6), &uParam1, iParam0, iParam5, &Var0);
	return Var0;
}
...
int func_475(int iParam0, var uParam1, var uParam2, int iParam3, int iParam4, int iParam5, bool bParam6)
{
	...
	Var0.f_9 = -1591664384;
	if (!func_488(*uParam1, &Var0, bParam6, 0))
	{
		return 0;
	}
	if (iParam3 < 0)
	...
	if (!INVENTORY::_0x3E4E811480B3AE79(func_492(bParam6), uParam1, iParam3, iParam4))
	{
		return 0;
	}
	return 1;
...
int func_476(bool bParam0)
{
	...
	return INVENTORY::_0x0FBBFFC891A97C81(func_492(bParam0));
}
...
void func_478(int iParam0, int iParam1)
{
	...
	{
		iVar1 = func_495(WEAPON::_0xD3750CCC00635FC2(iParam0), iParam1);
...
{
	return func_474(1328661203, func_496(), -1591664384, bParam0);
}
...
struct<4> func_483(bool bParam0)
{
	...
	if (iVar0 == 2)
	{
		...
		{
			*Global_1224214 = { func_474(923904168, func_481(bParam0), -740156546, bParam0) };
		}
	...
	else if (iVar0 == 3)
	{
		...
		{
			*Global_1224222 = { func_474(923904168, func_481(bParam0), -740156546, 0) };
		}
		return *Global_1224222;
	}
	return func_474(923904168, func_481(bParam0), -740156546, 0);
}

int func_484(int iParam0, bool bParam1)
{
	if (func_486(iParam0) == 1779021115)
	{
		return 0;
	}
	if (WEAPON::_0xD955FEE4B87AFA07(iParam0))
	{
		if (bParam1)
		{
			return func_497(-1185145312, 0) > 0;
		}
		else
		{
			return 1;
...
struct<4> func_485(bool bParam0)
{
	...
	if (iVar0 == 2 || iVar0 == 3)
	{
		...
		{
			*Global_1224218 = { func_474(271701509, func_481(bParam0), 12999093, 0) };
		}
		return *Global_1224218;
	}
	return func_474(271701509, func_481(bParam0), 12999093, 0);
}
...
int func_488(var uParam0, var uParam1, var uParam2, var uParam3, var uParam4, bool bParam5, bool bParam6)
{
	if (!INVENTORY::_0xB881CA836CC4B6D4(&uParam0))
	{
		return 0;
	}
	if (!INVENTORY::_0x9700E8EFC4AB9089(func_492(bParam5), &uParam0, uParam4, !bParam6))
	{
		return 0;
	}
	return 1;
...
int func_489(int iParam0, struct<4> Param1, int iParam5, bool bParam6)
{
	...
	uVar4 = INVENTORY::_0xC97E0D2302382211(func_492(bParam6), &Var0, 0);
	return uVar4;
}
...
int func_490(int iParam0, var uParam1, var uParam2, int iParam3)
{
	...
	iVar0 = func_492(0);
	*uParam1 = { func_474(iParam0, func_483(0), iParam3, 0) };
	if (!INVENTORY::_0xB881CA836CC4B6D4(uParam1))
	{
		return 0;
	}
...
int func_497(int iParam0, bool bParam1)
{
	...
	return INVENTORY::_0xE787F05DFC977BDE(func_492(bParam1), iParam0, 0);
}
